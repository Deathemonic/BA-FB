...
impl<'a> CharacterDialogFieldExcel<'a> {
  ...
  pub const VT_LOCALIZETH: flatbuffers::VOffsetT = 24;
  pub const VT_LOCALIZETW: flatbuffers::VOffsetT = 26;
  pub const VT_LOCALIZEEN: flatbuffers::VOffsetT = 28;
  ...
  pub fn LocalizeTH(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(CharacterDialogFieldExcel::VT_LOCALIZETH, None)}
  }
  #[inline]
  pub fn LocalizeTW(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(CharacterDialogFieldExcel::VT_LOCALIZETW, None)}
  }
  #[inline]
  pub fn LocalizeEN(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(CharacterDialogFieldExcel::VT_LOCALIZEEN, None)}
  }
}
...
impl Serialize for CharacterDialogFieldExcel<'_> {
  ...
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("CharacterDialogFieldExcel", 13)?;
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> CharacterDialogFieldExcelBuilder<'a, 'b, A> {
  ...
  pub fn add_LocalizeTH(&mut self, LocalizeTH: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(CharacterDialogFieldExcel::VT_LOCALIZETH, LocalizeTH);
  }
  #[inline]
  pub fn add_LocalizeTW(&mut self, LocalizeTW: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(CharacterDialogFieldExcel::VT_LOCALIZETW, LocalizeTW);
  }
  #[inline]
  pub fn add_LocalizeEN(&mut self, LocalizeEN: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(CharacterDialogFieldExcel::VT_LOCALIZEEN, LocalizeEN);
  }
  #[inline]
