...
impl<'a> CharacterVoiceSubtitleExcel<'a> {
  ...
  pub fn TLMID(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(CharacterVoiceSubtitleExcel::VT_TLMID, None)}
  }
  #[inline]
  ...
  pub fn DurationKr(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(CharacterVoiceSubtitleExcel::VT_DURATIONKR, Some(0)).unwrap()}
  }
  #[inline]
  ...
  pub fn LocalizeTH(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(CharacterVoiceSubtitleExcel::VT_LOCALIZETH, None)}
  }
  #[inline]
  pub fn LocalizeTW(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(CharacterVoiceSubtitleExcel::VT_LOCALIZETW, None)}
  }
  #[inline]
  pub fn LocalizeEN(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(CharacterVoiceSubtitleExcel::VT_LOCALIZEEN, None)}
  }
}
...
impl Serialize for CharacterVoiceSubtitleExcel<'_> {
  ...
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("CharacterVoiceSubtitleExcel", 11)?;
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> CharacterVoiceSubtitleExcelBuilder<'a, 'b, A> {
  ...
  pub fn add_TLMID(&mut self, TLMID: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(CharacterVoiceSubtitleExcel::VT_TLMID, TLMID);
  }
  #[inline]
  ...
  pub fn add_DurationKr(&mut self, DurationKr: i64) {
    self.fbb_.push_slot::<i64>(CharacterVoiceSubtitleExcel::VT_DURATIONKR, DurationKr, 0);
  }
  #[inline]
  ...
  pub fn add_LocalizeTH(&mut self, LocalizeTH: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(CharacterVoiceSubtitleExcel::VT_LOCALIZETH, LocalizeTH);
  }
  #[inline]
  pub fn add_LocalizeTW(&mut self, LocalizeTW: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(CharacterVoiceSubtitleExcel::VT_LOCALIZETW, LocalizeTW);
  }
  #[inline]
  pub fn add_LocalizeEN(&mut self, LocalizeEN: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(CharacterVoiceSubtitleExcel::VT_LOCALIZEEN, LocalizeEN);
  }
  #[inline]
