...
impl<'a> ScenarioScriptExcel<'a> {
  ...
  pub const VT_TEXTTH: flatbuffers::VOffsetT = 24;
  pub const VT_TEXTTW: flatbuffers::VOffsetT = 26;
  pub const VT_TEXTEN: flatbuffers::VOffsetT = 28;
  pub const VT_VOICEID: flatbuffers::VOffsetT = 30;
  pub const VT_TEENMODE: flatbuffers::VOffsetT = 32;
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    let key = table_encryption_service::create_key(b"ScenarioScript");
      ...
      if let Some(x) = args.TextEn {
        ...
        builder.add_TextEn(x);
      }
      if let Some(x) = args.TextTw {
        let x = if table_encryption_service::use_encryption() { _fbb.create_string(&table_encryption_service::new_encrypt_string(&x, &key).unwrap()) } else { _fbb.create_string(&x) };
        builder.add_TextTw(x);
      }
      if let Some(x) = args.TextTh {
        let x = if table_encryption_service::use_encryption() { _fbb.create_string(&table_encryption_service::new_encrypt_string(&x, &key).unwrap()) } else { _fbb.create_string(&x) };
        builder.add_TextTh(x);
      }
  ...
  pub fn unpack(&self) -> ScenarioScriptExcelT {
    ...
    let TextTh = self.TextTh().map(|x| {
      if table_encryption_service::use_encryption() { table_encryption_service::convert_string(&x, &key).unwrap() } else { x.to_string() }
    });
    let TextTw = self.TextTw().map(|x| {
      if table_encryption_service::use_encryption() { table_encryption_service::convert_string(&x, &key).unwrap() } else { x.to_string() }
    });
    let TextEn = self.TextEn().map(|x| {
      if table_encryption_service::use_encryption() { table_encryption_service::convert_string(&x, &key).unwrap() } else { x.to_string() }
    });
  ...
  #[inline]
  pub fn TextTh(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(ScenarioScriptExcel::VT_TEXTTH, None)}
  }
  #[inline]
  pub fn TextTw(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(ScenarioScriptExcel::VT_TEXTTW, None)}
  }
  #[inline]
  pub fn TextEn(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(ScenarioScriptExcel::VT_TEXTEN, None)}
  }
  #[inline]
  ...
  pub fn TeenMode(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(ScenarioScriptExcel::VT_TEENMODE, Some(false)).unwrap()}
  }
}
...
impl flatbuffers::Verifiable for ScenarioScriptExcel<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("TextTh", Self::VT_TEXTTH, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("TextTw", Self::VT_TEXTTW, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("TextEn", Self::VT_TEXTEN, false)?
...
pub struct ScenarioScriptExcelArgs<'a> {
    ...
    pub TextTh: Option<flatbuffers::WIPOffset<&'a str>>,
    pub TextTw: Option<flatbuffers::WIPOffset<&'a str>>,
    pub TextEn: Option<flatbuffers::WIPOffset<&'a str>>,
    pub VoiceId: u32,
    pub TeenMode: bool,
}
...
impl Serialize for ScenarioScriptExcel<'_> {
    ...
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("ScenarioScriptExcel", 15)?;
      ...
      if let Some(f) = self.TextTh() {
        s.serialize_field("TextTh", &f)?;
      } else {
        s.skip_field("TextTh")?;
      }
      if let Some(f) = self.TextTw() {
        s.serialize_field("TextTw", &f)?;
      } else {
        s.skip_field("TextTw")?;
      }
      if let Some(f) = self.TextEn() {
        s.serialize_field("TextEn", &f)?;
      } else {
        s.skip_field("TextEn")?;
      }
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> ScenarioScriptExcelBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn add_TextTh(&mut self, TextTh: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(ScenarioScriptExcel::VT_TEXTTH, TextTh);
  }
  #[inline]
  pub fn add_TextTw(&mut self, TextTw: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(ScenarioScriptExcel::VT_TEXTTW, TextTw);
  }
  #[inline]
  pub fn add_TextEn(&mut self, TextEn: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(ScenarioScriptExcel::VT_TEXTEN, TextEn);
  }
  #[inline]
  ...
  pub fn add_TeenMode(&mut self, TeenMode: bool) {
    self.fbb_.push_slot::<bool>(ScenarioScriptExcel::VT_TEENMODE, TeenMode, false);
  }
  #[inline]
...
impl core::fmt::Debug for ScenarioScriptExcel<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("ScenarioScriptExcel");
      ...
      ds.field("TextTh", &self.TextTh());
      ds.field("TextTw", &self.TextTw());
      ds.field("TextEn", &self.TextEn());
...
pub struct ScenarioScriptExcelT {
  ...
  pub TextTh: Option<String>,
  pub TextTw: Option<String>,
  pub TextEn: Option<String>,
  pub VoiceId: u32,
  pub TeenMode: bool,
}
...
impl ScenarioScriptExcelT {
  pub fn pack<'b, A: flatbuffers::Allocator + 'b>(
    ...
    let TextTh = self.TextTh.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let TextTw = self.TextTw.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let TextEn = self.TextEn.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let VoiceId = self.VoiceId;
    let TeenMode = self.TeenMode;
