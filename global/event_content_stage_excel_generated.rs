...
impl<'a> EventContentStageExcel<'a> {
  ...
  pub const VT_PREVSTAGESUBEVENTID: flatbuffers::VOffsetT = 22;
  pub const VT_OPENCONDITIONSCENARIOID: flatbuffers::VOffsetT = 24;
  pub const VT_OPENCONDITIONCONTENTTYPE: flatbuffers::VOffsetT = 26;
  pub const VT_OPENCONDITIONCONTENTID: flatbuffers::VOffsetT = 28;
  pub const VT_BATTLEDURATION: flatbuffers::VOffsetT = 30;
  pub const VT_STAGEENTERCOSTTYPE: flatbuffers::VOffsetT = 32;
  pub const VT_STAGEENTERCOSTID: flatbuffers::VOffsetT = 34;
  pub const VT_STAGEENTERCOSTAMOUNT: flatbuffers::VOffsetT = 36;
  pub const VT_STAGEENTERECHELONCOUNT: flatbuffers::VOffsetT = 38;
  pub const VT_STARCONDITIONTACTICRANKSCOUNT: flatbuffers::VOffsetT = 40;
  pub const VT_STARCONDITIONTURNCOUNT: flatbuffers::VOffsetT = 42;
  pub const VT_ENTERSCENARIOGROUPID: flatbuffers::VOffsetT = 44;
  pub const VT_CLEARSCENARIOGROUPID: flatbuffers::VOffsetT = 46;
  pub const VT_STRATEGYMAP: flatbuffers::VOffsetT = 48;
  pub const VT_STRATEGYMAPBG: flatbuffers::VOffsetT = 50;
  pub const VT_EVENTCONTENTSTAGEREWARDID: flatbuffers::VOffsetT = 52;
  pub const VT_MAXTURN: flatbuffers::VOffsetT = 54;
  pub const VT_STAGETOPOGRAPHY: flatbuffers::VOffsetT = 56;
  pub const VT_RECOMMANDLEVEL: flatbuffers::VOffsetT = 58;
  pub const VT_BGMID: flatbuffers::VOffsetT = 60;
  pub const VT_STRATEGYENVIRONMENT: flatbuffers::VOffsetT = 62;
  pub const VT_GROUNDID: flatbuffers::VOffsetT = 64;
  pub const VT_CONTENTTYPE: flatbuffers::VOffsetT = 66;
  pub const VT_BGMID: flatbuffers::VOffsetT = 68;
  pub const VT_INSTANTCLEAR: flatbuffers::VOffsetT = 70;
  pub const VT_BUFFCONTENTID: flatbuffers::VOffsetT = 72;
  pub const VT_FIXEDECHELONID: flatbuffers::VOffsetT = 74;
  pub const VT_CHALLENGEDISPLAY: flatbuffers::VOffsetT = 76;
  pub const VT_STARGOAL: flatbuffers::VOffsetT = 78;
  pub const VT_STARGOALAMOUNT: flatbuffers::VOffsetT = 80;
  pub const VT_ISDEFEATBATTLE: flatbuffers::VOffsetT = 82;
  pub const VT_STAGEHINT: flatbuffers::VOffsetT = 84;
  pub const VT_ECHELONEXTENSIONTYPE: flatbuffers::VOffsetT = 86;
  ...
  pub fn unpack(&self) -> EventContentStageExcelT {
    ...
    let Name = self.Name().map(|x| {
      ...
      let StageDifficulty = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.StageDifficulty(), &key)
      } else {
    ...
    let StageNumber = self.StageNumber().map(|x| {
      ...
      let OpenConditionContentType = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.OpenConditionContentType(), &key)
      } else {
      ...
      let StageEnterCostType = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.StageEnterCostType(), &key)
      } else {
    ...
    let BgmId = self.BgmId().map(|x| {
      ...
      let StrategyEnvironment = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.StrategyEnvironment(), &key)
      } else {
        self.StrategyEnvironment()
      };
      let GroundID = self.GroundID();
      let ContentType = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.ContentType(), &key)
      } else {
        self.ContentType()
      };
...
impl Serialize for EventContentStageExcel<'_> {
  ...
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("EventContentStageExcel", 42)?;
