...
impl<'a> RaidSeasonManageExcel<'a> {
  ...
  pub const VT_OPENRAIDBOSSGROUP: flatbuffers::VOffsetT = 14;
  pub const VT_RANKINGREWARDGROUPID: flatbuffers::VOffsetT = 16;
  pub const VT_MAXSEASONREWARDGAUAGE: flatbuffers::VOffsetT = 18;
  pub const VT_STACKEDSEASONREWARDGAUGE: flatbuffers::VOffsetT = 20;
  pub const VT_SEASONREWARDID: flatbuffers::VOffsetT = 22;
...
impl Serialize for RaidSeasonManageExcel<'_> {
  ...
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("RaidSeasonManageExcel", 10)?;
