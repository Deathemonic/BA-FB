...
impl<'a> ConstStrategyExcel<'a> {
  ...
  pub const VT_MULTISWEEPPRESETNAMEMAXLENGTHKR: flatbuffers::VOffsetT = 46;
  pub const VT_MULTISWEEPPRESETSELECTSTAGEMAXCOUNT: flatbuffers::VOffsetT = 48;
  pub const VT_MULTISWEEPPRESETMAXSWEEPCOUNT: flatbuffers::VOffsetT = 50;
  pub const VT_MULTISWEEPPRESETSELECTPARCELMAXCOUNT: flatbuffers::VOffsetT = 52;
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    let key = table_encryption_service::create_key(b"ConstStrategy");
      ...
      let x = args.MultiSweepPresetNameMaxLengthKr;
      let x = if table_encryption_service::use_encryption() { table_encryption_service::convert_int(x, &key) } else { x };
      builder.add_MultiSweepPresetNameMaxLengthKr(x);
  ...
  pub fn unpack(&self) -> ConstStrategyExcelT {
    let key = table_encryption_service::create_key(b"ConstStrategy");
      ...
      let HealCostType = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.HealCostType(), &key)
      } else {
        self.HealCostType()
      };
    let healCostAmount = self.healCostAmount().map(|x| {
      ...
      let MultiSweepPresetNameMaxLengthKr = self.MultiSweepPresetNameMaxLengthKr();
    ...
    ConstStrategyExcelT {
      ...
      MultiSweepPresetNameMaxLengthKr,
  ...
  #[inline]
  pub fn MultiSweepPresetNameMaxLengthKr(&self) -> i32 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(ConstStrategyExcel::VT_MULTISWEEPPRESETNAMEMAXLENGTHKR, Some(0)).unwrap()}
  }
  #[inline]
...
impl flatbuffers::Verifiable for ConstStrategyExcel<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<i32>("MultiSweepPresetNameMaxLengthKr", Self::VT_MULTISWEEPPRESETNAMEMAXLENGTHKR, false)?
...
pub struct ConstStrategyExcelArgs<'a> {
    ...
    pub MultiSweepPresetNameMaxLengthKr: i32,
...
impl<'a> Default for ConstStrategyExcelArgs<'a> {
  ...
  fn default() -> Self {
    ConstStrategyExcelArgs {
      ...
      MultiSweepPresetNameMaxLengthKr: 0,
...
impl Serialize for ConstStrategyExcel<'_> {
  ...
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("ConstStrategyExcel", 25)?;
      ...
      s.serialize_field("MultiSweepPresetNameMaxLengthKr", &self.MultiSweepPresetNameMaxLengthKr())?;
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> ConstStrategyExcelBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn add_MultiSweepPresetNameMaxLengthKr(&mut self, MultiSweepPresetNameMaxLengthKr: i32) {
    self.fbb_.push_slot::<i32>(ConstStrategyExcel::VT_MULTISWEEPPRESETNAMEMAXLENGTHKR, MultiSweepPresetNameMaxLengthKr, 0);
  }
  #[inline]
...
impl core::fmt::Debug for ConstStrategyExcel<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("ConstStrategyExcel");
      ...
      ds.field("MultiSweepPresetNameMaxLengthKr", &self.MultiSweepPresetNameMaxLengthKr());
