...
impl<'a> EmblemExcel<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    let key = table_encryption_service::create_key(b"Emblem");
      ...
      if let Some(x) = args.EmblemBGPathTw {
        let x = if table_encryption_service::use_encryption() { _fbb.create_string(&table_encryption_service::new_encrypt_string(&x, &key).unwrap()) } else { _fbb.create_string(&x) };
        builder.add_EmblemBGPathTw(x);
      }
      if let Some(x) = args.EmblemBGPathTh {
        let x = if table_encryption_service::use_encryption() { _fbb.create_string(&table_encryption_service::new_encrypt_string(&x, &key).unwrap()) } else { _fbb.create_string(&x) };
        builder.add_EmblemBGPathTh(x);
      }
  ...
  pub fn unpack(&self) -> EmblemExcelT {
    ...
    let EmblemBGPathTh = self.EmblemBGPathTh().map(|x| {
      if table_encryption_service::use_encryption() { table_encryption_service::convert_string(&x, &key).unwrap() } else { x.to_string() }
    });
    let EmblemBGPathTw = self.EmblemBGPathTw().map(|x| {
      if table_encryption_service::use_encryption() { table_encryption_service::convert_string(&x, &key).unwrap() } else { x.to_string() }
    });
    let EmblemBGPathEn = self.EmblemBGPathEn().map(|x| {
      ...
      let DisplayType = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.DisplayType(), &key)
      } else {
        self.DisplayType()
      };
    ...
    let DisplayEndDate = self.DisplayEndDate().map(|x| {
      ...
      let CheckPassType = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.CheckPassType(), &key)
      } else {
        self.CheckPassType()
      };
  ...
  #[inline]
  pub fn EmblemBGPathTh(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(EmblemExcel::VT_EMBLEMBGPATHTH, None)}
  }
  #[inline]
  pub fn EmblemBGPathTw(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(EmblemExcel::VT_EMBLEMBGPATHTW, None)}
  }
  #[inline]
  pub fn EmblemBGPathEn(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
...
impl Serialize for EmblemExcel<'_> {
    ...
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("EmblemExcel", 24)?;
      ...
      if let Some(f) = self.EmblemBGPathTh() {
        s.serialize_field("EmblemBGPathTh", &f)?;
      } else {
        s.skip_field("EmblemBGPathTh")?;
      }
      if let Some(f) = self.EmblemBGPathTw() {
        s.serialize_field("EmblemBGPathTw", &f)?;
      } else {
        s.skip_field("EmblemBGPathTw")?;
      }
      if let Some(f) = self.EmblemBGPathEn() {
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> EmblemExcelBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn add_EmblemBGPathTh(&mut self, EmblemBGPathTh: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(EmblemExcel::VT_EMBLEMBGPATHTH, EmblemBGPathTh);
  }
  #[inline]
  pub fn add_EmblemBGPathTw(&mut self, EmblemBGPathTw: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(EmblemExcel::VT_EMBLEMBGPATHTW, EmblemBGPathTw);
  }
  #[inline]
  pub fn add_EmblemBGPathEn(&mut self, EmblemBGPathEn: flatbuffers::WIPOffset<&'b  str>) {
...
impl EmblemExcelT {
  pub fn pack<'b, A: flatbuffers::Allocator + 'b>(
    ...
    let EmblemBGPathTh = self.EmblemBGPathTh.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let EmblemBGPathTw = self.EmblemBGPathTw.as_ref().map(|x|{
      _fbb.create_string(x)
    });
