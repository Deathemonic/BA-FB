...
impl<'a> CharacterExcel<'a> {
  ...
  pub const VT_ISAIRUNIT: flatbuffers::VOffsetT = 116;
  pub const VT_AIRUNITHEIGHT: flatbuffers::VOffsetT = 118;
  pub const VT_TAGS: flatbuffers::VOffsetT = 120;
  pub const VT_SECRETSTONEITEMID: flatbuffers::VOffsetT = 122;
  pub const VT_SECRETSTONEITEMAMOUNT: flatbuffers::VOffsetT = 124;
  pub const VT_CHARACTERPIECEITEMID: flatbuffers::VOffsetT = 126;
  pub const VT_CHARACTERPIECEITEMAMOUNT: flatbuffers::VOffsetT = 128;
  pub const VT_COMBINERECIPEID: flatbuffers::VOffsetT = 130;
  ...
  pub fn unpack(&self) -> CharacterExcelT {
    ...
    let CollectionVisibleEndDate = self.CollectionVisibleEndDate().map(|x| {
      ...
      let TacticEntityType = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.TacticEntityType(), &key)
      } else {
      ...
      let TacticRole = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.TacticRole(), &key)
      } else {
        self.TacticRole()
      };
      let WeaponType = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.WeaponType(), &key)
      } else {
        self.WeaponType()
      };
      let TacticRange = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.TacticRange(), &key)
      } else {
        self.TacticRange()
      };
      let BulletType = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.BulletType(), &key)
      } else {
        self.BulletType()
      };
      let ArmorType = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.ArmorType(), &key)
      } else {
        self.ArmorType()
      };
      let AimIKType = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.AimIKType(), &key)
      } else {
        self.AimIKType()
      };
      let School = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.School(), &key)
      } else {
        self.School()
      };
      let Club = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.Club(), &key)
      } else {
        self.Club()
      };
      ...
      let SquadType = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.SquadType(), &key)
      } else {
        self.SquadType()
      };
...
impl Serialize for CharacterExcel<'_> {
  ...
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("CharacterExcel", 64)?;
