...
impl<'a> ProductBattlePassExcel<'a> {
  ...
  pub const VT_PURCHASECOUNTLIMIT: flatbuffers::VOffsetT = 14;
  pub const VT_BATTLEPASSPRODUCTGROUPID: flatbuffers::VOffsetT = 16;
  pub const VT_PARCELTYPE: flatbuffers::VOffsetT = 18;
  pub const VT_PARCELID: flatbuffers::VOffsetT = 20;
  pub const VT_PARCELAMOUNT: flatbuffers::VOffsetT = 22;
  ...
  pub fn TeenProductId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(ProductBattlePassExcel::VT_TEENPRODUCTID, None)}
  }
  #[inline]
...
impl Serialize for ProductBattlePassExcel<'_> {
  ...
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("ProductBattlePassExcel", 10)?;
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> ProductBattlePassExcelBuilder<'a, 'b, A> {
  ...
  pub fn add_TeenProductId(&mut self, TeenProductId: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(ProductBattlePassExcel::VT_TEENPRODUCTID, TeenProductId);
  }
  #[inline]
