...
impl<'a> CharacterDialogExcel<'a> {
  ...
  pub const VT_APPLYPOSITION: flatbuffers::VOffsetT = 46;
  pub const VT_POSX: flatbuffers::VOffsetT = 48;
  pub const VT_POSY: flatbuffers::VOffsetT = 50;
  pub const VT_COLLECTIONVISIBLE: flatbuffers::VOffsetT = 52;
  pub const VT_CVCOLLECTIONTYPE: flatbuffers::VOffsetT = 54;
  pub const VT_UNLOCKFAVORRANK: flatbuffers::VOffsetT = 56;
  pub const VT_UNLOCKEQUIPWEAPON: flatbuffers::VOffsetT = 58;
  pub const VT_LOCALIZECVGROUP: flatbuffers::VOffsetT = 60;
  pub const VT_TEENMODE: flatbuffers::VOffsetT = 62;
  ...
  pub fn unpack(&self) -> CharacterDialogExcelT {
    let key = table_encryption_service::create_key(b"CharacterDialog");
      ...
      let Anniversary = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.Anniversary(), &key)
      } else {
        self.Anniversary()
      };
  ...
  pub fn DurationKr(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(CharacterDialogExcel::VT_DURATIONKR, Some(0)).unwrap()}
  }
  #[inline]
  ...
  pub fn LocalizeTH(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(CharacterDialogExcel::VT_LOCALIZETH, None)}
  }
  #[inline]
  pub fn LocalizeTW(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(CharacterDialogExcel::VT_LOCALIZETW, None)}
  }
  #[inline]
  pub fn LocalizeEN(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(CharacterDialogExcel::VT_LOCALIZEEN, None)}
  }
  #[inline]
  ...
  pub fn TeenMode(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(CharacterDialogExcel::VT_TEENMODE, Some(false)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> CharacterDialogExcelBuilder<'a, 'b, A> {
  ...
  pub fn add_DurationKr(&mut self, DurationKr: i64) {
    self.fbb_.push_slot::<i64>(CharacterDialogExcel::VT_DURATIONKR, DurationKr, 0);
  }
  #[inline]
  ...
  pub fn add_LocalizeTH(&mut self, LocalizeTH: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(CharacterDialogExcel::VT_LOCALIZETH, LocalizeTH);
  }
  #[inline]
  pub fn add_LocalizeTW(&mut self, LocalizeTW: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(CharacterDialogExcel::VT_LOCALIZETW, LocalizeTW);
  }
  #[inline]
  pub fn add_LocalizeEN(&mut self, LocalizeEN: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(CharacterDialogExcel::VT_LOCALIZEEN, LocalizeEN);
  }
  #[inline]
  ...
  pub fn add_TeenMode(&mut self, TeenMode: bool) {
    self.fbb_.push_slot::<bool>(CharacterDialogExcel::VT_TEENMODE, TeenMode, false);
  }
  #[inline]
