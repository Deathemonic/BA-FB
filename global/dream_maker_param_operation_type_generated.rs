...
pub const ENUM_MIN_DREAM_MAKER_PARAM_OPERATION_TYPE: i32 = 0;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_DREAM_MAKER_PARAM_OPERATION_TYPE: i32 = 4;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_DREAM_MAKER_PARAM_OPERATION_TYPE: [DreamMakerParamOperationType; 5] = [
  DreamMakerParamOperationType::None,
  DreamMakerParamOperationType::GrowUpHigh,
  DreamMakerParamOperationType::GrowUp,
  DreamMakerParamOperationType::GrowDownHigh,
  DreamMakerParamOperationType::GrowDown,
];
...
impl Serialize for DreamMakerParamOperationType {
  ...
  where
    S: Serializer,
  {
    serializer.serialize_unit_variant("DreamMakerParamOperationType", self.0 as u32, self.variant_name().unwrap())
  }
}
