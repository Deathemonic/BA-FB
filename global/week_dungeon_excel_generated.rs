  ...
  pub fn unpack(&self) -> WeekDungeonExcelT {
    let key = table_encryption_service::create_key(b"WeekDungeon");
      ...
      let WeekDungeonType = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.WeekDungeonType(), &key)
      } else {
    ...
    let starGoalAmount = self.starGoalAmount().map(|x| {
      ...
      let StageTopography = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.StageTopography(), &key)
      } else {
    ...
    let groupBuffID = self.groupBuffID().map(|x| {
      ...
      let EchelonExtensionType = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.EchelonExtensionType(), &key)
      } else {
