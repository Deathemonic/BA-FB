...
pub const ENUM_MIN_CURRENCY_ADDITIONAL_CHARGE_TYPE: i32 = 0;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_CURRENCY_ADDITIONAL_CHARGE_TYPE: i32 = 1;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_CURRENCY_ADDITIONAL_CHARGE_TYPE: [CurrencyAdditionalChargeType; 2] = [
  CurrencyAdditionalChargeType::EnableAutoChargeOverLimit,
  CurrencyAdditionalChargeType::DisableAutoChargeOverLimit,
];
...
impl Serialize for CurrencyAdditionalChargeType {
  ...
  where
    S: Serializer,
  {
    serializer.serialize_unit_variant("CurrencyAdditionalChargeType", self.0 as u32, self.variant_name().unwrap())
  }
}
