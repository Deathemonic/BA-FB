...
impl<'a> CharacterWeaponExcel<'a> {
  ...
  pub const VT_UNLOCK: flatbuffers::VOffsetT = 26;
  pub const VT_RECIPEID: flatbuffers::VOffsetT = 28;
  pub const VT_MAXLEVEL: flatbuffers::VOffsetT = 30;
  pub const VT_LEARNSKILLSLOT: flatbuffers::VOffsetT = 32;
  pub const VT_STATTYPE: flatbuffers::VOffsetT = 34;
  pub const VT_STATVALUE: flatbuffers::VOffsetT = 36;
  ...
  pub fn tags(&self) -> Option<flatbuffers::Vector<'a, Tag>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, Tag>>>(CharacterWeaponExcel::VT_TAGS, None)}
  }
  #[inline]
...
impl Serialize for CharacterWeaponExcel<'_> {
  ...
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("CharacterWeaponExcel", 17)?;
