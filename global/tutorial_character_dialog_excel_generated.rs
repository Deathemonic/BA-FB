...
impl<'a> TutorialCharacterDialogExcel<'a> {
  ...
  pub const VT_LOCALIZETH: flatbuffers::VOffsetT = 12;
  pub const VT_LOCALIZETW: flatbuffers::VOffsetT = 14;
  pub const VT_LOCALIZEEN: flatbuffers::VOffsetT = 16;
  pub const VT_VOICEID: flatbuffers::VOffsetT = 18;
  ...
  pub fn LocalizeTH(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(TutorialCharacterDialogExcel::VT_LOCALIZETH, None)}
  }
  #[inline]
  pub fn LocalizeTW(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(TutorialCharacterDialogExcel::VT_LOCALIZETW, None)}
  }
  #[inline]
  pub fn LocalizeEN(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(TutorialCharacterDialogExcel::VT_LOCALIZEEN, None)}
  }
  #[inline]
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> TutorialCharacterDialogExcelBuilder<'a, 'b, A> {
  ...
  pub fn add_LocalizeTH(&mut self, LocalizeTH: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(TutorialCharacterDialogExcel::VT_LOCALIZETH, LocalizeTH);
  }
  #[inline]
  pub fn add_LocalizeTW(&mut self, LocalizeTW: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(TutorialCharacterDialogExcel::VT_LOCALIZETW, LocalizeTW);
  }
  #[inline]
  pub fn add_LocalizeEN(&mut self, LocalizeEN: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(TutorialCharacterDialogExcel::VT_LOCALIZEEN, LocalizeEN);
  }
  #[inline]
