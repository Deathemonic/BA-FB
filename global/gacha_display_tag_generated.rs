...
pub const ENUM_VALUES_GACHA_DISPLAY_TAG: [GachaDisplayTag; 9] = [
  ...
  GachaDisplayTag::ThreeStar,
  GachaDisplayTag::Free,
  GachaDisplayTag::New,
  GachaDisplayTag::Fes,
...
#[repr(transparent)]
pub struct GachaDisplayTag(pub i32);
#[allow(non_upper_case_globals)]
impl GachaDisplayTag {
  pub const None: Self = Self(0);
  pub const Limited: Self = Self(1);
  pub const TwoStar: Self = Self(2);
  pub const ThreeStar: Self = Self(3);
...
impl core::fmt::Debug for GachaDisplayTag {
...
impl Serialize for GachaDisplayTag {
  fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
  where
    S: Serializer,
  {
    serializer.serialize_unit_variant("GachaDisplayTag", self.0 as u32, self.variant_name().unwrap())
  }
}

impl<'a> flatbuffers::Follow<'a> for GachaDisplayTag {
  type Inner = Self;
  #[inline]
...
impl flatbuffers::Push for GachaDisplayTag {
    type Output = GachaDisplayTag;
    #[inline]
...
impl flatbuffers::EndianScalar for GachaDisplayTag {
  type Scalar = i32;
  #[inline]
...
impl<'a> flatbuffers::Verifiable for GachaDisplayTag {
  #[inline]
  fn run_verifier(
...
impl flatbuffers::SimpleToVerifyInSlice for GachaDisplayTag {}
