...
impl<'a> ConstCombatExcel<'a> {
  ...
  pub const VT_WORLDBOSSBATTLELITTLETW: flatbuffers::VOffsetT = 126;
  pub const VT_WORLDBOSSBATTLELITTLEASIA: flatbuffers::VOffsetT = 128;
  pub const VT_WORLDBOSSBATTLELITTLENA: flatbuffers::VOffsetT = 130;
  pub const VT_WORLDBOSSBATTLELITTLEGLOBAL: flatbuffers::VOffsetT = 132;
  pub const VT_WORLDBOSSBATTLEMIDDLE: flatbuffers::VOffsetT = 134;
  pub const VT_WORLDBOSSBATTLEMIDDLETW: flatbuffers::VOffsetT = 136;
  pub const VT_WORLDBOSSBATTLEMIDDLEASIA: flatbuffers::VOffsetT = 138;
  pub const VT_WORLDBOSSBATTLEMIDDLENA: flatbuffers::VOffsetT = 140;
  pub const VT_WORLDBOSSBATTLEMIDDLEGLOBAL: flatbuffers::VOffsetT = 142;
  pub const VT_WORLDBOSSBATTLEHIGH: flatbuffers::VOffsetT = 144;
  pub const VT_WORLDBOSSBATTLEHIGHTW: flatbuffers::VOffsetT = 146;
  pub const VT_WORLDBOSSBATTLEHIGHASIA: flatbuffers::VOffsetT = 148;
  pub const VT_WORLDBOSSBATTLEHIGHNA: flatbuffers::VOffsetT = 150;
  pub const VT_WORLDBOSSBATTLEHIGHGLOBAL: flatbuffers::VOffsetT = 152;
  pub const VT_WORLDBOSSBATTLEVERYHIGH: flatbuffers::VOffsetT = 154;
  pub const VT_WORLDBOSSBATTLEVERYHIGHTW: flatbuffers::VOffsetT = 156;
  pub const VT_WORLDBOSSBATTLEVERYHIGHASIA: flatbuffers::VOffsetT = 158;
  pub const VT_WORLDBOSSBATTLEVERYHIGHNA: flatbuffers::VOffsetT = 160;
  pub const VT_WORLDBOSSBATTLEVERYHIGHGLOBAL: flatbuffers::VOffsetT = 162;
  pub const VT_WORLDRAIDAUTOSYNCTERMSECOND: flatbuffers::VOffsetT = 164;
  pub const VT_WORLDRAIDBOSSHPDECREASETERM: flatbuffers::VOffsetT = 166;
  pub const VT_WORLDRAIDBOSSPARCELREACTIONDELAY: flatbuffers::VOffsetT = 168;
  pub const VT_RAIDRANKINGJUMPMINIMUMWAITINGTIME: flatbuffers::VOffsetT = 170;
  pub const VT_EFFECTTELEPORTDISTANCE: flatbuffers::VOffsetT = 172;
  pub const VT_AURAEXITTHRESHOLDMARGIN: flatbuffers::VOffsetT = 174;
  pub const VT_TSAINTERACTIONDAMAGEFACTOR: flatbuffers::VOffsetT = 176;
  pub const VT_VICTORYINTERACTIONRATE: flatbuffers::VOffsetT = 178;
  pub const VT_ECHELONEXTENSIONENGAGETIMELINEPATH: flatbuffers::VOffsetT = 180;
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    let key = table_encryption_service::create_key(b"ConstCombat");
      ...
      let x = args.WORLDBOSSBATTLEVERYHIGHGlobal;
      let x = if table_encryption_service::use_encryption() { table_encryption_service::convert_long(x, &key) } else { x };
      builder.add_WORLDBOSSBATTLEVERYHIGHGlobal(x);
      let x = args.WORLDBOSSBATTLEVERYHIGHNa;
      let x = if table_encryption_service::use_encryption() { table_encryption_service::convert_long(x, &key) } else { x };
      builder.add_WORLDBOSSBATTLEVERYHIGHNa(x);
      let x = args.WORLDBOSSBATTLEVERYHIGHAsia;
      let x = if table_encryption_service::use_encryption() { table_encryption_service::convert_long(x, &key) } else { x };
      builder.add_WORLDBOSSBATTLEVERYHIGHAsia(x);
      let x = args.WORLDBOSSBATTLEVERYHIGHTw;
      let x = if table_encryption_service::use_encryption() { table_encryption_service::convert_long(x, &key) } else { x };
      builder.add_WORLDBOSSBATTLEVERYHIGHTw(x);
      let x = args.WORLDBOSSBATTLEVERYHIGH;
      let x = if table_encryption_service::use_encryption() { table_encryption_service::convert_long(x, &key) } else { x };
      builder.add_WORLDBOSSBATTLEVERYHIGH(x);
      let x = args.WORLDBOSSBATTLEHIGHGlobal;
      let x = if table_encryption_service::use_encryption() { table_encryption_service::convert_long(x, &key) } else { x };
      builder.add_WORLDBOSSBATTLEHIGHGlobal(x);
      let x = args.WORLDBOSSBATTLEHIGHNa;
      let x = if table_encryption_service::use_encryption() { table_encryption_service::convert_long(x, &key) } else { x };
      builder.add_WORLDBOSSBATTLEHIGHNa(x);
      let x = args.WORLDBOSSBATTLEHIGHAsia;
      let x = if table_encryption_service::use_encryption() { table_encryption_service::convert_long(x, &key) } else { x };
      builder.add_WORLDBOSSBATTLEHIGHAsia(x);
      let x = args.WORLDBOSSBATTLEHIGHTw;
      let x = if table_encryption_service::use_encryption() { table_encryption_service::convert_long(x, &key) } else { x };
      builder.add_WORLDBOSSBATTLEHIGHTw(x);
      let x = args.WORLDBOSSBATTLEHIGH;
      let x = if table_encryption_service::use_encryption() { table_encryption_service::convert_long(x, &key) } else { x };
      builder.add_WORLDBOSSBATTLEHIGH(x);
      let x = args.WORLDBOSSBATTLEMIDDLEGlobal;
      let x = if table_encryption_service::use_encryption() { table_encryption_service::convert_long(x, &key) } else { x };
      builder.add_WORLDBOSSBATTLEMIDDLEGlobal(x);
      let x = args.WORLDBOSSBATTLEMIDDLENa;
      let x = if table_encryption_service::use_encryption() { table_encryption_service::convert_long(x, &key) } else { x };
      builder.add_WORLDBOSSBATTLEMIDDLENa(x);
      let x = args.WORLDBOSSBATTLEMIDDLEAsia;
      let x = if table_encryption_service::use_encryption() { table_encryption_service::convert_long(x, &key) } else { x };
      builder.add_WORLDBOSSBATTLEMIDDLEAsia(x);
      let x = args.WORLDBOSSBATTLEMIDDLETw;
      let x = if table_encryption_service::use_encryption() { table_encryption_service::convert_long(x, &key) } else { x };
      builder.add_WORLDBOSSBATTLEMIDDLETw(x);
      let x = args.WORLDBOSSBATTLEMIDDLE;
      let x = if table_encryption_service::use_encryption() { table_encryption_service::convert_long(x, &key) } else { x };
      builder.add_WORLDBOSSBATTLEMIDDLE(x);
      let x = args.WORLDBOSSBATTLELITTLEGlobal;
      let x = if table_encryption_service::use_encryption() { table_encryption_service::convert_long(x, &key) } else { x };
      builder.add_WORLDBOSSBATTLELITTLEGlobal(x);
      let x = args.WORLDBOSSBATTLELITTLENa;
      let x = if table_encryption_service::use_encryption() { table_encryption_service::convert_long(x, &key) } else { x };
      builder.add_WORLDBOSSBATTLELITTLENa(x);
      let x = args.WORLDBOSSBATTLELITTLEAsia;
      let x = if table_encryption_service::use_encryption() { table_encryption_service::convert_long(x, &key) } else { x };
      builder.add_WORLDBOSSBATTLELITTLEAsia(x);
      let x = args.WORLDBOSSBATTLELITTLETw;
      let x = if table_encryption_service::use_encryption() { table_encryption_service::convert_long(x, &key) } else { x };
      builder.add_WORLDBOSSBATTLELITTLETw(x);
  ...
  pub fn unpack(&self) -> ConstCombatExcelT {
    ...
    let EliminateRaidOpenScenarioId = self.EliminateRaidOpenScenarioId().map(|x| {
      ...
      let WORLDBOSSBATTLELITTLETw = self.WORLDBOSSBATTLELITTLETw();
      let WORLDBOSSBATTLELITTLEAsia = self.WORLDBOSSBATTLELITTLEAsia();
      let WORLDBOSSBATTLELITTLENa = self.WORLDBOSSBATTLELITTLENa();
      let WORLDBOSSBATTLELITTLEGlobal = self.WORLDBOSSBATTLELITTLEGlobal();
      let WORLDBOSSBATTLEMIDDLE = self.WORLDBOSSBATTLEMIDDLE();
      let WORLDBOSSBATTLEMIDDLETw = self.WORLDBOSSBATTLEMIDDLETw();
      let WORLDBOSSBATTLEMIDDLEAsia = self.WORLDBOSSBATTLEMIDDLEAsia();
      let WORLDBOSSBATTLEMIDDLENa = self.WORLDBOSSBATTLEMIDDLENa();
      let WORLDBOSSBATTLEMIDDLEGlobal = self.WORLDBOSSBATTLEMIDDLEGlobal();
      let WORLDBOSSBATTLEHIGH = self.WORLDBOSSBATTLEHIGH();
      let WORLDBOSSBATTLEHIGHTw = self.WORLDBOSSBATTLEHIGHTw();
      let WORLDBOSSBATTLEHIGHAsia = self.WORLDBOSSBATTLEHIGHAsia();
      let WORLDBOSSBATTLEHIGHNa = self.WORLDBOSSBATTLEHIGHNa();
      let WORLDBOSSBATTLEHIGHGlobal = self.WORLDBOSSBATTLEHIGHGlobal();
      let WORLDBOSSBATTLEVERYHIGH = self.WORLDBOSSBATTLEVERYHIGH();
      let WORLDBOSSBATTLEVERYHIGHTw = self.WORLDBOSSBATTLEVERYHIGHTw();
      let WORLDBOSSBATTLEVERYHIGHAsia = self.WORLDBOSSBATTLEVERYHIGHAsia();
      let WORLDBOSSBATTLEVERYHIGHNa = self.WORLDBOSSBATTLEVERYHIGHNa();
      let WORLDBOSSBATTLEVERYHIGHGlobal = self.WORLDBOSSBATTLEVERYHIGHGlobal();
    ...
    ConstCombatExcelT {
      ...
      WORLDBOSSBATTLELITTLETw,
      WORLDBOSSBATTLELITTLEAsia,
      WORLDBOSSBATTLELITTLENa,
      WORLDBOSSBATTLELITTLEGlobal,
      WORLDBOSSBATTLEMIDDLE,
      WORLDBOSSBATTLEMIDDLETw,
      WORLDBOSSBATTLEMIDDLEAsia,
      WORLDBOSSBATTLEMIDDLENa,
      WORLDBOSSBATTLEMIDDLEGlobal,
      WORLDBOSSBATTLEHIGH,
      WORLDBOSSBATTLEHIGHTw,
      WORLDBOSSBATTLEHIGHAsia,
      WORLDBOSSBATTLEHIGHNa,
      WORLDBOSSBATTLEHIGHGlobal,
      WORLDBOSSBATTLEVERYHIGH,
      WORLDBOSSBATTLEVERYHIGHTw,
      WORLDBOSSBATTLEVERYHIGHAsia,
      WORLDBOSSBATTLEVERYHIGHNa,
      WORLDBOSSBATTLEVERYHIGHGlobal,
  ...
  #[inline]
  pub fn WORLDBOSSBATTLELITTLETw(&self) -> i64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(ConstCombatExcel::VT_WORLDBOSSBATTLELITTLETW, Some(0)).unwrap()}
  }
  #[inline]
  pub fn WORLDBOSSBATTLELITTLEAsia(&self) -> i64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(ConstCombatExcel::VT_WORLDBOSSBATTLELITTLEASIA, Some(0)).unwrap()}
  }
  #[inline]
  pub fn WORLDBOSSBATTLELITTLENa(&self) -> i64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(ConstCombatExcel::VT_WORLDBOSSBATTLELITTLENA, Some(0)).unwrap()}
  }
  #[inline]
  pub fn WORLDBOSSBATTLELITTLEGlobal(&self) -> i64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(ConstCombatExcel::VT_WORLDBOSSBATTLELITTLEGLOBAL, Some(0)).unwrap()}
  }
  #[inline]
  ...
  #[inline]
  pub fn WORLDBOSSBATTLEMIDDLETw(&self) -> i64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(ConstCombatExcel::VT_WORLDBOSSBATTLEMIDDLETW, Some(0)).unwrap()}
  }
  #[inline]
  pub fn WORLDBOSSBATTLEMIDDLEAsia(&self) -> i64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(ConstCombatExcel::VT_WORLDBOSSBATTLEMIDDLEASIA, Some(0)).unwrap()}
  }
  #[inline]
  pub fn WORLDBOSSBATTLEMIDDLENa(&self) -> i64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(ConstCombatExcel::VT_WORLDBOSSBATTLEMIDDLENA, Some(0)).unwrap()}
  }
  #[inline]
  pub fn WORLDBOSSBATTLEMIDDLEGlobal(&self) -> i64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(ConstCombatExcel::VT_WORLDBOSSBATTLEMIDDLEGLOBAL, Some(0)).unwrap()}
  }
  #[inline]
  ...
  #[inline]
  pub fn WORLDBOSSBATTLEHIGHTw(&self) -> i64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(ConstCombatExcel::VT_WORLDBOSSBATTLEHIGHTW, Some(0)).unwrap()}
  }
  #[inline]
  pub fn WORLDBOSSBATTLEHIGHAsia(&self) -> i64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(ConstCombatExcel::VT_WORLDBOSSBATTLEHIGHASIA, Some(0)).unwrap()}
  }
  #[inline]
  pub fn WORLDBOSSBATTLEHIGHNa(&self) -> i64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(ConstCombatExcel::VT_WORLDBOSSBATTLEHIGHNA, Some(0)).unwrap()}
  }
  #[inline]
  pub fn WORLDBOSSBATTLEHIGHGlobal(&self) -> i64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(ConstCombatExcel::VT_WORLDBOSSBATTLEHIGHGLOBAL, Some(0)).unwrap()}
  }
  #[inline]
  ...
  #[inline]
  pub fn WORLDBOSSBATTLEVERYHIGHTw(&self) -> i64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(ConstCombatExcel::VT_WORLDBOSSBATTLEVERYHIGHTW, Some(0)).unwrap()}
  }
  #[inline]
  pub fn WORLDBOSSBATTLEVERYHIGHAsia(&self) -> i64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(ConstCombatExcel::VT_WORLDBOSSBATTLEVERYHIGHASIA, Some(0)).unwrap()}
  }
  #[inline]
  pub fn WORLDBOSSBATTLEVERYHIGHNa(&self) -> i64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(ConstCombatExcel::VT_WORLDBOSSBATTLEVERYHIGHNA, Some(0)).unwrap()}
  }
  #[inline]
  pub fn WORLDBOSSBATTLEVERYHIGHGlobal(&self) -> i64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(ConstCombatExcel::VT_WORLDBOSSBATTLEVERYHIGHGLOBAL, Some(0)).unwrap()}
  }
  #[inline]
...
impl flatbuffers::Verifiable for ConstCombatExcel<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<i64>("WORLDBOSSBATTLELITTLETw", Self::VT_WORLDBOSSBATTLELITTLETW, false)?
     .visit_field::<i64>("WORLDBOSSBATTLELITTLEAsia", Self::VT_WORLDBOSSBATTLELITTLEASIA, false)?
     .visit_field::<i64>("WORLDBOSSBATTLELITTLENa", Self::VT_WORLDBOSSBATTLELITTLENA, false)?
     .visit_field::<i64>("WORLDBOSSBATTLELITTLEGlobal", Self::VT_WORLDBOSSBATTLELITTLEGLOBAL, false)?
     .visit_field::<i64>("WORLDBOSSBATTLEMIDDLE", Self::VT_WORLDBOSSBATTLEMIDDLE, false)?
     .visit_field::<i64>("WORLDBOSSBATTLEMIDDLETw", Self::VT_WORLDBOSSBATTLEMIDDLETW, false)?
     .visit_field::<i64>("WORLDBOSSBATTLEMIDDLEAsia", Self::VT_WORLDBOSSBATTLEMIDDLEASIA, false)?
     .visit_field::<i64>("WORLDBOSSBATTLEMIDDLENa", Self::VT_WORLDBOSSBATTLEMIDDLENA, false)?
     .visit_field::<i64>("WORLDBOSSBATTLEMIDDLEGlobal", Self::VT_WORLDBOSSBATTLEMIDDLEGLOBAL, false)?
     .visit_field::<i64>("WORLDBOSSBATTLEHIGH", Self::VT_WORLDBOSSBATTLEHIGH, false)?
     .visit_field::<i64>("WORLDBOSSBATTLEHIGHTw", Self::VT_WORLDBOSSBATTLEHIGHTW, false)?
     .visit_field::<i64>("WORLDBOSSBATTLEHIGHAsia", Self::VT_WORLDBOSSBATTLEHIGHASIA, false)?
     .visit_field::<i64>("WORLDBOSSBATTLEHIGHNa", Self::VT_WORLDBOSSBATTLEHIGHNA, false)?
     .visit_field::<i64>("WORLDBOSSBATTLEHIGHGlobal", Self::VT_WORLDBOSSBATTLEHIGHGLOBAL, false)?
     .visit_field::<i64>("WORLDBOSSBATTLEVERYHIGH", Self::VT_WORLDBOSSBATTLEVERYHIGH, false)?
     .visit_field::<i64>("WORLDBOSSBATTLEVERYHIGHTw", Self::VT_WORLDBOSSBATTLEVERYHIGHTW, false)?
     .visit_field::<i64>("WORLDBOSSBATTLEVERYHIGHAsia", Self::VT_WORLDBOSSBATTLEVERYHIGHASIA, false)?
     .visit_field::<i64>("WORLDBOSSBATTLEVERYHIGHNa", Self::VT_WORLDBOSSBATTLEVERYHIGHNA, false)?
     .visit_field::<i64>("WORLDBOSSBATTLEVERYHIGHGlobal", Self::VT_WORLDBOSSBATTLEVERYHIGHGLOBAL, false)?
...
pub struct ConstCombatExcelArgs<'a> {
    ...
    pub WORLDBOSSBATTLELITTLETw: i64,
    pub WORLDBOSSBATTLELITTLEAsia: i64,
    pub WORLDBOSSBATTLELITTLENa: i64,
    pub WORLDBOSSBATTLELITTLEGlobal: i64,
    pub WORLDBOSSBATTLEMIDDLE: i64,
    pub WORLDBOSSBATTLEMIDDLETw: i64,
    pub WORLDBOSSBATTLEMIDDLEAsia: i64,
    pub WORLDBOSSBATTLEMIDDLENa: i64,
    pub WORLDBOSSBATTLEMIDDLEGlobal: i64,
    pub WORLDBOSSBATTLEHIGH: i64,
    pub WORLDBOSSBATTLEHIGHTw: i64,
    pub WORLDBOSSBATTLEHIGHAsia: i64,
    pub WORLDBOSSBATTLEHIGHNa: i64,
    pub WORLDBOSSBATTLEHIGHGlobal: i64,
    pub WORLDBOSSBATTLEVERYHIGH: i64,
    pub WORLDBOSSBATTLEVERYHIGHTw: i64,
    pub WORLDBOSSBATTLEVERYHIGHAsia: i64,
    pub WORLDBOSSBATTLEVERYHIGHNa: i64,
    pub WORLDBOSSBATTLEVERYHIGHGlobal: i64,
...
impl<'a> Default for ConstCombatExcelArgs<'a> {
  ...
  fn default() -> Self {
    ConstCombatExcelArgs {
      ...
      WORLDBOSSBATTLELITTLETw: 0,
      WORLDBOSSBATTLELITTLEAsia: 0,
      WORLDBOSSBATTLELITTLENa: 0,
      WORLDBOSSBATTLELITTLEGlobal: 0,
      WORLDBOSSBATTLEMIDDLE: 0,
      WORLDBOSSBATTLEMIDDLETw: 0,
      WORLDBOSSBATTLEMIDDLEAsia: 0,
      WORLDBOSSBATTLEMIDDLENa: 0,
      WORLDBOSSBATTLEMIDDLEGlobal: 0,
      WORLDBOSSBATTLEHIGH: 0,
      WORLDBOSSBATTLEHIGHTw: 0,
      WORLDBOSSBATTLEHIGHAsia: 0,
      WORLDBOSSBATTLEHIGHNa: 0,
      WORLDBOSSBATTLEHIGHGlobal: 0,
      WORLDBOSSBATTLEVERYHIGH: 0,
      WORLDBOSSBATTLEVERYHIGHTw: 0,
      WORLDBOSSBATTLEVERYHIGHAsia: 0,
      WORLDBOSSBATTLEVERYHIGHNa: 0,
      WORLDBOSSBATTLEVERYHIGHGlobal: 0,
...
impl Serialize for ConstCombatExcel<'_> {
  ...
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("ConstCombatExcel", 95)?;
      ...
      s.serialize_field("WORLDBOSSBATTLELITTLETw", &self.WORLDBOSSBATTLELITTLETw())?;
      s.serialize_field("WORLDBOSSBATTLELITTLEAsia", &self.WORLDBOSSBATTLELITTLEAsia())?;
      s.serialize_field("WORLDBOSSBATTLELITTLENa", &self.WORLDBOSSBATTLELITTLENa())?;
      s.serialize_field("WORLDBOSSBATTLELITTLEGlobal", &self.WORLDBOSSBATTLELITTLEGlobal())?;
      s.serialize_field("WORLDBOSSBATTLEMIDDLE", &self.WORLDBOSSBATTLEMIDDLE())?;
      s.serialize_field("WORLDBOSSBATTLEMIDDLETw", &self.WORLDBOSSBATTLEMIDDLETw())?;
      s.serialize_field("WORLDBOSSBATTLEMIDDLEAsia", &self.WORLDBOSSBATTLEMIDDLEAsia())?;
      s.serialize_field("WORLDBOSSBATTLEMIDDLENa", &self.WORLDBOSSBATTLEMIDDLENa())?;
      s.serialize_field("WORLDBOSSBATTLEMIDDLEGlobal", &self.WORLDBOSSBATTLEMIDDLEGlobal())?;
      s.serialize_field("WORLDBOSSBATTLEHIGH", &self.WORLDBOSSBATTLEHIGH())?;
      s.serialize_field("WORLDBOSSBATTLEHIGHTw", &self.WORLDBOSSBATTLEHIGHTw())?;
      s.serialize_field("WORLDBOSSBATTLEHIGHAsia", &self.WORLDBOSSBATTLEHIGHAsia())?;
      s.serialize_field("WORLDBOSSBATTLEHIGHNa", &self.WORLDBOSSBATTLEHIGHNa())?;
      s.serialize_field("WORLDBOSSBATTLEHIGHGlobal", &self.WORLDBOSSBATTLEHIGHGlobal())?;
      s.serialize_field("WORLDBOSSBATTLEVERYHIGH", &self.WORLDBOSSBATTLEVERYHIGH())?;
      s.serialize_field("WORLDBOSSBATTLEVERYHIGHTw", &self.WORLDBOSSBATTLEVERYHIGHTw())?;
      s.serialize_field("WORLDBOSSBATTLEVERYHIGHAsia", &self.WORLDBOSSBATTLEVERYHIGHAsia())?;
      s.serialize_field("WORLDBOSSBATTLEVERYHIGHNa", &self.WORLDBOSSBATTLEVERYHIGHNa())?;
      s.serialize_field("WORLDBOSSBATTLEVERYHIGHGlobal", &self.WORLDBOSSBATTLEVERYHIGHGlobal())?;
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> ConstCombatExcelBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn add_WORLDBOSSBATTLELITTLETw(&mut self, WORLDBOSSBATTLELITTLETw: i64) {
    self.fbb_.push_slot::<i64>(ConstCombatExcel::VT_WORLDBOSSBATTLELITTLETW, WORLDBOSSBATTLELITTLETw, 0);
  }
  #[inline]
  pub fn add_WORLDBOSSBATTLELITTLEAsia(&mut self, WORLDBOSSBATTLELITTLEAsia: i64) {
    self.fbb_.push_slot::<i64>(ConstCombatExcel::VT_WORLDBOSSBATTLELITTLEASIA, WORLDBOSSBATTLELITTLEAsia, 0);
  }
  #[inline]
  pub fn add_WORLDBOSSBATTLELITTLENa(&mut self, WORLDBOSSBATTLELITTLENa: i64) {
    self.fbb_.push_slot::<i64>(ConstCombatExcel::VT_WORLDBOSSBATTLELITTLENA, WORLDBOSSBATTLELITTLENa, 0);
  }
  #[inline]
  pub fn add_WORLDBOSSBATTLELITTLEGlobal(&mut self, WORLDBOSSBATTLELITTLEGlobal: i64) {
    self.fbb_.push_slot::<i64>(ConstCombatExcel::VT_WORLDBOSSBATTLELITTLEGLOBAL, WORLDBOSSBATTLELITTLEGlobal, 0);
  }
  #[inline]
  ...
  #[inline]
  pub fn add_WORLDBOSSBATTLEMIDDLETw(&mut self, WORLDBOSSBATTLEMIDDLETw: i64) {
    self.fbb_.push_slot::<i64>(ConstCombatExcel::VT_WORLDBOSSBATTLEMIDDLETW, WORLDBOSSBATTLEMIDDLETw, 0);
  }
  #[inline]
  pub fn add_WORLDBOSSBATTLEMIDDLEAsia(&mut self, WORLDBOSSBATTLEMIDDLEAsia: i64) {
    self.fbb_.push_slot::<i64>(ConstCombatExcel::VT_WORLDBOSSBATTLEMIDDLEASIA, WORLDBOSSBATTLEMIDDLEAsia, 0);
  }
  #[inline]
  pub fn add_WORLDBOSSBATTLEMIDDLENa(&mut self, WORLDBOSSBATTLEMIDDLENa: i64) {
    self.fbb_.push_slot::<i64>(ConstCombatExcel::VT_WORLDBOSSBATTLEMIDDLENA, WORLDBOSSBATTLEMIDDLENa, 0);
  }
  #[inline]
  pub fn add_WORLDBOSSBATTLEMIDDLEGlobal(&mut self, WORLDBOSSBATTLEMIDDLEGlobal: i64) {
    self.fbb_.push_slot::<i64>(ConstCombatExcel::VT_WORLDBOSSBATTLEMIDDLEGLOBAL, WORLDBOSSBATTLEMIDDLEGlobal, 0);
  }
  #[inline]
  ...
  #[inline]
  pub fn add_WORLDBOSSBATTLEHIGHTw(&mut self, WORLDBOSSBATTLEHIGHTw: i64) {
    self.fbb_.push_slot::<i64>(ConstCombatExcel::VT_WORLDBOSSBATTLEHIGHTW, WORLDBOSSBATTLEHIGHTw, 0);
  }
  #[inline]
  pub fn add_WORLDBOSSBATTLEHIGHAsia(&mut self, WORLDBOSSBATTLEHIGHAsia: i64) {
    self.fbb_.push_slot::<i64>(ConstCombatExcel::VT_WORLDBOSSBATTLEHIGHASIA, WORLDBOSSBATTLEHIGHAsia, 0);
  }
  #[inline]
  pub fn add_WORLDBOSSBATTLEHIGHNa(&mut self, WORLDBOSSBATTLEHIGHNa: i64) {
    self.fbb_.push_slot::<i64>(ConstCombatExcel::VT_WORLDBOSSBATTLEHIGHNA, WORLDBOSSBATTLEHIGHNa, 0);
  }
  #[inline]
  pub fn add_WORLDBOSSBATTLEHIGHGlobal(&mut self, WORLDBOSSBATTLEHIGHGlobal: i64) {
    self.fbb_.push_slot::<i64>(ConstCombatExcel::VT_WORLDBOSSBATTLEHIGHGLOBAL, WORLDBOSSBATTLEHIGHGlobal, 0);
  }
  #[inline]
  ...
  #[inline]
  pub fn add_WORLDBOSSBATTLEVERYHIGHTw(&mut self, WORLDBOSSBATTLEVERYHIGHTw: i64) {
    self.fbb_.push_slot::<i64>(ConstCombatExcel::VT_WORLDBOSSBATTLEVERYHIGHTW, WORLDBOSSBATTLEVERYHIGHTw, 0);
  }
  #[inline]
  pub fn add_WORLDBOSSBATTLEVERYHIGHAsia(&mut self, WORLDBOSSBATTLEVERYHIGHAsia: i64) {
    self.fbb_.push_slot::<i64>(ConstCombatExcel::VT_WORLDBOSSBATTLEVERYHIGHASIA, WORLDBOSSBATTLEVERYHIGHAsia, 0);
  }
  #[inline]
  pub fn add_WORLDBOSSBATTLEVERYHIGHNa(&mut self, WORLDBOSSBATTLEVERYHIGHNa: i64) {
    self.fbb_.push_slot::<i64>(ConstCombatExcel::VT_WORLDBOSSBATTLEVERYHIGHNA, WORLDBOSSBATTLEVERYHIGHNa, 0);
  }
  #[inline]
  pub fn add_WORLDBOSSBATTLEVERYHIGHGlobal(&mut self, WORLDBOSSBATTLEVERYHIGHGlobal: i64) {
    self.fbb_.push_slot::<i64>(ConstCombatExcel::VT_WORLDBOSSBATTLEVERYHIGHGLOBAL, WORLDBOSSBATTLEVERYHIGHGlobal, 0);
  }
  #[inline]
...
impl core::fmt::Debug for ConstCombatExcel<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("ConstCombatExcel");
      ...
      ds.field("WORLDBOSSBATTLELITTLETw", &self.WORLDBOSSBATTLELITTLETw());
      ds.field("WORLDBOSSBATTLELITTLEAsia", &self.WORLDBOSSBATTLELITTLEAsia());
      ds.field("WORLDBOSSBATTLELITTLENa", &self.WORLDBOSSBATTLELITTLENa());
      ds.field("WORLDBOSSBATTLELITTLEGlobal", &self.WORLDBOSSBATTLELITTLEGlobal());
      ds.field("WORLDBOSSBATTLEMIDDLE", &self.WORLDBOSSBATTLEMIDDLE());
      ds.field("WORLDBOSSBATTLEMIDDLETw", &self.WORLDBOSSBATTLEMIDDLETw());
      ds.field("WORLDBOSSBATTLEMIDDLEAsia", &self.WORLDBOSSBATTLEMIDDLEAsia());
      ds.field("WORLDBOSSBATTLEMIDDLENa", &self.WORLDBOSSBATTLEMIDDLENa());
      ds.field("WORLDBOSSBATTLEMIDDLEGlobal", &self.WORLDBOSSBATTLEMIDDLEGlobal());
      ds.field("WORLDBOSSBATTLEHIGH", &self.WORLDBOSSBATTLEHIGH());
      ds.field("WORLDBOSSBATTLEHIGHTw", &self.WORLDBOSSBATTLEHIGHTw());
      ds.field("WORLDBOSSBATTLEHIGHAsia", &self.WORLDBOSSBATTLEHIGHAsia());
      ds.field("WORLDBOSSBATTLEHIGHNa", &self.WORLDBOSSBATTLEHIGHNa());
      ds.field("WORLDBOSSBATTLEHIGHGlobal", &self.WORLDBOSSBATTLEHIGHGlobal());
      ds.field("WORLDBOSSBATTLEVERYHIGH", &self.WORLDBOSSBATTLEVERYHIGH());
      ds.field("WORLDBOSSBATTLEVERYHIGHTw", &self.WORLDBOSSBATTLEVERYHIGHTw());
      ds.field("WORLDBOSSBATTLEVERYHIGHAsia", &self.WORLDBOSSBATTLEVERYHIGHAsia());
      ds.field("WORLDBOSSBATTLEVERYHIGHNa", &self.WORLDBOSSBATTLEVERYHIGHNa());
      ds.field("WORLDBOSSBATTLEVERYHIGHGlobal", &self.WORLDBOSSBATTLEVERYHIGHGlobal());
