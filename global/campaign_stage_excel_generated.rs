...
impl<'a> CampaignStageExcel<'a> {
  ...
  pub fn FirstClearFunnelMessage(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(CampaignStageExcel::VT_FIRSTCLEARFUNNELMESSAGE, None)}
  }
  #[inline]
  pub fn FirstClearEventMessage(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
...
impl Serialize for CampaignStageExcel<'_> {
    ...
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("CampaignStageExcel", 32)?;
      ...
      if let Some(f) = self.FirstClearEventMessage() {
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> CampaignStageExcelBuilder<'a, 'b, A> {
  ...
  pub fn add_FirstClearFunnelMessage(&mut self, FirstClearFunnelMessage: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(CampaignStageExcel::VT_FIRSTCLEARFUNNELMESSAGE, FirstClearFunnelMessage);
  }
  #[inline]
  pub fn add_FirstClearEventMessage(&mut self, FirstClearEventMessage: flatbuffers::WIPOffset<&'b  str>) {
