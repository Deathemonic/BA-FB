...
impl<'a> TimeAttackDungeonSeasonManageExcel<'a> {
  ...
  pub const VT_UISLOT: flatbuffers::VOffsetT = 10;
  pub const VT_DUNGEONID: flatbuffers::VOffsetT = 12;
  pub const VT_DIFFICULTYGEAS: flatbuffers::VOffsetT = 14;
  pub const VT_TIMEATTACKDUNGEONREWARDID: flatbuffers::VOffsetT = 16;
  pub const VT_ROOMLIFETIMEINSECONDS: flatbuffers::VOffsetT = 18;
...
impl Serialize for TimeAttackDungeonSeasonManageExcel<'_> {
  ...
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("TimeAttackDungeonSeasonManageExcel", 8)?;
