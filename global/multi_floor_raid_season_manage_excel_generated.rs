...
impl<'a> MultiFloorRaidSeasonManageExcel<'a> {
  ...
  pub const VT_SEASONENDDATE: flatbuffers::VOffsetT = 12;
  pub const VT_SETTLEMENTENDDATE: flatbuffers::VOffsetT = 14;
  pub const VT_OPENRAIDBOSSGROUPID: flatbuffers::VOffsetT = 16;
  pub const VT_ENTERSCENARIOKEY: flatbuffers::VOffsetT = 18;
  pub const VT_LOBBYIMGPATH: flatbuffers::VOffsetT = 20;
  pub const VT_LEVELIMGPATH: flatbuffers::VOffsetT = 22;
  pub const VT_PLAYTIP: flatbuffers::VOffsetT = 24;
...
impl Serialize for MultiFloorRaidSeasonManageExcel<'_> {
  ...
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("MultiFloorRaidSeasonManageExcel", 11)?;
