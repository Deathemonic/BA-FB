...
use super::*;
pub enum AcademyMessanger2ExcelOffset {}
#[derive(Copy, Clone, PartialEq)]

pub struct AcademyMessanger2Excel<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for AcademyMessanger2Excel<'a> {
  type Inner = AcademyMessanger2Excel<'a>;
  #[inline]
...
impl<'a> AcademyMessanger2Excel<'a> {
  ...
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    AcademyMessanger2Excel { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr, A>,
    args: &'args AcademyMessanger2ExcelArgs<'args>
  ) -> flatbuffers::WIPOffset<AcademyMessanger2Excel<'bldr>> {
    let mut builder = AcademyMessanger2ExcelBuilder::new(_fbb);
    let key = table_encryption_service::create_key(b"AcademyMessanger2");
  ...
  pub fn unpack(&self) -> AcademyMessanger2ExcelT {
    let key = table_encryption_service::create_key(b"AcademyMessanger2");
  ...
  pub fn MessageGroupId(&self) -> i64 {
    ...
    unsafe { self._tab.get::<i64>(AcademyMessanger2Excel::VT_MESSAGEGROUPID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn Id(&self) -> i64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(AcademyMessanger2Excel::VT_ID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn CharacterId(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(AcademyMessanger2Excel::VT_CHARACTERID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn MessageCondition(&self) -> AcademyMessageConditions {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<AcademyMessageConditions>(AcademyMessanger2Excel::VT_MESSAGECONDITION, Some(AcademyMessageConditions::None)).unwrap()}
  }
  #[inline]
  pub fn ConditionValue(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(AcademyMessanger2Excel::VT_CONDITIONVALUE, Some(0)).unwrap()}
  }
  #[inline]
  pub fn PreConditionGroupId(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(AcademyMessanger2Excel::VT_PRECONDITIONGROUPID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn PreConditionFavorScheduleId(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(AcademyMessanger2Excel::VT_PRECONDITIONFAVORSCHEDULEID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn FavorScheduleId(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(AcademyMessanger2Excel::VT_FAVORSCHEDULEID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn NextGroupId(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(AcademyMessanger2Excel::VT_NEXTGROUPID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn FeedbackTimeMillisec(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(AcademyMessanger2Excel::VT_FEEDBACKTIMEMILLISEC, Some(0)).unwrap()}
  }
  #[inline]
  pub fn MessageType(&self) -> AcademyMessageTypes {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<AcademyMessageTypes>(AcademyMessanger2Excel::VT_MESSAGETYPE, Some(AcademyMessageTypes::None)).unwrap()}
  }
  #[inline]
  pub fn ImagePath(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(AcademyMessanger2Excel::VT_IMAGEPATH, None)}
  }
  #[inline]
  pub fn MessageKR(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(AcademyMessanger2Excel::VT_MESSAGEKR, None)}
  }
  #[inline]
  pub fn MessageJP(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(AcademyMessanger2Excel::VT_MESSAGEJP, None)}
  }
  #[inline]
  pub fn MessageTH(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(AcademyMessanger2Excel::VT_MESSAGETH, None)}
  }
  #[inline]
  pub fn MessageTW(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(AcademyMessanger2Excel::VT_MESSAGETW, None)}
  }
  #[inline]
  pub fn MessageEN(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(AcademyMessanger2Excel::VT_MESSAGEEN, None)}
  }
}

impl flatbuffers::Verifiable for AcademyMessanger2Excel<'_> {
  #[inline]
  fn run_verifier(
...
pub struct AcademyMessanger2ExcelArgs<'a> {
...
impl<'a> Default for AcademyMessanger2ExcelArgs<'a> {
  #[inline]
  fn default() -> Self {
    AcademyMessanger2ExcelArgs {
      MessageGroupId: 0,
      Id: 0,
      CharacterId: 0,
...
impl Serialize for AcademyMessanger2Excel<'_> {
  fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("AcademyMessanger2Excel", 17)?;
...
pub struct AcademyMessanger2ExcelBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> AcademyMessanger2ExcelBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_MessageGroupId(&mut self, MessageGroupId: i64) {
    self.fbb_.push_slot::<i64>(AcademyMessanger2Excel::VT_MESSAGEGROUPID, MessageGroupId, 0);
  }
  #[inline]
  pub fn add_Id(&mut self, Id: i64) {
    self.fbb_.push_slot::<i64>(AcademyMessanger2Excel::VT_ID, Id, 0);
  }
  #[inline]
  pub fn add_CharacterId(&mut self, CharacterId: i64) {
    self.fbb_.push_slot::<i64>(AcademyMessanger2Excel::VT_CHARACTERID, CharacterId, 0);
  }
  #[inline]
  pub fn add_MessageCondition(&mut self, MessageCondition: AcademyMessageConditions) {
    self.fbb_.push_slot::<AcademyMessageConditions>(AcademyMessanger2Excel::VT_MESSAGECONDITION, MessageCondition, AcademyMessageConditions::None);
  }
  #[inline]
  pub fn add_ConditionValue(&mut self, ConditionValue: i64) {
    self.fbb_.push_slot::<i64>(AcademyMessanger2Excel::VT_CONDITIONVALUE, ConditionValue, 0);
  }
  #[inline]
  pub fn add_PreConditionGroupId(&mut self, PreConditionGroupId: i64) {
    self.fbb_.push_slot::<i64>(AcademyMessanger2Excel::VT_PRECONDITIONGROUPID, PreConditionGroupId, 0);
  }
  #[inline]
  pub fn add_PreConditionFavorScheduleId(&mut self, PreConditionFavorScheduleId: i64) {
    self.fbb_.push_slot::<i64>(AcademyMessanger2Excel::VT_PRECONDITIONFAVORSCHEDULEID, PreConditionFavorScheduleId, 0);
  }
  #[inline]
  pub fn add_FavorScheduleId(&mut self, FavorScheduleId: i64) {
    self.fbb_.push_slot::<i64>(AcademyMessanger2Excel::VT_FAVORSCHEDULEID, FavorScheduleId, 0);
  }
  #[inline]
  pub fn add_NextGroupId(&mut self, NextGroupId: i64) {
    self.fbb_.push_slot::<i64>(AcademyMessanger2Excel::VT_NEXTGROUPID, NextGroupId, 0);
  }
  #[inline]
  pub fn add_FeedbackTimeMillisec(&mut self, FeedbackTimeMillisec: i64) {
    self.fbb_.push_slot::<i64>(AcademyMessanger2Excel::VT_FEEDBACKTIMEMILLISEC, FeedbackTimeMillisec, 0);
  }
  #[inline]
  pub fn add_MessageType(&mut self, MessageType: AcademyMessageTypes) {
    self.fbb_.push_slot::<AcademyMessageTypes>(AcademyMessanger2Excel::VT_MESSAGETYPE, MessageType, AcademyMessageTypes::None);
  }
  #[inline]
  pub fn add_ImagePath(&mut self, ImagePath: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(AcademyMessanger2Excel::VT_IMAGEPATH, ImagePath);
  }
  #[inline]
  pub fn add_MessageKR(&mut self, MessageKR: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(AcademyMessanger2Excel::VT_MESSAGEKR, MessageKR);
  }
  #[inline]
  pub fn add_MessageJP(&mut self, MessageJP: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(AcademyMessanger2Excel::VT_MESSAGEJP, MessageJP);
  }
  #[inline]
  pub fn add_MessageTH(&mut self, MessageTH: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(AcademyMessanger2Excel::VT_MESSAGETH, MessageTH);
  }
  #[inline]
  pub fn add_MessageTW(&mut self, MessageTW: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(AcademyMessanger2Excel::VT_MESSAGETW, MessageTW);
  }
  #[inline]
  pub fn add_MessageEN(&mut self, MessageEN: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(AcademyMessanger2Excel::VT_MESSAGEEN, MessageEN);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> AcademyMessanger2ExcelBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    AcademyMessanger2ExcelBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<AcademyMessanger2Excel<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for AcademyMessanger2Excel<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("AcademyMessanger2Excel");
...
pub struct AcademyMessanger2ExcelT {
  pub MessageGroupId: i64,
  pub Id: i64,
  pub CharacterId: i64,
  pub MessageCondition: AcademyMessageConditions,
...
impl Default for AcademyMessanger2ExcelT {
  fn default() -> Self {
    Self {
      MessageGroupId: 0,
      Id: 0,
...
impl AcademyMessanger2ExcelT {
  pub fn pack<'b, A: flatbuffers::Allocator + 'b>(
    &self,
    _fbb: &mut flatbuffers::FlatBufferBuilder<'b, A>
  ) -> flatbuffers::WIPOffset<AcademyMessanger2Excel<'b>> {
    let MessageGroupId = self.MessageGroupId;
    let Id = self.Id;
    let CharacterId = self.CharacterId;
    ...
    AcademyMessanger2Excel::create(_fbb, &AcademyMessanger2ExcelArgs{
      MessageGroupId,
      Id,
      CharacterId,
      MessageCondition,
