...
pub const ENUM_MIN_DAILY_REFILL_TYPE: i32 = 0;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_DAILY_REFILL_TYPE: i32 = 2;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_DAILY_REFILL_TYPE: [DailyRefillType; 3] = [
  DailyRefillType::None,
  DailyRefillType::Default,
  DailyRefillType::Login,
];
...
impl Serialize for DailyRefillType {
  ...
  where
    S: Serializer,
  {
    serializer.serialize_unit_variant("DailyRefillType", self.0 as u32, self.variant_name().unwrap())
  }
}
