...
pub const ENUM_VALUES_SHOP_CATEGORY_TYPE: [ShopCategoryType; 38] = [
  ...
  ShopCategoryType::DirectPayGacha_DontUseGlobal,
...
impl ShopCategoryType {
  ...
  pub const DirectPayGacha_DontUseGlobal: Self = Self(23);
  ...
  pub const ENUM_VALUES: &'static [Self] = &[
    ...
    Self::TicketGacha,
    Self::DirectPayGacha_DontUseGlobal,
    Self::FesGacha,
    Self::TimeAttack,
    Self::Chaser,
    Self::ChaserTicket,
  ...
  pub fn variant_name(self) -> Option<&'static str> {
    match self {
      ...
      Self::DirectPayGacha_DontUseGlobal => Some("DirectPayGacha_DontUseGlobal"),
