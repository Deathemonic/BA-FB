...
impl<'a> ScenarioResourceInfoExcel<'a> {
  ...
  pub const VT_VIDEOID: flatbuffers::VOffsetT = 8;
  pub const VT_BGMID: flatbuffers::VOffsetT = 10;
  pub const VT_AUDIONAME: flatbuffers::VOffsetT = 12;
  pub const VT_SPINEPATH: flatbuffers::VOffsetT = 14;
  pub const VT_RATIO: flatbuffers::VOffsetT = 16;
  pub const VT_LOBBYANIPATH: flatbuffers::VOffsetT = 18;
  pub const VT_MOVIECGPATH: flatbuffers::VOffsetT = 20;
  pub const VT_LOCALIZEID: flatbuffers::VOffsetT = 22;
...
impl Serialize for ScenarioResourceInfoExcel<'_> {
  ...
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("ScenarioResourceInfoExcel", 10)?;
