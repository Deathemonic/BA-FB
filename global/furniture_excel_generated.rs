...
impl<'a> FurnitureExcel<'a> {
  ...
  pub const VT_STARGRADEINIT: flatbuffers::VOffsetT = 16;
  pub const VT_TIER: flatbuffers::VOffsetT = 18;
  pub const VT_ICON: flatbuffers::VOffsetT = 20;
  pub const VT_SIZEWIDTH: flatbuffers::VOffsetT = 22;
  pub const VT_SIZEHEIGHT: flatbuffers::VOffsetT = 24;
  pub const VT_OTHERSIZE: flatbuffers::VOffsetT = 26;
  pub const VT_EXPANDWIDTH: flatbuffers::VOffsetT = 28;
  pub const VT_ENABLE: flatbuffers::VOffsetT = 30;
  pub const VT_REVERSEROTATION: flatbuffers::VOffsetT = 32;
  pub const VT_PREFAB: flatbuffers::VOffsetT = 34;
  pub const VT_PREFABEXPAND: flatbuffers::VOffsetT = 36;
  pub const VT_SUBPREFAB: flatbuffers::VOffsetT = 38;
  pub const VT_SUBEXPANDPREFAB: flatbuffers::VOffsetT = 40;
  pub const VT_CORNERPREFAB: flatbuffers::VOffsetT = 42;
  pub const VT_STACKABLEMAX: flatbuffers::VOffsetT = 44;
  pub const VT_RECIPECRAFTID: flatbuffers::VOffsetT = 46;
  pub const VT_SETGROUDPID: flatbuffers::VOffsetT = 48;
  pub const VT_COMFORTBONUS: flatbuffers::VOffsetT = 50;
  pub const VT_VISITOPERATIONTYPE: flatbuffers::VOffsetT = 52;
  pub const VT_VISITBONUSOPERATIONTYPE: flatbuffers::VOffsetT = 54;
  pub const VT_TAGS: flatbuffers::VOffsetT = 56;
  pub const VT_CRAFTQUALITYTIER0: flatbuffers::VOffsetT = 58;
  pub const VT_CRAFTQUALITYTIER1: flatbuffers::VOffsetT = 60;
  pub const VT_CRAFTQUALITYTIER2: flatbuffers::VOffsetT = 62;
  pub const VT_SHIFTINGCRAFTQUALITY: flatbuffers::VOffsetT = 64;
  pub const VT_FURNITUREFUNCTIONTYPE: flatbuffers::VOffsetT = 66;
  pub const VT_FURNITUREFUNCTIONPARAMETER: flatbuffers::VOffsetT = 68;
  pub const VT_VIDEOID: flatbuffers::VOffsetT = 70;
  pub const VT_EVENTCOLLECTIONID: flatbuffers::VOffsetT = 72;
  pub const VT_FURNITUREBUBBLEOFFSETX: flatbuffers::VOffsetT = 74;
  pub const VT_FURNITUREBUBBLEOFFSETY: flatbuffers::VOffsetT = 76;
  pub const VT_CAFECHARACTERSTATEREQ: flatbuffers::VOffsetT = 78;
  pub const VT_CAFECHARACTERSTATEADD: flatbuffers::VOffsetT = 80;
  pub const VT_CAFECHARACTERSTATEMAKE: flatbuffers::VOffsetT = 82;
  pub const VT_CAFECHARACTERSTATEONLY: flatbuffers::VOffsetT = 84;
  ...
  pub fn unpack(&self) -> FurnitureExcelT {
    let key = table_encryption_service::create_key(b"Furniture");
      ...
      let Rarity = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.Rarity(), &key)
      } else {
        self.Rarity()
      };
      ...
      let SubCategory = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.SubCategory(), &key)
      } else {
        self.SubCategory()
      };
    ...
    let tags = self.tags().map(|x| {
      ...
      let FurnitureFunctionType = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.FurnitureFunctionType(), &key)
      } else {
...
impl Serialize for FurnitureExcel<'_> {
  ...
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("FurnitureExcel", 41)?;
