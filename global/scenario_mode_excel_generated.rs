...
impl<'a> ScenarioModeExcel<'a> {
  ...
  pub const VT_SCENARIOOPENDATE: flatbuffers::VOffsetT = 22;
  pub const VT_SCENARIOCLOSEDATE: flatbuffers::VOffsetT = 24;
  pub const VT_ISCONTINUE: flatbuffers::VOffsetT = 26;
  pub const VT_EPISODECONTINUEMODEID: flatbuffers::VOffsetT = 28;
  pub const VT_FRONTSCENARIOGROUPID: flatbuffers::VOffsetT = 30;
  pub const VT_STRATEGYID: flatbuffers::VOffsetT = 32;
  pub const VT_GROUNDID: flatbuffers::VOffsetT = 34;
  pub const VT_ISDEFEATBATTLE: flatbuffers::VOffsetT = 36;
  pub const VT_BATTLEDURATION: flatbuffers::VOffsetT = 38;
  pub const VT_BACKSCENARIOGROUPID: flatbuffers::VOffsetT = 40;
  pub const VT_CLEAREDMODEID: flatbuffers::VOffsetT = 42;
  pub const VT_SCENARIOMODEREWARDID: flatbuffers::VOffsetT = 44;
  pub const VT_ISSCENARIOSPECIALREWARD: flatbuffers::VOffsetT = 46;
  pub const VT_ACCOUNTLEVELLIMIT: flatbuffers::VOffsetT = 48;
  pub const VT_CLEAREDSTAGEID: flatbuffers::VOffsetT = 50;
  pub const VT_NEEDCLUB: flatbuffers::VOffsetT = 52;
  pub const VT_NEEDCLUBSTUDENTCOUNT: flatbuffers::VOffsetT = 54;
  pub const VT_EVENTCONTENTID: flatbuffers::VOffsetT = 56;
  pub const VT_EVENTCONTENTTYPE: flatbuffers::VOffsetT = 58;
  pub const VT_EVENTCONTENTCONDITION: flatbuffers::VOffsetT = 60;
  pub const VT_EVENTCONTENTCONDITIONGROUP: flatbuffers::VOffsetT = 62;
  pub const VT_MAPDIFFICULTY: flatbuffers::VOffsetT = 64;
  pub const VT_STEPINDEX: flatbuffers::VOffsetT = 66;
  pub const VT_RECOMMENDLEVEL: flatbuffers::VOffsetT = 68;
  pub const VT_EVENTICONPARCELPATH: flatbuffers::VOffsetT = 70;
  pub const VT_EVENTBANNERTITLE: flatbuffers::VOffsetT = 72;
  pub const VT_LOF: flatbuffers::VOffsetT = 74;
  pub const VT_STAGETOPOGRAPHY: flatbuffers::VOffsetT = 76;
  pub const VT_FIXEDECHELONID: flatbuffers::VOffsetT = 78;
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    let key = table_encryption_service::create_key(b"ScenarioMode");
      ...
      if let Some(x) = args.ScenarioCloseDate {
        let x = if table_encryption_service::use_encryption() { _fbb.create_string(&table_encryption_service::new_encrypt_string(&x, &key).unwrap()) } else { _fbb.create_string(&x) };
        builder.add_ScenarioCloseDate(x);
      }
      if let Some(x) = args.ScenarioOpenDate {
        let x = if table_encryption_service::use_encryption() { _fbb.create_string(&table_encryption_service::new_encrypt_string(&x, &key).unwrap()) } else { _fbb.create_string(&x) };
        builder.add_ScenarioOpenDate(x);
      }
  ...
  pub fn unpack(&self) -> ScenarioModeExcelT {
    let key = table_encryption_service::create_key(b"ScenarioMode");
      ...
      let ModeType = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.ModeType(), &key)
      } else {
        self.ModeType()
      };
      let SubType = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.SubType(), &key)
      } else {
        self.SubType()
      };
    ...
    let ExposedTime = self.ExposedTime().map(|x| {
      ...
      let Hide = self.Hide();
      let Open = self.Open();
    let ScenarioOpenDate = self.ScenarioOpenDate().map(|x| {
      if table_encryption_service::use_encryption() { table_encryption_service::convert_string(&x, &key).unwrap() } else { x.to_string() }
    });
    let ScenarioCloseDate = self.ScenarioCloseDate().map(|x| {
      if table_encryption_service::use_encryption() { table_encryption_service::convert_string(&x, &key).unwrap() } else { x.to_string() }
    });
    ...
    let ClearedModeId = self.ClearedModeId().map(|x| {
      ...
      let NeedClub = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.NeedClub(), &key)
      } else {
        self.NeedClub()
      };
      ...
      let EventContentType = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.EventContentType(), &key)
      } else {
      ...
      let MapDifficulty = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.MapDifficulty(), &key)
      } else {
        self.MapDifficulty()
      };
  ...
  #[inline]
  pub fn ScenarioOpenDate(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(ScenarioModeExcel::VT_SCENARIOOPENDATE, None)}
  }
  #[inline]
  pub fn ScenarioCloseDate(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(ScenarioModeExcel::VT_SCENARIOCLOSEDATE, None)}
  }
  #[inline]
...
impl flatbuffers::Verifiable for ScenarioModeExcel<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("ScenarioOpenDate", Self::VT_SCENARIOOPENDATE, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("ScenarioCloseDate", Self::VT_SCENARIOCLOSEDATE, false)?
...
pub struct ScenarioModeExcelArgs<'a> {
    ...
    pub Hide: bool,
    pub Open: bool,
    pub ScenarioOpenDate: Option<flatbuffers::WIPOffset<&'a str>>,
    pub ScenarioCloseDate: Option<flatbuffers::WIPOffset<&'a str>>,
    pub IsContinue: bool,
...
impl Serialize for ScenarioModeExcel<'_> {
    ...
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("ScenarioModeExcel", 41)?;
      ...
      if let Some(f) = self.ScenarioOpenDate() {
        s.serialize_field("ScenarioOpenDate", &f)?;
      } else {
        s.skip_field("ScenarioOpenDate")?;
      }
      if let Some(f) = self.ScenarioCloseDate() {
        s.serialize_field("ScenarioCloseDate", &f)?;
      } else {
        s.skip_field("ScenarioCloseDate")?;
      }
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> ScenarioModeExcelBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn add_ScenarioOpenDate(&mut self, ScenarioOpenDate: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(ScenarioModeExcel::VT_SCENARIOOPENDATE, ScenarioOpenDate);
  }
  #[inline]
  pub fn add_ScenarioCloseDate(&mut self, ScenarioCloseDate: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(ScenarioModeExcel::VT_SCENARIOCLOSEDATE, ScenarioCloseDate);
  }
  #[inline]
...
impl core::fmt::Debug for ScenarioModeExcel<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("ScenarioModeExcel");
      ...
      ds.field("ScenarioOpenDate", &self.ScenarioOpenDate());
      ds.field("ScenarioCloseDate", &self.ScenarioCloseDate());
...
pub struct ScenarioModeExcelT {
  ...
  pub Hide: bool,
  pub Open: bool,
  pub ScenarioOpenDate: Option<String>,
  pub ScenarioCloseDate: Option<String>,
  pub IsContinue: bool,
  pub EpisodeContinueModeId: i64,
...
impl ScenarioModeExcelT {
  pub fn pack<'b, A: flatbuffers::Allocator + 'b>(
    ...
    let Hide = self.Hide;
    let Open = self.Open;
    let ScenarioOpenDate = self.ScenarioOpenDate.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let ScenarioCloseDate = self.ScenarioCloseDate.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let IsContinue = self.IsContinue;
    let EpisodeContinueModeId = self.EpisodeContinueModeId;
