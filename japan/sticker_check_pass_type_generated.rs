...
pub const ENUM_MIN_STICKER_CHECK_PASS_TYPE: i32 = 0;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_STICKER_CHECK_PASS_TYPE: i32 = 2;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_STICKER_CHECK_PASS_TYPE: [StickerCheckPassType; 3] = [
  StickerCheckPassType::None,
  StickerCheckPassType::ClearScenarioModeId,
  StickerCheckPassType::ClearCampaignStageId,
];
...
impl Serialize for StickerCheckPassType {
  ...
  where
    S: Serializer,
  {
    serializer.serialize_unit_variant("StickerCheckPassType", self.0 as u32, self.variant_name().unwrap())
  }
}
