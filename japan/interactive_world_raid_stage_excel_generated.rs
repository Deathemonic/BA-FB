...
use super::*;
pub enum InteractiveWorldRaidStageExcelOffset {}
#[derive(Copy, Clone, PartialEq)]

pub struct InteractiveWorldRaidStageExcel<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for InteractiveWorldRaidStageExcel<'a> {
  type Inner = InteractiveWorldRaidStageExcel<'a>;
  #[inline]
...
impl<'a> InteractiveWorldRaidStageExcel<'a> {
  ...
  pub const VT_RAIDSKILLDESCRIPTIONLISTID: flatbuffers::VOffsetT = 16;
  pub const VT_RAIDCHARACTERID: flatbuffers::VOffsetT = 18;
  pub const VT_BOSSCHARACTERID: flatbuffers::VOffsetT = 20;
  pub const VT_ASSISTCHARACTERLIMITCOUNT: flatbuffers::VOffsetT = 22;
  pub const VT_WORLDRAIDDIFFICULTY: flatbuffers::VOffsetT = 24;
  pub const VT_DIFFICULTYOPENCONDITION: flatbuffers::VOffsetT = 26;
  pub const VT_RAIDENTERAMOUNT: flatbuffers::VOffsetT = 28;
  pub const VT_REENTERAMOUNT: flatbuffers::VOffsetT = 30;
  pub const VT_BATTLEDURATION: flatbuffers::VOffsetT = 32;
  pub const VT_GROUNDID: flatbuffers::VOffsetT = 34;
  pub const VT_RAIDBATTLEENDREWARDGROUPID: flatbuffers::VOffsetT = 36;
  pub const VT_RAIDREWARDGROUPID: flatbuffers::VOffsetT = 38;
  pub const VT_BATTLEREADYTIMELINEPATH: flatbuffers::VOffsetT = 40;
  pub const VT_BATTLEREADYTIMELINEPHASESTART: flatbuffers::VOffsetT = 42;
  pub const VT_BATTLEREADYTIMELINEPHASEEND: flatbuffers::VOffsetT = 44;
  pub const VT_VICTORYTIMELINEPATH: flatbuffers::VOffsetT = 46;
  pub const VT_PHASECHANGETIMELINEPATH: flatbuffers::VOffsetT = 48;
  pub const VT_TIMELINEPHASE: flatbuffers::VOffsetT = 50;
  pub const VT_ENTERSCENARIOKEY: flatbuffers::VOffsetT = 52;
  pub const VT_CLEARSCENARIOKEY: flatbuffers::VOffsetT = 54;
  pub const VT_USEFIXEDECHELON: flatbuffers::VOffsetT = 56;
  pub const VT_FIXEDECHELONID: flatbuffers::VOffsetT = 58;
  pub const VT_ISRAIDSCENARIOBATTLE: flatbuffers::VOffsetT = 60;
  pub const VT_SHOWSKILLCARD: flatbuffers::VOffsetT = 62;
  pub const VT_BOSSBGINFOKEY: flatbuffers::VOffsetT = 64;
  pub const VT_DAMAGETOWORLDBOSS: flatbuffers::VOffsetT = 66;
  pub const VT_ALLYPASSIVESKILL: flatbuffers::VOffsetT = 68;
  pub const VT_ALLYPASSIVESKILLLEVEL: flatbuffers::VOffsetT = 70;
  pub const VT_ALLYPASSIVESKILLREMOVECONDITION: flatbuffers::VOffsetT = 72;
  pub const VT_ENEMYPASSIVESKILL: flatbuffers::VOffsetT = 74;
  pub const VT_ENEMYPASSIVESKILLLEVEL: flatbuffers::VOffsetT = 76;
  pub const VT_ENEMYPASSIVESKILLREMOVECONDITION: flatbuffers::VOffsetT = 78;
  pub const VT_SAVECURRENTLOCALBOSSHP: flatbuffers::VOffsetT = 80;
  pub const VT_ECHELONEXTENSIONTYPE: flatbuffers::VOffsetT = 82;

  #[inline]
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    InteractiveWorldRaidStageExcel { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr, A>,
    args: &'args InteractiveWorldRaidStageExcelArgs<'args>
  ) -> flatbuffers::WIPOffset<InteractiveWorldRaidStageExcel<'bldr>> {
    let mut builder = InteractiveWorldRaidStageExcelBuilder::new(_fbb);
    let key = table_encryption_service::create_key(b"InteractiveWorldRaidStage");
      ...
      let x = args.RaidSkillDescriptionListId;
      let x = if table_encryption_service::use_encryption() { table_encryption_service::convert_long(x, &key) } else { x };
      builder.add_RaidSkillDescriptionListId(x);
      ...
      if let Some(x) = args.EnemyPassiveSkillRemoveCondition {
        builder.add_EnemyPassiveSkillRemoveCondition(x);
      }
      if let Some(x) = args.EnemyPassiveSkillLevel {
        builder.add_EnemyPassiveSkillLevel(x);
      }
      if let Some(x) = args.EnemyPassiveSkill {
        builder.add_EnemyPassiveSkill(x);
      }
      if let Some(x) = args.AllyPassiveSkillRemoveCondition {
        builder.add_AllyPassiveSkillRemoveCondition(x);
      }
  ...
  pub fn unpack(&self) -> InteractiveWorldRaidStageExcelT {
    let key = table_encryption_service::create_key(b"InteractiveWorldRaidStage");
      let Id = self.Id();
    ...
    let BGPath = self.BGPath().map(|x| {
      ...
      let RaidSkillDescriptionListId = self.RaidSkillDescriptionListId();
    ...
    let AllyPassiveSkillRemoveCondition = self.AllyPassiveSkillRemoveCondition().map(|x| {
      x.iter().map(|val| if table_encryption_service::use_encryption() { table_encryption_service::convert_long(*val, &key) } else { *val }).collect()
    });
    let EnemyPassiveSkill = self.EnemyPassiveSkill().map(|x| {
      x.iter().map(|s| if table_encryption_service::use_encryption() { table_encryption_service::convert_string(s, &key).unwrap() } else { s.to_string() }).collect()
    });
    let EnemyPassiveSkillLevel = self.EnemyPassiveSkillLevel().map(|x| {
      x.iter().map(|val| if table_encryption_service::use_encryption() { table_encryption_service::convert_int(*val, &key) } else { *val }).collect()
    });
    let EnemyPassiveSkillRemoveCondition = self.EnemyPassiveSkillRemoveCondition().map(|x| {
      x.iter().map(|val| if table_encryption_service::use_encryption() { table_encryption_service::convert_long(*val, &key) } else { *val }).collect()
    });
    ...
    InteractiveWorldRaidStageExcelT {
      ...
      AllyPassiveSkillRemoveCondition,
      EnemyPassiveSkill,
      EnemyPassiveSkillLevel,
      EnemyPassiveSkillRemoveCondition,
  ...
  pub fn Id(&self) -> i64 {
    ...
    unsafe { self._tab.get::<i64>(InteractiveWorldRaidStageExcel::VT_ID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn UseBossIndex(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(InteractiveWorldRaidStageExcel::VT_USEBOSSINDEX, Some(false)).unwrap()}
  }
  #[inline]
  pub fn UseBossAIPhaseSync(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(InteractiveWorldRaidStageExcel::VT_USEBOSSAIPHASESYNC, Some(false)).unwrap()}
  }
  #[inline]
  pub fn WorldRaidBossGroupId(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(InteractiveWorldRaidStageExcel::VT_WORLDRAIDBOSSGROUPID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn PortraitPath(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(InteractiveWorldRaidStageExcel::VT_PORTRAITPATH, None)}
  }
  #[inline]
  pub fn BGPath(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(InteractiveWorldRaidStageExcel::VT_BGPATH, None)}
  }
  #[inline]
  pub fn RaidSkillDescriptionListId(&self) -> i64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(InteractiveWorldRaidStageExcel::VT_RAIDSKILLDESCRIPTIONLISTID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn RaidCharacterId(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(InteractiveWorldRaidStageExcel::VT_RAIDCHARACTERID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn BossCharacterId(&self) -> Option<flatbuffers::Vector<'a, i64>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(InteractiveWorldRaidStageExcel::VT_BOSSCHARACTERID, None)}
  }
  #[inline]
  pub fn AssistCharacterLimitCount(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(InteractiveWorldRaidStageExcel::VT_ASSISTCHARACTERLIMITCOUNT, Some(0)).unwrap()}
  }
  #[inline]
  pub fn WorldRaidDifficulty(&self) -> WorldRaidDifficulty {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<WorldRaidDifficulty>(InteractiveWorldRaidStageExcel::VT_WORLDRAIDDIFFICULTY, Some(WorldRaidDifficulty::None)).unwrap()}
  }
  #[inline]
  pub fn DifficultyOpenCondition(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(InteractiveWorldRaidStageExcel::VT_DIFFICULTYOPENCONDITION, Some(false)).unwrap()}
  }
  #[inline]
  pub fn RaidEnterAmount(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(InteractiveWorldRaidStageExcel::VT_RAIDENTERAMOUNT, Some(0)).unwrap()}
  }
  #[inline]
  pub fn ReEnterAmount(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(InteractiveWorldRaidStageExcel::VT_REENTERAMOUNT, Some(0)).unwrap()}
  }
  #[inline]
  pub fn BattleDuration(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(InteractiveWorldRaidStageExcel::VT_BATTLEDURATION, Some(0)).unwrap()}
  }
  #[inline]
  pub fn GroundId(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(InteractiveWorldRaidStageExcel::VT_GROUNDID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn RaidBattleEndRewardGroupId(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(InteractiveWorldRaidStageExcel::VT_RAIDBATTLEENDREWARDGROUPID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn RaidRewardGroupId(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(InteractiveWorldRaidStageExcel::VT_RAIDREWARDGROUPID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn BattleReadyTimelinePath(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(InteractiveWorldRaidStageExcel::VT_BATTLEREADYTIMELINEPATH, None)}
  }
  #[inline]
  pub fn BattleReadyTimelinePhaseStart(&self) -> Option<flatbuffers::Vector<'a, i32>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i32>>>(InteractiveWorldRaidStageExcel::VT_BATTLEREADYTIMELINEPHASESTART, None)}
  }
  #[inline]
  pub fn BattleReadyTimelinePhaseEnd(&self) -> Option<flatbuffers::Vector<'a, i32>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i32>>>(InteractiveWorldRaidStageExcel::VT_BATTLEREADYTIMELINEPHASEEND, None)}
  }
  #[inline]
  pub fn VictoryTimelinePath(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(InteractiveWorldRaidStageExcel::VT_VICTORYTIMELINEPATH, None)}
  }
  #[inline]
  pub fn PhaseChangeTimelinePath(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(InteractiveWorldRaidStageExcel::VT_PHASECHANGETIMELINEPATH, None)}
  }
  #[inline]
  pub fn TimeLinePhase(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(InteractiveWorldRaidStageExcel::VT_TIMELINEPHASE, Some(0)).unwrap()}
  }
  #[inline]
  pub fn EnterScenarioKey(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(InteractiveWorldRaidStageExcel::VT_ENTERSCENARIOKEY, Some(0)).unwrap()}
  }
  #[inline]
  pub fn ClearScenarioKey(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(InteractiveWorldRaidStageExcel::VT_CLEARSCENARIOKEY, Some(0)).unwrap()}
  }
  #[inline]
  pub fn UseFixedEchelon(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(InteractiveWorldRaidStageExcel::VT_USEFIXEDECHELON, Some(false)).unwrap()}
  }
  #[inline]
  pub fn FixedEchelonId(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(InteractiveWorldRaidStageExcel::VT_FIXEDECHELONID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn IsRaidScenarioBattle(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(InteractiveWorldRaidStageExcel::VT_ISRAIDSCENARIOBATTLE, Some(false)).unwrap()}
  }
  #[inline]
  pub fn ShowSkillCard(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(InteractiveWorldRaidStageExcel::VT_SHOWSKILLCARD, Some(false)).unwrap()}
  }
  #[inline]
  pub fn BossBGInfoKey(&self) -> u32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u32>(InteractiveWorldRaidStageExcel::VT_BOSSBGINFOKEY, Some(0)).unwrap()}
  }
  #[inline]
  pub fn DamageToWorldBoss(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(InteractiveWorldRaidStageExcel::VT_DAMAGETOWORLDBOSS, Some(0)).unwrap()}
  }
  #[inline]
  pub fn AllyPassiveSkill(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(InteractiveWorldRaidStageExcel::VT_ALLYPASSIVESKILL, None)}
  }
  #[inline]
  pub fn AllyPassiveSkillLevel(&self) -> Option<flatbuffers::Vector<'a, i32>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i32>>>(InteractiveWorldRaidStageExcel::VT_ALLYPASSIVESKILLLEVEL, None)}
  }
  #[inline]
  pub fn AllyPassiveSkillRemoveCondition(&self) -> Option<flatbuffers::Vector<'a, i64>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(InteractiveWorldRaidStageExcel::VT_ALLYPASSIVESKILLREMOVECONDITION, None)}
  }
  #[inline]
  pub fn EnemyPassiveSkill(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(InteractiveWorldRaidStageExcel::VT_ENEMYPASSIVESKILL, None)}
  }
  #[inline]
  pub fn EnemyPassiveSkillLevel(&self) -> Option<flatbuffers::Vector<'a, i32>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i32>>>(InteractiveWorldRaidStageExcel::VT_ENEMYPASSIVESKILLLEVEL, None)}
  }
  #[inline]
  pub fn EnemyPassiveSkillRemoveCondition(&self) -> Option<flatbuffers::Vector<'a, i64>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(InteractiveWorldRaidStageExcel::VT_ENEMYPASSIVESKILLREMOVECONDITION, None)}
  }
  #[inline]
  pub fn SaveCurrentLocalBossHP(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(InteractiveWorldRaidStageExcel::VT_SAVECURRENTLOCALBOSSHP, Some(false)).unwrap()}
  }
  #[inline]
  pub fn EchelonExtensionType(&self) -> EchelonExtensionType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<EchelonExtensionType>(InteractiveWorldRaidStageExcel::VT_ECHELONEXTENSIONTYPE, Some(EchelonExtensionType::Base)).unwrap()}
  }
}

impl flatbuffers::Verifiable for InteractiveWorldRaidStageExcel<'_> {
  #[inline]
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<i64>("RaidSkillDescriptionListId", Self::VT_RAIDSKILLDESCRIPTIONLISTID, false)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, i64>>>("AllyPassiveSkillRemoveCondition", Self::VT_ALLYPASSIVESKILLREMOVECONDITION, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<&'_ str>>>>("EnemyPassiveSkill", Self::VT_ENEMYPASSIVESKILL, false)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, i64>>>("EnemyPassiveSkillRemoveCondition", Self::VT_ENEMYPASSIVESKILLREMOVECONDITION, false)?
...
pub struct InteractiveWorldRaidStageExcelArgs<'a> {
    pub Id: i64,
    ...
    pub RaidSkillDescriptionListId: i64,
    ...
    pub AllyPassiveSkillRemoveCondition: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, i64>>>,
    pub EnemyPassiveSkill: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>,
    pub EnemyPassiveSkillLevel: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, i32>>>,
    pub EnemyPassiveSkillRemoveCondition: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, i64>>>,
    pub SaveCurrentLocalBossHP: bool,
    pub EchelonExtensionType: EchelonExtensionType,
}
impl<'a> Default for InteractiveWorldRaidStageExcelArgs<'a> {
  #[inline]
  fn default() -> Self {
    InteractiveWorldRaidStageExcelArgs {
      Id: 0,
      UseBossIndex: false,
...
impl Serialize for InteractiveWorldRaidStageExcel<'_> {
  fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("InteractiveWorldRaidStageExcel", 40)?;
      ...
      s.serialize_field("RaidSkillDescriptionListId", &self.RaidSkillDescriptionListId())?;
      ...
      if let Some(f) = self.AllyPassiveSkillRemoveCondition() {
        s.serialize_field("AllyPassiveSkillRemoveCondition", &f)?;
      } else {
        s.skip_field("AllyPassiveSkillRemoveCondition")?;
      }
      if let Some(f) = self.EnemyPassiveSkill() {
        s.serialize_field("EnemyPassiveSkill", &f)?;
      } else {
        s.skip_field("EnemyPassiveSkill")?;
      }
      ...
      if let Some(f) = self.EnemyPassiveSkillRemoveCondition() {
        s.serialize_field("EnemyPassiveSkillRemoveCondition", &f)?;
      } else {
        s.skip_field("EnemyPassiveSkillRemoveCondition")?;
      }
...
pub struct InteractiveWorldRaidStageExcelBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> InteractiveWorldRaidStageExcelBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_Id(&mut self, Id: i64) {
    self.fbb_.push_slot::<i64>(InteractiveWorldRaidStageExcel::VT_ID, Id, 0);
  }
  #[inline]
  pub fn add_UseBossIndex(&mut self, UseBossIndex: bool) {
    self.fbb_.push_slot::<bool>(InteractiveWorldRaidStageExcel::VT_USEBOSSINDEX, UseBossIndex, false);
  }
  #[inline]
  pub fn add_UseBossAIPhaseSync(&mut self, UseBossAIPhaseSync: bool) {
    self.fbb_.push_slot::<bool>(InteractiveWorldRaidStageExcel::VT_USEBOSSAIPHASESYNC, UseBossAIPhaseSync, false);
  }
  #[inline]
  pub fn add_WorldRaidBossGroupId(&mut self, WorldRaidBossGroupId: i64) {
    self.fbb_.push_slot::<i64>(InteractiveWorldRaidStageExcel::VT_WORLDRAIDBOSSGROUPID, WorldRaidBossGroupId, 0);
  }
  #[inline]
  pub fn add_PortraitPath(&mut self, PortraitPath: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(InteractiveWorldRaidStageExcel::VT_PORTRAITPATH, PortraitPath);
  }
  #[inline]
  pub fn add_BGPath(&mut self, BGPath: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(InteractiveWorldRaidStageExcel::VT_BGPATH, BGPath);
  }
  #[inline]
  pub fn add_RaidSkillDescriptionListId(&mut self, RaidSkillDescriptionListId: i64) {
    self.fbb_.push_slot::<i64>(InteractiveWorldRaidStageExcel::VT_RAIDSKILLDESCRIPTIONLISTID, RaidSkillDescriptionListId, 0);
  }
  #[inline]
  pub fn add_RaidCharacterId(&mut self, RaidCharacterId: i64) {
    self.fbb_.push_slot::<i64>(InteractiveWorldRaidStageExcel::VT_RAIDCHARACTERID, RaidCharacterId, 0);
  }
  #[inline]
  pub fn add_BossCharacterId(&mut self, BossCharacterId: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(InteractiveWorldRaidStageExcel::VT_BOSSCHARACTERID, BossCharacterId);
  }
  #[inline]
  pub fn add_AssistCharacterLimitCount(&mut self, AssistCharacterLimitCount: i64) {
    self.fbb_.push_slot::<i64>(InteractiveWorldRaidStageExcel::VT_ASSISTCHARACTERLIMITCOUNT, AssistCharacterLimitCount, 0);
  }
  #[inline]
  pub fn add_WorldRaidDifficulty(&mut self, WorldRaidDifficulty: WorldRaidDifficulty) {
    self.fbb_.push_slot::<WorldRaidDifficulty>(InteractiveWorldRaidStageExcel::VT_WORLDRAIDDIFFICULTY, WorldRaidDifficulty, WorldRaidDifficulty::None);
  }
  #[inline]
  pub fn add_DifficultyOpenCondition(&mut self, DifficultyOpenCondition: bool) {
    self.fbb_.push_slot::<bool>(InteractiveWorldRaidStageExcel::VT_DIFFICULTYOPENCONDITION, DifficultyOpenCondition, false);
  }
  #[inline]
  pub fn add_RaidEnterAmount(&mut self, RaidEnterAmount: i64) {
    self.fbb_.push_slot::<i64>(InteractiveWorldRaidStageExcel::VT_RAIDENTERAMOUNT, RaidEnterAmount, 0);
  }
  #[inline]
  pub fn add_ReEnterAmount(&mut self, ReEnterAmount: i64) {
    self.fbb_.push_slot::<i64>(InteractiveWorldRaidStageExcel::VT_REENTERAMOUNT, ReEnterAmount, 0);
  }
  #[inline]
  pub fn add_BattleDuration(&mut self, BattleDuration: i64) {
    self.fbb_.push_slot::<i64>(InteractiveWorldRaidStageExcel::VT_BATTLEDURATION, BattleDuration, 0);
  }
  #[inline]
  pub fn add_GroundId(&mut self, GroundId: i64) {
    self.fbb_.push_slot::<i64>(InteractiveWorldRaidStageExcel::VT_GROUNDID, GroundId, 0);
  }
  #[inline]
  pub fn add_RaidBattleEndRewardGroupId(&mut self, RaidBattleEndRewardGroupId: i64) {
    self.fbb_.push_slot::<i64>(InteractiveWorldRaidStageExcel::VT_RAIDBATTLEENDREWARDGROUPID, RaidBattleEndRewardGroupId, 0);
  }
  #[inline]
  pub fn add_RaidRewardGroupId(&mut self, RaidRewardGroupId: i64) {
    self.fbb_.push_slot::<i64>(InteractiveWorldRaidStageExcel::VT_RAIDREWARDGROUPID, RaidRewardGroupId, 0);
  }
  #[inline]
  pub fn add_BattleReadyTimelinePath(&mut self, BattleReadyTimelinePath: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(InteractiveWorldRaidStageExcel::VT_BATTLEREADYTIMELINEPATH, BattleReadyTimelinePath);
  }
  #[inline]
  pub fn add_BattleReadyTimelinePhaseStart(&mut self, BattleReadyTimelinePhaseStart: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i32>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(InteractiveWorldRaidStageExcel::VT_BATTLEREADYTIMELINEPHASESTART, BattleReadyTimelinePhaseStart);
  }
  #[inline]
  pub fn add_BattleReadyTimelinePhaseEnd(&mut self, BattleReadyTimelinePhaseEnd: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i32>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(InteractiveWorldRaidStageExcel::VT_BATTLEREADYTIMELINEPHASEEND, BattleReadyTimelinePhaseEnd);
  }
  #[inline]
  pub fn add_VictoryTimelinePath(&mut self, VictoryTimelinePath: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(InteractiveWorldRaidStageExcel::VT_VICTORYTIMELINEPATH, VictoryTimelinePath);
  }
  #[inline]
  pub fn add_PhaseChangeTimelinePath(&mut self, PhaseChangeTimelinePath: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(InteractiveWorldRaidStageExcel::VT_PHASECHANGETIMELINEPATH, PhaseChangeTimelinePath);
  }
  #[inline]
  pub fn add_TimeLinePhase(&mut self, TimeLinePhase: i64) {
    self.fbb_.push_slot::<i64>(InteractiveWorldRaidStageExcel::VT_TIMELINEPHASE, TimeLinePhase, 0);
  }
  #[inline]
  pub fn add_EnterScenarioKey(&mut self, EnterScenarioKey: i64) {
    self.fbb_.push_slot::<i64>(InteractiveWorldRaidStageExcel::VT_ENTERSCENARIOKEY, EnterScenarioKey, 0);
  }
  #[inline]
  pub fn add_ClearScenarioKey(&mut self, ClearScenarioKey: i64) {
    self.fbb_.push_slot::<i64>(InteractiveWorldRaidStageExcel::VT_CLEARSCENARIOKEY, ClearScenarioKey, 0);
  }
  #[inline]
  pub fn add_UseFixedEchelon(&mut self, UseFixedEchelon: bool) {
    self.fbb_.push_slot::<bool>(InteractiveWorldRaidStageExcel::VT_USEFIXEDECHELON, UseFixedEchelon, false);
  }
  #[inline]
  pub fn add_FixedEchelonId(&mut self, FixedEchelonId: i64) {
    self.fbb_.push_slot::<i64>(InteractiveWorldRaidStageExcel::VT_FIXEDECHELONID, FixedEchelonId, 0);
  }
  #[inline]
  pub fn add_IsRaidScenarioBattle(&mut self, IsRaidScenarioBattle: bool) {
    self.fbb_.push_slot::<bool>(InteractiveWorldRaidStageExcel::VT_ISRAIDSCENARIOBATTLE, IsRaidScenarioBattle, false);
  }
  #[inline]
  pub fn add_ShowSkillCard(&mut self, ShowSkillCard: bool) {
    self.fbb_.push_slot::<bool>(InteractiveWorldRaidStageExcel::VT_SHOWSKILLCARD, ShowSkillCard, false);
  }
  #[inline]
  pub fn add_BossBGInfoKey(&mut self, BossBGInfoKey: u32) {
    self.fbb_.push_slot::<u32>(InteractiveWorldRaidStageExcel::VT_BOSSBGINFOKEY, BossBGInfoKey, 0);
  }
  #[inline]
  pub fn add_DamageToWorldBoss(&mut self, DamageToWorldBoss: i64) {
    self.fbb_.push_slot::<i64>(InteractiveWorldRaidStageExcel::VT_DAMAGETOWORLDBOSS, DamageToWorldBoss, 0);
  }
  #[inline]
  pub fn add_AllyPassiveSkill(&mut self, AllyPassiveSkill: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(InteractiveWorldRaidStageExcel::VT_ALLYPASSIVESKILL, AllyPassiveSkill);
  }
  #[inline]
  pub fn add_AllyPassiveSkillLevel(&mut self, AllyPassiveSkillLevel: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i32>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(InteractiveWorldRaidStageExcel::VT_ALLYPASSIVESKILLLEVEL, AllyPassiveSkillLevel);
  }
  #[inline]
  pub fn add_AllyPassiveSkillRemoveCondition(&mut self, AllyPassiveSkillRemoveCondition: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(InteractiveWorldRaidStageExcel::VT_ALLYPASSIVESKILLREMOVECONDITION, AllyPassiveSkillRemoveCondition);
  }
  #[inline]
  pub fn add_EnemyPassiveSkill(&mut self, EnemyPassiveSkill: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(InteractiveWorldRaidStageExcel::VT_ENEMYPASSIVESKILL, EnemyPassiveSkill);
  }
  #[inline]
  pub fn add_EnemyPassiveSkillLevel(&mut self, EnemyPassiveSkillLevel: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i32>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(InteractiveWorldRaidStageExcel::VT_ENEMYPASSIVESKILLLEVEL, EnemyPassiveSkillLevel);
  }
  #[inline]
  pub fn add_EnemyPassiveSkillRemoveCondition(&mut self, EnemyPassiveSkillRemoveCondition: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(InteractiveWorldRaidStageExcel::VT_ENEMYPASSIVESKILLREMOVECONDITION, EnemyPassiveSkillRemoveCondition);
  }
  #[inline]
  pub fn add_SaveCurrentLocalBossHP(&mut self, SaveCurrentLocalBossHP: bool) {
    self.fbb_.push_slot::<bool>(InteractiveWorldRaidStageExcel::VT_SAVECURRENTLOCALBOSSHP, SaveCurrentLocalBossHP, false);
  }
  #[inline]
  pub fn add_EchelonExtensionType(&mut self, EchelonExtensionType: EchelonExtensionType) {
    self.fbb_.push_slot::<EchelonExtensionType>(InteractiveWorldRaidStageExcel::VT_ECHELONEXTENSIONTYPE, EchelonExtensionType, EchelonExtensionType::Base);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> InteractiveWorldRaidStageExcelBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    InteractiveWorldRaidStageExcelBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<InteractiveWorldRaidStageExcel<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for InteractiveWorldRaidStageExcel<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("InteractiveWorldRaidStageExcel");
      ds.field("Id", &self.Id());
      ...
      ds.field("RaidSkillDescriptionListId", &self.RaidSkillDescriptionListId());
      ...
      ds.field("AllyPassiveSkillRemoveCondition", &self.AllyPassiveSkillRemoveCondition());
      ds.field("EnemyPassiveSkill", &self.EnemyPassiveSkill());
      ds.field("EnemyPassiveSkillLevel", &self.EnemyPassiveSkillLevel());
      ds.field("EnemyPassiveSkillRemoveCondition", &self.EnemyPassiveSkillRemoveCondition());
...
pub struct InteractiveWorldRaidStageExcelT {
  pub Id: i64,
  pub UseBossIndex: bool,
  pub UseBossAIPhaseSync: bool,
  pub WorldRaidBossGroupId: i64,
  ...
  pub AllyPassiveSkillRemoveCondition: Option<Vec<i64>>,
  pub EnemyPassiveSkill: Option<Vec<String>>,
  pub EnemyPassiveSkillLevel: Option<Vec<i32>>,
  pub EnemyPassiveSkillRemoveCondition: Option<Vec<i64>>,
  pub SaveCurrentLocalBossHP: bool,
  pub EchelonExtensionType: EchelonExtensionType,
}
impl Default for InteractiveWorldRaidStageExcelT {
  fn default() -> Self {
    Self {
      Id: 0,
      UseBossIndex: false,
...
impl InteractiveWorldRaidStageExcelT {
  pub fn pack<'b, A: flatbuffers::Allocator + 'b>(
    &self,
    _fbb: &mut flatbuffers::FlatBufferBuilder<'b, A>
  ) -> flatbuffers::WIPOffset<InteractiveWorldRaidStageExcel<'b>> {
    let Id = self.Id;
    let UseBossIndex = self.UseBossIndex;
    let UseBossAIPhaseSync = self.UseBossAIPhaseSync;
    let WorldRaidBossGroupId = self.WorldRaidBossGroupId;
    ...
    let AllyPassiveSkillRemoveCondition = self.AllyPassiveSkillRemoveCondition.as_ref().map(|x|{
      _fbb.create_vector(x)
    });
    let EnemyPassiveSkill = self.EnemyPassiveSkill.as_ref().map(|x|{
      let w: Vec<_> = x.iter().map(|s| _fbb.create_string(s)).collect();_fbb.create_vector(&w)
    });
    let EnemyPassiveSkillLevel = self.EnemyPassiveSkillLevel.as_ref().map(|x|{
      _fbb.create_vector(x)
    });
    let EnemyPassiveSkillRemoveCondition = self.EnemyPassiveSkillRemoveCondition.as_ref().map(|x|{
      _fbb.create_vector(x)
    });
    let SaveCurrentLocalBossHP = self.SaveCurrentLocalBossHP;
    let EchelonExtensionType = self.EchelonExtensionType;
    InteractiveWorldRaidStageExcel::create(_fbb, &InteractiveWorldRaidStageExcelArgs{
      Id,
      UseBossIndex,
      UseBossAIPhaseSync,
      WorldRaidBossGroupId,
