  ...
  pub fn unpack(&self) -> BattleExcelT {
    ...
    let none = self.none().map(|x| {
      ...
      let Single = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.Single(), &key)
      } else {
        self.Single()
      };
      let Guided = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.Guided(), &key)
      } else {
        self.Guided()
      };
      let Blue = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.Blue(), &key)
      } else {
        self.Blue()
      };
      let CoverEnter = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.CoverEnter(), &key)
      } else {
        self.CoverEnter()
      };
    let normal = self.normal().map(|x| {
      ...
      let Crush = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.Crush(), &key)
      } else {
        self.Crush()
      };
      let Able = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.Able(), &key)
      } else {
        self.Able()
      };
      let AllySelf = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.AllySelf(), &key)
      } else {
        self.AllySelf()
      };
      let LightArmor = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.LightArmor(), &key)
      } else {
        self.LightArmor()
      };
      let Wood = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.Wood(), &key)
      } else {
        self.Wood()
      };
      let All = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.All(), &key)
      } else {
        self.All()
      };
      let DISTANCE = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.DISTANCE(), &key)
      } else {
        self.DISTANCE()
      };
      let CloseToObstacle = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.CloseToObstacle(), &key)
      } else {
        self.CloseToObstacle()
      };
      let Students = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.Students(), &key)
      } else {
        self.Students()
      };
      let Sequence = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.Sequence(), &key)
      } else {
        self.Sequence()
      };
      let UseNextExSkill = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.UseNextExSkill(), &key)
      } else {
        self.UseNextExSkill()
      };
      let Student = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.Student(), &key)
      } else {
        self.Student()
      };
      let SearchAndMove = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.SearchAndMove(), &key)
      } else {
        self.SearchAndMove()
      };
      let Position = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.Position(), &key)
      } else {
        self.Position()
      };
      let Street = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.Street(), &key)
      } else {
        self.Street()
      };
      let D = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.D(), &key)
      } else {
        self.D()
      };
      let MAIN = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.MAIN(), &key)
      } else {
        self.MAIN()
      };
      let Remain = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.Remain(), &key)
      } else {
        self.Remain()
      };
      let Low = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.Low(), &key)
      } else {
        self.Low()
      };
      let Resist = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.Resist(), &key)
      } else {
        self.Resist()
      };
      let Ally = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.Ally(), &key)
      } else {
        self.Ally()
      };
      let Main = if table_encryption_service::use_encryption() {
      ...
      let TargetToCaster = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.TargetToCaster(), &key)
      } else {
        self.TargetToCaster()
      };
      let Duration = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.Duration(), &key)
      } else {
        self.Duration()
      };
      let Preset = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.Preset(), &key)
      } else {
        self.Preset()
      };
      let FinalDamage = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.FinalDamage(), &key)
      } else {
        self.FinalDamage()
      };
      let SpecialTransStat = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.SpecialTransStat(), &key)
      } else {
        self.SpecialTransStat()
      };
      let Talk = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.Talk(), &key)
      } else {
        self.Talk()
      };
    BattleExcelT {
