...
pub const ENUM_MIN_EVENT_TARGET_TYPE: i32 = 0;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_EVENT_TARGET_TYPE: i32 = 10;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_EVENT_TARGET_TYPE: [EventTargetType; 11] = [
  EventTargetType::WeekDungeon,
  EventTargetType::Chaser,
  EventTargetType::Campaign_Normal,
  EventTargetType::Campaign_Hard,
  EventTargetType::SchoolDungeon,
  EventTargetType::AcademySchedule,
  EventTargetType::TimeAttackDungeon,
  EventTargetType::AccountLevelExpIncrease,
  EventTargetType::Raid,
  EventTargetType::EliminateRaid,
  EventTargetType::MultiFloorRaid,
];
...
impl Serialize for EventTargetType {
  ...
  where
    S: Serializer,
  {
    serializer.serialize_unit_variant("EventTargetType", self.0 as u32, self.variant_name().unwrap())
  }
}
