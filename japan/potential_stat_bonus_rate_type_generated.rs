...
pub const ENUM_MIN_POTENTIAL_STAT_BONUS_RATE_TYPE: i32 = 0;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_POTENTIAL_STAT_BONUS_RATE_TYPE: i32 = 3;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_POTENTIAL_STAT_BONUS_RATE_TYPE: [PotentialStatBonusRateType; 4] = [
  PotentialStatBonusRateType::None,
  PotentialStatBonusRateType::MaxHP,
  PotentialStatBonusRateType::AttackPower,
  PotentialStatBonusRateType::HealPower,
];
...
impl Serialize for PotentialStatBonusRateType {
  ...
  where
    S: Serializer,
  {
    serializer.serialize_unit_variant("PotentialStatBonusRateType", self.0 as u32, self.variant_name().unwrap())
  }
}
