...
pub const ENUM_MIN_SCHOOL_DUNGEON_TYPE: i32 = 0;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_SCHOOL_DUNGEON_TYPE: i32 = 3;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_SCHOOL_DUNGEON_TYPE: [SchoolDungeonType; 4] = [
  SchoolDungeonType::SchoolA,
  SchoolDungeonType::SchoolB,
  SchoolDungeonType::SchoolC,
  SchoolDungeonType::None,
];
...
impl Serialize for SchoolDungeonType {
  ...
  where
    S: Serializer,
  {
    serializer.serialize_unit_variant("SchoolDungeonType", self.0 as u32, self.variant_name().unwrap())
  }
}
