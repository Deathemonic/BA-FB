...
pub const ENUM_MIN_ATTENDANCE_TYPE: i32 = 0;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_ATTENDANCE_TYPE: i32 = 4;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_ATTENDANCE_TYPE: [AttendanceType; 5] = [
  AttendanceType::Basic,
  AttendanceType::Event,
  AttendanceType::Newbie,
  AttendanceType::EventCountDown,
  AttendanceType::Event20Days,
];
...
impl Serialize for AttendanceType {
  ...
  where
    S: Serializer,
  {
    serializer.serialize_unit_variant("AttendanceType", self.0 as u32, self.variant_name().unwrap())
  }
}
