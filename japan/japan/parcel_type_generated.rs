...
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_PARCEL_TYPE: i32 = 26;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_PARCEL_TYPE: [ParcelType; 27] = [
  ParcelType::None,
...
impl ParcelType {
  ...
  pub const PossessionCheck: Self = Self(23);
  pub const BattlePassExp: Self = Self(24);
  pub const SelectedCharacter: Self = Self(25);
  pub const UnSelectedCharacter: Self = Self(26);
