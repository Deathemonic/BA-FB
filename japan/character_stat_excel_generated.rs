...
impl<'a> CharacterStatExcel<'a> {
  ...
  pub const VT_HEALRATE: flatbuffers::VOffsetT = 132;
  pub const VT_HEALLIGHTARMORRATE: flatbuffers::VOffsetT = 134;
  pub const VT_HEALHEAVYARMORRATE: flatbuffers::VOffsetT = 136;
  pub const VT_HEALUNARMEDRATE: flatbuffers::VOffsetT = 138;
  pub const VT_HEALELASTICARMORRATE: flatbuffers::VOffsetT = 140;
  pub const VT_HEALNORMALARMORRATE: flatbuffers::VOffsetT = 142;
  pub const VT_HEALEDEXPLOSIONRATE: flatbuffers::VOffsetT = 144;
  pub const VT_HEALEDPIERCERATE: flatbuffers::VOffsetT = 146;
  pub const VT_HEALEDMYSTICRATE: flatbuffers::VOffsetT = 148;
  pub const VT_HEALEDSONICRATE: flatbuffers::VOffsetT = 150;
  pub const VT_HEALEDNORMALRATE: flatbuffers::VOffsetT = 152;
  pub const VT_STREETBATTLEADAPTATION: flatbuffers::VOffsetT = 154;
  pub const VT_OUTDOORBATTLEADAPTATION: flatbuffers::VOffsetT = 156;
  pub const VT_INDOORBATTLEADAPTATION: flatbuffers::VOffsetT = 158;
  pub const VT_REGENCOST: flatbuffers::VOffsetT = 160;
  ...
  pub fn unpack(&self) -> CharacterStatExcelT {
    let key = table_encryption_service::create_key(b"CharacterStat");
      ...
      let StreetBattleAdaptation = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.StreetBattleAdaptation(), &key)
      } else {
        self.StreetBattleAdaptation()
      };
      let OutdoorBattleAdaptation = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.OutdoorBattleAdaptation(), &key)
      } else {
        self.OutdoorBattleAdaptation()
      };
      let IndoorBattleAdaptation = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.IndoorBattleAdaptation(), &key)
      } else {
...
impl Serialize for CharacterStatExcel<'_> {
  ...
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("CharacterStatExcel", 79)?;
