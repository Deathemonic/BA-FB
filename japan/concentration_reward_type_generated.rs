...
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_CONCENTRATION_REWARD_TYPE: i32 = 3;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_CONCENTRATION_REWARD_TYPE: [ConcentrationRewardType; 4] = [
  ConcentrationRewardType::None,
  ConcentrationRewardType::CardOpen,
...
impl ConcentrationRewardType {
  ...
  pub const CardOpen: Self = Self(1);
  pub const PairMatch: Self = Self(2);
