...
impl<'a> WorldRaidBossGroupExcel<'a> {
  ...
  pub const VT_UIHIDEBEFORESPAWN: flatbuffers::VOffsetT = 20;
  pub const VT_HIDEANOTHERBOSSKILLED: flatbuffers::VOffsetT = 22;
  pub const VT_WORLDBOSSCLEARREWARDGROUPID: flatbuffers::VOffsetT = 24;
  pub const VT_ANOTHERBOSSKILLED: flatbuffers::VOffsetT = 26;
  pub const VT_ECHELONCONSTRAINTGROUPID: flatbuffers::VOffsetT = 28;
  pub const VT_EXCLUSIVEOPERATORBOSSSPAWN: flatbuffers::VOffsetT = 30;
  pub const VT_EXCLUSIVEOPERATORBOSSKILL: flatbuffers::VOffsetT = 32;
  pub const VT_EXCLUSIVEOPERATORSCENARIOBATTLE: flatbuffers::VOffsetT = 34;
  pub const VT_EXCLUSIVEOPERATORBOSSDAMAGED: flatbuffers::VOffsetT = 36;
  pub const VT_BOSSGROUPOPENCONDITION: flatbuffers::VOffsetT = 38;
...
impl Serialize for WorldRaidBossGroupExcel<'_> {
  ...
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("WorldRaidBossGroupExcel", 18)?;
