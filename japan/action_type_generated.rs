...
pub const ENUM_MIN_ACTION_TYPE: i32 = 0;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_ACTION_TYPE: i32 = 2;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
...
#[repr(transparent)]
pub struct ActionType(pub i32);
#[allow(non_upper_case_globals)]
impl ActionType {
  pub const Crush: Self = Self(0);
  pub const Courage: Self = Self(1);
  pub const Tactic: Self = Self(2);
...
impl Serialize for ActionType {
  ...
  where
    S: Serializer,
  {
    serializer.serialize_unit_variant("ActionType", self.0 as u32, self.variant_name().unwrap())
  }
}
