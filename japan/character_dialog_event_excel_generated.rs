...
impl<'a> CharacterDialogEventExcel<'a> {
  ...
  pub const VT_COLLECTIONVISIBLE: flatbuffers::VOffsetT = 38;
  pub const VT_CVCOLLECTIONTYPE: flatbuffers::VOffsetT = 40;
  pub const VT_CVUNLOCKSCENARIOTYPE: flatbuffers::VOffsetT = 42;
