...
pub const ENUM_MIN_WEEK_DUNGEON_TYPE: i32 = 0;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_WEEK_DUNGEON_TYPE: i32 = 5;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_WEEK_DUNGEON_TYPE: [WeekDungeonType; 6] = [
  WeekDungeonType::None,
  WeekDungeonType::ChaserA,
  WeekDungeonType::ChaserB,
  WeekDungeonType::ChaserC,
  WeekDungeonType::FindGift,
  WeekDungeonType::Blood,
];
...
impl Serialize for WeekDungeonType {
  ...
  where
    S: Serializer,
  {
    serializer.serialize_unit_variant("WeekDungeonType", self.0 as u32, self.variant_name().unwrap())
  }
}
