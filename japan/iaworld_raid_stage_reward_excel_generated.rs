...
use super::*;
pub enum IAWorldRaidStageRewardExcelOffset {}
#[derive(Copy, Clone, PartialEq)]

pub struct IAWorldRaidStageRewardExcel<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for IAWorldRaidStageRewardExcel<'a> {
  type Inner = IAWorldRaidStageRewardExcel<'a>;
  #[inline]
...
impl<'a> IAWorldRaidStageRewardExcel<'a> {
  ...
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    IAWorldRaidStageRewardExcel { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr, A>,
    args: &'args IAWorldRaidStageRewardExcelArgs<'args>
  ) -> flatbuffers::WIPOffset<IAWorldRaidStageRewardExcel<'bldr>> {
    let mut builder = IAWorldRaidStageRewardExcelBuilder::new(_fbb);
    let key = table_encryption_service::create_key(b"IAWorldRaidStageReward");
  ...
  pub fn unpack(&self) -> IAWorldRaidStageRewardExcelT {
    let key = table_encryption_service::create_key(b"IAWorldRaidStageReward");
  ...
  pub fn GroupId(&self) -> i64 {
    ...
    unsafe { self._tab.get::<i64>(IAWorldRaidStageRewardExcel::VT_GROUPID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn IsClearStageRewardHideInfo(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(IAWorldRaidStageRewardExcel::VT_ISCLEARSTAGEREWARDHIDEINFO, Some(false)).unwrap()}
  }
  #[inline]
  pub fn ClearStageRewardProb(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(IAWorldRaidStageRewardExcel::VT_CLEARSTAGEREWARDPROB, Some(0)).unwrap()}
  }
  #[inline]
  pub fn ClearStageRewardParcelType(&self) -> ParcelType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<ParcelType>(IAWorldRaidStageRewardExcel::VT_CLEARSTAGEREWARDPARCELTYPE, Some(ParcelType::None)).unwrap()}
  }
  #[inline]
  pub fn ClearStageRewardParcelUniqueID(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(IAWorldRaidStageRewardExcel::VT_CLEARSTAGEREWARDPARCELUNIQUEID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn ClearStageRewardParcelUniqueName(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(IAWorldRaidStageRewardExcel::VT_CLEARSTAGEREWARDPARCELUNIQUENAME, None)}
  }
  #[inline]
  pub fn ClearStageRewardAmount(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(IAWorldRaidStageRewardExcel::VT_CLEARSTAGEREWARDAMOUNT, Some(0)).unwrap()}
  }
}

impl flatbuffers::Verifiable for IAWorldRaidStageRewardExcel<'_> {
  #[inline]
  fn run_verifier(
...
pub struct IAWorldRaidStageRewardExcelArgs<'a> {
    pub GroupId: i64,
...
impl<'a> Default for IAWorldRaidStageRewardExcelArgs<'a> {
  #[inline]
  fn default() -> Self {
    IAWorldRaidStageRewardExcelArgs {
      GroupId: 0,
...
impl Serialize for IAWorldRaidStageRewardExcel<'_> {
  fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("IAWorldRaidStageRewardExcel", 7)?;
...
pub struct IAWorldRaidStageRewardExcelBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> IAWorldRaidStageRewardExcelBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_GroupId(&mut self, GroupId: i64) {
    self.fbb_.push_slot::<i64>(IAWorldRaidStageRewardExcel::VT_GROUPID, GroupId, 0);
  }
  #[inline]
  pub fn add_IsClearStageRewardHideInfo(&mut self, IsClearStageRewardHideInfo: bool) {
    self.fbb_.push_slot::<bool>(IAWorldRaidStageRewardExcel::VT_ISCLEARSTAGEREWARDHIDEINFO, IsClearStageRewardHideInfo, false);
  }
  #[inline]
  pub fn add_ClearStageRewardProb(&mut self, ClearStageRewardProb: i64) {
    self.fbb_.push_slot::<i64>(IAWorldRaidStageRewardExcel::VT_CLEARSTAGEREWARDPROB, ClearStageRewardProb, 0);
  }
  #[inline]
  pub fn add_ClearStageRewardParcelType(&mut self, ClearStageRewardParcelType: ParcelType) {
    self.fbb_.push_slot::<ParcelType>(IAWorldRaidStageRewardExcel::VT_CLEARSTAGEREWARDPARCELTYPE, ClearStageRewardParcelType, ParcelType::None);
  }
  #[inline]
  pub fn add_ClearStageRewardParcelUniqueID(&mut self, ClearStageRewardParcelUniqueID: i64) {
    self.fbb_.push_slot::<i64>(IAWorldRaidStageRewardExcel::VT_CLEARSTAGEREWARDPARCELUNIQUEID, ClearStageRewardParcelUniqueID, 0);
  }
  #[inline]
  pub fn add_ClearStageRewardParcelUniqueName(&mut self, ClearStageRewardParcelUniqueName: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(IAWorldRaidStageRewardExcel::VT_CLEARSTAGEREWARDPARCELUNIQUENAME, ClearStageRewardParcelUniqueName);
  }
  #[inline]
  pub fn add_ClearStageRewardAmount(&mut self, ClearStageRewardAmount: i64) {
    self.fbb_.push_slot::<i64>(IAWorldRaidStageRewardExcel::VT_CLEARSTAGEREWARDAMOUNT, ClearStageRewardAmount, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> IAWorldRaidStageRewardExcelBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    IAWorldRaidStageRewardExcelBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<IAWorldRaidStageRewardExcel<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for IAWorldRaidStageRewardExcel<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("IAWorldRaidStageRewardExcel");
...
pub struct IAWorldRaidStageRewardExcelT {
  pub GroupId: i64,
  pub IsClearStageRewardHideInfo: bool,
  pub ClearStageRewardProb: i64,
  pub ClearStageRewardParcelType: ParcelType,
...
impl Default for IAWorldRaidStageRewardExcelT {
  fn default() -> Self {
    Self {
      GroupId: 0,
      IsClearStageRewardHideInfo: false,
...
impl IAWorldRaidStageRewardExcelT {
  pub fn pack<'b, A: flatbuffers::Allocator + 'b>(
    &self,
    _fbb: &mut flatbuffers::FlatBufferBuilder<'b, A>
  ) -> flatbuffers::WIPOffset<IAWorldRaidStageRewardExcel<'b>> {
    let GroupId = self.GroupId;
    let IsClearStageRewardHideInfo = self.IsClearStageRewardHideInfo;
    let ClearStageRewardProb = self.ClearStageRewardProb;
    ...
    let ClearStageRewardAmount = self.ClearStageRewardAmount;
    IAWorldRaidStageRewardExcel::create(_fbb, &IAWorldRaidStageRewardExcelArgs{
      GroupId,
      IsClearStageRewardHideInfo,
      ClearStageRewardProb,
      ClearStageRewardParcelType,
