...
impl<'a> ProductExcel<'a> {
  ...
  pub const VT_PURCHASEPERIODTYPE: flatbuffers::VOffsetT = 14;
  pub const VT_PURCHASEPERIODLIMIT: flatbuffers::VOffsetT = 16;
...
impl Serialize for ProductExcel<'_> {
  ...
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("ProductExcel", 10)?;
