...
pub const ENUM_MIN_DREAM_MAKER_MULTIPLIER_CONDITION: i32 = 0;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_DREAM_MAKER_MULTIPLIER_CONDITION: i32 = 3;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_DREAM_MAKER_MULTIPLIER_CONDITION: [DreamMakerMultiplierCondition; 4] = [
  DreamMakerMultiplierCondition::None,
  DreamMakerMultiplierCondition::Round,
  DreamMakerMultiplierCondition::CollectionCount,
  DreamMakerMultiplierCondition::EndingCount,
];
...
impl Serialize for DreamMakerMultiplierCondition {
  ...
  where
    S: Serializer,
  {
    serializer.serialize_unit_variant("DreamMakerMultiplierCondition", self.0 as u32, self.variant_name().unwrap())
  }
}
