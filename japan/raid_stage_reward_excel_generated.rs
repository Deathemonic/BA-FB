...
impl<'a> RaidStageRewardExcel<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    args: &'args RaidStageRewardExcelArgs
...
pub struct RaidStageRewardExcelArgs {
    pub GroupId: i64,
...
impl<'a> Default for RaidStageRewardExcelArgs {
  #[inline]
  fn default() -> Self {
...
impl Serialize for RaidStageRewardExcel<'_> {
  ...
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("RaidStageRewardExcel", 6)?;
