...
use super::*;
pub enum FieldKeywordExcelOffset {}
#[derive(Copy, Clone, PartialEq)]

pub struct FieldKeywordExcel<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for FieldKeywordExcel<'a> {
  type Inner = FieldKeywordExcel<'a>;
  #[inline]
...
impl<'a> FieldKeywordExcel<'a> {
  ...
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    FieldKeywordExcel { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr, A>,
    args: &'args FieldKeywordExcelArgs<'args>
  ) -> flatbuffers::WIPOffset<FieldKeywordExcel<'bldr>> {
    let mut builder = FieldKeywordExcelBuilder::new(_fbb);
    let key = table_encryption_service::create_key(b"FieldKeyword");
      let x = args.SeasonId;
  ...
  pub fn unpack(&self) -> FieldKeywordExcelT {
    let key = table_encryption_service::create_key(b"FieldKeyword");
  ...
  pub fn UniqueId(&self) -> i64 {
    ...
    unsafe { self._tab.get::<i64>(FieldKeywordExcel::VT_UNIQUEID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn SeasonId(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(FieldKeywordExcel::VT_SEASONID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn NameLocalizeKey(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FieldKeywordExcel::VT_NAMELOCALIZEKEY, None)}
  }
  #[inline]
  pub fn DescriptionLocalizeKey(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FieldKeywordExcel::VT_DESCRIPTIONLOCALIZEKEY, None)}
  }
  #[inline]
  pub fn ImagePath(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FieldKeywordExcel::VT_IMAGEPATH, None)}
  }
}

impl flatbuffers::Verifiable for FieldKeywordExcel<'_> {
  #[inline]
  fn run_verifier(
...
pub struct FieldKeywordExcelArgs<'a> {
    pub UniqueId: i64,
    pub SeasonId: i64,
...
impl<'a> Default for FieldKeywordExcelArgs<'a> {
  #[inline]
  fn default() -> Self {
    FieldKeywordExcelArgs {
      UniqueId: 0,
      SeasonId: 0,
...
impl Serialize for FieldKeywordExcel<'_> {
  fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("FieldKeywordExcel", 5)?;
...
pub struct FieldKeywordExcelBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> FieldKeywordExcelBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_UniqueId(&mut self, UniqueId: i64) {
    self.fbb_.push_slot::<i64>(FieldKeywordExcel::VT_UNIQUEID, UniqueId, 0);
  }
  #[inline]
  pub fn add_SeasonId(&mut self, SeasonId: i64) {
    self.fbb_.push_slot::<i64>(FieldKeywordExcel::VT_SEASONID, SeasonId, 0);
  }
  #[inline]
  pub fn add_NameLocalizeKey(&mut self, NameLocalizeKey: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FieldKeywordExcel::VT_NAMELOCALIZEKEY, NameLocalizeKey);
  }
  #[inline]
  pub fn add_DescriptionLocalizeKey(&mut self, DescriptionLocalizeKey: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FieldKeywordExcel::VT_DESCRIPTIONLOCALIZEKEY, DescriptionLocalizeKey);
  }
  #[inline]
  pub fn add_ImagePath(&mut self, ImagePath: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FieldKeywordExcel::VT_IMAGEPATH, ImagePath);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> FieldKeywordExcelBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    FieldKeywordExcelBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<FieldKeywordExcel<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for FieldKeywordExcel<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("FieldKeywordExcel");
...
impl Default for FieldKeywordExcelT {
  fn default() -> Self {
    Self {
      UniqueId: 0,
      SeasonId: 0,
...
impl FieldKeywordExcelT {
  pub fn pack<'b, A: flatbuffers::Allocator + 'b>(
    &self,
    _fbb: &mut flatbuffers::FlatBufferBuilder<'b, A>
  ) -> flatbuffers::WIPOffset<FieldKeywordExcel<'b>> {
    let UniqueId = self.UniqueId;
    let SeasonId = self.SeasonId;
    ...
    FieldKeywordExcel::create(_fbb, &FieldKeywordExcelArgs{
      UniqueId,
      SeasonId,
      NameLocalizeKey,
      DescriptionLocalizeKey,
