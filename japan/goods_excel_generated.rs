...
impl<'a> GoodsExcel<'a> {
  ...
  pub const VT_CONSUMEEXTRASTEP: flatbuffers::VOffsetT = 28;
  pub const VT_CONSUMEEXTRAAMOUNT: flatbuffers::VOffsetT = 30;
  pub const VT_STATE: flatbuffers::VOffsetT = 32;
  pub const VT_PARCELTYPE: flatbuffers::VOffsetT = 34;
  pub const VT_PARCELID: flatbuffers::VOffsetT = 36;
  pub const VT_PARCELAMOUNT: flatbuffers::VOffsetT = 38;
...
impl Serialize for GoodsExcel<'_> {
  ...
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("GoodsExcel", 18)?;
