...
use super::*;
pub enum InteractiveWorldRaidSeasonManageExcelOffset {}
#[derive(Copy, Clone, PartialEq)]

pub struct InteractiveWorldRaidSeasonManageExcel<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for InteractiveWorldRaidSeasonManageExcel<'a> {
  type Inner = InteractiveWorldRaidSeasonManageExcel<'a>;
  #[inline]
...
impl<'a> InteractiveWorldRaidSeasonManageExcel<'a> {
  pub const VT_SEASONID: flatbuffers::VOffsetT = 4;
  pub const VT_PHASEID: flatbuffers::VOffsetT = 6;
  pub const VT_PHASESTARTCONDITION: flatbuffers::VOffsetT = 8;
  pub const VT_ISREPLAYSEASON: flatbuffers::VOffsetT = 10;
  pub const VT_ENTERTICKET: flatbuffers::VOffsetT = 12;
  pub const VT_PHASESTARTTIME: flatbuffers::VOffsetT = 14;
  pub const VT_PHASEENDTIME: flatbuffers::VOffsetT = 16;
  pub const VT_WORLDRAIDLOBBYSCENE: flatbuffers::VOffsetT = 18;
  pub const VT_WORLDRAIDLOBBYBANNER: flatbuffers::VOffsetT = 20;
  pub const VT_WORLDRAIDLOBBYBG: flatbuffers::VOffsetT = 22;
  pub const VT_WORLDRAIDLOBBYBANNERSHOW: flatbuffers::VOffsetT = 24;
  pub const VT_SEASONOPENCONDITION: flatbuffers::VOffsetT = 26;
  pub const VT_WORLDRAIDLOBBYENTERSCENARIO: flatbuffers::VOffsetT = 28;
  pub const VT_CANPLAYNOTSEASONTIME: flatbuffers::VOffsetT = 30;
  pub const VT_WORLDRAIDUNIQUETHEMELOBBYUI: flatbuffers::VOffsetT = 32;
  pub const VT_WORLDRAIDUNIQUETHEMENAME: flatbuffers::VOffsetT = 34;
  pub const VT_CANWORLDRAIDGEMENTER: flatbuffers::VOffsetT = 36;
  pub const VT_HIDEWORLDRAIDTICKETUI: flatbuffers::VOffsetT = 38;
  pub const VT_HIDEWORLDRAIDBOSSCOMPLETEREWARDUI: flatbuffers::VOffsetT = 40;
  pub const VT_USEWORLDRAIDCOMMONTOAST: flatbuffers::VOffsetT = 42;
  pub const VT_OPENRAIDBOSSGROUPID: flatbuffers::VOffsetT = 44;
  pub const VT_BOSSSPAWNTIME: flatbuffers::VOffsetT = 46;
  pub const VT_ELIMINATETIME: flatbuffers::VOffsetT = 48;
  pub const VT_SCENARIOOUTPUTCONDITIONID: flatbuffers::VOffsetT = 50;
  pub const VT_CONDITIONSCENARIOGROUPID: flatbuffers::VOffsetT = 52;
  pub const VT_CARRIERSKILLGROUPID: flatbuffers::VOffsetT = 54;
  pub const VT_WORLDRAIDMAPENTEROPERATOR: flatbuffers::VOffsetT = 56;
  pub const VT_USEFAVORRANKBUFF: flatbuffers::VOffsetT = 58;

  #[inline]
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    InteractiveWorldRaidSeasonManageExcel { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr, A>,
    args: &'args InteractiveWorldRaidSeasonManageExcelArgs<'args>
  ) -> flatbuffers::WIPOffset<InteractiveWorldRaidSeasonManageExcel<'bldr>> {
    let mut builder = InteractiveWorldRaidSeasonManageExcelBuilder::new(_fbb);
    let key = table_encryption_service::create_key(b"InteractiveWorldRaidSeasonManage");
      ...
      let x = args.PhaseStartCondition;
      let x = if table_encryption_service::use_encryption() { table_encryption_service::convert_long(x, &key) } else { x };
      builder.add_PhaseStartCondition(x);
      let x = args.PhaseId;
      let x = if table_encryption_service::use_encryption() { table_encryption_service::convert_long(x, &key) } else { x };
      ...
      if let Some(x) = args.PhaseEndTime {
        builder.add_PhaseEndTime(x);
      }
      if let Some(x) = args.PhaseStartTime {
        builder.add_PhaseStartTime(x);
      }
      ...
      builder.add_IsReplaySeason(args.IsReplaySeason);
    builder.finish()
  }

  pub fn unpack(&self) -> InteractiveWorldRaidSeasonManageExcelT {
    let key = table_encryption_service::create_key(b"InteractiveWorldRaidSeasonManage");
      let SeasonId = self.SeasonId();
      let PhaseId = self.PhaseId();
      let PhaseStartCondition = self.PhaseStartCondition();
      let IsReplaySeason = self.IsReplaySeason();
      let EnterTicket = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_enum(self.EnterTicket(), &key)
      } else {
        self.EnterTicket()
      };
    let PhaseStartTime = self.PhaseStartTime().map(|x| {
      if table_encryption_service::use_encryption() { table_encryption_service::convert_string(&x, &key).unwrap() } else { x.to_string() }
    });
    let PhaseEndTime = self.PhaseEndTime().map(|x| {
      if table_encryption_service::use_encryption() { table_encryption_service::convert_string(&x, &key).unwrap() } else { x.to_string() }
    });
  ...
  pub fn SeasonId(&self) -> i64 {
    ...
    unsafe { self._tab.get::<i64>(InteractiveWorldRaidSeasonManageExcel::VT_SEASONID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn PhaseId(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(InteractiveWorldRaidSeasonManageExcel::VT_PHASEID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn PhaseStartCondition(&self) -> i64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(InteractiveWorldRaidSeasonManageExcel::VT_PHASESTARTCONDITION, Some(0)).unwrap()}
  }
  #[inline]
  pub fn IsReplaySeason(&self) -> bool {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(InteractiveWorldRaidSeasonManageExcel::VT_ISREPLAYSEASON, Some(false)).unwrap()}
  }
  #[inline]
  pub fn EnterTicket(&self) -> CurrencyTypes {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<CurrencyTypes>(InteractiveWorldRaidSeasonManageExcel::VT_ENTERTICKET, Some(CurrencyTypes::Invalid)).unwrap()}
  }
  #[inline]
  pub fn PhaseStartTime(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(InteractiveWorldRaidSeasonManageExcel::VT_PHASESTARTTIME, None)}
  }
  #[inline]
  pub fn PhaseEndTime(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(InteractiveWorldRaidSeasonManageExcel::VT_PHASEENDTIME, None)}
  }
  #[inline]
  pub fn WorldRaidLobbyScene(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(InteractiveWorldRaidSeasonManageExcel::VT_WORLDRAIDLOBBYSCENE, None)}
  }
  #[inline]
  pub fn WorldRaidLobbyBanner(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(InteractiveWorldRaidSeasonManageExcel::VT_WORLDRAIDLOBBYBANNER, None)}
  }
  #[inline]
  pub fn WorldRaidLobbyBG(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(InteractiveWorldRaidSeasonManageExcel::VT_WORLDRAIDLOBBYBG, None)}
  }
  #[inline]
  pub fn WorldRaidLobbyBannerShow(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(InteractiveWorldRaidSeasonManageExcel::VT_WORLDRAIDLOBBYBANNERSHOW, Some(false)).unwrap()}
  }
  #[inline]
  pub fn SeasonOpenCondition(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(InteractiveWorldRaidSeasonManageExcel::VT_SEASONOPENCONDITION, Some(0)).unwrap()}
  }
  #[inline]
  pub fn WorldRaidLobbyEnterScenario(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(InteractiveWorldRaidSeasonManageExcel::VT_WORLDRAIDLOBBYENTERSCENARIO, Some(0)).unwrap()}
  }
  #[inline]
  pub fn CanPlayNotSeasonTime(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(InteractiveWorldRaidSeasonManageExcel::VT_CANPLAYNOTSEASONTIME, Some(false)).unwrap()}
  }
  #[inline]
  pub fn WorldRaidUniqueThemeLobbyUI(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(InteractiveWorldRaidSeasonManageExcel::VT_WORLDRAIDUNIQUETHEMELOBBYUI, Some(false)).unwrap()}
  }
  #[inline]
  pub fn WorldRaidUniqueThemeName(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(InteractiveWorldRaidSeasonManageExcel::VT_WORLDRAIDUNIQUETHEMENAME, None)}
  }
  #[inline]
  pub fn CanWorldRaidGemEnter(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(InteractiveWorldRaidSeasonManageExcel::VT_CANWORLDRAIDGEMENTER, Some(false)).unwrap()}
  }
  #[inline]
  pub fn HideWorldRaidTicketUI(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(InteractiveWorldRaidSeasonManageExcel::VT_HIDEWORLDRAIDTICKETUI, Some(false)).unwrap()}
  }
  #[inline]
  pub fn HideWorldRaidBossCompleteRewardUI(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(InteractiveWorldRaidSeasonManageExcel::VT_HIDEWORLDRAIDBOSSCOMPLETEREWARDUI, Some(false)).unwrap()}
  }
  #[inline]
  pub fn UseWorldRaidCommonToast(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(InteractiveWorldRaidSeasonManageExcel::VT_USEWORLDRAIDCOMMONTOAST, Some(false)).unwrap()}
  }
  #[inline]
  pub fn OpenRaidBossGroupId(&self) -> Option<flatbuffers::Vector<'a, i64>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(InteractiveWorldRaidSeasonManageExcel::VT_OPENRAIDBOSSGROUPID, None)}
  }
  #[inline]
  pub fn BossSpawnTime(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(InteractiveWorldRaidSeasonManageExcel::VT_BOSSSPAWNTIME, None)}
  }
  #[inline]
  pub fn EliminateTime(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(InteractiveWorldRaidSeasonManageExcel::VT_ELIMINATETIME, None)}
  }
  #[inline]
  pub fn ScenarioOutputConditionId(&self) -> Option<flatbuffers::Vector<'a, i64>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(InteractiveWorldRaidSeasonManageExcel::VT_SCENARIOOUTPUTCONDITIONID, None)}
  }
  #[inline]
  pub fn ConditionScenarioGroupid(&self) -> Option<flatbuffers::Vector<'a, i64>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(InteractiveWorldRaidSeasonManageExcel::VT_CONDITIONSCENARIOGROUPID, None)}
  }
  #[inline]
  pub fn CarrierSkillGroupId(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(InteractiveWorldRaidSeasonManageExcel::VT_CARRIERSKILLGROUPID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn WorldRaidMapEnterOperator(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(InteractiveWorldRaidSeasonManageExcel::VT_WORLDRAIDMAPENTEROPERATOR, None)}
  }
  #[inline]
  pub fn UseFavorRankBuff(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(InteractiveWorldRaidSeasonManageExcel::VT_USEFAVORRANKBUFF, Some(false)).unwrap()}
  }
}

impl flatbuffers::Verifiable for InteractiveWorldRaidSeasonManageExcel<'_> {
  #[inline]
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<i64>("PhaseStartCondition", Self::VT_PHASESTARTCONDITION, false)?
     .visit_field::<bool>("IsReplaySeason", Self::VT_ISREPLAYSEASON, false)?
     .visit_field::<CurrencyTypes>("EnterTicket", Self::VT_ENTERTICKET, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("PhaseStartTime", Self::VT_PHASESTARTTIME, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("PhaseEndTime", Self::VT_PHASEENDTIME, false)?
...
pub struct InteractiveWorldRaidSeasonManageExcelArgs<'a> {
    pub SeasonId: i64,
    pub PhaseId: i64,
    pub PhaseStartCondition: i64,
    pub IsReplaySeason: bool,
    pub EnterTicket: CurrencyTypes,
    pub PhaseStartTime: Option<flatbuffers::WIPOffset<&'a str>>,
    pub PhaseEndTime: Option<flatbuffers::WIPOffset<&'a str>>,
...
impl<'a> Default for InteractiveWorldRaidSeasonManageExcelArgs<'a> {
  #[inline]
  fn default() -> Self {
    InteractiveWorldRaidSeasonManageExcelArgs {
      SeasonId: 0,
      PhaseId: 0,
...
impl Serialize for InteractiveWorldRaidSeasonManageExcel<'_> {
  fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("InteractiveWorldRaidSeasonManageExcel", 28)?;
      s.serialize_field("SeasonId", &self.SeasonId())?;
      s.serialize_field("PhaseId", &self.PhaseId())?;
      s.serialize_field("PhaseStartCondition", &self.PhaseStartCondition())?;
      s.serialize_field("IsReplaySeason", &self.IsReplaySeason())?;
      s.serialize_field("EnterTicket", &self.EnterTicket())?;
      if let Some(f) = self.PhaseStartTime() {
        s.serialize_field("PhaseStartTime", &f)?;
      } else {
        s.skip_field("PhaseStartTime")?;
      }
      if let Some(f) = self.PhaseEndTime() {
        s.serialize_field("PhaseEndTime", &f)?;
      } else {
        s.skip_field("PhaseEndTime")?;
      }
...
pub struct InteractiveWorldRaidSeasonManageExcelBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> InteractiveWorldRaidSeasonManageExcelBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_SeasonId(&mut self, SeasonId: i64) {
    self.fbb_.push_slot::<i64>(InteractiveWorldRaidSeasonManageExcel::VT_SEASONID, SeasonId, 0);
  }
  #[inline]
  pub fn add_PhaseId(&mut self, PhaseId: i64) {
    self.fbb_.push_slot::<i64>(InteractiveWorldRaidSeasonManageExcel::VT_PHASEID, PhaseId, 0);
  }
  #[inline]
  pub fn add_PhaseStartCondition(&mut self, PhaseStartCondition: i64) {
    self.fbb_.push_slot::<i64>(InteractiveWorldRaidSeasonManageExcel::VT_PHASESTARTCONDITION, PhaseStartCondition, 0);
  }
  #[inline]
  pub fn add_IsReplaySeason(&mut self, IsReplaySeason: bool) {
    self.fbb_.push_slot::<bool>(InteractiveWorldRaidSeasonManageExcel::VT_ISREPLAYSEASON, IsReplaySeason, false);
  }
  #[inline]
  pub fn add_EnterTicket(&mut self, EnterTicket: CurrencyTypes) {
    self.fbb_.push_slot::<CurrencyTypes>(InteractiveWorldRaidSeasonManageExcel::VT_ENTERTICKET, EnterTicket, CurrencyTypes::Invalid);
  }
  #[inline]
  pub fn add_PhaseStartTime(&mut self, PhaseStartTime: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(InteractiveWorldRaidSeasonManageExcel::VT_PHASESTARTTIME, PhaseStartTime);
  }
  #[inline]
  pub fn add_PhaseEndTime(&mut self, PhaseEndTime: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(InteractiveWorldRaidSeasonManageExcel::VT_PHASEENDTIME, PhaseEndTime);
  }
  #[inline]
  pub fn add_WorldRaidLobbyScene(&mut self, WorldRaidLobbyScene: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(InteractiveWorldRaidSeasonManageExcel::VT_WORLDRAIDLOBBYSCENE, WorldRaidLobbyScene);
  }
  #[inline]
  pub fn add_WorldRaidLobbyBanner(&mut self, WorldRaidLobbyBanner: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(InteractiveWorldRaidSeasonManageExcel::VT_WORLDRAIDLOBBYBANNER, WorldRaidLobbyBanner);
  }
  #[inline]
  pub fn add_WorldRaidLobbyBG(&mut self, WorldRaidLobbyBG: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(InteractiveWorldRaidSeasonManageExcel::VT_WORLDRAIDLOBBYBG, WorldRaidLobbyBG);
  }
  #[inline]
  pub fn add_WorldRaidLobbyBannerShow(&mut self, WorldRaidLobbyBannerShow: bool) {
    self.fbb_.push_slot::<bool>(InteractiveWorldRaidSeasonManageExcel::VT_WORLDRAIDLOBBYBANNERSHOW, WorldRaidLobbyBannerShow, false);
  }
  #[inline]
  pub fn add_SeasonOpenCondition(&mut self, SeasonOpenCondition: i64) {
    self.fbb_.push_slot::<i64>(InteractiveWorldRaidSeasonManageExcel::VT_SEASONOPENCONDITION, SeasonOpenCondition, 0);
  }
  #[inline]
  pub fn add_WorldRaidLobbyEnterScenario(&mut self, WorldRaidLobbyEnterScenario: i64) {
    self.fbb_.push_slot::<i64>(InteractiveWorldRaidSeasonManageExcel::VT_WORLDRAIDLOBBYENTERSCENARIO, WorldRaidLobbyEnterScenario, 0);
  }
  #[inline]
  pub fn add_CanPlayNotSeasonTime(&mut self, CanPlayNotSeasonTime: bool) {
    self.fbb_.push_slot::<bool>(InteractiveWorldRaidSeasonManageExcel::VT_CANPLAYNOTSEASONTIME, CanPlayNotSeasonTime, false);
  }
  #[inline]
  pub fn add_WorldRaidUniqueThemeLobbyUI(&mut self, WorldRaidUniqueThemeLobbyUI: bool) {
    self.fbb_.push_slot::<bool>(InteractiveWorldRaidSeasonManageExcel::VT_WORLDRAIDUNIQUETHEMELOBBYUI, WorldRaidUniqueThemeLobbyUI, false);
  }
  #[inline]
  pub fn add_WorldRaidUniqueThemeName(&mut self, WorldRaidUniqueThemeName: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(InteractiveWorldRaidSeasonManageExcel::VT_WORLDRAIDUNIQUETHEMENAME, WorldRaidUniqueThemeName);
  }
  #[inline]
  pub fn add_CanWorldRaidGemEnter(&mut self, CanWorldRaidGemEnter: bool) {
    self.fbb_.push_slot::<bool>(InteractiveWorldRaidSeasonManageExcel::VT_CANWORLDRAIDGEMENTER, CanWorldRaidGemEnter, false);
  }
  #[inline]
  pub fn add_HideWorldRaidTicketUI(&mut self, HideWorldRaidTicketUI: bool) {
    self.fbb_.push_slot::<bool>(InteractiveWorldRaidSeasonManageExcel::VT_HIDEWORLDRAIDTICKETUI, HideWorldRaidTicketUI, false);
  }
  #[inline]
  pub fn add_HideWorldRaidBossCompleteRewardUI(&mut self, HideWorldRaidBossCompleteRewardUI: bool) {
    self.fbb_.push_slot::<bool>(InteractiveWorldRaidSeasonManageExcel::VT_HIDEWORLDRAIDBOSSCOMPLETEREWARDUI, HideWorldRaidBossCompleteRewardUI, false);
  }
  #[inline]
  pub fn add_UseWorldRaidCommonToast(&mut self, UseWorldRaidCommonToast: bool) {
    self.fbb_.push_slot::<bool>(InteractiveWorldRaidSeasonManageExcel::VT_USEWORLDRAIDCOMMONTOAST, UseWorldRaidCommonToast, false);
  }
  #[inline]
  pub fn add_OpenRaidBossGroupId(&mut self, OpenRaidBossGroupId: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(InteractiveWorldRaidSeasonManageExcel::VT_OPENRAIDBOSSGROUPID, OpenRaidBossGroupId);
  }
  #[inline]
  pub fn add_BossSpawnTime(&mut self, BossSpawnTime: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(InteractiveWorldRaidSeasonManageExcel::VT_BOSSSPAWNTIME, BossSpawnTime);
  }
  #[inline]
  pub fn add_EliminateTime(&mut self, EliminateTime: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(InteractiveWorldRaidSeasonManageExcel::VT_ELIMINATETIME, EliminateTime);
  }
  #[inline]
  pub fn add_ScenarioOutputConditionId(&mut self, ScenarioOutputConditionId: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(InteractiveWorldRaidSeasonManageExcel::VT_SCENARIOOUTPUTCONDITIONID, ScenarioOutputConditionId);
  }
  #[inline]
  pub fn add_ConditionScenarioGroupid(&mut self, ConditionScenarioGroupid: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(InteractiveWorldRaidSeasonManageExcel::VT_CONDITIONSCENARIOGROUPID, ConditionScenarioGroupid);
  }
  #[inline]
  pub fn add_CarrierSkillGroupId(&mut self, CarrierSkillGroupId: i64) {
    self.fbb_.push_slot::<i64>(InteractiveWorldRaidSeasonManageExcel::VT_CARRIERSKILLGROUPID, CarrierSkillGroupId, 0);
  }
  #[inline]
  pub fn add_WorldRaidMapEnterOperator(&mut self, WorldRaidMapEnterOperator: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(InteractiveWorldRaidSeasonManageExcel::VT_WORLDRAIDMAPENTEROPERATOR, WorldRaidMapEnterOperator);
  }
  #[inline]
  pub fn add_UseFavorRankBuff(&mut self, UseFavorRankBuff: bool) {
    self.fbb_.push_slot::<bool>(InteractiveWorldRaidSeasonManageExcel::VT_USEFAVORRANKBUFF, UseFavorRankBuff, false);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> InteractiveWorldRaidSeasonManageExcelBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    InteractiveWorldRaidSeasonManageExcelBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<InteractiveWorldRaidSeasonManageExcel<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for InteractiveWorldRaidSeasonManageExcel<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("InteractiveWorldRaidSeasonManageExcel");
      ds.field("SeasonId", &self.SeasonId());
      ds.field("PhaseId", &self.PhaseId());
      ds.field("PhaseStartCondition", &self.PhaseStartCondition());
      ds.field("IsReplaySeason", &self.IsReplaySeason());
      ds.field("EnterTicket", &self.EnterTicket());
      ds.field("PhaseStartTime", &self.PhaseStartTime());
      ds.field("PhaseEndTime", &self.PhaseEndTime());
...
pub struct InteractiveWorldRaidSeasonManageExcelT {
  pub SeasonId: i64,
  pub PhaseId: i64,
  pub PhaseStartCondition: i64,
  pub IsReplaySeason: bool,
  pub EnterTicket: CurrencyTypes,
  pub PhaseStartTime: Option<String>,
  pub PhaseEndTime: Option<String>,
...
impl Default for InteractiveWorldRaidSeasonManageExcelT {
  fn default() -> Self {
    Self {
      SeasonId: 0,
      PhaseId: 0,
...
impl InteractiveWorldRaidSeasonManageExcelT {
  pub fn pack<'b, A: flatbuffers::Allocator + 'b>(
    &self,
    _fbb: &mut flatbuffers::FlatBufferBuilder<'b, A>
  ) -> flatbuffers::WIPOffset<InteractiveWorldRaidSeasonManageExcel<'b>> {
    let SeasonId = self.SeasonId;
    let PhaseId = self.PhaseId;
    let PhaseStartCondition = self.PhaseStartCondition;
    let IsReplaySeason = self.IsReplaySeason;
    let EnterTicket = self.EnterTicket;
    let PhaseStartTime = self.PhaseStartTime.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let PhaseEndTime = self.PhaseEndTime.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    ...
    let UseFavorRankBuff = self.UseFavorRankBuff;
    InteractiveWorldRaidSeasonManageExcel::create(_fbb, &InteractiveWorldRaidSeasonManageExcelArgs{
      SeasonId,
      PhaseId,
      PhaseStartCondition,
      IsReplaySeason,
