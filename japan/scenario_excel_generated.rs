  ...
  pub fn unpack(&self) -> ScenarioExcelT {
    ...
    let idle = self.idle().map(|x| {
      ...
      let Cafe = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.Cafe(), &key)
      } else {
        self.Cafe()
      };
      ...
      let Open = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.Open(), &key)
      } else {
        self.Open()
      };
      let EnterConver = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.EnterConver(), &key)
      } else {
        self.EnterConver()
      };
      let Center = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.Center(), &key)
      } else {
        self.Center()
      };
      let Instant = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.Instant(), &key)
      } else {
        self.Instant()
      };
      let Prologue = if table_encryption_service::use_encryption() {
        table_encryption_service::convert_int(self.Prologue(), &key)
      } else {
        self.Prologue()
      };
    ScenarioExcelT {
