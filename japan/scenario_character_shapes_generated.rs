...
pub const ENUM_MIN_SCENARIO_CHARACTER_SHAPES: i32 = 0;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_SCENARIO_CHARACTER_SHAPES: i32 = 16;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_SCENARIO_CHARACTER_SHAPES: [ScenarioCharacterShapes; 6] = [
  ScenarioCharacterShapes::None,
  ScenarioCharacterShapes::Signal,
  ScenarioCharacterShapes::BlackSilhouette,
  ScenarioCharacterShapes::Closeup,
  ScenarioCharacterShapes::Highlight,
  ScenarioCharacterShapes::WhiteSilhouette,
];
...
impl Serialize for ScenarioCharacterShapes {
  ...
  where
    S: Serializer,
  {
    serializer.serialize_unit_variant("ScenarioCharacterShapes", self.0 as u32, self.variant_name().unwrap())
  }
}
