...
pub const ENUM_VALUES_TUTORIAL_FAILURE_CONTENT_TYPE: [TutorialFailureContentType; 9] = [
  ...
  TutorialFailureContentType::Raid,
  TutorialFailureContentType::TimeAttackDungeon,
  TutorialFailureContentType::WorldRaid,
...
impl Serialize for TutorialFailureContentType {
  ...
  where
    S: Serializer,
  {
    serializer.serialize_unit_variant("TutorialFailureContentType", self.0 as u32, self.variant_name().unwrap())
  }
}
