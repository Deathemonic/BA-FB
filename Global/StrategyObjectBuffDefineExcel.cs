...
public struct StrategyObjectBuffDefineExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.StrategyObjectBuffDefineExcel> CreateStrategyObjectBuffDefineExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.StrategyObjectBuffDefineExcel> EndStrategyObjectBuffDefineExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.StrategyObjectBuffDefineExcel>(o);
  }
  ...
  public void UnPackTo(StrategyObjectBuffDefineExcelT _o) {
    ...
    _o.StrategyObjectBuffID = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StrategyObjectBuffID, key) : this.StrategyObjectBuffID;
    _o.StrategyObjectTurn = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StrategyObjectTurn, key) : this.StrategyObjectTurn;
  ...
  public static Offset<Global.StrategyObjectBuffDefineExcel> Pack(FlatBufferBuilder builder, StrategyObjectBuffDefineExcelT _o) {
    if (_o == null) return default(Offset<Global.StrategyObjectBuffDefineExcel>);
		byte[] key = TableEncryptionService.CreateKey("StrategyObjectBuffDefine");
		var _StrategyObjectBuffID = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StrategyObjectBuffID, key) : _o.StrategyObjectBuffID;
		var _StrategyObjectTurn = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StrategyObjectTurn, key) : _o.StrategyObjectTurn;
