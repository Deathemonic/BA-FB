...
public struct RecipeIngredientExcel : IFlatbufferObject
{
  ...
  public Global.RecipeType RecipeType { get { int o = __p.__offset(6); return o != 0 ? (Global.RecipeType)__p.bb.GetInt(o + __p.bb_pos) : Global.RecipeType.None; } }
  public Global.ParcelType CostParcelType(int j) { int o = __p.__offset(8); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Global.ParcelType)0; }
  public int CostParcelTypeLength { get { int o = __p.__offset(8); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Global.ParcelType> GetCostParcelTypeBytes() { return __p.__vector_as_span<Global.ParcelType>(8, 4); }
#else
  public ArraySegment<byte>? GetCostParcelTypeBytes() { return __p.__vector_as_arraysegment(8); }
#endif
  public Global.ParcelType[] GetCostParcelTypeArray() { int o = __p.__offset(8); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Global.ParcelType[] a = new Global.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Global.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Global.ParcelType IngredientParcelType(int j) { int o = __p.__offset(14); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Global.ParcelType)0; }
  public int IngredientParcelTypeLength { get { int o = __p.__offset(14); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Global.ParcelType> GetIngredientParcelTypeBytes() { return __p.__vector_as_span<Global.ParcelType>(14, 4); }
#else
  public ArraySegment<byte>? GetIngredientParcelTypeBytes() { return __p.__vector_as_arraysegment(14); }
#endif
  public Global.ParcelType[] GetIngredientParcelTypeArray() { int o = __p.__offset(14); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Global.ParcelType[] a = new Global.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Global.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Global.RecipeIngredientExcel> CreateRecipeIngredientExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddRecipeType(FlatBufferBuilder builder, Global.RecipeType recipeType) { builder.AddInt(1, (int)recipeType, 0); }
  ...
  public static VectorOffset CreateIngredientParcelTypeVector(FlatBufferBuilder builder, Global.ParcelType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateIngredientParcelTypeVectorBlock(FlatBufferBuilder builder, Global.ParcelType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateIngredientParcelTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Global.ParcelType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateIngredientParcelTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Global.ParcelType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Global.RecipeIngredientExcel> EndRecipeIngredientExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.RecipeIngredientExcel>(o);
  }
  ...
  public void UnPackTo(RecipeIngredientExcelT _o) {
    ...
    _o.IngredientParcelType = new List<Global.ParcelType>();
    for (var _j = 0; _j < this.IngredientParcelTypeLength; ++_j) {_o.IngredientParcelType.Add(TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)this.IngredientParcelType(_j), key) : this.IngredientParcelType(_j));}
  ...
  public static Offset<Global.RecipeIngredientExcel> Pack(FlatBufferBuilder builder, RecipeIngredientExcelT _o) {
    if (_o == null) return default(Offset<Global.RecipeIngredientExcel>);
		byte[] key = TableEncryptionService.CreateKey("RecipeIngredient");
    ...
    if (_o.IngredientParcelType != null) {
      var __IngredientParcelType = _o.IngredientParcelType.Select(x => TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)x, key) : x).ToArray();
...
public class RecipeIngredientExcelT
{
  ...
  public List<Global.ParcelType> IngredientParcelType { get; set; }
...
static public class RecipeIngredientExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*RecipeType*/, 4 /*Global.RecipeType*/, 4, false)
      && verifier.VerifyVectorOfData(tablePos, 8 /*CostParcelType*/, 4 /*Global.ParcelType*/, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 14 /*IngredientParcelType*/, 4 /*Global.ParcelType*/, false)
