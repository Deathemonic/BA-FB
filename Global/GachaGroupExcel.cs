...
public struct GachaGroupExcel : IFlatbufferObject
{
  ...
  public Global.GachaGroupType GroupType { get { int o = __p.__offset(10); return o != 0 ? (Global.GachaGroupType)__p.bb.GetInt(o + __p.bb_pos) : Global.GachaGroupType.None; } }

  public static Offset<Global.GachaGroupExcel> CreateGachaGroupExcel(FlatBufferBuilder builder,
      long ID = 0,
      StringOffset NameKrOffset = default(StringOffset),
      bool IsRecursive = false,
      Global.GachaGroupType GroupType = Global.GachaGroupType.None) {
  ...
  public static void AddGroupType(FlatBufferBuilder builder, Global.GachaGroupType groupType) { builder.AddInt(3, (int)groupType, 0); }
  public static Offset<Global.GachaGroupExcel> EndGachaGroupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.GachaGroupExcel>(o);
  }
  ...
  public void UnPackTo(GachaGroupExcelT _o) {
    ...
    _o.IsRecursive = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.IsRecursive, key) : this.IsRecursive;
    _o.GroupType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.GroupType, key) : this.GroupType;
  }
  public static Offset<Global.GachaGroupExcel> Pack(FlatBufferBuilder builder, GachaGroupExcelT _o) {
    if (_o == null) return default(Offset<Global.GachaGroupExcel>);
		byte[] key = TableEncryptionService.CreateKey("GachaGroup");
    ...
    var _NameKr = _o.NameKr == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.NameKr, key) : _o.NameKr));
		var _IsRecursive = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IsRecursive, key) : _o.IsRecursive;
		var _GroupType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.GroupType, key) : _o.GroupType;
    return CreateGachaGroupExcel(
      builder,
      TableEncryptionService.UseEncryption ? _ID : _o.ID,
      _NameKr,
      TableEncryptionService.UseEncryption ? _IsRecursive : _o.IsRecursive,
      TableEncryptionService.UseEncryption ? _GroupType : _o.GroupType);
  }
}
...
public class GachaGroupExcelT
{
  ...
  public Global.GachaGroupType GroupType { get; set; }

  public GachaGroupExcelT() {
    this.ID = 0;
    this.NameKr = null;
    this.IsRecursive = false;
    this.GroupType = Global.GachaGroupType.None;
  }
}
...
static public class GachaGroupExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*GroupType*/, 4 /*Global.GachaGroupType*/, 4, false)
