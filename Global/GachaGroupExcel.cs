...
public struct GachaGroupExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(GachaGroupExcelT _o) {
    ...
    _o.IsRecursive = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.IsRecursive, key) : this.IsRecursive;
    _o.GroupType = TableEncryptionService.UseEncryption ? (Global.GachaGroupType)TableEncryptionService.Convert((int)this.GroupType, key) : this.GroupType;
  }
  public static Offset<Global.GachaGroupExcel> Pack(FlatBufferBuilder builder, GachaGroupExcelT _o) {
    ...
    var _NameKr = _o.NameKr == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.NameKr, key) : _o.NameKr));
		var _IsRecursive = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.IsRecursive, key) : _o.IsRecursive;
		var _GroupType = TableEncryptionService.UseEncryption ? (Global.GachaGroupType)TableEncryptionService.Convert((int)_o.GroupType, key) : _o.GroupType;
