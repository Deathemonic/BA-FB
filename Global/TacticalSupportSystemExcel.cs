...
public struct TacticalSupportSystemExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.TacticalSupportSystemExcel> CreateTacticalSupportSystemExcel(FlatBufferBuilder builder,
      long Id = 0,
      long SummonedTime = 0,
  ...
  public static Offset<Global.TacticalSupportSystemExcel> EndTacticalSupportSystemExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.TacticalSupportSystemExcel>(o);
  }
  ...
  public void UnPackTo(TacticalSupportSystemExcelT _o) {
    ...
    _o.SummonedTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.SummonedTime, key) : this.SummonedTime;
    _o.DefaultPersonalityId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.DefaultPersonalityId, key) : this.DefaultPersonalityId;
    _o.CanTargeting = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.CanTargeting, key) : this.CanTargeting;
    _o.CanCover = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.CanCover, key) : this.CanCover;
    _o.ObstacleUniqueName = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ObstacleUniqueName, key) : this.ObstacleUniqueName;
    _o.ObstacleCoverRange = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ObstacleCoverRange, key) : this.ObstacleCoverRange;
    _o.SummonSkilllGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SummonSkilllGroupId, key) : this.SummonSkilllGroupId;
    _o.CrashObstacleOBBWidth = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.CrashObstacleOBBWidth, key) : this.CrashObstacleOBBWidth;
    _o.CrashObstacleOBBHeight = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.CrashObstacleOBBHeight, key) : this.CrashObstacleOBBHeight;
    _o.IsTSSBlockedNodeCheck = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.IsTSSBlockedNodeCheck, key) : this.IsTSSBlockedNodeCheck;
    _o.NumberOfUses = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.NumberOfUses, key) : this.NumberOfUses;
    _o.InventoryOffsetX = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)this.InventoryOffsetX, key) : this.InventoryOffsetX;
    _o.InventoryOffsetY = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)this.InventoryOffsetY, key) : this.InventoryOffsetY;
    _o.InventoryOffsetZ = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)this.InventoryOffsetZ, key) : this.InventoryOffsetZ;
    _o.InteractionChar = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.InteractionChar, key) : this.InteractionChar;
    _o.CharacterInteractionStartDelay = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.CharacterInteractionStartDelay, key) : this.CharacterInteractionStartDelay;
    _o.GetOnStartEffectPath = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.GetOnStartEffectPath, key) : this.GetOnStartEffectPath;
    _o.GetOnEndEffectPath = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.GetOnEndEffectPath, key) : this.GetOnEndEffectPath;
    _o.SummonerCharacterId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.SummonerCharacterId, key) : this.SummonerCharacterId;
    _o.InteractionFrame = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.InteractionFrame, key) : this.InteractionFrame;
    _o.TSAInteractionAddDuration = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.TSAInteractionAddDuration, key) : this.TSAInteractionAddDuration;
    _o.InteractionStudentExSkillGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.InteractionStudentExSkillGroupId, key) : this.InteractionStudentExSkillGroupId;
    _o.InteractionSkillCardTexture = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.InteractionSkillCardTexture, key) : this.InteractionSkillCardTexture;
    _o.InteractionSkillSpine = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.InteractionSkillSpine, key) : this.InteractionSkillSpine;
    _o.RetreatFrame = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.RetreatFrame, key) : this.RetreatFrame;
    _o.DestroyFrame = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.DestroyFrame, key) : this.DestroyFrame;
  }
  public static Offset<Global.TacticalSupportSystemExcel> Pack(FlatBufferBuilder builder, TacticalSupportSystemExcelT _o) {
    if (_o == null) return default(Offset<Global.TacticalSupportSystemExcel>);
		byte[] key = TableEncryptionService.CreateKey("TacticalSupportSystem");
		var _Id = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.Id, key) : _o.Id;
		var _SummonedTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.SummonedTime, key) : _o.SummonedTime;
		var _DefaultPersonalityId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.DefaultPersonalityId, key) : _o.DefaultPersonalityId;
		var _CanTargeting = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.CanTargeting, key) : _o.CanTargeting;
		var _CanCover = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.CanCover, key) : _o.CanCover;
    var _ObstacleUniqueName = _o.ObstacleUniqueName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.ObstacleUniqueName, key) : _o.ObstacleUniqueName));
		var _ObstacleCoverRange = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ObstacleCoverRange, key) : _o.ObstacleCoverRange;
    var _SummonSkilllGroupId = _o.SummonSkilllGroupId == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.SummonSkilllGroupId, key) : _o.SummonSkilllGroupId));
		var _CrashObstacleOBBWidth = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.CrashObstacleOBBWidth, key) : _o.CrashObstacleOBBWidth;
		var _CrashObstacleOBBHeight = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.CrashObstacleOBBHeight, key) : _o.CrashObstacleOBBHeight;
		var _IsTSSBlockedNodeCheck = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.IsTSSBlockedNodeCheck, key) : _o.IsTSSBlockedNodeCheck;
		var _NumberOfUses = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.NumberOfUses, key) : _o.NumberOfUses;
		var _InventoryOffsetX = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)_o.InventoryOffsetX, key) : _o.InventoryOffsetX;
		var _InventoryOffsetY = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)_o.InventoryOffsetY, key) : _o.InventoryOffsetY;
		var _InventoryOffsetZ = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)_o.InventoryOffsetZ, key) : _o.InventoryOffsetZ;
		var _InteractionChar = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.InteractionChar, key) : _o.InteractionChar;
		var _CharacterInteractionStartDelay = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.CharacterInteractionStartDelay, key) : _o.CharacterInteractionStartDelay;
    var _GetOnStartEffectPath = _o.GetOnStartEffectPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.GetOnStartEffectPath, key) : _o.GetOnStartEffectPath));
    var _GetOnEndEffectPath = _o.GetOnEndEffectPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.GetOnEndEffectPath, key) : _o.GetOnEndEffectPath));
		var _SummonerCharacterId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.SummonerCharacterId, key) : _o.SummonerCharacterId;
		var _InteractionFrame = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.InteractionFrame, key) : _o.InteractionFrame;
		var _TSAInteractionAddDuration = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.TSAInteractionAddDuration, key) : _o.TSAInteractionAddDuration;
    var _InteractionStudentExSkillGroupId = _o.InteractionStudentExSkillGroupId == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.InteractionStudentExSkillGroupId, key) : _o.InteractionStudentExSkillGroupId));
    var _InteractionSkillCardTexture = _o.InteractionSkillCardTexture == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.InteractionSkillCardTexture, key) : _o.InteractionSkillCardTexture));
    var _InteractionSkillSpine = _o.InteractionSkillSpine == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.InteractionSkillSpine, key) : _o.InteractionSkillSpine));
		var _RetreatFrame = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.RetreatFrame, key) : _o.RetreatFrame;
		var _DestroyFrame = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.DestroyFrame, key) : _o.DestroyFrame;
    return CreateTacticalSupportSystemExcel(
      builder,
      TableEncryptionService.UseEncryption ? _Id : _o.Id,
      TableEncryptionService.UseEncryption ? _SummonedTime : _o.SummonedTime,
      TableEncryptionService.UseEncryption ? _DefaultPersonalityId : _o.DefaultPersonalityId,
      TableEncryptionService.UseEncryption ? _CanTargeting : _o.CanTargeting,
      TableEncryptionService.UseEncryption ? _CanCover : _o.CanCover,
      _ObstacleUniqueName,
      TableEncryptionService.UseEncryption ? _ObstacleCoverRange : _o.ObstacleCoverRange,
      _SummonSkilllGroupId,
      TableEncryptionService.UseEncryption ? _CrashObstacleOBBWidth : _o.CrashObstacleOBBWidth,
      TableEncryptionService.UseEncryption ? _CrashObstacleOBBHeight : _o.CrashObstacleOBBHeight,
      TableEncryptionService.UseEncryption ? _IsTSSBlockedNodeCheck : _o.IsTSSBlockedNodeCheck,
      TableEncryptionService.UseEncryption ? _NumberOfUses : _o.NumberOfUses,
      TableEncryptionService.UseEncryption ? _InventoryOffsetX : _o.InventoryOffsetX,
      TableEncryptionService.UseEncryption ? _InventoryOffsetY : _o.InventoryOffsetY,
      TableEncryptionService.UseEncryption ? _InventoryOffsetZ : _o.InventoryOffsetZ,
      TableEncryptionService.UseEncryption ? _InteractionChar : _o.InteractionChar,
      TableEncryptionService.UseEncryption ? _CharacterInteractionStartDelay : _o.CharacterInteractionStartDelay,
      _GetOnStartEffectPath,
      _GetOnEndEffectPath,
      TableEncryptionService.UseEncryption ? _SummonerCharacterId : _o.SummonerCharacterId,
      TableEncryptionService.UseEncryption ? _InteractionFrame : _o.InteractionFrame,
      TableEncryptionService.UseEncryption ? _TSAInteractionAddDuration : _o.TSAInteractionAddDuration,
      _InteractionStudentExSkillGroupId,
      _InteractionSkillCardTexture,
      _InteractionSkillSpine,
      TableEncryptionService.UseEncryption ? _RetreatFrame : _o.RetreatFrame,
      TableEncryptionService.UseEncryption ? _DestroyFrame : _o.DestroyFrame);
  }
}
