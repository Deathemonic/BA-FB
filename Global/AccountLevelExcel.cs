...
public struct AccountLevelExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.AccountLevelExcel> CreateAccountLevelExcel(FlatBufferBuilder builder,
      long Id = 0,
      long Level = 0,
      long Exp = 0,
  ...
  public static Offset<Global.AccountLevelExcel> EndAccountLevelExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.AccountLevelExcel>(o);
  }
  ...
  public void UnPackTo(AccountLevelExcelT _o) {
    ...
    _o.Exp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.Exp, key) : this.Exp;
    _o.NewbieExpRatio = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.NewbieExpRatio, key) : this.NewbieExpRatio;
    _o.CloseInterval = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.CloseInterval, key) : this.CloseInterval;
    _o.APAutoChargeMax = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.APAutoChargeMax, key) : this.APAutoChargeMax;
    _o.NeedReportEvent = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.NeedReportEvent, key) : this.NeedReportEvent;
  }
  public static Offset<Global.AccountLevelExcel> Pack(FlatBufferBuilder builder, AccountLevelExcelT _o) {
    if (_o == null) return default(Offset<Global.AccountLevelExcel>);
		byte[] key = TableEncryptionService.CreateKey("AccountLevel");
		...
		var _Exp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.Exp, key) : _o.Exp;
		var _NewbieExpRatio = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.NewbieExpRatio, key) : _o.NewbieExpRatio;
		var _CloseInterval = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.CloseInterval, key) : _o.CloseInterval;
		var _APAutoChargeMax = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.APAutoChargeMax, key) : _o.APAutoChargeMax;
		var _NeedReportEvent = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.NeedReportEvent, key) : _o.NeedReportEvent;
    return CreateAccountLevelExcel(
      ...
      TableEncryptionService.UseEncryption ? _NewbieExpRatio : _o.NewbieExpRatio,
      TableEncryptionService.UseEncryption ? _CloseInterval : _o.CloseInterval,
      TableEncryptionService.UseEncryption ? _APAutoChargeMax : _o.APAutoChargeMax,
      TableEncryptionService.UseEncryption ? _NeedReportEvent : _o.NeedReportEvent);
  }
}
