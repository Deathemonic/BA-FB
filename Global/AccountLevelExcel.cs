...
public struct AccountLevelExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(AccountLevelExcelT _o) {
    ...
    _o.NewbieExpRatio = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.NewbieExpRatio, key) : this.NewbieExpRatio;
    _o.CloseInterval = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CloseInterval, key) : this.CloseInterval;
    _o.APAutoChargeMax = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.APAutoChargeMax, key) : this.APAutoChargeMax;
    _o.NeedReportEvent = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.NeedReportEvent, key) : this.NeedReportEvent;
  }
  public static Offset<Global.AccountLevelExcel> Pack(FlatBufferBuilder builder, AccountLevelExcelT _o) {
    if (_o == null) return default(Offset<Global.AccountLevelExcel>);
		...
		var _NewbieExpRatio = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.NewbieExpRatio, key) : _o.NewbieExpRatio;
		var _CloseInterval = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CloseInterval, key) : _o.CloseInterval;
		var _APAutoChargeMax = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.APAutoChargeMax, key) : _o.APAutoChargeMax;
		var _NeedReportEvent = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.NeedReportEvent, key) : _o.NeedReportEvent;
