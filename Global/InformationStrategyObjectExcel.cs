...
public struct InformationStrategyObjectExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.InformationStrategyObjectExcel> CreateInformationStrategyObjectExcel(FlatBufferBuilder builder,
      long Id = 0,
      long StageId = 0,
  ...
  public static Offset<Global.InformationStrategyObjectExcel> EndInformationStrategyObjectExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.InformationStrategyObjectExcel>(o);
  }
  ...
  public static Offset<Global.InformationStrategyObjectExcel> Pack(FlatBufferBuilder builder, InformationStrategyObjectExcelT _o) {
    if (_o == null) return default(Offset<Global.InformationStrategyObjectExcel>);
		byte[] key = TableEncryptionService.CreateKey("InformationStrategyObject");
