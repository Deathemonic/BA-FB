...
public struct LocalizeExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.LocalizeExcel> CreateLocalizeExcel(FlatBufferBuilder builder,
      uint Key = 0,
  ...
  public static Offset<Global.LocalizeExcel> EndLocalizeExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.LocalizeExcel>(o);
  }
  ...
  public static Offset<Global.LocalizeExcel> Pack(FlatBufferBuilder builder, LocalizeExcelT _o) {
    if (_o == null) return default(Offset<Global.LocalizeExcel>);
		byte[] key = TableEncryptionService.CreateKey("Localize");
