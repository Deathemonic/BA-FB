...
public struct FieldCurtainCallFreeModeExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(FieldCurtainCallFreeModeExcelT _o) {
    ...
    _o.SetFieldDateID = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.SetFieldDateID, key) : this.SetFieldDateID;
    _o.SetFieldQuestOpenDate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.SetFieldQuestOpenDate, key) : this.SetFieldQuestOpenDate;
  }
  public static Offset<Global.FieldCurtainCallFreeModeExcel> Pack(FlatBufferBuilder builder, FieldCurtainCallFreeModeExcelT _o) {
    if (_o == null) return default(Offset<Global.FieldCurtainCallFreeModeExcel>);
		...
		var _SetFieldDateID = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.SetFieldDateID, key) : _o.SetFieldDateID;
		var _SetFieldQuestOpenDate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.SetFieldQuestOpenDate, key) : _o.SetFieldQuestOpenDate;
