...
public struct FieldCurtainCallFreeModeExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.FieldCurtainCallFreeModeExcel> CreateFieldCurtainCallFreeModeExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      long OpenDate = 0,
  ...
  public static Offset<Global.FieldCurtainCallFreeModeExcel> EndFieldCurtainCallFreeModeExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.FieldCurtainCallFreeModeExcel>(o);
  }
  ...
  public void UnPackTo(FieldCurtainCallFreeModeExcelT _o) {
    ...
    _o.SetFieldDateID = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SetFieldDateID, key) : this.SetFieldDateID;
    _o.SetFieldQuestOpenDate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SetFieldQuestOpenDate, key) : this.SetFieldQuestOpenDate;
  }
  public static Offset<Global.FieldCurtainCallFreeModeExcel> Pack(FlatBufferBuilder builder, FieldCurtainCallFreeModeExcelT _o) {
    if (_o == null) return default(Offset<Global.FieldCurtainCallFreeModeExcel>);
		byte[] key = TableEncryptionService.CreateKey("FieldCurtainCallFreeMode");
		...
		var _SetFieldDateID = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.SetFieldDateID, key) : _o.SetFieldDateID;
		var _SetFieldQuestOpenDate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.SetFieldQuestOpenDate, key) : _o.SetFieldQuestOpenDate;
    return CreateFieldCurtainCallFreeModeExcel(
      ...
      TableEncryptionService.UseEncryption ? _SetFieldDateID : _o.SetFieldDateID,
      TableEncryptionService.UseEncryption ? _SetFieldQuestOpenDate : _o.SetFieldQuestOpenDate);
  }
}
