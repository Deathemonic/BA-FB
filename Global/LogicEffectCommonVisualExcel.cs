...
public struct LogicEffectCommonVisualExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(LogicEffectCommonVisualExcelT _o) {
    ...
    _o.StringID = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StringID, key) : this.StringID;
    ...
    for (var _j = 0; _j < this.IconDispelColorLength; ++_j) {_o.IconDispelColor.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.IconDispelColor(_j), key) : this.IconDispelColor(_j));}
    ...
    _o.ParticleEnterSocket = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ParticleEnterSocket, key) : this.ParticleEnterSocket;
    ...
    _o.ParticleLoopSocket = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ParticleLoopSocket, key) : this.ParticleLoopSocket;
    ...
    _o.ParticleEndSocket = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ParticleEndSocket, key) : this.ParticleEndSocket;
    ...
    _o.ParticleApplySocket = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ParticleApplySocket, key) : this.ParticleApplySocket;
    ...
    _o.ParticleRemovedSocket = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ParticleRemovedSocket, key) : this.ParticleRemovedSocket;
  }
  public static Offset<Global.LogicEffectCommonVisualExcel> Pack(FlatBufferBuilder builder, LogicEffectCommonVisualExcelT _o) {
    if (_o == null) return default(Offset<Global.LogicEffectCommonVisualExcel>);
		byte[] key = TableEncryptionService.CreateKey("LogicEffectCommonVisual");
		var _StringID = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StringID, key) : _o.StringID;
    var _IconSpriteName = _o.IconSpriteName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.IconSpriteName, key) : _o.IconSpriteName));
    var _IconDispelColor = default(VectorOffset);
    if (_o.IconDispelColor != null) {
      var __IconDispelColor = _o.IconDispelColor.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
      _IconDispelColor = CreateIconDispelColorVector(builder, __IconDispelColor);
    }
    var _ParticleEnterPath = _o.ParticleEnterPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ParticleEnterPath, key) : _o.ParticleEnterPath));
		var _ParticleEnterSocket = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ParticleEnterSocket, key) : _o.ParticleEnterSocket;
    var _ParticleLoopPath = _o.ParticleLoopPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ParticleLoopPath, key) : _o.ParticleLoopPath));
		var _ParticleLoopSocket = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ParticleLoopSocket, key) : _o.ParticleLoopSocket;
    var _ParticleEndPath = _o.ParticleEndPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ParticleEndPath, key) : _o.ParticleEndPath));
		var _ParticleEndSocket = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ParticleEndSocket, key) : _o.ParticleEndSocket;
    var _ParticleApplyPath = _o.ParticleApplyPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ParticleApplyPath, key) : _o.ParticleApplyPath));
		var _ParticleApplySocket = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ParticleApplySocket, key) : _o.ParticleApplySocket;
    var _ParticleRemovedPath = _o.ParticleRemovedPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ParticleRemovedPath, key) : _o.ParticleRemovedPath));
		var _ParticleRemovedSocket = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ParticleRemovedSocket, key) : _o.ParticleRemovedSocket;
