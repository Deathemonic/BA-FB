...
public struct ArenaNPCExcel : IFlatbufferObject
{
  ...
  public Global.Rarity ExceptionCharacterRarities(int j) { int o = __p.__offset(16); return o != 0 ? (Global.Rarity)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Global.Rarity)0; }
  public int ExceptionCharacterRaritiesLength { get { int o = __p.__offset(16); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Global.Rarity> GetExceptionCharacterRaritiesBytes() { return __p.__vector_as_span<Global.Rarity>(16, 4); }
#else
  public ArraySegment<byte>? GetExceptionCharacterRaritiesBytes() { return __p.__vector_as_arraysegment(16); }
#endif
  public Global.Rarity[] GetExceptionCharacterRaritiesArray() { int o = __p.__offset(16); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Global.Rarity[] a = new Global.Rarity[l]; for (int i = 0; i < l; i++) { a[i] = (Global.Rarity)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Global.ArenaNPCExcel> CreateArenaNPCExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      long Rank = 0,
  ...
  public static VectorOffset CreateExceptionCharacterRaritiesVector(FlatBufferBuilder builder, Global.Rarity[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateExceptionCharacterRaritiesVectorBlock(FlatBufferBuilder builder, Global.Rarity[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateExceptionCharacterRaritiesVectorBlock(FlatBufferBuilder builder, ArraySegment<Global.Rarity> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateExceptionCharacterRaritiesVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Global.Rarity>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Global.ArenaNPCExcel> EndArenaNPCExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.ArenaNPCExcel>(o);
  }
  ...
  public void UnPackTo(ArenaNPCExcelT _o) {
    ...
    _o.ExceptionCharacterRarities = new List<Global.Rarity>();
    for (var _j = 0; _j < this.ExceptionCharacterRaritiesLength; ++_j) {_o.ExceptionCharacterRarities.Add(TableEncryptionService.UseEncryption ? (Global.Rarity)TableEncryptionService.Convert((int)this.ExceptionCharacterRarities(_j), key) : this.ExceptionCharacterRarities(_j));}
  ...
  public static Offset<Global.ArenaNPCExcel> Pack(FlatBufferBuilder builder, ArenaNPCExcelT _o) {
    if (_o == null) return default(Offset<Global.ArenaNPCExcel>);
		byte[] key = TableEncryptionService.CreateKey("ArenaNPC");
    ...
    if (_o.ExceptionCharacterRarities != null) {
      var __ExceptionCharacterRarities = _o.ExceptionCharacterRarities.Select(x => TableEncryptionService.UseEncryption ? (Global.Rarity)TableEncryptionService.Convert((int)x, key) : x).ToArray();
...
public class ArenaNPCExcelT
{
  ...
  public List<Global.Rarity> ExceptionCharacterRarities { get; set; }
...
static public class ArenaNPCExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 16 /*ExceptionCharacterRarities*/, 4 /*Global.Rarity*/, false)
