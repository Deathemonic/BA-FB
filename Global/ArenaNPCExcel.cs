...
public struct ArenaNPCExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.ArenaNPCExcel> Pack(FlatBufferBuilder builder, ArenaNPCExcelT _o) {
    if (_o == null) return default(Offset<Global.ArenaNPCExcel>);
		...
		var _NPCAccountLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.NPCAccountLevel, key) : _o.NPCAccountLevel;
    ...
    if (_o.ExceptionTSSIds != null) {
      var __ExceptionTSSIds = _o.ExceptionTSSIds.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
