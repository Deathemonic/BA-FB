...
public struct CheatCodeListExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.CheatCodeListExcel> EndCheatCodeListExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.CheatCodeListExcel>(o);
  }
  ...
  public static Offset<Global.CheatCodeListExcel> Pack(FlatBufferBuilder builder, CheatCodeListExcelT _o) {
    if (_o == null) return default(Offset<Global.CheatCodeListExcel>);
		byte[] key = TableEncryptionService.CreateKey("CheatCodeList");
