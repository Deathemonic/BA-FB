...
public struct WeekDungeonGroupBuffExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(WeekDungeonGroupBuffExcelT _o) {
    ...
    _o.WeekDungeonBuffId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.WeekDungeonBuffId, key) : this.WeekDungeonBuffId;
    ...
    _o.FormationLocalizeEtcId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.FormationLocalizeEtcId, key) : this.FormationLocalizeEtcId;
  ...
  public static Offset<Global.WeekDungeonGroupBuffExcel> Pack(FlatBufferBuilder builder, WeekDungeonGroupBuffExcelT _o) {
    if (_o == null) return default(Offset<Global.WeekDungeonGroupBuffExcel>);
		byte[] key = TableEncryptionService.CreateKey("WeekDungeonGroupBuff");
		var _WeekDungeonBuffId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.WeekDungeonBuffId, key) : _o.WeekDungeonBuffId;
		...
		var _FormationLocalizeEtcId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.FormationLocalizeEtcId, key) : _o.FormationLocalizeEtcId;
