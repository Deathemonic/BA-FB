...
public struct CouponStuffExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(CouponStuffExcelT _o) {
    ...
    _o.StuffId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.StuffId, key) : this.StuffId;
    ...
    _o.LimitAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.LimitAmount, key) : this.LimitAmount;
  ...
  public static Offset<Global.CouponStuffExcel> Pack(FlatBufferBuilder builder, CouponStuffExcelT _o) {
    if (_o == null) return default(Offset<Global.CouponStuffExcel>);
		byte[] key = TableEncryptionService.CreateKey("CouponStuff");
		var _StuffId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.StuffId, key) : _o.StuffId;
		...
		var _LimitAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.LimitAmount, key) : _o.LimitAmount;
    var _CouponStuffNameLocalizeKey = _o.CouponStuffNameLocalizeKey == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.CouponStuffNameLocalizeKey, key) : _o.CouponStuffNameLocalizeKey));
