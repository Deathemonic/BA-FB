...
public struct CouponStuffExcel : IFlatbufferObject
{
  ...
  public Global.ParcelType ParcelType { get { int o = __p.__offset(6); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Global.ParcelType.None; } }
  ...
  public static Offset<Global.CouponStuffExcel> CreateCouponStuffExcel(FlatBufferBuilder builder,
      long StuffId = 0,
  ...
  public static void AddParcelType(FlatBufferBuilder builder, Global.ParcelType parcelType) { builder.AddInt(1, (int)parcelType, 0); }
  ...
  public static Offset<Global.CouponStuffExcel> EndCouponStuffExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.CouponStuffExcel>(o);
  }
  ...
  public void UnPackTo(CouponStuffExcelT _o) {
    ...
    _o.StuffId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StuffId, key) : this.StuffId;
    ...
    _o.LimitAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.LimitAmount, key) : this.LimitAmount;
    _o.CouponStuffNameLocalizeKey = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CouponStuffNameLocalizeKey, key) : this.CouponStuffNameLocalizeKey;
  }
  public static Offset<Global.CouponStuffExcel> Pack(FlatBufferBuilder builder, CouponStuffExcelT _o) {
    if (_o == null) return default(Offset<Global.CouponStuffExcel>);
		byte[] key = TableEncryptionService.CreateKey("CouponStuff");
		var _StuffId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StuffId, key) : _o.StuffId;
		...
		var _LimitAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.LimitAmount, key) : _o.LimitAmount;
    var _CouponStuffNameLocalizeKey = _o.CouponStuffNameLocalizeKey == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.CouponStuffNameLocalizeKey, key) : _o.CouponStuffNameLocalizeKey));
    return CreateCouponStuffExcel(
      builder,
      TableEncryptionService.UseEncryption ? _StuffId : _o.StuffId,
      TableEncryptionService.UseEncryption ? _ParcelType : _o.ParcelType,
      TableEncryptionService.UseEncryption ? _ParcelId : _o.ParcelId,
      TableEncryptionService.UseEncryption ? _LimitAmount : _o.LimitAmount,
...
static public class CouponStuffExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*ParcelType*/, 4 /*Global.ParcelType*/, 4, false)
