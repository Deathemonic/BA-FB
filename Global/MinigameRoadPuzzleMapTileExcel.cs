...
public struct MinigameRoadPuzzleMapTileExcel : IFlatbufferObject
{
  ...
  public Global.RoadPuzzleMapTileType MapTileType { get { int o = __p.__offset(10); return o != 0 ? (Global.RoadPuzzleMapTileType)__p.bb.GetInt(o + __p.bb_pos) : Global.RoadPuzzleMapTileType.None; } }

  public static Offset<Global.MinigameRoadPuzzleMapTileExcel> CreateMinigameRoadPuzzleMapTileExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      long UniqueId = 0,
      StringOffset PrefabNameOffset = default(StringOffset),
      Global.RoadPuzzleMapTileType MapTileType = Global.RoadPuzzleMapTileType.None) {
  ...
  public static void AddMapTileType(FlatBufferBuilder builder, Global.RoadPuzzleMapTileType mapTileType) { builder.AddInt(3, (int)mapTileType, 0); }
  public static Offset<Global.MinigameRoadPuzzleMapTileExcel> EndMinigameRoadPuzzleMapTileExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.MinigameRoadPuzzleMapTileExcel>(o);
  }
  ...
  public void UnPackTo(MinigameRoadPuzzleMapTileExcelT _o) {
    ...
    _o.MapTileType = TableEncryptionService.UseEncryption ? (Global.RoadPuzzleMapTileType)TableEncryptionService.Convert((int)this.MapTileType, key) : this.MapTileType;
  }
  public static Offset<Global.MinigameRoadPuzzleMapTileExcel> Pack(FlatBufferBuilder builder, MinigameRoadPuzzleMapTileExcelT _o) {
    if (_o == null) return default(Offset<Global.MinigameRoadPuzzleMapTileExcel>);
		byte[] key = TableEncryptionService.CreateKey("MinigameRoadPuzzleMapTile");
    ...
    var _PrefabName = _o.PrefabName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.PrefabName, key) : _o.PrefabName));
		var _MapTileType = TableEncryptionService.UseEncryption ? (Global.RoadPuzzleMapTileType)TableEncryptionService.Convert((int)_o.MapTileType, key) : _o.MapTileType;
...
public class MinigameRoadPuzzleMapTileExcelT
{
  ...
  public Global.RoadPuzzleMapTileType MapTileType { get; set; }

  public MinigameRoadPuzzleMapTileExcelT() {
    this.EventContentId = 0;
    this.UniqueId = 0;
    this.PrefabName = null;
    this.MapTileType = Global.RoadPuzzleMapTileType.None;
  }
}
...
static public class MinigameRoadPuzzleMapTileExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*MapTileType*/, 4 /*Global.RoadPuzzleMapTileType*/, 4, false)
