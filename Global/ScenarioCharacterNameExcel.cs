...
public struct ScenarioCharacterNameExcel : IFlatbufferObject
{
  ...
  public Global.ScenarioCharacterShapes Shape { get { int o = __p.__offset(28); return o != 0 ? (Global.ScenarioCharacterShapes)__p.bb.GetInt(o + __p.bb_pos) : Global.ScenarioCharacterShapes.None; } }
  ...
  public static Offset<Global.ScenarioCharacterNameExcel> CreateScenarioCharacterNameExcel(FlatBufferBuilder builder,
      ...
      Global.ScenarioCharacterShapes Shape = Global.ScenarioCharacterShapes.None,
  ...
  public static void AddShape(FlatBufferBuilder builder, Global.ScenarioCharacterShapes shape) { builder.AddInt(12, (int)shape, 0); }
  ...
  public static Offset<Global.ScenarioCharacterNameExcel> EndScenarioCharacterNameExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.ScenarioCharacterNameExcel>(o);
  }
  ...
  public void UnPackTo(ScenarioCharacterNameExcelT _o) {
    ...
    _o.CharacterName = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CharacterName, key) : this.CharacterName;
    ...
    _o.NameTH = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.NameTH, key) : this.NameTH;
    _o.NicknameTH = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.NicknameTH, key) : this.NicknameTH;
    _o.NameTW = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.NameTW, key) : this.NameTW;
    _o.NicknameTW = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.NicknameTW, key) : this.NicknameTW;
    _o.NameEN = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.NameEN, key) : this.NameEN;
    _o.NicknameEN = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.NicknameEN, key) : this.NicknameEN;
  ...
  public static Offset<Global.ScenarioCharacterNameExcel> Pack(FlatBufferBuilder builder, ScenarioCharacterNameExcelT _o) {
    if (_o == null) return default(Offset<Global.ScenarioCharacterNameExcel>);
		byte[] key = TableEncryptionService.CreateKey("ScenarioCharacterName");
		var _CharacterName = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CharacterName, key) : _o.CharacterName;
    ...
    var _NicknameKR = _o.NicknameKR == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.NicknameKR, key) : _o.NicknameKR));
    ...
    var _NicknameJP = _o.NicknameJP == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.NicknameJP, key) : _o.NicknameJP));
    var _NameTH = _o.NameTH == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.NameTH, key) : _o.NameTH));
    var _NicknameTH = _o.NicknameTH == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.NicknameTH, key) : _o.NicknameTH));
    var _NameTW = _o.NameTW == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.NameTW, key) : _o.NameTW));
    var _NicknameTW = _o.NicknameTW == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.NicknameTW, key) : _o.NicknameTW));
    var _NameEN = _o.NameEN == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.NameEN, key) : _o.NameEN));
    var _NicknameEN = _o.NicknameEN == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.NicknameEN, key) : _o.NicknameEN));
		var _Shape = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Shape, key) : _o.Shape;
    var _SpinePrefabName = _o.SpinePrefabName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.SpinePrefabName, key) : _o.SpinePrefabName));
    var _SmallPortrait = _o.SmallPortrait == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.SmallPortrait, key) : _o.SmallPortrait));
...
public class ScenarioCharacterNameExcelT
{
  ...
  public Global.ScenarioCharacterShapes Shape { get; set; }
  ...
  public ScenarioCharacterNameExcelT() {
    ...
    this.Shape = Global.ScenarioCharacterShapes.None;
...
static public class ScenarioCharacterNameExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 28 /*Shape*/, 4 /*Global.ScenarioCharacterShapes*/, 4, false)
