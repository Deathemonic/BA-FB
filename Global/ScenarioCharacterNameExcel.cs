...
public struct ScenarioCharacterNameExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ScenarioCharacterNameExcelT _o) {
    ...
    _o.Shape = TableEncryptionService.UseEncryption ? (Global.ScenarioCharacterShapes)TableEncryptionService.Convert((int)this.Shape, key) : this.Shape;
  ...
  public static Offset<Global.ScenarioCharacterNameExcel> Pack(FlatBufferBuilder builder, ScenarioCharacterNameExcelT _o) {
    ...
    var _NameTH = _o.NameTH == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.NameTH, key) : _o.NameTH));
    var _NicknameTH = _o.NicknameTH == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.NicknameTH, key) : _o.NicknameTH));
    var _NameTW = _o.NameTW == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.NameTW, key) : _o.NameTW));
    var _NicknameTW = _o.NicknameTW == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.NicknameTW, key) : _o.NicknameTW));
    var _NameEN = _o.NameEN == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.NameEN, key) : _o.NameEN));
    var _NicknameEN = _o.NicknameEN == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.NicknameEN, key) : _o.NicknameEN));
		var _Shape = TableEncryptionService.UseEncryption ? (Global.ScenarioCharacterShapes)TableEncryptionService.Convert((int)_o.Shape, key) : _o.Shape;
