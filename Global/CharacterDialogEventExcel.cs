...
public struct CharacterDialogEventExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(CharacterDialogEventExcelT _o) {
    ...
    _o.CVUnlockScenarioType = TableEncryptionService.UseEncryption ? (Global.CVUnlockScenarioType)TableEncryptionService.Convert((int)this.CVUnlockScenarioType, key) : this.CVUnlockScenarioType;
  ...
  public static Offset<Global.CharacterDialogEventExcel> Pack(FlatBufferBuilder builder, CharacterDialogEventExcelT _o) {
    ...
    if (_o.VoiceId != null) {
      ...
      _VoiceId = CreateVoiceIdVector(builder, __VoiceId);
		...
		var _CVUnlockScenarioType = TableEncryptionService.UseEncryption ? (Global.CVUnlockScenarioType)TableEncryptionService.Convert((int)_o.CVUnlockScenarioType, key) : _o.CVUnlockScenarioType;
