...
public struct CharacterDialogEventExcel : IFlatbufferObject
{
  ...
  public Global.CVCollectionType CVCollectionType { get { int o = __p.__offset(48); return o != 0 ? (Global.CVCollectionType)__p.bb.GetInt(o + __p.bb_pos) : Global.CVCollectionType.CVNormal; } }
  public Global.CVUnlockScenarioType CVUnlockScenarioType { get { int o = __p.__offset(50); return o != 0 ? (Global.CVUnlockScenarioType)__p.bb.GetInt(o + __p.bb_pos) : Global.CVUnlockScenarioType.Main; } }
  ...
  public static Offset<Global.CharacterDialogEventExcel> CreateCharacterDialogEventExcel(FlatBufferBuilder builder,
      ...
      Global.CVUnlockScenarioType CVUnlockScenarioType = Global.CVUnlockScenarioType.Main,
  ...
  public static void AddCVCollectionType(FlatBufferBuilder builder, Global.CVCollectionType cVCollectionType) { builder.AddInt(22, (int)cVCollectionType, 0); }
  public static void AddCVUnlockScenarioType(FlatBufferBuilder builder, Global.CVUnlockScenarioType cVUnlockScenarioType) { builder.AddInt(23, (int)cVUnlockScenarioType, 0); }
  ...
  public static Offset<Global.CharacterDialogEventExcel> EndCharacterDialogEventExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.CharacterDialogEventExcel>(o);
  }
  ...
  public static Offset<Global.CharacterDialogEventExcel> Pack(FlatBufferBuilder builder, CharacterDialogEventExcelT _o) {
    if (_o == null) return default(Offset<Global.CharacterDialogEventExcel>);
		byte[] key = TableEncryptionService.CreateKey("CharacterDialogEvent");
...
public class CharacterDialogEventExcelT
{
  ...
  public Global.CVUnlockScenarioType CVUnlockScenarioType { get; set; }
  ...
  public CharacterDialogEventExcelT() {
    ...
    this.CVUnlockScenarioType = Global.CVUnlockScenarioType.Main;
...
static public class CharacterDialogEventExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 48 /*CVCollectionType*/, 4 /*Global.CVCollectionType*/, 4, false)
      && verifier.VerifyField(tablePos, 50 /*CVUnlockScenarioType*/, 4 /*Global.CVUnlockScenarioType*/, 4, false)
