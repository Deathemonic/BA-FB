...
public struct WebEventSeasonExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.WebEventSeasonExcel> Pack(FlatBufferBuilder builder, WebEventSeasonExcelT _o) {
    ...
    var _PopupTitleLocalizeKey = _o.PopupTitleLocalizeKey == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.PopupTitleLocalizeKey, key) : _o.PopupTitleLocalizeKey));
    var _StageEventUrl = _o.StageEventUrl == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.StageEventUrl, key) : _o.StageEventUrl));
    var _LiveEventUrl = _o.LiveEventUrl == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.LiveEventUrl, key) : _o.LiveEventUrl));
