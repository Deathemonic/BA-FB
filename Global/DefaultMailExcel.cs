...
public struct DefaultMailExcel : IFlatbufferObject
{
  ...
  public Global.MailType MailType { get { int o = __p.__offset(8); return o != 0 ? (Global.MailType)__p.bb.GetInt(o + __p.bb_pos) : Global.MailType.System; } }
  ...
  public static Offset<Global.DefaultMailExcel> CreateDefaultMailExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddMailType(FlatBufferBuilder builder, Global.MailType mailType) { builder.AddInt(2, (int)mailType, 0); }
  ...
  public static Offset<Global.DefaultMailExcel> EndDefaultMailExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.DefaultMailExcel>(o);
  }
  ...
  public static Offset<Global.DefaultMailExcel> Pack(FlatBufferBuilder builder, DefaultMailExcelT _o) {
    if (_o == null) return default(Offset<Global.DefaultMailExcel>);
		byte[] key = TableEncryptionService.CreateKey("DefaultMail");
...
static public class DefaultMailExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*MailType*/, 4 /*Global.MailType*/, 4, false)
