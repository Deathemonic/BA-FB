...
public struct ProductSelectExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.ProductSelectExcel> CreateProductSelectExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Global.ProductSelectExcel> EndProductSelectExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.ProductSelectExcel>(o);
  }
  ...
  public static Offset<Global.ProductSelectExcel> Pack(FlatBufferBuilder builder, ProductSelectExcelT _o) {
    if (_o == null) return default(Offset<Global.ProductSelectExcel>);
		byte[] key = TableEncryptionService.CreateKey("ProductSelect");
