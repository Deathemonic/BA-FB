...
public struct BuffParticleExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.BuffParticleExcel> CreateBuffParticleExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
  ...
  public static Offset<Global.BuffParticleExcel> EndBuffParticleExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.BuffParticleExcel>(o);
  }
  ...
  public void UnPackTo(BuffParticleExcelT _o) {
    ...
    _o.UniqueName = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.UniqueName, key) : this.UniqueName;
    _o.BuffType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BuffType, key) : this.BuffType;
    _o.BuffName = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BuffName, key) : this.BuffName;
  ...
  public static Offset<Global.BuffParticleExcel> Pack(FlatBufferBuilder builder, BuffParticleExcelT _o) {
    if (_o == null) return default(Offset<Global.BuffParticleExcel>);
		byte[] key = TableEncryptionService.CreateKey("BuffParticle");
		var _UniqueId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.UniqueId, key) : _o.UniqueId;
    var _UniqueName = _o.UniqueName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.UniqueName, key) : _o.UniqueName));
    var _BuffType = _o.BuffType == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.BuffType, key) : _o.BuffType));
    var _BuffName = _o.BuffName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.BuffName, key) : _o.BuffName));
    var _ResourcePath = _o.ResourcePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ResourcePath, key) : _o.ResourcePath));
