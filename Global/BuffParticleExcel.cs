...
public struct BuffParticleExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.BuffParticleExcel> Pack(FlatBufferBuilder builder, BuffParticleExcelT _o) {
    ...
    var _UniqueName = _o.UniqueName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.UniqueName, key) : _o.UniqueName));
    var _BuffType = _o.BuffType == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.BuffType, key) : _o.BuffType));
    var _BuffName = _o.BuffName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.BuffName, key) : _o.BuffName));
