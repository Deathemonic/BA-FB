...
public struct MinigameTBGDiceExcel : IFlatbufferObject
{
  ...
  public Global.TBGProbModifyCondition ProbModifyCondition(int j) { int o = __p.__offset(14); return o != 0 ? (Global.TBGProbModifyCondition)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Global.TBGProbModifyCondition)0; }
  public int ProbModifyConditionLength { get { int o = __p.__offset(14); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Global.TBGProbModifyCondition> GetProbModifyConditionBytes() { return __p.__vector_as_span<Global.TBGProbModifyCondition>(14, 4); }
#else
  public ArraySegment<byte>? GetProbModifyConditionBytes() { return __p.__vector_as_arraysegment(14); }
#endif
  public Global.TBGProbModifyCondition[] GetProbModifyConditionArray() { int o = __p.__offset(14); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Global.TBGProbModifyCondition[] a = new Global.TBGProbModifyCondition[l]; for (int i = 0; i < l; i++) { a[i] = (Global.TBGProbModifyCondition)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Global.MinigameTBGDiceExcel> CreateMinigameTBGDiceExcel(FlatBufferBuilder builder,
  ...
  public static VectorOffset CreateProbModifyConditionVector(FlatBufferBuilder builder, Global.TBGProbModifyCondition[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateProbModifyConditionVectorBlock(FlatBufferBuilder builder, Global.TBGProbModifyCondition[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateProbModifyConditionVectorBlock(FlatBufferBuilder builder, ArraySegment<Global.TBGProbModifyCondition> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateProbModifyConditionVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Global.TBGProbModifyCondition>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Global.MinigameTBGDiceExcel> EndMinigameTBGDiceExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.MinigameTBGDiceExcel>(o);
  }
  ...
  public void UnPackTo(MinigameTBGDiceExcelT _o) {
    ...
    _o.DiceGroup = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.DiceGroup, key) : this.DiceGroup;
    ...
    _o.ProbModifyCondition = new List<Global.TBGProbModifyCondition>();
    for (var _j = 0; _j < this.ProbModifyConditionLength; ++_j) {_o.ProbModifyCondition.Add(TableEncryptionService.UseEncryption ? (Global.TBGProbModifyCondition)TableEncryptionService.Convert((int)this.ProbModifyCondition(_j), key) : this.ProbModifyCondition(_j));}
    _o.ProbModifyValue = new List<int>();
    for (var _j = 0; _j < this.ProbModifyValueLength; ++_j) {_o.ProbModifyValue.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.ProbModifyValue(_j), key) : this.ProbModifyValue(_j));}
    _o.ProbModifyLimit = new List<int>();
    for (var _j = 0; _j < this.ProbModifyLimitLength; ++_j) {_o.ProbModifyLimit.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.ProbModifyLimit(_j), key) : this.ProbModifyLimit(_j));}
  }
  public static Offset<Global.MinigameTBGDiceExcel> Pack(FlatBufferBuilder builder, MinigameTBGDiceExcelT _o) {
    if (_o == null) return default(Offset<Global.MinigameTBGDiceExcel>);
		byte[] key = TableEncryptionService.CreateKey("MinigameTBGDice");
		...
		var _DiceGroup = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.DiceGroup, key) : _o.DiceGroup;
    ...
    if (_o.ProbModifyCondition != null) {
      var __ProbModifyCondition = _o.ProbModifyCondition.Select(x => TableEncryptionService.UseEncryption ? (Global.TBGProbModifyCondition)TableEncryptionService.Convert((int)x, key) : x).ToArray();
    ...
    if (_o.ProbModifyValue != null) {
      var __ProbModifyValue = _o.ProbModifyValue.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)x, key) : x).ToArray();
    ...
    if (_o.ProbModifyLimit != null) {
      var __ProbModifyLimit = _o.ProbModifyLimit.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)x, key) : x).ToArray();
...
public class MinigameTBGDiceExcelT
{
  ...
  public List<Global.TBGProbModifyCondition> ProbModifyCondition { get; set; }
...
static public class MinigameTBGDiceExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 14 /*ProbModifyCondition*/, 4 /*Global.TBGProbModifyCondition*/, false)
