...
public struct GachaElementRecursiveExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.GachaElementRecursiveExcel> CreateGachaElementRecursiveExcel(FlatBufferBuilder builder,
      long ID = 0,
      long GachaGroupID = 0,
  ...
  public static Offset<Global.GachaElementRecursiveExcel> EndGachaElementRecursiveExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.GachaElementRecursiveExcel>(o);
  }
  ...
  public static Offset<Global.GachaElementRecursiveExcel> Pack(FlatBufferBuilder builder, GachaElementRecursiveExcelT _o) {
    if (_o == null) return default(Offset<Global.GachaElementRecursiveExcel>);
		byte[] key = TableEncryptionService.CreateKey("GachaElementRecursive");
