...
public struct Position : IFlatbufferObject
{
  ...
  public static Offset<Global.Position> CreatePosition(FlatBufferBuilder builder,
      float X = 0.0f,
      float Z = 0.0f) {
  ...
  public static Offset<Global.Position> EndPosition(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.Position>(o);
  }
  ...
  public void UnPackTo(PositionT _o) {
		byte[] key = TableEncryptionService.CreateKey("Pos");
  ...
  public static Offset<Global.Position> Pack(FlatBufferBuilder builder, PositionT _o) {
    if (_o == null) return default(Offset<Global.Position>);
		byte[] key = TableEncryptionService.CreateKey("Pos");
