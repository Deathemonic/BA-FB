...
public struct ObstacleStatExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.ObstacleStatExcel> CreateObstacleStatExcel(FlatBufferBuilder builder,
      uint StringID = 0,
  ...
  public static Offset<Global.ObstacleStatExcel> EndObstacleStatExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.ObstacleStatExcel>(o);
  }
  ...
  public void UnPackTo(ObstacleStatExcelT _o) {
    ...
    _o.Dodge = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Dodge, key) : this.Dodge;
    _o.CanNotStandRange = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CanNotStandRange, key) : this.CanNotStandRange;
  ...
  public static Offset<Global.ObstacleStatExcel> Pack(FlatBufferBuilder builder, ObstacleStatExcelT _o) {
    if (_o == null) return default(Offset<Global.ObstacleStatExcel>);
		byte[] key = TableEncryptionService.CreateKey("ObstacleStat");
    ...
    var _Name = _o.Name == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.Name, key) : _o.Name));
		...
		var _Dodge = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Dodge, key) : _o.Dodge;
		var _CanNotStandRange = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CanNotStandRange, key) : _o.CanNotStandRange;
    ...
    return CreateObstacleStatExcel(
      ...
      TableEncryptionService.UseEncryption ? _Dodge : _o.Dodge,
      TableEncryptionService.UseEncryption ? _CanNotStandRange : _o.CanNotStandRange,
