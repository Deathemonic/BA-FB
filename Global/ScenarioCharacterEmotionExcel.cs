...
public struct ScenarioCharacterEmotionExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.ScenarioCharacterEmotionExcel> CreateScenarioCharacterEmotionExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.ScenarioCharacterEmotionExcel> EndScenarioCharacterEmotionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.ScenarioCharacterEmotionExcel>(o);
  }
  ...
  public void UnPackTo(ScenarioCharacterEmotionExcelT _o) {
    ...
    _o.EmoticonName = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EmoticonName, key) : this.EmoticonName;
    _o.Name = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Name, key) : this.Name;
  }
  public static Offset<Global.ScenarioCharacterEmotionExcel> Pack(FlatBufferBuilder builder, ScenarioCharacterEmotionExcelT _o) {
    if (_o == null) return default(Offset<Global.ScenarioCharacterEmotionExcel>);
		byte[] key = TableEncryptionService.CreateKey("ScenarioCharacterEmotion");
    var _EmoticonName = _o.EmoticonName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.EmoticonName, key) : _o.EmoticonName));
