...
public struct MessagePopupExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(MessagePopupExcelT _o) {
    ...
    _o.MessagePopupLayout = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MessagePopupLayout, key) : this.MessagePopupLayout;
    _o.OrderType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.OrderType, key) : this.OrderType;
    _o.Image = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Image, key) : this.Image;
    _o.TitleText = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.TitleText, key) : this.TitleText;
    _o.SubTitleText = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SubTitleText, key) : this.SubTitleText;
    _o.MessageText = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MessageText, key) : this.MessageText;
    _o.ConditionText = new List<uint>();
    for (var _j = 0; _j < this.ConditionTextLength; ++_j) {_o.ConditionText.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ConditionText(_j), key) : this.ConditionText(_j));}
    _o.DisplayXButton = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.DisplayXButton, key) : this.DisplayXButton;
    _o.Button = new List<Global.MessagePopupButtonType>();
    for (var _j = 0; _j < this.ButtonLength; ++_j) {_o.Button.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Button(_j), key) : this.Button(_j));}
    _o.ButtonText = new List<uint>();
    for (var _j = 0; _j < this.ButtonTextLength; ++_j) {_o.ButtonText.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ButtonText(_j), key) : this.ButtonText(_j));}
  ...
  public static Offset<Global.MessagePopupExcel> Pack(FlatBufferBuilder builder, MessagePopupExcelT _o) {
    if (_o == null) return default(Offset<Global.MessagePopupExcel>);
		...
		var _MessagePopupLayout = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MessagePopupLayout, key) : _o.MessagePopupLayout;
		var _OrderType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.OrderType, key) : _o.OrderType;
    var _Image = _o.Image == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.Image, key) : _o.Image));
		var _TitleText = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.TitleText, key) : _o.TitleText;
		var _SubTitleText = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.SubTitleText, key) : _o.SubTitleText;
		var _MessageText = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MessageText, key) : _o.MessageText;
    var _ConditionText = default(VectorOffset);
    if (_o.ConditionText != null) {
      var __ConditionText = _o.ConditionText.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
      _ConditionText = CreateConditionTextVector(builder, __ConditionText);
    }
		var _DisplayXButton = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DisplayXButton, key) : _o.DisplayXButton;
    var _Button = default(VectorOffset);
    if (_o.Button != null) {
      var __Button = _o.Button.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
      _Button = CreateButtonVector(builder, __Button);
    }
    var _ButtonText = default(VectorOffset);
    if (_o.ButtonText != null) {
      var __ButtonText = _o.ButtonText.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.ButtonCommand != null) {
      ...
      for (var _j = 0; _j < __ButtonCommand.Length; ++_j) { __ButtonCommand[_j] = builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ButtonCommand[_j], key) : _o.ButtonCommand[_j])); }
    ...
    if (_o.ButtonParameter != null) {
      ...
      for (var _j = 0; _j < __ButtonParameter.Length; ++_j) { __ButtonParameter[_j] = builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ButtonParameter[_j], key) : _o.ButtonParameter[_j])); }
