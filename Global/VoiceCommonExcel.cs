...
public struct VoiceCommonExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(VoiceCommonExcelT _o) {
    ...
    _o.VoiceEvent = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.VoiceEvent, key) : this.VoiceEvent;
  ...
  public static Offset<Global.VoiceCommonExcel> Pack(FlatBufferBuilder builder, VoiceCommonExcelT _o) {
    if (_o == null) return default(Offset<Global.VoiceCommonExcel>);
		byte[] key = TableEncryptionService.CreateKey("VoiceCommon");
		var _VoiceEvent = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.VoiceEvent, key) : _o.VoiceEvent;
		var _Rate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Rate, key) : _o.Rate;
