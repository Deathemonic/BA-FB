...
public struct VoiceCommonExcel : IFlatbufferObject
{
  ...
  public Global.VoiceEvent VoiceEvent { get { int o = __p.__offset(4); return o != 0 ? (Global.VoiceEvent)__p.bb.GetInt(o + __p.bb_pos) : Global.VoiceEvent.OnTSA; } }
  ...
  public static Offset<Global.VoiceCommonExcel> CreateVoiceCommonExcel(FlatBufferBuilder builder,
      Global.VoiceEvent VoiceEvent = Global.VoiceEvent.OnTSA,
      long Rate = 0,
  ...
  public static void AddVoiceEvent(FlatBufferBuilder builder, Global.VoiceEvent voiceEvent) { builder.AddInt(0, (int)voiceEvent, 0); }
  ...
  public static Offset<Global.VoiceCommonExcel> EndVoiceCommonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.VoiceCommonExcel>(o);
  }
  ...
  public void UnPackTo(VoiceCommonExcelT _o) {
    ...
    _o.VoiceEvent = TableEncryptionService.UseEncryption ? (Global.VoiceEvent)TableEncryptionService.Convert((int)this.VoiceEvent, key) : this.VoiceEvent;
    _o.Rate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.Rate, key) : this.Rate;
  ...
  public static Offset<Global.VoiceCommonExcel> Pack(FlatBufferBuilder builder, VoiceCommonExcelT _o) {
    if (_o == null) return default(Offset<Global.VoiceCommonExcel>);
		byte[] key = TableEncryptionService.CreateKey("VoiceCommon");
		var _VoiceEvent = TableEncryptionService.UseEncryption ? (Global.VoiceEvent)TableEncryptionService.Convert((int)_o.VoiceEvent, key) : _o.VoiceEvent;
		var _Rate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.Rate, key) : _o.Rate;
    ...
    return CreateVoiceCommonExcel(
      builder,
      TableEncryptionService.UseEncryption ? _VoiceEvent : _o.VoiceEvent,
...
{
  public Global.VoiceEvent VoiceEvent { get; set; }
  public long Rate { get; set; }
  public List<uint> VoiceHash { get; set; }

  public VoiceCommonExcelT() {
    this.VoiceEvent = Global.VoiceEvent.OnTSA;
    this.Rate = 0;
    this.VoiceHash = null;
  }
}
...
static public class VoiceCommonExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyField(tablePos, 4 /*VoiceEvent*/, 4 /*Global.VoiceEvent*/, 4, false)
