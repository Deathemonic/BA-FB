...
public struct MultiFloorRaidStatChangeExcel : IFlatbufferObject
{
  ...
  public Global.StatType StatType(int j) { int o = __p.__offset(6); return o != 0 ? (Global.StatType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Global.StatType)0; }
  public int StatTypeLength { get { int o = __p.__offset(6); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Global.StatType> GetStatTypeBytes() { return __p.__vector_as_span<Global.StatType>(6, 4); }
#else
  public ArraySegment<byte>? GetStatTypeBytes() { return __p.__vector_as_arraysegment(6); }
#endif
  public Global.StatType[] GetStatTypeArray() { int o = __p.__offset(6); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Global.StatType[] a = new Global.StatType[l]; for (int i = 0; i < l; i++) { a[i] = (Global.StatType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Global.MultiFloorRaidStatChangeExcel> CreateMultiFloorRaidStatChangeExcel(FlatBufferBuilder builder,
      long StatChangeId = 0,
  ...
  public static VectorOffset CreateStatTypeVector(FlatBufferBuilder builder, Global.StatType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateStatTypeVectorBlock(FlatBufferBuilder builder, Global.StatType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateStatTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Global.StatType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateStatTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Global.StatType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Global.MultiFloorRaidStatChangeExcel> EndMultiFloorRaidStatChangeExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.MultiFloorRaidStatChangeExcel>(o);
  }
  ...
  public void UnPackTo(MultiFloorRaidStatChangeExcelT _o) {
    ...
    _o.StatChangeId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.StatChangeId, key) : this.StatChangeId;
    _o.StatType = new List<Global.StatType>();
    for (var _j = 0; _j < this.StatTypeLength; ++_j) {_o.StatType.Add(TableEncryptionService.UseEncryption ? (Global.StatType)TableEncryptionService.Convert((int)this.StatType(_j), key) : this.StatType(_j));}
    _o.StatAdd = new List<long>();
    for (var _j = 0; _j < this.StatAddLength; ++_j) {_o.StatAdd.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.StatAdd(_j), key) : this.StatAdd(_j));}
    _o.StatMultiply = new List<long>();
    for (var _j = 0; _j < this.StatMultiplyLength; ++_j) {_o.StatMultiply.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.StatMultiply(_j), key) : this.StatMultiply(_j));}
    _o.ApplyCharacterId = new List<long>();
    for (var _j = 0; _j < this.ApplyCharacterIdLength; ++_j) {_o.ApplyCharacterId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ApplyCharacterId(_j), key) : this.ApplyCharacterId(_j));}
  }
  public static Offset<Global.MultiFloorRaidStatChangeExcel> Pack(FlatBufferBuilder builder, MultiFloorRaidStatChangeExcelT _o) {
    if (_o == null) return default(Offset<Global.MultiFloorRaidStatChangeExcel>);
		byte[] key = TableEncryptionService.CreateKey("MultiFloorRaidStatChange");
		var _StatChangeId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.StatChangeId, key) : _o.StatChangeId;
    var _StatType = default(VectorOffset);
    if (_o.StatType != null) {
      var __StatType = _o.StatType.Select(x => TableEncryptionService.UseEncryption ? (Global.StatType)TableEncryptionService.Convert((int)x, key) : x).ToArray();
      _StatType = CreateStatTypeVector(builder, __StatType);
    }
    var _StatAdd = default(VectorOffset);
    if (_o.StatAdd != null) {
      var __StatAdd = _o.StatAdd.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
      _StatAdd = CreateStatAddVector(builder, __StatAdd);
    }
    var _StatMultiply = default(VectorOffset);
    if (_o.StatMultiply != null) {
      var __StatMultiply = _o.StatMultiply.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
    ...
    if (_o.ApplyCharacterId != null) {
      var __ApplyCharacterId = _o.ApplyCharacterId.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
      _ApplyCharacterId = CreateApplyCharacterIdVector(builder, __ApplyCharacterId);
    }
    return CreateMultiFloorRaidStatChangeExcel(
      builder,
      TableEncryptionService.UseEncryption ? _StatChangeId : _o.StatChangeId,
      _StatType,
      _StatAdd,
      _StatMultiply,
      _ApplyCharacterId);
...
public class MultiFloorRaidStatChangeExcelT
{
  ...
  public List<Global.StatType> StatType { get; set; }
...
static public class MultiFloorRaidStatChangeExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 6 /*StatType*/, 4 /*Global.StatType*/, false)
