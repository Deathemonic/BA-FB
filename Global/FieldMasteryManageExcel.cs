...
public struct FieldMasteryManageExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(FieldMasteryManageExcelT _o) {
    ...
    _o.FieldSeason = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.FieldSeason, key) : this.FieldSeason;
    _o.LocalizeEtc = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)this.LocalizeEtc, key) : this.LocalizeEtc;
  ...
  public static Offset<Global.FieldMasteryManageExcel> Pack(FlatBufferBuilder builder, FieldMasteryManageExcelT _o) {
    if (_o == null) return default(Offset<Global.FieldMasteryManageExcel>);
		byte[] key = TableEncryptionService.CreateKey("FieldMasteryManage");
		var _FieldSeason = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.FieldSeason, key) : _o.FieldSeason;
		var _LocalizeEtc = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)_o.LocalizeEtc, key) : _o.LocalizeEtc;
