...
public struct CharacterDialogSubtitleExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.CharacterDialogSubtitleExcel> CreateCharacterDialogSubtitleExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.CharacterDialogSubtitleExcel> EndCharacterDialogSubtitleExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.CharacterDialogSubtitleExcel>(o);
  }
  ...
  public static Offset<Global.CharacterDialogSubtitleExcel> Pack(FlatBufferBuilder builder, CharacterDialogSubtitleExcelT _o) {
    if (_o == null) return default(Offset<Global.CharacterDialogSubtitleExcel>);
		byte[] key = TableEncryptionService.CreateKey("CharacterDialogSubtitle");
