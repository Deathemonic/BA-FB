...
public struct MiniGameRhythmExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(MiniGameRhythmExcelT _o) {
    ...
    _o.StageDifficulty = TableEncryptionService.UseEncryption ? (Global.Difficulty)TableEncryptionService.Convert((int)this.StageDifficulty, key) : this.StageDifficulty;
  ...
  public static Offset<Global.MiniGameRhythmExcel> Pack(FlatBufferBuilder builder, MiniGameRhythmExcelT _o) {
    ...
    var _PresetName = _o.PresetName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.PresetName, key) : _o.PresetName));
		var _StageDifficulty = TableEncryptionService.UseEncryption ? (Global.Difficulty)TableEncryptionService.Convert((int)_o.StageDifficulty, key) : _o.StageDifficulty;
