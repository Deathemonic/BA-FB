...
public struct MiniGameRhythmExcel : IFlatbufferObject
{
  ...
  public Global.Difficulty StageDifficulty { get { int o = __p.__offset(10); return o != 0 ? (Global.Difficulty)__p.bb.GetInt(o + __p.bb_pos) : Global.Difficulty.Normal; } }
  ...
  public static Offset<Global.MiniGameRhythmExcel> CreateMiniGameRhythmExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      long RhythmBgmId = 0,
      StringOffset PresetNameOffset = default(StringOffset),
      Global.Difficulty StageDifficulty = Global.Difficulty.Normal,
  ...
  public static void AddStageDifficulty(FlatBufferBuilder builder, Global.Difficulty stageDifficulty) { builder.AddInt(3, (int)stageDifficulty, 0); }
  ...
  public static Offset<Global.MiniGameRhythmExcel> EndMiniGameRhythmExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.MiniGameRhythmExcel>(o);
  }
  ...
  public void UnPackTo(MiniGameRhythmExcelT _o) {
    ...
    _o.RhythmBgmId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.RhythmBgmId, key) : this.RhythmBgmId;
    ...
    _o.IsSpecial = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.IsSpecial, key) : this.IsSpecial;
    _o.OpenStageScoreAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.OpenStageScoreAmount, key) : this.OpenStageScoreAmount;
    _o.MaxHp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MaxHp, key) : this.MaxHp;
    _o.MissDamage = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MissDamage, key) : this.MissDamage;
    _o.CriticalHPRestoreValue = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CriticalHPRestoreValue, key) : this.CriticalHPRestoreValue;
    _o.MaxScore = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MaxScore, key) : this.MaxScore;
    _o.FeverScoreRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.FeverScoreRate, key) : this.FeverScoreRate;
    _o.NoteScoreRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.NoteScoreRate, key) : this.NoteScoreRate;
    _o.ComboScoreRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ComboScoreRate, key) : this.ComboScoreRate;
    _o.AttackScoreRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.AttackScoreRate, key) : this.AttackScoreRate;
    _o.FeverCriticalRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.FeverCriticalRate, key) : this.FeverCriticalRate;
    _o.FeverAttackRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.FeverAttackRate, key) : this.FeverAttackRate;
    _o.MaxHpScore = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MaxHpScore, key) : this.MaxHpScore;
  ...
  public static Offset<Global.MiniGameRhythmExcel> Pack(FlatBufferBuilder builder, MiniGameRhythmExcelT _o) {
    if (_o == null) return default(Offset<Global.MiniGameRhythmExcel>);
		byte[] key = TableEncryptionService.CreateKey("MiniGameRhythm");
		var _UniqueId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.UniqueId, key) : _o.UniqueId;
		var _RhythmBgmId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RhythmBgmId, key) : _o.RhythmBgmId;
    var _PresetName = _o.PresetName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.PresetName, key) : _o.PresetName));
		...
		var _IsSpecial = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IsSpecial, key) : _o.IsSpecial;
		var _OpenStageScoreAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.OpenStageScoreAmount, key) : _o.OpenStageScoreAmount;
		var _MaxHp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MaxHp, key) : _o.MaxHp;
		var _MissDamage = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MissDamage, key) : _o.MissDamage;
		var _CriticalHPRestoreValue = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CriticalHPRestoreValue, key) : _o.CriticalHPRestoreValue;
		var _MaxScore = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MaxScore, key) : _o.MaxScore;
		var _FeverScoreRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.FeverScoreRate, key) : _o.FeverScoreRate;
		var _NoteScoreRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.NoteScoreRate, key) : _o.NoteScoreRate;
		var _ComboScoreRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ComboScoreRate, key) : _o.ComboScoreRate;
		var _AttackScoreRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.AttackScoreRate, key) : _o.AttackScoreRate;
		var _FeverCriticalRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.FeverCriticalRate, key) : _o.FeverCriticalRate;
		var _FeverAttackRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.FeverAttackRate, key) : _o.FeverAttackRate;
		var _MaxHpScore = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MaxHpScore, key) : _o.MaxHpScore;
    var _RhythmFileName = _o.RhythmFileName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.RhythmFileName, key) : _o.RhythmFileName));
    var _ArtLevelSceneName = _o.ArtLevelSceneName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ArtLevelSceneName, key) : _o.ArtLevelSceneName));
    var _ComboImagePath = _o.ComboImagePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ComboImagePath, key) : _o.ComboImagePath));
...
public class MiniGameRhythmExcelT
{
  ...
  public Global.Difficulty StageDifficulty { get; set; }
  ...
  public MiniGameRhythmExcelT() {
    ...
    this.StageDifficulty = Global.Difficulty.Normal;
...
static public class MiniGameRhythmExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*StageDifficulty*/, 4 /*Global.Difficulty*/, 4, false)
