...
public struct ContentsScenarioExcel : IFlatbufferObject
{
  ...
  public Global.ScenarioContentType ScenarioContentType { get { int o = __p.__offset(10); return o != 0 ? (Global.ScenarioContentType)__p.bb.GetInt(o + __p.bb_pos) : Global.ScenarioContentType.Prologue; } }
  ...
  public static Offset<Global.ContentsScenarioExcel> CreateContentsScenarioExcel(FlatBufferBuilder builder,
      uint Id = 0,
      uint LocalizeId = 0,
      int DisplayOrder = 0,
      Global.ScenarioContentType ScenarioContentType = Global.ScenarioContentType.Prologue,
  ...
  public static void AddScenarioContentType(FlatBufferBuilder builder, Global.ScenarioContentType scenarioContentType) { builder.AddInt(3, (int)scenarioContentType, 0); }
  ...
  public static Offset<Global.ContentsScenarioExcel> EndContentsScenarioExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.ContentsScenarioExcel>(o);
  }
  ...
  public void UnPackTo(ContentsScenarioExcelT _o) {
    ...
    _o.ScenarioContentType = TableEncryptionService.UseEncryption ? (Global.ScenarioContentType)TableEncryptionService.Convert((int)this.ScenarioContentType, key) : this.ScenarioContentType;
  ...
  public static Offset<Global.ContentsScenarioExcel> Pack(FlatBufferBuilder builder, ContentsScenarioExcelT _o) {
    if (_o == null) return default(Offset<Global.ContentsScenarioExcel>);
		byte[] key = TableEncryptionService.CreateKey("ContentsScenario");
		...
		var _ScenarioContentType = TableEncryptionService.UseEncryption ? (Global.ScenarioContentType)TableEncryptionService.Convert((int)_o.ScenarioContentType, key) : _o.ScenarioContentType;
    ...
    return CreateContentsScenarioExcel(
      ...
      TableEncryptionService.UseEncryption ? _ScenarioContentType : _o.ScenarioContentType,
      _ScenarioGroupId);
  }
}
...
public class ContentsScenarioExcelT
{
  ...
  public Global.ScenarioContentType ScenarioContentType { get; set; }
  ...
  public ContentsScenarioExcelT() {
    ...
    this.LocalizeId = 0;
    this.DisplayOrder = 0;
    this.ScenarioContentType = Global.ScenarioContentType.Prologue;
...
static public class ContentsScenarioExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*ScenarioContentType*/, 4 /*Global.ScenarioContentType*/, 4, false)
