...
public struct ContentsScenarioExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ContentsScenarioExcelT _o) {
    ...
    _o.ScenarioContentType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ScenarioContentType, key) : this.ScenarioContentType;
  ...
  public static Offset<Global.ContentsScenarioExcel> Pack(FlatBufferBuilder builder, ContentsScenarioExcelT _o) {
    if (_o == null) return default(Offset<Global.ContentsScenarioExcel>);
		...
		var _LocalizeId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.LocalizeId, key) : _o.LocalizeId;
		...
		var _ScenarioContentType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ScenarioContentType, key) : _o.ScenarioContentType;
