...
public struct MinigameTBGEncounterOptionExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.MinigameTBGEncounterOptionExcel> CreateMinigameTBGEncounterOptionExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.MinigameTBGEncounterOptionExcel> EndMinigameTBGEncounterOptionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.MinigameTBGEncounterOptionExcel>(o);
  }
  ...
  public void UnPackTo(MinigameTBGEncounterOptionExcelT _o) {
    ...
    _o.SlotIndex = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SlotIndex, key) : this.SlotIndex;
    _o.OptionTitleLocalize = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.OptionTitleLocalize, key) : this.OptionTitleLocalize;
    _o.OptionSuccessLocalize = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.OptionSuccessLocalize, key) : this.OptionSuccessLocalize;
    _o.OptionSuccessRewardGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.OptionSuccessRewardGroupId, key) : this.OptionSuccessRewardGroupId;
    _o.OptionSuccessOrHigherDiceCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.OptionSuccessOrHigherDiceCount, key) : this.OptionSuccessOrHigherDiceCount;
    _o.OptionGreatSuccessOrHigherDiceCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.OptionGreatSuccessOrHigherDiceCount, key) : this.OptionGreatSuccessOrHigherDiceCount;
    _o.OptionFailLocalize = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.OptionFailLocalize, key) : this.OptionFailLocalize;
    _o.OptionFailLessDiceCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.OptionFailLessDiceCount, key) : this.OptionFailLessDiceCount;
    _o.RunawayOrHigherDiceCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.RunawayOrHigherDiceCount, key) : this.RunawayOrHigherDiceCount;
    _o.RewardHide = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.RewardHide, key) : this.RewardHide;
  }
  public static Offset<Global.MinigameTBGEncounterOptionExcel> Pack(FlatBufferBuilder builder, MinigameTBGEncounterOptionExcelT _o) {
    if (_o == null) return default(Offset<Global.MinigameTBGEncounterOptionExcel>);
		byte[] key = TableEncryptionService.CreateKey("MinigameTBGEncounterOption");
		...
		var _SlotIndex = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.SlotIndex, key) : _o.SlotIndex;
    var _OptionTitleLocalize = _o.OptionTitleLocalize == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.OptionTitleLocalize, key) : _o.OptionTitleLocalize));
    var _OptionSuccessLocalize = _o.OptionSuccessLocalize == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.OptionSuccessLocalize, key) : _o.OptionSuccessLocalize));
		var _OptionSuccessRewardGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.OptionSuccessRewardGroupId, key) : _o.OptionSuccessRewardGroupId;
		var _OptionSuccessOrHigherDiceCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.OptionSuccessOrHigherDiceCount, key) : _o.OptionSuccessOrHigherDiceCount;
		var _OptionGreatSuccessOrHigherDiceCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.OptionGreatSuccessOrHigherDiceCount, key) : _o.OptionGreatSuccessOrHigherDiceCount;
    var _OptionFailLocalize = _o.OptionFailLocalize == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.OptionFailLocalize, key) : _o.OptionFailLocalize));
		var _OptionFailLessDiceCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.OptionFailLessDiceCount, key) : _o.OptionFailLessDiceCount;
		var _RunawayOrHigherDiceCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RunawayOrHigherDiceCount, key) : _o.RunawayOrHigherDiceCount;
    ...
    return CreateMinigameTBGEncounterOptionExcel(
      ...
      TableEncryptionService.UseEncryption ? _SlotIndex : _o.SlotIndex,
      _OptionTitleLocalize,
      _OptionSuccessLocalize,
      TableEncryptionService.UseEncryption ? _OptionSuccessRewardGroupId : _o.OptionSuccessRewardGroupId,
      TableEncryptionService.UseEncryption ? _OptionSuccessOrHigherDiceCount : _o.OptionSuccessOrHigherDiceCount,
      TableEncryptionService.UseEncryption ? _OptionGreatSuccessOrHigherDiceCount : _o.OptionGreatSuccessOrHigherDiceCount,
      _OptionFailLocalize,
      TableEncryptionService.UseEncryption ? _OptionFailLessDiceCount : _o.OptionFailLessDiceCount,
      TableEncryptionService.UseEncryption ? _RunawayOrHigherDiceCount : _o.RunawayOrHigherDiceCount,
