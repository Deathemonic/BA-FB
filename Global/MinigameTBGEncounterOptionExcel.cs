...
public struct MinigameTBGEncounterOptionExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(MinigameTBGEncounterOptionExcelT _o) {
    ...
    _o.SlotIndex = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.SlotIndex, key) : this.SlotIndex;
    ...
    _o.OptionSuccessRewardGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.OptionSuccessRewardGroupId, key) : this.OptionSuccessRewardGroupId;
    _o.OptionSuccessOrHigherDiceCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.OptionSuccessOrHigherDiceCount, key) : this.OptionSuccessOrHigherDiceCount;
    _o.OptionGreatSuccessOrHigherDiceCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.OptionGreatSuccessOrHigherDiceCount, key) : this.OptionGreatSuccessOrHigherDiceCount;
    ...
    _o.OptionFailLessDiceCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.OptionFailLessDiceCount, key) : this.OptionFailLessDiceCount;
    _o.RunawayOrHigherDiceCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.RunawayOrHigherDiceCount, key) : this.RunawayOrHigherDiceCount;
  ...
  public static Offset<Global.MinigameTBGEncounterOptionExcel> Pack(FlatBufferBuilder builder, MinigameTBGEncounterOptionExcelT _o) {
    if (_o == null) return default(Offset<Global.MinigameTBGEncounterOptionExcel>);
		...
		var _SlotIndex = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.SlotIndex, key) : _o.SlotIndex;
    var _OptionTitleLocalize = _o.OptionTitleLocalize == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.OptionTitleLocalize, key) : _o.OptionTitleLocalize));
    var _OptionSuccessLocalize = _o.OptionSuccessLocalize == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.OptionSuccessLocalize, key) : _o.OptionSuccessLocalize));
		var _OptionSuccessRewardGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.OptionSuccessRewardGroupId, key) : _o.OptionSuccessRewardGroupId;
		var _OptionSuccessOrHigherDiceCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.OptionSuccessOrHigherDiceCount, key) : _o.OptionSuccessOrHigherDiceCount;
		var _OptionGreatSuccessOrHigherDiceCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.OptionGreatSuccessOrHigherDiceCount, key) : _o.OptionGreatSuccessOrHigherDiceCount;
    var _OptionFailLocalize = _o.OptionFailLocalize == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.OptionFailLocalize, key) : _o.OptionFailLocalize));
		var _OptionFailLessDiceCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.OptionFailLessDiceCount, key) : _o.OptionFailLessDiceCount;
		var _RunawayOrHigherDiceCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.RunawayOrHigherDiceCount, key) : _o.RunawayOrHigherDiceCount;
