...
public struct MiniGameDreamScheduleResultExcel : IFlatbufferObject
{
  ...
  public Global.DreamMakerResult DreamMakerResult { get { int o = __p.__offset(8); return o != 0 ? (Global.DreamMakerResult)__p.bb.GetInt(o + __p.bb_pos) : Global.DreamMakerResult.None; } }
  ...
  public Global.DreamMakerParameterType RewardParameter(int j) { int o = __p.__offset(14); return o != 0 ? (Global.DreamMakerParameterType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Global.DreamMakerParameterType)0; }
  public int RewardParameterLength { get { int o = __p.__offset(14); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Global.DreamMakerParameterType> GetRewardParameterBytes() { return __p.__vector_as_span<Global.DreamMakerParameterType>(14, 4); }
#else
  public ArraySegment<byte>? GetRewardParameterBytes() { return __p.__vector_as_arraysegment(14); }
#endif
  public Global.DreamMakerParameterType[] GetRewardParameterArray() { int o = __p.__offset(14); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Global.DreamMakerParameterType[] a = new Global.DreamMakerParameterType[l]; for (int i = 0; i < l; i++) { a[i] = (Global.DreamMakerParameterType)__p.bb.GetInt(p + i * 4); } return a; }
  public Global.DreamMakerParamOperationType RewardParameterOperationType(int j) { int o = __p.__offset(16); return o != 0 ? (Global.DreamMakerParamOperationType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Global.DreamMakerParamOperationType)0; }
  public int RewardParameterOperationTypeLength { get { int o = __p.__offset(16); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Global.DreamMakerParamOperationType> GetRewardParameterOperationTypeBytes() { return __p.__vector_as_span<Global.DreamMakerParamOperationType>(16, 4); }
#else
  public ArraySegment<byte>? GetRewardParameterOperationTypeBytes() { return __p.__vector_as_arraysegment(16); }
#endif
  public Global.DreamMakerParamOperationType[] GetRewardParameterOperationTypeArray() { int o = __p.__offset(16); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Global.DreamMakerParamOperationType[] a = new Global.DreamMakerParamOperationType[l]; for (int i = 0; i < l; i++) { a[i] = (Global.DreamMakerParamOperationType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Global.ParcelType RewardParcelType { get { int o = __p.__offset(20); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Global.ParcelType.None; } }
  ...
  public static Offset<Global.MiniGameDreamScheduleResultExcel> CreateMiniGameDreamScheduleResultExcel(FlatBufferBuilder builder,
      long Id = 0,
      long EventContentId = 0,
      Global.DreamMakerResult DreamMakerResult = Global.DreamMakerResult.None,
  ...
  public static void AddDreamMakerResult(FlatBufferBuilder builder, Global.DreamMakerResult dreamMakerResult) { builder.AddInt(2, (int)dreamMakerResult, 0); }
  ...
  public static VectorOffset CreateRewardParameterVector(FlatBufferBuilder builder, Global.DreamMakerParameterType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateRewardParameterVectorBlock(FlatBufferBuilder builder, Global.DreamMakerParameterType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateRewardParameterVectorBlock(FlatBufferBuilder builder, ArraySegment<Global.DreamMakerParameterType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateRewardParameterVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Global.DreamMakerParameterType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static VectorOffset CreateRewardParameterOperationTypeVector(FlatBufferBuilder builder, Global.DreamMakerParamOperationType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateRewardParameterOperationTypeVectorBlock(FlatBufferBuilder builder, Global.DreamMakerParamOperationType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateRewardParameterOperationTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Global.DreamMakerParamOperationType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateRewardParameterOperationTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Global.DreamMakerParamOperationType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static void AddRewardParcelType(FlatBufferBuilder builder, Global.ParcelType rewardParcelType) { builder.AddInt(8, (int)rewardParcelType, 0); }
  ...
  public static Offset<Global.MiniGameDreamScheduleResultExcel> EndMiniGameDreamScheduleResultExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.MiniGameDreamScheduleResultExcel>(o);
  }
  ...
  public void UnPackTo(MiniGameDreamScheduleResultExcelT _o) {
    ...
    _o.RewardParameter = new List<Global.DreamMakerParameterType>();
    ...
    _o.RewardParameterOperationType = new List<Global.DreamMakerParamOperationType>();
  ...
  public static Offset<Global.MiniGameDreamScheduleResultExcel> Pack(FlatBufferBuilder builder, MiniGameDreamScheduleResultExcelT _o) {
    if (_o == null) return default(Offset<Global.MiniGameDreamScheduleResultExcel>);
		byte[] key = TableEncryptionService.CreateKey("MiniGameDreamScheduleResult");
...
public class MiniGameDreamScheduleResultExcelT
{
  ...
  public Global.DreamMakerResult DreamMakerResult { get; set; }
  public long DreamMakerScheduleGroup { get; set; }
  public int Prob { get; set; }
  public List<Global.DreamMakerParameterType> RewardParameter { get; set; }
  public List<Global.DreamMakerParamOperationType> RewardParameterOperationType { get; set; }
  ...
  public MiniGameDreamScheduleResultExcelT() {
    ...
    this.DreamMakerResult = Global.DreamMakerResult.None;
...
static public class MiniGameDreamScheduleResultExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*DreamMakerResult*/, 4 /*Global.DreamMakerResult*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 14 /*RewardParameter*/, 4 /*Global.DreamMakerParameterType*/, false)
      && verifier.VerifyVectorOfData(tablePos, 16 /*RewardParameterOperationType*/, 4 /*Global.DreamMakerParamOperationType*/, false)
      && verifier.VerifyVectorOfData(tablePos, 18 /*RewardParameterAmount*/, 8 /*long*/, false)
      && verifier.VerifyField(tablePos, 20 /*RewardParcelType*/, 4 /*Global.ParcelType*/, 4, false)
