...
public struct MiniGameDreamScheduleResultExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(MiniGameDreamScheduleResultExcelT _o) {
    ...
    _o.DreamMakerResult = TableEncryptionService.UseEncryption ? (Global.DreamMakerResult)TableEncryptionService.Convert((int)this.DreamMakerResult, key) : this.DreamMakerResult;
    ...
    for (var _j = 0; _j < this.RewardParameterLength; ++_j) {_o.RewardParameter.Add(TableEncryptionService.UseEncryption ? (Global.DreamMakerParameterType)TableEncryptionService.Convert((int)this.RewardParameter(_j), key) : this.RewardParameter(_j));}
    _o.RewardParameterOperationType = new List<Global.DreamMakerParamOperationType>();
    for (var _j = 0; _j < this.RewardParameterOperationTypeLength; ++_j) {_o.RewardParameterOperationType.Add(TableEncryptionService.UseEncryption ? (Global.DreamMakerParamOperationType)TableEncryptionService.Convert((int)this.RewardParameterOperationType(_j), key) : this.RewardParameterOperationType(_j));}
  ...
  public static Offset<Global.MiniGameDreamScheduleResultExcel> Pack(FlatBufferBuilder builder, MiniGameDreamScheduleResultExcelT _o) {
    if (_o == null) return default(Offset<Global.MiniGameDreamScheduleResultExcel>);
		...
		var _DreamMakerResult = TableEncryptionService.UseEncryption ? (Global.DreamMakerResult)TableEncryptionService.Convert((int)_o.DreamMakerResult, key) : _o.DreamMakerResult;
    ...
    if (_o.RewardParameter != null) {
      var __RewardParameter = _o.RewardParameter.Select(x => TableEncryptionService.UseEncryption ? (Global.DreamMakerParameterType)TableEncryptionService.Convert((int)x, key) : x).ToArray();
    ...
    if (_o.RewardParameterOperationType != null) {
      var __RewardParameterOperationType = _o.RewardParameterOperationType.Select(x => TableEncryptionService.UseEncryption ? (Global.DreamMakerParamOperationType)TableEncryptionService.Convert((int)x, key) : x).ToArray();
