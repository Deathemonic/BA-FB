...
public struct PresetCharacterGroupExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(PresetCharacterGroupExcelT _o) {
    ...
    _o.PresetCharacterGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.PresetCharacterGroupId, key) : this.PresetCharacterGroupId;
    ...
    _o.FavorExp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.FavorExp, key) : this.FavorExp;
    _o.FavorRank = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.FavorRank, key) : this.FavorRank;
    _o.StarGrade = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StarGrade, key) : this.StarGrade;
    _o.ExSkillLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ExSkillLevel, key) : this.ExSkillLevel;
    _o.PassiveSkillLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.PassiveSkillLevel, key) : this.PassiveSkillLevel;
    _o.ExtraPassiveSkillLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ExtraPassiveSkillLevel, key) : this.ExtraPassiveSkillLevel;
    _o.CommonSkillLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CommonSkillLevel, key) : this.CommonSkillLevel;
    _o.LeaderSkillLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.LeaderSkillLevel, key) : this.LeaderSkillLevel;
    _o.EquipSlot01 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EquipSlot01, key) : this.EquipSlot01;
    _o.EquipSlotTier01 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EquipSlotTier01, key) : this.EquipSlotTier01;
    _o.EquipSlotLevel01 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EquipSlotLevel01, key) : this.EquipSlotLevel01;
    _o.EquipSlot02 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EquipSlot02, key) : this.EquipSlot02;
    _o.EquipSlotTier02 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EquipSlotTier02, key) : this.EquipSlotTier02;
    _o.EquipSlotLevel02 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EquipSlotLevel02, key) : this.EquipSlotLevel02;
    _o.EquipSlot03 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EquipSlot03, key) : this.EquipSlot03;
    _o.EquipSlotTier03 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EquipSlotTier03, key) : this.EquipSlotTier03;
    _o.EquipSlotLevel03 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EquipSlotLevel03, key) : this.EquipSlotLevel03;
    _o.EquipCharacterWeapon = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EquipCharacterWeapon, key) : this.EquipCharacterWeapon;
    _o.EquipCharacterWeaponTier = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EquipCharacterWeaponTier, key) : this.EquipCharacterWeaponTier;
    _o.EquipCharacterWeaponLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EquipCharacterWeaponLevel, key) : this.EquipCharacterWeaponLevel;
    _o.EquipCharacterGear = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EquipCharacterGear, key) : this.EquipCharacterGear;
    _o.EquipCharacterGearTier = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EquipCharacterGearTier, key) : this.EquipCharacterGearTier;
    _o.EquipCharacterGearLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EquipCharacterGearLevel, key) : this.EquipCharacterGearLevel;
    _o.PotentialType01 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.PotentialType01, key) : this.PotentialType01;
    _o.PotentialLevel01 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.PotentialLevel01, key) : this.PotentialLevel01;
    _o.PotentialType02 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.PotentialType02, key) : this.PotentialType02;
    _o.PotentialLevel02 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.PotentialLevel02, key) : this.PotentialLevel02;
    _o.PotentialType03 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.PotentialType03, key) : this.PotentialType03;
    _o.PotentialLevel03 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.PotentialLevel03, key) : this.PotentialLevel03;
  }
  public static Offset<Global.PresetCharacterGroupExcel> Pack(FlatBufferBuilder builder, PresetCharacterGroupExcelT _o) {
    if (_o == null) return default(Offset<Global.PresetCharacterGroupExcel>);
		byte[] key = TableEncryptionService.CreateKey("PresetCharacterGroup");
		var _PresetCharacterGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PresetCharacterGroupId, key) : _o.PresetCharacterGroupId;
    var _GetPresetType = _o.GetPresetType == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.GetPresetType, key) : _o.GetPresetType));
		var _Level = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Level, key) : _o.Level;
		var _Exp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Exp, key) : _o.Exp;
		var _FavorExp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.FavorExp, key) : _o.FavorExp;
		var _FavorRank = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.FavorRank, key) : _o.FavorRank;
		var _StarGrade = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StarGrade, key) : _o.StarGrade;
		var _ExSkillLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ExSkillLevel, key) : _o.ExSkillLevel;
		var _PassiveSkillLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PassiveSkillLevel, key) : _o.PassiveSkillLevel;
		var _ExtraPassiveSkillLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ExtraPassiveSkillLevel, key) : _o.ExtraPassiveSkillLevel;
		var _CommonSkillLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CommonSkillLevel, key) : _o.CommonSkillLevel;
		var _LeaderSkillLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.LeaderSkillLevel, key) : _o.LeaderSkillLevel;
		var _EquipSlot01 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EquipSlot01, key) : _o.EquipSlot01;
		var _EquipSlotTier01 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EquipSlotTier01, key) : _o.EquipSlotTier01;
		var _EquipSlotLevel01 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EquipSlotLevel01, key) : _o.EquipSlotLevel01;
		var _EquipSlot02 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EquipSlot02, key) : _o.EquipSlot02;
		var _EquipSlotTier02 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EquipSlotTier02, key) : _o.EquipSlotTier02;
		var _EquipSlotLevel02 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EquipSlotLevel02, key) : _o.EquipSlotLevel02;
		var _EquipSlot03 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EquipSlot03, key) : _o.EquipSlot03;
		var _EquipSlotTier03 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EquipSlotTier03, key) : _o.EquipSlotTier03;
		var _EquipSlotLevel03 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EquipSlotLevel03, key) : _o.EquipSlotLevel03;
		var _EquipCharacterWeapon = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EquipCharacterWeapon, key) : _o.EquipCharacterWeapon;
		var _EquipCharacterWeaponTier = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EquipCharacterWeaponTier, key) : _o.EquipCharacterWeaponTier;
		var _EquipCharacterWeaponLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EquipCharacterWeaponLevel, key) : _o.EquipCharacterWeaponLevel;
		var _EquipCharacterGear = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EquipCharacterGear, key) : _o.EquipCharacterGear;
		var _EquipCharacterGearTier = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EquipCharacterGearTier, key) : _o.EquipCharacterGearTier;
		var _EquipCharacterGearLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EquipCharacterGearLevel, key) : _o.EquipCharacterGearLevel;
		var _PotentialType01 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PotentialType01, key) : _o.PotentialType01;
		var _PotentialLevel01 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PotentialLevel01, key) : _o.PotentialLevel01;
		var _PotentialType02 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PotentialType02, key) : _o.PotentialType02;
		var _PotentialLevel02 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PotentialLevel02, key) : _o.PotentialLevel02;
		var _PotentialType03 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PotentialType03, key) : _o.PotentialType03;
		var _PotentialLevel03 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PotentialLevel03, key) : _o.PotentialLevel03;
