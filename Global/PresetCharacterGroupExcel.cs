...
public struct PresetCharacterGroupExcel : IFlatbufferObject
{
  ...
  public Global.PotentialStatBonusRateType PotentialType01 { get { int o = __p.__offset(58); return o != 0 ? (Global.PotentialStatBonusRateType)__p.bb.GetInt(o + __p.bb_pos) : Global.PotentialStatBonusRateType.None; } }
  public int PotentialLevel01 { get { int o = __p.__offset(60); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  public Global.PotentialStatBonusRateType PotentialType02 { get { int o = __p.__offset(62); return o != 0 ? (Global.PotentialStatBonusRateType)__p.bb.GetInt(o + __p.bb_pos) : Global.PotentialStatBonusRateType.None; } }
  public int PotentialLevel02 { get { int o = __p.__offset(64); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  public Global.PotentialStatBonusRateType PotentialType03 { get { int o = __p.__offset(66); return o != 0 ? (Global.PotentialStatBonusRateType)__p.bb.GetInt(o + __p.bb_pos) : Global.PotentialStatBonusRateType.None; } }
  public int PotentialLevel03 { get { int o = __p.__offset(68); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }

  public static Offset<Global.PresetCharacterGroupExcel> CreatePresetCharacterGroupExcel(FlatBufferBuilder builder,
      ...
      Global.PotentialStatBonusRateType PotentialType01 = Global.PotentialStatBonusRateType.None,
      int PotentialLevel01 = 0,
      Global.PotentialStatBonusRateType PotentialType02 = Global.PotentialStatBonusRateType.None,
      int PotentialLevel02 = 0,
      Global.PotentialStatBonusRateType PotentialType03 = Global.PotentialStatBonusRateType.None,
  ...
  public static void AddPotentialType01(FlatBufferBuilder builder, Global.PotentialStatBonusRateType potentialType01) { builder.AddInt(27, (int)potentialType01, 0); }
  ...
  public static void AddPotentialType02(FlatBufferBuilder builder, Global.PotentialStatBonusRateType potentialType02) { builder.AddInt(29, (int)potentialType02, 0); }
  ...
  public static void AddPotentialType03(FlatBufferBuilder builder, Global.PotentialStatBonusRateType potentialType03) { builder.AddInt(31, (int)potentialType03, 0); }
  ...
  public static Offset<Global.PresetCharacterGroupExcel> EndPresetCharacterGroupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.PresetCharacterGroupExcel>(o);
  }
  ...
  public void UnPackTo(PresetCharacterGroupExcelT _o) {
    ...
    _o.PresetCharacterGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.PresetCharacterGroupId, key) : this.PresetCharacterGroupId;
    _o.GetPresetType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.GetPresetType, key) : this.GetPresetType;
    _o.Level = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.Level, key) : this.Level;
    _o.Exp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.Exp, key) : this.Exp;
    _o.FavorExp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.FavorExp, key) : this.FavorExp;
    _o.FavorRank = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.FavorRank, key) : this.FavorRank;
    _o.StarGrade = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.StarGrade, key) : this.StarGrade;
    _o.ExSkillLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.ExSkillLevel, key) : this.ExSkillLevel;
    _o.PassiveSkillLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.PassiveSkillLevel, key) : this.PassiveSkillLevel;
    _o.ExtraPassiveSkillLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.ExtraPassiveSkillLevel, key) : this.ExtraPassiveSkillLevel;
    _o.CommonSkillLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.CommonSkillLevel, key) : this.CommonSkillLevel;
    _o.LeaderSkillLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.LeaderSkillLevel, key) : this.LeaderSkillLevel;
    _o.EquipSlot01 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.EquipSlot01, key) : this.EquipSlot01;
    _o.EquipSlotTier01 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.EquipSlotTier01, key) : this.EquipSlotTier01;
    _o.EquipSlotLevel01 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.EquipSlotLevel01, key) : this.EquipSlotLevel01;
    _o.EquipSlot02 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.EquipSlot02, key) : this.EquipSlot02;
    _o.EquipSlotTier02 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.EquipSlotTier02, key) : this.EquipSlotTier02;
    _o.EquipSlotLevel02 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.EquipSlotLevel02, key) : this.EquipSlotLevel02;
    _o.EquipSlot03 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.EquipSlot03, key) : this.EquipSlot03;
    _o.EquipSlotTier03 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.EquipSlotTier03, key) : this.EquipSlotTier03;
    _o.EquipSlotLevel03 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.EquipSlotLevel03, key) : this.EquipSlotLevel03;
    _o.EquipCharacterWeapon = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.EquipCharacterWeapon, key) : this.EquipCharacterWeapon;
    _o.EquipCharacterWeaponTier = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.EquipCharacterWeaponTier, key) : this.EquipCharacterWeaponTier;
    _o.EquipCharacterWeaponLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.EquipCharacterWeaponLevel, key) : this.EquipCharacterWeaponLevel;
    _o.EquipCharacterGear = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.EquipCharacterGear, key) : this.EquipCharacterGear;
    _o.EquipCharacterGearTier = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.EquipCharacterGearTier, key) : this.EquipCharacterGearTier;
    _o.EquipCharacterGearLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.EquipCharacterGearLevel, key) : this.EquipCharacterGearLevel;
    _o.PotentialType01 = TableEncryptionService.UseEncryption ? (Global.PotentialStatBonusRateType)TableEncryptionService.Convert((int)this.PotentialType01, key) : this.PotentialType01;
    _o.PotentialLevel01 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.PotentialLevel01, key) : this.PotentialLevel01;
    _o.PotentialType02 = TableEncryptionService.UseEncryption ? (Global.PotentialStatBonusRateType)TableEncryptionService.Convert((int)this.PotentialType02, key) : this.PotentialType02;
    _o.PotentialLevel02 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.PotentialLevel02, key) : this.PotentialLevel02;
    _o.PotentialType03 = TableEncryptionService.UseEncryption ? (Global.PotentialStatBonusRateType)TableEncryptionService.Convert((int)this.PotentialType03, key) : this.PotentialType03;
    _o.PotentialLevel03 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.PotentialLevel03, key) : this.PotentialLevel03;
  }
  public static Offset<Global.PresetCharacterGroupExcel> Pack(FlatBufferBuilder builder, PresetCharacterGroupExcelT _o) {
    if (_o == null) return default(Offset<Global.PresetCharacterGroupExcel>);
		byte[] key = TableEncryptionService.CreateKey("PresetCharacterGroup");
		var _PresetCharacterGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.PresetCharacterGroupId, key) : _o.PresetCharacterGroupId;
    var _GetPresetType = _o.GetPresetType == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.GetPresetType, key) : _o.GetPresetType));
		var _Level = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.Level, key) : _o.Level;
		var _Exp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.Exp, key) : _o.Exp;
		var _FavorExp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.FavorExp, key) : _o.FavorExp;
		var _FavorRank = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.FavorRank, key) : _o.FavorRank;
		var _StarGrade = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.StarGrade, key) : _o.StarGrade;
		var _ExSkillLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.ExSkillLevel, key) : _o.ExSkillLevel;
		var _PassiveSkillLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.PassiveSkillLevel, key) : _o.PassiveSkillLevel;
		var _ExtraPassiveSkillLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.ExtraPassiveSkillLevel, key) : _o.ExtraPassiveSkillLevel;
		var _CommonSkillLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.CommonSkillLevel, key) : _o.CommonSkillLevel;
		var _LeaderSkillLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.LeaderSkillLevel, key) : _o.LeaderSkillLevel;
		var _EquipSlot01 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.EquipSlot01, key) : _o.EquipSlot01;
		var _EquipSlotTier01 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.EquipSlotTier01, key) : _o.EquipSlotTier01;
		var _EquipSlotLevel01 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.EquipSlotLevel01, key) : _o.EquipSlotLevel01;
		var _EquipSlot02 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.EquipSlot02, key) : _o.EquipSlot02;
		var _EquipSlotTier02 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.EquipSlotTier02, key) : _o.EquipSlotTier02;
		var _EquipSlotLevel02 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.EquipSlotLevel02, key) : _o.EquipSlotLevel02;
		var _EquipSlot03 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.EquipSlot03, key) : _o.EquipSlot03;
		var _EquipSlotTier03 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.EquipSlotTier03, key) : _o.EquipSlotTier03;
		var _EquipSlotLevel03 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.EquipSlotLevel03, key) : _o.EquipSlotLevel03;
		var _EquipCharacterWeapon = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.EquipCharacterWeapon, key) : _o.EquipCharacterWeapon;
		var _EquipCharacterWeaponTier = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.EquipCharacterWeaponTier, key) : _o.EquipCharacterWeaponTier;
		var _EquipCharacterWeaponLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.EquipCharacterWeaponLevel, key) : _o.EquipCharacterWeaponLevel;
		var _EquipCharacterGear = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.EquipCharacterGear, key) : _o.EquipCharacterGear;
		var _EquipCharacterGearTier = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.EquipCharacterGearTier, key) : _o.EquipCharacterGearTier;
		var _EquipCharacterGearLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.EquipCharacterGearLevel, key) : _o.EquipCharacterGearLevel;
		var _PotentialType01 = TableEncryptionService.UseEncryption ? (Global.PotentialStatBonusRateType)TableEncryptionService.Convert((int)_o.PotentialType01, key) : _o.PotentialType01;
		var _PotentialLevel01 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.PotentialLevel01, key) : _o.PotentialLevel01;
		var _PotentialType02 = TableEncryptionService.UseEncryption ? (Global.PotentialStatBonusRateType)TableEncryptionService.Convert((int)_o.PotentialType02, key) : _o.PotentialType02;
		var _PotentialLevel02 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.PotentialLevel02, key) : _o.PotentialLevel02;
		var _PotentialType03 = TableEncryptionService.UseEncryption ? (Global.PotentialStatBonusRateType)TableEncryptionService.Convert((int)_o.PotentialType03, key) : _o.PotentialType03;
		var _PotentialLevel03 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.PotentialLevel03, key) : _o.PotentialLevel03;
    return CreatePresetCharacterGroupExcel(
      builder,
      TableEncryptionService.UseEncryption ? _PresetCharacterGroupId : _o.PresetCharacterGroupId,
      _GetPresetType,
      TableEncryptionService.UseEncryption ? _Level : _o.Level,
      TableEncryptionService.UseEncryption ? _Exp : _o.Exp,
      TableEncryptionService.UseEncryption ? _FavorExp : _o.FavorExp,
      TableEncryptionService.UseEncryption ? _FavorRank : _o.FavorRank,
      TableEncryptionService.UseEncryption ? _StarGrade : _o.StarGrade,
      TableEncryptionService.UseEncryption ? _ExSkillLevel : _o.ExSkillLevel,
      TableEncryptionService.UseEncryption ? _PassiveSkillLevel : _o.PassiveSkillLevel,
      TableEncryptionService.UseEncryption ? _ExtraPassiveSkillLevel : _o.ExtraPassiveSkillLevel,
      TableEncryptionService.UseEncryption ? _CommonSkillLevel : _o.CommonSkillLevel,
      TableEncryptionService.UseEncryption ? _LeaderSkillLevel : _o.LeaderSkillLevel,
      TableEncryptionService.UseEncryption ? _EquipSlot01 : _o.EquipSlot01,
      TableEncryptionService.UseEncryption ? _EquipSlotTier01 : _o.EquipSlotTier01,
      TableEncryptionService.UseEncryption ? _EquipSlotLevel01 : _o.EquipSlotLevel01,
      TableEncryptionService.UseEncryption ? _EquipSlot02 : _o.EquipSlot02,
      TableEncryptionService.UseEncryption ? _EquipSlotTier02 : _o.EquipSlotTier02,
      TableEncryptionService.UseEncryption ? _EquipSlotLevel02 : _o.EquipSlotLevel02,
      TableEncryptionService.UseEncryption ? _EquipSlot03 : _o.EquipSlot03,
      TableEncryptionService.UseEncryption ? _EquipSlotTier03 : _o.EquipSlotTier03,
      TableEncryptionService.UseEncryption ? _EquipSlotLevel03 : _o.EquipSlotLevel03,
      TableEncryptionService.UseEncryption ? _EquipCharacterWeapon : _o.EquipCharacterWeapon,
      TableEncryptionService.UseEncryption ? _EquipCharacterWeaponTier : _o.EquipCharacterWeaponTier,
      TableEncryptionService.UseEncryption ? _EquipCharacterWeaponLevel : _o.EquipCharacterWeaponLevel,
      TableEncryptionService.UseEncryption ? _EquipCharacterGear : _o.EquipCharacterGear,
      TableEncryptionService.UseEncryption ? _EquipCharacterGearTier : _o.EquipCharacterGearTier,
      TableEncryptionService.UseEncryption ? _EquipCharacterGearLevel : _o.EquipCharacterGearLevel,
      TableEncryptionService.UseEncryption ? _PotentialType01 : _o.PotentialType01,
      TableEncryptionService.UseEncryption ? _PotentialLevel01 : _o.PotentialLevel01,
      TableEncryptionService.UseEncryption ? _PotentialType02 : _o.PotentialType02,
      TableEncryptionService.UseEncryption ? _PotentialLevel02 : _o.PotentialLevel02,
      TableEncryptionService.UseEncryption ? _PotentialType03 : _o.PotentialType03,
      TableEncryptionService.UseEncryption ? _PotentialLevel03 : _o.PotentialLevel03);
  }
}
...
public class PresetCharacterGroupExcelT
{
  ...
  public Global.PotentialStatBonusRateType PotentialType01 { get; set; }
  public int PotentialLevel01 { get; set; }
  public Global.PotentialStatBonusRateType PotentialType02 { get; set; }
  public int PotentialLevel02 { get; set; }
  public Global.PotentialStatBonusRateType PotentialType03 { get; set; }
  ...
  public PresetCharacterGroupExcelT() {
    ...
    this.PotentialType01 = Global.PotentialStatBonusRateType.None;
    this.PotentialLevel01 = 0;
    this.PotentialType02 = Global.PotentialStatBonusRateType.None;
    this.PotentialLevel02 = 0;
    this.PotentialType03 = Global.PotentialStatBonusRateType.None;
...
static public class PresetCharacterGroupExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 58 /*PotentialType01*/, 4 /*Global.PotentialStatBonusRateType*/, 4, false)
      && verifier.VerifyField(tablePos, 60 /*PotentialLevel01*/, 4 /*int*/, 4, false)
      && verifier.VerifyField(tablePos, 62 /*PotentialType02*/, 4 /*Global.PotentialStatBonusRateType*/, 4, false)
      && verifier.VerifyField(tablePos, 64 /*PotentialLevel02*/, 4 /*int*/, 4, false)
      && verifier.VerifyField(tablePos, 66 /*PotentialType03*/, 4 /*Global.PotentialStatBonusRateType*/, 4, false)
