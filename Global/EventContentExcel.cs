...
public struct EventContentExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.EventContentExcel> CreateEventContentExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Global.EventContentExcel> EndEventContentExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.EventContentExcel>(o);
  }
  ...
  public void UnPackTo(EventContentExcelT _o) {
    ...
    _o.BgImagePath = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BgImagePath, key) : this.BgImagePath;
  }
  public static Offset<Global.EventContentExcel> Pack(FlatBufferBuilder builder, EventContentExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContent");
    ...
    var _BgImagePath = _o.BgImagePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.BgImagePath, key) : _o.BgImagePath));
