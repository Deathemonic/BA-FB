...
public struct EventContentExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.EventContentExcel> Pack(FlatBufferBuilder builder, EventContentExcelT _o) {
    ...
    var _BgImagePath = _o.BgImagePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.BgImagePath, key) : _o.BgImagePath));
