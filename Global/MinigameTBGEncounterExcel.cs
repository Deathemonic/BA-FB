...
public struct MinigameTBGEncounterExcel : IFlatbufferObject
{
  ...
  public Global.TBGThemaType ThemaType { get { int o = __p.__offset(12); return o != 0 ? (Global.TBGThemaType)__p.bb.GetInt(o + __p.bb_pos) : Global.TBGThemaType.None; } }
  public Global.TBGObjectType ObjectType { get { int o = __p.__offset(14); return o != 0 ? (Global.TBGObjectType)__p.bb.GetInt(o + __p.bb_pos) : Global.TBGObjectType.None; } }
  ...
  public static Offset<Global.MinigameTBGEncounterExcel> CreateMinigameTBGEncounterExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      long UniqueId = 0,
      bool AllThema = false,
      int ThemaIndex = 0,
      Global.TBGThemaType ThemaType = Global.TBGThemaType.None,
      Global.TBGObjectType ObjectType = Global.TBGObjectType.None,
  ...
  public static void AddThemaType(FlatBufferBuilder builder, Global.TBGThemaType themaType) { builder.AddInt(4, (int)themaType, 0); }
  public static void AddObjectType(FlatBufferBuilder builder, Global.TBGObjectType objectType) { builder.AddInt(5, (int)objectType, 0); }
  ...
  public static Offset<Global.MinigameTBGEncounterExcel> EndMinigameTBGEncounterExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.MinigameTBGEncounterExcel>(o);
  }
  ...
  public void UnPackTo(MinigameTBGEncounterExcelT _o) {
    ...
    _o.AllThema = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.AllThema, key) : this.AllThema;
    _o.ThemaIndex = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ThemaIndex, key) : this.ThemaIndex;
    _o.ThemaType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ThemaType, key) : this.ThemaType;
    _o.ObjectType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ObjectType, key) : this.ObjectType;
    ...
    _o.OptionGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.OptionGroupId, key) : this.OptionGroupId;
    _o.RewardHide = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.RewardHide, key) : this.RewardHide;
  ...
  public static Offset<Global.MinigameTBGEncounterExcel> Pack(FlatBufferBuilder builder, MinigameTBGEncounterExcelT _o) {
    if (_o == null) return default(Offset<Global.MinigameTBGEncounterExcel>);
		byte[] key = TableEncryptionService.CreateKey("MinigameTBGEncounter");
		...
		var _AllThema = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.AllThema, key) : _o.AllThema;
		var _ThemaIndex = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ThemaIndex, key) : _o.ThemaIndex;
		var _ThemaType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ThemaType, key) : _o.ThemaType;
		var _ObjectType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ObjectType, key) : _o.ObjectType;
    var _EnemyImagePath = _o.EnemyImagePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.EnemyImagePath, key) : _o.EnemyImagePath));
    var _EnemyPrefabName = _o.EnemyPrefabName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.EnemyPrefabName, key) : _o.EnemyPrefabName));
    var _EnemyNameLocalize = _o.EnemyNameLocalize == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.EnemyNameLocalize, key) : _o.EnemyNameLocalize));
		var _OptionGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.OptionGroupId, key) : _o.OptionGroupId;
		var _RewardHide = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RewardHide, key) : _o.RewardHide;
    var _EncounterTitleLocalize = _o.EncounterTitleLocalize == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.EncounterTitleLocalize, key) : _o.EncounterTitleLocalize));
    var _StoryImagePath = _o.StoryImagePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.StoryImagePath, key) : _o.StoryImagePath));
    var _BeforeStoryLocalize = _o.BeforeStoryLocalize == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.BeforeStoryLocalize, key) : _o.BeforeStoryLocalize));
    var _BeforeStoryOption1Localize = _o.BeforeStoryOption1Localize == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.BeforeStoryOption1Localize, key) : _o.BeforeStoryOption1Localize));
    var _BeforeStoryOption2Localize = _o.BeforeStoryOption2Localize == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.BeforeStoryOption2Localize, key) : _o.BeforeStoryOption2Localize));
    var _BeforeStoryOption3Localize = _o.BeforeStoryOption3Localize == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.BeforeStoryOption3Localize, key) : _o.BeforeStoryOption3Localize));
    var _AllyAttackLocalize = _o.AllyAttackLocalize == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.AllyAttackLocalize, key) : _o.AllyAttackLocalize));
    var _EnemyAttackLocalize = _o.EnemyAttackLocalize == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.EnemyAttackLocalize, key) : _o.EnemyAttackLocalize));
    var _AttackDefenceLocalize = _o.AttackDefenceLocalize == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.AttackDefenceLocalize, key) : _o.AttackDefenceLocalize));
    var _ClearStoryLocalize = _o.ClearStoryLocalize == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ClearStoryLocalize, key) : _o.ClearStoryLocalize));
    var _DefeatStoryLocalize = _o.DefeatStoryLocalize == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.DefeatStoryLocalize, key) : _o.DefeatStoryLocalize));
    var _RunawayStoryLocalize = _o.RunawayStoryLocalize == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.RunawayStoryLocalize, key) : _o.RunawayStoryLocalize));
...
public class MinigameTBGEncounterExcelT
{
  ...
  public Global.TBGObjectType ObjectType { get; set; }
  ...
  public MinigameTBGEncounterExcelT() {
    ...
    this.ObjectType = Global.TBGObjectType.None;
...
static public class MinigameTBGEncounterExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*ThemaType*/, 4 /*Global.TBGThemaType*/, 4, false)
      && verifier.VerifyField(tablePos, 14 /*ObjectType*/, 4 /*Global.TBGObjectType*/, 4, false)
