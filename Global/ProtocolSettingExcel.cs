...
public struct ProtocolSettingExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ProtocolSettingExcelT _o) {
    ...
    _o.Currency = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Currency, key) : this.Currency;
    _o.Inventory = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Inventory, key) : this.Inventory;
    _o.Mail = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Mail, key) : this.Mail;
  }
  public static Offset<Global.ProtocolSettingExcel> Pack(FlatBufferBuilder builder, ProtocolSettingExcelT _o) {
    if (_o == null) return default(Offset<Global.ProtocolSettingExcel>);
		byte[] key = TableEncryptionService.CreateKey("ProtocolSetting");
    var _Protocol = _o.Protocol == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.Protocol, key) : _o.Protocol));
		...
		var _Currency = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Currency, key) : _o.Currency;
		var _Inventory = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Inventory, key) : _o.Inventory;
		var _Mail = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Mail, key) : _o.Mail;
