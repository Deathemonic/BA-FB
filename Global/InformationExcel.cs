...
public struct InformationExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.InformationExcel> CreateInformationExcel(FlatBufferBuilder builder,
      long GroupID = 0,
  ...
  public static Offset<Global.InformationExcel> EndInformationExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.InformationExcel>(o);
  }
  ...
  public static Offset<Global.InformationExcel> Pack(FlatBufferBuilder builder, InformationExcelT _o) {
    if (_o == null) return default(Offset<Global.InformationExcel>);
		byte[] key = TableEncryptionService.CreateKey("Information");
		var _GroupID = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.GroupID, key) : _o.GroupID;
    var _PageName = _o.PageName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.PageName, key) : _o.PageName));
		var _IsPcBuild = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IsPcBuild, key) : _o.IsPcBuild;
