...
public struct CampaignStrategyObjectExcel : IFlatbufferObject
{
  ...
  public Global.StrategyObjectType StrategyObjectType { get { int o = __p.__offset(12); return o != 0 ? (Global.StrategyObjectType)__p.bb.GetInt(o + __p.bb_pos) : Global.StrategyObjectType.None; } }
  public Global.ParcelType StrategyRewardParcelType { get { int o = __p.__offset(14); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Global.ParcelType.None; } }
  ...
  public static Offset<Global.CampaignStrategyObjectExcel> CreateCampaignStrategyObjectExcel(FlatBufferBuilder builder,
      long Id = 0,
      uint Key = 0,
      StringOffset NameOffset = default(StringOffset),
      StringOffset PrefabNameOffset = default(StringOffset),
      Global.StrategyObjectType StrategyObjectType = Global.StrategyObjectType.None,
      Global.ParcelType StrategyRewardParcelType = Global.ParcelType.None,
  ...
  public static void AddStrategyObjectType(FlatBufferBuilder builder, Global.StrategyObjectType strategyObjectType) { builder.AddInt(4, (int)strategyObjectType, 0); }
  public static void AddStrategyRewardParcelType(FlatBufferBuilder builder, Global.ParcelType strategyRewardParcelType) { builder.AddInt(5, (int)strategyRewardParcelType, 0); }
  ...
  public static Offset<Global.CampaignStrategyObjectExcel> EndCampaignStrategyObjectExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.CampaignStrategyObjectExcel>(o);
  }
  ...
  public void UnPackTo(CampaignStrategyObjectExcelT _o) {
    ...
    _o.StrategyObjectType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StrategyObjectType, key) : this.StrategyObjectType;
    _o.StrategyRewardParcelType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StrategyRewardParcelType, key) : this.StrategyRewardParcelType;
    _o.StrategyRewardID = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StrategyRewardID, key) : this.StrategyRewardID;
    ...
    _o.StrategyRewardAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StrategyRewardAmount, key) : this.StrategyRewardAmount;
    ...
    _o.PortalId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.PortalId, key) : this.PortalId;
    _o.HealValue = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.HealValue, key) : this.HealValue;
    _o.SwithId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SwithId, key) : this.SwithId;
    _o.BuffId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BuffId, key) : this.BuffId;
    _o.Disposable = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Disposable, key) : this.Disposable;
  }
  public static Offset<Global.CampaignStrategyObjectExcel> Pack(FlatBufferBuilder builder, CampaignStrategyObjectExcelT _o) {
    if (_o == null) return default(Offset<Global.CampaignStrategyObjectExcel>);
		byte[] key = TableEncryptionService.CreateKey("CampaignStrategyObject");
    ...
    var _PrefabName = _o.PrefabName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.PrefabName, key) : _o.PrefabName));
		var _StrategyObjectType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StrategyObjectType, key) : _o.StrategyObjectType;
		var _StrategyRewardParcelType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StrategyRewardParcelType, key) : _o.StrategyRewardParcelType;
		var _StrategyRewardID = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StrategyRewardID, key) : _o.StrategyRewardID;
    var _StrategyRewardName = _o.StrategyRewardName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.StrategyRewardName, key) : _o.StrategyRewardName));
		var _StrategyRewardAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StrategyRewardAmount, key) : _o.StrategyRewardAmount;
		...
		var _PortalId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PortalId, key) : _o.PortalId;
		var _HealValue = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.HealValue, key) : _o.HealValue;
		var _SwithId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.SwithId, key) : _o.SwithId;
		var _BuffId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.BuffId, key) : _o.BuffId;
		var _Disposable = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Disposable, key) : _o.Disposable;
...
public class CampaignStrategyObjectExcelT
{
  ...
  public Global.StrategyObjectType StrategyObjectType { get; set; }
  public Global.ParcelType StrategyRewardParcelType { get; set; }
  ...
  public CampaignStrategyObjectExcelT() {
    ...
    this.StrategyObjectType = Global.StrategyObjectType.None;
    this.StrategyRewardParcelType = Global.ParcelType.None;
...
static public class CampaignStrategyObjectExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*StrategyObjectType*/, 4 /*Global.StrategyObjectType*/, 4, false)
      && verifier.VerifyField(tablePos, 14 /*StrategyRewardParcelType*/, 4 /*Global.ParcelType*/, 4, false)
