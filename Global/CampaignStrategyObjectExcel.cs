...
public struct CampaignStrategyObjectExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(CampaignStrategyObjectExcelT _o) {
    ...
    _o.StrategyObjectType = TableEncryptionService.UseEncryption ? (Global.StrategyObjectType)TableEncryptionService.Convert((int)this.StrategyObjectType, key) : this.StrategyObjectType;
    _o.StrategyRewardParcelType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)this.StrategyRewardParcelType, key) : this.StrategyRewardParcelType;
  ...
  public static Offset<Global.CampaignStrategyObjectExcel> Pack(FlatBufferBuilder builder, CampaignStrategyObjectExcelT _o) {
    ...
    var _PrefabName = _o.PrefabName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.PrefabName, key) : _o.PrefabName));
		var _StrategyObjectType = TableEncryptionService.UseEncryption ? (Global.StrategyObjectType)TableEncryptionService.Convert((int)_o.StrategyObjectType, key) : _o.StrategyObjectType;
		var _StrategyRewardParcelType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)_o.StrategyRewardParcelType, key) : _o.StrategyRewardParcelType;
