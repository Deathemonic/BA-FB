...
public struct ConquestEventExcel : IFlatbufferObject
{
  ...
  public Global.ConquestEventType ConquestEventType { get { int o = __p.__offset(8); return o != 0 ? (Global.ConquestEventType)__p.bb.GetInt(o + __p.bb_pos) : Global.ConquestEventType.None; } }
  ...
  public static Offset<Global.ConquestEventExcel> CreateConquestEventExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      long MainStoryEventContentId = 0,
      Global.ConquestEventType ConquestEventType = Global.ConquestEventType.None,
  ...
  public static void AddConquestEventType(FlatBufferBuilder builder, Global.ConquestEventType conquestEventType) { builder.AddInt(2, (int)conquestEventType, 0); }
  ...
  public static Offset<Global.ConquestEventExcel> EndConquestEventExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.ConquestEventExcel>(o);
  }
  ...
  public void UnPackTo(ConquestEventExcelT _o) {
    ...
    _o.MainStoryEventContentId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.MainStoryEventContentId, key) : this.MainStoryEventContentId;
    _o.ConquestEventType = TableEncryptionService.UseEncryption ? (Global.ConquestEventType)TableEncryptionService.Convert((int)this.ConquestEventType, key) : this.ConquestEventType;
    _o.UseErosion = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.UseErosion, key) : this.UseErosion;
    _o.UseUnexpectedEvent = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.UseUnexpectedEvent, key) : this.UseUnexpectedEvent;
    _o.UseCalculate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.UseCalculate, key) : this.UseCalculate;
    _o.UseConquestObject = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.UseConquestObject, key) : this.UseConquestObject;
    _o.EvnetMapGoalLocalize = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EvnetMapGoalLocalize, key) : this.EvnetMapGoalLocalize;
    _o.EvnetMapNameLocalize = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EvnetMapNameLocalize, key) : this.EvnetMapNameLocalize;
    _o.MapEnterScenarioGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.MapEnterScenarioGroupId, key) : this.MapEnterScenarioGroupId;
    _o.EvnetScenarioBG = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EvnetScenarioBG, key) : this.EvnetScenarioBG;
    _o.ManageUnitChange = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.ManageUnitChange, key) : this.ManageUnitChange;
    _o.AssistCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.AssistCount, key) : this.AssistCount;
    _o.PlayTimeLimitInSeconds = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.PlayTimeLimitInSeconds, key) : this.PlayTimeLimitInSeconds;
    _o.AnimationUnitAmountMin = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.AnimationUnitAmountMin, key) : this.AnimationUnitAmountMin;
    _o.AnimationUnitAmountMax = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.AnimationUnitAmountMax, key) : this.AnimationUnitAmountMax;
    _o.AnimationUnitDelay = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)this.AnimationUnitDelay, key) : this.AnimationUnitDelay;
    _o.LocalizeUnexpected = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.LocalizeUnexpected, key) : this.LocalizeUnexpected;
    _o.LocalizeErosions = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.LocalizeErosions, key) : this.LocalizeErosions;
    _o.LocalizeStep = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.LocalizeStep, key) : this.LocalizeStep;
    _o.LocalizeTile = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.LocalizeTile, key) : this.LocalizeTile;
    _o.LocalizeMapInfo = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.LocalizeMapInfo, key) : this.LocalizeMapInfo;
    _o.LocalizeManage = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.LocalizeManage, key) : this.LocalizeManage;
    _o.LocalizeUpgrade = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.LocalizeUpgrade, key) : this.LocalizeUpgrade;
    _o.LocalizeTreasureBox = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.LocalizeTreasureBox, key) : this.LocalizeTreasureBox;
    _o.IndividualErosionDailyCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.IndividualErosionDailyCount, key) : this.IndividualErosionDailyCount;
  }
  public static Offset<Global.ConquestEventExcel> Pack(FlatBufferBuilder builder, ConquestEventExcelT _o) {
    if (_o == null) return default(Offset<Global.ConquestEventExcel>);
		byte[] key = TableEncryptionService.CreateKey("ConquestEvent");
		...
		var _MainStoryEventContentId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.MainStoryEventContentId, key) : _o.MainStoryEventContentId;
		var _ConquestEventType = TableEncryptionService.UseEncryption ? (Global.ConquestEventType)TableEncryptionService.Convert((int)_o.ConquestEventType, key) : _o.ConquestEventType;
		var _UseErosion = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.UseErosion, key) : _o.UseErosion;
		var _UseUnexpectedEvent = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.UseUnexpectedEvent, key) : _o.UseUnexpectedEvent;
		var _UseCalculate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.UseCalculate, key) : _o.UseCalculate;
		var _UseConquestObject = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.UseConquestObject, key) : _o.UseConquestObject;
    var _EvnetMapGoalLocalize = _o.EvnetMapGoalLocalize == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.EvnetMapGoalLocalize, key) : _o.EvnetMapGoalLocalize));
    var _EvnetMapNameLocalize = _o.EvnetMapNameLocalize == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.EvnetMapNameLocalize, key) : _o.EvnetMapNameLocalize));
		var _MapEnterScenarioGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.MapEnterScenarioGroupId, key) : _o.MapEnterScenarioGroupId;
    var _EvnetScenarioBG = _o.EvnetScenarioBG == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.EvnetScenarioBG, key) : _o.EvnetScenarioBG));
		var _ManageUnitChange = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.ManageUnitChange, key) : _o.ManageUnitChange;
		var _AssistCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.AssistCount, key) : _o.AssistCount;
		var _PlayTimeLimitInSeconds = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.PlayTimeLimitInSeconds, key) : _o.PlayTimeLimitInSeconds;
		var _AnimationUnitAmountMin = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.AnimationUnitAmountMin, key) : _o.AnimationUnitAmountMin;
		var _AnimationUnitAmountMax = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.AnimationUnitAmountMax, key) : _o.AnimationUnitAmountMax;
		var _AnimationUnitDelay = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)_o.AnimationUnitDelay, key) : _o.AnimationUnitDelay;
    var _LocalizeUnexpected = _o.LocalizeUnexpected == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.LocalizeUnexpected, key) : _o.LocalizeUnexpected));
    var _LocalizeErosions = _o.LocalizeErosions == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.LocalizeErosions, key) : _o.LocalizeErosions));
    var _LocalizeStep = _o.LocalizeStep == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.LocalizeStep, key) : _o.LocalizeStep));
    var _LocalizeTile = _o.LocalizeTile == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.LocalizeTile, key) : _o.LocalizeTile));
    var _LocalizeMapInfo = _o.LocalizeMapInfo == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.LocalizeMapInfo, key) : _o.LocalizeMapInfo));
    var _LocalizeManage = _o.LocalizeManage == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.LocalizeManage, key) : _o.LocalizeManage));
    var _LocalizeUpgrade = _o.LocalizeUpgrade == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.LocalizeUpgrade, key) : _o.LocalizeUpgrade));
    var _LocalizeTreasureBox = _o.LocalizeTreasureBox == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.LocalizeTreasureBox, key) : _o.LocalizeTreasureBox));
		var _IndividualErosionDailyCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.IndividualErosionDailyCount, key) : _o.IndividualErosionDailyCount;
    return CreateConquestEventExcel(
      builder,
      TableEncryptionService.UseEncryption ? _EventContentId : _o.EventContentId,
      TableEncryptionService.UseEncryption ? _MainStoryEventContentId : _o.MainStoryEventContentId,
      TableEncryptionService.UseEncryption ? _ConquestEventType : _o.ConquestEventType,
      TableEncryptionService.UseEncryption ? _UseErosion : _o.UseErosion,
      TableEncryptionService.UseEncryption ? _UseUnexpectedEvent : _o.UseUnexpectedEvent,
      TableEncryptionService.UseEncryption ? _UseCalculate : _o.UseCalculate,
      TableEncryptionService.UseEncryption ? _UseConquestObject : _o.UseConquestObject,
      _EvnetMapGoalLocalize,
      _EvnetMapNameLocalize,
      TableEncryptionService.UseEncryption ? _MapEnterScenarioGroupId : _o.MapEnterScenarioGroupId,
      _EvnetScenarioBG,
      TableEncryptionService.UseEncryption ? _ManageUnitChange : _o.ManageUnitChange,
      TableEncryptionService.UseEncryption ? _AssistCount : _o.AssistCount,
      TableEncryptionService.UseEncryption ? _PlayTimeLimitInSeconds : _o.PlayTimeLimitInSeconds,
      TableEncryptionService.UseEncryption ? _AnimationUnitAmountMin : _o.AnimationUnitAmountMin,
      TableEncryptionService.UseEncryption ? _AnimationUnitAmountMax : _o.AnimationUnitAmountMax,
      TableEncryptionService.UseEncryption ? _AnimationUnitDelay : _o.AnimationUnitDelay,
      _LocalizeUnexpected,
      _LocalizeErosions,
      _LocalizeStep,
      _LocalizeTile,
      ...
      TableEncryptionService.UseEncryption ? _IndividualErosionDailyCount : _o.IndividualErosionDailyCount);
  }
}
...
public class ConquestEventExcelT
{
  ...
  public Global.ConquestEventType ConquestEventType { get; set; }
  ...
  public ConquestEventExcelT() {
    ...
    this.ConquestEventType = Global.ConquestEventType.None;
...
static public class ConquestEventExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*ConquestEventType*/, 4 /*Global.ConquestEventType*/, 4, false)
