...
public struct ConquestEventExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ConquestEventExcelT _o) {
    ...
    _o.MainStoryEventContentId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MainStoryEventContentId, key) : this.MainStoryEventContentId;
    _o.ConquestEventType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ConquestEventType, key) : this.ConquestEventType;
    _o.UseErosion = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.UseErosion, key) : this.UseErosion;
    _o.UseUnexpectedEvent = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.UseUnexpectedEvent, key) : this.UseUnexpectedEvent;
    _o.UseCalculate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.UseCalculate, key) : this.UseCalculate;
    _o.UseConquestObject = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.UseConquestObject, key) : this.UseConquestObject;
    ...
    _o.MapEnterScenarioGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MapEnterScenarioGroupId, key) : this.MapEnterScenarioGroupId;
    ...
    _o.ManageUnitChange = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ManageUnitChange, key) : this.ManageUnitChange;
    _o.AssistCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.AssistCount, key) : this.AssistCount;
    ...
    _o.AnimationUnitAmountMin = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.AnimationUnitAmountMin, key) : this.AnimationUnitAmountMin;
    _o.AnimationUnitAmountMax = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.AnimationUnitAmountMax, key) : this.AnimationUnitAmountMax;
    _o.AnimationUnitDelay = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.AnimationUnitDelay, key) : this.AnimationUnitDelay;
    ...
    _o.IndividualErosionDailyCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.IndividualErosionDailyCount, key) : this.IndividualErosionDailyCount;
  }
  public static Offset<Global.ConquestEventExcel> Pack(FlatBufferBuilder builder, ConquestEventExcelT _o) {
    if (_o == null) return default(Offset<Global.ConquestEventExcel>);
		...
		var _MainStoryEventContentId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MainStoryEventContentId, key) : _o.MainStoryEventContentId;
		var _ConquestEventType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ConquestEventType, key) : _o.ConquestEventType;
		var _UseErosion = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.UseErosion, key) : _o.UseErosion;
		var _UseUnexpectedEvent = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.UseUnexpectedEvent, key) : _o.UseUnexpectedEvent;
		var _UseCalculate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.UseCalculate, key) : _o.UseCalculate;
		var _UseConquestObject = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.UseConquestObject, key) : _o.UseConquestObject;
    var _EvnetMapGoalLocalize = _o.EvnetMapGoalLocalize == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.EvnetMapGoalLocalize, key) : _o.EvnetMapGoalLocalize));
    var _EvnetMapNameLocalize = _o.EvnetMapNameLocalize == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.EvnetMapNameLocalize, key) : _o.EvnetMapNameLocalize));
		var _MapEnterScenarioGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MapEnterScenarioGroupId, key) : _o.MapEnterScenarioGroupId;
    var _EvnetScenarioBG = _o.EvnetScenarioBG == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.EvnetScenarioBG, key) : _o.EvnetScenarioBG));
		var _ManageUnitChange = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ManageUnitChange, key) : _o.ManageUnitChange;
		var _AssistCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.AssistCount, key) : _o.AssistCount;
		...
		var _AnimationUnitAmountMin = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.AnimationUnitAmountMin, key) : _o.AnimationUnitAmountMin;
		var _AnimationUnitAmountMax = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.AnimationUnitAmountMax, key) : _o.AnimationUnitAmountMax;
		var _AnimationUnitDelay = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.AnimationUnitDelay, key) : _o.AnimationUnitDelay;
    var _LocalizeUnexpected = _o.LocalizeUnexpected == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.LocalizeUnexpected, key) : _o.LocalizeUnexpected));
    var _LocalizeErosions = _o.LocalizeErosions == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.LocalizeErosions, key) : _o.LocalizeErosions));
    var _LocalizeStep = _o.LocalizeStep == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.LocalizeStep, key) : _o.LocalizeStep));
    var _LocalizeTile = _o.LocalizeTile == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.LocalizeTile, key) : _o.LocalizeTile));
    var _LocalizeMapInfo = _o.LocalizeMapInfo == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.LocalizeMapInfo, key) : _o.LocalizeMapInfo));
    var _LocalizeManage = _o.LocalizeManage == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.LocalizeManage, key) : _o.LocalizeManage));
    var _LocalizeUpgrade = _o.LocalizeUpgrade == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.LocalizeUpgrade, key) : _o.LocalizeUpgrade));
    var _LocalizeTreasureBox = _o.LocalizeTreasureBox == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.LocalizeTreasureBox, key) : _o.LocalizeTreasureBox));
		var _IndividualErosionDailyCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IndividualErosionDailyCount, key) : _o.IndividualErosionDailyCount;
