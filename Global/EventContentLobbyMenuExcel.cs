...
public struct EventContentLobbyMenuExcel : IFlatbufferObject
{
  ...
  public Global.EventContentType EventContentType { get { int o = __p.__offset(6); return o != 0 ? (Global.EventContentType)__p.bb.GetInt(o + __p.bb_pos) : Global.EventContentType.Stage; } }
  ...
  public static Offset<Global.EventContentLobbyMenuExcel> CreateEventContentLobbyMenuExcel(FlatBufferBuilder builder,
  ...
  public static void AddEventContentType(FlatBufferBuilder builder, Global.EventContentType eventContentType) { builder.AddInt(1, (int)eventContentType, 0); }
  ...
  public static Offset<Global.EventContentLobbyMenuExcel> EndEventContentLobbyMenuExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.EventContentLobbyMenuExcel>(o);
  }
  ...
  public void UnPackTo(EventContentLobbyMenuExcelT _o) {
    ...
    _o.IconOffsetX = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.IconOffsetX, key) : this.IconOffsetX;
    _o.IconOffsetY = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.IconOffsetY, key) : this.IconOffsetY;
  ...
  public static Offset<Global.EventContentLobbyMenuExcel> Pack(FlatBufferBuilder builder, EventContentLobbyMenuExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentLobbyMenuExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentLobbyMenu");
    ...
    var _ButtonText = _o.ButtonText == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ButtonText, key) : _o.ButtonText));
		...
		var _IconOffsetX = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IconOffsetX, key) : _o.IconOffsetX;
		var _IconOffsetY = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IconOffsetY, key) : _o.IconOffsetY;
    var _ReddotSpriteName = _o.ReddotSpriteName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ReddotSpriteName, key) : _o.ReddotSpriteName));
...
static public class EventContentLobbyMenuExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*EventContentType*/, 4 /*Global.EventContentType*/, 4, false)
