...
public struct ConquestErosionUnitExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.ConquestErosionUnitExcel> CreateConquestErosionUnitExcel(FlatBufferBuilder builder,
      long TilePrefabId = 0,
  ...
  public static Offset<Global.ConquestErosionUnitExcel> EndConquestErosionUnitExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.ConquestErosionUnitExcel>(o);
  }
  ...
  public void UnPackTo(ConquestErosionUnitExcelT _o) {
    ...
    _o.TilePrefabId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.TilePrefabId, key) : this.TilePrefabId;
    _o.MassErosionUnitId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MassErosionUnitId, key) : this.MassErosionUnitId;
    _o.MassErosionUnitRotationY = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MassErosionUnitRotationY, key) : this.MassErosionUnitRotationY;
    _o.IndividualErosionUnitId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.IndividualErosionUnitId, key) : this.IndividualErosionUnitId;
    _o.IndividualErosionUnitRotationY = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.IndividualErosionUnitRotationY, key) : this.IndividualErosionUnitRotationY;
  }
  public static Offset<Global.ConquestErosionUnitExcel> Pack(FlatBufferBuilder builder, ConquestErosionUnitExcelT _o) {
    if (_o == null) return default(Offset<Global.ConquestErosionUnitExcel>);
		byte[] key = TableEncryptionService.CreateKey("ConquestErosionUnit");
		var _TilePrefabId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.TilePrefabId, key) : _o.TilePrefabId;
		var _MassErosionUnitId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MassErosionUnitId, key) : _o.MassErosionUnitId;
		var _MassErosionUnitRotationY = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MassErosionUnitRotationY, key) : _o.MassErosionUnitRotationY;
		var _IndividualErosionUnitId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IndividualErosionUnitId, key) : _o.IndividualErosionUnitId;
		var _IndividualErosionUnitRotationY = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IndividualErosionUnitRotationY, key) : _o.IndividualErosionUnitRotationY;
