...
public struct GroundGridFlat : IFlatbufferObject
{
  ...
  public Global.GroundNodeFlat? Nodes(int j) { int o = __p.__offset(14); return o != 0 ? (Global.GroundNodeFlat?)(new Global.GroundNodeFlat()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  ...
  public static Offset<Global.GroundGridFlat> CreateGroundGridFlat(FlatBufferBuilder builder,
      int X = 0,
      int Y = 0,
      float StartX = 0.0f,
      float StartY = 0.0f,
  ...
  public static VectorOffset CreateNodesVector(FlatBufferBuilder builder, Offset<Global.GroundNodeFlat>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateNodesVectorBlock(FlatBufferBuilder builder, Offset<Global.GroundNodeFlat>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateNodesVectorBlock(FlatBufferBuilder builder, ArraySegment<Offset<Global.GroundNodeFlat>> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateNodesVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Offset<Global.GroundNodeFlat>>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Global.GroundGridFlat> EndGroundGridFlat(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.GroundGridFlat>(o);
  }
  ...
  public void UnPackTo(GroundGridFlatT _o) {
		byte[] key = TableEncryptionService.CreateKey("GroundGri");
    ...
    _o.StartX = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)this.StartX, key) : this.StartX;
    _o.StartY = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)this.StartY, key) : this.StartY;
    _o.Gap = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)this.Gap, key) : this.Gap;
    _o.Nodes = new List<Global.GroundNodeFlatT>();
    for (var _j = 0; _j < this.NodesLength; ++_j) {_o.Nodes.Add(this.Nodes(_j).HasValue ? this.Nodes(_j).Value.UnPack() : null);}
    _o.Version = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Version, key) : this.Version;
  }
  public static Offset<Global.GroundGridFlat> Pack(FlatBufferBuilder builder, GroundGridFlatT _o) {
    if (_o == null) return default(Offset<Global.GroundGridFlat>);
		byte[] key = TableEncryptionService.CreateKey("GroundGri");
		...
		var _StartX = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)_o.StartX, key) : _o.StartX;
		var _StartY = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)_o.StartY, key) : _o.StartY;
		var _Gap = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)_o.Gap, key) : _o.Gap;
    var _Nodes = default(VectorOffset);
    if (_o.Nodes != null) {
      var __Nodes = new Offset<Global.GroundNodeFlat>[_o.Nodes.Count];
      for (var _j = 0; _j < __Nodes.Length; ++_j) { __Nodes[_j] = Global.GroundNodeFlat.Pack(builder, _o.Nodes[_j]); }
      _Nodes = CreateNodesVector(builder, __Nodes);
    }
    var _Version = _o.Version == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.Version, key) : _o.Version));
    return CreateGroundGridFlat(
      builder,
      TableEncryptionService.UseEncryption ? _X : _o.X,
      TableEncryptionService.UseEncryption ? _Y : _o.Y,
      TableEncryptionService.UseEncryption ? _StartX : _o.StartX,
      TableEncryptionService.UseEncryption ? _StartY : _o.StartY,
      TableEncryptionService.UseEncryption ? _Gap : _o.Gap,
      _Nodes,
      _Version);
  }
}
...
public class GroundGridFlatT
{
  ...
  public List<Global.GroundNodeFlatT> Nodes { get; set; }
...
static public class GroundGridFlatVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfTables(tablePos, 14 /*Nodes*/, Global.GroundNodeFlatVerify.Verify, false)
