...
public struct GroundGridFlat : IFlatbufferObject
{
  ...
  public void UnPackTo(GroundGridFlatT _o) {
    ...
    _o.StartX = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StartX, key) : this.StartX;
    _o.StartY = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StartY, key) : this.StartY;
    _o.Gap = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Gap, key) : this.Gap;
  ...
  public static Offset<Global.GroundGridFlat> Pack(FlatBufferBuilder builder, GroundGridFlatT _o) {
    if (_o == null) return default(Offset<Global.GroundGridFlat>);
		...
		var _Y = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Y, key) : _o.Y;
		var _StartX = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StartX, key) : _o.StartX;
		var _StartY = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StartY, key) : _o.StartY;
		var _Gap = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Gap, key) : _o.Gap;
    ...
    var _Version = _o.Version == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.Version, key) : _o.Version));
