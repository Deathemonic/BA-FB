...
public struct SchoolDungeonStageExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(SchoolDungeonStageExcelT _o) {
    ...
    for (var _j = 0; _j < this.StageEnterCostMinimumAmountLength; ++_j) {_o.StageEnterCostMinimumAmount.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StageEnterCostMinimumAmount(_j), key) : this.StageEnterCostMinimumAmount(_j));}
  ...
  public static Offset<Global.SchoolDungeonStageExcel> Pack(FlatBufferBuilder builder, SchoolDungeonStageExcelT _o) {
    ...
    if (_o.StageEnterCostMinimumAmount != null) {
      var __StageEnterCostMinimumAmount = _o.StageEnterCostMinimumAmount.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
