...
public struct ShopRefreshExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ShopRefreshExcelT _o) {
    ...
    _o.ShopPurchasePopupType = TableEncryptionService.UseEncryption ? (Global.ShopPurchasePopupType)TableEncryptionService.Convert((int)this.ShopPurchasePopupType, key) : this.ShopPurchasePopupType;
  ...
  public static Offset<Global.ShopRefreshExcel> Pack(FlatBufferBuilder builder, ShopRefreshExcelT _o) {
    if (_o == null) return default(Offset<Global.ShopRefreshExcel>);
		byte[] key = TableEncryptionService.CreateKey("ShopRefresh");
		...
		var _ShopPurchasePopupType = TableEncryptionService.UseEncryption ? (Global.ShopPurchasePopupType)TableEncryptionService.Convert((int)_o.ShopPurchasePopupType, key) : _o.ShopPurchasePopupType;
