...
public struct AniEventData : IFlatbufferObject
{
  ...
  public static Offset<Global.AniEventData> CreateAniEventData(FlatBufferBuilder builder,
  ...
  public static Offset<Global.AniEventData> EndAniEventData(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.AniEventData>(o);
  }
  ...
  public void UnPackTo(AniEventDataT _o) {
		byte[] key = TableEncryptionService.CreateKey("AniEven");
    _o.Name = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Name, key) : this.Name;
    _o.Time = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Time, key) : this.Time;
    _o.IntParam = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.IntParam, key) : this.IntParam;
    _o.FloatParam = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.FloatParam, key) : this.FloatParam;
    _o.StringParam = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StringParam, key) : this.StringParam;
  }
  public static Offset<Global.AniEventData> Pack(FlatBufferBuilder builder, AniEventDataT _o) {
    if (_o == null) return default(Offset<Global.AniEventData>);
		byte[] key = TableEncryptionService.CreateKey("AniEven");
    var _Name = _o.Name == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.Name, key) : _o.Name));
		var _Time = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Time, key) : _o.Time;
		var _IntParam = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IntParam, key) : _o.IntParam;
		var _FloatParam = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.FloatParam, key) : _o.FloatParam;
    var _StringParam = _o.StringParam == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.StringParam, key) : _o.StringParam));
    return CreateAniEventData(
      builder,
      _Name,
      TableEncryptionService.UseEncryption ? _Time : _o.Time,
      TableEncryptionService.UseEncryption ? _IntParam : _o.IntParam,
      TableEncryptionService.UseEncryption ? _FloatParam : _o.FloatParam,
      _StringParam);
  }
}
