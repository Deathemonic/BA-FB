...
public struct MinigameCCGLevelNodeExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(MinigameCCGLevelNodeExcelT _o) {
    ...
    _o.NodeIcon = TableEncryptionService.UseEncryption ? (Global.CCGLevelNodeIcon)TableEncryptionService.Convert((int)this.NodeIcon, key) : this.NodeIcon;
  ...
  public static Offset<Global.MinigameCCGLevelNodeExcel> Pack(FlatBufferBuilder builder, MinigameCCGLevelNodeExcelT _o) {
    if (_o == null) return default(Offset<Global.MinigameCCGLevelNodeExcel>);
		...
		var _NodeIcon = TableEncryptionService.UseEncryption ? (Global.CCGLevelNodeIcon)TableEncryptionService.Convert((int)_o.NodeIcon, key) : _o.NodeIcon;
