...
public struct MinigameCCGLevelNodeExcel : IFlatbufferObject
{
  ...
  public Global.CCGLevelNodeIcon NodeIcon { get { int o = __p.__offset(8); return o != 0 ? (Global.CCGLevelNodeIcon)__p.bb.GetInt(o + __p.bb_pos) : Global.CCGLevelNodeIcon.None; } }
  ...
  public static Offset<Global.MinigameCCGLevelNodeExcel> CreateMinigameCCGLevelNodeExcel(FlatBufferBuilder builder,
      long LevelId = 0,
      long NodeId = 0,
      Global.CCGLevelNodeIcon NodeIcon = Global.CCGLevelNodeIcon.None,
      long StageGroupId = 0,
  ...
  public static void AddNodeIcon(FlatBufferBuilder builder, Global.CCGLevelNodeIcon nodeIcon) { builder.AddInt(2, (int)nodeIcon, 0); }
  ...
  public static Offset<Global.MinigameCCGLevelNodeExcel> EndMinigameCCGLevelNodeExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.MinigameCCGLevelNodeExcel>(o);
  }
  ...
  public static Offset<Global.MinigameCCGLevelNodeExcel> Pack(FlatBufferBuilder builder, MinigameCCGLevelNodeExcelT _o) {
    if (_o == null) return default(Offset<Global.MinigameCCGLevelNodeExcel>);
		byte[] key = TableEncryptionService.CreateKey("MinigameCCGLevelNode");
		var _LevelId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.LevelId, key) : _o.LevelId;
		var _NodeId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.NodeId, key) : _o.NodeId;
		var _NodeIcon = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.NodeIcon, key) : _o.NodeIcon;
		var _StageGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StageGroupId, key) : _o.StageGroupId;
    var _NextNodeId = default(VectorOffset);
    if (_o.NextNodeId != null) {
      var __NextNodeId = _o.NextNodeId.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
...
public class MinigameCCGLevelNodeExcelT
{
  ...
  public Global.CCGLevelNodeIcon NodeIcon { get; set; }
  ...
  public MinigameCCGLevelNodeExcelT() {
    this.LevelId = 0;
    this.NodeId = 0;
    this.NodeIcon = Global.CCGLevelNodeIcon.None;
    this.StageGroupId = 0;
...
static public class MinigameCCGLevelNodeExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*NodeIcon*/, 4 /*Global.CCGLevelNodeIcon*/, 4, false)
