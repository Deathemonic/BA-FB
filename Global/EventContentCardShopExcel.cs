...
public struct EventContentCardShopExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.EventContentCardShopExcel> CreateEventContentCardShopExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.EventContentCardShopExcel> EndEventContentCardShopExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.EventContentCardShopExcel>(o);
  }
  ...
  public static Offset<Global.EventContentCardShopExcel> Pack(FlatBufferBuilder builder, EventContentCardShopExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentCardShopExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentCardShop");
		...
		var _CardGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CardGroupId, key) : _o.CardGroupId;
		...
		var _ProbWeight1 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ProbWeight1, key) : _o.ProbWeight1;
