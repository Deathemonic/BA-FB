...
public struct HpBarAbbreviationExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(HpBarAbbreviationExcelT _o) {
    ...
    _o.MonsterLv = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MonsterLv, key) : this.MonsterLv;
    _o.StandardHpBar = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StandardHpBar, key) : this.StandardHpBar;
    _o.RaidBossHpBar = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.RaidBossHpBar, key) : this.RaidBossHpBar;
  }
  public static Offset<Global.HpBarAbbreviationExcel> Pack(FlatBufferBuilder builder, HpBarAbbreviationExcelT _o) {
    if (_o == null) return default(Offset<Global.HpBarAbbreviationExcel>);
		byte[] key = TableEncryptionService.CreateKey("HpBarAbbreviation");
		var _MonsterLv = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MonsterLv, key) : _o.MonsterLv;
		var _StandardHpBar = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StandardHpBar, key) : _o.StandardHpBar;
		var _RaidBossHpBar = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RaidBossHpBar, key) : _o.RaidBossHpBar;
