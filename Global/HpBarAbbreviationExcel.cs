...
public struct HpBarAbbreviationExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.HpBarAbbreviationExcel> CreateHpBarAbbreviationExcel(FlatBufferBuilder builder,
      int MonsterLv = 0,
      int StandardHpBar = 0,
      int RaidBossHpBar = 0) {
  ...
  public static Offset<Global.HpBarAbbreviationExcel> EndHpBarAbbreviationExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.HpBarAbbreviationExcel>(o);
  }
  ...
  public void UnPackTo(HpBarAbbreviationExcelT _o) {
    ...
    _o.MonsterLv = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.MonsterLv, key) : this.MonsterLv;
    _o.StandardHpBar = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.StandardHpBar, key) : this.StandardHpBar;
    _o.RaidBossHpBar = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.RaidBossHpBar, key) : this.RaidBossHpBar;
  }
  public static Offset<Global.HpBarAbbreviationExcel> Pack(FlatBufferBuilder builder, HpBarAbbreviationExcelT _o) {
    if (_o == null) return default(Offset<Global.HpBarAbbreviationExcel>);
		byte[] key = TableEncryptionService.CreateKey("HpBarAbbreviation");
		var _MonsterLv = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.MonsterLv, key) : _o.MonsterLv;
		var _StandardHpBar = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.StandardHpBar, key) : _o.StandardHpBar;
		var _RaidBossHpBar = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.RaidBossHpBar, key) : _o.RaidBossHpBar;
    return CreateHpBarAbbreviationExcel(
      builder,
      TableEncryptionService.UseEncryption ? _MonsterLv : _o.MonsterLv,
      TableEncryptionService.UseEncryption ? _StandardHpBar : _o.StandardHpBar,
      TableEncryptionService.UseEncryption ? _RaidBossHpBar : _o.RaidBossHpBar);
  }
}
