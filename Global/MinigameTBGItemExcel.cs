...
public struct MinigameTBGItemExcel : IFlatbufferObject
{
  ...
  public Global.TBGItemType ItemType { get { int o = __p.__offset(6); return o != 0 ? (Global.TBGItemType)__p.bb.GetInt(o + __p.bb_pos) : Global.TBGItemType.None; } }
  public Global.TBGItemEffectType TBGItemEffectType { get { int o = __p.__offset(8); return o != 0 ? (Global.TBGItemEffectType)__p.bb.GetInt(o + __p.bb_pos) : Global.TBGItemEffectType.None; } }
  ...
  public static Offset<Global.MinigameTBGItemExcel> CreateMinigameTBGItemExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      Global.TBGItemType ItemType = Global.TBGItemType.None,
      Global.TBGItemEffectType TBGItemEffectType = Global.TBGItemEffectType.None,
      int ItemParameter = 0,
  ...
  public static void AddItemType(FlatBufferBuilder builder, Global.TBGItemType itemType) { builder.AddInt(1, (int)itemType, 0); }
  public static void AddTBGItemEffectType(FlatBufferBuilder builder, Global.TBGItemEffectType tBGItemEffectType) { builder.AddInt(2, (int)tBGItemEffectType, 0); }
  ...
  public static Offset<Global.MinigameTBGItemExcel> EndMinigameTBGItemExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.MinigameTBGItemExcel>(o);
  }
  ...
  public void UnPackTo(MinigameTBGItemExcelT _o) {
    ...
    _o.ItemType = TableEncryptionService.UseEncryption ? (Global.TBGItemType)TableEncryptionService.Convert((int)this.ItemType, key) : this.ItemType;
    _o.TBGItemEffectType = TableEncryptionService.UseEncryption ? (Global.TBGItemEffectType)TableEncryptionService.Convert((int)this.TBGItemEffectType, key) : this.TBGItemEffectType;
    _o.ItemParameter = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.ItemParameter, key) : this.ItemParameter;
    ...
    _o.BuffIcon = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BuffIcon, key) : this.BuffIcon;
    _o.EncounterCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.EncounterCount, key) : this.EncounterCount;
    _o.DiceEffectAniClip = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.DiceEffectAniClip, key) : this.DiceEffectAniClip;
    _o.BuffIconHUDVisible = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.BuffIconHUDVisible, key) : this.BuffIconHUDVisible;
  }
  public static Offset<Global.MinigameTBGItemExcel> Pack(FlatBufferBuilder builder, MinigameTBGItemExcelT _o) {
    if (_o == null) return default(Offset<Global.MinigameTBGItemExcel>);
		byte[] key = TableEncryptionService.CreateKey("MinigameTBGItem");
		var _UniqueId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.UniqueId, key) : _o.UniqueId;
		var _ItemType = TableEncryptionService.UseEncryption ? (Global.TBGItemType)TableEncryptionService.Convert((int)_o.ItemType, key) : _o.ItemType;
		var _TBGItemEffectType = TableEncryptionService.UseEncryption ? (Global.TBGItemEffectType)TableEncryptionService.Convert((int)_o.TBGItemEffectType, key) : _o.TBGItemEffectType;
		var _ItemParameter = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.ItemParameter, key) : _o.ItemParameter;
    var _LocalizeETCId = _o.LocalizeETCId == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.LocalizeETCId, key) : _o.LocalizeETCId));
    ...
    var _BuffIcon = _o.BuffIcon == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.BuffIcon, key) : _o.BuffIcon));
		var _EncounterCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.EncounterCount, key) : _o.EncounterCount;
    var _DiceEffectAniClip = _o.DiceEffectAniClip == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.DiceEffectAniClip, key) : _o.DiceEffectAniClip));
		var _BuffIconHUDVisible = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.BuffIconHUDVisible, key) : _o.BuffIconHUDVisible;
    return CreateMinigameTBGItemExcel(
      builder,
      TableEncryptionService.UseEncryption ? _UniqueId : _o.UniqueId,
      TableEncryptionService.UseEncryption ? _ItemType : _o.ItemType,
      TableEncryptionService.UseEncryption ? _TBGItemEffectType : _o.TBGItemEffectType,
      TableEncryptionService.UseEncryption ? _ItemParameter : _o.ItemParameter,
      _LocalizeETCId,
      _Icon,
      _BuffIcon,
      TableEncryptionService.UseEncryption ? _EncounterCount : _o.EncounterCount,
      _DiceEffectAniClip,
      TableEncryptionService.UseEncryption ? _BuffIconHUDVisible : _o.BuffIconHUDVisible);
  }
}
...
public class MinigameTBGItemExcelT
{
  ...
  public Global.TBGItemType ItemType { get; set; }
  public Global.TBGItemEffectType TBGItemEffectType { get; set; }
  ...
  public MinigameTBGItemExcelT() {
    this.UniqueId = 0;
    this.ItemType = Global.TBGItemType.None;
    this.TBGItemEffectType = Global.TBGItemEffectType.None;
...
static public class MinigameTBGItemExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*ItemType*/, 4 /*Global.TBGItemType*/, 4, false)
      && verifier.VerifyField(tablePos, 8 /*TBGItemEffectType*/, 4 /*Global.TBGItemEffectType*/, 4, false)
