...
public struct MinigameTBGItemExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(MinigameTBGItemExcelT _o) {
    ...
    _o.ItemType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ItemType, key) : this.ItemType;
    _o.TBGItemEffectType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.TBGItemEffectType, key) : this.TBGItemEffectType;
    _o.ItemParameter = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ItemParameter, key) : this.ItemParameter;
    ...
    _o.EncounterCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EncounterCount, key) : this.EncounterCount;
    ...
    _o.BuffIconHUDVisible = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BuffIconHUDVisible, key) : this.BuffIconHUDVisible;
  }
  public static Offset<Global.MinigameTBGItemExcel> Pack(FlatBufferBuilder builder, MinigameTBGItemExcelT _o) {
    if (_o == null) return default(Offset<Global.MinigameTBGItemExcel>);
		...
		var _ItemType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ItemType, key) : _o.ItemType;
		var _TBGItemEffectType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.TBGItemEffectType, key) : _o.TBGItemEffectType;
		var _ItemParameter = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ItemParameter, key) : _o.ItemParameter;
    var _LocalizeETCId = _o.LocalizeETCId == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.LocalizeETCId, key) : _o.LocalizeETCId));
    ...
    var _BuffIcon = _o.BuffIcon == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.BuffIcon, key) : _o.BuffIcon));
		var _EncounterCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EncounterCount, key) : _o.EncounterCount;
    var _DiceEffectAniClip = _o.DiceEffectAniClip == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.DiceEffectAniClip, key) : _o.DiceEffectAniClip));
		var _BuffIconHUDVisible = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.BuffIconHUDVisible, key) : _o.BuffIconHUDVisible;
