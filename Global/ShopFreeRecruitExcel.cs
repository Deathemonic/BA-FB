...
public struct ShopFreeRecruitExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.ShopFreeRecruitExcel> Pack(FlatBufferBuilder builder, ShopFreeRecruitExcelT _o) {
    ...
    var _FreeRecruitPeriodFrom = _o.FreeRecruitPeriodFrom == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.FreeRecruitPeriodFrom, key) : _o.FreeRecruitPeriodFrom));
