...
public struct KeyMappingPopupExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.KeyMappingPopupExcel> Pack(FlatBufferBuilder builder, KeyMappingPopupExcelT _o) {
    ...
    var _ButtonName01 = _o.ButtonName01 == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ButtonName01, key) : _o.ButtonName01));
    var _KeyMappingId01 = _o.KeyMappingId01 == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.KeyMappingId01, key) : _o.KeyMappingId01));
    var _ButtonName02 = _o.ButtonName02 == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ButtonName02, key) : _o.ButtonName02));
    var _KeyMappingId02 = _o.KeyMappingId02 == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.KeyMappingId02, key) : _o.KeyMappingId02));
    var _ButtonName03 = _o.ButtonName03 == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ButtonName03, key) : _o.ButtonName03));
    var _KeyMappingId03 = _o.KeyMappingId03 == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.KeyMappingId03, key) : _o.KeyMappingId03));
    var _ButtonName04 = _o.ButtonName04 == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ButtonName04, key) : _o.ButtonName04));
    var _KeyMappingId04 = _o.KeyMappingId04 == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.KeyMappingId04, key) : _o.KeyMappingId04));
    var _ButtonName05 = _o.ButtonName05 == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ButtonName05, key) : _o.ButtonName05));
    var _KeyMappingId05 = _o.KeyMappingId05 == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.KeyMappingId05, key) : _o.KeyMappingId05));
