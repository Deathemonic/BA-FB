...
public struct LoadingImageExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.LoadingImageExcel> CreateLoadingImageExcel(FlatBufferBuilder builder,
      long ID = 0,
  ...
  public static Offset<Global.LoadingImageExcel> EndLoadingImageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.LoadingImageExcel>(o);
  }
  ...
  public static Offset<Global.LoadingImageExcel> Pack(FlatBufferBuilder builder, LoadingImageExcelT _o) {
    if (_o == null) return default(Offset<Global.LoadingImageExcel>);
		byte[] key = TableEncryptionService.CreateKey("LoadingImage");
