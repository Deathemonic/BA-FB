...
public struct EventContentShopExcel : IFlatbufferObject
{
  ...
  public Global.ShopCategoryType CategoryType { get { int o = __p.__offset(10); return o != 0 ? (Global.ShopCategoryType)__p.bb.GetInt(o + __p.bb_pos) : Global.ShopCategoryType.General; } }
  ...
  public static Offset<Global.EventContentShopExcel> CreateEventContentShopExcel(FlatBufferBuilder builder,
  ...
  public static void AddCategoryType(FlatBufferBuilder builder, Global.ShopCategoryType categoryType) { builder.AddInt(3, (int)categoryType, 0); }
  ...
  public static Offset<Global.EventContentShopExcel> EndEventContentShopExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.EventContentShopExcel>(o);
  }
  ...
  public static Offset<Global.EventContentShopExcel> Pack(FlatBufferBuilder builder, EventContentShopExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentShopExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentShop");
...
static public class EventContentShopExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*CategoryType*/, 4 /*Global.ShopCategoryType*/, 4, false)
