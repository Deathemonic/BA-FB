...
public struct ShiftingCraftRecipeExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ShiftingCraftRecipeExcelT _o) {
    ...
    _o.ResultParcel = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)this.ResultParcel, key) : this.ResultParcel;
    ...
    for (var _j = 0; _j < this.IngredientTagLength; ++_j) {_o.IngredientTag.Add(TableEncryptionService.UseEncryption ? (Global.Tag)TableEncryptionService.Convert((int)this.IngredientTag(_j), key) : this.IngredientTag(_j));}
  ...
  public static Offset<Global.ShiftingCraftRecipeExcel> Pack(FlatBufferBuilder builder, ShiftingCraftRecipeExcelT _o) {
    if (_o == null) return default(Offset<Global.ShiftingCraftRecipeExcel>);
		...
		var _ResultParcel = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)_o.ResultParcel, key) : _o.ResultParcel;
    ...
    if (_o.IngredientTag != null) {
      var __IngredientTag = _o.IngredientTag.Select(x => TableEncryptionService.UseEncryption ? (Global.Tag)TableEncryptionService.Convert((int)x, key) : x).ToArray();
