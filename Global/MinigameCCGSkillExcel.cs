...
public struct MinigameCCGSkillExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.MinigameCCGSkillExcel> CreateMinigameCCGSkillExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Global.MinigameCCGSkillExcel> EndMinigameCCGSkillExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.MinigameCCGSkillExcel>(o);
  }
  ...
  public static Offset<Global.MinigameCCGSkillExcel> Pack(FlatBufferBuilder builder, MinigameCCGSkillExcelT _o) {
    if (_o == null) return default(Offset<Global.MinigameCCGSkillExcel>);
		byte[] key = TableEncryptionService.CreateKey("MinigameCCGSkill");
		var _Id = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Id, key) : _o.Id;
    var _SkillType = _o.SkillType == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.SkillType, key) : _o.SkillType));
    var _DataLoadPath = _o.DataLoadPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.DataLoadPath, key) : _o.DataLoadPath));
    ...
    var _SkillIcon = _o.SkillIcon == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.SkillIcon, key) : _o.SkillIcon));
