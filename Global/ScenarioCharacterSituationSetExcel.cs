...
public struct ScenarioCharacterSituationSetExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.ScenarioCharacterSituationSetExcel> CreateScenarioCharacterSituationSetExcel(FlatBufferBuilder builder,
      uint Name = 0,
  ...
  public static Offset<Global.ScenarioCharacterSituationSetExcel> EndScenarioCharacterSituationSetExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.ScenarioCharacterSituationSetExcel>(o);
  }
  ...
  public void UnPackTo(ScenarioCharacterSituationSetExcelT _o) {
    ...
    _o.Emotion = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Emotion, key) : this.Emotion;
  }
  public static Offset<Global.ScenarioCharacterSituationSetExcel> Pack(FlatBufferBuilder builder, ScenarioCharacterSituationSetExcelT _o) {
    if (_o == null) return default(Offset<Global.ScenarioCharacterSituationSetExcel>);
		byte[] key = TableEncryptionService.CreateKey("ScenarioCharacterSituationSet");
		var _Name = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Name, key) : _o.Name;
    var _Face = _o.Face == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.Face, key) : _o.Face));
    var _Behavior = _o.Behavior == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.Behavior, key) : _o.Behavior));
    var _Action = _o.Action == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.Action, key) : _o.Action));
    var _Shape = _o.Shape == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.Shape, key) : _o.Shape));
		var _Effect = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Effect, key) : _o.Effect;
		var _Emotion = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Emotion, key) : _o.Emotion;
