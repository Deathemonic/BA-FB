...
public struct CafeInteractionExcel : IFlatbufferObject
{
  ...
  public Global.BubbleType BubbleType(int j) { int o = __p.__offset(12); return o != 0 ? (Global.BubbleType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Global.BubbleType)0; }
  public int BubbleTypeLength { get { int o = __p.__offset(12); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Global.BubbleType> GetBubbleTypeBytes() { return __p.__vector_as_span<Global.BubbleType>(12, 4); }
#else
  public ArraySegment<byte>? GetBubbleTypeBytes() { return __p.__vector_as_arraysegment(12); }
#endif
  public Global.BubbleType[] GetBubbleTypeArray() { int o = __p.__offset(12); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Global.BubbleType[] a = new Global.BubbleType[l]; for (int i = 0; i < l; i++) { a[i] = (Global.BubbleType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Global.ParcelType FavorEmoticonRewardParcelType { get { int o = __p.__offset(16); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Global.ParcelType.None; } }
  ...
  public static Offset<Global.CafeInteractionExcel> CreateCafeInteractionExcel(FlatBufferBuilder builder,
      long CharacterId = 0,
  ...
  public static VectorOffset CreateBubbleTypeVector(FlatBufferBuilder builder, Global.BubbleType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateBubbleTypeVectorBlock(FlatBufferBuilder builder, Global.BubbleType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateBubbleTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Global.BubbleType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateBubbleTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Global.BubbleType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static void AddFavorEmoticonRewardParcelType(FlatBufferBuilder builder, Global.ParcelType favorEmoticonRewardParcelType) { builder.AddInt(6, (int)favorEmoticonRewardParcelType, 0); }
  ...
  public static Offset<Global.CafeInteractionExcel> EndCafeInteractionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.CafeInteractionExcel>(o);
  }
  ...
  public void UnPackTo(CafeInteractionExcelT _o) {
    ...
    _o.BubbleType = new List<Global.BubbleType>();
    for (var _j = 0; _j < this.BubbleTypeLength; ++_j) {_o.BubbleType.Add(TableEncryptionService.UseEncryption ? (Global.BubbleType)TableEncryptionService.Convert((int)this.BubbleType(_j), key) : this.BubbleType(_j));}
    ...
    _o.FavorEmoticonRewardParcelType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)this.FavorEmoticonRewardParcelType, key) : this.FavorEmoticonRewardParcelType;
  ...
  public static Offset<Global.CafeInteractionExcel> Pack(FlatBufferBuilder builder, CafeInteractionExcelT _o) {
    if (_o == null) return default(Offset<Global.CafeInteractionExcel>);
		byte[] key = TableEncryptionService.CreateKey("CafeInteraction");
    ...
    if (_o.BubbleType != null) {
      var __BubbleType = _o.BubbleType.Select(x => TableEncryptionService.UseEncryption ? (Global.BubbleType)TableEncryptionService.Convert((int)x, key) : x).ToArray();
    ...
    if (_o.BubbleDuration != null) {
      ...
      _BubbleDuration = CreateBubbleDurationVector(builder, __BubbleDuration);
		...
		var _FavorEmoticonRewardParcelType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)_o.FavorEmoticonRewardParcelType, key) : _o.FavorEmoticonRewardParcelType;
...
public class CafeInteractionExcelT
{
  ...
  public List<Global.BubbleType> BubbleType { get; set; }
  public List<long> BubbleDuration { get; set; }
  public Global.ParcelType FavorEmoticonRewardParcelType { get; set; }
  ...
  public CafeInteractionExcelT() {
    ...
    this.FavorEmoticonRewardParcelType = Global.ParcelType.None;
...
static public class CafeInteractionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 12 /*BubbleType*/, 4 /*Global.BubbleType*/, false)
      && verifier.VerifyVectorOfData(tablePos, 14 /*BubbleDuration*/, 8 /*long*/, false)
      && verifier.VerifyField(tablePos, 16 /*FavorEmoticonRewardParcelType*/, 4 /*Global.ParcelType*/, 4, false)
