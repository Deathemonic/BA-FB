...
public struct MiniGameShootingGeasExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(MiniGameShootingGeasExcelT _o) {
    ...
    _o.GeasType = TableEncryptionService.UseEncryption ? (Global.Geas)TableEncryptionService.Convert((int)this.GeasType, key) : this.GeasType;
  ...
  public static Offset<Global.MiniGameShootingGeasExcel> Pack(FlatBufferBuilder builder, MiniGameShootingGeasExcelT _o) {
    if (_o == null) return default(Offset<Global.MiniGameShootingGeasExcel>);
		...
		var _GeasType = TableEncryptionService.UseEncryption ? (Global.Geas)TableEncryptionService.Convert((int)_o.GeasType, key) : _o.GeasType;
