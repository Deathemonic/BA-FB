...
public struct MiniGameShootingGeasExcel : IFlatbufferObject
{
  ...
  public Global.Geas GeasType { get { int o = __p.__offset(6); return o != 0 ? (Global.Geas)__p.bb.GetInt(o + __p.bb_pos) : Global.Geas.ForwardProjectile; } }
  ...
  public static Offset<Global.MiniGameShootingGeasExcel> CreateMiniGameShootingGeasExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      Global.Geas GeasType = Global.Geas.ForwardProjectile,
  ...
  public static void AddGeasType(FlatBufferBuilder builder, Global.Geas geasType) { builder.AddInt(1, (int)geasType, 0); }
  ...
  public static Offset<Global.MiniGameShootingGeasExcel> EndMiniGameShootingGeasExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.MiniGameShootingGeasExcel>(o);
  }
  ...
  public static Offset<Global.MiniGameShootingGeasExcel> Pack(FlatBufferBuilder builder, MiniGameShootingGeasExcelT _o) {
    if (_o == null) return default(Offset<Global.MiniGameShootingGeasExcel>);
		byte[] key = TableEncryptionService.CreateKey("MiniGameShootingGeas");
		var _UniqueId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.UniqueId, key) : _o.UniqueId;
		var _GeasType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.GeasType, key) : _o.GeasType;
    var _Icon = _o.Icon == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.Icon, key) : _o.Icon));
		var _Probability = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Probability, key) : _o.Probability;
		var _MaxOverlapCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MaxOverlapCount, key) : _o.MaxOverlapCount;
    var _GeasData = _o.GeasData == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.GeasData, key) : _o.GeasData));
		var _NeedGeasId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.NeedGeasId, key) : _o.NeedGeasId;
		var _HideInPausePopup = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.HideInPausePopup, key) : _o.HideInPausePopup;
...
public class MiniGameShootingGeasExcelT
{
  ...
  public Global.Geas GeasType { get; set; }
  ...
  public MiniGameShootingGeasExcelT() {
    this.UniqueId = 0;
    this.GeasType = Global.Geas.ForwardProjectile;
    this.Icon = null;
    this.Probability = 0;
...
static public class MiniGameShootingGeasExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*GeasType*/, 4 /*Global.Geas*/, 4, false)
