...
public struct FieldQuestExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.FieldQuestExcel> CreateFieldQuestExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.FieldQuestExcel> EndFieldQuestExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.FieldQuestExcel>(o);
  }
  ...
  public void UnPackTo(FieldQuestExcelT _o) {
    ...
    _o.IsDaily = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.IsDaily, key) : this.IsDaily;
    ...
    _o.AssetPath = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.AssetPath, key) : this.AssetPath;
    ...
    _o.QuestNamKey = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.QuestNamKey, key) : this.QuestNamKey;
    _o.QuestDescKey = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.QuestDescKey, key) : this.QuestDescKey;
  }
  public static Offset<Global.FieldQuestExcel> Pack(FlatBufferBuilder builder, FieldQuestExcelT _o) {
    if (_o == null) return default(Offset<Global.FieldQuestExcel>);
		byte[] key = TableEncryptionService.CreateKey("FieldQuest");
		...
		var _IsDaily = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IsDaily, key) : _o.IsDaily;
    ...
    var _AssetPath = _o.AssetPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.AssetPath, key) : _o.AssetPath));
		...
		var _QuestNamKey = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.QuestNamKey, key) : _o.QuestNamKey;
		var _QuestDescKey = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.QuestDescKey, key) : _o.QuestDescKey;
    return CreateFieldQuestExcel(
      ...
      TableEncryptionService.UseEncryption ? _IsDaily : _o.IsDaily,
      ...
      TableEncryptionService.UseEncryption ? _QuestNamKey : _o.QuestNamKey,
      TableEncryptionService.UseEncryption ? _QuestDescKey : _o.QuestDescKey);
  }
}
