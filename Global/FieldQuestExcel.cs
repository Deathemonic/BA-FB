...
public struct FieldQuestExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(FieldQuestExcelT _o) {
    ...
    _o.IsDaily = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.IsDaily, key) : this.IsDaily;
    ...
    _o.QuestNamKey = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)this.QuestNamKey, key) : this.QuestNamKey;
    _o.QuestDescKey = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)this.QuestDescKey, key) : this.QuestDescKey;
  }
  public static Offset<Global.FieldQuestExcel> Pack(FlatBufferBuilder builder, FieldQuestExcelT _o) {
    if (_o == null) return default(Offset<Global.FieldQuestExcel>);
		...
		var _IsDaily = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.IsDaily, key) : _o.IsDaily;
    ...
    var _AssetPath = _o.AssetPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.AssetPath, key) : _o.AssetPath));
		...
		var _QuestNamKey = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)_o.QuestNamKey, key) : _o.QuestNamKey;
		var _QuestDescKey = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)_o.QuestDescKey, key) : _o.QuestDescKey;
