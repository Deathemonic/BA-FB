...
public struct EventContentSpoilerPopupExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.EventContentSpoilerPopupExcel> CreateEventContentSpoilerPopupExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.EventContentSpoilerPopupExcel> EndEventContentSpoilerPopupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.EventContentSpoilerPopupExcel>(o);
  }
  ...
  public static Offset<Global.EventContentSpoilerPopupExcel> Pack(FlatBufferBuilder builder, EventContentSpoilerPopupExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentSpoilerPopupExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentSpoilerPopup");
