...
public struct FieldTutorialExcel : IFlatbufferObject
{
  ...
  public Global.FieldTutorialType TutorialType(int j) { int o = __p.__offset(6); return o != 0 ? (Global.FieldTutorialType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Global.FieldTutorialType)0; }
  public int TutorialTypeLength { get { int o = __p.__offset(6); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Global.FieldTutorialType> GetTutorialTypeBytes() { return __p.__vector_as_span<Global.FieldTutorialType>(6, 4); }
#else
  public ArraySegment<byte>? GetTutorialTypeBytes() { return __p.__vector_as_arraysegment(6); }
#endif
  public Global.FieldTutorialType[] GetTutorialTypeArray() { int o = __p.__offset(6); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Global.FieldTutorialType[] a = new Global.FieldTutorialType[l]; for (int i = 0; i < l; i++) { a[i] = (Global.FieldTutorialType)__p.bb.GetInt(p + i * 4); } return a; }
  public Global.FieldConditionType ConditionType(int j) { int o = __p.__offset(8); return o != 0 ? (Global.FieldConditionType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Global.FieldConditionType)0; }
  public int ConditionTypeLength { get { int o = __p.__offset(8); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Global.FieldConditionType> GetConditionTypeBytes() { return __p.__vector_as_span<Global.FieldConditionType>(8, 4); }
#else
  public ArraySegment<byte>? GetConditionTypeBytes() { return __p.__vector_as_arraysegment(8); }
#endif
  public Global.FieldConditionType[] GetConditionTypeArray() { int o = __p.__offset(8); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Global.FieldConditionType[] a = new Global.FieldConditionType[l]; for (int i = 0; i < l; i++) { a[i] = (Global.FieldConditionType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static VectorOffset CreateTutorialTypeVector(FlatBufferBuilder builder, Global.FieldTutorialType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateTutorialTypeVectorBlock(FlatBufferBuilder builder, Global.FieldTutorialType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateTutorialTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Global.FieldTutorialType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateTutorialTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Global.FieldTutorialType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Global.FieldTutorialExcel> EndFieldTutorialExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.FieldTutorialExcel>(o);
  }
  ...
  public void UnPackTo(FieldTutorialExcelT _o) {
    ...
    _o.TutorialType = new List<Global.FieldTutorialType>();
    for (var _j = 0; _j < this.TutorialTypeLength; ++_j) {_o.TutorialType.Add(TableEncryptionService.UseEncryption ? (Global.FieldTutorialType)TableEncryptionService.Convert((int)this.TutorialType(_j), key) : this.TutorialType(_j));}
  ...
  public static Offset<Global.FieldTutorialExcel> Pack(FlatBufferBuilder builder, FieldTutorialExcelT _o) {
    ...
    if (_o.TutorialType != null) {
      var __tutorialType = _o.TutorialType.Select(x => TableEncryptionService.UseEncryption ? (Global.FieldTutorialType)TableEncryptionService.Convert((int)x, key) : x).ToArray();
...
public class FieldTutorialExcelT
{
  ...
  public List<Global.FieldTutorialType> TutorialType { get; set; }
...
static public class FieldTutorialExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 6 /*TutorialType*/, 4 /*Global.FieldTutorialType*/, false)
      && verifier.VerifyVectorOfData(tablePos, 8 /*ConditionType*/, 4 /*Global.FieldConditionType*/, false)
