...
public struct MiniGameShootingCharacterExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(MiniGameShootingCharacterExcelT _o) {
    ...
    _o.DefensePower = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.DefensePower, key) : this.DefensePower;
    _o.CriticalRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CriticalRate, key) : this.CriticalRate;
    ...
    _o.AttackRange = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.AttackRange, key) : this.AttackRange;
    _o.MoveSpeed = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MoveSpeed, key) : this.MoveSpeed;
    _o.ShotTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ShotTime, key) : this.ShotTime;
    _o.IsBoss = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.IsBoss, key) : this.IsBoss;
    _o.Scale = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Scale, key) : this.Scale;
    _o.IgnoreObstacleCheck = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.IgnoreObstacleCheck, key) : this.IgnoreObstacleCheck;
  ...
  public static Offset<Global.MiniGameShootingCharacterExcel> Pack(FlatBufferBuilder builder, MiniGameShootingCharacterExcelT _o) {
    ...
    var _DeathSkillData = _o.DeathSkillData == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.DeathSkillData, key) : _o.DeathSkillData));
		...
		var _DefensePower = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DefensePower, key) : _o.DefensePower;
		var _CriticalRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CriticalRate, key) : _o.CriticalRate;
		...
		var _AttackRange = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.AttackRange, key) : _o.AttackRange;
		var _MoveSpeed = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MoveSpeed, key) : _o.MoveSpeed;
		var _ShotTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ShotTime, key) : _o.ShotTime;
		var _IsBoss = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IsBoss, key) : _o.IsBoss;
		var _Scale = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Scale, key) : _o.Scale;
		var _IgnoreObstacleCheck = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IgnoreObstacleCheck, key) : _o.IgnoreObstacleCheck;
