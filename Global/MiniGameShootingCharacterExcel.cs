...
public struct MiniGameShootingCharacterExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.MiniGameShootingCharacterExcel> CreateMiniGameShootingCharacterExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
  ...
  public static Offset<Global.MiniGameShootingCharacterExcel> EndMiniGameShootingCharacterExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.MiniGameShootingCharacterExcel>(o);
  }
  ...
  public void UnPackTo(MiniGameShootingCharacterExcelT _o) {
    ...
    _o.BodyRadius = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)this.BodyRadius, key) : this.BodyRadius;
    ...
    _o.NormalAttackSkillData = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.NormalAttackSkillData, key) : this.NormalAttackSkillData;
    _o.PublicSkillData = new List<string>();
    for (var _j = 0; _j < this.PublicSkillDataLength; ++_j) {_o.PublicSkillData.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.PublicSkillData(_j), key) : this.PublicSkillData(_j));}
    _o.DeathSkillData = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.DeathSkillData, key) : this.DeathSkillData;
    ...
    _o.DefensePower = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.DefensePower, key) : this.DefensePower;
    _o.CriticalRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.CriticalRate, key) : this.CriticalRate;
    ...
    _o.AttackRange = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.AttackRange, key) : this.AttackRange;
    _o.MoveSpeed = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.MoveSpeed, key) : this.MoveSpeed;
    _o.ShotTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ShotTime, key) : this.ShotTime;
    _o.IsBoss = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.IsBoss, key) : this.IsBoss;
    _o.Scale = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)this.Scale, key) : this.Scale;
    _o.IgnoreObstacleCheck = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.IgnoreObstacleCheck, key) : this.IgnoreObstacleCheck;
  ...
  public static Offset<Global.MiniGameShootingCharacterExcel> Pack(FlatBufferBuilder builder, MiniGameShootingCharacterExcelT _o) {
    if (_o == null) return default(Offset<Global.MiniGameShootingCharacterExcel>);
		byte[] key = TableEncryptionService.CreateKey("MiniGameShootingCharacter");
    ...
    var _SpineResourceName = _o.SpineResourceName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.SpineResourceName, key) : _o.SpineResourceName));
		var _BodyRadius = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)_o.BodyRadius, key) : _o.BodyRadius;
    ...
    var _NormalAttackSkillData = _o.NormalAttackSkillData == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.NormalAttackSkillData, key) : _o.NormalAttackSkillData));
    ...
    if (_o.PublicSkillData != null) {
      ...
      for (var _j = 0; _j < __PublicSkillData.Length; ++_j) { __PublicSkillData[_j] = builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.PublicSkillData[_j], key) : _o.PublicSkillData[_j])); }
      _PublicSkillData = CreatePublicSkillDataVector(builder, __PublicSkillData);
    }
    var _DeathSkillData = _o.DeathSkillData == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.DeathSkillData, key) : _o.DeathSkillData));
		...
		var _DefensePower = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.DefensePower, key) : _o.DefensePower;
		var _CriticalRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.CriticalRate, key) : _o.CriticalRate;
		...
		var _AttackRange = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.AttackRange, key) : _o.AttackRange;
		var _MoveSpeed = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.MoveSpeed, key) : _o.MoveSpeed;
		var _ShotTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ShotTime, key) : _o.ShotTime;
		var _IsBoss = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.IsBoss, key) : _o.IsBoss;
		var _Scale = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)_o.Scale, key) : _o.Scale;
		var _IgnoreObstacleCheck = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.IgnoreObstacleCheck, key) : _o.IgnoreObstacleCheck;
    ...
    return CreateMiniGameShootingCharacterExcel(
      ...
      TableEncryptionService.UseEncryption ? _DefensePower : _o.DefensePower,
      TableEncryptionService.UseEncryption ? _CriticalRate : _o.CriticalRate,
      TableEncryptionService.UseEncryption ? _CriticalDamageRate : _o.CriticalDamageRate,
      TableEncryptionService.UseEncryption ? _AttackRange : _o.AttackRange,
      TableEncryptionService.UseEncryption ? _MoveSpeed : _o.MoveSpeed,
      TableEncryptionService.UseEncryption ? _ShotTime : _o.ShotTime,
      TableEncryptionService.UseEncryption ? _IsBoss : _o.IsBoss,
      TableEncryptionService.UseEncryption ? _Scale : _o.Scale,
      TableEncryptionService.UseEncryption ? _IgnoreObstacleCheck : _o.IgnoreObstacleCheck,
