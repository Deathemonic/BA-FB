...
public struct PersonalityExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.PersonalityExcel> CreatePersonalityExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Global.PersonalityExcel> EndPersonalityExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.PersonalityExcel>(o);
  }
  ...
  public static Offset<Global.PersonalityExcel> Pack(FlatBufferBuilder builder, PersonalityExcelT _o) {
    if (_o == null) return default(Offset<Global.PersonalityExcel>);
		byte[] key = TableEncryptionService.CreateKey("Personality");
