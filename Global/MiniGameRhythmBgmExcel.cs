...
public struct MiniGameRhythmBgmExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(MiniGameRhythmBgmExcelT _o) {
    ...
    _o.Bpm = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.Bpm, key) : this.Bpm;
    ...
    _o.HasLyricist = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.HasLyricist, key) : this.HasLyricist;
    ...
    _o.BgmLength = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.BgmLength, key) : this.BgmLength;
  }
  public static Offset<Global.MiniGameRhythmBgmExcel> Pack(FlatBufferBuilder builder, MiniGameRhythmBgmExcelT _o) {
    ...
    var _StageSelectImagePath = _o.StageSelectImagePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.StageSelectImagePath, key) : _o.StageSelectImagePath));
		var _Bpm = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.Bpm, key) : _o.Bpm;
		var _Bgm = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.Bgm, key) : _o.Bgm;
    var _BgmNameText = _o.BgmNameText == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.BgmNameText, key) : _o.BgmNameText));
    var _BgmArtistText = _o.BgmArtistText == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.BgmArtistText, key) : _o.BgmArtistText));
		var _HasLyricist = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.HasLyricist, key) : _o.HasLyricist;
    var _BgmComposerText = _o.BgmComposerText == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.BgmComposerText, key) : _o.BgmComposerText));
		var _BgmLength = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.BgmLength, key) : _o.BgmLength;
