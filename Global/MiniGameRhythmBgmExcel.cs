...
public struct MiniGameRhythmBgmExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.MiniGameRhythmBgmExcel> CreateMiniGameRhythmBgmExcel(FlatBufferBuilder builder,
      long RhythmBgmId = 0,
  ...
  public static Offset<Global.MiniGameRhythmBgmExcel> EndMiniGameRhythmBgmExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.MiniGameRhythmBgmExcel>(o);
  }
  ...
  public void UnPackTo(MiniGameRhythmBgmExcelT _o) {
    ...
    _o.StageSelectImagePath = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StageSelectImagePath, key) : this.StageSelectImagePath;
    _o.Bpm = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Bpm, key) : this.Bpm;
    _o.Bgm = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Bgm, key) : this.Bgm;
    _o.BgmNameText = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BgmNameText, key) : this.BgmNameText;
    _o.BgmArtistText = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BgmArtistText, key) : this.BgmArtistText;
    _o.HasLyricist = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.HasLyricist, key) : this.HasLyricist;
    _o.BgmComposerText = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BgmComposerText, key) : this.BgmComposerText;
    _o.BgmLength = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BgmLength, key) : this.BgmLength;
  }
  public static Offset<Global.MiniGameRhythmBgmExcel> Pack(FlatBufferBuilder builder, MiniGameRhythmBgmExcelT _o) {
    if (_o == null) return default(Offset<Global.MiniGameRhythmBgmExcel>);
		byte[] key = TableEncryptionService.CreateKey("MiniGameRhythmBgm");
    ...
    var _StageSelectImagePath = _o.StageSelectImagePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.StageSelectImagePath, key) : _o.StageSelectImagePath));
		var _Bpm = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Bpm, key) : _o.Bpm;
		var _Bgm = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Bgm, key) : _o.Bgm;
    var _BgmNameText = _o.BgmNameText == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.BgmNameText, key) : _o.BgmNameText));
    var _BgmArtistText = _o.BgmArtistText == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.BgmArtistText, key) : _o.BgmArtistText));
		var _HasLyricist = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.HasLyricist, key) : _o.HasLyricist;
    var _BgmComposerText = _o.BgmComposerText == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.BgmComposerText, key) : _o.BgmComposerText));
		var _BgmLength = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.BgmLength, key) : _o.BgmLength;
    return CreateMiniGameRhythmBgmExcel(
      ...
      TableEncryptionService.UseEncryption ? _Bpm : _o.Bpm,
      TableEncryptionService.UseEncryption ? _Bgm : _o.Bgm,
      _BgmNameText,
      _BgmArtistText,
      TableEncryptionService.UseEncryption ? _HasLyricist : _o.HasLyricist,
      _BgmComposerText,
      TableEncryptionService.UseEncryption ? _BgmLength : _o.BgmLength);
  }
}
