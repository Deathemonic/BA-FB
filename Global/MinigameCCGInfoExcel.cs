...
public struct MinigameCCGInfoExcel : IFlatbufferObject
{
  ...
  public Global.ParcelType CostParcelType { get { int o = __p.__offset(8); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Global.ParcelType.None; } }
  ...
  public Global.ParcelType PerkCostParcelType { get { int o = __p.__offset(16); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Global.ParcelType.None; } }
  public long PerkCostParcelId { get { int o = __p.__offset(18); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }

  public static Offset<Global.MinigameCCGInfoExcel> CreateMinigameCCGInfoExcel(FlatBufferBuilder builder,
      ...
      Global.ParcelType PerkCostParcelType = Global.ParcelType.None,
  ...
  public static void AddCostParcelType(FlatBufferBuilder builder, Global.ParcelType costParcelType) { builder.AddInt(2, (int)costParcelType, 0); }
  ...
  public static void AddPerkCostParcelType(FlatBufferBuilder builder, Global.ParcelType perkCostParcelType) { builder.AddInt(6, (int)perkCostParcelType, 0); }
  ...
  public static Offset<Global.MinigameCCGInfoExcel> EndMinigameCCGInfoExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.MinigameCCGInfoExcel>(o);
  }
  ...
  public static Offset<Global.MinigameCCGInfoExcel> Pack(FlatBufferBuilder builder, MinigameCCGInfoExcelT _o) {
    if (_o == null) return default(Offset<Global.MinigameCCGInfoExcel>);
		byte[] key = TableEncryptionService.CreateKey("MinigameCCGInfo");
		...
		var _CostParcelId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CostParcelId, key) : _o.CostParcelId;
		var _CostParcelAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CostParcelAmount, key) : _o.CostParcelAmount;
    var _CardBackPath = _o.CardBackPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.CardBackPath, key) : _o.CardBackPath));
		var _PerkCostParcelType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PerkCostParcelType, key) : _o.PerkCostParcelType;
		var _PerkCostParcelId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PerkCostParcelId, key) : _o.PerkCostParcelId;
...
public class MinigameCCGInfoExcelT
{
  ...
  public Global.ParcelType PerkCostParcelType { get; set; }
  ...
  public MinigameCCGInfoExcelT() {
    ...
    this.PerkCostParcelType = Global.ParcelType.None;
...
static public class MinigameCCGInfoExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*CostParcelType*/, 4 /*Global.ParcelType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 16 /*PerkCostParcelType*/, 4 /*Global.ParcelType*/, 4, false)
