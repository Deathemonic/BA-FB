...
public struct MinigameCCGInfoExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(MinigameCCGInfoExcelT _o) {
    ...
    _o.CostParcelType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)this.CostParcelType, key) : this.CostParcelType;
    ...
    _o.PerkCostParcelType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)this.PerkCostParcelType, key) : this.PerkCostParcelType;
  ...
  public static Offset<Global.MinigameCCGInfoExcel> Pack(FlatBufferBuilder builder, MinigameCCGInfoExcelT _o) {
    if (_o == null) return default(Offset<Global.MinigameCCGInfoExcel>);
		...
		var _CostParcelType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)_o.CostParcelType, key) : _o.CostParcelType;
    ...
    var _CardBackPath = _o.CardBackPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.CardBackPath, key) : _o.CardBackPath));
		var _PerkCostParcelType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)_o.PerkCostParcelType, key) : _o.PerkCostParcelType;
