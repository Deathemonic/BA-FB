...
public struct BGMRaidExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.BGMRaidExcel> CreateBGMRaidExcel(FlatBufferBuilder builder,
      long StageId = 0,
      long PhaseIndex = 0,
      long BGMId = 0) {
  ...
  public static Offset<Global.BGMRaidExcel> EndBGMRaidExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.BGMRaidExcel>(o);
  }
  ...
  public void UnPackTo(BGMRaidExcelT _o) {
    ...
    _o.PhaseIndex = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.PhaseIndex, key) : this.PhaseIndex;
    _o.BGMId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BGMId, key) : this.BGMId;
  }
  public static Offset<Global.BGMRaidExcel> Pack(FlatBufferBuilder builder, BGMRaidExcelT _o) {
    if (_o == null) return default(Offset<Global.BGMRaidExcel>);
		byte[] key = TableEncryptionService.CreateKey("BGMRaid");
		var _StageId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StageId, key) : _o.StageId;
		var _PhaseIndex = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PhaseIndex, key) : _o.PhaseIndex;
