...
public struct AttendanceRewardExcel : IFlatbufferObject
{
  ...
  public Global.ParcelType RewardParcelType(int j) { int o = __p.__offset(10); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Global.ParcelType)0; }
  public int RewardParcelTypeLength { get { int o = __p.__offset(10); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Global.ParcelType> GetRewardParcelTypeBytes() { return __p.__vector_as_span<Global.ParcelType>(10, 4); }
#else
  public ArraySegment<byte>? GetRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(10); }
#endif
  public Global.ParcelType[] GetRewardParcelTypeArray() { int o = __p.__offset(10); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Global.ParcelType[] a = new Global.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Global.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Global.AttendanceRewardExcel> CreateAttendanceRewardExcel(FlatBufferBuilder builder,
      long AttendanceId = 0,
      long Day = 0,
  ...
  public static Offset<Global.AttendanceRewardExcel> EndAttendanceRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.AttendanceRewardExcel>(o);
  }
  ...
  public void UnPackTo(AttendanceRewardExcelT _o) {
    ...
    _o.AttendanceId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.AttendanceId, key) : this.AttendanceId;
  ...
  public static Offset<Global.AttendanceRewardExcel> Pack(FlatBufferBuilder builder, AttendanceRewardExcelT _o) {
    if (_o == null) return default(Offset<Global.AttendanceRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("AttendanceReward");
		var _AttendanceId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.AttendanceId, key) : _o.AttendanceId;
		var _Day = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Day, key) : _o.Day;
    ...
    return CreateAttendanceRewardExcel(
      builder,
      TableEncryptionService.UseEncryption ? _AttendanceId : _o.AttendanceId,
      TableEncryptionService.UseEncryption ? _Day : _o.Day,
      _RewardIcon,
      _RewardParcelType,
      _RewardId,
      _RewardAmount);
...
static public class AttendanceRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 10 /*RewardParcelType*/, 4 /*Global.ParcelType*/, false)
