...
public struct FavorLevelRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.FavorLevelRewardExcel> CreateFavorLevelRewardExcel(FlatBufferBuilder builder,
      long CharacterId = 0,
      long FavorLevel = 0,
  ...
  public static Offset<Global.FavorLevelRewardExcel> EndFavorLevelRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.FavorLevelRewardExcel>(o);
  }
  ...
  public static Offset<Global.FavorLevelRewardExcel> Pack(FlatBufferBuilder builder, FavorLevelRewardExcelT _o) {
    if (_o == null) return default(Offset<Global.FavorLevelRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("FavorLevelReward");
		var _CharacterId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CharacterId, key) : _o.CharacterId;
		var _FavorLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.FavorLevel, key) : _o.FavorLevel;
    ...
    return CreateFavorLevelRewardExcel(
      ...
      TableEncryptionService.UseEncryption ? _FavorLevel : _o.FavorLevel,
      _StatType,
      _StatValue,
      _RewardParcelType,
      _RewardParcelId,
