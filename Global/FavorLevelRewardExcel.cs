...
public struct FavorLevelRewardExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(FavorLevelRewardExcelT _o) {
    ...
    _o.FavorLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.FavorLevel, key) : this.FavorLevel;
  ...
  public static Offset<Global.FavorLevelRewardExcel> Pack(FlatBufferBuilder builder, FavorLevelRewardExcelT _o) {
    if (_o == null) return default(Offset<Global.FavorLevelRewardExcel>);
		...
		var _FavorLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.FavorLevel, key) : _o.FavorLevel;
