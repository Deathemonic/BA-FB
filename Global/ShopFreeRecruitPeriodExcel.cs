...
public struct ShopFreeRecruitPeriodExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ShopFreeRecruitPeriodExcelT _o) {
    ...
    _o.ShopFreeRecruitId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ShopFreeRecruitId, key) : this.ShopFreeRecruitId;
    _o.ShopFreeRecruitIntervalId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ShopFreeRecruitIntervalId, key) : this.ShopFreeRecruitIntervalId;
    ...
    _o.FreeRecruitCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.FreeRecruitCount, key) : this.FreeRecruitCount;
  }
  public static Offset<Global.ShopFreeRecruitPeriodExcel> Pack(FlatBufferBuilder builder, ShopFreeRecruitPeriodExcelT _o) {
    if (_o == null) return default(Offset<Global.ShopFreeRecruitPeriodExcel>);
		byte[] key = TableEncryptionService.CreateKey("ShopFreeRecruitPeriod");
		var _ShopFreeRecruitId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ShopFreeRecruitId, key) : _o.ShopFreeRecruitId;
		var _ShopFreeRecruitIntervalId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ShopFreeRecruitIntervalId, key) : _o.ShopFreeRecruitIntervalId;
    var _IntervalDate = _o.IntervalDate == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.IntervalDate, key) : _o.IntervalDate));
		var _FreeRecruitCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.FreeRecruitCount, key) : _o.FreeRecruitCount;
