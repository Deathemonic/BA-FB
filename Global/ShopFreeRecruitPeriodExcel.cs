...
public struct ShopFreeRecruitPeriodExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.ShopFreeRecruitPeriodExcel> CreateShopFreeRecruitPeriodExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.ShopFreeRecruitPeriodExcel> EndShopFreeRecruitPeriodExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.ShopFreeRecruitPeriodExcel>(o);
  }
  ...
  public void UnPackTo(ShopFreeRecruitPeriodExcelT _o) {
    ...
    _o.ShopFreeRecruitId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ShopFreeRecruitId, key) : this.ShopFreeRecruitId;
    _o.ShopFreeRecruitIntervalId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ShopFreeRecruitIntervalId, key) : this.ShopFreeRecruitIntervalId;
    _o.IntervalDate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.IntervalDate, key) : this.IntervalDate;
    _o.FreeRecruitCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.FreeRecruitCount, key) : this.FreeRecruitCount;
  }
  public static Offset<Global.ShopFreeRecruitPeriodExcel> Pack(FlatBufferBuilder builder, ShopFreeRecruitPeriodExcelT _o) {
    if (_o == null) return default(Offset<Global.ShopFreeRecruitPeriodExcel>);
		byte[] key = TableEncryptionService.CreateKey("ShopFreeRecruitPeriod");
		var _ShopFreeRecruitId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ShopFreeRecruitId, key) : _o.ShopFreeRecruitId;
		var _ShopFreeRecruitIntervalId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ShopFreeRecruitIntervalId, key) : _o.ShopFreeRecruitIntervalId;
    var _IntervalDate = _o.IntervalDate == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.IntervalDate, key) : _o.IntervalDate));
		var _FreeRecruitCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.FreeRecruitCount, key) : _o.FreeRecruitCount;
    return CreateShopFreeRecruitPeriodExcel(
      builder,
      TableEncryptionService.UseEncryption ? _ShopFreeRecruitId : _o.ShopFreeRecruitId,
      TableEncryptionService.UseEncryption ? _ShopFreeRecruitIntervalId : _o.ShopFreeRecruitIntervalId,
      _IntervalDate,
      TableEncryptionService.UseEncryption ? _FreeRecruitCount : _o.FreeRecruitCount);
  }
}
