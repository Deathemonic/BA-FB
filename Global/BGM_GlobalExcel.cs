...
public struct BGM_GlobalExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(BGM_GlobalExcelT _o) {
    ...
    _o.GroupBGMId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.GroupBGMId, key) : this.GroupBGMId;
    _o.BGMIdKr = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BGMIdKr, key) : this.BGMIdKr;
    _o.BGMIdJp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BGMIdJp, key) : this.BGMIdJp;
    _o.BGMIdTh = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BGMIdTh, key) : this.BGMIdTh;
    _o.BGMIdTw = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BGMIdTw, key) : this.BGMIdTw;
    _o.BGMIdEn = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BGMIdEn, key) : this.BGMIdEn;
  }
  public static Offset<Global.BGM_GlobalExcel> Pack(FlatBufferBuilder builder, BGM_GlobalExcelT _o) {
    if (_o == null) return default(Offset<Global.BGM_GlobalExcel>);
		byte[] key = TableEncryptionService.CreateKey("BGM_Global");
		var _GroupBGMId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.GroupBGMId, key) : _o.GroupBGMId;
		var _BGMIdKr = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.BGMIdKr, key) : _o.BGMIdKr;
		var _BGMIdJp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.BGMIdJp, key) : _o.BGMIdJp;
		var _BGMIdTh = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.BGMIdTh, key) : _o.BGMIdTh;
		var _BGMIdTw = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.BGMIdTw, key) : _o.BGMIdTw;
		var _BGMIdEn = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.BGMIdEn, key) : _o.BGMIdEn;
