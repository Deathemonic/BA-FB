...
public struct BGM_GlobalExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.BGM_GlobalExcel> CreateBGM_GlobalExcel(FlatBufferBuilder builder,
      long GroupBGMId = 0,
      long BGMIdKr = 0,
      long BGMIdJp = 0,
      long BGMIdTh = 0,
  ...
  public static Offset<Global.BGM_GlobalExcel> EndBGM_GlobalExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.BGM_GlobalExcel>(o);
  }
  ...
  public void UnPackTo(BGM_GlobalExcelT _o) {
    ...
    _o.GroupBGMId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.GroupBGMId, key) : this.GroupBGMId;
    _o.BGMIdKr = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.BGMIdKr, key) : this.BGMIdKr;
    _o.BGMIdJp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.BGMIdJp, key) : this.BGMIdJp;
    _o.BGMIdTh = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.BGMIdTh, key) : this.BGMIdTh;
    _o.BGMIdTw = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.BGMIdTw, key) : this.BGMIdTw;
    _o.BGMIdEn = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.BGMIdEn, key) : this.BGMIdEn;
  }
  public static Offset<Global.BGM_GlobalExcel> Pack(FlatBufferBuilder builder, BGM_GlobalExcelT _o) {
    if (_o == null) return default(Offset<Global.BGM_GlobalExcel>);
		byte[] key = TableEncryptionService.CreateKey("BGM_Global");
		var _GroupBGMId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.GroupBGMId, key) : _o.GroupBGMId;
		var _BGMIdKr = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.BGMIdKr, key) : _o.BGMIdKr;
		var _BGMIdJp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.BGMIdJp, key) : _o.BGMIdJp;
		var _BGMIdTh = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.BGMIdTh, key) : _o.BGMIdTh;
		var _BGMIdTw = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.BGMIdTw, key) : _o.BGMIdTw;
		var _BGMIdEn = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.BGMIdEn, key) : _o.BGMIdEn;
    return CreateBGM_GlobalExcel(
      builder,
      TableEncryptionService.UseEncryption ? _GroupBGMId : _o.GroupBGMId,
      TableEncryptionService.UseEncryption ? _BGMIdKr : _o.BGMIdKr,
      TableEncryptionService.UseEncryption ? _BGMIdJp : _o.BGMIdJp,
      TableEncryptionService.UseEncryption ? _BGMIdTh : _o.BGMIdTh,
      TableEncryptionService.UseEncryption ? _BGMIdTw : _o.BGMIdTw,
      TableEncryptionService.UseEncryption ? _BGMIdEn : _o.BGMIdEn);
  }
}
