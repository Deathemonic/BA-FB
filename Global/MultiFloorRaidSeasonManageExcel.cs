...
public struct MultiFloorRaidSeasonManageExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.MultiFloorRaidSeasonManageExcel> CreateMultiFloorRaidSeasonManageExcel(FlatBufferBuilder builder,
      long SeasonId = 0,
  ...
  public static Offset<Global.MultiFloorRaidSeasonManageExcel> EndMultiFloorRaidSeasonManageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.MultiFloorRaidSeasonManageExcel>(o);
  }
  ...
  public static Offset<Global.MultiFloorRaidSeasonManageExcel> Pack(FlatBufferBuilder builder, MultiFloorRaidSeasonManageExcelT _o) {
    if (_o == null) return default(Offset<Global.MultiFloorRaidSeasonManageExcel>);
		byte[] key = TableEncryptionService.CreateKey("MultiFloorRaidSeasonManage");
		var _SeasonId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.SeasonId, key) : _o.SeasonId;
		var _LobbyEnterScenario = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.LobbyEnterScenario, key) : _o.LobbyEnterScenario;
		var _ShowLobbyBanner = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ShowLobbyBanner, key) : _o.ShowLobbyBanner;
    var _SeasonStartDate = _o.SeasonStartDate == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.SeasonStartDate, key) : _o.SeasonStartDate));
    ...
    var _SeasonEndDate = _o.SeasonEndDate == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.SeasonEndDate, key) : _o.SeasonEndDate));
    ...
    var _OpenRaidBossGroupId = _o.OpenRaidBossGroupId == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.OpenRaidBossGroupId, key) : _o.OpenRaidBossGroupId));
    ...
    var _LobbyImgPath = _o.LobbyImgPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.LobbyImgPath, key) : _o.LobbyImgPath));
    var _LevelImgPath = _o.LevelImgPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.LevelImgPath, key) : _o.LevelImgPath));
    var _PlayTip = _o.PlayTip == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.PlayTip, key) : _o.PlayTip));
    return CreateMultiFloorRaidSeasonManageExcel(
      builder,
      TableEncryptionService.UseEncryption ? _SeasonId : _o.SeasonId,
      TableEncryptionService.UseEncryption ? _LobbyEnterScenario : _o.LobbyEnterScenario,
      TableEncryptionService.UseEncryption ? _ShowLobbyBanner : _o.ShowLobbyBanner,
      _SeasonStartDate,
