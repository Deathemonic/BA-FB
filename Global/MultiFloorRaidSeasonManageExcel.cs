...
public struct MultiFloorRaidSeasonManageExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(MultiFloorRaidSeasonManageExcelT _o) {
    ...
    _o.LobbyEnterScenario = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)this.LobbyEnterScenario, key) : this.LobbyEnterScenario;
    _o.ShowLobbyBanner = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.ShowLobbyBanner, key) : this.ShowLobbyBanner;
  ...
  public static Offset<Global.MultiFloorRaidSeasonManageExcel> Pack(FlatBufferBuilder builder, MultiFloorRaidSeasonManageExcelT _o) {
    if (_o == null) return default(Offset<Global.MultiFloorRaidSeasonManageExcel>);
		...
		var _LobbyEnterScenario = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)_o.LobbyEnterScenario, key) : _o.LobbyEnterScenario;
		var _ShowLobbyBanner = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.ShowLobbyBanner, key) : _o.ShowLobbyBanner;
    var _SeasonStartDate = _o.SeasonStartDate == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.SeasonStartDate, key) : _o.SeasonStartDate));
    ...
    var _SeasonEndDate = _o.SeasonEndDate == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.SeasonEndDate, key) : _o.SeasonEndDate));
    ...
    var _OpenRaidBossGroupId = _o.OpenRaidBossGroupId == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.OpenRaidBossGroupId, key) : _o.OpenRaidBossGroupId));
    ...
    var _LobbyImgPath = _o.LobbyImgPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.LobbyImgPath, key) : _o.LobbyImgPath));
    var _LevelImgPath = _o.LevelImgPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.LevelImgPath, key) : _o.LevelImgPath));
    var _PlayTip = _o.PlayTip == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.PlayTip, key) : _o.PlayTip));
