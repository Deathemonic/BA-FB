...
public struct ConstKeyMappingExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.ConstKeyMappingExcel> Pack(FlatBufferBuilder builder, ConstKeyMappingExcelT _o) {
    if (_o == null) return default(Offset<Global.ConstKeyMappingExcel>);
		byte[] key = TableEncryptionService.CreateKey("ConstKeyMapping");
		var _DragSensitivity = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DragSensitivity, key) : _o.DragSensitivity;
		var _PcInformationGroupID = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PcInformationGroupID, key) : _o.PcInformationGroupID;
		var _ScrollWheelFactor = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ScrollWheelFactor, key) : _o.ScrollWheelFactor;
    var _RemoveKeycodeWord = _o.RemoveKeycodeWord == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.RemoveKeycodeWord, key) : _o.RemoveKeycodeWord));
    var _TutorialDialogTouchKey = _o.TutorialDialogTouchKey == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.TutorialDialogTouchKey, key) : _o.TutorialDialogTouchKey));
