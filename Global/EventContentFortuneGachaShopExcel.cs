...
public struct EventContentFortuneGachaShopExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.EventContentFortuneGachaShopExcel> CreateEventContentFortuneGachaShopExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.EventContentFortuneGachaShopExcel> EndEventContentFortuneGachaShopExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.EventContentFortuneGachaShopExcel>(o);
  }
  ...
  public static Offset<Global.EventContentFortuneGachaShopExcel> Pack(FlatBufferBuilder builder, EventContentFortuneGachaShopExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentFortuneGachaShopExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentFortuneGachaShop");
		...
		var _FortuneGachaGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.FortuneGachaGroupId, key) : _o.FortuneGachaGroupId;
