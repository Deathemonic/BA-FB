...
public struct EventContentFortuneGachaShopExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(EventContentFortuneGachaShopExcelT _o) {
    ...
    _o.ProbModifyValue = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.ProbModifyValue, key) : this.ProbModifyValue;
    _o.ProbModifyLimit = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.ProbModifyLimit, key) : this.ProbModifyLimit;
  ...
  public static Offset<Global.EventContentFortuneGachaShopExcel> Pack(FlatBufferBuilder builder, EventContentFortuneGachaShopExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentFortuneGachaShopExcel>);
		...
		var _ProbModifyValue = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.ProbModifyValue, key) : _o.ProbModifyValue;
		var _ProbModifyLimit = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.ProbModifyLimit, key) : _o.ProbModifyLimit;
