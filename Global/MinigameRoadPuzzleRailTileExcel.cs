...
public struct MinigameRoadPuzzleRailTileExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(MinigameRoadPuzzleRailTileExcelT _o) {
    ...
    _o.RailTileType = TableEncryptionService.UseEncryption ? (Global.RoadPuzzleRailTileType)TableEncryptionService.Convert((int)this.RailTileType, key) : this.RailTileType;
  }
  public static Offset<Global.MinigameRoadPuzzleRailTileExcel> Pack(FlatBufferBuilder builder, MinigameRoadPuzzleRailTileExcelT _o) {
    ...
    var _PrefabName = _o.PrefabName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.PrefabName, key) : _o.PrefabName));
		var _RailTileType = TableEncryptionService.UseEncryption ? (Global.RoadPuzzleRailTileType)TableEncryptionService.Convert((int)_o.RailTileType, key) : _o.RailTileType;
