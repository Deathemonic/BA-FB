...
public struct MinigameRoadPuzzleRailTileExcel : IFlatbufferObject
{
  ...
  public Global.RoadPuzzleRailTileType RailTileType { get { int o = __p.__offset(14); return o != 0 ? (Global.RoadPuzzleRailTileType)__p.bb.GetInt(o + __p.bb_pos) : Global.RoadPuzzleRailTileType.None; } }

  public static Offset<Global.MinigameRoadPuzzleRailTileExcel> CreateMinigameRoadPuzzleRailTileExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      long UniqueId = 0,
      long GroupId = 0,
      bool OriginalTile = false,
      StringOffset PrefabNameOffset = default(StringOffset),
      Global.RoadPuzzleRailTileType RailTileType = Global.RoadPuzzleRailTileType.None) {
  ...
  public static void AddRailTileType(FlatBufferBuilder builder, Global.RoadPuzzleRailTileType railTileType) { builder.AddInt(5, (int)railTileType, 0); }
  public static Offset<Global.MinigameRoadPuzzleRailTileExcel> EndMinigameRoadPuzzleRailTileExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.MinigameRoadPuzzleRailTileExcel>(o);
  }
  ...
  public static Offset<Global.MinigameRoadPuzzleRailTileExcel> Pack(FlatBufferBuilder builder, MinigameRoadPuzzleRailTileExcelT _o) {
    if (_o == null) return default(Offset<Global.MinigameRoadPuzzleRailTileExcel>);
		byte[] key = TableEncryptionService.CreateKey("MinigameRoadPuzzleRailTile");
		...
		var _OriginalTile = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.OriginalTile, key) : _o.OriginalTile;
    var _PrefabName = _o.PrefabName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.PrefabName, key) : _o.PrefabName));
		var _RailTileType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RailTileType, key) : _o.RailTileType;
...
public class MinigameRoadPuzzleRailTileExcelT
{
  ...
  public Global.RoadPuzzleRailTileType RailTileType { get; set; }
  ...
  public MinigameRoadPuzzleRailTileExcelT() {
    ...
    this.RailTileType = Global.RoadPuzzleRailTileType.None;
  }
}
...
static public class MinigameRoadPuzzleRailTileExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 14 /*RailTileType*/, 4 /*Global.RoadPuzzleRailTileType*/, 4, false)
