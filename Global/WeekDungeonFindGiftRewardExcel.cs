...
public struct WeekDungeonFindGiftRewardExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(WeekDungeonFindGiftRewardExcelT _o) {
    ...
    for (var _j = 0; _j < this.RewardParcelProbabilityLength; ++_j) {_o.RewardParcelProbability.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.RewardParcelProbability(_j), key) : this.RewardParcelProbability(_j));}
  ...
  public static Offset<Global.WeekDungeonFindGiftRewardExcel> Pack(FlatBufferBuilder builder, WeekDungeonFindGiftRewardExcelT _o) {
    ...
    if (_o.RewardParcelProbability != null) {
      var __RewardParcelProbability = _o.RewardParcelProbability.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
    ...
    if (_o.DropItemModelPrefabPath != null) {
      ...
      for (var _j = 0; _j < __DropItemModelPrefabPath.Length; ++_j) { __DropItemModelPrefabPath[_j] = builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.DropItemModelPrefabPath[_j], key) : _o.DropItemModelPrefabPath[_j])); }
