...
public struct WeekDungeonFindGiftRewardExcel : IFlatbufferObject
{
  ...
  public Global.ParcelType RewardParcelType(int j) { int o = __p.__offset(8); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Global.ParcelType)0; }
  public int RewardParcelTypeLength { get { int o = __p.__offset(8); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Global.ParcelType> GetRewardParcelTypeBytes() { return __p.__vector_as_span<Global.ParcelType>(8, 4); }
#else
  public ArraySegment<byte>? GetRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(8); }
#endif
  public Global.ParcelType[] GetRewardParcelTypeArray() { int o = __p.__offset(8); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Global.ParcelType[] a = new Global.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Global.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Global.WeekDungeonFindGiftRewardExcel> CreateWeekDungeonFindGiftRewardExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.WeekDungeonFindGiftRewardExcel> EndWeekDungeonFindGiftRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.WeekDungeonFindGiftRewardExcel>(o);
  }
  ...
  public void UnPackTo(WeekDungeonFindGiftRewardExcelT _o) {
    ...
    for (var _j = 0; _j < this.RewardParcelProbabilityLength; ++_j) {_o.RewardParcelProbability.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.RewardParcelProbability(_j), key) : this.RewardParcelProbability(_j));}
    _o.DropItemModelPrefabPath = new List<string>();
    for (var _j = 0; _j < this.DropItemModelPrefabPathLength; ++_j) {_o.DropItemModelPrefabPath.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.DropItemModelPrefabPath(_j), key) : this.DropItemModelPrefabPath(_j));}
  }
  public static Offset<Global.WeekDungeonFindGiftRewardExcel> Pack(FlatBufferBuilder builder, WeekDungeonFindGiftRewardExcelT _o) {
    if (_o == null) return default(Offset<Global.WeekDungeonFindGiftRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("WeekDungeonFindGiftReward");
    ...
    if (_o.RewardParcelProbability != null) {
      var __RewardParcelProbability = _o.RewardParcelProbability.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.DropItemModelPrefabPath != null) {
      ...
      for (var _j = 0; _j < __DropItemModelPrefabPath.Length; ++_j) { __DropItemModelPrefabPath[_j] = builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.DropItemModelPrefabPath[_j], key) : _o.DropItemModelPrefabPath[_j])); }
...
static public class WeekDungeonFindGiftRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 8 /*RewardParcelType*/, 4 /*Global.ParcelType*/, false)
