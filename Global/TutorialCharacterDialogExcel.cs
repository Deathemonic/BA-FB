...
public struct TutorialCharacterDialogExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.TutorialCharacterDialogExcel> CreateTutorialCharacterDialogExcel(FlatBufferBuilder builder,
      long TalkId = 0,
  ...
  public static Offset<Global.TutorialCharacterDialogExcel> EndTutorialCharacterDialogExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.TutorialCharacterDialogExcel>(o);
  }
  ...
  public void UnPackTo(TutorialCharacterDialogExcelT _o) {
    ...
    _o.TalkId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.TalkId, key) : this.TalkId;
  ...
  public static Offset<Global.TutorialCharacterDialogExcel> Pack(FlatBufferBuilder builder, TutorialCharacterDialogExcelT _o) {
    if (_o == null) return default(Offset<Global.TutorialCharacterDialogExcel>);
		byte[] key = TableEncryptionService.CreateKey("TutorialCharacterDialog");
		var _TalkId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.TalkId, key) : _o.TalkId;
    ...
    return CreateTutorialCharacterDialogExcel(
      builder,
      TableEncryptionService.UseEncryption ? _TalkId : _o.TalkId,
      _AnimationName,
      _LocalizeKR,
      _LocalizeJP,
      _LocalizeTH,
