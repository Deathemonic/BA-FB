...
public struct MiniGameDreamEndingRewardExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(MiniGameDreamEndingRewardExcelT _o) {
    ...
    _o.DreamMakerEndingRewardType = TableEncryptionService.UseEncryption ? (Global.DreamMakerEndingRewardType)TableEncryptionService.Convert((int)this.DreamMakerEndingRewardType, key) : this.DreamMakerEndingRewardType;
  ...
  public static Offset<Global.MiniGameDreamEndingRewardExcel> Pack(FlatBufferBuilder builder, MiniGameDreamEndingRewardExcelT _o) {
    if (_o == null) return default(Offset<Global.MiniGameDreamEndingRewardExcel>);
		...
		var _DreamMakerEndingRewardType = TableEncryptionService.UseEncryption ? (Global.DreamMakerEndingRewardType)TableEncryptionService.Convert((int)_o.DreamMakerEndingRewardType, key) : _o.DreamMakerEndingRewardType;
