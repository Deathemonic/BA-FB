...
public struct CampaignStageRewardExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(CampaignStageRewardExcelT _o) {
    ...
    _o.StageRewardParcelType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)this.StageRewardParcelType, key) : this.StageRewardParcelType;
  ...
  public static Offset<Global.CampaignStageRewardExcel> Pack(FlatBufferBuilder builder, CampaignStageRewardExcelT _o) {
    if (_o == null) return default(Offset<Global.CampaignStageRewardExcel>);
		...
		var _StageRewardParcelType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)_o.StageRewardParcelType, key) : _o.StageRewardParcelType;
