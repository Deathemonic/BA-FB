...
public struct DuplicateBonusExcel : IFlatbufferObject
{
  ...
  public Global.ItemCategory ItemCategory { get { int o = __p.__offset(6); return o != 0 ? (Global.ItemCategory)__p.bb.GetInt(o + __p.bb_pos) : Global.ItemCategory.Coin; } }
  ...
  public static Offset<Global.DuplicateBonusExcel> CreateDuplicateBonusExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddItemCategory(FlatBufferBuilder builder, Global.ItemCategory itemCategory) { builder.AddInt(1, (int)itemCategory, 0); }
  ...
  public static Offset<Global.DuplicateBonusExcel> EndDuplicateBonusExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.DuplicateBonusExcel>(o);
  }
  ...
  public static Offset<Global.DuplicateBonusExcel> Pack(FlatBufferBuilder builder, DuplicateBonusExcelT _o) {
    if (_o == null) return default(Offset<Global.DuplicateBonusExcel>);
		byte[] key = TableEncryptionService.CreateKey("DuplicateBonus");
...
static public class DuplicateBonusExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*ItemCategory*/, 4 /*Global.ItemCategory*/, 4, false)
