...
public struct TimeAttackDungeonRewardExcel : IFlatbufferObject
{
  ...
  public Global.TimeAttackDungeonRewardType RewardType(int j) { int o = __p.__offset(8); return o != 0 ? (Global.TimeAttackDungeonRewardType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Global.TimeAttackDungeonRewardType)0; }
  public int RewardTypeLength { get { int o = __p.__offset(8); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Global.TimeAttackDungeonRewardType> GetRewardTypeBytes() { return __p.__vector_as_span<Global.TimeAttackDungeonRewardType>(8, 4); }
#else
  public ArraySegment<byte>? GetRewardTypeBytes() { return __p.__vector_as_arraysegment(8); }
#endif
  public Global.TimeAttackDungeonRewardType[] GetRewardTypeArray() { int o = __p.__offset(8); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Global.TimeAttackDungeonRewardType[] a = new Global.TimeAttackDungeonRewardType[l]; for (int i = 0; i < l; i++) { a[i] = (Global.TimeAttackDungeonRewardType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Global.TimeAttackDungeonRewardExcel> CreateTimeAttackDungeonRewardExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static VectorOffset CreateRewardTypeVector(FlatBufferBuilder builder, Global.TimeAttackDungeonRewardType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateRewardTypeVectorBlock(FlatBufferBuilder builder, Global.TimeAttackDungeonRewardType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateRewardTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Global.TimeAttackDungeonRewardType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateRewardTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Global.TimeAttackDungeonRewardType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Global.TimeAttackDungeonRewardExcel> EndTimeAttackDungeonRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.TimeAttackDungeonRewardExcel>(o);
  }
  ...
  public void UnPackTo(TimeAttackDungeonRewardExcelT _o) {
    ...
    _o.RewardType = new List<Global.TimeAttackDungeonRewardType>();
    for (var _j = 0; _j < this.RewardTypeLength; ++_j) {_o.RewardType.Add(TableEncryptionService.UseEncryption ? (Global.TimeAttackDungeonRewardType)TableEncryptionService.Convert((int)this.RewardType(_j), key) : this.RewardType(_j));}
  ...
  public static Offset<Global.TimeAttackDungeonRewardExcel> Pack(FlatBufferBuilder builder, TimeAttackDungeonRewardExcelT _o) {
    if (_o == null) return default(Offset<Global.TimeAttackDungeonRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("TimeAttackDungeonReward");
    ...
    if (_o.RewardType != null) {
      var __RewardType = _o.RewardType.Select(x => TableEncryptionService.UseEncryption ? (Global.TimeAttackDungeonRewardType)TableEncryptionService.Convert((int)x, key) : x).ToArray();
...
public class TimeAttackDungeonRewardExcelT
{
  ...
  public List<Global.TimeAttackDungeonRewardType> RewardType { get; set; }
...
static public class TimeAttackDungeonRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 8 /*RewardType*/, 4 /*Global.TimeAttackDungeonRewardType*/, false)
