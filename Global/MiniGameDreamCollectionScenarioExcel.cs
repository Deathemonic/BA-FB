...
public struct MiniGameDreamCollectionScenarioExcel : IFlatbufferObject
{
  ...
  public Global.DreamMakerParameterType Parameter(int j) { int o = __p.__offset(10); return o != 0 ? (Global.DreamMakerParameterType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Global.DreamMakerParameterType)0; }
  public int ParameterLength { get { int o = __p.__offset(10); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Global.DreamMakerParameterType> GetParameterBytes() { return __p.__vector_as_span<Global.DreamMakerParameterType>(10, 4); }
#else
  public ArraySegment<byte>? GetParameterBytes() { return __p.__vector_as_arraysegment(10); }
#endif
  public Global.DreamMakerParameterType[] GetParameterArray() { int o = __p.__offset(10); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Global.DreamMakerParameterType[] a = new Global.DreamMakerParameterType[l]; for (int i = 0; i < l; i++) { a[i] = (Global.DreamMakerParameterType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Global.MiniGameDreamCollectionScenarioExcel> CreateMiniGameDreamCollectionScenarioExcel(FlatBufferBuilder builder,
      long Id = 0,
      bool IsSkip = false,
  ...
  public static VectorOffset CreateParameterVector(FlatBufferBuilder builder, Global.DreamMakerParameterType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateParameterVectorBlock(FlatBufferBuilder builder, Global.DreamMakerParameterType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateParameterVectorBlock(FlatBufferBuilder builder, ArraySegment<Global.DreamMakerParameterType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateParameterVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Global.DreamMakerParameterType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Global.MiniGameDreamCollectionScenarioExcel> EndMiniGameDreamCollectionScenarioExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.MiniGameDreamCollectionScenarioExcel>(o);
  }
  ...
  public void UnPackTo(MiniGameDreamCollectionScenarioExcelT _o) {
    ...
    _o.IsSkip = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.IsSkip, key) : this.IsSkip;
    ...
    _o.Parameter = new List<Global.DreamMakerParameterType>();
    for (var _j = 0; _j < this.ParameterLength; ++_j) {_o.Parameter.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Parameter(_j), key) : this.Parameter(_j));}
    _o.ParameterAmount = new List<long>();
    for (var _j = 0; _j < this.ParameterAmountLength; ++_j) {_o.ParameterAmount.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ParameterAmount(_j), key) : this.ParameterAmount(_j));}
  ...
  public static Offset<Global.MiniGameDreamCollectionScenarioExcel> Pack(FlatBufferBuilder builder, MiniGameDreamCollectionScenarioExcelT _o) {
    if (_o == null) return default(Offset<Global.MiniGameDreamCollectionScenarioExcel>);
		byte[] key = TableEncryptionService.CreateKey("MiniGameDreamCollectionScenario");
		var _Id = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Id, key) : _o.Id;
		var _IsSkip = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IsSkip, key) : _o.IsSkip;
    ...
    if (_o.Parameter != null) {
      var __Parameter = _o.Parameter.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
      _Parameter = CreateParameterVector(builder, __Parameter);
    }
    var _ParameterAmount = default(VectorOffset);
    if (_o.ParameterAmount != null) {
      var __ParameterAmount = _o.ParameterAmount.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
...
public class MiniGameDreamCollectionScenarioExcelT
{
  ...
  public List<Global.DreamMakerParameterType> Parameter { get; set; }
...
static public class MiniGameDreamCollectionScenarioExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 10 /*Parameter*/, 4 /*Global.DreamMakerParameterType*/, false)
