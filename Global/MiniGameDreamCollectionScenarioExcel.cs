...
public struct MiniGameDreamCollectionScenarioExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(MiniGameDreamCollectionScenarioExcelT _o) {
    ...
    for (var _j = 0; _j < this.ParameterLength; ++_j) {_o.Parameter.Add(TableEncryptionService.UseEncryption ? (Global.DreamMakerParameterType)TableEncryptionService.Convert((int)this.Parameter(_j), key) : this.Parameter(_j));}
  ...
  public static Offset<Global.MiniGameDreamCollectionScenarioExcel> Pack(FlatBufferBuilder builder, MiniGameDreamCollectionScenarioExcelT _o) {
    ...
    if (_o.Parameter != null) {
      var __Parameter = _o.Parameter.Select(x => TableEncryptionService.UseEncryption ? (Global.DreamMakerParameterType)TableEncryptionService.Convert((int)x, key) : x).ToArray();
