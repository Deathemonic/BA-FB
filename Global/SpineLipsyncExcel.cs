...
public struct SpineLipsyncExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.SpineLipsyncExcel> Pack(FlatBufferBuilder builder, SpineLipsyncExcelT _o) {
    ...
    var _AnimJson = _o.AnimJson == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.AnimJson, key) : _o.AnimJson));
    var _AnimJsonKr = _o.AnimJsonKr == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.AnimJsonKr, key) : _o.AnimJsonKr));
