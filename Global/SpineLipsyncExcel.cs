...
public struct SpineLipsyncExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.SpineLipsyncExcel> CreateSpineLipsyncExcel(FlatBufferBuilder builder,
      uint VoiceId = 0,
  ...
  public static Offset<Global.SpineLipsyncExcel> EndSpineLipsyncExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.SpineLipsyncExcel>(o);
  }
  ...
  public void UnPackTo(SpineLipsyncExcelT _o) {
    ...
    _o.AnimJson = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.AnimJson, key) : this.AnimJson;
    _o.AnimJsonKr = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.AnimJsonKr, key) : this.AnimJsonKr;
  }
  public static Offset<Global.SpineLipsyncExcel> Pack(FlatBufferBuilder builder, SpineLipsyncExcelT _o) {
    if (_o == null) return default(Offset<Global.SpineLipsyncExcel>);
		byte[] key = TableEncryptionService.CreateKey("SpineLipsync");
		var _VoiceId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.VoiceId, key) : _o.VoiceId;
    var _AnimJson = _o.AnimJson == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.AnimJson, key) : _o.AnimJson));
    var _AnimJsonKr = _o.AnimJsonKr == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.AnimJsonKr, key) : _o.AnimJsonKr));
