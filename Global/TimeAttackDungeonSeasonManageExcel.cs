...
public struct TimeAttackDungeonSeasonManageExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.TimeAttackDungeonSeasonManageExcel> Pack(FlatBufferBuilder builder, TimeAttackDungeonSeasonManageExcelT _o) {
    ...
    var _EndDate = _o.EndDate == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.EndDate, key) : _o.EndDate));
		var _UISlot = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.UISlot, key) : _o.UISlot;
		var _DungeonId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DungeonId, key) : _o.DungeonId;
    var _DifficultyGeas = default(VectorOffset);
    if (_o.DifficultyGeas != null) {
      var __DifficultyGeas = _o.DifficultyGeas.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
      _DifficultyGeas = CreateDifficultyGeasVector(builder, __DifficultyGeas);
    }
		var _TimeAttackDungeonRewardId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.TimeAttackDungeonRewardId, key) : _o.TimeAttackDungeonRewardId;
		var _RoomLifeTimeInSeconds = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RoomLifeTimeInSeconds, key) : _o.RoomLifeTimeInSeconds;
