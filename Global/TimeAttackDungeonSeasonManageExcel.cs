...
public struct TimeAttackDungeonSeasonManageExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.TimeAttackDungeonSeasonManageExcel> CreateTimeAttackDungeonSeasonManageExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Global.TimeAttackDungeonSeasonManageExcel> EndTimeAttackDungeonSeasonManageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.TimeAttackDungeonSeasonManageExcel>(o);
  }
  ...
  public void UnPackTo(TimeAttackDungeonSeasonManageExcelT _o) {
    ...
    _o.UISlot = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.UISlot, key) : this.UISlot;
    _o.DungeonId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.DungeonId, key) : this.DungeonId;
    _o.DifficultyGeas = new List<long>();
    for (var _j = 0; _j < this.DifficultyGeasLength; ++_j) {_o.DifficultyGeas.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.DifficultyGeas(_j), key) : this.DifficultyGeas(_j));}
    _o.TimeAttackDungeonRewardId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.TimeAttackDungeonRewardId, key) : this.TimeAttackDungeonRewardId;
    _o.RoomLifeTimeInSeconds = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.RoomLifeTimeInSeconds, key) : this.RoomLifeTimeInSeconds;
  }
  public static Offset<Global.TimeAttackDungeonSeasonManageExcel> Pack(FlatBufferBuilder builder, TimeAttackDungeonSeasonManageExcelT _o) {
    if (_o == null) return default(Offset<Global.TimeAttackDungeonSeasonManageExcel>);
		byte[] key = TableEncryptionService.CreateKey("TimeAttackDungeonSeasonManage");
    ...
    var _EndDate = _o.EndDate == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.EndDate, key) : _o.EndDate));
		var _UISlot = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.UISlot, key) : _o.UISlot;
		var _DungeonId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.DungeonId, key) : _o.DungeonId;
    var _DifficultyGeas = default(VectorOffset);
    if (_o.DifficultyGeas != null) {
      var __DifficultyGeas = _o.DifficultyGeas.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
      _DifficultyGeas = CreateDifficultyGeasVector(builder, __DifficultyGeas);
    }
		var _TimeAttackDungeonRewardId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.TimeAttackDungeonRewardId, key) : _o.TimeAttackDungeonRewardId;
		var _RoomLifeTimeInSeconds = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.RoomLifeTimeInSeconds, key) : _o.RoomLifeTimeInSeconds;
    return CreateTimeAttackDungeonSeasonManageExcel(
      ...
      _EndDate,
      TableEncryptionService.UseEncryption ? _UISlot : _o.UISlot,
      TableEncryptionService.UseEncryption ? _DungeonId : _o.DungeonId,
      _DifficultyGeas,
      TableEncryptionService.UseEncryption ? _TimeAttackDungeonRewardId : _o.TimeAttackDungeonRewardId,
      TableEncryptionService.UseEncryption ? _RoomLifeTimeInSeconds : _o.RoomLifeTimeInSeconds);
  }
}
