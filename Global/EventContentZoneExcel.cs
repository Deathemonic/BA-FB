...
public struct EventContentZoneExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(EventContentZoneExcelT _o) {
    ...
    _o.OriginalZoneId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.OriginalZoneId, key) : this.OriginalZoneId;
    _o.LocationId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.LocationId, key) : this.LocationId;
    ...
    _o.EventPointForLocationRank = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EventPointForLocationRank, key) : this.EventPointForLocationRank;
    ...
    for (var _j = 0; _j < this.StudentVisitProbLength; ++_j) {_o.StudentVisitProb.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StudentVisitProb(_j), key) : this.StudentVisitProb(_j));}
    ...
    for (var _j = 0; _j < this.WhiteListTagsLength; ++_j) {_o.WhiteListTags.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.WhiteListTags(_j), key) : this.WhiteListTags(_j));}
  }
  public static Offset<Global.EventContentZoneExcel> Pack(FlatBufferBuilder builder, EventContentZoneExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentZoneExcel>);
		...
		var _OriginalZoneId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.OriginalZoneId, key) : _o.OriginalZoneId;
		var _LocationId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.LocationId, key) : _o.LocationId;
