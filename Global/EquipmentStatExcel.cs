...
public struct EquipmentStatExcel : IFlatbufferObject
{
  ...
  public Global.StatLevelUpType StatLevelUpType { get { int o = __p.__offset(6); return o != 0 ? (Global.StatLevelUpType)__p.bb.GetInt(o + __p.bb_pos) : Global.StatLevelUpType.Standard; } }
  public Global.EquipmentOptionType StatType(int j) { int o = __p.__offset(8); return o != 0 ? (Global.EquipmentOptionType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Global.EquipmentOptionType)0; }
  public int StatTypeLength { get { int o = __p.__offset(8); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Global.EquipmentOptionType> GetStatTypeBytes() { return __p.__vector_as_span<Global.EquipmentOptionType>(8, 4); }
#else
  public ArraySegment<byte>? GetStatTypeBytes() { return __p.__vector_as_arraysegment(8); }
#endif
  public Global.EquipmentOptionType[] GetStatTypeArray() { int o = __p.__offset(8); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Global.EquipmentOptionType[] a = new Global.EquipmentOptionType[l]; for (int i = 0; i < l; i++) { a[i] = (Global.EquipmentOptionType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Global.CurrencyTypes LevelUpFeedCostCurrency { get { int o = __p.__offset(18); return o != 0 ? (Global.CurrencyTypes)__p.bb.GetInt(o + __p.bb_pos) : Global.CurrencyTypes.Invalid; } }
  public long LevelUpFeedCostAmount { get { int o = __p.__offset(20); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public Global.EquipmentCategory EquipmentCategory { get { int o = __p.__offset(22); return o != 0 ? (Global.EquipmentCategory)__p.bb.GetInt(o + __p.bb_pos) : Global.EquipmentCategory.Unable; } }
  ...
  public static void AddStatLevelUpType(FlatBufferBuilder builder, Global.StatLevelUpType statLevelUpType) { builder.AddInt(1, (int)statLevelUpType, 0); }
  ...
  public static VectorOffset CreateStatTypeVector(FlatBufferBuilder builder, Global.EquipmentOptionType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateStatTypeVectorBlock(FlatBufferBuilder builder, Global.EquipmentOptionType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateStatTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Global.EquipmentOptionType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateStatTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Global.EquipmentOptionType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static void AddLevelUpFeedCostCurrency(FlatBufferBuilder builder, Global.CurrencyTypes levelUpFeedCostCurrency) { builder.AddInt(7, (int)levelUpFeedCostCurrency, 0); }
  ...
  public static void AddEquipmentCategory(FlatBufferBuilder builder, Global.EquipmentCategory equipmentCategory) { builder.AddInt(9, (int)equipmentCategory, 0); }
  ...
  public static Offset<Global.EquipmentStatExcel> EndEquipmentStatExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.EquipmentStatExcel>(o);
  }
  ...
  public void UnPackTo(EquipmentStatExcelT _o) {
    ...
    _o.EquipmentId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.EquipmentId, key) : this.EquipmentId;
    ...
    _o.StatType = new List<Global.EquipmentOptionType>();
    for (var _j = 0; _j < this.StatTypeLength; ++_j) {_o.StatType.Add(TableEncryptionService.UseEncryption ? (Global.EquipmentOptionType)TableEncryptionService.Convert((int)this.StatType(_j), key) : this.StatType(_j));}
    _o.MinStat = new List<long>();
    for (var _j = 0; _j < this.MinStatLength; ++_j) {_o.MinStat.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.MinStat(_j), key) : this.MinStat(_j));}
    _o.MaxStat = new List<long>();
    for (var _j = 0; _j < this.MaxStatLength; ++_j) {_o.MaxStat.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.MaxStat(_j), key) : this.MaxStat(_j));}
    _o.LevelUpInsertLimit = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.LevelUpInsertLimit, key) : this.LevelUpInsertLimit;
    _o.LevelUpFeedExp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.LevelUpFeedExp, key) : this.LevelUpFeedExp;
    _o.LevelUpFeedCostCurrency = TableEncryptionService.UseEncryption ? (Global.CurrencyTypes)TableEncryptionService.Convert((int)this.LevelUpFeedCostCurrency, key) : this.LevelUpFeedCostCurrency;
    _o.LevelUpFeedCostAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.LevelUpFeedCostAmount, key) : this.LevelUpFeedCostAmount;
    _o.EquipmentCategory = TableEncryptionService.UseEncryption ? (Global.EquipmentCategory)TableEncryptionService.Convert((int)this.EquipmentCategory, key) : this.EquipmentCategory;
    _o.LevelUpFeedAddExp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.LevelUpFeedAddExp, key) : this.LevelUpFeedAddExp;
    _o.DefaultMaxLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.DefaultMaxLevel, key) : this.DefaultMaxLevel;
    _o.TranscendenceMax = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.TranscendenceMax, key) : this.TranscendenceMax;
  ...
  public static Offset<Global.EquipmentStatExcel> Pack(FlatBufferBuilder builder, EquipmentStatExcelT _o) {
    if (_o == null) return default(Offset<Global.EquipmentStatExcel>);
		byte[] key = TableEncryptionService.CreateKey("EquipmentStat");
		var _EquipmentId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.EquipmentId, key) : _o.EquipmentId;
    ...
    if (_o.StatType != null) {
      var __StatType = _o.StatType.Select(x => TableEncryptionService.UseEncryption ? (Global.EquipmentOptionType)TableEncryptionService.Convert((int)x, key) : x).ToArray();
      _StatType = CreateStatTypeVector(builder, __StatType);
    }
    var _MinStat = default(VectorOffset);
    if (_o.MinStat != null) {
      var __MinStat = _o.MinStat.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
      _MinStat = CreateMinStatVector(builder, __MinStat);
    }
    var _MaxStat = default(VectorOffset);
    if (_o.MaxStat != null) {
      var __MaxStat = _o.MaxStat.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
      _MaxStat = CreateMaxStatVector(builder, __MaxStat);
    }
		var _LevelUpInsertLimit = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.LevelUpInsertLimit, key) : _o.LevelUpInsertLimit;
		var _LevelUpFeedExp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.LevelUpFeedExp, key) : _o.LevelUpFeedExp;
		var _LevelUpFeedCostCurrency = TableEncryptionService.UseEncryption ? (Global.CurrencyTypes)TableEncryptionService.Convert((int)_o.LevelUpFeedCostCurrency, key) : _o.LevelUpFeedCostCurrency;
		var _LevelUpFeedCostAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.LevelUpFeedCostAmount, key) : _o.LevelUpFeedCostAmount;
		var _EquipmentCategory = TableEncryptionService.UseEncryption ? (Global.EquipmentCategory)TableEncryptionService.Convert((int)_o.EquipmentCategory, key) : _o.EquipmentCategory;
		var _LevelUpFeedAddExp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.LevelUpFeedAddExp, key) : _o.LevelUpFeedAddExp;
		var _DefaultMaxLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.DefaultMaxLevel, key) : _o.DefaultMaxLevel;
		var _TranscendenceMax = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.TranscendenceMax, key) : _o.TranscendenceMax;
    ...
    return CreateEquipmentStatExcel(
      ...
      TableEncryptionService.UseEncryption ? _LevelUpFeedCostAmount : _o.LevelUpFeedCostAmount,
      TableEncryptionService.UseEncryption ? _EquipmentCategory : _o.EquipmentCategory,
      TableEncryptionService.UseEncryption ? _LevelUpFeedAddExp : _o.LevelUpFeedAddExp,
      TableEncryptionService.UseEncryption ? _DefaultMaxLevel : _o.DefaultMaxLevel,
      TableEncryptionService.UseEncryption ? _TranscendenceMax : _o.TranscendenceMax,
...
public class EquipmentStatExcelT
{
  ...
  public List<Global.EquipmentOptionType> StatType { get; set; }
  ...
  public Global.CurrencyTypes LevelUpFeedCostCurrency { get; set; }
  ...
  public EquipmentStatExcelT() {
    ...
    this.LevelUpFeedCostCurrency = Global.CurrencyTypes.Invalid;
...
static public class EquipmentStatExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*StatLevelUpType*/, 4 /*Global.StatLevelUpType*/, 4, false)
      && verifier.VerifyVectorOfData(tablePos, 8 /*StatType*/, 4 /*Global.EquipmentOptionType*/, false)
      ...
      && verifier.VerifyField(tablePos, 18 /*LevelUpFeedCostCurrency*/, 4 /*Global.CurrencyTypes*/, 4, false)
      && verifier.VerifyField(tablePos, 20 /*LevelUpFeedCostAmount*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 22 /*EquipmentCategory*/, 4 /*Global.EquipmentCategory*/, 4, false)
