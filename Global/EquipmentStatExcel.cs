  ...
  public static Offset<Global.EquipmentStatExcel> Pack(FlatBufferBuilder builder, EquipmentStatExcelT _o) {
    ...
    if (_o.MaxStat != null) {
      ...
      _maxStat = CreateMaxStatVector(builder, __maxStat);
		...
		var _LevelUpFeedCostCurrency = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.LevelUpFeedCostCurrency, key) : _o.LevelUpFeedCostCurrency;
		var _LevelUpFeedCostAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.LevelUpFeedCostAmount, key) : _o.LevelUpFeedCostAmount;
		...
		var _LevelUpFeedAddExp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.LevelUpFeedAddExp, key) : _o.LevelUpFeedAddExp;
		var _DefaultMaxLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DefaultMaxLevel, key) : _o.DefaultMaxLevel;
		var _TranscendenceMax = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.TranscendenceMax, key) : _o.TranscendenceMax;
    var _DamageFactorGroupId = _o.DamageFactorGroupId == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.DamageFactorGroupId, key) : _o.DamageFactorGroupId));
