...
public struct MiniGameDreamDailyPointExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(MiniGameDreamDailyPointExcelT _o) {
    ...
    _o.TotalParameterMin = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.TotalParameterMin, key) : this.TotalParameterMin;
    _o.TotalParameterMax = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.TotalParameterMax, key) : this.TotalParameterMax;
    _o.DailyPointCoefficient = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.DailyPointCoefficient, key) : this.DailyPointCoefficient;
    _o.DailyPointCorrectionValue = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.DailyPointCorrectionValue, key) : this.DailyPointCorrectionValue;
  }
  public static Offset<Global.MiniGameDreamDailyPointExcel> Pack(FlatBufferBuilder builder, MiniGameDreamDailyPointExcelT _o) {
    if (_o == null) return default(Offset<Global.MiniGameDreamDailyPointExcel>);
		...
		var _TotalParameterMin = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.TotalParameterMin, key) : _o.TotalParameterMin;
		var _TotalParameterMax = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.TotalParameterMax, key) : _o.TotalParameterMax;
		var _DailyPointCoefficient = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DailyPointCoefficient, key) : _o.DailyPointCoefficient;
		var _DailyPointCorrectionValue = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DailyPointCorrectionValue, key) : _o.DailyPointCorrectionValue;
