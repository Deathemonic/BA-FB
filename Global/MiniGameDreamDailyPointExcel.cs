...
public struct MiniGameDreamDailyPointExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.MiniGameDreamDailyPointExcel> CreateMiniGameDreamDailyPointExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
  ...
  public static Offset<Global.MiniGameDreamDailyPointExcel> EndMiniGameDreamDailyPointExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.MiniGameDreamDailyPointExcel>(o);
  }
  ...
  public void UnPackTo(MiniGameDreamDailyPointExcelT _o) {
    ...
    _o.TotalParameterMin = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.TotalParameterMin, key) : this.TotalParameterMin;
    _o.TotalParameterMax = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.TotalParameterMax, key) : this.TotalParameterMax;
    _o.DailyPointCoefficient = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.DailyPointCoefficient, key) : this.DailyPointCoefficient;
    _o.DailyPointCorrectionValue = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.DailyPointCorrectionValue, key) : this.DailyPointCorrectionValue;
  }
  public static Offset<Global.MiniGameDreamDailyPointExcel> Pack(FlatBufferBuilder builder, MiniGameDreamDailyPointExcelT _o) {
    if (_o == null) return default(Offset<Global.MiniGameDreamDailyPointExcel>);
		byte[] key = TableEncryptionService.CreateKey("MiniGameDreamDailyPoint");
		...
		var _TotalParameterMin = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.TotalParameterMin, key) : _o.TotalParameterMin;
		var _TotalParameterMax = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.TotalParameterMax, key) : _o.TotalParameterMax;
		var _DailyPointCoefficient = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.DailyPointCoefficient, key) : _o.DailyPointCoefficient;
		var _DailyPointCorrectionValue = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.DailyPointCorrectionValue, key) : _o.DailyPointCorrectionValue;
    return CreateMiniGameDreamDailyPointExcel(
      ...
      TableEncryptionService.UseEncryption ? _TotalParameterMin : _o.TotalParameterMin,
      TableEncryptionService.UseEncryption ? _TotalParameterMax : _o.TotalParameterMax,
      TableEncryptionService.UseEncryption ? _DailyPointCoefficient : _o.DailyPointCoefficient,
      TableEncryptionService.UseEncryption ? _DailyPointCorrectionValue : _o.DailyPointCorrectionValue);
  }
}
