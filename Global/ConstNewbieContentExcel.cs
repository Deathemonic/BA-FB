...
public struct ConstNewbieContentExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ConstNewbieContentExcelT _o) {
    ...
    _o.NewbieGachaCheckDays = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.NewbieGachaCheckDays, key) : this.NewbieGachaCheckDays;
    _o.NewbieGachaTokenGraceTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.NewbieGachaTokenGraceTime, key) : this.NewbieGachaTokenGraceTime;
    ...
    _o.NewbieAttendanceStartableEndDay = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.NewbieAttendanceStartableEndDay, key) : this.NewbieAttendanceStartableEndDay;
    _o.NewbieAttendanceEndDay = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.NewbieAttendanceEndDay, key) : this.NewbieAttendanceEndDay;
  }
  public static Offset<Global.ConstNewbieContentExcel> Pack(FlatBufferBuilder builder, ConstNewbieContentExcelT _o) {
    if (_o == null) return default(Offset<Global.ConstNewbieContentExcel>);
		byte[] key = TableEncryptionService.CreateKey("ConstNewbieContent");
    var _NewbieGachaReleaseDate = _o.NewbieGachaReleaseDate == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.NewbieGachaReleaseDate, key) : _o.NewbieGachaReleaseDate));
		var _NewbieGachaCheckDays = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.NewbieGachaCheckDays, key) : _o.NewbieGachaCheckDays;
		var _NewbieGachaTokenGraceTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.NewbieGachaTokenGraceTime, key) : _o.NewbieGachaTokenGraceTime;
    var _NewbieAttendanceReleaseDate = _o.NewbieAttendanceReleaseDate == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.NewbieAttendanceReleaseDate, key) : _o.NewbieAttendanceReleaseDate));
		var _NewbieAttendanceStartableEndDay = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.NewbieAttendanceStartableEndDay, key) : _o.NewbieAttendanceStartableEndDay;
		var _NewbieAttendanceEndDay = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.NewbieAttendanceEndDay, key) : _o.NewbieAttendanceEndDay;
