...
public struct ConstNewbieContentExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.ConstNewbieContentExcel> CreateConstNewbieContentExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.ConstNewbieContentExcel> EndConstNewbieContentExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.ConstNewbieContentExcel>(o);
  }
  ...
  public void UnPackTo(ConstNewbieContentExcelT _o) {
    ...
    _o.NewbieGachaReleaseDate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.NewbieGachaReleaseDate, key) : this.NewbieGachaReleaseDate;
    _o.NewbieGachaCheckDays = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.NewbieGachaCheckDays, key) : this.NewbieGachaCheckDays;
    _o.NewbieGachaTokenGraceTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.NewbieGachaTokenGraceTime, key) : this.NewbieGachaTokenGraceTime;
    _o.NewbieAttendanceReleaseDate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.NewbieAttendanceReleaseDate, key) : this.NewbieAttendanceReleaseDate;
    _o.NewbieAttendanceStartableEndDay = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.NewbieAttendanceStartableEndDay, key) : this.NewbieAttendanceStartableEndDay;
    _o.NewbieAttendanceEndDay = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.NewbieAttendanceEndDay, key) : this.NewbieAttendanceEndDay;
  }
  public static Offset<Global.ConstNewbieContentExcel> Pack(FlatBufferBuilder builder, ConstNewbieContentExcelT _o) {
    if (_o == null) return default(Offset<Global.ConstNewbieContentExcel>);
		byte[] key = TableEncryptionService.CreateKey("ConstNewbieContent");
    var _NewbieGachaReleaseDate = _o.NewbieGachaReleaseDate == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.NewbieGachaReleaseDate, key) : _o.NewbieGachaReleaseDate));
		var _NewbieGachaCheckDays = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.NewbieGachaCheckDays, key) : _o.NewbieGachaCheckDays;
		var _NewbieGachaTokenGraceTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.NewbieGachaTokenGraceTime, key) : _o.NewbieGachaTokenGraceTime;
    var _NewbieAttendanceReleaseDate = _o.NewbieAttendanceReleaseDate == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.NewbieAttendanceReleaseDate, key) : _o.NewbieAttendanceReleaseDate));
		var _NewbieAttendanceStartableEndDay = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.NewbieAttendanceStartableEndDay, key) : _o.NewbieAttendanceStartableEndDay;
		var _NewbieAttendanceEndDay = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.NewbieAttendanceEndDay, key) : _o.NewbieAttendanceEndDay;
    return CreateConstNewbieContentExcel(
      builder,
      _NewbieGachaReleaseDate,
      TableEncryptionService.UseEncryption ? _NewbieGachaCheckDays : _o.NewbieGachaCheckDays,
      TableEncryptionService.UseEncryption ? _NewbieGachaTokenGraceTime : _o.NewbieGachaTokenGraceTime,
      _NewbieAttendanceReleaseDate,
      TableEncryptionService.UseEncryption ? _NewbieAttendanceStartableEndDay : _o.NewbieAttendanceStartableEndDay,
      TableEncryptionService.UseEncryption ? _NewbieAttendanceEndDay : _o.NewbieAttendanceEndDay);
  }
}
