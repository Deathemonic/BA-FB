...
public struct MinigameCCGEnemyGroupExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.MinigameCCGEnemyGroupExcel> CreateMinigameCCGEnemyGroupExcel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static Offset<Global.MinigameCCGEnemyGroupExcel> EndMinigameCCGEnemyGroupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.MinigameCCGEnemyGroupExcel>(o);
  }
  ...
  public static Offset<Global.MinigameCCGEnemyGroupExcel> Pack(FlatBufferBuilder builder, MinigameCCGEnemyGroupExcelT _o) {
    if (_o == null) return default(Offset<Global.MinigameCCGEnemyGroupExcel>);
		byte[] key = TableEncryptionService.CreateKey("MinigameCCGEnemyGroup");
		var _GroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.GroupId, key) : _o.GroupId;
    var _EnemyAI = _o.EnemyAI == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.EnemyAI, key) : _o.EnemyAI));
		var _EnemyBGM = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EnemyBGM, key) : _o.EnemyBGM;
		var _LocalizeEnemyGroupName = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.LocalizeEnemyGroupName, key) : _o.LocalizeEnemyGroupName;
		var _LocalizeEnemyGroupDesc = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.LocalizeEnemyGroupDesc, key) : _o.LocalizeEnemyGroupDesc;
