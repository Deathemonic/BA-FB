...
public struct ObstacleExcel : IFlatbufferObject
{
  ...
  public Global.ObstacleDestroyType DestroyType { get { int o = __p.__offset(24); return o != 0 ? (Global.ObstacleDestroyType)__p.bb.GetInt(o + __p.bb_pos) : Global.ObstacleDestroyType.Remain; } }
  ...
  public static Offset<Global.ObstacleExcel> CreateObstacleExcel(FlatBufferBuilder builder,
      long Index = 0,
      ...
      int BlockRate = 0,
      int EvasionRate = 0,
      Global.ObstacleDestroyType DestroyType = Global.ObstacleDestroyType.Remain,
  ...
  public static void AddDestroyType(FlatBufferBuilder builder, Global.ObstacleDestroyType destroyType) { builder.AddInt(10, (int)destroyType, 0); }
  ...
  public static Offset<Global.ObstacleExcel> EndObstacleExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.ObstacleExcel>(o);
  }
  ...
  public void UnPackTo(ObstacleExcelT _o) {
    ...
    _o.Index = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Index, key) : this.Index;
    ...
    for (var _j = 0; _j < this.SubOffsetLength; ++_j) {_o.SubOffset.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SubOffset(_j), key) : this.SubOffset(_j));}
    _o.X = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.X, key) : this.X;
    _o.Z = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Z, key) : this.Z;
    _o.Hp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Hp, key) : this.Hp;
    ...
    _o.EvasionRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EvasionRate, key) : this.EvasionRate;
    _o.DestroyType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.DestroyType, key) : this.DestroyType;
    _o.Point1Offeset = new List<float>();
    for (var _j = 0; _j < this.Point1OffesetLength; ++_j) {_o.Point1Offeset.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Point1Offeset(_j), key) : this.Point1Offeset(_j));}
    _o.EnemyPoint1Osset = new List<float>();
    for (var _j = 0; _j < this.EnemyPoint1OssetLength; ++_j) {_o.EnemyPoint1Osset.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EnemyPoint1Osset(_j), key) : this.EnemyPoint1Osset(_j));}
    _o.Point2Offeset = new List<float>();
    for (var _j = 0; _j < this.Point2OffesetLength; ++_j) {_o.Point2Offeset.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Point2Offeset(_j), key) : this.Point2Offeset(_j));}
    _o.EnemyPoint2Osset = new List<float>();
    for (var _j = 0; _j < this.EnemyPoint2OssetLength; ++_j) {_o.EnemyPoint2Osset.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EnemyPoint2Osset(_j), key) : this.EnemyPoint2Osset(_j));}
    _o.SubObstacleID = new List<long>();
    for (var _j = 0; _j < this.SubObstacleIDLength; ++_j) {_o.SubObstacleID.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SubObstacleID(_j), key) : this.SubObstacleID(_j));}
  }
  public static Offset<Global.ObstacleExcel> Pack(FlatBufferBuilder builder, ObstacleExcelT _o) {
    if (_o == null) return default(Offset<Global.ObstacleExcel>);
		byte[] key = TableEncryptionService.CreateKey("Obstacle");
		var _Index = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Index, key) : _o.Index;
    ...
    if (_o.SubOffset != null) {
      var __SubOffset = _o.SubOffset.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
      _SubOffset = CreateSubOffsetVector(builder, __SubOffset);
    }
		var _X = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.X, key) : _o.X;
		var _Z = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Z, key) : _o.Z;
		var _Hp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Hp, key) : _o.Hp;
		...
		var _EvasionRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EvasionRate, key) : _o.EvasionRate;
		var _DestroyType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DestroyType, key) : _o.DestroyType;
    var _Point1Offeset = default(VectorOffset);
    if (_o.Point1Offeset != null) {
      var __Point1Offeset = _o.Point1Offeset.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.EnemyPoint1Osset != null) {
      var __EnemyPoint1Osset = _o.EnemyPoint1Osset.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.Point2Offeset != null) {
      var __Point2Offeset = _o.Point2Offeset.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.EnemyPoint2Osset != null) {
      var __EnemyPoint2Osset = _o.EnemyPoint2Osset.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.SubObstacleID != null) {
      var __SubObstacleID = _o.SubObstacleID.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    return CreateObstacleExcel(
      ...
      TableEncryptionService.UseEncryption ? _Hp : _o.Hp,
      TableEncryptionService.UseEncryption ? _MaxHp : _o.MaxHp,
      TableEncryptionService.UseEncryption ? _BlockRate : _o.BlockRate,
      TableEncryptionService.UseEncryption ? _EvasionRate : _o.EvasionRate,
      TableEncryptionService.UseEncryption ? _DestroyType : _o.DestroyType,
      _Point1Offeset,
      _EnemyPoint1Osset,
      _Point2Offeset,
      _EnemyPoint2Osset,
...
public class ObstacleExcelT
{
  ...
  public Global.ObstacleDestroyType DestroyType { get; set; }
  ...
  public ObstacleExcelT() {
    ...
    this.BlockRate = 0;
    this.EvasionRate = 0;
    this.DestroyType = Global.ObstacleDestroyType.Remain;
...
static public class ObstacleExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 24 /*DestroyType*/, 4 /*Global.ObstacleDestroyType*/, 4, false)
