...
public struct ObstacleExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ObstacleExcelT _o) {
    ...
    for (var _j = 0; _j < this.SubOffsetLength; ++_j) {_o.SubOffset.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)this.SubOffset(_j), key) : this.SubOffset(_j));}
    ...
    _o.Hp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.Hp, key) : this.Hp;
    _o.MaxHp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.MaxHp, key) : this.MaxHp;
    _o.BlockRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.BlockRate, key) : this.BlockRate;
    _o.EvasionRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.EvasionRate, key) : this.EvasionRate;
    _o.DestroyType = TableEncryptionService.UseEncryption ? (Global.ObstacleDestroyType)TableEncryptionService.Convert((int)this.DestroyType, key) : this.DestroyType;
    _o.Point1Offeset = new List<float>();
    for (var _j = 0; _j < this.Point1OffesetLength; ++_j) {_o.Point1Offeset.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)this.Point1Offeset(_j), key) : this.Point1Offeset(_j));}
    _o.EnemyPoint1Osset = new List<float>();
    for (var _j = 0; _j < this.EnemyPoint1OssetLength; ++_j) {_o.EnemyPoint1Osset.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)this.EnemyPoint1Osset(_j), key) : this.EnemyPoint1Osset(_j));}
    _o.Point2Offeset = new List<float>();
    for (var _j = 0; _j < this.Point2OffesetLength; ++_j) {_o.Point2Offeset.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)this.Point2Offeset(_j), key) : this.Point2Offeset(_j));}
    _o.EnemyPoint2Osset = new List<float>();
    for (var _j = 0; _j < this.EnemyPoint2OssetLength; ++_j) {_o.EnemyPoint2Osset.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)this.EnemyPoint2Osset(_j), key) : this.EnemyPoint2Osset(_j));}
    _o.SubObstacleID = new List<long>();
    for (var _j = 0; _j < this.SubObstacleIDLength; ++_j) {_o.SubObstacleID.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.SubObstacleID(_j), key) : this.SubObstacleID(_j));}
  }
  public static Offset<Global.ObstacleExcel> Pack(FlatBufferBuilder builder, ObstacleExcelT _o) {
    ...
    if (_o.SubOffset != null) {
      var __SubOffset = _o.SubOffset.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)x, key) : x).ToArray();
      _SubOffset = CreateSubOffsetVector(builder, __SubOffset);
		...
		var _Hp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.Hp, key) : _o.Hp;
		var _MaxHp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.MaxHp, key) : _o.MaxHp;
		var _BlockRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.BlockRate, key) : _o.BlockRate;
		var _EvasionRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.EvasionRate, key) : _o.EvasionRate;
		var _DestroyType = TableEncryptionService.UseEncryption ? (Global.ObstacleDestroyType)TableEncryptionService.Convert((int)_o.DestroyType, key) : _o.DestroyType;
    var _Point1Offeset = default(VectorOffset);
    if (_o.Point1Offeset != null) {
      var __Point1Offeset = _o.Point1Offeset.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)x, key) : x).ToArray();
    ...
    if (_o.EnemyPoint1Osset != null) {
      var __EnemyPoint1Osset = _o.EnemyPoint1Osset.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)x, key) : x).ToArray();
    ...
    if (_o.Point2Offeset != null) {
      var __Point2Offeset = _o.Point2Offeset.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)x, key) : x).ToArray();
    ...
    if (_o.EnemyPoint2Osset != null) {
      var __EnemyPoint2Osset = _o.EnemyPoint2Osset.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)x, key) : x).ToArray();
    ...
    if (_o.SubObstacleID != null) {
      var __SubObstacleID = _o.SubObstacleID.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
