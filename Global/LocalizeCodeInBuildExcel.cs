...
public struct LocalizeCodeInBuildExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.LocalizeCodeInBuildExcel> CreateLocalizeCodeInBuildExcel(FlatBufferBuilder builder,
      uint Key = 0,
  ...
  public static Offset<Global.LocalizeCodeInBuildExcel> EndLocalizeCodeInBuildExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.LocalizeCodeInBuildExcel>(o);
  }
  ...
  public static Offset<Global.LocalizeCodeInBuildExcel> Pack(FlatBufferBuilder builder, LocalizeCodeInBuildExcelT _o) {
    if (_o == null) return default(Offset<Global.LocalizeCodeInBuildExcel>);
		byte[] key = TableEncryptionService.CreateKey("LocalizeCodeInBuild");
