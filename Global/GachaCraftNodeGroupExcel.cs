...
public struct GachaCraftNodeGroupExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.GachaCraftNodeGroupExcel> CreateGachaCraftNodeGroupExcel(FlatBufferBuilder builder,
      long NodeId = 0,
      long GachaGroupId = 0,
      long ProbWeight = 0) {
  ...
  public static Offset<Global.GachaCraftNodeGroupExcel> EndGachaCraftNodeGroupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.GachaCraftNodeGroupExcel>(o);
  }
  ...
  public void UnPackTo(GachaCraftNodeGroupExcelT _o) {
    ...
    _o.ProbWeight = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ProbWeight, key) : this.ProbWeight;
  }
  public static Offset<Global.GachaCraftNodeGroupExcel> Pack(FlatBufferBuilder builder, GachaCraftNodeGroupExcelT _o) {
    if (_o == null) return default(Offset<Global.GachaCraftNodeGroupExcel>);
		byte[] key = TableEncryptionService.CreateKey("GachaCraftNodeGroup");
		...
		var _ProbWeight = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ProbWeight, key) : _o.ProbWeight;
    return CreateGachaCraftNodeGroupExcel(
      ...
      TableEncryptionService.UseEncryption ? _ProbWeight : _o.ProbWeight);
  }
}
