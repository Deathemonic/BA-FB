...
public struct CharacterGearLevelExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(CharacterGearLevelExcelT _o) {
    ...
    for (var _j = 0; _j < this.TierLevelExpLength; ++_j) {_o.TierLevelExp.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.TierLevelExp(_j), key) : this.TierLevelExp(_j));}
  ...
  public static Offset<Global.CharacterGearLevelExcel> Pack(FlatBufferBuilder builder, CharacterGearLevelExcelT _o) {
    ...
    if (_o.TierLevelExp != null) {
      var __TierLevelExp = _o.TierLevelExp.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
