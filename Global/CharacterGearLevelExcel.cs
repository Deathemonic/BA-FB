...
public struct CharacterGearLevelExcel : IFlatbufferObject
{
  ...
  public static CharacterGearLevelExcel GetRootAsCharacterGearLevelExcel(ByteBuffer _bb) { return GetRootAsCharacterGearLevelExcel(_bb, new CharacterGearLevelExcel()); }
  public static CharacterGearLevelExcel GetRootAsCharacterGearLevelExcel(ByteBuffer _bb, CharacterGearLevelExcel obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public CharacterGearLevelExcel __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<Global.CharacterGearLevelExcel> CreateCharacterGearLevelExcel(FlatBufferBuilder builder,
      int Level = 0,
      VectorOffset TierLevelExpOffset = default(VectorOffset),
      VectorOffset TotalExpOffset = default(VectorOffset)) {
    builder.StartTable(3);
    CharacterGearLevelExcel.AddTotalExp(builder, TotalExpOffset);
    CharacterGearLevelExcel.AddTierLevelExp(builder, TierLevelExpOffset);
    CharacterGearLevelExcel.AddLevel(builder, Level);
    return CharacterGearLevelExcel.EndCharacterGearLevelExcel(builder);
  }

  public static void StartCharacterGearLevelExcel(FlatBufferBuilder builder) { builder.StartTable(3); }
  ...
  public static Offset<Global.CharacterGearLevelExcel> EndCharacterGearLevelExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.CharacterGearLevelExcel>(o);
  }
  ...
  public void UnPackTo(CharacterGearLevelExcelT _o) {
    ...
    for (var _j = 0; _j < this.TierLevelExpLength; ++_j) {_o.TierLevelExp.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.TierLevelExp(_j), key) : this.TierLevelExp(_j));}
    _o.TotalExp = new List<long>();
    for (var _j = 0; _j < this.TotalExpLength; ++_j) {_o.TotalExp.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.TotalExp(_j), key) : this.TotalExp(_j));}
  }
  public static Offset<Global.CharacterGearLevelExcel> Pack(FlatBufferBuilder builder, CharacterGearLevelExcelT _o) {
    if (_o == null) return default(Offset<Global.CharacterGearLevelExcel>);
		byte[] key = TableEncryptionService.CreateKey("CharacterGearLevel");
...
static public class CharacterGearLevelExcelVerify
{
