...
public struct ConquestUnexpectedEventExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ConquestUnexpectedEventExcelT _o) {
    ...
    _o.UnexpectedEventConditionType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.UnexpectedEventConditionType, key) : this.UnexpectedEventConditionType;
    _o.UnexpectedEventConditionUniqueId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.UnexpectedEventConditionUniqueId, key) : this.UnexpectedEventConditionUniqueId;
    _o.UnexpectedEventConditionAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.UnexpectedEventConditionAmount, key) : this.UnexpectedEventConditionAmount;
    _o.UnexpectedEventOccurDailyLimitCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.UnexpectedEventOccurDailyLimitCount, key) : this.UnexpectedEventOccurDailyLimitCount;
    _o.UnitCountPerStep = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.UnitCountPerStep, key) : this.UnitCountPerStep;
  ...
  public static Offset<Global.ConquestUnexpectedEventExcel> Pack(FlatBufferBuilder builder, ConquestUnexpectedEventExcelT _o) {
    if (_o == null) return default(Offset<Global.ConquestUnexpectedEventExcel>);
		...
		var _UnexpectedEventConditionType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.UnexpectedEventConditionType, key) : _o.UnexpectedEventConditionType;
		var _UnexpectedEventConditionUniqueId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.UnexpectedEventConditionUniqueId, key) : _o.UnexpectedEventConditionUniqueId;
