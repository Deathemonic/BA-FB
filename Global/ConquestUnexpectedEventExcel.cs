...
public struct ConquestUnexpectedEventExcel : IFlatbufferObject
{
  ...
  public Global.ParcelType UnexpectedEventConditionType { get { int o = __p.__offset(6); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Global.ParcelType.None; } }
  ...
  public static Offset<Global.ConquestUnexpectedEventExcel> CreateConquestUnexpectedEventExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      Global.ParcelType UnexpectedEventConditionType = Global.ParcelType.None,
  ...
  public static void AddUnexpectedEventConditionType(FlatBufferBuilder builder, Global.ParcelType unexpectedEventConditionType) { builder.AddInt(1, (int)unexpectedEventConditionType, 0); }
  ...
  public static Offset<Global.ConquestUnexpectedEventExcel> EndConquestUnexpectedEventExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.ConquestUnexpectedEventExcel>(o);
  }
  ...
  public void UnPackTo(ConquestUnexpectedEventExcelT _o) {
    ...
    _o.UnexpectedEventConditionType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)this.UnexpectedEventConditionType, key) : this.UnexpectedEventConditionType;
    _o.UnexpectedEventConditionUniqueId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.UnexpectedEventConditionUniqueId, key) : this.UnexpectedEventConditionUniqueId;
    _o.UnexpectedEventConditionAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.UnexpectedEventConditionAmount, key) : this.UnexpectedEventConditionAmount;
    _o.UnexpectedEventOccurDailyLimitCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.UnexpectedEventOccurDailyLimitCount, key) : this.UnexpectedEventOccurDailyLimitCount;
    _o.UnitCountPerStep = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.UnitCountPerStep, key) : this.UnitCountPerStep;
    _o.UnexpectedEventPrefab = new List<string>();
    for (var _j = 0; _j < this.UnexpectedEventPrefabLength; ++_j) {_o.UnexpectedEventPrefab.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.UnexpectedEventPrefab(_j), key) : this.UnexpectedEventPrefab(_j));}
  ...
  public static Offset<Global.ConquestUnexpectedEventExcel> Pack(FlatBufferBuilder builder, ConquestUnexpectedEventExcelT _o) {
    if (_o == null) return default(Offset<Global.ConquestUnexpectedEventExcel>);
		byte[] key = TableEncryptionService.CreateKey("ConquestUnexpectedEvent");
		...
		var _UnexpectedEventConditionType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)_o.UnexpectedEventConditionType, key) : _o.UnexpectedEventConditionType;
		var _UnexpectedEventConditionUniqueId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.UnexpectedEventConditionUniqueId, key) : _o.UnexpectedEventConditionUniqueId;
		var _UnexpectedEventConditionAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.UnexpectedEventConditionAmount, key) : _o.UnexpectedEventConditionAmount;
		var _UnexpectedEventOccurDailyLimitCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.UnexpectedEventOccurDailyLimitCount, key) : _o.UnexpectedEventOccurDailyLimitCount;
		var _UnitCountPerStep = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.UnitCountPerStep, key) : _o.UnitCountPerStep;
    ...
    if (_o.UnexpectedEventPrefab != null) {
      ...
      for (var _j = 0; _j < __UnexpectedEventPrefab.Length; ++_j) { __UnexpectedEventPrefab[_j] = builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.UnexpectedEventPrefab[_j], key) : _o.UnexpectedEventPrefab[_j])); }
    ...
    return CreateConquestUnexpectedEventExcel(
      ...
      TableEncryptionService.UseEncryption ? _UnexpectedEventConditionType : _o.UnexpectedEventConditionType,
      TableEncryptionService.UseEncryption ? _UnexpectedEventConditionUniqueId : _o.UnexpectedEventConditionUniqueId,
...
public class ConquestUnexpectedEventExcelT
{
  ...
  public Global.ParcelType UnexpectedEventConditionType { get; set; }
  ...
  public ConquestUnexpectedEventExcelT() {
    ...
    this.UnexpectedEventConditionType = Global.ParcelType.None;
...
static public class ConquestUnexpectedEventExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*UnexpectedEventConditionType*/, 4 /*Global.ParcelType*/, 4, false)
