...
public struct BlendInfo : IFlatbufferObject
{
  ...
  public void UnPackTo(BlendInfoT _o) {
    ...
    _o.From = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.From, key) : this.From;
    _o.To = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.To, key) : this.To;
    _o.Blend = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Blend, key) : this.Blend;
  }
  public static Offset<Global.BlendInfo> Pack(FlatBufferBuilder builder, BlendInfoT _o) {
    if (_o == null) return default(Offset<Global.BlendInfo>);
		byte[] key = TableEncryptionService.CreateKey("Blen");
		var _From = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.From, key) : _o.From;
		var _To = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.To, key) : _o.To;
		var _blend = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Blend, key) : _o.Blend;
