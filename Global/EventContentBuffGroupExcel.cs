...
public struct EventContentBuffGroupExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(EventContentBuffGroupExcelT _o) {
    ...
    _o.BuffGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.BuffGroupId, key) : this.BuffGroupId;
    ...
    _o.EventContentBuffId1 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.EventContentBuffId1, key) : this.EventContentBuffId1;
    ...
    _o.EventContentBuffId2 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.EventContentBuffId2, key) : this.EventContentBuffId2;
    ...
    _o.EventContentDebuffId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.EventContentDebuffId, key) : this.EventContentDebuffId;
    ...
    _o.BuffGroupProb = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.BuffGroupProb, key) : this.BuffGroupProb;
  }
  public static Offset<Global.EventContentBuffGroupExcel> Pack(FlatBufferBuilder builder, EventContentBuffGroupExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentBuffGroupExcel>);
		...
		var _BuffGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.BuffGroupId, key) : _o.BuffGroupId;
    var _BuffGroupNameLocalizeCodeId = _o.BuffGroupNameLocalizeCodeId == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.BuffGroupNameLocalizeCodeId, key) : _o.BuffGroupNameLocalizeCodeId));
		var _EventContentBuffId1 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.EventContentBuffId1, key) : _o.EventContentBuffId1;
    var _BuffNameLocalizeCodeId1 = _o.BuffNameLocalizeCodeId1 == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.BuffNameLocalizeCodeId1, key) : _o.BuffNameLocalizeCodeId1));
    var _BuffDescriptionIconPath1 = _o.BuffDescriptionIconPath1 == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.BuffDescriptionIconPath1, key) : _o.BuffDescriptionIconPath1));
		var _EventContentBuffId2 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.EventContentBuffId2, key) : _o.EventContentBuffId2;
    var _BuffNameLocalizeCodeId2 = _o.BuffNameLocalizeCodeId2 == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.BuffNameLocalizeCodeId2, key) : _o.BuffNameLocalizeCodeId2));
    var _BuffDescriptionIconPath2 = _o.BuffDescriptionIconPath2 == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.BuffDescriptionIconPath2, key) : _o.BuffDescriptionIconPath2));
		var _EventContentDebuffId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.EventContentDebuffId, key) : _o.EventContentDebuffId;
    var _DebuffNameLocalizeCodeId = _o.DebuffNameLocalizeCodeId == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.DebuffNameLocalizeCodeId, key) : _o.DebuffNameLocalizeCodeId));
    var _DeBuffDescriptionIconPath = _o.DeBuffDescriptionIconPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.DeBuffDescriptionIconPath, key) : _o.DeBuffDescriptionIconPath));
		var _BuffGroupProb = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.BuffGroupProb, key) : _o.BuffGroupProb;
