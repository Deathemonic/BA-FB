...
public struct EventContentBuffGroupExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.EventContentBuffGroupExcel> CreateEventContentBuffGroupExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.EventContentBuffGroupExcel> EndEventContentBuffGroupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.EventContentBuffGroupExcel>(o);
  }
  ...
  public void UnPackTo(EventContentBuffGroupExcelT _o) {
    ...
    _o.BuffGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BuffGroupId, key) : this.BuffGroupId;
    _o.BuffGroupNameLocalizeCodeId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BuffGroupNameLocalizeCodeId, key) : this.BuffGroupNameLocalizeCodeId;
    _o.EventContentBuffId1 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EventContentBuffId1, key) : this.EventContentBuffId1;
    _o.BuffNameLocalizeCodeId1 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BuffNameLocalizeCodeId1, key) : this.BuffNameLocalizeCodeId1;
    _o.BuffDescriptionIconPath1 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BuffDescriptionIconPath1, key) : this.BuffDescriptionIconPath1;
    _o.EventContentBuffId2 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EventContentBuffId2, key) : this.EventContentBuffId2;
    _o.BuffNameLocalizeCodeId2 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BuffNameLocalizeCodeId2, key) : this.BuffNameLocalizeCodeId2;
    _o.BuffDescriptionIconPath2 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BuffDescriptionIconPath2, key) : this.BuffDescriptionIconPath2;
    _o.EventContentDebuffId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EventContentDebuffId, key) : this.EventContentDebuffId;
    _o.DebuffNameLocalizeCodeId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.DebuffNameLocalizeCodeId, key) : this.DebuffNameLocalizeCodeId;
    _o.DeBuffDescriptionIconPath = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.DeBuffDescriptionIconPath, key) : this.DeBuffDescriptionIconPath;
    _o.BuffGroupProb = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BuffGroupProb, key) : this.BuffGroupProb;
  }
  public static Offset<Global.EventContentBuffGroupExcel> Pack(FlatBufferBuilder builder, EventContentBuffGroupExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentBuffGroupExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentBuffGroup");
		...
		var _BuffGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.BuffGroupId, key) : _o.BuffGroupId;
    var _BuffGroupNameLocalizeCodeId = _o.BuffGroupNameLocalizeCodeId == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.BuffGroupNameLocalizeCodeId, key) : _o.BuffGroupNameLocalizeCodeId));
		var _EventContentBuffId1 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EventContentBuffId1, key) : _o.EventContentBuffId1;
    var _BuffNameLocalizeCodeId1 = _o.BuffNameLocalizeCodeId1 == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.BuffNameLocalizeCodeId1, key) : _o.BuffNameLocalizeCodeId1));
    var _BuffDescriptionIconPath1 = _o.BuffDescriptionIconPath1 == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.BuffDescriptionIconPath1, key) : _o.BuffDescriptionIconPath1));
		var _EventContentBuffId2 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EventContentBuffId2, key) : _o.EventContentBuffId2;
    var _BuffNameLocalizeCodeId2 = _o.BuffNameLocalizeCodeId2 == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.BuffNameLocalizeCodeId2, key) : _o.BuffNameLocalizeCodeId2));
    var _BuffDescriptionIconPath2 = _o.BuffDescriptionIconPath2 == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.BuffDescriptionIconPath2, key) : _o.BuffDescriptionIconPath2));
		var _EventContentDebuffId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EventContentDebuffId, key) : _o.EventContentDebuffId;
    var _DebuffNameLocalizeCodeId = _o.DebuffNameLocalizeCodeId == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.DebuffNameLocalizeCodeId, key) : _o.DebuffNameLocalizeCodeId));
    var _DeBuffDescriptionIconPath = _o.DeBuffDescriptionIconPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.DeBuffDescriptionIconPath, key) : _o.DeBuffDescriptionIconPath));
		var _BuffGroupProb = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.BuffGroupProb, key) : _o.BuffGroupProb;
    return CreateEventContentBuffGroupExcel(
      ...
      TableEncryptionService.UseEncryption ? _BuffGroupId : _o.BuffGroupId,
      _BuffGroupNameLocalizeCodeId,
      TableEncryptionService.UseEncryption ? _EventContentBuffId1 : _o.EventContentBuffId1,
      _BuffNameLocalizeCodeId1,
      _BuffDescriptionIconPath1,
      TableEncryptionService.UseEncryption ? _EventContentBuffId2 : _o.EventContentBuffId2,
      _BuffNameLocalizeCodeId2,
      _BuffDescriptionIconPath2,
      TableEncryptionService.UseEncryption ? _EventContentDebuffId : _o.EventContentDebuffId,
      _DebuffNameLocalizeCodeId,
      _DeBuffDescriptionIconPath,
      TableEncryptionService.UseEncryption ? _BuffGroupProb : _o.BuffGroupProb);
  }
}
