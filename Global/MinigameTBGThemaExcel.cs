...
public struct MinigameTBGThemaExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(MinigameTBGThemaExcelT _o) {
    ...
    for (var _j = 0; _j < this.PortalConditionLength; ++_j) {_o.PortalCondition.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.PortalCondition(_j), key) : this.PortalCondition(_j));}
    ...
    _o.ThemaLeaderId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ThemaLeaderId, key) : this.ThemaLeaderId;
    ...
    _o.InstantClearCostAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.InstantClearCostAmount, key) : this.InstantClearCostAmount;
    _o.IsTutorial = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.IsTutorial, key) : this.IsTutorial;
  }
  public static Offset<Global.MinigameTBGThemaExcel> Pack(FlatBufferBuilder builder, MinigameTBGThemaExcelT _o) {
    ...
    var _ThemaPlayerPrefab = _o.ThemaPlayerPrefab == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ThemaPlayerPrefab, key) : _o.ThemaPlayerPrefab));
		var _ThemaLeaderId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ThemaLeaderId, key) : _o.ThemaLeaderId;
    var _ThemaGoalLocalize = _o.ThemaGoalLocalize == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ThemaGoalLocalize, key) : _o.ThemaGoalLocalize));
		var _InstantClearCostAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.InstantClearCostAmount, key) : _o.InstantClearCostAmount;
		var _IsTutorial = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IsTutorial, key) : _o.IsTutorial;
