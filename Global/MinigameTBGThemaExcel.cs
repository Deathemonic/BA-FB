...
public struct MinigameTBGThemaExcel : IFlatbufferObject
{
  ...
  public Global.TBGThemaType ThemaType { get { int o = __p.__offset(10); return o != 0 ? (Global.TBGThemaType)__p.bb.GetInt(o + __p.bb_pos) : Global.TBGThemaType.None; } }
  ...
  public Global.TBGPortalCondition PortalCondition(int j) { int o = __p.__offset(16); return o != 0 ? (Global.TBGPortalCondition)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Global.TBGPortalCondition)0; }
  public int PortalConditionLength { get { int o = __p.__offset(16); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Global.TBGPortalCondition> GetPortalConditionBytes() { return __p.__vector_as_span<Global.TBGPortalCondition>(16, 4); }
#else
  public ArraySegment<byte>? GetPortalConditionBytes() { return __p.__vector_as_arraysegment(16); }
#endif
  public Global.TBGPortalCondition[] GetPortalConditionArray() { int o = __p.__offset(16); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Global.TBGPortalCondition[] a = new Global.TBGPortalCondition[l]; for (int i = 0; i < l; i++) { a[i] = (Global.TBGPortalCondition)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public bool IsTutorial { get { int o = __p.__offset(32); return o != 0 ? 0!=__p.bb.Get(o + __p.bb_pos) : (bool)false; } }

  public static Offset<Global.MinigameTBGThemaExcel> CreateMinigameTBGThemaExcel(FlatBufferBuilder builder,
  ...
  public static void StartMinigameTBGThemaExcel(FlatBufferBuilder builder) { builder.StartTable(15); }
  ...
  public static void AddThemaType(FlatBufferBuilder builder, Global.TBGThemaType themaType) { builder.AddInt(3, (int)themaType, 0); }
  ...
  public static VectorOffset CreatePortalConditionVector(FlatBufferBuilder builder, Global.TBGPortalCondition[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreatePortalConditionVectorBlock(FlatBufferBuilder builder, Global.TBGPortalCondition[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreatePortalConditionVectorBlock(FlatBufferBuilder builder, ArraySegment<Global.TBGPortalCondition> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreatePortalConditionVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Global.TBGPortalCondition>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static void AddIsTutorial(FlatBufferBuilder builder, bool isTutorial) { builder.AddBool(14, isTutorial, false); }
  public static Offset<Global.MinigameTBGThemaExcel> EndMinigameTBGThemaExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.MinigameTBGThemaExcel>(o);
  }
  ...
  public void UnPackTo(MinigameTBGThemaExcelT _o) {
    ...
    _o.ThemaType = TableEncryptionService.UseEncryption ? (Global.TBGThemaType)TableEncryptionService.Convert((int)this.ThemaType, key) : this.ThemaType;
    _o.ThemaMap = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ThemaMap, key) : this.ThemaMap;
    _o.ThemaMapBG = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ThemaMapBG, key) : this.ThemaMapBG;
    _o.PortalCondition = new List<Global.TBGPortalCondition>();
    for (var _j = 0; _j < this.PortalConditionLength; ++_j) {_o.PortalCondition.Add(TableEncryptionService.UseEncryption ? (Global.TBGPortalCondition)TableEncryptionService.Convert((int)this.PortalCondition(_j), key) : this.PortalCondition(_j));}
    _o.PortalConditionParameter = new List<string>();
    for (var _j = 0; _j < this.PortalConditionParameterLength; ++_j) {_o.PortalConditionParameter.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.PortalConditionParameter(_j), key) : this.PortalConditionParameter(_j));}
    _o.ThemaNameLocalize = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ThemaNameLocalize, key) : this.ThemaNameLocalize;
    _o.ThemaLoadingImage = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ThemaLoadingImage, key) : this.ThemaLoadingImage;
    _o.ThemaPlayerPrefab = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ThemaPlayerPrefab, key) : this.ThemaPlayerPrefab;
    _o.ThemaLeaderId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ThemaLeaderId, key) : this.ThemaLeaderId;
    _o.ThemaGoalLocalize = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ThemaGoalLocalize, key) : this.ThemaGoalLocalize;
    _o.InstantClearCostAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.InstantClearCostAmount, key) : this.InstantClearCostAmount;
    _o.IsTutorial = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.IsTutorial, key) : this.IsTutorial;
  }
  public static Offset<Global.MinigameTBGThemaExcel> Pack(FlatBufferBuilder builder, MinigameTBGThemaExcelT _o) {
    if (_o == null) return default(Offset<Global.MinigameTBGThemaExcel>);
		byte[] key = TableEncryptionService.CreateKey("MinigameTBGThema");
		...
		var _ThemaType = TableEncryptionService.UseEncryption ? (Global.TBGThemaType)TableEncryptionService.Convert((int)_o.ThemaType, key) : _o.ThemaType;
    var _ThemaMap = _o.ThemaMap == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.ThemaMap, key) : _o.ThemaMap));
    var _ThemaMapBG = _o.ThemaMapBG == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.ThemaMapBG, key) : _o.ThemaMapBG));
    var _PortalCondition = default(VectorOffset);
    if (_o.PortalCondition != null) {
      var __PortalCondition = _o.PortalCondition.Select(x => TableEncryptionService.UseEncryption ? (Global.TBGPortalCondition)TableEncryptionService.Convert((int)x, key) : x).ToArray();
    ...
    if (_o.PortalConditionParameter != null) {
      ...
      for (var _j = 0; _j < __PortalConditionParameter.Length; ++_j) { __PortalConditionParameter[_j] = builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.PortalConditionParameter[_j], key) : _o.PortalConditionParameter[_j])); }
      _PortalConditionParameter = CreatePortalConditionParameterVector(builder, __PortalConditionParameter);
    }
    var _ThemaNameLocalize = _o.ThemaNameLocalize == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.ThemaNameLocalize, key) : _o.ThemaNameLocalize));
    var _ThemaLoadingImage = _o.ThemaLoadingImage == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.ThemaLoadingImage, key) : _o.ThemaLoadingImage));
    var _ThemaPlayerPrefab = _o.ThemaPlayerPrefab == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.ThemaPlayerPrefab, key) : _o.ThemaPlayerPrefab));
		var _ThemaLeaderId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ThemaLeaderId, key) : _o.ThemaLeaderId;
    var _ThemaGoalLocalize = _o.ThemaGoalLocalize == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.ThemaGoalLocalize, key) : _o.ThemaGoalLocalize));
		var _InstantClearCostAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.InstantClearCostAmount, key) : _o.InstantClearCostAmount;
		var _IsTutorial = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.IsTutorial, key) : _o.IsTutorial;
    return CreateMinigameTBGThemaExcel(
      ...
      _ThemaLoadingImage,
      _ThemaPlayerPrefab,
      TableEncryptionService.UseEncryption ? _ThemaLeaderId : _o.ThemaLeaderId,
      _ThemaGoalLocalize,
      TableEncryptionService.UseEncryption ? _InstantClearCostAmount : _o.InstantClearCostAmount,
      TableEncryptionService.UseEncryption ? _IsTutorial : _o.IsTutorial);
  }
}
...
public class MinigameTBGThemaExcelT
{
  ...
  public Global.TBGThemaType ThemaType { get; set; }
  public string ThemaMap { get; set; }
  public string ThemaMapBG { get; set; }
  public List<Global.TBGPortalCondition> PortalCondition { get; set; }
  ...
  public MinigameTBGThemaExcelT() {
    ...
    this.UniqueId = 0;
    this.ThemaIndex = 0;
    this.ThemaType = Global.TBGThemaType.None;
    this.ThemaMap = null;
...
static public class MinigameTBGThemaExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*ThemaType*/, 4 /*Global.TBGThemaType*/, 4, false)
      && verifier.VerifyString(tablePos, 12 /*ThemaMap*/, false)
      && verifier.VerifyString(tablePos, 14 /*ThemaMapBG*/, false)
      && verifier.VerifyVectorOfData(tablePos, 16 /*PortalCondition*/, 4 /*Global.TBGPortalCondition*/, false)
      ...
      && verifier.VerifyField(tablePos, 32 /*IsTutorial*/, 1 /*bool*/, 1, false)
