...
public struct MiniGameRoadPuzzleAdditionalRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.MiniGameRoadPuzzleAdditionalRewardExcel> CreateMiniGameRoadPuzzleAdditionalRewardExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.MiniGameRoadPuzzleAdditionalRewardExcel> EndMiniGameRoadPuzzleAdditionalRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.MiniGameRoadPuzzleAdditionalRewardExcel>(o);
  }
  ...
  public static Offset<Global.MiniGameRoadPuzzleAdditionalRewardExcel> Pack(FlatBufferBuilder builder, MiniGameRoadPuzzleAdditionalRewardExcelT _o) {
    if (_o == null) return default(Offset<Global.MiniGameRoadPuzzleAdditionalRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("MiniGameRoadPuzzleAdditionalReward");
