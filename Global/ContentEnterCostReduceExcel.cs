...
public struct ContentEnterCostReduceExcel : IFlatbufferObject
{
  ...
  public Global.ParcelType ReduceEnterCostType { get { int o = __p.__offset(10); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Global.ParcelType.None; } }
  ...
  public static Offset<Global.ContentEnterCostReduceExcel> CreateContentEnterCostReduceExcel(FlatBufferBuilder builder,
      long EnterCostReduceGroupId = 0,
      Global.ContentType ContentType = Global.ContentType.None,
      long StageId = 0,
      Global.ParcelType ReduceEnterCostType = Global.ParcelType.None,
  ...
  public static void AddReduceEnterCostType(FlatBufferBuilder builder, Global.ParcelType reduceEnterCostType) { builder.AddInt(3, (int)reduceEnterCostType, 0); }
  ...
  public static Offset<Global.ContentEnterCostReduceExcel> EndContentEnterCostReduceExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.ContentEnterCostReduceExcel>(o);
  }
  ...
  public static Offset<Global.ContentEnterCostReduceExcel> Pack(FlatBufferBuilder builder, ContentEnterCostReduceExcelT _o) {
    if (_o == null) return default(Offset<Global.ContentEnterCostReduceExcel>);
		byte[] key = TableEncryptionService.CreateKey("ContentEnterCostReduce");
...
public class ContentEnterCostReduceExcelT
{
  ...
  public Global.ParcelType ReduceEnterCostType { get; set; }
  ...
  public ContentEnterCostReduceExcelT() {
    ...
    this.StageId = 0;
    this.ReduceEnterCostType = Global.ParcelType.None;
...
static public class ContentEnterCostReduceExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*ReduceEnterCostType*/, 4 /*Global.ParcelType*/, 4, false)
