...
public struct ContentEnterCostReduceExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ContentEnterCostReduceExcelT _o) {
    ...
    _o.ReduceEnterCostType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)this.ReduceEnterCostType, key) : this.ReduceEnterCostType;
    _o.ReduceEnterCostId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ReduceEnterCostId, key) : this.ReduceEnterCostId;
    _o.ReduceAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ReduceAmount, key) : this.ReduceAmount;
  }
  public static Offset<Global.ContentEnterCostReduceExcel> Pack(FlatBufferBuilder builder, ContentEnterCostReduceExcelT _o) {
    if (_o == null) return default(Offset<Global.ContentEnterCostReduceExcel>);
		...
		var _ReduceEnterCostType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)_o.ReduceEnterCostType, key) : _o.ReduceEnterCostType;
		var _ReduceEnterCostId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ReduceEnterCostId, key) : _o.ReduceEnterCostId;
		var _ReduceAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ReduceAmount, key) : _o.ReduceAmount;
