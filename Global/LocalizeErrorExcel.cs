...
public struct LocalizeErrorExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(LocalizeErrorExcelT _o) {
    ...
    _o.ErrorLevel = TableEncryptionService.UseEncryption ? (Global.WebAPIErrorLevel)TableEncryptionService.Convert((int)this.ErrorLevel, key) : this.ErrorLevel;
  ...
  public static Offset<Global.LocalizeErrorExcel> Pack(FlatBufferBuilder builder, LocalizeErrorExcelT _o) {
    if (_o == null) return default(Offset<Global.LocalizeErrorExcel>);
		...
		var _ErrorLevel = TableEncryptionService.UseEncryption ? (Global.WebAPIErrorLevel)TableEncryptionService.Convert((int)_o.ErrorLevel, key) : _o.ErrorLevel;
    ...
    var _Th = _o.Th == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.Th, key) : _o.Th));
    var _Tw = _o.Tw == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.Tw, key) : _o.Tw));
    var _En = _o.En == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.En, key) : _o.En));
