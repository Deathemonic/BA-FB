...
public struct LocalizeErrorExcel : IFlatbufferObject
{
  ...
  public Global.WebAPIErrorLevel ErrorLevel { get { int o = __p.__offset(6); return o != 0 ? (Global.WebAPIErrorLevel)__p.bb.GetInt(o + __p.bb_pos) : Global.WebAPIErrorLevel.None; } }
  ...
  public static Offset<Global.LocalizeErrorExcel> CreateLocalizeErrorExcel(FlatBufferBuilder builder,
      uint Key = 0,
      Global.WebAPIErrorLevel ErrorLevel = Global.WebAPIErrorLevel.None,
  ...
  public static void AddErrorLevel(FlatBufferBuilder builder, Global.WebAPIErrorLevel errorLevel) { builder.AddInt(1, (int)errorLevel, 0); }
  ...
  public static Offset<Global.LocalizeErrorExcel> EndLocalizeErrorExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.LocalizeErrorExcel>(o);
  }
  ...
  public void UnPackTo(LocalizeErrorExcelT _o) {
    ...
    _o.ErrorLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ErrorLevel, key) : this.ErrorLevel;
  ...
  public static Offset<Global.LocalizeErrorExcel> Pack(FlatBufferBuilder builder, LocalizeErrorExcelT _o) {
    if (_o == null) return default(Offset<Global.LocalizeErrorExcel>);
		byte[] key = TableEncryptionService.CreateKey("LocalizeError");
		var _Key = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Key, key) : _o.Key;
		var _ErrorLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ErrorLevel, key) : _o.ErrorLevel;
    var _Kr = _o.Kr == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.Kr, key) : _o.Kr));
    var _Jp = _o.Jp == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.Jp, key) : _o.Jp));
    var _Th = _o.Th == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.Th, key) : _o.Th));
    var _Tw = _o.Tw == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.Tw, key) : _o.Tw));
    var _En = _o.En == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.En, key) : _o.En));
...
public class LocalizeErrorExcelT
{
  ...
  public Global.WebAPIErrorLevel ErrorLevel { get; set; }
  ...
  public LocalizeErrorExcelT() {
    this.Key = 0;
    this.ErrorLevel = Global.WebAPIErrorLevel.None;
    this.Kr = null;
    this.Jp = null;
    this.Th = null;
    this.Tw = null;
...
static public class LocalizeErrorExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*ErrorLevel*/, 4 /*Global.WebAPIErrorLevel*/, 4, false)
