...
public struct ContentsShortcutExcel : IFlatbufferObject
{
  ...
  public Global.StageDifficulty ConquestMapDifficulty { get { int o = __p.__offset(20); return o != 0 ? (Global.StageDifficulty)__p.bb.GetInt(o + __p.bb_pos) : Global.StageDifficulty.None; } }
  ...
  public static Offset<Global.ContentsShortcutExcel> CreateContentsShortcutExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      ...
      Global.StageDifficulty ConquestMapDifficulty = Global.StageDifficulty.None,
  ...
  public static void AddConquestMapDifficulty(FlatBufferBuilder builder, Global.StageDifficulty conquestMapDifficulty) { builder.AddInt(8, (int)conquestMapDifficulty, 0); }
  ...
  public static Offset<Global.ContentsShortcutExcel> EndContentsShortcutExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.ContentsShortcutExcel>(o);
  }
  ...
  public void UnPackTo(ContentsShortcutExcelT _o) {
    ...
    _o.ScenarioModeVolume = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ScenarioModeVolume, key) : this.ScenarioModeVolume;
    _o.ScenarioModeChapter = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ScenarioModeChapter, key) : this.ScenarioModeChapter;
    ...
    _o.ShortcutCloseTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ShortcutCloseTime, key) : this.ShortcutCloseTime;
    _o.ConditionContentId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ConditionContentId, key) : this.ConditionContentId;
    _o.ConquestMapDifficulty = TableEncryptionService.UseEncryption ? (Global.StageDifficulty)TableEncryptionService.Convert((int)this.ConquestMapDifficulty, key) : this.ConquestMapDifficulty;
    _o.ConquestStepIndex = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.ConquestStepIndex, key) : this.ConquestStepIndex;
    _o.ShortcutContentId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ShortcutContentId, key) : this.ShortcutContentId;
  ...
  public static Offset<Global.ContentsShortcutExcel> Pack(FlatBufferBuilder builder, ContentsShortcutExcelT _o) {
    if (_o == null) return default(Offset<Global.ContentsShortcutExcel>);
		byte[] key = TableEncryptionService.CreateKey("ContentsShortcut");
		...
		var _ScenarioModeVolume = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ScenarioModeVolume, key) : _o.ScenarioModeVolume;
		var _ScenarioModeChapter = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ScenarioModeChapter, key) : _o.ScenarioModeChapter;
    var _ShortcutOpenTime = _o.ShortcutOpenTime == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.ShortcutOpenTime, key) : _o.ShortcutOpenTime));
    var _ShortcutCloseTime = _o.ShortcutCloseTime == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.ShortcutCloseTime, key) : _o.ShortcutCloseTime));
		var _ConditionContentId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ConditionContentId, key) : _o.ConditionContentId;
		var _ConquestMapDifficulty = TableEncryptionService.UseEncryption ? (Global.StageDifficulty)TableEncryptionService.Convert((int)_o.ConquestMapDifficulty, key) : _o.ConquestMapDifficulty;
		var _ConquestStepIndex = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.ConquestStepIndex, key) : _o.ConquestStepIndex;
		var _ShortcutContentId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ShortcutContentId, key) : _o.ShortcutContentId;
    ...
    var _Localize = _o.Localize == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.Localize, key) : _o.Localize));
    return CreateContentsShortcutExcel(
      ...
      TableEncryptionService.UseEncryption ? _ScenarioModeVolume : _o.ScenarioModeVolume,
      TableEncryptionService.UseEncryption ? _ScenarioModeChapter : _o.ScenarioModeChapter,
      _ShortcutOpenTime,
      _ShortcutCloseTime,
      TableEncryptionService.UseEncryption ? _ConditionContentId : _o.ConditionContentId,
      TableEncryptionService.UseEncryption ? _ConquestMapDifficulty : _o.ConquestMapDifficulty,
      TableEncryptionService.UseEncryption ? _ConquestStepIndex : _o.ConquestStepIndex,
      TableEncryptionService.UseEncryption ? _ShortcutContentId : _o.ShortcutContentId,
      _ShortcutUIName,
      _Localize);
  }
}
...
public class ContentsShortcutExcelT
{
  ...
  public Global.StageDifficulty ConquestMapDifficulty { get; set; }
  ...
  public ContentsShortcutExcelT() {
    ...
    this.ConquestMapDifficulty = Global.StageDifficulty.None;
...
static public class ContentsShortcutExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 20 /*ConquestMapDifficulty*/, 4 /*Global.StageDifficulty*/, 4, false)
