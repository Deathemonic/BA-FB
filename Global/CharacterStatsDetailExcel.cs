...
public struct CharacterStatsDetailExcel : IFlatbufferObject
{
  ...
  public Global.StatType DetailShowStats(int j) { int o = __p.__offset(6); return o != 0 ? (Global.StatType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Global.StatType)0; }
  public int DetailShowStatsLength { get { int o = __p.__offset(6); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Global.StatType> GetDetailShowStatsBytes() { return __p.__vector_as_span<Global.StatType>(6, 4); }
#else
  public ArraySegment<byte>? GetDetailShowStatsBytes() { return __p.__vector_as_arraysegment(6); }
#endif
  public Global.StatType[] GetDetailShowStatsArray() { int o = __p.__offset(6); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Global.StatType[] a = new Global.StatType[l]; for (int i = 0; i < l; i++) { a[i] = (Global.StatType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static VectorOffset CreateDetailShowStatsVector(FlatBufferBuilder builder, Global.StatType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateDetailShowStatsVectorBlock(FlatBufferBuilder builder, Global.StatType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateDetailShowStatsVectorBlock(FlatBufferBuilder builder, ArraySegment<Global.StatType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateDetailShowStatsVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Global.StatType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Global.CharacterStatsDetailExcel> EndCharacterStatsDetailExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.CharacterStatsDetailExcel>(o);
  }
  ...
  public void UnPackTo(CharacterStatsDetailExcelT _o) {
    ...
    _o.DetailShowStats = new List<Global.StatType>();
    for (var _j = 0; _j < this.DetailShowStatsLength; ++_j) {_o.DetailShowStats.Add(TableEncryptionService.UseEncryption ? (Global.StatType)TableEncryptionService.Convert((int)this.DetailShowStats(_j), key) : this.DetailShowStats(_j));}
  ...
  public static Offset<Global.CharacterStatsDetailExcel> Pack(FlatBufferBuilder builder, CharacterStatsDetailExcelT _o) {
    ...
    if (_o.DetailShowStats != null) {
      var __detailShowStats = _o.DetailShowStats.Select(x => TableEncryptionService.UseEncryption ? (Global.StatType)TableEncryptionService.Convert((int)x, key) : x).ToArray();
...
public class CharacterStatsDetailExcelT
{
  ...
  public List<Global.StatType> DetailShowStats { get; set; }
...
static public class CharacterStatsDetailExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 6 /*DetailShowStats*/, 4 /*Global.StatType*/, false)
