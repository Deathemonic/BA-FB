...
public struct ConquestErosionExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ConquestErosionExcelT _o) {
    ...
    _o.ErosionType = TableEncryptionService.UseEncryption ? (Global.ConquestErosionType)TableEncryptionService.Convert((int)this.ErosionType, key) : this.ErosionType;
    ...
    for (var _j = 0; _j < this.PhaseStartConditionTypeLength; ++_j) {_o.PhaseStartConditionType.Add(TableEncryptionService.UseEncryption ? (Global.ConquestConditionType)TableEncryptionService.Convert((int)this.PhaseStartConditionType(_j), key) : this.PhaseStartConditionType(_j));}
    ...
    for (var _j = 0; _j < this.PhaseBeforeExposeConditionTypeLength; ++_j) {_o.PhaseBeforeExposeConditionType.Add(TableEncryptionService.UseEncryption ? (Global.ConquestConditionType)TableEncryptionService.Convert((int)this.PhaseBeforeExposeConditionType(_j), key) : this.PhaseBeforeExposeConditionType(_j));}
    ...
    _o.ErosionBattleConditionParcelType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)this.ErosionBattleConditionParcelType, key) : this.ErosionBattleConditionParcelType;
  ...
  public static Offset<Global.ConquestErosionExcel> Pack(FlatBufferBuilder builder, ConquestErosionExcelT _o) {
    if (_o == null) return default(Offset<Global.ConquestErosionExcel>);
		...
		var _ErosionType = TableEncryptionService.UseEncryption ? (Global.ConquestErosionType)TableEncryptionService.Convert((int)_o.ErosionType, key) : _o.ErosionType;
    ...
    if (_o.PhaseStartConditionType != null) {
      var __PhaseStartConditionType = _o.PhaseStartConditionType.Select(x => TableEncryptionService.UseEncryption ? (Global.ConquestConditionType)TableEncryptionService.Convert((int)x, key) : x).ToArray();
    ...
    if (_o.PhaseBeforeExposeConditionType != null) {
      var __PhaseBeforeExposeConditionType = _o.PhaseBeforeExposeConditionType.Select(x => TableEncryptionService.UseEncryption ? (Global.ConquestConditionType)TableEncryptionService.Convert((int)x, key) : x).ToArray();
    ...
    if (_o.PhaseBeforeExposeConditionParameter != null) {
      ...
      _PhaseBeforeExposeConditionParameter = CreatePhaseBeforeExposeConditionParameterVector(builder, __PhaseBeforeExposeConditionParameter);
		...
		var _ErosionBattleConditionParcelType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)_o.ErosionBattleConditionParcelType, key) : _o.ErosionBattleConditionParcelType;
