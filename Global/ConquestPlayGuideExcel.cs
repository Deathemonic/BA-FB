...
public struct ConquestPlayGuideExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.ConquestPlayGuideExcel> CreateConquestPlayGuideExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Global.ConquestPlayGuideExcel> EndConquestPlayGuideExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.ConquestPlayGuideExcel>(o);
  }
  ...
  public static Offset<Global.ConquestPlayGuideExcel> Pack(FlatBufferBuilder builder, ConquestPlayGuideExcelT _o) {
    if (_o == null) return default(Offset<Global.ConquestPlayGuideExcel>);
		byte[] key = TableEncryptionService.CreateKey("ConquestPlayGuide");
