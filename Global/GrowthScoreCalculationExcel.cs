...
public struct GrowthScoreCalculationExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(GrowthScoreCalculationExcelT _o) {
    ...
    _o.IncludeGrowthFactor = TableEncryptionService.UseEncryption ? (Global.GrowthFactor)TableEncryptionService.Convert((int)this.IncludeGrowthFactor, key) : this.IncludeGrowthFactor;
  ...
  public static Offset<Global.GrowthScoreCalculationExcel> Pack(FlatBufferBuilder builder, GrowthScoreCalculationExcelT _o) {
    if (_o == null) return default(Offset<Global.GrowthScoreCalculationExcel>);
		...
		var _IncludeGrowthFactor = TableEncryptionService.UseEncryption ? (Global.GrowthFactor)TableEncryptionService.Convert((int)_o.IncludeGrowthFactor, key) : _o.IncludeGrowthFactor;
