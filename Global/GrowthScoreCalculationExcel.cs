...
public struct GrowthScoreCalculationExcel : IFlatbufferObject
{
  ...
  public Global.GrowthFactor IncludeGrowthFactor { get { int o = __p.__offset(6); return o != 0 ? (Global.GrowthFactor)__p.bb.GetInt(o + __p.bb_pos) : Global.GrowthFactor.CharacterLevel; } }
  public long ConversionCoefficient { get { int o = __p.__offset(8); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }

  public static Offset<Global.GrowthScoreCalculationExcel> CreateGrowthScoreCalculationExcel(FlatBufferBuilder builder,
      long Id = 0,
      Global.GrowthFactor IncludeGrowthFactor = Global.GrowthFactor.CharacterLevel,
  ...
  public static void AddIncludeGrowthFactor(FlatBufferBuilder builder, Global.GrowthFactor includeGrowthFactor) { builder.AddInt(1, (int)includeGrowthFactor, 0); }
  ...
  public static Offset<Global.GrowthScoreCalculationExcel> EndGrowthScoreCalculationExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.GrowthScoreCalculationExcel>(o);
  }
  ...
  public static Offset<Global.GrowthScoreCalculationExcel> Pack(FlatBufferBuilder builder, GrowthScoreCalculationExcelT _o) {
    if (_o == null) return default(Offset<Global.GrowthScoreCalculationExcel>);
		byte[] key = TableEncryptionService.CreateKey("GrowthScoreCalculation");
...
public class GrowthScoreCalculationExcelT
{
  ...
  public Global.GrowthFactor IncludeGrowthFactor { get; set; }
  public long ConversionCoefficient { get; set; }

  public GrowthScoreCalculationExcelT() {
    this.Id = 0;
    this.IncludeGrowthFactor = Global.GrowthFactor.CharacterLevel;
...
static public class GrowthScoreCalculationExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*IncludeGrowthFactor*/, 4 /*Global.GrowthFactor*/, 4, false)
