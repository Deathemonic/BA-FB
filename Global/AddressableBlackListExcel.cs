...
public struct AddressableBlackListExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.AddressableBlackListExcel> EndAddressableBlackListExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.AddressableBlackListExcel>(o);
  }
  ...
  public static Offset<Global.AddressableBlackListExcel> Pack(FlatBufferBuilder builder, AddressableBlackListExcelT _o) {
    ...
    if (_o.FolderPath != null) {
      ...
      for (var _j = 0; _j < __folderPath.Length; ++_j) { __folderPath[_j] = builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.FolderPath[_j], key) : _o.FolderPath[_j])); }
    ...
    if (_o.ResourcePath != null) {
      ...
      for (var _j = 0; _j < __resourcePath.Length; ++_j) { __resourcePath[_j] = builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.ResourcePath[_j], key) : _o.ResourcePath[_j])); }
