...
public struct MinigameCCGCardExcel : IFlatbufferObject
{
  ...
  public Global.CCGCardType Type { get { int o = __p.__offset(6); return o != 0 ? (Global.CCGCardType)__p.bb.GetInt(o + __p.bb_pos) : Global.CCGCardType.None; } }
  ...
  public static Offset<Global.MinigameCCGCardExcel> CreateMinigameCCGCardExcel(FlatBufferBuilder builder,
      long Id = 0,
      Global.CCGCardType Type = Global.CCGCardType.None,
  ...
  public static void AddType(FlatBufferBuilder builder, Global.CCGCardType type) { builder.AddInt(1, (int)type, 0); }
  ...
  public static Offset<Global.MinigameCCGCardExcel> EndMinigameCCGCardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.MinigameCCGCardExcel>(o);
  }
  ...
  public static Offset<Global.MinigameCCGCardExcel> Pack(FlatBufferBuilder builder, MinigameCCGCardExcelT _o) {
    if (_o == null) return default(Offset<Global.MinigameCCGCardExcel>);
		byte[] key = TableEncryptionService.CreateKey("MinigameCCGCard");
		...
		var _IsDisposal = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IsDisposal, key) : _o.IsDisposal;
    ...
    if (_o.PassiveSkillId != null) {
      ...
      _PassiveSkillId = CreatePassiveSkillIdVector(builder, __PassiveSkillId);
		...
		var _PassiveActivateCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PassiveActivateCount, key) : _o.PassiveActivateCount;
...
public class MinigameCCGCardExcelT
{
  ...
  public Global.CCGCardType Type { get; set; }
  ...
  public MinigameCCGCardExcelT() {
    this.Id = 0;
    this.Type = Global.CCGCardType.None;
...
static public class MinigameCCGCardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*Type*/, 4 /*Global.CCGCardType*/, 4, false)
