...
public struct MinigameCCGCardExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(MinigameCCGCardExcelT _o) {
    ...
    _o.Type = TableEncryptionService.UseEncryption ? (Global.CCGCardType)TableEncryptionService.Convert((int)this.Type, key) : this.Type;
  ...
  public static Offset<Global.MinigameCCGCardExcel> Pack(FlatBufferBuilder builder, MinigameCCGCardExcelT _o) {
    if (_o == null) return default(Offset<Global.MinigameCCGCardExcel>);
		...
		var _Type = TableEncryptionService.UseEncryption ? (Global.CCGCardType)TableEncryptionService.Convert((int)_o.Type, key) : _o.Type;
