...
public struct CurrencyExcel : IFlatbufferObject
{
  ...
  public Global.CurrencyTypes CurrencyType { get { int o = __p.__offset(8); return o != 0 ? (Global.CurrencyTypes)__p.bb.GetInt(o + __p.bb_pos) : Global.CurrencyTypes.Invalid; } }
  ...
  public Global.Rarity Rarity { get { int o = __p.__offset(14); return o != 0 ? (Global.Rarity)__p.bb.GetInt(o + __p.bb_pos) : Global.Rarity.N; } }
  ...
  public Global.CurrencyOverChargeType CurrencyOverChargeType { get { int o = __p.__offset(20); return o != 0 ? (Global.CurrencyOverChargeType)__p.bb.GetInt(o + __p.bb_pos) : Global.CurrencyOverChargeType.CanNotCharge; } }
  public Global.CurrencyAdditionalChargeType CurrencyAdditionalChargeType { get { int o = __p.__offset(22); return o != 0 ? (Global.CurrencyAdditionalChargeType)__p.bb.GetInt(o + __p.bb_pos) : Global.CurrencyAdditionalChargeType.EnableAutoChargeOverLimit; } }
  ...
  public Global.DailyRefillType DailyRefillType { get { int o = __p.__offset(30); return o != 0 ? (Global.DailyRefillType)__p.bb.GetInt(o + __p.bb_pos) : Global.DailyRefillType.None; } }
  ...
  public Global.ParcelType ExpiryChangeParcelType { get { int o = __p.__offset(40); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Global.ParcelType.None; } }
  ...
  public static Offset<Global.CurrencyExcel> CreateCurrencyExcel(FlatBufferBuilder builder,
      long ID = 0,
      uint LocalizeEtcId = 0,
      Global.CurrencyTypes CurrencyType = Global.CurrencyTypes.Invalid,
      StringOffset CurrencyNameOffset = default(StringOffset),
      StringOffset IconOffset = default(StringOffset),
      Global.Rarity Rarity = Global.Rarity.N,
      int AutoChargeMsc = 0,
      int AutoChargeAmount = 0,
      Global.CurrencyOverChargeType CurrencyOverChargeType = Global.CurrencyOverChargeType.CanNotCharge,
      Global.CurrencyAdditionalChargeType CurrencyAdditionalChargeType = Global.CurrencyAdditionalChargeType.EnableAutoChargeOverLimit,
      long ChargeLimit = 0,
      long OverChargeLimit = 0,
      StringOffset SpriteNameOffset = default(StringOffset),
      Global.DailyRefillType DailyRefillType = Global.DailyRefillType.None,
  ...
  public static void AddCurrencyType(FlatBufferBuilder builder, Global.CurrencyTypes currencyType) { builder.AddInt(2, (int)currencyType, 0); }
  ...
  public static void AddRarity(FlatBufferBuilder builder, Global.Rarity rarity) { builder.AddInt(5, (int)rarity, 0); }
  ...
  public static void AddCurrencyOverChargeType(FlatBufferBuilder builder, Global.CurrencyOverChargeType currencyOverChargeType) { builder.AddInt(8, (int)currencyOverChargeType, 0); }
  public static void AddCurrencyAdditionalChargeType(FlatBufferBuilder builder, Global.CurrencyAdditionalChargeType currencyAdditionalChargeType) { builder.AddInt(9, (int)currencyAdditionalChargeType, 0); }
  ...
  public static void AddDailyRefillType(FlatBufferBuilder builder, Global.DailyRefillType dailyRefillType) { builder.AddInt(13, (int)dailyRefillType, 0); }
  ...
  public static void AddExpiryChangeParcelType(FlatBufferBuilder builder, Global.ParcelType expiryChangeParcelType) { builder.AddInt(18, (int)expiryChangeParcelType, 0); }
  ...
  public static Offset<Global.CurrencyExcel> EndCurrencyExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.CurrencyExcel>(o);
  }
  ...
  public static Offset<Global.CurrencyExcel> Pack(FlatBufferBuilder builder, CurrencyExcelT _o) {
    if (_o == null) return default(Offset<Global.CurrencyExcel>);
		byte[] key = TableEncryptionService.CreateKey("Currency");
...
public class CurrencyExcelT
{
  ...
  public Global.CurrencyTypes CurrencyType { get; set; }
  public string CurrencyName { get; set; }
  public string Icon { get; set; }
  public Global.Rarity Rarity { get; set; }
  public int AutoChargeMsc { get; set; }
  public int AutoChargeAmount { get; set; }
  public Global.CurrencyOverChargeType CurrencyOverChargeType { get; set; }
  public Global.CurrencyAdditionalChargeType CurrencyAdditionalChargeType { get; set; }
  public long ChargeLimit { get; set; }
  public long OverChargeLimit { get; set; }
  public string SpriteName { get; set; }
  public Global.DailyRefillType DailyRefillType { get; set; }
  ...
  public CurrencyExcelT() {
    ...
    this.CurrencyType = Global.CurrencyTypes.Invalid;
    this.CurrencyName = null;
    this.Icon = null;
    this.Rarity = Global.Rarity.N;
    this.AutoChargeMsc = 0;
    this.AutoChargeAmount = 0;
    this.CurrencyOverChargeType = Global.CurrencyOverChargeType.CanNotCharge;
    this.CurrencyAdditionalChargeType = Global.CurrencyAdditionalChargeType.EnableAutoChargeOverLimit;
    this.ChargeLimit = 0;
    this.OverChargeLimit = 0;
    this.SpriteName = null;
    this.DailyRefillType = Global.DailyRefillType.None;
...
static public class CurrencyExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*CurrencyType*/, 4 /*Global.CurrencyTypes*/, 4, false)
      && verifier.VerifyString(tablePos, 10 /*CurrencyName*/, false)
      && verifier.VerifyString(tablePos, 12 /*Icon*/, false)
      && verifier.VerifyField(tablePos, 14 /*Rarity*/, 4 /*Global.Rarity*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 20 /*CurrencyOverChargeType*/, 4 /*Global.CurrencyOverChargeType*/, 4, false)
      && verifier.VerifyField(tablePos, 22 /*CurrencyAdditionalChargeType*/, 4 /*Global.CurrencyAdditionalChargeType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 30 /*DailyRefillType*/, 4 /*Global.DailyRefillType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 40 /*ExpiryChangeParcelType*/, 4 /*Global.ParcelType*/, 4, false)
