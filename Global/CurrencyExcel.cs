...
public struct CurrencyExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(CurrencyExcelT _o) {
    ...
    _o.CurrencyType = TableEncryptionService.UseEncryption ? (Global.CurrencyTypes)TableEncryptionService.Convert((int)this.CurrencyType, key) : this.CurrencyType;
    ...
    _o.AutoChargeMsc = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.AutoChargeMsc, key) : this.AutoChargeMsc;
    _o.AutoChargeAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.AutoChargeAmount, key) : this.AutoChargeAmount;
    _o.CurrencyOverChargeType = TableEncryptionService.UseEncryption ? (Global.CurrencyOverChargeType)TableEncryptionService.Convert((int)this.CurrencyOverChargeType, key) : this.CurrencyOverChargeType;
    _o.CurrencyAdditionalChargeType = TableEncryptionService.UseEncryption ? (Global.CurrencyAdditionalChargeType)TableEncryptionService.Convert((int)this.CurrencyAdditionalChargeType, key) : this.CurrencyAdditionalChargeType;
    _o.ChargeLimit = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ChargeLimit, key) : this.ChargeLimit;
    _o.OverChargeLimit = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.OverChargeLimit, key) : this.OverChargeLimit;
    _o.SpriteName = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SpriteName, key) : this.SpriteName;
    _o.DailyRefillType = TableEncryptionService.UseEncryption ? (Global.DailyRefillType)TableEncryptionService.Convert((int)this.DailyRefillType, key) : this.DailyRefillType;
    _o.DailyRefillAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.DailyRefillAmount, key) : this.DailyRefillAmount;
    _o.DailyRefillTime = new List<long>();
    for (var _j = 0; _j < this.DailyRefillTimeLength; ++_j) {_o.DailyRefillTime.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.DailyRefillTime(_j), key) : this.DailyRefillTime(_j));}
  ...
  public static Offset<Global.CurrencyExcel> Pack(FlatBufferBuilder builder, CurrencyExcelT _o) {
    if (_o == null) return default(Offset<Global.CurrencyExcel>);
		...
		var _CurrencyType = TableEncryptionService.UseEncryption ? (Global.CurrencyTypes)TableEncryptionService.Convert((int)_o.CurrencyType, key) : _o.CurrencyType;
    var _CurrencyName = _o.CurrencyName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.CurrencyName, key) : _o.CurrencyName));
    var _Icon = _o.Icon == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.Icon, key) : _o.Icon));
		...
		var _AutoChargeMsc = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.AutoChargeMsc, key) : _o.AutoChargeMsc;
		var _AutoChargeAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.AutoChargeAmount, key) : _o.AutoChargeAmount;
		var _CurrencyOverChargeType = TableEncryptionService.UseEncryption ? (Global.CurrencyOverChargeType)TableEncryptionService.Convert((int)_o.CurrencyOverChargeType, key) : _o.CurrencyOverChargeType;
		var _CurrencyAdditionalChargeType = TableEncryptionService.UseEncryption ? (Global.CurrencyAdditionalChargeType)TableEncryptionService.Convert((int)_o.CurrencyAdditionalChargeType, key) : _o.CurrencyAdditionalChargeType;
		var _ChargeLimit = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ChargeLimit, key) : _o.ChargeLimit;
		var _OverChargeLimit = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.OverChargeLimit, key) : _o.OverChargeLimit;
    var _SpriteName = _o.SpriteName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.SpriteName, key) : _o.SpriteName));
		var _DailyRefillType = TableEncryptionService.UseEncryption ? (Global.DailyRefillType)TableEncryptionService.Convert((int)_o.DailyRefillType, key) : _o.DailyRefillType;
		var _DailyRefillAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.DailyRefillAmount, key) : _o.DailyRefillAmount;
    var _DailyRefillTime = default(VectorOffset);
    if (_o.DailyRefillTime != null) {
      var __DailyRefillTime = _o.DailyRefillTime.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
