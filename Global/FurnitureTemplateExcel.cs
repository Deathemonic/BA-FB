...
public struct FurnitureTemplateExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(FurnitureTemplateExcelT _o) {
    ...
    _o.FunitureTemplateTitle = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)this.FunitureTemplateTitle, key) : this.FunitureTemplateTitle;
  ...
  public static Offset<Global.FurnitureTemplateExcel> Pack(FlatBufferBuilder builder, FurnitureTemplateExcelT _o) {
    if (_o == null) return default(Offset<Global.FurnitureTemplateExcel>);
		...
		var _FunitureTemplateTitle = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)_o.FunitureTemplateTitle, key) : _o.FunitureTemplateTitle;
    var _ThumbnailImagePath = _o.ThumbnailImagePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.ThumbnailImagePath, key) : _o.ThumbnailImagePath));
