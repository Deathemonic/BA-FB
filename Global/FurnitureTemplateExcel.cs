...
public struct FurnitureTemplateExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.FurnitureTemplateExcel> CreateFurnitureTemplateExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.FurnitureTemplateExcel> EndFurnitureTemplateExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.FurnitureTemplateExcel>(o);
  }
  ...
  public void UnPackTo(FurnitureTemplateExcelT _o) {
    ...
    _o.FunitureTemplateTitle = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.FunitureTemplateTitle, key) : this.FunitureTemplateTitle;
    _o.ThumbnailImagePath = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ThumbnailImagePath, key) : this.ThumbnailImagePath;
    _o.ImagePath = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ImagePath, key) : this.ImagePath;
  }
  public static Offset<Global.FurnitureTemplateExcel> Pack(FlatBufferBuilder builder, FurnitureTemplateExcelT _o) {
    if (_o == null) return default(Offset<Global.FurnitureTemplateExcel>);
		byte[] key = TableEncryptionService.CreateKey("FurnitureTemplate");
		...
		var _FunitureTemplateTitle = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.FunitureTemplateTitle, key) : _o.FunitureTemplateTitle;
    var _ThumbnailImagePath = _o.ThumbnailImagePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ThumbnailImagePath, key) : _o.ThumbnailImagePath));
    ...
    return CreateFurnitureTemplateExcel(
      ...
      TableEncryptionService.UseEncryption ? _FunitureTemplateTitle : _o.FunitureTemplateTitle,
      _ThumbnailImagePath,
      _ImagePath);
  }
}
