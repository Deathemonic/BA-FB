...
public struct ClanAssistSlotExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.ClanAssistSlotExcel> CreateClanAssistSlotExcel(FlatBufferBuilder builder,
      long SlotId = 0,
  ...
  public static Offset<Global.ClanAssistSlotExcel> EndClanAssistSlotExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.ClanAssistSlotExcel>(o);
  }
  ...
  public static Offset<Global.ClanAssistSlotExcel> Pack(FlatBufferBuilder builder, ClanAssistSlotExcelT _o) {
    if (_o == null) return default(Offset<Global.ClanAssistSlotExcel>);
		byte[] key = TableEncryptionService.CreateKey("ClanAssistSlot");
		...
		var _AssistTermRewardPeriodFromSec = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.AssistTermRewardPeriodFromSec, key) : _o.AssistTermRewardPeriodFromSec;
		var _AssistRewardLimit = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.AssistRewardLimit, key) : _o.AssistRewardLimit;
