...
public struct GroundVector3 : IFlatbufferObject
{
  ...
  public static Offset<Global.GroundVector3> CreateGroundVector3(FlatBufferBuilder builder,
      float x = 0.0f,
      float y = 0.0f,
      float z = 0.0f) {
  ...
  public static Offset<Global.GroundVector3> EndGroundVector3(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.GroundVector3>(o);
  }
  ...
  public static Offset<Global.GroundVector3> Pack(FlatBufferBuilder builder, GroundVector3T _o) {
    if (_o == null) return default(Offset<Global.GroundVector3>);
		byte[] key = TableEncryptionService.CreateKey("GroundVe");
