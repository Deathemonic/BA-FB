...
public struct RecipeSelectionAutoUseExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(RecipeSelectionAutoUseExcelT _o) {
    ...
    _o.TargetItemId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.TargetItemId, key) : this.TargetItemId;
    _o.Priority = new List<long>();
    for (var _j = 0; _j < this.PriorityLength; ++_j) {_o.Priority.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Priority(_j), key) : this.Priority(_j));}
  }
