...
public struct RecipeSelectionAutoUseExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.RecipeSelectionAutoUseExcel> CreateRecipeSelectionAutoUseExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Global.RecipeSelectionAutoUseExcel> EndRecipeSelectionAutoUseExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.RecipeSelectionAutoUseExcel>(o);
  }
  ...
  public void UnPackTo(RecipeSelectionAutoUseExcelT _o) {
    ...
    _o.TargetItemId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.TargetItemId, key) : this.TargetItemId;
    _o.Priority = new List<long>();
    for (var _j = 0; _j < this.PriorityLength; ++_j) {_o.Priority.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.Priority(_j), key) : this.Priority(_j));}
  }
  public static Offset<Global.RecipeSelectionAutoUseExcel> Pack(FlatBufferBuilder builder, RecipeSelectionAutoUseExcelT _o) {
    if (_o == null) return default(Offset<Global.RecipeSelectionAutoUseExcel>);
		byte[] key = TableEncryptionService.CreateKey("RecipeSelectionAutoUse");
		...
		var _TargetItemId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.TargetItemId, key) : _o.TargetItemId;
    var _Priority = default(VectorOffset);
    if (_o.Priority != null) {
      var __Priority = _o.Priority.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
