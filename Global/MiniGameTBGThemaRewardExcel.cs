...
public struct MiniGameTBGThemaRewardExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(MiniGameTBGThemaRewardExcelT _o) {
    ...
    _o.MiniGameTBGThemaRewardType = TableEncryptionService.UseEncryption ? (Global.MiniGameTBGThemaRewardType)TableEncryptionService.Convert((int)this.MiniGameTBGThemaRewardType, key) : this.MiniGameTBGThemaRewardType;
  ...
  public static Offset<Global.MiniGameTBGThemaRewardExcel> Pack(FlatBufferBuilder builder, MiniGameTBGThemaRewardExcelT _o) {
    if (_o == null) return default(Offset<Global.MiniGameTBGThemaRewardExcel>);
		...
		var _MiniGameTBGThemaRewardType = TableEncryptionService.UseEncryption ? (Global.MiniGameTBGThemaRewardType)TableEncryptionService.Convert((int)_o.MiniGameTBGThemaRewardType, key) : _o.MiniGameTBGThemaRewardType;
