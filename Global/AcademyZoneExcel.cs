...
public struct AcademyZoneExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(AcademyZoneExcelT _o) {
    ...
    _o.LocationRankForUnlock = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.LocationRankForUnlock, key) : this.LocationRankForUnlock;
  ...
  public static Offset<Global.AcademyZoneExcel> Pack(FlatBufferBuilder builder, AcademyZoneExcelT _o) {
    if (_o == null) return default(Offset<Global.AcademyZoneExcel>);
		...
		var _LocationRankForUnlock = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.LocationRankForUnlock, key) : _o.LocationRankForUnlock;
