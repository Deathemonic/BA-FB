...
public struct AcademyZoneExcel : IFlatbufferObject
{
  ...
  public Global.Tag Tags(int j) { int o = __p.__offset(16); return o != 0 ? (Global.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Global.Tag)0; }
  public int TagsLength { get { int o = __p.__offset(16); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Global.Tag> GetTagsBytes() { return __p.__vector_as_span<Global.Tag>(16, 4); }
#else
  public ArraySegment<byte>? GetTagsBytes() { return __p.__vector_as_arraysegment(16); }
#endif
  public Global.Tag[] GetTagsArray() { int o = __p.__offset(16); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Global.Tag[] a = new Global.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (Global.Tag)__p.bb.GetInt(p + i * 4); } return a; }

  public static Offset<Global.AcademyZoneExcel> CreateAcademyZoneExcel(FlatBufferBuilder builder,
      long Id = 0,
      long LocationId = 0,
  ...
  public static Offset<Global.AcademyZoneExcel> EndAcademyZoneExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.AcademyZoneExcel>(o);
  }
  ...
  public void UnPackTo(AcademyZoneExcelT _o) {
    ...
    _o.LocationRankForUnlock = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.LocationRankForUnlock, key) : this.LocationRankForUnlock;
  ...
  public static Offset<Global.AcademyZoneExcel> Pack(FlatBufferBuilder builder, AcademyZoneExcelT _o) {
    if (_o == null) return default(Offset<Global.AcademyZoneExcel>);
		byte[] key = TableEncryptionService.CreateKey("AcademyZone");
		...
		var _LocationRankForUnlock = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.LocationRankForUnlock, key) : _o.LocationRankForUnlock;
    ...
    return CreateAcademyZoneExcel(
      ...
      TableEncryptionService.UseEncryption ? _LocationRankForUnlock : _o.LocationRankForUnlock,
...
static public class AcademyZoneExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 16 /*Tags*/, 4 /*Global.Tag*/, false)
