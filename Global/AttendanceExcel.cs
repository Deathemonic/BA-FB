...
public struct AttendanceExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(AttendanceExcelT _o) {
    ...
    _o.Type = TableEncryptionService.UseEncryption ? (Global.AttendanceType)TableEncryptionService.Convert((int)this.Type, key) : this.Type;
    ...
    _o.CountRule = TableEncryptionService.UseEncryption ? (Global.AttendanceCountRule)TableEncryptionService.Convert((int)this.CountRule, key) : this.CountRule;
    _o.CountReset = TableEncryptionService.UseEncryption ? (Global.AttendanceResetType)TableEncryptionService.Convert((int)this.CountReset, key) : this.CountReset;
  ...
  public static Offset<Global.AttendanceExcel> Pack(FlatBufferBuilder builder, AttendanceExcelT _o) {
    if (_o == null) return default(Offset<Global.AttendanceExcel>);
		...
		var _Type = TableEncryptionService.UseEncryption ? (Global.AttendanceType)TableEncryptionService.Convert((int)_o.Type, key) : _o.Type;
    ...
    var _InfomationLocalizeCode = _o.InfomationLocalizeCode == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.InfomationLocalizeCode, key) : _o.InfomationLocalizeCode));
		var _CountRule = TableEncryptionService.UseEncryption ? (Global.AttendanceCountRule)TableEncryptionService.Convert((int)_o.CountRule, key) : _o.CountRule;
		var _CountReset = TableEncryptionService.UseEncryption ? (Global.AttendanceResetType)TableEncryptionService.Convert((int)_o.CountReset, key) : _o.CountReset;
