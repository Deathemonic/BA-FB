...
public struct AttendanceExcel : IFlatbufferObject
{
  ...
  public Global.AttendanceType Type { get { int o = __p.__offset(6); return o != 0 ? (Global.AttendanceType)__p.bb.GetInt(o + __p.bb_pos) : Global.AttendanceType.Basic; } }
  ...
  public Global.AttendanceCountRule CountRule { get { int o = __p.__offset(20); return o != 0 ? (Global.AttendanceCountRule)__p.bb.GetInt(o + __p.bb_pos) : Global.AttendanceCountRule.Accumulation; } }
  public Global.AttendanceResetType CountReset { get { int o = __p.__offset(22); return o != 0 ? (Global.AttendanceResetType)__p.bb.GetInt(o + __p.bb_pos) : Global.AttendanceResetType.User; } }
  ...
  public Global.DialogCategory DialogCategory { get { int o = __p.__offset(36); return o != 0 ? (Global.DialogCategory)__p.bb.GetInt(o + __p.bb_pos) : Global.DialogCategory.Cafe; } }
  ...
  public static Offset<Global.AttendanceExcel> CreateAttendanceExcel(FlatBufferBuilder builder,
      long Id = 0,
      Global.AttendanceType Type = Global.AttendanceType.Basic,
      ...
      Global.AttendanceCountRule CountRule = Global.AttendanceCountRule.Accumulation,
      Global.AttendanceResetType CountReset = Global.AttendanceResetType.User,
      long BookSize = 0,
  ...
  public static void AddType(FlatBufferBuilder builder, Global.AttendanceType type) { builder.AddInt(1, (int)type, 0); }
  ...
  public static void AddCountRule(FlatBufferBuilder builder, Global.AttendanceCountRule countRule) { builder.AddInt(8, (int)countRule, 0); }
  public static void AddCountReset(FlatBufferBuilder builder, Global.AttendanceResetType countReset) { builder.AddInt(9, (int)countReset, 0); }
  ...
  public static void AddDialogCategory(FlatBufferBuilder builder, Global.DialogCategory dialogCategory) { builder.AddInt(16, (int)dialogCategory, 0); }
  ...
  public static Offset<Global.AttendanceExcel> EndAttendanceExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.AttendanceExcel>(o);
  }
  ...
  public static Offset<Global.AttendanceExcel> Pack(FlatBufferBuilder builder, AttendanceExcelT _o) {
    if (_o == null) return default(Offset<Global.AttendanceExcel>);
		byte[] key = TableEncryptionService.CreateKey("Attendance");
...
public class AttendanceExcelT
{
  ...
  public Global.AttendanceType Type { get; set; }
  ...
  public Global.AttendanceCountRule CountRule { get; set; }
  public Global.AttendanceResetType CountReset { get; set; }
  ...
  public AttendanceExcelT() {
    this.Id = 0;
    this.Type = Global.AttendanceType.Basic;
    ...
    this.CountRule = Global.AttendanceCountRule.Accumulation;
    this.CountReset = Global.AttendanceResetType.User;
    this.BookSize = 0;
    this.StartDate = null;
...
static public class AttendanceExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*Type*/, 4 /*Global.AttendanceType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 20 /*CountRule*/, 4 /*Global.AttendanceCountRule*/, 4, false)
      && verifier.VerifyField(tablePos, 22 /*CountReset*/, 4 /*Global.AttendanceResetType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 36 /*DialogCategory*/, 4 /*Global.DialogCategory*/, 4, false)
