...
public struct ScenarioContentCollectionExcel : IFlatbufferObject
{
  ...
  public Global.CollectionUnlockType UnlockConditionType { get { int o = __p.__offset(8); return o != 0 ? (Global.CollectionUnlockType)__p.bb.GetInt(o + __p.bb_pos) : Global.CollectionUnlockType.None; } }
  ...
  public Global.MultipleConditionCheckType MultipleConditionCheckType { get { int o = __p.__offset(12); return o != 0 ? (Global.MultipleConditionCheckType)__p.bb.GetInt(o + __p.bb_pos) : Global.MultipleConditionCheckType.And; } }
  ...
  public static Offset<Global.ScenarioContentCollectionExcel> CreateScenarioContentCollectionExcel(FlatBufferBuilder builder,
      long Id = 0,
      long GroupId = 0,
  ...
  public static void AddUnlockConditionType(FlatBufferBuilder builder, Global.CollectionUnlockType unlockConditionType) { builder.AddInt(2, (int)unlockConditionType, 0); }
  ...
  public static void AddMultipleConditionCheckType(FlatBufferBuilder builder, Global.MultipleConditionCheckType multipleConditionCheckType) { builder.AddInt(4, (int)multipleConditionCheckType, 0); }
  ...
  public static Offset<Global.ScenarioContentCollectionExcel> EndScenarioContentCollectionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.ScenarioContentCollectionExcel>(o);
  }
  ...
  public void UnPackTo(ScenarioContentCollectionExcelT _o) {
    ...
    _o.UnlockConditionType = TableEncryptionService.UseEncryption ? (Global.CollectionUnlockType)TableEncryptionService.Convert((int)this.UnlockConditionType, key) : this.UnlockConditionType;
  ...
  public static Offset<Global.ScenarioContentCollectionExcel> Pack(FlatBufferBuilder builder, ScenarioContentCollectionExcelT _o) {
    if (_o == null) return default(Offset<Global.ScenarioContentCollectionExcel>);
		byte[] key = TableEncryptionService.CreateKey("ScenarioContentCollection");
		...
		var _UnlockConditionType = TableEncryptionService.UseEncryption ? (Global.CollectionUnlockType)TableEncryptionService.Convert((int)_o.UnlockConditionType, key) : _o.UnlockConditionType;
...
public class ScenarioContentCollectionExcelT
{
  ...
  public Global.CollectionUnlockType UnlockConditionType { get; set; }
  ...
  public ScenarioContentCollectionExcelT() {
    this.Id = 0;
    this.GroupId = 0;
    this.UnlockConditionType = Global.CollectionUnlockType.None;
...
static public class ScenarioContentCollectionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*UnlockConditionType*/, 4 /*Global.CollectionUnlockType*/, 4, false)
      && verifier.VerifyVectorOfData(tablePos, 10 /*UnlockConditionParameter*/, 8 /*long*/, false)
      && verifier.VerifyField(tablePos, 12 /*MultipleConditionCheckType*/, 4 /*Global.MultipleConditionCheckType*/, 4, false)
