...
public struct MiniGameDreamScheduleExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.MiniGameDreamScheduleExcel> CreateMiniGameDreamScheduleExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.MiniGameDreamScheduleExcel> EndMiniGameDreamScheduleExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.MiniGameDreamScheduleExcel>(o);
  }
  ...
  public void UnPackTo(MiniGameDreamScheduleExcelT _o) {
    ...
    _o.DreamMakerScheduleGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.DreamMakerScheduleGroupId, key) : this.DreamMakerScheduleGroupId;
    ...
    _o.LoadingResource01 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.LoadingResource01, key) : this.LoadingResource01;
    _o.LoadingResource02 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.LoadingResource02, key) : this.LoadingResource02;
  ...
  public static Offset<Global.MiniGameDreamScheduleExcel> Pack(FlatBufferBuilder builder, MiniGameDreamScheduleExcelT _o) {
    if (_o == null) return default(Offset<Global.MiniGameDreamScheduleExcel>);
		byte[] key = TableEncryptionService.CreateKey("MiniGameDreamSchedule");
		...
		var _DreamMakerScheduleGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DreamMakerScheduleGroupId, key) : _o.DreamMakerScheduleGroupId;
    ...
    var _LoadingResource01 = _o.LoadingResource01 == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.LoadingResource01, key) : _o.LoadingResource01));
    var _LoadingResource02 = _o.LoadingResource02 == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.LoadingResource02, key) : _o.LoadingResource02));
    ...
    return CreateMiniGameDreamScheduleExcel(
      ...
      TableEncryptionService.UseEncryption ? _DreamMakerScheduleGroupId : _o.DreamMakerScheduleGroupId,
