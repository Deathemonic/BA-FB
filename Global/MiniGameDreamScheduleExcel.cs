...
public struct MiniGameDreamScheduleExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(MiniGameDreamScheduleExcelT _o) {
    ...
    _o.DreamMakerScheduleGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.DreamMakerScheduleGroupId, key) : this.DreamMakerScheduleGroupId;
  ...
  public static Offset<Global.MiniGameDreamScheduleExcel> Pack(FlatBufferBuilder builder, MiniGameDreamScheduleExcelT _o) {
    if (_o == null) return default(Offset<Global.MiniGameDreamScheduleExcel>);
		...
		var _DreamMakerScheduleGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.DreamMakerScheduleGroupId, key) : _o.DreamMakerScheduleGroupId;
    ...
    var _LoadingResource01 = _o.LoadingResource01 == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.LoadingResource01, key) : _o.LoadingResource01));
    var _LoadingResource02 = _o.LoadingResource02 == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.LoadingResource02, key) : _o.LoadingResource02));
