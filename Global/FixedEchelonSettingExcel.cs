...
public struct FixedEchelonSettingExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(FixedEchelonSettingExcelT _o) {
    ...
    _o.EchelonSceneSkip = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EchelonSceneSkip, key) : this.EchelonSceneSkip;
    _o.MainLeaderSlot = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MainLeaderSlot, key) : this.MainLeaderSlot;
    _o.MainCharacterID = new List<long>();
    for (var _j = 0; _j < this.MainCharacterIDLength; ++_j) {_o.MainCharacterID.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MainCharacterID(_j), key) : this.MainCharacterID(_j));}
    _o.MainLevel = new List<int>();
    for (var _j = 0; _j < this.MainLevelLength; ++_j) {_o.MainLevel.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MainLevel(_j), key) : this.MainLevel(_j));}
    _o.MainGrade = new List<int>();
    for (var _j = 0; _j < this.MainGradeLength; ++_j) {_o.MainGrade.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MainGrade(_j), key) : this.MainGrade(_j));}
    _o.MainExSkillLevel = new List<int>();
    for (var _j = 0; _j < this.MainExSkillLevelLength; ++_j) {_o.MainExSkillLevel.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MainExSkillLevel(_j), key) : this.MainExSkillLevel(_j));}
    _o.MainNoneExSkillLevel = new List<int>();
    for (var _j = 0; _j < this.MainNoneExSkillLevelLength; ++_j) {_o.MainNoneExSkillLevel.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MainNoneExSkillLevel(_j), key) : this.MainNoneExSkillLevel(_j));}
    _o.MainEquipment1Tier = new List<int>();
    for (var _j = 0; _j < this.MainEquipment1TierLength; ++_j) {_o.MainEquipment1Tier.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MainEquipment1Tier(_j), key) : this.MainEquipment1Tier(_j));}
    _o.MainEquipment1Level = new List<int>();
    for (var _j = 0; _j < this.MainEquipment1LevelLength; ++_j) {_o.MainEquipment1Level.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MainEquipment1Level(_j), key) : this.MainEquipment1Level(_j));}
    _o.MainEquipment2Tier = new List<int>();
    for (var _j = 0; _j < this.MainEquipment2TierLength; ++_j) {_o.MainEquipment2Tier.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MainEquipment2Tier(_j), key) : this.MainEquipment2Tier(_j));}
    _o.MainEquipment2Level = new List<int>();
    for (var _j = 0; _j < this.MainEquipment2LevelLength; ++_j) {_o.MainEquipment2Level.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MainEquipment2Level(_j), key) : this.MainEquipment2Level(_j));}
    _o.MainEquipment3Tier = new List<int>();
    for (var _j = 0; _j < this.MainEquipment3TierLength; ++_j) {_o.MainEquipment3Tier.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MainEquipment3Tier(_j), key) : this.MainEquipment3Tier(_j));}
    _o.MainEquipment3Level = new List<int>();
    for (var _j = 0; _j < this.MainEquipment3LevelLength; ++_j) {_o.MainEquipment3Level.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MainEquipment3Level(_j), key) : this.MainEquipment3Level(_j));}
    _o.MainCharacterWeaponGrade = new List<int>();
    for (var _j = 0; _j < this.MainCharacterWeaponGradeLength; ++_j) {_o.MainCharacterWeaponGrade.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MainCharacterWeaponGrade(_j), key) : this.MainCharacterWeaponGrade(_j));}
    _o.MainCharacterWeaponLevel = new List<int>();
    for (var _j = 0; _j < this.MainCharacterWeaponLevelLength; ++_j) {_o.MainCharacterWeaponLevel.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MainCharacterWeaponLevel(_j), key) : this.MainCharacterWeaponLevel(_j));}
    _o.MainCharacterGearTier = new List<int>();
    for (var _j = 0; _j < this.MainCharacterGearTierLength; ++_j) {_o.MainCharacterGearTier.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MainCharacterGearTier(_j), key) : this.MainCharacterGearTier(_j));}
    _o.MainCharacterGearLevel = new List<int>();
    for (var _j = 0; _j < this.MainCharacterGearLevelLength; ++_j) {_o.MainCharacterGearLevel.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MainCharacterGearLevel(_j), key) : this.MainCharacterGearLevel(_j));}
    _o.SupportCharacterID = new List<long>();
    for (var _j = 0; _j < this.SupportCharacterIDLength; ++_j) {_o.SupportCharacterID.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SupportCharacterID(_j), key) : this.SupportCharacterID(_j));}
    _o.SupportLevel = new List<int>();
    for (var _j = 0; _j < this.SupportLevelLength; ++_j) {_o.SupportLevel.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SupportLevel(_j), key) : this.SupportLevel(_j));}
    _o.SupportGrade = new List<int>();
    for (var _j = 0; _j < this.SupportGradeLength; ++_j) {_o.SupportGrade.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SupportGrade(_j), key) : this.SupportGrade(_j));}
    _o.SupportExSkillLevel = new List<int>();
    for (var _j = 0; _j < this.SupportExSkillLevelLength; ++_j) {_o.SupportExSkillLevel.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SupportExSkillLevel(_j), key) : this.SupportExSkillLevel(_j));}
    _o.SupportNoneExSkillLevel = new List<int>();
    for (var _j = 0; _j < this.SupportNoneExSkillLevelLength; ++_j) {_o.SupportNoneExSkillLevel.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SupportNoneExSkillLevel(_j), key) : this.SupportNoneExSkillLevel(_j));}
    _o.SupportEquipment1Tier = new List<int>();
    for (var _j = 0; _j < this.SupportEquipment1TierLength; ++_j) {_o.SupportEquipment1Tier.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SupportEquipment1Tier(_j), key) : this.SupportEquipment1Tier(_j));}
    _o.SupportEquipment1Level = new List<int>();
    for (var _j = 0; _j < this.SupportEquipment1LevelLength; ++_j) {_o.SupportEquipment1Level.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SupportEquipment1Level(_j), key) : this.SupportEquipment1Level(_j));}
    _o.SupportEquipment2Tier = new List<int>();
    for (var _j = 0; _j < this.SupportEquipment2TierLength; ++_j) {_o.SupportEquipment2Tier.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SupportEquipment2Tier(_j), key) : this.SupportEquipment2Tier(_j));}
    _o.SupportEquipment2Level = new List<int>();
    for (var _j = 0; _j < this.SupportEquipment2LevelLength; ++_j) {_o.SupportEquipment2Level.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SupportEquipment2Level(_j), key) : this.SupportEquipment2Level(_j));}
    _o.SupportEquipment3Tier = new List<int>();
    for (var _j = 0; _j < this.SupportEquipment3TierLength; ++_j) {_o.SupportEquipment3Tier.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SupportEquipment3Tier(_j), key) : this.SupportEquipment3Tier(_j));}
    _o.SupportEquipment3Level = new List<int>();
    for (var _j = 0; _j < this.SupportEquipment3LevelLength; ++_j) {_o.SupportEquipment3Level.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SupportEquipment3Level(_j), key) : this.SupportEquipment3Level(_j));}
    _o.SupportCharacterWeaponGrade = new List<int>();
    for (var _j = 0; _j < this.SupportCharacterWeaponGradeLength; ++_j) {_o.SupportCharacterWeaponGrade.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SupportCharacterWeaponGrade(_j), key) : this.SupportCharacterWeaponGrade(_j));}
    _o.SupportCharacterWeaponLevel = new List<int>();
    for (var _j = 0; _j < this.SupportCharacterWeaponLevelLength; ++_j) {_o.SupportCharacterWeaponLevel.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SupportCharacterWeaponLevel(_j), key) : this.SupportCharacterWeaponLevel(_j));}
    _o.SupportCharacterGearTier = new List<int>();
    for (var _j = 0; _j < this.SupportCharacterGearTierLength; ++_j) {_o.SupportCharacterGearTier.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SupportCharacterGearTier(_j), key) : this.SupportCharacterGearTier(_j));}
    _o.SupportCharacterGearLevel = new List<int>();
    for (var _j = 0; _j < this.SupportCharacterGearLevelLength; ++_j) {_o.SupportCharacterGearLevel.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SupportCharacterGearLevel(_j), key) : this.SupportCharacterGearLevel(_j));}
    _o.InteractionTSCharacterId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.InteractionTSCharacterId, key) : this.InteractionTSCharacterId;
  }
  public static Offset<Global.FixedEchelonSettingExcel> Pack(FlatBufferBuilder builder, FixedEchelonSettingExcelT _o) {
    if (_o == null) return default(Offset<Global.FixedEchelonSettingExcel>);
		...
		var _EchelonSceneSkip = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EchelonSceneSkip, key) : _o.EchelonSceneSkip;
		var _MainLeaderSlot = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MainLeaderSlot, key) : _o.MainLeaderSlot;
    var _MainCharacterID = default(VectorOffset);
    if (_o.MainCharacterID != null) {
      var __MainCharacterID = _o.MainCharacterID.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.MainLevel != null) {
      var __MainLevel = _o.MainLevel.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
      _MainLevel = CreateMainLevelVector(builder, __MainLevel);
    }
    var _MainGrade = default(VectorOffset);
    if (_o.MainGrade != null) {
      var __MainGrade = _o.MainGrade.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.MainExSkillLevel != null) {
      var __MainExSkillLevel = _o.MainExSkillLevel.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.MainNoneExSkillLevel != null) {
      var __MainNoneExSkillLevel = _o.MainNoneExSkillLevel.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.MainEquipment1Tier != null) {
      var __MainEquipment1Tier = _o.MainEquipment1Tier.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.MainEquipment1Level != null) {
      var __MainEquipment1Level = _o.MainEquipment1Level.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.MainEquipment2Tier != null) {
      var __MainEquipment2Tier = _o.MainEquipment2Tier.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.MainEquipment2Level != null) {
      var __MainEquipment2Level = _o.MainEquipment2Level.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.MainEquipment3Tier != null) {
      var __MainEquipment3Tier = _o.MainEquipment3Tier.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.MainEquipment3Level != null) {
      var __MainEquipment3Level = _o.MainEquipment3Level.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.MainCharacterWeaponGrade != null) {
      var __MainCharacterWeaponGrade = _o.MainCharacterWeaponGrade.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.MainCharacterWeaponLevel != null) {
      var __MainCharacterWeaponLevel = _o.MainCharacterWeaponLevel.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.MainCharacterGearTier != null) {
      var __MainCharacterGearTier = _o.MainCharacterGearTier.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.MainCharacterGearLevel != null) {
      var __MainCharacterGearLevel = _o.MainCharacterGearLevel.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.SupportCharacterID != null) {
      var __SupportCharacterID = _o.SupportCharacterID.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.SupportLevel != null) {
      var __SupportLevel = _o.SupportLevel.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.SupportGrade != null) {
      var __SupportGrade = _o.SupportGrade.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.SupportExSkillLevel != null) {
      var __SupportExSkillLevel = _o.SupportExSkillLevel.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.SupportNoneExSkillLevel != null) {
      var __SupportNoneExSkillLevel = _o.SupportNoneExSkillLevel.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.SupportEquipment1Tier != null) {
      var __SupportEquipment1Tier = _o.SupportEquipment1Tier.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.SupportEquipment1Level != null) {
      var __SupportEquipment1Level = _o.SupportEquipment1Level.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.SupportEquipment2Tier != null) {
      var __SupportEquipment2Tier = _o.SupportEquipment2Tier.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.SupportEquipment2Level != null) {
      var __SupportEquipment2Level = _o.SupportEquipment2Level.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.SupportEquipment3Tier != null) {
      var __SupportEquipment3Tier = _o.SupportEquipment3Tier.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.SupportEquipment3Level != null) {
      var __SupportEquipment3Level = _o.SupportEquipment3Level.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.SupportCharacterWeaponGrade != null) {
      var __SupportCharacterWeaponGrade = _o.SupportCharacterWeaponGrade.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.SupportCharacterWeaponLevel != null) {
      var __SupportCharacterWeaponLevel = _o.SupportCharacterWeaponLevel.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.SupportCharacterGearTier != null) {
      var __SupportCharacterGearTier = _o.SupportCharacterGearTier.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.SupportCharacterGearLevel != null) {
      var __SupportCharacterGearLevel = _o.SupportCharacterGearLevel.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
      _SupportCharacterGearLevel = CreateSupportCharacterGearLevelVector(builder, __SupportCharacterGearLevel);
    }
		var _InteractionTSCharacterId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.InteractionTSCharacterId, key) : _o.InteractionTSCharacterId;
