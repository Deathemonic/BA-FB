...
public struct EventContentCardExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.EventContentCardExcel> CreateEventContentCardExcel(FlatBufferBuilder builder,
      int CardGroupId = 0,
  ...
  public static Offset<Global.EventContentCardExcel> EndEventContentCardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.EventContentCardExcel>(o);
  }
  ...
  public static Offset<Global.EventContentCardExcel> Pack(FlatBufferBuilder builder, EventContentCardExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentCardExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentCard");
