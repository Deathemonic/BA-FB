...
public struct CharacterDialogFieldExcel : IFlatbufferObject
{
  ...
  public Global.FieldDialogType DialogType { get { int o = __p.__offset(10); return o != 0 ? (Global.FieldDialogType)__p.bb.GetInt(o + __p.bb_pos) : Global.FieldDialogType.None; } }
  ...
  public static Offset<Global.CharacterDialogFieldExcel> CreateCharacterDialogFieldExcel(FlatBufferBuilder builder,
      long GroupId = 0,
      int Phase = 0,
      int TargetIndex = 0,
      Global.FieldDialogType DialogType = Global.FieldDialogType.None,
      long Duration = 0,
  ...
  public static void AddDialogType(FlatBufferBuilder builder, Global.FieldDialogType dialogType) { builder.AddInt(3, (int)dialogType, 0); }
  ...
  public static Offset<Global.CharacterDialogFieldExcel> EndCharacterDialogFieldExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.CharacterDialogFieldExcel>(o);
  }
  ...
  public void UnPackTo(CharacterDialogFieldExcelT _o) {
    ...
    _o.MotionName = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MotionName, key) : this.MotionName;
    _o.IsInteractionDialog = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.IsInteractionDialog, key) : this.IsInteractionDialog;
  ...
  public static Offset<Global.CharacterDialogFieldExcel> Pack(FlatBufferBuilder builder, CharacterDialogFieldExcelT _o) {
    if (_o == null) return default(Offset<Global.CharacterDialogFieldExcel>);
		byte[] key = TableEncryptionService.CreateKey("CharacterDialogField");
		...
		var _TargetIndex = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.TargetIndex, key) : _o.TargetIndex;
    ...
    var _MotionName = _o.MotionName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.MotionName, key) : _o.MotionName));
		var _IsInteractionDialog = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IsInteractionDialog, key) : _o.IsInteractionDialog;
		var _HideUI = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.HideUI, key) : _o.HideUI;
    ...
    return CreateCharacterDialogFieldExcel(
      ...
      _MotionName,
      TableEncryptionService.UseEncryption ? _IsInteractionDialog : _o.IsInteractionDialog,
...
public class CharacterDialogFieldExcelT
{
  ...
  public Global.FieldDialogType DialogType { get; set; }
  ...
  public CharacterDialogFieldExcelT() {
    ...
    this.Phase = 0;
    this.TargetIndex = 0;
    this.DialogType = Global.FieldDialogType.None;
    this.Duration = 0;
...
static public class CharacterDialogFieldExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*DialogType*/, 4 /*Global.FieldDialogType*/, 4, false)
