...
public struct CharacterDialogFieldExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(CharacterDialogFieldExcelT _o) {
    ...
    _o.DialogType = TableEncryptionService.UseEncryption ? (Global.FieldDialogType)TableEncryptionService.Convert((int)this.DialogType, key) : this.DialogType;
    ...
    _o.IsInteractionDialog = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.IsInteractionDialog, key) : this.IsInteractionDialog;
  ...
  public static Offset<Global.CharacterDialogFieldExcel> Pack(FlatBufferBuilder builder, CharacterDialogFieldExcelT _o) {
    if (_o == null) return default(Offset<Global.CharacterDialogFieldExcel>);
		...
		var _DialogType = TableEncryptionService.UseEncryption ? (Global.FieldDialogType)TableEncryptionService.Convert((int)_o.DialogType, key) : _o.DialogType;
		var _Duration = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.Duration, key) : _o.Duration;
    var _MotionName = _o.MotionName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.MotionName, key) : _o.MotionName));
		var _IsInteractionDialog = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.IsInteractionDialog, key) : _o.IsInteractionDialog;
