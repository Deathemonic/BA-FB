...
public struct NormalSkillTemplateExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.NormalSkillTemplateExcel> CreateNormalSkillTemplateExcel(FlatBufferBuilder builder,
      long Index = 0,
  ...
  public static Offset<Global.NormalSkillTemplateExcel> EndNormalSkillTemplateExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.NormalSkillTemplateExcel>(o);
  }
  ...
  public void UnPackTo(NormalSkillTemplateExcelT _o) {
    ...
    _o.FirstCoolTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.FirstCoolTime, key) : this.FirstCoolTime;
    _o.CoolTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CoolTime, key) : this.CoolTime;
    _o.MultiAni = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MultiAni, key) : this.MultiAni;
  }
  public static Offset<Global.NormalSkillTemplateExcel> Pack(FlatBufferBuilder builder, NormalSkillTemplateExcelT _o) {
    if (_o == null) return default(Offset<Global.NormalSkillTemplateExcel>);
		byte[] key = TableEncryptionService.CreateKey("NormalSkillTemplate");
		var _Index = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Index, key) : _o.Index;
		var _FirstCoolTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.FirstCoolTime, key) : _o.FirstCoolTime;
		var _CoolTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CoolTime, key) : _o.CoolTime;
		var _MultiAni = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MultiAni, key) : _o.MultiAni;
    return CreateNormalSkillTemplateExcel(
      builder,
      TableEncryptionService.UseEncryption ? _Index : _o.Index,
      TableEncryptionService.UseEncryption ? _FirstCoolTime : _o.FirstCoolTime,
      TableEncryptionService.UseEncryption ? _CoolTime : _o.CoolTime,
      TableEncryptionService.UseEncryption ? _MultiAni : _o.MultiAni);
  }
}
