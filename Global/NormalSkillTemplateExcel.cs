...
public struct NormalSkillTemplateExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(NormalSkillTemplateExcelT _o) {
    ...
    _o.FirstCoolTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)this.FirstCoolTime, key) : this.FirstCoolTime;
    _o.CoolTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)this.CoolTime, key) : this.CoolTime;
    _o.MultiAni = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.MultiAni, key) : this.MultiAni;
  }
  public static Offset<Global.NormalSkillTemplateExcel> Pack(FlatBufferBuilder builder, NormalSkillTemplateExcelT _o) {
    if (_o == null) return default(Offset<Global.NormalSkillTemplateExcel>);
		...
		var _FirstCoolTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)_o.FirstCoolTime, key) : _o.FirstCoolTime;
		var _CoolTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)_o.CoolTime, key) : _o.CoolTime;
		var _MultiAni = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.MultiAni, key) : _o.MultiAni;
