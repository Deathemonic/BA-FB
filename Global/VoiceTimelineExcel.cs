...
public struct VoiceTimelineExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.VoiceTimelineExcel> CreateVoiceTimelineExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      uint Id = 0,
  ...
  public static Offset<Global.VoiceTimelineExcel> EndVoiceTimelineExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.VoiceTimelineExcel>(o);
  }
  ...
  public static Offset<Global.VoiceTimelineExcel> Pack(FlatBufferBuilder builder, VoiceTimelineExcelT _o) {
    if (_o == null) return default(Offset<Global.VoiceTimelineExcel>);
		byte[] key = TableEncryptionService.CreateKey("VoiceTimeline");
