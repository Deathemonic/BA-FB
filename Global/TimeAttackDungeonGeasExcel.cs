...
public struct TimeAttackDungeonGeasExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(TimeAttackDungeonGeasExcelT _o) {
    ...
    _o.TimeAttackDungeonType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.TimeAttackDungeonType, key) : this.TimeAttackDungeonType;
    _o.LocalizeEtcKey = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.LocalizeEtcKey, key) : this.LocalizeEtcKey;
    ...
    _o.ClearDefaultPoint = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ClearDefaultPoint, key) : this.ClearDefaultPoint;
    _o.ClearTimeWeightPoint = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ClearTimeWeightPoint, key) : this.ClearTimeWeightPoint;
    _o.TimeWeightConst = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.TimeWeightConst, key) : this.TimeWeightConst;
    ...
    for (var _j = 0; _j < this.GeasLocalizeEtcKeyLength; ++_j) {_o.GeasLocalizeEtcKey.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.GeasLocalizeEtcKey(_j), key) : this.GeasLocalizeEtcKey(_j));}
  }
  public static Offset<Global.TimeAttackDungeonGeasExcel> Pack(FlatBufferBuilder builder, TimeAttackDungeonGeasExcelT _o) {
    if (_o == null) return default(Offset<Global.TimeAttackDungeonGeasExcel>);
		...
		var _TimeAttackDungeonType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.TimeAttackDungeonType, key) : _o.TimeAttackDungeonType;
		var _LocalizeEtcKey = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.LocalizeEtcKey, key) : _o.LocalizeEtcKey;
		...
		var _ClearDefaultPoint = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ClearDefaultPoint, key) : _o.ClearDefaultPoint;
		var _ClearTimeWeightPoint = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ClearTimeWeightPoint, key) : _o.ClearTimeWeightPoint;
		var _TimeWeightConst = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.TimeWeightConst, key) : _o.TimeWeightConst;
