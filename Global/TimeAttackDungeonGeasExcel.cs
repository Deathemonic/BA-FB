...
public struct TimeAttackDungeonGeasExcel : IFlatbufferObject
{
  ...
  public Global.TimeAttackDungeonType TimeAttackDungeonType { get { int o = __p.__offset(6); return o != 0 ? (Global.TimeAttackDungeonType)__p.bb.GetInt(o + __p.bb_pos) : Global.TimeAttackDungeonType.None; } }
  ...
  public static Offset<Global.TimeAttackDungeonGeasExcel> CreateTimeAttackDungeonGeasExcel(FlatBufferBuilder builder,
      long Id = 0,
      Global.TimeAttackDungeonType TimeAttackDungeonType = Global.TimeAttackDungeonType.None,
  ...
  public static void AddTimeAttackDungeonType(FlatBufferBuilder builder, Global.TimeAttackDungeonType timeAttackDungeonType) { builder.AddInt(1, (int)timeAttackDungeonType, 0); }
  ...
  public static Offset<Global.TimeAttackDungeonGeasExcel> EndTimeAttackDungeonGeasExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.TimeAttackDungeonGeasExcel>(o);
  }
  ...
  public void UnPackTo(TimeAttackDungeonGeasExcelT _o) {
    ...
    _o.TimeAttackDungeonType = TableEncryptionService.UseEncryption ? (Global.TimeAttackDungeonType)TableEncryptionService.Convert((int)this.TimeAttackDungeonType, key) : this.TimeAttackDungeonType;
    ...
    _o.ClearDefaultPoint = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ClearDefaultPoint, key) : this.ClearDefaultPoint;
    _o.ClearTimeWeightPoint = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ClearTimeWeightPoint, key) : this.ClearTimeWeightPoint;
    _o.TimeWeightConst = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.TimeWeightConst, key) : this.TimeWeightConst;
    ...
    for (var _j = 0; _j < this.GeasIconPathLength; ++_j) {_o.GeasIconPath.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.GeasIconPath(_j), key) : this.GeasIconPath(_j));}
    _o.GeasLocalizeEtcKey = new List<uint>();
    for (var _j = 0; _j < this.GeasLocalizeEtcKeyLength; ++_j) {_o.GeasLocalizeEtcKey.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)this.GeasLocalizeEtcKey(_j), key) : this.GeasLocalizeEtcKey(_j));}
  }
  public static Offset<Global.TimeAttackDungeonGeasExcel> Pack(FlatBufferBuilder builder, TimeAttackDungeonGeasExcelT _o) {
    if (_o == null) return default(Offset<Global.TimeAttackDungeonGeasExcel>);
		byte[] key = TableEncryptionService.CreateKey("TimeAttackDungeonGeas");
		var _Id = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.Id, key) : _o.Id;
		var _TimeAttackDungeonType = TableEncryptionService.UseEncryption ? (Global.TimeAttackDungeonType)TableEncryptionService.Convert((int)_o.TimeAttackDungeonType, key) : _o.TimeAttackDungeonType;
		...
		var _ClearDefaultPoint = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ClearDefaultPoint, key) : _o.ClearDefaultPoint;
		var _ClearTimeWeightPoint = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ClearTimeWeightPoint, key) : _o.ClearTimeWeightPoint;
		var _TimeWeightConst = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.TimeWeightConst, key) : _o.TimeWeightConst;
    ...
    if (_o.GeasIconPath != null) {
      ...
      for (var _j = 0; _j < __GeasIconPath.Length; ++_j) { __GeasIconPath[_j] = builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.GeasIconPath[_j], key) : _o.GeasIconPath[_j])); }
    ...
    if (_o.GeasLocalizeEtcKey != null) {
      var __GeasLocalizeEtcKey = _o.GeasLocalizeEtcKey.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)x, key) : x).ToArray();
    ...
    return CreateTimeAttackDungeonGeasExcel(
      ...
      TableEncryptionService.UseEncryption ? _ClearDefaultPoint : _o.ClearDefaultPoint,
      TableEncryptionService.UseEncryption ? _ClearTimeWeightPoint : _o.ClearTimeWeightPoint,
      TableEncryptionService.UseEncryption ? _TimeWeightConst : _o.TimeWeightConst,
...
public class TimeAttackDungeonGeasExcelT
{
  ...
  public Global.TimeAttackDungeonType TimeAttackDungeonType { get; set; }
  ...
  public TimeAttackDungeonGeasExcelT() {
    this.Id = 0;
    this.TimeAttackDungeonType = Global.TimeAttackDungeonType.None;
...
static public class TimeAttackDungeonGeasExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*TimeAttackDungeonType*/, 4 /*Global.TimeAttackDungeonType*/, 4, false)
