...
public struct PossessionCheckExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(PossessionCheckExcelT _o) {
    ...
    _o.DefaultParcelType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)this.DefaultParcelType, key) : this.DefaultParcelType;
    ...
    _o.ReplaceParcelType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)this.ReplaceParcelType, key) : this.ReplaceParcelType;
  ...
  public static Offset<Global.PossessionCheckExcel> Pack(FlatBufferBuilder builder, PossessionCheckExcelT _o) {
    if (_o == null) return default(Offset<Global.PossessionCheckExcel>);
		...
		var _DefaultParcelType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)_o.DefaultParcelType, key) : _o.DefaultParcelType;
		...
		var _ReplaceParcelType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)_o.ReplaceParcelType, key) : _o.ReplaceParcelType;
