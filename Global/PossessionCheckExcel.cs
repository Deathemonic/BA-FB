...
public struct PossessionCheckExcel : IFlatbufferObject
{
  ...
  public Global.ParcelType DefaultParcelType { get { int o = __p.__offset(6); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Global.ParcelType.None; } }
  ...
  public Global.ParcelType ReplaceParcelType { get { int o = __p.__offset(12); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Global.ParcelType.None; } }
  ...
  public static Offset<Global.PossessionCheckExcel> CreatePossessionCheckExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      Global.ParcelType DefaultParcelType = Global.ParcelType.None,
      long DefaultParcelId = 0,
      int DefaultParcelAmount = 0,
      Global.ParcelType ReplaceParcelType = Global.ParcelType.None,
  ...
  public static void AddDefaultParcelType(FlatBufferBuilder builder, Global.ParcelType defaultParcelType) { builder.AddInt(1, (int)defaultParcelType, 0); }
  ...
  public static void AddReplaceParcelType(FlatBufferBuilder builder, Global.ParcelType replaceParcelType) { builder.AddInt(4, (int)replaceParcelType, 0); }
  ...
  public static Offset<Global.PossessionCheckExcel> EndPossessionCheckExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.PossessionCheckExcel>(o);
  }
  ...
  public static Offset<Global.PossessionCheckExcel> Pack(FlatBufferBuilder builder, PossessionCheckExcelT _o) {
    if (_o == null) return default(Offset<Global.PossessionCheckExcel>);
		byte[] key = TableEncryptionService.CreateKey("PossessionCheck");
		var _UniqueId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.UniqueId, key) : _o.UniqueId;
		var _DefaultParcelType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DefaultParcelType, key) : _o.DefaultParcelType;
		var _DefaultParcelId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DefaultParcelId, key) : _o.DefaultParcelId;
		var _DefaultParcelAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DefaultParcelAmount, key) : _o.DefaultParcelAmount;
		var _ReplaceParcelType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ReplaceParcelType, key) : _o.ReplaceParcelType;
		var _ReplaceParcelId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ReplaceParcelId, key) : _o.ReplaceParcelId;
		var _ReplaceParcelAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ReplaceParcelAmount, key) : _o.ReplaceParcelAmount;
...
static public class PossessionCheckExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*DefaultParcelType*/, 4 /*Global.ParcelType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 12 /*ReplaceParcelType*/, 4 /*Global.ParcelType*/, 4, false)
