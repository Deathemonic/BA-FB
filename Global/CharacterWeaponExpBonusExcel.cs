...
public struct CharacterWeaponExpBonusExcel : IFlatbufferObject
{
  ...
  public Global.WeaponType WeaponType { get { int o = __p.__offset(4); return o != 0 ? (Global.WeaponType)__p.bb.GetInt(o + __p.bb_pos) : Global.WeaponType.None; } }
  ...
  public static Offset<Global.CharacterWeaponExpBonusExcel> CreateCharacterWeaponExpBonusExcel(FlatBufferBuilder builder,
  ...
  public static void AddWeaponType(FlatBufferBuilder builder, Global.WeaponType weaponType) { builder.AddInt(0, (int)weaponType, 0); }
  ...
  public static Offset<Global.CharacterWeaponExpBonusExcel> EndCharacterWeaponExpBonusExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.CharacterWeaponExpBonusExcel>(o);
  }
  ...
  public void UnPackTo(CharacterWeaponExpBonusExcelT _o) {
    ...
    _o.WeaponExpGrowthA = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.WeaponExpGrowthA, key) : this.WeaponExpGrowthA;
    _o.WeaponExpGrowthB = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.WeaponExpGrowthB, key) : this.WeaponExpGrowthB;
    _o.WeaponExpGrowthC = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.WeaponExpGrowthC, key) : this.WeaponExpGrowthC;
    _o.WeaponExpGrowthZ = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.WeaponExpGrowthZ, key) : this.WeaponExpGrowthZ;
  }
  public static Offset<Global.CharacterWeaponExpBonusExcel> Pack(FlatBufferBuilder builder, CharacterWeaponExpBonusExcelT _o) {
    if (_o == null) return default(Offset<Global.CharacterWeaponExpBonusExcel>);
		byte[] key = TableEncryptionService.CreateKey("CharacterWeaponExpBonus");
		...
		var _WeaponExpGrowthA = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.WeaponExpGrowthA, key) : _o.WeaponExpGrowthA;
		var _WeaponExpGrowthB = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.WeaponExpGrowthB, key) : _o.WeaponExpGrowthB;
		var _WeaponExpGrowthC = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.WeaponExpGrowthC, key) : _o.WeaponExpGrowthC;
		var _WeaponExpGrowthZ = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.WeaponExpGrowthZ, key) : _o.WeaponExpGrowthZ;
...
static public class CharacterWeaponExpBonusExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyField(tablePos, 4 /*WeaponType*/, 4 /*Global.WeaponType*/, 4, false)
