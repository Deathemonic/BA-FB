...
public struct GuideMissionOpenStageConditionExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.GuideMissionOpenStageConditionExcel> CreateGuideMissionOpenStageConditionExcel(FlatBufferBuilder builder,
      long SeasonId = 0,
      long OrderNumber = 0,
  ...
  public static Offset<Global.GuideMissionOpenStageConditionExcel> EndGuideMissionOpenStageConditionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.GuideMissionOpenStageConditionExcel>(o);
  }
  ...
  public void UnPackTo(GuideMissionOpenStageConditionExcelT _o) {
    ...
    _o.OrderNumber = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.OrderNumber, key) : this.OrderNumber;
    _o.TabLocalizeCode = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.TabLocalizeCode, key) : this.TabLocalizeCode;
    _o.ClearScenarioModeId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ClearScenarioModeId, key) : this.ClearScenarioModeId;
    _o.LockScenarioTextLocailzeCode = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.LockScenarioTextLocailzeCode, key) : this.LockScenarioTextLocailzeCode;
    _o.ShortcutScenarioUI = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ShortcutScenarioUI, key) : this.ShortcutScenarioUI;
    _o.ClearStageId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ClearStageId, key) : this.ClearStageId;
    _o.LockStageTextLocailzeCode = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.LockStageTextLocailzeCode, key) : this.LockStageTextLocailzeCode;
    _o.ShortcutStageUI = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ShortcutStageUI, key) : this.ShortcutStageUI;
  }
  public static Offset<Global.GuideMissionOpenStageConditionExcel> Pack(FlatBufferBuilder builder, GuideMissionOpenStageConditionExcelT _o) {
    if (_o == null) return default(Offset<Global.GuideMissionOpenStageConditionExcel>);
		byte[] key = TableEncryptionService.CreateKey("GuideMissionOpenStageCondition");
		var _SeasonId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.SeasonId, key) : _o.SeasonId;
		var _OrderNumber = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.OrderNumber, key) : _o.OrderNumber;
    var _TabLocalizeCode = _o.TabLocalizeCode == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.TabLocalizeCode, key) : _o.TabLocalizeCode));
		var _ClearScenarioModeId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ClearScenarioModeId, key) : _o.ClearScenarioModeId;
    var _LockScenarioTextLocailzeCode = _o.LockScenarioTextLocailzeCode == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.LockScenarioTextLocailzeCode, key) : _o.LockScenarioTextLocailzeCode));
    var _ShortcutScenarioUI = _o.ShortcutScenarioUI == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.ShortcutScenarioUI, key) : _o.ShortcutScenarioUI));
		var _ClearStageId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ClearStageId, key) : _o.ClearStageId;
    var _LockStageTextLocailzeCode = _o.LockStageTextLocailzeCode == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.LockStageTextLocailzeCode, key) : _o.LockStageTextLocailzeCode));
    var _ShortcutStageUI = _o.ShortcutStageUI == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.ShortcutStageUI, key) : _o.ShortcutStageUI));
    return CreateGuideMissionOpenStageConditionExcel(
      builder,
      TableEncryptionService.UseEncryption ? _SeasonId : _o.SeasonId,
      TableEncryptionService.UseEncryption ? _OrderNumber : _o.OrderNumber,
      _TabLocalizeCode,
      TableEncryptionService.UseEncryption ? _ClearScenarioModeId : _o.ClearScenarioModeId,
      _LockScenarioTextLocailzeCode,
      _ShortcutScenarioUI,
      TableEncryptionService.UseEncryption ? _ClearStageId : _o.ClearStageId,
