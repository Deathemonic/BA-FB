...
public struct GuideMissionOpenStageConditionExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(GuideMissionOpenStageConditionExcelT _o) {
    ...
    _o.OrderNumber = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.OrderNumber, key) : this.OrderNumber;
    ...
    _o.ClearScenarioModeId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ClearScenarioModeId, key) : this.ClearScenarioModeId;
    ...
    _o.ClearStageId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ClearStageId, key) : this.ClearStageId;
  ...
  public static Offset<Global.GuideMissionOpenStageConditionExcel> Pack(FlatBufferBuilder builder, GuideMissionOpenStageConditionExcelT _o) {
    if (_o == null) return default(Offset<Global.GuideMissionOpenStageConditionExcel>);
		...
		var _OrderNumber = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.OrderNumber, key) : _o.OrderNumber;
    var _TabLocalizeCode = _o.TabLocalizeCode == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.TabLocalizeCode, key) : _o.TabLocalizeCode));
		var _ClearScenarioModeId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ClearScenarioModeId, key) : _o.ClearScenarioModeId;
    var _LockScenarioTextLocailzeCode = _o.LockScenarioTextLocailzeCode == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.LockScenarioTextLocailzeCode, key) : _o.LockScenarioTextLocailzeCode));
    var _ShortcutScenarioUI = _o.ShortcutScenarioUI == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ShortcutScenarioUI, key) : _o.ShortcutScenarioUI));
		var _ClearStageId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ClearStageId, key) : _o.ClearStageId;
    var _LockStageTextLocailzeCode = _o.LockStageTextLocailzeCode == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.LockStageTextLocailzeCode, key) : _o.LockStageTextLocailzeCode));
    var _ShortcutStageUI = _o.ShortcutStageUI == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ShortcutStageUI, key) : _o.ShortcutStageUI));
