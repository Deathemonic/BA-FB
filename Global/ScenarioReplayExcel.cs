...
public struct ScenarioReplayExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ScenarioReplayExcelT _o) {
    ...
    _o.ReplayType = TableEncryptionService.UseEncryption ? (Global.ScenarioModeReplayTypes)TableEncryptionService.Convert((int)this.ReplayType, key) : this.ReplayType;
  ...
  public static Offset<Global.ScenarioReplayExcel> Pack(FlatBufferBuilder builder, ScenarioReplayExcelT _o) {
    if (_o == null) return default(Offset<Global.ScenarioReplayExcel>);
		...
		var _ReplayType = TableEncryptionService.UseEncryption ? (Global.ScenarioModeReplayTypes)TableEncryptionService.Convert((int)_o.ReplayType, key) : _o.ReplayType;
