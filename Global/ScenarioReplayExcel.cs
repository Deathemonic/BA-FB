...
public struct ScenarioReplayExcel : IFlatbufferObject
{
  ...
  public Global.ScenarioModeReplayTypes ReplayType { get { int o = __p.__offset(8); return o != 0 ? (Global.ScenarioModeReplayTypes)__p.bb.GetInt(o + __p.bb_pos) : Global.ScenarioModeReplayTypes.None; } }
  ...
  public static Offset<Global.ScenarioReplayExcel> CreateScenarioReplayExcel(FlatBufferBuilder builder,
      long ModeId = 0,
      long VolumeId = 0,
      Global.ScenarioModeReplayTypes ReplayType = Global.ScenarioModeReplayTypes.None,
      long ChapterId = 0,
      long EpisodeId = 0,
  ...
  public static void AddReplayType(FlatBufferBuilder builder, Global.ScenarioModeReplayTypes replayType) { builder.AddInt(2, (int)replayType, 0); }
  ...
  public static Offset<Global.ScenarioReplayExcel> EndScenarioReplayExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.ScenarioReplayExcel>(o);
  }
  ...
  public void UnPackTo(ScenarioReplayExcelT _o) {
    ...
    _o.ReplayType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ReplayType, key) : this.ReplayType;
  ...
  public static Offset<Global.ScenarioReplayExcel> Pack(FlatBufferBuilder builder, ScenarioReplayExcelT _o) {
    if (_o == null) return default(Offset<Global.ScenarioReplayExcel>);
		byte[] key = TableEncryptionService.CreateKey("ScenarioReplay");
		...
		var _ReplayType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ReplayType, key) : _o.ReplayType;
    ...
    return CreateScenarioReplayExcel(
      ...
      TableEncryptionService.UseEncryption ? _ReplayType : _o.ReplayType,
...
public class ScenarioReplayExcelT
{
  ...
  public Global.ScenarioModeReplayTypes ReplayType { get; set; }
  ...
  public ScenarioReplayExcelT() {
    this.ModeId = 0;
    this.VolumeId = 0;
    this.ReplayType = Global.ScenarioModeReplayTypes.None;
    this.ChapterId = 0;
    this.EpisodeId = 0;
...
static public class ScenarioReplayExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*ReplayType*/, 4 /*Global.ScenarioModeReplayTypes*/, 4, false)
