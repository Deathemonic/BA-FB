...
public struct EventContentBoxGachaElementExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.EventContentBoxGachaElementExcel> CreateEventContentBoxGachaElementExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.EventContentBoxGachaElementExcel> EndEventContentBoxGachaElementExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.EventContentBoxGachaElementExcel>(o);
  }
  ...
  public static Offset<Global.EventContentBoxGachaElementExcel> Pack(FlatBufferBuilder builder, EventContentBoxGachaElementExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentBoxGachaElementExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentBoxGachaElement");
