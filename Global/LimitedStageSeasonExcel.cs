...
public struct LimitedStageSeasonExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(LimitedStageSeasonExcelT _o) {
    ...
    _o.TypeACount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.TypeACount, key) : this.TypeACount;
    _o.TypeBCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.TypeBCount, key) : this.TypeBCount;
    _o.TypeCCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.TypeCCount, key) : this.TypeCCount;
  }
  public static Offset<Global.LimitedStageSeasonExcel> Pack(FlatBufferBuilder builder, LimitedStageSeasonExcelT _o) {
    ...
    var _EndDate = _o.EndDate == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.EndDate, key) : _o.EndDate));
		var _TypeACount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.TypeACount, key) : _o.TypeACount;
		var _TypeBCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.TypeBCount, key) : _o.TypeBCount;
		var _TypeCCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.TypeCCount, key) : _o.TypeCCount;
