...
public struct LimitedStageSeasonExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.LimitedStageSeasonExcel> CreateLimitedStageSeasonExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Global.LimitedStageSeasonExcel> EndLimitedStageSeasonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.LimitedStageSeasonExcel>(o);
  }
  ...
  public void UnPackTo(LimitedStageSeasonExcelT _o) {
    ...
    _o.TypeACount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.TypeACount, key) : this.TypeACount;
    _o.TypeBCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.TypeBCount, key) : this.TypeBCount;
    _o.TypeCCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.TypeCCount, key) : this.TypeCCount;
  }
  public static Offset<Global.LimitedStageSeasonExcel> Pack(FlatBufferBuilder builder, LimitedStageSeasonExcelT _o) {
    if (_o == null) return default(Offset<Global.LimitedStageSeasonExcel>);
		byte[] key = TableEncryptionService.CreateKey("LimitedStageSeason");
    ...
    var _EndDate = _o.EndDate == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.EndDate, key) : _o.EndDate));
		var _TypeACount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.TypeACount, key) : _o.TypeACount;
		var _TypeBCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.TypeBCount, key) : _o.TypeBCount;
		var _TypeCCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.TypeCCount, key) : _o.TypeCCount;
    return CreateLimitedStageSeasonExcel(
      builder,
      TableEncryptionService.UseEncryption ? _Id : _o.Id,
      _StartDate,
      _EndDate,
      TableEncryptionService.UseEncryption ? _TypeACount : _o.TypeACount,
      TableEncryptionService.UseEncryption ? _TypeBCount : _o.TypeBCount,
      TableEncryptionService.UseEncryption ? _TypeCCount : _o.TypeCCount);
  }
}
