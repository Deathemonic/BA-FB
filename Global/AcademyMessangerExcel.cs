...
public struct AcademyMessangerExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.AcademyMessangerExcel> CreateAcademyMessangerExcel(FlatBufferBuilder builder,
    ...
    AcademyMessangerExcel.AddMessageEN(builder, MessageENOffset);
    AcademyMessangerExcel.AddMessageTW(builder, MessageTWOffset);
    AcademyMessangerExcel.AddMessageTH(builder, MessageTHOffset);
  ...
  public static void StartAcademyMessangerExcel(FlatBufferBuilder builder) { builder.StartTable(17); }
  ...
  public static Offset<Global.AcademyMessangerExcel> EndAcademyMessangerExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.AcademyMessangerExcel>(o);
  }
  ...
  public void UnPackTo(AcademyMessangerExcelT _o) {
    ...
    _o.MessageGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.MessageGroupId, key) : this.MessageGroupId;
    ...
    _o.MessageCondition = TableEncryptionService.UseEncryption ? (Global.AcademyMessageConditions)TableEncryptionService.Convert((int)this.MessageCondition, key) : this.MessageCondition;
    _o.ConditionValue = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ConditionValue, key) : this.ConditionValue;
    _o.PreConditionGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.PreConditionGroupId, key) : this.PreConditionGroupId;
    _o.PreConditionFavorScheduleId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.PreConditionFavorScheduleId, key) : this.PreConditionFavorScheduleId;
    _o.FavorScheduleId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.FavorScheduleId, key) : this.FavorScheduleId;
    _o.NextGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.NextGroupId, key) : this.NextGroupId;
    _o.FeedbackTimeMillisec = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.FeedbackTimeMillisec, key) : this.FeedbackTimeMillisec;
    _o.MessageType = TableEncryptionService.UseEncryption ? (Global.AcademyMessageTypes)TableEncryptionService.Convert((int)this.MessageType, key) : this.MessageType;
  ...
  public static Offset<Global.AcademyMessangerExcel> Pack(FlatBufferBuilder builder, AcademyMessangerExcelT _o) {
    if (_o == null) return default(Offset<Global.AcademyMessangerExcel>);
		byte[] key = TableEncryptionService.CreateKey("AcademyMessanger");
		var _MessageGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.MessageGroupId, key) : _o.MessageGroupId;
		...
		var _MessageCondition = TableEncryptionService.UseEncryption ? (Global.AcademyMessageConditions)TableEncryptionService.Convert((int)_o.MessageCondition, key) : _o.MessageCondition;
		var _ConditionValue = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ConditionValue, key) : _o.ConditionValue;
		var _PreConditionGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.PreConditionGroupId, key) : _o.PreConditionGroupId;
		var _PreConditionFavorScheduleId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.PreConditionFavorScheduleId, key) : _o.PreConditionFavorScheduleId;
		var _FavorScheduleId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.FavorScheduleId, key) : _o.FavorScheduleId;
		var _NextGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.NextGroupId, key) : _o.NextGroupId;
		var _FeedbackTimeMillisec = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.FeedbackTimeMillisec, key) : _o.FeedbackTimeMillisec;
		var _MessageType = TableEncryptionService.UseEncryption ? (Global.AcademyMessageTypes)TableEncryptionService.Convert((int)_o.MessageType, key) : _o.MessageType;
    ...
    var _MessageKR = _o.MessageKR == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.MessageKR, key) : _o.MessageKR));
    var _MessageJP = _o.MessageJP == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.MessageJP, key) : _o.MessageJP));
    var _MessageTH = _o.MessageTH == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.MessageTH, key) : _o.MessageTH));
    var _MessageTW = _o.MessageTW == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.MessageTW, key) : _o.MessageTW));
    var _MessageEN = _o.MessageEN == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.MessageEN, key) : _o.MessageEN));
