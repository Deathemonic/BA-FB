...
public struct ScenarioBGNameExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ScenarioBGNameExcelT _o) {
    ...
    _o.BGType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BGType, key) : this.BGType;
    ...
    _o.SpineScale = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SpineScale, key) : this.SpineScale;
    _o.SpineLocalPosX = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SpineLocalPosX, key) : this.SpineLocalPosX;
    _o.SpineLocalPosY = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SpineLocalPosY, key) : this.SpineLocalPosY;
  }
  public static Offset<Global.ScenarioBGNameExcel> Pack(FlatBufferBuilder builder, ScenarioBGNameExcelT _o) {
    ...
    var _BGFileName = _o.BGFileName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.BGFileName, key) : _o.BGFileName));
		var _BGType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.BGType, key) : _o.BGType;
    var _AnimationRoot = _o.AnimationRoot == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.AnimationRoot, key) : _o.AnimationRoot));
    var _AnimationName = _o.AnimationName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.AnimationName, key) : _o.AnimationName));
		var _SpineScale = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.SpineScale, key) : _o.SpineScale;
		var _SpineLocalPosX = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.SpineLocalPosX, key) : _o.SpineLocalPosX;
		var _SpineLocalPosY = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.SpineLocalPosY, key) : _o.SpineLocalPosY;
