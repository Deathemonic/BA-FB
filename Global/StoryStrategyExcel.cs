...
public struct StoryStrategyExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(StoryStrategyExcelT _o) {
    ...
    _o.WhiteListId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.WhiteListId, key) : this.WhiteListId;
  ...
  public static Offset<Global.StoryStrategyExcel> Pack(FlatBufferBuilder builder, StoryStrategyExcelT _o) {
    ...
    var _Localize = _o.Localize == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.Localize, key) : _o.Localize));
		...
		var _WhiteListId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.WhiteListId, key) : _o.WhiteListId;
