...
public struct ScenarioResourceInfoExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.ScenarioResourceInfoExcel> CreateScenarioResourceInfoExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Global.ScenarioResourceInfoExcel> EndScenarioResourceInfoExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.ScenarioResourceInfoExcel>(o);
  }
  ...
  public static Offset<Global.ScenarioResourceInfoExcel> Pack(FlatBufferBuilder builder, ScenarioResourceInfoExcelT _o) {
    if (_o == null) return default(Offset<Global.ScenarioResourceInfoExcel>);
		byte[] key = TableEncryptionService.CreateKey("ScenarioResourceInfo");
		...
		var _PriorityOrder = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PriorityOrder, key) : _o.PriorityOrder;
		var _PVDisplayOrder = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PVDisplayOrder, key) : _o.PVDisplayOrder;
    ...
    var _AudioName = _o.AudioName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.AudioName, key) : _o.AudioName));
    var _SpinePath = _o.SpinePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.SpinePath, key) : _o.SpinePath));
		var _Ratio = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Ratio, key) : _o.Ratio;
    var _LobbyAniPath = _o.LobbyAniPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.LobbyAniPath, key) : _o.LobbyAniPath));
    var _MovieCGPath = _o.MovieCGPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.MovieCGPath, key) : _o.MovieCGPath));
