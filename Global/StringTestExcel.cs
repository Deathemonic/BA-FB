...
public struct StringTestExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.StringTestExcel> Pack(FlatBufferBuilder builder, StringTestExcelT _o) {
    ...
    if (_o.String != null) {
      ...
      for (var _j = 0; _j < __String.Length; ++_j) { __String[_j] = builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.String[_j], key) : _o.String[_j])); }
      _String = CreateStringVector(builder, __String);
    }
    var _sentence1 = _o.Sentence1 == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.Sentence1, key) : _o.Sentence1));
    var _Script = _o.Script == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.Script, key) : _o.Script));
