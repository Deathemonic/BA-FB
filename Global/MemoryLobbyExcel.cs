...
public struct MemoryLobbyExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(MemoryLobbyExcelT _o) {
    ...
    _o.MemoryLobbyCategory = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MemoryLobbyCategory, key) : this.MemoryLobbyCategory;
  ...
  public static Offset<Global.MemoryLobbyExcel> Pack(FlatBufferBuilder builder, MemoryLobbyExcelT _o) {
    ...
    var _PrefabName = _o.PrefabName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.PrefabName, key) : _o.PrefabName));
		var _MemoryLobbyCategory = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MemoryLobbyCategory, key) : _o.MemoryLobbyCategory;
    var _SlotTextureName = _o.SlotTextureName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.SlotTextureName, key) : _o.SlotTextureName));
    var _RewardTextureName = _o.RewardTextureName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.RewardTextureName, key) : _o.RewardTextureName));
		var _BGMId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.BGMId, key) : _o.BGMId;
    var _AudioClipJp = _o.AudioClipJp == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.AudioClipJp, key) : _o.AudioClipJp));
    var _AudioClipKr = _o.AudioClipKr == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.AudioClipKr, key) : _o.AudioClipKr));
    var _AudioClipTh = _o.AudioClipTh == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.AudioClipTh, key) : _o.AudioClipTh));
    var _AudioClipTw = _o.AudioClipTw == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.AudioClipTw, key) : _o.AudioClipTw));
    var _AudioClipEn = _o.AudioClipEn == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.AudioClipEn, key) : _o.AudioClipEn));
