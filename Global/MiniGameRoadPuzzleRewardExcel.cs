...
public struct MiniGameRoadPuzzleRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.MiniGameRoadPuzzleRewardExcel> CreateMiniGameRoadPuzzleRewardExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.MiniGameRoadPuzzleRewardExcel> EndMiniGameRoadPuzzleRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.MiniGameRoadPuzzleRewardExcel>(o);
  }
  ...
  public static Offset<Global.MiniGameRoadPuzzleRewardExcel> Pack(FlatBufferBuilder builder, MiniGameRoadPuzzleRewardExcelT _o) {
    if (_o == null) return default(Offset<Global.MiniGameRoadPuzzleRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("MiniGameRoadPuzzleReward");
