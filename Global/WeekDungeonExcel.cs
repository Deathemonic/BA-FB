...
public struct WeekDungeonExcel : IFlatbufferObject
{
  ...
  public Global.WeekDungeonType WeekDungeonType { get { int o = __p.__offset(6); return o != 0 ? (Global.WeekDungeonType)__p.bb.GetInt(o + __p.bb_pos) : Global.WeekDungeonType.None; } }
  ...
  public Global.StarGoalType StarGoal(int j) { int o = __p.__offset(22); return o != 0 ? (Global.StarGoalType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Global.StarGoalType)0; }
  public int StarGoalLength { get { int o = __p.__offset(22); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Global.StarGoalType> GetStarGoalBytes() { return __p.__vector_as_span<Global.StarGoalType>(22, 4); }
#else
  public ArraySegment<byte>? GetStarGoalBytes() { return __p.__vector_as_arraysegment(22); }
#endif
  public Global.StarGoalType[] GetStarGoalArray() { int o = __p.__offset(22); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Global.StarGoalType[] a = new Global.StarGoalType[l]; for (int i = 0; i < l; i++) { a[i] = (Global.StarGoalType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Global.StageTopography StageTopography { get { int o = __p.__offset(26); return o != 0 ? (Global.StageTopography)__p.bb.GetInt(o + __p.bb_pos) : Global.StageTopography.Street; } }
  ...
  public Global.EchelonExtensionType EchelonExtensionType { get { int o = __p.__offset(40); return o != 0 ? (Global.EchelonExtensionType)__p.bb.GetInt(o + __p.bb_pos) : Global.EchelonExtensionType.Base; } }

  public static Offset<Global.WeekDungeonExcel> CreateWeekDungeonExcel(FlatBufferBuilder builder,
      long StageId = 0,
      Global.WeekDungeonType WeekDungeonType = Global.WeekDungeonType.None,
      int Difficulty = 0,
  ...
  public static void AddWeekDungeonType(FlatBufferBuilder builder, Global.WeekDungeonType weekDungeonType) { builder.AddInt(1, (int)weekDungeonType, 0); }
  ...
  public static void AddStageTopography(FlatBufferBuilder builder, Global.StageTopography stageTopography) { builder.AddInt(11, (int)stageTopography, 0); }
  ...
  public static void AddEchelonExtensionType(FlatBufferBuilder builder, Global.EchelonExtensionType echelonExtensionType) { builder.AddInt(18, (int)echelonExtensionType, 0); }
  public static Offset<Global.WeekDungeonExcel> EndWeekDungeonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.WeekDungeonExcel>(o);
  }
  ...
  public void UnPackTo(WeekDungeonExcelT _o) {
    ...
    _o.WeekDungeonType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.WeekDungeonType, key) : this.WeekDungeonType;
    ...
    for (var _j = 0; _j < this.StageEnterCostTypeLength; ++_j) {_o.StageEnterCostType.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StageEnterCostType(_j), key) : this.StageEnterCostType(_j));}
    _o.StageEnterCostId = new List<long>();
    for (var _j = 0; _j < this.StageEnterCostIdLength; ++_j) {_o.StageEnterCostId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StageEnterCostId(_j), key) : this.StageEnterCostId(_j));}
    _o.StageEnterCostAmount = new List<int>();
    for (var _j = 0; _j < this.StageEnterCostAmountLength; ++_j) {_o.StageEnterCostAmount.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StageEnterCostAmount(_j), key) : this.StageEnterCostAmount(_j));}
    ...
    _o.BattleRewardExp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BattleRewardExp, key) : this.BattleRewardExp;
    _o.BattleRewardPlayerExp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BattleRewardPlayerExp, key) : this.BattleRewardPlayerExp;
    _o.GroupBuffID = new List<long>();
    for (var _j = 0; _j < this.GroupBuffIDLength; ++_j) {_o.GroupBuffID.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.GroupBuffID(_j), key) : this.GroupBuffID(_j));}
  ...
  public static Offset<Global.WeekDungeonExcel> Pack(FlatBufferBuilder builder, WeekDungeonExcelT _o) {
    if (_o == null) return default(Offset<Global.WeekDungeonExcel>);
		byte[] key = TableEncryptionService.CreateKey("WeekDungeon");
		var _StageId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StageId, key) : _o.StageId;
		var _WeekDungeonType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.WeekDungeonType, key) : _o.WeekDungeonType;
    ...
    if (_o.StageEnterCostType != null) {
      var __StageEnterCostType = _o.StageEnterCostType.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.StarGoalAmount != null) {
      ...
      _StarGoalAmount = CreateStarGoalAmountVector(builder, __StarGoalAmount);
		...
		var _BattleRewardExp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.BattleRewardExp, key) : _o.BattleRewardExp;
		var _BattleRewardPlayerExp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.BattleRewardPlayerExp, key) : _o.BattleRewardPlayerExp;
    var _GroupBuffID = default(VectorOffset);
    if (_o.GroupBuffID != null) {
      var __GroupBuffID = _o.GroupBuffID.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    return CreateWeekDungeonExcel(
      ...
      TableEncryptionService.UseEncryption ? _BattleRewardExp : _o.BattleRewardExp,
      TableEncryptionService.UseEncryption ? _BattleRewardPlayerExp : _o.BattleRewardPlayerExp,
      _GroupBuffID,
...
public class WeekDungeonExcelT
{
  ...
  public Global.WeekDungeonType WeekDungeonType { get; set; }
  ...
  public WeekDungeonExcelT() {
    this.StageId = 0;
    this.WeekDungeonType = Global.WeekDungeonType.None;
    this.Difficulty = 0;
...
static public class WeekDungeonExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*WeekDungeonType*/, 4 /*Global.WeekDungeonType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 22 /*StarGoal*/, 4 /*Global.StarGoalType*/, false)
      && verifier.VerifyVectorOfData(tablePos, 24 /*StarGoalAmount*/, 4 /*int*/, false)
      && verifier.VerifyField(tablePos, 26 /*StageTopography*/, 4 /*Global.StageTopography*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 40 /*EchelonExtensionType*/, 4 /*Global.EchelonExtensionType*/, 4, false)
