...
public struct WeekDungeonExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(WeekDungeonExcelT _o) {
    ...
    _o.WeekDungeonType = TableEncryptionService.UseEncryption ? (Global.WeekDungeonType)TableEncryptionService.Convert((int)this.WeekDungeonType, key) : this.WeekDungeonType;
    ...
    for (var _j = 0; _j < this.StageEnterCostAmountLength; ++_j) {_o.StageEnterCostAmount.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.StageEnterCostAmount(_j), key) : this.StageEnterCostAmount(_j));}
    ...
    _o.BattleRewardExp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.BattleRewardExp, key) : this.BattleRewardExp;
    _o.BattleRewardPlayerExp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.BattleRewardPlayerExp, key) : this.BattleRewardPlayerExp;
    _o.GroupBuffID = new List<long>();
    for (var _j = 0; _j < this.GroupBuffIDLength; ++_j) {_o.GroupBuffID.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.GroupBuffID(_j), key) : this.GroupBuffID(_j));}
  ...
  public static Offset<Global.WeekDungeonExcel> Pack(FlatBufferBuilder builder, WeekDungeonExcelT _o) {
    if (_o == null) return default(Offset<Global.WeekDungeonExcel>);
		...
		var _WeekDungeonType = TableEncryptionService.UseEncryption ? (Global.WeekDungeonType)TableEncryptionService.Convert((int)_o.WeekDungeonType, key) : _o.WeekDungeonType;
    ...
    if (_o.StageEnterCostAmount != null) {
      var __StageEnterCostAmount = _o.StageEnterCostAmount.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)x, key) : x).ToArray();
    ...
    if (_o.StarGoalAmount != null) {
      ...
      _StarGoalAmount = CreateStarGoalAmountVector(builder, __StarGoalAmount);
		...
		var _BattleRewardExp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.BattleRewardExp, key) : _o.BattleRewardExp;
		var _BattleRewardPlayerExp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.BattleRewardPlayerExp, key) : _o.BattleRewardPlayerExp;
    var _GroupBuffID = default(VectorOffset);
    if (_o.GroupBuffID != null) {
      var __GroupBuffID = _o.GroupBuffID.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
