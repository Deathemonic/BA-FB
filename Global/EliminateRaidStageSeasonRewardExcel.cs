...
public struct EliminateRaidStageSeasonRewardExcel : IFlatbufferObject
{
  ...
  public Global.ParcelType SeasonRewardParcelType(int j) { int o = __p.__offset(6); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Global.ParcelType)0; }
  public int SeasonRewardParcelTypeLength { get { int o = __p.__offset(6); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Global.ParcelType> GetSeasonRewardParcelTypeBytes() { return __p.__vector_as_span<Global.ParcelType>(6, 4); }
#else
  public ArraySegment<byte>? GetSeasonRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(6); }
#endif
  public Global.ParcelType[] GetSeasonRewardParcelTypeArray() { int o = __p.__offset(6); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Global.ParcelType[] a = new Global.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Global.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Global.EliminateRaidStageSeasonRewardExcel> CreateEliminateRaidStageSeasonRewardExcel(FlatBufferBuilder builder,
  ...
  public static VectorOffset CreateSeasonRewardParcelTypeVector(FlatBufferBuilder builder, Global.ParcelType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateSeasonRewardParcelTypeVectorBlock(FlatBufferBuilder builder, Global.ParcelType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateSeasonRewardParcelTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Global.ParcelType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateSeasonRewardParcelTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Global.ParcelType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Global.EliminateRaidStageSeasonRewardExcel> EndEliminateRaidStageSeasonRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.EliminateRaidStageSeasonRewardExcel>(o);
  }
  ...
  public void UnPackTo(EliminateRaidStageSeasonRewardExcelT _o) {
		byte[] key = TableEncryptionService.CreateKey("EliminateRaidStageSeasonReward");
    _o.SeasonRewardId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SeasonRewardId, key) : this.SeasonRewardId;
    _o.SeasonRewardParcelType = new List<Global.ParcelType>();
    for (var _j = 0; _j < this.SeasonRewardParcelTypeLength; ++_j) {_o.SeasonRewardParcelType.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SeasonRewardParcelType(_j), key) : this.SeasonRewardParcelType(_j));}
    _o.SeasonRewardParcelUniqueId = new List<long>();
    for (var _j = 0; _j < this.SeasonRewardParcelUniqueIdLength; ++_j) {_o.SeasonRewardParcelUniqueId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SeasonRewardParcelUniqueId(_j), key) : this.SeasonRewardParcelUniqueId(_j));}
    _o.SeasonRewardParcelUniqueName = new List<string>();
    for (var _j = 0; _j < this.SeasonRewardParcelUniqueNameLength; ++_j) {_o.SeasonRewardParcelUniqueName.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SeasonRewardParcelUniqueName(_j), key) : this.SeasonRewardParcelUniqueName(_j));}
    _o.SeasonRewardAmount = new List<long>();
    for (var _j = 0; _j < this.SeasonRewardAmountLength; ++_j) {_o.SeasonRewardAmount.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SeasonRewardAmount(_j), key) : this.SeasonRewardAmount(_j));}
  }
  public static Offset<Global.EliminateRaidStageSeasonRewardExcel> Pack(FlatBufferBuilder builder, EliminateRaidStageSeasonRewardExcelT _o) {
    if (_o == null) return default(Offset<Global.EliminateRaidStageSeasonRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("EliminateRaidStageSeasonReward");
    ...
    if (_o.SeasonRewardAmount != null) {
      var __seasonRewardAmount = _o.SeasonRewardAmount.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
...
public class EliminateRaidStageSeasonRewardExcelT
{
  ...
  public List<Global.ParcelType> SeasonRewardParcelType { get; set; }
...
static public class EliminateRaidStageSeasonRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 6 /*SeasonRewardParcelType*/, 4 /*Global.ParcelType*/, false)
