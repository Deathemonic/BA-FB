...
public struct EliminateRaidStageSeasonRewardExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(EliminateRaidStageSeasonRewardExcelT _o) {
    ...
    for (var _j = 0; _j < this.SeasonRewardParcelTypeLength; ++_j) {_o.SeasonRewardParcelType.Add(TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)this.SeasonRewardParcelType(_j), key) : this.SeasonRewardParcelType(_j));}
  ...
  public static Offset<Global.EliminateRaidStageSeasonRewardExcel> Pack(FlatBufferBuilder builder, EliminateRaidStageSeasonRewardExcelT _o) {
    ...
    if (_o.SeasonRewardParcelType != null) {
      var __SeasonRewardParcelType = _o.SeasonRewardParcelType.Select(x => TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)x, key) : x).ToArray();
    ...
    if (_o.SeasonRewardParcelUniqueName != null) {
      ...
      for (var _j = 0; _j < __SeasonRewardParcelUniqueName.Length; ++_j) { __SeasonRewardParcelUniqueName[_j] = builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.SeasonRewardParcelUniqueName[_j], key) : _o.SeasonRewardParcelUniqueName[_j])); }
