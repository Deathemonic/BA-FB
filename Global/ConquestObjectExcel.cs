...
public struct ConquestObjectExcel : IFlatbufferObject
{
  ...
  public Global.ConquestObjectType ConquestObjectType { get { int o = __p.__offset(8); return o != 0 ? (Global.ConquestObjectType)__p.bb.GetInt(o + __p.bb_pos) : Global.ConquestObjectType.None; } }
  ...
  public Global.ParcelType ConquestRewardParcelType { get { int o = __p.__offset(16); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Global.ParcelType.None; } }
  ...
  public static Offset<Global.ConquestObjectExcel> CreateConquestObjectExcel(FlatBufferBuilder builder,
      long Id = 0,
      long EventContentId = 0,
      Global.ConquestObjectType ConquestObjectType = Global.ConquestObjectType.None,
      uint Key = 0,
      StringOffset NameOffset = default(StringOffset),
      StringOffset PrefabNameOffset = default(StringOffset),
      Global.ParcelType ConquestRewardParcelType = Global.ParcelType.None,
  ...
  public static void AddConquestObjectType(FlatBufferBuilder builder, Global.ConquestObjectType conquestObjectType) { builder.AddInt(2, (int)conquestObjectType, 0); }
  ...
  public static void AddConquestRewardParcelType(FlatBufferBuilder builder, Global.ParcelType conquestRewardParcelType) { builder.AddInt(6, (int)conquestRewardParcelType, 0); }
  ...
  public static Offset<Global.ConquestObjectExcel> EndConquestObjectExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.ConquestObjectExcel>(o);
  }
  ...
  public static Offset<Global.ConquestObjectExcel> Pack(FlatBufferBuilder builder, ConquestObjectExcelT _o) {
    if (_o == null) return default(Offset<Global.ConquestObjectExcel>);
		byte[] key = TableEncryptionService.CreateKey("ConquestObject");
		...
		var _ConquestObjectType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ConquestObjectType, key) : _o.ConquestObjectType;
    ...
    var _PrefabName = _o.PrefabName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.PrefabName, key) : _o.PrefabName));
		var _ConquestRewardParcelType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ConquestRewardParcelType, key) : _o.ConquestRewardParcelType;
		...
		var _ConquestRewardAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ConquestRewardAmount, key) : _o.ConquestRewardAmount;
		...
		var _StepObjectCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StepObjectCount, key) : _o.StepObjectCount;
    return CreateConquestObjectExcel(
      builder,
      TableEncryptionService.UseEncryption ? _Id : _o.Id,
      TableEncryptionService.UseEncryption ? _EventContentId : _o.EventContentId,
      TableEncryptionService.UseEncryption ? _ConquestObjectType : _o.ConquestObjectType,
      TableEncryptionService.UseEncryption ? _Key : _o.Key,
      _Name,
      _PrefabName,
      TableEncryptionService.UseEncryption ? _ConquestRewardParcelType : _o.ConquestRewardParcelType,
      TableEncryptionService.UseEncryption ? _ConquestRewardID : _o.ConquestRewardID,
      TableEncryptionService.UseEncryption ? _ConquestRewardAmount : _o.ConquestRewardAmount,
      ...
      TableEncryptionService.UseEncryption ? _StepObjectCount : _o.StepObjectCount);
  }
}
...
public class ConquestObjectExcelT
{
  ...
  public Global.ConquestObjectType ConquestObjectType { get; set; }
  public uint Key { get; set; }
  public string Name { get; set; }
  public string PrefabName { get; set; }
  public Global.ParcelType ConquestRewardParcelType { get; set; }
  ...
  public ConquestObjectExcelT() {
    ...
    this.ConquestObjectType = Global.ConquestObjectType.None;
    this.Key = 0;
    this.Name = null;
    this.PrefabName = null;
    this.ConquestRewardParcelType = Global.ParcelType.None;
...
static public class ConquestObjectExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*ConquestObjectType*/, 4 /*Global.ConquestObjectType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 16 /*ConquestRewardParcelType*/, 4 /*Global.ParcelType*/, 4, false)
