...
public struct EliminateRaidStageRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.EliminateRaidStageRewardExcel> CreateEliminateRaidStageRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static Offset<Global.EliminateRaidStageRewardExcel> EndEliminateRaidStageRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.EliminateRaidStageRewardExcel>(o);
  }
  ...
  public static Offset<Global.EliminateRaidStageRewardExcel> Pack(FlatBufferBuilder builder, EliminateRaidStageRewardExcelT _o) {
    if (_o == null) return default(Offset<Global.EliminateRaidStageRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("EliminateRaidStageReward");
