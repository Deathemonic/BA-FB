...
public struct MiniGameDreamEndingExcel : IFlatbufferObject
{
  ...
  public Global.DreamMakerEndingType DreamMakerEndingType { get { int o = __p.__offset(8); return o != 0 ? (Global.DreamMakerEndingType)__p.bb.GetInt(o + __p.bb_pos) : Global.DreamMakerEndingType.None; } }
  ...
  public Global.DreamMakerEndingCondition EndingCondition(int j) { int o = __p.__offset(14); return o != 0 ? (Global.DreamMakerEndingCondition)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Global.DreamMakerEndingCondition)0; }
  public int EndingConditionLength { get { int o = __p.__offset(14); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Global.DreamMakerEndingCondition> GetEndingConditionBytes() { return __p.__vector_as_span<Global.DreamMakerEndingCondition>(14, 4); }
#else
  public ArraySegment<byte>? GetEndingConditionBytes() { return __p.__vector_as_arraysegment(14); }
#endif
  public Global.DreamMakerEndingCondition[] GetEndingConditionArray() { int o = __p.__offset(14); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Global.DreamMakerEndingCondition[] a = new Global.DreamMakerEndingCondition[l]; for (int i = 0; i < l; i++) { a[i] = (Global.DreamMakerEndingCondition)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Global.MiniGameDreamEndingExcel> CreateMiniGameDreamEndingExcel(FlatBufferBuilder builder,
  ...
  public static void AddDreamMakerEndingType(FlatBufferBuilder builder, Global.DreamMakerEndingType dreamMakerEndingType) { builder.AddInt(2, (int)dreamMakerEndingType, 0); }
  ...
  public static VectorOffset CreateEndingConditionVector(FlatBufferBuilder builder, Global.DreamMakerEndingCondition[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateEndingConditionVectorBlock(FlatBufferBuilder builder, Global.DreamMakerEndingCondition[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateEndingConditionVectorBlock(FlatBufferBuilder builder, ArraySegment<Global.DreamMakerEndingCondition> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateEndingConditionVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Global.DreamMakerEndingCondition>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Global.MiniGameDreamEndingExcel> EndMiniGameDreamEndingExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.MiniGameDreamEndingExcel>(o);
  }
  ...
  public void UnPackTo(MiniGameDreamEndingExcelT _o) {
    ...
    _o.DreamMakerEndingType = TableEncryptionService.UseEncryption ? (Global.DreamMakerEndingType)TableEncryptionService.Convert((int)this.DreamMakerEndingType, key) : this.DreamMakerEndingType;
    ...
    _o.EndingCondition = new List<Global.DreamMakerEndingCondition>();
    for (var _j = 0; _j < this.EndingConditionLength; ++_j) {_o.EndingCondition.Add(TableEncryptionService.UseEncryption ? (Global.DreamMakerEndingCondition)TableEncryptionService.Convert((int)this.EndingCondition(_j), key) : this.EndingCondition(_j));}
  ...
  public static Offset<Global.MiniGameDreamEndingExcel> Pack(FlatBufferBuilder builder, MiniGameDreamEndingExcelT _o) {
    if (_o == null) return default(Offset<Global.MiniGameDreamEndingExcel>);
		byte[] key = TableEncryptionService.CreateKey("MiniGameDreamEnding");
		...
		var _DreamMakerEndingType = TableEncryptionService.UseEncryption ? (Global.DreamMakerEndingType)TableEncryptionService.Convert((int)_o.DreamMakerEndingType, key) : _o.DreamMakerEndingType;
    ...
    if (_o.EndingCondition != null) {
      var __EndingCondition = _o.EndingCondition.Select(x => TableEncryptionService.UseEncryption ? (Global.DreamMakerEndingCondition)TableEncryptionService.Convert((int)x, key) : x).ToArray();
...
public class MiniGameDreamEndingExcelT
{
  ...
  public List<Global.DreamMakerEndingCondition> EndingCondition { get; set; }
...
static public class MiniGameDreamEndingExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*DreamMakerEndingType*/, 4 /*Global.DreamMakerEndingType*/, 4, false)
      && verifier.VerifyField(tablePos, 10 /*Order*/, 4 /*int*/, 4, false)
      && verifier.VerifyField(tablePos, 12 /*ScenarioGroupId*/, 8 /*long*/, 8, false)
      && verifier.VerifyVectorOfData(tablePos, 14 /*EndingCondition*/, 4 /*Global.DreamMakerEndingCondition*/, false)
