...
public struct ConstArenaExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ConstArenaExcelT _o) {
    ...
    _o.AttackCoolTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.AttackCoolTime, key) : this.AttackCoolTime;
    ...
    _o.DefenseCoolTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.DefenseCoolTime, key) : this.DefenseCoolTime;
    _o.TSSStartCoolTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.TSSStartCoolTime, key) : this.TSSStartCoolTime;
    _o.EndAlarm = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EndAlarm, key) : this.EndAlarm;
    _o.TimeRewardMaxAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.TimeRewardMaxAmount, key) : this.TimeRewardMaxAmount;
    _o.EnterCostType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EnterCostType, key) : this.EnterCostType;
    _o.EnterCostId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EnterCostId, key) : this.EnterCostId;
    _o.TicketCost = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.TicketCost, key) : this.TicketCost;
    ...
    for (var _j = 0; _j < this.CharacterSlotHideRankLength; ++_j) {_o.CharacterSlotHideRank.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CharacterSlotHideRank(_j), key) : this.CharacterSlotHideRank(_j));}
    _o.MapSlotHideRank = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MapSlotHideRank, key) : this.MapSlotHideRank;
    _o.RelativeOpponentRankStart = new List<long>();
    for (var _j = 0; _j < this.RelativeOpponentRankStartLength; ++_j) {_o.RelativeOpponentRankStart.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.RelativeOpponentRankStart(_j), key) : this.RelativeOpponentRankStart(_j));}
    _o.RelativeOpponentRankEnd = new List<long>();
    for (var _j = 0; _j < this.RelativeOpponentRankEndLength; ++_j) {_o.RelativeOpponentRankEnd.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.RelativeOpponentRankEnd(_j), key) : this.RelativeOpponentRankEnd(_j));}
    _o.ModifiedStatType = new List<Global.StatType>();
    for (var _j = 0; _j < this.ModifiedStatTypeLength; ++_j) {_o.ModifiedStatType.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ModifiedStatType(_j), key) : this.ModifiedStatType(_j));}
    _o.StatMulFactor = new List<long>();
    for (var _j = 0; _j < this.StatMulFactorLength; ++_j) {_o.StatMulFactor.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StatMulFactor(_j), key) : this.StatMulFactor(_j));}
    _o.StatSumFactor = new List<long>();
    for (var _j = 0; _j < this.StatSumFactorLength; ++_j) {_o.StatSumFactor.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StatSumFactor(_j), key) : this.StatSumFactor(_j));}
    ...
    _o.NPCMainCharacterCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.NPCMainCharacterCount, key) : this.NPCMainCharacterCount;
    _o.NPCSupportCharacterCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.NPCSupportCharacterCount, key) : this.NPCSupportCharacterCount;
    _o.NPCCharacterSkillLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.NPCCharacterSkillLevel, key) : this.NPCCharacterSkillLevel;
    _o.TimeSpanInDaysForBattleHistory = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.TimeSpanInDaysForBattleHistory, key) : this.TimeSpanInDaysForBattleHistory;
    ...
    _o.DefenseVictoryRewardMaxCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.DefenseVictoryRewardMaxCount, key) : this.DefenseVictoryRewardMaxCount;
    _o.TopRankerCountLimit = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.TopRankerCountLimit, key) : this.TopRankerCountLimit;
    _o.AutoRefreshIntervalMilliSeconds = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.AutoRefreshIntervalMilliSeconds, key) : this.AutoRefreshIntervalMilliSeconds;
    _o.EchelonSettingIntervalMilliSeconds = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EchelonSettingIntervalMilliSeconds, key) : this.EchelonSettingIntervalMilliSeconds;
    _o.SkipAllowedTimeMilliSeconds = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SkipAllowedTimeMilliSeconds, key) : this.SkipAllowedTimeMilliSeconds;
    ...
    _o.ShowSeasonId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ShowSeasonId, key) : this.ShowSeasonId;
    _o.ArenaHistoryQueryLimitDays = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ArenaHistoryQueryLimitDays, key) : this.ArenaHistoryQueryLimitDays;
  }
  public static Offset<Global.ConstArenaExcel> Pack(FlatBufferBuilder builder, ConstArenaExcelT _o) {
    if (_o == null) return default(Offset<Global.ConstArenaExcel>);
		byte[] key = TableEncryptionService.CreateKey("ConstArena");
		var _AttackCoolTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.AttackCoolTime, key) : _o.AttackCoolTime;
		...
		var _DefenseCoolTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DefenseCoolTime, key) : _o.DefenseCoolTime;
		var _TSSStartCoolTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.TSSStartCoolTime, key) : _o.TSSStartCoolTime;
		var _EndAlarm = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EndAlarm, key) : _o.EndAlarm;
		var _TimeRewardMaxAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.TimeRewardMaxAmount, key) : _o.TimeRewardMaxAmount;
		var _EnterCostType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EnterCostType, key) : _o.EnterCostType;
		var _EnterCostId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EnterCostId, key) : _o.EnterCostId;
		var _TicketCost = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.TicketCost, key) : _o.TicketCost;
    var _DailyRewardResetTime = _o.DailyRewardResetTime == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.DailyRewardResetTime, key) : _o.DailyRewardResetTime));
    var _OpenScenarioId = _o.OpenScenarioId == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.OpenScenarioId, key) : _o.OpenScenarioId));
    var _characterSlotHideRank = default(VectorOffset);
    if (_o.CharacterSlotHideRank != null) {
      var __characterSlotHideRank = _o.CharacterSlotHideRank.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
      _characterSlotHideRank = CreateCharacterSlotHideRankVector(builder, __characterSlotHideRank);
    }
		var _MapSlotHideRank = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MapSlotHideRank, key) : _o.MapSlotHideRank;
    ...
    if (_o.ModifiedStatType != null) {
      var __ModifiedStatType = _o.ModifiedStatType.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.NPCName != null) {
      ...
      for (var _j = 0; _j < __NPCName.Length; ++_j) { __NPCName[_j] = builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.NPCName[_j], key) : _o.NPCName[_j])); }
      _NPCName = CreateNPCNameVector(builder, __NPCName);
    }
		var _NPCMainCharacterCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.NPCMainCharacterCount, key) : _o.NPCMainCharacterCount;
		var _NPCSupportCharacterCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.NPCSupportCharacterCount, key) : _o.NPCSupportCharacterCount;
		var _NPCCharacterSkillLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.NPCCharacterSkillLevel, key) : _o.NPCCharacterSkillLevel;
		var _TimeSpanInDaysForBattleHistory = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.TimeSpanInDaysForBattleHistory, key) : _o.TimeSpanInDaysForBattleHistory;
    var _HiddenCharacterImagePath = _o.HiddenCharacterImagePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.HiddenCharacterImagePath, key) : _o.HiddenCharacterImagePath));
		var _DefenseVictoryRewardMaxCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DefenseVictoryRewardMaxCount, key) : _o.DefenseVictoryRewardMaxCount;
		var _TopRankerCountLimit = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.TopRankerCountLimit, key) : _o.TopRankerCountLimit;
		var _AutoRefreshIntervalMilliSeconds = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.AutoRefreshIntervalMilliSeconds, key) : _o.AutoRefreshIntervalMilliSeconds;
		var _EchelonSettingIntervalMilliSeconds = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EchelonSettingIntervalMilliSeconds, key) : _o.EchelonSettingIntervalMilliSeconds;
		var _SkipAllowedTimeMilliSeconds = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.SkipAllowedTimeMilliSeconds, key) : _o.SkipAllowedTimeMilliSeconds;
    var _ShowSeasonChangeInfoStartTime = _o.ShowSeasonChangeInfoStartTime == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ShowSeasonChangeInfoStartTime, key) : _o.ShowSeasonChangeInfoStartTime));
    var _ShowSeasonChangeInfoEndTime = _o.ShowSeasonChangeInfoEndTime == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ShowSeasonChangeInfoEndTime, key) : _o.ShowSeasonChangeInfoEndTime));
		var _ShowSeasonId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ShowSeasonId, key) : _o.ShowSeasonId;
		var _ArenaHistoryQueryLimitDays = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ArenaHistoryQueryLimitDays, key) : _o.ArenaHistoryQueryLimitDays;
