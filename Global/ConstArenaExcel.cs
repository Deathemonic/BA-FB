...
public struct ConstArenaExcel : IFlatbufferObject
{
  ...
  public Global.ParcelType EnterCostType { get { int o = __p.__offset(16); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Global.ParcelType.None; } }
  ...
  public Global.StatType ModifiedStatType(int j) { int o = __p.__offset(34); return o != 0 ? (Global.StatType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Global.StatType)0; }
  public int ModifiedStatTypeLength { get { int o = __p.__offset(34); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Global.StatType> GetModifiedStatTypeBytes() { return __p.__vector_as_span<Global.StatType>(34, 4); }
#else
  public ArraySegment<byte>? GetModifiedStatTypeBytes() { return __p.__vector_as_arraysegment(34); }
#endif
  public Global.StatType[] GetModifiedStatTypeArray() { int o = __p.__offset(34); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Global.StatType[] a = new Global.StatType[l]; for (int i = 0; i < l; i++) { a[i] = (Global.StatType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Global.ConstArenaExcel> CreateConstArenaExcel(FlatBufferBuilder builder,
      ...
      Global.ParcelType EnterCostType = Global.ParcelType.None,
      long EnterCostId = 0,
      long TicketCost = 0,
  ...
  public static void AddEnterCostType(FlatBufferBuilder builder, Global.ParcelType enterCostType) { builder.AddInt(6, (int)enterCostType, 0); }
  ...
  public static VectorOffset CreateModifiedStatTypeVector(FlatBufferBuilder builder, Global.StatType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateModifiedStatTypeVectorBlock(FlatBufferBuilder builder, Global.StatType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateModifiedStatTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Global.StatType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateModifiedStatTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Global.StatType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Global.ConstArenaExcel> EndConstArenaExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.ConstArenaExcel>(o);
  }
  ...
  public void UnPackTo(ConstArenaExcelT _o) {
    ...
    _o.AttackCoolTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.AttackCoolTime, key) : this.AttackCoolTime;
    ...
    _o.DefenseCoolTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.DefenseCoolTime, key) : this.DefenseCoolTime;
    _o.TSSStartCoolTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.TSSStartCoolTime, key) : this.TSSStartCoolTime;
    _o.EndAlarm = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.EndAlarm, key) : this.EndAlarm;
    _o.TimeRewardMaxAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.TimeRewardMaxAmount, key) : this.TimeRewardMaxAmount;
    _o.EnterCostType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)this.EnterCostType, key) : this.EnterCostType;
    _o.EnterCostId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.EnterCostId, key) : this.EnterCostId;
    _o.TicketCost = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.TicketCost, key) : this.TicketCost;
    _o.DailyRewardResetTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.DailyRewardResetTime, key) : this.DailyRewardResetTime;
    _o.OpenScenarioId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.OpenScenarioId, key) : this.OpenScenarioId;
    _o.CharacterSlotHideRank = new List<long>();
    for (var _j = 0; _j < this.CharacterSlotHideRankLength; ++_j) {_o.CharacterSlotHideRank.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.CharacterSlotHideRank(_j), key) : this.CharacterSlotHideRank(_j));}
    _o.MapSlotHideRank = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.MapSlotHideRank, key) : this.MapSlotHideRank;
    _o.RelativeOpponentRankStart = new List<long>();
    for (var _j = 0; _j < this.RelativeOpponentRankStartLength; ++_j) {_o.RelativeOpponentRankStart.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.RelativeOpponentRankStart(_j), key) : this.RelativeOpponentRankStart(_j));}
    _o.RelativeOpponentRankEnd = new List<long>();
    for (var _j = 0; _j < this.RelativeOpponentRankEndLength; ++_j) {_o.RelativeOpponentRankEnd.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.RelativeOpponentRankEnd(_j), key) : this.RelativeOpponentRankEnd(_j));}
    _o.ModifiedStatType = new List<Global.StatType>();
    for (var _j = 0; _j < this.ModifiedStatTypeLength; ++_j) {_o.ModifiedStatType.Add(TableEncryptionService.UseEncryption ? (Global.StatType)TableEncryptionService.Convert((int)this.ModifiedStatType(_j), key) : this.ModifiedStatType(_j));}
    _o.StatMulFactor = new List<long>();
    for (var _j = 0; _j < this.StatMulFactorLength; ++_j) {_o.StatMulFactor.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.StatMulFactor(_j), key) : this.StatMulFactor(_j));}
    _o.StatSumFactor = new List<long>();
    for (var _j = 0; _j < this.StatSumFactorLength; ++_j) {_o.StatSumFactor.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.StatSumFactor(_j), key) : this.StatSumFactor(_j));}
    _o.NPCName = new List<string>();
    for (var _j = 0; _j < this.NPCNameLength; ++_j) {_o.NPCName.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.NPCName(_j), key) : this.NPCName(_j));}
    _o.NPCMainCharacterCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.NPCMainCharacterCount, key) : this.NPCMainCharacterCount;
    _o.NPCSupportCharacterCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.NPCSupportCharacterCount, key) : this.NPCSupportCharacterCount;
    _o.NPCCharacterSkillLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.NPCCharacterSkillLevel, key) : this.NPCCharacterSkillLevel;
    _o.TimeSpanInDaysForBattleHistory = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.TimeSpanInDaysForBattleHistory, key) : this.TimeSpanInDaysForBattleHistory;
    _o.HiddenCharacterImagePath = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.HiddenCharacterImagePath, key) : this.HiddenCharacterImagePath;
    _o.DefenseVictoryRewardMaxCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.DefenseVictoryRewardMaxCount, key) : this.DefenseVictoryRewardMaxCount;
    _o.TopRankerCountLimit = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.TopRankerCountLimit, key) : this.TopRankerCountLimit;
    _o.AutoRefreshIntervalMilliSeconds = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.AutoRefreshIntervalMilliSeconds, key) : this.AutoRefreshIntervalMilliSeconds;
    _o.EchelonSettingIntervalMilliSeconds = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.EchelonSettingIntervalMilliSeconds, key) : this.EchelonSettingIntervalMilliSeconds;
    _o.SkipAllowedTimeMilliSeconds = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.SkipAllowedTimeMilliSeconds, key) : this.SkipAllowedTimeMilliSeconds;
    _o.ShowSeasonChangeInfoStartTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ShowSeasonChangeInfoStartTime, key) : this.ShowSeasonChangeInfoStartTime;
    _o.ShowSeasonChangeInfoEndTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ShowSeasonChangeInfoEndTime, key) : this.ShowSeasonChangeInfoEndTime;
    _o.ShowSeasonId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ShowSeasonId, key) : this.ShowSeasonId;
    _o.ArenaHistoryQueryLimitDays = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.ArenaHistoryQueryLimitDays, key) : this.ArenaHistoryQueryLimitDays;
  }
  public static Offset<Global.ConstArenaExcel> Pack(FlatBufferBuilder builder, ConstArenaExcelT _o) {
    if (_o == null) return default(Offset<Global.ConstArenaExcel>);
		byte[] key = TableEncryptionService.CreateKey("ConstArena");
		var _AttackCoolTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.AttackCoolTime, key) : _o.AttackCoolTime;
		...
		var _DefenseCoolTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.DefenseCoolTime, key) : _o.DefenseCoolTime;
		var _TSSStartCoolTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.TSSStartCoolTime, key) : _o.TSSStartCoolTime;
		var _EndAlarm = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.EndAlarm, key) : _o.EndAlarm;
		var _TimeRewardMaxAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.TimeRewardMaxAmount, key) : _o.TimeRewardMaxAmount;
		var _EnterCostType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)_o.EnterCostType, key) : _o.EnterCostType;
		var _EnterCostId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.EnterCostId, key) : _o.EnterCostId;
		var _TicketCost = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.TicketCost, key) : _o.TicketCost;
    var _DailyRewardResetTime = _o.DailyRewardResetTime == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.DailyRewardResetTime, key) : _o.DailyRewardResetTime));
    var _OpenScenarioId = _o.OpenScenarioId == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.OpenScenarioId, key) : _o.OpenScenarioId));
    var _characterSlotHideRank = default(VectorOffset);
    if (_o.CharacterSlotHideRank != null) {
      var __characterSlotHideRank = _o.CharacterSlotHideRank.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
      _characterSlotHideRank = CreateCharacterSlotHideRankVector(builder, __characterSlotHideRank);
    }
		var _MapSlotHideRank = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.MapSlotHideRank, key) : _o.MapSlotHideRank;
    var _relativeOpponentRankStart = default(VectorOffset);
    if (_o.RelativeOpponentRankStart != null) {
      var __relativeOpponentRankStart = _o.RelativeOpponentRankStart.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
    ...
    if (_o.RelativeOpponentRankEnd != null) {
      var __relativeOpponentRankEnd = _o.RelativeOpponentRankEnd.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
    ...
    if (_o.ModifiedStatType != null) {
      var __modifiedStatType = _o.ModifiedStatType.Select(x => TableEncryptionService.UseEncryption ? (Global.StatType)TableEncryptionService.Convert((int)x, key) : x).ToArray();
    ...
    if (_o.StatMulFactor != null) {
      var __statMulFactor = _o.StatMulFactor.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
    ...
    if (_o.StatSumFactor != null) {
      var __statSumFactor = _o.StatSumFactor.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
    ...
    if (_o.NPCName != null) {
      ...
      for (var _j = 0; _j < __nPCName.Length; ++_j) { __nPCName[_j] = builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.NPCName[_j], key) : _o.NPCName[_j])); }
      _nPCName = CreateNPCNameVector(builder, __nPCName);
    }
		var _NPCMainCharacterCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.NPCMainCharacterCount, key) : _o.NPCMainCharacterCount;
		var _NPCSupportCharacterCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.NPCSupportCharacterCount, key) : _o.NPCSupportCharacterCount;
		var _NPCCharacterSkillLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.NPCCharacterSkillLevel, key) : _o.NPCCharacterSkillLevel;
		var _TimeSpanInDaysForBattleHistory = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.TimeSpanInDaysForBattleHistory, key) : _o.TimeSpanInDaysForBattleHistory;
    var _HiddenCharacterImagePath = _o.HiddenCharacterImagePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.HiddenCharacterImagePath, key) : _o.HiddenCharacterImagePath));
		var _DefenseVictoryRewardMaxCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.DefenseVictoryRewardMaxCount, key) : _o.DefenseVictoryRewardMaxCount;
		var _TopRankerCountLimit = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.TopRankerCountLimit, key) : _o.TopRankerCountLimit;
		var _AutoRefreshIntervalMilliSeconds = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.AutoRefreshIntervalMilliSeconds, key) : _o.AutoRefreshIntervalMilliSeconds;
		var _EchelonSettingIntervalMilliSeconds = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.EchelonSettingIntervalMilliSeconds, key) : _o.EchelonSettingIntervalMilliSeconds;
		var _SkipAllowedTimeMilliSeconds = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.SkipAllowedTimeMilliSeconds, key) : _o.SkipAllowedTimeMilliSeconds;
    var _ShowSeasonChangeInfoStartTime = _o.ShowSeasonChangeInfoStartTime == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.ShowSeasonChangeInfoStartTime, key) : _o.ShowSeasonChangeInfoStartTime));
    var _ShowSeasonChangeInfoEndTime = _o.ShowSeasonChangeInfoEndTime == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.ShowSeasonChangeInfoEndTime, key) : _o.ShowSeasonChangeInfoEndTime));
		var _ShowSeasonId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ShowSeasonId, key) : _o.ShowSeasonId;
		var _ArenaHistoryQueryLimitDays = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.ArenaHistoryQueryLimitDays, key) : _o.ArenaHistoryQueryLimitDays;
    return CreateConstArenaExcel(
      builder,
      TableEncryptionService.UseEncryption ? _AttackCoolTime : _o.AttackCoolTime,
      TableEncryptionService.UseEncryption ? _BattleDuration : _o.BattleDuration,
      TableEncryptionService.UseEncryption ? _DefenseCoolTime : _o.DefenseCoolTime,
      TableEncryptionService.UseEncryption ? _TSSStartCoolTime : _o.TSSStartCoolTime,
      TableEncryptionService.UseEncryption ? _EndAlarm : _o.EndAlarm,
      TableEncryptionService.UseEncryption ? _TimeRewardMaxAmount : _o.TimeRewardMaxAmount,
      TableEncryptionService.UseEncryption ? _EnterCostType : _o.EnterCostType,
      TableEncryptionService.UseEncryption ? _EnterCostId : _o.EnterCostId,
      TableEncryptionService.UseEncryption ? _TicketCost : _o.TicketCost,
      ...
      TableEncryptionService.UseEncryption ? _NPCCharacterSkillLevel : _o.NPCCharacterSkillLevel,
      TableEncryptionService.UseEncryption ? _TimeSpanInDaysForBattleHistory : _o.TimeSpanInDaysForBattleHistory,
      _HiddenCharacterImagePath,
      TableEncryptionService.UseEncryption ? _DefenseVictoryRewardMaxCount : _o.DefenseVictoryRewardMaxCount,
      TableEncryptionService.UseEncryption ? _TopRankerCountLimit : _o.TopRankerCountLimit,
      TableEncryptionService.UseEncryption ? _AutoRefreshIntervalMilliSeconds : _o.AutoRefreshIntervalMilliSeconds,
      TableEncryptionService.UseEncryption ? _EchelonSettingIntervalMilliSeconds : _o.EchelonSettingIntervalMilliSeconds,
      TableEncryptionService.UseEncryption ? _SkipAllowedTimeMilliSeconds : _o.SkipAllowedTimeMilliSeconds,
      _ShowSeasonChangeInfoStartTime,
      _ShowSeasonChangeInfoEndTime,
      TableEncryptionService.UseEncryption ? _ShowSeasonId : _o.ShowSeasonId,
      TableEncryptionService.UseEncryption ? _ArenaHistoryQueryLimitDays : _o.ArenaHistoryQueryLimitDays);
  }
}
...
public class ConstArenaExcelT
{
  ...
  public Global.ParcelType EnterCostType { get; set; }
  ...
  public List<Global.StatType> ModifiedStatType { get; set; }
  ...
  public ConstArenaExcelT() {
    ...
    this.EnterCostType = Global.ParcelType.None;
    this.EnterCostId = 0;
    this.TicketCost = 0;
...
static public class ConstArenaExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 16 /*EnterCostType*/, 4 /*Global.ParcelType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 34 /*ModifiedStatType*/, 4 /*Global.StatType*/, false)
