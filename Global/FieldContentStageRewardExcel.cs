...
public struct FieldContentStageRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.FieldContentStageRewardExcel> CreateFieldContentStageRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static Offset<Global.FieldContentStageRewardExcel> EndFieldContentStageRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.FieldContentStageRewardExcel>(o);
  }
  ...
  public static Offset<Global.FieldContentStageRewardExcel> Pack(FlatBufferBuilder builder, FieldContentStageRewardExcelT _o) {
    if (_o == null) return default(Offset<Global.FieldContentStageRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("FieldContentStageReward");
