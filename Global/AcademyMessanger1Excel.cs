...
public struct AcademyMessanger1Excel : IFlatbufferObject
{
  ...
  public static Offset<Global.AcademyMessanger1Excel> CreateAcademyMessanger1Excel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.AcademyMessanger1Excel> EndAcademyMessanger1Excel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.AcademyMessanger1Excel>(o);
  }
  ...
  public static Offset<Global.AcademyMessanger1Excel> Pack(FlatBufferBuilder builder, AcademyMessanger1ExcelT _o) {
    if (_o == null) return default(Offset<Global.AcademyMessanger1Excel>);
		byte[] key = TableEncryptionService.CreateKey("AcademyMessanger1");
