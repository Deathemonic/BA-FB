...
public struct PresetParcelsExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.PresetParcelsExcel> CreatePresetParcelsExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.PresetParcelsExcel> EndPresetParcelsExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.PresetParcelsExcel>(o);
  }
  ...
  public static Offset<Global.PresetParcelsExcel> Pack(FlatBufferBuilder builder, PresetParcelsExcelT _o) {
    if (_o == null) return default(Offset<Global.PresetParcelsExcel>);
		byte[] key = TableEncryptionService.CreateKey("PresetParcels");
