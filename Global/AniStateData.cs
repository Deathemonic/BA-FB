...
public struct AniStateData : IFlatbufferObject
{
  ...
  public Global.AniEventData? Events(int j) { int o = __p.__offset(26); return o != 0 ? (Global.AniEventData?)(new Global.AniEventData()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  public int EventsLength { get { int o = __p.__offset(26); return o != 0 ? __p.__vector_len(o) : 0; } }

  public static Offset<Global.AniStateData> CreateAniStateData(FlatBufferBuilder builder,
  ...
  public static VectorOffset CreateEventsVector(FlatBufferBuilder builder, Offset<Global.AniEventData>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateEventsVectorBlock(FlatBufferBuilder builder, Offset<Global.AniEventData>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateEventsVectorBlock(FlatBufferBuilder builder, ArraySegment<Offset<Global.AniEventData>> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateEventsVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Offset<Global.AniEventData>>(dataPtr, sizeInBytes); return builder.EndVector(); }
  public static void StartEventsVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static Offset<Global.AniStateData> EndAniStateData(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.AniStateData>(o);
  }
  ...
  public void UnPackTo(AniStateDataT _o) {
		byte[] key = TableEncryptionService.CreateKey("AniStat");
    _o.StateName = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StateName, key) : this.StateName;
    _o.StatePrefix = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StatePrefix, key) : this.StatePrefix;
    _o.StateNameWithPrefix = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StateNameWithPrefix, key) : this.StateNameWithPrefix;
    _o.Tag = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Tag, key) : this.Tag;
    _o.SpeedParameterName = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SpeedParameterName, key) : this.SpeedParameterName;
    _o.SpeedParamter = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)this.SpeedParamter, key) : this.SpeedParamter;
    _o.StateSpeed = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)this.StateSpeed, key) : this.StateSpeed;
    _o.ClipName = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ClipName, key) : this.ClipName;
    _o.Length = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)this.Length, key) : this.Length;
    _o.FrameRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)this.FrameRate, key) : this.FrameRate;
    _o.IsLooping = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.IsLooping, key) : this.IsLooping;
    _o.Events = new List<Global.AniEventDataT>();
    for (var _j = 0; _j < this.EventsLength; ++_j) {_o.Events.Add(this.Events(_j).HasValue ? this.Events(_j).Value.UnPack() : null);}
  }
  public static Offset<Global.AniStateData> Pack(FlatBufferBuilder builder, AniStateDataT _o) {
    if (_o == null) return default(Offset<Global.AniStateData>);
		byte[] key = TableEncryptionService.CreateKey("AniStat");
    ...
    var _StatePrefix = _o.StatePrefix == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.StatePrefix, key) : _o.StatePrefix));
    var _StateNameWithPrefix = _o.StateNameWithPrefix == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.StateNameWithPrefix, key) : _o.StateNameWithPrefix));
    var _Tag = _o.Tag == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.Tag, key) : _o.Tag));
    var _SpeedParameterName = _o.SpeedParameterName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.SpeedParameterName, key) : _o.SpeedParameterName));
		var _SpeedParamter = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)_o.SpeedParamter, key) : _o.SpeedParamter;
		var _StateSpeed = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)_o.StateSpeed, key) : _o.StateSpeed;
    var _ClipName = _o.ClipName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.ClipName, key) : _o.ClipName));
		var _Length = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)_o.Length, key) : _o.Length;
		var _FrameRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)_o.FrameRate, key) : _o.FrameRate;
		var _IsLooping = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.IsLooping, key) : _o.IsLooping;
    var _Events = default(VectorOffset);
    if (_o.Events != null) {
      var __Events = new Offset<Global.AniEventData>[_o.Events.Count];
      for (var _j = 0; _j < __Events.Length; ++_j) { __Events[_j] = Global.AniEventData.Pack(builder, _o.Events[_j]); }
    ...
    return CreateAniStateData(
      ...
      _Tag,
      _SpeedParameterName,
      TableEncryptionService.UseEncryption ? _SpeedParamter : _o.SpeedParamter,
      TableEncryptionService.UseEncryption ? _StateSpeed : _o.StateSpeed,
      _ClipName,
      TableEncryptionService.UseEncryption ? _Length : _o.Length,
      TableEncryptionService.UseEncryption ? _FrameRate : _o.FrameRate,
      TableEncryptionService.UseEncryption ? _IsLooping : _o.IsLooping,
      _Events);
  }
}
...
public class AniStateDataT
{
  ...
  public List<Global.AniEventDataT> Events { get; set; }
...
static public class AniStateDataVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfTables(tablePos, 26 /*Events*/, Global.AniEventDataVerify.Verify, false)
