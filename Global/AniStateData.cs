...
public struct AniStateData : IFlatbufferObject
{
  ...
  public void UnPackTo(AniStateDataT _o) {
    ...
    _o.SpeedParamter = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SpeedParamter, key) : this.SpeedParamter;
    _o.StateSpeed = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StateSpeed, key) : this.StateSpeed;
    _o.ClipName = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ClipName, key) : this.ClipName;
    _o.Length = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Length, key) : this.Length;
    _o.FrameRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.FrameRate, key) : this.FrameRate;
    _o.IsLooping = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.IsLooping, key) : this.IsLooping;
  ...
  public static Offset<Global.AniStateData> Pack(FlatBufferBuilder builder, AniStateDataT _o) {
    ...
    var _StatePrefix = _o.StatePrefix == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.StatePrefix, key) : _o.StatePrefix));
    var _StateNameWithPrefix = _o.StateNameWithPrefix == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.StateNameWithPrefix, key) : _o.StateNameWithPrefix));
    var _Tag = _o.Tag == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.Tag, key) : _o.Tag));
    var _SpeedParameterName = _o.SpeedParameterName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.SpeedParameterName, key) : _o.SpeedParameterName));
		var _SpeedParamter = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.SpeedParamter, key) : _o.SpeedParamter;
		var _StateSpeed = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StateSpeed, key) : _o.StateSpeed;
    var _ClipName = _o.ClipName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ClipName, key) : _o.ClipName));
		var _Length = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Length, key) : _o.Length;
		var _FrameRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.FrameRate, key) : _o.FrameRate;
		var _IsLooping = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IsLooping, key) : _o.IsLooping;
