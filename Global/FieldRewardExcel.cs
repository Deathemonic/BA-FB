...
public struct FieldRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.FieldRewardExcel> CreateFieldRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
      int RewardProb = 0,
  ...
  public static Offset<Global.FieldRewardExcel> EndFieldRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.FieldRewardExcel>(o);
  }
  ...
  public static Offset<Global.FieldRewardExcel> Pack(FlatBufferBuilder builder, FieldRewardExcelT _o) {
    if (_o == null) return default(Offset<Global.FieldRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("FieldReward");
