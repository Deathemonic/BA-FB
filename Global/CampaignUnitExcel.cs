...
public struct CampaignUnitExcel : IFlatbufferObject
{
  ...
  public Global.StrategyAIType AIMoveType { get { int o = __p.__offset(22); return o != 0 ? (Global.StrategyAIType)__p.bb.GetInt(o + __p.bb_pos) : Global.StrategyAIType.None; } }
  public Global.HexaUnitGrade Grade { get { int o = __p.__offset(24); return o != 0 ? (Global.HexaUnitGrade)__p.bb.GetInt(o + __p.bb_pos) : Global.HexaUnitGrade.Grade1; } }
  public Global.TacticEnvironment EnvironmentType { get { int o = __p.__offset(26); return o != 0 ? (Global.TacticEnvironment)__p.bb.GetInt(o + __p.bb_pos) : Global.TacticEnvironment.None; } }
  ...
  public static Offset<Global.CampaignUnitExcel> CreateCampaignUnitExcel(FlatBufferBuilder builder,
      long Id = 0,
      uint Key = 0,
      ...
      long GroundId = 0,
      int MoveRange = 0,
      Global.StrategyAIType AIMoveType = Global.StrategyAIType.None,
      Global.HexaUnitGrade Grade = Global.HexaUnitGrade.Grade1,
      Global.TacticEnvironment EnvironmentType = Global.TacticEnvironment.None,
      float Scale = 0.0f,
  ...
  public static void AddAIMoveType(FlatBufferBuilder builder, Global.StrategyAIType aIMoveType) { builder.AddInt(9, (int)aIMoveType, 0); }
  public static void AddGrade(FlatBufferBuilder builder, Global.HexaUnitGrade grade) { builder.AddInt(10, (int)grade, 0); }
  public static void AddEnvironmentType(FlatBufferBuilder builder, Global.TacticEnvironment environmentType) { builder.AddInt(11, (int)environmentType, 0); }
  ...
  public static Offset<Global.CampaignUnitExcel> EndCampaignUnitExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.CampaignUnitExcel>(o);
  }
  ...
  public void UnPackTo(CampaignUnitExcelT _o) {
    ...
    _o.MoveRange = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MoveRange, key) : this.MoveRange;
    _o.AIMoveType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.AIMoveType, key) : this.AIMoveType;
    _o.Grade = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Grade, key) : this.Grade;
    _o.EnvironmentType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EnvironmentType, key) : this.EnvironmentType;
    _o.Scale = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Scale, key) : this.Scale;
    _o.IsTacticSkip = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.IsTacticSkip, key) : this.IsTacticSkip;
  }
  public static Offset<Global.CampaignUnitExcel> Pack(FlatBufferBuilder builder, CampaignUnitExcelT _o) {
    if (_o == null) return default(Offset<Global.CampaignUnitExcel>);
		byte[] key = TableEncryptionService.CreateKey("CampaignUnit");
    ...
    if (_o.ClearScenarioGroupId != null) {
      ...
      _ClearScenarioGroupId = CreateClearScenarioGroupIdVector(builder, __ClearScenarioGroupId);
		...
		var _MoveRange = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MoveRange, key) : _o.MoveRange;
		var _AIMoveType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.AIMoveType, key) : _o.AIMoveType;
		var _Grade = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Grade, key) : _o.Grade;
		var _EnvironmentType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EnvironmentType, key) : _o.EnvironmentType;
    ...
    return CreateCampaignUnitExcel(
      ...
      TableEncryptionService.UseEncryption ? _MoveRange : _o.MoveRange,
      TableEncryptionService.UseEncryption ? _AIMoveType : _o.AIMoveType,
      TableEncryptionService.UseEncryption ? _Grade : _o.Grade,
      TableEncryptionService.UseEncryption ? _EnvironmentType : _o.EnvironmentType,
...
public class CampaignUnitExcelT
{
  ...
  public Global.StrategyAIType AIMoveType { get; set; }
  public Global.HexaUnitGrade Grade { get; set; }
  public Global.TacticEnvironment EnvironmentType { get; set; }
  ...
  public CampaignUnitExcelT() {
    ...
    this.GroundId = 0;
    this.MoveRange = 0;
    this.AIMoveType = Global.StrategyAIType.None;
    this.Grade = Global.HexaUnitGrade.Grade1;
    this.EnvironmentType = Global.TacticEnvironment.None;
    this.Scale = 0.0f;
...
static public class CampaignUnitExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 22 /*AIMoveType*/, 4 /*Global.StrategyAIType*/, 4, false)
      && verifier.VerifyField(tablePos, 24 /*Grade*/, 4 /*Global.HexaUnitGrade*/, 4, false)
      && verifier.VerifyField(tablePos, 26 /*EnvironmentType*/, 4 /*Global.TacticEnvironment*/, 4, false)
