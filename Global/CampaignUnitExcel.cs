...
public struct CampaignUnitExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(CampaignUnitExcelT _o) {
    ...
    _o.MoveRange = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.MoveRange, key) : this.MoveRange;
    _o.AIMoveType = TableEncryptionService.UseEncryption ? (Global.StrategyAIType)TableEncryptionService.Convert((int)this.AIMoveType, key) : this.AIMoveType;
    _o.Grade = TableEncryptionService.UseEncryption ? (Global.HexaUnitGrade)TableEncryptionService.Convert((int)this.Grade, key) : this.Grade;
    _o.EnvironmentType = TableEncryptionService.UseEncryption ? (Global.TacticEnvironment)TableEncryptionService.Convert((int)this.EnvironmentType, key) : this.EnvironmentType;
  ...
  public static Offset<Global.CampaignUnitExcel> Pack(FlatBufferBuilder builder, CampaignUnitExcelT _o) {
    ...
    if (_o.ClearScenarioGroupId != null) {
      ...
      _ClearScenarioGroupId = CreateClearScenarioGroupIdVector(builder, __ClearScenarioGroupId);
		...
		var _MoveRange = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.MoveRange, key) : _o.MoveRange;
		var _AIMoveType = TableEncryptionService.UseEncryption ? (Global.StrategyAIType)TableEncryptionService.Convert((int)_o.AIMoveType, key) : _o.AIMoveType;
		var _Grade = TableEncryptionService.UseEncryption ? (Global.HexaUnitGrade)TableEncryptionService.Convert((int)_o.Grade, key) : _o.Grade;
		var _EnvironmentType = TableEncryptionService.UseEncryption ? (Global.TacticEnvironment)TableEncryptionService.Convert((int)_o.EnvironmentType, key) : _o.EnvironmentType;
