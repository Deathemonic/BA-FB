...
public struct ScenarioModeExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.ScenarioModeExcel> Pack(FlatBufferBuilder builder, ScenarioModeExcelT _o) {
    ...
    var _ScenarioOpenDate = _o.ScenarioOpenDate == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ScenarioOpenDate, key) : _o.ScenarioOpenDate));
    var _ScenarioCloseDate = _o.ScenarioCloseDate == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ScenarioCloseDate, key) : _o.ScenarioCloseDate));
