...
public struct EventContentBoxGachaShopExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.EventContentBoxGachaShopExcel> CreateEventContentBoxGachaShopExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.EventContentBoxGachaShopExcel> EndEventContentBoxGachaShopExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.EventContentBoxGachaShopExcel>(o);
  }
  ...
  public void UnPackTo(EventContentBoxGachaShopExcelT _o) {
    ...
    _o.GroupElementAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.GroupElementAmount, key) : this.GroupElementAmount;
    _o.Round = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.Round, key) : this.Round;
    _o.IsLegacy = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.IsLegacy, key) : this.IsLegacy;
    _o.IsPrize = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.IsPrize, key) : this.IsPrize;
  ...
  public static Offset<Global.EventContentBoxGachaShopExcel> Pack(FlatBufferBuilder builder, EventContentBoxGachaShopExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentBoxGachaShopExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentBoxGachaShop");
		...
		var _GroupElementAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.GroupElementAmount, key) : _o.GroupElementAmount;
		var _Round = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.Round, key) : _o.Round;
		var _IsLegacy = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.IsLegacy, key) : _o.IsLegacy;
		var _IsPrize = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.IsPrize, key) : _o.IsPrize;
    ...
    return CreateEventContentBoxGachaShopExcel(
      ...
      TableEncryptionService.UseEncryption ? _GroupElementAmount : _o.GroupElementAmount,
