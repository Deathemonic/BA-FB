...
public struct EventContentBoxGachaShopExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(EventContentBoxGachaShopExcelT _o) {
    ...
    _o.GroupElementAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.GroupElementAmount, key) : this.GroupElementAmount;
    ...
    _o.IsPrize = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.IsPrize, key) : this.IsPrize;
  ...
  public static Offset<Global.EventContentBoxGachaShopExcel> Pack(FlatBufferBuilder builder, EventContentBoxGachaShopExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentBoxGachaShopExcel>);
		...
		var _GroupElementAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.GroupElementAmount, key) : _o.GroupElementAmount;
