...
public struct MiniGameAudioAnimatorExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.MiniGameAudioAnimatorExcel> CreateMiniGameAudioAnimatorExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.MiniGameAudioAnimatorExcel> EndMiniGameAudioAnimatorExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.MiniGameAudioAnimatorExcel>(o);
  }
  ...
  public static Offset<Global.MiniGameAudioAnimatorExcel> Pack(FlatBufferBuilder builder, MiniGameAudioAnimatorExcelT _o) {
    if (_o == null) return default(Offset<Global.MiniGameAudioAnimatorExcel>);
		byte[] key = TableEncryptionService.CreateKey("MiniGameAudioAnimator");
