...
public struct TacticArenaSimulatorSettingExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(TacticArenaSimulatorSettingExcelT _o) {
    ...
    _o.AttackerFrom = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.AttackerFrom, key) : this.AttackerFrom;
    _o.AttackerUserArenaGroup = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.AttackerUserArenaGroup, key) : this.AttackerUserArenaGroup;
    _o.AttackerUserArenaRank = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.AttackerUserArenaRank, key) : this.AttackerUserArenaRank;
    _o.AttackerPresetGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.AttackerPresetGroupId, key) : this.AttackerPresetGroupId;
    _o.AttackerStrikerNum = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.AttackerStrikerNum, key) : this.AttackerStrikerNum;
    _o.AttackerSpecialNum = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.AttackerSpecialNum, key) : this.AttackerSpecialNum;
    _o.DefenderFrom = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.DefenderFrom, key) : this.DefenderFrom;
    _o.DefenderUserArenaGroup = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.DefenderUserArenaGroup, key) : this.DefenderUserArenaGroup;
    _o.DefenderUserArenaRank = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.DefenderUserArenaRank, key) : this.DefenderUserArenaRank;
    _o.DefenderPresetGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.DefenderPresetGroupId, key) : this.DefenderPresetGroupId;
    _o.DefenderStrikerNum = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.DefenderStrikerNum, key) : this.DefenderStrikerNum;
    _o.DefenderSpecialNum = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.DefenderSpecialNum, key) : this.DefenderSpecialNum;
  ...
  public static Offset<Global.TacticArenaSimulatorSettingExcel> Pack(FlatBufferBuilder builder, TacticArenaSimulatorSettingExcelT _o) {
    if (_o == null) return default(Offset<Global.TacticArenaSimulatorSettingExcel>);
		...
		var _AttackerFrom = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.AttackerFrom, key) : _o.AttackerFrom;
		var _AttackerUserArenaGroup = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.AttackerUserArenaGroup, key) : _o.AttackerUserArenaGroup;
		var _AttackerUserArenaRank = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.AttackerUserArenaRank, key) : _o.AttackerUserArenaRank;
		var _AttackerPresetGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.AttackerPresetGroupId, key) : _o.AttackerPresetGroupId;
		var _AttackerStrikerNum = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.AttackerStrikerNum, key) : _o.AttackerStrikerNum;
		var _AttackerSpecialNum = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.AttackerSpecialNum, key) : _o.AttackerSpecialNum;
		var _DefenderFrom = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DefenderFrom, key) : _o.DefenderFrom;
		var _DefenderUserArenaGroup = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DefenderUserArenaGroup, key) : _o.DefenderUserArenaGroup;
		var _DefenderUserArenaRank = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DefenderUserArenaRank, key) : _o.DefenderUserArenaRank;
		var _DefenderPresetGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DefenderPresetGroupId, key) : _o.DefenderPresetGroupId;
		var _DefenderStrikerNum = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DefenderStrikerNum, key) : _o.DefenderStrikerNum;
		var _DefenderSpecialNum = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DefenderSpecialNum, key) : _o.DefenderSpecialNum;
