...
public struct FieldContentStageExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(FieldContentStageExcelT _o) {
    ...
    _o.AreaId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.AreaId, key) : this.AreaId;
    ...
    _o.SkipFormationSettings = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.SkipFormationSettings, key) : this.SkipFormationSettings;
    _o.DailyLastPlay = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.DailyLastPlay, key) : this.DailyLastPlay;
  ...
  public static Offset<Global.FieldContentStageExcel> Pack(FlatBufferBuilder builder, FieldContentStageExcelT _o) {
    if (_o == null) return default(Offset<Global.FieldContentStageExcel>);
		...
		var _AreaId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.AreaId, key) : _o.AreaId;
    ...
    var _Name = _o.Name == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.Name, key) : _o.Name));
		...
		var _SkipFormationSettings = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.SkipFormationSettings, key) : _o.SkipFormationSettings;
		var _DailyLastPlay = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.DailyLastPlay, key) : _o.DailyLastPlay;
