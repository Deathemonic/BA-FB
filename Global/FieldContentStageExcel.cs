...
public struct FieldContentStageExcel : IFlatbufferObject
{
  ...
  public Global.StageDifficulty StageDifficulty { get { int o = __p.__offset(12); return o != 0 ? (Global.StageDifficulty)__p.bb.GetInt(o + __p.bb_pos) : Global.StageDifficulty.None; } }
  ...
  public Global.ParcelType StageEnterCostType { get { int o = __p.__offset(20); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Global.ParcelType.None; } }
  ...
  public Global.StarGoalType StarGoal(int j) { int o = __p.__offset(42); return o != 0 ? (Global.StarGoalType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Global.StarGoalType)0; }
  public int StarGoalLength { get { int o = __p.__offset(42); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Global.StarGoalType> GetStarGoalBytes() { return __p.__vector_as_span<Global.StarGoalType>(42, 4); }
#else
  public ArraySegment<byte>? GetStarGoalBytes() { return __p.__vector_as_arraysegment(42); }
#endif
  public Global.StarGoalType[] GetStarGoalArray() { int o = __p.__offset(42); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Global.StarGoalType[] a = new Global.StarGoalType[l]; for (int i = 0; i < l; i++) { a[i] = (Global.StarGoalType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Global.FieldContentStageExcel> CreateFieldContentStageExcel(FlatBufferBuilder builder,
      long Id = 0,
      long SeasonId = 0,
      long AreaId = 0,
      long GroupId = 0,
  ...
  public static void AddStageDifficulty(FlatBufferBuilder builder, Global.StageDifficulty stageDifficulty) { builder.AddInt(4, (int)stageDifficulty, 0); }
  ...
  public static void AddStageEnterCostType(FlatBufferBuilder builder, Global.ParcelType stageEnterCostType) { builder.AddInt(8, (int)stageEnterCostType, 0); }
  ...
  public static Offset<Global.FieldContentStageExcel> EndFieldContentStageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.FieldContentStageExcel>(o);
  }
  ...
  public void UnPackTo(FieldContentStageExcelT _o) {
    ...
    _o.AreaId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.AreaId, key) : this.AreaId;
    ...
    _o.SkipFormationSettings = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SkipFormationSettings, key) : this.SkipFormationSettings;
    _o.DailyLastPlay = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.DailyLastPlay, key) : this.DailyLastPlay;
  ...
  public static Offset<Global.FieldContentStageExcel> Pack(FlatBufferBuilder builder, FieldContentStageExcelT _o) {
    if (_o == null) return default(Offset<Global.FieldContentStageExcel>);
		byte[] key = TableEncryptionService.CreateKey("FieldContentStage");
		...
		var _AreaId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.AreaId, key) : _o.AreaId;
    ...
    var _Name = _o.Name == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.Name, key) : _o.Name));
		...
		var _SkipFormationSettings = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.SkipFormationSettings, key) : _o.SkipFormationSettings;
		var _DailyLastPlay = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DailyLastPlay, key) : _o.DailyLastPlay;
    ...
    return CreateFieldContentStageExcel(
      ...
      TableEncryptionService.UseEncryption ? _AreaId : _o.AreaId,
...
static public class FieldContentStageExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*StageDifficulty*/, 4 /*Global.StageDifficulty*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 20 /*StageEnterCostType*/, 4 /*Global.ParcelType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 42 /*StarGoal*/, 4 /*Global.StarGoalType*/, false)
