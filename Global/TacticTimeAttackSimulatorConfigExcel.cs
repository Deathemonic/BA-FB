...
public struct TacticTimeAttackSimulatorConfigExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.TacticTimeAttackSimulatorConfigExcel> CreateTacticTimeAttackSimulatorConfigExcel(FlatBufferBuilder builder,
      long Order = 0,
      long Repeat = 0,
  ...
  public static Offset<Global.TacticTimeAttackSimulatorConfigExcel> EndTacticTimeAttackSimulatorConfigExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.TacticTimeAttackSimulatorConfigExcel>(o);
  }
  ...
  public void UnPackTo(TacticTimeAttackSimulatorConfigExcelT _o) {
    ...
    _o.AttackStrikerNum = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.AttackStrikerNum, key) : this.AttackStrikerNum;
    _o.AttackSpecialNum = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.AttackSpecialNum, key) : this.AttackSpecialNum;
    _o.GeasId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.GeasId, key) : this.GeasId;
  }
  public static Offset<Global.TacticTimeAttackSimulatorConfigExcel> Pack(FlatBufferBuilder builder, TacticTimeAttackSimulatorConfigExcelT _o) {
    if (_o == null) return default(Offset<Global.TacticTimeAttackSimulatorConfigExcel>);
		byte[] key = TableEncryptionService.CreateKey("TacticTimeAttackSimulatorConfig");
		...
		var _AttackStrikerNum = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.AttackStrikerNum, key) : _o.AttackStrikerNum;
		var _AttackSpecialNum = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.AttackSpecialNum, key) : _o.AttackSpecialNum;
		var _GeasId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.GeasId, key) : _o.GeasId;
    return CreateTacticTimeAttackSimulatorConfigExcel(
      ...
      TableEncryptionService.UseEncryption ? _AttackStrikerNum : _o.AttackStrikerNum,
      TableEncryptionService.UseEncryption ? _AttackSpecialNum : _o.AttackSpecialNum,
      TableEncryptionService.UseEncryption ? _GeasId : _o.GeasId);
  }
}
