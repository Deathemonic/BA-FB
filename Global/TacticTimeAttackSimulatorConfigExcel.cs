...
public struct TacticTimeAttackSimulatorConfigExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(TacticTimeAttackSimulatorConfigExcelT _o) {
    ...
    _o.PresetGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.PresetGroupId, key) : this.PresetGroupId;
    _o.AttackStrikerNum = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.AttackStrikerNum, key) : this.AttackStrikerNum;
    _o.AttackSpecialNum = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.AttackSpecialNum, key) : this.AttackSpecialNum;
    _o.GeasId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.GeasId, key) : this.GeasId;
  }
  public static Offset<Global.TacticTimeAttackSimulatorConfigExcel> Pack(FlatBufferBuilder builder, TacticTimeAttackSimulatorConfigExcelT _o) {
    if (_o == null) return default(Offset<Global.TacticTimeAttackSimulatorConfigExcel>);
		...
		var _PresetGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PresetGroupId, key) : _o.PresetGroupId;
		var _AttackStrikerNum = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.AttackStrikerNum, key) : _o.AttackStrikerNum;
		var _AttackSpecialNum = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.AttackSpecialNum, key) : _o.AttackSpecialNum;
		var _GeasId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.GeasId, key) : _o.GeasId;
