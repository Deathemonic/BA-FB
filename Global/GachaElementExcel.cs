...
public struct GachaElementExcel : IFlatbufferObject
{
  ...
  public Global.Rarity Rarity { get { int o = __p.__offset(12); return o != 0 ? (Global.Rarity)__p.bb.GetInt(o + __p.bb_pos) : Global.Rarity.N; } }
  ...
  public static Offset<Global.GachaElementExcel> CreateGachaElementExcel(FlatBufferBuilder builder,
      long ID = 0,
      long GachaGroupID = 0,
  ...
  public static void AddRarity(FlatBufferBuilder builder, Global.Rarity rarity) { builder.AddInt(4, (int)rarity, 0); }
  ...
  public static Offset<Global.GachaElementExcel> EndGachaElementExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.GachaElementExcel>(o);
  }
  ...
  public static Offset<Global.GachaElementExcel> Pack(FlatBufferBuilder builder, GachaElementExcelT _o) {
    if (_o == null) return default(Offset<Global.GachaElementExcel>);
		byte[] key = TableEncryptionService.CreateKey("GachaElement");
		var _ID = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ID, key) : _o.ID;
		var _GachaGroupID = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.GachaGroupID, key) : _o.GachaGroupID;
		...
		var _ParcelAmountMin = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ParcelAmountMin, key) : _o.ParcelAmountMin;
		var _ParcelAmountMax = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ParcelAmountMax, key) : _o.ParcelAmountMax;
...
static public class GachaElementExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*Rarity*/, 4 /*Global.Rarity*/, 4, false)
