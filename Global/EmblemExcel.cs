...
public struct EmblemExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(EmblemExcelT _o) {
    ...
    _o.Category = TableEncryptionService.UseEncryption ? (Global.EmblemCategory)TableEncryptionService.Convert((int)this.Category, key) : this.Category;
    ...
    _o.DisplayType = TableEncryptionService.UseEncryption ? (Global.EmblemDisplayType)TableEncryptionService.Convert((int)this.DisplayType, key) : this.DisplayType;
    ...
    _o.CheckPassType = TableEncryptionService.UseEncryption ? (Global.EmblemCheckPassType)TableEncryptionService.Convert((int)this.CheckPassType, key) : this.CheckPassType;
  ...
  public static Offset<Global.EmblemExcel> Pack(FlatBufferBuilder builder, EmblemExcelT _o) {
    if (_o == null) return default(Offset<Global.EmblemExcel>);
		...
		var _Category = TableEncryptionService.UseEncryption ? (Global.EmblemCategory)TableEncryptionService.Convert((int)_o.Category, key) : _o.Category;
    ...
    var _EmblemBGPathTh = _o.EmblemBGPathTh == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.EmblemBGPathTh, key) : _o.EmblemBGPathTh));
    var _EmblemBGPathTw = _o.EmblemBGPathTw == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.EmblemBGPathTw, key) : _o.EmblemBGPathTw));
    var _EmblemBGPathEn = _o.EmblemBGPathEn == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.EmblemBGPathEn, key) : _o.EmblemBGPathEn));
    var _EmblemEffectPath = _o.EmblemEffectPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.EmblemEffectPath, key) : _o.EmblemEffectPath));
		var _DisplayType = TableEncryptionService.UseEncryption ? (Global.EmblemDisplayType)TableEncryptionService.Convert((int)_o.DisplayType, key) : _o.DisplayType;
    ...
    var _DisplayEndDate = _o.DisplayEndDate == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.DisplayEndDate, key) : _o.DisplayEndDate));
		...
		var _CheckPassType = TableEncryptionService.UseEncryption ? (Global.EmblemCheckPassType)TableEncryptionService.Convert((int)_o.CheckPassType, key) : _o.CheckPassType;
