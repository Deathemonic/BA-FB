...
public struct EmblemExcel : IFlatbufferObject
{
  ...
  public Global.EmblemCategory Category { get { int o = __p.__offset(6); return o != 0 ? (Global.EmblemCategory)__p.bb.GetInt(o + __p.bb_pos) : Global.EmblemCategory.None; } }
  ...
  public static Offset<Global.EmblemExcel> CreateEmblemExcel(FlatBufferBuilder builder,
      long Id = 0,
      Global.EmblemCategory Category = Global.EmblemCategory.None,
  ...
  public static Offset<Global.EmblemExcel> Pack(FlatBufferBuilder builder, EmblemExcelT _o) {
    if (_o == null) return default(Offset<Global.EmblemExcel>);
		byte[] key = TableEncryptionService.CreateKey("Emblem");
...
public class EmblemExcelT
{
  ...
  public Global.EmblemCategory Category { get; set; }
  ...
  public Global.EmblemCheckPassType CheckPassType { get; set; }
  public long EmblemParameter { get; set; }
  public long CheckPassCount { get; set; }

  public EmblemExcelT() {
    this.Id = 0;
    this.Category = Global.EmblemCategory.None;
    ...
    this.CheckPassType = Global.EmblemCheckPassType.None;
...
static public class EmblemExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*Category*/, 4 /*Global.EmblemCategory*/, 4, false)
