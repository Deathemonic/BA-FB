...
public struct StatLevelInterpolationExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.StatLevelInterpolationExcel> CreateStatLevelInterpolationExcel(FlatBufferBuilder builder,
      long Level = 0,
  ...
  public static Offset<Global.StatLevelInterpolationExcel> EndStatLevelInterpolationExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.StatLevelInterpolationExcel>(o);
  }
  ...
  public void UnPackTo(StatLevelInterpolationExcelT _o) {
    ...
    for (var _j = 0; _j < this.StatTypeIndexLength; ++_j) {_o.StatTypeIndex.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.StatTypeIndex(_j), key) : this.StatTypeIndex(_j));}
  }
  public static Offset<Global.StatLevelInterpolationExcel> Pack(FlatBufferBuilder builder, StatLevelInterpolationExcelT _o) {
    if (_o == null) return default(Offset<Global.StatLevelInterpolationExcel>);
		byte[] key = TableEncryptionService.CreateKey("StatLevelInterpolation");
    ...
    if (_o.StatTypeIndex != null) {
      var __StatTypeIndex = _o.StatTypeIndex.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
