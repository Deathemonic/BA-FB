...
public struct EventContentLocationExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(EventContentLocationExcelT _o) {
    ...
    _o.LocationResetScheduleCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.LocationResetScheduleCount, key) : this.LocationResetScheduleCount;
    _o.ScheduleEventPointCostParcelType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ScheduleEventPointCostParcelType, key) : this.ScheduleEventPointCostParcelType;
    _o.ScheduleEventPointCostParcelId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ScheduleEventPointCostParcelId, key) : this.ScheduleEventPointCostParcelId;
    _o.ScheduleEventPointCostParcelAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ScheduleEventPointCostParcelAmount, key) : this.ScheduleEventPointCostParcelAmount;
  ...
  public static Offset<Global.EventContentLocationExcel> Pack(FlatBufferBuilder builder, EventContentLocationExcelT _o) {
    ...
    var _PrefabPath = _o.PrefabPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.PrefabPath, key) : _o.PrefabPath));
		var _LocationResetScheduleCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.LocationResetScheduleCount, key) : _o.LocationResetScheduleCount;
		var _ScheduleEventPointCostParcelType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ScheduleEventPointCostParcelType, key) : _o.ScheduleEventPointCostParcelType;
		var _ScheduleEventPointCostParcelId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ScheduleEventPointCostParcelId, key) : _o.ScheduleEventPointCostParcelId;
		var _ScheduleEventPointCostParcelAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ScheduleEventPointCostParcelAmount, key) : _o.ScheduleEventPointCostParcelAmount;
		...
		var _InformationGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.InformationGroupId, key) : _o.InformationGroupId;
