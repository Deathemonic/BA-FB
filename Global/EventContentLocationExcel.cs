...
public struct EventContentLocationExcel : IFlatbufferObject
{
  ...
  public Global.ParcelType ScheduleEventPointCostParcelType { get { int o = __p.__offset(14); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Global.ParcelType.None; } }
  ...
  public static Offset<Global.EventContentLocationExcel> CreateEventContentLocationExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      long Id = 0,
      uint LocalizeEtcId = 0,
      StringOffset PrefabPathOffset = default(StringOffset),
      int LocationResetScheduleCount = 0,
      Global.ParcelType ScheduleEventPointCostParcelType = Global.ParcelType.None,
  ...
  public static void AddScheduleEventPointCostParcelType(FlatBufferBuilder builder, Global.ParcelType scheduleEventPointCostParcelType) { builder.AddInt(5, (int)scheduleEventPointCostParcelType, 0); }
  ...
  public static Offset<Global.EventContentLocationExcel> EndEventContentLocationExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.EventContentLocationExcel>(o);
  }
  ...
  public void UnPackTo(EventContentLocationExcelT _o) {
    ...
    _o.LocationResetScheduleCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.LocationResetScheduleCount, key) : this.LocationResetScheduleCount;
    _o.ScheduleEventPointCostParcelType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)this.ScheduleEventPointCostParcelType, key) : this.ScheduleEventPointCostParcelType;
    _o.ScheduleEventPointCostParcelId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ScheduleEventPointCostParcelId, key) : this.ScheduleEventPointCostParcelId;
    _o.ScheduleEventPointCostParcelAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ScheduleEventPointCostParcelAmount, key) : this.ScheduleEventPointCostParcelAmount;
  ...
  public static Offset<Global.EventContentLocationExcel> Pack(FlatBufferBuilder builder, EventContentLocationExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentLocationExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentLocation");
    ...
    var _PrefabPath = _o.PrefabPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.PrefabPath, key) : _o.PrefabPath));
		var _LocationResetScheduleCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.LocationResetScheduleCount, key) : _o.LocationResetScheduleCount;
		var _ScheduleEventPointCostParcelType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)_o.ScheduleEventPointCostParcelType, key) : _o.ScheduleEventPointCostParcelType;
		var _ScheduleEventPointCostParcelId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ScheduleEventPointCostParcelId, key) : _o.ScheduleEventPointCostParcelId;
		var _ScheduleEventPointCostParcelAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ScheduleEventPointCostParcelAmount, key) : _o.ScheduleEventPointCostParcelAmount;
    ...
    return CreateEventContentLocationExcel(
      ...
      _PrefabPath,
      TableEncryptionService.UseEncryption ? _LocationResetScheduleCount : _o.LocationResetScheduleCount,
      TableEncryptionService.UseEncryption ? _ScheduleEventPointCostParcelType : _o.ScheduleEventPointCostParcelType,
      TableEncryptionService.UseEncryption ? _ScheduleEventPointCostParcelId : _o.ScheduleEventPointCostParcelId,
      TableEncryptionService.UseEncryption ? _ScheduleEventPointCostParcelAmount : _o.ScheduleEventPointCostParcelAmount,
...
public class EventContentLocationExcelT
{
  ...
  public Global.ParcelType ScheduleEventPointCostParcelType { get; set; }
  ...
  public EventContentLocationExcelT() {
    ...
    this.ScheduleEventPointCostParcelType = Global.ParcelType.None;
...
static public class EventContentLocationExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 14 /*ScheduleEventPointCostParcelType*/, 4 /*Global.ParcelType*/, 4, false)
