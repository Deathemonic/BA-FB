...
public struct TutorialExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.TutorialExcel> CreateTutorialExcel(FlatBufferBuilder builder,
      long ID = 0,
  ...
  public static Offset<Global.TutorialExcel> EndTutorialExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.TutorialExcel>(o);
  }
  ...
  public void UnPackTo(TutorialExcelT _o) {
    ...
    _o.CompulsoryTutorial = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CompulsoryTutorial, key) : this.CompulsoryTutorial;
    _o.DescriptionTutorial = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.DescriptionTutorial, key) : this.DescriptionTutorial;
    _o.TutorialStageId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.TutorialStageId, key) : this.TutorialStageId;
  ...
  public static Offset<Global.TutorialExcel> Pack(FlatBufferBuilder builder, TutorialExcelT _o) {
    if (_o == null) return default(Offset<Global.TutorialExcel>);
		byte[] key = TableEncryptionService.CreateKey("Tutorial");
		var _ID = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ID, key) : _o.ID;
    var _CompletionReportEventName = _o.CompletionReportEventName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.CompletionReportEventName, key) : _o.CompletionReportEventName));
		var _CompulsoryTutorial = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CompulsoryTutorial, key) : _o.CompulsoryTutorial;
		var _DescriptionTutorial = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DescriptionTutorial, key) : _o.DescriptionTutorial;
		var _TutorialStageId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.TutorialStageId, key) : _o.TutorialStageId;
    var _UIName = default(VectorOffset);
    if (_o.UIName != null) {
      var __UIName = new StringOffset[_o.UIName.Count];
      for (var _j = 0; _j < __UIName.Length; ++_j) { __UIName[_j] = builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.UIName[_j], key) : _o.UIName[_j])); }
    ...
    if (_o.TutorialParentName != null) {
      ...
      for (var _j = 0; _j < __TutorialParentName.Length; ++_j) { __TutorialParentName[_j] = builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.TutorialParentName[_j], key) : _o.TutorialParentName[_j])); }
