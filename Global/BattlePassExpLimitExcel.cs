...
public struct BattlePassExpLimitExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.BattlePassExpLimitExcel> CreateBattlePassExpLimitExcel(FlatBufferBuilder builder,
      long BattlePassId = 0,
  ...
  public static Offset<Global.BattlePassExpLimitExcel> EndBattlePassExpLimitExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.BattlePassExpLimitExcel>(o);
  }
  ...
  public static Offset<Global.BattlePassExpLimitExcel> Pack(FlatBufferBuilder builder, BattlePassExpLimitExcelT _o) {
    if (_o == null) return default(Offset<Global.BattlePassExpLimitExcel>);
		byte[] key = TableEncryptionService.CreateKey("BattlePassExpLimit");
    ...
    var _LimitStartTime = _o.LimitStartTime == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.LimitStartTime, key) : _o.LimitStartTime));
    var _LimitEndTime = _o.LimitEndTime == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.LimitEndTime, key) : _o.LimitEndTime));
		var _ExpLimitAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ExpLimitAmount, key) : _o.ExpLimitAmount;
