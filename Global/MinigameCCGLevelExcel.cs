...
public struct MinigameCCGLevelExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.MinigameCCGLevelExcel> CreateMinigameCCGLevelExcel(FlatBufferBuilder builder,
      long LevelId = 0,
      long CCGId = 0,
      int FloorIndex = 0,
  ...
  public static Offset<Global.MinigameCCGLevelExcel> EndMinigameCCGLevelExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.MinigameCCGLevelExcel>(o);
  }
  ...
  public static Offset<Global.MinigameCCGLevelExcel> Pack(FlatBufferBuilder builder, MinigameCCGLevelExcelT _o) {
    if (_o == null) return default(Offset<Global.MinigameCCGLevelExcel>);
		byte[] key = TableEncryptionService.CreateKey("MinigameCCGLevel");
		...
		var _FloorIndex = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.FloorIndex, key) : _o.FloorIndex;
    var _BackgroundPath = _o.BackgroundPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.BackgroundPath, key) : _o.BackgroundPath));
