...
public struct CharacterCombatSkinExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.CharacterCombatSkinExcel> CreateCharacterCombatSkinExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.CharacterCombatSkinExcel> EndCharacterCombatSkinExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.CharacterCombatSkinExcel>(o);
  }
  ...
  public static Offset<Global.CharacterCombatSkinExcel> Pack(FlatBufferBuilder builder, CharacterCombatSkinExcelT _o) {
    if (_o == null) return default(Offset<Global.CharacterCombatSkinExcel>);
		byte[] key = TableEncryptionService.CreateKey("CharacterCombatSkin");
