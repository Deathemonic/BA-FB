...
public struct LocalizeCharProfileChangeExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.LocalizeCharProfileChangeExcel> CreateLocalizeCharProfileChangeExcel(FlatBufferBuilder builder,
      long CharacterId = 0,
  ...
  public static Offset<Global.LocalizeCharProfileChangeExcel> EndLocalizeCharProfileChangeExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.LocalizeCharProfileChangeExcel>(o);
  }
  ...
  public void UnPackTo(LocalizeCharProfileChangeExcelT _o) {
    ...
    _o.ChangeCharacterID = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ChangeCharacterID, key) : this.ChangeCharacterID;
  }
  public static Offset<Global.LocalizeCharProfileChangeExcel> Pack(FlatBufferBuilder builder, LocalizeCharProfileChangeExcelT _o) {
    if (_o == null) return default(Offset<Global.LocalizeCharProfileChangeExcel>);
		byte[] key = TableEncryptionService.CreateKey("LocalizeCharProfileChange");
		...
		var _ChangeCharacterID = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ChangeCharacterID, key) : _o.ChangeCharacterID;
    return CreateLocalizeCharProfileChangeExcel(
      ...
      TableEncryptionService.UseEncryption ? _ChangeCharacterID : _o.ChangeCharacterID);
  }
}
