...
public struct MinigameTBGVoiceExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(MinigameTBGVoiceExcelT _o) {
    ...
    _o.VoiceCondition = TableEncryptionService.UseEncryption ? (Global.TBGVoiceCondition)TableEncryptionService.Convert((int)this.VoiceCondition, key) : this.VoiceCondition;
  ...
  public static Offset<Global.MinigameTBGVoiceExcel> Pack(FlatBufferBuilder builder, MinigameTBGVoiceExcelT _o) {
    if (_o == null) return default(Offset<Global.MinigameTBGVoiceExcel>);
		...
		var _VoiceCondition = TableEncryptionService.UseEncryption ? (Global.TBGVoiceCondition)TableEncryptionService.Convert((int)_o.VoiceCondition, key) : _o.VoiceCondition;
