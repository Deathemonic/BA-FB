...
public struct MinigameTBGVoiceExcel : IFlatbufferObject
{
  ...
  public Global.TBGVoiceCondition VoiceCondition { get { int o = __p.__offset(8); return o != 0 ? (Global.TBGVoiceCondition)__p.bb.GetInt(o + __p.bb_pos) : Global.TBGVoiceCondition.None; } }
  public uint VoiceId { get { int o = __p.__offset(10); return o != 0 ? __p.bb.GetUint(o + __p.bb_pos) : (uint)0; } }

  public static Offset<Global.MinigameTBGVoiceExcel> CreateMinigameTBGVoiceExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      long UniqueId = 0,
      Global.TBGVoiceCondition VoiceCondition = Global.TBGVoiceCondition.None,
      uint VoiceId = 0) {
  ...
  public static void AddVoiceCondition(FlatBufferBuilder builder, Global.TBGVoiceCondition voiceCondition) { builder.AddInt(2, (int)voiceCondition, 0); }
  public static void AddVoiceId(FlatBufferBuilder builder, uint voiceId) { builder.AddUint(3, voiceId, 0); }
  public static Offset<Global.MinigameTBGVoiceExcel> EndMinigameTBGVoiceExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.MinigameTBGVoiceExcel>(o);
  }
  ...
  public static Offset<Global.MinigameTBGVoiceExcel> Pack(FlatBufferBuilder builder, MinigameTBGVoiceExcelT _o) {
    if (_o == null) return default(Offset<Global.MinigameTBGVoiceExcel>);
		byte[] key = TableEncryptionService.CreateKey("MinigameTBGVoice");
...
public class MinigameTBGVoiceExcelT
{
  ...
  public Global.TBGVoiceCondition VoiceCondition { get; set; }
  public uint VoiceId { get; set; }

  public MinigameTBGVoiceExcelT() {
    this.EventContentId = 0;
    this.UniqueId = 0;
    this.VoiceCondition = Global.TBGVoiceCondition.None;
    this.VoiceId = 0;
  }
}
...
static public class MinigameTBGVoiceExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*VoiceCondition*/, 4 /*Global.TBGVoiceCondition*/, 4, false)
