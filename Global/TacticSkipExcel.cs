...
public struct TacticSkipExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.TacticSkipExcel> CreateTacticSkipExcel(FlatBufferBuilder builder,
      int LevelDiff = 0,
      long HPResult = 0) {
  ...
  public static Offset<Global.TacticSkipExcel> EndTacticSkipExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.TacticSkipExcel>(o);
  }
  ...
  public void UnPackTo(TacticSkipExcelT _o) {
    ...
    _o.LevelDiff = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.LevelDiff, key) : this.LevelDiff;
    _o.HPResult = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.HPResult, key) : this.HPResult;
  }
  public static Offset<Global.TacticSkipExcel> Pack(FlatBufferBuilder builder, TacticSkipExcelT _o) {
    if (_o == null) return default(Offset<Global.TacticSkipExcel>);
		byte[] key = TableEncryptionService.CreateKey("TacticSkip");
		var _LevelDiff = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.LevelDiff, key) : _o.LevelDiff;
		var _HPResult = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.HPResult, key) : _o.HPResult;
    return CreateTacticSkipExcel(
      builder,
      TableEncryptionService.UseEncryption ? _LevelDiff : _o.LevelDiff,
      TableEncryptionService.UseEncryption ? _HPResult : _o.HPResult);
  }
}
