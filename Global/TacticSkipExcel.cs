...
public struct TacticSkipExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(TacticSkipExcelT _o) {
    ...
    _o.LevelDiff = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.LevelDiff, key) : this.LevelDiff;
    _o.HPResult = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.HPResult, key) : this.HPResult;
  }
  public static Offset<Global.TacticSkipExcel> Pack(FlatBufferBuilder builder, TacticSkipExcelT _o) {
    if (_o == null) return default(Offset<Global.TacticSkipExcel>);
		byte[] key = TableEncryptionService.CreateKey("TacticSkip");
		var _LevelDiff = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.LevelDiff, key) : _o.LevelDiff;
		var _HPResult = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.HPResult, key) : _o.HPResult;
