...
public struct CharacterIllustCoordinateExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.CharacterIllustCoordinateExcel> CreateCharacterIllustCoordinateExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Global.CharacterIllustCoordinateExcel> EndCharacterIllustCoordinateExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.CharacterIllustCoordinateExcel>(o);
  }
  ...
  public void UnPackTo(CharacterIllustCoordinateExcelT _o) {
    ...
    _o.CharacterBodyCenterX = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CharacterBodyCenterX, key) : this.CharacterBodyCenterX;
    _o.CharacterBodyCenterY = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CharacterBodyCenterY, key) : this.CharacterBodyCenterY;
    _o.DefaultScale = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.DefaultScale, key) : this.DefaultScale;
    _o.MinScale = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MinScale, key) : this.MinScale;
    _o.MaxScale = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MaxScale, key) : this.MaxScale;
  }
  public static Offset<Global.CharacterIllustCoordinateExcel> Pack(FlatBufferBuilder builder, CharacterIllustCoordinateExcelT _o) {
    if (_o == null) return default(Offset<Global.CharacterIllustCoordinateExcel>);
		byte[] key = TableEncryptionService.CreateKey("CharacterIllustCoordinate");
		var _Id = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Id, key) : _o.Id;
		var _CharacterBodyCenterX = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CharacterBodyCenterX, key) : _o.CharacterBodyCenterX;
		var _CharacterBodyCenterY = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CharacterBodyCenterY, key) : _o.CharacterBodyCenterY;
		var _DefaultScale = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DefaultScale, key) : _o.DefaultScale;
		var _MinScale = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MinScale, key) : _o.MinScale;
		var _MaxScale = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MaxScale, key) : _o.MaxScale;
