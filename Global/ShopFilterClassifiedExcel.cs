...
public struct ShopFilterClassifiedExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ShopFilterClassifiedExcelT _o) {
    ...
    _o.ConsumeParcelType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)this.ConsumeParcelType, key) : this.ConsumeParcelType;
    ...
    _o.ShopFilterType = TableEncryptionService.UseEncryption ? (Global.ShopFilterType)TableEncryptionService.Convert((int)this.ShopFilterType, key) : this.ShopFilterType;
  ...
  public static Offset<Global.ShopFilterClassifiedExcel> Pack(FlatBufferBuilder builder, ShopFilterClassifiedExcelT _o) {
    if (_o == null) return default(Offset<Global.ShopFilterClassifiedExcel>);
		...
		var _ConsumeParcelType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)_o.ConsumeParcelType, key) : _o.ConsumeParcelType;
		...
		var _ShopFilterType = TableEncryptionService.UseEncryption ? (Global.ShopFilterType)TableEncryptionService.Convert((int)_o.ShopFilterType, key) : _o.ShopFilterType;
