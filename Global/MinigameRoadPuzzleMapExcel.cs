...
public struct MinigameRoadPuzzleMapExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.MinigameRoadPuzzleMapExcel> CreateMinigameRoadPuzzleMapExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.MinigameRoadPuzzleMapExcel> EndMinigameRoadPuzzleMapExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.MinigameRoadPuzzleMapExcel>(o);
  }
  ...
  public static Offset<Global.MinigameRoadPuzzleMapExcel> Pack(FlatBufferBuilder builder, MinigameRoadPuzzleMapExcelT _o) {
    if (_o == null) return default(Offset<Global.MinigameRoadPuzzleMapExcel>);
		byte[] key = TableEncryptionService.CreateKey("MinigameRoadPuzzleMap");
    ...
    var _Map = _o.Map == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.Map, key) : _o.Map));
    var _MapBG = _o.MapBG == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.MapBG, key) : _o.MapBG));
    ...
    if (_o.AvailableRailTile != null) {
      var __AvailableRailTile = _o.AvailableRailTile.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.AvailableRailTileAmount != null) {
      var __AvailableRailTileAmount = _o.AvailableRailTileAmount.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.OriginalTileCount != null) {
      var __OriginalTileCount = _o.OriginalTileCount.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
      _OriginalTileCount = CreateOriginalTileCountVector(builder, __OriginalTileCount);
    }
		var _TrainSpeed = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.TrainSpeed, key) : _o.TrainSpeed;
