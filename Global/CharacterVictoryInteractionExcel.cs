...
public struct CharacterVictoryInteractionExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(CharacterVictoryInteractionExcelT _o) {
    ...
    _o.InteractionId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.InteractionId, key) : this.InteractionId;
    _o.CostumeId01 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CostumeId01, key) : this.CostumeId01;
    _o.PositionIndex01 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.PositionIndex01, key) : this.PositionIndex01;
    ...
    _o.VoiceEvent01 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.VoiceEvent01, key) : this.VoiceEvent01;
    _o.CostumeId02 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CostumeId02, key) : this.CostumeId02;
    _o.PositionIndex02 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.PositionIndex02, key) : this.PositionIndex02;
    ...
    _o.VoiceEvent02 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.VoiceEvent02, key) : this.VoiceEvent02;
    _o.CostumeId03 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CostumeId03, key) : this.CostumeId03;
    _o.PositionIndex03 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.PositionIndex03, key) : this.PositionIndex03;
    ...
    _o.VoiceEvent03 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.VoiceEvent03, key) : this.VoiceEvent03;
    _o.CostumeId04 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CostumeId04, key) : this.CostumeId04;
    _o.PositionIndex04 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.PositionIndex04, key) : this.PositionIndex04;
    ...
    _o.VoiceEvent04 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.VoiceEvent04, key) : this.VoiceEvent04;
    _o.CostumeId05 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CostumeId05, key) : this.CostumeId05;
    _o.PositionIndex05 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.PositionIndex05, key) : this.PositionIndex05;
    ...
    _o.VoiceEvent05 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.VoiceEvent05, key) : this.VoiceEvent05;
    _o.CostumeId06 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CostumeId06, key) : this.CostumeId06;
    _o.PositionIndex06 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.PositionIndex06, key) : this.PositionIndex06;
    ...
    _o.VoiceEvent06 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.VoiceEvent06, key) : this.VoiceEvent06;
  }
  public static Offset<Global.CharacterVictoryInteractionExcel> Pack(FlatBufferBuilder builder, CharacterVictoryInteractionExcelT _o) {
    if (_o == null) return default(Offset<Global.CharacterVictoryInteractionExcel>);
		byte[] key = TableEncryptionService.CreateKey("CharacterVictoryInteraction");
		var _InteractionId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.InteractionId, key) : _o.InteractionId;
		var _CostumeId01 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CostumeId01, key) : _o.CostumeId01;
		var _PositionIndex01 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PositionIndex01, key) : _o.PositionIndex01;
    var _VictoryStartAnimationPath01 = _o.VictoryStartAnimationPath01 == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.VictoryStartAnimationPath01, key) : _o.VictoryStartAnimationPath01));
    var _VictoryEndAnimationPath01 = _o.VictoryEndAnimationPath01 == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.VictoryEndAnimationPath01, key) : _o.VictoryEndAnimationPath01));
		var _VoiceEvent01 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.VoiceEvent01, key) : _o.VoiceEvent01;
		var _CostumeId02 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CostumeId02, key) : _o.CostumeId02;
		var _PositionIndex02 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PositionIndex02, key) : _o.PositionIndex02;
    var _VictoryStartAnimationPath02 = _o.VictoryStartAnimationPath02 == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.VictoryStartAnimationPath02, key) : _o.VictoryStartAnimationPath02));
    var _VictoryEndAnimationPath02 = _o.VictoryEndAnimationPath02 == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.VictoryEndAnimationPath02, key) : _o.VictoryEndAnimationPath02));
		var _VoiceEvent02 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.VoiceEvent02, key) : _o.VoiceEvent02;
		var _CostumeId03 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CostumeId03, key) : _o.CostumeId03;
		var _PositionIndex03 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PositionIndex03, key) : _o.PositionIndex03;
    var _VictoryStartAnimationPath03 = _o.VictoryStartAnimationPath03 == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.VictoryStartAnimationPath03, key) : _o.VictoryStartAnimationPath03));
    var _VictoryEndAnimationPath03 = _o.VictoryEndAnimationPath03 == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.VictoryEndAnimationPath03, key) : _o.VictoryEndAnimationPath03));
		var _VoiceEvent03 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.VoiceEvent03, key) : _o.VoiceEvent03;
		var _CostumeId04 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CostumeId04, key) : _o.CostumeId04;
		var _PositionIndex04 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PositionIndex04, key) : _o.PositionIndex04;
    var _VictoryStartAnimationPath04 = _o.VictoryStartAnimationPath04 == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.VictoryStartAnimationPath04, key) : _o.VictoryStartAnimationPath04));
    var _VictoryEndAnimationPath04 = _o.VictoryEndAnimationPath04 == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.VictoryEndAnimationPath04, key) : _o.VictoryEndAnimationPath04));
		var _VoiceEvent04 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.VoiceEvent04, key) : _o.VoiceEvent04;
		var _CostumeId05 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CostumeId05, key) : _o.CostumeId05;
		var _PositionIndex05 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PositionIndex05, key) : _o.PositionIndex05;
    var _VictoryStartAnimationPath05 = _o.VictoryStartAnimationPath05 == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.VictoryStartAnimationPath05, key) : _o.VictoryStartAnimationPath05));
    var _VictoryEndAnimationPath05 = _o.VictoryEndAnimationPath05 == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.VictoryEndAnimationPath05, key) : _o.VictoryEndAnimationPath05));
		var _VoiceEvent05 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.VoiceEvent05, key) : _o.VoiceEvent05;
		var _CostumeId06 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CostumeId06, key) : _o.CostumeId06;
		var _PositionIndex06 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PositionIndex06, key) : _o.PositionIndex06;
    var _VictoryStartAnimationPath06 = _o.VictoryStartAnimationPath06 == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.VictoryStartAnimationPath06, key) : _o.VictoryStartAnimationPath06));
    var _VictoryEndAnimationPath06 = _o.VictoryEndAnimationPath06 == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.VictoryEndAnimationPath06, key) : _o.VictoryEndAnimationPath06));
		var _VoiceEvent06 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.VoiceEvent06, key) : _o.VoiceEvent06;
