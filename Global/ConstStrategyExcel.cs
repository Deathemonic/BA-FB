...
public struct ConstStrategyExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ConstStrategyExcelT _o) {
    ...
    _o.HealCostType = TableEncryptionService.UseEncryption ? (Global.CurrencyTypes)TableEncryptionService.Convert((int)this.HealCostType, key) : this.HealCostType;
    ...
    _o.MultiSweepPresetNameMaxLengthKr = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.MultiSweepPresetNameMaxLengthKr, key) : this.MultiSweepPresetNameMaxLengthKr;
  ...
  public static Offset<Global.ConstStrategyExcel> Pack(FlatBufferBuilder builder, ConstStrategyExcelT _o) {
    if (_o == null) return default(Offset<Global.ConstStrategyExcel>);
		...
		var _HealCostType = TableEncryptionService.UseEncryption ? (Global.CurrencyTypes)TableEncryptionService.Convert((int)_o.HealCostType, key) : _o.HealCostType;
    ...
    if (_o.HealCostAmount != null) {
      ...
      _healCostAmount = CreateHealCostAmountVector(builder, __healCostAmount);
		...
		var _MultiSweepPresetNameMaxLengthKr = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.MultiSweepPresetNameMaxLengthKr, key) : _o.MultiSweepPresetNameMaxLengthKr;
