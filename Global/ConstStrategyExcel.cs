...
public struct ConstStrategyExcel : IFlatbufferObject
{
  ...
  public Global.CurrencyTypes HealCostType { get { int o = __p.__offset(14); return o != 0 ? (Global.CurrencyTypes)__p.bb.GetInt(o + __p.bb_pos) : Global.CurrencyTypes.Invalid; } }
  ...
  public static Offset<Global.ConstStrategyExcel> CreateConstStrategyExcel(FlatBufferBuilder builder,
  ...
  public static void AddHealCostType(FlatBufferBuilder builder, Global.CurrencyTypes healCostType) { builder.AddInt(5, (int)healCostType, 0); }
  ...
  public static Offset<Global.ConstStrategyExcel> EndConstStrategyExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.ConstStrategyExcel>(o);
  }
  ...
  public static Offset<Global.ConstStrategyExcel> Pack(FlatBufferBuilder builder, ConstStrategyExcelT _o) {
    if (_o == null) return default(Offset<Global.ConstStrategyExcel>);
		byte[] key = TableEncryptionService.CreateKey("ConstStrategy");
		var _HexaMapBoundaryOffset = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.HexaMapBoundaryOffset, key) : _o.HexaMapBoundaryOffset;
		var _HexaMapStartCameraOffset = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.HexaMapStartCameraOffset, key) : _o.HexaMapStartCameraOffset;
    ...
    if (_o.HealCostAmount != null) {
      ...
      _healCostAmount = CreateHealCostAmountVector(builder, __healCostAmount);
		...
		var _AdventureEchelonCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.AdventureEchelonCount, key) : _o.AdventureEchelonCount;
		var _RaidEchelonCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RaidEchelonCount, key) : _o.RaidEchelonCount;
		var _DefaultEchelonCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DefaultEchelonCount, key) : _o.DefaultEchelonCount;
		var _EventContentEchelonCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EventContentEchelonCount, key) : _o.EventContentEchelonCount;
		var _TimeAttackDungeonEchelonCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.TimeAttackDungeonEchelonCount, key) : _o.TimeAttackDungeonEchelonCount;
		var _WorldRaidEchelonCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.WorldRaidEchelonCount, key) : _o.WorldRaidEchelonCount;
		var _TacticSkipClearTimeSeconds = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.TacticSkipClearTimeSeconds, key) : _o.TacticSkipClearTimeSeconds;
		var _TacticSkipFramePerSecond = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.TacticSkipFramePerSecond, key) : _o.TacticSkipFramePerSecond;
		var _ConquestEchelonCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ConquestEchelonCount, key) : _o.ConquestEchelonCount;
		var _StoryEchelonCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StoryEchelonCount, key) : _o.StoryEchelonCount;
		var _MultiSweepPresetCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MultiSweepPresetCount, key) : _o.MultiSweepPresetCount;
		var _MultiSweepPresetNameMaxLength = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MultiSweepPresetNameMaxLength, key) : _o.MultiSweepPresetNameMaxLength;
		var _MultiSweepPresetNameMaxLengthKr = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MultiSweepPresetNameMaxLengthKr, key) : _o.MultiSweepPresetNameMaxLengthKr;
		var _MultiSweepPresetSelectStageMaxCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MultiSweepPresetSelectStageMaxCount, key) : _o.MultiSweepPresetSelectStageMaxCount;
		var _MultiSweepPresetMaxSweepCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MultiSweepPresetMaxSweepCount, key) : _o.MultiSweepPresetMaxSweepCount;
		var _MultiSweepPresetSelectParcelMaxCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MultiSweepPresetSelectParcelMaxCount, key) : _o.MultiSweepPresetSelectParcelMaxCount;
    return CreateConstStrategyExcel(
      ...
      TableEncryptionService.UseEncryption ? _MultiSweepPresetNameMaxLengthKr : _o.MultiSweepPresetNameMaxLengthKr,
...
public class ConstStrategyExcelT
{
  ...
  public Global.CurrencyTypes HealCostType { get; set; }
  ...
  public ConstStrategyExcelT() {
    ...
    this.HealCostType = Global.CurrencyTypes.Invalid;
...
static public class ConstStrategyExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 14 /*HealCostType*/, 4 /*Global.CurrencyTypes*/, 4, false)
