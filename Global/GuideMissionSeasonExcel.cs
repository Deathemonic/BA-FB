...
public struct GuideMissionSeasonExcel : IFlatbufferObject
{
  ...
  public Global.AccountState AccountType { get { int o = __p.__offset(12); return o != 0 ? (Global.AccountState)__p.bb.GetInt(o + __p.bb_pos) : Global.AccountState.WaitingSignIn; } }
  ...
  public Global.ParcelType RequirementParcelType { get { int o = __p.__offset(42); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Global.ParcelType.None; } }
  ...
  public Global.GuideMissionTabType TabType { get { int o = __p.__offset(48); return o != 0 ? (Global.GuideMissionTabType)__p.bb.GetInt(o + __p.bb_pos) : Global.GuideMissionTabType.None; } }
  ...
  public static Offset<Global.GuideMissionSeasonExcel> CreateGuideMissionSeasonExcel(FlatBufferBuilder builder,
      long Id = 0,
      ...
      Global.ParcelType RequirementParcelType = Global.ParcelType.None,
      long RequirementParcelId = 0,
      int RequirementParcelAmount = 0,
      Global.GuideMissionTabType TabType = Global.GuideMissionTabType.None,
  ...
  public static void AddAccountType(FlatBufferBuilder builder, Global.AccountState accountType) { builder.AddInt(4, (int)accountType, 0); }
  ...
  public static void AddRequirementParcelType(FlatBufferBuilder builder, Global.ParcelType requirementParcelType) { builder.AddInt(19, (int)requirementParcelType, 0); }
  ...
  public static void AddTabType(FlatBufferBuilder builder, Global.GuideMissionTabType tabType) { builder.AddInt(22, (int)tabType, 0); }
  ...
  public static Offset<Global.GuideMissionSeasonExcel> EndGuideMissionSeasonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.GuideMissionSeasonExcel>(o);
  }
  ...
  public void UnPackTo(GuideMissionSeasonExcelT _o) {
    ...
    _o.RequirementParcelType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)this.RequirementParcelType, key) : this.RequirementParcelType;
    ...
    _o.TabType = TableEncryptionService.UseEncryption ? (Global.GuideMissionTabType)TableEncryptionService.Convert((int)this.TabType, key) : this.TabType;
  ...
  public static Offset<Global.GuideMissionSeasonExcel> Pack(FlatBufferBuilder builder, GuideMissionSeasonExcelT _o) {
    if (_o == null) return default(Offset<Global.GuideMissionSeasonExcel>);
		byte[] key = TableEncryptionService.CreateKey("GuideMissionSeason");
    ...
    var _TitleImage = _o.TitleImage == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.TitleImage, key) : _o.TitleImage));
		var _RequirementParcelType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)_o.RequirementParcelType, key) : _o.RequirementParcelType;
		...
		var _TabType = TableEncryptionService.UseEncryption ? (Global.GuideMissionTabType)TableEncryptionService.Convert((int)_o.TabType, key) : _o.TabType;
...
public class GuideMissionSeasonExcelT
{
  ...
  public Global.ParcelType RequirementParcelType { get; set; }
  public long RequirementParcelId { get; set; }
  public int RequirementParcelAmount { get; set; }
  public Global.GuideMissionTabType TabType { get; set; }
  ...
  public GuideMissionSeasonExcelT() {
    ...
    this.RequirementParcelType = Global.ParcelType.None;
    this.RequirementParcelId = 0;
    this.RequirementParcelAmount = 0;
    this.TabType = Global.GuideMissionTabType.None;
...
static public class GuideMissionSeasonExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*AccountType*/, 4 /*Global.AccountState*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 42 /*RequirementParcelType*/, 4 /*Global.ParcelType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 48 /*TabType*/, 4 /*Global.GuideMissionTabType*/, 4, false)
