...
public struct ConstMiniGameShootingExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.ConstMiniGameShootingExcel> CreateConstMiniGameShootingExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.ConstMiniGameShootingExcel> EndConstMiniGameShootingExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.ConstMiniGameShootingExcel>(o);
  }
  ...
  public void UnPackTo(ConstMiniGameShootingExcelT _o) {
    ...
    _o.NormalStageId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.NormalStageId, key) : this.NormalStageId;
    _o.NormalSectionCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.NormalSectionCount, key) : this.NormalSectionCount;
    _o.HardStageId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.HardStageId, key) : this.HardStageId;
    _o.HardSectionCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.HardSectionCount, key) : this.HardSectionCount;
    _o.FreeStageId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.FreeStageId, key) : this.FreeStageId;
    _o.FreeSectionCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.FreeSectionCount, key) : this.FreeSectionCount;
    _o.PlayerCharacterId = new List<long>();
    for (var _j = 0; _j < this.PlayerCharacterIdLength; ++_j) {_o.PlayerCharacterId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.PlayerCharacterId(_j), key) : this.PlayerCharacterId(_j));}
    _o.HiddenPlayerCharacterId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.HiddenPlayerCharacterId, key) : this.HiddenPlayerCharacterId;
    _o.CameraSmoothTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)this.CameraSmoothTime, key) : this.CameraSmoothTime;
    _o.SpawnEffectPath = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SpawnEffectPath, key) : this.SpawnEffectPath;
    _o.WaitTimeAfterSpawn = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)this.WaitTimeAfterSpawn, key) : this.WaitTimeAfterSpawn;
    _o.FreeGearInterval = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.FreeGearInterval, key) : this.FreeGearInterval;
  }
  public static Offset<Global.ConstMiniGameShootingExcel> Pack(FlatBufferBuilder builder, ConstMiniGameShootingExcelT _o) {
    if (_o == null) return default(Offset<Global.ConstMiniGameShootingExcel>);
		byte[] key = TableEncryptionService.CreateKey("ConstMiniGameShooting");
		var _NormalStageId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.NormalStageId, key) : _o.NormalStageId;
		var _NormalSectionCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.NormalSectionCount, key) : _o.NormalSectionCount;
		var _HardStageId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.HardStageId, key) : _o.HardStageId;
		var _HardSectionCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.HardSectionCount, key) : _o.HardSectionCount;
		var _FreeStageId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.FreeStageId, key) : _o.FreeStageId;
		var _FreeSectionCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.FreeSectionCount, key) : _o.FreeSectionCount;
    var _playerCharacterId = default(VectorOffset);
    if (_o.PlayerCharacterId != null) {
      var __playerCharacterId = _o.PlayerCharacterId.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
      _playerCharacterId = CreatePlayerCharacterIdVector(builder, __playerCharacterId);
    }
		var _HiddenPlayerCharacterId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.HiddenPlayerCharacterId, key) : _o.HiddenPlayerCharacterId;
		var _CameraSmoothTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)_o.CameraSmoothTime, key) : _o.CameraSmoothTime;
    var _SpawnEffectPath = _o.SpawnEffectPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.SpawnEffectPath, key) : _o.SpawnEffectPath));
		var _WaitTimeAfterSpawn = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)_o.WaitTimeAfterSpawn, key) : _o.WaitTimeAfterSpawn;
		var _FreeGearInterval = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.FreeGearInterval, key) : _o.FreeGearInterval;
    return CreateConstMiniGameShootingExcel(
      builder,
      TableEncryptionService.UseEncryption ? _NormalStageId : _o.NormalStageId,
      TableEncryptionService.UseEncryption ? _NormalSectionCount : _o.NormalSectionCount,
      TableEncryptionService.UseEncryption ? _HardStageId : _o.HardStageId,
      ...
      _SpawnEffectPath,
      TableEncryptionService.UseEncryption ? _WaitTimeAfterSpawn : _o.WaitTimeAfterSpawn,
      TableEncryptionService.UseEncryption ? _FreeGearInterval : _o.FreeGearInterval);
  }
}
