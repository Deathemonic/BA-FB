...
public struct ConstMiniGameShootingExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ConstMiniGameShootingExcelT _o) {
    ...
    _o.NormalStageId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.NormalStageId, key) : this.NormalStageId;
    _o.NormalSectionCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.NormalSectionCount, key) : this.NormalSectionCount;
    _o.HardStageId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.HardStageId, key) : this.HardStageId;
    _o.HardSectionCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.HardSectionCount, key) : this.HardSectionCount;
    _o.FreeStageId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.FreeStageId, key) : this.FreeStageId;
    _o.FreeSectionCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.FreeSectionCount, key) : this.FreeSectionCount;
    _o.PlayerCharacterId = new List<long>();
    for (var _j = 0; _j < this.PlayerCharacterIdLength; ++_j) {_o.PlayerCharacterId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.PlayerCharacterId(_j), key) : this.PlayerCharacterId(_j));}
    _o.HiddenPlayerCharacterId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.HiddenPlayerCharacterId, key) : this.HiddenPlayerCharacterId;
    _o.CameraSmoothTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CameraSmoothTime, key) : this.CameraSmoothTime;
    ...
    _o.WaitTimeAfterSpawn = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.WaitTimeAfterSpawn, key) : this.WaitTimeAfterSpawn;
    _o.FreeGearInterval = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.FreeGearInterval, key) : this.FreeGearInterval;
  }
  public static Offset<Global.ConstMiniGameShootingExcel> Pack(FlatBufferBuilder builder, ConstMiniGameShootingExcelT _o) {
    if (_o == null) return default(Offset<Global.ConstMiniGameShootingExcel>);
		byte[] key = TableEncryptionService.CreateKey("ConstMiniGameShooting");
		var _NormalStageId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.NormalStageId, key) : _o.NormalStageId;
		var _NormalSectionCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.NormalSectionCount, key) : _o.NormalSectionCount;
		var _HardStageId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.HardStageId, key) : _o.HardStageId;
    ...
    var _SpawnEffectPath = _o.SpawnEffectPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.SpawnEffectPath, key) : _o.SpawnEffectPath));
		var _WaitTimeAfterSpawn = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.WaitTimeAfterSpawn, key) : _o.WaitTimeAfterSpawn;
		var _FreeGearInterval = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.FreeGearInterval, key) : _o.FreeGearInterval;
