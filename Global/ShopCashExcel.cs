...
public struct ShopCashExcel : IFlatbufferObject
{
  ...
  public Global.PurchaseSourceType PackageType { get { int o = __p.__offset(8); return o != 0 ? (Global.PurchaseSourceType)__p.bb.GetInt(o + __p.bb_pos) : Global.PurchaseSourceType.None; } }
  ...
  public Global.ProductCategory CategoryType { get { int o = __p.__offset(18); return o != 0 ? (Global.ProductCategory)__p.bb.GetInt(o + __p.bb_pos) : Global.ProductCategory.None; } }
  public Global.ProductDisplayTag DisplayTag { get { int o = __p.__offset(20); return o != 0 ? (Global.ProductDisplayTag)__p.bb.GetInt(o + __p.bb_pos) : Global.ProductDisplayTag.None; } }
  ...
  public Global.PurchaseSourceType PackageClientType { get { int o = __p.__offset(38); return o != 0 ? (Global.PurchaseSourceType)__p.bb.GetInt(o + __p.bb_pos) : Global.PurchaseSourceType.None; } }
  ...
  public static Offset<Global.ShopCashExcel> CreateShopCashExcel(FlatBufferBuilder builder,
      long Id = 0,
      long CashProductId = 0,
      Global.PurchaseSourceType PackageType = Global.PurchaseSourceType.None,
      uint LocalizeEtcId = 0,
      StringOffset IconPathOffset = default(StringOffset),
      long DisplayOrder = 0,
      long RenewalDisplayOrder = 0,
      Global.ProductCategory CategoryType = Global.ProductCategory.None,
      ...
      Global.PurchaseSourceType PackageClientType = Global.PurchaseSourceType.None,
  ...
  public static void AddPackageType(FlatBufferBuilder builder, Global.PurchaseSourceType packageType) { builder.AddInt(2, (int)packageType, 0); }
  ...
  public static void AddCategoryType(FlatBufferBuilder builder, Global.ProductCategory categoryType) { builder.AddInt(7, (int)categoryType, 0); }
  public static void AddDisplayTag(FlatBufferBuilder builder, Global.ProductDisplayTag displayTag) { builder.AddInt(8, (int)displayTag, 0); }
  ...
  public static void AddPackageClientType(FlatBufferBuilder builder, Global.PurchaseSourceType packageClientType) { builder.AddInt(17, (int)packageClientType, 0); }
  ...
  public static Offset<Global.ShopCashExcel> EndShopCashExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.ShopCashExcel>(o);
  }
  ...
  public static Offset<Global.ShopCashExcel> Pack(FlatBufferBuilder builder, ShopCashExcelT _o) {
    if (_o == null) return default(Offset<Global.ShopCashExcel>);
		byte[] key = TableEncryptionService.CreateKey("ShopCash");
		var _Id = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Id, key) : _o.Id;
		var _CashProductId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CashProductId, key) : _o.CashProductId;
		var _PackageType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PackageType, key) : _o.PackageType;
    ...
    var _IconPath = _o.IconPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.IconPath, key) : _o.IconPath));
		...
		var _RenewalDisplayOrder = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RenewalDisplayOrder, key) : _o.RenewalDisplayOrder;
    ...
    var _SalePeriodTo = _o.SalePeriodTo == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.SalePeriodTo, key) : _o.SalePeriodTo));
		var _PeriodTag = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PeriodTag, key) : _o.PeriodTag;
		...
		var _AccountLevelHide = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.AccountLevelHide, key) : _o.AccountLevelHide;
		var _ClearMissionLimit = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ClearMissionLimit, key) : _o.ClearMissionLimit;
		var _ClearMissionHide = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ClearMissionHide, key) : _o.ClearMissionHide;
    var _PurchaseReportEventName = _o.PurchaseReportEventName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.PurchaseReportEventName, key) : _o.PurchaseReportEventName));
		var _PackageClientType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PackageClientType, key) : _o.PackageClientType;
		var _IsStartDash = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IsStartDash, key) : _o.IsStartDash;
    ...
    return CreateShopCashExcel(
      ...
      TableEncryptionService.UseEncryption ? _PackageClientType : _o.PackageClientType,
      TableEncryptionService.UseEncryption ? _IsStartDash : _o.IsStartDash,
...
public class ShopCashExcelT
{
  ...
  public Global.PurchaseSourceType PackageType { get; set; }
  public uint LocalizeEtcId { get; set; }
  public string IconPath { get; set; }
  public long DisplayOrder { get; set; }
  public long RenewalDisplayOrder { get; set; }
  public Global.ProductCategory CategoryType { get; set; }
  ...
  public Global.PurchaseSourceType PackageClientType { get; set; }
  ...
  public ShopCashExcelT() {
    ...
    this.PackageType = Global.PurchaseSourceType.None;
    this.LocalizeEtcId = 0;
    this.IconPath = null;
    this.DisplayOrder = 0;
    this.RenewalDisplayOrder = 0;
    this.CategoryType = Global.ProductCategory.None;
    ...
    this.PackageClientType = Global.PurchaseSourceType.None;
...
static public class ShopCashExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*PackageType*/, 4 /*Global.PurchaseSourceType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 18 /*CategoryType*/, 4 /*Global.ProductCategory*/, 4, false)
      && verifier.VerifyField(tablePos, 20 /*DisplayTag*/, 4 /*Global.ProductDisplayTag*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 38 /*PackageClientType*/, 4 /*Global.PurchaseSourceType*/, 4, false)
