...
public struct ShopCashExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ShopCashExcelT _o) {
    ...
    _o.PackageType = TableEncryptionService.UseEncryption ? (Global.PurchaseSourceType)TableEncryptionService.Convert((int)this.PackageType, key) : this.PackageType;
    ...
    _o.CategoryType = TableEncryptionService.UseEncryption ? (Global.ProductCategory)TableEncryptionService.Convert((int)this.CategoryType, key) : this.CategoryType;
    _o.DisplayTag = TableEncryptionService.UseEncryption ? (Global.ProductDisplayTag)TableEncryptionService.Convert((int)this.DisplayTag, key) : this.DisplayTag;
    ...
    _o.PackageClientType = TableEncryptionService.UseEncryption ? (Global.PurchaseSourceType)TableEncryptionService.Convert((int)this.PackageClientType, key) : this.PackageClientType;
    _o.IsStartDash = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.IsStartDash, key) : this.IsStartDash;
  ...
  public static Offset<Global.ShopCashExcel> Pack(FlatBufferBuilder builder, ShopCashExcelT _o) {
    if (_o == null) return default(Offset<Global.ShopCashExcel>);
		...
		var _PackageType = TableEncryptionService.UseEncryption ? (Global.PurchaseSourceType)TableEncryptionService.Convert((int)_o.PackageType, key) : _o.PackageType;
    ...
    var _IconPath = _o.IconPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.IconPath, key) : _o.IconPath));
		...
		var _CategoryType = TableEncryptionService.UseEncryption ? (Global.ProductCategory)TableEncryptionService.Convert((int)_o.CategoryType, key) : _o.CategoryType;
		var _DisplayTag = TableEncryptionService.UseEncryption ? (Global.ProductDisplayTag)TableEncryptionService.Convert((int)_o.DisplayTag, key) : _o.DisplayTag;
    ...
    var _PurchaseReportEventName = _o.PurchaseReportEventName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.PurchaseReportEventName, key) : _o.PurchaseReportEventName));
		var _PackageClientType = TableEncryptionService.UseEncryption ? (Global.PurchaseSourceType)TableEncryptionService.Convert((int)_o.PackageClientType, key) : _o.PackageClientType;
		var _IsStartDash = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.IsStartDash, key) : _o.IsStartDash;
