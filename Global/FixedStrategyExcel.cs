...
public struct FixedStrategyExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(FixedStrategyExcelT _o) {
    ...
    _o.StageEnterEchelon01FixedEchelonId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StageEnterEchelon01FixedEchelonId, key) : this.StageEnterEchelon01FixedEchelonId;
    _o.StageEnterEchelon01Starttile = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StageEnterEchelon01Starttile, key) : this.StageEnterEchelon01Starttile;
    _o.StageEnterEchelon02FixedEchelonId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StageEnterEchelon02FixedEchelonId, key) : this.StageEnterEchelon02FixedEchelonId;
    _o.StageEnterEchelon02Starttile = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StageEnterEchelon02Starttile, key) : this.StageEnterEchelon02Starttile;
    _o.StageEnterEchelon03FixedEchelonId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StageEnterEchelon03FixedEchelonId, key) : this.StageEnterEchelon03FixedEchelonId;
    _o.StageEnterEchelon03Starttile = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StageEnterEchelon03Starttile, key) : this.StageEnterEchelon03Starttile;
    _o.StageEnterEchelon04FixedEchelonId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StageEnterEchelon04FixedEchelonId, key) : this.StageEnterEchelon04FixedEchelonId;
    _o.StageEnterEchelon04Starttile = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StageEnterEchelon04Starttile, key) : this.StageEnterEchelon04Starttile;
  }
  public static Offset<Global.FixedStrategyExcel> Pack(FlatBufferBuilder builder, FixedStrategyExcelT _o) {
    if (_o == null) return default(Offset<Global.FixedStrategyExcel>);
		...
		var _StageEnterEchelon01FixedEchelonId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StageEnterEchelon01FixedEchelonId, key) : _o.StageEnterEchelon01FixedEchelonId;
		var _StageEnterEchelon01Starttile = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StageEnterEchelon01Starttile, key) : _o.StageEnterEchelon01Starttile;
		var _StageEnterEchelon02FixedEchelonId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StageEnterEchelon02FixedEchelonId, key) : _o.StageEnterEchelon02FixedEchelonId;
		var _StageEnterEchelon02Starttile = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StageEnterEchelon02Starttile, key) : _o.StageEnterEchelon02Starttile;
		var _StageEnterEchelon03FixedEchelonId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StageEnterEchelon03FixedEchelonId, key) : _o.StageEnterEchelon03FixedEchelonId;
		var _StageEnterEchelon03Starttile = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StageEnterEchelon03Starttile, key) : _o.StageEnterEchelon03Starttile;
		var _StageEnterEchelon04FixedEchelonId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StageEnterEchelon04FixedEchelonId, key) : _o.StageEnterEchelon04FixedEchelonId;
		var _StageEnterEchelon04Starttile = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StageEnterEchelon04Starttile, key) : _o.StageEnterEchelon04Starttile;
