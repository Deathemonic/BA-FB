...
public struct ConstCombatExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.ConstCombatExcel> CreateConstCombatExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.ConstCombatExcel> EndConstCombatExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.ConstCombatExcel>(o);
  }
  ...
  public static Offset<Global.ConstCombatExcel> Pack(FlatBufferBuilder builder, ConstCombatExcelT _o) {
    if (_o == null) return default(Offset<Global.ConstCombatExcel>);
		byte[] key = TableEncryptionService.CreateKey("ConstCombat");
    ...
    var _EliminateRaidOpenScenarioId = _o.EliminateRaidOpenScenarioId == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.EliminateRaidOpenScenarioId, key) : _o.EliminateRaidOpenScenarioId));
		...
		var _WORLDBOSSBATTLELITTLETw = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.WORLDBOSSBATTLELITTLETw, key) : _o.WORLDBOSSBATTLELITTLETw;
		var _WORLDBOSSBATTLELITTLEAsia = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.WORLDBOSSBATTLELITTLEAsia, key) : _o.WORLDBOSSBATTLELITTLEAsia;
		var _WORLDBOSSBATTLELITTLENa = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.WORLDBOSSBATTLELITTLENa, key) : _o.WORLDBOSSBATTLELITTLENa;
		var _WORLDBOSSBATTLELITTLEGlobal = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.WORLDBOSSBATTLELITTLEGlobal, key) : _o.WORLDBOSSBATTLELITTLEGlobal;
		...
		var _WORLDBOSSBATTLEMIDDLETw = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.WORLDBOSSBATTLEMIDDLETw, key) : _o.WORLDBOSSBATTLEMIDDLETw;
		var _WORLDBOSSBATTLEMIDDLEAsia = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.WORLDBOSSBATTLEMIDDLEAsia, key) : _o.WORLDBOSSBATTLEMIDDLEAsia;
		var _WORLDBOSSBATTLEMIDDLENa = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.WORLDBOSSBATTLEMIDDLENa, key) : _o.WORLDBOSSBATTLEMIDDLENa;
		var _WORLDBOSSBATTLEMIDDLEGlobal = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.WORLDBOSSBATTLEMIDDLEGlobal, key) : _o.WORLDBOSSBATTLEMIDDLEGlobal;
		...
		var _WORLDBOSSBATTLEHIGHTw = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.WORLDBOSSBATTLEHIGHTw, key) : _o.WORLDBOSSBATTLEHIGHTw;
		var _WORLDBOSSBATTLEHIGHAsia = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.WORLDBOSSBATTLEHIGHAsia, key) : _o.WORLDBOSSBATTLEHIGHAsia;
		var _WORLDBOSSBATTLEHIGHNa = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.WORLDBOSSBATTLEHIGHNa, key) : _o.WORLDBOSSBATTLEHIGHNa;
		var _WORLDBOSSBATTLEHIGHGlobal = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.WORLDBOSSBATTLEHIGHGlobal, key) : _o.WORLDBOSSBATTLEHIGHGlobal;
		...
		var _WORLDBOSSBATTLEVERYHIGHTw = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.WORLDBOSSBATTLEVERYHIGHTw, key) : _o.WORLDBOSSBATTLEVERYHIGHTw;
		var _WORLDBOSSBATTLEVERYHIGHAsia = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.WORLDBOSSBATTLEVERYHIGHAsia, key) : _o.WORLDBOSSBATTLEVERYHIGHAsia;
		var _WORLDBOSSBATTLEVERYHIGHNa = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.WORLDBOSSBATTLEVERYHIGHNa, key) : _o.WORLDBOSSBATTLEVERYHIGHNa;
		var _WORLDBOSSBATTLEVERYHIGHGlobal = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.WORLDBOSSBATTLEVERYHIGHGlobal, key) : _o.WORLDBOSSBATTLEVERYHIGHGlobal;
    ...
    var _EchelonExtensionVictoryTimelinePath = _o.EchelonExtensionVictoryTimelinePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.EchelonExtensionVictoryTimelinePath, key) : _o.EchelonExtensionVictoryTimelinePath));
		...
		var _EchelonMaxOverloadCost = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EchelonMaxOverloadCost, key) : _o.EchelonMaxOverloadCost;
		var _EchelonExtensionMaxOverloadCost = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EchelonExtensionMaxOverloadCost, key) : _o.EchelonExtensionMaxOverloadCost;
		...
		var _EchelonOverloadCostRegenRatio = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EchelonOverloadCostRegenRatio, key) : _o.EchelonOverloadCostRegenRatio;
		var _EchelonExtensionOverloadCostRegenRatio = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EchelonExtensionOverloadCostRegenRatio, key) : _o.EchelonExtensionOverloadCostRegenRatio;
		...
		var _MoveCorrectionSkipRatio = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MoveCorrectionSkipRatio, key) : _o.MoveCorrectionSkipRatio;
    return CreateConstCombatExcel(
      ...
      TableEncryptionService.UseEncryption ? _WORLDBOSSBATTLELITTLETw : _o.WORLDBOSSBATTLELITTLETw,
      TableEncryptionService.UseEncryption ? _WORLDBOSSBATTLELITTLEAsia : _o.WORLDBOSSBATTLELITTLEAsia,
      TableEncryptionService.UseEncryption ? _WORLDBOSSBATTLELITTLENa : _o.WORLDBOSSBATTLELITTLENa,
      TableEncryptionService.UseEncryption ? _WORLDBOSSBATTLELITTLEGlobal : _o.WORLDBOSSBATTLELITTLEGlobal,
      TableEncryptionService.UseEncryption ? _WORLDBOSSBATTLEMIDDLE : _o.WORLDBOSSBATTLEMIDDLE,
      TableEncryptionService.UseEncryption ? _WORLDBOSSBATTLEMIDDLETw : _o.WORLDBOSSBATTLEMIDDLETw,
      TableEncryptionService.UseEncryption ? _WORLDBOSSBATTLEMIDDLEAsia : _o.WORLDBOSSBATTLEMIDDLEAsia,
      TableEncryptionService.UseEncryption ? _WORLDBOSSBATTLEMIDDLENa : _o.WORLDBOSSBATTLEMIDDLENa,
      TableEncryptionService.UseEncryption ? _WORLDBOSSBATTLEMIDDLEGlobal : _o.WORLDBOSSBATTLEMIDDLEGlobal,
      TableEncryptionService.UseEncryption ? _WORLDBOSSBATTLEHIGH : _o.WORLDBOSSBATTLEHIGH,
      TableEncryptionService.UseEncryption ? _WORLDBOSSBATTLEHIGHTw : _o.WORLDBOSSBATTLEHIGHTw,
      TableEncryptionService.UseEncryption ? _WORLDBOSSBATTLEHIGHAsia : _o.WORLDBOSSBATTLEHIGHAsia,
      TableEncryptionService.UseEncryption ? _WORLDBOSSBATTLEHIGHNa : _o.WORLDBOSSBATTLEHIGHNa,
      TableEncryptionService.UseEncryption ? _WORLDBOSSBATTLEHIGHGlobal : _o.WORLDBOSSBATTLEHIGHGlobal,
      TableEncryptionService.UseEncryption ? _WORLDBOSSBATTLEVERYHIGH : _o.WORLDBOSSBATTLEVERYHIGH,
      TableEncryptionService.UseEncryption ? _WORLDBOSSBATTLEVERYHIGHTw : _o.WORLDBOSSBATTLEVERYHIGHTw,
      TableEncryptionService.UseEncryption ? _WORLDBOSSBATTLEVERYHIGHAsia : _o.WORLDBOSSBATTLEVERYHIGHAsia,
      TableEncryptionService.UseEncryption ? _WORLDBOSSBATTLEVERYHIGHNa : _o.WORLDBOSSBATTLEVERYHIGHNa,
      TableEncryptionService.UseEncryption ? _WORLDBOSSBATTLEVERYHIGHGlobal : _o.WORLDBOSSBATTLEVERYHIGHGlobal,
