...
public struct ConstCombatExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ConstCombatExcelT _o) {
    ...
    _o.WORLDBOSSBATTLELITTLETw = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.WORLDBOSSBATTLELITTLETw, key) : this.WORLDBOSSBATTLELITTLETw;
    _o.WORLDBOSSBATTLELITTLEAsia = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.WORLDBOSSBATTLELITTLEAsia, key) : this.WORLDBOSSBATTLELITTLEAsia;
    _o.WORLDBOSSBATTLELITTLENa = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.WORLDBOSSBATTLELITTLENa, key) : this.WORLDBOSSBATTLELITTLENa;
    _o.WORLDBOSSBATTLELITTLEGlobal = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.WORLDBOSSBATTLELITTLEGlobal, key) : this.WORLDBOSSBATTLELITTLEGlobal;
    ...
    _o.WORLDBOSSBATTLEMIDDLETw = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.WORLDBOSSBATTLEMIDDLETw, key) : this.WORLDBOSSBATTLEMIDDLETw;
    _o.WORLDBOSSBATTLEMIDDLEAsia = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.WORLDBOSSBATTLEMIDDLEAsia, key) : this.WORLDBOSSBATTLEMIDDLEAsia;
    _o.WORLDBOSSBATTLEMIDDLENa = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.WORLDBOSSBATTLEMIDDLENa, key) : this.WORLDBOSSBATTLEMIDDLENa;
    _o.WORLDBOSSBATTLEMIDDLEGlobal = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.WORLDBOSSBATTLEMIDDLEGlobal, key) : this.WORLDBOSSBATTLEMIDDLEGlobal;
    ...
    _o.WORLDBOSSBATTLEHIGHTw = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.WORLDBOSSBATTLEHIGHTw, key) : this.WORLDBOSSBATTLEHIGHTw;
    _o.WORLDBOSSBATTLEHIGHAsia = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.WORLDBOSSBATTLEHIGHAsia, key) : this.WORLDBOSSBATTLEHIGHAsia;
    _o.WORLDBOSSBATTLEHIGHNa = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.WORLDBOSSBATTLEHIGHNa, key) : this.WORLDBOSSBATTLEHIGHNa;
    _o.WORLDBOSSBATTLEHIGHGlobal = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.WORLDBOSSBATTLEHIGHGlobal, key) : this.WORLDBOSSBATTLEHIGHGlobal;
    ...
    _o.WORLDBOSSBATTLEVERYHIGHTw = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.WORLDBOSSBATTLEVERYHIGHTw, key) : this.WORLDBOSSBATTLEVERYHIGHTw;
    _o.WORLDBOSSBATTLEVERYHIGHAsia = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.WORLDBOSSBATTLEVERYHIGHAsia, key) : this.WORLDBOSSBATTLEVERYHIGHAsia;
    _o.WORLDBOSSBATTLEVERYHIGHNa = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.WORLDBOSSBATTLEVERYHIGHNa, key) : this.WORLDBOSSBATTLEVERYHIGHNa;
    _o.WORLDBOSSBATTLEVERYHIGHGlobal = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.WORLDBOSSBATTLEVERYHIGHGlobal, key) : this.WORLDBOSSBATTLEVERYHIGHGlobal;
  ...
  public static Offset<Global.ConstCombatExcel> Pack(FlatBufferBuilder builder, ConstCombatExcelT _o) {
    ...
    var _EliminateRaidOpenScenarioId = _o.EliminateRaidOpenScenarioId == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.EliminateRaidOpenScenarioId, key) : _o.EliminateRaidOpenScenarioId));
		...
		var _WORLDBOSSBATTLELITTLETw = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.WORLDBOSSBATTLELITTLETw, key) : _o.WORLDBOSSBATTLELITTLETw;
		var _WORLDBOSSBATTLELITTLEAsia = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.WORLDBOSSBATTLELITTLEAsia, key) : _o.WORLDBOSSBATTLELITTLEAsia;
		var _WORLDBOSSBATTLELITTLENa = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.WORLDBOSSBATTLELITTLENa, key) : _o.WORLDBOSSBATTLELITTLENa;
		var _WORLDBOSSBATTLELITTLEGlobal = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.WORLDBOSSBATTLELITTLEGlobal, key) : _o.WORLDBOSSBATTLELITTLEGlobal;
		...
		var _WORLDBOSSBATTLEMIDDLETw = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.WORLDBOSSBATTLEMIDDLETw, key) : _o.WORLDBOSSBATTLEMIDDLETw;
		var _WORLDBOSSBATTLEMIDDLEAsia = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.WORLDBOSSBATTLEMIDDLEAsia, key) : _o.WORLDBOSSBATTLEMIDDLEAsia;
		var _WORLDBOSSBATTLEMIDDLENa = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.WORLDBOSSBATTLEMIDDLENa, key) : _o.WORLDBOSSBATTLEMIDDLENa;
		var _WORLDBOSSBATTLEMIDDLEGlobal = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.WORLDBOSSBATTLEMIDDLEGlobal, key) : _o.WORLDBOSSBATTLEMIDDLEGlobal;
		...
		var _WORLDBOSSBATTLEHIGHTw = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.WORLDBOSSBATTLEHIGHTw, key) : _o.WORLDBOSSBATTLEHIGHTw;
		var _WORLDBOSSBATTLEHIGHAsia = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.WORLDBOSSBATTLEHIGHAsia, key) : _o.WORLDBOSSBATTLEHIGHAsia;
		var _WORLDBOSSBATTLEHIGHNa = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.WORLDBOSSBATTLEHIGHNa, key) : _o.WORLDBOSSBATTLEHIGHNa;
		var _WORLDBOSSBATTLEHIGHGlobal = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.WORLDBOSSBATTLEHIGHGlobal, key) : _o.WORLDBOSSBATTLEHIGHGlobal;
		...
		var _WORLDBOSSBATTLEVERYHIGHTw = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.WORLDBOSSBATTLEVERYHIGHTw, key) : _o.WORLDBOSSBATTLEVERYHIGHTw;
		var _WORLDBOSSBATTLEVERYHIGHAsia = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.WORLDBOSSBATTLEVERYHIGHAsia, key) : _o.WORLDBOSSBATTLEVERYHIGHAsia;
		var _WORLDBOSSBATTLEVERYHIGHNa = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.WORLDBOSSBATTLEVERYHIGHNa, key) : _o.WORLDBOSSBATTLEVERYHIGHNa;
		var _WORLDBOSSBATTLEVERYHIGHGlobal = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.WORLDBOSSBATTLEVERYHIGHGlobal, key) : _o.WORLDBOSSBATTLEVERYHIGHGlobal;
