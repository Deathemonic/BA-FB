...
public struct EliminateRaidRankingRewardExcel : IFlatbufferObject
{
  ...
  public Global.ParcelType RewardParcelType(int j) { int o = __p.__offset(34); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Global.ParcelType)0; }
  public int RewardParcelTypeLength { get { int o = __p.__offset(34); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Global.ParcelType> GetRewardParcelTypeBytes() { return __p.__vector_as_span<Global.ParcelType>(34, 4); }
#else
  public ArraySegment<byte>? GetRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(34); }
#endif
  public Global.ParcelType[] GetRewardParcelTypeArray() { int o = __p.__offset(34); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Global.ParcelType[] a = new Global.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Global.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Global.EliminateRaidRankingRewardExcel> CreateEliminateRaidRankingRewardExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.EliminateRaidRankingRewardExcel> EndEliminateRaidRankingRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.EliminateRaidRankingRewardExcel>(o);
  }
  public EliminateRaidRankingRewardExcelT UnPack() {
    var _o = new EliminateRaidRankingRewardExcelT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(EliminateRaidRankingRewardExcelT _o) {
		byte[] key = TableEncryptionService.CreateKey("EliminateRaidRankingReward");
    ...
    _o.RankStart = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.RankStart, key) : this.RankStart;
    _o.RankEnd = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.RankEnd, key) : this.RankEnd;
    _o.RankStartTw = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.RankStartTw, key) : this.RankStartTw;
    _o.RankEndTw = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.RankEndTw, key) : this.RankEndTw;
    _o.RankStartAsia = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.RankStartAsia, key) : this.RankStartAsia;
    _o.RankEndAsia = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.RankEndAsia, key) : this.RankEndAsia;
    _o.RankStartNa = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.RankStartNa, key) : this.RankStartNa;
    _o.RankEndNa = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.RankEndNa, key) : this.RankEndNa;
    _o.RankStartGlobal = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.RankStartGlobal, key) : this.RankStartGlobal;
    _o.RankEndGlobal = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.RankEndGlobal, key) : this.RankEndGlobal;
    _o.PercentRankStart = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.PercentRankStart, key) : this.PercentRankStart;
    _o.PercentRankEnd = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.PercentRankEnd, key) : this.PercentRankEnd;
    ...
    for (var _j = 0; _j < this.RewardParcelUniqueIdLength; ++_j) {_o.RewardParcelUniqueId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.RewardParcelUniqueId(_j), key) : this.RewardParcelUniqueId(_j));}
  ...
  public static Offset<Global.EliminateRaidRankingRewardExcel> Pack(FlatBufferBuilder builder, EliminateRaidRankingRewardExcelT _o) {
    if (_o == null) return default(Offset<Global.EliminateRaidRankingRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("EliminateRaidRankingReward");
		var _RankingRewardGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RankingRewardGroupId, key) : _o.RankingRewardGroupId;
		...
		var _RankStartTw = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RankStartTw, key) : _o.RankStartTw;
		var _RankEndTw = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RankEndTw, key) : _o.RankEndTw;
		var _RankStartAsia = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RankStartAsia, key) : _o.RankStartAsia;
		var _RankEndAsia = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RankEndAsia, key) : _o.RankEndAsia;
		var _RankStartNa = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RankStartNa, key) : _o.RankStartNa;
		var _RankEndNa = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RankEndNa, key) : _o.RankEndNa;
		var _RankStartGlobal = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RankStartGlobal, key) : _o.RankStartGlobal;
		var _RankEndGlobal = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RankEndGlobal, key) : _o.RankEndGlobal;
		var _PercentRankStart = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PercentRankStart, key) : _o.PercentRankStart;
		var _PercentRankEnd = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PercentRankEnd, key) : _o.PercentRankEnd;
    ...
    return CreateEliminateRaidRankingRewardExcel(
      ...
      TableEncryptionService.UseEncryption ? _RankStartTw : _o.RankStartTw,
      TableEncryptionService.UseEncryption ? _RankEndTw : _o.RankEndTw,
      TableEncryptionService.UseEncryption ? _RankStartAsia : _o.RankStartAsia,
      TableEncryptionService.UseEncryption ? _RankEndAsia : _o.RankEndAsia,
      TableEncryptionService.UseEncryption ? _RankStartNa : _o.RankStartNa,
      TableEncryptionService.UseEncryption ? _RankEndNa : _o.RankEndNa,
      TableEncryptionService.UseEncryption ? _RankStartGlobal : _o.RankStartGlobal,
      TableEncryptionService.UseEncryption ? _RankEndGlobal : _o.RankEndGlobal,
...
public class EliminateRaidRankingRewardExcelT
{
  public long RankingRewardGroupId { get; set; }
  public long Id { get; set; }
  public long RankStart { get; set; }
  public long RankEnd { get; set; }
  public long RankStartTw { get; set; }
  public long RankEndTw { get; set; }
  public long RankStartAsia { get; set; }
  public long RankEndAsia { get; set; }
  public long RankStartNa { get; set; }
  public long RankEndNa { get; set; }
  public long RankStartGlobal { get; set; }
  public long RankEndGlobal { get; set; }
  ...
  public EliminateRaidRankingRewardExcelT() {
    ...
    this.RankStartTw = 0;
    this.RankEndTw = 0;
    this.RankStartAsia = 0;
    this.RankEndAsia = 0;
    this.RankStartNa = 0;
    this.RankEndNa = 0;
    this.RankStartGlobal = 0;
    this.RankEndGlobal = 0;
...
static public class EliminateRaidRankingRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 34 /*RewardParcelType*/, 4 /*Global.ParcelType*/, false)
