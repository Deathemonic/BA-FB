...
public struct EliminateRaidRankingRewardExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(EliminateRaidRankingRewardExcelT _o) {
    ...
    _o.RankStartTw = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.RankStartTw, key) : this.RankStartTw;
    _o.RankEndTw = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.RankEndTw, key) : this.RankEndTw;
    _o.RankStartAsia = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.RankStartAsia, key) : this.RankStartAsia;
    _o.RankEndAsia = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.RankEndAsia, key) : this.RankEndAsia;
    _o.RankStartNa = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.RankStartNa, key) : this.RankStartNa;
    _o.RankEndNa = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.RankEndNa, key) : this.RankEndNa;
    _o.RankStartGlobal = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.RankStartGlobal, key) : this.RankStartGlobal;
    _o.RankEndGlobal = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.RankEndGlobal, key) : this.RankEndGlobal;
  ...
  public static Offset<Global.EliminateRaidRankingRewardExcel> Pack(FlatBufferBuilder builder, EliminateRaidRankingRewardExcelT _o) {
    if (_o == null) return default(Offset<Global.EliminateRaidRankingRewardExcel>);
		...
		var _RankStartTw = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.RankStartTw, key) : _o.RankStartTw;
		var _RankEndTw = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.RankEndTw, key) : _o.RankEndTw;
		var _RankStartAsia = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.RankStartAsia, key) : _o.RankStartAsia;
		var _RankEndAsia = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.RankEndAsia, key) : _o.RankEndAsia;
		var _RankStartNa = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.RankStartNa, key) : _o.RankStartNa;
		var _RankEndNa = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.RankEndNa, key) : _o.RankEndNa;
		var _RankStartGlobal = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.RankStartGlobal, key) : _o.RankStartGlobal;
		var _RankEndGlobal = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.RankEndGlobal, key) : _o.RankEndGlobal;
