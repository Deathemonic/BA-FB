...
public struct EventContentDiceRaceExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.EventContentDiceRaceExcel> CreateEventContentDiceRaceExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.EventContentDiceRaceExcel> EndEventContentDiceRaceExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.EventContentDiceRaceExcel>(o);
  }
  ...
  public static Offset<Global.EventContentDiceRaceExcel> Pack(FlatBufferBuilder builder, EventContentDiceRaceExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentDiceRaceExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentDiceRace");
		...
		var _DiceCostGoodsId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DiceCostGoodsId, key) : _o.DiceCostGoodsId;
