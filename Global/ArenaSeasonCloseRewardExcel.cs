...
public struct ArenaSeasonCloseRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.ArenaSeasonCloseRewardExcel> CreateArenaSeasonCloseRewardExcel(FlatBufferBuilder builder,
      long SeasonId = 0,
      long RankStart = 0,
      long RankEnd = 0,
  ...
  public static Offset<Global.ArenaSeasonCloseRewardExcel> EndArenaSeasonCloseRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.ArenaSeasonCloseRewardExcel>(o);
  }
  ...
  public static Offset<Global.ArenaSeasonCloseRewardExcel> Pack(FlatBufferBuilder builder, ArenaSeasonCloseRewardExcelT _o) {
    if (_o == null) return default(Offset<Global.ArenaSeasonCloseRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("ArenaSeasonCloseReward");
