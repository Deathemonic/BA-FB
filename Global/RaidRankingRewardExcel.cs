...
public struct RaidRankingRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.RaidRankingRewardExcel> CreateRaidRankingRewardExcel(FlatBufferBuilder builder,
  ...
  public static void StartRaidRankingRewardExcel(FlatBufferBuilder builder) { builder.StartTable(19); }
  ...
  public static Offset<Global.RaidRankingRewardExcel> EndRaidRankingRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.RaidRankingRewardExcel>(o);
  }
  ...
  public static Offset<Global.RaidRankingRewardExcel> Pack(FlatBufferBuilder builder, RaidRankingRewardExcelT _o) {
    if (_o == null) return default(Offset<Global.RaidRankingRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("RaidRankingReward");
