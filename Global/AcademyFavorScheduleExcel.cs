...
public struct AcademyFavorScheduleExcel : IFlatbufferObject
{
  ...
  public Global.ParcelType RewardParcelType(int j) { int o = __p.__offset(22); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Global.ParcelType)0; }
  public int RewardParcelTypeLength { get { int o = __p.__offset(22); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Global.ParcelType> GetRewardParcelTypeBytes() { return __p.__vector_as_span<Global.ParcelType>(22, 4); }
#else
  public ArraySegment<byte>? GetRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(22); }
#endif
  public Global.ParcelType[] GetRewardParcelTypeArray() { int o = __p.__offset(22); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Global.ParcelType[] a = new Global.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Global.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Global.AcademyFavorScheduleExcel> CreateAcademyFavorScheduleExcel(FlatBufferBuilder builder,
      long Id = 0,
      long CharacterId = 0,
  ...
  public static Offset<Global.AcademyFavorScheduleExcel> EndAcademyFavorScheduleExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.AcademyFavorScheduleExcel>(o);
  }
  ...
  public void UnPackTo(AcademyFavorScheduleExcelT _o) {
    ...
    _o.LocalizeScenarioId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.LocalizeScenarioId, key) : this.LocalizeScenarioId;
    ...
    _o.ScenarioSriptGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ScenarioSriptGroupId, key) : this.ScenarioSriptGroupId;
  ...
  public static Offset<Global.AcademyFavorScheduleExcel> Pack(FlatBufferBuilder builder, AcademyFavorScheduleExcelT _o) {
    if (_o == null) return default(Offset<Global.AcademyFavorScheduleExcel>);
		byte[] key = TableEncryptionService.CreateKey("AcademyFavorSchedule");
    ...
    var _Location = _o.Location == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.Location, key) : _o.Location));
		var _LocalizeScenarioId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.LocalizeScenarioId, key) : _o.LocalizeScenarioId;
		...
		var _ScenarioSriptGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ScenarioSriptGroupId, key) : _o.ScenarioSriptGroupId;
    ...
    return CreateAcademyFavorScheduleExcel(
      ...
      _Location,
      TableEncryptionService.UseEncryption ? _LocalizeScenarioId : _o.LocalizeScenarioId,
      ...
      TableEncryptionService.UseEncryption ? _ScenarioSriptGroupId : _o.ScenarioSriptGroupId,
      _rewardParcelType,
      _rewardParcelId,
      _rewardAmount);
  }
...
static public class AcademyFavorScheduleExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 22 /*RewardParcelType*/, 4 /*Global.ParcelType*/, false)
