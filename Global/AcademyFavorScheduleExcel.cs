...
public struct AcademyFavorScheduleExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(AcademyFavorScheduleExcelT _o) {
    ...
    _o.LocalizeScenarioId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)this.LocalizeScenarioId, key) : this.LocalizeScenarioId;
    _o.FavorRank = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.FavorRank, key) : this.FavorRank;
    ...
    _o.ScenarioSriptGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ScenarioSriptGroupId, key) : this.ScenarioSriptGroupId;
  ...
  public static Offset<Global.AcademyFavorScheduleExcel> Pack(FlatBufferBuilder builder, AcademyFavorScheduleExcelT _o) {
    ...
    var _Location = _o.Location == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.Location, key) : _o.Location));
		var _LocalizeScenarioId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)_o.LocalizeScenarioId, key) : _o.LocalizeScenarioId;
		var _FavorRank = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.FavorRank, key) : _o.FavorRank;
		...
		var _ScenarioSriptGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ScenarioSriptGroupId, key) : _o.ScenarioSriptGroupId;
