...
public struct IdCardBackgroundExcel : IFlatbufferObject
{
  ...
  public Global.Rarity Rarity { get { int o = __p.__offset(6); return o != 0 ? (Global.Rarity)__p.bb.GetInt(o + __p.bb_pos) : Global.Rarity.N; } }
  ...
  public static Offset<Global.IdCardBackgroundExcel> CreateIdCardBackgroundExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddRarity(FlatBufferBuilder builder, Global.Rarity rarity) { builder.AddInt(1, (int)rarity, 0); }
  ...
  public static Offset<Global.IdCardBackgroundExcel> EndIdCardBackgroundExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.IdCardBackgroundExcel>(o);
  }
  ...
  public static Offset<Global.IdCardBackgroundExcel> Pack(FlatBufferBuilder builder, IdCardBackgroundExcelT _o) {
    if (_o == null) return default(Offset<Global.IdCardBackgroundExcel>);
		byte[] key = TableEncryptionService.CreateKey("IdCardBackground");
...
static public class IdCardBackgroundExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*Rarity*/, 4 /*Global.Rarity*/, 4, false)
