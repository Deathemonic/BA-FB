...
public struct GachaCraftNodeExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(GachaCraftNodeExcelT _o) {
    ...
    _o.QuickCraftNodeDisplayOrder = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.QuickCraftNodeDisplayOrder, key) : this.QuickCraftNodeDisplayOrder;
    _o.NodeQuality = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.NodeQuality, key) : this.NodeQuality;
    _o.Icon = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Icon, key) : this.Icon;
    _o.LocalizeKey = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.LocalizeKey, key) : this.LocalizeKey;
    _o.Property = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Property, key) : this.Property;
  }
  public static Offset<Global.GachaCraftNodeExcel> Pack(FlatBufferBuilder builder, GachaCraftNodeExcelT _o) {
    if (_o == null) return default(Offset<Global.GachaCraftNodeExcel>);
		...
		var _QuickCraftNodeDisplayOrder = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.QuickCraftNodeDisplayOrder, key) : _o.QuickCraftNodeDisplayOrder;
		var _NodeQuality = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.NodeQuality, key) : _o.NodeQuality;
    var _Icon = _o.Icon == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.Icon, key) : _o.Icon));
		var _LocalizeKey = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.LocalizeKey, key) : _o.LocalizeKey;
		var _Property = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Property, key) : _o.Property;
