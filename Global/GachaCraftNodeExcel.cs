...
public struct GachaCraftNodeExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.GachaCraftNodeExcel> CreateGachaCraftNodeExcel(FlatBufferBuilder builder,
      long ID = 0,
      long Tier = 0,
  ...
  public static Offset<Global.GachaCraftNodeExcel> EndGachaCraftNodeExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.GachaCraftNodeExcel>(o);
  }
  ...
  public void UnPackTo(GachaCraftNodeExcelT _o) {
    ...
    _o.QuickCraftNodeDisplayOrder = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.QuickCraftNodeDisplayOrder, key) : this.QuickCraftNodeDisplayOrder;
    _o.NodeQuality = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.NodeQuality, key) : this.NodeQuality;
    _o.Icon = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Icon, key) : this.Icon;
    _o.LocalizeKey = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)this.LocalizeKey, key) : this.LocalizeKey;
    _o.Property = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.Property, key) : this.Property;
  }
  public static Offset<Global.GachaCraftNodeExcel> Pack(FlatBufferBuilder builder, GachaCraftNodeExcelT _o) {
    if (_o == null) return default(Offset<Global.GachaCraftNodeExcel>);
		byte[] key = TableEncryptionService.CreateKey("GachaCraftNode");
		...
		var _QuickCraftNodeDisplayOrder = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.QuickCraftNodeDisplayOrder, key) : _o.QuickCraftNodeDisplayOrder;
		var _NodeQuality = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.NodeQuality, key) : _o.NodeQuality;
    var _Icon = _o.Icon == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.Icon, key) : _o.Icon));
		var _LocalizeKey = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)_o.LocalizeKey, key) : _o.LocalizeKey;
		var _Property = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.Property, key) : _o.Property;
    return CreateGachaCraftNodeExcel(
      builder,
      TableEncryptionService.UseEncryption ? _ID : _o.ID,
      TableEncryptionService.UseEncryption ? _Tier : _o.Tier,
      TableEncryptionService.UseEncryption ? _QuickCraftNodeDisplayOrder : _o.QuickCraftNodeDisplayOrder,
      TableEncryptionService.UseEncryption ? _NodeQuality : _o.NodeQuality,
      _Icon,
      TableEncryptionService.UseEncryption ? _LocalizeKey : _o.LocalizeKey,
      TableEncryptionService.UseEncryption ? _Property : _o.Property);
  }
}
