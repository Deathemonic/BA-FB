...
public struct SystemMailExcel : IFlatbufferObject
{
  ...
  public Global.MailType MailType { get { int o = __p.__offset(4); return o != 0 ? (Global.MailType)__p.bb.GetInt(o + __p.bb_pos) : Global.MailType.System; } }
  ...
  public static Offset<Global.SystemMailExcel> CreateSystemMailExcel(FlatBufferBuilder builder,
  ...
  public static void AddMailType(FlatBufferBuilder builder, Global.MailType mailType) { builder.AddInt(0, (int)mailType, 0); }
  ...
  public static Offset<Global.SystemMailExcel> EndSystemMailExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.SystemMailExcel>(o);
  }
  ...
  public static Offset<Global.SystemMailExcel> Pack(FlatBufferBuilder builder, SystemMailExcelT _o) {
    if (_o == null) return default(Offset<Global.SystemMailExcel>);
		byte[] key = TableEncryptionService.CreateKey("SystemMail");
...
static public class SystemMailExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyField(tablePos, 4 /*MailType*/, 4 /*Global.MailType*/, 4, false)
