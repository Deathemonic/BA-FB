...
public struct AcademyLocationExcel : IFlatbufferObject
{
  ...
  public Global.School OpenCondition(int j) { int o = __p.__offset(12); return o != 0 ? (Global.School)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Global.School)0; }
  public int OpenConditionLength { get { int o = __p.__offset(12); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Global.School> GetOpenConditionBytes() { return __p.__vector_as_span<Global.School>(12, 4); }
#else
  public ArraySegment<byte>? GetOpenConditionBytes() { return __p.__vector_as_arraysegment(12); }
#endif
  public Global.School[] GetOpenConditionArray() { int o = __p.__offset(12); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Global.School[] a = new Global.School[l]; for (int i = 0; i < l; i++) { a[i] = (Global.School)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Global.ParcelType RewardParcelType { get { int o = __p.__offset(16); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Global.ParcelType.None; } }
  ...
  public static Offset<Global.AcademyLocationExcel> CreateAcademyLocationExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static VectorOffset CreateOpenConditionVector(FlatBufferBuilder builder, Global.School[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateOpenConditionVectorBlock(FlatBufferBuilder builder, Global.School[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateOpenConditionVectorBlock(FlatBufferBuilder builder, ArraySegment<Global.School> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateOpenConditionVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Global.School>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static void AddRewardParcelType(FlatBufferBuilder builder, Global.ParcelType rewardParcelType) { builder.AddInt(6, (int)rewardParcelType, 0); }
  ...
  public static Offset<Global.AcademyLocationExcel> EndAcademyLocationExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.AcademyLocationExcel>(o);
  }
  ...
  public void UnPackTo(AcademyLocationExcelT _o) {
    ...
    _o.OpenCondition = new List<Global.School>();
    for (var _j = 0; _j < this.OpenConditionLength; ++_j) {_o.OpenCondition.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.OpenCondition(_j), key) : this.OpenCondition(_j));}
    _o.OpenConditionCount = new List<long>();
    for (var _j = 0; _j < this.OpenConditionCountLength; ++_j) {_o.OpenConditionCount.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.OpenConditionCount(_j), key) : this.OpenConditionCount(_j));}
    ...
    _o.OpenTeacherRank = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.OpenTeacherRank, key) : this.OpenTeacherRank;
  }
  public static Offset<Global.AcademyLocationExcel> Pack(FlatBufferBuilder builder, AcademyLocationExcelT _o) {
    if (_o == null) return default(Offset<Global.AcademyLocationExcel>);
		byte[] key = TableEncryptionService.CreateKey("AcademyLocation");
    ...
    if (_o.OpenConditionCount != null) {
      var __OpenConditionCount = _o.OpenConditionCount.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
      _OpenConditionCount = CreateOpenConditionCountVector(builder, __OpenConditionCount);
		...
		var _OpenTeacherRank = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.OpenTeacherRank, key) : _o.OpenTeacherRank;
...
public class AcademyLocationExcelT
{
  ...
  public List<Global.School> OpenCondition { get; set; }
...
static public class AcademyLocationExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 12 /*OpenCondition*/, 4 /*Global.School*/, false)
      && verifier.VerifyVectorOfData(tablePos, 14 /*OpenConditionCount*/, 8 /*long*/, false)
      && verifier.VerifyField(tablePos, 16 /*RewardParcelType*/, 4 /*Global.ParcelType*/, 4, false)
