...
public struct ShopExcel : IFlatbufferObject
{
  ...
  public Global.ShopCategoryType CategoryType { get { int o = __p.__offset(8); return o != 0 ? (Global.ShopCategoryType)__p.bb.GetInt(o + __p.bb_pos) : Global.ShopCategoryType.General; } }
  public bool IsLegacy { get { int o = __p.__offset(10); return o != 0 ? 0!=__p.bb.Get(o + __p.bb_pos) : (bool)false; } }
  public bool UseBigPopup { get { int o = __p.__offset(12); return o != 0 ? 0!=__p.bb.Get(o + __p.bb_pos) : (bool)false; } }
  ...
  public Global.PurchaseCountResetType PurchaseCountResetType { get { int o = __p.__offset(26); return o != 0 ? (Global.PurchaseCountResetType)__p.bb.GetInt(o + __p.bb_pos) : Global.PurchaseCountResetType.None; } }
  ...
  public Global.ProductDisplayTag DisplayTag { get { int o = __p.__offset(32); return o != 0 ? (Global.ProductDisplayTag)__p.bb.GetInt(o + __p.bb_pos) : Global.ProductDisplayTag.None; } }
  public int ShopUpdateGroupId { get { int o = __p.__offset(34); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }

  public static Offset<Global.ShopExcel> CreateShopExcel(FlatBufferBuilder builder,
      long Id = 0,
      uint LocalizeEtcId = 0,
      Global.ShopCategoryType CategoryType = Global.ShopCategoryType.General,
      bool IsLegacy = false,
      bool UseBigPopup = false,
    ...
    ShopExcel.AddUseBigPopup(builder, UseBigPopup);
    ShopExcel.AddIsLegacy(builder, IsLegacy);
    return ShopExcel.EndShopExcel(builder);
  }

  public static void StartShopExcel(FlatBufferBuilder builder) { builder.StartTable(16); }
  ...
  public static void AddCategoryType(FlatBufferBuilder builder, Global.ShopCategoryType categoryType) { builder.AddInt(2, (int)categoryType, 0); }
  public static void AddIsLegacy(FlatBufferBuilder builder, bool isLegacy) { builder.AddBool(3, isLegacy, false); }
  public static void AddUseBigPopup(FlatBufferBuilder builder, bool useBigPopup) { builder.AddBool(4, useBigPopup, false); }
  ...
  public static void AddPurchaseCountResetType(FlatBufferBuilder builder, Global.PurchaseCountResetType purchaseCountResetType) { builder.AddInt(11, (int)purchaseCountResetType, 0); }
  ...
  public static void AddDisplayTag(FlatBufferBuilder builder, Global.ProductDisplayTag displayTag) { builder.AddInt(14, (int)displayTag, 0); }
  public static void AddShopUpdateGroupId(FlatBufferBuilder builder, int shopUpdateGroupId) { builder.AddInt(15, shopUpdateGroupId, 0); }
  public static Offset<Global.ShopExcel> EndShopExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.ShopExcel>(o);
  }
  ...
  public void UnPackTo(ShopExcelT _o) {
    ...
    _o.UseBigPopup = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.UseBigPopup, key) : this.UseBigPopup;
    ...
    _o.RestrictBuyWhenInventoryFull = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.RestrictBuyWhenInventoryFull, key) : this.RestrictBuyWhenInventoryFull;
    _o.DisplayTag = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.DisplayTag, key) : this.DisplayTag;
    _o.ShopUpdateGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ShopUpdateGroupId, key) : this.ShopUpdateGroupId;
  }
  public static Offset<Global.ShopExcel> Pack(FlatBufferBuilder builder, ShopExcelT _o) {
    if (_o == null) return default(Offset<Global.ShopExcel>);
		byte[] key = TableEncryptionService.CreateKey("Shop");
		...
		var _UseBigPopup = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.UseBigPopup, key) : _o.UseBigPopup;
    ...
    var _BuyReportEventName = _o.BuyReportEventName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.BuyReportEventName, key) : _o.BuyReportEventName));
		var _RestrictBuyWhenInventoryFull = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RestrictBuyWhenInventoryFull, key) : _o.RestrictBuyWhenInventoryFull;
		var _DisplayTag = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DisplayTag, key) : _o.DisplayTag;
		var _ShopUpdateGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ShopUpdateGroupId, key) : _o.ShopUpdateGroupId;
    return CreateShopExcel(
      ...
      TableEncryptionService.UseEncryption ? _UseBigPopup : _o.UseBigPopup,
      _GoodsId,
      ...
      _BuyReportEventName,
      TableEncryptionService.UseEncryption ? _RestrictBuyWhenInventoryFull : _o.RestrictBuyWhenInventoryFull,
      TableEncryptionService.UseEncryption ? _DisplayTag : _o.DisplayTag,
      TableEncryptionService.UseEncryption ? _ShopUpdateGroupId : _o.ShopUpdateGroupId);
  }
}
...
public class ShopExcelT
{
  ...
  public bool UseBigPopup { get; set; }
  ...
  public Global.ProductDisplayTag DisplayTag { get; set; }
  ...
  public ShopExcelT() {
    ...
    this.DisplayTag = Global.ProductDisplayTag.None;
...
static public class ShopExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*CategoryType*/, 4 /*Global.ShopCategoryType*/, 4, false)
      && verifier.VerifyField(tablePos, 10 /*IsLegacy*/, 1 /*bool*/, 1, false)
      && verifier.VerifyField(tablePos, 12 /*UseBigPopup*/, 1 /*bool*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 26 /*PurchaseCountResetType*/, 4 /*Global.PurchaseCountResetType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 32 /*DisplayTag*/, 4 /*Global.ProductDisplayTag*/, 4, false)
      && verifier.VerifyField(tablePos, 34 /*ShopUpdateGroupId*/, 4 /*int*/, 4, false)
