...
public struct ShopExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ShopExcelT _o) {
    ...
    _o.UseBigPopup = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.UseBigPopup, key) : this.UseBigPopup;
    ...
    _o.RestrictBuyWhenInventoryFull = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.RestrictBuyWhenInventoryFull, key) : this.RestrictBuyWhenInventoryFull;
    ...
    _o.ShopUpdateGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.ShopUpdateGroupId, key) : this.ShopUpdateGroupId;
  }
  public static Offset<Global.ShopExcel> Pack(FlatBufferBuilder builder, ShopExcelT _o) {
    if (_o == null) return default(Offset<Global.ShopExcel>);
		...
		var _UseBigPopup = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.UseBigPopup, key) : _o.UseBigPopup;
    ...
    var _BuyReportEventName = _o.BuyReportEventName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.BuyReportEventName, key) : _o.BuyReportEventName));
		var _RestrictBuyWhenInventoryFull = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.RestrictBuyWhenInventoryFull, key) : _o.RestrictBuyWhenInventoryFull;
		...
		var _ShopUpdateGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.ShopUpdateGroupId, key) : _o.ShopUpdateGroupId;
