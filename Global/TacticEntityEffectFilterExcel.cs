...
public struct TacticEntityEffectFilterExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.TacticEntityEffectFilterExcel> CreateTacticEntityEffectFilterExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.TacticEntityEffectFilterExcel> EndTacticEntityEffectFilterExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.TacticEntityEffectFilterExcel>(o);
  }
  ...
  public void UnPackTo(TacticEntityEffectFilterExcelT _o) {
    ...
    _o.TargetEffectName = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.TargetEffectName, key) : this.TargetEffectName;
    _o.ShowEffectToVehicle = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.ShowEffectToVehicle, key) : this.ShowEffectToVehicle;
    _o.ShowEffectToBoss = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.ShowEffectToBoss, key) : this.ShowEffectToBoss;
  }
  public static Offset<Global.TacticEntityEffectFilterExcel> Pack(FlatBufferBuilder builder, TacticEntityEffectFilterExcelT _o) {
    if (_o == null) return default(Offset<Global.TacticEntityEffectFilterExcel>);
		byte[] key = TableEncryptionService.CreateKey("TacticEntityEffectFilter");
    var _TargetEffectName = _o.TargetEffectName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.TargetEffectName, key) : _o.TargetEffectName));
		var _ShowEffectToVehicle = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.ShowEffectToVehicle, key) : _o.ShowEffectToVehicle;
		var _ShowEffectToBoss = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.ShowEffectToBoss, key) : _o.ShowEffectToBoss;
    return CreateTacticEntityEffectFilterExcel(
      builder,
      _TargetEffectName,
      TableEncryptionService.UseEncryption ? _ShowEffectToVehicle : _o.ShowEffectToVehicle,
      TableEncryptionService.UseEncryption ? _ShowEffectToBoss : _o.ShowEffectToBoss);
  }
}
