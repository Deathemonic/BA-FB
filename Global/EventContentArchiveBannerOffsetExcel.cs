...
public struct EventContentArchiveBannerOffsetExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.EventContentArchiveBannerOffsetExcel> CreateEventContentArchiveBannerOffsetExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.EventContentArchiveBannerOffsetExcel> EndEventContentArchiveBannerOffsetExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.EventContentArchiveBannerOffsetExcel>(o);
  }
  ...
  public void UnPackTo(EventContentArchiveBannerOffsetExcelT _o) {
    ...
    _o.OffsetX = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)this.OffsetX, key) : this.OffsetX;
    _o.OffsetY = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)this.OffsetY, key) : this.OffsetY;
    _o.ScaleX = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)this.ScaleX, key) : this.ScaleX;
    _o.ScaleY = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)this.ScaleY, key) : this.ScaleY;
  }
  public static Offset<Global.EventContentArchiveBannerOffsetExcel> Pack(FlatBufferBuilder builder, EventContentArchiveBannerOffsetExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentArchiveBannerOffsetExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentArchiveBannerOffset");
		...
		var _OffsetX = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)_o.OffsetX, key) : _o.OffsetX;
		var _OffsetY = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)_o.OffsetY, key) : _o.OffsetY;
		var _ScaleX = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)_o.ScaleX, key) : _o.ScaleX;
		var _ScaleY = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)_o.ScaleY, key) : _o.ScaleY;
    return CreateEventContentArchiveBannerOffsetExcel(
      builder,
      TableEncryptionService.UseEncryption ? _EventContentId : _o.EventContentId,
      TableEncryptionService.UseEncryption ? _OffsetX : _o.OffsetX,
      TableEncryptionService.UseEncryption ? _OffsetY : _o.OffsetY,
      TableEncryptionService.UseEncryption ? _ScaleX : _o.ScaleX,
      TableEncryptionService.UseEncryption ? _ScaleY : _o.ScaleY);
  }
}
