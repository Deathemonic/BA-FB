...
public struct EventContentArchiveBannerOffsetExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(EventContentArchiveBannerOffsetExcelT _o) {
    ...
    _o.OffsetX = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.OffsetX, key) : this.OffsetX;
    _o.OffsetY = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.OffsetY, key) : this.OffsetY;
    _o.ScaleX = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ScaleX, key) : this.ScaleX;
    _o.ScaleY = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ScaleY, key) : this.ScaleY;
  }
  public static Offset<Global.EventContentArchiveBannerOffsetExcel> Pack(FlatBufferBuilder builder, EventContentArchiveBannerOffsetExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentArchiveBannerOffsetExcel>);
		...
		var _OffsetX = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.OffsetX, key) : _o.OffsetX;
		var _OffsetY = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.OffsetY, key) : _o.OffsetY;
		var _ScaleX = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ScaleX, key) : _o.ScaleX;
		var _ScaleY = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ScaleY, key) : _o.ScaleY;
