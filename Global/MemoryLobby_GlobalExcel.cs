...
public struct MemoryLobby_GlobalExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.MemoryLobby_GlobalExcel> Pack(FlatBufferBuilder builder, MemoryLobby_GlobalExcelT _o) {
    ...
    var _PrefabNameKr = _o.PrefabNameKr == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.PrefabNameKr, key) : _o.PrefabNameKr));
    var _PrefabNameTw = _o.PrefabNameTw == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.PrefabNameTw, key) : _o.PrefabNameTw));
    var _PrefabNameAsia = _o.PrefabNameAsia == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.PrefabNameAsia, key) : _o.PrefabNameAsia));
    var _PrefabNameNa = _o.PrefabNameNa == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.PrefabNameNa, key) : _o.PrefabNameNa));
    var _PrefabNameGlobal = _o.PrefabNameGlobal == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.PrefabNameGlobal, key) : _o.PrefabNameGlobal));
    var _PrefabNameTeen = _o.PrefabNameTeen == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.PrefabNameTeen, key) : _o.PrefabNameTeen));
