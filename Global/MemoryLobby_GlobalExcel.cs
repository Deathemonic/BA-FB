...
public struct MemoryLobby_GlobalExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.MemoryLobby_GlobalExcel> CreateMemoryLobby_GlobalExcel(FlatBufferBuilder builder,
      long Id = 0,
      long CharacterId = 0,
  ...
  public static Offset<Global.MemoryLobby_GlobalExcel> EndMemoryLobby_GlobalExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.MemoryLobby_GlobalExcel>(o);
  }
  ...
  public void UnPackTo(MemoryLobby_GlobalExcelT _o) {
    ...
    _o.PrefabNameKr = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.PrefabNameKr, key) : this.PrefabNameKr;
    _o.PrefabNameTw = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.PrefabNameTw, key) : this.PrefabNameTw;
    _o.PrefabNameAsia = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.PrefabNameAsia, key) : this.PrefabNameAsia;
    _o.PrefabNameNa = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.PrefabNameNa, key) : this.PrefabNameNa;
    _o.PrefabNameGlobal = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.PrefabNameGlobal, key) : this.PrefabNameGlobal;
    _o.PrefabNameTeen = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.PrefabNameTeen, key) : this.PrefabNameTeen;
  }
  public static Offset<Global.MemoryLobby_GlobalExcel> Pack(FlatBufferBuilder builder, MemoryLobby_GlobalExcelT _o) {
    if (_o == null) return default(Offset<Global.MemoryLobby_GlobalExcel>);
		byte[] key = TableEncryptionService.CreateKey("MemoryLobby_Global");
    ...
    var _PrefabNameKr = _o.PrefabNameKr == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.PrefabNameKr, key) : _o.PrefabNameKr));
    var _PrefabNameTw = _o.PrefabNameTw == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.PrefabNameTw, key) : _o.PrefabNameTw));
    var _PrefabNameAsia = _o.PrefabNameAsia == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.PrefabNameAsia, key) : _o.PrefabNameAsia));
    var _PrefabNameNa = _o.PrefabNameNa == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.PrefabNameNa, key) : _o.PrefabNameNa));
    var _PrefabNameGlobal = _o.PrefabNameGlobal == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.PrefabNameGlobal, key) : _o.PrefabNameGlobal));
    var _PrefabNameTeen = _o.PrefabNameTeen == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.PrefabNameTeen, key) : _o.PrefabNameTeen));
