...
public struct EventContentTreasureCellRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.EventContentTreasureCellRewardExcel> CreateEventContentTreasureCellRewardExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Global.EventContentTreasureCellRewardExcel> EndEventContentTreasureCellRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.EventContentTreasureCellRewardExcel>(o);
  }
  ...
  public static Offset<Global.EventContentTreasureCellRewardExcel> Pack(FlatBufferBuilder builder, EventContentTreasureCellRewardExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentTreasureCellRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentTreasureCellReward");
