...
public struct FavorLevelExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.FavorLevelExcel> CreateFavorLevelExcel(FlatBufferBuilder builder,
      long Level = 0,
  ...
  public static Offset<Global.FavorLevelExcel> EndFavorLevelExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.FavorLevelExcel>(o);
  }
  ...
  public void UnPackTo(FavorLevelExcelT _o) {
    ...
    for (var _j = 0; _j < this.ExpTypeLength; ++_j) {_o.ExpType.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ExpType(_j), key) : this.ExpType(_j));}
  }
  public static Offset<Global.FavorLevelExcel> Pack(FlatBufferBuilder builder, FavorLevelExcelT _o) {
    if (_o == null) return default(Offset<Global.FavorLevelExcel>);
		byte[] key = TableEncryptionService.CreateKey("FavorLevel");
    ...
    if (_o.ExpType != null) {
      var __ExpType = _o.ExpType.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
