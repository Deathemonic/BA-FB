...
public struct EquipmentLevelExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.EquipmentLevelExcel> EndEquipmentLevelExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.EquipmentLevelExcel>(o);
  }
  ...
  public static Offset<Global.EquipmentLevelExcel> Pack(FlatBufferBuilder builder, EquipmentLevelExcelT _o) {
