...
public struct CostumeExcel : IFlatbufferObject
{
  ...
  public Global.Rarity Rarity { get { int o = __p.__offset(22); return o != 0 ? (Global.Rarity)__p.bb.GetInt(o + __p.bb_pos) : Global.Rarity.N; } }
  ...
  public Global.EntityMaterialType EntityMaterialType { get { int o = __p.__offset(32); return o != 0 ? (Global.EntityMaterialType)__p.bb.GetInt(o + __p.bb_pos) : Global.EntityMaterialType.Wood; } }
  ...
  public static Offset<Global.CostumeExcel> CreateCostumeExcel(FlatBufferBuilder builder,
      ...
      Global.EntityMaterialType EntityMaterialType = Global.EntityMaterialType.Wood,
  ...
  public static void AddRarity(FlatBufferBuilder builder, Global.Rarity rarity) { builder.AddInt(9, (int)rarity, 0); }
  ...
  public static void AddEntityMaterialType(FlatBufferBuilder builder, Global.EntityMaterialType entityMaterialType) { builder.AddInt(14, (int)entityMaterialType, 0); }
  ...
  public static Offset<Global.CostumeExcel> EndCostumeExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.CostumeExcel>(o);
  }
  ...
  public void UnPackTo(CostumeExcelT _o) {
    ...
    _o.EntityMaterialType = TableEncryptionService.UseEncryption ? (Global.EntityMaterialType)TableEncryptionService.Convert((int)this.EntityMaterialType, key) : this.EntityMaterialType;
  ...
  public static Offset<Global.CostumeExcel> Pack(FlatBufferBuilder builder, CostumeExcelT _o) {
    if (_o == null) return default(Offset<Global.CostumeExcel>);
		byte[] key = TableEncryptionService.CreateKey("Costume");
    ...
    if (_o.SpineResourceNameDioramaForFormConversion != null) {
      ...
      _spineResourceNameDioramaForFormConversion = CreateSpineResourceNameDioramaForFormConversionVector(builder, __spineResourceNameDioramaForFormConversion);
		...
		var _EntityMaterialType = TableEncryptionService.UseEncryption ? (Global.EntityMaterialType)TableEncryptionService.Convert((int)_o.EntityMaterialType, key) : _o.EntityMaterialType;
...
public class CostumeExcelT
{
  ...
  public Global.EntityMaterialType EntityMaterialType { get; set; }
  ...
  public CostumeExcelT() {
    ...
    this.EntityMaterialType = Global.EntityMaterialType.Wood;
...
static public class CostumeExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 22 /*Rarity*/, 4 /*Global.Rarity*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 32 /*EntityMaterialType*/, 4 /*Global.EntityMaterialType*/, 4, false)
