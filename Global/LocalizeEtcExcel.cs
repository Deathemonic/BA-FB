...
public struct LocalizeEtcExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.LocalizeEtcExcel> CreateLocalizeEtcExcel(FlatBufferBuilder builder,
      uint Key = 0,
  ...
  public static Offset<Global.LocalizeEtcExcel> EndLocalizeEtcExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.LocalizeEtcExcel>(o);
  }
  ...
  public static Offset<Global.LocalizeEtcExcel> Pack(FlatBufferBuilder builder, LocalizeEtcExcelT _o) {
    if (_o == null) return default(Offset<Global.LocalizeEtcExcel>);
		byte[] key = TableEncryptionService.CreateKey("LocalizeEtc");
