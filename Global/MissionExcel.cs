...
public struct MissionExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(MissionExcelT _o) {
    ...
    _o.DateAutoRefer = TableEncryptionService.UseEncryption ? (Global.ContentType)TableEncryptionService.Convert((int)this.DateAutoRefer, key) : this.DateAutoRefer;
    ...
    for (var _j = 0; _j < this.ContentTagsLength; ++_j) {_o.ContentTags.Add(TableEncryptionService.UseEncryption ? (Global.SuddenMissionContentType)TableEncryptionService.Convert((int)this.ContentTags(_j), key) : this.ContentTags(_j));}
  ...
  public static Offset<Global.MissionExcel> Pack(FlatBufferBuilder builder, MissionExcelT _o) {
    ...
    var _StartableEndDate = _o.StartableEndDate == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.StartableEndDate, key) : _o.StartableEndDate));
		var _DateAutoRefer = TableEncryptionService.UseEncryption ? (Global.ContentType)TableEncryptionService.Convert((int)_o.DateAutoRefer, key) : _o.DateAutoRefer;
    ...
    if (_o.ContentTags != null) {
      var __ContentTags = _o.ContentTags.Select(x => TableEncryptionService.UseEncryption ? (Global.SuddenMissionContentType)TableEncryptionService.Convert((int)x, key) : x).ToArray();
