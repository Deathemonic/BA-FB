...
public struct TimeAttackDungeonExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.TimeAttackDungeonExcel> CreateTimeAttackDungeonExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Global.TimeAttackDungeonExcel> EndTimeAttackDungeonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.TimeAttackDungeonExcel>(o);
  }
  ...
  public static Offset<Global.TimeAttackDungeonExcel> Pack(FlatBufferBuilder builder, TimeAttackDungeonExcelT _o) {
    if (_o == null) return default(Offset<Global.TimeAttackDungeonExcel>);
		byte[] key = TableEncryptionService.CreateKey("TimeAttackDungeon");
