...
public struct MinigameCCGLevelStageExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(MinigameCCGLevelStageExcelT _o) {
    ...
    _o.StageType = TableEncryptionService.UseEncryption ? (Global.CCGStageType)TableEncryptionService.Convert((int)this.StageType, key) : this.StageType;
    ...
    _o.RewardType = TableEncryptionService.UseEncryption ? (Global.CCGStageRewardType)TableEncryptionService.Convert((int)this.RewardType, key) : this.RewardType;
  ...
  public static Offset<Global.MinigameCCGLevelStageExcel> Pack(FlatBufferBuilder builder, MinigameCCGLevelStageExcelT _o) {
    ...
    if (_o.EnemyGroupId != null) {
      ...
      _EnemyGroupId = CreateEnemyGroupIdVector(builder, __EnemyGroupId);
		...
		var _StageType = TableEncryptionService.UseEncryption ? (Global.CCGStageType)TableEncryptionService.Convert((int)_o.StageType, key) : _o.StageType;
    ...
    var _CampBackgroundPath = _o.CampBackgroundPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.CampBackgroundPath, key) : _o.CampBackgroundPath));
		var _RewardType = TableEncryptionService.UseEncryption ? (Global.CCGStageRewardType)TableEncryptionService.Convert((int)_o.RewardType, key) : _o.RewardType;
