...
public struct MinigameCCGLevelStageExcel : IFlatbufferObject
{
  ...
  public Global.CCGStageType StageType { get { int o = __p.__offset(10); return o != 0 ? (Global.CCGStageType)__p.bb.GetInt(o + __p.bb_pos) : Global.CCGStageType.None; } }
  ...
  public Global.CCGStageRewardType RewardType { get { int o = __p.__offset(18); return o != 0 ? (Global.CCGStageRewardType)__p.bb.GetInt(o + __p.bb_pos) : Global.CCGStageRewardType.None; } }
  ...
  public static Offset<Global.MinigameCCGLevelStageExcel> CreateMinigameCCGLevelStageExcel(FlatBufferBuilder builder,
      long Id = 0,
      long GroupId = 0,
      VectorOffset EnemyGroupIdOffset = default(VectorOffset),
      Global.CCGStageType StageType = Global.CCGStageType.None,
      ...
      Global.CCGStageRewardType RewardType = Global.CCGStageRewardType.None,
      int RewardCount = 0,
  ...
  public static void AddStageType(FlatBufferBuilder builder, Global.CCGStageType stageType) { builder.AddInt(3, (int)stageType, 0); }
  ...
  public static void AddRewardType(FlatBufferBuilder builder, Global.CCGStageRewardType rewardType) { builder.AddInt(7, (int)rewardType, 0); }
  ...
  public static Offset<Global.MinigameCCGLevelStageExcel> EndMinigameCCGLevelStageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.MinigameCCGLevelStageExcel>(o);
  }
  ...
  public static Offset<Global.MinigameCCGLevelStageExcel> Pack(FlatBufferBuilder builder, MinigameCCGLevelStageExcelT _o) {
    if (_o == null) return default(Offset<Global.MinigameCCGLevelStageExcel>);
		byte[] key = TableEncryptionService.CreateKey("MinigameCCGLevelStage");
    ...
    if (_o.EnemyGroupId != null) {
      var __EnemyGroupId = _o.EnemyGroupId.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
      _EnemyGroupId = CreateEnemyGroupIdVector(builder, __EnemyGroupId);
    }
		var _StageType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StageType, key) : _o.StageType;
		var _CampDiscardCardCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CampDiscardCardCount, key) : _o.CampDiscardCardCount;
    var _CampSprPath = _o.CampSprPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.CampSprPath, key) : _o.CampSprPath));
    var _CampBackgroundPath = _o.CampBackgroundPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.CampBackgroundPath, key) : _o.CampBackgroundPath));
		var _RewardType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RewardType, key) : _o.RewardType;
		var _RewardCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RewardCount, key) : _o.RewardCount;
		var _RewardCardGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RewardCardGroupId, key) : _o.RewardCardGroupId;
		var _CardRarityGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CardRarityGroupId, key) : _o.CardRarityGroupId;
		var _isSkipIntroScenario = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IsSkipIntroScenario, key) : _o.IsSkipIntroScenario;
		var _IntroScenarioGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IntroScenarioGroupId, key) : _o.IntroScenarioGroupId;
		var _isSkipOutroScenario = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IsSkipOutroScenario, key) : _o.IsSkipOutroScenario;
		var _OutroScenarioGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.OutroScenarioGroupId, key) : _o.OutroScenarioGroupId;
...
public class MinigameCCGLevelStageExcelT
{
  ...
  public MinigameCCGLevelStageExcelT() {
    ...
    this.StageType = Global.CCGStageType.None;
    this.CampDiscardCardCount = 0;
    this.CampSprPath = null;
    this.CampBackgroundPath = null;
    this.RewardType = Global.CCGStageRewardType.None;
    this.RewardCount = 0;
...
static public class MinigameCCGLevelStageExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*StageType*/, 4 /*Global.CCGStageType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 18 /*RewardType*/, 4 /*Global.CCGStageRewardType*/, 4, false)
