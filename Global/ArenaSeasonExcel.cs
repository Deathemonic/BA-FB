...
public struct ArenaSeasonExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.ArenaSeasonExcel> Pack(FlatBufferBuilder builder, ArenaSeasonExcelT _o) {
    ...
    var _SeasonEndDate = _o.SeasonEndDate == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.SeasonEndDate, key) : _o.SeasonEndDate));
		var _SeasonGroupLimit = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.SeasonGroupLimit, key) : _o.SeasonGroupLimit;
		var _PrevSeasonId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PrevSeasonId, key) : _o.PrevSeasonId;
