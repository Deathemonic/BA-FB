...
public struct ArenaSeasonExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.ArenaSeasonExcel> CreateArenaSeasonExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
  ...
  public static Offset<Global.ArenaSeasonExcel> EndArenaSeasonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.ArenaSeasonExcel>(o);
  }
  ...
  public static Offset<Global.ArenaSeasonExcel> Pack(FlatBufferBuilder builder, ArenaSeasonExcelT _o) {
    if (_o == null) return default(Offset<Global.ArenaSeasonExcel>);
		byte[] key = TableEncryptionService.CreateKey("ArenaSeason");
