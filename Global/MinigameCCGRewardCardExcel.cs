...
public struct MinigameCCGRewardCardExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(MinigameCCGRewardCardExcelT _o) {
    ...
    _o.EntityType = TableEncryptionService.UseEncryption ? (Global.CCGEntityType)TableEncryptionService.Convert((int)this.EntityType, key) : this.EntityType;
  ...
  public static Offset<Global.MinigameCCGRewardCardExcel> Pack(FlatBufferBuilder builder, MinigameCCGRewardCardExcelT _o) {
    if (_o == null) return default(Offset<Global.MinigameCCGRewardCardExcel>);
		...
		var _EntityType = TableEncryptionService.UseEncryption ? (Global.CCGEntityType)TableEncryptionService.Convert((int)_o.EntityType, key) : _o.EntityType;
