...
public struct MinigameCCGRewardCardExcel : IFlatbufferObject
{
  ...
  public Global.CCGEntityType EntityType { get { int o = __p.__offset(8); return o != 0 ? (Global.CCGEntityType)__p.bb.GetInt(o + __p.bb_pos) : Global.CCGEntityType.None; } }
  ...
  public static Offset<Global.MinigameCCGRewardCardExcel> CreateMinigameCCGRewardCardExcel(FlatBufferBuilder builder,
      long Id = 0,
      long GroupId = 0,
      Global.CCGEntityType EntityType = Global.CCGEntityType.None,
      long CardId = 0,
      int CardRarity = 0) {
  ...
  public static void AddEntityType(FlatBufferBuilder builder, Global.CCGEntityType entityType) { builder.AddInt(2, (int)entityType, 0); }
  ...
  public static Offset<Global.MinigameCCGRewardCardExcel> EndMinigameCCGRewardCardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.MinigameCCGRewardCardExcel>(o);
  }
  ...
  public static Offset<Global.MinigameCCGRewardCardExcel> Pack(FlatBufferBuilder builder, MinigameCCGRewardCardExcelT _o) {
    if (_o == null) return default(Offset<Global.MinigameCCGRewardCardExcel>);
		byte[] key = TableEncryptionService.CreateKey("MinigameCCGRewardCard");
		...
		var _EntityType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EntityType, key) : _o.EntityType;
		var _CardId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CardId, key) : _o.CardId;
		var _CardRarity = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CardRarity, key) : _o.CardRarity;
...
public class MinigameCCGRewardCardExcelT
{
  ...
  public Global.CCGEntityType EntityType { get; set; }
  ...
  public MinigameCCGRewardCardExcelT() {
    this.Id = 0;
    this.GroupId = 0;
    this.EntityType = Global.CCGEntityType.None;
    this.CardId = 0;
    this.CardRarity = 0;
  }
}
...
static public class MinigameCCGRewardCardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*EntityType*/, 4 /*Global.CCGEntityType*/, 4, false)
