...
public struct OpenConditionExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.OpenConditionExcel> Pack(FlatBufferBuilder builder, OpenConditionExcelT _o) {
    ...
    if (_o.LockUI != null) {
      ...
      for (var _j = 0; _j < __LockUI.Length; ++_j) { __LockUI[_j] = builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.LockUI[_j], key) : _o.LockUI[_j])); }
      _LockUI = CreateLockUIVector(builder, __LockUI);
    }
		var _ShortcutPopupPriority = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ShortcutPopupPriority, key) : _o.ShortcutPopupPriority;
    ...
    if (_o.ShortcutUIName != null) {
      ...
      for (var _j = 0; _j < __ShortcutUIName.Length; ++_j) { __ShortcutUIName[_j] = builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ShortcutUIName[_j], key) : _o.ShortcutUIName[_j])); }
      _ShortcutUIName = CreateShortcutUINameVector(builder, __ShortcutUIName);
    }
		var _ShortcutParam = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ShortcutParam, key) : _o.ShortcutParam;
    var _Scene = _o.Scene == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.Scene, key) : _o.Scene));
		var _HideWhenLocked = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.HideWhenLocked, key) : _o.HideWhenLocked;
		...
		var _ScenarioModeId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ScenarioModeId, key) : _o.ScenarioModeId;
		var _CampaignStageId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CampaignStageId, key) : _o.CampaignStageId;
		...
		var _OpenDayOfWeek = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.OpenDayOfWeek, key) : _o.OpenDayOfWeek;
		var _OpenHour = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.OpenHour, key) : _o.OpenHour;
		var _CloseDayOfWeek = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CloseDayOfWeek, key) : _o.CloseDayOfWeek;
		var _CloseHour = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CloseHour, key) : _o.CloseHour;
		var _OpenedCafeId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.OpenedCafeId, key) : _o.OpenedCafeId;
		var _CafeIdforCafeRank = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CafeIdforCafeRank, key) : _o.CafeIdforCafeRank;
		var _CafeRank = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CafeRank, key) : _o.CafeRank;
		var _ContentsOpenShow = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ContentsOpenShow, key) : _o.ContentsOpenShow;
    var _ContentsOpenShortcutUI = _o.ContentsOpenShortcutUI == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ContentsOpenShortcutUI, key) : _o.ContentsOpenShortcutUI));
