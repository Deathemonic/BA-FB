...
public struct OpenConditionExcel : IFlatbufferObject
{
  ...
  public Global.OpenConditionContent OpenConditionContentType { get { int o = __p.__offset(4); return o != 0 ? (Global.OpenConditionContent)__p.bb.GetInt(o + __p.bb_pos) : Global.OpenConditionContent.Shop; } }
  ...
  public Global.MultipleConditionCheckType MultipleConditionCheckType { get { int o = __p.__offset(24); return o != 0 ? (Global.MultipleConditionCheckType)__p.bb.GetInt(o + __p.bb_pos) : Global.MultipleConditionCheckType.And; } }
  public Global.WeekDay OpenDayOfWeek { get { int o = __p.__offset(26); return o != 0 ? (Global.WeekDay)__p.bb.GetInt(o + __p.bb_pos) : Global.WeekDay.Sunday; } }
  public long OpenHour { get { int o = __p.__offset(28); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public Global.WeekDay CloseDayOfWeek { get { int o = __p.__offset(30); return o != 0 ? (Global.WeekDay)__p.bb.GetInt(o + __p.bb_pos) : Global.WeekDay.Sunday; } }
  ...
  public static Offset<Global.OpenConditionExcel> CreateOpenConditionExcel(FlatBufferBuilder builder,
      Global.OpenConditionContent OpenConditionContentType = Global.OpenConditionContent.Shop,
      ...
      Global.WeekDay OpenDayOfWeek = Global.WeekDay.Sunday,
      long OpenHour = 0,
      Global.WeekDay CloseDayOfWeek = Global.WeekDay.Sunday,
      long CloseHour = 0,
      long OpenedCafeId = 0,
  ...
  public static void AddOpenConditionContentType(FlatBufferBuilder builder, Global.OpenConditionContent openConditionContentType) { builder.AddInt(0, (int)openConditionContentType, 0); }
  ...
  public static void AddMultipleConditionCheckType(FlatBufferBuilder builder, Global.MultipleConditionCheckType multipleConditionCheckType) { builder.AddInt(10, (int)multipleConditionCheckType, 0); }
  public static void AddOpenDayOfWeek(FlatBufferBuilder builder, Global.WeekDay openDayOfWeek) { builder.AddInt(11, (int)openDayOfWeek, 0); }
  public static void AddOpenHour(FlatBufferBuilder builder, long openHour) { builder.AddLong(12, openHour, 0); }
  public static void AddCloseDayOfWeek(FlatBufferBuilder builder, Global.WeekDay closeDayOfWeek) { builder.AddInt(13, (int)closeDayOfWeek, 0); }
  ...
  public static Offset<Global.OpenConditionExcel> EndOpenConditionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.OpenConditionExcel>(o);
  }
  ...
  public void UnPackTo(OpenConditionExcelT _o) {
    ...
    _o.OpenConditionContentType = TableEncryptionService.UseEncryption ? (Global.OpenConditionContent)TableEncryptionService.Convert((int)this.OpenConditionContentType, key) : this.OpenConditionContentType;
    ...
    _o.ShortcutPopupPriority = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ShortcutPopupPriority, key) : this.ShortcutPopupPriority;
    ...
    _o.ShortcutParam = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.ShortcutParam, key) : this.ShortcutParam;
    _o.Scene = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Scene, key) : this.Scene;
    _o.HideWhenLocked = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.HideWhenLocked, key) : this.HideWhenLocked;
    ...
    _o.CampaignStageId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.CampaignStageId, key) : this.CampaignStageId;
    _o.MultipleConditionCheckType = TableEncryptionService.UseEncryption ? (Global.MultipleConditionCheckType)TableEncryptionService.Convert((int)this.MultipleConditionCheckType, key) : this.MultipleConditionCheckType;
    _o.OpenDayOfWeek = TableEncryptionService.UseEncryption ? (Global.WeekDay)TableEncryptionService.Convert((int)this.OpenDayOfWeek, key) : this.OpenDayOfWeek;
    _o.OpenHour = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.OpenHour, key) : this.OpenHour;
    _o.CloseDayOfWeek = TableEncryptionService.UseEncryption ? (Global.WeekDay)TableEncryptionService.Convert((int)this.CloseDayOfWeek, key) : this.CloseDayOfWeek;
    _o.CloseHour = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.CloseHour, key) : this.CloseHour;
    _o.OpenedCafeId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.OpenedCafeId, key) : this.OpenedCafeId;
    _o.CafeIdforCafeRank = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.CafeIdforCafeRank, key) : this.CafeIdforCafeRank;
    _o.CafeRank = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.CafeRank, key) : this.CafeRank;
    _o.ContentsOpenShow = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.ContentsOpenShow, key) : this.ContentsOpenShow;
  ...
  public static Offset<Global.OpenConditionExcel> Pack(FlatBufferBuilder builder, OpenConditionExcelT _o) {
    if (_o == null) return default(Offset<Global.OpenConditionExcel>);
		byte[] key = TableEncryptionService.CreateKey("OpenCondition");
		var _OpenConditionContentType = TableEncryptionService.UseEncryption ? (Global.OpenConditionContent)TableEncryptionService.Convert((int)_o.OpenConditionContentType, key) : _o.OpenConditionContentType;
    var _LockUI = default(VectorOffset);
    if (_o.LockUI != null) {
      var __LockUI = new StringOffset[_o.LockUI.Count];
      for (var _j = 0; _j < __LockUI.Length; ++_j) { __LockUI[_j] = builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.LockUI[_j], key) : _o.LockUI[_j])); }
      _LockUI = CreateLockUIVector(builder, __LockUI);
    }
		var _ShortcutPopupPriority = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ShortcutPopupPriority, key) : _o.ShortcutPopupPriority;
    ...
    if (_o.ShortcutUIName != null) {
      ...
      for (var _j = 0; _j < __ShortcutUIName.Length; ++_j) { __ShortcutUIName[_j] = builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.ShortcutUIName[_j], key) : _o.ShortcutUIName[_j])); }
      _ShortcutUIName = CreateShortcutUINameVector(builder, __ShortcutUIName);
    }
		var _ShortcutParam = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.ShortcutParam, key) : _o.ShortcutParam;
    var _Scene = _o.Scene == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.Scene, key) : _o.Scene));
		var _HideWhenLocked = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.HideWhenLocked, key) : _o.HideWhenLocked;
		...
		var _CampaignStageId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.CampaignStageId, key) : _o.CampaignStageId;
		var _MultipleConditionCheckType = TableEncryptionService.UseEncryption ? (Global.MultipleConditionCheckType)TableEncryptionService.Convert((int)_o.MultipleConditionCheckType, key) : _o.MultipleConditionCheckType;
		var _OpenDayOfWeek = TableEncryptionService.UseEncryption ? (Global.WeekDay)TableEncryptionService.Convert((int)_o.OpenDayOfWeek, key) : _o.OpenDayOfWeek;
		var _OpenHour = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.OpenHour, key) : _o.OpenHour;
		var _CloseDayOfWeek = TableEncryptionService.UseEncryption ? (Global.WeekDay)TableEncryptionService.Convert((int)_o.CloseDayOfWeek, key) : _o.CloseDayOfWeek;
		var _CloseHour = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.CloseHour, key) : _o.CloseHour;
		var _OpenedCafeId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.OpenedCafeId, key) : _o.OpenedCafeId;
		var _CafeIdforCafeRank = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.CafeIdforCafeRank, key) : _o.CafeIdforCafeRank;
		var _CafeRank = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.CafeRank, key) : _o.CafeRank;
		var _ContentsOpenShow = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.ContentsOpenShow, key) : _o.ContentsOpenShow;
    var _ContentsOpenShortcutUI = _o.ContentsOpenShortcutUI == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.ContentsOpenShortcutUI, key) : _o.ContentsOpenShortcutUI));
    return CreateOpenConditionExcel(
      ...
      _LockUI,
      TableEncryptionService.UseEncryption ? _ShortcutPopupPriority : _o.ShortcutPopupPriority,
      _ShortcutUIName,
      TableEncryptionService.UseEncryption ? _ShortcutParam : _o.ShortcutParam,
      _Scene,
      TableEncryptionService.UseEncryption ? _HideWhenLocked : _o.HideWhenLocked,
      ...
      TableEncryptionService.UseEncryption ? _CampaignStageId : _o.CampaignStageId,
      TableEncryptionService.UseEncryption ? _MultipleConditionCheckType : _o.MultipleConditionCheckType,
      TableEncryptionService.UseEncryption ? _OpenDayOfWeek : _o.OpenDayOfWeek,
      TableEncryptionService.UseEncryption ? _OpenHour : _o.OpenHour,
      TableEncryptionService.UseEncryption ? _CloseDayOfWeek : _o.CloseDayOfWeek,
      TableEncryptionService.UseEncryption ? _CloseHour : _o.CloseHour,
      TableEncryptionService.UseEncryption ? _OpenedCafeId : _o.OpenedCafeId,
      TableEncryptionService.UseEncryption ? _CafeIdforCafeRank : _o.CafeIdforCafeRank,
      TableEncryptionService.UseEncryption ? _CafeRank : _o.CafeRank,
      TableEncryptionService.UseEncryption ? _ContentsOpenShow : _o.ContentsOpenShow,
...
{
  public Global.OpenConditionContent OpenConditionContentType { get; set; }
  ...
  public Global.MultipleConditionCheckType MultipleConditionCheckType { get; set; }
  public Global.WeekDay OpenDayOfWeek { get; set; }
  public long OpenHour { get; set; }
  public Global.WeekDay CloseDayOfWeek { get; set; }
  ...
  public OpenConditionExcelT() {
    this.OpenConditionContentType = Global.OpenConditionContent.Shop;
    this.LockUI = null;
    ...
    this.MultipleConditionCheckType = Global.MultipleConditionCheckType.And;
    this.OpenDayOfWeek = Global.WeekDay.Sunday;
    this.OpenHour = 0;
    this.CloseDayOfWeek = Global.WeekDay.Sunday;
    this.CloseHour = 0;
    this.OpenedCafeId = 0;
...
static public class OpenConditionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyField(tablePos, 4 /*OpenConditionContentType*/, 4 /*Global.OpenConditionContent*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 24 /*MultipleConditionCheckType*/, 4 /*Global.MultipleConditionCheckType*/, 4, false)
      && verifier.VerifyField(tablePos, 26 /*OpenDayOfWeek*/, 4 /*Global.WeekDay*/, 4, false)
      && verifier.VerifyField(tablePos, 28 /*OpenHour*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 30 /*CloseDayOfWeek*/, 4 /*Global.WeekDay*/, 4, false)
