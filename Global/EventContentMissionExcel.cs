...
public struct EventContentMissionExcel : IFlatbufferObject
{
  ...
  public Global.MissionCompleteConditionType CompleteConditionType { get { int o = __p.__offset(36); return o != 0 ? (Global.MissionCompleteConditionType)__p.bb.GetInt(o + __p.bb_pos) : Global.MissionCompleteConditionType.None; } }
  ...
  public Global.Tag CompleteConditionParameterTag(int j) { int o = __p.__offset(44); return o != 0 ? (Global.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Global.Tag)0; }
  public int CompleteConditionParameterTagLength { get { int o = __p.__offset(44); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Global.Tag> GetCompleteConditionParameterTagBytes() { return __p.__vector_as_span<Global.Tag>(44, 4); }
#else
  public ArraySegment<byte>? GetCompleteConditionParameterTagBytes() { return __p.__vector_as_arraysegment(44); }
#endif
  public Global.Tag[] GetCompleteConditionParameterTagArray() { int o = __p.__offset(44); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Global.Tag[] a = new Global.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (Global.Tag)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Global.ParcelType MissionRewardParcelType(int j) { int o = __p.__offset(52); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Global.ParcelType)0; }
  public int MissionRewardParcelTypeLength { get { int o = __p.__offset(52); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Global.ParcelType> GetMissionRewardParcelTypeBytes() { return __p.__vector_as_span<Global.ParcelType>(52, 4); }
#else
  public ArraySegment<byte>? GetMissionRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(52); }
#endif
  public Global.ParcelType[] GetMissionRewardParcelTypeArray() { int o = __p.__offset(52); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Global.ParcelType[] a = new Global.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Global.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Global.ParcelType ConditionRewardParcelType(int j) { int o = __p.__offset(58); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Global.ParcelType)0; }
  public int ConditionRewardParcelTypeLength { get { int o = __p.__offset(58); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Global.ParcelType> GetConditionRewardParcelTypeBytes() { return __p.__vector_as_span<Global.ParcelType>(58, 4); }
#else
  public ArraySegment<byte>? GetConditionRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(58); }
#endif
  public Global.ParcelType[] GetConditionRewardParcelTypeArray() { int o = __p.__offset(58); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Global.ParcelType[] a = new Global.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Global.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Global.EventContentMissionExcel> CreateEventContentMissionExcel(FlatBufferBuilder builder,
      long id = 0,
  ...
  public static void AddCompleteConditionType(FlatBufferBuilder builder, Global.MissionCompleteConditionType completeConditionType) { builder.AddInt(16, (int)completeConditionType, 0); }
  ...
  public static Offset<Global.EventContentMissionExcel> EndEventContentMissionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.EventContentMissionExcel>(o);
  }
  ...
  public static Offset<Global.EventContentMissionExcel> Pack(FlatBufferBuilder builder, EventContentMissionExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentMissionExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentMission");
...
static public class EventContentMissionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 36 /*CompleteConditionType*/, 4 /*Global.MissionCompleteConditionType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 44 /*CompleteConditionParameterTag*/, 4 /*Global.Tag*/, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 52 /*MissionRewardParcelType*/, 4 /*Global.ParcelType*/, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 58 /*ConditionRewardParcelType*/, 4 /*Global.ParcelType*/, false)
