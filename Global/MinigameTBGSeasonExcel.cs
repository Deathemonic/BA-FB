...
public struct MinigameTBGSeasonExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(MinigameTBGSeasonExcelT _o) {
    ...
    _o.ItemSlot = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.ItemSlot, key) : this.ItemSlot;
    _o.DefaultEchelonHp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.DefaultEchelonHp, key) : this.DefaultEchelonHp;
    _o.DefaultItemDiceId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.DefaultItemDiceId, key) : this.DefaultItemDiceId;
    _o.EchelonSlot1CharacterId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.EchelonSlot1CharacterId, key) : this.EchelonSlot1CharacterId;
    _o.EchelonSlot2CharacterId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.EchelonSlot2CharacterId, key) : this.EchelonSlot2CharacterId;
    _o.EchelonSlot3CharacterId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.EchelonSlot3CharacterId, key) : this.EchelonSlot3CharacterId;
    _o.EchelonSlot4CharacterId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.EchelonSlot4CharacterId, key) : this.EchelonSlot4CharacterId;
    ...
    _o.EventUseCostType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)this.EventUseCostType, key) : this.EventUseCostType;
    ...
    _o.EchelonRevivalCostType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)this.EchelonRevivalCostType, key) : this.EchelonRevivalCostType;
    _o.EchelonRevivalCostId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.EchelonRevivalCostId, key) : this.EchelonRevivalCostId;
    _o.EchelonRevivalCostAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.EchelonRevivalCostAmount, key) : this.EchelonRevivalCostAmount;
    _o.EnemyBossHP = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.EnemyBossHP, key) : this.EnemyBossHP;
    _o.EnemyMinionHP = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.EnemyMinionHP, key) : this.EnemyMinionHP;
    _o.AttackDamage = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.AttackDamage, key) : this.AttackDamage;
    _o.CriticalAttackDamage = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.CriticalAttackDamage, key) : this.CriticalAttackDamage;
    _o.RoundItemSelectLimit = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.RoundItemSelectLimit, key) : this.RoundItemSelectLimit;
    ...
    _o.MaxHp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.MaxHp, key) : this.MaxHp;
    ...
    _o.StartThemaIndex = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.StartThemaIndex, key) : this.StartThemaIndex;
    _o.LoopThemaIndex = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.LoopThemaIndex, key) : this.LoopThemaIndex;
    _o.MaxDicePlus = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.MaxDicePlus, key) : this.MaxDicePlus;
  }
  public static Offset<Global.MinigameTBGSeasonExcel> Pack(FlatBufferBuilder builder, MinigameTBGSeasonExcelT _o) {
    if (_o == null) return default(Offset<Global.MinigameTBGSeasonExcel>);
		...
		var _ItemSlot = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.ItemSlot, key) : _o.ItemSlot;
		var _DefaultEchelonHp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.DefaultEchelonHp, key) : _o.DefaultEchelonHp;
		var _DefaultItemDiceId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.DefaultItemDiceId, key) : _o.DefaultItemDiceId;
		var _EchelonSlot1CharacterId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.EchelonSlot1CharacterId, key) : _o.EchelonSlot1CharacterId;
		var _EchelonSlot2CharacterId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.EchelonSlot2CharacterId, key) : _o.EchelonSlot2CharacterId;
		var _EchelonSlot3CharacterId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.EchelonSlot3CharacterId, key) : _o.EchelonSlot3CharacterId;
		var _EchelonSlot4CharacterId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.EchelonSlot4CharacterId, key) : _o.EchelonSlot4CharacterId;
    var _EchelonSlot1Portrait = _o.EchelonSlot1Portrait == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.EchelonSlot1Portrait, key) : _o.EchelonSlot1Portrait));
    var _EchelonSlot2Portrait = _o.EchelonSlot2Portrait == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.EchelonSlot2Portrait, key) : _o.EchelonSlot2Portrait));
    var _EchelonSlot3Portrait = _o.EchelonSlot3Portrait == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.EchelonSlot3Portrait, key) : _o.EchelonSlot3Portrait));
    var _EchelonSlot4Portrait = _o.EchelonSlot4Portrait == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.EchelonSlot4Portrait, key) : _o.EchelonSlot4Portrait));
		var _EventUseCostType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)_o.EventUseCostType, key) : _o.EventUseCostType;
		...
		var _EchelonRevivalCostType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)_o.EchelonRevivalCostType, key) : _o.EchelonRevivalCostType;
		var _EchelonRevivalCostId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.EchelonRevivalCostId, key) : _o.EchelonRevivalCostId;
		var _EchelonRevivalCostAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.EchelonRevivalCostAmount, key) : _o.EchelonRevivalCostAmount;
		var _EnemyBossHP = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.EnemyBossHP, key) : _o.EnemyBossHP;
		var _EnemyMinionHP = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.EnemyMinionHP, key) : _o.EnemyMinionHP;
		var _AttackDamage = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.AttackDamage, key) : _o.AttackDamage;
		var _CriticalAttackDamage = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.CriticalAttackDamage, key) : _o.CriticalAttackDamage;
		var _RoundItemSelectLimit = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.RoundItemSelectLimit, key) : _o.RoundItemSelectLimit;
		...
		var _MaxHp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.MaxHp, key) : _o.MaxHp;
    var _MapImagePath = _o.MapImagePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.MapImagePath, key) : _o.MapImagePath));
    var _MapNameLocalize = _o.MapNameLocalize == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.MapNameLocalize, key) : _o.MapNameLocalize));
		var _StartThemaIndex = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.StartThemaIndex, key) : _o.StartThemaIndex;
		var _LoopThemaIndex = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.LoopThemaIndex, key) : _o.LoopThemaIndex;
		var _MaxDicePlus = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.MaxDicePlus, key) : _o.MaxDicePlus;
