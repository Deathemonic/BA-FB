...
public struct MinigameTBGSeasonExcel : IFlatbufferObject
{
  ...
  public Global.ParcelType EventUseCostType { get { int o = __p.__offset(28); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Global.ParcelType.None; } }
  public long EventUseCostId { get { int o = __p.__offset(30); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public Global.ParcelType EchelonRevivalCostType { get { int o = __p.__offset(32); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Global.ParcelType.None; } }
  ...
  public static Offset<Global.MinigameTBGSeasonExcel> CreateMinigameTBGSeasonExcel(FlatBufferBuilder builder,
      ...
      Global.ParcelType EchelonRevivalCostType = Global.ParcelType.None,
  ...
  public static void AddEventUseCostType(FlatBufferBuilder builder, Global.ParcelType eventUseCostType) { builder.AddInt(12, (int)eventUseCostType, 0); }
  public static void AddEventUseCostId(FlatBufferBuilder builder, long eventUseCostId) { builder.AddLong(13, eventUseCostId, 0); }
  public static void AddEchelonRevivalCostType(FlatBufferBuilder builder, Global.ParcelType echelonRevivalCostType) { builder.AddInt(14, (int)echelonRevivalCostType, 0); }
  ...
  public static Offset<Global.MinigameTBGSeasonExcel> EndMinigameTBGSeasonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.MinigameTBGSeasonExcel>(o);
  }
  ...
  public void UnPackTo(MinigameTBGSeasonExcelT _o) {
    ...
    _o.ItemSlot = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ItemSlot, key) : this.ItemSlot;
    _o.DefaultEchelonHp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.DefaultEchelonHp, key) : this.DefaultEchelonHp;
    _o.DefaultItemDiceId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.DefaultItemDiceId, key) : this.DefaultItemDiceId;
    _o.EchelonSlot1CharacterId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EchelonSlot1CharacterId, key) : this.EchelonSlot1CharacterId;
    _o.EchelonSlot2CharacterId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EchelonSlot2CharacterId, key) : this.EchelonSlot2CharacterId;
    _o.EchelonSlot3CharacterId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EchelonSlot3CharacterId, key) : this.EchelonSlot3CharacterId;
    _o.EchelonSlot4CharacterId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EchelonSlot4CharacterId, key) : this.EchelonSlot4CharacterId;
    _o.EchelonSlot1Portrait = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EchelonSlot1Portrait, key) : this.EchelonSlot1Portrait;
    _o.EchelonSlot2Portrait = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EchelonSlot2Portrait, key) : this.EchelonSlot2Portrait;
    _o.EchelonSlot3Portrait = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EchelonSlot3Portrait, key) : this.EchelonSlot3Portrait;
    _o.EchelonSlot4Portrait = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EchelonSlot4Portrait, key) : this.EchelonSlot4Portrait;
    ...
    _o.EchelonRevivalCostType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EchelonRevivalCostType, key) : this.EchelonRevivalCostType;
    _o.EchelonRevivalCostId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EchelonRevivalCostId, key) : this.EchelonRevivalCostId;
    _o.EchelonRevivalCostAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EchelonRevivalCostAmount, key) : this.EchelonRevivalCostAmount;
    _o.EnemyBossHP = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EnemyBossHP, key) : this.EnemyBossHP;
    _o.EnemyMinionHP = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EnemyMinionHP, key) : this.EnemyMinionHP;
    _o.AttackDamage = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.AttackDamage, key) : this.AttackDamage;
    _o.CriticalAttackDamage = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CriticalAttackDamage, key) : this.CriticalAttackDamage;
    _o.RoundItemSelectLimit = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.RoundItemSelectLimit, key) : this.RoundItemSelectLimit;
    ...
    _o.MaxHp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MaxHp, key) : this.MaxHp;
    _o.MapImagePath = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MapImagePath, key) : this.MapImagePath;
    _o.MapNameLocalize = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MapNameLocalize, key) : this.MapNameLocalize;
    _o.StartThemaIndex = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StartThemaIndex, key) : this.StartThemaIndex;
    _o.LoopThemaIndex = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.LoopThemaIndex, key) : this.LoopThemaIndex;
    _o.MaxDicePlus = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MaxDicePlus, key) : this.MaxDicePlus;
  }
  public static Offset<Global.MinigameTBGSeasonExcel> Pack(FlatBufferBuilder builder, MinigameTBGSeasonExcelT _o) {
    if (_o == null) return default(Offset<Global.MinigameTBGSeasonExcel>);
		byte[] key = TableEncryptionService.CreateKey("MinigameTBGSeason");
		...
		var _ItemSlot = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ItemSlot, key) : _o.ItemSlot;
		var _DefaultEchelonHp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DefaultEchelonHp, key) : _o.DefaultEchelonHp;
		var _DefaultItemDiceId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DefaultItemDiceId, key) : _o.DefaultItemDiceId;
		var _EchelonSlot1CharacterId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EchelonSlot1CharacterId, key) : _o.EchelonSlot1CharacterId;
		var _EchelonSlot2CharacterId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EchelonSlot2CharacterId, key) : _o.EchelonSlot2CharacterId;
		var _EchelonSlot3CharacterId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EchelonSlot3CharacterId, key) : _o.EchelonSlot3CharacterId;
		var _EchelonSlot4CharacterId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EchelonSlot4CharacterId, key) : _o.EchelonSlot4CharacterId;
    var _EchelonSlot1Portrait = _o.EchelonSlot1Portrait == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.EchelonSlot1Portrait, key) : _o.EchelonSlot1Portrait));
    var _EchelonSlot2Portrait = _o.EchelonSlot2Portrait == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.EchelonSlot2Portrait, key) : _o.EchelonSlot2Portrait));
    var _EchelonSlot3Portrait = _o.EchelonSlot3Portrait == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.EchelonSlot3Portrait, key) : _o.EchelonSlot3Portrait));
    var _EchelonSlot4Portrait = _o.EchelonSlot4Portrait == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.EchelonSlot4Portrait, key) : _o.EchelonSlot4Portrait));
		...
		var _EchelonRevivalCostType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EchelonRevivalCostType, key) : _o.EchelonRevivalCostType;
		var _EchelonRevivalCostId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EchelonRevivalCostId, key) : _o.EchelonRevivalCostId;
		var _EchelonRevivalCostAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EchelonRevivalCostAmount, key) : _o.EchelonRevivalCostAmount;
		var _EnemyBossHP = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EnemyBossHP, key) : _o.EnemyBossHP;
		var _EnemyMinionHP = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EnemyMinionHP, key) : _o.EnemyMinionHP;
		var _AttackDamage = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.AttackDamage, key) : _o.AttackDamage;
		var _CriticalAttackDamage = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CriticalAttackDamage, key) : _o.CriticalAttackDamage;
		var _RoundItemSelectLimit = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RoundItemSelectLimit, key) : _o.RoundItemSelectLimit;
    ...
    var _MapImagePath = _o.MapImagePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.MapImagePath, key) : _o.MapImagePath));
    var _MapNameLocalize = _o.MapNameLocalize == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.MapNameLocalize, key) : _o.MapNameLocalize));
		var _StartThemaIndex = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StartThemaIndex, key) : _o.StartThemaIndex;
		var _LoopThemaIndex = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.LoopThemaIndex, key) : _o.LoopThemaIndex;
		var _MaxDicePlus = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MaxDicePlus, key) : _o.MaxDicePlus;
    return CreateMinigameTBGSeasonExcel(
      builder,
      TableEncryptionService.UseEncryption ? _EventContentId : _o.EventContentId,
      TableEncryptionService.UseEncryption ? _ItemSlot : _o.ItemSlot,
      TableEncryptionService.UseEncryption ? _DefaultEchelonHp : _o.DefaultEchelonHp,
      TableEncryptionService.UseEncryption ? _DefaultItemDiceId : _o.DefaultItemDiceId,
      TableEncryptionService.UseEncryption ? _EchelonSlot1CharacterId : _o.EchelonSlot1CharacterId,
      TableEncryptionService.UseEncryption ? _EchelonSlot2CharacterId : _o.EchelonSlot2CharacterId,
      TableEncryptionService.UseEncryption ? _EchelonSlot3CharacterId : _o.EchelonSlot3CharacterId,
      TableEncryptionService.UseEncryption ? _EchelonSlot4CharacterId : _o.EchelonSlot4CharacterId,
      ...
      TableEncryptionService.UseEncryption ? _EchelonRevivalCostType : _o.EchelonRevivalCostType,
      TableEncryptionService.UseEncryption ? _EchelonRevivalCostId : _o.EchelonRevivalCostId,
      TableEncryptionService.UseEncryption ? _EchelonRevivalCostAmount : _o.EchelonRevivalCostAmount,
      TableEncryptionService.UseEncryption ? _EnemyBossHP : _o.EnemyBossHP,
      TableEncryptionService.UseEncryption ? _EnemyMinionHP : _o.EnemyMinionHP,
      TableEncryptionService.UseEncryption ? _AttackDamage : _o.AttackDamage,
      TableEncryptionService.UseEncryption ? _CriticalAttackDamage : _o.CriticalAttackDamage,
      TableEncryptionService.UseEncryption ? _RoundItemSelectLimit : _o.RoundItemSelectLimit,
      ...
      _MapImagePath,
      _MapNameLocalize,
      TableEncryptionService.UseEncryption ? _StartThemaIndex : _o.StartThemaIndex,
      TableEncryptionService.UseEncryption ? _LoopThemaIndex : _o.LoopThemaIndex,
      TableEncryptionService.UseEncryption ? _MaxDicePlus : _o.MaxDicePlus);
  }
}
...
public class MinigameTBGSeasonExcelT
{
  ...
  public Global.ParcelType EchelonRevivalCostType { get; set; }
  ...
  public MinigameTBGSeasonExcelT() {
    ...
    this.EchelonRevivalCostType = Global.ParcelType.None;
...
static public class MinigameTBGSeasonExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 28 /*EventUseCostType*/, 4 /*Global.ParcelType*/, 4, false)
      && verifier.VerifyField(tablePos, 30 /*EventUseCostId*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 32 /*EchelonRevivalCostType*/, 4 /*Global.ParcelType*/, 4, false)
