...
public struct CampaignStageExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.CampaignStageExcel> Pack(FlatBufferBuilder builder, CampaignStageExcelT _o) {
    ...
    var _FirstClearEventMessage = _o.FirstClearEventMessage == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.FirstClearEventMessage, key) : _o.FirstClearEventMessage));
