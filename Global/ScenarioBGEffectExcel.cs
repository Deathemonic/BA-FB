...
public struct ScenarioBGEffectExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ScenarioBGEffectExcelT _o) {
    ...
    _o.Scroll = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Scroll, key) : this.Scroll;
    _o.ScrollTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ScrollTime, key) : this.ScrollTime;
    _o.ScrollFrom = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ScrollFrom, key) : this.ScrollFrom;
    _o.ScrollTo = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ScrollTo, key) : this.ScrollTo;
  }
  public static Offset<Global.ScenarioBGEffectExcel> Pack(FlatBufferBuilder builder, ScenarioBGEffectExcelT _o) {
    ...
    var _Effect = _o.Effect == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.Effect, key) : _o.Effect));
    var _Effect2 = _o.Effect2 == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.Effect2, key) : _o.Effect2));
		var _Scroll = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Scroll, key) : _o.Scroll;
		var _ScrollTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ScrollTime, key) : _o.ScrollTime;
		var _ScrollFrom = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ScrollFrom, key) : _o.ScrollFrom;
		var _ScrollTo = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ScrollTo, key) : _o.ScrollTo;
