...
public struct ScenarioBGEffectExcel : IFlatbufferObject
{
  ...
  public Global.ScenarioBGScroll Scroll { get { int o = __p.__offset(10); return o != 0 ? (Global.ScenarioBGScroll)__p.bb.GetInt(o + __p.bb_pos) : Global.ScenarioBGScroll.None; } }
  ...
  public static Offset<Global.ScenarioBGEffectExcel> CreateScenarioBGEffectExcel(FlatBufferBuilder builder,
      uint Name = 0,
      StringOffset EffectOffset = default(StringOffset),
      StringOffset Effect2Offset = default(StringOffset),
      Global.ScenarioBGScroll Scroll = Global.ScenarioBGScroll.None,
      long ScrollTime = 0,
      long ScrollFrom = 0,
      long ScrollTo = 0) {
  ...
  public static void AddScroll(FlatBufferBuilder builder, Global.ScenarioBGScroll scroll) { builder.AddInt(3, (int)scroll, 0); }
  ...
  public static Offset<Global.ScenarioBGEffectExcel> EndScenarioBGEffectExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.ScenarioBGEffectExcel>(o);
  }
  ...
  public void UnPackTo(ScenarioBGEffectExcelT _o) {
    ...
    _o.Effect = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Effect, key) : this.Effect;
    _o.Effect2 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Effect2, key) : this.Effect2;
    _o.Scroll = TableEncryptionService.UseEncryption ? (Global.ScenarioBGScroll)TableEncryptionService.Convert((int)this.Scroll, key) : this.Scroll;
    _o.ScrollTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ScrollTime, key) : this.ScrollTime;
    _o.ScrollFrom = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ScrollFrom, key) : this.ScrollFrom;
    _o.ScrollTo = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ScrollTo, key) : this.ScrollTo;
  }
  public static Offset<Global.ScenarioBGEffectExcel> Pack(FlatBufferBuilder builder, ScenarioBGEffectExcelT _o) {
    if (_o == null) return default(Offset<Global.ScenarioBGEffectExcel>);
		byte[] key = TableEncryptionService.CreateKey("ScenarioBGEffect");
		var _Name = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)_o.Name, key) : _o.Name;
    var _Effect = _o.Effect == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.Effect, key) : _o.Effect));
    var _Effect2 = _o.Effect2 == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.Effect2, key) : _o.Effect2));
		var _Scroll = TableEncryptionService.UseEncryption ? (Global.ScenarioBGScroll)TableEncryptionService.Convert((int)_o.Scroll, key) : _o.Scroll;
		var _ScrollTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ScrollTime, key) : _o.ScrollTime;
		var _ScrollFrom = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ScrollFrom, key) : _o.ScrollFrom;
		var _ScrollTo = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ScrollTo, key) : _o.ScrollTo;
    return CreateScenarioBGEffectExcel(
      builder,
      TableEncryptionService.UseEncryption ? _Name : _o.Name,
      _Effect,
      _Effect2,
      TableEncryptionService.UseEncryption ? _Scroll : _o.Scroll,
      TableEncryptionService.UseEncryption ? _ScrollTime : _o.ScrollTime,
      TableEncryptionService.UseEncryption ? _ScrollFrom : _o.ScrollFrom,
      TableEncryptionService.UseEncryption ? _ScrollTo : _o.ScrollTo);
  }
}
...
public class ScenarioBGEffectExcelT
{
  ...
  public Global.ScenarioBGScroll Scroll { get; set; }
  ...
  public ScenarioBGEffectExcelT() {
    ...
    this.Effect = null;
    this.Effect2 = null;
    this.Scroll = Global.ScenarioBGScroll.None;
    this.ScrollTime = 0;
    this.ScrollFrom = 0;
    this.ScrollTo = 0;
  }
...
static public class ScenarioBGEffectExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*Scroll*/, 4 /*Global.ScenarioBGScroll*/, 4, false)
