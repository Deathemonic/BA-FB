...
public struct EventContentFortuneGachaModifyExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(EventContentFortuneGachaModifyExcelT _o) {
    ...
    _o.TargetGrade = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.TargetGrade, key) : this.TargetGrade;
    _o.ProbModifyStartCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ProbModifyStartCount, key) : this.ProbModifyStartCount;
  ...
  public static Offset<Global.EventContentFortuneGachaModifyExcel> Pack(FlatBufferBuilder builder, EventContentFortuneGachaModifyExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentFortuneGachaModifyExcel>);
		...
		var _TargetGrade = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.TargetGrade, key) : _o.TargetGrade;
		var _ProbModifyStartCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ProbModifyStartCount, key) : _o.ProbModifyStartCount;
    var _UsePrefabName = _o.UsePrefabName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.UsePrefabName, key) : _o.UsePrefabName));
    var _BucketImagePath = _o.BucketImagePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.BucketImagePath, key) : _o.BucketImagePath));
    var _ShopBgImagePath = _o.ShopBgImagePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ShopBgImagePath, key) : _o.ShopBgImagePath));
    var _TitleLocalizeKey = _o.TitleLocalizeKey == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.TitleLocalizeKey, key) : _o.TitleLocalizeKey));
