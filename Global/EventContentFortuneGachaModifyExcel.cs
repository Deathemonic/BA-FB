...
public struct EventContentFortuneGachaModifyExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.EventContentFortuneGachaModifyExcel> CreateEventContentFortuneGachaModifyExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.EventContentFortuneGachaModifyExcel> EndEventContentFortuneGachaModifyExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.EventContentFortuneGachaModifyExcel>(o);
  }
  ...
  public void UnPackTo(EventContentFortuneGachaModifyExcelT _o) {
    ...
    _o.EventContentId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.EventContentId, key) : this.EventContentId;
    _o.TargetGrade = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.TargetGrade, key) : this.TargetGrade;
    _o.ProbModifyStartCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.ProbModifyStartCount, key) : this.ProbModifyStartCount;
    ...
    _o.BucketImagePath = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BucketImagePath, key) : this.BucketImagePath;
    _o.ShopBgImagePath = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ShopBgImagePath, key) : this.ShopBgImagePath;
    _o.TitleLocalizeKey = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.TitleLocalizeKey, key) : this.TitleLocalizeKey;
  }
  public static Offset<Global.EventContentFortuneGachaModifyExcel> Pack(FlatBufferBuilder builder, EventContentFortuneGachaModifyExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentFortuneGachaModifyExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentFortuneGachaModify");
		var _EventContentId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.EventContentId, key) : _o.EventContentId;
		var _TargetGrade = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.TargetGrade, key) : _o.TargetGrade;
		var _ProbModifyStartCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.ProbModifyStartCount, key) : _o.ProbModifyStartCount;
    ...
    var _BucketImagePath = _o.BucketImagePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.BucketImagePath, key) : _o.BucketImagePath));
    var _ShopBgImagePath = _o.ShopBgImagePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.ShopBgImagePath, key) : _o.ShopBgImagePath));
    var _TitleLocalizeKey = _o.TitleLocalizeKey == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.TitleLocalizeKey, key) : _o.TitleLocalizeKey));
    return CreateEventContentFortuneGachaModifyExcel(
      builder,
      TableEncryptionService.UseEncryption ? _EventContentId : _o.EventContentId,
      TableEncryptionService.UseEncryption ? _TargetGrade : _o.TargetGrade,
      TableEncryptionService.UseEncryption ? _ProbModifyStartCount : _o.ProbModifyStartCount,
      _UsePrefabName,
      _BucketImagePath,
      _ShopBgImagePath,
      _TitleLocalizeKey);
