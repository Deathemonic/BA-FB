...
public struct DefaultCharacterExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.DefaultCharacterExcel> CreateDefaultCharacterExcel(FlatBufferBuilder builder,
      long CharacterId = 0,
  ...
  public static Offset<Global.DefaultCharacterExcel> EndDefaultCharacterExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.DefaultCharacterExcel>(o);
  }
  ...
  public void UnPackTo(DefaultCharacterExcelT _o) {
    ...
    _o.FavoriteCharacter = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.FavoriteCharacter, key) : this.FavoriteCharacter;
  ...
  public static Offset<Global.DefaultCharacterExcel> Pack(FlatBufferBuilder builder, DefaultCharacterExcelT _o) {
    if (_o == null) return default(Offset<Global.DefaultCharacterExcel>);
		byte[] key = TableEncryptionService.CreateKey("DefaultCharacter");
		...
		var _FavoriteCharacter = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.FavoriteCharacter, key) : _o.FavoriteCharacter;
    ...
    return CreateDefaultCharacterExcel(
      ...
      TableEncryptionService.UseEncryption ? _FavoriteCharacter : _o.FavoriteCharacter,
