...
public struct DefaultCharacterExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(DefaultCharacterExcelT _o) {
    ...
    _o.FavoriteCharacter = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.FavoriteCharacter, key) : this.FavoriteCharacter;
  ...
  public static Offset<Global.DefaultCharacterExcel> Pack(FlatBufferBuilder builder, DefaultCharacterExcelT _o) {
    if (_o == null) return default(Offset<Global.DefaultCharacterExcel>);
		...
		var _FavoriteCharacter = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.FavoriteCharacter, key) : _o.FavoriteCharacter;
