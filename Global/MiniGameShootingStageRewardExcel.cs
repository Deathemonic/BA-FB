...
public struct MiniGameShootingStageRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.MiniGameShootingStageRewardExcel> CreateMiniGameShootingStageRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
      long RewardId = 0,
      long ClearSection = 0,
  ...
  public static Offset<Global.MiniGameShootingStageRewardExcel> EndMiniGameShootingStageRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.MiniGameShootingStageRewardExcel>(o);
  }
  ...
  public void UnPackTo(MiniGameShootingStageRewardExcelT _o) {
    ...
    _o.ClearSection = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ClearSection, key) : this.ClearSection;
  ...
  public static Offset<Global.MiniGameShootingStageRewardExcel> Pack(FlatBufferBuilder builder, MiniGameShootingStageRewardExcelT _o) {
    if (_o == null) return default(Offset<Global.MiniGameShootingStageRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("MiniGameShootingStageReward");
