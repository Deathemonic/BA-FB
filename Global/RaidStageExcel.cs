...
public struct RaidStageExcel : IFlatbufferObject
{
  ...
  public Global.Difficulty Difficulty { get { int o = __p.__offset(20); return o != 0 ? (Global.Difficulty)__p.bb.GetInt(o + __p.bb_pos) : Global.Difficulty.Normal; } }
  ...
  public Global.TacticEnvironment TacticEnvironment { get { int o = __p.__offset(36); return o != 0 ? (Global.TacticEnvironment)__p.bb.GetInt(o + __p.bb_pos) : Global.TacticEnvironment.None; } }
  ...
  public static Offset<Global.RaidStageExcel> CreateRaidStageExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddDifficulty(FlatBufferBuilder builder, Global.Difficulty difficulty) { builder.AddInt(8, (int)difficulty, 0); }
  ...
  public static void AddTacticEnvironment(FlatBufferBuilder builder, Global.TacticEnvironment tacticEnvironment) { builder.AddInt(16, (int)tacticEnvironment, 0); }
  ...
  public static Offset<Global.RaidStageExcel> EndRaidStageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.RaidStageExcel>(o);
  }
  ...
  public static Offset<Global.RaidStageExcel> Pack(FlatBufferBuilder builder, RaidStageExcelT _o) {
    if (_o == null) return default(Offset<Global.RaidStageExcel>);
		byte[] key = TableEncryptionService.CreateKey("RaidStage");
...
static public class RaidStageExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 20 /*Difficulty*/, 4 /*Global.Difficulty*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 36 /*TacticEnvironment*/, 4 /*Global.TacticEnvironment*/, 4, false)
