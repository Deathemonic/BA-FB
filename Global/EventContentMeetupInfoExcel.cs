...
public struct EventContentMeetupInfoExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(EventContentMeetupInfoExcelT _o) {
    ...
    _o.CostId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.CostId, key) : this.CostId;
    _o.CostAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.CostAmount, key) : this.CostAmount;
  }
  public static Offset<Global.EventContentMeetupInfoExcel> Pack(FlatBufferBuilder builder, EventContentMeetupInfoExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentMeetupInfoExcel>);
		...
		var _CostId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.CostId, key) : _o.CostId;
		var _CostAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.CostAmount, key) : _o.CostAmount;
