...
public struct CafeProductionExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(CafeProductionExcelT _o) {
    ...
    _o.CafeProductionParcelType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)this.CafeProductionParcelType, key) : this.CafeProductionParcelType;
    _o.CafeProductionParcelId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.CafeProductionParcelId, key) : this.CafeProductionParcelId;
    _o.ParcelProductionCoefficient = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ParcelProductionCoefficient, key) : this.ParcelProductionCoefficient;
    _o.ParcelProductionCorrectionValue = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ParcelProductionCorrectionValue, key) : this.ParcelProductionCorrectionValue;
    _o.ParcelStorageMax = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ParcelStorageMax, key) : this.ParcelStorageMax;
  }
  public static Offset<Global.CafeProductionExcel> Pack(FlatBufferBuilder builder, CafeProductionExcelT _o) {
    if (_o == null) return default(Offset<Global.CafeProductionExcel>);
		...
		var _CafeProductionParcelType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)_o.CafeProductionParcelType, key) : _o.CafeProductionParcelType;
		var _CafeProductionParcelId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.CafeProductionParcelId, key) : _o.CafeProductionParcelId;
		var _ParcelProductionCoefficient = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ParcelProductionCoefficient, key) : _o.ParcelProductionCoefficient;
		var _ParcelProductionCorrectionValue = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ParcelProductionCorrectionValue, key) : _o.ParcelProductionCorrectionValue;
		var _ParcelStorageMax = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ParcelStorageMax, key) : _o.ParcelStorageMax;
