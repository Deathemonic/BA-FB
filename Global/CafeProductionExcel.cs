...
public struct CafeProductionExcel : IFlatbufferObject
{
  ...
  public Global.ParcelType CafeProductionParcelType { get { int o = __p.__offset(8); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Global.ParcelType.None; } }
  ...
  public static Offset<Global.CafeProductionExcel> CreateCafeProductionExcel(FlatBufferBuilder builder,
      long CafeId = 0,
      long Rank = 0,
      Global.ParcelType CafeProductionParcelType = Global.ParcelType.None,
  ...
  public static void AddCafeProductionParcelType(FlatBufferBuilder builder, Global.ParcelType cafeProductionParcelType) { builder.AddInt(2, (int)cafeProductionParcelType, 0); }
  ...
  public static Offset<Global.CafeProductionExcel> EndCafeProductionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.CafeProductionExcel>(o);
  }
  ...
  public void UnPackTo(CafeProductionExcelT _o) {
    ...
    _o.CafeProductionParcelType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CafeProductionParcelType, key) : this.CafeProductionParcelType;
    _o.CafeProductionParcelId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CafeProductionParcelId, key) : this.CafeProductionParcelId;
    _o.ParcelProductionCoefficient = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ParcelProductionCoefficient, key) : this.ParcelProductionCoefficient;
    _o.ParcelProductionCorrectionValue = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ParcelProductionCorrectionValue, key) : this.ParcelProductionCorrectionValue;
    _o.ParcelStorageMax = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ParcelStorageMax, key) : this.ParcelStorageMax;
  }
  public static Offset<Global.CafeProductionExcel> Pack(FlatBufferBuilder builder, CafeProductionExcelT _o) {
    if (_o == null) return default(Offset<Global.CafeProductionExcel>);
		byte[] key = TableEncryptionService.CreateKey("CafeProduction");
		var _CafeId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CafeId, key) : _o.CafeId;
		var _Rank = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Rank, key) : _o.Rank;
		var _CafeProductionParcelType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CafeProductionParcelType, key) : _o.CafeProductionParcelType;
		var _CafeProductionParcelId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CafeProductionParcelId, key) : _o.CafeProductionParcelId;
		var _ParcelProductionCoefficient = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ParcelProductionCoefficient, key) : _o.ParcelProductionCoefficient;
		var _ParcelProductionCorrectionValue = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ParcelProductionCorrectionValue, key) : _o.ParcelProductionCorrectionValue;
		var _ParcelStorageMax = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ParcelStorageMax, key) : _o.ParcelStorageMax;
    return CreateCafeProductionExcel(
      ...
      TableEncryptionService.UseEncryption ? _CafeProductionParcelType : _o.CafeProductionParcelType,
      TableEncryptionService.UseEncryption ? _CafeProductionParcelId : _o.CafeProductionParcelId,
      TableEncryptionService.UseEncryption ? _ParcelProductionCoefficient : _o.ParcelProductionCoefficient,
      TableEncryptionService.UseEncryption ? _ParcelProductionCorrectionValue : _o.ParcelProductionCorrectionValue,
      TableEncryptionService.UseEncryption ? _ParcelStorageMax : _o.ParcelStorageMax);
  }
}
...
public class CafeProductionExcelT
{
  ...
  public Global.ParcelType CafeProductionParcelType { get; set; }
  ...
  public CafeProductionExcelT() {
    this.CafeId = 0;
    this.Rank = 0;
    this.CafeProductionParcelType = Global.ParcelType.None;
...
static public class CafeProductionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*CafeProductionParcelType*/, 4 /*Global.ParcelType*/, 4, false)
