...
public struct EventContentShopInfoExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.EventContentShopInfoExcel> CreateEventContentShopInfoExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.EventContentShopInfoExcel> EndEventContentShopInfoExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.EventContentShopInfoExcel>(o);
  }
  ...
  public static Offset<Global.EventContentShopInfoExcel> Pack(FlatBufferBuilder builder, EventContentShopInfoExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentShopInfoExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentShopInfo");
