...
public struct EventContentTreasureRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.EventContentTreasureRewardExcel> CreateEventContentTreasureRewardExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Global.EventContentTreasureRewardExcel> EndEventContentTreasureRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.EventContentTreasureRewardExcel>(o);
  }
  ...
  public static Offset<Global.EventContentTreasureRewardExcel> Pack(FlatBufferBuilder builder, EventContentTreasureRewardExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentTreasureRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentTreasureReward");
