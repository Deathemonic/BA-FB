...
public struct CharacterLevelStatFactorExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.CharacterLevelStatFactorExcel> CreateCharacterLevelStatFactorExcel(FlatBufferBuilder builder,
      long Level = 0,
  ...
  public static Offset<Global.CharacterLevelStatFactorExcel> EndCharacterLevelStatFactorExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.CharacterLevelStatFactorExcel>(o);
  }
  ...
  public void UnPackTo(CharacterLevelStatFactorExcelT _o) {
    ...
    _o.CriticalFactor = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.CriticalFactor, key) : this.CriticalFactor;
    _o.StabilityFactor = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.StabilityFactor, key) : this.StabilityFactor;
    _o.DefenceFactor = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.DefenceFactor, key) : this.DefenceFactor;
  ...
  public static Offset<Global.CharacterLevelStatFactorExcel> Pack(FlatBufferBuilder builder, CharacterLevelStatFactorExcelT _o) {
    if (_o == null) return default(Offset<Global.CharacterLevelStatFactorExcel>);
		byte[] key = TableEncryptionService.CreateKey("CharacterLevelStatFactor");
		var _Level = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.Level, key) : _o.Level;
		var _CriticalFactor = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.CriticalFactor, key) : _o.CriticalFactor;
		var _StabilityFactor = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.StabilityFactor, key) : _o.StabilityFactor;
		var _DefenceFactor = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.DefenceFactor, key) : _o.DefenceFactor;
    ...
    return CreateCharacterLevelStatFactorExcel(
      ...
      TableEncryptionService.UseEncryption ? _CriticalFactor : _o.CriticalFactor,
      TableEncryptionService.UseEncryption ? _StabilityFactor : _o.StabilityFactor,
      TableEncryptionService.UseEncryption ? _DefenceFactor : _o.DefenceFactor,
