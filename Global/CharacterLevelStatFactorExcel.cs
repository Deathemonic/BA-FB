...
public struct CharacterLevelStatFactorExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(CharacterLevelStatFactorExcelT _o) {
    ...
    _o.CriticalFactor = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CriticalFactor, key) : this.CriticalFactor;
    _o.StabilityFactor = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StabilityFactor, key) : this.StabilityFactor;
    _o.DefenceFactor = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.DefenceFactor, key) : this.DefenceFactor;
  ...
  public static Offset<Global.CharacterLevelStatFactorExcel> Pack(FlatBufferBuilder builder, CharacterLevelStatFactorExcelT _o) {
    if (_o == null) return default(Offset<Global.CharacterLevelStatFactorExcel>);
		...
		var _CriticalFactor = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CriticalFactor, key) : _o.CriticalFactor;
		var _StabilityFactor = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StabilityFactor, key) : _o.StabilityFactor;
		var _DefenceFactor = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DefenceFactor, key) : _o.DefenceFactor;
