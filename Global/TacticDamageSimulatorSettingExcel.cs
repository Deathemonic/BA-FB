...
public struct TacticDamageSimulatorSettingExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(TacticDamageSimulatorSettingExcelT _o) {
    ...
    _o.Repeat = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Repeat, key) : this.Repeat;
    _o.TestPreset = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.TestPreset, key) : this.TestPreset;
    _o.TestBattleTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.TestBattleTime, key) : this.TestBattleTime;
    _o.StrikerSquard = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StrikerSquard, key) : this.StrikerSquard;
    _o.SpecialSquard = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SpecialSquard, key) : this.SpecialSquard;
    _o.ReplaceCharacterCostRegen = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ReplaceCharacterCostRegen, key) : this.ReplaceCharacterCostRegen;
    _o.ReplaceCostRegenValue = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ReplaceCostRegenValue, key) : this.ReplaceCostRegenValue;
    _o.UseAutoSkill = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.UseAutoSkill, key) : this.UseAutoSkill;
    _o.OverrideStreetAdaptation = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.OverrideStreetAdaptation, key) : this.OverrideStreetAdaptation;
    _o.OverrideOutdoorAdaptation = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.OverrideOutdoorAdaptation, key) : this.OverrideOutdoorAdaptation;
    _o.OverrideIndoorAdaptation = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.OverrideIndoorAdaptation, key) : this.OverrideIndoorAdaptation;
    _o.ApplyOverrideAdaptation = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ApplyOverrideAdaptation, key) : this.ApplyOverrideAdaptation;
    _o.OverrideFavorLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.OverrideFavorLevel, key) : this.OverrideFavorLevel;
    _o.ApplyOverrideFavorLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ApplyOverrideFavorLevel, key) : this.ApplyOverrideFavorLevel;
    ...
    for (var _j = 0; _j < this.FixedCharacterLength; ++_j) {_o.FixedCharacter.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.FixedCharacter(_j), key) : this.FixedCharacter(_j));}
  }
  public static Offset<Global.TacticDamageSimulatorSettingExcel> Pack(FlatBufferBuilder builder, TacticDamageSimulatorSettingExcelT _o) {
    if (_o == null) return default(Offset<Global.TacticDamageSimulatorSettingExcel>);
		...
		var _Repeat = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Repeat, key) : _o.Repeat;
		var _TestPreset = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.TestPreset, key) : _o.TestPreset;
		var _TestBattleTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.TestBattleTime, key) : _o.TestBattleTime;
		var _StrikerSquard = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StrikerSquard, key) : _o.StrikerSquard;
		var _SpecialSquard = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.SpecialSquard, key) : _o.SpecialSquard;
		var _ReplaceCharacterCostRegen = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ReplaceCharacterCostRegen, key) : _o.ReplaceCharacterCostRegen;
		var _ReplaceCostRegenValue = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ReplaceCostRegenValue, key) : _o.ReplaceCostRegenValue;
		var _UseAutoSkill = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.UseAutoSkill, key) : _o.UseAutoSkill;
		var _OverrideStreetAdaptation = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.OverrideStreetAdaptation, key) : _o.OverrideStreetAdaptation;
		var _OverrideOutdoorAdaptation = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.OverrideOutdoorAdaptation, key) : _o.OverrideOutdoorAdaptation;
		var _OverrideIndoorAdaptation = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.OverrideIndoorAdaptation, key) : _o.OverrideIndoorAdaptation;
		var _ApplyOverrideAdaptation = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ApplyOverrideAdaptation, key) : _o.ApplyOverrideAdaptation;
		var _OverrideFavorLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.OverrideFavorLevel, key) : _o.OverrideFavorLevel;
		var _ApplyOverrideFavorLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ApplyOverrideFavorLevel, key) : _o.ApplyOverrideFavorLevel;
    ...
    if (_o.FixedCharacter != null) {
      var __fixedCharacter = _o.FixedCharacter.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
