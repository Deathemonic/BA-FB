...
public struct EventContentCollectionExcel : IFlatbufferObject
{
  ...
  public Global.CollectionUnlockType UnlockConditionType { get { int o = __p.__offset(10); return o != 0 ? (Global.CollectionUnlockType)__p.bb.GetInt(o + __p.bb_pos) : Global.CollectionUnlockType.None; } }
  ...
  public Global.MultipleConditionCheckType MultipleConditionCheckType { get { int o = __p.__offset(14); return o != 0 ? (Global.MultipleConditionCheckType)__p.bb.GetInt(o + __p.bb_pos) : Global.MultipleConditionCheckType.And; } }
  ...
  public static void AddUnlockConditionType(FlatBufferBuilder builder, Global.CollectionUnlockType unlockConditionType) { builder.AddInt(3, (int)unlockConditionType, 0); }
  ...
  public static void AddMultipleConditionCheckType(FlatBufferBuilder builder, Global.MultipleConditionCheckType multipleConditionCheckType) { builder.AddInt(5, (int)multipleConditionCheckType, 0); }
  ...
  public static Offset<Global.EventContentCollectionExcel> Pack(FlatBufferBuilder builder, EventContentCollectionExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentCollectionExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentCollection");
...
static public class EventContentCollectionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*UnlockConditionType*/, 4 /*Global.CollectionUnlockType*/, 4, false)
      && verifier.VerifyVectorOfData(tablePos, 12 /*UnlockConditionParameter*/, 8 /*long*/, false)
      && verifier.VerifyField(tablePos, 14 /*MultipleConditionCheckType*/, 4 /*Global.MultipleConditionCheckType*/, 4, false)
