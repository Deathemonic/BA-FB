...
public struct EventContentCollectionExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(EventContentCollectionExcelT _o) {
    ...
    _o.IsObjectOnFullResource = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.IsObjectOnFullResource, key) : this.IsObjectOnFullResource;
  ...
  public static Offset<Global.EventContentCollectionExcel> Pack(FlatBufferBuilder builder, EventContentCollectionExcelT _o) {
    ...
    if (_o.UnlockConditionParameter != null) {
      ...
      _unlockConditionParameter = CreateUnlockConditionParameterVector(builder, __unlockConditionParameter);
		...
		var _IsObject = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IsObject, key) : _o.IsObject;
		var _IsObjectOnFullResource = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IsObjectOnFullResource, key) : _o.IsObjectOnFullResource;
		var _IsHorizon = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IsHorizon, key) : _o.IsHorizon;
