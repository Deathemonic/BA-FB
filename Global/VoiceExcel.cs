...
public struct VoiceExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.VoiceExcel> CreateVoiceExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      uint Id = 0,
  ...
  public static Offset<Global.VoiceExcel> EndVoiceExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.VoiceExcel>(o);
  }
  ...
  public static Offset<Global.VoiceExcel> Pack(FlatBufferBuilder builder, VoiceExcelT _o) {
    if (_o == null) return default(Offset<Global.VoiceExcel>);
		byte[] key = TableEncryptionService.CreateKey("Voice");
