...
public struct GroundModuleRewardExcel : IFlatbufferObject
{
  ...
  public Global.ParcelType RewardParcelType { get { int o = __p.__offset(6); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Global.ParcelType.None; } }
  ...
  public static Offset<Global.GroundModuleRewardExcel> CreateGroundModuleRewardExcel(FlatBufferBuilder builder,
      uint GroupId = 0,
  ...
  public static void AddRewardParcelType(FlatBufferBuilder builder, Global.ParcelType rewardParcelType) { builder.AddInt(1, (int)rewardParcelType, 0); }
  ...
  public static Offset<Global.GroundModuleRewardExcel> EndGroundModuleRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.GroundModuleRewardExcel>(o);
  }
  ...
  public static Offset<Global.GroundModuleRewardExcel> Pack(FlatBufferBuilder builder, GroundModuleRewardExcelT _o) {
    if (_o == null) return default(Offset<Global.GroundModuleRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("GroundModuleReward");
...
static public class GroundModuleRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*RewardParcelType*/, 4 /*Global.ParcelType*/, 4, false)
