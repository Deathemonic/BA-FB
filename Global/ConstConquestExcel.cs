...
public struct ConstConquestExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.ConstConquestExcel> CreateConstConquestExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.ConstConquestExcel> EndConstConquestExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.ConstConquestExcel>(o);
  }
  ...
  public static Offset<Global.ConstConquestExcel> Pack(FlatBufferBuilder builder, ConstConquestExcelT _o) {
    if (_o == null) return default(Offset<Global.ConstConquestExcel>);
		byte[] key = TableEncryptionService.CreateKey("ConstConquest");
