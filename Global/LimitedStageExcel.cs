...
public struct LimitedStageExcel : IFlatbufferObject
{
  ...
  public Global.StageTopography StageTopography { get { int o = __p.__offset(48); return o != 0 ? (Global.StageTopography)__p.bb.GetInt(o + __p.bb_pos) : Global.StageTopography.Street; } }
  ...
  public Global.StrategyEnvironment StrategyEnvironment { get { int o = __p.__offset(54); return o != 0 ? (Global.StrategyEnvironment)__p.bb.GetInt(o + __p.bb_pos) : Global.StrategyEnvironment.None; } }
  ...
  public static Offset<Global.LimitedStageExcel> CreateLimitedStageExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddStageTopography(FlatBufferBuilder builder, Global.StageTopography stageTopography) { builder.AddInt(22, (int)stageTopography, 0); }
  ...
  public static void AddStrategyEnvironment(FlatBufferBuilder builder, Global.StrategyEnvironment strategyEnvironment) { builder.AddInt(25, (int)strategyEnvironment, 0); }
  ...
  public static Offset<Global.LimitedStageExcel> EndLimitedStageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.LimitedStageExcel>(o);
  }
  ...
  public static Offset<Global.LimitedStageExcel> Pack(FlatBufferBuilder builder, LimitedStageExcelT _o) {
    if (_o == null) return default(Offset<Global.LimitedStageExcel>);
		byte[] key = TableEncryptionService.CreateKey("LimitedStage");
...
static public class LimitedStageExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 48 /*StageTopography*/, 4 /*Global.StageTopography*/, 4, false)
      && verifier.VerifyField(tablePos, 50 /*RecommandLevel*/, 4 /*int*/, 4, false)
      && verifier.VerifyString(tablePos, 52 /*BgmId*/, false)
      && verifier.VerifyField(tablePos, 54 /*StrategyEnvironment*/, 4 /*Global.StrategyEnvironment*/, 4, false)
