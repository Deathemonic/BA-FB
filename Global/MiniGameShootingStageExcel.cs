...
public struct MiniGameShootingStageExcel : IFlatbufferObject
{
  ...
  public Global.Difficulty Difficulty { get { int o = __p.__offset(10); return o != 0 ? (Global.Difficulty)__p.bb.GetInt(o + __p.bb_pos) : Global.Difficulty.Normal; } }
  ...
  public static void AddDifficulty(FlatBufferBuilder builder, Global.Difficulty difficulty) { builder.AddInt(3, (int)difficulty, 0); }
  ...
  public static Offset<Global.MiniGameShootingStageExcel> EndMiniGameShootingStageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.MiniGameShootingStageExcel>(o);
  }
  ...
  public void UnPackTo(MiniGameShootingStageExcelT _o) {
    ...
    for (var _j = 0; _j < this.BgmIdLength; ++_j) {_o.BgmId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BgmId(_j), key) : this.BgmId(_j));}
    ...
    _o.StartBattleDuration = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StartBattleDuration, key) : this.StartBattleDuration;
    _o.DefaultBattleDuration = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.DefaultBattleDuration, key) : this.DefaultBattleDuration;
    ...
    _o.CameraSizeRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CameraSizeRate, key) : this.CameraSizeRate;
  ...
  public static Offset<Global.MiniGameShootingStageExcel> Pack(FlatBufferBuilder builder, MiniGameShootingStageExcelT _o) {
    ...
    var _DesignLevel = _o.DesignLevel == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.DesignLevel, key) : _o.DesignLevel));
    var _ArtLevel = _o.ArtLevel == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ArtLevel, key) : _o.ArtLevel));
		var _StartBattleDuration = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StartBattleDuration, key) : _o.StartBattleDuration;
		var _DefaultBattleDuration = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DefaultBattleDuration, key) : _o.DefaultBattleDuration;
    var _DefaultLogicEffect = _o.DefaultLogicEffect == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.DefaultLogicEffect, key) : _o.DefaultLogicEffect));
		var _CameraSizeRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CameraSizeRate, key) : _o.CameraSizeRate;
...
static public class MiniGameShootingStageExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*Difficulty*/, 4 /*Global.Difficulty*/, 4, false)
