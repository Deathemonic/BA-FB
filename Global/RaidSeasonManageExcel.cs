...
public struct RaidSeasonManageExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.RaidSeasonManageExcel> CreateRaidSeasonManageExcel(FlatBufferBuilder builder,
      long SeasonId = 0,
  ...
  public static Offset<Global.RaidSeasonManageExcel> EndRaidSeasonManageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.RaidSeasonManageExcel>(o);
  }
  ...
  public static Offset<Global.RaidSeasonManageExcel> Pack(FlatBufferBuilder builder, RaidSeasonManageExcelT _o) {
    if (_o == null) return default(Offset<Global.RaidSeasonManageExcel>);
		byte[] key = TableEncryptionService.CreateKey("RaidSeasonManage");
    ...
    if (_o.OpenRaidBossGroup != null) {
      ...
      for (var _j = 0; _j < __OpenRaidBossGroup.Length; ++_j) { __OpenRaidBossGroup[_j] = builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.OpenRaidBossGroup[_j], key) : _o.OpenRaidBossGroup[_j])); }
