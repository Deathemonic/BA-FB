...
public struct RaidSeasonManageExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.RaidSeasonManageExcel> Pack(FlatBufferBuilder builder, RaidSeasonManageExcelT _o) {
    ...
    if (_o.OpenRaidBossGroup != null) {
      ...
      for (var _j = 0; _j < __OpenRaidBossGroup.Length; ++_j) { __OpenRaidBossGroup[_j] = builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.OpenRaidBossGroup[_j], key) : _o.OpenRaidBossGroup[_j])); }
