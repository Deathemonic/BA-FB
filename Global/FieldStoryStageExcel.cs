...
public struct FieldStoryStageExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.FieldStoryStageExcel> CreateFieldStoryStageExcel(FlatBufferBuilder builder,
      long Id = 0,
      long SeasonId = 0,
  ...
  public static Offset<Global.FieldStoryStageExcel> EndFieldStoryStageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.FieldStoryStageExcel>(o);
  }
  ...
  public static Offset<Global.FieldStoryStageExcel> Pack(FlatBufferBuilder builder, FieldStoryStageExcelT _o) {
    if (_o == null) return default(Offset<Global.FieldStoryStageExcel>);
		byte[] key = TableEncryptionService.CreateKey("FieldStoryStage");
