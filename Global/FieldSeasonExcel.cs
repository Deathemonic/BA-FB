...
public struct FieldSeasonExcel : IFlatbufferObject
{
  ...
  public Global.FieldDialogType FieldGetKeywordCallDialogEnum { get { int o = __p.__offset(20); return o != 0 ? (Global.FieldDialogType)__p.bb.GetInt(o + __p.bb_pos) : Global.FieldDialogType.None; } }
  ...
  public static Offset<Global.FieldSeasonExcel> CreateFieldSeasonExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      ...
      Global.FieldDialogType FieldGetKeywordCallDialogEnum = Global.FieldDialogType.None,
  ...
  public static void AddFieldGetKeywordCallDialogEnum(FlatBufferBuilder builder, Global.FieldDialogType fieldGetKeywordCallDialogEnum) { builder.AddInt(8, (int)fieldGetKeywordCallDialogEnum, 0); }
  ...
  public static Offset<Global.FieldSeasonExcel> EndFieldSeasonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.FieldSeasonExcel>(o);
  }
  ...
  public static Offset<Global.FieldSeasonExcel> Pack(FlatBufferBuilder builder, FieldSeasonExcelT _o) {
    if (_o == null) return default(Offset<Global.FieldSeasonExcel>);
		byte[] key = TableEncryptionService.CreateKey("FieldSeason");
		...
		var _EntryDateId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EntryDateId, key) : _o.EntryDateId;
		var _InstantEntryDateId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.InstantEntryDateId, key) : _o.InstantEntryDateId;
    ...
    var _EndDate = _o.EndDate == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.EndDate, key) : _o.EndDate));
		var _LobbyBGMChangeStageId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.LobbyBGMChangeStageId, key) : _o.LobbyBGMChangeStageId;
		var _FieldPrefabControlID = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.FieldPrefabControlID, key) : _o.FieldPrefabControlID;
		var _FieldGetKeywordCallDialogEnum = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.FieldGetKeywordCallDialogEnum, key) : _o.FieldGetKeywordCallDialogEnum;
    var _MasteryImagePath = _o.MasteryImagePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.MasteryImagePath, key) : _o.MasteryImagePath));
    var _FieldLobbyTitleImagePath = _o.FieldLobbyTitleImagePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.FieldLobbyTitleImagePath, key) : _o.FieldLobbyTitleImagePath));
    var _KeywordLogoImagePath = _o.KeywordLogoImagePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.KeywordLogoImagePath, key) : _o.KeywordLogoImagePath));
...
public class FieldSeasonExcelT
{
  ...
  public Global.FieldDialogType FieldGetKeywordCallDialogEnum { get; set; }
  ...
  public FieldSeasonExcelT() {
    ...
    this.FieldGetKeywordCallDialogEnum = Global.FieldDialogType.None;
...
static public class FieldSeasonExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 20 /*FieldGetKeywordCallDialogEnum*/, 4 /*Global.FieldDialogType*/, 4, false)
