...
public struct FieldSeasonExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(FieldSeasonExcelT _o) {
    ...
    _o.FieldGetKeywordCallDialogEnum = TableEncryptionService.UseEncryption ? (Global.FieldDialogType)TableEncryptionService.Convert((int)this.FieldGetKeywordCallDialogEnum, key) : this.FieldGetKeywordCallDialogEnum;
  ...
  public static Offset<Global.FieldSeasonExcel> Pack(FlatBufferBuilder builder, FieldSeasonExcelT _o) {
    ...
    var _EndDate = _o.EndDate == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.EndDate, key) : _o.EndDate));
		...
		var _FieldGetKeywordCallDialogEnum = TableEncryptionService.UseEncryption ? (Global.FieldDialogType)TableEncryptionService.Convert((int)_o.FieldGetKeywordCallDialogEnum, key) : _o.FieldGetKeywordCallDialogEnum;
