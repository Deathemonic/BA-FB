...
public struct SkillAdditionalTooltipExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.SkillAdditionalTooltipExcel> CreateSkillAdditionalTooltipExcel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static Offset<Global.SkillAdditionalTooltipExcel> EndSkillAdditionalTooltipExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.SkillAdditionalTooltipExcel>(o);
  }
  ...
  public static Offset<Global.SkillAdditionalTooltipExcel> Pack(FlatBufferBuilder builder, SkillAdditionalTooltipExcelT _o) {
    if (_o == null) return default(Offset<Global.SkillAdditionalTooltipExcel>);
		byte[] key = TableEncryptionService.CreateKey("SkillAdditionalTooltip");
		var _GroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.GroupId, key) : _o.GroupId;
    var _AdditionalSkillGroupId = _o.AdditionalSkillGroupId == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.AdditionalSkillGroupId, key) : _o.AdditionalSkillGroupId));
    var _ShowSkillSlot = _o.ShowSkillSlot == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.ShowSkillSlot, key) : _o.ShowSkillSlot));
