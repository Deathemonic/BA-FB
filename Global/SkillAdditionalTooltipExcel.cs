...
public struct SkillAdditionalTooltipExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.SkillAdditionalTooltipExcel> Pack(FlatBufferBuilder builder, SkillAdditionalTooltipExcelT _o) {
    ...
    var _AdditionalSkillGroupId = _o.AdditionalSkillGroupId == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.AdditionalSkillGroupId, key) : _o.AdditionalSkillGroupId));
    var _ShowSkillSlot = _o.ShowSkillSlot == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ShowSkillSlot, key) : _o.ShowSkillSlot));
