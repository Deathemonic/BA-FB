...
public struct EventContentTreasureRoundExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.EventContentTreasureRoundExcel> CreateEventContentTreasureRoundExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.EventContentTreasureRoundExcel> EndEventContentTreasureRoundExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.EventContentTreasureRoundExcel>(o);
  }
  ...
  public void UnPackTo(EventContentTreasureRoundExcelT _o) {
    ...
    _o.TreasureRound = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.TreasureRound, key) : this.TreasureRound;
    _o.TreasureRoundSize = new List<int>();
    for (var _j = 0; _j < this.TreasureRoundSizeLength; ++_j) {_o.TreasureRoundSize.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.TreasureRoundSize(_j), key) : this.TreasureRoundSize(_j));}
    _o.CellVisualSortUnstructed = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CellVisualSortUnstructed, key) : this.CellVisualSortUnstructed;
    _o.CellCheckGoodsId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CellCheckGoodsId, key) : this.CellCheckGoodsId;
    _o.CellRewardId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CellRewardId, key) : this.CellRewardId;
    ...
    _o.TreasureCellImagePath = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.TreasureCellImagePath, key) : this.TreasureCellImagePath;
  }
  public static Offset<Global.EventContentTreasureRoundExcel> Pack(FlatBufferBuilder builder, EventContentTreasureRoundExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentTreasureRoundExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentTreasureRound");
		...
		var _TreasureRound = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.TreasureRound, key) : _o.TreasureRound;
    var _TreasureRoundSize = default(VectorOffset);
    if (_o.TreasureRoundSize != null) {
      var __TreasureRoundSize = _o.TreasureRoundSize.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
      _TreasureRoundSize = CreateTreasureRoundSizeVector(builder, __TreasureRoundSize);
    }
		var _CellVisualSortUnstructed = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CellVisualSortUnstructed, key) : _o.CellVisualSortUnstructed;
		var _CellCheckGoodsId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CellCheckGoodsId, key) : _o.CellCheckGoodsId;
		var _CellRewardId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CellRewardId, key) : _o.CellRewardId;
    ...
    var _TreasureCellImagePath = _o.TreasureCellImagePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.TreasureCellImagePath, key) : _o.TreasureCellImagePath));
    return CreateEventContentTreasureRoundExcel(
      builder,
      TableEncryptionService.UseEncryption ? _EventContentId : _o.EventContentId,
      TableEncryptionService.UseEncryption ? _TreasureRound : _o.TreasureRound,
      _TreasureRoundSize,
      TableEncryptionService.UseEncryption ? _CellVisualSortUnstructed : _o.CellVisualSortUnstructed,
      TableEncryptionService.UseEncryption ? _CellCheckGoodsId : _o.CellCheckGoodsId,
      TableEncryptionService.UseEncryption ? _CellRewardId : _o.CellRewardId,
      _RewardID,
      _RewardAmount,
