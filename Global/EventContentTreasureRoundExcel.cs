...
public struct EventContentTreasureRoundExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(EventContentTreasureRoundExcelT _o) {
    ...
    _o.TreasureRound = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.TreasureRound, key) : this.TreasureRound;
    _o.TreasureRoundSize = new List<int>();
    for (var _j = 0; _j < this.TreasureRoundSizeLength; ++_j) {_o.TreasureRoundSize.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.TreasureRoundSize(_j), key) : this.TreasureRoundSize(_j));}
    _o.CellVisualSortUnstructed = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.CellVisualSortUnstructed, key) : this.CellVisualSortUnstructed;
    _o.CellCheckGoodsId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.CellCheckGoodsId, key) : this.CellCheckGoodsId;
    _o.CellRewardId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.CellRewardId, key) : this.CellRewardId;
  ...
  public static Offset<Global.EventContentTreasureRoundExcel> Pack(FlatBufferBuilder builder, EventContentTreasureRoundExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentTreasureRoundExcel>);
		...
		var _TreasureRound = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.TreasureRound, key) : _o.TreasureRound;
    var _TreasureRoundSize = default(VectorOffset);
    if (_o.TreasureRoundSize != null) {
      var __TreasureRoundSize = _o.TreasureRoundSize.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)x, key) : x).ToArray();
      _TreasureRoundSize = CreateTreasureRoundSizeVector(builder, __TreasureRoundSize);
    }
		var _CellVisualSortUnstructed = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.CellVisualSortUnstructed, key) : _o.CellVisualSortUnstructed;
		var _CellCheckGoodsId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.CellCheckGoodsId, key) : _o.CellCheckGoodsId;
		var _CellRewardId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.CellRewardId, key) : _o.CellRewardId;
    ...
    var _TreasureCellImagePath = _o.TreasureCellImagePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.TreasureCellImagePath, key) : _o.TreasureCellImagePath));
