...
public struct AccountLevelRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.AccountLevelRewardExcel> CreateAccountLevelRewardExcel(FlatBufferBuilder builder,
      long Id = 0,
      long Level = 0,
  ...
  public static Offset<Global.AccountLevelRewardExcel> EndAccountLevelRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.AccountLevelRewardExcel>(o);
  }
  ...
  public static Offset<Global.AccountLevelRewardExcel> Pack(FlatBufferBuilder builder, AccountLevelRewardExcelT _o) {
    if (_o == null) return default(Offset<Global.AccountLevelRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("AccountLevelReward");
