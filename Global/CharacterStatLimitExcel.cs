...
public struct CharacterStatLimitExcel : IFlatbufferObject
{
  ...
  public Global.StatType StatType { get { int o = __p.__offset(8); return o != 0 ? (Global.StatType)__p.bb.GetInt(o + __p.bb_pos) : Global.StatType.None; } }
  ...
  public static Offset<Global.CharacterStatLimitExcel> CreateCharacterStatLimitExcel(FlatBufferBuilder builder,
      long Id = 0,
      Global.TacticEntityType TacticEntityType = Global.TacticEntityType.None,
      Global.StatType StatType = Global.StatType.None,
      long StatMinValue = 0,
      long StatMaxValue = 0,
  ...
  public static void AddStatType(FlatBufferBuilder builder, Global.StatType statType) { builder.AddInt(2, (int)statType, 0); }
  ...
  public static Offset<Global.CharacterStatLimitExcel> EndCharacterStatLimitExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.CharacterStatLimitExcel>(o);
  }
  ...
  public void UnPackTo(CharacterStatLimitExcelT _o) {
    ...
    _o.StatType = TableEncryptionService.UseEncryption ? (Global.StatType)TableEncryptionService.Convert((int)this.StatType, key) : this.StatType;
  ...
  public static Offset<Global.CharacterStatLimitExcel> Pack(FlatBufferBuilder builder, CharacterStatLimitExcelT _o) {
    if (_o == null) return default(Offset<Global.CharacterStatLimitExcel>);
		byte[] key = TableEncryptionService.CreateKey("CharacterStatLimit");
		...
		var _StatType = TableEncryptionService.UseEncryption ? (Global.StatType)TableEncryptionService.Convert((int)_o.StatType, key) : _o.StatType;
...
public class CharacterStatLimitExcelT
{
  ...
  public Global.StatType StatType { get; set; }
  ...
  public CharacterStatLimitExcelT() {
    ...
    this.StatType = Global.StatType.None;
    this.StatMinValue = 0;
    this.StatMaxValue = 0;
...
static public class CharacterStatLimitExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*StatType*/, 4 /*Global.StatType*/, 4, false)
