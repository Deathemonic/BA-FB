...
public struct CharacterWeaponLevelExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.CharacterWeaponLevelExcel> CreateCharacterWeaponLevelExcel(FlatBufferBuilder builder,
      int Level = 0,
      long Exp = 0,
      long TotalExp = 0) {
  ...
  public static Offset<Global.CharacterWeaponLevelExcel> EndCharacterWeaponLevelExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.CharacterWeaponLevelExcel>(o);
  }
  ...
  public static Offset<Global.CharacterWeaponLevelExcel> Pack(FlatBufferBuilder builder, CharacterWeaponLevelExcelT _o) {
    if (_o == null) return default(Offset<Global.CharacterWeaponLevelExcel>);
		byte[] key = TableEncryptionService.CreateKey("CharacterWeaponLevel");
