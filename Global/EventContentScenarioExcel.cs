...
public struct EventContentScenarioExcel : IFlatbufferObject
{
  ...
  public Global.EventContentScenarioConditionType ScenarioConditionType { get { int o = __p.__offset(22); return o != 0 ? (Global.EventContentScenarioConditionType)__p.bb.GetInt(o + __p.bb_pos) : Global.EventContentScenarioConditionType.None; } }
  ...
  public Global.ParcelType RewardParcelType(int j) { int o = __p.__offset(36); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Global.ParcelType)0; }
  public int RewardParcelTypeLength { get { int o = __p.__offset(36); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Global.ParcelType> GetRewardParcelTypeBytes() { return __p.__vector_as_span<Global.ParcelType>(36, 4); }
#else
  public ArraySegment<byte>? GetRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(36); }
#endif
  public Global.ParcelType[] GetRewardParcelTypeArray() { int o = __p.__offset(36); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Global.ParcelType[] a = new Global.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Global.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Global.EventContentScenarioExcel> CreateEventContentScenarioExcel(FlatBufferBuilder builder,
      long Id = 0,
      ...
      Global.EventContentScenarioConditionType ScenarioConditionType = Global.EventContentScenarioConditionType.None,
  ...
  public static void AddScenarioConditionType(FlatBufferBuilder builder, Global.EventContentScenarioConditionType scenarioConditionType) { builder.AddInt(9, (int)scenarioConditionType, 0); }
  ...
  public static Offset<Global.EventContentScenarioExcel> EndEventContentScenarioExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.EventContentScenarioExcel>(o);
  }
  ...
  public void UnPackTo(EventContentScenarioExcelT _o) {
    ...
    _o.ScenarioConditionType = TableEncryptionService.UseEncryption ? (Global.EventContentScenarioConditionType)TableEncryptionService.Convert((int)this.ScenarioConditionType, key) : this.ScenarioConditionType;
  ...
  public static Offset<Global.EventContentScenarioExcel> Pack(FlatBufferBuilder builder, EventContentScenarioExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentScenarioExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentScenario");
    ...
    if (_o.ScenarioGroupId != null) {
      ...
      _scenarioGroupId = CreateScenarioGroupIdVector(builder, __scenarioGroupId);
		...
		var _ScenarioConditionType = TableEncryptionService.UseEncryption ? (Global.EventContentScenarioConditionType)TableEncryptionService.Convert((int)_o.ScenarioConditionType, key) : _o.ScenarioConditionType;
...
public class EventContentScenarioExcelT
{
  ...
  public Global.EventContentScenarioConditionType ScenarioConditionType { get; set; }
  ...
  public EventContentScenarioExcelT() {
    ...
    this.ScenarioConditionType = Global.EventContentScenarioConditionType.None;
...
static public class EventContentScenarioExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 22 /*ScenarioConditionType*/, 4 /*Global.EventContentScenarioConditionType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 36 /*RewardParcelType*/, 4 /*Global.ParcelType*/, false)
