...
public struct StickerPageContentExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.StickerPageContentExcel> Pack(FlatBufferBuilder builder, StickerPageContentExcelT _o) {
    if (_o == null) return default(Offset<Global.StickerPageContentExcel>);
		...
		var _StickerGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StickerGroupId, key) : _o.StickerGroupId;
		var _StickerPageId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StickerPageId, key) : _o.StickerPageId;
		var _StickerSlot = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StickerSlot, key) : _o.StickerSlot;
		var _StickerGetConditionType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StickerGetConditionType, key) : _o.StickerGetConditionType;
		var _StickerCheckPassType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StickerCheckPassType, key) : _o.StickerCheckPassType;
		var _GetStickerConditionType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.GetStickerConditionType, key) : _o.GetStickerConditionType;
		var _StickerGetConditionCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StickerGetConditionCount, key) : _o.StickerGetConditionCount;
    var _StickerGetConditionParameter = default(VectorOffset);
    if (_o.StickerGetConditionParameter != null) {
      var __StickerGetConditionParameter = _o.StickerGetConditionParameter.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.StickerGetConditionParameterTag != null) {
      var __StickerGetConditionParameterTag = _o.StickerGetConditionParameterTag.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
      _StickerGetConditionParameterTag = CreateStickerGetConditionParameterTagVector(builder, __StickerGetConditionParameterTag);
    }
		var _PackedStickerIconLocalizeEtcId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PackedStickerIconLocalizeEtcId, key) : _o.PackedStickerIconLocalizeEtcId;
    var _PackedStickerIconPath = _o.PackedStickerIconPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.PackedStickerIconPath, key) : _o.PackedStickerIconPath));
    ...
    var _StickerDetailPath = _o.StickerDetailPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.StickerDetailPath, key) : _o.StickerDetailPath));
