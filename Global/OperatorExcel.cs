...
public struct OperatorExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(OperatorExcelT _o) {
    ...
    _o.OperatorCondition = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.OperatorCondition, key) : this.OperatorCondition;
    _o.OutputSequence = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.OutputSequence, key) : this.OutputSequence;
    _o.RandomWeight = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.RandomWeight, key) : this.RandomWeight;
    _o.OutputDelay = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.OutputDelay, key) : this.OutputDelay;
    _o.Duration = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Duration, key) : this.Duration;
    _o.OperatorOutputPriority = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.OperatorOutputPriority, key) : this.OperatorOutputPriority;
  ...
  public static Offset<Global.OperatorExcel> Pack(FlatBufferBuilder builder, OperatorExcelT _o) {
    ...
    var _GroupId = _o.GroupId == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.GroupId, key) : _o.GroupId));
		var _OperatorCondition = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.OperatorCondition, key) : _o.OperatorCondition;
		var _OutputSequence = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.OutputSequence, key) : _o.OutputSequence;
		var _RandomWeight = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RandomWeight, key) : _o.RandomWeight;
		var _OutputDelay = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.OutputDelay, key) : _o.OutputDelay;
		var _Duration = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Duration, key) : _o.Duration;
		var _OperatorOutputPriority = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.OperatorOutputPriority, key) : _o.OperatorOutputPriority;
    ...
    var _TextLocalizeKey = _o.TextLocalizeKey == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.TextLocalizeKey, key) : _o.TextLocalizeKey));
    ...
    if (_o.VoiceId != null) {
      ...
      _VoiceId = CreateVoiceIdVector(builder, __VoiceId);
		...
		var _OperatorWaitQueue = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.OperatorWaitQueue, key) : _o.OperatorWaitQueue;
