...
public struct OperatorExcel : IFlatbufferObject
{
  ...
  public Global.OperatorCondition OperatorCondition { get { int o = __p.__offset(8); return o != 0 ? (Global.OperatorCondition)__p.bb.GetInt(o + __p.bb_pos) : Global.OperatorCondition.None; } }
  ...
  public static Offset<Global.OperatorExcel> CreateOperatorExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      StringOffset GroupIdOffset = default(StringOffset),
      Global.OperatorCondition OperatorCondition = Global.OperatorCondition.None,
  ...
  public static void AddOperatorCondition(FlatBufferBuilder builder, Global.OperatorCondition operatorCondition) { builder.AddInt(2, (int)operatorCondition, 0); }
  ...
  public static Offset<Global.OperatorExcel> EndOperatorExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.OperatorExcel>(o);
  }
  ...
  public void UnPackTo(OperatorExcelT _o) {
    ...
    _o.OperatorCondition = TableEncryptionService.UseEncryption ? (Global.OperatorCondition)TableEncryptionService.Convert((int)this.OperatorCondition, key) : this.OperatorCondition;
  ...
  public static Offset<Global.OperatorExcel> Pack(FlatBufferBuilder builder, OperatorExcelT _o) {
    if (_o == null) return default(Offset<Global.OperatorExcel>);
		byte[] key = TableEncryptionService.CreateKey("Operator");
    ...
    var _GroupId = _o.GroupId == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.GroupId, key) : _o.GroupId));
		var _OperatorCondition = TableEncryptionService.UseEncryption ? (Global.OperatorCondition)TableEncryptionService.Convert((int)_o.OperatorCondition, key) : _o.OperatorCondition;
...
public class OperatorExcelT
{
  ...
  public Global.OperatorCondition OperatorCondition { get; set; }
  ...
  public OperatorExcelT() {
    this.UniqueId = 0;
    this.GroupId = null;
    this.OperatorCondition = Global.OperatorCondition.None;
...
static public class OperatorExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*OperatorCondition*/, 4 /*Global.OperatorCondition*/, 4, false)
