...
public struct CharacterLevelExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.CharacterLevelExcel> CreateCharacterLevelExcel(FlatBufferBuilder builder,
      int Level = 0,
      long Exp = 0,
      long TotalExp = 0) {
  ...
  public static Offset<Global.CharacterLevelExcel> EndCharacterLevelExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.CharacterLevelExcel>(o);
  }
  ...
  public static Offset<Global.CharacterLevelExcel> Pack(FlatBufferBuilder builder, CharacterLevelExcelT _o) {
    if (_o == null) return default(Offset<Global.CharacterLevelExcel>);
		byte[] key = TableEncryptionService.CreateKey("CharacterLevel");
