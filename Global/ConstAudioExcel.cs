...
public struct ConstAudioExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.ConstAudioExcel> Pack(FlatBufferBuilder builder, ConstAudioExcelT _o) {
    if (_o == null) return default(Offset<Global.ConstAudioExcel>);
		byte[] key = TableEncryptionService.CreateKey("ConstAudio");
    var _DefaultSnapShotName = _o.DefaultSnapShotName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.DefaultSnapShotName, key) : _o.DefaultSnapShotName));
    var _BattleSnapShotName = _o.BattleSnapShotName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.BattleSnapShotName, key) : _o.BattleSnapShotName));
    var _RaidSnapShotName = _o.RaidSnapShotName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.RaidSnapShotName, key) : _o.RaidSnapShotName));
    var _ExSkillCutInSnapShotName = _o.ExSkillCutInSnapShotName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ExSkillCutInSnapShotName, key) : _o.ExSkillCutInSnapShotName));
