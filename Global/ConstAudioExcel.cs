...
public struct ConstAudioExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.ConstAudioExcel> CreateConstAudioExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.ConstAudioExcel> EndConstAudioExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.ConstAudioExcel>(o);
  }
  ...
  public void UnPackTo(ConstAudioExcelT _o) {
    ...
    _o.DefaultSnapShotName = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.DefaultSnapShotName, key) : this.DefaultSnapShotName;
    _o.BattleSnapShotName = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BattleSnapShotName, key) : this.BattleSnapShotName;
    _o.RaidSnapShotName = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.RaidSnapShotName, key) : this.RaidSnapShotName;
    _o.ExSkillCutInSnapShotName = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ExSkillCutInSnapShotName, key) : this.ExSkillCutInSnapShotName;
  }
  public static Offset<Global.ConstAudioExcel> Pack(FlatBufferBuilder builder, ConstAudioExcelT _o) {
    if (_o == null) return default(Offset<Global.ConstAudioExcel>);
		byte[] key = TableEncryptionService.CreateKey("ConstAudio");
    var _DefaultSnapShotName = _o.DefaultSnapShotName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.DefaultSnapShotName, key) : _o.DefaultSnapShotName));
    var _BattleSnapShotName = _o.BattleSnapShotName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.BattleSnapShotName, key) : _o.BattleSnapShotName));
    var _RaidSnapShotName = _o.RaidSnapShotName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.RaidSnapShotName, key) : _o.RaidSnapShotName));
    var _ExSkillCutInSnapShotName = _o.ExSkillCutInSnapShotName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.ExSkillCutInSnapShotName, key) : _o.ExSkillCutInSnapShotName));
