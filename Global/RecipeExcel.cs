...
public struct RecipeExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.RecipeExcel> CreateRecipeExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Global.RecipeExcel> EndRecipeExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.RecipeExcel>(o);
  }
  ...
  public static Offset<Global.RecipeExcel> Pack(FlatBufferBuilder builder, RecipeExcelT _o) {
    if (_o == null) return default(Offset<Global.RecipeExcel>);
		byte[] key = TableEncryptionService.CreateKey("Recipe");
