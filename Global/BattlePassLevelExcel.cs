...
public struct BattlePassLevelExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.BattlePassLevelExcel> CreateBattlePassLevelExcel(FlatBufferBuilder builder,
      long BattlePassId = 0,
      long Level = 0,
  ...
  public static Offset<Global.BattlePassLevelExcel> EndBattlePassLevelExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.BattlePassLevelExcel>(o);
  }
  ...
  public static Offset<Global.BattlePassLevelExcel> Pack(FlatBufferBuilder builder, BattlePassLevelExcelT _o) {
    if (_o == null) return default(Offset<Global.BattlePassLevelExcel>);
		byte[] key = TableEncryptionService.CreateKey("BattlePassLevel");
		...
		var _IsPickUpReward = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IsPickUpReward, key) : _o.IsPickUpReward;
