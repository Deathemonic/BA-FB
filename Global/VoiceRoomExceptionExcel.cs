...
public struct VoiceRoomExceptionExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(VoiceRoomExceptionExcelT _o) {
    ...
    _o.LinkedCharacterVoicePrintType = TableEncryptionService.UseEncryption ? (Global.CVPrintType)TableEncryptionService.Convert((int)this.LinkedCharacterVoicePrintType, key) : this.LinkedCharacterVoicePrintType;
  ...
  public static Offset<Global.VoiceRoomExceptionExcel> Pack(FlatBufferBuilder builder, VoiceRoomExceptionExcelT _o) {
    if (_o == null) return default(Offset<Global.VoiceRoomExceptionExcel>);
		...
		var _LinkedCharacterVoicePrintType = TableEncryptionService.UseEncryption ? (Global.CVPrintType)TableEncryptionService.Convert((int)_o.LinkedCharacterVoicePrintType, key) : _o.LinkedCharacterVoicePrintType;
