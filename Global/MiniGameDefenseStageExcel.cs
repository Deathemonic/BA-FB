...
public struct MiniGameDefenseStageExcel : IFlatbufferObject
{
  ...
  public Global.EchelonExtensionType EchelonExtensionType { get { int o = __p.__offset(20); return o != 0 ? (Global.EchelonExtensionType)__p.bb.GetInt(o + __p.bb_pos) : Global.EchelonExtensionType.Base; } }
  public long BattleDuration { get { int o = __p.__offset(22); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public Global.ParcelType StageEnterCostType { get { int o = __p.__offset(24); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Global.ParcelType.None; } }
  ...
  public Global.StageTopography StageTopography { get { int o = __p.__offset(36); return o != 0 ? (Global.StageTopography)__p.bb.GetInt(o + __p.bb_pos) : Global.StageTopography.Street; } }
  ...
  public Global.ContentType ContentType { get { int o = __p.__offset(42); return o != 0 ? (Global.ContentType)__p.bb.GetInt(o + __p.bb_pos) : Global.ContentType.None; } }
  public Global.StarGoalType StarGoal(int j) { int o = __p.__offset(44); return o != 0 ? (Global.StarGoalType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Global.StarGoalType)0; }
  public int StarGoalLength { get { int o = __p.__offset(44); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Global.StarGoalType> GetStarGoalBytes() { return __p.__vector_as_span<Global.StarGoalType>(44, 4); }
#else
  public ArraySegment<byte>? GetStarGoalBytes() { return __p.__vector_as_arraysegment(44); }
#endif
  public Global.StarGoalType[] GetStarGoalArray() { int o = __p.__offset(44); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Global.StarGoalType[] a = new Global.StarGoalType[l]; for (int i = 0; i < l; i++) { a[i] = (Global.StarGoalType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Global.MiniGameDefenseStageExcel> CreateMiniGameDefenseStageExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddEchelonExtensionType(FlatBufferBuilder builder, Global.EchelonExtensionType echelonExtensionType) { builder.AddInt(8, (int)echelonExtensionType, 0); }
  public static void AddBattleDuration(FlatBufferBuilder builder, long battleDuration) { builder.AddLong(9, battleDuration, 0); }
  public static void AddStageEnterCostType(FlatBufferBuilder builder, Global.ParcelType stageEnterCostType) { builder.AddInt(10, (int)stageEnterCostType, 0); }
  ...
  public static void AddStageTopography(FlatBufferBuilder builder, Global.StageTopography stageTopography) { builder.AddInt(16, (int)stageTopography, 0); }
  ...
  public static void AddContentType(FlatBufferBuilder builder, Global.ContentType contentType) { builder.AddInt(19, (int)contentType, 0); }
  ...
  public static Offset<Global.MiniGameDefenseStageExcel> EndMiniGameDefenseStageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.MiniGameDefenseStageExcel>(o);
  }
  ...
  public void UnPackTo(MiniGameDefenseStageExcelT _o) {
    ...
    _o.StageDifficultyLocalize = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StageDifficultyLocalize, key) : this.StageDifficultyLocalize;
    ...
    _o.DefenseFormationBGPrefabScale = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.DefenseFormationBGPrefabScale, key) : this.DefenseFormationBGPrefabScale;
    _o.FixedEchelon = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.FixedEchelon, key) : this.FixedEchelon;
    _o.MininageDefenseFixedStatId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MininageDefenseFixedStatId, key) : this.MininageDefenseFixedStatId;
    _o.StageHint = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StageHint, key) : this.StageHint;
  }
  public static Offset<Global.MiniGameDefenseStageExcel> Pack(FlatBufferBuilder builder, MiniGameDefenseStageExcelT _o) {
    if (_o == null) return default(Offset<Global.MiniGameDefenseStageExcel>);
		byte[] key = TableEncryptionService.CreateKey("MiniGameDefenseStage");
    ...
    var _Name = _o.Name == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.Name, key) : _o.Name));
		...
		var _StageDifficultyLocalize = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StageDifficultyLocalize, key) : _o.StageDifficultyLocalize;
		var _StageNumber = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StageNumber, key) : _o.StageNumber;
    ...
    var _DefenseFormationBGPrefab = _o.DefenseFormationBGPrefab == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.DefenseFormationBGPrefab, key) : _o.DefenseFormationBGPrefab));
		var _DefenseFormationBGPrefabScale = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DefenseFormationBGPrefabScale, key) : _o.DefenseFormationBGPrefabScale;
		var _FixedEchelon = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.FixedEchelon, key) : _o.FixedEchelon;
		var _MininageDefenseFixedStatId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MininageDefenseFixedStatId, key) : _o.MininageDefenseFixedStatId;
...
static public class MiniGameDefenseStageExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 20 /*EchelonExtensionType*/, 4 /*Global.EchelonExtensionType*/, 4, false)
      && verifier.VerifyField(tablePos, 22 /*BattleDuration*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 24 /*StageEnterCostType*/, 4 /*Global.ParcelType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 36 /*StageTopography*/, 4 /*Global.StageTopography*/, 4, false)
      && verifier.VerifyField(tablePos, 38 /*RecommandLevel*/, 4 /*int*/, 4, false)
      && verifier.VerifyField(tablePos, 40 /*GroundID*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 42 /*ContentType*/, 4 /*Global.ContentType*/, 4, false)
      && verifier.VerifyVectorOfData(tablePos, 44 /*StarGoal*/, 4 /*Global.StarGoalType*/, false)
