...
public struct CombatEmojiExcel : IFlatbufferObject
{
  ...
  public Global.EmojiEvent EmojiEvent { get { int o = __p.__offset(6); return o != 0 ? (Global.EmojiEvent)__p.bb.GetInt(o + __p.bb_pos) : Global.EmojiEvent.EnterConver; } }
  ...
  public static Offset<Global.CombatEmojiExcel> CreateCombatEmojiExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      Global.EmojiEvent EmojiEvent = Global.EmojiEvent.EnterConver,
  ...
  public static void AddEmojiEvent(FlatBufferBuilder builder, Global.EmojiEvent emojiEvent) { builder.AddInt(1, (int)emojiEvent, 0); }
  ...
  public static Offset<Global.CombatEmojiExcel> EndCombatEmojiExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.CombatEmojiExcel>(o);
  }
  ...
  public void UnPackTo(CombatEmojiExcelT _o) {
    ...
    _o.EmojiEvent = TableEncryptionService.UseEncryption ? (Global.EmojiEvent)TableEncryptionService.Convert((int)this.EmojiEvent, key) : this.EmojiEvent;
    _o.OrderOfPriority = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.OrderOfPriority, key) : this.OrderOfPriority;
    _o.EmojiDuration = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.EmojiDuration, key) : this.EmojiDuration;
    _o.EmojiReversal = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.EmojiReversal, key) : this.EmojiReversal;
    _o.EmojiTurnOn = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.EmojiTurnOn, key) : this.EmojiTurnOn;
    _o.ShowEmojiDelay = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.ShowEmojiDelay, key) : this.ShowEmojiDelay;
    _o.ShowDefaultBG = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.ShowDefaultBG, key) : this.ShowDefaultBG;
  }
  public static Offset<Global.CombatEmojiExcel> Pack(FlatBufferBuilder builder, CombatEmojiExcelT _o) {
    if (_o == null) return default(Offset<Global.CombatEmojiExcel>);
		byte[] key = TableEncryptionService.CreateKey("CombatEmoji");
		var _UniqueId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.UniqueId, key) : _o.UniqueId;
		var _EmojiEvent = TableEncryptionService.UseEncryption ? (Global.EmojiEvent)TableEncryptionService.Convert((int)_o.EmojiEvent, key) : _o.EmojiEvent;
		var _OrderOfPriority = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.OrderOfPriority, key) : _o.OrderOfPriority;
		var _EmojiDuration = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.EmojiDuration, key) : _o.EmojiDuration;
		var _EmojiReversal = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.EmojiReversal, key) : _o.EmojiReversal;
		var _EmojiTurnOn = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.EmojiTurnOn, key) : _o.EmojiTurnOn;
		var _ShowEmojiDelay = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.ShowEmojiDelay, key) : _o.ShowEmojiDelay;
		var _ShowDefaultBG = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.ShowDefaultBG, key) : _o.ShowDefaultBG;
    return CreateCombatEmojiExcel(
      builder,
      TableEncryptionService.UseEncryption ? _UniqueId : _o.UniqueId,
      TableEncryptionService.UseEncryption ? _EmojiEvent : _o.EmojiEvent,
      TableEncryptionService.UseEncryption ? _OrderOfPriority : _o.OrderOfPriority,
      TableEncryptionService.UseEncryption ? _EmojiDuration : _o.EmojiDuration,
      TableEncryptionService.UseEncryption ? _EmojiReversal : _o.EmojiReversal,
      TableEncryptionService.UseEncryption ? _EmojiTurnOn : _o.EmojiTurnOn,
      TableEncryptionService.UseEncryption ? _ShowEmojiDelay : _o.ShowEmojiDelay,
      TableEncryptionService.UseEncryption ? _ShowDefaultBG : _o.ShowDefaultBG);
  }
}
...
public class CombatEmojiExcelT
{
  ...
  public Global.EmojiEvent EmojiEvent { get; set; }
  ...
  public CombatEmojiExcelT() {
    this.UniqueId = 0;
    this.EmojiEvent = Global.EmojiEvent.EnterConver;
...
static public class CombatEmojiExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*EmojiEvent*/, 4 /*Global.EmojiEvent*/, 4, false)
