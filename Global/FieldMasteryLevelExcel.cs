...
public struct FieldMasteryLevelExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.FieldMasteryLevelExcel> CreateFieldMasteryLevelExcel(FlatBufferBuilder builder,
      int Level = 0,
  ...
  public static Offset<Global.FieldMasteryLevelExcel> EndFieldMasteryLevelExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.FieldMasteryLevelExcel>(o);
  }
  ...
  public void UnPackTo(FieldMasteryLevelExcelT _o) {
    ...
    _o.Id = new List<long>();
    for (var _j = 0; _j < this.IdLength; ++_j) {_o.Id.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Id(_j), key) : this.Id(_j));}
    _o.Exp = new List<long>();
    for (var _j = 0; _j < this.ExpLength; ++_j) {_o.Exp.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Exp(_j), key) : this.Exp(_j));}
  ...
  public static Offset<Global.FieldMasteryLevelExcel> Pack(FlatBufferBuilder builder, FieldMasteryLevelExcelT _o) {
    if (_o == null) return default(Offset<Global.FieldMasteryLevelExcel>);
		byte[] key = TableEncryptionService.CreateKey("FieldMasteryLevel");
    ...
    if (_o.Id != null) {
      var __id = _o.Id.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
