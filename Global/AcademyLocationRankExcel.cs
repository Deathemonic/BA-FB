...
public struct AcademyLocationRankExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(AcademyLocationRankExcelT _o) {
    ...
    _o.RankExp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.RankExp, key) : this.RankExp;
  ...
  public static Offset<Global.AcademyLocationRankExcel> Pack(FlatBufferBuilder builder, AcademyLocationRankExcelT _o) {
    if (_o == null) return default(Offset<Global.AcademyLocationRankExcel>);
		...
		var _RankExp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RankExp, key) : _o.RankExp;
		var _TotalExp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.TotalExp, key) : _o.TotalExp;
