...
public struct AcademyLocationRankExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.AcademyLocationRankExcel> CreateAcademyLocationRankExcel(FlatBufferBuilder builder,
      long Rank = 0,
      long RankExp = 0,
      long TotalExp = 0) {
  ...
  public static Offset<Global.AcademyLocationRankExcel> EndAcademyLocationRankExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.AcademyLocationRankExcel>(o);
  }
  ...
  public void UnPackTo(AcademyLocationRankExcelT _o) {
    ...
    _o.RankExp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.RankExp, key) : this.RankExp;
    _o.TotalExp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.TotalExp, key) : this.TotalExp;
  }
  public static Offset<Global.AcademyLocationRankExcel> Pack(FlatBufferBuilder builder, AcademyLocationRankExcelT _o) {
    if (_o == null) return default(Offset<Global.AcademyLocationRankExcel>);
		byte[] key = TableEncryptionService.CreateKey("AcademyLocationRank");
		var _Rank = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.Rank, key) : _o.Rank;
		var _RankExp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.RankExp, key) : _o.RankExp;
		var _TotalExp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.TotalExp, key) : _o.TotalExp;
    return CreateAcademyLocationRankExcel(
      builder,
      TableEncryptionService.UseEncryption ? _Rank : _o.Rank,
      TableEncryptionService.UseEncryption ? _RankExp : _o.RankExp,
      TableEncryptionService.UseEncryption ? _TotalExp : _o.TotalExp);
  }
}
