...
public struct AcademyMessanger3Excel : IFlatbufferObject
{
  ...
  public static Offset<Global.AcademyMessanger3Excel> CreateAcademyMessanger3Excel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.AcademyMessanger3Excel> EndAcademyMessanger3Excel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.AcademyMessanger3Excel>(o);
  }
  ...
  public static Offset<Global.AcademyMessanger3Excel> Pack(FlatBufferBuilder builder, AcademyMessanger3ExcelT _o) {
    if (_o == null) return default(Offset<Global.AcademyMessanger3Excel>);
		byte[] key = TableEncryptionService.CreateKey("AcademyMessanger3");
