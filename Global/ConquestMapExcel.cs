...
public struct ConquestMapExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ConquestMapExcelT _o) {
    ...
    _o.StepEnterScenarioGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.StepEnterScenarioGroupId, key) : this.StepEnterScenarioGroupId;
    _o.StepOpenConditionType = new List<Global.ConquestConditionType>();
    for (var _j = 0; _j < this.StepOpenConditionTypeLength; ++_j) {_o.StepOpenConditionType.Add(TableEncryptionService.UseEncryption ? (Global.ConquestConditionType)TableEncryptionService.Convert((int)this.StepOpenConditionType(_j), key) : this.StepOpenConditionType(_j));}
    ...
    _o.CameraSettingId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.CameraSettingId, key) : this.CameraSettingId;
  }
  public static Offset<Global.ConquestMapExcel> Pack(FlatBufferBuilder builder, ConquestMapExcelT _o) {
    ...
    var _ConquestMap = _o.ConquestMap == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.ConquestMap, key) : _o.ConquestMap));
		var _StepEnterScenarioGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.StepEnterScenarioGroupId, key) : _o.StepEnterScenarioGroupId;
    var _StepOpenConditionType = default(VectorOffset);
    if (_o.StepOpenConditionType != null) {
      var __StepOpenConditionType = _o.StepOpenConditionType.Select(x => TableEncryptionService.UseEncryption ? (Global.ConquestConditionType)TableEncryptionService.Convert((int)x, key) : x).ToArray();
    ...
    if (_o.StepOpenConditionParameter != null) {
      ...
      for (var _j = 0; _j < __StepOpenConditionParameter.Length; ++_j) { __StepOpenConditionParameter[_j] = builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.StepOpenConditionParameter[_j], key) : _o.StepOpenConditionParameter[_j])); }
      _StepOpenConditionParameter = CreateStepOpenConditionParameterVector(builder, __StepOpenConditionParameter);
    }
    var _MapGoalLocalize = _o.MapGoalLocalize == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.MapGoalLocalize, key) : _o.MapGoalLocalize));
    var _StepGoalLocalize = _o.StepGoalLocalize == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.StepGoalLocalize, key) : _o.StepGoalLocalize));
    var _StepNameLocalize = _o.StepNameLocalize == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.StepNameLocalize, key) : _o.StepNameLocalize));
    var _ConquestMapBG = _o.ConquestMapBG == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.ConquestMapBG, key) : _o.ConquestMapBG));
		var _CameraSettingId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.CameraSettingId, key) : _o.CameraSettingId;
