...
public struct ScenarioScriptExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ScenarioScriptExcelT _o) {
    ...
    _o.SelectionGroup = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SelectionGroup, key) : this.SelectionGroup;
    ...
    _o.Transition = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Transition, key) : this.Transition;
    _o.BGName = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BGName, key) : this.BGName;
    _o.BGEffect = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BGEffect, key) : this.BGEffect;
    ...
    _o.VoiceId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.VoiceId, key) : this.VoiceId;
  ...
  public static Offset<Global.ScenarioScriptExcel> Pack(FlatBufferBuilder builder, ScenarioScriptExcelT _o) {
    if (_o == null) return default(Offset<Global.ScenarioScriptExcel>);
		...
		var _SelectionGroup = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.SelectionGroup, key) : _o.SelectionGroup;
		var _BGMId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.BGMId, key) : _o.BGMId;
    var _Sound = _o.Sound == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.Sound, key) : _o.Sound));
		var _Transition = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Transition, key) : _o.Transition;
		var _BGName = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.BGName, key) : _o.BGName;
		var _BGEffect = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.BGEffect, key) : _o.BGEffect;
    var _PopupFileName = _o.PopupFileName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.PopupFileName, key) : _o.PopupFileName));
    var _ScriptKr = _o.ScriptKr == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ScriptKr, key) : _o.ScriptKr));
    var _TextJp = _o.TextJp == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.TextJp, key) : _o.TextJp));
    var _TextTh = _o.TextTh == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.TextTh, key) : _o.TextTh));
    var _TextTw = _o.TextTw == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.TextTw, key) : _o.TextTw));
    var _TextEn = _o.TextEn == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.TextEn, key) : _o.TextEn));
		var _VoiceId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.VoiceId, key) : _o.VoiceId;
