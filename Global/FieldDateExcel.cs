...
public struct FieldDateExcel : IFlatbufferObject
{
  ...
  public Global.FieldConditionType StartConditionType { get { int o = __p.__offset(14); return o != 0 ? (Global.FieldConditionType)__p.bb.GetInt(o + __p.bb_pos) : Global.FieldConditionType.Invalid; } }
  public long StartConditionId { get { int o = __p.__offset(16); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public Global.FieldConditionType EndConditionType { get { int o = __p.__offset(18); return o != 0 ? (Global.FieldConditionType)__p.bb.GetInt(o + __p.bb_pos) : Global.FieldConditionType.Invalid; } }
  public long EndConditionId { get { int o = __p.__offset(20); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public Global.FieldConditionType EndReadyConditionType { get { int o = __p.__offset(22); return o != 0 ? (Global.FieldConditionType)__p.bb.GetInt(o + __p.bb_pos) : Global.FieldConditionType.Invalid; } }
  ...
  public static Offset<Global.FieldDateExcel> CreateFieldDateExcel(FlatBufferBuilder builder,
      long SeasonId = 0,
      long UniqueId = 0,
      long OpenDate = 0,
      StringOffset DateLocalizeKeyOffset = default(StringOffset),
      long EntrySceneId = 0,
      Global.FieldConditionType StartConditionType = Global.FieldConditionType.Invalid,
      long StartConditionId = 0,
      Global.FieldConditionType EndConditionType = Global.FieldConditionType.Invalid,
      long EndConditionId = 0,
      Global.FieldConditionType EndReadyConditionType = Global.FieldConditionType.Invalid,
  ...
  public static void AddStartConditionType(FlatBufferBuilder builder, Global.FieldConditionType startConditionType) { builder.AddInt(5, (int)startConditionType, 0); }
  ...
  public static void AddEndConditionType(FlatBufferBuilder builder, Global.FieldConditionType endConditionType) { builder.AddInt(7, (int)endConditionType, 0); }
  public static void AddEndConditionId(FlatBufferBuilder builder, long endConditionId) { builder.AddLong(8, endConditionId, 0); }
  public static void AddEndReadyConditionType(FlatBufferBuilder builder, Global.FieldConditionType endReadyConditionType) { builder.AddInt(9, (int)endReadyConditionType, 0); }
  ...
  public static Offset<Global.FieldDateExcel> EndFieldDateExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.FieldDateExcel>(o);
  }
  ...
  public void UnPackTo(FieldDateExcelT _o) {
    ...
    _o.EntrySceneId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.EntrySceneId, key) : this.EntrySceneId;
    _o.StartConditionType = TableEncryptionService.UseEncryption ? (Global.FieldConditionType)TableEncryptionService.Convert((int)this.StartConditionType, key) : this.StartConditionType;
    _o.StartConditionId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.StartConditionId, key) : this.StartConditionId;
    _o.EndConditionType = TableEncryptionService.UseEncryption ? (Global.FieldConditionType)TableEncryptionService.Convert((int)this.EndConditionType, key) : this.EndConditionType;
    _o.EndConditionId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.EndConditionId, key) : this.EndConditionId;
    _o.EndReadyConditionType = TableEncryptionService.UseEncryption ? (Global.FieldConditionType)TableEncryptionService.Convert((int)this.EndReadyConditionType, key) : this.EndReadyConditionType;
    _o.EndReadyConditionId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.EndReadyConditionId, key) : this.EndReadyConditionId;
    _o.OpenConditionStage = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.OpenConditionStage, key) : this.OpenConditionStage;
    ...
    _o.DateResultSpineOffsetX = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)this.DateResultSpineOffsetX, key) : this.DateResultSpineOffsetX;
  }
  public static Offset<Global.FieldDateExcel> Pack(FlatBufferBuilder builder, FieldDateExcelT _o) {
    if (_o == null) return default(Offset<Global.FieldDateExcel>);
		byte[] key = TableEncryptionService.CreateKey("FieldDate");
    ...
    var _DateLocalizeKey = _o.DateLocalizeKey == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.DateLocalizeKey, key) : _o.DateLocalizeKey));
		var _EntrySceneId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.EntrySceneId, key) : _o.EntrySceneId;
		var _StartConditionType = TableEncryptionService.UseEncryption ? (Global.FieldConditionType)TableEncryptionService.Convert((int)_o.StartConditionType, key) : _o.StartConditionType;
		var _StartConditionId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.StartConditionId, key) : _o.StartConditionId;
		var _EndConditionType = TableEncryptionService.UseEncryption ? (Global.FieldConditionType)TableEncryptionService.Convert((int)_o.EndConditionType, key) : _o.EndConditionType;
		var _EndConditionId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.EndConditionId, key) : _o.EndConditionId;
		var _EndReadyConditionType = TableEncryptionService.UseEncryption ? (Global.FieldConditionType)TableEncryptionService.Convert((int)_o.EndReadyConditionType, key) : _o.EndReadyConditionType;
		var _EndReadyConditionId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.EndReadyConditionId, key) : _o.EndReadyConditionId;
		var _OpenConditionStage = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.OpenConditionStage, key) : _o.OpenConditionStage;
    var _CharacterIconPath = _o.CharacterIconPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.CharacterIconPath, key) : _o.CharacterIconPath));
    var _DateResultBGPath = _o.DateResultBGPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.DateResultBGPath, key) : _o.DateResultBGPath));
    var _DateResultSpinePath = _o.DateResultSpinePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.DateResultSpinePath, key) : _o.DateResultSpinePath));
		var _DateResultSpineOffsetX = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)_o.DateResultSpineOffsetX, key) : _o.DateResultSpineOffsetX;
    return CreateFieldDateExcel(
      ...
      _DateLocalizeKey,
      TableEncryptionService.UseEncryption ? _EntrySceneId : _o.EntrySceneId,
      TableEncryptionService.UseEncryption ? _StartConditionType : _o.StartConditionType,
      TableEncryptionService.UseEncryption ? _StartConditionId : _o.StartConditionId,
      TableEncryptionService.UseEncryption ? _EndConditionType : _o.EndConditionType,
      TableEncryptionService.UseEncryption ? _EndConditionId : _o.EndConditionId,
      TableEncryptionService.UseEncryption ? _EndReadyConditionType : _o.EndReadyConditionType,
      TableEncryptionService.UseEncryption ? _EndReadyConditionId : _o.EndReadyConditionId,
      TableEncryptionService.UseEncryption ? _OpenConditionStage : _o.OpenConditionStage,
      _CharacterIconPath,
      _DateResultBGPath,
      _DateResultSpinePath,
      TableEncryptionService.UseEncryption ? _DateResultSpineOffsetX : _o.DateResultSpineOffsetX);
  }
}
...
public class FieldDateExcelT
{
  ...
  public Global.FieldConditionType StartConditionType { get; set; }
  public long StartConditionId { get; set; }
  public Global.FieldConditionType EndConditionType { get; set; }
  public long EndConditionId { get; set; }
  public Global.FieldConditionType EndReadyConditionType { get; set; }
  ...
  public FieldDateExcelT() {
    ...
    this.EntrySceneId = 0;
    this.StartConditionType = Global.FieldConditionType.Invalid;
    this.StartConditionId = 0;
    this.EndConditionType = Global.FieldConditionType.Invalid;
    this.EndConditionId = 0;
    this.EndReadyConditionType = Global.FieldConditionType.Invalid;
...
static public class FieldDateExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 14 /*StartConditionType*/, 4 /*Global.FieldConditionType*/, 4, false)
      && verifier.VerifyField(tablePos, 16 /*StartConditionId*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 18 /*EndConditionType*/, 4 /*Global.FieldConditionType*/, 4, false)
      && verifier.VerifyField(tablePos, 20 /*EndConditionId*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 22 /*EndReadyConditionType*/, 4 /*Global.FieldConditionType*/, 4, false)
