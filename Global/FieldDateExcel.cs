...
public struct FieldDateExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.FieldDateExcel> Pack(FlatBufferBuilder builder, FieldDateExcelT _o) {
    ...
    var _DateLocalizeKey = _o.DateLocalizeKey == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.DateLocalizeKey, key) : _o.DateLocalizeKey));
		var _EntrySceneId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EntrySceneId, key) : _o.EntrySceneId;
		var _StartConditionType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StartConditionType, key) : _o.StartConditionType;
		var _StartConditionId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StartConditionId, key) : _o.StartConditionId;
		var _EndConditionType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EndConditionType, key) : _o.EndConditionType;
		var _EndConditionId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EndConditionId, key) : _o.EndConditionId;
		var _EndReadyConditionType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EndReadyConditionType, key) : _o.EndReadyConditionType;
		var _EndReadyConditionId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EndReadyConditionId, key) : _o.EndReadyConditionId;
		var _OpenConditionStage = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.OpenConditionStage, key) : _o.OpenConditionStage;
    var _CharacterIconPath = _o.CharacterIconPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.CharacterIconPath, key) : _o.CharacterIconPath));
    var _DateResultBGPath = _o.DateResultBGPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.DateResultBGPath, key) : _o.DateResultBGPath));
    var _DateResultSpinePath = _o.DateResultSpinePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.DateResultSpinePath, key) : _o.DateResultSpinePath));
		var _DateResultSpineOffsetX = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DateResultSpineOffsetX, key) : _o.DateResultSpineOffsetX;
