...
public struct CharacterGearExcel : IFlatbufferObject
{
  ...
  public Global.StatLevelUpType StatLevelUpType { get { int o = __p.__offset(8); return o != 0 ? (Global.StatLevelUpType)__p.bb.GetInt(o + __p.bb_pos) : Global.StatLevelUpType.Standard; } }
  ...
  public Global.EquipmentOptionType StatType(int j) { int o = __p.__offset(22); return o != 0 ? (Global.EquipmentOptionType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Global.EquipmentOptionType)0; }
  public int StatTypeLength { get { int o = __p.__offset(22); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Global.EquipmentOptionType> GetStatTypeBytes() { return __p.__vector_as_span<Global.EquipmentOptionType>(22, 4); }
#else
  public ArraySegment<byte>? GetStatTypeBytes() { return __p.__vector_as_arraysegment(22); }
#endif
  public Global.EquipmentOptionType[] GetStatTypeArray() { int o = __p.__offset(22); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Global.EquipmentOptionType[] a = new Global.EquipmentOptionType[l]; for (int i = 0; i < l; i++) { a[i] = (Global.EquipmentOptionType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Global.Tag Tags(int j) { int o = __p.__offset(32); return o != 0 ? (Global.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Global.Tag)0; }
  public int TagsLength { get { int o = __p.__offset(32); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Global.Tag> GetTagsBytes() { return __p.__vector_as_span<Global.Tag>(32, 4); }
#else
  public ArraySegment<byte>? GetTagsBytes() { return __p.__vector_as_arraysegment(32); }
#endif
  public Global.Tag[] GetTagsArray() { int o = __p.__offset(32); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Global.Tag[] a = new Global.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (Global.Tag)__p.bb.GetInt(p + i * 4); } return a; }

  public static Offset<Global.CharacterGearExcel> CreateCharacterGearExcel(FlatBufferBuilder builder,
      long Id = 0,
      long CharacterId = 0,
  ...
  public static void AddStatLevelUpType(FlatBufferBuilder builder, Global.StatLevelUpType statLevelUpType) { builder.AddInt(2, (int)statLevelUpType, 0); }
  ...
  public static Offset<Global.CharacterGearExcel> EndCharacterGearExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.CharacterGearExcel>(o);
  }
  ...
  public void UnPackTo(CharacterGearExcelT _o) {
    ...
    _o.NextTierEquipment = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.NextTierEquipment, key) : this.NextTierEquipment;
    _o.RecipeId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.RecipeId, key) : this.RecipeId;
    _o.OpenFavorLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.OpenFavorLevel, key) : this.OpenFavorLevel;
    _o.MaxLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.MaxLevel, key) : this.MaxLevel;
    _o.LearnSkillSlot = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.LearnSkillSlot, key) : this.LearnSkillSlot;
    ...
    for (var _j = 0; _j < this.MinStatValueLength; ++_j) {_o.MinStatValue.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.MinStatValue(_j), key) : this.MinStatValue(_j));}
    _o.MaxStatValue = new List<long>();
    for (var _j = 0; _j < this.MaxStatValueLength; ++_j) {_o.MaxStatValue.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.MaxStatValue(_j), key) : this.MaxStatValue(_j));}
  ...
  public static Offset<Global.CharacterGearExcel> Pack(FlatBufferBuilder builder, CharacterGearExcelT _o) {
    if (_o == null) return default(Offset<Global.CharacterGearExcel>);
		byte[] key = TableEncryptionService.CreateKey("CharacterGear");
		...
		var _NextTierEquipment = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.NextTierEquipment, key) : _o.NextTierEquipment;
		var _RecipeId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.RecipeId, key) : _o.RecipeId;
		var _OpenFavorLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.OpenFavorLevel, key) : _o.OpenFavorLevel;
		var _MaxLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.MaxLevel, key) : _o.MaxLevel;
    var _LearnSkillSlot = _o.LearnSkillSlot == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.LearnSkillSlot, key) : _o.LearnSkillSlot));
    ...
    if (_o.MinStatValue != null) {
      var __MinStatValue = _o.MinStatValue.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
    ...
    if (_o.MaxStatValue != null) {
      var __MaxStatValue = _o.MaxStatValue.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
    ...
    return CreateCharacterGearExcel(
      ...
      TableEncryptionService.UseEncryption ? _OpenFavorLevel : _o.OpenFavorLevel,
...
static public class CharacterGearExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*StatLevelUpType*/, 4 /*Global.StatLevelUpType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 22 /*StatType*/, 4 /*Global.EquipmentOptionType*/, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 32 /*Tags*/, 4 /*Global.Tag*/, false)
