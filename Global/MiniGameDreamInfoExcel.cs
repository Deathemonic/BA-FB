...
public struct MiniGameDreamInfoExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(MiniGameDreamInfoExcelT _o) {
    ...
    _o.DreamMakerMultiplierCondition = TableEncryptionService.UseEncryption ? (Global.DreamMakerMultiplierCondition)TableEncryptionService.Convert((int)this.DreamMakerMultiplierCondition, key) : this.DreamMakerMultiplierCondition;
    ...
    _o.DreamMakerParcelType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)this.DreamMakerParcelType, key) : this.DreamMakerParcelType;
    ...
    _o.DreamMakerDailyPointParcelType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)this.DreamMakerDailyPointParcelType, key) : this.DreamMakerDailyPointParcelType;
  ...
  public static Offset<Global.MiniGameDreamInfoExcel> Pack(FlatBufferBuilder builder, MiniGameDreamInfoExcelT _o) {
    if (_o == null) return default(Offset<Global.MiniGameDreamInfoExcel>);
		...
		var _DreamMakerMultiplierCondition = TableEncryptionService.UseEncryption ? (Global.DreamMakerMultiplierCondition)TableEncryptionService.Convert((int)_o.DreamMakerMultiplierCondition, key) : _o.DreamMakerMultiplierCondition;
		...
		var _DreamMakerParcelType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)_o.DreamMakerParcelType, key) : _o.DreamMakerParcelType;
		...
		var _DreamMakerDailyPointParcelType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)_o.DreamMakerDailyPointParcelType, key) : _o.DreamMakerDailyPointParcelType;
