...
public struct ScenarioBGName_GlobalExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ScenarioBGName_GlobalExcelT _o) {
    ...
    _o.NameAsia = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.NameAsia, key) : this.NameAsia;
    _o.NameNa = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.NameNa, key) : this.NameNa;
    _o.NameGlobal = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.NameGlobal, key) : this.NameGlobal;
    _o.NameTeen = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.NameTeen, key) : this.NameTeen;
  }
  public static Offset<Global.ScenarioBGName_GlobalExcel> Pack(FlatBufferBuilder builder, ScenarioBGName_GlobalExcelT _o) {
    if (_o == null) return default(Offset<Global.ScenarioBGName_GlobalExcel>);
		byte[] key = TableEncryptionService.CreateKey("ScenarioBGName_Global");
		var _GroupName = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.GroupName, key) : _o.GroupName;
		var _NameKr = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.NameKr, key) : _o.NameKr;
		var _NameTw = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.NameTw, key) : _o.NameTw;
		var _NameAsia = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.NameAsia, key) : _o.NameAsia;
		var _NameNa = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.NameNa, key) : _o.NameNa;
		var _NameGlobal = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.NameGlobal, key) : _o.NameGlobal;
		var _NameTeen = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.NameTeen, key) : _o.NameTeen;
