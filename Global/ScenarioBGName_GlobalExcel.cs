...
public struct ScenarioBGName_GlobalExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.ScenarioBGName_GlobalExcel> CreateScenarioBGName_GlobalExcel(FlatBufferBuilder builder,
      uint GroupName = 0,
      uint NameKr = 0,
      uint NameTw = 0,
      uint NameAsia = 0,
  ...
  public static Offset<Global.ScenarioBGName_GlobalExcel> EndScenarioBGName_GlobalExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.ScenarioBGName_GlobalExcel>(o);
  }
  ...
  public void UnPackTo(ScenarioBGName_GlobalExcelT _o) {
    ...
    _o.GroupName = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)this.GroupName, key) : this.GroupName;
    _o.NameKr = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)this.NameKr, key) : this.NameKr;
    _o.NameTw = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)this.NameTw, key) : this.NameTw;
    _o.NameAsia = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)this.NameAsia, key) : this.NameAsia;
    _o.NameNa = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)this.NameNa, key) : this.NameNa;
    _o.NameGlobal = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)this.NameGlobal, key) : this.NameGlobal;
    _o.NameTeen = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)this.NameTeen, key) : this.NameTeen;
  }
  public static Offset<Global.ScenarioBGName_GlobalExcel> Pack(FlatBufferBuilder builder, ScenarioBGName_GlobalExcelT _o) {
    if (_o == null) return default(Offset<Global.ScenarioBGName_GlobalExcel>);
		byte[] key = TableEncryptionService.CreateKey("ScenarioBGName_Global");
		var _GroupName = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)_o.GroupName, key) : _o.GroupName;
		var _NameKr = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)_o.NameKr, key) : _o.NameKr;
		var _NameTw = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)_o.NameTw, key) : _o.NameTw;
		var _NameAsia = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)_o.NameAsia, key) : _o.NameAsia;
		var _NameNa = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)_o.NameNa, key) : _o.NameNa;
		var _NameGlobal = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)_o.NameGlobal, key) : _o.NameGlobal;
		var _NameTeen = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)_o.NameTeen, key) : _o.NameTeen;
    return CreateScenarioBGName_GlobalExcel(
      builder,
      TableEncryptionService.UseEncryption ? _GroupName : _o.GroupName,
      TableEncryptionService.UseEncryption ? _NameKr : _o.NameKr,
      TableEncryptionService.UseEncryption ? _NameTw : _o.NameTw,
      TableEncryptionService.UseEncryption ? _NameAsia : _o.NameAsia,
      TableEncryptionService.UseEncryption ? _NameNa : _o.NameNa,
      TableEncryptionService.UseEncryption ? _NameGlobal : _o.NameGlobal,
      TableEncryptionService.UseEncryption ? _NameTeen : _o.NameTeen);
  }
}
