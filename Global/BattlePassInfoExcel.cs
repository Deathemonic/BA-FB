...
public struct BattlePassInfoExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.BattlePassInfoExcel> CreateBattlePassInfoExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Global.BattlePassInfoExcel> EndBattlePassInfoExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.BattlePassInfoExcel>(o);
  }
  ...
  public static Offset<Global.BattlePassInfoExcel> Pack(FlatBufferBuilder builder, BattlePassInfoExcelT _o) {
    if (_o == null) return default(Offset<Global.BattlePassInfoExcel>);
		byte[] key = TableEncryptionService.CreateKey("BattlePassInfo");
		var _Id = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Id, key) : _o.Id;
		var _FreeRewardGroupID = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.FreeRewardGroupID, key) : _o.FreeRewardGroupID;
		var _PurchaseRewardGroupID = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PurchaseRewardGroupID, key) : _o.PurchaseRewardGroupID;
		var _NormalProductGroupID = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.NormalProductGroupID, key) : _o.NormalProductGroupID;
		var _PremiumProductGroupID = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PremiumProductGroupID, key) : _o.PremiumProductGroupID;
		var _DiscountPremiumProductGroupID = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DiscountPremiumProductGroupID, key) : _o.DiscountPremiumProductGroupID;
		var _NextLvNeedExp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.NextLvNeedExp, key) : _o.NextLvNeedExp;
		var _PassLvUpGoodsID = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PassLvUpGoodsID, key) : _o.PassLvUpGoodsID;
		var _BuyPremiumLvUpAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.BuyPremiumLvUpAmount, key) : _o.BuyPremiumLvUpAmount;
    ...
    if (_o.VideoId != null) {
      ...
      _VideoId = CreateVideoIdVector(builder, __VideoId);
		...
		var _FlavorTextGroupID = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.FlavorTextGroupID, key) : _o.FlavorTextGroupID;
		var _ExclusiveRewardID = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ExclusiveRewardID, key) : _o.ExclusiveRewardID;
		var _ExclusiveEmblemID = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ExclusiveEmblemID, key) : _o.ExclusiveEmblemID;
		var _PassExpLocalizeEtcId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PassExpLocalizeEtcId, key) : _o.PassExpLocalizeEtcId;
    var _LobbyBannerPath = _o.LobbyBannerPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.LobbyBannerPath, key) : _o.LobbyBannerPath));
    ...
    var _PurchaseStepProductImagePath = _o.PurchaseStepProductImagePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.PurchaseStepProductImagePath, key) : _o.PurchaseStepProductImagePath));
    var _PurchaseStepBgImagePath = _o.PurchaseStepBgImagePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.PurchaseStepBgImagePath, key) : _o.PurchaseStepBgImagePath));
