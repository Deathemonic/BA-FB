...
public struct BattlePassInfoExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.BattlePassInfoExcel> Pack(FlatBufferBuilder builder, BattlePassInfoExcelT _o) {
    ...
    var _PurchaseStepBgImagePath = _o.PurchaseStepBgImagePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.PurchaseStepBgImagePath, key) : _o.PurchaseStepBgImagePath));
