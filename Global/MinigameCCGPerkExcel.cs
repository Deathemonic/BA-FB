...
public struct MinigameCCGPerkExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.MinigameCCGPerkExcel> CreateMinigameCCGPerkExcel(FlatBufferBuilder builder,
      long Id = 0,
      long CCGId = 0,
  ...
  public static Offset<Global.MinigameCCGPerkExcel> EndMinigameCCGPerkExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.MinigameCCGPerkExcel>(o);
  }
  ...
  public static Offset<Global.MinigameCCGPerkExcel> Pack(FlatBufferBuilder builder, MinigameCCGPerkExcelT _o) {
    if (_o == null) return default(Offset<Global.MinigameCCGPerkExcel>);
		byte[] key = TableEncryptionService.CreateKey("MinigameCCGPerk");
		...
		var _RerollPoint = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RerollPoint, key) : _o.RerollPoint;
		var _DiscardPoint = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DiscardPoint, key) : _o.DiscardPoint;
    var _EnvironmentLogicEffectId = default(VectorOffset);
    if (_o.EnvironmentLogicEffectId != null) {
      var __EnvironmentLogicEffectId = _o.EnvironmentLogicEffectId.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.RequiredPerkId != null) {
      var __RequiredPerkId = _o.RequiredPerkId.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
      _RequiredPerkId = CreateRequiredPerkIdVector(builder, __RequiredPerkId);
    }
		var _ShopOrder = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ShopOrder, key) : _o.ShopOrder;
    var _ShopIcon = _o.ShopIcon == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ShopIcon, key) : _o.ShopIcon));
		var _ShopLocalizeTitle = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ShopLocalizeTitle, key) : _o.ShopLocalizeTitle;
		var _ShopLocalizeDesc = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ShopLocalizeDesc, key) : _o.ShopLocalizeDesc;
