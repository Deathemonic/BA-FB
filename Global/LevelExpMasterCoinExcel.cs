...
public struct LevelExpMasterCoinExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.LevelExpMasterCoinExcel> CreateLevelExpMasterCoinExcel(FlatBufferBuilder builder,
      long Id = 0,
      int MinLevel = 0,
      int MaxLevel = 0,
      int Ratio = 0) {
  ...
  public static Offset<Global.LevelExpMasterCoinExcel> EndLevelExpMasterCoinExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.LevelExpMasterCoinExcel>(o);
  }
  ...
  public static Offset<Global.LevelExpMasterCoinExcel> Pack(FlatBufferBuilder builder, LevelExpMasterCoinExcelT _o) {
    if (_o == null) return default(Offset<Global.LevelExpMasterCoinExcel>);
		byte[] key = TableEncryptionService.CreateKey("LevelExpMasterCoin");
		var _Id = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Id, key) : _o.Id;
		var _MinLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MinLevel, key) : _o.MinLevel;
