...
public struct FieldSceneExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.FieldSceneExcel> CreateFieldSceneExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      long DateId = 0,
      long GroupId = 0,
  ...
  public static Offset<Global.FieldSceneExcel> EndFieldSceneExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.FieldSceneExcel>(o);
  }
  ...
  public static Offset<Global.FieldSceneExcel> Pack(FlatBufferBuilder builder, FieldSceneExcelT _o) {
    if (_o == null) return default(Offset<Global.FieldSceneExcel>);
		byte[] key = TableEncryptionService.CreateKey("FieldScene");
