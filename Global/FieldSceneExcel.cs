...
public struct FieldSceneExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(FieldSceneExcelT _o) {
    ...
    _o.DateId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.DateId, key) : this.DateId;
    ...
    for (var _j = 0; _j < this.ConditionalBGMQuestIdLength; ++_j) {_o.ConditionalBGMQuestId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ConditionalBGMQuestId(_j), key) : this.ConditionalBGMQuestId(_j));}
    _o.BeginConditionalBGMScenarioGroupId = new List<long>();
    for (var _j = 0; _j < this.BeginConditionalBGMScenarioGroupIdLength; ++_j) {_o.BeginConditionalBGMScenarioGroupId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BeginConditionalBGMScenarioGroupId(_j), key) : this.BeginConditionalBGMScenarioGroupId(_j));}
    _o.BeginConditionalBGMInteractionId = new List<long>();
    for (var _j = 0; _j < this.BeginConditionalBGMInteractionIdLength; ++_j) {_o.BeginConditionalBGMInteractionId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BeginConditionalBGMInteractionId(_j), key) : this.BeginConditionalBGMInteractionId(_j));}
    _o.EndConditionalBGMScenarioGroupId = new List<long>();
    for (var _j = 0; _j < this.EndConditionalBGMScenarioGroupIdLength; ++_j) {_o.EndConditionalBGMScenarioGroupId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EndConditionalBGMScenarioGroupId(_j), key) : this.EndConditionalBGMScenarioGroupId(_j));}
    _o.EndConditionalBGMInteractionId = new List<long>();
    for (var _j = 0; _j < this.EndConditionalBGMInteractionIdLength; ++_j) {_o.EndConditionalBGMInteractionId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EndConditionalBGMInteractionId(_j), key) : this.EndConditionalBGMInteractionId(_j));}
    _o.ConditionalBGMId = new List<long>();
    for (var _j = 0; _j < this.ConditionalBGMIdLength; ++_j) {_o.ConditionalBGMId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ConditionalBGMId(_j), key) : this.ConditionalBGMId(_j));}
  }
  public static Offset<Global.FieldSceneExcel> Pack(FlatBufferBuilder builder, FieldSceneExcelT _o) {
    if (_o == null) return default(Offset<Global.FieldSceneExcel>);
		...
		var _DateId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DateId, key) : _o.DateId;
    ...
    if (_o.BeginConditionalBGMInteractionId != null) {
      var __BeginConditionalBGMInteractionId = _o.BeginConditionalBGMInteractionId.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
