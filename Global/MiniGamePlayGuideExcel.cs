...
public struct MiniGamePlayGuideExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.MiniGamePlayGuideExcel> CreateMiniGamePlayGuideExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Global.MiniGamePlayGuideExcel> EndMiniGamePlayGuideExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.MiniGamePlayGuideExcel>(o);
  }
  ...
  public static Offset<Global.MiniGamePlayGuideExcel> Pack(FlatBufferBuilder builder, MiniGamePlayGuideExcelT _o) {
    if (_o == null) return default(Offset<Global.MiniGamePlayGuideExcel>);
		byte[] key = TableEncryptionService.CreateKey("MiniGamePlayGuide");
    ...
    var _GuideTitle = _o.GuideTitle == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.GuideTitle, key) : _o.GuideTitle));
    var _GuideImagePath = _o.GuideImagePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.GuideImagePath, key) : _o.GuideImagePath));
    var _GuideText = _o.GuideText == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.GuideText, key) : _o.GuideText));
