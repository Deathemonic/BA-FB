...
public struct ConstEventCommonExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ConstEventCommonExcelT _o) {
    ...
    _o.EventContentHardStageCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EventContentHardStageCount, key) : this.EventContentHardStageCount;
    _o.EventStrategyPlayTimeLimitInSeconds = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EventStrategyPlayTimeLimitInSeconds, key) : this.EventStrategyPlayTimeLimitInSeconds;
    _o.SubEventChangeLimitSeconds = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SubEventChangeLimitSeconds, key) : this.SubEventChangeLimitSeconds;
    _o.SubEventInstantClear = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SubEventInstantClear, key) : this.SubEventInstantClear;
    _o.CardShopProbWeightCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CardShopProbWeightCount, key) : this.CardShopProbWeightCount;
    _o.CardShopProbWeightRarity = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CardShopProbWeightRarity, key) : this.CardShopProbWeightRarity;
    ...
    _o.SpecialOperactionCollectionGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SpecialOperactionCollectionGroupId, key) : this.SpecialOperactionCollectionGroupId;
    _o.TreasureNormalVariationAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.TreasureNormalVariationAmount, key) : this.TreasureNormalVariationAmount;
    _o.TreasureLoopVariationAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.TreasureLoopVariationAmount, key) : this.TreasureLoopVariationAmount;
    _o.TreasureLimitVariationLoopCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.TreasureLimitVariationLoopCount, key) : this.TreasureLimitVariationLoopCount;
    _o.TreasureLimitVariationClearLoopCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.TreasureLimitVariationClearLoopCount, key) : this.TreasureLimitVariationClearLoopCount;
    _o.EventStoryReplayHideEventContentId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EventStoryReplayHideEventContentId, key) : this.EventStoryReplayHideEventContentId;
  }
  public static Offset<Global.ConstEventCommonExcel> Pack(FlatBufferBuilder builder, ConstEventCommonExcelT _o) {
    if (_o == null) return default(Offset<Global.ConstEventCommonExcel>);
		byte[] key = TableEncryptionService.CreateKey("ConstEventCommon");
		var _EventContentHardStageCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EventContentHardStageCount, key) : _o.EventContentHardStageCount;
		var _EventStrategyPlayTimeLimitInSeconds = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EventStrategyPlayTimeLimitInSeconds, key) : _o.EventStrategyPlayTimeLimitInSeconds;
		var _SubEventChangeLimitSeconds = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.SubEventChangeLimitSeconds, key) : _o.SubEventChangeLimitSeconds;
		var _SubEventInstantClear = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.SubEventInstantClear, key) : _o.SubEventInstantClear;
		var _CardShopProbWeightCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CardShopProbWeightCount, key) : _o.CardShopProbWeightCount;
		var _CardShopProbWeightRarity = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CardShopProbWeightRarity, key) : _o.CardShopProbWeightRarity;
    var _MeetupScenarioReplayResource = _o.MeetupScenarioReplayResource == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.MeetupScenarioReplayResource, key) : _o.MeetupScenarioReplayResource));
    var _MeetupScenarioReplayTitleLocalize = _o.MeetupScenarioReplayTitleLocalize == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.MeetupScenarioReplayTitleLocalize, key) : _o.MeetupScenarioReplayTitleLocalize));
		var _SpecialOperactionCollectionGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.SpecialOperactionCollectionGroupId, key) : _o.SpecialOperactionCollectionGroupId;
		var _TreasureNormalVariationAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.TreasureNormalVariationAmount, key) : _o.TreasureNormalVariationAmount;
		var _TreasureLoopVariationAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.TreasureLoopVariationAmount, key) : _o.TreasureLoopVariationAmount;
		var _TreasureLimitVariationLoopCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.TreasureLimitVariationLoopCount, key) : _o.TreasureLimitVariationLoopCount;
		var _TreasureLimitVariationClearLoopCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.TreasureLimitVariationClearLoopCount, key) : _o.TreasureLimitVariationClearLoopCount;
		var _EventStoryReplayHideEventContentId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EventStoryReplayHideEventContentId, key) : _o.EventStoryReplayHideEventContentId;
