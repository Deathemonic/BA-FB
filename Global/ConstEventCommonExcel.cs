...
public struct ConstEventCommonExcel : IFlatbufferObject
{
  ...
  public Global.Rarity CardShopProbWeightRarity { get { int o = __p.__offset(14); return o != 0 ? (Global.Rarity)__p.bb.GetInt(o + __p.bb_pos) : Global.Rarity.N; } }
  ...
  public static Offset<Global.ConstEventCommonExcel> CreateConstEventCommonExcel(FlatBufferBuilder builder,
      ...
      Global.Rarity CardShopProbWeightRarity = Global.Rarity.N,
  ...
  public static void AddCardShopProbWeightRarity(FlatBufferBuilder builder, Global.Rarity cardShopProbWeightRarity) { builder.AddInt(5, (int)cardShopProbWeightRarity, 0); }
  ...
  public static Offset<Global.ConstEventCommonExcel> EndConstEventCommonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.ConstEventCommonExcel>(o);
  }
  ...
  public void UnPackTo(ConstEventCommonExcelT _o) {
    ...
    _o.EventContentHardStageCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.EventContentHardStageCount, key) : this.EventContentHardStageCount;
    _o.EventStrategyPlayTimeLimitInSeconds = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.EventStrategyPlayTimeLimitInSeconds, key) : this.EventStrategyPlayTimeLimitInSeconds;
    _o.SubEventChangeLimitSeconds = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.SubEventChangeLimitSeconds, key) : this.SubEventChangeLimitSeconds;
    _o.SubEventInstantClear = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.SubEventInstantClear, key) : this.SubEventInstantClear;
    _o.CardShopProbWeightCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.CardShopProbWeightCount, key) : this.CardShopProbWeightCount;
    _o.CardShopProbWeightRarity = TableEncryptionService.UseEncryption ? (Global.Rarity)TableEncryptionService.Convert((int)this.CardShopProbWeightRarity, key) : this.CardShopProbWeightRarity;
    _o.MeetupScenarioReplayResource = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MeetupScenarioReplayResource, key) : this.MeetupScenarioReplayResource;
    _o.MeetupScenarioReplayTitleLocalize = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MeetupScenarioReplayTitleLocalize, key) : this.MeetupScenarioReplayTitleLocalize;
    _o.SpecialOperactionCollectionGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.SpecialOperactionCollectionGroupId, key) : this.SpecialOperactionCollectionGroupId;
    _o.TreasureNormalVariationAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.TreasureNormalVariationAmount, key) : this.TreasureNormalVariationAmount;
    _o.TreasureLoopVariationAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.TreasureLoopVariationAmount, key) : this.TreasureLoopVariationAmount;
    _o.TreasureLimitVariationLoopCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.TreasureLimitVariationLoopCount, key) : this.TreasureLimitVariationLoopCount;
    _o.TreasureLimitVariationClearLoopCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.TreasureLimitVariationClearLoopCount, key) : this.TreasureLimitVariationClearLoopCount;
    _o.EventStoryReplayHideEventContentId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.EventStoryReplayHideEventContentId, key) : this.EventStoryReplayHideEventContentId;
  }
  public static Offset<Global.ConstEventCommonExcel> Pack(FlatBufferBuilder builder, ConstEventCommonExcelT _o) {
    if (_o == null) return default(Offset<Global.ConstEventCommonExcel>);
		byte[] key = TableEncryptionService.CreateKey("ConstEventCommon");
		var _EventContentHardStageCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.EventContentHardStageCount, key) : _o.EventContentHardStageCount;
		var _EventStrategyPlayTimeLimitInSeconds = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.EventStrategyPlayTimeLimitInSeconds, key) : _o.EventStrategyPlayTimeLimitInSeconds;
		var _SubEventChangeLimitSeconds = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.SubEventChangeLimitSeconds, key) : _o.SubEventChangeLimitSeconds;
		var _SubEventInstantClear = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.SubEventInstantClear, key) : _o.SubEventInstantClear;
		var _CardShopProbWeightCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.CardShopProbWeightCount, key) : _o.CardShopProbWeightCount;
		var _CardShopProbWeightRarity = TableEncryptionService.UseEncryption ? (Global.Rarity)TableEncryptionService.Convert((int)_o.CardShopProbWeightRarity, key) : _o.CardShopProbWeightRarity;
    var _MeetupScenarioReplayResource = _o.MeetupScenarioReplayResource == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.MeetupScenarioReplayResource, key) : _o.MeetupScenarioReplayResource));
    var _MeetupScenarioReplayTitleLocalize = _o.MeetupScenarioReplayTitleLocalize == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.MeetupScenarioReplayTitleLocalize, key) : _o.MeetupScenarioReplayTitleLocalize));
		var _SpecialOperactionCollectionGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.SpecialOperactionCollectionGroupId, key) : _o.SpecialOperactionCollectionGroupId;
		var _TreasureNormalVariationAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.TreasureNormalVariationAmount, key) : _o.TreasureNormalVariationAmount;
		var _TreasureLoopVariationAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.TreasureLoopVariationAmount, key) : _o.TreasureLoopVariationAmount;
		var _TreasureLimitVariationLoopCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.TreasureLimitVariationLoopCount, key) : _o.TreasureLimitVariationLoopCount;
		var _TreasureLimitVariationClearLoopCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.TreasureLimitVariationClearLoopCount, key) : _o.TreasureLimitVariationClearLoopCount;
		var _EventStoryReplayHideEventContentId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.EventStoryReplayHideEventContentId, key) : _o.EventStoryReplayHideEventContentId;
    return CreateConstEventCommonExcel(
      builder,
      TableEncryptionService.UseEncryption ? _EventContentHardStageCount : _o.EventContentHardStageCount,
      TableEncryptionService.UseEncryption ? _EventStrategyPlayTimeLimitInSeconds : _o.EventStrategyPlayTimeLimitInSeconds,
      TableEncryptionService.UseEncryption ? _SubEventChangeLimitSeconds : _o.SubEventChangeLimitSeconds,
      TableEncryptionService.UseEncryption ? _SubEventInstantClear : _o.SubEventInstantClear,
      TableEncryptionService.UseEncryption ? _CardShopProbWeightCount : _o.CardShopProbWeightCount,
      TableEncryptionService.UseEncryption ? _CardShopProbWeightRarity : _o.CardShopProbWeightRarity,
      _MeetupScenarioReplayResource,
      _MeetupScenarioReplayTitleLocalize,
      TableEncryptionService.UseEncryption ? _SpecialOperactionCollectionGroupId : _o.SpecialOperactionCollectionGroupId,
      TableEncryptionService.UseEncryption ? _TreasureNormalVariationAmount : _o.TreasureNormalVariationAmount,
      TableEncryptionService.UseEncryption ? _TreasureLoopVariationAmount : _o.TreasureLoopVariationAmount,
      TableEncryptionService.UseEncryption ? _TreasureLimitVariationLoopCount : _o.TreasureLimitVariationLoopCount,
      TableEncryptionService.UseEncryption ? _TreasureLimitVariationClearLoopCount : _o.TreasureLimitVariationClearLoopCount,
      TableEncryptionService.UseEncryption ? _EventStoryReplayHideEventContentId : _o.EventStoryReplayHideEventContentId);
  }
}
...
public class ConstEventCommonExcelT
{
  ...
  public Global.Rarity CardShopProbWeightRarity { get; set; }
  ...
  public ConstEventCommonExcelT() {
    ...
    this.CardShopProbWeightRarity = Global.Rarity.N;
...
static public class ConstEventCommonExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 14 /*CardShopProbWeightRarity*/, 4 /*Global.Rarity*/, 4, false)
