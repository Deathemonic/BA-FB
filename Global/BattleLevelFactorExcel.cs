...
public struct BattleLevelFactorExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.BattleLevelFactorExcel> CreateBattleLevelFactorExcel(FlatBufferBuilder builder,
      int LevelDiff = 0,
      long DamageRate = 0) {
  ...
  public static Offset<Global.BattleLevelFactorExcel> EndBattleLevelFactorExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.BattleLevelFactorExcel>(o);
  }
  ...
  public static Offset<Global.BattleLevelFactorExcel> Pack(FlatBufferBuilder builder, BattleLevelFactorExcelT _o) {
    if (_o == null) return default(Offset<Global.BattleLevelFactorExcel>);
		byte[] key = TableEncryptionService.CreateKey("BattleLevelFactor");
