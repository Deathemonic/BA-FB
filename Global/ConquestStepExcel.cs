...
public struct ConquestStepExcel : IFlatbufferObject
{
  ...
  public Global.StageDifficulty MapDifficulty { get { int o = __p.__offset(6); return o != 0 ? (Global.StageDifficulty)__p.bb.GetInt(o + __p.bb_pos) : Global.StageDifficulty.None; } }
  ...
  public Global.ParcelType StepEnterItemType { get { int o = __p.__offset(14); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Global.ParcelType.None; } }
  ...
  public static Offset<Global.ConquestStepExcel> CreateConquestStepExcel(FlatBufferBuilder builder,
  ...
  public static void AddMapDifficulty(FlatBufferBuilder builder, Global.StageDifficulty mapDifficulty) { builder.AddInt(1, (int)mapDifficulty, 0); }
  ...
  public static void AddStepEnterItemType(FlatBufferBuilder builder, Global.ParcelType stepEnterItemType) { builder.AddInt(5, (int)stepEnterItemType, 0); }
  ...
  public static Offset<Global.ConquestStepExcel> EndConquestStepExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.ConquestStepExcel>(o);
  }
  ...
  public void UnPackTo(ConquestStepExcelT _o) {
    ...
    _o.StepEnterItemType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)this.StepEnterItemType, key) : this.StepEnterItemType;
    _o.StepEnterItemUniqueId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.StepEnterItemUniqueId, key) : this.StepEnterItemUniqueId;
    _o.StepEnterItemAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.StepEnterItemAmount, key) : this.StepEnterItemAmount;
    _o.UnexpectedEventUnitId = new List<long>();
    for (var _j = 0; _j < this.UnexpectedEventUnitIdLength; ++_j) {_o.UnexpectedEventUnitId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.UnexpectedEventUnitId(_j), key) : this.UnexpectedEventUnitId(_j));}
    _o.UnexpectedEventPrefab = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.UnexpectedEventPrefab, key) : this.UnexpectedEventPrefab;
    _o.TreasureBoxObjectId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.TreasureBoxObjectId, key) : this.TreasureBoxObjectId;
    _o.TreasureBoxCountPerStepOpen = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.TreasureBoxCountPerStepOpen, key) : this.TreasureBoxCountPerStepOpen;
  }
  public static Offset<Global.ConquestStepExcel> Pack(FlatBufferBuilder builder, ConquestStepExcelT _o) {
    if (_o == null) return default(Offset<Global.ConquestStepExcel>);
		byte[] key = TableEncryptionService.CreateKey("ConquestStep");
    ...
    var _StepGoalLocalize = _o.StepGoalLocalize == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.StepGoalLocalize, key) : _o.StepGoalLocalize));
		...
		var _StepEnterItemType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)_o.StepEnterItemType, key) : _o.StepEnterItemType;
		var _StepEnterItemUniqueId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.StepEnterItemUniqueId, key) : _o.StepEnterItemUniqueId;
		var _StepEnterItemAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.StepEnterItemAmount, key) : _o.StepEnterItemAmount;
    var _unexpectedEventUnitId = default(VectorOffset);
    if (_o.UnexpectedEventUnitId != null) {
      var __unexpectedEventUnitId = _o.UnexpectedEventUnitId.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
      _unexpectedEventUnitId = CreateUnexpectedEventUnitIdVector(builder, __unexpectedEventUnitId);
    }
    var _UnexpectedEventPrefab = _o.UnexpectedEventPrefab == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.UnexpectedEventPrefab, key) : _o.UnexpectedEventPrefab));
		var _TreasureBoxObjectId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.TreasureBoxObjectId, key) : _o.TreasureBoxObjectId;
		var _TreasureBoxCountPerStepOpen = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.TreasureBoxCountPerStepOpen, key) : _o.TreasureBoxCountPerStepOpen;
...
public class ConquestStepExcelT
{
  ...
  public Global.ParcelType StepEnterItemType { get; set; }
  ...
  public ConquestStepExcelT() {
    ...
    this.StepEnterItemType = Global.ParcelType.None;
...
static public class ConquestStepExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*MapDifficulty*/, 4 /*Global.StageDifficulty*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 14 /*StepEnterItemType*/, 4 /*Global.ParcelType*/, 4, false)
