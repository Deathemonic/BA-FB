...
public struct ConquestStepExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ConquestStepExcelT _o) {
    ...
    _o.StepEnterItemType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StepEnterItemType, key) : this.StepEnterItemType;
    _o.StepEnterItemUniqueId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StepEnterItemUniqueId, key) : this.StepEnterItemUniqueId;
    _o.StepEnterItemAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StepEnterItemAmount, key) : this.StepEnterItemAmount;
    _o.UnexpectedEventUnitId = new List<long>();
    for (var _j = 0; _j < this.UnexpectedEventUnitIdLength; ++_j) {_o.UnexpectedEventUnitId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.UnexpectedEventUnitId(_j), key) : this.UnexpectedEventUnitId(_j));}
    ...
    _o.TreasureBoxObjectId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.TreasureBoxObjectId, key) : this.TreasureBoxObjectId;
    _o.TreasureBoxCountPerStepOpen = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.TreasureBoxCountPerStepOpen, key) : this.TreasureBoxCountPerStepOpen;
  }
  public static Offset<Global.ConquestStepExcel> Pack(FlatBufferBuilder builder, ConquestStepExcelT _o) {
    ...
    var _UnexpectedEventPrefab = _o.UnexpectedEventPrefab == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.UnexpectedEventPrefab, key) : _o.UnexpectedEventPrefab));
		...
		var _TreasureBoxCountPerStepOpen = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.TreasureBoxCountPerStepOpen, key) : _o.TreasureBoxCountPerStepOpen;
