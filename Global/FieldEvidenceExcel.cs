...
public struct FieldEvidenceExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.FieldEvidenceExcel> CreateFieldEvidenceExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      long SeasonId = 0,
  ...
  public static Offset<Global.FieldEvidenceExcel> EndFieldEvidenceExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.FieldEvidenceExcel>(o);
  }
  ...
  public void UnPackTo(FieldEvidenceExcelT _o) {
    ...
    _o.DetailLocalizeKey = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.DetailLocalizeKey, key) : this.DetailLocalizeKey;
    _o.ImagePath = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ImagePath, key) : this.ImagePath;
  }
  public static Offset<Global.FieldEvidenceExcel> Pack(FlatBufferBuilder builder, FieldEvidenceExcelT _o) {
    if (_o == null) return default(Offset<Global.FieldEvidenceExcel>);
		byte[] key = TableEncryptionService.CreateKey("FieldEvidence");
    ...
    var _NameLocalizeKey = _o.NameLocalizeKey == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.NameLocalizeKey, key) : _o.NameLocalizeKey));
    var _DescriptionLocalizeKey = _o.DescriptionLocalizeKey == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.DescriptionLocalizeKey, key) : _o.DescriptionLocalizeKey));
    var _DetailLocalizeKey = _o.DetailLocalizeKey == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.DetailLocalizeKey, key) : _o.DetailLocalizeKey));
