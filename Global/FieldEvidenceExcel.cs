...
public struct FieldEvidenceExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.FieldEvidenceExcel> Pack(FlatBufferBuilder builder, FieldEvidenceExcelT _o) {
    ...
    var _DetailLocalizeKey = _o.DetailLocalizeKey == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.DetailLocalizeKey, key) : _o.DetailLocalizeKey));
