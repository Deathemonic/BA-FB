...
public struct TranscendenceRecipeExcel : IFlatbufferObject
{
  ...
  public Global.CurrencyTypes CostCurrencyType { get { int o = __p.__offset(8); return o != 0 ? (Global.CurrencyTypes)__p.bb.GetInt(o + __p.bb_pos) : Global.CurrencyTypes.Invalid; } }
  public long CostCurrencyAmount { get { int o = __p.__offset(10); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public Global.ParcelType ParcelType(int j) { int o = __p.__offset(12); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Global.ParcelType)0; }
  public int ParcelTypeLength { get { int o = __p.__offset(12); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Global.ParcelType> GetParcelTypeBytes() { return __p.__vector_as_span<Global.ParcelType>(12, 4); }
#else
  public ArraySegment<byte>? GetParcelTypeBytes() { return __p.__vector_as_arraysegment(12); }
#endif
  public Global.ParcelType[] GetParcelTypeArray() { int o = __p.__offset(12); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Global.ParcelType[] a = new Global.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Global.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Global.TranscendenceRecipeExcel> CreateTranscendenceRecipeExcel(FlatBufferBuilder builder,
      long Id = 0,
      StringOffset DevNameOffset = default(StringOffset),
      Global.CurrencyTypes CostCurrencyType = Global.CurrencyTypes.Invalid,
  ...
  public static void AddCostCurrencyType(FlatBufferBuilder builder, Global.CurrencyTypes costCurrencyType) { builder.AddInt(2, (int)costCurrencyType, 0); }
  ...
  public static Offset<Global.TranscendenceRecipeExcel> EndTranscendenceRecipeExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.TranscendenceRecipeExcel>(o);
  }
  ...
  public void UnPackTo(TranscendenceRecipeExcelT _o) {
    ...
    _o.CostCurrencyType = TableEncryptionService.UseEncryption ? (Global.CurrencyTypes)TableEncryptionService.Convert((int)this.CostCurrencyType, key) : this.CostCurrencyType;
  ...
  public static Offset<Global.TranscendenceRecipeExcel> Pack(FlatBufferBuilder builder, TranscendenceRecipeExcelT _o) {
    if (_o == null) return default(Offset<Global.TranscendenceRecipeExcel>);
		byte[] key = TableEncryptionService.CreateKey("TranscendenceRecipe");
    ...
    var _DevName = _o.DevName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.DevName, key) : _o.DevName));
		var _CostCurrencyType = TableEncryptionService.UseEncryption ? (Global.CurrencyTypes)TableEncryptionService.Convert((int)_o.CostCurrencyType, key) : _o.CostCurrencyType;
...
public class TranscendenceRecipeExcelT
{
  ...
  public Global.CurrencyTypes CostCurrencyType { get; set; }
  ...
  public TranscendenceRecipeExcelT() {
    this.Id = 0;
    this.DevName = null;
    this.CostCurrencyType = Global.CurrencyTypes.Invalid;
...
static public class TranscendenceRecipeExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*CostCurrencyType*/, 4 /*Global.CurrencyTypes*/, 4, false)
      && verifier.VerifyField(tablePos, 10 /*CostCurrencyAmount*/, 8 /*long*/, 8, false)
      && verifier.VerifyVectorOfData(tablePos, 12 /*ParcelType*/, 4 /*Global.ParcelType*/, false)
