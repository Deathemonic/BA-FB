...
public struct CharacterDialogEmojiExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.CharacterDialogEmojiExcel> Pack(FlatBufferBuilder builder, CharacterDialogEmojiExcelT _o) {
    ...
    var _DialogType = _o.DialogType == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.DialogType, key) : _o.DialogType));
