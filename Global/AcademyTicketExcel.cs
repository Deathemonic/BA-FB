...
public struct AcademyTicketExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.AcademyTicketExcel> CreateAcademyTicketExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.AcademyTicketExcel> EndAcademyTicketExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.AcademyTicketExcel>(o);
  }
  ...
  public void UnPackTo(AcademyTicketExcelT _o) {
    ...
    _o.LocationRankSum = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.LocationRankSum, key) : this.LocationRankSum;
    _o.ScheduleTicktetMax = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ScheduleTicktetMax, key) : this.ScheduleTicktetMax;
  }
  public static Offset<Global.AcademyTicketExcel> Pack(FlatBufferBuilder builder, AcademyTicketExcelT _o) {
    if (_o == null) return default(Offset<Global.AcademyTicketExcel>);
		byte[] key = TableEncryptionService.CreateKey("AcademyTicket");
		var _LocationRankSum = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.LocationRankSum, key) : _o.LocationRankSum;
		var _ScheduleTicktetMax = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ScheduleTicktetMax, key) : _o.ScheduleTicktetMax;
