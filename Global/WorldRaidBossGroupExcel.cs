...
public struct WorldRaidBossGroupExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.WorldRaidBossGroupExcel> CreateWorldRaidBossGroupExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Global.WorldRaidBossGroupExcel> EndWorldRaidBossGroupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.WorldRaidBossGroupExcel>(o);
  }
  ...
  public void UnPackTo(WorldRaidBossGroupExcelT _o) {
    ...
    _o.WorldBossName = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.WorldBossName, key) : this.WorldBossName;
    _o.WorldBossPopupPortrait = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.WorldBossPopupPortrait, key) : this.WorldBossPopupPortrait;
    _o.WorldBossPopupBG = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.WorldBossPopupBG, key) : this.WorldBossPopupBG;
    _o.WorldBossParcelPortrait = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.WorldBossParcelPortrait, key) : this.WorldBossParcelPortrait;
    _o.WorldBossListParcel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.WorldBossListParcel, key) : this.WorldBossListParcel;
    _o.WorldBossHP = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.WorldBossHP, key) : this.WorldBossHP;
    _o.WorldBossHPTw = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.WorldBossHPTw, key) : this.WorldBossHPTw;
    _o.WorldBossHPAsia = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.WorldBossHPAsia, key) : this.WorldBossHPAsia;
    _o.WorldBossHPNa = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.WorldBossHPNa, key) : this.WorldBossHPNa;
    _o.WorldBossHPGlobal = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.WorldBossHPGlobal, key) : this.WorldBossHPGlobal;
    _o.UIHideBeforeSpawn = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.UIHideBeforeSpawn, key) : this.UIHideBeforeSpawn;
    _o.HideAnotherBossKilled = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.HideAnotherBossKilled, key) : this.HideAnotherBossKilled;
    _o.WorldBossClearRewardGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.WorldBossClearRewardGroupId, key) : this.WorldBossClearRewardGroupId;
    _o.AnotherBossKilled = new List<long>();
    for (var _j = 0; _j < this.AnotherBossKilledLength; ++_j) {_o.AnotherBossKilled.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.AnotherBossKilled(_j), key) : this.AnotherBossKilled(_j));}
    _o.EchelonConstraintGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.EchelonConstraintGroupId, key) : this.EchelonConstraintGroupId;
    _o.ExclusiveOperatorBossSpawn = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ExclusiveOperatorBossSpawn, key) : this.ExclusiveOperatorBossSpawn;
    _o.ExclusiveOperatorBossKill = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ExclusiveOperatorBossKill, key) : this.ExclusiveOperatorBossKill;
    _o.ExclusiveOperatorScenarioBattle = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ExclusiveOperatorScenarioBattle, key) : this.ExclusiveOperatorScenarioBattle;
    _o.ExclusiveOperatorBossDamaged = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ExclusiveOperatorBossDamaged, key) : this.ExclusiveOperatorBossDamaged;
    _o.BossGroupOpenCondition = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.BossGroupOpenCondition, key) : this.BossGroupOpenCondition;
  }
  public static Offset<Global.WorldRaidBossGroupExcel> Pack(FlatBufferBuilder builder, WorldRaidBossGroupExcelT _o) {
    if (_o == null) return default(Offset<Global.WorldRaidBossGroupExcel>);
		byte[] key = TableEncryptionService.CreateKey("WorldRaidBossGroup");
    ...
    var _WorldBossName = _o.WorldBossName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.WorldBossName, key) : _o.WorldBossName));
    var _WorldBossPopupPortrait = _o.WorldBossPopupPortrait == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.WorldBossPopupPortrait, key) : _o.WorldBossPopupPortrait));
    var _WorldBossPopupBG = _o.WorldBossPopupBG == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.WorldBossPopupBG, key) : _o.WorldBossPopupBG));
    var _WorldBossParcelPortrait = _o.WorldBossParcelPortrait == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.WorldBossParcelPortrait, key) : _o.WorldBossParcelPortrait));
    var _WorldBossListParcel = _o.WorldBossListParcel == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.WorldBossListParcel, key) : _o.WorldBossListParcel));
		var _WorldBossHP = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.WorldBossHP, key) : _o.WorldBossHP;
		var _WorldBossHPTw = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.WorldBossHPTw, key) : _o.WorldBossHPTw;
		var _WorldBossHPAsia = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.WorldBossHPAsia, key) : _o.WorldBossHPAsia;
		var _WorldBossHPNa = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.WorldBossHPNa, key) : _o.WorldBossHPNa;
		var _WorldBossHPGlobal = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.WorldBossHPGlobal, key) : _o.WorldBossHPGlobal;
		var _UIHideBeforeSpawn = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.UIHideBeforeSpawn, key) : _o.UIHideBeforeSpawn;
		var _HideAnotherBossKilled = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.HideAnotherBossKilled, key) : _o.HideAnotherBossKilled;
		var _WorldBossClearRewardGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.WorldBossClearRewardGroupId, key) : _o.WorldBossClearRewardGroupId;
    var _AnotherBossKilled = default(VectorOffset);
    if (_o.AnotherBossKilled != null) {
      var __AnotherBossKilled = _o.AnotherBossKilled.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
      _AnotherBossKilled = CreateAnotherBossKilledVector(builder, __AnotherBossKilled);
    }
		var _EchelonConstraintGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.EchelonConstraintGroupId, key) : _o.EchelonConstraintGroupId;
    var _ExclusiveOperatorBossSpawn = _o.ExclusiveOperatorBossSpawn == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.ExclusiveOperatorBossSpawn, key) : _o.ExclusiveOperatorBossSpawn));
    var _ExclusiveOperatorBossKill = _o.ExclusiveOperatorBossKill == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.ExclusiveOperatorBossKill, key) : _o.ExclusiveOperatorBossKill));
    var _ExclusiveOperatorScenarioBattle = _o.ExclusiveOperatorScenarioBattle == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.ExclusiveOperatorScenarioBattle, key) : _o.ExclusiveOperatorScenarioBattle));
    var _ExclusiveOperatorBossDamaged = _o.ExclusiveOperatorBossDamaged == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.ExclusiveOperatorBossDamaged, key) : _o.ExclusiveOperatorBossDamaged));
		var _BossGroupOpenCondition = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.BossGroupOpenCondition, key) : _o.BossGroupOpenCondition;
    return CreateWorldRaidBossGroupExcel(
      ...
      TableEncryptionService.UseEncryption ? _WorldBossHP : _o.WorldBossHP,
      TableEncryptionService.UseEncryption ? _WorldBossHPTw : _o.WorldBossHPTw,
      TableEncryptionService.UseEncryption ? _WorldBossHPAsia : _o.WorldBossHPAsia,
      TableEncryptionService.UseEncryption ? _WorldBossHPNa : _o.WorldBossHPNa,
      TableEncryptionService.UseEncryption ? _WorldBossHPGlobal : _o.WorldBossHPGlobal,
      TableEncryptionService.UseEncryption ? _UIHideBeforeSpawn : _o.UIHideBeforeSpawn,
      TableEncryptionService.UseEncryption ? _HideAnotherBossKilled : _o.HideAnotherBossKilled,
      TableEncryptionService.UseEncryption ? _WorldBossClearRewardGroupId : _o.WorldBossClearRewardGroupId,
      _AnotherBossKilled,
      TableEncryptionService.UseEncryption ? _EchelonConstraintGroupId : _o.EchelonConstraintGroupId,
      _ExclusiveOperatorBossSpawn,
      _ExclusiveOperatorBossKill,
      _ExclusiveOperatorScenarioBattle,
      _ExclusiveOperatorBossDamaged,
      TableEncryptionService.UseEncryption ? _BossGroupOpenCondition : _o.BossGroupOpenCondition);
  }
}
...
public class WorldRaidBossGroupExcelT
{
  ...
  public long WorldBossHPTw { get; set; }
  public long WorldBossHPAsia { get; set; }
  public long WorldBossHPNa { get; set; }
  public long WorldBossHPGlobal { get; set; }
  ...
  public WorldRaidBossGroupExcelT() {
    ...
    this.WorldBossHP = 0;
    this.WorldBossHPTw = 0;
    this.WorldBossHPAsia = 0;
    this.WorldBossHPNa = 0;
    this.WorldBossHPGlobal = 0;
...
static public class WorldRaidBossGroupExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 20 /*WorldBossHPTw*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 22 /*WorldBossHPAsia*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 24 /*WorldBossHPNa*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 26 /*WorldBossHPGlobal*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 28 /*UIHideBeforeSpawn*/, 1 /*bool*/, 1, false)
      && verifier.VerifyField(tablePos, 30 /*HideAnotherBossKilled*/, 1 /*bool*/, 1, false)
      && verifier.VerifyField(tablePos, 32 /*WorldBossClearRewardGroupId*/, 8 /*long*/, 8, false)
      && verifier.VerifyVectorOfData(tablePos, 34 /*AnotherBossKilled*/, 8 /*long*/, false)
      && verifier.VerifyField(tablePos, 36 /*EchelonConstraintGroupId*/, 8 /*long*/, 8, false)
      && verifier.VerifyString(tablePos, 38 /*ExclusiveOperatorBossSpawn*/, false)
      && verifier.VerifyString(tablePos, 40 /*ExclusiveOperatorBossKill*/, false)
      && verifier.VerifyString(tablePos, 42 /*ExclusiveOperatorScenarioBattle*/, false)
      && verifier.VerifyString(tablePos, 44 /*ExclusiveOperatorBossDamaged*/, false)
      && verifier.VerifyField(tablePos, 46 /*BossGroupOpenCondition*/, 8 /*long*/, 8, false)
