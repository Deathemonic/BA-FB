...
public struct WorldRaidBossGroupExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(WorldRaidBossGroupExcelT _o) {
    ...
    _o.WorldBossHP = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.WorldBossHP, key) : this.WorldBossHP;
    _o.WorldBossHPTw = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.WorldBossHPTw, key) : this.WorldBossHPTw;
    _o.WorldBossHPAsia = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.WorldBossHPAsia, key) : this.WorldBossHPAsia;
    _o.WorldBossHPNa = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.WorldBossHPNa, key) : this.WorldBossHPNa;
    _o.WorldBossHPGlobal = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.WorldBossHPGlobal, key) : this.WorldBossHPGlobal;
    _o.UIHideBeforeSpawn = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.UIHideBeforeSpawn, key) : this.UIHideBeforeSpawn;
    _o.HideAnotherBossKilled = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.HideAnotherBossKilled, key) : this.HideAnotherBossKilled;
    _o.WorldBossClearRewardGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.WorldBossClearRewardGroupId, key) : this.WorldBossClearRewardGroupId;
    _o.AnotherBossKilled = new List<long>();
    for (var _j = 0; _j < this.AnotherBossKilledLength; ++_j) {_o.AnotherBossKilled.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.AnotherBossKilled(_j), key) : this.AnotherBossKilled(_j));}
    _o.EchelonConstraintGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EchelonConstraintGroupId, key) : this.EchelonConstraintGroupId;
    ...
    _o.BossGroupOpenCondition = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BossGroupOpenCondition, key) : this.BossGroupOpenCondition;
  }
  public static Offset<Global.WorldRaidBossGroupExcel> Pack(FlatBufferBuilder builder, WorldRaidBossGroupExcelT _o) {
    if (_o == null) return default(Offset<Global.WorldRaidBossGroupExcel>);
		...
		var _WorldRaidBossGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.WorldRaidBossGroupId, key) : _o.WorldRaidBossGroupId;
    var _WorldBossName = _o.WorldBossName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.WorldBossName, key) : _o.WorldBossName));
    var _WorldBossPopupPortrait = _o.WorldBossPopupPortrait == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.WorldBossPopupPortrait, key) : _o.WorldBossPopupPortrait));
    var _WorldBossPopupBG = _o.WorldBossPopupBG == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.WorldBossPopupBG, key) : _o.WorldBossPopupBG));
    var _WorldBossParcelPortrait = _o.WorldBossParcelPortrait == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.WorldBossParcelPortrait, key) : _o.WorldBossParcelPortrait));
    var _WorldBossListParcel = _o.WorldBossListParcel == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.WorldBossListParcel, key) : _o.WorldBossListParcel));
		var _WorldBossHP = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.WorldBossHP, key) : _o.WorldBossHP;
		var _WorldBossHPTw = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.WorldBossHPTw, key) : _o.WorldBossHPTw;
		var _WorldBossHPAsia = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.WorldBossHPAsia, key) : _o.WorldBossHPAsia;
		var _WorldBossHPNa = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.WorldBossHPNa, key) : _o.WorldBossHPNa;
		var _WorldBossHPGlobal = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.WorldBossHPGlobal, key) : _o.WorldBossHPGlobal;
		var _UIHideBeforeSpawn = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.UIHideBeforeSpawn, key) : _o.UIHideBeforeSpawn;
		var _HideAnotherBossKilled = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.HideAnotherBossKilled, key) : _o.HideAnotherBossKilled;
		var _WorldBossClearRewardGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.WorldBossClearRewardGroupId, key) : _o.WorldBossClearRewardGroupId;
    var _AnotherBossKilled = default(VectorOffset);
    if (_o.AnotherBossKilled != null) {
      var __AnotherBossKilled = _o.AnotherBossKilled.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
      _AnotherBossKilled = CreateAnotherBossKilledVector(builder, __AnotherBossKilled);
    }
		var _EchelonConstraintGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EchelonConstraintGroupId, key) : _o.EchelonConstraintGroupId;
    var _ExclusiveOperatorBossSpawn = _o.ExclusiveOperatorBossSpawn == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ExclusiveOperatorBossSpawn, key) : _o.ExclusiveOperatorBossSpawn));
    var _ExclusiveOperatorBossKill = _o.ExclusiveOperatorBossKill == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ExclusiveOperatorBossKill, key) : _o.ExclusiveOperatorBossKill));
    var _ExclusiveOperatorScenarioBattle = _o.ExclusiveOperatorScenarioBattle == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ExclusiveOperatorScenarioBattle, key) : _o.ExclusiveOperatorScenarioBattle));
    var _ExclusiveOperatorBossDamaged = _o.ExclusiveOperatorBossDamaged == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ExclusiveOperatorBossDamaged, key) : _o.ExclusiveOperatorBossDamaged));
		var _BossGroupOpenCondition = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.BossGroupOpenCondition, key) : _o.BossGroupOpenCondition;
