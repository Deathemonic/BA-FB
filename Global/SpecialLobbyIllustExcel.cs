...
public struct SpecialLobbyIllustExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.SpecialLobbyIllustExcel> CreateSpecialLobbyIllustExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
  ...
  public static Offset<Global.SpecialLobbyIllustExcel> EndSpecialLobbyIllustExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.SpecialLobbyIllustExcel>(o);
  }
  ...
  public void UnPackTo(SpecialLobbyIllustExcelT _o) {
    ...
    _o.CharacterCostumeUniqueId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CharacterCostumeUniqueId, key) : this.CharacterCostumeUniqueId;
  ...
  public static Offset<Global.SpecialLobbyIllustExcel> Pack(FlatBufferBuilder builder, SpecialLobbyIllustExcelT _o) {
    if (_o == null) return default(Offset<Global.SpecialLobbyIllustExcel>);
		byte[] key = TableEncryptionService.CreateKey("SpecialLobbyIllust");
    ...
    var _DevName = _o.DevName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.DevName, key) : _o.DevName));
		var _CharacterCostumeUniqueId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CharacterCostumeUniqueId, key) : _o.CharacterCostumeUniqueId;
    ...
    return CreateSpecialLobbyIllustExcel(
      ...
      _DevName,
      TableEncryptionService.UseEncryption ? _CharacterCostumeUniqueId : _o.CharacterCostumeUniqueId,
      _PrefabName,
      _SlotTextureName,
      _RewardTextureName);
  }
