...
public struct SpecialLobbyIllustExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(SpecialLobbyIllustExcelT _o) {
    ...
    _o.CharacterCostumeUniqueId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.CharacterCostumeUniqueId, key) : this.CharacterCostumeUniqueId;
  ...
  public static Offset<Global.SpecialLobbyIllustExcel> Pack(FlatBufferBuilder builder, SpecialLobbyIllustExcelT _o) {
    ...
    var _DevName = _o.DevName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.DevName, key) : _o.DevName));
		var _CharacterCostumeUniqueId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.CharacterCostumeUniqueId, key) : _o.CharacterCostumeUniqueId;
