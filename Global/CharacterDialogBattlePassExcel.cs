...
public struct CharacterDialogBattlePassExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(CharacterDialogBattlePassExcelT _o) {
    ...
    _o.DialogConditionDetail = TableEncryptionService.UseEncryption ? (Global.DialogConditionDetail)TableEncryptionService.Convert((int)this.DialogConditionDetail, key) : this.DialogConditionDetail;
    ...
    _o.UnlockBattlePassId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.UnlockBattlePassId, key) : this.UnlockBattlePassId;
  ...
  public static Offset<Global.CharacterDialogBattlePassExcel> Pack(FlatBufferBuilder builder, CharacterDialogBattlePassExcelT _o) {
    if (_o == null) return default(Offset<Global.CharacterDialogBattlePassExcel>);
		...
		var _DialogConditionDetail = TableEncryptionService.UseEncryption ? (Global.DialogConditionDetail)TableEncryptionService.Convert((int)_o.DialogConditionDetail, key) : _o.DialogConditionDetail;
    ...
    if (_o.VoiceId != null) {
      ...
      _VoiceId = CreateVoiceIdVector(builder, __VoiceId);
		...
		var _UnlockBattlePassId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.UnlockBattlePassId, key) : _o.UnlockBattlePassId;
