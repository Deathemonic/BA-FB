...
public struct TrophyCollectionExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.TrophyCollectionExcel> EndTrophyCollectionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.TrophyCollectionExcel>(o);
  }
  ...
  public static Offset<Global.TrophyCollectionExcel> Pack(FlatBufferBuilder builder, TrophyCollectionExcelT _o) {
    if (_o == null) return default(Offset<Global.TrophyCollectionExcel>);
		byte[] key = TableEncryptionService.CreateKey("TrophyCollection");
