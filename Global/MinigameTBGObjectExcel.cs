...
public struct MinigameTBGObjectExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(MinigameTBGObjectExcelT _o) {
    ...
    _o.ObjectType = TableEncryptionService.UseEncryption ? (Global.TBGObjectType)TableEncryptionService.Convert((int)this.ObjectType, key) : this.ObjectType;
    _o.ObjectCostType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)this.ObjectCostType, key) : this.ObjectCostType;
  ...
  public static Offset<Global.MinigameTBGObjectExcel> Pack(FlatBufferBuilder builder, MinigameTBGObjectExcelT _o) {
    ...
    var _PrefabName = _o.PrefabName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.PrefabName, key) : _o.PrefabName));
		var _ObjectType = TableEncryptionService.UseEncryption ? (Global.TBGObjectType)TableEncryptionService.Convert((int)_o.ObjectType, key) : _o.ObjectType;
		var _ObjectCostType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)_o.ObjectCostType, key) : _o.ObjectCostType;
