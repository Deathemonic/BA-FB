...
public struct MinigameTBGObjectExcel : IFlatbufferObject
{
  ...
  public Global.TBGObjectType ObjectType { get { int o = __p.__offset(10); return o != 0 ? (Global.TBGObjectType)__p.bb.GetInt(o + __p.bb_pos) : Global.TBGObjectType.None; } }
  public Global.ParcelType ObjectCostType { get { int o = __p.__offset(12); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Global.ParcelType.None; } }
  ...
  public static Offset<Global.MinigameTBGObjectExcel> CreateMinigameTBGObjectExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      ...
      Global.ParcelType ObjectCostType = Global.ParcelType.None,
      long ObjectCostId = 0,
  ...
  public static void AddObjectType(FlatBufferBuilder builder, Global.TBGObjectType objectType) { builder.AddInt(3, (int)objectType, 0); }
  public static void AddObjectCostType(FlatBufferBuilder builder, Global.ParcelType objectCostType) { builder.AddInt(4, (int)objectCostType, 0); }
  ...
  public static Offset<Global.MinigameTBGObjectExcel> EndMinigameTBGObjectExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.MinigameTBGObjectExcel>(o);
  }
  ...
  public void UnPackTo(MinigameTBGObjectExcelT _o) {
    ...
    _o.ObjectCostType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ObjectCostType, key) : this.ObjectCostType;
    _o.ObjectCostId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ObjectCostId, key) : this.ObjectCostId;
    _o.ObjectCostAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ObjectCostAmount, key) : this.ObjectCostAmount;
    _o.Disposable = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Disposable, key) : this.Disposable;
    _o.ReEncounterCost = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ReEncounterCost, key) : this.ReEncounterCost;
  }
  public static Offset<Global.MinigameTBGObjectExcel> Pack(FlatBufferBuilder builder, MinigameTBGObjectExcelT _o) {
    if (_o == null) return default(Offset<Global.MinigameTBGObjectExcel>);
		byte[] key = TableEncryptionService.CreateKey("MinigameTBGObject");
		var _UniqueId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.UniqueId, key) : _o.UniqueId;
    var _Key = _o.Key == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.Key, key) : _o.Key));
    var _PrefabName = _o.PrefabName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.PrefabName, key) : _o.PrefabName));
		...
		var _ObjectCostType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ObjectCostType, key) : _o.ObjectCostType;
		var _ObjectCostId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ObjectCostId, key) : _o.ObjectCostId;
		var _ObjectCostAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ObjectCostAmount, key) : _o.ObjectCostAmount;
		var _Disposable = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Disposable, key) : _o.Disposable;
		var _ReEncounterCost = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ReEncounterCost, key) : _o.ReEncounterCost;
...
public class MinigameTBGObjectExcelT
{
  ...
  public Global.ParcelType ObjectCostType { get; set; }
  ...
  public MinigameTBGObjectExcelT() {
    ...
    this.ObjectCostType = Global.ParcelType.None;
    this.ObjectCostId = 0;
...
static public class MinigameTBGObjectExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*ObjectType*/, 4 /*Global.TBGObjectType*/, 4, false)
      && verifier.VerifyField(tablePos, 12 /*ObjectCostType*/, 4 /*Global.ParcelType*/, 4, false)
