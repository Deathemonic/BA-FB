...
public struct EventContentMiniEventTokenExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.EventContentMiniEventTokenExcel> CreateEventContentMiniEventTokenExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.EventContentMiniEventTokenExcel> EndEventContentMiniEventTokenExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.EventContentMiniEventTokenExcel>(o);
  }
  ...
  public void UnPackTo(EventContentMiniEventTokenExcelT _o) {
    ...
    _o.MaximumAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MaximumAmount, key) : this.MaximumAmount;
  }
  public static Offset<Global.EventContentMiniEventTokenExcel> Pack(FlatBufferBuilder builder, EventContentMiniEventTokenExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentMiniEventTokenExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentMiniEventToken");
		...
		var _MaximumAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MaximumAmount, key) : _o.MaximumAmount;
    return CreateEventContentMiniEventTokenExcel(
      ...
      TableEncryptionService.UseEncryption ? _MaximumAmount : _o.MaximumAmount);
  }
}
