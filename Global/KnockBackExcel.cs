...
public struct KnockBackExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.KnockBackExcel> CreateKnockBackExcel(FlatBufferBuilder builder,
      long Index = 0,
      float Dist = 0.0f,
      float Speed = 0.0f) {
  ...
  public static Offset<Global.KnockBackExcel> EndKnockBackExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.KnockBackExcel>(o);
  }
  ...
  public void UnPackTo(KnockBackExcelT _o) {
    ...
    _o.Dist = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Dist, key) : this.Dist;
    _o.Speed = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Speed, key) : this.Speed;
  }
  public static Offset<Global.KnockBackExcel> Pack(FlatBufferBuilder builder, KnockBackExcelT _o) {
    if (_o == null) return default(Offset<Global.KnockBackExcel>);
		byte[] key = TableEncryptionService.CreateKey("KnockBack");
		var _Index = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Index, key) : _o.Index;
		var _Dist = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Dist, key) : _o.Dist;
		var _Speed = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Speed, key) : _o.Speed;
