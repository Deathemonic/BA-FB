...
public struct ContentSpoilerPopupExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.ContentSpoilerPopupExcel> CreateContentSpoilerPopupExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.ContentSpoilerPopupExcel> EndContentSpoilerPopupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.ContentSpoilerPopupExcel>(o);
  }
  ...
  public static Offset<Global.ContentSpoilerPopupExcel> Pack(FlatBufferBuilder builder, ContentSpoilerPopupExcelT _o) {
    if (_o == null) return default(Offset<Global.ContentSpoilerPopupExcel>);
		byte[] key = TableEncryptionService.CreateKey("ContentSpoilerPopup");
