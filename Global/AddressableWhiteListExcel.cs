...
public struct AddressableWhiteListExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.AddressableWhiteListExcel> EndAddressableWhiteListExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.AddressableWhiteListExcel>(o);
  }
  ...
  public static Offset<Global.AddressableWhiteListExcel> Pack(FlatBufferBuilder builder, AddressableWhiteListExcelT _o) {
