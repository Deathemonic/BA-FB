...
public struct EventContentBoxGachaManageExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.EventContentBoxGachaManageExcel> CreateEventContentBoxGachaManageExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.EventContentBoxGachaManageExcel> EndEventContentBoxGachaManageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.EventContentBoxGachaManageExcel>(o);
  }
  ...
  public static Offset<Global.EventContentBoxGachaManageExcel> Pack(FlatBufferBuilder builder, EventContentBoxGachaManageExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentBoxGachaManageExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentBoxGachaManage");
