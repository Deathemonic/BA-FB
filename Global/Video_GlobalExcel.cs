...
public struct Video_GlobalExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.Video_GlobalExcel> CreateVideo_GlobalExcel(FlatBufferBuilder builder,
      long VideoId = 0,
  ...
  public static Offset<Global.Video_GlobalExcel> EndVideo_GlobalExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.Video_GlobalExcel>(o);
  }
  ...
  public void UnPackTo(Video_GlobalExcelT _o) {
    ...
    _o.VideoPathKr = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.VideoPathKr, key) : this.VideoPathKr;
    _o.VideoTeenPathKr = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.VideoTeenPathKr, key) : this.VideoTeenPathKr;
    _o.VideoPathTh = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.VideoPathTh, key) : this.VideoPathTh;
    _o.VideoTeenPathTh = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.VideoTeenPathTh, key) : this.VideoTeenPathTh;
    _o.VideoPathTw = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.VideoPathTw, key) : this.VideoPathTw;
    _o.VideoTeenPathTw = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.VideoTeenPathTw, key) : this.VideoTeenPathTw;
    _o.VideoPathEn = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.VideoPathEn, key) : this.VideoPathEn;
    _o.VideoTeenPathEn = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.VideoTeenPathEn, key) : this.VideoTeenPathEn;
  }
  public static Offset<Global.Video_GlobalExcel> Pack(FlatBufferBuilder builder, Video_GlobalExcelT _o) {
    if (_o == null) return default(Offset<Global.Video_GlobalExcel>);
		byte[] key = TableEncryptionService.CreateKey("Video_Global");
		var _VideoId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.VideoId, key) : _o.VideoId;
    var _VideoPathKr = _o.VideoPathKr == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.VideoPathKr, key) : _o.VideoPathKr));
    var _VideoTeenPathKr = _o.VideoTeenPathKr == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.VideoTeenPathKr, key) : _o.VideoTeenPathKr));
    var _VideoPathTh = _o.VideoPathTh == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.VideoPathTh, key) : _o.VideoPathTh));
    var _VideoTeenPathTh = _o.VideoTeenPathTh == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.VideoTeenPathTh, key) : _o.VideoTeenPathTh));
    var _VideoPathTw = _o.VideoPathTw == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.VideoPathTw, key) : _o.VideoPathTw));
    var _VideoTeenPathTw = _o.VideoTeenPathTw == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.VideoTeenPathTw, key) : _o.VideoTeenPathTw));
    var _VideoPathEn = _o.VideoPathEn == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.VideoPathEn, key) : _o.VideoPathEn));
    var _VideoTeenPathEn = _o.VideoTeenPathEn == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.VideoTeenPathEn, key) : _o.VideoTeenPathEn));
