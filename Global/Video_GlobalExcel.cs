...
public struct Video_GlobalExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.Video_GlobalExcel> Pack(FlatBufferBuilder builder, Video_GlobalExcelT _o) {
    ...
    var _VideoPathKr = _o.VideoPathKr == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.VideoPathKr, key) : _o.VideoPathKr));
    var _VideoTeenPathKr = _o.VideoTeenPathKr == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.VideoTeenPathKr, key) : _o.VideoTeenPathKr));
    var _VideoPathTh = _o.VideoPathTh == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.VideoPathTh, key) : _o.VideoPathTh));
    var _VideoTeenPathTh = _o.VideoTeenPathTh == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.VideoTeenPathTh, key) : _o.VideoTeenPathTh));
    var _VideoPathTw = _o.VideoPathTw == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.VideoPathTw, key) : _o.VideoPathTw));
    var _VideoTeenPathTw = _o.VideoTeenPathTw == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.VideoTeenPathTw, key) : _o.VideoTeenPathTw));
    var _VideoPathEn = _o.VideoPathEn == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.VideoPathEn, key) : _o.VideoPathEn));
    var _VideoTeenPathEn = _o.VideoTeenPathEn == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.VideoTeenPathEn, key) : _o.VideoTeenPathEn));
