...
public struct BGMUIExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(BGMUIExcelT _o) {
    ...
    _o.UIPrefab = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.UIPrefab, key) : this.UIPrefab;
    _o.BGMId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BGMId, key) : this.BGMId;
    _o.BGMId2nd = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BGMId2nd, key) : this.BGMId2nd;
    _o.BGMId3rd = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BGMId3rd, key) : this.BGMId3rd;
  ...
  public static Offset<Global.BGMUIExcel> Pack(FlatBufferBuilder builder, BGMUIExcelT _o) {
    if (_o == null) return default(Offset<Global.BGMUIExcel>);
		byte[] key = TableEncryptionService.CreateKey("BGMUI");
		var _UIPrefab = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.UIPrefab, key) : _o.UIPrefab;
		var _BGMId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.BGMId, key) : _o.BGMId;
		var _BGMId2nd = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.BGMId2nd, key) : _o.BGMId2nd;
		var _BGMId3rd = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.BGMId3rd, key) : _o.BGMId3rd;
