...
public struct BGMUIExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.BGMUIExcel> CreateBGMUIExcel(FlatBufferBuilder builder,
      uint UIPrefab = 0,
      long BGMId = 0,
      long BGMId2nd = 0,
      long BGMId3rd = 0,
  ...
  public static Offset<Global.BGMUIExcel> EndBGMUIExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.BGMUIExcel>(o);
  }
  ...
  public void UnPackTo(BGMUIExcelT _o) {
    ...
    _o.UIPrefab = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)this.UIPrefab, key) : this.UIPrefab;
    _o.BGMId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.BGMId, key) : this.BGMId;
    _o.BGMId2nd = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.BGMId2nd, key) : this.BGMId2nd;
    _o.BGMId3rd = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.BGMId3rd, key) : this.BGMId3rd;
  ...
  public static Offset<Global.BGMUIExcel> Pack(FlatBufferBuilder builder, BGMUIExcelT _o) {
    if (_o == null) return default(Offset<Global.BGMUIExcel>);
		byte[] key = TableEncryptionService.CreateKey("BGMUI");
		var _UIPrefab = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)_o.UIPrefab, key) : _o.UIPrefab;
		var _BGMId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.BGMId, key) : _o.BGMId;
		var _BGMId2nd = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.BGMId2nd, key) : _o.BGMId2nd;
		var _BGMId3rd = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.BGMId3rd, key) : _o.BGMId3rd;
    ...
    return CreateBGMUIExcel(
      builder,
      TableEncryptionService.UseEncryption ? _UIPrefab : _o.UIPrefab,
      TableEncryptionService.UseEncryption ? _BGMId : _o.BGMId,
      TableEncryptionService.UseEncryption ? _BGMId2nd : _o.BGMId2nd,
      TableEncryptionService.UseEncryption ? _BGMId3rd : _o.BGMId3rd,
