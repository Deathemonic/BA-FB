...
public struct EventContentFortuneGachaExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.EventContentFortuneGachaExcel> CreateEventContentFortuneGachaExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.EventContentFortuneGachaExcel> EndEventContentFortuneGachaExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.EventContentFortuneGachaExcel>(o);
  }
  ...
  public static Offset<Global.EventContentFortuneGachaExcel> Pack(FlatBufferBuilder builder, EventContentFortuneGachaExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentFortuneGachaExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentFortuneGacha");
    ...
    var _NameImagePath = _o.NameImagePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.NameImagePath, key) : _o.NameImagePath));
