...
public struct StickerGroupExcel : IFlatbufferObject
{
  ...
  public Global.ParcelType PageCompleteRewardParcelType { get { int o = __p.__offset(14); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Global.ParcelType.None; } }
  ...
  public static Offset<Global.StickerGroupExcel> CreateStickerGroupExcel(FlatBufferBuilder builder,
      long Id = 0,
      ...
      Global.ParcelType PageCompleteRewardParcelType = Global.ParcelType.None,
  ...
  public static void AddPageCompleteRewardParcelType(FlatBufferBuilder builder, Global.ParcelType pageCompleteRewardParcelType) { builder.AddInt(5, (int)pageCompleteRewardParcelType, 0); }
  ...
  public static Offset<Global.StickerGroupExcel> EndStickerGroupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.StickerGroupExcel>(o);
  }
  ...
  public void UnPackTo(StickerGroupExcelT _o) {
    ...
    _o.Layout = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Layout, key) : this.Layout;
    _o.UniqueLayoutPath = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.UniqueLayoutPath, key) : this.UniqueLayoutPath;
    _o.StickerGroupIconpath = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StickerGroupIconpath, key) : this.StickerGroupIconpath;
    _o.PageCompleteSlot = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.PageCompleteSlot, key) : this.PageCompleteSlot;
    _o.PageCompleteRewardParcelType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)this.PageCompleteRewardParcelType, key) : this.PageCompleteRewardParcelType;
    _o.PageCompleteRewardParcelId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.PageCompleteRewardParcelId, key) : this.PageCompleteRewardParcelId;
    _o.PageCompleteRewardAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.PageCompleteRewardAmount, key) : this.PageCompleteRewardAmount;
    _o.LocalizeTitle = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)this.LocalizeTitle, key) : this.LocalizeTitle;
    _o.LocalizeDescription = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)this.LocalizeDescription, key) : this.LocalizeDescription;
    _o.StickerGroupCoverpath = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StickerGroupCoverpath, key) : this.StickerGroupCoverpath;
  }
  public static Offset<Global.StickerGroupExcel> Pack(FlatBufferBuilder builder, StickerGroupExcelT _o) {
    if (_o == null) return default(Offset<Global.StickerGroupExcel>);
		byte[] key = TableEncryptionService.CreateKey("StickerGroup");
		var _Id = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.Id, key) : _o.Id;
    var _Layout = _o.Layout == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.Layout, key) : _o.Layout));
    var _UniqueLayoutPath = _o.UniqueLayoutPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.UniqueLayoutPath, key) : _o.UniqueLayoutPath));
    var _StickerGroupIconpath = _o.StickerGroupIconpath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.StickerGroupIconpath, key) : _o.StickerGroupIconpath));
		var _PageCompleteSlot = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.PageCompleteSlot, key) : _o.PageCompleteSlot;
		var _PageCompleteRewardParcelType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)_o.PageCompleteRewardParcelType, key) : _o.PageCompleteRewardParcelType;
		var _PageCompleteRewardParcelId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.PageCompleteRewardParcelId, key) : _o.PageCompleteRewardParcelId;
		var _PageCompleteRewardAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.PageCompleteRewardAmount, key) : _o.PageCompleteRewardAmount;
		var _LocalizeTitle = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)_o.LocalizeTitle, key) : _o.LocalizeTitle;
		var _LocalizeDescription = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)_o.LocalizeDescription, key) : _o.LocalizeDescription;
    var _StickerGroupCoverpath = _o.StickerGroupCoverpath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.StickerGroupCoverpath, key) : _o.StickerGroupCoverpath));
    return CreateStickerGroupExcel(
      ...
      TableEncryptionService.UseEncryption ? _PageCompleteSlot : _o.PageCompleteSlot,
      TableEncryptionService.UseEncryption ? _PageCompleteRewardParcelType : _o.PageCompleteRewardParcelType,
      TableEncryptionService.UseEncryption ? _PageCompleteRewardParcelId : _o.PageCompleteRewardParcelId,
      TableEncryptionService.UseEncryption ? _PageCompleteRewardAmount : _o.PageCompleteRewardAmount,
      TableEncryptionService.UseEncryption ? _LocalizeTitle : _o.LocalizeTitle,
      TableEncryptionService.UseEncryption ? _LocalizeDescription : _o.LocalizeDescription,
...
public class StickerGroupExcelT
{
  ...
  public Global.ParcelType PageCompleteRewardParcelType { get; set; }
  ...
  public StickerGroupExcelT() {
    ...
    this.PageCompleteRewardParcelType = Global.ParcelType.None;
...
static public class StickerGroupExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 14 /*PageCompleteRewardParcelType*/, 4 /*Global.ParcelType*/, 4, false)
