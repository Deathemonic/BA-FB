...
public struct StickerGroupExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(StickerGroupExcelT _o) {
    ...
    _o.PageCompleteSlot = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.PageCompleteSlot, key) : this.PageCompleteSlot;
    _o.PageCompleteRewardParcelType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.PageCompleteRewardParcelType, key) : this.PageCompleteRewardParcelType;
    _o.PageCompleteRewardParcelId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.PageCompleteRewardParcelId, key) : this.PageCompleteRewardParcelId;
    _o.PageCompleteRewardAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.PageCompleteRewardAmount, key) : this.PageCompleteRewardAmount;
    _o.LocalizeTitle = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.LocalizeTitle, key) : this.LocalizeTitle;
    _o.LocalizeDescription = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.LocalizeDescription, key) : this.LocalizeDescription;
  ...
  public static Offset<Global.StickerGroupExcel> Pack(FlatBufferBuilder builder, StickerGroupExcelT _o) {
    ...
    var _Layout = _o.Layout == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.Layout, key) : _o.Layout));
    var _UniqueLayoutPath = _o.UniqueLayoutPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.UniqueLayoutPath, key) : _o.UniqueLayoutPath));
    var _StickerGroupIconpath = _o.StickerGroupIconpath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.StickerGroupIconpath, key) : _o.StickerGroupIconpath));
		var _PageCompleteSlot = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PageCompleteSlot, key) : _o.PageCompleteSlot;
		var _PageCompleteRewardParcelType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PageCompleteRewardParcelType, key) : _o.PageCompleteRewardParcelType;
		var _PageCompleteRewardParcelId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PageCompleteRewardParcelId, key) : _o.PageCompleteRewardParcelId;
		var _PageCompleteRewardAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PageCompleteRewardAmount, key) : _o.PageCompleteRewardAmount;
		var _LocalizeTitle = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.LocalizeTitle, key) : _o.LocalizeTitle;
		var _LocalizeDescription = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.LocalizeDescription, key) : _o.LocalizeDescription;
    var _StickerGroupCoverpath = _o.StickerGroupCoverpath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.StickerGroupCoverpath, key) : _o.StickerGroupCoverpath));
