...
public struct EventContentSeasonExcel : IFlatbufferObject
{
  ...
  public Global.EventContentType EventContentType { get { int o = __p.__offset(12); return o != 0 ? (Global.EventContentType)__p.bb.GetInt(o + __p.bb_pos) : Global.EventContentType.Stage; } }
  public Global.OpenConditionContent OpenConditionContent { get { int o = __p.__offset(14); return o != 0 ? (Global.OpenConditionContent)__p.bb.GetInt(o + __p.bb_pos) : Global.OpenConditionContent.Shop; } }
  ...
  public Global.SubEventType SubEventType { get { int o = __p.__offset(20); return o != 0 ? (Global.SubEventType)__p.bb.GetInt(o + __p.bb_pos) : Global.SubEventType.None; } }
  ...
  public Global.EventContentReleaseType EventContentReleaseType { get { int o = __p.__offset(68); return o != 0 ? (Global.EventContentReleaseType)__p.bb.GetInt(o + __p.bb_pos) : Global.EventContentReleaseType.None; } }
  public long EventContentStageRewardIdPermanent { get { int o = __p.__offset(70); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public Global.RewardTag RewardTagPermanent { get { int o = __p.__offset(72); return o != 0 ? (Global.RewardTag)__p.bb.GetInt(o + __p.bb_pos) : Global.RewardTag.Default; } }
  ...
  public static Offset<Global.EventContentSeasonExcel> CreateEventContentSeasonExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      long OriginalEventContentId = 0,
      bool IsReturn = false,
      StringOffset NameOffset = default(StringOffset),
      Global.EventContentType EventContentType = Global.EventContentType.Stage,
      Global.OpenConditionContent OpenConditionContent = Global.OpenConditionContent.Shop,
      bool EventDisplay = false,
      int IconOrder = 0,
      Global.SubEventType SubEventType = Global.SubEventType.None,
      bool SubEvent = false,
      long EventItemId = 0,
      long MainEventId = 0,
      ...
      Global.EventContentReleaseType EventContentReleaseType = Global.EventContentReleaseType.None,
      long EventContentStageRewardIdPermanent = 0,
      Global.RewardTag RewardTagPermanent = Global.RewardTag.Default,
  ...
  public static void AddEventContentType(FlatBufferBuilder builder, Global.EventContentType eventContentType) { builder.AddInt(4, (int)eventContentType, 0); }
  public static void AddOpenConditionContent(FlatBufferBuilder builder, Global.OpenConditionContent openConditionContent) { builder.AddInt(5, (int)openConditionContent, 0); }
  ...
  public static void AddSubEventType(FlatBufferBuilder builder, Global.SubEventType subEventType) { builder.AddInt(8, (int)subEventType, 0); }
  ...
  public static void AddEventContentReleaseType(FlatBufferBuilder builder, Global.EventContentReleaseType eventContentReleaseType) { builder.AddInt(32, (int)eventContentReleaseType, 0); }
  ...
  public static void AddRewardTagPermanent(FlatBufferBuilder builder, Global.RewardTag rewardTagPermanent) { builder.AddInt(34, (int)rewardTagPermanent, 0); }
  ...
  public static Offset<Global.EventContentSeasonExcel> EndEventContentSeasonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.EventContentSeasonExcel>(o);
  }
  ...
  public void UnPackTo(EventContentSeasonExcelT _o) {
    ...
    _o.OriginalEventContentId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.OriginalEventContentId, key) : this.OriginalEventContentId;
    _o.IsReturn = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.IsReturn, key) : this.IsReturn;
    ...
    _o.OpenConditionContent = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.OpenConditionContent, key) : this.OpenConditionContent;
    _o.EventDisplay = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EventDisplay, key) : this.EventDisplay;
    _o.IconOrder = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.IconOrder, key) : this.IconOrder;
    _o.SubEventType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SubEventType, key) : this.SubEventType;
    _o.SubEvent = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SubEvent, key) : this.SubEvent;
    _o.EventItemId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EventItemId, key) : this.EventItemId;
    _o.MainEventId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MainEventId, key) : this.MainEventId;
    ...
    _o.MinigamePrologScenarioGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MinigamePrologScenarioGroupId, key) : this.MinigamePrologScenarioGroupId;
    _o.BeforehandScenarioGroupId = new List<long>();
    for (var _j = 0; _j < this.BeforehandScenarioGroupIdLength; ++_j) {_o.BeforehandScenarioGroupId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BeforehandScenarioGroupId(_j), key) : this.BeforehandScenarioGroupId(_j));}
    ...
    _o.ShiftTriggerStageId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ShiftTriggerStageId, key) : this.ShiftTriggerStageId;
    ...
    _o.EventAssist = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EventAssist, key) : this.EventAssist;
    _o.EventContentReleaseType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EventContentReleaseType, key) : this.EventContentReleaseType;
    _o.EventContentStageRewardIdPermanent = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EventContentStageRewardIdPermanent, key) : this.EventContentStageRewardIdPermanent;
    _o.RewardTagPermanent = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.RewardTagPermanent, key) : this.RewardTagPermanent;
    _o.MiniEventShortCutScenarioModeId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MiniEventShortCutScenarioModeId, key) : this.MiniEventShortCutScenarioModeId;
    _o.ScenarioContentCollectionGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ScenarioContentCollectionGroupId, key) : this.ScenarioContentCollectionGroupId;
  }
  public static Offset<Global.EventContentSeasonExcel> Pack(FlatBufferBuilder builder, EventContentSeasonExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentSeasonExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentSeason");
		...
		var _OriginalEventContentId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.OriginalEventContentId, key) : _o.OriginalEventContentId;
		var _IsReturn = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IsReturn, key) : _o.IsReturn;
    var _Name = _o.Name == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.Name, key) : _o.Name));
		...
		var _OpenConditionContent = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.OpenConditionContent, key) : _o.OpenConditionContent;
		var _EventDisplay = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EventDisplay, key) : _o.EventDisplay;
		var _IconOrder = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IconOrder, key) : _o.IconOrder;
		var _SubEventType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.SubEventType, key) : _o.SubEventType;
		var _SubEvent = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.SubEvent, key) : _o.SubEvent;
		var _EventItemId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EventItemId, key) : _o.EventItemId;
		var _MainEventId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MainEventId, key) : _o.MainEventId;
    ...
    var _MainBgImagePath = _o.MainBgImagePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.MainBgImagePath, key) : _o.MainBgImagePath));
		var _ShiftTriggerStageId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ShiftTriggerStageId, key) : _o.ShiftTriggerStageId;
    var _ShiftMainBgImagePath = _o.ShiftMainBgImagePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ShiftMainBgImagePath, key) : _o.ShiftMainBgImagePath));
    var _MinigameLobbyPrefabName = _o.MinigameLobbyPrefabName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.MinigameLobbyPrefabName, key) : _o.MinigameLobbyPrefabName));
    var _MinigameVictoryPrefabName = _o.MinigameVictoryPrefabName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.MinigameVictoryPrefabName, key) : _o.MinigameVictoryPrefabName));
    var _MinigameMissionBgPrefabName = _o.MinigameMissionBgPrefabName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.MinigameMissionBgPrefabName, key) : _o.MinigameMissionBgPrefabName));
    var _MinigameMissionBgImagePath = _o.MinigameMissionBgImagePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.MinigameMissionBgImagePath, key) : _o.MinigameMissionBgImagePath));
    var _CardBgImagePath = _o.CardBgImagePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.CardBgImagePath, key) : _o.CardBgImagePath));
		var _EventAssist = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EventAssist, key) : _o.EventAssist;
		var _EventContentReleaseType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EventContentReleaseType, key) : _o.EventContentReleaseType;
		var _EventContentStageRewardIdPermanent = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EventContentStageRewardIdPermanent, key) : _o.EventContentStageRewardIdPermanent;
		var _RewardTagPermanent = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RewardTagPermanent, key) : _o.RewardTagPermanent;
		var _MiniEventShortCutScenarioModeId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MiniEventShortCutScenarioModeId, key) : _o.MiniEventShortCutScenarioModeId;
		var _ScenarioContentCollectionGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ScenarioContentCollectionGroupId, key) : _o.ScenarioContentCollectionGroupId;
...
public class EventContentSeasonExcelT
{
  ...
  public Global.OpenConditionContent OpenConditionContent { get; set; }
  public bool EventDisplay { get; set; }
  public int IconOrder { get; set; }
  public Global.SubEventType SubEventType { get; set; }
  ...
  public Global.EventContentReleaseType EventContentReleaseType { get; set; }
  public long EventContentStageRewardIdPermanent { get; set; }
  public Global.RewardTag RewardTagPermanent { get; set; }
  ...
  public EventContentSeasonExcelT() {
    ...
    this.OpenConditionContent = Global.OpenConditionContent.Shop;
    this.EventDisplay = false;
    this.IconOrder = 0;
    this.SubEventType = Global.SubEventType.None;
    this.SubEvent = false;
    this.EventItemId = 0;
    this.MainEventId = 0;
    ...
    this.EventContentReleaseType = Global.EventContentReleaseType.None;
    this.EventContentStageRewardIdPermanent = 0;
    this.RewardTagPermanent = Global.RewardTag.Default;
...
static public class EventContentSeasonExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*EventContentType*/, 4 /*Global.EventContentType*/, 4, false)
      && verifier.VerifyField(tablePos, 14 /*OpenConditionContent*/, 4 /*Global.OpenConditionContent*/, 4, false)
      && verifier.VerifyField(tablePos, 16 /*EventDisplay*/, 1 /*bool*/, 1, false)
      && verifier.VerifyField(tablePos, 18 /*IconOrder*/, 4 /*int*/, 4, false)
      && verifier.VerifyField(tablePos, 20 /*SubEventType*/, 4 /*Global.SubEventType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 68 /*EventContentReleaseType*/, 4 /*Global.EventContentReleaseType*/, 4, false)
      && verifier.VerifyField(tablePos, 70 /*EventContentStageRewardIdPermanent*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 72 /*RewardTagPermanent*/, 4 /*Global.RewardTag*/, 4, false)
