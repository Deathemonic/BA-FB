...
public struct EventContentSeasonExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(EventContentSeasonExcelT _o) {
    ...
    _o.OpenConditionContent = TableEncryptionService.UseEncryption ? (Global.OpenConditionContent)TableEncryptionService.Convert((int)this.OpenConditionContent, key) : this.OpenConditionContent;
    ...
    _o.SubEventType = TableEncryptionService.UseEncryption ? (Global.SubEventType)TableEncryptionService.Convert((int)this.SubEventType, key) : this.SubEventType;
    ...
    _o.EventContentReleaseType = TableEncryptionService.UseEncryption ? (Global.EventContentReleaseType)TableEncryptionService.Convert((int)this.EventContentReleaseType, key) : this.EventContentReleaseType;
    ...
    _o.RewardTagPermanent = TableEncryptionService.UseEncryption ? (Global.RewardTag)TableEncryptionService.Convert((int)this.RewardTagPermanent, key) : this.RewardTagPermanent;
  ...
  public static Offset<Global.EventContentSeasonExcel> Pack(FlatBufferBuilder builder, EventContentSeasonExcelT _o) {
    ...
    var _Name = _o.Name == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.Name, key) : _o.Name));
		...
		var _OpenConditionContent = TableEncryptionService.UseEncryption ? (Global.OpenConditionContent)TableEncryptionService.Convert((int)_o.OpenConditionContent, key) : _o.OpenConditionContent;
		...
		var _SubEventType = TableEncryptionService.UseEncryption ? (Global.SubEventType)TableEncryptionService.Convert((int)_o.SubEventType, key) : _o.SubEventType;
    ...
    var _CardBgImagePath = _o.CardBgImagePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.CardBgImagePath, key) : _o.CardBgImagePath));
		...
		var _EventContentReleaseType = TableEncryptionService.UseEncryption ? (Global.EventContentReleaseType)TableEncryptionService.Convert((int)_o.EventContentReleaseType, key) : _o.EventContentReleaseType;
		...
		var _RewardTagPermanent = TableEncryptionService.UseEncryption ? (Global.RewardTag)TableEncryptionService.Convert((int)_o.RewardTagPermanent, key) : _o.RewardTagPermanent;
