...
public struct EventContentTreasureExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.EventContentTreasureExcel> CreateEventContentTreasureExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.EventContentTreasureExcel> EndEventContentTreasureExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.EventContentTreasureExcel>(o);
  }
  ...
  public void UnPackTo(EventContentTreasureExcelT _o) {
    ...
    _o.LoopRound = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.LoopRound, key) : this.LoopRound;
    ...
    _o.TreasureBGImagePath = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.TreasureBGImagePath, key) : this.TreasureBGImagePath;
  }
  public static Offset<Global.EventContentTreasureExcel> Pack(FlatBufferBuilder builder, EventContentTreasureExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentTreasureExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentTreasure");
    ...
    var _TitleLocalize = _o.TitleLocalize == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.TitleLocalize, key) : _o.TitleLocalize));
		var _LoopRound = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.LoopRound, key) : _o.LoopRound;
    ...
    var _TreasureBGImagePath = _o.TreasureBGImagePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.TreasureBGImagePath, key) : _o.TreasureBGImagePath));
    return CreateEventContentTreasureExcel(
      builder,
      TableEncryptionService.UseEncryption ? _EventContentId : _o.EventContentId,
      _TitleLocalize,
      TableEncryptionService.UseEncryption ? _LoopRound : _o.LoopRound,
      _UsePrefabName,
