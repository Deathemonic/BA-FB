...
public struct EventContentTreasureExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(EventContentTreasureExcelT _o) {
    ...
    _o.LoopRound = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.LoopRound, key) : this.LoopRound;
  ...
  public static Offset<Global.EventContentTreasureExcel> Pack(FlatBufferBuilder builder, EventContentTreasureExcelT _o) {
    ...
    var _TitleLocalize = _o.TitleLocalize == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.TitleLocalize, key) : _o.TitleLocalize));
		var _LoopRound = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.LoopRound, key) : _o.LoopRound;
    ...
    var _TreasureBGImagePath = _o.TreasureBGImagePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.TreasureBGImagePath, key) : _o.TreasureBGImagePath));
