...
public struct FurnitureGroupExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.FurnitureGroupExcel> CreateFurnitureGroupExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Global.FurnitureGroupExcel> EndFurnitureGroupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.FurnitureGroupExcel>(o);
  }
  ...
  public void UnPackTo(FurnitureGroupExcelT _o) {
    ...
    _o.GroupNameLocalize = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.GroupNameLocalize, key) : this.GroupNameLocalize;
    ...
    for (var _j = 0; _j < this.RequiredFurnitureCountLength; ++_j) {_o.RequiredFurnitureCount.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.RequiredFurnitureCount(_j), key) : this.RequiredFurnitureCount(_j));}
    _o.ComfortBonus = new List<long>();
    for (var _j = 0; _j < this.ComfortBonusLength; ++_j) {_o.ComfortBonus.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ComfortBonus(_j), key) : this.ComfortBonus(_j));}
  }
  public static Offset<Global.FurnitureGroupExcel> Pack(FlatBufferBuilder builder, FurnitureGroupExcelT _o) {
    if (_o == null) return default(Offset<Global.FurnitureGroupExcel>);
		byte[] key = TableEncryptionService.CreateKey("FurnitureGroup");
    ...
    if (_o.ComfortBonus != null) {
      var __ComfortBonus = _o.ComfortBonus.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
