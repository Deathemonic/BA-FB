...
public struct EventContentShopRefreshExcel : IFlatbufferObject
{
  ...
  public Global.ShopCategoryType CategoryType { get { int o = __p.__offset(16); return o != 0 ? (Global.ShopCategoryType)__p.bb.GetInt(o + __p.bb_pos) : Global.ShopCategoryType.General; } }
  ...
  public static Offset<Global.EventContentShopRefreshExcel> CreateEventContentShopRefreshExcel(FlatBufferBuilder builder,
  ...
  public static void AddCategoryType(FlatBufferBuilder builder, Global.ShopCategoryType categoryType) { builder.AddInt(6, (int)categoryType, 0); }
  ...
  public static Offset<Global.EventContentShopRefreshExcel> EndEventContentShopRefreshExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.EventContentShopRefreshExcel>(o);
  }
  ...
  public static Offset<Global.EventContentShopRefreshExcel> Pack(FlatBufferBuilder builder, EventContentShopRefreshExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentShopRefreshExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentShopRefresh");
...
static public class EventContentShopRefreshExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 16 /*CategoryType*/, 4 /*Global.ShopCategoryType*/, 4, false)
