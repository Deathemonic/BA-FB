...
public struct EventContentDiceRaceEffectExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.EventContentDiceRaceEffectExcel> CreateEventContentDiceRaceEffectExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.EventContentDiceRaceEffectExcel> EndEventContentDiceRaceEffectExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.EventContentDiceRaceEffectExcel>(o);
  }
  ...
  public static Offset<Global.EventContentDiceRaceEffectExcel> Pack(FlatBufferBuilder builder, EventContentDiceRaceEffectExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentDiceRaceEffectExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentDiceRaceEffect");
