...
public struct EchelonConstraintExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(EchelonConstraintExcelT _o) {
    ...
    _o.IsWhiteList = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.IsWhiteList, key) : this.IsWhiteList;
    _o.CharacterId = new List<long>();
    for (var _j = 0; _j < this.CharacterIdLength; ++_j) {_o.CharacterId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CharacterId(_j), key) : this.CharacterId(_j));}
    _o.PersonalityId = new List<long>();
    for (var _j = 0; _j < this.PersonalityIdLength; ++_j) {_o.PersonalityId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.PersonalityId(_j), key) : this.PersonalityId(_j));}
    ...
    _o.Role = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Role, key) : this.Role;
  }
  public static Offset<Global.EchelonConstraintExcel> Pack(FlatBufferBuilder builder, EchelonConstraintExcelT _o) {
    ...
    if (_o.PersonalityId != null) {
      ...
      _personalityId = CreatePersonalityIdVector(builder, __personalityId);
		...
		var _Role = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Role, key) : _o.Role;
