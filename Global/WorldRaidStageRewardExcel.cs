...
public struct WorldRaidStageRewardExcel : IFlatbufferObject
{
  ...
  public Global.ParcelType ClearStageRewardParcelType { get { int o = __p.__offset(10); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Global.ParcelType.None; } }
  ...
  public static Offset<Global.WorldRaidStageRewardExcel> CreateWorldRaidStageRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static void AddClearStageRewardParcelType(FlatBufferBuilder builder, Global.ParcelType clearStageRewardParcelType) { builder.AddInt(3, (int)clearStageRewardParcelType, 0); }
  ...
  public static Offset<Global.WorldRaidStageRewardExcel> EndWorldRaidStageRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.WorldRaidStageRewardExcel>(o);
  }
  public WorldRaidStageRewardExcelT UnPack() {
    var _o = new WorldRaidStageRewardExcelT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(WorldRaidStageRewardExcelT _o) {
		byte[] key = TableEncryptionService.CreateKey("WorldRaidStageReward");
  ...
  public static Offset<Global.WorldRaidStageRewardExcel> Pack(FlatBufferBuilder builder, WorldRaidStageRewardExcelT _o) {
    if (_o == null) return default(Offset<Global.WorldRaidStageRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("WorldRaidStageReward");
...
public class WorldRaidStageRewardExcelT
{
...
static public class WorldRaidStageRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*ClearStageRewardParcelType*/, 4 /*Global.ParcelType*/, 4, false)
