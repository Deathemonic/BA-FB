...
public struct WorldRaidStageRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.WorldRaidStageRewardExcel> Pack(FlatBufferBuilder builder, WorldRaidStageRewardExcelT _o) {
    ...
    var _ClearStageRewardParcelUniqueName = _o.ClearStageRewardParcelUniqueName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.ClearStageRewardParcelUniqueName, key) : _o.ClearStageRewardParcelUniqueName));
