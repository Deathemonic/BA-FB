...
public struct EventContentDebuffRewardExcel : IFlatbufferObject
{
  ...
  public Global.EventContentItemType EventContentItemType { get { int o = __p.__offset(8); return o != 0 ? (Global.EventContentItemType)__p.bb.GetInt(o + __p.bb_pos) : Global.EventContentItemType.EventPoint; } }
  public long RewardPercentage { get { int o = __p.__offset(10); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }

  public static Offset<Global.EventContentDebuffRewardExcel> CreateEventContentDebuffRewardExcel(FlatBufferBuilder builder,
  ...
  public static void AddEventContentItemType(FlatBufferBuilder builder, Global.EventContentItemType eventContentItemType) { builder.AddInt(2, (int)eventContentItemType, 0); }
  ...
  public static Offset<Global.EventContentDebuffRewardExcel> EndEventContentDebuffRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.EventContentDebuffRewardExcel>(o);
  }
  ...
  public static Offset<Global.EventContentDebuffRewardExcel> Pack(FlatBufferBuilder builder, EventContentDebuffRewardExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentDebuffRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentDebuffReward");
...
static public class EventContentDebuffRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*EventContentItemType*/, 4 /*Global.EventContentItemType*/, 4, false)
