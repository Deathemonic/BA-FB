...
public struct EventContentSpineDialogOffsetExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.EventContentSpineDialogOffsetExcel> CreateEventContentSpineDialogOffsetExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.EventContentSpineDialogOffsetExcel> EndEventContentSpineDialogOffsetExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.EventContentSpineDialogOffsetExcel>(o);
  }
  ...
  public static Offset<Global.EventContentSpineDialogOffsetExcel> Pack(FlatBufferBuilder builder, EventContentSpineDialogOffsetExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentSpineDialogOffsetExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentSpineDialogOffset");
		...
		var _SpineOffsetX = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.SpineOffsetX, key) : _o.SpineOffsetX;
		var _SpineOffsetY = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.SpineOffsetY, key) : _o.SpineOffsetY;
		var _DialogOffsetX = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DialogOffsetX, key) : _o.DialogOffsetX;
		var _DialogOffsetY = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DialogOffsetY, key) : _o.DialogOffsetY;
