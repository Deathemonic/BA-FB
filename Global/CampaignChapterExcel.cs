...
public struct CampaignChapterExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(CampaignChapterExcelT _o) {
    ...
    for (var _j = 0; _j < this.PreChapterIdLength; ++_j) {_o.PreChapterId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.PreChapterId(_j), key) : this.PreChapterId(_j));}
    _o.ChapterRewardId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ChapterRewardId, key) : this.ChapterRewardId;
    _o.ChapterHardRewardId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ChapterHardRewardId, key) : this.ChapterHardRewardId;
    _o.ChapterVeryHardRewardId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ChapterVeryHardRewardId, key) : this.ChapterVeryHardRewardId;
    _o.NormalCampaignStageId = new List<long>();
    for (var _j = 0; _j < this.NormalCampaignStageIdLength; ++_j) {_o.NormalCampaignStageId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.NormalCampaignStageId(_j), key) : this.NormalCampaignStageId(_j));}
    _o.NormalExtraStageId = new List<long>();
    for (var _j = 0; _j < this.NormalExtraStageIdLength; ++_j) {_o.NormalExtraStageId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.NormalExtraStageId(_j), key) : this.NormalExtraStageId(_j));}
    _o.HardCampaignStageId = new List<long>();
    for (var _j = 0; _j < this.HardCampaignStageIdLength; ++_j) {_o.HardCampaignStageId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.HardCampaignStageId(_j), key) : this.HardCampaignStageId(_j));}
    _o.VeryHardCampaignStageId = new List<long>();
    for (var _j = 0; _j < this.VeryHardCampaignStageIdLength; ++_j) {_o.VeryHardCampaignStageId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.VeryHardCampaignStageId(_j), key) : this.VeryHardCampaignStageId(_j));}
  ...
  public static Offset<Global.CampaignChapterExcel> Pack(FlatBufferBuilder builder, CampaignChapterExcelT _o) {
    ...
    if (_o.PreChapterId != null) {
      ...
      _preChapterId = CreatePreChapterIdVector(builder, __preChapterId);
		...
		var _ChapterVeryHardRewardId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ChapterVeryHardRewardId, key) : _o.ChapterVeryHardRewardId;
    var _normalCampaignStageId = default(VectorOffset);
    if (_o.NormalCampaignStageId != null) {
      var __normalCampaignStageId = _o.NormalCampaignStageId.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
