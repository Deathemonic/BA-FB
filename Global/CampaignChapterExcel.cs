...
public struct CampaignChapterExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.CampaignChapterExcel> CreateCampaignChapterExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Global.CampaignChapterExcel> EndCampaignChapterExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.CampaignChapterExcel>(o);
  }
  ...
  public void UnPackTo(CampaignChapterExcelT _o) {
    ...
    _o.NormalImagePath = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.NormalImagePath, key) : this.NormalImagePath;
    _o.HardImagePath = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.HardImagePath, key) : this.HardImagePath;
    ...
    for (var _j = 0; _j < this.PreChapterIdLength; ++_j) {_o.PreChapterId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.PreChapterId(_j), key) : this.PreChapterId(_j));}
    _o.ChapterRewardId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ChapterRewardId, key) : this.ChapterRewardId;
    _o.ChapterHardRewardId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ChapterHardRewardId, key) : this.ChapterHardRewardId;
    _o.ChapterVeryHardRewardId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ChapterVeryHardRewardId, key) : this.ChapterVeryHardRewardId;
    _o.NormalCampaignStageId = new List<long>();
    for (var _j = 0; _j < this.NormalCampaignStageIdLength; ++_j) {_o.NormalCampaignStageId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.NormalCampaignStageId(_j), key) : this.NormalCampaignStageId(_j));}
    _o.NormalExtraStageId = new List<long>();
    for (var _j = 0; _j < this.NormalExtraStageIdLength; ++_j) {_o.NormalExtraStageId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.NormalExtraStageId(_j), key) : this.NormalExtraStageId(_j));}
    _o.HardCampaignStageId = new List<long>();
    for (var _j = 0; _j < this.HardCampaignStageIdLength; ++_j) {_o.HardCampaignStageId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.HardCampaignStageId(_j), key) : this.HardCampaignStageId(_j));}
    _o.VeryHardCampaignStageId = new List<long>();
    for (var _j = 0; _j < this.VeryHardCampaignStageIdLength; ++_j) {_o.VeryHardCampaignStageId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.VeryHardCampaignStageId(_j), key) : this.VeryHardCampaignStageId(_j));}
    _o.IsTacticSkip = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.IsTacticSkip, key) : this.IsTacticSkip;
  }
  public static Offset<Global.CampaignChapterExcel> Pack(FlatBufferBuilder builder, CampaignChapterExcelT _o) {
    if (_o == null) return default(Offset<Global.CampaignChapterExcel>);
		byte[] key = TableEncryptionService.CreateKey("CampaignChapter");
    ...
    var _NormalImagePath = _o.NormalImagePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.NormalImagePath, key) : _o.NormalImagePath));
    var _HardImagePath = _o.HardImagePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.HardImagePath, key) : _o.HardImagePath));
    ...
    if (_o.PreChapterId != null) {
      var __PreChapterId = _o.PreChapterId.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
      _PreChapterId = CreatePreChapterIdVector(builder, __PreChapterId);
    }
		var _ChapterRewardId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ChapterRewardId, key) : _o.ChapterRewardId;
		var _ChapterHardRewardId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ChapterHardRewardId, key) : _o.ChapterHardRewardId;
		var _ChapterVeryHardRewardId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ChapterVeryHardRewardId, key) : _o.ChapterVeryHardRewardId;
    var _NormalCampaignStageId = default(VectorOffset);
    if (_o.NormalCampaignStageId != null) {
      var __NormalCampaignStageId = _o.NormalCampaignStageId.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
    ...
    if (_o.NormalExtraStageId != null) {
      var __NormalExtraStageId = _o.NormalExtraStageId.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
    ...
    if (_o.HardCampaignStageId != null) {
      var __HardCampaignStageId = _o.HardCampaignStageId.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
    ...
    if (_o.VeryHardCampaignStageId != null) {
      var __VeryHardCampaignStageId = _o.VeryHardCampaignStageId.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
      _VeryHardCampaignStageId = CreateVeryHardCampaignStageIdVector(builder, __VeryHardCampaignStageId);
    }
		var _IsTacticSkip = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.IsTacticSkip, key) : _o.IsTacticSkip;
