...
public struct FieldMasteryExcel : IFlatbufferObject
{
  ...
  public Global.ParcelType TokenType { get { int o = __p.__offset(12); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Global.ParcelType.None; } }
  ...
  public Global.FieldConditionType AccomplishmentConditionType { get { int o = __p.__offset(18); return o != 0 ? (Global.FieldConditionType)__p.bb.GetInt(o + __p.bb_pos) : Global.FieldConditionType.Invalid; } }
  public long AccomplishmentConditionId { get { int o = __p.__offset(20); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }

  public static Offset<Global.FieldMasteryExcel> CreateFieldMasteryExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      long SeasonId = 0,
      int Order = 0,
      long ExpAmount = 0,
      Global.ParcelType TokenType = Global.ParcelType.None,
      long TokenId = 0,
      long TokenRequirement = 0,
      Global.FieldConditionType AccomplishmentConditionType = Global.FieldConditionType.Invalid,
  ...
  public static void AddTokenType(FlatBufferBuilder builder, Global.ParcelType tokenType) { builder.AddInt(4, (int)tokenType, 0); }
  ...
  public static void AddAccomplishmentConditionType(FlatBufferBuilder builder, Global.FieldConditionType accomplishmentConditionType) { builder.AddInt(7, (int)accomplishmentConditionType, 0); }
  ...
  public static Offset<Global.FieldMasteryExcel> EndFieldMasteryExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.FieldMasteryExcel>(o);
  }
  ...
  public void UnPackTo(FieldMasteryExcelT _o) {
    ...
    _o.ExpAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ExpAmount, key) : this.ExpAmount;
    _o.TokenType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)this.TokenType, key) : this.TokenType;
    _o.TokenId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.TokenId, key) : this.TokenId;
    _o.TokenRequirement = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.TokenRequirement, key) : this.TokenRequirement;
    _o.AccomplishmentConditionType = TableEncryptionService.UseEncryption ? (Global.FieldConditionType)TableEncryptionService.Convert((int)this.AccomplishmentConditionType, key) : this.AccomplishmentConditionType;
    _o.AccomplishmentConditionId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.AccomplishmentConditionId, key) : this.AccomplishmentConditionId;
  }
  public static Offset<Global.FieldMasteryExcel> Pack(FlatBufferBuilder builder, FieldMasteryExcelT _o) {
    if (_o == null) return default(Offset<Global.FieldMasteryExcel>);
		byte[] key = TableEncryptionService.CreateKey("FieldMastery");
		...
		var _ExpAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ExpAmount, key) : _o.ExpAmount;
		var _TokenType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)_o.TokenType, key) : _o.TokenType;
		var _TokenId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.TokenId, key) : _o.TokenId;
		var _TokenRequirement = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.TokenRequirement, key) : _o.TokenRequirement;
		var _AccomplishmentConditionType = TableEncryptionService.UseEncryption ? (Global.FieldConditionType)TableEncryptionService.Convert((int)_o.AccomplishmentConditionType, key) : _o.AccomplishmentConditionType;
		var _AccomplishmentConditionId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.AccomplishmentConditionId, key) : _o.AccomplishmentConditionId;
...
public class FieldMasteryExcelT
{
  ...
  public Global.ParcelType TokenType { get; set; }
  public long TokenId { get; set; }
  public long TokenRequirement { get; set; }
  public Global.FieldConditionType AccomplishmentConditionType { get; set; }
  ...
  public FieldMasteryExcelT() {
    ...
    this.Order = 0;
    this.ExpAmount = 0;
    this.TokenType = Global.ParcelType.None;
    this.TokenId = 0;
    this.TokenRequirement = 0;
    this.AccomplishmentConditionType = Global.FieldConditionType.Invalid;
...
static public class FieldMasteryExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*TokenType*/, 4 /*Global.ParcelType*/, 4, false)
      && verifier.VerifyField(tablePos, 14 /*TokenId*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 16 /*TokenRequirement*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 18 /*AccomplishmentConditionType*/, 4 /*Global.FieldConditionType*/, 4, false)
