...
public struct ShopInfoExcel : IFlatbufferObject
{
  ...
  public Global.ShopCategoryType CategoryType { get { int o = __p.__offset(4); return o != 0 ? (Global.ShopCategoryType)__p.bb.GetInt(o + __p.bb_pos) : Global.ShopCategoryType.General; } }
  ...
  public Global.ParcelType CostParcelType(int j) { int o = __p.__offset(10); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Global.ParcelType)0; }
  public int CostParcelTypeLength { get { int o = __p.__offset(10); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Global.ParcelType> GetCostParcelTypeBytes() { return __p.__vector_as_span<Global.ParcelType>(10, 4); }
#else
  public ArraySegment<byte>? GetCostParcelTypeBytes() { return __p.__vector_as_arraysegment(10); }
#endif
  public Global.ParcelType[] GetCostParcelTypeArray() { int o = __p.__offset(10); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Global.ParcelType[] a = new Global.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Global.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static VectorOffset CreateCostParcelTypeVector(FlatBufferBuilder builder, Global.ParcelType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateCostParcelTypeVectorBlock(FlatBufferBuilder builder, Global.ParcelType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateCostParcelTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Global.ParcelType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateCostParcelTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Global.ParcelType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public void UnPackTo(ShopInfoExcelT _o) {
    ...
    _o.CostParcelType = new List<Global.ParcelType>();
    for (var _j = 0; _j < this.CostParcelTypeLength; ++_j) {_o.CostParcelType.Add(TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)this.CostParcelType(_j), key) : this.CostParcelType(_j));}
    ...
    _o.ShopRefresherType = TableEncryptionService.UseEncryption ? (Global.ShopRefresherType)TableEncryptionService.Convert((int)this.ShopRefresherType, key) : this.ShopRefresherType;
    _o.ShopRefreshPeriodType = TableEncryptionService.UseEncryption ? (Global.ShopRefreshPeriodType)TableEncryptionService.Convert((int)this.ShopRefreshPeriodType, key) : this.ShopRefreshPeriodType;
    ...
    _o.DisplayParcelType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)this.DisplayParcelType, key) : this.DisplayParcelType;
  ...
  public static Offset<Global.ShopInfoExcel> Pack(FlatBufferBuilder builder, ShopInfoExcelT _o) {
    if (_o == null) return default(Offset<Global.ShopInfoExcel>);
		byte[] key = TableEncryptionService.CreateKey("ShopInfo");
    ...
    if (_o.CostParcelType != null) {
      var __CostParcelType = _o.CostParcelType.Select(x => TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)x, key) : x).ToArray();
    ...
    if (_o.CostParcelId != null) {
      ...
      _CostParcelId = CreateCostParcelIdVector(builder, __CostParcelId);
		...
		var _ShopRefresherType = TableEncryptionService.UseEncryption ? (Global.ShopRefresherType)TableEncryptionService.Convert((int)_o.ShopRefresherType, key) : _o.ShopRefresherType;
		var _ShopRefreshPeriodType = TableEncryptionService.UseEncryption ? (Global.ShopRefreshPeriodType)TableEncryptionService.Convert((int)_o.ShopRefreshPeriodType, key) : _o.ShopRefreshPeriodType;
    ...
    var _ShopProductUpdateTime = _o.ShopProductUpdateTime == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.ShopProductUpdateTime, key) : _o.ShopProductUpdateTime));
		var _DisplayParcelType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)_o.DisplayParcelType, key) : _o.DisplayParcelType;
...
static public class ShopInfoExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyField(tablePos, 4 /*CategoryType*/, 4 /*Global.ShopCategoryType*/, 4, false)
