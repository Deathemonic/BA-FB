...
public struct ConquestProgressResourceExcel : IFlatbufferObject
{
  ...
  public Global.ConquestProgressType Group { get { int o = __p.__offset(8); return o != 0 ? (Global.ConquestProgressType)__p.bb.GetInt(o + __p.bb_pos) : Global.ConquestProgressType.None; } }
  ...
  public static Offset<Global.ConquestProgressResourceExcel> CreateConquestProgressResourceExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddGroup(FlatBufferBuilder builder, Global.ConquestProgressType group) { builder.AddInt(2, (int)group, 0); }
  ...
  public static Offset<Global.ConquestProgressResourceExcel> EndConquestProgressResourceExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.ConquestProgressResourceExcel>(o);
  }
  ...
  public void UnPackTo(ConquestProgressResourceExcelT _o) {
    ...
    _o.Group = TableEncryptionService.UseEncryption ? (Global.ConquestProgressType)TableEncryptionService.Convert((int)this.Group, key) : this.Group;
  ...
  public static Offset<Global.ConquestProgressResourceExcel> Pack(FlatBufferBuilder builder, ConquestProgressResourceExcelT _o) {
    if (_o == null) return default(Offset<Global.ConquestProgressResourceExcel>);
		byte[] key = TableEncryptionService.CreateKey("ConquestProgressResource");
		...
		var _Group = TableEncryptionService.UseEncryption ? (Global.ConquestProgressType)TableEncryptionService.Convert((int)_o.Group, key) : _o.Group;
...
public class ConquestProgressResourceExcelT
{
  ...
  public Global.ConquestProgressType Group { get; set; }
  ...
  public ConquestProgressResourceExcelT() {
    ...
    this.Group = Global.ConquestProgressType.None;
...
static public class ConquestProgressResourceExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*Group*/, 4 /*Global.ConquestProgressType*/, 4, false)
