...
public struct DefaultEchelonExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.DefaultEchelonExcel> EndDefaultEchelonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.DefaultEchelonExcel>(o);
  }
  ...
  public static Offset<Global.DefaultEchelonExcel> Pack(FlatBufferBuilder builder, DefaultEchelonExcelT _o) {
    if (_o == null) return default(Offset<Global.DefaultEchelonExcel>);
		byte[] key = TableEncryptionService.CreateKey("DefaultEchelon");
