...
public struct WorldRaidSeasonManageExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.WorldRaidSeasonManageExcel> Pack(FlatBufferBuilder builder, WorldRaidSeasonManageExcelT _o) {
    if (_o == null) return default(Offset<Global.WorldRaidSeasonManageExcel>);
		...
		var _EnterTicket = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EnterTicket, key) : _o.EnterTicket;
    var _WorldRaidLobbyScene = _o.WorldRaidLobbyScene == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.WorldRaidLobbyScene, key) : _o.WorldRaidLobbyScene));
    var _WorldRaidLobbyBanner = _o.WorldRaidLobbyBanner == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.WorldRaidLobbyBanner, key) : _o.WorldRaidLobbyBanner));
    var _WorldRaidLobbyBG = _o.WorldRaidLobbyBG == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.WorldRaidLobbyBG, key) : _o.WorldRaidLobbyBG));
		var _WorldRaidLobbyBannerShow = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.WorldRaidLobbyBannerShow, key) : _o.WorldRaidLobbyBannerShow;
		var _SeasonOpenCondition = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.SeasonOpenCondition, key) : _o.SeasonOpenCondition;
		var _WorldRaidLobbyEnterScenario = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.WorldRaidLobbyEnterScenario, key) : _o.WorldRaidLobbyEnterScenario;
		var _CanPlayNotSeasonTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CanPlayNotSeasonTime, key) : _o.CanPlayNotSeasonTime;
		var _WorldRaidUniqueThemeLobbyUI = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.WorldRaidUniqueThemeLobbyUI, key) : _o.WorldRaidUniqueThemeLobbyUI;
    var _WorldRaidUniqueThemeName = _o.WorldRaidUniqueThemeName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.WorldRaidUniqueThemeName, key) : _o.WorldRaidUniqueThemeName));
		var _CanWorldRaidGemEnter = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CanWorldRaidGemEnter, key) : _o.CanWorldRaidGemEnter;
    ...
    if (_o.BossSpawnTime != null) {
      ...
      for (var _j = 0; _j < __BossSpawnTime.Length; ++_j) { __BossSpawnTime[_j] = builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.BossSpawnTime[_j], key) : _o.BossSpawnTime[_j])); }
    ...
    if (_o.EliminateTime != null) {
      ...
      for (var _j = 0; _j < __EliminateTime.Length; ++_j) { __EliminateTime[_j] = builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.EliminateTime[_j], key) : _o.EliminateTime[_j])); }
