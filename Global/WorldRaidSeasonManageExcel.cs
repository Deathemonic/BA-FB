...
public struct WorldRaidSeasonManageExcel : IFlatbufferObject
{
  ...
  public Global.CurrencyTypes EnterTicket { get { int o = __p.__offset(8); return o != 0 ? (Global.CurrencyTypes)__p.bb.GetInt(o + __p.bb_pos) : Global.CurrencyTypes.Invalid; } }
  ...
  public static Offset<Global.WorldRaidSeasonManageExcel> CreateWorldRaidSeasonManageExcel(FlatBufferBuilder builder,
      long SeasonId = 0,
      long EventContentId = 0,
      Global.CurrencyTypes EnterTicket = Global.CurrencyTypes.Invalid,
  ...
  public static void AddEnterTicket(FlatBufferBuilder builder, Global.CurrencyTypes enterTicket) { builder.AddInt(2, (int)enterTicket, 0); }
  ...
  public static Offset<Global.WorldRaidSeasonManageExcel> EndWorldRaidSeasonManageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.WorldRaidSeasonManageExcel>(o);
  }
  ...
  public void UnPackTo(WorldRaidSeasonManageExcelT _o) {
    ...
    _o.EnterTicket = TableEncryptionService.UseEncryption ? (Global.CurrencyTypes)TableEncryptionService.Convert((int)this.EnterTicket, key) : this.EnterTicket;
    ...
    _o.WorldRaidLobbyBannerShow = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.WorldRaidLobbyBannerShow, key) : this.WorldRaidLobbyBannerShow;
    _o.SeasonOpenCondition = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.SeasonOpenCondition, key) : this.SeasonOpenCondition;
    _o.WorldRaidLobbyEnterScenario = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.WorldRaidLobbyEnterScenario, key) : this.WorldRaidLobbyEnterScenario;
    _o.CanPlayNotSeasonTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.CanPlayNotSeasonTime, key) : this.CanPlayNotSeasonTime;
    _o.WorldRaidUniqueThemeLobbyUI = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.WorldRaidUniqueThemeLobbyUI, key) : this.WorldRaidUniqueThemeLobbyUI;
    ...
    _o.CanWorldRaidGemEnter = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.CanWorldRaidGemEnter, key) : this.CanWorldRaidGemEnter;
    _o.HideWorldRaidTicketUI = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.HideWorldRaidTicketUI, key) : this.HideWorldRaidTicketUI;
    _o.HideWorldRaidBossCompleteRewardUI = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.HideWorldRaidBossCompleteRewardUI, key) : this.HideWorldRaidBossCompleteRewardUI;
    _o.UseWorldRaidCommonToast = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.UseWorldRaidCommonToast, key) : this.UseWorldRaidCommonToast;
    _o.OpenRaidBossGroupId = new List<long>();
    for (var _j = 0; _j < this.OpenRaidBossGroupIdLength; ++_j) {_o.OpenRaidBossGroupId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.OpenRaidBossGroupId(_j), key) : this.OpenRaidBossGroupId(_j));}
    ...
    for (var _j = 0; _j < this.ScenarioOutputConditionIdLength; ++_j) {_o.ScenarioOutputConditionId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ScenarioOutputConditionId(_j), key) : this.ScenarioOutputConditionId(_j));}
    _o.ConditionScenarioGroupid = new List<long>();
    for (var _j = 0; _j < this.ConditionScenarioGroupidLength; ++_j) {_o.ConditionScenarioGroupid.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ConditionScenarioGroupid(_j), key) : this.ConditionScenarioGroupid(_j));}
    ...
    _o.UseFavorRankBuff = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.UseFavorRankBuff, key) : this.UseFavorRankBuff;
  }
  public static Offset<Global.WorldRaidSeasonManageExcel> Pack(FlatBufferBuilder builder, WorldRaidSeasonManageExcelT _o) {
    if (_o == null) return default(Offset<Global.WorldRaidSeasonManageExcel>);
		byte[] key = TableEncryptionService.CreateKey("WorldRaidSeasonManage");
		...
		var _EnterTicket = TableEncryptionService.UseEncryption ? (Global.CurrencyTypes)TableEncryptionService.Convert((int)_o.EnterTicket, key) : _o.EnterTicket;
    var _WorldRaidLobbyScene = _o.WorldRaidLobbyScene == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.WorldRaidLobbyScene, key) : _o.WorldRaidLobbyScene));
    var _WorldRaidLobbyBanner = _o.WorldRaidLobbyBanner == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.WorldRaidLobbyBanner, key) : _o.WorldRaidLobbyBanner));
    var _WorldRaidLobbyBG = _o.WorldRaidLobbyBG == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.WorldRaidLobbyBG, key) : _o.WorldRaidLobbyBG));
		var _WorldRaidLobbyBannerShow = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.WorldRaidLobbyBannerShow, key) : _o.WorldRaidLobbyBannerShow;
		var _SeasonOpenCondition = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.SeasonOpenCondition, key) : _o.SeasonOpenCondition;
		var _WorldRaidLobbyEnterScenario = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.WorldRaidLobbyEnterScenario, key) : _o.WorldRaidLobbyEnterScenario;
		var _CanPlayNotSeasonTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.CanPlayNotSeasonTime, key) : _o.CanPlayNotSeasonTime;
		var _WorldRaidUniqueThemeLobbyUI = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.WorldRaidUniqueThemeLobbyUI, key) : _o.WorldRaidUniqueThemeLobbyUI;
    var _WorldRaidUniqueThemeName = _o.WorldRaidUniqueThemeName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.WorldRaidUniqueThemeName, key) : _o.WorldRaidUniqueThemeName));
		var _CanWorldRaidGemEnter = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.CanWorldRaidGemEnter, key) : _o.CanWorldRaidGemEnter;
		var _HideWorldRaidTicketUI = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.HideWorldRaidTicketUI, key) : _o.HideWorldRaidTicketUI;
		var _HideWorldRaidBossCompleteRewardUI = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.HideWorldRaidBossCompleteRewardUI, key) : _o.HideWorldRaidBossCompleteRewardUI;
		var _UseWorldRaidCommonToast = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.UseWorldRaidCommonToast, key) : _o.UseWorldRaidCommonToast;
    var _OpenRaidBossGroupId = default(VectorOffset);
    if (_o.OpenRaidBossGroupId != null) {
      var __OpenRaidBossGroupId = _o.OpenRaidBossGroupId.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
    ...
    if (_o.BossSpawnTime != null) {
      ...
      for (var _j = 0; _j < __BossSpawnTime.Length; ++_j) { __BossSpawnTime[_j] = builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.BossSpawnTime[_j], key) : _o.BossSpawnTime[_j])); }
    ...
    if (_o.EliminateTime != null) {
      ...
      for (var _j = 0; _j < __EliminateTime.Length; ++_j) { __EliminateTime[_j] = builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.EliminateTime[_j], key) : _o.EliminateTime[_j])); }
    ...
    if (_o.ScenarioOutputConditionId != null) {
      var __ScenarioOutputConditionId = _o.ScenarioOutputConditionId.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
    ...
    if (_o.ConditionScenarioGroupid != null) {
      var __ConditionScenarioGroupid = _o.ConditionScenarioGroupid.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
      _ConditionScenarioGroupid = CreateConditionScenarioGroupidVector(builder, __ConditionScenarioGroupid);
    }
    var _WorldRaidMapEnterOperator = _o.WorldRaidMapEnterOperator == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.WorldRaidMapEnterOperator, key) : _o.WorldRaidMapEnterOperator));
		var _UseFavorRankBuff = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.UseFavorRankBuff, key) : _o.UseFavorRankBuff;
    return CreateWorldRaidSeasonManageExcel(
      ...
      TableEncryptionService.UseEncryption ? _EnterTicket : _o.EnterTicket,
      _WorldRaidLobbyScene,
      _WorldRaidLobbyBanner,
      _WorldRaidLobbyBG,
      TableEncryptionService.UseEncryption ? _WorldRaidLobbyBannerShow : _o.WorldRaidLobbyBannerShow,
      TableEncryptionService.UseEncryption ? _SeasonOpenCondition : _o.SeasonOpenCondition,
      TableEncryptionService.UseEncryption ? _WorldRaidLobbyEnterScenario : _o.WorldRaidLobbyEnterScenario,
      TableEncryptionService.UseEncryption ? _CanPlayNotSeasonTime : _o.CanPlayNotSeasonTime,
      TableEncryptionService.UseEncryption ? _WorldRaidUniqueThemeLobbyUI : _o.WorldRaidUniqueThemeLobbyUI,
      _WorldRaidUniqueThemeName,
      TableEncryptionService.UseEncryption ? _CanWorldRaidGemEnter : _o.CanWorldRaidGemEnter,
...
public class WorldRaidSeasonManageExcelT
{
  ...
  public Global.CurrencyTypes EnterTicket { get; set; }
  ...
  public WorldRaidSeasonManageExcelT() {
    ...
    this.EnterTicket = Global.CurrencyTypes.Invalid;
...
static public class WorldRaidSeasonManageExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*EnterTicket*/, 4 /*Global.CurrencyTypes*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 32 /*HideWorldRaidBossCompleteRewardUI*/, 1 /*bool*/, 1, false)
      && verifier.VerifyField(tablePos, 34 /*UseWorldRaidCommonToast*/, 1 /*bool*/, 1, false)
      && verifier.VerifyVectorOfData(tablePos, 36 /*OpenRaidBossGroupId*/, 8 /*long*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 38 /*BossSpawnTime*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 40 /*EliminateTime*/, false)
      && verifier.VerifyVectorOfData(tablePos, 42 /*ScenarioOutputConditionId*/, 8 /*long*/, false)
      && verifier.VerifyVectorOfData(tablePos, 44 /*ConditionScenarioGroupid*/, 8 /*long*/, false)
      && verifier.VerifyString(tablePos, 46 /*WorldRaidMapEnterOperator*/, false)
      && verifier.VerifyField(tablePos, 48 /*UseFavorRankBuff*/, 1 /*bool*/, 1, false)
