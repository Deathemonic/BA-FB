...
public struct MiniGameRoadPuzzleRailSetRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.MiniGameRoadPuzzleRailSetRewardExcel> CreateMiniGameRoadPuzzleRailSetRewardExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.MiniGameRoadPuzzleRailSetRewardExcel> EndMiniGameRoadPuzzleRailSetRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.MiniGameRoadPuzzleRailSetRewardExcel>(o);
  }
  ...
  public static Offset<Global.MiniGameRoadPuzzleRailSetRewardExcel> Pack(FlatBufferBuilder builder, MiniGameRoadPuzzleRailSetRewardExcelT _o) {
    if (_o == null) return default(Offset<Global.MiniGameRoadPuzzleRailSetRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("MiniGameRoadPuzzleRailSetReward");
