...
public struct RaidStageRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.RaidStageRewardExcel> CreateRaidStageRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static Offset<Global.RaidStageRewardExcel> EndRaidStageRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.RaidStageRewardExcel>(o);
  }
  ...
  public static Offset<Global.RaidStageRewardExcel> Pack(FlatBufferBuilder builder, RaidStageRewardExcelT _o) {
    if (_o == null) return default(Offset<Global.RaidStageRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("RaidStageReward");
