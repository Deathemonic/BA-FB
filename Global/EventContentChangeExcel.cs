...
public struct EventContentChangeExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(EventContentChangeExcelT _o) {
    ...
    _o.ChangeCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ChangeCount, key) : this.ChangeCount;
    _o.IsLast = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.IsLast, key) : this.IsLast;
    ...
    _o.ChangeCostType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ChangeCostType, key) : this.ChangeCostType;
    _o.ChangeCostId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ChangeCostId, key) : this.ChangeCostId;
    _o.ChangeCostAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ChangeCostAmount, key) : this.ChangeCostAmount;
  }
  public static Offset<Global.EventContentChangeExcel> Pack(FlatBufferBuilder builder, EventContentChangeExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentChangeExcel>);
		...
		var _ChangeCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ChangeCount, key) : _o.ChangeCount;
		var _IsLast = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IsLast, key) : _o.IsLast;
		...
		var _ChangeCostType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ChangeCostType, key) : _o.ChangeCostType;
		var _ChangeCostId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ChangeCostId, key) : _o.ChangeCostId;
		var _ChangeCostAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ChangeCostAmount, key) : _o.ChangeCostAmount;
