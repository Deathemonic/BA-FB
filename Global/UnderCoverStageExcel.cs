...
public struct UnderCoverStageExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(UnderCoverStageExcelT _o) {
    ...
    _o.StageTryCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StageTryCount, key) : this.StageTryCount;
    _o.ApplySkip = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ApplySkip, key) : this.ApplySkip;
    _o.SkipCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SkipCount, key) : this.SkipCount;
    _o.ShowClearScene = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ShowClearScene, key) : this.ShowClearScene;
    _o.StageTips = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StageTips, key) : this.StageTips;
    _o.StageName = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StageName, key) : this.StageName;
  }
  public static Offset<Global.UnderCoverStageExcel> Pack(FlatBufferBuilder builder, UnderCoverStageExcelT _o) {
    ...
    var _StageNameFile = _o.StageNameFile == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.StageNameFile, key) : _o.StageNameFile));
		var _StageTryCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StageTryCount, key) : _o.StageTryCount;
		var _ApplySkip = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ApplySkip, key) : _o.ApplySkip;
		var _SkipCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.SkipCount, key) : _o.SkipCount;
		var _ShowClearScene = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ShowClearScene, key) : _o.ShowClearScene;
		var _StageTips = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StageTips, key) : _o.StageTips;
		var _StageName = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StageName, key) : _o.StageName;
