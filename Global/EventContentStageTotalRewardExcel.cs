...
public struct EventContentStageTotalRewardExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(EventContentStageTotalRewardExcelT _o) {
    ...
    _o.RequiredEventItemAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.RequiredEventItemAmount, key) : this.RequiredEventItemAmount;
  ...
  public static Offset<Global.EventContentStageTotalRewardExcel> Pack(FlatBufferBuilder builder, EventContentStageTotalRewardExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentStageTotalRewardExcel>);
		...
		var _RequiredEventItemAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.RequiredEventItemAmount, key) : _o.RequiredEventItemAmount;
