...
public struct EventContentStageTotalRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.EventContentStageTotalRewardExcel> CreateEventContentStageTotalRewardExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Global.EventContentStageTotalRewardExcel> EndEventContentStageTotalRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.EventContentStageTotalRewardExcel>(o);
  }
  ...
  public static Offset<Global.EventContentStageTotalRewardExcel> Pack(FlatBufferBuilder builder, EventContentStageTotalRewardExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentStageTotalRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentStageTotalReward");
