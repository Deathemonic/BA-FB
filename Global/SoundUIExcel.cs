...
public struct SoundUIExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.SoundUIExcel> Pack(FlatBufferBuilder builder, SoundUIExcelT _o) {
    ...
    var _SoundUniqueId = _o.SoundUniqueId == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.SoundUniqueId, key) : _o.SoundUniqueId));
    var _Path = _o.Path == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.Path, key) : _o.Path));
