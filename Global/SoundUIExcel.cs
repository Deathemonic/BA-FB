...
public struct SoundUIExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.SoundUIExcel> CreateSoundUIExcel(FlatBufferBuilder builder,
      long ID = 0,
  ...
  public static Offset<Global.SoundUIExcel> EndSoundUIExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.SoundUIExcel>(o);
  }
  ...
  public void UnPackTo(SoundUIExcelT _o) {
    ...
    _o.SoundUniqueId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SoundUniqueId, key) : this.SoundUniqueId;
    _o.Path = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Path, key) : this.Path;
  }
  public static Offset<Global.SoundUIExcel> Pack(FlatBufferBuilder builder, SoundUIExcelT _o) {
    if (_o == null) return default(Offset<Global.SoundUIExcel>);
		byte[] key = TableEncryptionService.CreateKey("SoundUI");
		var _ID = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ID, key) : _o.ID;
    var _SoundUniqueId = _o.SoundUniqueId == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.SoundUniqueId, key) : _o.SoundUniqueId));
    var _Path = _o.Path == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.Path, key) : _o.Path));
