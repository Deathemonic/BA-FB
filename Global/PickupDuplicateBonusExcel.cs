...
public struct PickupDuplicateBonusExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(PickupDuplicateBonusExcelT _o) {
    ...
    _o.ShopCategoryType = TableEncryptionService.UseEncryption ? (Global.ShopCategoryType)TableEncryptionService.Convert((int)this.ShopCategoryType, key) : this.ShopCategoryType;
    _o.ShopId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ShopId, key) : this.ShopId;
  ...
  public static Offset<Global.PickupDuplicateBonusExcel> Pack(FlatBufferBuilder builder, PickupDuplicateBonusExcelT _o) {
    if (_o == null) return default(Offset<Global.PickupDuplicateBonusExcel>);
		...
		var _ShopCategoryType = TableEncryptionService.UseEncryption ? (Global.ShopCategoryType)TableEncryptionService.Convert((int)_o.ShopCategoryType, key) : _o.ShopCategoryType;
		var _ShopId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ShopId, key) : _o.ShopId;
