...
public struct WorldRaidConditionExcel : IFlatbufferObject
{
  ...
  public Global.MultipleConditionCheckType MultipleConditionCheckType { get { int o = __p.__offset(16); return o != 0 ? (Global.MultipleConditionCheckType)__p.bb.GetInt(o + __p.bb_pos) : Global.MultipleConditionCheckType.And; } }
  ...
  public static Offset<Global.WorldRaidConditionExcel> CreateWorldRaidConditionExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddMultipleConditionCheckType(FlatBufferBuilder builder, Global.MultipleConditionCheckType multipleConditionCheckType) { builder.AddInt(6, (int)multipleConditionCheckType, 0); }
  ...
  public static Offset<Global.WorldRaidConditionExcel> EndWorldRaidConditionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.WorldRaidConditionExcel>(o);
  }
  ...
  public void UnPackTo(WorldRaidConditionExcelT _o) {
    ...
    for (var _j = 0; _j < this.ScenarioModeIdLength; ++_j) {_o.ScenarioModeId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ScenarioModeId(_j), key) : this.ScenarioModeId(_j));}
    _o.CampaignStageID = new List<long>();
    for (var _j = 0; _j < this.CampaignStageIDLength; ++_j) {_o.CampaignStageID.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.CampaignStageID(_j), key) : this.CampaignStageID(_j));}
    ...
    _o.AfterWhenDate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.AfterWhenDate, key) : this.AfterWhenDate;
    _o.WorldRaidBossKill = new List<long>();
    for (var _j = 0; _j < this.WorldRaidBossKillLength; ++_j) {_o.WorldRaidBossKill.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.WorldRaidBossKill(_j), key) : this.WorldRaidBossKill(_j));}
  }
  public static Offset<Global.WorldRaidConditionExcel> Pack(FlatBufferBuilder builder, WorldRaidConditionExcelT _o) {
    if (_o == null) return default(Offset<Global.WorldRaidConditionExcel>);
		byte[] key = TableEncryptionService.CreateKey("WorldRaidCondition");
    ...
    if (_o.ScenarioModeId != null) {
      var __ScenarioModeId = _o.ScenarioModeId.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
    ...
    if (_o.CampaignStageID != null) {
      var __CampaignStageID = _o.CampaignStageID.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
    ...
    var _AfterWhenDate = _o.AfterWhenDate == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.AfterWhenDate, key) : _o.AfterWhenDate));
    var _WorldRaidBossKill = default(VectorOffset);
    if (_o.WorldRaidBossKill != null) {
      var __WorldRaidBossKill = _o.WorldRaidBossKill.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
...
static public class WorldRaidConditionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 16 /*MultipleConditionCheckType*/, 4 /*Global.MultipleConditionCheckType*/, 4, false)
