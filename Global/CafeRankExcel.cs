...
public struct CafeRankExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.CafeRankExcel> CreateCafeRankExcel(FlatBufferBuilder builder,
      long CafeId = 0,
      long Rank = 0,
      long RecipeId = 0,
      long ComfortMax = 0,
  ...
  public static Offset<Global.CafeRankExcel> EndCafeRankExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.CafeRankExcel>(o);
  }
  ...
  public void UnPackTo(CafeRankExcelT _o) {
    ...
    _o.ComfortMax = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ComfortMax, key) : this.ComfortMax;
    _o.TagCountMax = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.TagCountMax, key) : this.TagCountMax;
    _o.CharacterVisitMin = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.CharacterVisitMin, key) : this.CharacterVisitMin;
    _o.CharacterVisitMax = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.CharacterVisitMax, key) : this.CharacterVisitMax;
    _o.CafeVisitWeightBase = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.CafeVisitWeightBase, key) : this.CafeVisitWeightBase;
    _o.CafeVisitWeightTagBonusStep = new List<int>();
    for (var _j = 0; _j < this.CafeVisitWeightTagBonusStepLength; ++_j) {_o.CafeVisitWeightTagBonusStep.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.CafeVisitWeightTagBonusStep(_j), key) : this.CafeVisitWeightTagBonusStep(_j));}
    _o.CafeVisitWeightTagBonus = new List<int>();
    for (var _j = 0; _j < this.CafeVisitWeightTagBonusLength; ++_j) {_o.CafeVisitWeightTagBonus.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.CafeVisitWeightTagBonus(_j), key) : this.CafeVisitWeightTagBonus(_j));}
  }
  public static Offset<Global.CafeRankExcel> Pack(FlatBufferBuilder builder, CafeRankExcelT _o) {
    if (_o == null) return default(Offset<Global.CafeRankExcel>);
		byte[] key = TableEncryptionService.CreateKey("CafeRank");
		...
		var _ComfortMax = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ComfortMax, key) : _o.ComfortMax;
		var _TagCountMax = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.TagCountMax, key) : _o.TagCountMax;
		var _CharacterVisitMin = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.CharacterVisitMin, key) : _o.CharacterVisitMin;
		var _CharacterVisitMax = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.CharacterVisitMax, key) : _o.CharacterVisitMax;
		var _CafeVisitWeightBase = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.CafeVisitWeightBase, key) : _o.CafeVisitWeightBase;
    var _CafeVisitWeightTagBonusStep = default(VectorOffset);
    if (_o.CafeVisitWeightTagBonusStep != null) {
      var __CafeVisitWeightTagBonusStep = _o.CafeVisitWeightTagBonusStep.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)x, key) : x).ToArray();
    ...
    if (_o.CafeVisitWeightTagBonus != null) {
      var __CafeVisitWeightTagBonus = _o.CafeVisitWeightTagBonus.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)x, key) : x).ToArray();
    ...
    return CreateCafeRankExcel(
      ...
      TableEncryptionService.UseEncryption ? _ComfortMax : _o.ComfortMax,
      TableEncryptionService.UseEncryption ? _TagCountMax : _o.TagCountMax,
