...
public struct CharacterCalculationLimitExcel : IFlatbufferObject
{
  ...
  public Global.BattleCalculationStat CalculationValue { get { int o = __p.__offset(8); return o != 0 ? (Global.BattleCalculationStat)__p.bb.GetInt(o + __p.bb_pos) : Global.BattleCalculationStat.FinalDamage; } }
  ...
  public static Offset<Global.CharacterCalculationLimitExcel> CreateCharacterCalculationLimitExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddCalculationValue(FlatBufferBuilder builder, Global.BattleCalculationStat calculationValue) { builder.AddInt(2, (int)calculationValue, 0); }
  ...
  public static Offset<Global.CharacterCalculationLimitExcel> EndCharacterCalculationLimitExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.CharacterCalculationLimitExcel>(o);
  }
  ...
  public void UnPackTo(CharacterCalculationLimitExcelT _o) {
    ...
    _o.CalculationValue = TableEncryptionService.UseEncryption ? (Global.BattleCalculationStat)TableEncryptionService.Convert((int)this.CalculationValue, key) : this.CalculationValue;
  ...
  public static Offset<Global.CharacterCalculationLimitExcel> Pack(FlatBufferBuilder builder, CharacterCalculationLimitExcelT _o) {
    if (_o == null) return default(Offset<Global.CharacterCalculationLimitExcel>);
		byte[] key = TableEncryptionService.CreateKey("CharacterCalculationLimit");
		...
		var _CalculationValue = TableEncryptionService.UseEncryption ? (Global.BattleCalculationStat)TableEncryptionService.Convert((int)_o.CalculationValue, key) : _o.CalculationValue;
...
public class CharacterCalculationLimitExcelT
{
  ...
  public Global.BattleCalculationStat CalculationValue { get; set; }
  ...
  public CharacterCalculationLimitExcelT() {
    ...
    this.CalculationValue = Global.BattleCalculationStat.FinalDamage;
    this.MinValue = 0;
    this.MaxValue = 0;
...
static public class CharacterCalculationLimitExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*CalculationValue*/, 4 /*Global.BattleCalculationStat*/, 4, false)
