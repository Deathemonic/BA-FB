...
public struct ProductBattlePassExcel : IFlatbufferObject
{
  ...
  public Global.ParcelType ParcelType(int j) { int o = __p.__offset(18); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Global.ParcelType)0; }
  public int ParcelTypeLength { get { int o = __p.__offset(18); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Global.ParcelType> GetParcelTypeBytes() { return __p.__vector_as_span<Global.ParcelType>(18, 4); }
#else
  public ArraySegment<byte>? GetParcelTypeBytes() { return __p.__vector_as_arraysegment(18); }
#endif
  public Global.ParcelType[] GetParcelTypeArray() { int o = __p.__offset(18); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Global.ParcelType[] a = new Global.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Global.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Global.ProductBattlePassExcel> CreateProductBattlePassExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Global.ProductBattlePassExcel> EndProductBattlePassExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.ProductBattlePassExcel>(o);
  }
  ...
  public static Offset<Global.ProductBattlePassExcel> Pack(FlatBufferBuilder builder, ProductBattlePassExcelT _o) {
    if (_o == null) return default(Offset<Global.ProductBattlePassExcel>);
		byte[] key = TableEncryptionService.CreateKey("ProductBattlePass");
...
static public class ProductBattlePassExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 18 /*ParcelType*/, 4 /*Global.ParcelType*/, false)
