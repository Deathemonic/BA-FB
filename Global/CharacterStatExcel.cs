...
public struct CharacterStatExcel : IFlatbufferObject
{
  ...
  public Global.TerrainAdaptationStat StreetBattleAdaptation { get { int o = __p.__offset(154); return o != 0 ? (Global.TerrainAdaptationStat)__p.bb.GetInt(o + __p.bb_pos) : Global.TerrainAdaptationStat.D; } }
  public Global.TerrainAdaptationStat OutdoorBattleAdaptation { get { int o = __p.__offset(156); return o != 0 ? (Global.TerrainAdaptationStat)__p.bb.GetInt(o + __p.bb_pos) : Global.TerrainAdaptationStat.D; } }
  public Global.TerrainAdaptationStat IndoorBattleAdaptation { get { int o = __p.__offset(158); return o != 0 ? (Global.TerrainAdaptationStat)__p.bb.GetInt(o + __p.bb_pos) : Global.TerrainAdaptationStat.D; } }
  public long RegenCost { get { int o = __p.__offset(160); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }

  public static Offset<Global.CharacterStatExcel> CreateCharacterStatExcel(FlatBufferBuilder builder,
      long CharacterId = 0,
      ...
      Global.TerrainAdaptationStat StreetBattleAdaptation = Global.TerrainAdaptationStat.D,
      Global.TerrainAdaptationStat OutdoorBattleAdaptation = Global.TerrainAdaptationStat.D,
      Global.TerrainAdaptationStat IndoorBattleAdaptation = Global.TerrainAdaptationStat.D,
      long RegenCost = 0) {
  ...
  public static void AddStreetBattleAdaptation(FlatBufferBuilder builder, Global.TerrainAdaptationStat streetBattleAdaptation) { builder.AddInt(75, (int)streetBattleAdaptation, 0); }
  public static void AddOutdoorBattleAdaptation(FlatBufferBuilder builder, Global.TerrainAdaptationStat outdoorBattleAdaptation) { builder.AddInt(76, (int)outdoorBattleAdaptation, 0); }
  public static void AddIndoorBattleAdaptation(FlatBufferBuilder builder, Global.TerrainAdaptationStat indoorBattleAdaptation) { builder.AddInt(77, (int)indoorBattleAdaptation, 0); }
  public static void AddRegenCost(FlatBufferBuilder builder, long regenCost) { builder.AddLong(78, regenCost, 0); }
  public static Offset<Global.CharacterStatExcel> EndCharacterStatExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.CharacterStatExcel>(o);
  }
  ...
  public static Offset<Global.CharacterStatExcel> Pack(FlatBufferBuilder builder, CharacterStatExcelT _o) {
    if (_o == null) return default(Offset<Global.CharacterStatExcel>);
		byte[] key = TableEncryptionService.CreateKey("CharacterStat");
		var _CharacterId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CharacterId, key) : _o.CharacterId;
		var _StabilityRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StabilityRate, key) : _o.StabilityRate;
		var _StabilityPoint = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StabilityPoint, key) : _o.StabilityPoint;
		var _AttackPower1 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.AttackPower1, key) : _o.AttackPower1;
		var _AttackPower100 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.AttackPower100, key) : _o.AttackPower100;
		var _MaxHP1 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MaxHP1, key) : _o.MaxHP1;
		var _MaxHP100 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MaxHP100, key) : _o.MaxHP100;
		var _DefensePower1 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DefensePower1, key) : _o.DefensePower1;
		var _DefensePower100 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DefensePower100, key) : _o.DefensePower100;
		var _HealPower1 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.HealPower1, key) : _o.HealPower1;
		...
		var _DodgePoint = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DodgePoint, key) : _o.DodgePoint;
		var _AccuracyPoint = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.AccuracyPoint, key) : _o.AccuracyPoint;
		var _CriticalPoint = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CriticalPoint, key) : _o.CriticalPoint;
		var _CriticalResistPoint = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CriticalResistPoint, key) : _o.CriticalResistPoint;
		var _CriticalDamageRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CriticalDamageRate, key) : _o.CriticalDamageRate;
		var _CriticalDamageResistRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CriticalDamageResistRate, key) : _o.CriticalDamageResistRate;
		var _BlockRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.BlockRate, key) : _o.BlockRate;
		var _HealEffectivenessRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.HealEffectivenessRate, key) : _o.HealEffectivenessRate;
		var _OppressionPower = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.OppressionPower, key) : _o.OppressionPower;
		var _OppressionResist = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.OppressionResist, key) : _o.OppressionResist;
		var _DefensePenetration1 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DefensePenetration1, key) : _o.DefensePenetration1;
		var _DefensePenetration100 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DefensePenetration100, key) : _o.DefensePenetration100;
		var _DefensePenetrationResist1 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DefensePenetrationResist1, key) : _o.DefensePenetrationResist1;
		var _DefensePenetrationResist100 = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DefensePenetrationResist100, key) : _o.DefensePenetrationResist100;
		var _EnhanceExplosionRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EnhanceExplosionRate, key) : _o.EnhanceExplosionRate;
		var _EnhancePierceRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EnhancePierceRate, key) : _o.EnhancePierceRate;
		var _EnhanceMysticRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EnhanceMysticRate, key) : _o.EnhanceMysticRate;
		var _EnhanceSonicRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EnhanceSonicRate, key) : _o.EnhanceSonicRate;
		var _EnhanceSiegeRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EnhanceSiegeRate, key) : _o.EnhanceSiegeRate;
		var _EnhanceNormalRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EnhanceNormalRate, key) : _o.EnhanceNormalRate;
		var _EnhanceLightArmorRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EnhanceLightArmorRate, key) : _o.EnhanceLightArmorRate;
		var _EnhanceHeavyArmorRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EnhanceHeavyArmorRate, key) : _o.EnhanceHeavyArmorRate;
		var _EnhanceUnarmedRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EnhanceUnarmedRate, key) : _o.EnhanceUnarmedRate;
		var _EnhanceElasticArmorRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EnhanceElasticArmorRate, key) : _o.EnhanceElasticArmorRate;
		var _EnhanceStructureRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EnhanceStructureRate, key) : _o.EnhanceStructureRate;
		var _EnhanceNormalArmorRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EnhanceNormalArmorRate, key) : _o.EnhanceNormalArmorRate;
		var _ExtendBuffDuration = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ExtendBuffDuration, key) : _o.ExtendBuffDuration;
		var _ExtendDebuffDuration = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ExtendDebuffDuration, key) : _o.ExtendDebuffDuration;
		var _ExtendCrowdControlDuration = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ExtendCrowdControlDuration, key) : _o.ExtendCrowdControlDuration;
		var _AmmoCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.AmmoCount, key) : _o.AmmoCount;
		var _AmmoCost = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.AmmoCost, key) : _o.AmmoCost;
		var _IgnoreDelayCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IgnoreDelayCount, key) : _o.IgnoreDelayCount;
		var _NormalAttackSpeed = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.NormalAttackSpeed, key) : _o.NormalAttackSpeed;
		var _Range = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Range, key) : _o.Range;
		var _InitialRangeRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.InitialRangeRate, key) : _o.InitialRangeRate;
		var _MoveSpeed = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MoveSpeed, key) : _o.MoveSpeed;
		var _SightPoint = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.SightPoint, key) : _o.SightPoint;
		var _ActiveGauge = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ActiveGauge, key) : _o.ActiveGauge;
		var _GroggyGauge = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.GroggyGauge, key) : _o.GroggyGauge;
		var _GroggyTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.GroggyTime, key) : _o.GroggyTime;
		var _StrategyMobility = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StrategyMobility, key) : _o.StrategyMobility;
		var _ActionCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ActionCount, key) : _o.ActionCount;
		var _StrategySightRange = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StrategySightRange, key) : _o.StrategySightRange;
		var _DamageRatio = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DamageRatio, key) : _o.DamageRatio;
		var _DamagedRatio = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DamagedRatio, key) : _o.DamagedRatio;
		var _DamageRatio2Increase = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DamageRatio2Increase, key) : _o.DamageRatio2Increase;
		var _DamageRatio2Decrease = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DamageRatio2Decrease, key) : _o.DamageRatio2Decrease;
		var _DamagedRatio2Increase = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DamagedRatio2Increase, key) : _o.DamagedRatio2Increase;
		var _DamagedRatio2Decrease = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DamagedRatio2Decrease, key) : _o.DamagedRatio2Decrease;
		var _ExDamagedRatioIncrease = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ExDamagedRatioIncrease, key) : _o.ExDamagedRatioIncrease;
		var _ExDamagedRatioDecrease = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ExDamagedRatioDecrease, key) : _o.ExDamagedRatioDecrease;
		var _EnhanceExDamageRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EnhanceExDamageRate, key) : _o.EnhanceExDamageRate;
		var _ReduceExDamagedRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ReduceExDamagedRate, key) : _o.ReduceExDamagedRate;
		var _HealRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.HealRate, key) : _o.HealRate;
		var _HealLightArmorRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.HealLightArmorRate, key) : _o.HealLightArmorRate;
		var _HealHeavyArmorRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.HealHeavyArmorRate, key) : _o.HealHeavyArmorRate;
		var _HealUnarmedRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.HealUnarmedRate, key) : _o.HealUnarmedRate;
		var _HealElasticArmorRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.HealElasticArmorRate, key) : _o.HealElasticArmorRate;
		var _HealNormalArmorRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.HealNormalArmorRate, key) : _o.HealNormalArmorRate;
		var _HealedExplosionRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.HealedExplosionRate, key) : _o.HealedExplosionRate;
		var _HealedPierceRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.HealedPierceRate, key) : _o.HealedPierceRate;
		var _HealedMysticRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.HealedMysticRate, key) : _o.HealedMysticRate;
		var _HealedSonicRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.HealedSonicRate, key) : _o.HealedSonicRate;
		var _HealedNormalRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.HealedNormalRate, key) : _o.HealedNormalRate;
		var _StreetBattleAdaptation = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StreetBattleAdaptation, key) : _o.StreetBattleAdaptation;
		var _OutdoorBattleAdaptation = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.OutdoorBattleAdaptation, key) : _o.OutdoorBattleAdaptation;
		var _IndoorBattleAdaptation = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IndoorBattleAdaptation, key) : _o.IndoorBattleAdaptation;
		var _RegenCost = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RegenCost, key) : _o.RegenCost;
...
public class CharacterStatExcelT
{
  ...
  public Global.TerrainAdaptationStat StreetBattleAdaptation { get; set; }
  public Global.TerrainAdaptationStat OutdoorBattleAdaptation { get; set; }
  public Global.TerrainAdaptationStat IndoorBattleAdaptation { get; set; }
  ...
  public CharacterStatExcelT() {
    ...
    this.StreetBattleAdaptation = Global.TerrainAdaptationStat.D;
    this.OutdoorBattleAdaptation = Global.TerrainAdaptationStat.D;
    this.IndoorBattleAdaptation = Global.TerrainAdaptationStat.D;
    this.RegenCost = 0;
  }
}
...
static public class CharacterStatExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 154 /*StreetBattleAdaptation*/, 4 /*Global.TerrainAdaptationStat*/, 4, false)
      && verifier.VerifyField(tablePos, 156 /*OutdoorBattleAdaptation*/, 4 /*Global.TerrainAdaptationStat*/, 4, false)
      && verifier.VerifyField(tablePos, 158 /*IndoorBattleAdaptation*/, 4 /*Global.TerrainAdaptationStat*/, 4, false)
