...
public struct KeyMappingExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.KeyMappingExcel> Pack(FlatBufferBuilder builder, KeyMappingExcelT _o) {
    if (_o == null) return default(Offset<Global.KeyMappingExcel>);
		byte[] key = TableEncryptionService.CreateKey("KeyMapping");
    var _Id = _o.Id == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.Id, key) : _o.Id));
    var _TargetKeyCode = _o.TargetKeyCode == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.TargetKeyCode, key) : _o.TargetKeyCode));
		var _isDisplay = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IsDisplay, key) : _o.IsDisplay;
		var _isUsed = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IsUsed, key) : _o.IsUsed;
		var _isLongPress = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IsLongPress, key) : _o.IsLongPress;
		var _IgnorePosCheck = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IgnorePosCheck, key) : _o.IgnorePosCheck;
		var _IconPositionX = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IconPositionX, key) : _o.IconPositionX;
		var _IconPositionY = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IconPositionY, key) : _o.IconPositionY;
		var _IconScaleX = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IconScaleX, key) : _o.IconScaleX;
		var _IconScaleY = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IconScaleY, key) : _o.IconScaleY;
