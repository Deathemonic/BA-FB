...
public struct PropVector3 : IFlatbufferObject
{
  ...
  public static Offset<Global.PropVector3> CreatePropVector3(FlatBufferBuilder builder,
      float X = 0.0f,
      float Y = 0.0f,
      float Z = 0.0f) {
  ...
  public static Offset<Global.PropVector3> EndPropVector3(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.PropVector3>(o);
  }
  ...
  public void UnPackTo(PropVector3T _o) {
		byte[] key = TableEncryptionService.CreateKey("PropVe");
  ...
  public static Offset<Global.PropVector3> Pack(FlatBufferBuilder builder, PropVector3T _o) {
    if (_o == null) return default(Offset<Global.PropVector3>);
		byte[] key = TableEncryptionService.CreateKey("PropVe");
