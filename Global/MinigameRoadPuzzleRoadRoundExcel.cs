...
public struct MinigameRoadPuzzleRoadRoundExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.MinigameRoadPuzzleRoadRoundExcel> CreateMinigameRoadPuzzleRoadRoundExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.MinigameRoadPuzzleRoadRoundExcel> EndMinigameRoadPuzzleRoadRoundExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.MinigameRoadPuzzleRoadRoundExcel>(o);
  }
  ...
  public static Offset<Global.MinigameRoadPuzzleRoadRoundExcel> Pack(FlatBufferBuilder builder, MinigameRoadPuzzleRoadRoundExcelT _o) {
    if (_o == null) return default(Offset<Global.MinigameRoadPuzzleRoadRoundExcel>);
		byte[] key = TableEncryptionService.CreateKey("MinigameRoadPuzzleRoadRound");
		...
		var _EndScenarioGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EndScenarioGroupId, key) : _o.EndScenarioGroupId;
		var _MapGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MapGroupId, key) : _o.MapGroupId;
		var _RoundReward = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RoundReward, key) : _o.RoundReward;
    var _AdditionalRewardID = default(VectorOffset);
    if (_o.AdditionalRewardID != null) {
      var __AdditionalRewardID = _o.AdditionalRewardID.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.AdditionalRewardAmount != null) {
      var __AdditionalRewardAmount = _o.AdditionalRewardAmount.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
