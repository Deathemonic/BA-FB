...
public struct MiniGameDreamReplayScenarioExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.MiniGameDreamReplayScenarioExcel> CreateMiniGameDreamReplayScenarioExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.MiniGameDreamReplayScenarioExcel> EndMiniGameDreamReplayScenarioExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.MiniGameDreamReplayScenarioExcel>(o);
  }
  ...
  public void UnPackTo(MiniGameDreamReplayScenarioExcelT _o) {
    ...
    _o.ReplaySummaryTitleLocalize = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)this.ReplaySummaryTitleLocalize, key) : this.ReplaySummaryTitleLocalize;
    _o.ReplaySummaryLocalizeScenarioId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)this.ReplaySummaryLocalizeScenarioId, key) : this.ReplaySummaryLocalizeScenarioId;
    _o.ReplayScenarioResource = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ReplayScenarioResource, key) : this.ReplayScenarioResource;
    _o.IsReplayScenarioHorizon = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.IsReplayScenarioHorizon, key) : this.IsReplayScenarioHorizon;
  }
  public static Offset<Global.MiniGameDreamReplayScenarioExcel> Pack(FlatBufferBuilder builder, MiniGameDreamReplayScenarioExcelT _o) {
    if (_o == null) return default(Offset<Global.MiniGameDreamReplayScenarioExcel>);
		byte[] key = TableEncryptionService.CreateKey("MiniGameDreamReplayScenario");
		...
		var _ReplaySummaryTitleLocalize = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)_o.ReplaySummaryTitleLocalize, key) : _o.ReplaySummaryTitleLocalize;
		var _ReplaySummaryLocalizeScenarioId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)_o.ReplaySummaryLocalizeScenarioId, key) : _o.ReplaySummaryLocalizeScenarioId;
    var _ReplayScenarioResource = _o.ReplayScenarioResource == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.ReplayScenarioResource, key) : _o.ReplayScenarioResource));
		var _IsReplayScenarioHorizon = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.IsReplayScenarioHorizon, key) : _o.IsReplayScenarioHorizon;
    return CreateMiniGameDreamReplayScenarioExcel(
      ...
      TableEncryptionService.UseEncryption ? _ReplaySummaryTitleLocalize : _o.ReplaySummaryTitleLocalize,
      TableEncryptionService.UseEncryption ? _ReplaySummaryLocalizeScenarioId : _o.ReplaySummaryLocalizeScenarioId,
      _ReplayScenarioResource,
      TableEncryptionService.UseEncryption ? _IsReplayScenarioHorizon : _o.IsReplayScenarioHorizon);
  }
}
