...
public struct MiniGameDreamReplayScenarioExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(MiniGameDreamReplayScenarioExcelT _o) {
    ...
    _o.ReplaySummaryTitleLocalize = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ReplaySummaryTitleLocalize, key) : this.ReplaySummaryTitleLocalize;
    _o.ReplaySummaryLocalizeScenarioId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ReplaySummaryLocalizeScenarioId, key) : this.ReplaySummaryLocalizeScenarioId;
    ...
    _o.IsReplayScenarioHorizon = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.IsReplayScenarioHorizon, key) : this.IsReplayScenarioHorizon;
  }
  public static Offset<Global.MiniGameDreamReplayScenarioExcel> Pack(FlatBufferBuilder builder, MiniGameDreamReplayScenarioExcelT _o) {
    if (_o == null) return default(Offset<Global.MiniGameDreamReplayScenarioExcel>);
		...
		var _ReplaySummaryTitleLocalize = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ReplaySummaryTitleLocalize, key) : _o.ReplaySummaryTitleLocalize;
		var _ReplaySummaryLocalizeScenarioId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ReplaySummaryLocalizeScenarioId, key) : _o.ReplaySummaryLocalizeScenarioId;
    var _ReplayScenarioResource = _o.ReplayScenarioResource == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ReplayScenarioResource, key) : _o.ReplayScenarioResource));
		var _IsReplayScenarioHorizon = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IsReplayScenarioHorizon, key) : _o.IsReplayScenarioHorizon;
