...
public struct ConquestUnitExcel : IFlatbufferObject
{
  ...
  public Global.ConquestEnemyType EnemyType { get { int o = __p.__offset(22); return o != 0 ? (Global.ConquestEnemyType)__p.bb.GetInt(o + __p.bb_pos) : Global.ConquestEnemyType.None; } }
  public Global.ConquestTeamType Team { get { int o = __p.__offset(24); return o != 0 ? (Global.ConquestTeamType)__p.bb.GetInt(o + __p.bb_pos) : Global.ConquestTeamType.None; } }
  ...
  public Global.StarGoalType StarGoal(int j) { int o = __p.__offset(34); return o != 0 ? (Global.StarGoalType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Global.StarGoalType)0; }
  public int StarGoalLength { get { int o = __p.__offset(34); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Global.StarGoalType> GetStarGoalBytes() { return __p.__vector_as_span<Global.StarGoalType>(34, 4); }
#else
  public ArraySegment<byte>? GetStarGoalBytes() { return __p.__vector_as_arraysegment(34); }
#endif
  public Global.StarGoalType[] GetStarGoalArray() { int o = __p.__offset(34); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Global.StarGoalType[] a = new Global.StarGoalType[l]; for (int i = 0; i < l; i++) { a[i] = (Global.StarGoalType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Global.ParcelType StageEnterCostType { get { int o = __p.__offset(40); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Global.ParcelType.None; } }
  ...
  public Global.ParcelType ManageEchelonStageEnterCostType { get { int o = __p.__offset(46); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Global.ParcelType.None; } }
  ...
  public Global.StageTopography StageTopography { get { int o = __p.__offset(58); return o != 0 ? (Global.StageTopography)__p.bb.GetInt(o + __p.bb_pos) : Global.StageTopography.Street; } }
  ...
  public static Offset<Global.ConquestUnitExcel> CreateConquestUnitExcel(FlatBufferBuilder builder,
      long Id = 0,
      uint Key = 0,
      ...
      Global.ConquestEnemyType EnemyType = Global.ConquestEnemyType.None,
      Global.ConquestTeamType Team = Global.ConquestTeamType.None,
      long UnitGroup = 0,
      ...
      Global.ParcelType ManageEchelonStageEnterCostType = Global.ParcelType.None,
  ...
  public static void AddEnemyType(FlatBufferBuilder builder, Global.ConquestEnemyType enemyType) { builder.AddInt(9, (int)enemyType, 0); }
  public static void AddTeam(FlatBufferBuilder builder, Global.ConquestTeamType team) { builder.AddInt(10, (int)team, 0); }
  ...
  public static void AddStageEnterCostType(FlatBufferBuilder builder, Global.ParcelType stageEnterCostType) { builder.AddInt(18, (int)stageEnterCostType, 0); }
  ...
  public static void AddManageEchelonStageEnterCostType(FlatBufferBuilder builder, Global.ParcelType manageEchelonStageEnterCostType) { builder.AddInt(21, (int)manageEchelonStageEnterCostType, 0); }
  ...
  public static void AddStageTopography(FlatBufferBuilder builder, Global.StageTopography stageTopography) { builder.AddInt(27, (int)stageTopography, 0); }
  ...
  public static Offset<Global.ConquestUnitExcel> EndConquestUnitExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.ConquestUnitExcel>(o);
  }
  ...
  public static Offset<Global.ConquestUnitExcel> Pack(FlatBufferBuilder builder, ConquestUnitExcelT _o) {
    if (_o == null) return default(Offset<Global.ConquestUnitExcel>);
		byte[] key = TableEncryptionService.CreateKey("ConquestUnit");
...
public class ConquestUnitExcelT
{
  ...
  public Global.ConquestEnemyType EnemyType { get; set; }
  public Global.ConquestTeamType Team { get; set; }
  ...
  public Global.ParcelType ManageEchelonStageEnterCostType { get; set; }
  ...
  public ConquestUnitExcelT() {
    ...
    this.EnemyType = Global.ConquestEnemyType.None;
    this.Team = Global.ConquestTeamType.None;
    this.UnitGroup = 0;
    ...
    this.ManageEchelonStageEnterCostType = Global.ParcelType.None;
...
static public class ConquestUnitExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 22 /*EnemyType*/, 4 /*Global.ConquestEnemyType*/, 4, false)
      && verifier.VerifyField(tablePos, 24 /*Team*/, 4 /*Global.ConquestTeamType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 34 /*StarGoal*/, 4 /*Global.StarGoalType*/, false)
      ...
      && verifier.VerifyField(tablePos, 40 /*StageEnterCostType*/, 4 /*Global.ParcelType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 46 /*ManageEchelonStageEnterCostType*/, 4 /*Global.ParcelType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 58 /*StageTopography*/, 4 /*Global.StageTopography*/, 4, false)
