...
public struct ConquestUnitExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ConquestUnitExcelT _o) {
    ...
    _o.EnemyType = TableEncryptionService.UseEncryption ? (Global.ConquestEnemyType)TableEncryptionService.Convert((int)this.EnemyType, key) : this.EnemyType;
    _o.Team = TableEncryptionService.UseEncryption ? (Global.ConquestTeamType)TableEncryptionService.Convert((int)this.Team, key) : this.Team;
    ...
    _o.ManageEchelonStageEnterCostType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)this.ManageEchelonStageEnterCostType, key) : this.ManageEchelonStageEnterCostType;
  ...
  public static Offset<Global.ConquestUnitExcel> Pack(FlatBufferBuilder builder, ConquestUnitExcelT _o) {
    ...
    var _PointAnimation = _o.PointAnimation == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.PointAnimation, key) : _o.PointAnimation));
		var _EnemyType = TableEncryptionService.UseEncryption ? (Global.ConquestEnemyType)TableEncryptionService.Convert((int)_o.EnemyType, key) : _o.EnemyType;
		var _Team = TableEncryptionService.UseEncryption ? (Global.ConquestTeamType)TableEncryptionService.Convert((int)_o.Team, key) : _o.Team;
    ...
    if (_o.StarGoalAmount != null) {
      ...
      _StarGoalAmount = CreateStarGoalAmountVector(builder, __StarGoalAmount);
		...
		var _ManageEchelonStageEnterCostType = TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)_o.ManageEchelonStageEnterCostType, key) : _o.ManageEchelonStageEnterCostType;
