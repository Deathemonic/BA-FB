...
public struct EventContentZoneVisitRewardExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(EventContentZoneVisitRewardExcelT _o) {
    ...
    _o.EventContentLocationId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EventContentLocationId, key) : this.EventContentLocationId;
    ...
    for (var _j = 0; _j < this.VisitRewardParcelTypeLength; ++_j) {_o.VisitRewardParcelType.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.VisitRewardParcelType(_j), key) : this.VisitRewardParcelType(_j));}
    _o.VisitRewardParcelId = new List<long>();
    for (var _j = 0; _j < this.VisitRewardParcelIdLength; ++_j) {_o.VisitRewardParcelId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.VisitRewardParcelId(_j), key) : this.VisitRewardParcelId(_j));}
    _o.VisitRewardAmount = new List<long>();
    for (var _j = 0; _j < this.VisitRewardAmountLength; ++_j) {_o.VisitRewardAmount.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.VisitRewardAmount(_j), key) : this.VisitRewardAmount(_j));}
    _o.VisitRewardProb = new List<long>();
    for (var _j = 0; _j < this.VisitRewardProbLength; ++_j) {_o.VisitRewardProb.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.VisitRewardProb(_j), key) : this.VisitRewardProb(_j));}
  }
  public static Offset<Global.EventContentZoneVisitRewardExcel> Pack(FlatBufferBuilder builder, EventContentZoneVisitRewardExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentZoneVisitRewardExcel>);
		...
		var _EventContentLocationId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EventContentLocationId, key) : _o.EventContentLocationId;
