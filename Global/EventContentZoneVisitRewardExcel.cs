...
public struct EventContentZoneVisitRewardExcel : IFlatbufferObject
{
  ...
  public Global.ParcelType VisitRewardParcelType(int j) { int o = __p.__offset(14); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Global.ParcelType)0; }
  public int VisitRewardParcelTypeLength { get { int o = __p.__offset(14); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Global.ParcelType> GetVisitRewardParcelTypeBytes() { return __p.__vector_as_span<Global.ParcelType>(14, 4); }
#else
  public ArraySegment<byte>? GetVisitRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(14); }
#endif
  public Global.ParcelType[] GetVisitRewardParcelTypeArray() { int o = __p.__offset(14); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Global.ParcelType[] a = new Global.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Global.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Global.EventContentZoneVisitRewardExcel> CreateEventContentZoneVisitRewardExcel(FlatBufferBuilder builder,
  ...
  public static VectorOffset CreateVisitRewardParcelTypeVector(FlatBufferBuilder builder, Global.ParcelType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateVisitRewardParcelTypeVectorBlock(FlatBufferBuilder builder, Global.ParcelType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateVisitRewardParcelTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Global.ParcelType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateVisitRewardParcelTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Global.ParcelType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Global.EventContentZoneVisitRewardExcel> EndEventContentZoneVisitRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.EventContentZoneVisitRewardExcel>(o);
  }
  ...
  public void UnPackTo(EventContentZoneVisitRewardExcelT _o) {
    ...
    _o.EventContentLocationId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.EventContentLocationId, key) : this.EventContentLocationId;
    ...
    _o.CharacterDevName = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CharacterDevName, key) : this.CharacterDevName;
    _o.VisitRewardParcelType = new List<Global.ParcelType>();
    for (var _j = 0; _j < this.VisitRewardParcelTypeLength; ++_j) {_o.VisitRewardParcelType.Add(TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)this.VisitRewardParcelType(_j), key) : this.VisitRewardParcelType(_j));}
    _o.VisitRewardParcelId = new List<long>();
    for (var _j = 0; _j < this.VisitRewardParcelIdLength; ++_j) {_o.VisitRewardParcelId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.VisitRewardParcelId(_j), key) : this.VisitRewardParcelId(_j));}
    _o.VisitRewardAmount = new List<long>();
    for (var _j = 0; _j < this.VisitRewardAmountLength; ++_j) {_o.VisitRewardAmount.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.VisitRewardAmount(_j), key) : this.VisitRewardAmount(_j));}
    _o.VisitRewardProb = new List<long>();
    for (var _j = 0; _j < this.VisitRewardProbLength; ++_j) {_o.VisitRewardProb.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.VisitRewardProb(_j), key) : this.VisitRewardProb(_j));}
  }
  public static Offset<Global.EventContentZoneVisitRewardExcel> Pack(FlatBufferBuilder builder, EventContentZoneVisitRewardExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentZoneVisitRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentZoneVisitReward");
		...
		var _EventContentLocationId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.EventContentLocationId, key) : _o.EventContentLocationId;
    ...
    var _CharacterDevName = _o.CharacterDevName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.CharacterDevName, key) : _o.CharacterDevName));
    var _visitRewardParcelType = default(VectorOffset);
    if (_o.VisitRewardParcelType != null) {
      var __visitRewardParcelType = _o.VisitRewardParcelType.Select(x => TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)x, key) : x).ToArray();
    ...
    if (_o.VisitRewardParcelId != null) {
      var __visitRewardParcelId = _o.VisitRewardParcelId.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
    ...
    if (_o.VisitRewardAmount != null) {
      var __visitRewardAmount = _o.VisitRewardAmount.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
    ...
    if (_o.VisitRewardProb != null) {
      var __visitRewardProb = _o.VisitRewardProb.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
    ...
    return CreateEventContentZoneVisitRewardExcel(
      ...
      TableEncryptionService.UseEncryption ? _EventContentLocationId : _o.EventContentLocationId,
      _DevName,
...
public class EventContentZoneVisitRewardExcelT
{
  ...
  public List<Global.ParcelType> VisitRewardParcelType { get; set; }
...
static public class EventContentZoneVisitRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 14 /*VisitRewardParcelType*/, 4 /*Global.ParcelType*/, false)
