...
public struct FarmingDungeonLocationManageExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(FarmingDungeonLocationManageExcelT _o) {
    ...
    _o.FarmingDungeonLocationId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.FarmingDungeonLocationId, key) : this.FarmingDungeonLocationId;
    ...
    _o.SchoolDungeonType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SchoolDungeonType, key) : this.SchoolDungeonType;
    ...
    _o.LocalizeCodeTitle = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.LocalizeCodeTitle, key) : this.LocalizeCodeTitle;
    _o.LocalizeCodeInfo = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.LocalizeCodeInfo, key) : this.LocalizeCodeInfo;
  }
  public static Offset<Global.FarmingDungeonLocationManageExcel> Pack(FlatBufferBuilder builder, FarmingDungeonLocationManageExcelT _o) {
    if (_o == null) return default(Offset<Global.FarmingDungeonLocationManageExcel>);
		byte[] key = TableEncryptionService.CreateKey("FarmingDungeonLocationManage");
		var _FarmingDungeonLocationId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.FarmingDungeonLocationId, key) : _o.FarmingDungeonLocationId;
		...
		var _SchoolDungeonType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.SchoolDungeonType, key) : _o.SchoolDungeonType;
		var _Order = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Order, key) : _o.Order;
    var _OpenStartDateTime = _o.OpenStartDateTime == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.OpenStartDateTime, key) : _o.OpenStartDateTime));
    var _OpenEndDateTime = _o.OpenEndDateTime == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.OpenEndDateTime, key) : _o.OpenEndDateTime));
    var _LocationButtonImagePath = _o.LocationButtonImagePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.LocationButtonImagePath, key) : _o.LocationButtonImagePath));
		var _LocalizeCodeTitle = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.LocalizeCodeTitle, key) : _o.LocalizeCodeTitle;
		var _LocalizeCodeInfo = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.LocalizeCodeInfo, key) : _o.LocalizeCodeInfo;
