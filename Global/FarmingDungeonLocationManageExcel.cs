...
public struct FarmingDungeonLocationManageExcel : IFlatbufferObject
{
  ...
  public Global.ContentType ContentType { get { int o = __p.__offset(6); return o != 0 ? (Global.ContentType)__p.bb.GetInt(o + __p.bb_pos) : Global.ContentType.None; } }
  public Global.WeekDungeonType WeekDungeonType { get { int o = __p.__offset(8); return o != 0 ? (Global.WeekDungeonType)__p.bb.GetInt(o + __p.bb_pos) : Global.WeekDungeonType.None; } }
  public Global.SchoolDungeonType SchoolDungeonType { get { int o = __p.__offset(10); return o != 0 ? (Global.SchoolDungeonType)__p.bb.GetInt(o + __p.bb_pos) : Global.SchoolDungeonType.SchoolA; } }
  ...
  public static Offset<Global.FarmingDungeonLocationManageExcel> CreateFarmingDungeonLocationManageExcel(FlatBufferBuilder builder,
      ...
      Global.SchoolDungeonType SchoolDungeonType = Global.SchoolDungeonType.SchoolA,
      long Order = 0,
  ...
  public static void AddContentType(FlatBufferBuilder builder, Global.ContentType contentType) { builder.AddInt(1, (int)contentType, 0); }
  public static void AddWeekDungeonType(FlatBufferBuilder builder, Global.WeekDungeonType weekDungeonType) { builder.AddInt(2, (int)weekDungeonType, 0); }
  public static void AddSchoolDungeonType(FlatBufferBuilder builder, Global.SchoolDungeonType schoolDungeonType) { builder.AddInt(3, (int)schoolDungeonType, 0); }
  ...
  public static Offset<Global.FarmingDungeonLocationManageExcel> EndFarmingDungeonLocationManageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.FarmingDungeonLocationManageExcel>(o);
  }
  ...
  public void UnPackTo(FarmingDungeonLocationManageExcelT _o) {
    ...
    _o.SchoolDungeonType = TableEncryptionService.UseEncryption ? (Global.SchoolDungeonType)TableEncryptionService.Convert((int)this.SchoolDungeonType, key) : this.SchoolDungeonType;
  ...
  public static Offset<Global.FarmingDungeonLocationManageExcel> Pack(FlatBufferBuilder builder, FarmingDungeonLocationManageExcelT _o) {
    if (_o == null) return default(Offset<Global.FarmingDungeonLocationManageExcel>);
		byte[] key = TableEncryptionService.CreateKey("FarmingDungeonLocationManage");
		...
		var _SchoolDungeonType = TableEncryptionService.UseEncryption ? (Global.SchoolDungeonType)TableEncryptionService.Convert((int)_o.SchoolDungeonType, key) : _o.SchoolDungeonType;
...
public class FarmingDungeonLocationManageExcelT
{
  ...
  public Global.SchoolDungeonType SchoolDungeonType { get; set; }
  ...
  public FarmingDungeonLocationManageExcelT() {
    ...
    this.SchoolDungeonType = Global.SchoolDungeonType.SchoolA;
    this.Order = 0;
...
static public class FarmingDungeonLocationManageExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*ContentType*/, 4 /*Global.ContentType*/, 4, false)
      && verifier.VerifyField(tablePos, 8 /*WeekDungeonType*/, 4 /*Global.WeekDungeonType*/, 4, false)
      && verifier.VerifyField(tablePos, 10 /*SchoolDungeonType*/, 4 /*Global.SchoolDungeonType*/, 4, false)
