...
public struct ShopCashScenarioResourceInfoExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.ShopCashScenarioResourceInfoExcel> CreateShopCashScenarioResourceInfoExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.ShopCashScenarioResourceInfoExcel> EndShopCashScenarioResourceInfoExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.ShopCashScenarioResourceInfoExcel>(o);
  }
  ...
  public void UnPackTo(ShopCashScenarioResourceInfoExcelT _o) {
    ...
    _o.ScenarioResrouceInfoId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ScenarioResrouceInfoId, key) : this.ScenarioResrouceInfoId;
    _o.ShopCashId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ShopCashId, key) : this.ShopCashId;
    _o.IconPath = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.IconPath, key) : this.IconPath;
  }
  public static Offset<Global.ShopCashScenarioResourceInfoExcel> Pack(FlatBufferBuilder builder, ShopCashScenarioResourceInfoExcelT _o) {
    if (_o == null) return default(Offset<Global.ShopCashScenarioResourceInfoExcel>);
		byte[] key = TableEncryptionService.CreateKey("ShopCashScenarioResourceInfo");
		var _ScenarioResrouceInfoId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ScenarioResrouceInfoId, key) : _o.ScenarioResrouceInfoId;
		var _ShopCashId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ShopCashId, key) : _o.ShopCashId;
    ...
    return CreateShopCashScenarioResourceInfoExcel(
      builder,
      TableEncryptionService.UseEncryption ? _ScenarioResrouceInfoId : _o.ScenarioResrouceInfoId,
      TableEncryptionService.UseEncryption ? _ShopCashId : _o.ShopCashId,
      _IconPath);
  }
}
