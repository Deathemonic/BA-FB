...
public struct ShopCashScenarioResourceInfoExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ShopCashScenarioResourceInfoExcelT _o) {
    ...
    _o.ScenarioResrouceInfoId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ScenarioResrouceInfoId, key) : this.ScenarioResrouceInfoId;
    _o.ShopCashId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ShopCashId, key) : this.ShopCashId;
  ...
  public static Offset<Global.ShopCashScenarioResourceInfoExcel> Pack(FlatBufferBuilder builder, ShopCashScenarioResourceInfoExcelT _o) {
    if (_o == null) return default(Offset<Global.ShopCashScenarioResourceInfoExcel>);
		byte[] key = TableEncryptionService.CreateKey("ShopCashScenarioResourceInfo");
		var _ScenarioResrouceInfoId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ScenarioResrouceInfoId, key) : _o.ScenarioResrouceInfoId;
		var _ShopCashId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ShopCashId, key) : _o.ShopCashId;
