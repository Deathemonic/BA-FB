...
public struct MissionEmergencyCompleteExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.MissionEmergencyCompleteExcel> CreateMissionEmergencyCompleteExcel(FlatBufferBuilder builder,
      long MissionId = 0,
  ...
  public static Offset<Global.MissionEmergencyCompleteExcel> EndMissionEmergencyCompleteExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.MissionEmergencyCompleteExcel>(o);
  }
  ...
  public void UnPackTo(MissionEmergencyCompleteExcelT _o) {
    ...
    _o.MissionId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.MissionId, key) : this.MissionId;
    _o.EmergencyComplete = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.EmergencyComplete, key) : this.EmergencyComplete;
  }
  public static Offset<Global.MissionEmergencyCompleteExcel> Pack(FlatBufferBuilder builder, MissionEmergencyCompleteExcelT _o) {
    if (_o == null) return default(Offset<Global.MissionEmergencyCompleteExcel>);
		byte[] key = TableEncryptionService.CreateKey("MissionEmergencyComplete");
		var _MissionId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.MissionId, key) : _o.MissionId;
		var _EmergencyComplete = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.EmergencyComplete, key) : _o.EmergencyComplete;
    return CreateMissionEmergencyCompleteExcel(
      builder,
      TableEncryptionService.UseEncryption ? _MissionId : _o.MissionId,
      TableEncryptionService.UseEncryption ? _EmergencyComplete : _o.EmergencyComplete);
  }
}
