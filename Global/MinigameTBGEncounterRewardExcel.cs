...
public struct MinigameTBGEncounterRewardExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(MinigameTBGEncounterRewardExcelT _o) {
    ...
    _o.TBGOptionSuccessType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.TBGOptionSuccessType, key) : this.TBGOptionSuccessType;
    _o.Paremeter = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Paremeter, key) : this.Paremeter;
    ...
    _o.Amount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Amount, key) : this.Amount;
  ...
  public static Offset<Global.MinigameTBGEncounterRewardExcel> Pack(FlatBufferBuilder builder, MinigameTBGEncounterRewardExcelT _o) {
    if (_o == null) return default(Offset<Global.MinigameTBGEncounterRewardExcel>);
		...
		var _TBGOptionSuccessType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.TBGOptionSuccessType, key) : _o.TBGOptionSuccessType;
		var _Paremeter = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Paremeter, key) : _o.Paremeter;
		...
		var _Amount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Amount, key) : _o.Amount;
