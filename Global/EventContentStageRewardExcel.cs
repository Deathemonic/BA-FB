...
public struct EventContentStageRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.EventContentStageRewardExcel> CreateEventContentStageRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static Offset<Global.EventContentStageRewardExcel> EndEventContentStageRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.EventContentStageRewardExcel>(o);
  }
  public EventContentStageRewardExcelT UnPack() {
    var _o = new EventContentStageRewardExcelT();
    this.UnPackTo(_o);
    return _o;
  }
  ...
  public static Offset<Global.EventContentStageRewardExcel> Pack(FlatBufferBuilder builder, EventContentStageRewardExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentStageRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentStageReward");
