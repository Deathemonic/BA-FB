...
public struct CharacterExcel : IFlatbufferObject
{
  ...
  public Global.Tag Tags(int j) { int o = __p.__offset(120); return o != 0 ? (Global.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Global.Tag)0; }
  public int TagsLength { get { int o = __p.__offset(120); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Global.Tag> GetTagsBytes() { return __p.__vector_as_span<Global.Tag>(120, 4); }
#else
  public ArraySegment<byte>? GetTagsBytes() { return __p.__vector_as_arraysegment(120); }
#endif
  public Global.Tag[] GetTagsArray() { int o = __p.__offset(120); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Global.Tag[] a = new Global.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (Global.Tag)__p.bb.GetInt(p + i * 4); } return a; }
...
static public class CharacterExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 120 /*Tags*/, 4 /*Global.Tag*/, false)
