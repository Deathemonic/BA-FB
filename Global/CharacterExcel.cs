...
public struct CharacterExcel : IFlatbufferObject
{
  ...
  public Global.Rarity Rarity { get { int o = __p.__offset(26); return o != 0 ? (Global.Rarity)__p.bb.GetInt(o + __p.bb_pos) : Global.Rarity.N; } }
  public bool IsNPC { get { int o = __p.__offset(28); return o != 0 ? 0!=__p.bb.Get(o + __p.bb_pos) : (bool)false; } }
  public Global.TacticEntityType TacticEntityType { get { int o = __p.__offset(30); return o != 0 ? (Global.TacticEntityType)__p.bb.GetInt(o + __p.bb_pos) : Global.TacticEntityType.None; } }
  ...
  public Global.TacticRole TacticRole { get { int o = __p.__offset(38); return o != 0 ? (Global.TacticRole)__p.bb.GetInt(o + __p.bb_pos) : Global.TacticRole.None; } }
  public Global.WeaponType WeaponType { get { int o = __p.__offset(40); return o != 0 ? (Global.WeaponType)__p.bb.GetInt(o + __p.bb_pos) : Global.WeaponType.None; } }
  public Global.TacticRange TacticRange { get { int o = __p.__offset(42); return o != 0 ? (Global.TacticRange)__p.bb.GetInt(o + __p.bb_pos) : Global.TacticRange.Back; } }
  public Global.BulletType BulletType { get { int o = __p.__offset(44); return o != 0 ? (Global.BulletType)__p.bb.GetInt(o + __p.bb_pos) : Global.BulletType.Normal; } }
  public Global.ArmorType ArmorType { get { int o = __p.__offset(46); return o != 0 ? (Global.ArmorType)__p.bb.GetInt(o + __p.bb_pos) : Global.ArmorType.LightArmor; } }
  public Global.AimIKType AimIKType { get { int o = __p.__offset(48); return o != 0 ? (Global.AimIKType)__p.bb.GetInt(o + __p.bb_pos) : Global.AimIKType.None; } }
  public Global.School School { get { int o = __p.__offset(50); return o != 0 ? (Global.School)__p.bb.GetInt(o + __p.bb_pos) : Global.School.None; } }
  public Global.Club Club { get { int o = __p.__offset(52); return o != 0 ? (Global.Club)__p.bb.GetInt(o + __p.bb_pos) : Global.Club.None; } }
  ...
  public Global.StatLevelUpType StatLevelUpType { get { int o = __p.__offset(58); return o != 0 ? (Global.StatLevelUpType)__p.bb.GetInt(o + __p.bb_pos) : Global.StatLevelUpType.Standard; } }
  public Global.SquadType SquadType { get { int o = __p.__offset(60); return o != 0 ? (Global.SquadType)__p.bb.GetInt(o + __p.bb_pos) : Global.SquadType.None; } }
  ...
  public Global.EquipmentCategory EquipmentSlot(int j) { int o = __p.__offset(80); return o != 0 ? (Global.EquipmentCategory)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Global.EquipmentCategory)0; }
  public int EquipmentSlotLength { get { int o = __p.__offset(80); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Global.EquipmentCategory> GetEquipmentSlotBytes() { return __p.__vector_as_span<Global.EquipmentCategory>(80, 4); }
#else
  public ArraySegment<byte>? GetEquipmentSlotBytes() { return __p.__vector_as_arraysegment(80); }
#endif
  public Global.EquipmentCategory[] GetEquipmentSlotArray() { int o = __p.__offset(80); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Global.EquipmentCategory[] a = new Global.EquipmentCategory[l]; for (int i = 0; i < l; i++) { a[i] = (Global.EquipmentCategory)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Global.Tag Tags(int j) { int o = __p.__offset(122); return o != 0 ? (Global.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Global.Tag)0; }
  public int TagsLength { get { int o = __p.__offset(122); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Global.Tag> GetTagsBytes() { return __p.__vector_as_span<Global.Tag>(122, 4); }
#else
  public ArraySegment<byte>? GetTagsBytes() { return __p.__vector_as_arraysegment(122); }
#endif
  public Global.Tag[] GetTagsArray() { int o = __p.__offset(122); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Global.Tag[] a = new Global.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (Global.Tag)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Global.CharacterExcel> CreateCharacterExcel(FlatBufferBuilder builder,
      long Id = 0,
      ...
      Global.SquadType SquadType = Global.SquadType.None,
      bool Jumpable = false,
  ...
  public static void AddRarity(FlatBufferBuilder builder, Global.Rarity rarity) { builder.AddInt(11, (int)rarity, 0); }
  public static void AddIsNPC(FlatBufferBuilder builder, bool isNPC) { builder.AddBool(12, isNPC, false); }
  public static void AddTacticEntityType(FlatBufferBuilder builder, Global.TacticEntityType tacticEntityType) { builder.AddInt(13, (int)tacticEntityType, 0); }
  ...
  public static void AddTacticRole(FlatBufferBuilder builder, Global.TacticRole tacticRole) { builder.AddInt(17, (int)tacticRole, 0); }
  public static void AddWeaponType(FlatBufferBuilder builder, Global.WeaponType weaponType) { builder.AddInt(18, (int)weaponType, 0); }
  public static void AddTacticRange(FlatBufferBuilder builder, Global.TacticRange tacticRange) { builder.AddInt(19, (int)tacticRange, 0); }
  public static void AddBulletType(FlatBufferBuilder builder, Global.BulletType bulletType) { builder.AddInt(20, (int)bulletType, 0); }
  public static void AddArmorType(FlatBufferBuilder builder, Global.ArmorType armorType) { builder.AddInt(21, (int)armorType, 0); }
  public static void AddAimIKType(FlatBufferBuilder builder, Global.AimIKType aimIKType) { builder.AddInt(22, (int)aimIKType, 0); }
  public static void AddSchool(FlatBufferBuilder builder, Global.School school) { builder.AddInt(23, (int)school, 0); }
  public static void AddClub(FlatBufferBuilder builder, Global.Club club) { builder.AddInt(24, (int)club, 0); }
  ...
  public static void AddStatLevelUpType(FlatBufferBuilder builder, Global.StatLevelUpType statLevelUpType) { builder.AddInt(27, (int)statLevelUpType, 0); }
  public static void AddSquadType(FlatBufferBuilder builder, Global.SquadType squadType) { builder.AddInt(28, (int)squadType, 0); }
  ...
  public static VectorOffset CreateEquipmentSlotVector(FlatBufferBuilder builder, Global.EquipmentCategory[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateEquipmentSlotVectorBlock(FlatBufferBuilder builder, Global.EquipmentCategory[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateEquipmentSlotVectorBlock(FlatBufferBuilder builder, ArraySegment<Global.EquipmentCategory> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateEquipmentSlotVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Global.EquipmentCategory>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Global.CharacterExcel> EndCharacterExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.CharacterExcel>(o);
  }
  ...
  public void UnPackTo(CharacterExcelT _o) {
    ...
    _o.EquipmentSlot = new List<Global.EquipmentCategory>();
  ...
  public static Offset<Global.CharacterExcel> Pack(FlatBufferBuilder builder, CharacterExcelT _o) {
    if (_o == null) return default(Offset<Global.CharacterExcel>);
		byte[] key = TableEncryptionService.CreateKey("Character");
...
public class CharacterExcelT
{
  ...
  public Global.TacticRole TacticRole { get; set; }
  public Global.WeaponType WeaponType { get; set; }
  public Global.TacticRange TacticRange { get; set; }
  public Global.BulletType BulletType { get; set; }
  public Global.ArmorType ArmorType { get; set; }
  public Global.AimIKType AimIKType { get; set; }
  ...
  public Global.StatLevelUpType StatLevelUpType { get; set; }
  public Global.SquadType SquadType { get; set; }
  ...
  public List<Global.EquipmentCategory> EquipmentSlot { get; set; }
  ...
  public CharacterExcelT() {
    ...
    this.TacticRole = Global.TacticRole.None;
    this.WeaponType = Global.WeaponType.None;
    this.TacticRange = Global.TacticRange.Back;
    this.BulletType = Global.BulletType.Normal;
    this.ArmorType = Global.ArmorType.LightArmor;
    this.AimIKType = Global.AimIKType.None;
    this.School = Global.School.None;
    this.Club = Global.Club.None;
    this.DefaultStarGrade = 0;
    this.MaxStarGrade = 0;
    this.StatLevelUpType = Global.StatLevelUpType.Standard;
    this.SquadType = Global.SquadType.None;
    this.Jumpable = false;
...
static public class CharacterExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 26 /*Rarity*/, 4 /*Global.Rarity*/, 4, false)
      && verifier.VerifyField(tablePos, 28 /*IsNPC*/, 1 /*bool*/, 1, false)
      && verifier.VerifyField(tablePos, 30 /*TacticEntityType*/, 4 /*Global.TacticEntityType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 38 /*TacticRole*/, 4 /*Global.TacticRole*/, 4, false)
      && verifier.VerifyField(tablePos, 40 /*WeaponType*/, 4 /*Global.WeaponType*/, 4, false)
      && verifier.VerifyField(tablePos, 42 /*TacticRange*/, 4 /*Global.TacticRange*/, 4, false)
      && verifier.VerifyField(tablePos, 44 /*BulletType*/, 4 /*Global.BulletType*/, 4, false)
      && verifier.VerifyField(tablePos, 46 /*ArmorType*/, 4 /*Global.ArmorType*/, 4, false)
      && verifier.VerifyField(tablePos, 48 /*AimIKType*/, 4 /*Global.AimIKType*/, 4, false)
      && verifier.VerifyField(tablePos, 50 /*School*/, 4 /*Global.School*/, 4, false)
      && verifier.VerifyField(tablePos, 52 /*Club*/, 4 /*Global.Club*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 58 /*StatLevelUpType*/, 4 /*Global.StatLevelUpType*/, 4, false)
      && verifier.VerifyField(tablePos, 60 /*SquadType*/, 4 /*Global.SquadType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 80 /*EquipmentSlot*/, 4 /*Global.EquipmentCategory*/, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 122 /*Tags*/, 4 /*Global.Tag*/, false)
