...
public struct CharacterExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(CharacterExcelT _o) {
    ...
    _o.TacticRole = TableEncryptionService.UseEncryption ? (Global.TacticRole)TableEncryptionService.Convert((int)this.TacticRole, key) : this.TacticRole;
    ...
    _o.TacticRange = TableEncryptionService.UseEncryption ? (Global.TacticRange)TableEncryptionService.Convert((int)this.TacticRange, key) : this.TacticRange;
    ...
    _o.AimIKType = TableEncryptionService.UseEncryption ? (Global.AimIKType)TableEncryptionService.Convert((int)this.AimIKType, key) : this.AimIKType;
    ...
    _o.StatLevelUpType = TableEncryptionService.UseEncryption ? (Global.StatLevelUpType)TableEncryptionService.Convert((int)this.StatLevelUpType, key) : this.StatLevelUpType;
    _o.SquadType = TableEncryptionService.UseEncryption ? (Global.SquadType)TableEncryptionService.Convert((int)this.SquadType, key) : this.SquadType;
    ...
    for (var _j = 0; _j < this.EquipmentSlotLength; ++_j) {_o.EquipmentSlot.Add(TableEncryptionService.UseEncryption ? (Global.EquipmentCategory)TableEncryptionService.Convert((int)this.EquipmentSlot(_j), key) : this.EquipmentSlot(_j));}
  ...
  public static Offset<Global.CharacterExcel> Pack(FlatBufferBuilder builder, CharacterExcelT _o) {
    ...
    var _CollectionVisibleEndDate = _o.CollectionVisibleEndDate == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.CollectionVisibleEndDate, key) : _o.CollectionVisibleEndDate));
		...
		var _TacticRole = TableEncryptionService.UseEncryption ? (Global.TacticRole)TableEncryptionService.Convert((int)_o.TacticRole, key) : _o.TacticRole;
		...
		var _TacticRange = TableEncryptionService.UseEncryption ? (Global.TacticRange)TableEncryptionService.Convert((int)_o.TacticRange, key) : _o.TacticRange;
		...
		var _AimIKType = TableEncryptionService.UseEncryption ? (Global.AimIKType)TableEncryptionService.Convert((int)_o.AimIKType, key) : _o.AimIKType;
		...
		var _StatLevelUpType = TableEncryptionService.UseEncryption ? (Global.StatLevelUpType)TableEncryptionService.Convert((int)_o.StatLevelUpType, key) : _o.StatLevelUpType;
		var _SquadType = TableEncryptionService.UseEncryption ? (Global.SquadType)TableEncryptionService.Convert((int)_o.SquadType, key) : _o.SquadType;
    ...
    if (_o.EquipmentSlot != null) {
      var __equipmentSlot = _o.EquipmentSlot.Select(x => TableEncryptionService.UseEncryption ? (Global.EquipmentCategory)TableEncryptionService.Convert((int)x, key) : x).ToArray();
