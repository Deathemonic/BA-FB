...
public struct CharacterPotentialStatExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(CharacterPotentialStatExcelT _o) {
    ...
    _o.PotentialLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.PotentialLevel, key) : this.PotentialLevel;
    _o.RecipeId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.RecipeId, key) : this.RecipeId;
    _o.StatBonusRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StatBonusRate, key) : this.StatBonusRate;
  }
  public static Offset<Global.CharacterPotentialStatExcel> Pack(FlatBufferBuilder builder, CharacterPotentialStatExcelT _o) {
    if (_o == null) return default(Offset<Global.CharacterPotentialStatExcel>);
		...
		var _PotentialLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PotentialLevel, key) : _o.PotentialLevel;
		var _RecipeId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RecipeId, key) : _o.RecipeId;
		var _StatBonusRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StatBonusRate, key) : _o.StatBonusRate;
