...
public struct CharacterPotentialStatExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.CharacterPotentialStatExcel> CreateCharacterPotentialStatExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.CharacterPotentialStatExcel> EndCharacterPotentialStatExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.CharacterPotentialStatExcel>(o);
  }
  ...
  public void UnPackTo(CharacterPotentialStatExcelT _o) {
    ...
    _o.PotentialLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.PotentialLevel, key) : this.PotentialLevel;
    _o.RecipeId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.RecipeId, key) : this.RecipeId;
    _o.StatBonusRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.StatBonusRate, key) : this.StatBonusRate;
  }
  public static Offset<Global.CharacterPotentialStatExcel> Pack(FlatBufferBuilder builder, CharacterPotentialStatExcelT _o) {
    if (_o == null) return default(Offset<Global.CharacterPotentialStatExcel>);
		byte[] key = TableEncryptionService.CreateKey("CharacterPotentialStat");
		...
		var _PotentialLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.PotentialLevel, key) : _o.PotentialLevel;
		var _RecipeId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.RecipeId, key) : _o.RecipeId;
		var _StatBonusRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.StatBonusRate, key) : _o.StatBonusRate;
    return CreateCharacterPotentialStatExcel(
      ...
      TableEncryptionService.UseEncryption ? _PotentialLevel : _o.PotentialLevel,
      TableEncryptionService.UseEncryption ? _RecipeId : _o.RecipeId,
      TableEncryptionService.UseEncryption ? _StatBonusRate : _o.StatBonusRate);
  }
}
