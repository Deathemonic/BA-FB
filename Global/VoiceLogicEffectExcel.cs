...
public struct VoiceLogicEffectExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(VoiceLogicEffectExcelT _o) {
    ...
    _o.LogicEffectNameHash = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)this.LogicEffectNameHash, key) : this.LogicEffectNameHash;
    _o.Self = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.Self, key) : this.Self;
  ...
  public static Offset<Global.VoiceLogicEffectExcel> Pack(FlatBufferBuilder builder, VoiceLogicEffectExcelT _o) {
    if (_o == null) return default(Offset<Global.VoiceLogicEffectExcel>);
		byte[] key = TableEncryptionService.CreateKey("VoiceLogicEffect");
		var _LogicEffectNameHash = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)_o.LogicEffectNameHash, key) : _o.LogicEffectNameHash;
		var _Self = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.Self, key) : _o.Self;
