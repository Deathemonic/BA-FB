...
public struct VoiceLogicEffectExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.VoiceLogicEffectExcel> CreateVoiceLogicEffectExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.VoiceLogicEffectExcel> EndVoiceLogicEffectExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.VoiceLogicEffectExcel>(o);
  }
  ...
  public void UnPackTo(VoiceLogicEffectExcelT _o) {
    ...
    _o.LogicEffectNameHash = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.LogicEffectNameHash, key) : this.LogicEffectNameHash;
    _o.Self = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Self, key) : this.Self;
  ...
  public static Offset<Global.VoiceLogicEffectExcel> Pack(FlatBufferBuilder builder, VoiceLogicEffectExcelT _o) {
    if (_o == null) return default(Offset<Global.VoiceLogicEffectExcel>);
		byte[] key = TableEncryptionService.CreateKey("VoiceLogicEffect");
		var _LogicEffectNameHash = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.LogicEffectNameHash, key) : _o.LogicEffectNameHash;
		var _Self = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Self, key) : _o.Self;
    ...
    return CreateVoiceLogicEffectExcel(
      builder,
      TableEncryptionService.UseEncryption ? _LogicEffectNameHash : _o.LogicEffectNameHash,
      TableEncryptionService.UseEncryption ? _Self : _o.Self,
