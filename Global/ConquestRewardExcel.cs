...
public struct ConquestRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.ConquestRewardExcel> CreateConquestRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static Offset<Global.ConquestRewardExcel> EndConquestRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.ConquestRewardExcel>(o);
  }
  ...
  public static Offset<Global.ConquestRewardExcel> Pack(FlatBufferBuilder builder, ConquestRewardExcelT _o) {
    if (_o == null) return default(Offset<Global.ConquestRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("ConquestReward");
