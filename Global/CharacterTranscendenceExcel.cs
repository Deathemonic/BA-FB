...
public struct CharacterTranscendenceExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.CharacterTranscendenceExcel> CreateCharacterTranscendenceExcel(FlatBufferBuilder builder,
      long CharacterId = 0,
  ...
  public static Offset<Global.CharacterTranscendenceExcel> EndCharacterTranscendenceExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.CharacterTranscendenceExcel>(o);
  }
  ...
  public void UnPackTo(CharacterTranscendenceExcelT _o) {
    ...
    for (var _j = 0; _j < this.MaxFavorLevelLength; ++_j) {_o.MaxFavorLevel.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.MaxFavorLevel(_j), key) : this.MaxFavorLevel(_j));}
    _o.StatBonusRateAttack = new List<long>();
    for (var _j = 0; _j < this.StatBonusRateAttackLength; ++_j) {_o.StatBonusRateAttack.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.StatBonusRateAttack(_j), key) : this.StatBonusRateAttack(_j));}
    _o.StatBonusRateHP = new List<long>();
    for (var _j = 0; _j < this.StatBonusRateHPLength; ++_j) {_o.StatBonusRateHP.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.StatBonusRateHP(_j), key) : this.StatBonusRateHP(_j));}
    _o.StatBonusRateHeal = new List<long>();
    for (var _j = 0; _j < this.StatBonusRateHealLength; ++_j) {_o.StatBonusRateHeal.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.StatBonusRateHeal(_j), key) : this.StatBonusRateHeal(_j));}
    ...
    for (var _j = 0; _j < this.SkillSlotALength; ++_j) {_o.SkillSlotA.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SkillSlotA(_j), key) : this.SkillSlotA(_j));}
    _o.SkillSlotB = new List<string>();
    for (var _j = 0; _j < this.SkillSlotBLength; ++_j) {_o.SkillSlotB.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SkillSlotB(_j), key) : this.SkillSlotB(_j));}
    _o.SkillSlotC = new List<string>();
    for (var _j = 0; _j < this.SkillSlotCLength; ++_j) {_o.SkillSlotC.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SkillSlotC(_j), key) : this.SkillSlotC(_j));}
    _o.MaxlevelStar = new List<int>();
    for (var _j = 0; _j < this.MaxlevelStarLength; ++_j) {_o.MaxlevelStar.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.MaxlevelStar(_j), key) : this.MaxlevelStar(_j));}
  }
  public static Offset<Global.CharacterTranscendenceExcel> Pack(FlatBufferBuilder builder, CharacterTranscendenceExcelT _o) {
    if (_o == null) return default(Offset<Global.CharacterTranscendenceExcel>);
		byte[] key = TableEncryptionService.CreateKey("CharacterTranscendence");
    ...
    if (_o.MaxFavorLevel != null) {
      var __maxFavorLevel = _o.MaxFavorLevel.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)x, key) : x).ToArray();
    ...
    if (_o.StatBonusRateAttack != null) {
      var __statBonusRateAttack = _o.StatBonusRateAttack.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
    ...
    if (_o.StatBonusRateHP != null) {
      var __statBonusRateHP = _o.StatBonusRateHP.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
    ...
    if (_o.StatBonusRateHeal != null) {
      var __statBonusRateHeal = _o.StatBonusRateHeal.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
    ...
    if (_o.SkillSlotA != null) {
      ...
      for (var _j = 0; _j < __skillSlotA.Length; ++_j) { __skillSlotA[_j] = builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.SkillSlotA[_j], key) : _o.SkillSlotA[_j])); }
    ...
    if (_o.SkillSlotB != null) {
      ...
      for (var _j = 0; _j < __skillSlotB.Length; ++_j) { __skillSlotB[_j] = builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.SkillSlotB[_j], key) : _o.SkillSlotB[_j])); }
    ...
    if (_o.SkillSlotC != null) {
      ...
      for (var _j = 0; _j < __skillSlotC.Length; ++_j) { __skillSlotC[_j] = builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.SkillSlotC[_j], key) : _o.SkillSlotC[_j])); }
      _skillSlotC = CreateSkillSlotCVector(builder, __skillSlotC);
    }
    var _maxlevelStar = default(VectorOffset);
    if (_o.MaxlevelStar != null) {
      var __maxlevelStar = _o.MaxlevelStar.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)x, key) : x).ToArray();
