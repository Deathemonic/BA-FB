...
public struct MiniGameDefenseFixedStatExcel : IFlatbufferObject
{
  ...
  public static Offset<Global.MiniGameDefenseFixedStatExcel> CreateMiniGameDefenseFixedStatExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Global.MiniGameDefenseFixedStatExcel> EndMiniGameDefenseFixedStatExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.MiniGameDefenseFixedStatExcel>(o);
  }
  ...
  public void UnPackTo(MiniGameDefenseFixedStatExcelT _o) {
    ...
    _o.MinigameDefenseFixedStatId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.MinigameDefenseFixedStatId, key) : this.MinigameDefenseFixedStatId;
    _o.Level = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.Level, key) : this.Level;
    _o.Grade = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.Grade, key) : this.Grade;
    ...
    _o.NoneExSkillLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.NoneExSkillLevel, key) : this.NoneExSkillLevel;
    _o.Equipment1Tier = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.Equipment1Tier, key) : this.Equipment1Tier;
    _o.Equipment1Level = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.Equipment1Level, key) : this.Equipment1Level;
    _o.Equipment2Tier = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.Equipment2Tier, key) : this.Equipment2Tier;
    _o.Equipment2Level = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.Equipment2Level, key) : this.Equipment2Level;
    _o.Equipment3Tier = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.Equipment3Tier, key) : this.Equipment3Tier;
    _o.Equipment3Level = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.Equipment3Level, key) : this.Equipment3Level;
    _o.CharacterWeaponGrade = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.CharacterWeaponGrade, key) : this.CharacterWeaponGrade;
    _o.CharacterWeaponLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.CharacterWeaponLevel, key) : this.CharacterWeaponLevel;
    _o.CharacterGearTier = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.CharacterGearTier, key) : this.CharacterGearTier;
    _o.CharacterGearLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.CharacterGearLevel, key) : this.CharacterGearLevel;
  }
  public static Offset<Global.MiniGameDefenseFixedStatExcel> Pack(FlatBufferBuilder builder, MiniGameDefenseFixedStatExcelT _o) {
    if (_o == null) return default(Offset<Global.MiniGameDefenseFixedStatExcel>);
		byte[] key = TableEncryptionService.CreateKey("MiniGameDefenseFixedStat");
		var _MinigameDefenseFixedStatId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.MinigameDefenseFixedStatId, key) : _o.MinigameDefenseFixedStatId;
		var _Level = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.Level, key) : _o.Level;
		var _Grade = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.Grade, key) : _o.Grade;
		...
		var _NoneExSkillLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.NoneExSkillLevel, key) : _o.NoneExSkillLevel;
		var _Equipment1Tier = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.Equipment1Tier, key) : _o.Equipment1Tier;
		var _Equipment1Level = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.Equipment1Level, key) : _o.Equipment1Level;
		var _Equipment2Tier = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.Equipment2Tier, key) : _o.Equipment2Tier;
		var _Equipment2Level = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.Equipment2Level, key) : _o.Equipment2Level;
		var _Equipment3Tier = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.Equipment3Tier, key) : _o.Equipment3Tier;
		var _Equipment3Level = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.Equipment3Level, key) : _o.Equipment3Level;
		var _CharacterWeaponGrade = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.CharacterWeaponGrade, key) : _o.CharacterWeaponGrade;
		var _CharacterWeaponLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.CharacterWeaponLevel, key) : _o.CharacterWeaponLevel;
		var _CharacterGearTier = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.CharacterGearTier, key) : _o.CharacterGearTier;
		var _CharacterGearLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.CharacterGearLevel, key) : _o.CharacterGearLevel;
    return CreateMiniGameDefenseFixedStatExcel(
      builder,
      TableEncryptionService.UseEncryption ? _MinigameDefenseFixedStatId : _o.MinigameDefenseFixedStatId,
      TableEncryptionService.UseEncryption ? _Level : _o.Level,
      TableEncryptionService.UseEncryption ? _Grade : _o.Grade,
      TableEncryptionService.UseEncryption ? _ExSkillLevel : _o.ExSkillLevel,
      TableEncryptionService.UseEncryption ? _NoneExSkillLevel : _o.NoneExSkillLevel,
      TableEncryptionService.UseEncryption ? _Equipment1Tier : _o.Equipment1Tier,
      TableEncryptionService.UseEncryption ? _Equipment1Level : _o.Equipment1Level,
      TableEncryptionService.UseEncryption ? _Equipment2Tier : _o.Equipment2Tier,
      TableEncryptionService.UseEncryption ? _Equipment2Level : _o.Equipment2Level,
      TableEncryptionService.UseEncryption ? _Equipment3Tier : _o.Equipment3Tier,
      TableEncryptionService.UseEncryption ? _Equipment3Level : _o.Equipment3Level,
      TableEncryptionService.UseEncryption ? _CharacterWeaponGrade : _o.CharacterWeaponGrade,
      TableEncryptionService.UseEncryption ? _CharacterWeaponLevel : _o.CharacterWeaponLevel,
      TableEncryptionService.UseEncryption ? _CharacterGearTier : _o.CharacterGearTier,
      TableEncryptionService.UseEncryption ? _CharacterGearLevel : _o.CharacterGearLevel);
  }
}
