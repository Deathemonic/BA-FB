...
public struct EventContentLocationRewardExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(EventContentLocationRewardExcelT _o) {
    ...
    _o.ScheduleGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ScheduleGroupId, key) : this.ScheduleGroupId;
    _o.OrderInGroup = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.OrderInGroup, key) : this.OrderInGroup;
    ...
    _o.LocationRank = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.LocationRank, key) : this.LocationRank;
    _o.FavorExp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.FavorExp, key) : this.FavorExp;
    _o.SecretStoneAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SecretStoneAmount, key) : this.SecretStoneAmount;
    _o.SecretStoneProb = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SecretStoneProb, key) : this.SecretStoneProb;
    _o.ExtraFavorExp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ExtraFavorExp, key) : this.ExtraFavorExp;
    _o.ExtraFavorExpProb = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ExtraFavorExpProb, key) : this.ExtraFavorExpProb;
    _o.ExtraRewardParcelType = new List<Global.ParcelType>();
    for (var _j = 0; _j < this.ExtraRewardParcelTypeLength; ++_j) {_o.ExtraRewardParcelType.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ExtraRewardParcelType(_j), key) : this.ExtraRewardParcelType(_j));}
    _o.ExtraRewardParcelId = new List<long>();
    for (var _j = 0; _j < this.ExtraRewardParcelIdLength; ++_j) {_o.ExtraRewardParcelId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ExtraRewardParcelId(_j), key) : this.ExtraRewardParcelId(_j));}
    _o.ExtraRewardAmount = new List<long>();
    for (var _j = 0; _j < this.ExtraRewardAmountLength; ++_j) {_o.ExtraRewardAmount.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ExtraRewardAmount(_j), key) : this.ExtraRewardAmount(_j));}
    _o.ExtraRewardProb = new List<long>();
    for (var _j = 0; _j < this.ExtraRewardProbLength; ++_j) {_o.ExtraRewardProb.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ExtraRewardProb(_j), key) : this.ExtraRewardProb(_j));}
    _o.IsExtraRewardDisplayed = new List<bool>();
    for (var _j = 0; _j < this.IsExtraRewardDisplayedLength; ++_j) {_o.IsExtraRewardDisplayed.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.IsExtraRewardDisplayed(_j), key) : this.IsExtraRewardDisplayed(_j));}
  ...
  public static Offset<Global.EventContentLocationRewardExcel> Pack(FlatBufferBuilder builder, EventContentLocationRewardExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentLocationRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentLocationReward");
    var _Location = _o.Location == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.Location, key) : _o.Location));
		var _ScheduleGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ScheduleGroupId, key) : _o.ScheduleGroupId;
    ...
    if (_o.VoiceId != null) {
      ...
      _VoiceId = CreateVoiceIdVector(builder, __VoiceId);
		...
		var _SecretStoneAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.SecretStoneAmount, key) : _o.SecretStoneAmount;
