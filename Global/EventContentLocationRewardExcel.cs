...
public struct EventContentLocationRewardExcel : IFlatbufferObject
{
  ...
  public Global.ParcelType ExtraRewardParcelType(int j) { int o = __p.__offset(30); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Global.ParcelType)0; }
  public int ExtraRewardParcelTypeLength { get { int o = __p.__offset(30); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Global.ParcelType> GetExtraRewardParcelTypeBytes() { return __p.__vector_as_span<Global.ParcelType>(30, 4); }
#else
  public ArraySegment<byte>? GetExtraRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(30); }
#endif
  public Global.ParcelType[] GetExtraRewardParcelTypeArray() { int o = __p.__offset(30); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Global.ParcelType[] a = new Global.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Global.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Global.ParcelType RewardParcelType(int j) { int o = __p.__offset(40); return o != 0 ? (Global.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Global.ParcelType)0; }
  public int RewardParcelTypeLength { get { int o = __p.__offset(40); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Global.ParcelType> GetRewardParcelTypeBytes() { return __p.__vector_as_span<Global.ParcelType>(40, 4); }
#else
  public ArraySegment<byte>? GetRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(40); }
#endif
  public Global.ParcelType[] GetRewardParcelTypeArray() { int o = __p.__offset(40); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Global.ParcelType[] a = new Global.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Global.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Global.EventContentLocationRewardExcel> CreateEventContentLocationRewardExcel(FlatBufferBuilder builder,
  ...
  public static VectorOffset CreateExtraRewardParcelTypeVector(FlatBufferBuilder builder, Global.ParcelType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateExtraRewardParcelTypeVectorBlock(FlatBufferBuilder builder, Global.ParcelType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateExtraRewardParcelTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Global.ParcelType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateExtraRewardParcelTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Global.ParcelType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Global.EventContentLocationRewardExcel> EndEventContentLocationRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Global.EventContentLocationRewardExcel>(o);
  }
  public EventContentLocationRewardExcelT UnPack() {
    var _o = new EventContentLocationRewardExcelT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(EventContentLocationRewardExcelT _o) {
		byte[] key = TableEncryptionService.CreateKey("EventContentLocationReward");
    _o.Location = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Location, key) : this.Location;
    _o.ScheduleGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ScheduleGroupId, key) : this.ScheduleGroupId;
    _o.OrderInGroup = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.OrderInGroup, key) : this.OrderInGroup;
    _o.Id = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.Id, key) : this.Id;
    _o.ProgressTexture = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ProgressTexture, key) : this.ProgressTexture;
    ...
    _o.LocationRank = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.LocationRank, key) : this.LocationRank;
    _o.FavorExp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.FavorExp, key) : this.FavorExp;
    _o.SecretStoneAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.SecretStoneAmount, key) : this.SecretStoneAmount;
    _o.SecretStoneProb = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.SecretStoneProb, key) : this.SecretStoneProb;
    _o.ExtraFavorExp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ExtraFavorExp, key) : this.ExtraFavorExp;
    _o.ExtraFavorExpProb = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ExtraFavorExpProb, key) : this.ExtraFavorExpProb;
    _o.ExtraRewardParcelType = new List<Global.ParcelType>();
    for (var _j = 0; _j < this.ExtraRewardParcelTypeLength; ++_j) {_o.ExtraRewardParcelType.Add(TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)this.ExtraRewardParcelType(_j), key) : this.ExtraRewardParcelType(_j));}
    _o.ExtraRewardParcelId = new List<long>();
    for (var _j = 0; _j < this.ExtraRewardParcelIdLength; ++_j) {_o.ExtraRewardParcelId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ExtraRewardParcelId(_j), key) : this.ExtraRewardParcelId(_j));}
    _o.ExtraRewardAmount = new List<long>();
    for (var _j = 0; _j < this.ExtraRewardAmountLength; ++_j) {_o.ExtraRewardAmount.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ExtraRewardAmount(_j), key) : this.ExtraRewardAmount(_j));}
    _o.ExtraRewardProb = new List<long>();
    for (var _j = 0; _j < this.ExtraRewardProbLength; ++_j) {_o.ExtraRewardProb.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ExtraRewardProb(_j), key) : this.ExtraRewardProb(_j));}
    _o.IsExtraRewardDisplayed = new List<bool>();
    for (var _j = 0; _j < this.IsExtraRewardDisplayedLength; ++_j) {_o.IsExtraRewardDisplayed.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.IsExtraRewardDisplayed(_j), key) : this.IsExtraRewardDisplayed(_j));}
  ...
  public static Offset<Global.EventContentLocationRewardExcel> Pack(FlatBufferBuilder builder, EventContentLocationRewardExcelT _o) {
    if (_o == null) return default(Offset<Global.EventContentLocationRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentLocationReward");
    var _Location = _o.Location == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.Location, key) : _o.Location));
		var _ScheduleGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ScheduleGroupId, key) : _o.ScheduleGroupId;
		var _OrderInGroup = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.OrderInGroup, key) : _o.OrderInGroup;
		var _Id = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.Id, key) : _o.Id;
    var _ProgressTexture = _o.ProgressTexture == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.ProgressTexture, key) : _o.ProgressTexture));
    ...
    if (_o.VoiceId != null) {
      ...
      _voiceId = CreateVoiceIdVector(builder, __voiceId);
		...
		var _LocationRank = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.LocationRank, key) : _o.LocationRank;
		var _FavorExp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.FavorExp, key) : _o.FavorExp;
		var _SecretStoneAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.SecretStoneAmount, key) : _o.SecretStoneAmount;
		var _SecretStoneProb = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.SecretStoneProb, key) : _o.SecretStoneProb;
		var _ExtraFavorExp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ExtraFavorExp, key) : _o.ExtraFavorExp;
		var _ExtraFavorExpProb = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ExtraFavorExpProb, key) : _o.ExtraFavorExpProb;
    var _extraRewardParcelType = default(VectorOffset);
    if (_o.ExtraRewardParcelType != null) {
      var __extraRewardParcelType = _o.ExtraRewardParcelType.Select(x => TableEncryptionService.UseEncryption ? (Global.ParcelType)TableEncryptionService.Convert((int)x, key) : x).ToArray();
    ...
    if (_o.ExtraRewardParcelId != null) {
      var __extraRewardParcelId = _o.ExtraRewardParcelId.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
    ...
    if (_o.ExtraRewardAmount != null) {
      var __extraRewardAmount = _o.ExtraRewardAmount.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
    ...
    if (_o.ExtraRewardProb != null) {
      var __extraRewardProb = _o.ExtraRewardProb.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
    ...
    if (_o.IsExtraRewardDisplayed != null) {
      var __isExtraRewardDisplayed = _o.IsExtraRewardDisplayed.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)x, key) : x).ToArray();
    ...
    return CreateEventContentLocationRewardExcel(
      builder,
      _Location,
      TableEncryptionService.UseEncryption ? _ScheduleGroupId : _o.ScheduleGroupId,
      ...
      TableEncryptionService.UseEncryption ? _SecretStoneAmount : _o.SecretStoneAmount,
...
public class EventContentLocationRewardExcelT
{
  ...
  public List<Global.ParcelType> ExtraRewardParcelType { get; set; }
  ...
  public EventContentLocationRewardExcelT() {
    this.Location = null;
...
static public class EventContentLocationRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 30 /*ExtraRewardParcelType*/, 4 /*Global.ParcelType*/, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 40 /*RewardParcelType*/, 4 /*Global.ParcelType*/, false)
