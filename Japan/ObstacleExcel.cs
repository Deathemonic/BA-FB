...
public struct ObstacleExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ObstacleExcelT _o) {
    ...
    _o.DestroyType = TableEncryptionService.UseEncryption ? (Japan.ObstacleDestroyType)TableEncryptionService.Convert((int)this.DestroyType, key) : this.DestroyType;
  ...
  public static Offset<Japan.ObstacleExcel> Pack(FlatBufferBuilder builder, ObstacleExcelT _o) {
    ...
    if (_o.SubOffset != null) {
      ...
      _SubOffset = CreateSubOffsetVector(builder, __SubOffset);
		...
		var _DestroyType = TableEncryptionService.UseEncryption ? (Japan.ObstacleDestroyType)TableEncryptionService.Convert((int)_o.DestroyType, key) : _o.DestroyType;
