...
public struct MiniGameDreamEndingRewardExcel : IFlatbufferObject
{
  ...
  public Japan.DreamMakerEndingRewardType DreamMakerEndingRewardType { get { int o = __p.__offset(10); return o != 0 ? (Japan.DreamMakerEndingRewardType)__p.bb.GetInt(o + __p.bb_pos) : Japan.DreamMakerEndingRewardType.None; } }
  public Japan.DreamMakerEndingType DreamMakerEndingType { get { int o = __p.__offset(12); return o != 0 ? (Japan.DreamMakerEndingType)__p.bb.GetInt(o + __p.bb_pos) : Japan.DreamMakerEndingType.None; } }
  public Japan.ParcelType RewardParcelType(int j) { int o = __p.__offset(14); return o != 0 ? (Japan.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.ParcelType)0; }
  public int RewardParcelTypeLength { get { int o = __p.__offset(14); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.ParcelType> GetRewardParcelTypeBytes() { return __p.__vector_as_span<Japan.ParcelType>(14, 4); }
#else
  public ArraySegment<byte>? GetRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(14); }
#endif
  public Japan.ParcelType[] GetRewardParcelTypeArray() { int o = __p.__offset(14); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.ParcelType[] a = new Japan.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Japan.MiniGameDreamEndingRewardExcel> CreateMiniGameDreamEndingRewardExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      long EndingId = 0,
      uint LocalizeEtcId = 0,
      Japan.DreamMakerEndingRewardType DreamMakerEndingRewardType = Japan.DreamMakerEndingRewardType.None,
  ...
  public static void AddDreamMakerEndingRewardType(FlatBufferBuilder builder, Japan.DreamMakerEndingRewardType dreamMakerEndingRewardType) { builder.AddInt(3, (int)dreamMakerEndingRewardType, 0); }
  public static void AddDreamMakerEndingType(FlatBufferBuilder builder, Japan.DreamMakerEndingType dreamMakerEndingType) { builder.AddInt(4, (int)dreamMakerEndingType, 0); }
  ...
  public static Offset<Japan.MiniGameDreamEndingRewardExcel> EndMiniGameDreamEndingRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.MiniGameDreamEndingRewardExcel>(o);
  }
  ...
  public static Offset<Japan.MiniGameDreamEndingRewardExcel> Pack(FlatBufferBuilder builder, MiniGameDreamEndingRewardExcelT _o) {
    if (_o == null) return default(Offset<Japan.MiniGameDreamEndingRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("MiniGameDreamEndingReward");
...
public class MiniGameDreamEndingRewardExcelT
{
  ...
  public Japan.DreamMakerEndingRewardType DreamMakerEndingRewardType { get; set; }
  ...
  public MiniGameDreamEndingRewardExcelT() {
    ...
    this.DreamMakerEndingRewardType = Japan.DreamMakerEndingRewardType.None;
...
static public class MiniGameDreamEndingRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*DreamMakerEndingRewardType*/, 4 /*Japan.DreamMakerEndingRewardType*/, 4, false)
      && verifier.VerifyField(tablePos, 12 /*DreamMakerEndingType*/, 4 /*Japan.DreamMakerEndingType*/, 4, false)
      && verifier.VerifyVectorOfData(tablePos, 14 /*RewardParcelType*/, 4 /*Japan.ParcelType*/, false)
