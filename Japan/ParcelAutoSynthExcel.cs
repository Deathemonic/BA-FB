...
public struct ParcelAutoSynthExcel : IFlatbufferObject
{
  ...
  public Japan.ParcelType RequireParcelType { get { int o = __p.__offset(4); return o != 0 ? (Japan.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Japan.ParcelType.None; } }
  ...
  public Japan.ParcelType ResultParcelType { get { int o = __p.__offset(16); return o != 0 ? (Japan.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Japan.ParcelType.None; } }
  ...
  public static Offset<Japan.ParcelAutoSynthExcel> CreateParcelAutoSynthExcel(FlatBufferBuilder builder,
      Japan.ParcelType RequireParcelType = Japan.ParcelType.None,
      long RequireParcelId = 0,
      long RequireParcelAmount = 0,
      long SynthStartAmount = 0,
      long SynthEndAmount = 0,
      bool SynthMaxItem = false,
      Japan.ParcelType ResultParcelType = Japan.ParcelType.None,
  ...
  public static void AddRequireParcelType(FlatBufferBuilder builder, Japan.ParcelType requireParcelType) { builder.AddInt(0, (int)requireParcelType, 0); }
  ...
  public static void AddResultParcelType(FlatBufferBuilder builder, Japan.ParcelType resultParcelType) { builder.AddInt(6, (int)resultParcelType, 0); }
  ...
  public static Offset<Japan.ParcelAutoSynthExcel> EndParcelAutoSynthExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ParcelAutoSynthExcel>(o);
  }
  ...
  public static Offset<Japan.ParcelAutoSynthExcel> Pack(FlatBufferBuilder builder, ParcelAutoSynthExcelT _o) {
    if (_o == null) return default(Offset<Japan.ParcelAutoSynthExcel>);
		byte[] key = TableEncryptionService.CreateKey("ParcelAutoSynth");
...
{
  public Japan.ParcelType RequireParcelType { get; set; }
...
static public class ParcelAutoSynthExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyField(tablePos, 4 /*RequireParcelType*/, 4 /*Japan.ParcelType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 16 /*ResultParcelType*/, 4 /*Japan.ParcelType*/, 4, false)
