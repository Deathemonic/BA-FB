...
public struct ConquestCameraSettingExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.ConquestCameraSettingExcel> CreateConquestCameraSettingExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Japan.ConquestCameraSettingExcel> EndConquestCameraSettingExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ConquestCameraSettingExcel>(o);
  }
  ...
  public static Offset<Japan.ConquestCameraSettingExcel> Pack(FlatBufferBuilder builder, ConquestCameraSettingExcelT _o) {
    if (_o == null) return default(Offset<Japan.ConquestCameraSettingExcel>);
		byte[] key = TableEncryptionService.CreateKey("ConquestCameraSetting");
