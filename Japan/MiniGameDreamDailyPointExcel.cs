...
public struct MiniGameDreamDailyPointExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.MiniGameDreamDailyPointExcel> CreateMiniGameDreamDailyPointExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
  ...
  public static Offset<Japan.MiniGameDreamDailyPointExcel> EndMiniGameDreamDailyPointExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.MiniGameDreamDailyPointExcel>(o);
  }
  ...
  public static Offset<Japan.MiniGameDreamDailyPointExcel> Pack(FlatBufferBuilder builder, MiniGameDreamDailyPointExcelT _o) {
    if (_o == null) return default(Offset<Japan.MiniGameDreamDailyPointExcel>);
		byte[] key = TableEncryptionService.CreateKey("MiniGameDreamDailyPoint");
