...
public struct CampaignChapterRewardExcel : IFlatbufferObject
{
  ...
  public Japan.ParcelType ChapterRewardParcelType(int j) { int o = __p.__offset(8); return o != 0 ? (Japan.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.ParcelType)0; }
  public int ChapterRewardParcelTypeLength { get { int o = __p.__offset(8); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.ParcelType> GetChapterRewardParcelTypeBytes() { return __p.__vector_as_span<Japan.ParcelType>(8, 4); }
#else
  public ArraySegment<byte>? GetChapterRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(8); }
#endif
  public Japan.ParcelType[] GetChapterRewardParcelTypeArray() { int o = __p.__offset(8); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.ParcelType[] a = new Japan.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Japan.CampaignChapterRewardExcel> CreateCampaignChapterRewardExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static VectorOffset CreateChapterRewardParcelTypeVector(FlatBufferBuilder builder, Japan.ParcelType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateChapterRewardParcelTypeVectorBlock(FlatBufferBuilder builder, Japan.ParcelType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateChapterRewardParcelTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Japan.ParcelType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateChapterRewardParcelTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Japan.ParcelType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Japan.CampaignChapterRewardExcel> EndCampaignChapterRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.CampaignChapterRewardExcel>(o);
  }
  ...
  public void UnPackTo(CampaignChapterRewardExcelT _o) {
    ...
    _o.CampaignChapterStar = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.CampaignChapterStar, key) : this.CampaignChapterStar;
    _o.ChapterRewardParcelType = new List<Japan.ParcelType>();
    for (var _j = 0; _j < this.ChapterRewardParcelTypeLength; ++_j) {_o.ChapterRewardParcelType.Add(TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)this.ChapterRewardParcelType(_j), key) : this.ChapterRewardParcelType(_j));}
    _o.ChapterRewardId = new List<long>();
    for (var _j = 0; _j < this.ChapterRewardIdLength; ++_j) {_o.ChapterRewardId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ChapterRewardId(_j), key) : this.ChapterRewardId(_j));}
    _o.ChapterRewardAmount = new List<int>();
    for (var _j = 0; _j < this.ChapterRewardAmountLength; ++_j) {_o.ChapterRewardAmount.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.ChapterRewardAmount(_j), key) : this.ChapterRewardAmount(_j));}
  }
  public static Offset<Japan.CampaignChapterRewardExcel> Pack(FlatBufferBuilder builder, CampaignChapterRewardExcelT _o) {
    if (_o == null) return default(Offset<Japan.CampaignChapterRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("CampaignChapterReward");
		var _Id = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.Id, key) : _o.Id;
		var _CampaignChapterStar = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.CampaignChapterStar, key) : _o.CampaignChapterStar;
    var _ChapterRewardParcelType = default(VectorOffset);
    if (_o.ChapterRewardParcelType != null) {
      var __ChapterRewardParcelType = _o.ChapterRewardParcelType.Select(x => TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)x, key) : x).ToArray();
    ...
    if (_o.ChapterRewardId != null) {
      var __ChapterRewardId = _o.ChapterRewardId.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
    ...
    if (_o.ChapterRewardAmount != null) {
      var __ChapterRewardAmount = _o.ChapterRewardAmount.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)x, key) : x).ToArray();
...
public class CampaignChapterRewardExcelT
{
  ...
  public List<Japan.ParcelType> ChapterRewardParcelType { get; set; }
...
static public class CampaignChapterRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 8 /*ChapterRewardParcelType*/, 4 /*Japan.ParcelType*/, false)
