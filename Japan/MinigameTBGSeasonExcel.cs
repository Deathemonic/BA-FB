...
public struct MinigameTBGSeasonExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(MinigameTBGSeasonExcelT _o) {
    ...
    _o.EchelonRevivalCostType = TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)this.EchelonRevivalCostType, key) : this.EchelonRevivalCostType;
  ...
  public static Offset<Japan.MinigameTBGSeasonExcel> Pack(FlatBufferBuilder builder, MinigameTBGSeasonExcelT _o) {
    ...
    var _EchelonSlot4Portrait = _o.EchelonSlot4Portrait == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.EchelonSlot4Portrait, key) : _o.EchelonSlot4Portrait));
		...
		var _EchelonRevivalCostType = TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)_o.EchelonRevivalCostType, key) : _o.EchelonRevivalCostType;
