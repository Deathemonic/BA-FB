...
public struct MinigameTBGSeasonExcel : IFlatbufferObject
{
  ...
  public Japan.ParcelType EventUseCostType { get { int o = __p.__offset(28); return o != 0 ? (Japan.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Japan.ParcelType.None; } }
  public long EventUseCostId { get { int o = __p.__offset(30); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public Japan.ParcelType EchelonRevivalCostType { get { int o = __p.__offset(32); return o != 0 ? (Japan.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Japan.ParcelType.None; } }
  ...
  public static Offset<Japan.MinigameTBGSeasonExcel> CreateMinigameTBGSeasonExcel(FlatBufferBuilder builder,
      ...
      Japan.ParcelType EchelonRevivalCostType = Japan.ParcelType.None,
  ...
  public static void AddEventUseCostType(FlatBufferBuilder builder, Japan.ParcelType eventUseCostType) { builder.AddInt(12, (int)eventUseCostType, 0); }
  public static void AddEventUseCostId(FlatBufferBuilder builder, long eventUseCostId) { builder.AddLong(13, eventUseCostId, 0); }
  public static void AddEchelonRevivalCostType(FlatBufferBuilder builder, Japan.ParcelType echelonRevivalCostType) { builder.AddInt(14, (int)echelonRevivalCostType, 0); }
  ...
  public static Offset<Japan.MinigameTBGSeasonExcel> EndMinigameTBGSeasonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.MinigameTBGSeasonExcel>(o);
  }
  ...
  public static Offset<Japan.MinigameTBGSeasonExcel> Pack(FlatBufferBuilder builder, MinigameTBGSeasonExcelT _o) {
    if (_o == null) return default(Offset<Japan.MinigameTBGSeasonExcel>);
		byte[] key = TableEncryptionService.CreateKey("MinigameTBGSeason");
...
public class MinigameTBGSeasonExcelT
{
  ...
  public Japan.ParcelType EchelonRevivalCostType { get; set; }
  ...
  public MinigameTBGSeasonExcelT() {
    ...
    this.EchelonRevivalCostType = Japan.ParcelType.None;
...
static public class MinigameTBGSeasonExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 28 /*EventUseCostType*/, 4 /*Japan.ParcelType*/, 4, false)
      && verifier.VerifyField(tablePos, 30 /*EventUseCostId*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 32 /*EchelonRevivalCostType*/, 4 /*Japan.ParcelType*/, 4, false)
