...
public struct LocalizeCharProfileExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.LocalizeCharProfileExcel> CreateLocalizeCharProfileExcel(FlatBufferBuilder builder,
      long CharacterId = 0,
  ...
  public static Offset<Japan.LocalizeCharProfileExcel> EndLocalizeCharProfileExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.LocalizeCharProfileExcel>(o);
  }
  ...
  public static Offset<Japan.LocalizeCharProfileExcel> Pack(FlatBufferBuilder builder, LocalizeCharProfileExcelT _o) {
    if (_o == null) return default(Offset<Japan.LocalizeCharProfileExcel>);
		byte[] key = TableEncryptionService.CreateKey("LocalizeCharProfile");
