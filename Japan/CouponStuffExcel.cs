...
public struct CouponStuffExcel : IFlatbufferObject
{
  ...
  public Japan.ParcelType ParcelType { get { int o = __p.__offset(6); return o != 0 ? (Japan.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Japan.ParcelType.None; } }
  ...
  public static Offset<Japan.CouponStuffExcel> CreateCouponStuffExcel(FlatBufferBuilder builder,
      long StuffId = 0,
  ...
  public static void AddParcelType(FlatBufferBuilder builder, Japan.ParcelType parcelType) { builder.AddInt(1, (int)parcelType, 0); }
  ...
  public static Offset<Japan.CouponStuffExcel> EndCouponStuffExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.CouponStuffExcel>(o);
  }
  ...
  public static Offset<Japan.CouponStuffExcel> Pack(FlatBufferBuilder builder, CouponStuffExcelT _o) {
    if (_o == null) return default(Offset<Japan.CouponStuffExcel>);
		byte[] key = TableEncryptionService.CreateKey("CouponStuff");
...
static public class CouponStuffExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*ParcelType*/, 4 /*Japan.ParcelType*/, 4, false)
