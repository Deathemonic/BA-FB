...
public struct ProductExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.ProductExcel> CreateProductExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Japan.ProductExcel> EndProductExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ProductExcel>(o);
  }
  ...
  public static Offset<Japan.ProductExcel> Pack(FlatBufferBuilder builder, ProductExcelT _o) {
    if (_o == null) return default(Offset<Japan.ProductExcel>);
		byte[] key = TableEncryptionService.CreateKey("Product");
