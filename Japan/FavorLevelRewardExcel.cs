...
public struct FavorLevelRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.FavorLevelRewardExcel> CreateFavorLevelRewardExcel(FlatBufferBuilder builder,
      long CharacterId = 0,
      long FavorLevel = 0,
  ...
  public static Offset<Japan.FavorLevelRewardExcel> EndFavorLevelRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.FavorLevelRewardExcel>(o);
  }
  ...
  public static Offset<Japan.FavorLevelRewardExcel> Pack(FlatBufferBuilder builder, FavorLevelRewardExcelT _o) {
    if (_o == null) return default(Offset<Japan.FavorLevelRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("FavorLevelReward");
