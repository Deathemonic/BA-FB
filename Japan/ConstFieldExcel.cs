...
public struct ConstFieldExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.ConstFieldExcel> CreateConstFieldExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.ConstFieldExcel> EndConstFieldExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ConstFieldExcel>(o);
  }
  ...
  public void UnPackTo(ConstFieldExcelT _o) {
    ...
    _o.DialogSmoothTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.DialogSmoothTime, key) : this.DialogSmoothTime;
    _o.TalkDialogDurationDefault = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.TalkDialogDurationDefault, key) : this.TalkDialogDurationDefault;
    _o.ThinkDialogDurationDefault = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ThinkDialogDurationDefault, key) : this.ThinkDialogDurationDefault;
    _o.IdleThinkDelayMin = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.IdleThinkDelayMin, key) : this.IdleThinkDelayMin;
    _o.IdleThinkDelayMax = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.IdleThinkDelayMax, key) : this.IdleThinkDelayMax;
  }
  public static Offset<Japan.ConstFieldExcel> Pack(FlatBufferBuilder builder, ConstFieldExcelT _o) {
    if (_o == null) return default(Offset<Japan.ConstFieldExcel>);
		byte[] key = TableEncryptionService.CreateKey("ConstField");
		var _DialogSmoothTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DialogSmoothTime, key) : _o.DialogSmoothTime;
		var _TalkDialogDurationDefault = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.TalkDialogDurationDefault, key) : _o.TalkDialogDurationDefault;
		var _ThinkDialogDurationDefault = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ThinkDialogDurationDefault, key) : _o.ThinkDialogDurationDefault;
		var _IdleThinkDelayMin = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IdleThinkDelayMin, key) : _o.IdleThinkDelayMin;
		var _IdleThinkDelayMax = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IdleThinkDelayMax, key) : _o.IdleThinkDelayMax;
