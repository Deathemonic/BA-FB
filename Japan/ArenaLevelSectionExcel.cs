...
public struct ArenaLevelSectionExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.ArenaLevelSectionExcel> CreateArenaLevelSectionExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.ArenaLevelSectionExcel> EndArenaLevelSectionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ArenaLevelSectionExcel>(o);
  }
  ...
  public void UnPackTo(ArenaLevelSectionExcelT _o) {
    ...
    _o.StartLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StartLevel, key) : this.StartLevel;
    _o.LastLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.LastLevel, key) : this.LastLevel;
    _o.UserCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.UserCount, key) : this.UserCount;
  }
  public static Offset<Japan.ArenaLevelSectionExcel> Pack(FlatBufferBuilder builder, ArenaLevelSectionExcelT _o) {
    if (_o == null) return default(Offset<Japan.ArenaLevelSectionExcel>);
		byte[] key = TableEncryptionService.CreateKey("ArenaLevelSection");
		var _ArenaSeasonId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ArenaSeasonId, key) : _o.ArenaSeasonId;
		var _StartLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StartLevel, key) : _o.StartLevel;
		var _LastLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.LastLevel, key) : _o.LastLevel;
		var _UserCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.UserCount, key) : _o.UserCount;
