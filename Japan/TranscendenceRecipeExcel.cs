...
public struct TranscendenceRecipeExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.TranscendenceRecipeExcel> Pack(FlatBufferBuilder builder, TranscendenceRecipeExcelT _o) {
    ...
    var _DevName = _o.DevName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.DevName, key) : _o.DevName));
		var _CostCurrencyType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CostCurrencyType, key) : _o.CostCurrencyType;
		var _CostCurrencyAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CostCurrencyAmount, key) : _o.CostCurrencyAmount;
