...
public struct StringTestExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.StringTestExcel> CreateStringTestExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.StringTestExcel> EndStringTestExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.StringTestExcel>(o);
  }
  ...
  public static Offset<Japan.StringTestExcel> Pack(FlatBufferBuilder builder, StringTestExcelT _o) {
    if (_o == null) return default(Offset<Japan.StringTestExcel>);
		byte[] key = TableEncryptionService.CreateKey("StringTest");
