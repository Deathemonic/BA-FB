...
public struct DefaultMailExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.DefaultMailExcel> Pack(FlatBufferBuilder builder, DefaultMailExcelT _o) {
    ...
    var _MailSendPeriodFrom = _o.MailSendPeriodFrom == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.MailSendPeriodFrom, key) : _o.MailSendPeriodFrom));
    var _MailSendPeriodTo = _o.MailSendPeriodTo == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.MailSendPeriodTo, key) : _o.MailSendPeriodTo));
