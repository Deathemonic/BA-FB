...
public struct DefaultMailExcel : IFlatbufferObject
{
  ...
  public Japan.MailType MailType { get { int o = __p.__offset(8); return o != 0 ? (Japan.MailType)__p.bb.GetInt(o + __p.bb_pos) : Japan.MailType.System; } }
  ...
  public static Offset<Japan.DefaultMailExcel> CreateDefaultMailExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddMailType(FlatBufferBuilder builder, Japan.MailType mailType) { builder.AddInt(2, (int)mailType, 0); }
  ...
  public static Offset<Japan.DefaultMailExcel> EndDefaultMailExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.DefaultMailExcel>(o);
  }
  ...
  public void UnPackTo(DefaultMailExcelT _o) {
    ...
    _o.MailSendPeriodFrom = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MailSendPeriodFrom, key) : this.MailSendPeriodFrom;
    _o.MailSendPeriodTo = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MailSendPeriodTo, key) : this.MailSendPeriodTo;
  ...
  public static Offset<Japan.DefaultMailExcel> Pack(FlatBufferBuilder builder, DefaultMailExcelT _o) {
    if (_o == null) return default(Offset<Japan.DefaultMailExcel>);
		byte[] key = TableEncryptionService.CreateKey("DefaultMail");
    ...
    var _MailSendPeriodFrom = _o.MailSendPeriodFrom == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.MailSendPeriodFrom, key) : _o.MailSendPeriodFrom));
    var _MailSendPeriodTo = _o.MailSendPeriodTo == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.MailSendPeriodTo, key) : _o.MailSendPeriodTo));
...
static public class DefaultMailExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*MailType*/, 4 /*Japan.MailType*/, 4, false)
