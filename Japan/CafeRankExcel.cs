...
public struct CafeRankExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.CafeRankExcel> CreateCafeRankExcel(FlatBufferBuilder builder,
      long CafeId = 0,
      long Rank = 0,
      long RecipeId = 0,
      long ComfortMax = 0,
  ...
  public static Offset<Japan.CafeRankExcel> EndCafeRankExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.CafeRankExcel>(o);
  }
  ...
  public static Offset<Japan.CafeRankExcel> Pack(FlatBufferBuilder builder, CafeRankExcelT _o) {
    if (_o == null) return default(Offset<Japan.CafeRankExcel>);
		byte[] key = TableEncryptionService.CreateKey("CafeRank");
