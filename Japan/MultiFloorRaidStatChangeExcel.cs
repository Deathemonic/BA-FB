...
public struct MultiFloorRaidStatChangeExcel : IFlatbufferObject
{
  ...
  public Japan.StatType StatType(int j) { int o = __p.__offset(6); return o != 0 ? (Japan.StatType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.StatType)0; }
  public int StatTypeLength { get { int o = __p.__offset(6); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.StatType> GetStatTypeBytes() { return __p.__vector_as_span<Japan.StatType>(6, 4); }
#else
  public ArraySegment<byte>? GetStatTypeBytes() { return __p.__vector_as_arraysegment(6); }
#endif
  public Japan.StatType[] GetStatTypeArray() { int o = __p.__offset(6); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.StatType[] a = new Japan.StatType[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.StatType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Japan.MultiFloorRaidStatChangeExcel> CreateMultiFloorRaidStatChangeExcel(FlatBufferBuilder builder,
      long StatChangeId = 0,
  ...
  public static VectorOffset CreateStatTypeVector(FlatBufferBuilder builder, Japan.StatType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateStatTypeVectorBlock(FlatBufferBuilder builder, Japan.StatType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateStatTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Japan.StatType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateStatTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Japan.StatType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Japan.MultiFloorRaidStatChangeExcel> EndMultiFloorRaidStatChangeExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.MultiFloorRaidStatChangeExcel>(o);
  }
  ...
  public void UnPackTo(MultiFloorRaidStatChangeExcelT _o) {
    ...
    _o.StatType = new List<Japan.StatType>();
    for (var _j = 0; _j < this.StatTypeLength; ++_j) {_o.StatType.Add(TableEncryptionService.UseEncryption ? (Japan.StatType)TableEncryptionService.Convert((int)this.StatType(_j), key) : this.StatType(_j));}
  ...
  public static Offset<Japan.MultiFloorRaidStatChangeExcel> Pack(FlatBufferBuilder builder, MultiFloorRaidStatChangeExcelT _o) {
    if (_o == null) return default(Offset<Japan.MultiFloorRaidStatChangeExcel>);
		byte[] key = TableEncryptionService.CreateKey("MultiFloorRaidStatChange");
    ...
    if (_o.StatType != null) {
      var __StatType = _o.StatType.Select(x => TableEncryptionService.UseEncryption ? (Japan.StatType)TableEncryptionService.Convert((int)x, key) : x).ToArray();
...
public class MultiFloorRaidStatChangeExcelT
{
  ...
  public List<Japan.StatType> StatType { get; set; }
...
static public class MultiFloorRaidStatChangeExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 6 /*StatType*/, 4 /*Japan.StatType*/, false)
