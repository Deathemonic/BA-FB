...
public struct ScenarioReplayExcel : IFlatbufferObject
{
  ...
  public Japan.ScenarioModeReplayTypes ReplayType { get { int o = __p.__offset(8); return o != 0 ? (Japan.ScenarioModeReplayTypes)__p.bb.GetInt(o + __p.bb_pos) : Japan.ScenarioModeReplayTypes.None; } }
  ...
  public static Offset<Japan.ScenarioReplayExcel> CreateScenarioReplayExcel(FlatBufferBuilder builder,
      long ModeId = 0,
      long VolumeId = 0,
      Japan.ScenarioModeReplayTypes ReplayType = Japan.ScenarioModeReplayTypes.None,
      long ChapterId = 0,
      long EpisodeId = 0,
  ...
  public static void AddReplayType(FlatBufferBuilder builder, Japan.ScenarioModeReplayTypes replayType) { builder.AddInt(2, (int)replayType, 0); }
  ...
  public static Offset<Japan.ScenarioReplayExcel> EndScenarioReplayExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ScenarioReplayExcel>(o);
  }
  ...
  public static Offset<Japan.ScenarioReplayExcel> Pack(FlatBufferBuilder builder, ScenarioReplayExcelT _o) {
    if (_o == null) return default(Offset<Japan.ScenarioReplayExcel>);
		byte[] key = TableEncryptionService.CreateKey("ScenarioReplay");
...
public class ScenarioReplayExcelT
{
  ...
  public Japan.ScenarioModeReplayTypes ReplayType { get; set; }
  ...
  public ScenarioReplayExcelT() {
    this.ModeId = 0;
    this.VolumeId = 0;
    this.ReplayType = Japan.ScenarioModeReplayTypes.None;
    this.ChapterId = 0;
    this.EpisodeId = 0;
...
static public class ScenarioReplayExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*ReplayType*/, 4 /*Japan.ScenarioModeReplayTypes*/, 4, false)
