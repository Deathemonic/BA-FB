...
public struct ScenarioReplayExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ScenarioReplayExcelT _o) {
    ...
    _o.ReplayType = TableEncryptionService.UseEncryption ? (Japan.ScenarioModeReplayTypes)TableEncryptionService.Convert((int)this.ReplayType, key) : this.ReplayType;
  ...
  public static Offset<Japan.ScenarioReplayExcel> Pack(FlatBufferBuilder builder, ScenarioReplayExcelT _o) {
    if (_o == null) return default(Offset<Japan.ScenarioReplayExcel>);
		...
		var _ReplayType = TableEncryptionService.UseEncryption ? (Japan.ScenarioModeReplayTypes)TableEncryptionService.Convert((int)_o.ReplayType, key) : _o.ReplayType;
