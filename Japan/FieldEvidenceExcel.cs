...
public struct FieldEvidenceExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.FieldEvidenceExcel> CreateFieldEvidenceExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      long SeasonId = 0,
  ...
  public static Offset<Japan.FieldEvidenceExcel> EndFieldEvidenceExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.FieldEvidenceExcel>(o);
  }
  ...
  public static Offset<Japan.FieldEvidenceExcel> Pack(FlatBufferBuilder builder, FieldEvidenceExcelT _o) {
    if (_o == null) return default(Offset<Japan.FieldEvidenceExcel>);
		byte[] key = TableEncryptionService.CreateKey("FieldEvidence");
