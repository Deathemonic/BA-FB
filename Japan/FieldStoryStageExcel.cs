...
public struct FieldStoryStageExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.FieldStoryStageExcel> CreateFieldStoryStageExcel(FlatBufferBuilder builder,
      long Id = 0,
      long SeasonId = 0,
  ...
  public static Offset<Japan.FieldStoryStageExcel> EndFieldStoryStageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.FieldStoryStageExcel>(o);
  }
  ...
  public static Offset<Japan.FieldStoryStageExcel> Pack(FlatBufferBuilder builder, FieldStoryStageExcelT _o) {
    if (_o == null) return default(Offset<Japan.FieldStoryStageExcel>);
		byte[] key = TableEncryptionService.CreateKey("FieldStoryStage");
