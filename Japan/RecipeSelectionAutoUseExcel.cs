...
public struct RecipeSelectionAutoUseExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.RecipeSelectionAutoUseExcel> CreateRecipeSelectionAutoUseExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Japan.RecipeSelectionAutoUseExcel> EndRecipeSelectionAutoUseExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.RecipeSelectionAutoUseExcel>(o);
  }
  ...
  public static Offset<Japan.RecipeSelectionAutoUseExcel> Pack(FlatBufferBuilder builder, RecipeSelectionAutoUseExcelT _o) {
    if (_o == null) return default(Offset<Japan.RecipeSelectionAutoUseExcel>);
		byte[] key = TableEncryptionService.CreateKey("RecipeSelectionAutoUse");
