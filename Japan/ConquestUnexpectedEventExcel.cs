...
public struct ConquestUnexpectedEventExcel : IFlatbufferObject
{
  ...
  public Japan.ParcelType UnexpectedEventConditionType { get { int o = __p.__offset(6); return o != 0 ? (Japan.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Japan.ParcelType.None; } }
  ...
  public static Offset<Japan.ConquestUnexpectedEventExcel> CreateConquestUnexpectedEventExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      Japan.ParcelType UnexpectedEventConditionType = Japan.ParcelType.None,
  ...
  public static void AddUnexpectedEventConditionType(FlatBufferBuilder builder, Japan.ParcelType unexpectedEventConditionType) { builder.AddInt(1, (int)unexpectedEventConditionType, 0); }
  ...
  public static Offset<Japan.ConquestUnexpectedEventExcel> EndConquestUnexpectedEventExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ConquestUnexpectedEventExcel>(o);
  }
  ...
  public void UnPackTo(ConquestUnexpectedEventExcelT _o) {
    ...
    _o.UnexpectedEventConditionType = TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)this.UnexpectedEventConditionType, key) : this.UnexpectedEventConditionType;
  ...
  public static Offset<Japan.ConquestUnexpectedEventExcel> Pack(FlatBufferBuilder builder, ConquestUnexpectedEventExcelT _o) {
    if (_o == null) return default(Offset<Japan.ConquestUnexpectedEventExcel>);
		byte[] key = TableEncryptionService.CreateKey("ConquestUnexpectedEvent");
		...
		var _UnexpectedEventConditionType = TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)_o.UnexpectedEventConditionType, key) : _o.UnexpectedEventConditionType;
...
public class ConquestUnexpectedEventExcelT
{
  ...
  public Japan.ParcelType UnexpectedEventConditionType { get; set; }
  ...
  public ConquestUnexpectedEventExcelT() {
    ...
    this.UnexpectedEventConditionType = Japan.ParcelType.None;
...
static public class ConquestUnexpectedEventExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*UnexpectedEventConditionType*/, 4 /*Japan.ParcelType*/, 4, false)
