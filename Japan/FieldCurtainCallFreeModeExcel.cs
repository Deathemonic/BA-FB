...
public struct FieldCurtainCallFreeModeExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.FieldCurtainCallFreeModeExcel> CreateFieldCurtainCallFreeModeExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      long OpenDate = 0,
  ...
  public static Offset<Japan.FieldCurtainCallFreeModeExcel> EndFieldCurtainCallFreeModeExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.FieldCurtainCallFreeModeExcel>(o);
  }
  ...
  public static Offset<Japan.FieldCurtainCallFreeModeExcel> Pack(FlatBufferBuilder builder, FieldCurtainCallFreeModeExcelT _o) {
    if (_o == null) return default(Offset<Japan.FieldCurtainCallFreeModeExcel>);
		byte[] key = TableEncryptionService.CreateKey("FieldCurtainCallFreeMode");
