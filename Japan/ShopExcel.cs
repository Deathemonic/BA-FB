...
public struct ShopExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ShopExcelT _o) {
    ...
    _o.PurchaseCountResetType = TableEncryptionService.UseEncryption ? (Japan.PurchaseCountResetType)TableEncryptionService.Convert((int)this.PurchaseCountResetType, key) : this.PurchaseCountResetType;
  ...
  public static Offset<Japan.ShopExcel> Pack(FlatBufferBuilder builder, ShopExcelT _o) {
    ...
    var _SalePeriodTo = _o.SalePeriodTo == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.SalePeriodTo, key) : _o.SalePeriodTo));
		...
		var _PurchaseCountResetType = TableEncryptionService.UseEncryption ? (Japan.PurchaseCountResetType)TableEncryptionService.Convert((int)_o.PurchaseCountResetType, key) : _o.PurchaseCountResetType;
