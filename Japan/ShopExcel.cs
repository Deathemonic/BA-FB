...
public struct ShopExcel : IFlatbufferObject
{
  ...
  public Japan.ShopCategoryType CategoryType { get { int o = __p.__offset(8); return o != 0 ? (Japan.ShopCategoryType)__p.bb.GetInt(o + __p.bb_pos) : Japan.ShopCategoryType.General; } }
  ...
  public Japan.PurchaseCountResetType PurchaseCountResetType { get { int o = __p.__offset(26); return o != 0 ? (Japan.PurchaseCountResetType)__p.bb.GetInt(o + __p.bb_pos) : Japan.PurchaseCountResetType.None; } }
  ...
  public static Offset<Japan.ShopExcel> CreateShopExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddCategoryType(FlatBufferBuilder builder, Japan.ShopCategoryType categoryType) { builder.AddInt(2, (int)categoryType, 0); }
  ...
  public static void AddPurchaseCountResetType(FlatBufferBuilder builder, Japan.PurchaseCountResetType purchaseCountResetType) { builder.AddInt(11, (int)purchaseCountResetType, 0); }
  ...
  public static Offset<Japan.ShopExcel> EndShopExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ShopExcel>(o);
  }
  ...
  public static Offset<Japan.ShopExcel> Pack(FlatBufferBuilder builder, ShopExcelT _o) {
    if (_o == null) return default(Offset<Japan.ShopExcel>);
		byte[] key = TableEncryptionService.CreateKey("Shop");
...
static public class ShopExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*CategoryType*/, 4 /*Japan.ShopCategoryType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 26 /*PurchaseCountResetType*/, 4 /*Japan.PurchaseCountResetType*/, 4, false)
