...
public struct LocalizeGachaShopExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.LocalizeGachaShopExcel> CreateLocalizeGachaShopExcel(FlatBufferBuilder builder,
      long GachaShopId = 0,
  ...
  public static Offset<Japan.LocalizeGachaShopExcel> EndLocalizeGachaShopExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.LocalizeGachaShopExcel>(o);
  }
  ...
  public static Offset<Japan.LocalizeGachaShopExcel> Pack(FlatBufferBuilder builder, LocalizeGachaShopExcelT _o) {
    if (_o == null) return default(Offset<Japan.LocalizeGachaShopExcel>);
		byte[] key = TableEncryptionService.CreateKey("LocalizeGachaShop");
