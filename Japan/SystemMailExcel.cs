...
public struct SystemMailExcel : IFlatbufferObject
{
  ...
  public Japan.MailType MailType { get { int o = __p.__offset(4); return o != 0 ? (Japan.MailType)__p.bb.GetInt(o + __p.bb_pos) : Japan.MailType.System; } }
  ...
  public static Offset<Japan.SystemMailExcel> CreateSystemMailExcel(FlatBufferBuilder builder,
  ...
  public static void AddMailType(FlatBufferBuilder builder, Japan.MailType mailType) { builder.AddInt(0, (int)mailType, 0); }
  ...
  public static Offset<Japan.SystemMailExcel> EndSystemMailExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.SystemMailExcel>(o);
  }
  ...
  public void UnPackTo(SystemMailExcelT _o) {
    ...
    _o.ExpiredDay = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ExpiredDay, key) : this.ExpiredDay;
  ...
  public static Offset<Japan.SystemMailExcel> Pack(FlatBufferBuilder builder, SystemMailExcelT _o) {
    if (_o == null) return default(Offset<Japan.SystemMailExcel>);
		byte[] key = TableEncryptionService.CreateKey("SystemMail");
		...
		var _ExpiredDay = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ExpiredDay, key) : _o.ExpiredDay;
    var _Sender = _o.Sender == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.Sender, key) : _o.Sender));
    var _Comment = _o.Comment == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.Comment, key) : _o.Comment));
    return CreateSystemMailExcel(
      builder,
      TableEncryptionService.UseEncryption ? _MailType : _o.MailType,
      TableEncryptionService.UseEncryption ? _ExpiredDay : _o.ExpiredDay,
      _Sender,
      _Comment);
  }
}
...
static public class SystemMailExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyField(tablePos, 4 /*MailType*/, 4 /*Japan.MailType*/, 4, false)
