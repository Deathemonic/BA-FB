...
public struct SystemMailExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.SystemMailExcel> Pack(FlatBufferBuilder builder, SystemMailExcelT _o) {
    if (_o == null) return default(Offset<Japan.SystemMailExcel>);
		...
		var _ExpiredDay = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ExpiredDay, key) : _o.ExpiredDay;
    var _Sender = _o.Sender == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.Sender, key) : _o.Sender));
    var _Comment = _o.Comment == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.Comment, key) : _o.Comment));
