...
public struct ScenarioBGEffectExcel : IFlatbufferObject
{
  ...
  public Japan.ScenarioBGScroll Scroll { get { int o = __p.__offset(10); return o != 0 ? (Japan.ScenarioBGScroll)__p.bb.GetInt(o + __p.bb_pos) : Japan.ScenarioBGScroll.None; } }
  ...
  public static Offset<Japan.ScenarioBGEffectExcel> CreateScenarioBGEffectExcel(FlatBufferBuilder builder,
      uint Name = 0,
      StringOffset EffectOffset = default(StringOffset),
      StringOffset Effect2Offset = default(StringOffset),
      Japan.ScenarioBGScroll Scroll = Japan.ScenarioBGScroll.None,
      long ScrollTime = 0,
      long ScrollFrom = 0,
      long ScrollTo = 0) {
  ...
  public static void AddScroll(FlatBufferBuilder builder, Japan.ScenarioBGScroll scroll) { builder.AddInt(3, (int)scroll, 0); }
  ...
  public static Offset<Japan.ScenarioBGEffectExcel> EndScenarioBGEffectExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ScenarioBGEffectExcel>(o);
  }
  ...
  public void UnPackTo(ScenarioBGEffectExcelT _o) {
    ...
    _o.Scroll = TableEncryptionService.UseEncryption ? (Japan.ScenarioBGScroll)TableEncryptionService.Convert((int)this.Scroll, key) : this.Scroll;
  ...
  public static Offset<Japan.ScenarioBGEffectExcel> Pack(FlatBufferBuilder builder, ScenarioBGEffectExcelT _o) {
    if (_o == null) return default(Offset<Japan.ScenarioBGEffectExcel>);
		byte[] key = TableEncryptionService.CreateKey("ScenarioBGEffect");
    ...
    var _Effect2 = _o.Effect2 == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.Effect2, key) : _o.Effect2));
		var _Scroll = TableEncryptionService.UseEncryption ? (Japan.ScenarioBGScroll)TableEncryptionService.Convert((int)_o.Scroll, key) : _o.Scroll;
...
public class ScenarioBGEffectExcelT
{
  ...
  public Japan.ScenarioBGScroll Scroll { get; set; }
  ...
  public ScenarioBGEffectExcelT() {
    ...
    this.Effect = null;
    this.Effect2 = null;
    this.Scroll = Japan.ScenarioBGScroll.None;
    this.ScrollTime = 0;
    this.ScrollFrom = 0;
    this.ScrollTo = 0;
  }
...
static public class ScenarioBGEffectExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*Scroll*/, 4 /*Japan.ScenarioBGScroll*/, 4, false)
