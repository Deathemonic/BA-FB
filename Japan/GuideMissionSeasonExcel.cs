...
public struct GuideMissionSeasonExcel : IFlatbufferObject
{
  ...
  public Japan.ParcelType RequirementParcelType { get { int o = __p.__offset(44); return o != 0 ? (Japan.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Japan.ParcelType.None; } }
  ...
  public Japan.GuideMissionTabType TabType { get { int o = __p.__offset(50); return o != 0 ? (Japan.GuideMissionTabType)__p.bb.GetInt(o + __p.bb_pos) : Japan.GuideMissionTabType.None; } }
  ...
  public static Offset<Japan.GuideMissionSeasonExcel> CreateGuideMissionSeasonExcel(FlatBufferBuilder builder,
      long Id = 0,
      ...
      Japan.ParcelType RequirementParcelType = Japan.ParcelType.None,
      long RequirementParcelId = 0,
      int RequirementParcelAmount = 0,
      Japan.GuideMissionTabType TabType = Japan.GuideMissionTabType.None,
  ...
  public static void AddRequirementParcelType(FlatBufferBuilder builder, Japan.ParcelType requirementParcelType) { builder.AddInt(20, (int)requirementParcelType, 0); }
  ...
  public static void AddTabType(FlatBufferBuilder builder, Japan.GuideMissionTabType tabType) { builder.AddInt(23, (int)tabType, 0); }
  ...
  public static Offset<Japan.GuideMissionSeasonExcel> EndGuideMissionSeasonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.GuideMissionSeasonExcel>(o);
  }
  ...
  public void UnPackTo(GuideMissionSeasonExcelT _o) {
    ...
    _o.CloseBannerAfterCompletion = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.CloseBannerAfterCompletion, key) : this.CloseBannerAfterCompletion;
    _o.MaximumLoginCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.MaximumLoginCount, key) : this.MaximumLoginCount;
    _o.ExpiryDate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ExpiryDate, key) : this.ExpiryDate;
    _o.IconOrder = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.IconOrder, key) : this.IconOrder;
    _o.SpineCharacterId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.SpineCharacterId, key) : this.SpineCharacterId;
    ...
    _o.RequirementParcelType = TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)this.RequirementParcelType, key) : this.RequirementParcelType;
    _o.RequirementParcelId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.RequirementParcelId, key) : this.RequirementParcelId;
    _o.RequirementParcelAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.RequirementParcelAmount, key) : this.RequirementParcelAmount;
    _o.TabType = TableEncryptionService.UseEncryption ? (Japan.GuideMissionTabType)TableEncryptionService.Convert((int)this.TabType, key) : this.TabType;
    _o.IsPermanent = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.IsPermanent, key) : this.IsPermanent;
    _o.PreSeasonId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.PreSeasonId, key) : this.PreSeasonId;
  }
  public static Offset<Japan.GuideMissionSeasonExcel> Pack(FlatBufferBuilder builder, GuideMissionSeasonExcelT _o) {
    if (_o == null) return default(Offset<Japan.GuideMissionSeasonExcel>);
		byte[] key = TableEncryptionService.CreateKey("GuideMissionSeason");
		var _Id = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.Id, key) : _o.Id;
    var _TitleLocalizeCode = _o.TitleLocalizeCode == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.TitleLocalizeCode, key) : _o.TitleLocalizeCode));
    var _PermanentInfomationLocalizeCode = _o.PermanentInfomationLocalizeCode == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.PermanentInfomationLocalizeCode, key) : _o.PermanentInfomationLocalizeCode));
    var _InfomationLocalizeCode = _o.InfomationLocalizeCode == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.InfomationLocalizeCode, key) : _o.InfomationLocalizeCode));
    ...
    var _BannerOpenDate = _o.BannerOpenDate == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.BannerOpenDate, key) : _o.BannerOpenDate));
    ...
    var _EndDate = _o.EndDate == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.EndDate, key) : _o.EndDate));
		var _CloseBannerAfterCompletion = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.CloseBannerAfterCompletion, key) : _o.CloseBannerAfterCompletion;
		var _MaximumLoginCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.MaximumLoginCount, key) : _o.MaximumLoginCount;
		var _ExpiryDate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ExpiryDate, key) : _o.ExpiryDate;
		var _IconOrder = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.IconOrder, key) : _o.IconOrder;
		var _SpineCharacterId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.SpineCharacterId, key) : _o.SpineCharacterId;
    var _RequirementParcelImage = _o.RequirementParcelImage == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.RequirementParcelImage, key) : _o.RequirementParcelImage));
    var _RewardImage = _o.RewardImage == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.RewardImage, key) : _o.RewardImage));
    ...
    var _BackgroundImage = _o.BackgroundImage == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.BackgroundImage, key) : _o.BackgroundImage));
    var _TitleImage = _o.TitleImage == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.TitleImage, key) : _o.TitleImage));
		var _RequirementParcelType = TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)_o.RequirementParcelType, key) : _o.RequirementParcelType;
		var _RequirementParcelId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.RequirementParcelId, key) : _o.RequirementParcelId;
		var _RequirementParcelAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.RequirementParcelAmount, key) : _o.RequirementParcelAmount;
		var _TabType = TableEncryptionService.UseEncryption ? (Japan.GuideMissionTabType)TableEncryptionService.Convert((int)_o.TabType, key) : _o.TabType;
		var _IsPermanent = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.IsPermanent, key) : _o.IsPermanent;
		var _PreSeasonId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.PreSeasonId, key) : _o.PreSeasonId;
    return CreateGuideMissionSeasonExcel(
      ...
      _StartableEndDate,
      _EndDate,
      TableEncryptionService.UseEncryption ? _CloseBannerAfterCompletion : _o.CloseBannerAfterCompletion,
      TableEncryptionService.UseEncryption ? _MaximumLoginCount : _o.MaximumLoginCount,
      ...
      TableEncryptionService.UseEncryption ? _SpineCharacterId : _o.SpineCharacterId,
      _RequirementParcelImage,
      _RewardImage,
      _LobbyBannerImage,
      _BackgroundImage,
      _TitleImage,
      TableEncryptionService.UseEncryption ? _RequirementParcelType : _o.RequirementParcelType,
      TableEncryptionService.UseEncryption ? _RequirementParcelId : _o.RequirementParcelId,
      TableEncryptionService.UseEncryption ? _RequirementParcelAmount : _o.RequirementParcelAmount,
      TableEncryptionService.UseEncryption ? _TabType : _o.TabType,
      TableEncryptionService.UseEncryption ? _IsPermanent : _o.IsPermanent,
      TableEncryptionService.UseEncryption ? _PreSeasonId : _o.PreSeasonId);
  }
}
...
public class GuideMissionSeasonExcelT
{
  ...
  public Japan.ParcelType RequirementParcelType { get; set; }
  public long RequirementParcelId { get; set; }
  public int RequirementParcelAmount { get; set; }
  public Japan.GuideMissionTabType TabType { get; set; }
  ...
  public GuideMissionSeasonExcelT() {
    ...
    this.RequirementParcelType = Japan.ParcelType.None;
    this.RequirementParcelId = 0;
    this.RequirementParcelAmount = 0;
    this.TabType = Japan.GuideMissionTabType.None;
...
static public class GuideMissionSeasonExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 44 /*RequirementParcelType*/, 4 /*Japan.ParcelType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 50 /*TabType*/, 4 /*Japan.GuideMissionTabType*/, 4, false)
