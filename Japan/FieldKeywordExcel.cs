...
public struct FieldKeywordExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.FieldKeywordExcel> CreateFieldKeywordExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      long SeasonId = 0,
  ...
  public static Offset<Japan.FieldKeywordExcel> EndFieldKeywordExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.FieldKeywordExcel>(o);
  }
  ...
  public static Offset<Japan.FieldKeywordExcel> Pack(FlatBufferBuilder builder, FieldKeywordExcelT _o) {
    if (_o == null) return default(Offset<Japan.FieldKeywordExcel>);
		byte[] key = TableEncryptionService.CreateKey("FieldKeyword");
