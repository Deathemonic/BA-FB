...
public struct AcademyMessangerExcel : IFlatbufferObject
{
  ...
  public Japan.AcademyMessageConditions MessageCondition { get { int o = __p.__offset(10); return o != 0 ? (Japan.AcademyMessageConditions)__p.bb.GetInt(o + __p.bb_pos) : Japan.AcademyMessageConditions.None; } }
  ...
  public Japan.AcademyMessageTypes MessageType { get { int o = __p.__offset(24); return o != 0 ? (Japan.AcademyMessageTypes)__p.bb.GetInt(o + __p.bb_pos) : Japan.AcademyMessageTypes.None; } }
  ...
  public static Offset<Japan.AcademyMessangerExcel> CreateAcademyMessangerExcel(FlatBufferBuilder builder,
      long MessageGroupId = 0,
      long Id = 0,
      long CharacterId = 0,
      Japan.AcademyMessageConditions MessageCondition = Japan.AcademyMessageConditions.None,
      ...
      Japan.AcademyMessageTypes MessageType = Japan.AcademyMessageTypes.None,
  ...
  public static void AddMessageCondition(FlatBufferBuilder builder, Japan.AcademyMessageConditions messageCondition) { builder.AddInt(3, (int)messageCondition, 0); }
  ...
  public static void AddMessageType(FlatBufferBuilder builder, Japan.AcademyMessageTypes messageType) { builder.AddInt(10, (int)messageType, 0); }
  ...
  public static Offset<Japan.AcademyMessangerExcel> EndAcademyMessangerExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.AcademyMessangerExcel>(o);
  }
  ...
  public void UnPackTo(AcademyMessangerExcelT _o) {
    ...
    _o.MessageCondition = TableEncryptionService.UseEncryption ? (Japan.AcademyMessageConditions)TableEncryptionService.Convert((int)this.MessageCondition, key) : this.MessageCondition;
    ...
    _o.MessageType = TableEncryptionService.UseEncryption ? (Japan.AcademyMessageTypes)TableEncryptionService.Convert((int)this.MessageType, key) : this.MessageType;
  ...
  public static Offset<Japan.AcademyMessangerExcel> Pack(FlatBufferBuilder builder, AcademyMessangerExcelT _o) {
    if (_o == null) return default(Offset<Japan.AcademyMessangerExcel>);
		byte[] key = TableEncryptionService.CreateKey("AcademyMessanger");
		...
		var _MessageCondition = TableEncryptionService.UseEncryption ? (Japan.AcademyMessageConditions)TableEncryptionService.Convert((int)_o.MessageCondition, key) : _o.MessageCondition;
		...
		var _MessageType = TableEncryptionService.UseEncryption ? (Japan.AcademyMessageTypes)TableEncryptionService.Convert((int)_o.MessageType, key) : _o.MessageType;
...
public class AcademyMessangerExcelT
{
  ...
  public Japan.AcademyMessageConditions MessageCondition { get; set; }
  ...
  public Japan.AcademyMessageTypes MessageType { get; set; }
  ...
  public AcademyMessangerExcelT() {
    ...
    this.Id = 0;
    this.CharacterId = 0;
    this.MessageCondition = Japan.AcademyMessageConditions.None;
    ...
    this.MessageType = Japan.AcademyMessageTypes.None;
    this.ImagePath = null;
    this.MessageKR = null;
    this.MessageJP = null;
  }
...
static public class AcademyMessangerExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*MessageCondition*/, 4 /*Japan.AcademyMessageConditions*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 24 /*MessageType*/, 4 /*Japan.AcademyMessageTypes*/, 4, false)
