...
public struct CharacterDialogSubtitleExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.CharacterDialogSubtitleExcel> CreateCharacterDialogSubtitleExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.CharacterDialogSubtitleExcel> EndCharacterDialogSubtitleExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.CharacterDialogSubtitleExcel>(o);
  }
  ...
  public static Offset<Japan.CharacterDialogSubtitleExcel> Pack(FlatBufferBuilder builder, CharacterDialogSubtitleExcelT _o) {
    if (_o == null) return default(Offset<Japan.CharacterDialogSubtitleExcel>);
		byte[] key = TableEncryptionService.CreateKey("CharacterDialogSubtitle");
