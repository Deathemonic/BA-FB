...
public struct TacticSimulatorSettingExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.TacticSimulatorSettingExcel> CreateTacticSimulatorSettingExcel(FlatBufferBuilder builder,
      long GroundId = 0,
  ...
  public static Offset<Japan.TacticSimulatorSettingExcel> EndTacticSimulatorSettingExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.TacticSimulatorSettingExcel>(o);
  }
  ...
  public static Offset<Japan.TacticSimulatorSettingExcel> Pack(FlatBufferBuilder builder, TacticSimulatorSettingExcelT _o) {
    if (_o == null) return default(Offset<Japan.TacticSimulatorSettingExcel>);
		byte[] key = TableEncryptionService.CreateKey("TacticSimulatorSetting");
