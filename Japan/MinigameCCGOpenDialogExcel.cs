...
public struct MinigameCCGOpenDialogExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.MinigameCCGOpenDialogExcel> CreateMinigameCCGOpenDialogExcel(FlatBufferBuilder builder,
      long DialogId = 0,
      int PlayOrder = 0,
  ...
  public static Offset<Japan.MinigameCCGOpenDialogExcel> EndMinigameCCGOpenDialogExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.MinigameCCGOpenDialogExcel>(o);
  }
  ...
  public static Offset<Japan.MinigameCCGOpenDialogExcel> Pack(FlatBufferBuilder builder, MinigameCCGOpenDialogExcelT _o) {
    if (_o == null) return default(Offset<Japan.MinigameCCGOpenDialogExcel>);
		byte[] key = TableEncryptionService.CreateKey("MinigameCCGOpenDialog");
		var _DialogId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DialogId, key) : _o.DialogId;
		var _PlayOrder = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PlayOrder, key) : _o.PlayOrder;
		var _ConditionCard = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ConditionCard, key) : _o.ConditionCard;
		var _Dialog = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Dialog, key) : _o.Dialog;
		var _Duration = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Duration, key) : _o.Duration;
		var _Voice = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Voice, key) : _o.Voice;
