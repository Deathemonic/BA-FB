...
public struct SkillAdditionalTooltipExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.SkillAdditionalTooltipExcel> CreateSkillAdditionalTooltipExcel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static Offset<Japan.SkillAdditionalTooltipExcel> EndSkillAdditionalTooltipExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.SkillAdditionalTooltipExcel>(o);
  }
  ...
  public static Offset<Japan.SkillAdditionalTooltipExcel> Pack(FlatBufferBuilder builder, SkillAdditionalTooltipExcelT _o) {
    if (_o == null) return default(Offset<Japan.SkillAdditionalTooltipExcel>);
		byte[] key = TableEncryptionService.CreateKey("SkillAdditionalTooltip");
