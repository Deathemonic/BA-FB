...
public struct ContentsScenarioExcel : IFlatbufferObject
{
  ...
  public Japan.ScenarioContentType ScenarioContentType { get { int o = __p.__offset(10); return o != 0 ? (Japan.ScenarioContentType)__p.bb.GetInt(o + __p.bb_pos) : Japan.ScenarioContentType.Prologue; } }
  ...
  public static Offset<Japan.ContentsScenarioExcel> CreateContentsScenarioExcel(FlatBufferBuilder builder,
      uint Id = 0,
      uint LocalizeId = 0,
      int DisplayOrder = 0,
      Japan.ScenarioContentType ScenarioContentType = Japan.ScenarioContentType.Prologue,
  ...
  public static void AddScenarioContentType(FlatBufferBuilder builder, Japan.ScenarioContentType scenarioContentType) { builder.AddInt(3, (int)scenarioContentType, 0); }
  ...
  public static Offset<Japan.ContentsScenarioExcel> EndContentsScenarioExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ContentsScenarioExcel>(o);
  }
  ...
  public void UnPackTo(ContentsScenarioExcelT _o) {
    ...
    _o.ScenarioContentType = TableEncryptionService.UseEncryption ? (Japan.ScenarioContentType)TableEncryptionService.Convert((int)this.ScenarioContentType, key) : this.ScenarioContentType;
  ...
  public static Offset<Japan.ContentsScenarioExcel> Pack(FlatBufferBuilder builder, ContentsScenarioExcelT _o) {
    if (_o == null) return default(Offset<Japan.ContentsScenarioExcel>);
		byte[] key = TableEncryptionService.CreateKey("ContentsScenario");
		...
		var _ScenarioContentType = TableEncryptionService.UseEncryption ? (Japan.ScenarioContentType)TableEncryptionService.Convert((int)_o.ScenarioContentType, key) : _o.ScenarioContentType;
...
public class ContentsScenarioExcelT
{
  ...
  public Japan.ScenarioContentType ScenarioContentType { get; set; }
  ...
  public ContentsScenarioExcelT() {
    ...
    this.LocalizeId = 0;
    this.DisplayOrder = 0;
    this.ScenarioContentType = Japan.ScenarioContentType.Prologue;
...
static public class ContentsScenarioExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*ScenarioContentType*/, 4 /*Japan.ScenarioContentType*/, 4, false)
