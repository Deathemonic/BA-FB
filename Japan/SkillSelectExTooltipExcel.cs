...
public struct SkillSelectExTooltipExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.SkillSelectExTooltipExcel> CreateSkillSelectExTooltipExcel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static Offset<Japan.SkillSelectExTooltipExcel> EndSkillSelectExTooltipExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.SkillSelectExTooltipExcel>(o);
  }
  ...
  public static Offset<Japan.SkillSelectExTooltipExcel> Pack(FlatBufferBuilder builder, SkillSelectExTooltipExcelT _o) {
    if (_o == null) return default(Offset<Japan.SkillSelectExTooltipExcel>);
		byte[] key = TableEncryptionService.CreateKey("SkillSelectExTooltip");
		var _GroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.GroupId, key) : _o.GroupId;
    var _SelectableExSkillGroupId = _o.SelectableExSkillGroupId == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.SelectableExSkillGroupId, key) : _o.SelectableExSkillGroupId));
    var _SkillUseConditionLocalizeId = _o.SkillUseConditionLocalizeId == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.SkillUseConditionLocalizeId, key) : _o.SkillUseConditionLocalizeId));
