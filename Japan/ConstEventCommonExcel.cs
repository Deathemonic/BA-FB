...
public struct ConstEventCommonExcel : IFlatbufferObject
{
  ...
  public Japan.Rarity CardShopProbWeightRarity { get { int o = __p.__offset(14); return o != 0 ? (Japan.Rarity)__p.bb.GetInt(o + __p.bb_pos) : Japan.Rarity.N; } }
  ...
  public static Offset<Japan.ConstEventCommonExcel> CreateConstEventCommonExcel(FlatBufferBuilder builder,
      ...
      Japan.Rarity CardShopProbWeightRarity = Japan.Rarity.N,
  ...
  public static void AddCardShopProbWeightRarity(FlatBufferBuilder builder, Japan.Rarity cardShopProbWeightRarity) { builder.AddInt(5, (int)cardShopProbWeightRarity, 0); }
  ...
  public static Offset<Japan.ConstEventCommonExcel> EndConstEventCommonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ConstEventCommonExcel>(o);
  }
  ...
  public void UnPackTo(ConstEventCommonExcelT _o) {
    ...
    _o.CardShopProbWeightRarity = TableEncryptionService.UseEncryption ? (Japan.Rarity)TableEncryptionService.Convert((int)this.CardShopProbWeightRarity, key) : this.CardShopProbWeightRarity;
  ...
  public static Offset<Japan.ConstEventCommonExcel> Pack(FlatBufferBuilder builder, ConstEventCommonExcelT _o) {
    if (_o == null) return default(Offset<Japan.ConstEventCommonExcel>);
		byte[] key = TableEncryptionService.CreateKey("ConstEventCommon");
		...
		var _CardShopProbWeightRarity = TableEncryptionService.UseEncryption ? (Japan.Rarity)TableEncryptionService.Convert((int)_o.CardShopProbWeightRarity, key) : _o.CardShopProbWeightRarity;
...
public class ConstEventCommonExcelT
{
  ...
  public Japan.Rarity CardShopProbWeightRarity { get; set; }
  ...
  public ConstEventCommonExcelT() {
    ...
    this.CardShopProbWeightRarity = Japan.Rarity.N;
...
static public class ConstEventCommonExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 14 /*CardShopProbWeightRarity*/, 4 /*Japan.Rarity*/, 4, false)
