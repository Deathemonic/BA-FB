...
public struct PresetParcelsExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(PresetParcelsExcelT _o) {
    ...
    _o.ParcelAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ParcelAmount, key) : this.ParcelAmount;
  }
  public static Offset<Japan.PresetParcelsExcel> Pack(FlatBufferBuilder builder, PresetParcelsExcelT _o) {
    if (_o == null) return default(Offset<Japan.PresetParcelsExcel>);
		...
		var _ParcelAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ParcelAmount, key) : _o.ParcelAmount;
