...
public struct CharacterLevelStatFactorExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.CharacterLevelStatFactorExcel> CreateCharacterLevelStatFactorExcel(FlatBufferBuilder builder,
      long Level = 0,
  ...
  public static Offset<Japan.CharacterLevelStatFactorExcel> EndCharacterLevelStatFactorExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.CharacterLevelStatFactorExcel>(o);
  }
  ...
  public static Offset<Japan.CharacterLevelStatFactorExcel> Pack(FlatBufferBuilder builder, CharacterLevelStatFactorExcelT _o) {
    if (_o == null) return default(Offset<Japan.CharacterLevelStatFactorExcel>);
		byte[] key = TableEncryptionService.CreateKey("CharacterLevelStatFactor");
