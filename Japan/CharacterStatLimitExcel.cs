...
public struct CharacterStatLimitExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.CharacterStatLimitExcel> Pack(FlatBufferBuilder builder, CharacterStatLimitExcelT _o) {
    if (_o == null) return default(Offset<Japan.CharacterStatLimitExcel>);
		...
		var _StatType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StatType, key) : _o.StatType;
		var _StatMinValue = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StatMinValue, key) : _o.StatMinValue;
		var _StatMaxValue = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StatMaxValue, key) : _o.StatMaxValue;
		var _StatRatioMinValue = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StatRatioMinValue, key) : _o.StatRatioMinValue;
		var _StatRatioMaxValue = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StatRatioMaxValue, key) : _o.StatRatioMaxValue;
