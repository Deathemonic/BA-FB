...
public struct FieldMasteryExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(FieldMasteryExcelT _o) {
    ...
    _o.TokenType = TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)this.TokenType, key) : this.TokenType;
    ...
    _o.AccomplishmentConditionType = TableEncryptionService.UseEncryption ? (Japan.FieldConditionType)TableEncryptionService.Convert((int)this.AccomplishmentConditionType, key) : this.AccomplishmentConditionType;
  ...
  public static Offset<Japan.FieldMasteryExcel> Pack(FlatBufferBuilder builder, FieldMasteryExcelT _o) {
    if (_o == null) return default(Offset<Japan.FieldMasteryExcel>);
		...
		var _TokenType = TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)_o.TokenType, key) : _o.TokenType;
		...
		var _AccomplishmentConditionType = TableEncryptionService.UseEncryption ? (Japan.FieldConditionType)TableEncryptionService.Convert((int)_o.AccomplishmentConditionType, key) : _o.AccomplishmentConditionType;
