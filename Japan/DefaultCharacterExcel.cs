...
public struct DefaultCharacterExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.DefaultCharacterExcel> CreateDefaultCharacterExcel(FlatBufferBuilder builder,
      long CharacterId = 0,
  ...
  public static Offset<Japan.DefaultCharacterExcel> EndDefaultCharacterExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.DefaultCharacterExcel>(o);
  }
  ...
  public static Offset<Japan.DefaultCharacterExcel> Pack(FlatBufferBuilder builder, DefaultCharacterExcelT _o) {
    if (_o == null) return default(Offset<Japan.DefaultCharacterExcel>);
		byte[] key = TableEncryptionService.CreateKey("DefaultCharacter");
