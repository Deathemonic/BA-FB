...
public struct FieldContentStageExcel : IFlatbufferObject
{
  ...
  public Japan.StageDifficulty StageDifficulty { get { int o = __p.__offset(12); return o != 0 ? (Japan.StageDifficulty)__p.bb.GetInt(o + __p.bb_pos) : Japan.StageDifficulty.None; } }
  ...
  public Japan.ParcelType StageEnterCostType { get { int o = __p.__offset(20); return o != 0 ? (Japan.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Japan.ParcelType.None; } }
  ...
  public Japan.StarGoalType StarGoal(int j) { int o = __p.__offset(42); return o != 0 ? (Japan.StarGoalType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.StarGoalType)0; }
  public int StarGoalLength { get { int o = __p.__offset(42); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.StarGoalType> GetStarGoalBytes() { return __p.__vector_as_span<Japan.StarGoalType>(42, 4); }
#else
  public ArraySegment<byte>? GetStarGoalBytes() { return __p.__vector_as_arraysegment(42); }
#endif
  public Japan.StarGoalType[] GetStarGoalArray() { int o = __p.__offset(42); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.StarGoalType[] a = new Japan.StarGoalType[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.StarGoalType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Japan.FieldContentStageExcel> CreateFieldContentStageExcel(FlatBufferBuilder builder,
      long Id = 0,
      long SeasonId = 0,
      long AreaId = 0,
      long GroupId = 0,
  ...
  public static void AddStageDifficulty(FlatBufferBuilder builder, Japan.StageDifficulty stageDifficulty) { builder.AddInt(4, (int)stageDifficulty, 0); }
  ...
  public static void AddStageEnterCostType(FlatBufferBuilder builder, Japan.ParcelType stageEnterCostType) { builder.AddInt(8, (int)stageEnterCostType, 0); }
  ...
  public static Offset<Japan.FieldContentStageExcel> EndFieldContentStageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.FieldContentStageExcel>(o);
  }
  ...
  public static Offset<Japan.FieldContentStageExcel> Pack(FlatBufferBuilder builder, FieldContentStageExcelT _o) {
    if (_o == null) return default(Offset<Japan.FieldContentStageExcel>);
		byte[] key = TableEncryptionService.CreateKey("FieldContentStage");
...
static public class FieldContentStageExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*StageDifficulty*/, 4 /*Japan.StageDifficulty*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 20 /*StageEnterCostType*/, 4 /*Japan.ParcelType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 42 /*StarGoal*/, 4 /*Japan.StarGoalType*/, false)
