...
public struct TacticArenaSimulatorSettingExcel : IFlatbufferObject
{
  ...
  public Japan.ArenaSimulatorServer AttackerFrom { get { int o = __p.__offset(8); return o != 0 ? (Japan.ArenaSimulatorServer)__p.bb.GetInt(o + __p.bb_pos) : Japan.ArenaSimulatorServer.Preset; } }
  ...
  public Japan.ArenaSimulatorServer DefenderFrom { get { int o = __p.__offset(20); return o != 0 ? (Japan.ArenaSimulatorServer)__p.bb.GetInt(o + __p.bb_pos) : Japan.ArenaSimulatorServer.Preset; } }
  ...
  public static Offset<Japan.TacticArenaSimulatorSettingExcel> CreateTacticArenaSimulatorSettingExcel(FlatBufferBuilder builder,
      long Order = 0,
      long Repeat = 0,
      Japan.ArenaSimulatorServer AttackerFrom = Japan.ArenaSimulatorServer.Preset,
      ...
      Japan.ArenaSimulatorServer DefenderFrom = Japan.ArenaSimulatorServer.Preset,
  ...
  public static void AddAttackerFrom(FlatBufferBuilder builder, Japan.ArenaSimulatorServer attackerFrom) { builder.AddInt(2, (int)attackerFrom, 0); }
  ...
  public static void AddDefenderFrom(FlatBufferBuilder builder, Japan.ArenaSimulatorServer defenderFrom) { builder.AddInt(8, (int)defenderFrom, 0); }
  ...
  public static Offset<Japan.TacticArenaSimulatorSettingExcel> EndTacticArenaSimulatorSettingExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.TacticArenaSimulatorSettingExcel>(o);
  }
  ...
  public void UnPackTo(TacticArenaSimulatorSettingExcelT _o) {
    ...
    _o.AttackerFrom = TableEncryptionService.UseEncryption ? (Japan.ArenaSimulatorServer)TableEncryptionService.Convert((int)this.AttackerFrom, key) : this.AttackerFrom;
    ...
    _o.DefenderFrom = TableEncryptionService.UseEncryption ? (Japan.ArenaSimulatorServer)TableEncryptionService.Convert((int)this.DefenderFrom, key) : this.DefenderFrom;
  ...
  public static Offset<Japan.TacticArenaSimulatorSettingExcel> Pack(FlatBufferBuilder builder, TacticArenaSimulatorSettingExcelT _o) {
    if (_o == null) return default(Offset<Japan.TacticArenaSimulatorSettingExcel>);
		byte[] key = TableEncryptionService.CreateKey("TacticArenaSimulatorSetting");
		...
		var _AttackerFrom = TableEncryptionService.UseEncryption ? (Japan.ArenaSimulatorServer)TableEncryptionService.Convert((int)_o.AttackerFrom, key) : _o.AttackerFrom;
		...
		var _DefenderFrom = TableEncryptionService.UseEncryption ? (Japan.ArenaSimulatorServer)TableEncryptionService.Convert((int)_o.DefenderFrom, key) : _o.DefenderFrom;
...
public class TacticArenaSimulatorSettingExcelT
{
  ...
  public Japan.ArenaSimulatorServer AttackerFrom { get; set; }
  ...
  public Japan.ArenaSimulatorServer DefenderFrom { get; set; }
  ...
  public TacticArenaSimulatorSettingExcelT() {
    this.Order = 0;
    this.Repeat = 0;
    this.AttackerFrom = Japan.ArenaSimulatorServer.Preset;
    ...
    this.DefenderFrom = Japan.ArenaSimulatorServer.Preset;
...
static public class TacticArenaSimulatorSettingExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*AttackerFrom*/, 4 /*Japan.ArenaSimulatorServer*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 20 /*DefenderFrom*/, 4 /*Japan.ArenaSimulatorServer*/, 4, false)
