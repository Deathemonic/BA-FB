...
public struct AttendanceRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.AttendanceRewardExcel> CreateAttendanceRewardExcel(FlatBufferBuilder builder,
      long AttendanceId = 0,
      long Day = 0,
  ...
  public static Offset<Japan.AttendanceRewardExcel> EndAttendanceRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.AttendanceRewardExcel>(o);
  }
  ...
  public static Offset<Japan.AttendanceRewardExcel> Pack(FlatBufferBuilder builder, AttendanceRewardExcelT _o) {
    if (_o == null) return default(Offset<Japan.AttendanceRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("AttendanceReward");
