...
public struct BattlePassRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.BattlePassRewardExcel> CreateBattlePassRewardExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Japan.BattlePassRewardExcel> EndBattlePassRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.BattlePassRewardExcel>(o);
  }
  ...
  public static Offset<Japan.BattlePassRewardExcel> Pack(FlatBufferBuilder builder, BattlePassRewardExcelT _o) {
    if (_o == null) return default(Offset<Japan.BattlePassRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("BattlePassReward");
		...
		var _RewardParcelUniqueId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RewardParcelUniqueId, key) : _o.RewardParcelUniqueId;
