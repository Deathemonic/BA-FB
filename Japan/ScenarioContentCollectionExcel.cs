...
public struct ScenarioContentCollectionExcel : IFlatbufferObject
{
  ...
  public Japan.CollectionUnlockType UnlockConditionType { get { int o = __p.__offset(8); return o != 0 ? (Japan.CollectionUnlockType)__p.bb.GetInt(o + __p.bb_pos) : Japan.CollectionUnlockType.None; } }
  ...
  public Japan.MultipleConditionCheckType MultipleConditionCheckType { get { int o = __p.__offset(12); return o != 0 ? (Japan.MultipleConditionCheckType)__p.bb.GetInt(o + __p.bb_pos) : Japan.MultipleConditionCheckType.And; } }
  ...
  public static Offset<Japan.ScenarioContentCollectionExcel> CreateScenarioContentCollectionExcel(FlatBufferBuilder builder,
      long Id = 0,
      long GroupId = 0,
  ...
  public static void AddUnlockConditionType(FlatBufferBuilder builder, Japan.CollectionUnlockType unlockConditionType) { builder.AddInt(2, (int)unlockConditionType, 0); }
  ...
  public static void AddMultipleConditionCheckType(FlatBufferBuilder builder, Japan.MultipleConditionCheckType multipleConditionCheckType) { builder.AddInt(4, (int)multipleConditionCheckType, 0); }
  ...
  public static Offset<Japan.ScenarioContentCollectionExcel> EndScenarioContentCollectionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ScenarioContentCollectionExcel>(o);
  }
  ...
  public static Offset<Japan.ScenarioContentCollectionExcel> Pack(FlatBufferBuilder builder, ScenarioContentCollectionExcelT _o) {
    if (_o == null) return default(Offset<Japan.ScenarioContentCollectionExcel>);
		byte[] key = TableEncryptionService.CreateKey("ScenarioContentCollection");
...
static public class ScenarioContentCollectionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*UnlockConditionType*/, 4 /*Japan.CollectionUnlockType*/, 4, false)
      && verifier.VerifyVectorOfData(tablePos, 10 /*UnlockConditionParameter*/, 8 /*long*/, false)
      && verifier.VerifyField(tablePos, 12 /*MultipleConditionCheckType*/, 4 /*Japan.MultipleConditionCheckType*/, 4, false)
