...
public struct EventContentFortuneGachaShopExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.EventContentFortuneGachaShopExcel> CreateEventContentFortuneGachaShopExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.EventContentFortuneGachaShopExcel> EndEventContentFortuneGachaShopExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.EventContentFortuneGachaShopExcel>(o);
  }
  ...
  public static Offset<Japan.EventContentFortuneGachaShopExcel> Pack(FlatBufferBuilder builder, EventContentFortuneGachaShopExcelT _o) {
    if (_o == null) return default(Offset<Japan.EventContentFortuneGachaShopExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentFortuneGachaShop");
