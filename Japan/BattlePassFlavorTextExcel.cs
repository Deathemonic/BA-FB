...
public struct BattlePassFlavorTextExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.BattlePassFlavorTextExcel> CreateBattlePassFlavorTextExcel(FlatBufferBuilder builder,
      long GroupId = 0,
      long Id = 0,
  ...
  public static Offset<Japan.BattlePassFlavorTextExcel> EndBattlePassFlavorTextExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.BattlePassFlavorTextExcel>(o);
  }
  ...
  public static Offset<Japan.BattlePassFlavorTextExcel> Pack(FlatBufferBuilder builder, BattlePassFlavorTextExcelT _o) {
    if (_o == null) return default(Offset<Japan.BattlePassFlavorTextExcel>);
		byte[] key = TableEncryptionService.CreateKey("BattlePassFlavorText");
