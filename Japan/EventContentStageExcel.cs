...
public struct EventContentStageExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(EventContentStageExcelT _o) {
    ...
    _o.OpenConditionScenarioPermanentSubEventId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.OpenConditionScenarioPermanentSubEventId, key) : this.OpenConditionScenarioPermanentSubEventId;
    ...
    _o.OpenConditionContentType = TableEncryptionService.UseEncryption ? (Japan.EventContentType)TableEncryptionService.Convert((int)this.OpenConditionContentType, key) : this.OpenConditionContentType;
  ...
  public static Offset<Japan.EventContentStageExcel> Pack(FlatBufferBuilder builder, EventContentStageExcelT _o) {
    ...
    var _StageNumber = _o.StageNumber == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.StageNumber, key) : _o.StageNumber));
		...
		var _OpenConditionScenarioPermanentSubEventId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.OpenConditionScenarioPermanentSubEventId, key) : _o.OpenConditionScenarioPermanentSubEventId;
		...
		var _OpenConditionContentType = TableEncryptionService.UseEncryption ? (Japan.EventContentType)TableEncryptionService.Convert((int)_o.OpenConditionContentType, key) : _o.OpenConditionContentType;
