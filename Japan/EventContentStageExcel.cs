...
public struct EventContentStageExcel : IFlatbufferObject
{
  ...
  public Japan.EventContentType OpenConditionContentType { get { int o = __p.__offset(28); return o != 0 ? (Japan.EventContentType)__p.bb.GetInt(o + __p.bb_pos) : Japan.EventContentType.Stage; } }
  ...
  public Japan.ParcelType StageEnterCostType { get { int o = __p.__offset(34); return o != 0 ? (Japan.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Japan.ParcelType.None; } }
  ...
  public Japan.StageTopography StageTopography { get { int o = __p.__offset(58); return o != 0 ? (Japan.StageTopography)__p.bb.GetInt(o + __p.bb_pos) : Japan.StageTopography.Street; } }
  ...
  public Japan.StrategyEnvironment StrategyEnvironment { get { int o = __p.__offset(64); return o != 0 ? (Japan.StrategyEnvironment)__p.bb.GetInt(o + __p.bb_pos) : Japan.StrategyEnvironment.None; } }
  public long GroundID { get { int o = __p.__offset(66); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public Japan.ContentType ContentType { get { int o = __p.__offset(68); return o != 0 ? (Japan.ContentType)__p.bb.GetInt(o + __p.bb_pos) : Japan.ContentType.None; } }
  ...
  public Japan.StarGoalType StarGoal(int j) { int o = __p.__offset(80); return o != 0 ? (Japan.StarGoalType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.StarGoalType)0; }
  public int StarGoalLength { get { int o = __p.__offset(80); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.StarGoalType> GetStarGoalBytes() { return __p.__vector_as_span<Japan.StarGoalType>(80, 4); }
#else
  public ArraySegment<byte>? GetStarGoalBytes() { return __p.__vector_as_arraysegment(80); }
#endif
  public Japan.StarGoalType[] GetStarGoalArray() { int o = __p.__offset(80); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.StarGoalType[] a = new Japan.StarGoalType[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.StarGoalType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Japan.EchelonExtensionType EchelonExtensionType { get { int o = __p.__offset(88); return o != 0 ? (Japan.EchelonExtensionType)__p.bb.GetInt(o + __p.bb_pos) : Japan.EchelonExtensionType.Base; } }

  public static Offset<Japan.EventContentStageExcel> CreateEventContentStageExcel(FlatBufferBuilder builder,
      long Id = 0,
      ...
      Japan.EventContentType OpenConditionContentType = Japan.EventContentType.Stage,
  ...
  public static void AddOpenConditionContentType(FlatBufferBuilder builder, Japan.EventContentType openConditionContentType) { builder.AddInt(12, (int)openConditionContentType, 0); }
  ...
  public static void AddStageEnterCostType(FlatBufferBuilder builder, Japan.ParcelType stageEnterCostType) { builder.AddInt(15, (int)stageEnterCostType, 0); }
  ...
  public static void AddStageTopography(FlatBufferBuilder builder, Japan.StageTopography stageTopography) { builder.AddInt(27, (int)stageTopography, 0); }
  ...
  public static void AddStrategyEnvironment(FlatBufferBuilder builder, Japan.StrategyEnvironment strategyEnvironment) { builder.AddInt(30, (int)strategyEnvironment, 0); }
  public static void AddGroundID(FlatBufferBuilder builder, long groundID) { builder.AddLong(31, groundID, 0); }
  public static void AddContentType(FlatBufferBuilder builder, Japan.ContentType contentType) { builder.AddInt(32, (int)contentType, 0); }
  ...
  public static void AddEchelonExtensionType(FlatBufferBuilder builder, Japan.EchelonExtensionType echelonExtensionType) { builder.AddInt(42, (int)echelonExtensionType, 0); }
  public static Offset<Japan.EventContentStageExcel> EndEventContentStageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.EventContentStageExcel>(o);
  }
  ...
  public void UnPackTo(EventContentStageExcelT _o) {
    ...
    _o.OpenConditionScenarioPermanentSubEventId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.OpenConditionScenarioPermanentSubEventId, key) : this.OpenConditionScenarioPermanentSubEventId;
  ...
  public static Offset<Japan.EventContentStageExcel> Pack(FlatBufferBuilder builder, EventContentStageExcelT _o) {
    if (_o == null) return default(Offset<Japan.EventContentStageExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentStage");
    ...
    var _StageNumber = _o.StageNumber == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.StageNumber, key) : _o.StageNumber));
		...
		var _OpenConditionScenarioPermanentSubEventId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.OpenConditionScenarioPermanentSubEventId, key) : _o.OpenConditionScenarioPermanentSubEventId;
    ...
    return CreateEventContentStageExcel(
      ...
      TableEncryptionService.UseEncryption ? _OpenConditionScenarioPermanentSubEventId : _o.OpenConditionScenarioPermanentSubEventId,
...
public class EventContentStageExcelT
{
  ...
  public Japan.EventContentType OpenConditionContentType { get; set; }
  ...
  public EventContentStageExcelT() {
    ...
    this.OpenConditionContentType = Japan.EventContentType.Stage;
...
static public class EventContentStageExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 28 /*OpenConditionContentType*/, 4 /*Japan.EventContentType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 34 /*StageEnterCostType*/, 4 /*Japan.ParcelType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 58 /*StageTopography*/, 4 /*Japan.StageTopography*/, 4, false)
      && verifier.VerifyField(tablePos, 60 /*RecommandLevel*/, 4 /*int*/, 4, false)
      && verifier.VerifyString(tablePos, 62 /*BgmId*/, false)
      && verifier.VerifyField(tablePos, 64 /*StrategyEnvironment*/, 4 /*Japan.StrategyEnvironment*/, 4, false)
      && verifier.VerifyField(tablePos, 66 /*GroundID*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 68 /*ContentType*/, 4 /*Japan.ContentType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 80 /*StarGoal*/, 4 /*Japan.StarGoalType*/, false)
      ...
      && verifier.VerifyField(tablePos, 88 /*EchelonExtensionType*/, 4 /*Japan.EchelonExtensionType*/, 4, false)
