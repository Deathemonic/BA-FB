...
public struct SkillExcel : IFlatbufferObject
{
  ...
  public Japan.BulletType BulletType { get { int o = __p.__offset(28); return o != 0 ? (Japan.BulletType)__p.bb.GetInt(o + __p.bb_pos) : Japan.BulletType.Normal; } }
  ...
  public static Offset<Japan.SkillExcel> CreateSkillExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddBulletType(FlatBufferBuilder builder, Japan.BulletType bulletType) { builder.AddInt(12, (int)bulletType, 0); }
  ...
  public static Offset<Japan.SkillExcel> EndSkillExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.SkillExcel>(o);
  }
  ...
  public void UnPackTo(SkillExcelT _o) {
    ...
    _o.LocalizeSkillId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.LocalizeSkillId, key) : this.LocalizeSkillId;
    ...
    _o.SkillCost = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.SkillCost, key) : this.SkillCost;
    _o.ExtraSkillCost = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ExtraSkillCost, key) : this.ExtraSkillCost;
    _o.EnemySkillCost = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EnemySkillCost, key) : this.EnemySkillCost;
    _o.ExtraEnemySkillCost = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ExtraEnemySkillCost, key) : this.ExtraEnemySkillCost;
    _o.NPCSkillCost = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.NPCSkillCost, key) : this.NPCSkillCost;
    _o.ExtraNPCSkillCost = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ExtraNPCSkillCost, key) : this.ExtraNPCSkillCost;
    _o.BulletType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BulletType, key) : this.BulletType;
    _o.StartCoolTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StartCoolTime, key) : this.StartCoolTime;
    _o.CoolTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CoolTime, key) : this.CoolTime;
    _o.EnemyStartCoolTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EnemyStartCoolTime, key) : this.EnemyStartCoolTime;
    _o.EnemyCoolTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EnemyCoolTime, key) : this.EnemyCoolTime;
    _o.NPCStartCoolTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.NPCStartCoolTime, key) : this.NPCStartCoolTime;
    _o.NPCCoolTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.NPCCoolTime, key) : this.NPCCoolTime;
    _o.UseAtg = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.UseAtg, key) : this.UseAtg;
    _o.RequireCharacterLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.RequireCharacterLevel, key) : this.RequireCharacterLevel;
    _o.RequireLevelUpMaterial = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.RequireLevelUpMaterial, key) : this.RequireLevelUpMaterial;
    _o.IconName = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.IconName, key) : this.IconName;
    _o.IsShowInfo = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.IsShowInfo, key) : this.IsShowInfo;
  ...
  public static Offset<Japan.SkillExcel> Pack(FlatBufferBuilder builder, SkillExcelT _o) {
    if (_o == null) return default(Offset<Japan.SkillExcel>);
		byte[] key = TableEncryptionService.CreateKey("Skill");
		var _Id = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Id, key) : _o.Id;
		var _LocalizeSkillId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.LocalizeSkillId, key) : _o.LocalizeSkillId;
    var _GroupId = _o.GroupId == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.GroupId, key) : _o.GroupId));
    var _SkillDataKey = _o.SkillDataKey == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.SkillDataKey, key) : _o.SkillDataKey));
    var _VisualDataKey = _o.VisualDataKey == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.VisualDataKey, key) : _o.VisualDataKey));
		var _Level = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Level, key) : _o.Level;
		var _SkillCost = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.SkillCost, key) : _o.SkillCost;
		var _ExtraSkillCost = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ExtraSkillCost, key) : _o.ExtraSkillCost;
		var _EnemySkillCost = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EnemySkillCost, key) : _o.EnemySkillCost;
		var _ExtraEnemySkillCost = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ExtraEnemySkillCost, key) : _o.ExtraEnemySkillCost;
		var _NPCSkillCost = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.NPCSkillCost, key) : _o.NPCSkillCost;
		var _ExtraNPCSkillCost = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ExtraNPCSkillCost, key) : _o.ExtraNPCSkillCost;
		var _BulletType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.BulletType, key) : _o.BulletType;
		var _StartCoolTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StartCoolTime, key) : _o.StartCoolTime;
		var _CoolTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CoolTime, key) : _o.CoolTime;
		var _EnemyStartCoolTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EnemyStartCoolTime, key) : _o.EnemyStartCoolTime;
		var _EnemyCoolTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EnemyCoolTime, key) : _o.EnemyCoolTime;
		var _NPCStartCoolTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.NPCStartCoolTime, key) : _o.NPCStartCoolTime;
		var _NPCCoolTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.NPCCoolTime, key) : _o.NPCCoolTime;
		var _UseAtg = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.UseAtg, key) : _o.UseAtg;
		var _RequireCharacterLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RequireCharacterLevel, key) : _o.RequireCharacterLevel;
		var _RequireLevelUpMaterial = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RequireLevelUpMaterial, key) : _o.RequireLevelUpMaterial;
    var _IconName = _o.IconName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.IconName, key) : _o.IconName));
		var _IsShowInfo = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IsShowInfo, key) : _o.IsShowInfo;
...
static public class SkillExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 28 /*BulletType*/, 4 /*Japan.BulletType*/, 4, false)
