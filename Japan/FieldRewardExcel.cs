...
public struct FieldRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.FieldRewardExcel> CreateFieldRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
      int RewardProb = 0,
  ...
  public static Offset<Japan.FieldRewardExcel> EndFieldRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.FieldRewardExcel>(o);
  }
  ...
  public static Offset<Japan.FieldRewardExcel> Pack(FlatBufferBuilder builder, FieldRewardExcelT _o) {
    if (_o == null) return default(Offset<Japan.FieldRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("FieldReward");
