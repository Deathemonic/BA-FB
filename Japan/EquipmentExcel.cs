...
public struct EquipmentExcel : IFlatbufferObject
{
  ...
  public Japan.EquipmentCategory EquipmentCategory { get { int o = __p.__offset(6); return o != 0 ? (Japan.EquipmentCategory)__p.bb.GetInt(o + __p.bb_pos) : Japan.EquipmentCategory.Unable; } }
  ...
  public Japan.Tag Tags(int j) { int o = __p.__offset(28); return o != 0 ? (Japan.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.Tag)0; }
  public int TagsLength { get { int o = __p.__offset(28); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.Tag> GetTagsBytes() { return __p.__vector_as_span<Japan.Tag>(28, 4); }
#else
  public ArraySegment<byte>? GetTagsBytes() { return __p.__vector_as_arraysegment(28); }
#endif
  public Japan.Tag[] GetTagsArray() { int o = __p.__offset(28); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.Tag[] a = new Japan.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.Tag)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Japan.ShopCategoryType ShopCategory(int j) { int o = __p.__offset(38); return o != 0 ? (Japan.ShopCategoryType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.ShopCategoryType)0; }
  public int ShopCategoryLength { get { int o = __p.__offset(38); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.ShopCategoryType> GetShopCategoryBytes() { return __p.__vector_as_span<Japan.ShopCategoryType>(38, 4); }
#else
  public ArraySegment<byte>? GetShopCategoryBytes() { return __p.__vector_as_arraysegment(38); }
#endif
  public Japan.ShopCategoryType[] GetShopCategoryArray() { int o = __p.__offset(38); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.ShopCategoryType[] a = new Japan.ShopCategoryType[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.ShopCategoryType)__p.bb.GetInt(p + i * 4); } return a; }
  public long ShortcutTypeId { get { int o = __p.__offset(40); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }

  public static Offset<Japan.EquipmentExcel> CreateEquipmentExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddEquipmentCategory(FlatBufferBuilder builder, Japan.EquipmentCategory equipmentCategory) { builder.AddInt(1, (int)equipmentCategory, 0); }
  ...
  public static Offset<Japan.EquipmentExcel> EndEquipmentExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.EquipmentExcel>(o);
  }
  ...
  public void UnPackTo(EquipmentExcelT _o) {
    ...
    _o.Wear = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.Wear, key) : this.Wear;
    _o.MaxLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.MaxLevel, key) : this.MaxLevel;
    _o.RecipeId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.RecipeId, key) : this.RecipeId;
    _o.TierInit = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.TierInit, key) : this.TierInit;
  ...
  public static Offset<Japan.EquipmentExcel> Pack(FlatBufferBuilder builder, EquipmentExcelT _o) {
    if (_o == null) return default(Offset<Japan.EquipmentExcel>);
		byte[] key = TableEncryptionService.CreateKey("Equipment");
		...
		var _Wear = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.Wear, key) : _o.Wear;
		var _MaxLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.MaxLevel, key) : _o.MaxLevel;
		var _RecipeId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.RecipeId, key) : _o.RecipeId;
		var _TierInit = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.TierInit, key) : _o.TierInit;
    ...
    var _ImageName = _o.ImageName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.ImageName, key) : _o.ImageName));
...
static public class EquipmentExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*EquipmentCategory*/, 4 /*Japan.EquipmentCategory*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 28 /*Tags*/, 4 /*Japan.Tag*/, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 38 /*ShopCategory*/, 4 /*Japan.ShopCategoryType*/, false)
