...
public struct WeekDungeonFindGiftRewardExcel : IFlatbufferObject
{
  ...
  public Japan.ParcelType RewardParcelType(int j) { int o = __p.__offset(8); return o != 0 ? (Japan.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.ParcelType)0; }
  public int RewardParcelTypeLength { get { int o = __p.__offset(8); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.ParcelType> GetRewardParcelTypeBytes() { return __p.__vector_as_span<Japan.ParcelType>(8, 4); }
#else
  public ArraySegment<byte>? GetRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(8); }
#endif
  public Japan.ParcelType[] GetRewardParcelTypeArray() { int o = __p.__offset(8); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.ParcelType[] a = new Japan.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Japan.WeekDungeonFindGiftRewardExcel> CreateWeekDungeonFindGiftRewardExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.WeekDungeonFindGiftRewardExcel> EndWeekDungeonFindGiftRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.WeekDungeonFindGiftRewardExcel>(o);
  }
  ...
  public static Offset<Japan.WeekDungeonFindGiftRewardExcel> Pack(FlatBufferBuilder builder, WeekDungeonFindGiftRewardExcelT _o) {
    if (_o == null) return default(Offset<Japan.WeekDungeonFindGiftRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("WeekDungeonFindGiftReward");
...
static public class WeekDungeonFindGiftRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 8 /*RewardParcelType*/, 4 /*Japan.ParcelType*/, false)
