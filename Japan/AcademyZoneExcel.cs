...
public struct AcademyZoneExcel : IFlatbufferObject
{
  ...
  public Japan.Tag Tags(int j) { int o = __p.__offset(16); return o != 0 ? (Japan.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.Tag)0; }
  public int TagsLength { get { int o = __p.__offset(16); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.Tag> GetTagsBytes() { return __p.__vector_as_span<Japan.Tag>(16, 4); }
#else
  public ArraySegment<byte>? GetTagsBytes() { return __p.__vector_as_arraysegment(16); }
#endif
  public Japan.Tag[] GetTagsArray() { int o = __p.__offset(16); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.Tag[] a = new Japan.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.Tag)__p.bb.GetInt(p + i * 4); } return a; }

  public static Offset<Japan.AcademyZoneExcel> CreateAcademyZoneExcel(FlatBufferBuilder builder,
      long Id = 0,
      long LocationId = 0,
  ...
  public static Offset<Japan.AcademyZoneExcel> EndAcademyZoneExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.AcademyZoneExcel>(o);
  }
  ...
  public static Offset<Japan.AcademyZoneExcel> Pack(FlatBufferBuilder builder, AcademyZoneExcelT _o) {
    if (_o == null) return default(Offset<Japan.AcademyZoneExcel>);
		byte[] key = TableEncryptionService.CreateKey("AcademyZone");
...
static public class AcademyZoneExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 16 /*Tags*/, 4 /*Japan.Tag*/, false)
