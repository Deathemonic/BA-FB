...
public struct BuffParticleExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.BuffParticleExcel> CreateBuffParticleExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
  ...
  public static Offset<Japan.BuffParticleExcel> EndBuffParticleExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.BuffParticleExcel>(o);
  }
  ...
  public static Offset<Japan.BuffParticleExcel> Pack(FlatBufferBuilder builder, BuffParticleExcelT _o) {
    if (_o == null) return default(Offset<Japan.BuffParticleExcel>);
		byte[] key = TableEncryptionService.CreateKey("BuffParticle");
