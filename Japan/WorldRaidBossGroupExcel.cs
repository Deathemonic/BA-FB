...
public struct WorldRaidBossGroupExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.WorldRaidBossGroupExcel> CreateWorldRaidBossGroupExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Japan.WorldRaidBossGroupExcel> EndWorldRaidBossGroupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.WorldRaidBossGroupExcel>(o);
  }
  ...
  public static Offset<Japan.WorldRaidBossGroupExcel> Pack(FlatBufferBuilder builder, WorldRaidBossGroupExcelT _o) {
    if (_o == null) return default(Offset<Japan.WorldRaidBossGroupExcel>);
		byte[] key = TableEncryptionService.CreateKey("WorldRaidBossGroup");
