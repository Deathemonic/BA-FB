...
public struct BGMUIExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.BGMUIExcel> CreateBGMUIExcel(FlatBufferBuilder builder,
      uint UIPrefab = 0,
      long BGMId = 0,
      long BGMId2nd = 0,
      long BGMId3rd = 0,
  ...
  public static Offset<Japan.BGMUIExcel> EndBGMUIExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.BGMUIExcel>(o);
  }
  ...
  public static Offset<Japan.BGMUIExcel> Pack(FlatBufferBuilder builder, BGMUIExcelT _o) {
    if (_o == null) return default(Offset<Japan.BGMUIExcel>);
		byte[] key = TableEncryptionService.CreateKey("BGMUI");
