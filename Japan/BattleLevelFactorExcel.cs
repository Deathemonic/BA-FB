...
public struct BattleLevelFactorExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.BattleLevelFactorExcel> CreateBattleLevelFactorExcel(FlatBufferBuilder builder,
      int LevelDiff = 0,
      long DamageRate = 0) {
  ...
  public static Offset<Japan.BattleLevelFactorExcel> EndBattleLevelFactorExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.BattleLevelFactorExcel>(o);
  }
  ...
  public static Offset<Japan.BattleLevelFactorExcel> Pack(FlatBufferBuilder builder, BattleLevelFactorExcelT _o) {
    if (_o == null) return default(Offset<Japan.BattleLevelFactorExcel>);
		byte[] key = TableEncryptionService.CreateKey("BattleLevelFactor");
