...
public struct FieldDateExcel : IFlatbufferObject
{
  ...
  public Japan.FieldConditionType StartConditionType { get { int o = __p.__offset(14); return o != 0 ? (Japan.FieldConditionType)__p.bb.GetInt(o + __p.bb_pos) : Japan.FieldConditionType.Invalid; } }
  public long StartConditionId { get { int o = __p.__offset(16); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public Japan.FieldConditionType EndConditionType { get { int o = __p.__offset(18); return o != 0 ? (Japan.FieldConditionType)__p.bb.GetInt(o + __p.bb_pos) : Japan.FieldConditionType.Invalid; } }
  public long EndConditionId { get { int o = __p.__offset(20); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public Japan.FieldConditionType EndReadyConditionType { get { int o = __p.__offset(22); return o != 0 ? (Japan.FieldConditionType)__p.bb.GetInt(o + __p.bb_pos) : Japan.FieldConditionType.Invalid; } }
  ...
  public static Offset<Japan.FieldDateExcel> CreateFieldDateExcel(FlatBufferBuilder builder,
      long SeasonId = 0,
      long UniqueId = 0,
      long OpenDate = 0,
      StringOffset DateLocalizeKeyOffset = default(StringOffset),
      long EntrySceneId = 0,
      Japan.FieldConditionType StartConditionType = Japan.FieldConditionType.Invalid,
      long StartConditionId = 0,
      Japan.FieldConditionType EndConditionType = Japan.FieldConditionType.Invalid,
      long EndConditionId = 0,
      Japan.FieldConditionType EndReadyConditionType = Japan.FieldConditionType.Invalid,
  ...
  public static void AddStartConditionType(FlatBufferBuilder builder, Japan.FieldConditionType startConditionType) { builder.AddInt(5, (int)startConditionType, 0); }
  ...
  public static void AddEndConditionType(FlatBufferBuilder builder, Japan.FieldConditionType endConditionType) { builder.AddInt(7, (int)endConditionType, 0); }
  public static void AddEndConditionId(FlatBufferBuilder builder, long endConditionId) { builder.AddLong(8, endConditionId, 0); }
  public static void AddEndReadyConditionType(FlatBufferBuilder builder, Japan.FieldConditionType endReadyConditionType) { builder.AddInt(9, (int)endReadyConditionType, 0); }
  ...
  public static Offset<Japan.FieldDateExcel> EndFieldDateExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.FieldDateExcel>(o);
  }
  ...
  public void UnPackTo(FieldDateExcelT _o) {
    ...
    _o.StartConditionType = TableEncryptionService.UseEncryption ? (Japan.FieldConditionType)TableEncryptionService.Convert((int)this.StartConditionType, key) : this.StartConditionType;
    ...
    _o.EndConditionType = TableEncryptionService.UseEncryption ? (Japan.FieldConditionType)TableEncryptionService.Convert((int)this.EndConditionType, key) : this.EndConditionType;
    ...
    _o.EndReadyConditionType = TableEncryptionService.UseEncryption ? (Japan.FieldConditionType)TableEncryptionService.Convert((int)this.EndReadyConditionType, key) : this.EndReadyConditionType;
  ...
  public static Offset<Japan.FieldDateExcel> Pack(FlatBufferBuilder builder, FieldDateExcelT _o) {
    if (_o == null) return default(Offset<Japan.FieldDateExcel>);
		byte[] key = TableEncryptionService.CreateKey("FieldDate");
    ...
    var _DateLocalizeKey = _o.DateLocalizeKey == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.DateLocalizeKey, key) : _o.DateLocalizeKey));
		...
		var _StartConditionType = TableEncryptionService.UseEncryption ? (Japan.FieldConditionType)TableEncryptionService.Convert((int)_o.StartConditionType, key) : _o.StartConditionType;
		...
		var _EndConditionType = TableEncryptionService.UseEncryption ? (Japan.FieldConditionType)TableEncryptionService.Convert((int)_o.EndConditionType, key) : _o.EndConditionType;
		...
		var _EndReadyConditionType = TableEncryptionService.UseEncryption ? (Japan.FieldConditionType)TableEncryptionService.Convert((int)_o.EndReadyConditionType, key) : _o.EndReadyConditionType;
...
public class FieldDateExcelT
{
  ...
  public Japan.FieldConditionType StartConditionType { get; set; }
  public long StartConditionId { get; set; }
  public Japan.FieldConditionType EndConditionType { get; set; }
  public long EndConditionId { get; set; }
  public Japan.FieldConditionType EndReadyConditionType { get; set; }
  ...
  public FieldDateExcelT() {
    ...
    this.EntrySceneId = 0;
    this.StartConditionType = Japan.FieldConditionType.Invalid;
    this.StartConditionId = 0;
    this.EndConditionType = Japan.FieldConditionType.Invalid;
    this.EndConditionId = 0;
    this.EndReadyConditionType = Japan.FieldConditionType.Invalid;
...
static public class FieldDateExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 14 /*StartConditionType*/, 4 /*Japan.FieldConditionType*/, 4, false)
      && verifier.VerifyField(tablePos, 16 /*StartConditionId*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 18 /*EndConditionType*/, 4 /*Japan.FieldConditionType*/, 4, false)
      && verifier.VerifyField(tablePos, 20 /*EndConditionId*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 22 /*EndReadyConditionType*/, 4 /*Japan.FieldConditionType*/, 4, false)
