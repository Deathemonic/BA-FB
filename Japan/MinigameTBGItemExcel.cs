...
public struct MinigameTBGItemExcel : IFlatbufferObject
{
  ...
  public Japan.TBGItemType ItemType { get { int o = __p.__offset(6); return o != 0 ? (Japan.TBGItemType)__p.bb.GetInt(o + __p.bb_pos) : Japan.TBGItemType.None; } }
  public Japan.TBGItemEffectType TBGItemEffectType { get { int o = __p.__offset(8); return o != 0 ? (Japan.TBGItemEffectType)__p.bb.GetInt(o + __p.bb_pos) : Japan.TBGItemEffectType.None; } }
  ...
  public static Offset<Japan.MinigameTBGItemExcel> CreateMinigameTBGItemExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      Japan.TBGItemType ItemType = Japan.TBGItemType.None,
      Japan.TBGItemEffectType TBGItemEffectType = Japan.TBGItemEffectType.None,
      int ItemParameter = 0,
  ...
  public static void AddItemType(FlatBufferBuilder builder, Japan.TBGItemType itemType) { builder.AddInt(1, (int)itemType, 0); }
  public static void AddTBGItemEffectType(FlatBufferBuilder builder, Japan.TBGItemEffectType tBGItemEffectType) { builder.AddInt(2, (int)tBGItemEffectType, 0); }
  ...
  public static Offset<Japan.MinigameTBGItemExcel> EndMinigameTBGItemExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.MinigameTBGItemExcel>(o);
  }
  ...
  public void UnPackTo(MinigameTBGItemExcelT _o) {
    ...
    _o.ItemType = TableEncryptionService.UseEncryption ? (Japan.TBGItemType)TableEncryptionService.Convert((int)this.ItemType, key) : this.ItemType;
    _o.TBGItemEffectType = TableEncryptionService.UseEncryption ? (Japan.TBGItemEffectType)TableEncryptionService.Convert((int)this.TBGItemEffectType, key) : this.TBGItemEffectType;
  ...
  public static Offset<Japan.MinigameTBGItemExcel> Pack(FlatBufferBuilder builder, MinigameTBGItemExcelT _o) {
    if (_o == null) return default(Offset<Japan.MinigameTBGItemExcel>);
		byte[] key = TableEncryptionService.CreateKey("MinigameTBGItem");
		var _UniqueId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.UniqueId, key) : _o.UniqueId;
		var _ItemType = TableEncryptionService.UseEncryption ? (Japan.TBGItemType)TableEncryptionService.Convert((int)_o.ItemType, key) : _o.ItemType;
		var _TBGItemEffectType = TableEncryptionService.UseEncryption ? (Japan.TBGItemEffectType)TableEncryptionService.Convert((int)_o.TBGItemEffectType, key) : _o.TBGItemEffectType;
...
public class MinigameTBGItemExcelT
{
  ...
  public Japan.TBGItemType ItemType { get; set; }
  public Japan.TBGItemEffectType TBGItemEffectType { get; set; }
  ...
  public MinigameTBGItemExcelT() {
    this.UniqueId = 0;
    this.ItemType = Japan.TBGItemType.None;
    this.TBGItemEffectType = Japan.TBGItemEffectType.None;
...
static public class MinigameTBGItemExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*ItemType*/, 4 /*Japan.TBGItemType*/, 4, false)
      && verifier.VerifyField(tablePos, 8 /*TBGItemEffectType*/, 4 /*Japan.TBGItemEffectType*/, 4, false)
