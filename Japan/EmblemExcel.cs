...
public struct EmblemExcel : IFlatbufferObject
{
  ...
  public Japan.EmblemDisplayType DisplayType { get { int o = __p.__offset(32); return o != 0 ? (Japan.EmblemDisplayType)__p.bb.GetInt(o + __p.bb_pos) : Japan.EmblemDisplayType.Always; } }
  ...
  public Japan.EmblemCheckPassType CheckPassType { get { int o = __p.__offset(40); return o != 0 ? (Japan.EmblemCheckPassType)__p.bb.GetInt(o + __p.bb_pos) : Japan.EmblemCheckPassType.None; } }
  ...
  public static void AddDisplayType(FlatBufferBuilder builder, Japan.EmblemDisplayType displayType) { builder.AddInt(14, (int)displayType, 0); }
  ...
  public static void AddCheckPassType(FlatBufferBuilder builder, Japan.EmblemCheckPassType checkPassType) { builder.AddInt(18, (int)checkPassType, 0); }
  ...
  public static Offset<Japan.EmblemExcel> Pack(FlatBufferBuilder builder, EmblemExcelT _o) {
    if (_o == null) return default(Offset<Japan.EmblemExcel>);
		...
		var _UseAtLocalizeId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.UseAtLocalizeId, key) : _o.UseAtLocalizeId;
		var _EmblemTextVisible = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EmblemTextVisible, key) : _o.EmblemTextVisible;
    ...
    var _EmblemIconPath = _o.EmblemIconPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.EmblemIconPath, key) : _o.EmblemIconPath));
		var _EmblemIconNumControl = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EmblemIconNumControl, key) : _o.EmblemIconNumControl;
    var _EmblemIconBGPath = _o.EmblemIconBGPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.EmblemIconBGPath, key) : _o.EmblemIconBGPath));
    var _EmblemBGPathJp = _o.EmblemBGPathJp == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.EmblemBGPathJp, key) : _o.EmblemBGPathJp));
    var _EmblemBGPathKr = _o.EmblemBGPathKr == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.EmblemBGPathKr, key) : _o.EmblemBGPathKr));
    ...
    var _DisplayEndDate = _o.DisplayEndDate == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.DisplayEndDate, key) : _o.DisplayEndDate));
		var _DislpayFavorLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DislpayFavorLevel, key) : _o.DislpayFavorLevel;
		var _CheckPassType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CheckPassType, key) : _o.CheckPassType;
		var _EmblemParameter = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EmblemParameter, key) : _o.EmblemParameter;
		var _CheckPassCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CheckPassCount, key) : _o.CheckPassCount;
...
static public class EmblemExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 32 /*DisplayType*/, 4 /*Japan.EmblemDisplayType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 40 /*CheckPassType*/, 4 /*Japan.EmblemCheckPassType*/, 4, false)
