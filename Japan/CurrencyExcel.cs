...
public struct CurrencyExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(CurrencyExcelT _o) {
    ...
    _o.CurrencyType = TableEncryptionService.UseEncryption ? (Japan.CurrencyTypes)TableEncryptionService.Convert((int)this.CurrencyType, key) : this.CurrencyType;
    ...
    _o.CurrencyOverChargeType = TableEncryptionService.UseEncryption ? (Japan.CurrencyOverChargeType)TableEncryptionService.Convert((int)this.CurrencyOverChargeType, key) : this.CurrencyOverChargeType;
    _o.CurrencyAdditionalChargeType = TableEncryptionService.UseEncryption ? (Japan.CurrencyAdditionalChargeType)TableEncryptionService.Convert((int)this.CurrencyAdditionalChargeType, key) : this.CurrencyAdditionalChargeType;
    ...
    _o.DailyRefillType = TableEncryptionService.UseEncryption ? (Japan.DailyRefillType)TableEncryptionService.Convert((int)this.DailyRefillType, key) : this.DailyRefillType;
    ...
    _o.ExpiryChangeParcelType = TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)this.ExpiryChangeParcelType, key) : this.ExpiryChangeParcelType;
    ...
    _o.ResetType = TableEncryptionService.UseEncryption ? (Japan.PeriodType)TableEncryptionService.Convert((int)this.ResetType, key) : this.ResetType;
    _o.ResetAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ResetAmount, key) : this.ResetAmount;
  }
  public static Offset<Japan.CurrencyExcel> Pack(FlatBufferBuilder builder, CurrencyExcelT _o) {
    if (_o == null) return default(Offset<Japan.CurrencyExcel>);
		...
		var _CurrencyType = TableEncryptionService.UseEncryption ? (Japan.CurrencyTypes)TableEncryptionService.Convert((int)_o.CurrencyType, key) : _o.CurrencyType;
    ...
    var _Icon = _o.Icon == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.Icon, key) : _o.Icon));
		...
		var _CurrencyOverChargeType = TableEncryptionService.UseEncryption ? (Japan.CurrencyOverChargeType)TableEncryptionService.Convert((int)_o.CurrencyOverChargeType, key) : _o.CurrencyOverChargeType;
		var _CurrencyAdditionalChargeType = TableEncryptionService.UseEncryption ? (Japan.CurrencyAdditionalChargeType)TableEncryptionService.Convert((int)_o.CurrencyAdditionalChargeType, key) : _o.CurrencyAdditionalChargeType;
    ...
    var _SpriteName = _o.SpriteName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.SpriteName, key) : _o.SpriteName));
		var _DailyRefillType = TableEncryptionService.UseEncryption ? (Japan.DailyRefillType)TableEncryptionService.Convert((int)_o.DailyRefillType, key) : _o.DailyRefillType;
    ...
    var _ExpirationDateTime = _o.ExpirationDateTime == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.ExpirationDateTime, key) : _o.ExpirationDateTime));
		...
		var _ExpiryChangeParcelType = TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)_o.ExpiryChangeParcelType, key) : _o.ExpiryChangeParcelType;
		...
		var _ResetType = TableEncryptionService.UseEncryption ? (Japan.PeriodType)TableEncryptionService.Convert((int)_o.ResetType, key) : _o.ResetType;
		var _ResetAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ResetAmount, key) : _o.ResetAmount;
