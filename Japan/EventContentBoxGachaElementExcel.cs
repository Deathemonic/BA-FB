...
public struct EventContentBoxGachaElementExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.EventContentBoxGachaElementExcel> CreateEventContentBoxGachaElementExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.EventContentBoxGachaElementExcel> EndEventContentBoxGachaElementExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.EventContentBoxGachaElementExcel>(o);
  }
  ...
  public static Offset<Japan.EventContentBoxGachaElementExcel> Pack(FlatBufferBuilder builder, EventContentBoxGachaElementExcelT _o) {
    if (_o == null) return default(Offset<Japan.EventContentBoxGachaElementExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentBoxGachaElement");
