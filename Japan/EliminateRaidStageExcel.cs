...
public struct EliminateRaidStageExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(EliminateRaidStageExcelT _o) {
    ...
    _o.RaidEnterCostType = TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)this.RaidEnterCostType, key) : this.RaidEnterCostType;
    ...
    _o.TacticEnvironment = TableEncryptionService.UseEncryption ? (Japan.TacticEnvironment)TableEncryptionService.Convert((int)this.TacticEnvironment, key) : this.TacticEnvironment;
  ...
  public static Offset<Japan.EliminateRaidStageExcel> Pack(FlatBufferBuilder builder, EliminateRaidStageExcelT _o) {
    ...
    var _RaidBossGroup = _o.RaidBossGroup == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.RaidBossGroup, key) : _o.RaidBossGroup));
		var _RaidEnterCostType = TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)_o.RaidEnterCostType, key) : _o.RaidEnterCostType;
    ...
    var _EnterTimeLine = _o.EnterTimeLine == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.EnterTimeLine, key) : _o.EnterTimeLine));
		var _TacticEnvironment = TableEncryptionService.UseEncryption ? (Japan.TacticEnvironment)TableEncryptionService.Convert((int)_o.TacticEnvironment, key) : _o.TacticEnvironment;
