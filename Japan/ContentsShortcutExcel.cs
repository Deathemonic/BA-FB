...
public struct ContentsShortcutExcel : IFlatbufferObject
{
  ...
  public Japan.StageDifficulty ConquestMapDifficulty { get { int o = __p.__offset(20); return o != 0 ? (Japan.StageDifficulty)__p.bb.GetInt(o + __p.bb_pos) : Japan.StageDifficulty.None; } }
  ...
  public static Offset<Japan.ContentsShortcutExcel> CreateContentsShortcutExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      ...
      Japan.StageDifficulty ConquestMapDifficulty = Japan.StageDifficulty.None,
  ...
  public static void AddConquestMapDifficulty(FlatBufferBuilder builder, Japan.StageDifficulty conquestMapDifficulty) { builder.AddInt(8, (int)conquestMapDifficulty, 0); }
  ...
  public static Offset<Japan.ContentsShortcutExcel> EndContentsShortcutExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ContentsShortcutExcel>(o);
  }
  ...
  public void UnPackTo(ContentsShortcutExcelT _o) {
    ...
    _o.ConquestMapDifficulty = TableEncryptionService.UseEncryption ? (Japan.StageDifficulty)TableEncryptionService.Convert((int)this.ConquestMapDifficulty, key) : this.ConquestMapDifficulty;
  ...
  public static Offset<Japan.ContentsShortcutExcel> Pack(FlatBufferBuilder builder, ContentsShortcutExcelT _o) {
    if (_o == null) return default(Offset<Japan.ContentsShortcutExcel>);
		byte[] key = TableEncryptionService.CreateKey("ContentsShortcut");
    ...
    var _ShortcutCloseTime = _o.ShortcutCloseTime == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.ShortcutCloseTime, key) : _o.ShortcutCloseTime));
		...
		var _ConquestMapDifficulty = TableEncryptionService.UseEncryption ? (Japan.StageDifficulty)TableEncryptionService.Convert((int)_o.ConquestMapDifficulty, key) : _o.ConquestMapDifficulty;
...
public class ContentsShortcutExcelT
{
  ...
  public Japan.StageDifficulty ConquestMapDifficulty { get; set; }
  ...
  public ContentsShortcutExcelT() {
    ...
    this.ConquestMapDifficulty = Japan.StageDifficulty.None;
...
static public class ContentsShortcutExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 20 /*ConquestMapDifficulty*/, 4 /*Japan.StageDifficulty*/, 4, false)
