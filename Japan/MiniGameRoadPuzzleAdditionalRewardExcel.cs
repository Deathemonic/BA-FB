...
public struct MiniGameRoadPuzzleAdditionalRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.MiniGameRoadPuzzleAdditionalRewardExcel> CreateMiniGameRoadPuzzleAdditionalRewardExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.MiniGameRoadPuzzleAdditionalRewardExcel> EndMiniGameRoadPuzzleAdditionalRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.MiniGameRoadPuzzleAdditionalRewardExcel>(o);
  }
  ...
  public static Offset<Japan.MiniGameRoadPuzzleAdditionalRewardExcel> Pack(FlatBufferBuilder builder, MiniGameRoadPuzzleAdditionalRewardExcelT _o) {
    if (_o == null) return default(Offset<Japan.MiniGameRoadPuzzleAdditionalRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("MiniGameRoadPuzzleAdditionalReward");
