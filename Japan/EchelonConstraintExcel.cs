...
public struct EchelonConstraintExcel : IFlatbufferObject
{
  ...
  public Japan.WeaponType WeaponType { get { int o = __p.__offset(12); return o != 0 ? (Japan.WeaponType)__p.bb.GetInt(o + __p.bb_pos) : Japan.WeaponType.None; } }
  public Japan.School School { get { int o = __p.__offset(14); return o != 0 ? (Japan.School)__p.bb.GetInt(o + __p.bb_pos) : Japan.School.None; } }
  public Japan.Club Club { get { int o = __p.__offset(16); return o != 0 ? (Japan.Club)__p.bb.GetInt(o + __p.bb_pos) : Japan.Club.None; } }
  public Japan.TacticRole Role { get { int o = __p.__offset(18); return o != 0 ? (Japan.TacticRole)__p.bb.GetInt(o + __p.bb_pos) : Japan.TacticRole.None; } }
  ...
  public static Offset<Japan.EchelonConstraintExcel> CreateEchelonConstraintExcel(FlatBufferBuilder builder,
      ...
      Japan.TacticRole Role = Japan.TacticRole.None) {
  ...
  public static void AddWeaponType(FlatBufferBuilder builder, Japan.WeaponType weaponType) { builder.AddInt(4, (int)weaponType, 0); }
  public static void AddSchool(FlatBufferBuilder builder, Japan.School school) { builder.AddInt(5, (int)school, 0); }
  public static void AddClub(FlatBufferBuilder builder, Japan.Club club) { builder.AddInt(6, (int)club, 0); }
  public static void AddRole(FlatBufferBuilder builder, Japan.TacticRole role) { builder.AddInt(7, (int)role, 0); }
  public static Offset<Japan.EchelonConstraintExcel> EndEchelonConstraintExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.EchelonConstraintExcel>(o);
  }
  ...
  public void UnPackTo(EchelonConstraintExcelT _o) {
    ...
    _o.Role = TableEncryptionService.UseEncryption ? (Japan.TacticRole)TableEncryptionService.Convert((int)this.Role, key) : this.Role;
  }
  public static Offset<Japan.EchelonConstraintExcel> Pack(FlatBufferBuilder builder, EchelonConstraintExcelT _o) {
    if (_o == null) return default(Offset<Japan.EchelonConstraintExcel>);
		byte[] key = TableEncryptionService.CreateKey("EchelonConstraint");
    ...
    if (_o.PersonalityId != null) {
      ...
      _PersonalityId = CreatePersonalityIdVector(builder, __PersonalityId);
		...
		var _Role = TableEncryptionService.UseEncryption ? (Japan.TacticRole)TableEncryptionService.Convert((int)_o.Role, key) : _o.Role;
...
public class EchelonConstraintExcelT
{
  ...
  public Japan.TacticRole Role { get; set; }
  ...
  public EchelonConstraintExcelT() {
    ...
    this.Role = Japan.TacticRole.None;
  }
}
...
static public class EchelonConstraintExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*WeaponType*/, 4 /*Japan.WeaponType*/, 4, false)
      && verifier.VerifyField(tablePos, 14 /*School*/, 4 /*Japan.School*/, 4, false)
      && verifier.VerifyField(tablePos, 16 /*Club*/, 4 /*Japan.Club*/, 4, false)
      && verifier.VerifyField(tablePos, 18 /*Role*/, 4 /*Japan.TacticRole*/, 4, false)
