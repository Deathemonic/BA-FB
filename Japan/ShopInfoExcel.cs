...
public struct ShopInfoExcel : IFlatbufferObject
{
  ...
  public Japan.ParcelType DisplayParcelType { get { int o = __p.__offset(26); return o != 0 ? (Japan.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Japan.ParcelType.None; } }
  ...
  public static void AddDisplayParcelType(FlatBufferBuilder builder, Japan.ParcelType displayParcelType) { builder.AddInt(11, (int)displayParcelType, 0); }
...
static public class ShopInfoExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 26 /*DisplayParcelType*/, 4 /*Japan.ParcelType*/, 4, false)
