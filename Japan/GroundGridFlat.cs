...
public struct GroundGridFlat : IFlatbufferObject
{
  ...
  public Japan.GroundNodeFlat? Nodes(int j) { int o = __p.__offset(14); return o != 0 ? (Japan.GroundNodeFlat?)(new Japan.GroundNodeFlat()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  ...
  public static Offset<Japan.GroundGridFlat> CreateGroundGridFlat(FlatBufferBuilder builder,
      int X = 0,
      int Y = 0,
      float StartX = 0.0f,
      float StartY = 0.0f,
  ...
  public static VectorOffset CreateNodesVector(FlatBufferBuilder builder, Offset<Japan.GroundNodeFlat>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateNodesVectorBlock(FlatBufferBuilder builder, Offset<Japan.GroundNodeFlat>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateNodesVectorBlock(FlatBufferBuilder builder, ArraySegment<Offset<Japan.GroundNodeFlat>> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateNodesVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Offset<Japan.GroundNodeFlat>>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Japan.GroundGridFlat> EndGroundGridFlat(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.GroundGridFlat>(o);
  }
  ...
  public void UnPackTo(GroundGridFlatT _o) {
    ...
    _o.Nodes = new List<Japan.GroundNodeFlatT>();
  ...
  public static Offset<Japan.GroundGridFlat> Pack(FlatBufferBuilder builder, GroundGridFlatT _o) {
    if (_o == null) return default(Offset<Japan.GroundGridFlat>);
		byte[] key = TableEncryptionService.CreateKey("GroundGri");
    ...
    if (_o.Nodes != null) {
      var __Nodes = new Offset<Japan.GroundNodeFlat>[_o.Nodes.Count];
      for (var _j = 0; _j < __Nodes.Length; ++_j) { __Nodes[_j] = Japan.GroundNodeFlat.Pack(builder, _o.Nodes[_j]); }
...
public class GroundGridFlatT
{
  ...
  public List<Japan.GroundNodeFlatT> Nodes { get; set; }
...
static public class GroundGridFlatVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfTables(tablePos, 14 /*Nodes*/, Japan.GroundNodeFlatVerify.Verify, false)
