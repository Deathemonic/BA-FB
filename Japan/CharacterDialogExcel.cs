...
public struct CharacterDialogExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(CharacterDialogExcelT _o) {
    ...
    _o.Anniversary = TableEncryptionService.UseEncryption ? (Japan.Anniversary)TableEncryptionService.Convert((int)this.Anniversary, key) : this.Anniversary;
  ...
  public static Offset<Japan.CharacterDialogExcel> Pack(FlatBufferBuilder builder, CharacterDialogExcelT _o) {
    if (_o == null) return default(Offset<Japan.CharacterDialogExcel>);
		...
		var _Anniversary = TableEncryptionService.UseEncryption ? (Japan.Anniversary)TableEncryptionService.Convert((int)_o.Anniversary, key) : _o.Anniversary;
