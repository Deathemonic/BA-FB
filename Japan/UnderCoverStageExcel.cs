...
public struct UnderCoverStageExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.UnderCoverStageExcel> CreateUnderCoverStageExcel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static Offset<Japan.UnderCoverStageExcel> EndUnderCoverStageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.UnderCoverStageExcel>(o);
  }
  ...
  public static Offset<Japan.UnderCoverStageExcel> Pack(FlatBufferBuilder builder, UnderCoverStageExcelT _o) {
    if (_o == null) return default(Offset<Japan.UnderCoverStageExcel>);
		byte[] key = TableEncryptionService.CreateKey("UnderCoverStage");
