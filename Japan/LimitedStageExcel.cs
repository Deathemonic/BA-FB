...
public struct LimitedStageExcel : IFlatbufferObject
{
  ...
  public Japan.StageTopography StageTopography { get { int o = __p.__offset(48); return o != 0 ? (Japan.StageTopography)__p.bb.GetInt(o + __p.bb_pos) : Japan.StageTopography.Street; } }
  ...
  public Japan.StrategyEnvironment StrategyEnvironment { get { int o = __p.__offset(54); return o != 0 ? (Japan.StrategyEnvironment)__p.bb.GetInt(o + __p.bb_pos) : Japan.StrategyEnvironment.None; } }
  ...
  public static Offset<Japan.LimitedStageExcel> CreateLimitedStageExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddStageTopography(FlatBufferBuilder builder, Japan.StageTopography stageTopography) { builder.AddInt(22, (int)stageTopography, 0); }
  ...
  public static void AddStrategyEnvironment(FlatBufferBuilder builder, Japan.StrategyEnvironment strategyEnvironment) { builder.AddInt(25, (int)strategyEnvironment, 0); }
  ...
  public static Offset<Japan.LimitedStageExcel> EndLimitedStageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.LimitedStageExcel>(o);
  }
  ...
  public static Offset<Japan.LimitedStageExcel> Pack(FlatBufferBuilder builder, LimitedStageExcelT _o) {
    if (_o == null) return default(Offset<Japan.LimitedStageExcel>);
		byte[] key = TableEncryptionService.CreateKey("LimitedStage");
...
static public class LimitedStageExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 48 /*StageTopography*/, 4 /*Japan.StageTopography*/, 4, false)
      && verifier.VerifyField(tablePos, 50 /*RecommandLevel*/, 4 /*int*/, 4, false)
      && verifier.VerifyString(tablePos, 52 /*BgmId*/, false)
      && verifier.VerifyField(tablePos, 54 /*StrategyEnvironment*/, 4 /*Japan.StrategyEnvironment*/, 4, false)
