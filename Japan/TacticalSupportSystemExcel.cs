...
public struct TacticalSupportSystemExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.TacticalSupportSystemExcel> CreateTacticalSupportSystemExcel(FlatBufferBuilder builder,
      long Id = 0,
      long SummonedTime = 0,
  ...
  public static Offset<Japan.TacticalSupportSystemExcel> EndTacticalSupportSystemExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.TacticalSupportSystemExcel>(o);
  }
  ...
  public static Offset<Japan.TacticalSupportSystemExcel> Pack(FlatBufferBuilder builder, TacticalSupportSystemExcelT _o) {
    if (_o == null) return default(Offset<Japan.TacticalSupportSystemExcel>);
		byte[] key = TableEncryptionService.CreateKey("TacticalSupportSystem");
