...
public struct EventContentShopRefreshExcel : IFlatbufferObject
{
  ...
  public Japan.ShopCategoryType CategoryType { get { int o = __p.__offset(16); return o != 0 ? (Japan.ShopCategoryType)__p.bb.GetInt(o + __p.bb_pos) : Japan.ShopCategoryType.General; } }
  ...
  public static Offset<Japan.EventContentShopRefreshExcel> CreateEventContentShopRefreshExcel(FlatBufferBuilder builder,
  ...
  public static void AddCategoryType(FlatBufferBuilder builder, Japan.ShopCategoryType categoryType) { builder.AddInt(6, (int)categoryType, 0); }
  ...
  public static Offset<Japan.EventContentShopRefreshExcel> EndEventContentShopRefreshExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.EventContentShopRefreshExcel>(o);
  }
  ...
  public static Offset<Japan.EventContentShopRefreshExcel> Pack(FlatBufferBuilder builder, EventContentShopRefreshExcelT _o) {
    if (_o == null) return default(Offset<Japan.EventContentShopRefreshExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentShopRefresh");
...
static public class EventContentShopRefreshExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 16 /*CategoryType*/, 4 /*Japan.ShopCategoryType*/, 4, false)
