...
public struct EventContentTreasureRoundExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.EventContentTreasureRoundExcel> CreateEventContentTreasureRoundExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.EventContentTreasureRoundExcel> EndEventContentTreasureRoundExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.EventContentTreasureRoundExcel>(o);
  }
  ...
  public static Offset<Japan.EventContentTreasureRoundExcel> Pack(FlatBufferBuilder builder, EventContentTreasureRoundExcelT _o) {
    if (_o == null) return default(Offset<Japan.EventContentTreasureRoundExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentTreasureRound");
