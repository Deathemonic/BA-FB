...
public struct RaidStageRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.RaidStageRewardExcel> CreateRaidStageRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static void StartRaidStageRewardExcel(FlatBufferBuilder builder) { builder.StartTable(6); }
  ...
  public static Offset<Japan.RaidStageRewardExcel> EndRaidStageRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.RaidStageRewardExcel>(o);
  }
  ...
  public static Offset<Japan.RaidStageRewardExcel> Pack(FlatBufferBuilder builder, RaidStageRewardExcelT _o) {
    if (_o == null) return default(Offset<Japan.RaidStageRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("RaidStageReward");
