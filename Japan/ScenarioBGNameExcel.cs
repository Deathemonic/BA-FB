...
public struct ScenarioBGNameExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ScenarioBGNameExcelT _o) {
    ...
    _o.BGType = TableEncryptionService.UseEncryption ? (Japan.ScenarioBGType)TableEncryptionService.Convert((int)this.BGType, key) : this.BGType;
  ...
  public static Offset<Japan.ScenarioBGNameExcel> Pack(FlatBufferBuilder builder, ScenarioBGNameExcelT _o) {
    ...
    var _BGFileName = _o.BGFileName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.BGFileName, key) : _o.BGFileName));
		var _BGType = TableEncryptionService.UseEncryption ? (Japan.ScenarioBGType)TableEncryptionService.Convert((int)_o.BGType, key) : _o.BGType;
