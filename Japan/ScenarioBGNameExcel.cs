...
public struct ScenarioBGNameExcel : IFlatbufferObject
{
  ...
  public Japan.ScenarioBGType BGType { get { int o = __p.__offset(10); return o != 0 ? (Japan.ScenarioBGType)__p.bb.GetInt(o + __p.bb_pos) : Japan.ScenarioBGType.None; } }
  ...
  public static Offset<Japan.ScenarioBGNameExcel> CreateScenarioBGNameExcel(FlatBufferBuilder builder,
      uint Name = 0,
      Japan.ProductionStep ProductionStep = Japan.ProductionStep.ToDo,
      StringOffset BGFileNameOffset = default(StringOffset),
      Japan.ScenarioBGType BGType = Japan.ScenarioBGType.None,
  ...
  public static void AddBGType(FlatBufferBuilder builder, Japan.ScenarioBGType bGType) { builder.AddInt(3, (int)bGType, 0); }
  ...
  public static Offset<Japan.ScenarioBGNameExcel> EndScenarioBGNameExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ScenarioBGNameExcel>(o);
  }
  ...
  public static Offset<Japan.ScenarioBGNameExcel> Pack(FlatBufferBuilder builder, ScenarioBGNameExcelT _o) {
    if (_o == null) return default(Offset<Japan.ScenarioBGNameExcel>);
		byte[] key = TableEncryptionService.CreateKey("ScenarioBGName");
...
public class ScenarioBGNameExcelT
{
  ...
  public Japan.ScenarioBGType BGType { get; set; }
  ...
  public ScenarioBGNameExcelT() {
    ...
    this.BGType = Japan.ScenarioBGType.None;
...
static public class ScenarioBGNameExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*BGType*/, 4 /*Japan.ScenarioBGType*/, 4, false)
