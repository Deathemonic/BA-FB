...
public struct RecipeCraftExcel : IFlatbufferObject
{
  ...
  public Japan.RecipeType RecipeType { get { int o = __p.__offset(8); return o != 0 ? (Japan.RecipeType)__p.bb.GetInt(o + __p.bb_pos) : Japan.RecipeType.None; } }
  ...
  public Japan.ParcelType ParcelType(int j) { int o = __p.__offset(14); return o != 0 ? (Japan.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.ParcelType)0; }
  public int ParcelTypeLength { get { int o = __p.__offset(14); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.ParcelType> GetParcelTypeBytes() { return __p.__vector_as_span<Japan.ParcelType>(14, 4); }
#else
  public ArraySegment<byte>? GetParcelTypeBytes() { return __p.__vector_as_arraysegment(14); }
#endif
  public Japan.ParcelType[] GetParcelTypeArray() { int o = __p.__offset(14); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.ParcelType[] a = new Japan.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Japan.RecipeCraftExcel> CreateRecipeCraftExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddRecipeType(FlatBufferBuilder builder, Japan.RecipeType recipeType) { builder.AddInt(2, (int)recipeType, 0); }
  ...
  public static Offset<Japan.RecipeCraftExcel> EndRecipeCraftExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.RecipeCraftExcel>(o);
  }
  ...
  public static Offset<Japan.RecipeCraftExcel> Pack(FlatBufferBuilder builder, RecipeCraftExcelT _o) {
    if (_o == null) return default(Offset<Japan.RecipeCraftExcel>);
		byte[] key = TableEncryptionService.CreateKey("RecipeCraft");
    ...
    var _RecipeIngredientDevName = _o.RecipeIngredientDevName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.RecipeIngredientDevName, key) : _o.RecipeIngredientDevName));
    ...
    if (_o.ParcelDevName != null) {
      ...
      for (var _j = 0; _j < __ParcelDevName.Length; ++_j) { __ParcelDevName[_j] = builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ParcelDevName[_j], key) : _o.ParcelDevName[_j])); }
...
static public class RecipeCraftExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*RecipeType*/, 4 /*Japan.RecipeType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 14 /*ParcelType*/, 4 /*Japan.ParcelType*/, false)
