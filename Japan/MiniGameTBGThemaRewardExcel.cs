...
public struct MiniGameTBGThemaRewardExcel : IFlatbufferObject
{
  ...
  public Japan.MiniGameTBGThemaRewardType MiniGameTBGThemaRewardType { get { int o = __p.__offset(12); return o != 0 ? (Japan.MiniGameTBGThemaRewardType)__p.bb.GetInt(o + __p.bb_pos) : Japan.MiniGameTBGThemaRewardType.TreasureReward; } }
  ...
  public static Offset<Japan.MiniGameTBGThemaRewardExcel> CreateMiniGameTBGThemaRewardExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      int ThemaRound = 0,
      int ThemaUniqueId = 0,
      bool IsLoop = false,
      Japan.MiniGameTBGThemaRewardType MiniGameTBGThemaRewardType = Japan.MiniGameTBGThemaRewardType.TreasureReward,
  ...
  public static void AddMiniGameTBGThemaRewardType(FlatBufferBuilder builder, Japan.MiniGameTBGThemaRewardType miniGameTBGThemaRewardType) { builder.AddInt(4, (int)miniGameTBGThemaRewardType, 0); }
  ...
  public static Offset<Japan.MiniGameTBGThemaRewardExcel> EndMiniGameTBGThemaRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.MiniGameTBGThemaRewardExcel>(o);
  }
  ...
  public static Offset<Japan.MiniGameTBGThemaRewardExcel> Pack(FlatBufferBuilder builder, MiniGameTBGThemaRewardExcelT _o) {
    if (_o == null) return default(Offset<Japan.MiniGameTBGThemaRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("MiniGameTBGThemaReward");
...
public class MiniGameTBGThemaRewardExcelT
{
  ...
  public Japan.MiniGameTBGThemaRewardType MiniGameTBGThemaRewardType { get; set; }
  ...
  public MiniGameTBGThemaRewardExcelT() {
    ...
    this.IsLoop = false;
    this.MiniGameTBGThemaRewardType = Japan.MiniGameTBGThemaRewardType.TreasureReward;
...
static public class MiniGameTBGThemaRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*MiniGameTBGThemaRewardType*/, 4 /*Japan.MiniGameTBGThemaRewardType*/, 4, false)
