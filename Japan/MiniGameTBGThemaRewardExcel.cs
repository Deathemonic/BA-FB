...
public struct MiniGameTBGThemaRewardExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(MiniGameTBGThemaRewardExcelT _o) {
    ...
    _o.ThemaRound = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.ThemaRound, key) : this.ThemaRound;
    _o.ThemaUniqueId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.ThemaUniqueId, key) : this.ThemaUniqueId;
    _o.IsLoop = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.IsLoop, key) : this.IsLoop;
    _o.MiniGameTBGThemaRewardType = TableEncryptionService.UseEncryption ? (Japan.MiniGameTBGThemaRewardType)TableEncryptionService.Convert((int)this.MiniGameTBGThemaRewardType, key) : this.MiniGameTBGThemaRewardType;
  ...
  public static Offset<Japan.MiniGameTBGThemaRewardExcel> Pack(FlatBufferBuilder builder, MiniGameTBGThemaRewardExcelT _o) {
    if (_o == null) return default(Offset<Japan.MiniGameTBGThemaRewardExcel>);
		...
		var _ThemaRound = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.ThemaRound, key) : _o.ThemaRound;
		var _ThemaUniqueId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.ThemaUniqueId, key) : _o.ThemaUniqueId;
		var _IsLoop = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.IsLoop, key) : _o.IsLoop;
		var _MiniGameTBGThemaRewardType = TableEncryptionService.UseEncryption ? (Japan.MiniGameTBGThemaRewardType)TableEncryptionService.Convert((int)_o.MiniGameTBGThemaRewardType, key) : _o.MiniGameTBGThemaRewardType;
