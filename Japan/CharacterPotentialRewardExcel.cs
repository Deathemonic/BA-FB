...
public struct CharacterPotentialRewardExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(CharacterPotentialRewardExcelT _o) {
    ...
    for (var _j = 0; _j < this.RequirePotentialStatTypeLength; ++_j) {_o.RequirePotentialStatType.Add(TableEncryptionService.UseEncryption ? (Japan.PotentialStatBonusRateType)TableEncryptionService.Convert((int)this.RequirePotentialStatType(_j), key) : this.RequirePotentialStatType(_j));}
  ...
  public static Offset<Japan.CharacterPotentialRewardExcel> Pack(FlatBufferBuilder builder, CharacterPotentialRewardExcelT _o) {
    ...
    if (_o.RequirePotentialStatType != null) {
      var __RequirePotentialStatType = _o.RequirePotentialStatType.Select(x => TableEncryptionService.UseEncryption ? (Japan.PotentialStatBonusRateType)TableEncryptionService.Convert((int)x, key) : x).ToArray();
