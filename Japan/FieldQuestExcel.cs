...
public struct FieldQuestExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.FieldQuestExcel> CreateFieldQuestExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.FieldQuestExcel> EndFieldQuestExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.FieldQuestExcel>(o);
  }
  ...
  public static Offset<Japan.FieldQuestExcel> Pack(FlatBufferBuilder builder, FieldQuestExcelT _o) {
    if (_o == null) return default(Offset<Japan.FieldQuestExcel>);
		byte[] key = TableEncryptionService.CreateKey("FieldQuest");
