...
public struct ConstArenaExcel : IFlatbufferObject
{
  ...
  public Japan.ParcelType EnterCostType { get { int o = __p.__offset(16); return o != 0 ? (Japan.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Japan.ParcelType.None; } }
  ...
  public Japan.StatType ModifiedStatType(int j) { int o = __p.__offset(34); return o != 0 ? (Japan.StatType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.StatType)0; }
  public int ModifiedStatTypeLength { get { int o = __p.__offset(34); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.StatType> GetModifiedStatTypeBytes() { return __p.__vector_as_span<Japan.StatType>(34, 4); }
#else
  public ArraySegment<byte>? GetModifiedStatTypeBytes() { return __p.__vector_as_arraysegment(34); }
#endif
  public Japan.StatType[] GetModifiedStatTypeArray() { int o = __p.__offset(34); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.StatType[] a = new Japan.StatType[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.StatType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Japan.ConstArenaExcel> CreateConstArenaExcel(FlatBufferBuilder builder,
      ...
      Japan.ParcelType EnterCostType = Japan.ParcelType.None,
      long EnterCostId = 0,
      long TicketCost = 0,
  ...
  public static void AddEnterCostType(FlatBufferBuilder builder, Japan.ParcelType enterCostType) { builder.AddInt(6, (int)enterCostType, 0); }
  ...
  public static VectorOffset CreateModifiedStatTypeVector(FlatBufferBuilder builder, Japan.StatType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateModifiedStatTypeVectorBlock(FlatBufferBuilder builder, Japan.StatType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateModifiedStatTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Japan.StatType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateModifiedStatTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Japan.StatType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Japan.ConstArenaExcel> EndConstArenaExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ConstArenaExcel>(o);
  }
  ...
  public void UnPackTo(ConstArenaExcelT _o) {
    ...
    _o.EnterCostType = TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)this.EnterCostType, key) : this.EnterCostType;
    ...
    _o.ModifiedStatType = new List<Japan.StatType>();
    for (var _j = 0; _j < this.ModifiedStatTypeLength; ++_j) {_o.ModifiedStatType.Add(TableEncryptionService.UseEncryption ? (Japan.StatType)TableEncryptionService.Convert((int)this.ModifiedStatType(_j), key) : this.ModifiedStatType(_j));}
  ...
  public static Offset<Japan.ConstArenaExcel> Pack(FlatBufferBuilder builder, ConstArenaExcelT _o) {
    if (_o == null) return default(Offset<Japan.ConstArenaExcel>);
		byte[] key = TableEncryptionService.CreateKey("ConstArena");
		...
		var _EnterCostType = TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)_o.EnterCostType, key) : _o.EnterCostType;
    ...
    if (_o.ModifiedStatType != null) {
      var __modifiedStatType = _o.ModifiedStatType.Select(x => TableEncryptionService.UseEncryption ? (Japan.StatType)TableEncryptionService.Convert((int)x, key) : x).ToArray();
...
public class ConstArenaExcelT
{
  ...
  public Japan.ParcelType EnterCostType { get; set; }
  ...
  public List<Japan.StatType> ModifiedStatType { get; set; }
  ...
  public ConstArenaExcelT() {
    ...
    this.EnterCostType = Japan.ParcelType.None;
    this.EnterCostId = 0;
    this.TicketCost = 0;
...
static public class ConstArenaExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 16 /*EnterCostType*/, 4 /*Japan.ParcelType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 34 /*ModifiedStatType*/, 4 /*Japan.StatType*/, false)
