...
public struct MiniGameDreamParameterExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(MiniGameDreamParameterExcelT _o) {
    ...
    _o.ParameterType = TableEncryptionService.UseEncryption ? (Japan.DreamMakerParameterType)TableEncryptionService.Convert((int)this.ParameterType, key) : this.ParameterType;
  ...
  public static Offset<Japan.MiniGameDreamParameterExcel> Pack(FlatBufferBuilder builder, MiniGameDreamParameterExcelT _o) {
    if (_o == null) return default(Offset<Japan.MiniGameDreamParameterExcel>);
		...
		var _ParameterType = TableEncryptionService.UseEncryption ? (Japan.DreamMakerParameterType)TableEncryptionService.Convert((int)_o.ParameterType, key) : _o.ParameterType;
