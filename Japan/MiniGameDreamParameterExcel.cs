...
public struct MiniGameDreamParameterExcel : IFlatbufferObject
{
  ...
  public Japan.DreamMakerParameterType ParameterType { get { int o = __p.__offset(8); return o != 0 ? (Japan.DreamMakerParameterType)__p.bb.GetInt(o + __p.bb_pos) : Japan.DreamMakerParameterType.None; } }
  ...
  public static Offset<Japan.MiniGameDreamParameterExcel> CreateMiniGameDreamParameterExcel(FlatBufferBuilder builder,
      long Id = 0,
      long EventContentId = 0,
      Japan.DreamMakerParameterType ParameterType = Japan.DreamMakerParameterType.None,
  ...
  public static void AddParameterType(FlatBufferBuilder builder, Japan.DreamMakerParameterType parameterType) { builder.AddInt(2, (int)parameterType, 0); }
  ...
  public static Offset<Japan.MiniGameDreamParameterExcel> EndMiniGameDreamParameterExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.MiniGameDreamParameterExcel>(o);
  }
  ...
  public void UnPackTo(MiniGameDreamParameterExcelT _o) {
    ...
    _o.ParameterType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ParameterType, key) : this.ParameterType;
    ...
    _o.ParameterBase = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ParameterBase, key) : this.ParameterBase;
    _o.ParameterBaseMax = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ParameterBaseMax, key) : this.ParameterBaseMax;
    _o.ParameterMin = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ParameterMin, key) : this.ParameterMin;
    _o.ParameterMax = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ParameterMax, key) : this.ParameterMax;
  }
  public static Offset<Japan.MiniGameDreamParameterExcel> Pack(FlatBufferBuilder builder, MiniGameDreamParameterExcelT _o) {
    if (_o == null) return default(Offset<Japan.MiniGameDreamParameterExcel>);
		byte[] key = TableEncryptionService.CreateKey("MiniGameDreamParameter");
		...
		var _ParameterType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ParameterType, key) : _o.ParameterType;
    ...
    var _IconPath = _o.IconPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.IconPath, key) : _o.IconPath));
		var _ParameterBase = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ParameterBase, key) : _o.ParameterBase;
		var _ParameterBaseMax = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ParameterBaseMax, key) : _o.ParameterBaseMax;
		var _ParameterMin = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ParameterMin, key) : _o.ParameterMin;
		var _ParameterMax = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ParameterMax, key) : _o.ParameterMax;
...
public class MiniGameDreamParameterExcelT
{
  ...
  public Japan.DreamMakerParameterType ParameterType { get; set; }
  ...
  public MiniGameDreamParameterExcelT() {
    ...
    this.ParameterType = Japan.DreamMakerParameterType.None;
...
static public class MiniGameDreamParameterExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*ParameterType*/, 4 /*Japan.DreamMakerParameterType*/, 4, false)
