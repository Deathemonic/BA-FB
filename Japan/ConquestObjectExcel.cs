...
public struct ConquestObjectExcel : IFlatbufferObject
{
  ...
  public Japan.ConquestObjectType ConquestObjectType { get { int o = __p.__offset(8); return o != 0 ? (Japan.ConquestObjectType)__p.bb.GetInt(o + __p.bb_pos) : Japan.ConquestObjectType.None; } }
  ...
  public Japan.ParcelType ConquestRewardParcelType { get { int o = __p.__offset(16); return o != 0 ? (Japan.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Japan.ParcelType.None; } }
  ...
  public static Offset<Japan.ConquestObjectExcel> CreateConquestObjectExcel(FlatBufferBuilder builder,
      long Id = 0,
      long EventContentId = 0,
      Japan.ConquestObjectType ConquestObjectType = Japan.ConquestObjectType.None,
      uint Key = 0,
      StringOffset NameOffset = default(StringOffset),
      StringOffset PrefabNameOffset = default(StringOffset),
      Japan.ParcelType ConquestRewardParcelType = Japan.ParcelType.None,
  ...
  public static void AddConquestObjectType(FlatBufferBuilder builder, Japan.ConquestObjectType conquestObjectType) { builder.AddInt(2, (int)conquestObjectType, 0); }
  ...
  public static void AddConquestRewardParcelType(FlatBufferBuilder builder, Japan.ParcelType conquestRewardParcelType) { builder.AddInt(6, (int)conquestRewardParcelType, 0); }
  ...
  public static Offset<Japan.ConquestObjectExcel> EndConquestObjectExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ConquestObjectExcel>(o);
  }
  ...
  public static Offset<Japan.ConquestObjectExcel> Pack(FlatBufferBuilder builder, ConquestObjectExcelT _o) {
    if (_o == null) return default(Offset<Japan.ConquestObjectExcel>);
		byte[] key = TableEncryptionService.CreateKey("ConquestObject");
...
public class ConquestObjectExcelT
{
  ...
  public Japan.ConquestObjectType ConquestObjectType { get; set; }
  public uint Key { get; set; }
  public string Name { get; set; }
  public string PrefabName { get; set; }
  public Japan.ParcelType ConquestRewardParcelType { get; set; }
  ...
  public ConquestObjectExcelT() {
    ...
    this.ConquestObjectType = Japan.ConquestObjectType.None;
    this.Key = 0;
    this.Name = null;
    this.PrefabName = null;
    this.ConquestRewardParcelType = Japan.ParcelType.None;
...
static public class ConquestObjectExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*ConquestObjectType*/, 4 /*Japan.ConquestObjectType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 16 /*ConquestRewardParcelType*/, 4 /*Japan.ParcelType*/, 4, false)
