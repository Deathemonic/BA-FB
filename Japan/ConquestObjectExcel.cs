...
public struct ConquestObjectExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ConquestObjectExcelT _o) {
    ...
    _o.ConquestObjectType = TableEncryptionService.UseEncryption ? (Japan.ConquestObjectType)TableEncryptionService.Convert((int)this.ConquestObjectType, key) : this.ConquestObjectType;
    ...
    _o.ConquestRewardParcelType = TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)this.ConquestRewardParcelType, key) : this.ConquestRewardParcelType;
  ...
  public static Offset<Japan.ConquestObjectExcel> Pack(FlatBufferBuilder builder, ConquestObjectExcelT _o) {
    if (_o == null) return default(Offset<Japan.ConquestObjectExcel>);
		...
		var _ConquestObjectType = TableEncryptionService.UseEncryption ? (Japan.ConquestObjectType)TableEncryptionService.Convert((int)_o.ConquestObjectType, key) : _o.ConquestObjectType;
    ...
    var _PrefabName = _o.PrefabName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.PrefabName, key) : _o.PrefabName));
		var _ConquestRewardParcelType = TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)_o.ConquestRewardParcelType, key) : _o.ConquestRewardParcelType;
