...
public struct TrophyCollectionExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.TrophyCollectionExcel> CreateTrophyCollectionExcel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static Offset<Japan.TrophyCollectionExcel> EndTrophyCollectionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.TrophyCollectionExcel>(o);
  }
  ...
  public void UnPackTo(TrophyCollectionExcelT _o) {
    ...
    for (var _j = 0; _j < this.FurnitureIdLength; ++_j) {_o.FurnitureId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.FurnitureId(_j), key) : this.FurnitureId(_j));}
  }
  public static Offset<Japan.TrophyCollectionExcel> Pack(FlatBufferBuilder builder, TrophyCollectionExcelT _o) {
    if (_o == null) return default(Offset<Japan.TrophyCollectionExcel>);
		byte[] key = TableEncryptionService.CreateKey("TrophyCollection");
    ...
    if (_o.FurnitureId != null) {
      var __FurnitureId = _o.FurnitureId.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
