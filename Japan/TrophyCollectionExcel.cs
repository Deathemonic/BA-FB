...
public struct TrophyCollectionExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(TrophyCollectionExcelT _o) {
    ...
    for (var _j = 0; _j < this.FurnitureIdLength; ++_j) {_o.FurnitureId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.FurnitureId(_j), key) : this.FurnitureId(_j));}
  }
