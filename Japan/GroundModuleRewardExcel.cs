...
public struct GroundModuleRewardExcel : IFlatbufferObject
{
  ...
  public Japan.ParcelType RewardParcelType { get { int o = __p.__offset(6); return o != 0 ? (Japan.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Japan.ParcelType.None; } }
  ...
  public static Offset<Japan.GroundModuleRewardExcel> CreateGroundModuleRewardExcel(FlatBufferBuilder builder,
      uint GroupId = 0,
  ...
  public static void AddRewardParcelType(FlatBufferBuilder builder, Japan.ParcelType rewardParcelType) { builder.AddInt(1, (int)rewardParcelType, 0); }
  ...
  public static Offset<Japan.GroundModuleRewardExcel> EndGroundModuleRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.GroundModuleRewardExcel>(o);
  }
  ...
  public static Offset<Japan.GroundModuleRewardExcel> Pack(FlatBufferBuilder builder, GroundModuleRewardExcelT _o) {
    if (_o == null) return default(Offset<Japan.GroundModuleRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("GroundModuleReward");
...
static public class GroundModuleRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*RewardParcelType*/, 4 /*Japan.ParcelType*/, 4, false)
