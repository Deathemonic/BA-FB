...
public struct OperatorExcel : IFlatbufferObject
{
  ...
  public Japan.OperatorCondition OperatorCondition { get { int o = __p.__offset(8); return o != 0 ? (Japan.OperatorCondition)__p.bb.GetInt(o + __p.bb_pos) : Japan.OperatorCondition.None; } }
  ...
  public Japan.CharacterVoiceOverridePriority CharacterVoiceOverridePriority { get { int o = __p.__offset(28); return o != 0 ? (Japan.CharacterVoiceOverridePriority)__p.bb.GetInt(o + __p.bb_pos) : Japan.CharacterVoiceOverridePriority.None; } }

  public static Offset<Japan.OperatorExcel> CreateOperatorExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      StringOffset GroupIdOffset = default(StringOffset),
      Japan.OperatorCondition OperatorCondition = Japan.OperatorCondition.None,
      ...
      Japan.CharacterVoiceOverridePriority CharacterVoiceOverridePriority = Japan.CharacterVoiceOverridePriority.None) {
  ...
  public static void AddOperatorCondition(FlatBufferBuilder builder, Japan.OperatorCondition operatorCondition) { builder.AddInt(2, (int)operatorCondition, 0); }
  ...
  public static void AddCharacterVoiceOverridePriority(FlatBufferBuilder builder, Japan.CharacterVoiceOverridePriority characterVoiceOverridePriority) { builder.AddInt(12, (int)characterVoiceOverridePriority, 0); }
  public static Offset<Japan.OperatorExcel> EndOperatorExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.OperatorExcel>(o);
  }
  ...
  public void UnPackTo(OperatorExcelT _o) {
    ...
    _o.OperatorCondition = TableEncryptionService.UseEncryption ? (Japan.OperatorCondition)TableEncryptionService.Convert((int)this.OperatorCondition, key) : this.OperatorCondition;
    _o.OutputSequence = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.OutputSequence, key) : this.OutputSequence;
    _o.RandomWeight = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.RandomWeight, key) : this.RandomWeight;
    _o.OutputDelay = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.OutputDelay, key) : this.OutputDelay;
    _o.Duration = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.Duration, key) : this.Duration;
    _o.OperatorOutputPriority = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.OperatorOutputPriority, key) : this.OperatorOutputPriority;
    ...
    _o.TextLocalizeKey = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.TextLocalizeKey, key) : this.TextLocalizeKey;
    ...
    _o.OperatorWaitQueue = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.OperatorWaitQueue, key) : this.OperatorWaitQueue;
    _o.CharacterVoiceOverridePriority = TableEncryptionService.UseEncryption ? (Japan.CharacterVoiceOverridePriority)TableEncryptionService.Convert((int)this.CharacterVoiceOverridePriority, key) : this.CharacterVoiceOverridePriority;
  }
  public static Offset<Japan.OperatorExcel> Pack(FlatBufferBuilder builder, OperatorExcelT _o) {
    if (_o == null) return default(Offset<Japan.OperatorExcel>);
		byte[] key = TableEncryptionService.CreateKey("Operator");
    ...
    var _GroupId = _o.GroupId == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.GroupId, key) : _o.GroupId));
		var _OperatorCondition = TableEncryptionService.UseEncryption ? (Japan.OperatorCondition)TableEncryptionService.Convert((int)_o.OperatorCondition, key) : _o.OperatorCondition;
		var _OutputSequence = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.OutputSequence, key) : _o.OutputSequence;
		var _RandomWeight = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.RandomWeight, key) : _o.RandomWeight;
		var _OutputDelay = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.OutputDelay, key) : _o.OutputDelay;
		var _Duration = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.Duration, key) : _o.Duration;
		var _OperatorOutputPriority = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.OperatorOutputPriority, key) : _o.OperatorOutputPriority;
    ...
    var _TextLocalizeKey = _o.TextLocalizeKey == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.TextLocalizeKey, key) : _o.TextLocalizeKey));
    ...
    if (_o.VoiceId != null) {
      ...
      _VoiceId = CreateVoiceIdVector(builder, __VoiceId);
		...
		var _OperatorWaitQueue = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.OperatorWaitQueue, key) : _o.OperatorWaitQueue;
		var _CharacterVoiceOverridePriority = TableEncryptionService.UseEncryption ? (Japan.CharacterVoiceOverridePriority)TableEncryptionService.Convert((int)_o.CharacterVoiceOverridePriority, key) : _o.CharacterVoiceOverridePriority;
    return CreateOperatorExcel(
      builder,
      TableEncryptionService.UseEncryption ? _UniqueId : _o.UniqueId,
      _GroupId,
      TableEncryptionService.UseEncryption ? _OperatorCondition : _o.OperatorCondition,
      TableEncryptionService.UseEncryption ? _OutputSequence : _o.OutputSequence,
      TableEncryptionService.UseEncryption ? _RandomWeight : _o.RandomWeight,
      TableEncryptionService.UseEncryption ? _OutputDelay : _o.OutputDelay,
      TableEncryptionService.UseEncryption ? _Duration : _o.Duration,
      TableEncryptionService.UseEncryption ? _OperatorOutputPriority : _o.OperatorOutputPriority,
      _PortraitPath,
      _TextLocalizeKey,
      _VoiceId,
      TableEncryptionService.UseEncryption ? _OperatorWaitQueue : _o.OperatorWaitQueue,
      TableEncryptionService.UseEncryption ? _CharacterVoiceOverridePriority : _o.CharacterVoiceOverridePriority);
  }
}
...
public class OperatorExcelT
{
  ...
  public Japan.OperatorCondition OperatorCondition { get; set; }
  ...
  public Japan.CharacterVoiceOverridePriority CharacterVoiceOverridePriority { get; set; }

  public OperatorExcelT() {
    this.UniqueId = 0;
    this.GroupId = null;
    this.OperatorCondition = Japan.OperatorCondition.None;
    ...
    this.CharacterVoiceOverridePriority = Japan.CharacterVoiceOverridePriority.None;
  }
}
...
static public class OperatorExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*OperatorCondition*/, 4 /*Japan.OperatorCondition*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 28 /*CharacterVoiceOverridePriority*/, 4 /*Japan.CharacterVoiceOverridePriority*/, 4, false)
