...
public struct IdCardBackgroundExcel : IFlatbufferObject
{
  ...
  public Japan.Rarity Rarity { get { int o = __p.__offset(6); return o != 0 ? (Japan.Rarity)__p.bb.GetInt(o + __p.bb_pos) : Japan.Rarity.N; } }
  ...
  public static Offset<Japan.IdCardBackgroundExcel> CreateIdCardBackgroundExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddRarity(FlatBufferBuilder builder, Japan.Rarity rarity) { builder.AddInt(1, (int)rarity, 0); }
  ...
  public static Offset<Japan.IdCardBackgroundExcel> EndIdCardBackgroundExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.IdCardBackgroundExcel>(o);
  }
  ...
  public static Offset<Japan.IdCardBackgroundExcel> Pack(FlatBufferBuilder builder, IdCardBackgroundExcelT _o) {
    if (_o == null) return default(Offset<Japan.IdCardBackgroundExcel>);
		byte[] key = TableEncryptionService.CreateKey("IdCardBackground");
...
static public class IdCardBackgroundExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*Rarity*/, 4 /*Japan.Rarity*/, 4, false)
