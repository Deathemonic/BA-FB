...
public struct AudioAnimatorExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.AudioAnimatorExcel> CreateAudioAnimatorExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.AudioAnimatorExcel> EndAudioAnimatorExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.AudioAnimatorExcel>(o);
  }
  ...
  public static Offset<Japan.AudioAnimatorExcel> Pack(FlatBufferBuilder builder, AudioAnimatorExcelT _o) {
    if (_o == null) return default(Offset<Japan.AudioAnimatorExcel>);
		byte[] key = TableEncryptionService.CreateKey("AudioAnimator");
		var _ControllerNameHash = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ControllerNameHash, key) : _o.ControllerNameHash;
    var _VoiceNamePrefix = _o.VoiceNamePrefix == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.VoiceNamePrefix, key) : _o.VoiceNamePrefix));
		var _StateNameHash = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StateNameHash, key) : _o.StateNameHash;
    var _StateName = _o.StateName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.StateName, key) : _o.StateName));
		...
		var _RandomPitchMax = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RandomPitchMax, key) : _o.RandomPitchMax;
		var _AudioPriority = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.AudioPriority, key) : _o.AudioPriority;
