...
public struct AcademyFavorScheduleExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.AcademyFavorScheduleExcel> CreateAcademyFavorScheduleExcel(FlatBufferBuilder builder,
      long Id = 0,
      long CharacterId = 0,
  ...
  public static Offset<Japan.AcademyFavorScheduleExcel> EndAcademyFavorScheduleExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.AcademyFavorScheduleExcel>(o);
  }
  ...
  public static Offset<Japan.AcademyFavorScheduleExcel> Pack(FlatBufferBuilder builder, AcademyFavorScheduleExcelT _o) {
    if (_o == null) return default(Offset<Japan.AcademyFavorScheduleExcel>);
		byte[] key = TableEncryptionService.CreateKey("AcademyFavorSchedule");
