...
public struct GoodsExcel : IFlatbufferObject
{
  ...
  public Japan.GachaTicketType ConsumeGachaTicketType { get { int o = __p.__offset(20); return o != 0 ? (Japan.GachaTicketType)__p.bb.GetInt(o + __p.bb_pos) : Japan.GachaTicketType.None; } }
  ...
  public static void AddConsumeGachaTicketType(FlatBufferBuilder builder, Japan.GachaTicketType consumeGachaTicketType) { builder.AddInt(8, (int)consumeGachaTicketType, 0); }
...
static public class GoodsExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 20 /*ConsumeGachaTicketType*/, 4 /*Japan.GachaTicketType*/, 4, false)
