...
public struct GoodsExcel : IFlatbufferObject
{
  ...
  public Japan.ParcelType ConsumeParcelType(int j) { int o = __p.__offset(12); return o != 0 ? (Japan.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.ParcelType)0; }
  public int ConsumeParcelTypeLength { get { int o = __p.__offset(12); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.ParcelType> GetConsumeParcelTypeBytes() { return __p.__vector_as_span<Japan.ParcelType>(12, 4); }
#else
  public ArraySegment<byte>? GetConsumeParcelTypeBytes() { return __p.__vector_as_arraysegment(12); }
#endif
  public Japan.ParcelType[] GetConsumeParcelTypeArray() { int o = __p.__offset(12); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.ParcelType[] a = new Japan.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Japan.ConsumeCondition ConsumeCondition(int j) { int o = __p.__offset(18); return o != 0 ? (Japan.ConsumeCondition)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.ConsumeCondition)0; }
  public int ConsumeConditionLength { get { int o = __p.__offset(18); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.ConsumeCondition> GetConsumeConditionBytes() { return __p.__vector_as_span<Japan.ConsumeCondition>(18, 4); }
#else
  public ArraySegment<byte>? GetConsumeConditionBytes() { return __p.__vector_as_arraysegment(18); }
#endif
  public Japan.ConsumeCondition[] GetConsumeConditionArray() { int o = __p.__offset(18); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.ConsumeCondition[] a = new Japan.ConsumeCondition[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.ConsumeCondition)__p.bb.GetInt(p + i * 4); } return a; }
  public Japan.GachaTicketType ConsumeGachaTicketType(int j) { int o = __p.__offset(20); return o != 0 ? (Japan.GachaTicketType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.GachaTicketType)0; }
  public int ConsumeGachaTicketTypeLength { get { int o = __p.__offset(20); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.GachaTicketType> GetConsumeGachaTicketTypeBytes() { return __p.__vector_as_span<Japan.GachaTicketType>(20, 4); }
#else
  public ArraySegment<byte>? GetConsumeGachaTicketTypeBytes() { return __p.__vector_as_arraysegment(20); }
#endif
  public Japan.GachaTicketType[] GetConsumeGachaTicketTypeArray() { int o = __p.__offset(20); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.GachaTicketType[] a = new Japan.GachaTicketType[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.GachaTicketType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public long ConsumeExtraStep(int j) { int o = __p.__offset(30); return o != 0 ? __p.bb.GetLong(__p.__vector(o) + j * 8) : (long)0; }
  public int ConsumeExtraStepLength { get { int o = __p.__offset(30); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<long> GetConsumeExtraStepBytes() { return __p.__vector_as_span<long>(30, 8); }
#else
  public ArraySegment<byte>? GetConsumeExtraStepBytes() { return __p.__vector_as_arraysegment(30); }
#endif
  public long[] GetConsumeExtraStepArray() { return __p.__vector_as_array<long>(30); }
  public long ConsumeExtraAmount(int j) { int o = __p.__offset(32); return o != 0 ? __p.bb.GetLong(__p.__vector(o) + j * 8) : (long)0; }
  public int ConsumeExtraAmountLength { get { int o = __p.__offset(32); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<long> GetConsumeExtraAmountBytes() { return __p.__vector_as_span<long>(32, 8); }
#else
  public ArraySegment<byte>? GetConsumeExtraAmountBytes() { return __p.__vector_as_arraysegment(32); }
#endif
  public long[] GetConsumeExtraAmountArray() { return __p.__vector_as_array<long>(32); }
  public int State { get { int o = __p.__offset(34); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  public Japan.ParcelType ParcelType(int j) { int o = __p.__offset(36); return o != 0 ? (Japan.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.ParcelType)0; }
  public int ParcelTypeLength { get { int o = __p.__offset(36); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.ParcelType> GetParcelTypeBytes() { return __p.__vector_as_span<Japan.ParcelType>(36, 4); }
#else
  public ArraySegment<byte>? GetParcelTypeBytes() { return __p.__vector_as_arraysegment(36); }
#endif
  public Japan.ParcelType[] GetParcelTypeArray() { int o = __p.__offset(36); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.ParcelType[] a = new Japan.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  public long ParcelId(int j) { int o = __p.__offset(38); return o != 0 ? __p.bb.GetLong(__p.__vector(o) + j * 8) : (long)0; }
  public int ParcelIdLength { get { int o = __p.__offset(38); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<long> GetParcelIdBytes() { return __p.__vector_as_span<long>(38, 8); }
#else
  public ArraySegment<byte>? GetParcelIdBytes() { return __p.__vector_as_arraysegment(38); }
#endif
  public long[] GetParcelIdArray() { return __p.__vector_as_array<long>(38); }
  public long ParcelAmount(int j) { int o = __p.__offset(40); return o != 0 ? __p.bb.GetLong(__p.__vector(o) + j * 8) : (long)0; }
  public int ParcelAmountLength { get { int o = __p.__offset(40); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<long> GetParcelAmountBytes() { return __p.__vector_as_span<long>(40, 8); }
#else
  public ArraySegment<byte>? GetParcelAmountBytes() { return __p.__vector_as_arraysegment(40); }
#endif
  public long[] GetParcelAmountArray() { return __p.__vector_as_array<long>(40); }

  public static Offset<Japan.GoodsExcel> CreateGoodsExcel(FlatBufferBuilder builder,
      long Id = 0,
      int Type = 0,
  ...
  public static void StartGoodsExcel(FlatBufferBuilder builder) { builder.StartTable(19); }
  ...
  public static VectorOffset CreateConsumeParcelTypeVector(FlatBufferBuilder builder, Japan.ParcelType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateConsumeParcelTypeVectorBlock(FlatBufferBuilder builder, Japan.ParcelType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateConsumeParcelTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Japan.ParcelType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateConsumeParcelTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Japan.ParcelType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static VectorOffset CreateConsumeConditionVector(FlatBufferBuilder builder, Japan.ConsumeCondition[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateConsumeConditionVectorBlock(FlatBufferBuilder builder, Japan.ConsumeCondition[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateConsumeConditionVectorBlock(FlatBufferBuilder builder, ArraySegment<Japan.ConsumeCondition> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateConsumeConditionVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Japan.ConsumeCondition>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static VectorOffset CreateConsumeGachaTicketTypeVector(FlatBufferBuilder builder, Japan.GachaTicketType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateConsumeGachaTicketTypeVectorBlock(FlatBufferBuilder builder, Japan.GachaTicketType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateConsumeGachaTicketTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Japan.GachaTicketType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateConsumeGachaTicketTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Japan.GachaTicketType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static void AddConsumeExtraStep(FlatBufferBuilder builder, VectorOffset consumeExtraStepOffset) { builder.AddOffset(13, consumeExtraStepOffset.Value, 0); }
  ...
  public static void AddConsumeExtraAmount(FlatBufferBuilder builder, VectorOffset consumeExtraAmountOffset) { builder.AddOffset(14, consumeExtraAmountOffset.Value, 0); }
  ...
  public static void AddState(FlatBufferBuilder builder, int state) { builder.AddInt(15, state, 0); }
  public static void AddParcelType(FlatBufferBuilder builder, VectorOffset parcelTypeOffset) { builder.AddOffset(16, parcelTypeOffset.Value, 0); }
  ...
  public static void AddParcelId(FlatBufferBuilder builder, VectorOffset parcelIdOffset) { builder.AddOffset(17, parcelIdOffset.Value, 0); }
  ...
  public static void AddParcelAmount(FlatBufferBuilder builder, VectorOffset parcelAmountOffset) { builder.AddOffset(18, parcelAmountOffset.Value, 0); }
  ...
  public static Offset<Japan.GoodsExcel> EndGoodsExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.GoodsExcel>(o);
  }
  ...
  public void UnPackTo(GoodsExcelT _o) {
    ...
    _o.Type = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.Type, key) : this.Type;
    ...
    _o.ConsumeParcelType = new List<Japan.ParcelType>();
    for (var _j = 0; _j < this.ConsumeParcelTypeLength; ++_j) {_o.ConsumeParcelType.Add(TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)this.ConsumeParcelType(_j), key) : this.ConsumeParcelType(_j));}
    _o.ConsumeParcelId = new List<long>();
    for (var _j = 0; _j < this.ConsumeParcelIdLength; ++_j) {_o.ConsumeParcelId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ConsumeParcelId(_j), key) : this.ConsumeParcelId(_j));}
    _o.ConsumeParcelAmount = new List<long>();
    for (var _j = 0; _j < this.ConsumeParcelAmountLength; ++_j) {_o.ConsumeParcelAmount.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ConsumeParcelAmount(_j), key) : this.ConsumeParcelAmount(_j));}
    _o.ConsumeCondition = new List<Japan.ConsumeCondition>();
    for (var _j = 0; _j < this.ConsumeConditionLength; ++_j) {_o.ConsumeCondition.Add(TableEncryptionService.UseEncryption ? (Japan.ConsumeCondition)TableEncryptionService.Convert((int)this.ConsumeCondition(_j), key) : this.ConsumeCondition(_j));}
    _o.ConsumeGachaTicketType = new List<Japan.GachaTicketType>();
    for (var _j = 0; _j < this.ConsumeGachaTicketTypeLength; ++_j) {_o.ConsumeGachaTicketType.Add(TableEncryptionService.UseEncryption ? (Japan.GachaTicketType)TableEncryptionService.Convert((int)this.ConsumeGachaTicketType(_j), key) : this.ConsumeGachaTicketType(_j));}
    _o.ConsumeGachaTicketTypeAmount = new List<long>();
    for (var _j = 0; _j < this.ConsumeGachaTicketTypeAmountLength; ++_j) {_o.ConsumeGachaTicketTypeAmount.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ConsumeGachaTicketTypeAmount(_j), key) : this.ConsumeGachaTicketTypeAmount(_j));}
    _o.CombinedGachaCostId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.CombinedGachaCostId, key) : this.CombinedGachaCostId;
    _o.ProductIdAOS = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ProductIdAOS, key) : this.ProductIdAOS;
    _o.ProductIdiOS = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ProductIdiOS, key) : this.ProductIdiOS;
    _o.ConsumeExtraStep = new List<long>();
    for (var _j = 0; _j < this.ConsumeExtraStepLength; ++_j) {_o.ConsumeExtraStep.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ConsumeExtraStep(_j), key) : this.ConsumeExtraStep(_j));}
    _o.ConsumeExtraAmount = new List<long>();
    for (var _j = 0; _j < this.ConsumeExtraAmountLength; ++_j) {_o.ConsumeExtraAmount.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ConsumeExtraAmount(_j), key) : this.ConsumeExtraAmount(_j));}
  ...
  public static Offset<Japan.GoodsExcel> Pack(FlatBufferBuilder builder, GoodsExcelT _o) {
    if (_o == null) return default(Offset<Japan.GoodsExcel>);
		byte[] key = TableEncryptionService.CreateKey("Goods");
		var _Id = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.Id, key) : _o.Id;
		var _Type = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.Type, key) : _o.Type;
    ...
    if (_o.ConsumeParcelType != null) {
      var __ConsumeParcelType = _o.ConsumeParcelType.Select(x => TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)x, key) : x).ToArray();
    ...
    if (_o.ConsumeParcelId != null) {
      var __ConsumeParcelId = _o.ConsumeParcelId.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
    ...
    if (_o.ConsumeParcelAmount != null) {
      var __ConsumeParcelAmount = _o.ConsumeParcelAmount.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
    ...
    if (_o.ConsumeCondition != null) {
      var __ConsumeCondition = _o.ConsumeCondition.Select(x => TableEncryptionService.UseEncryption ? (Japan.ConsumeCondition)TableEncryptionService.Convert((int)x, key) : x).ToArray();
    ...
    if (_o.ConsumeGachaTicketType != null) {
      var __ConsumeGachaTicketType = _o.ConsumeGachaTicketType.Select(x => TableEncryptionService.UseEncryption ? (Japan.GachaTicketType)TableEncryptionService.Convert((int)x, key) : x).ToArray();
    ...
    if (_o.ConsumeGachaTicketTypeAmount != null) {
      var __ConsumeGachaTicketTypeAmount = _o.ConsumeGachaTicketTypeAmount.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
      _ConsumeGachaTicketTypeAmount = CreateConsumeGachaTicketTypeAmountVector(builder, __ConsumeGachaTicketTypeAmount);
    }
		var _CombinedGachaCostId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.CombinedGachaCostId, key) : _o.CombinedGachaCostId;
		var _ProductIdAOS = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ProductIdAOS, key) : _o.ProductIdAOS;
		var _ProductIdiOS = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ProductIdiOS, key) : _o.ProductIdiOS;
    var _ConsumeExtraStep = default(VectorOffset);
    if (_o.ConsumeExtraStep != null) {
      var __ConsumeExtraStep = _o.ConsumeExtraStep.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
    ...
    if (_o.ConsumeExtraAmount != null) {
      var __ConsumeExtraAmount = _o.ConsumeExtraAmount.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
    ...
    return CreateGoodsExcel(
      ...
      TableEncryptionService.UseEncryption ? _CombinedGachaCostId : _o.CombinedGachaCostId,
...
public class GoodsExcelT
{
  ...
  public List<Japan.ParcelType> ConsumeParcelType { get; set; }
  public List<long> ConsumeParcelId { get; set; }
  public List<long> ConsumeParcelAmount { get; set; }
  public List<Japan.ConsumeCondition> ConsumeCondition { get; set; }
  public List<Japan.GachaTicketType> ConsumeGachaTicketType { get; set; }
...
static public class GoodsExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 12 /*ConsumeParcelType*/, 4 /*Japan.ParcelType*/, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 18 /*ConsumeCondition*/, 4 /*Japan.ConsumeCondition*/, false)
      && verifier.VerifyVectorOfData(tablePos, 20 /*ConsumeGachaTicketType*/, 4 /*Japan.GachaTicketType*/, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 30 /*ConsumeExtraStep*/, 8 /*long*/, false)
      && verifier.VerifyVectorOfData(tablePos, 32 /*ConsumeExtraAmount*/, 8 /*long*/, false)
      && verifier.VerifyField(tablePos, 34 /*State*/, 4 /*int*/, 4, false)
      && verifier.VerifyVectorOfData(tablePos, 36 /*ParcelType*/, 4 /*Japan.ParcelType*/, false)
      && verifier.VerifyVectorOfData(tablePos, 38 /*ParcelId*/, 8 /*long*/, false)
      && verifier.VerifyVectorOfData(tablePos, 40 /*ParcelAmount*/, 8 /*long*/, false)
