...
public struct GoodsExcel : IFlatbufferObject
{
  ...
  public Japan.ParcelType ParcelType(int j) { int o = __p.__offset(34); return o != 0 ? (Japan.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.ParcelType)0; }
  public int ParcelTypeLength { get { int o = __p.__offset(34); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.ParcelType> GetParcelTypeBytes() { return __p.__vector_as_span<Japan.ParcelType>(34, 4); }
#else
  public ArraySegment<byte>? GetParcelTypeBytes() { return __p.__vector_as_arraysegment(34); }
#endif
  public Japan.ParcelType[] GetParcelTypeArray() { int o = __p.__offset(34); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.ParcelType[] a = new Japan.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public void UnPackTo(GoodsExcelT _o) {
    ...
    for (var _j = 0; _j < this.ConsumeParcelTypeLength; ++_j) {_o.ConsumeParcelType.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ConsumeParcelType(_j), key) : this.ConsumeParcelType(_j));}
    _o.ConsumeParcelId = new List<long>();
    for (var _j = 0; _j < this.ConsumeParcelIdLength; ++_j) {_o.ConsumeParcelId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ConsumeParcelId(_j), key) : this.ConsumeParcelId(_j));}
    ...
    for (var _j = 0; _j < this.ConsumeExtraAmountLength; ++_j) {_o.ConsumeExtraAmount.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ConsumeExtraAmount(_j), key) : this.ConsumeExtraAmount(_j));}
  ...
  public static Offset<Japan.GoodsExcel> Pack(FlatBufferBuilder builder, GoodsExcelT _o) {
    ...
    if (_o.ConsumeParcelId != null) {
      var __ConsumeParcelId = _o.ConsumeParcelId.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.ConsumeParcelAmount != null) {
      var __ConsumeParcelAmount = _o.ConsumeParcelAmount.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.ConsumeExtraAmount != null) {
      var __ConsumeExtraAmount = _o.ConsumeExtraAmount.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
...
static public class GoodsExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 34 /*ParcelType*/, 4 /*Japan.ParcelType*/, false)
