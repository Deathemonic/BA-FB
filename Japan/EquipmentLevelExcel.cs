...
public struct EquipmentLevelExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.EquipmentLevelExcel> CreateEquipmentLevelExcel(FlatBufferBuilder builder,
      int Level = 0,
  ...
  public static Offset<Japan.EquipmentLevelExcel> EndEquipmentLevelExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.EquipmentLevelExcel>(o);
  }
  ...
  public static Offset<Japan.EquipmentLevelExcel> Pack(FlatBufferBuilder builder, EquipmentLevelExcelT _o) {
    if (_o == null) return default(Offset<Japan.EquipmentLevelExcel>);
		byte[] key = TableEncryptionService.CreateKey("EquipmentLevel");
