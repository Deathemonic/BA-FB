...
public struct MinigameCCGStartDeckCharacterExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.MinigameCCGStartDeckCharacterExcel> CreateMinigameCCGStartDeckCharacterExcel(FlatBufferBuilder builder,
      long CCGId = 0,
      long CharacterId = 0) {
  ...
  public static Offset<Japan.MinigameCCGStartDeckCharacterExcel> EndMinigameCCGStartDeckCharacterExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.MinigameCCGStartDeckCharacterExcel>(o);
  }
  ...
  public static Offset<Japan.MinigameCCGStartDeckCharacterExcel> Pack(FlatBufferBuilder builder, MinigameCCGStartDeckCharacterExcelT _o) {
    if (_o == null) return default(Offset<Japan.MinigameCCGStartDeckCharacterExcel>);
		byte[] key = TableEncryptionService.CreateKey("MinigameCCGStartDeckCharacter");
