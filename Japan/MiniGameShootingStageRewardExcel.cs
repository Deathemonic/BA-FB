...
public struct MiniGameShootingStageRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.MiniGameShootingStageRewardExcel> CreateMiniGameShootingStageRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
      long RewardId = 0,
      long ClearSection = 0,
  ...
  public static Offset<Japan.MiniGameShootingStageRewardExcel> EndMiniGameShootingStageRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.MiniGameShootingStageRewardExcel>(o);
  }
  ...
  public static Offset<Japan.MiniGameShootingStageRewardExcel> Pack(FlatBufferBuilder builder, MiniGameShootingStageRewardExcelT _o) {
    if (_o == null) return default(Offset<Japan.MiniGameShootingStageRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("MiniGameShootingStageReward");
