...
public struct ShopFreeRecruitPeriodExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.ShopFreeRecruitPeriodExcel> CreateShopFreeRecruitPeriodExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.ShopFreeRecruitPeriodExcel> EndShopFreeRecruitPeriodExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ShopFreeRecruitPeriodExcel>(o);
  }
  ...
  public static Offset<Japan.ShopFreeRecruitPeriodExcel> Pack(FlatBufferBuilder builder, ShopFreeRecruitPeriodExcelT _o) {
    if (_o == null) return default(Offset<Japan.ShopFreeRecruitPeriodExcel>);
		byte[] key = TableEncryptionService.CreateKey("ShopFreeRecruitPeriod");
