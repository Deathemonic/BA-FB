...
public struct TimeAttackDungeonSeasonManageExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.TimeAttackDungeonSeasonManageExcel> CreateTimeAttackDungeonSeasonManageExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Japan.TimeAttackDungeonSeasonManageExcel> EndTimeAttackDungeonSeasonManageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.TimeAttackDungeonSeasonManageExcel>(o);
  }
  ...
  public static Offset<Japan.TimeAttackDungeonSeasonManageExcel> Pack(FlatBufferBuilder builder, TimeAttackDungeonSeasonManageExcelT _o) {
    if (_o == null) return default(Offset<Japan.TimeAttackDungeonSeasonManageExcel>);
		byte[] key = TableEncryptionService.CreateKey("TimeAttackDungeonSeasonManage");
