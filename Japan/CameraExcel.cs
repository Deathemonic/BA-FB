...
public struct CameraExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.CameraExcel> CreateCameraExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
  ...
  public static Offset<Japan.CameraExcel> EndCameraExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.CameraExcel>(o);
  }
  ...
  public void UnPackTo(CameraExcelT _o) {
    ...
    _o.MinDistance = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MinDistance, key) : this.MinDistance;
    _o.MaxDistance = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MaxDistance, key) : this.MaxDistance;
    _o.RotationX = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.RotationX, key) : this.RotationX;
    _o.RotationY = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.RotationY, key) : this.RotationY;
    _o.MoveInstantly = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MoveInstantly, key) : this.MoveInstantly;
    _o.MoveInstantlyRotationSave = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MoveInstantlyRotationSave, key) : this.MoveInstantlyRotationSave;
    _o.LeftMargin = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.LeftMargin, key) : this.LeftMargin;
    _o.BottomMargin = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BottomMargin, key) : this.BottomMargin;
    _o.IgnoreEnemies = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.IgnoreEnemies, key) : this.IgnoreEnemies;
    _o.UseRailPointCompensation = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.UseRailPointCompensation, key) : this.UseRailPointCompensation;
  }
  public static Offset<Japan.CameraExcel> Pack(FlatBufferBuilder builder, CameraExcelT _o) {
    if (_o == null) return default(Offset<Japan.CameraExcel>);
		byte[] key = TableEncryptionService.CreateKey("Camera");
		var _UniqueId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.UniqueId, key) : _o.UniqueId;
		var _MinDistance = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MinDistance, key) : _o.MinDistance;
		var _MaxDistance = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MaxDistance, key) : _o.MaxDistance;
		var _RotationX = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RotationX, key) : _o.RotationX;
		var _RotationY = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RotationY, key) : _o.RotationY;
		var _MoveInstantly = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MoveInstantly, key) : _o.MoveInstantly;
		var _MoveInstantlyRotationSave = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MoveInstantlyRotationSave, key) : _o.MoveInstantlyRotationSave;
		var _LeftMargin = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.LeftMargin, key) : _o.LeftMargin;
		var _BottomMargin = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.BottomMargin, key) : _o.BottomMargin;
		var _IgnoreEnemies = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IgnoreEnemies, key) : _o.IgnoreEnemies;
		var _UseRailPointCompensation = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.UseRailPointCompensation, key) : _o.UseRailPointCompensation;
