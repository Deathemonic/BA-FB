...
public struct EventContentLocationRewardExcel : IFlatbufferObject
{
  ...
  public Japan.ParcelType ExtraRewardParcelType(int j) { int o = __p.__offset(30); return o != 0 ? (Japan.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.ParcelType)0; }
  public int ExtraRewardParcelTypeLength { get { int o = __p.__offset(30); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.ParcelType> GetExtraRewardParcelTypeBytes() { return __p.__vector_as_span<Japan.ParcelType>(30, 4); }
#else
  public ArraySegment<byte>? GetExtraRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(30); }
#endif
  public Japan.ParcelType[] GetExtraRewardParcelTypeArray() { int o = __p.__offset(30); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.ParcelType[] a = new Japan.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Japan.ParcelType RewardParcelType(int j) { int o = __p.__offset(40); return o != 0 ? (Japan.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.ParcelType)0; }
  public int RewardParcelTypeLength { get { int o = __p.__offset(40); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.ParcelType> GetRewardParcelTypeBytes() { return __p.__vector_as_span<Japan.ParcelType>(40, 4); }
#else
  public ArraySegment<byte>? GetRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(40); }
#endif
  public Japan.ParcelType[] GetRewardParcelTypeArray() { int o = __p.__offset(40); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.ParcelType[] a = new Japan.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Japan.EventContentLocationRewardExcel> CreateEventContentLocationRewardExcel(FlatBufferBuilder builder,
  ...
  public static VectorOffset CreateExtraRewardParcelTypeVector(FlatBufferBuilder builder, Japan.ParcelType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateExtraRewardParcelTypeVectorBlock(FlatBufferBuilder builder, Japan.ParcelType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateExtraRewardParcelTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Japan.ParcelType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateExtraRewardParcelTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Japan.ParcelType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Japan.EventContentLocationRewardExcel> EndEventContentLocationRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.EventContentLocationRewardExcel>(o);
  }
  ...
  public void UnPackTo(EventContentLocationRewardExcelT _o) {
    ...
    _o.ExtraRewardParcelType = new List<Japan.ParcelType>();
    for (var _j = 0; _j < this.ExtraRewardParcelTypeLength; ++_j) {_o.ExtraRewardParcelType.Add(TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)this.ExtraRewardParcelType(_j), key) : this.ExtraRewardParcelType(_j));}
  ...
  public static Offset<Japan.EventContentLocationRewardExcel> Pack(FlatBufferBuilder builder, EventContentLocationRewardExcelT _o) {
    if (_o == null) return default(Offset<Japan.EventContentLocationRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentLocationReward");
    ...
    if (_o.ExtraRewardParcelType != null) {
      var __ExtraRewardParcelType = _o.ExtraRewardParcelType.Select(x => TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)x, key) : x).ToArray();
...
public class EventContentLocationRewardExcelT
{
  ...
  public List<Japan.ParcelType> ExtraRewardParcelType { get; set; }
...
static public class EventContentLocationRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 30 /*ExtraRewardParcelType*/, 4 /*Japan.ParcelType*/, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 40 /*RewardParcelType*/, 4 /*Japan.ParcelType*/, false)
