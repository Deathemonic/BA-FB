...
public struct ConstMiniGameShootingExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.ConstMiniGameShootingExcel> CreateConstMiniGameShootingExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.ConstMiniGameShootingExcel> EndConstMiniGameShootingExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ConstMiniGameShootingExcel>(o);
  }
  ...
  public static Offset<Japan.ConstMiniGameShootingExcel> Pack(FlatBufferBuilder builder, ConstMiniGameShootingExcelT _o) {
    if (_o == null) return default(Offset<Japan.ConstMiniGameShootingExcel>);
		byte[] key = TableEncryptionService.CreateKey("ConstMiniGameShooting");
