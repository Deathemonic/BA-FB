...
public struct CharacterSkillListExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.CharacterSkillListExcel> CreateCharacterSkillListExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.CharacterSkillListExcel> EndCharacterSkillListExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.CharacterSkillListExcel>(o);
  }
  ...
  public static Offset<Japan.CharacterSkillListExcel> Pack(FlatBufferBuilder builder, CharacterSkillListExcelT _o) {
    if (_o == null) return default(Offset<Japan.CharacterSkillListExcel>);
		byte[] key = TableEncryptionService.CreateKey("CharacterSkillList");
		...
		var _MinimumGradeCharacterWeapon = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MinimumGradeCharacterWeapon, key) : _o.MinimumGradeCharacterWeapon;
		var _MinimumTierCharacterGear = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MinimumTierCharacterGear, key) : _o.MinimumTierCharacterGear;
		var _FormIndex = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.FormIndex, key) : _o.FormIndex;
		var _IsRootMotion = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IsRootMotion, key) : _o.IsRootMotion;
    ...
    if (_o.ExSkillGroupId != null) {
      ...
      for (var _j = 0; _j < __ExSkillGroupId.Length; ++_j) { __ExSkillGroupId[_j] = builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ExSkillGroupId[_j], key) : _o.ExSkillGroupId[_j])); }
    ...
    if (_o.ExSkillCutInTimeLineIndex != null) {
      ...
      for (var _j = 0; _j < __ExSkillCutInTimeLineIndex.Length; ++_j) { __ExSkillCutInTimeLineIndex[_j] = builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ExSkillCutInTimeLineIndex[_j], key) : _o.ExSkillCutInTimeLineIndex[_j])); }
    ...
    if (_o.ExSkillLevelTimeLineIndex != null) {
      ...
      for (var _j = 0; _j < __ExSkillLevelTimeLineIndex.Length; ++_j) { __ExSkillLevelTimeLineIndex[_j] = builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ExSkillLevelTimeLineIndex[_j], key) : _o.ExSkillLevelTimeLineIndex[_j])); }
