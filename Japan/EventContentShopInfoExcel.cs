...
public struct EventContentShopInfoExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.EventContentShopInfoExcel> Pack(FlatBufferBuilder builder, EventContentShopInfoExcelT _o) {
    ...
    var _ShopProductUpdateDate = _o.ShopProductUpdateDate == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ShopProductUpdateDate, key) : _o.ShopProductUpdateDate));
