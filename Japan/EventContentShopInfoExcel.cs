...
public struct EventContentShopInfoExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.EventContentShopInfoExcel> CreateEventContentShopInfoExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.EventContentShopInfoExcel> EndEventContentShopInfoExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.EventContentShopInfoExcel>(o);
  }
  ...
  public static Offset<Japan.EventContentShopInfoExcel> Pack(FlatBufferBuilder builder, EventContentShopInfoExcelT _o) {
    if (_o == null) return default(Offset<Japan.EventContentShopInfoExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentShopInfo");
    ...
    var _ShopProductUpdateDate = _o.ShopProductUpdateDate == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.ShopProductUpdateDate, key) : _o.ShopProductUpdateDate));
