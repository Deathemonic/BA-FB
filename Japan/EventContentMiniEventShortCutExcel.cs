...
public struct EventContentMiniEventShortCutExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(EventContentMiniEventShortCutExcelT _o) {
    ...
    _o.ShorcutContentType = TableEncryptionService.UseEncryption ? (Japan.EventTargetType)TableEncryptionService.Convert((int)this.ShorcutContentType, key) : this.ShorcutContentType;
  ...
  public static Offset<Japan.EventContentMiniEventShortCutExcel> Pack(FlatBufferBuilder builder, EventContentMiniEventShortCutExcelT _o) {
    if (_o == null) return default(Offset<Japan.EventContentMiniEventShortCutExcel>);
		...
		var _ShorcutContentType = TableEncryptionService.UseEncryption ? (Japan.EventTargetType)TableEncryptionService.Convert((int)_o.ShorcutContentType, key) : _o.ShorcutContentType;
