...
public struct EventContentMiniEventShortCutExcel : IFlatbufferObject
{
  ...
  public Japan.EventTargetType ShorcutContentType { get { int o = __p.__offset(8); return o != 0 ? (Japan.EventTargetType)__p.bb.GetInt(o + __p.bb_pos) : Japan.EventTargetType.WeekDungeon; } }
  ...
  public static Offset<Japan.EventContentMiniEventShortCutExcel> CreateEventContentMiniEventShortCutExcel(FlatBufferBuilder builder,
      int Id = 0,
      uint LocalizeEtcId = 0,
      Japan.EventTargetType ShorcutContentType = Japan.EventTargetType.WeekDungeon,
  ...
  public static void AddShorcutContentType(FlatBufferBuilder builder, Japan.EventTargetType shorcutContentType) { builder.AddInt(2, (int)shorcutContentType, 0); }
  ...
  public static Offset<Japan.EventContentMiniEventShortCutExcel> EndEventContentMiniEventShortCutExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.EventContentMiniEventShortCutExcel>(o);
  }
  ...
  public static Offset<Japan.EventContentMiniEventShortCutExcel> Pack(FlatBufferBuilder builder, EventContentMiniEventShortCutExcelT _o) {
    if (_o == null) return default(Offset<Japan.EventContentMiniEventShortCutExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentMiniEventShortCut");
    ...
    var _ShortcutUI = _o.ShortcutUI == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ShortcutUI, key) : _o.ShortcutUI));
...
public class EventContentMiniEventShortCutExcelT
{
  ...
  public Japan.EventTargetType ShorcutContentType { get; set; }
  public string ShortcutUI { get; set; }

  public EventContentMiniEventShortCutExcelT() {
    this.Id = 0;
    this.LocalizeEtcId = 0;
    this.ShorcutContentType = Japan.EventTargetType.WeekDungeon;
...
static public class EventContentMiniEventShortCutExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*ShorcutContentType*/, 4 /*Japan.EventTargetType*/, 4, false)
