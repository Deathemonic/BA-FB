...
public struct MinigameDreamVoiceExcel : IFlatbufferObject
{
  ...
  public Japan.DreamMakerVoiceCondition VoiceCondition { get { int o = __p.__offset(8); return o != 0 ? (Japan.DreamMakerVoiceCondition)__p.bb.GetInt(o + __p.bb_pos) : Japan.DreamMakerVoiceCondition.None; } }
  public uint VoiceClip { get { int o = __p.__offset(10); return o != 0 ? __p.bb.GetUint(o + __p.bb_pos) : (uint)0; } }

  public static Offset<Japan.MinigameDreamVoiceExcel> CreateMinigameDreamVoiceExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      long UniqueId = 0,
      Japan.DreamMakerVoiceCondition VoiceCondition = Japan.DreamMakerVoiceCondition.None,
      uint VoiceClip = 0) {
  ...
  public static void AddVoiceCondition(FlatBufferBuilder builder, Japan.DreamMakerVoiceCondition voiceCondition) { builder.AddInt(2, (int)voiceCondition, 0); }
  public static void AddVoiceClip(FlatBufferBuilder builder, uint voiceClip) { builder.AddUint(3, voiceClip, 0); }
  public static Offset<Japan.MinigameDreamVoiceExcel> EndMinigameDreamVoiceExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.MinigameDreamVoiceExcel>(o);
  }
  ...
  public void UnPackTo(MinigameDreamVoiceExcelT _o) {
    ...
    _o.VoiceCondition = TableEncryptionService.UseEncryption ? (Japan.DreamMakerVoiceCondition)TableEncryptionService.Convert((int)this.VoiceCondition, key) : this.VoiceCondition;
    _o.VoiceClip = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)this.VoiceClip, key) : this.VoiceClip;
  }
  public static Offset<Japan.MinigameDreamVoiceExcel> Pack(FlatBufferBuilder builder, MinigameDreamVoiceExcelT _o) {
    if (_o == null) return default(Offset<Japan.MinigameDreamVoiceExcel>);
		byte[] key = TableEncryptionService.CreateKey("MinigameDreamVoice");
		...
		var _VoiceCondition = TableEncryptionService.UseEncryption ? (Japan.DreamMakerVoiceCondition)TableEncryptionService.Convert((int)_o.VoiceCondition, key) : _o.VoiceCondition;
...
public class MinigameDreamVoiceExcelT
{
  ...
  public Japan.DreamMakerVoiceCondition VoiceCondition { get; set; }
  public uint VoiceClip { get; set; }

  public MinigameDreamVoiceExcelT() {
    this.EventContentId = 0;
    this.UniqueId = 0;
    this.VoiceCondition = Japan.DreamMakerVoiceCondition.None;
    this.VoiceClip = 0;
  }
}
...
static public class MinigameDreamVoiceExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*VoiceCondition*/, 4 /*Japan.DreamMakerVoiceCondition*/, 4, false)
