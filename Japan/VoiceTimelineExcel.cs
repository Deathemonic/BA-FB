...
public struct VoiceTimelineExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.VoiceTimelineExcel> CreateVoiceTimelineExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      uint Id = 0,
  ...
  public static Offset<Japan.VoiceTimelineExcel> EndVoiceTimelineExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.VoiceTimelineExcel>(o);
  }
  ...
  public static Offset<Japan.VoiceTimelineExcel> Pack(FlatBufferBuilder builder, VoiceTimelineExcelT _o) {
    if (_o == null) return default(Offset<Japan.VoiceTimelineExcel>);
		byte[] key = TableEncryptionService.CreateKey("VoiceTimeline");
