...
public struct EventContentDiceRaceEffectExcel : IFlatbufferObject
{
  ...
  public Japan.EventContentDiceRaceResultType EventContentDiceRaceResultType { get { int o = __p.__offset(6); return o != 0 ? (Japan.EventContentDiceRaceResultType)__p.bb.GetInt(o + __p.bb_pos) : Japan.EventContentDiceRaceResultType.DiceResult1; } }
  ...
  public static Offset<Japan.EventContentDiceRaceEffectExcel> CreateEventContentDiceRaceEffectExcel(FlatBufferBuilder builder,
  ...
  public static void AddEventContentDiceRaceResultType(FlatBufferBuilder builder, Japan.EventContentDiceRaceResultType eventContentDiceRaceResultType) { builder.AddInt(1, (int)eventContentDiceRaceResultType, 0); }
  ...
  public static Offset<Japan.EventContentDiceRaceEffectExcel> EndEventContentDiceRaceEffectExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.EventContentDiceRaceEffectExcel>(o);
  }
  ...
  public void UnPackTo(EventContentDiceRaceEffectExcelT _o) {
    ...
    _o.EventContentDiceRaceResultType = TableEncryptionService.UseEncryption ? (Japan.EventContentDiceRaceResultType)TableEncryptionService.Convert((int)this.EventContentDiceRaceResultType, key) : this.EventContentDiceRaceResultType;
    _o.IsDiceResult = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.IsDiceResult, key) : this.IsDiceResult;
  ...
  public static Offset<Japan.EventContentDiceRaceEffectExcel> Pack(FlatBufferBuilder builder, EventContentDiceRaceEffectExcelT _o) {
    if (_o == null) return default(Offset<Japan.EventContentDiceRaceEffectExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentDiceRaceEffect");
		...
		var _EventContentDiceRaceResultType = TableEncryptionService.UseEncryption ? (Japan.EventContentDiceRaceResultType)TableEncryptionService.Convert((int)_o.EventContentDiceRaceResultType, key) : _o.EventContentDiceRaceResultType;
		var _isDiceResult = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.IsDiceResult, key) : _o.IsDiceResult;
    var _AniClip = _o.AniClip == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.AniClip, key) : _o.AniClip));
...
public class EventContentDiceRaceEffectExcelT
{
  ...
  public Japan.EventContentDiceRaceResultType EventContentDiceRaceResultType { get; set; }
  ...
  public EventContentDiceRaceEffectExcelT() {
    ...
    this.EventContentDiceRaceResultType = Japan.EventContentDiceRaceResultType.DiceResult1;
...
static public class EventContentDiceRaceEffectExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*EventContentDiceRaceResultType*/, 4 /*Japan.EventContentDiceRaceResultType*/, 4, false)
