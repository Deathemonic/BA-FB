...
public struct ConstMinigameRoadPuzzleExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.ConstMinigameRoadPuzzleExcel> CreateConstMinigameRoadPuzzleExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.ConstMinigameRoadPuzzleExcel> EndConstMinigameRoadPuzzleExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ConstMinigameRoadPuzzleExcel>(o);
  }
  ...
  public static Offset<Japan.ConstMinigameRoadPuzzleExcel> Pack(FlatBufferBuilder builder, ConstMinigameRoadPuzzleExcelT _o) {
    if (_o == null) return default(Offset<Japan.ConstMinigameRoadPuzzleExcel>);
		byte[] key = TableEncryptionService.CreateKey("ConstMinigameRoadPuzzle");
		var _RoadPuzzleMapBoundaryOffsetLeft = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RoadPuzzleMapBoundaryOffsetLeft, key) : _o.RoadPuzzleMapBoundaryOffsetLeft;
		var _RoadPuzzleMapBoundaryOffsetRight = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RoadPuzzleMapBoundaryOffsetRight, key) : _o.RoadPuzzleMapBoundaryOffsetRight;
		var _RoadPuzzleMapBoundaryOffsetTop = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RoadPuzzleMapBoundaryOffsetTop, key) : _o.RoadPuzzleMapBoundaryOffsetTop;
		var _RoadPuzzleMapBoundaryOffsetBottom = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RoadPuzzleMapBoundaryOffsetBottom, key) : _o.RoadPuzzleMapBoundaryOffsetBottom;
		var _RoadPuzzleMapCenterOffsetX = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RoadPuzzleMapCenterOffsetX, key) : _o.RoadPuzzleMapCenterOffsetX;
		var _RoadPuzzleMapCenterOffsetY = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RoadPuzzleMapCenterOffsetY, key) : _o.RoadPuzzleMapCenterOffsetY;
		...
		var _StageLoadingProgressTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StageLoadingProgressTime, key) : _o.StageLoadingProgressTime;
		var _TileRotationDegree = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.TileRotationDegree, key) : _o.TileRotationDegree;
		var _StartStageIndex = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StartStageIndex, key) : _o.StartStageIndex;
		var _LoopStageIndex = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.LoopStageIndex, key) : _o.LoopStageIndex;
