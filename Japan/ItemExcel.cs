...
public struct ItemExcel : IFlatbufferObject
{
  ...
  public Japan.ItemCategory ItemCategory { get { int o = __p.__offset(14); return o != 0 ? (Japan.ItemCategory)__p.bb.GetInt(o + __p.bb_pos) : Japan.ItemCategory.Coin; } }
  ...
  public Japan.ParcelType UsingResultParcelType { get { int o = __p.__offset(28); return o != 0 ? (Japan.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Japan.ParcelType.None; } }
  ...
  public Japan.ParcelType ExpiryChangeParcelType { get { int o = __p.__offset(36); return o != 0 ? (Japan.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Japan.ParcelType.None; } }
  ...
  public Japan.Tag Tags(int j) { int o = __p.__offset(46); return o != 0 ? (Japan.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.Tag)0; }
  public int TagsLength { get { int o = __p.__offset(46); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.Tag> GetTagsBytes() { return __p.__vector_as_span<Japan.Tag>(46, 4); }
#else
  public ArraySegment<byte>? GetTagsBytes() { return __p.__vector_as_arraysegment(46); }
#endif
  public Japan.Tag[] GetTagsArray() { int o = __p.__offset(46); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.Tag[] a = new Japan.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.Tag)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Japan.ShopCategoryType ShopCategory(int j) { int o = __p.__offset(58); return o != 0 ? (Japan.ShopCategoryType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.ShopCategoryType)0; }
  public int ShopCategoryLength { get { int o = __p.__offset(58); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.ShopCategoryType> GetShopCategoryBytes() { return __p.__vector_as_span<Japan.ShopCategoryType>(58, 4); }
#else
  public ArraySegment<byte>? GetShopCategoryBytes() { return __p.__vector_as_arraysegment(58); }
#endif
  public Japan.ShopCategoryType[] GetShopCategoryArray() { int o = __p.__offset(58); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.ShopCategoryType[] a = new Japan.ShopCategoryType[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.ShopCategoryType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Japan.GachaTicketType GachaTicket { get { int o = __p.__offset(66); return o != 0 ? (Japan.GachaTicketType)__p.bb.GetInt(o + __p.bb_pos) : Japan.GachaTicketType.None; } }

  public static Offset<Japan.ItemExcel> CreateItemExcel(FlatBufferBuilder builder,
      long Id = 0,
      long GroupId = 0,
      ...
      Japan.ParcelType UsingResultParcelType = Japan.ParcelType.None,
      ...
      Japan.GachaTicketType GachaTicket = Japan.GachaTicketType.None) {
  ...
  public static void AddItemCategory(FlatBufferBuilder builder, Japan.ItemCategory itemCategory) { builder.AddInt(5, (int)itemCategory, 0); }
  ...
  public static void AddUsingResultParcelType(FlatBufferBuilder builder, Japan.ParcelType usingResultParcelType) { builder.AddInt(12, (int)usingResultParcelType, 0); }
  ...
  public static void AddExpiryChangeParcelType(FlatBufferBuilder builder, Japan.ParcelType expiryChangeParcelType) { builder.AddInt(16, (int)expiryChangeParcelType, 0); }
  ...
  public static VectorOffset CreateShopCategoryVector(FlatBufferBuilder builder, Japan.ShopCategoryType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateShopCategoryVectorBlock(FlatBufferBuilder builder, Japan.ShopCategoryType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateShopCategoryVectorBlock(FlatBufferBuilder builder, ArraySegment<Japan.ShopCategoryType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateShopCategoryVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Japan.ShopCategoryType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static void AddGachaTicket(FlatBufferBuilder builder, Japan.GachaTicketType gachaTicket) { builder.AddInt(31, (int)gachaTicket, 0); }
  public static Offset<Japan.ItemExcel> EndItemExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ItemExcel>(o);
  }
  ...
  public void UnPackTo(ItemExcelT _o) {
    ...
    _o.Quality = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Quality, key) : this.Quality;
    ...
    _o.StackableFunction = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StackableFunction, key) : this.StackableFunction;
    _o.ImmediateUse = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ImmediateUse, key) : this.ImmediateUse;
    _o.UsingResultParcelType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.UsingResultParcelType, key) : this.UsingResultParcelType;
    _o.UsingResultId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.UsingResultId, key) : this.UsingResultId;
    _o.UsingResultAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.UsingResultAmount, key) : this.UsingResultAmount;
    ...
    _o.CanTierUpgrade = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CanTierUpgrade, key) : this.CanTierUpgrade;
    ...
    _o.MaxGiftTags = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MaxGiftTags, key) : this.MaxGiftTags;
    _o.ShopCategory = new List<Japan.ShopCategoryType>();
  ...
  public static Offset<Japan.ItemExcel> Pack(FlatBufferBuilder builder, ItemExcelT _o) {
    if (_o == null) return default(Offset<Japan.ItemExcel>);
		byte[] key = TableEncryptionService.CreateKey("Item");
		...
		var _Quality = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Quality, key) : _o.Quality;
    ...
    var _SpriteName = _o.SpriteName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.SpriteName, key) : _o.SpriteName));
		...
		var _StackableFunction = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StackableFunction, key) : _o.StackableFunction;
		var _ImmediateUse = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ImmediateUse, key) : _o.ImmediateUse;
		var _UsingResultParcelType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.UsingResultParcelType, key) : _o.UsingResultParcelType;
		var _UsingResultId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.UsingResultId, key) : _o.UsingResultId;
		var _UsingResultAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.UsingResultAmount, key) : _o.UsingResultAmount;
    ...
    if (_o.Tags != null) {
      ...
      _Tags = CreateTagsVector(builder, __Tags);
		...
		var _MaxGiftTags = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MaxGiftTags, key) : _o.MaxGiftTags;
    ...
    var _ExpirationDateTime = _o.ExpirationDateTime == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ExpirationDateTime, key) : _o.ExpirationDateTime));
		...
		var _GachaTicket = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.GachaTicket, key) : _o.GachaTicket;
...
public class ItemExcelT
{
  ...
  public Japan.ParcelType UsingResultParcelType { get; set; }
  ...
  public List<Japan.ShopCategoryType> ShopCategory { get; set; }
  public string ExpirationDateTime { get; set; }
  public int ExpirationNotifyDateIn { get; set; }
  public long ShortcutTypeId { get; set; }
  public Japan.GachaTicketType GachaTicket { get; set; }
  ...
  public ItemExcelT() {
    ...
    this.UsingResultParcelType = Japan.ParcelType.None;
    ...
    this.GachaTicket = Japan.GachaTicketType.None;
  }
}
...
static public class ItemExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 14 /*ItemCategory*/, 4 /*Japan.ItemCategory*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 28 /*UsingResultParcelType*/, 4 /*Japan.ParcelType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 36 /*ExpiryChangeParcelType*/, 4 /*Japan.ParcelType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 46 /*Tags*/, 4 /*Japan.Tag*/, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 58 /*ShopCategory*/, 4 /*Japan.ShopCategoryType*/, false)
      ...
      && verifier.VerifyField(tablePos, 66 /*GachaTicket*/, 4 /*Japan.GachaTicketType*/, 4, false)
