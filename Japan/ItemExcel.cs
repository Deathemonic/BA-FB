...
public struct ItemExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ItemExcelT _o) {
    ...
    _o.ItemCategory = TableEncryptionService.UseEncryption ? (Japan.ItemCategory)TableEncryptionService.Convert((int)this.ItemCategory, key) : this.ItemCategory;
    ...
    _o.UsingResultParcelType = TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)this.UsingResultParcelType, key) : this.UsingResultParcelType;
    ...
    for (var _j = 0; _j < this.ShopCategoryLength; ++_j) {_o.ShopCategory.Add(TableEncryptionService.UseEncryption ? (Japan.ShopCategoryType)TableEncryptionService.Convert((int)this.ShopCategory(_j), key) : this.ShopCategory(_j));}
    ...
    _o.GachaTicket = TableEncryptionService.UseEncryption ? (Japan.GachaTicketType)TableEncryptionService.Convert((int)this.GachaTicket, key) : this.GachaTicket;
  }
  public static Offset<Japan.ItemExcel> Pack(FlatBufferBuilder builder, ItemExcelT _o) {
    if (_o == null) return default(Offset<Japan.ItemExcel>);
		...
		var _ItemCategory = TableEncryptionService.UseEncryption ? (Japan.ItemCategory)TableEncryptionService.Convert((int)_o.ItemCategory, key) : _o.ItemCategory;
    ...
    var _SpriteName = _o.SpriteName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.SpriteName, key) : _o.SpriteName));
		...
		var _UsingResultParcelType = TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)_o.UsingResultParcelType, key) : _o.UsingResultParcelType;
    ...
    if (_o.ShopCategory != null) {
      var __ShopCategory = _o.ShopCategory.Select(x => TableEncryptionService.UseEncryption ? (Japan.ShopCategoryType)TableEncryptionService.Convert((int)x, key) : x).ToArray();
    ...
    var _ExpirationDateTime = _o.ExpirationDateTime == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.ExpirationDateTime, key) : _o.ExpirationDateTime));
		...
		var _GachaTicket = TableEncryptionService.UseEncryption ? (Japan.GachaTicketType)TableEncryptionService.Convert((int)_o.GachaTicket, key) : _o.GachaTicket;
