...
public struct WeekDungeonExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(WeekDungeonExcelT _o) {
    ...
    for (var _j = 0; _j < this.StageEnterCostTypeLength; ++_j) {_o.StageEnterCostType.Add(TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)this.StageEnterCostType(_j), key) : this.StageEnterCostType(_j));}
  ...
  public static Offset<Japan.WeekDungeonExcel> Pack(FlatBufferBuilder builder, WeekDungeonExcelT _o) {
    ...
    if (_o.StageEnterCostType != null) {
      var __StageEnterCostType = _o.StageEnterCostType.Select(x => TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)x, key) : x).ToArray();
