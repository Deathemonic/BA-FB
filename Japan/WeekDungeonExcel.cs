...
public struct WeekDungeonExcel : IFlatbufferObject
{
  ...
  public Japan.WeekDungeonType WeekDungeonType { get { int o = __p.__offset(6); return o != 0 ? (Japan.WeekDungeonType)__p.bb.GetInt(o + __p.bb_pos) : Japan.WeekDungeonType.None; } }
  ...
  public Japan.ParcelType StageEnterCostType(int j) { int o = __p.__offset(14); return o != 0 ? (Japan.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.ParcelType)0; }
  public int StageEnterCostTypeLength { get { int o = __p.__offset(14); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.ParcelType> GetStageEnterCostTypeBytes() { return __p.__vector_as_span<Japan.ParcelType>(14, 4); }
#else
  public ArraySegment<byte>? GetStageEnterCostTypeBytes() { return __p.__vector_as_arraysegment(14); }
#endif
  public Japan.ParcelType[] GetStageEnterCostTypeArray() { int o = __p.__offset(14); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.ParcelType[] a = new Japan.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Japan.StarGoalType StarGoal(int j) { int o = __p.__offset(22); return o != 0 ? (Japan.StarGoalType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.StarGoalType)0; }
  public int StarGoalLength { get { int o = __p.__offset(22); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.StarGoalType> GetStarGoalBytes() { return __p.__vector_as_span<Japan.StarGoalType>(22, 4); }
#else
  public ArraySegment<byte>? GetStarGoalBytes() { return __p.__vector_as_arraysegment(22); }
#endif
  public Japan.StarGoalType[] GetStarGoalArray() { int o = __p.__offset(22); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.StarGoalType[] a = new Japan.StarGoalType[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.StarGoalType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Japan.StageTopography StageTopography { get { int o = __p.__offset(26); return o != 0 ? (Japan.StageTopography)__p.bb.GetInt(o + __p.bb_pos) : Japan.StageTopography.Street; } }
  ...
  public Japan.EchelonExtensionType EchelonExtensionType { get { int o = __p.__offset(40); return o != 0 ? (Japan.EchelonExtensionType)__p.bb.GetInt(o + __p.bb_pos) : Japan.EchelonExtensionType.Base; } }

  public static Offset<Japan.WeekDungeonExcel> CreateWeekDungeonExcel(FlatBufferBuilder builder,
      long StageId = 0,
  ...
  public static void AddWeekDungeonType(FlatBufferBuilder builder, Japan.WeekDungeonType weekDungeonType) { builder.AddInt(1, (int)weekDungeonType, 0); }
  ...
  public static VectorOffset CreateStageEnterCostTypeVector(FlatBufferBuilder builder, Japan.ParcelType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateStageEnterCostTypeVectorBlock(FlatBufferBuilder builder, Japan.ParcelType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateStageEnterCostTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Japan.ParcelType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateStageEnterCostTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Japan.ParcelType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static void AddStageTopography(FlatBufferBuilder builder, Japan.StageTopography stageTopography) { builder.AddInt(11, (int)stageTopography, 0); }
  ...
  public static void AddEchelonExtensionType(FlatBufferBuilder builder, Japan.EchelonExtensionType echelonExtensionType) { builder.AddInt(18, (int)echelonExtensionType, 0); }
  public static Offset<Japan.WeekDungeonExcel> EndWeekDungeonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.WeekDungeonExcel>(o);
  }
  ...
  public void UnPackTo(WeekDungeonExcelT _o) {
    ...
    _o.StageEnterCostType = new List<Japan.ParcelType>();
  ...
  public static Offset<Japan.WeekDungeonExcel> Pack(FlatBufferBuilder builder, WeekDungeonExcelT _o) {
    if (_o == null) return default(Offset<Japan.WeekDungeonExcel>);
		byte[] key = TableEncryptionService.CreateKey("WeekDungeon");
...
public class WeekDungeonExcelT
{
  ...
  public List<Japan.ParcelType> StageEnterCostType { get; set; }
...
static public class WeekDungeonExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*WeekDungeonType*/, 4 /*Japan.WeekDungeonType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 14 /*StageEnterCostType*/, 4 /*Japan.ParcelType*/, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 22 /*StarGoal*/, 4 /*Japan.StarGoalType*/, false)
      && verifier.VerifyVectorOfData(tablePos, 24 /*StarGoalAmount*/, 4 /*int*/, false)
      && verifier.VerifyField(tablePos, 26 /*StageTopography*/, 4 /*Japan.StageTopography*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 40 /*EchelonExtensionType*/, 4 /*Japan.EchelonExtensionType*/, 4, false)
