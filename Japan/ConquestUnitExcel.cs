...
public struct ConquestUnitExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ConquestUnitExcelT _o) {
    ...
    _o.Scale = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)this.Scale, key) : this.Scale;
    _o.ShieldEffectScale = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)this.ShieldEffectScale, key) : this.ShieldEffectScale;
    ...
    _o.EnemyType = TableEncryptionService.UseEncryption ? (Japan.ConquestEnemyType)TableEncryptionService.Convert((int)this.EnemyType, key) : this.EnemyType;
    _o.Team = TableEncryptionService.UseEncryption ? (Japan.ConquestTeamType)TableEncryptionService.Convert((int)this.Team, key) : this.Team;
    _o.UnitGroup = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.UnitGroup, key) : this.UnitGroup;
    _o.PrevUnitGroup = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.PrevUnitGroup, key) : this.PrevUnitGroup;
    ...
    _o.GroupBuffId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.GroupBuffId, key) : this.GroupBuffId;
    ...
    _o.ManageEchelonStageEnterCostType = TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)this.ManageEchelonStageEnterCostType, key) : this.ManageEchelonStageEnterCostType;
    _o.ManageEchelonStageEnterCostId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ManageEchelonStageEnterCostId, key) : this.ManageEchelonStageEnterCostId;
    _o.ManageEchelonStageEnterCostAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.ManageEchelonStageEnterCostAmount, key) : this.ManageEchelonStageEnterCostAmount;
    ...
    _o.ClearScenarioGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ClearScenarioGroupId, key) : this.ClearScenarioGroupId;
  ...
  public static Offset<Japan.ConquestUnitExcel> Pack(FlatBufferBuilder builder, ConquestUnitExcelT _o) {
    ...
    var _StrategyPrefabName = _o.StrategyPrefabName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.StrategyPrefabName, key) : _o.StrategyPrefabName));
		var _Scale = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)_o.Scale, key) : _o.Scale;
		var _ShieldEffectScale = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((float)_o.ShieldEffectScale, key) : _o.ShieldEffectScale;
    var _UnitFxPrefabName = _o.UnitFxPrefabName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.UnitFxPrefabName, key) : _o.UnitFxPrefabName));
    var _PointAnimation = _o.PointAnimation == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.PointAnimation, key) : _o.PointAnimation));
		var _EnemyType = TableEncryptionService.UseEncryption ? (Japan.ConquestEnemyType)TableEncryptionService.Convert((int)_o.EnemyType, key) : _o.EnemyType;
		var _Team = TableEncryptionService.UseEncryption ? (Japan.ConquestTeamType)TableEncryptionService.Convert((int)_o.Team, key) : _o.Team;
		var _UnitGroup = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.UnitGroup, key) : _o.UnitGroup;
		var _PrevUnitGroup = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.PrevUnitGroup, key) : _o.PrevUnitGroup;
    ...
    if (_o.StarGoalAmount != null) {
      ...
      _StarGoalAmount = CreateStarGoalAmountVector(builder, __StarGoalAmount);
		...
		var _GroupBuffId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.GroupBuffId, key) : _o.GroupBuffId;
		...
		var _ManageEchelonStageEnterCostType = TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)_o.ManageEchelonStageEnterCostType, key) : _o.ManageEchelonStageEnterCostType;
		var _ManageEchelonStageEnterCostId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ManageEchelonStageEnterCostId, key) : _o.ManageEchelonStageEnterCostId;
		var _ManageEchelonStageEnterCostAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.ManageEchelonStageEnterCostAmount, key) : _o.ManageEchelonStageEnterCostAmount;
		...
		var _ClearScenarioGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ClearScenarioGroupId, key) : _o.ClearScenarioGroupId;
