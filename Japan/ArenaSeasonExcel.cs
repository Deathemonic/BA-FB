...
public struct ArenaSeasonExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.ArenaSeasonExcel> CreateArenaSeasonExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
  ...
  public static Offset<Japan.ArenaSeasonExcel> EndArenaSeasonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ArenaSeasonExcel>(o);
  }
  ...
  public void UnPackTo(ArenaSeasonExcelT _o) {
    ...
    _o.SeasonGroupLimit = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.SeasonGroupLimit, key) : this.SeasonGroupLimit;
    _o.PrevSeasonId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.PrevSeasonId, key) : this.PrevSeasonId;
  ...
  public static Offset<Japan.ArenaSeasonExcel> Pack(FlatBufferBuilder builder, ArenaSeasonExcelT _o) {
    if (_o == null) return default(Offset<Japan.ArenaSeasonExcel>);
		byte[] key = TableEncryptionService.CreateKey("ArenaSeason");
    ...
    var _SeasonEndDate = _o.SeasonEndDate == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.SeasonEndDate, key) : _o.SeasonEndDate));
		var _SeasonGroupLimit = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.SeasonGroupLimit, key) : _o.SeasonGroupLimit;
		var _PrevSeasonId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.PrevSeasonId, key) : _o.PrevSeasonId;
    ...
    return CreateArenaSeasonExcel(
      ...
      _SeasonStartDate,
      _SeasonEndDate,
      TableEncryptionService.UseEncryption ? _SeasonGroupLimit : _o.SeasonGroupLimit,
      TableEncryptionService.UseEncryption ? _PrevSeasonId : _o.PrevSeasonId,
