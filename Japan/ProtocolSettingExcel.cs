...
public struct ProtocolSettingExcel : IFlatbufferObject
{
  ...
  public Japan.OpenConditionContent OpenConditionContent { get { int o = __p.__offset(6); return o != 0 ? (Japan.OpenConditionContent)__p.bb.GetInt(o + __p.bb_pos) : Japan.OpenConditionContent.Shop; } }
  ...
  public static Offset<Japan.ProtocolSettingExcel> CreateProtocolSettingExcel(FlatBufferBuilder builder,
  ...
  public static void AddOpenConditionContent(FlatBufferBuilder builder, Japan.OpenConditionContent openConditionContent) { builder.AddInt(1, (int)openConditionContent, 0); }
  ...
  public static Offset<Japan.ProtocolSettingExcel> EndProtocolSettingExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ProtocolSettingExcel>(o);
  }
  ...
  public static Offset<Japan.ProtocolSettingExcel> Pack(FlatBufferBuilder builder, ProtocolSettingExcelT _o) {
    if (_o == null) return default(Offset<Japan.ProtocolSettingExcel>);
		byte[] key = TableEncryptionService.CreateKey("ProtocolSetting");
...
static public class ProtocolSettingExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*OpenConditionContent*/, 4 /*Japan.OpenConditionContent*/, 4, false)
