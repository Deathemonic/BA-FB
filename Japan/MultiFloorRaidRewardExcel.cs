...
public struct MultiFloorRaidRewardExcel : IFlatbufferObject
{
  ...
  public Japan.ParcelType ClearStageRewardParcelType { get { int o = __p.__offset(8); return o != 0 ? (Japan.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Japan.ParcelType.None; } }
  ...
  public static Offset<Japan.MultiFloorRaidRewardExcel> CreateMultiFloorRaidRewardExcel(FlatBufferBuilder builder,
  ...
  public static void AddClearStageRewardParcelType(FlatBufferBuilder builder, Japan.ParcelType clearStageRewardParcelType) { builder.AddInt(2, (int)clearStageRewardParcelType, 0); }
  ...
  public static Offset<Japan.MultiFloorRaidRewardExcel> EndMultiFloorRaidRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.MultiFloorRaidRewardExcel>(o);
  }
  ...
  public static Offset<Japan.MultiFloorRaidRewardExcel> Pack(FlatBufferBuilder builder, MultiFloorRaidRewardExcelT _o) {
    if (_o == null) return default(Offset<Japan.MultiFloorRaidRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("MultiFloorRaidReward");
...
static public class MultiFloorRaidRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*ClearStageRewardParcelType*/, 4 /*Japan.ParcelType*/, 4, false)
