...
public struct EventContentMeetupExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(EventContentMeetupExcelT _o) {
    ...
    _o.ConditionScenarioGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ConditionScenarioGroupId, key) : this.ConditionScenarioGroupId;
    ...
    for (var _j = 0; _j < this.ConditionParameterLength; ++_j) {_o.ConditionParameter.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ConditionParameter(_j), key) : this.ConditionParameter(_j));}
    _o.ConditionPrintType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ConditionPrintType, key) : this.ConditionPrintType;
  }
