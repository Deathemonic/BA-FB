...
public struct EventContentMeetupExcel : IFlatbufferObject
{
  ...
  public Japan.MeetupConditionType ConditionType { get { int o = __p.__offset(12); return o != 0 ? (Japan.MeetupConditionType)__p.bb.GetInt(o + __p.bb_pos) : Japan.MeetupConditionType.None; } }
  ...
  public Japan.MeetupConditionPrintType ConditionPrintType { get { int o = __p.__offset(16); return o != 0 ? (Japan.MeetupConditionPrintType)__p.bb.GetInt(o + __p.bb_pos) : Japan.MeetupConditionPrintType.None; } }

  public static Offset<Japan.EventContentMeetupExcel> CreateEventContentMeetupExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddConditionType(FlatBufferBuilder builder, Japan.MeetupConditionType conditionType) { builder.AddInt(4, (int)conditionType, 0); }
  ...
  public static void AddConditionPrintType(FlatBufferBuilder builder, Japan.MeetupConditionPrintType conditionPrintType) { builder.AddInt(6, (int)conditionPrintType, 0); }
  public static Offset<Japan.EventContentMeetupExcel> EndEventContentMeetupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.EventContentMeetupExcel>(o);
  }
  ...
  public void UnPackTo(EventContentMeetupExcelT _o) {
    ...
    _o.ConditionType = TableEncryptionService.UseEncryption ? (Japan.MeetupConditionType)TableEncryptionService.Convert((int)this.ConditionType, key) : this.ConditionType;
    ...
    _o.ConditionPrintType = TableEncryptionService.UseEncryption ? (Japan.MeetupConditionPrintType)TableEncryptionService.Convert((int)this.ConditionPrintType, key) : this.ConditionPrintType;
  }
  public static Offset<Japan.EventContentMeetupExcel> Pack(FlatBufferBuilder builder, EventContentMeetupExcelT _o) {
    if (_o == null) return default(Offset<Japan.EventContentMeetupExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentMeetup");
		...
		var _ConditionType = TableEncryptionService.UseEncryption ? (Japan.MeetupConditionType)TableEncryptionService.Convert((int)_o.ConditionType, key) : _o.ConditionType;
    ...
    if (_o.ConditionParameter != null) {
      ...
      _ConditionParameter = CreateConditionParameterVector(builder, __ConditionParameter);
		...
		var _ConditionPrintType = TableEncryptionService.UseEncryption ? (Japan.MeetupConditionPrintType)TableEncryptionService.Convert((int)_o.ConditionPrintType, key) : _o.ConditionPrintType;
...
public class EventContentMeetupExcelT
{
  ...
  public Japan.MeetupConditionType ConditionType { get; set; }
  public List<long> ConditionParameter { get; set; }
  public Japan.MeetupConditionPrintType ConditionPrintType { get; set; }
  ...
  public EventContentMeetupExcelT() {
    ...
    this.ConditionType = Japan.MeetupConditionType.None;
    this.ConditionParameter = null;
    this.ConditionPrintType = Japan.MeetupConditionPrintType.None;
  }
}
...
static public class EventContentMeetupExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*ConditionType*/, 4 /*Japan.MeetupConditionType*/, 4, false)
      && verifier.VerifyVectorOfData(tablePos, 14 /*ConditionParameter*/, 8 /*long*/, false)
      && verifier.VerifyField(tablePos, 16 /*ConditionPrintType*/, 4 /*Japan.MeetupConditionPrintType*/, 4, false)
