...
public struct MiniGameDefenseCharacterBanExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.MiniGameDefenseCharacterBanExcel> CreateMiniGameDefenseCharacterBanExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.MiniGameDefenseCharacterBanExcel> EndMiniGameDefenseCharacterBanExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.MiniGameDefenseCharacterBanExcel>(o);
  }
  ...
  public static Offset<Japan.MiniGameDefenseCharacterBanExcel> Pack(FlatBufferBuilder builder, MiniGameDefenseCharacterBanExcelT _o) {
    if (_o == null) return default(Offset<Japan.MiniGameDefenseCharacterBanExcel>);
		byte[] key = TableEncryptionService.CreateKey("MiniGameDefenseCharacterBan");
