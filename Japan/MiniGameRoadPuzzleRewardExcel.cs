...
public struct MiniGameRoadPuzzleRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.MiniGameRoadPuzzleRewardExcel> CreateMiniGameRoadPuzzleRewardExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.MiniGameRoadPuzzleRewardExcel> EndMiniGameRoadPuzzleRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.MiniGameRoadPuzzleRewardExcel>(o);
  }
  ...
  public static Offset<Japan.MiniGameRoadPuzzleRewardExcel> Pack(FlatBufferBuilder builder, MiniGameRoadPuzzleRewardExcelT _o) {
    if (_o == null) return default(Offset<Japan.MiniGameRoadPuzzleRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("MiniGameRoadPuzzleReward");
