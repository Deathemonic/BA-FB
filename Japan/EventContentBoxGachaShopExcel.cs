...
public struct EventContentBoxGachaShopExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.EventContentBoxGachaShopExcel> CreateEventContentBoxGachaShopExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.EventContentBoxGachaShopExcel> EndEventContentBoxGachaShopExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.EventContentBoxGachaShopExcel>(o);
  }
  ...
  public static Offset<Japan.EventContentBoxGachaShopExcel> Pack(FlatBufferBuilder builder, EventContentBoxGachaShopExcelT _o) {
    if (_o == null) return default(Offset<Japan.EventContentBoxGachaShopExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentBoxGachaShop");
