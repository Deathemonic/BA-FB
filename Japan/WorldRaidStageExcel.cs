...
public struct WorldRaidStageExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(WorldRaidStageExcelT _o) {
    ...
    _o.WorldRaidDifficulty = TableEncryptionService.UseEncryption ? (Japan.WorldRaidDifficulty)TableEncryptionService.Convert((int)this.WorldRaidDifficulty, key) : this.WorldRaidDifficulty;
  ...
  public static Offset<Japan.WorldRaidStageExcel> Pack(FlatBufferBuilder builder, WorldRaidStageExcelT _o) {
    ...
    if (_o.BossCharacterId != null) {
      ...
      _BossCharacterId = CreateBossCharacterIdVector(builder, __BossCharacterId);
		...
		var _WorldRaidDifficulty = TableEncryptionService.UseEncryption ? (Japan.WorldRaidDifficulty)TableEncryptionService.Convert((int)_o.WorldRaidDifficulty, key) : _o.WorldRaidDifficulty;
