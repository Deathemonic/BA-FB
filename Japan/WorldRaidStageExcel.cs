...
public struct WorldRaidStageExcel : IFlatbufferObject
{
  ...
  public Japan.WorldRaidDifficulty WorldRaidDifficulty { get { int o = __p.__offset(22); return o != 0 ? (Japan.WorldRaidDifficulty)__p.bb.GetInt(o + __p.bb_pos) : Japan.WorldRaidDifficulty.None; } }
  ...
  public static Offset<Japan.WorldRaidStageExcel> CreateWorldRaidStageExcel(FlatBufferBuilder builder,
      long Id = 0,
      ...
      Japan.WorldRaidDifficulty WorldRaidDifficulty = Japan.WorldRaidDifficulty.None,
  ...
  public static void AddWorldRaidDifficulty(FlatBufferBuilder builder, Japan.WorldRaidDifficulty worldRaidDifficulty) { builder.AddInt(9, (int)worldRaidDifficulty, 0); }
  ...
  public static Offset<Japan.WorldRaidStageExcel> EndWorldRaidStageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.WorldRaidStageExcel>(o);
  }
  ...
  public static Offset<Japan.WorldRaidStageExcel> Pack(FlatBufferBuilder builder, WorldRaidStageExcelT _o) {
    if (_o == null) return default(Offset<Japan.WorldRaidStageExcel>);
		byte[] key = TableEncryptionService.CreateKey("WorldRaidStage");
    ...
    if (_o.BossCharacterId != null) {
      ...
      _BossCharacterId = CreateBossCharacterIdVector(builder, __BossCharacterId);
		...
		var _AssistCharacterLimitCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.AssistCharacterLimitCount, key) : _o.AssistCharacterLimitCount;
		var _WorldRaidDifficulty = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.WorldRaidDifficulty, key) : _o.WorldRaidDifficulty;
		...
		var _RaidEnterAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RaidEnterAmount, key) : _o.RaidEnterAmount;
		var _ReEnterAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ReEnterAmount, key) : _o.ReEnterAmount;
    ...
    var _PhaseChangeTimelinePath = _o.PhaseChangeTimelinePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.PhaseChangeTimelinePath, key) : _o.PhaseChangeTimelinePath));
		...
		var _UseFixedEchelon = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.UseFixedEchelon, key) : _o.UseFixedEchelon;
		...
		var _IsRaidScenarioBattle = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IsRaidScenarioBattle, key) : _o.IsRaidScenarioBattle;
    ...
    if (_o.AllyPassiveSkillLevel != null) {
      ...
      _AllyPassiveSkillLevel = CreateAllyPassiveSkillLevelVector(builder, __AllyPassiveSkillLevel);
		...
		var _SaveCurrentLocalBossHP = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.SaveCurrentLocalBossHP, key) : _o.SaveCurrentLocalBossHP;
...
public class WorldRaidStageExcelT
{
  ...
  public Japan.WorldRaidDifficulty WorldRaidDifficulty { get; set; }
  ...
  public WorldRaidStageExcelT() {
    ...
    this.WorldRaidDifficulty = Japan.WorldRaidDifficulty.None;
...
static public class WorldRaidStageExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 22 /*WorldRaidDifficulty*/, 4 /*Japan.WorldRaidDifficulty*/, 4, false)
