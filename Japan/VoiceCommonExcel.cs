...
public struct VoiceCommonExcel : IFlatbufferObject
{
  ...
  public Japan.VoiceEvent VoiceEvent { get { int o = __p.__offset(4); return o != 0 ? (Japan.VoiceEvent)__p.bb.GetInt(o + __p.bb_pos) : Japan.VoiceEvent.OnTSA; } }
  ...
  public static Offset<Japan.VoiceCommonExcel> CreateVoiceCommonExcel(FlatBufferBuilder builder,
      Japan.VoiceEvent VoiceEvent = Japan.VoiceEvent.OnTSA,
      long Rate = 0,
  ...
  public static void AddVoiceEvent(FlatBufferBuilder builder, Japan.VoiceEvent voiceEvent) { builder.AddInt(0, (int)voiceEvent, 0); }
  ...
  public static Offset<Japan.VoiceCommonExcel> EndVoiceCommonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.VoiceCommonExcel>(o);
  }
  ...
  public void UnPackTo(VoiceCommonExcelT _o) {
    ...
    _o.VoiceEvent = TableEncryptionService.UseEncryption ? (Japan.VoiceEvent)TableEncryptionService.Convert((int)this.VoiceEvent, key) : this.VoiceEvent;
  ...
  public static Offset<Japan.VoiceCommonExcel> Pack(FlatBufferBuilder builder, VoiceCommonExcelT _o) {
    if (_o == null) return default(Offset<Japan.VoiceCommonExcel>);
		byte[] key = TableEncryptionService.CreateKey("VoiceCommon");
		var _VoiceEvent = TableEncryptionService.UseEncryption ? (Japan.VoiceEvent)TableEncryptionService.Convert((int)_o.VoiceEvent, key) : _o.VoiceEvent;
...
{
  public Japan.VoiceEvent VoiceEvent { get; set; }
  public long Rate { get; set; }
  public List<uint> VoiceHash { get; set; }

  public VoiceCommonExcelT() {
    this.VoiceEvent = Japan.VoiceEvent.OnTSA;
    this.Rate = 0;
    this.VoiceHash = null;
  }
}
...
static public class VoiceCommonExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyField(tablePos, 4 /*VoiceEvent*/, 4 /*Japan.VoiceEvent*/, 4, false)
