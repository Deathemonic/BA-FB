...
public struct VoiceExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.VoiceExcel> CreateVoiceExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      uint Id = 0,
  ...
  public static Offset<Japan.VoiceExcel> EndVoiceExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.VoiceExcel>(o);
  }
  ...
  public static Offset<Japan.VoiceExcel> Pack(FlatBufferBuilder builder, VoiceExcelT _o) {
    if (_o == null) return default(Offset<Japan.VoiceExcel>);
		byte[] key = TableEncryptionService.CreateKey("Voice");
