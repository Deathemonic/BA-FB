...
public struct SchoolDungeonStageExcel : IFlatbufferObject
{
  ...
  public Japan.StarGoalType StarGoal(int j) { int o = __p.__offset(24); return o != 0 ? (Japan.StarGoalType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.StarGoalType)0; }
  public int StarGoalLength { get { int o = __p.__offset(24); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.StarGoalType> GetStarGoalBytes() { return __p.__vector_as_span<Japan.StarGoalType>(24, 4); }
#else
  public ArraySegment<byte>? GetStarGoalBytes() { return __p.__vector_as_arraysegment(24); }
#endif
  public Japan.StarGoalType[] GetStarGoalArray() { int o = __p.__offset(24); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.StarGoalType[] a = new Japan.StarGoalType[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.StarGoalType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Japan.StageTopography StageTopography { get { int o = __p.__offset(28); return o != 0 ? (Japan.StageTopography)__p.bb.GetInt(o + __p.bb_pos) : Japan.StageTopography.Street; } }
  ...
  public Japan.EchelonExtensionType EchelonExtensionType { get { int o = __p.__offset(36); return o != 0 ? (Japan.EchelonExtensionType)__p.bb.GetInt(o + __p.bb_pos) : Japan.EchelonExtensionType.Base; } }

  public static Offset<Japan.SchoolDungeonStageExcel> CreateSchoolDungeonStageExcel(FlatBufferBuilder builder,
      long StageId = 0,
  ...
  public static void AddStageTopography(FlatBufferBuilder builder, Japan.StageTopography stageTopography) { builder.AddInt(12, (int)stageTopography, 0); }
  ...
  public static void AddEchelonExtensionType(FlatBufferBuilder builder, Japan.EchelonExtensionType echelonExtensionType) { builder.AddInt(16, (int)echelonExtensionType, 0); }
  public static Offset<Japan.SchoolDungeonStageExcel> EndSchoolDungeonStageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.SchoolDungeonStageExcel>(o);
  }
  ...
  public static Offset<Japan.SchoolDungeonStageExcel> Pack(FlatBufferBuilder builder, SchoolDungeonStageExcelT _o) {
    if (_o == null) return default(Offset<Japan.SchoolDungeonStageExcel>);
		byte[] key = TableEncryptionService.CreateKey("SchoolDungeonStage");
...
static public class SchoolDungeonStageExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 24 /*StarGoal*/, 4 /*Japan.StarGoalType*/, false)
      && verifier.VerifyVectorOfData(tablePos, 26 /*StarGoalAmount*/, 4 /*int*/, false)
      && verifier.VerifyField(tablePos, 28 /*StageTopography*/, 4 /*Japan.StageTopography*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 36 /*EchelonExtensionType*/, 4 /*Japan.EchelonExtensionType*/, 4, false)
