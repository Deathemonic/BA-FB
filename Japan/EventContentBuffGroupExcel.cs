...
public struct EventContentBuffGroupExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.EventContentBuffGroupExcel> CreateEventContentBuffGroupExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.EventContentBuffGroupExcel> EndEventContentBuffGroupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.EventContentBuffGroupExcel>(o);
  }
  ...
  public static Offset<Japan.EventContentBuffGroupExcel> Pack(FlatBufferBuilder builder, EventContentBuffGroupExcelT _o) {
    if (_o == null) return default(Offset<Japan.EventContentBuffGroupExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentBuffGroup");
