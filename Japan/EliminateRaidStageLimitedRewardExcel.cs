...
public struct EliminateRaidStageLimitedRewardExcel : IFlatbufferObject
{
  ...
  public Japan.ParcelType LimitedRewardParcelType(int j) { int o = __p.__offset(6); return o != 0 ? (Japan.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.ParcelType)0; }
  public int LimitedRewardParcelTypeLength { get { int o = __p.__offset(6); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.ParcelType> GetLimitedRewardParcelTypeBytes() { return __p.__vector_as_span<Japan.ParcelType>(6, 4); }
#else
  public ArraySegment<byte>? GetLimitedRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(6); }
#endif
  public Japan.ParcelType[] GetLimitedRewardParcelTypeArray() { int o = __p.__offset(6); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.ParcelType[] a = new Japan.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Japan.EliminateRaidStageLimitedRewardExcel> CreateEliminateRaidStageLimitedRewardExcel(FlatBufferBuilder builder,
  ...
  public static VectorOffset CreateLimitedRewardParcelTypeVector(FlatBufferBuilder builder, Japan.ParcelType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateLimitedRewardParcelTypeVectorBlock(FlatBufferBuilder builder, Japan.ParcelType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateLimitedRewardParcelTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Japan.ParcelType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateLimitedRewardParcelTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Japan.ParcelType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Japan.EliminateRaidStageLimitedRewardExcel> EndEliminateRaidStageLimitedRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.EliminateRaidStageLimitedRewardExcel>(o);
  }
  ...
  public void UnPackTo(EliminateRaidStageLimitedRewardExcelT _o) {
    ...
    _o.LimitedRewardId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.LimitedRewardId, key) : this.LimitedRewardId;
    _o.LimitedRewardParcelType = new List<Japan.ParcelType>();
    for (var _j = 0; _j < this.LimitedRewardParcelTypeLength; ++_j) {_o.LimitedRewardParcelType.Add(TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)this.LimitedRewardParcelType(_j), key) : this.LimitedRewardParcelType(_j));}
    _o.LimitedRewardParcelUniqueId = new List<long>();
    for (var _j = 0; _j < this.LimitedRewardParcelUniqueIdLength; ++_j) {_o.LimitedRewardParcelUniqueId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.LimitedRewardParcelUniqueId(_j), key) : this.LimitedRewardParcelUniqueId(_j));}
    _o.LimitedRewardAmount = new List<long>();
    for (var _j = 0; _j < this.LimitedRewardAmountLength; ++_j) {_o.LimitedRewardAmount.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.LimitedRewardAmount(_j), key) : this.LimitedRewardAmount(_j));}
  }
  public static Offset<Japan.EliminateRaidStageLimitedRewardExcel> Pack(FlatBufferBuilder builder, EliminateRaidStageLimitedRewardExcelT _o) {
    if (_o == null) return default(Offset<Japan.EliminateRaidStageLimitedRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("EliminateRaidStageLimitedReward");
		var _LimitedRewardId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.LimitedRewardId, key) : _o.LimitedRewardId;
    var _LimitedRewardParcelType = default(VectorOffset);
    if (_o.LimitedRewardParcelType != null) {
      var __LimitedRewardParcelType = _o.LimitedRewardParcelType.Select(x => TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)x, key) : x).ToArray();
    ...
    if (_o.LimitedRewardParcelUniqueId != null) {
      var __LimitedRewardParcelUniqueId = _o.LimitedRewardParcelUniqueId.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
    ...
    if (_o.LimitedRewardAmount != null) {
      var __LimitedRewardAmount = _o.LimitedRewardAmount.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
...
public class EliminateRaidStageLimitedRewardExcelT
{
  ...
  public List<Japan.ParcelType> LimitedRewardParcelType { get; set; }
...
static public class EliminateRaidStageLimitedRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 6 /*LimitedRewardParcelType*/, 4 /*Japan.ParcelType*/, false)
