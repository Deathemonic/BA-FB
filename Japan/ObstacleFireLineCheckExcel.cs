...
public struct ObstacleFireLineCheckExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.ObstacleFireLineCheckExcel> CreateObstacleFireLineCheckExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.ObstacleFireLineCheckExcel> EndObstacleFireLineCheckExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ObstacleFireLineCheckExcel>(o);
  }
  ...
  public void UnPackTo(ObstacleFireLineCheckExcelT _o) {
    ...
    _o.MyObstacleFireLineCheck = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MyObstacleFireLineCheck, key) : this.MyObstacleFireLineCheck;
    _o.AllyObstacleFireLineCheck = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.AllyObstacleFireLineCheck, key) : this.AllyObstacleFireLineCheck;
    _o.EnemyObstacleFireLineCheck = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EnemyObstacleFireLineCheck, key) : this.EnemyObstacleFireLineCheck;
    _o.EmptyObstacleFireLineCheck = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EmptyObstacleFireLineCheck, key) : this.EmptyObstacleFireLineCheck;
  }
  public static Offset<Japan.ObstacleFireLineCheckExcel> Pack(FlatBufferBuilder builder, ObstacleFireLineCheckExcelT _o) {
    if (_o == null) return default(Offset<Japan.ObstacleFireLineCheckExcel>);
		byte[] key = TableEncryptionService.CreateKey("ObstacleFireLineCheck");
		var _MyObstacleFireLineCheck = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MyObstacleFireLineCheck, key) : _o.MyObstacleFireLineCheck;
		var _AllyObstacleFireLineCheck = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.AllyObstacleFireLineCheck, key) : _o.AllyObstacleFireLineCheck;
		var _EnemyObstacleFireLineCheck = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EnemyObstacleFireLineCheck, key) : _o.EnemyObstacleFireLineCheck;
		var _EmptyObstacleFireLineCheck = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EmptyObstacleFireLineCheck, key) : _o.EmptyObstacleFireLineCheck;
