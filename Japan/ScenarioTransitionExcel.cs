...
public struct ScenarioTransitionExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.ScenarioTransitionExcel> CreateScenarioTransitionExcel(FlatBufferBuilder builder,
      uint Name = 0,
  ...
  public static Offset<Japan.ScenarioTransitionExcel> EndScenarioTransitionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ScenarioTransitionExcel>(o);
  }
  ...
  public void UnPackTo(ScenarioTransitionExcelT _o) {
    ...
    _o.TransitionOutDuration = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.TransitionOutDuration, key) : this.TransitionOutDuration;
    ...
    _o.TransitionInDuration = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.TransitionInDuration, key) : this.TransitionInDuration;
  ...
  public static Offset<Japan.ScenarioTransitionExcel> Pack(FlatBufferBuilder builder, ScenarioTransitionExcelT _o) {
    if (_o == null) return default(Offset<Japan.ScenarioTransitionExcel>);
		byte[] key = TableEncryptionService.CreateKey("ScenarioTransition");
		var _Name = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Name, key) : _o.Name;
    var _TransitionOut = _o.TransitionOut == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.TransitionOut, key) : _o.TransitionOut));
		var _TransitionOutDuration = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.TransitionOutDuration, key) : _o.TransitionOutDuration;
    var _TransitionOutResource = _o.TransitionOutResource == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.TransitionOutResource, key) : _o.TransitionOutResource));
    var _TransitionIn = _o.TransitionIn == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.TransitionIn, key) : _o.TransitionIn));
		var _TransitionInDuration = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.TransitionInDuration, key) : _o.TransitionInDuration;
    var _TransitionInResource = _o.TransitionInResource == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.TransitionInResource, key) : _o.TransitionInResource));
