...
public struct MinigameTBGEncounterRewardExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(MinigameTBGEncounterRewardExcelT _o) {
    ...
    _o.TBGOptionSuccessType = TableEncryptionService.UseEncryption ? (Japan.TBGOptionSuccessType)TableEncryptionService.Convert((int)this.TBGOptionSuccessType, key) : this.TBGOptionSuccessType;
  ...
  public static Offset<Japan.MinigameTBGEncounterRewardExcel> Pack(FlatBufferBuilder builder, MinigameTBGEncounterRewardExcelT _o) {
    if (_o == null) return default(Offset<Japan.MinigameTBGEncounterRewardExcel>);
		...
		var _TBGOptionSuccessType = TableEncryptionService.UseEncryption ? (Japan.TBGOptionSuccessType)TableEncryptionService.Convert((int)_o.TBGOptionSuccessType, key) : _o.TBGOptionSuccessType;
