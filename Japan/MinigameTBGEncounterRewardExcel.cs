...
public struct MinigameTBGEncounterRewardExcel : IFlatbufferObject
{
  ...
  public Japan.TBGOptionSuccessType TBGOptionSuccessType { get { int o = __p.__offset(8); return o != 0 ? (Japan.TBGOptionSuccessType)__p.bb.GetInt(o + __p.bb_pos) : Japan.TBGOptionSuccessType.None; } }
  public long Paremeter { get { int o = __p.__offset(10); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public Japan.ParcelType ParcelType { get { int o = __p.__offset(12); return o != 0 ? (Japan.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Japan.ParcelType.None; } }
  ...
  public static Offset<Japan.MinigameTBGEncounterRewardExcel> CreateMinigameTBGEncounterRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
      long UniqueId = 0,
      Japan.TBGOptionSuccessType TBGOptionSuccessType = Japan.TBGOptionSuccessType.None,
      long Paremeter = 0,
  ...
  public static void AddTBGOptionSuccessType(FlatBufferBuilder builder, Japan.TBGOptionSuccessType tBGOptionSuccessType) { builder.AddInt(2, (int)tBGOptionSuccessType, 0); }
  public static void AddParemeter(FlatBufferBuilder builder, long paremeter) { builder.AddLong(3, paremeter, 0); }
  public static void AddParcelType(FlatBufferBuilder builder, Japan.ParcelType parcelType) { builder.AddInt(4, (int)parcelType, 0); }
  ...
  public static Offset<Japan.MinigameTBGEncounterRewardExcel> EndMinigameTBGEncounterRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.MinigameTBGEncounterRewardExcel>(o);
  }
  ...
  public static Offset<Japan.MinigameTBGEncounterRewardExcel> Pack(FlatBufferBuilder builder, MinigameTBGEncounterRewardExcelT _o) {
    if (_o == null) return default(Offset<Japan.MinigameTBGEncounterRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("MinigameTBGEncounterReward");
...
public class MinigameTBGEncounterRewardExcelT
{
  ...
  public Japan.TBGOptionSuccessType TBGOptionSuccessType { get; set; }
  ...
  public MinigameTBGEncounterRewardExcelT() {
    this.GroupId = 0;
    this.UniqueId = 0;
    this.TBGOptionSuccessType = Japan.TBGOptionSuccessType.None;
    this.Paremeter = 0;
...
static public class MinigameTBGEncounterRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*TBGOptionSuccessType*/, 4 /*Japan.TBGOptionSuccessType*/, 4, false)
      && verifier.VerifyField(tablePos, 10 /*Paremeter*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 12 /*ParcelType*/, 4 /*Japan.ParcelType*/, 4, false)
