...
public struct EventContentSpoilerPopupExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.EventContentSpoilerPopupExcel> CreateEventContentSpoilerPopupExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.EventContentSpoilerPopupExcel> EndEventContentSpoilerPopupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.EventContentSpoilerPopupExcel>(o);
  }
  ...
  public static Offset<Japan.EventContentSpoilerPopupExcel> Pack(FlatBufferBuilder builder, EventContentSpoilerPopupExcelT _o) {
    if (_o == null) return default(Offset<Japan.EventContentSpoilerPopupExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentSpoilerPopup");
