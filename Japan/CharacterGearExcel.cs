...
public struct CharacterGearExcel : IFlatbufferObject
{
  ...
  public Japan.StatLevelUpType StatLevelUpType { get { int o = __p.__offset(8); return o != 0 ? (Japan.StatLevelUpType)__p.bb.GetInt(o + __p.bb_pos) : Japan.StatLevelUpType.Standard; } }
  ...
  public Japan.EquipmentOptionType StatType(int j) { int o = __p.__offset(22); return o != 0 ? (Japan.EquipmentOptionType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.EquipmentOptionType)0; }
  public int StatTypeLength { get { int o = __p.__offset(22); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.EquipmentOptionType> GetStatTypeBytes() { return __p.__vector_as_span<Japan.EquipmentOptionType>(22, 4); }
#else
  public ArraySegment<byte>? GetStatTypeBytes() { return __p.__vector_as_arraysegment(22); }
#endif
  public Japan.EquipmentOptionType[] GetStatTypeArray() { int o = __p.__offset(22); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.EquipmentOptionType[] a = new Japan.EquipmentOptionType[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.EquipmentOptionType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Japan.Tag Tags(int j) { int o = __p.__offset(32); return o != 0 ? (Japan.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.Tag)0; }
  public int TagsLength { get { int o = __p.__offset(32); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.Tag> GetTagsBytes() { return __p.__vector_as_span<Japan.Tag>(32, 4); }
#else
  public ArraySegment<byte>? GetTagsBytes() { return __p.__vector_as_arraysegment(32); }
#endif
  public Japan.Tag[] GetTagsArray() { int o = __p.__offset(32); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.Tag[] a = new Japan.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.Tag)__p.bb.GetInt(p + i * 4); } return a; }

  public static Offset<Japan.CharacterGearExcel> CreateCharacterGearExcel(FlatBufferBuilder builder,
      long Id = 0,
      long CharacterId = 0,
  ...
  public static void AddStatLevelUpType(FlatBufferBuilder builder, Japan.StatLevelUpType statLevelUpType) { builder.AddInt(2, (int)statLevelUpType, 0); }
  ...
  public static Offset<Japan.CharacterGearExcel> EndCharacterGearExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.CharacterGearExcel>(o);
  }
  ...
  public static Offset<Japan.CharacterGearExcel> Pack(FlatBufferBuilder builder, CharacterGearExcelT _o) {
    if (_o == null) return default(Offset<Japan.CharacterGearExcel>);
		byte[] key = TableEncryptionService.CreateKey("CharacterGear");
...
static public class CharacterGearExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*StatLevelUpType*/, 4 /*Japan.StatLevelUpType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 22 /*StatType*/, 4 /*Japan.EquipmentOptionType*/, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 32 /*Tags*/, 4 /*Japan.Tag*/, false)
