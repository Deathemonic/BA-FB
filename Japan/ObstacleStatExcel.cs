...
public struct ObstacleStatExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.ObstacleStatExcel> CreateObstacleStatExcel(FlatBufferBuilder builder,
      uint StringID = 0,
  ...
  public static Offset<Japan.ObstacleStatExcel> EndObstacleStatExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ObstacleStatExcel>(o);
  }
  ...
  public static Offset<Japan.ObstacleStatExcel> Pack(FlatBufferBuilder builder, ObstacleStatExcelT _o) {
    if (_o == null) return default(Offset<Japan.ObstacleStatExcel>);
		byte[] key = TableEncryptionService.CreateKey("ObstacleStat");
