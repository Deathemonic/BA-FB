...
public struct ObstacleStatExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ObstacleStatExcelT _o) {
    ...
    _o.Dodge = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.Dodge, key) : this.Dodge;
    _o.CanNotStandRange = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.CanNotStandRange, key) : this.CanNotStandRange;
  ...
  public static Offset<Japan.ObstacleStatExcel> Pack(FlatBufferBuilder builder, ObstacleStatExcelT _o) {
    ...
    var _Name = _o.Name == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.Name, key) : _o.Name));
		...
		var _Dodge = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.Dodge, key) : _o.Dodge;
		var _CanNotStandRange = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.CanNotStandRange, key) : _o.CanNotStandRange;
...
static public class ObstacleStatExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 34 /*ReduceBasicsDamagedRate*/, 8 /*long*/, 8, false)
