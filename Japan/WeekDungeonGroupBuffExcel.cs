...
public struct WeekDungeonGroupBuffExcel : IFlatbufferObject
{
  ...
  public Japan.School School { get { int o = __p.__offset(6); return o != 0 ? (Japan.School)__p.bb.GetInt(o + __p.bb_pos) : Japan.School.None; } }
  ...
  public static Offset<Japan.WeekDungeonGroupBuffExcel> CreateWeekDungeonGroupBuffExcel(FlatBufferBuilder builder,
  ...
  public static void AddSchool(FlatBufferBuilder builder, Japan.School school) { builder.AddInt(1, (int)school, 0); }
  ...
  public static Offset<Japan.WeekDungeonGroupBuffExcel> EndWeekDungeonGroupBuffExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.WeekDungeonGroupBuffExcel>(o);
  }
  ...
  public static Offset<Japan.WeekDungeonGroupBuffExcel> Pack(FlatBufferBuilder builder, WeekDungeonGroupBuffExcelT _o) {
    if (_o == null) return default(Offset<Japan.WeekDungeonGroupBuffExcel>);
		byte[] key = TableEncryptionService.CreateKey("WeekDungeonGroupBuff");
...
static public class WeekDungeonGroupBuffExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*School*/, 4 /*Japan.School*/, 4, false)
