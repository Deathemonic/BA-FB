...
public struct Position : IFlatbufferObject
{
  ...
  public static Offset<Japan.Position> CreatePosition(FlatBufferBuilder builder,
      float X = 0.0f,
      float Z = 0.0f) {
  ...
  public static Offset<Japan.Position> EndPosition(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.Position>(o);
  }
  ...
  public static Offset<Japan.Position> Pack(FlatBufferBuilder builder, PositionT _o) {
    if (_o == null) return default(Offset<Japan.Position>);
		byte[] key = TableEncryptionService.CreateKey("Pos");
