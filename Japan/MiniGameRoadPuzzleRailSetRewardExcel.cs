...
public struct MiniGameRoadPuzzleRailSetRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.MiniGameRoadPuzzleRailSetRewardExcel> CreateMiniGameRoadPuzzleRailSetRewardExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.MiniGameRoadPuzzleRailSetRewardExcel> EndMiniGameRoadPuzzleRailSetRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.MiniGameRoadPuzzleRailSetRewardExcel>(o);
  }
  ...
  public static Offset<Japan.MiniGameRoadPuzzleRailSetRewardExcel> Pack(FlatBufferBuilder builder, MiniGameRoadPuzzleRailSetRewardExcelT _o) {
    if (_o == null) return default(Offset<Japan.MiniGameRoadPuzzleRailSetRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("MiniGameRoadPuzzleRailSetReward");
