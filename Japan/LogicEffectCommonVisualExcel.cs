...
public struct LogicEffectCommonVisualExcel : IFlatbufferObject
{
  ...
  public Japan.EffectBone ParticleEnterSocket { get { int o = __p.__offset(12); return o != 0 ? (Japan.EffectBone)__p.bb.GetInt(o + __p.bb_pos) : Japan.EffectBone.None; } }
  ...
  public Japan.EffectBone ParticleLoopSocket { get { int o = __p.__offset(16); return o != 0 ? (Japan.EffectBone)__p.bb.GetInt(o + __p.bb_pos) : Japan.EffectBone.None; } }
  ...
  public Japan.EffectBone ParticleEndSocket { get { int o = __p.__offset(20); return o != 0 ? (Japan.EffectBone)__p.bb.GetInt(o + __p.bb_pos) : Japan.EffectBone.None; } }
  ...
  public Japan.EffectBone ParticleApplySocket { get { int o = __p.__offset(24); return o != 0 ? (Japan.EffectBone)__p.bb.GetInt(o + __p.bb_pos) : Japan.EffectBone.None; } }
  ...
  public Japan.EffectBone ParticleRemovedSocket { get { int o = __p.__offset(28); return o != 0 ? (Japan.EffectBone)__p.bb.GetInt(o + __p.bb_pos) : Japan.EffectBone.None; } }

  public static Offset<Japan.LogicEffectCommonVisualExcel> CreateLogicEffectCommonVisualExcel(FlatBufferBuilder builder,
      uint StringID = 0,
      ...
      Japan.EffectBone ParticleEnterSocket = Japan.EffectBone.None,
      StringOffset ParticleLoopPathOffset = default(StringOffset),
      Japan.EffectBone ParticleLoopSocket = Japan.EffectBone.None,
      StringOffset ParticleEndPathOffset = default(StringOffset),
      Japan.EffectBone ParticleEndSocket = Japan.EffectBone.None,
      StringOffset ParticleApplyPathOffset = default(StringOffset),
      Japan.EffectBone ParticleApplySocket = Japan.EffectBone.None,
      StringOffset ParticleRemovedPathOffset = default(StringOffset),
      Japan.EffectBone ParticleRemovedSocket = Japan.EffectBone.None) {
  ...
  public static void AddParticleEnterSocket(FlatBufferBuilder builder, Japan.EffectBone particleEnterSocket) { builder.AddInt(4, (int)particleEnterSocket, 0); }
  ...
  public static void AddParticleLoopSocket(FlatBufferBuilder builder, Japan.EffectBone particleLoopSocket) { builder.AddInt(6, (int)particleLoopSocket, 0); }
  ...
  public static void AddParticleEndSocket(FlatBufferBuilder builder, Japan.EffectBone particleEndSocket) { builder.AddInt(8, (int)particleEndSocket, 0); }
  ...
  public static void AddParticleApplySocket(FlatBufferBuilder builder, Japan.EffectBone particleApplySocket) { builder.AddInt(10, (int)particleApplySocket, 0); }
  ...
  public static void AddParticleRemovedSocket(FlatBufferBuilder builder, Japan.EffectBone particleRemovedSocket) { builder.AddInt(12, (int)particleRemovedSocket, 0); }
  public static Offset<Japan.LogicEffectCommonVisualExcel> EndLogicEffectCommonVisualExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.LogicEffectCommonVisualExcel>(o);
  }
  ...
  public void UnPackTo(LogicEffectCommonVisualExcelT _o) {
    ...
    _o.ParticleEnterSocket = TableEncryptionService.UseEncryption ? (Japan.EffectBone)TableEncryptionService.Convert((int)this.ParticleEnterSocket, key) : this.ParticleEnterSocket;
    ...
    _o.ParticleLoopSocket = TableEncryptionService.UseEncryption ? (Japan.EffectBone)TableEncryptionService.Convert((int)this.ParticleLoopSocket, key) : this.ParticleLoopSocket;
    ...
    _o.ParticleEndSocket = TableEncryptionService.UseEncryption ? (Japan.EffectBone)TableEncryptionService.Convert((int)this.ParticleEndSocket, key) : this.ParticleEndSocket;
    ...
    _o.ParticleApplySocket = TableEncryptionService.UseEncryption ? (Japan.EffectBone)TableEncryptionService.Convert((int)this.ParticleApplySocket, key) : this.ParticleApplySocket;
    ...
    _o.ParticleRemovedSocket = TableEncryptionService.UseEncryption ? (Japan.EffectBone)TableEncryptionService.Convert((int)this.ParticleRemovedSocket, key) : this.ParticleRemovedSocket;
  }
  public static Offset<Japan.LogicEffectCommonVisualExcel> Pack(FlatBufferBuilder builder, LogicEffectCommonVisualExcelT _o) {
    if (_o == null) return default(Offset<Japan.LogicEffectCommonVisualExcel>);
		byte[] key = TableEncryptionService.CreateKey("LogicEffectCommonVisual");
    ...
    var _ParticleEnterPath = _o.ParticleEnterPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.ParticleEnterPath, key) : _o.ParticleEnterPath));
		var _ParticleEnterSocket = TableEncryptionService.UseEncryption ? (Japan.EffectBone)TableEncryptionService.Convert((int)_o.ParticleEnterSocket, key) : _o.ParticleEnterSocket;
    var _ParticleLoopPath = _o.ParticleLoopPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.ParticleLoopPath, key) : _o.ParticleLoopPath));
		var _ParticleLoopSocket = TableEncryptionService.UseEncryption ? (Japan.EffectBone)TableEncryptionService.Convert((int)_o.ParticleLoopSocket, key) : _o.ParticleLoopSocket;
    var _ParticleEndPath = _o.ParticleEndPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.ParticleEndPath, key) : _o.ParticleEndPath));
		var _ParticleEndSocket = TableEncryptionService.UseEncryption ? (Japan.EffectBone)TableEncryptionService.Convert((int)_o.ParticleEndSocket, key) : _o.ParticleEndSocket;
    var _ParticleApplyPath = _o.ParticleApplyPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.ParticleApplyPath, key) : _o.ParticleApplyPath));
		var _ParticleApplySocket = TableEncryptionService.UseEncryption ? (Japan.EffectBone)TableEncryptionService.Convert((int)_o.ParticleApplySocket, key) : _o.ParticleApplySocket;
    var _ParticleRemovedPath = _o.ParticleRemovedPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.ParticleRemovedPath, key) : _o.ParticleRemovedPath));
		var _ParticleRemovedSocket = TableEncryptionService.UseEncryption ? (Japan.EffectBone)TableEncryptionService.Convert((int)_o.ParticleRemovedSocket, key) : _o.ParticleRemovedSocket;
...
public class LogicEffectCommonVisualExcelT
{
  ...
  public Japan.EffectBone ParticleEnterSocket { get; set; }
  public string ParticleLoopPath { get; set; }
  public Japan.EffectBone ParticleLoopSocket { get; set; }
  public string ParticleEndPath { get; set; }
  public Japan.EffectBone ParticleEndSocket { get; set; }
  public string ParticleApplyPath { get; set; }
  public Japan.EffectBone ParticleApplySocket { get; set; }
  public string ParticleRemovedPath { get; set; }
  public Japan.EffectBone ParticleRemovedSocket { get; set; }
  ...
  public LogicEffectCommonVisualExcelT() {
    ...
    this.ParticleEnterSocket = Japan.EffectBone.None;
    this.ParticleLoopPath = null;
    this.ParticleLoopSocket = Japan.EffectBone.None;
    this.ParticleEndPath = null;
    this.ParticleEndSocket = Japan.EffectBone.None;
    this.ParticleApplyPath = null;
    this.ParticleApplySocket = Japan.EffectBone.None;
    this.ParticleRemovedPath = null;
    this.ParticleRemovedSocket = Japan.EffectBone.None;
  }
}
...
static public class LogicEffectCommonVisualExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*ParticleEnterSocket*/, 4 /*Japan.EffectBone*/, 4, false)
      && verifier.VerifyString(tablePos, 14 /*ParticleLoopPath*/, false)
      && verifier.VerifyField(tablePos, 16 /*ParticleLoopSocket*/, 4 /*Japan.EffectBone*/, 4, false)
      && verifier.VerifyString(tablePos, 18 /*ParticleEndPath*/, false)
      && verifier.VerifyField(tablePos, 20 /*ParticleEndSocket*/, 4 /*Japan.EffectBone*/, 4, false)
      && verifier.VerifyString(tablePos, 22 /*ParticleApplyPath*/, false)
      && verifier.VerifyField(tablePos, 24 /*ParticleApplySocket*/, 4 /*Japan.EffectBone*/, 4, false)
      && verifier.VerifyString(tablePos, 26 /*ParticleRemovedPath*/, false)
      && verifier.VerifyField(tablePos, 28 /*ParticleRemovedSocket*/, 4 /*Japan.EffectBone*/, 4, false)
