...
public struct EventContentChangeExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(EventContentChangeExcelT _o) {
    ...
    _o.ChangeCostType = TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)this.ChangeCostType, key) : this.ChangeCostType;
  ...
  public static Offset<Japan.EventContentChangeExcel> Pack(FlatBufferBuilder builder, EventContentChangeExcelT _o) {
    if (_o == null) return default(Offset<Japan.EventContentChangeExcel>);
		...
		var _ChangeCostType = TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)_o.ChangeCostType, key) : _o.ChangeCostType;
