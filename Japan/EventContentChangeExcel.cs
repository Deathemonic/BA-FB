...
public struct EventContentChangeExcel : IFlatbufferObject
{
  ...
  public Japan.ParcelType ChangeCostType { get { int o = __p.__offset(16); return o != 0 ? (Japan.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Japan.ParcelType.None; } }
  ...
  public static Offset<Japan.EventContentChangeExcel> CreateEventContentChangeExcel(FlatBufferBuilder builder,
      ...
      long RewardId = 0,
      int RewardAmount = 0,
      Japan.ParcelType ChangeCostType = Japan.ParcelType.None,
      long ChangeCostId = 0,
  ...
  public static void AddChangeCostType(FlatBufferBuilder builder, Japan.ParcelType changeCostType) { builder.AddInt(6, (int)changeCostType, 0); }
  ...
  public static Offset<Japan.EventContentChangeExcel> EndEventContentChangeExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.EventContentChangeExcel>(o);
  }
  ...
  public static Offset<Japan.EventContentChangeExcel> Pack(FlatBufferBuilder builder, EventContentChangeExcelT _o) {
    if (_o == null) return default(Offset<Japan.EventContentChangeExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentChange");
...
public class EventContentChangeExcelT
{
  ...
  public Japan.ParcelType ChangeCostType { get; set; }
  ...
  public EventContentChangeExcelT() {
    ...
    this.RewardId = 0;
    this.RewardAmount = 0;
    this.ChangeCostType = Japan.ParcelType.None;
    this.ChangeCostId = 0;
...
static public class EventContentChangeExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 16 /*ChangeCostType*/, 4 /*Japan.ParcelType*/, 4, false)
