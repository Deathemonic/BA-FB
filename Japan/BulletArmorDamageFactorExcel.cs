...
public struct BulletArmorDamageFactorExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(BulletArmorDamageFactorExcelT _o) {
    ...
    _o.DamageAttribute = TableEncryptionService.UseEncryption ? (Japan.DamageAttribute)TableEncryptionService.Convert((int)this.DamageAttribute, key) : this.DamageAttribute;
  ...
  public static Offset<Japan.BulletArmorDamageFactorExcel> Pack(FlatBufferBuilder builder, BulletArmorDamageFactorExcelT _o) {
    ...
    var _DamageFactorGroupId = _o.DamageFactorGroupId == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.DamageFactorGroupId, key) : _o.DamageFactorGroupId));
		...
		var _DamageAttribute = TableEncryptionService.UseEncryption ? (Japan.DamageAttribute)TableEncryptionService.Convert((int)_o.DamageAttribute, key) : _o.DamageAttribute;
