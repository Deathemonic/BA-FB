...
public struct BulletArmorDamageFactorExcel : IFlatbufferObject
{
  ...
  public Japan.BulletType BulletType { get { int o = __p.__offset(6); return o != 0 ? (Japan.BulletType)__p.bb.GetInt(o + __p.bb_pos) : Japan.BulletType.Normal; } }
  public Japan.ArmorType ArmorType { get { int o = __p.__offset(8); return o != 0 ? (Japan.ArmorType)__p.bb.GetInt(o + __p.bb_pos) : Japan.ArmorType.LightArmor; } }
  public long DamageRate { get { int o = __p.__offset(10); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public Japan.DamageAttribute DamageAttribute { get { int o = __p.__offset(12); return o != 0 ? (Japan.DamageAttribute)__p.bb.GetInt(o + __p.bb_pos) : Japan.DamageAttribute.Resist; } }
  ...
  public static Offset<Japan.BulletArmorDamageFactorExcel> CreateBulletArmorDamageFactorExcel(FlatBufferBuilder builder,
      ...
      long DamageRate = 0,
      Japan.DamageAttribute DamageAttribute = Japan.DamageAttribute.Resist,
  ...
  public static void AddBulletType(FlatBufferBuilder builder, Japan.BulletType bulletType) { builder.AddInt(1, (int)bulletType, 0); }
  public static void AddArmorType(FlatBufferBuilder builder, Japan.ArmorType armorType) { builder.AddInt(2, (int)armorType, 0); }
  public static void AddDamageRate(FlatBufferBuilder builder, long damageRate) { builder.AddLong(3, damageRate, 0); }
  public static void AddDamageAttribute(FlatBufferBuilder builder, Japan.DamageAttribute damageAttribute) { builder.AddInt(4, (int)damageAttribute, 0); }
  ...
  public static Offset<Japan.BulletArmorDamageFactorExcel> EndBulletArmorDamageFactorExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.BulletArmorDamageFactorExcel>(o);
  }
  ...
  public static Offset<Japan.BulletArmorDamageFactorExcel> Pack(FlatBufferBuilder builder, BulletArmorDamageFactorExcelT _o) {
    if (_o == null) return default(Offset<Japan.BulletArmorDamageFactorExcel>);
		byte[] key = TableEncryptionService.CreateKey("BulletArmorDamageFactor");
    var _DamageFactorGroupId = _o.DamageFactorGroupId == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.DamageFactorGroupId, key) : _o.DamageFactorGroupId));
		...
		var _DamageRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DamageRate, key) : _o.DamageRate;
		var _DamageAttribute = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DamageAttribute, key) : _o.DamageAttribute;
		var _MinDamageRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MinDamageRate, key) : _o.MinDamageRate;
		var _MaxDamageRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MaxDamageRate, key) : _o.MaxDamageRate;
		var _ShowHighlightFloater = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ShowHighlightFloater, key) : _o.ShowHighlightFloater;
...
public class BulletArmorDamageFactorExcelT
{
  ...
  public Japan.DamageAttribute DamageAttribute { get; set; }
  ...
  public BulletArmorDamageFactorExcelT() {
    ...
    this.DamageRate = 0;
    this.DamageAttribute = Japan.DamageAttribute.Resist;
...
static public class BulletArmorDamageFactorExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*BulletType*/, 4 /*Japan.BulletType*/, 4, false)
      && verifier.VerifyField(tablePos, 8 /*ArmorType*/, 4 /*Japan.ArmorType*/, 4, false)
      && verifier.VerifyField(tablePos, 10 /*DamageRate*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 12 /*DamageAttribute*/, 4 /*Japan.DamageAttribute*/, 4, false)
