...
public struct StatLevelInterpolationExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.StatLevelInterpolationExcel> CreateStatLevelInterpolationExcel(FlatBufferBuilder builder,
      long Level = 0,
  ...
  public static Offset<Japan.StatLevelInterpolationExcel> EndStatLevelInterpolationExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.StatLevelInterpolationExcel>(o);
  }
  ...
  public static Offset<Japan.StatLevelInterpolationExcel> Pack(FlatBufferBuilder builder, StatLevelInterpolationExcelT _o) {
    if (_o == null) return default(Offset<Japan.StatLevelInterpolationExcel>);
		byte[] key = TableEncryptionService.CreateKey("StatLevelInterpolation");
