...
public struct AccountLevelExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.AccountLevelExcel> CreateAccountLevelExcel(FlatBufferBuilder builder,
      long Id = 0,
      long Level = 0,
      long Exp = 0,
  ...
  public static Offset<Japan.AccountLevelExcel> EndAccountLevelExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.AccountLevelExcel>(o);
  }
  ...
  public static Offset<Japan.AccountLevelExcel> Pack(FlatBufferBuilder builder, AccountLevelExcelT _o) {
    if (_o == null) return default(Offset<Japan.AccountLevelExcel>);
		byte[] key = TableEncryptionService.CreateKey("AccountLevel");
