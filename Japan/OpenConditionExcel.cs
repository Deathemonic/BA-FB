...
public struct OpenConditionExcel : IFlatbufferObject
{
  ...
  public Japan.OpenConditionContent OpenConditionContentType { get { int o = __p.__offset(4); return o != 0 ? (Japan.OpenConditionContent)__p.bb.GetInt(o + __p.bb_pos) : Japan.OpenConditionContent.Shop; } }
  ...
  public Japan.MultipleConditionCheckType MultipleConditionCheckType { get { int o = __p.__offset(24); return o != 0 ? (Japan.MultipleConditionCheckType)__p.bb.GetInt(o + __p.bb_pos) : Japan.MultipleConditionCheckType.And; } }
  public Japan.WeekDay OpenDayOfWeek { get { int o = __p.__offset(26); return o != 0 ? (Japan.WeekDay)__p.bb.GetInt(o + __p.bb_pos) : Japan.WeekDay.Sunday; } }
  public long OpenHour { get { int o = __p.__offset(28); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public Japan.WeekDay CloseDayOfWeek { get { int o = __p.__offset(30); return o != 0 ? (Japan.WeekDay)__p.bb.GetInt(o + __p.bb_pos) : Japan.WeekDay.Sunday; } }
  ...
  public static Offset<Japan.OpenConditionExcel> CreateOpenConditionExcel(FlatBufferBuilder builder,
      Japan.OpenConditionContent OpenConditionContentType = Japan.OpenConditionContent.Shop,
      ...
      Japan.WeekDay OpenDayOfWeek = Japan.WeekDay.Sunday,
      long OpenHour = 0,
      Japan.WeekDay CloseDayOfWeek = Japan.WeekDay.Sunday,
      long CloseHour = 0,
      long OpenedCafeId = 0,
  ...
  public static void AddOpenConditionContentType(FlatBufferBuilder builder, Japan.OpenConditionContent openConditionContentType) { builder.AddInt(0, (int)openConditionContentType, 0); }
  ...
  public static void AddMultipleConditionCheckType(FlatBufferBuilder builder, Japan.MultipleConditionCheckType multipleConditionCheckType) { builder.AddInt(10, (int)multipleConditionCheckType, 0); }
  public static void AddOpenDayOfWeek(FlatBufferBuilder builder, Japan.WeekDay openDayOfWeek) { builder.AddInt(11, (int)openDayOfWeek, 0); }
  public static void AddOpenHour(FlatBufferBuilder builder, long openHour) { builder.AddLong(12, openHour, 0); }
  public static void AddCloseDayOfWeek(FlatBufferBuilder builder, Japan.WeekDay closeDayOfWeek) { builder.AddInt(13, (int)closeDayOfWeek, 0); }
  ...
  public static Offset<Japan.OpenConditionExcel> EndOpenConditionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.OpenConditionExcel>(o);
  }
  ...
  public void UnPackTo(OpenConditionExcelT _o) {
    ...
    _o.OpenConditionContentType = TableEncryptionService.UseEncryption ? (Japan.OpenConditionContent)TableEncryptionService.Convert((int)this.OpenConditionContentType, key) : this.OpenConditionContentType;
    ...
    _o.OpenDayOfWeek = TableEncryptionService.UseEncryption ? (Japan.WeekDay)TableEncryptionService.Convert((int)this.OpenDayOfWeek, key) : this.OpenDayOfWeek;
    _o.OpenHour = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.OpenHour, key) : this.OpenHour;
    _o.CloseDayOfWeek = TableEncryptionService.UseEncryption ? (Japan.WeekDay)TableEncryptionService.Convert((int)this.CloseDayOfWeek, key) : this.CloseDayOfWeek;
  ...
  public static Offset<Japan.OpenConditionExcel> Pack(FlatBufferBuilder builder, OpenConditionExcelT _o) {
    if (_o == null) return default(Offset<Japan.OpenConditionExcel>);
		byte[] key = TableEncryptionService.CreateKey("OpenCondition");
		var _OpenConditionContentType = TableEncryptionService.UseEncryption ? (Japan.OpenConditionContent)TableEncryptionService.Convert((int)_o.OpenConditionContentType, key) : _o.OpenConditionContentType;
    ...
    var _Scene = _o.Scene == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.Scene, key) : _o.Scene));
		...
		var _OpenDayOfWeek = TableEncryptionService.UseEncryption ? (Japan.WeekDay)TableEncryptionService.Convert((int)_o.OpenDayOfWeek, key) : _o.OpenDayOfWeek;
		var _OpenHour = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.OpenHour, key) : _o.OpenHour;
		var _CloseDayOfWeek = TableEncryptionService.UseEncryption ? (Japan.WeekDay)TableEncryptionService.Convert((int)_o.CloseDayOfWeek, key) : _o.CloseDayOfWeek;
...
{
  public Japan.OpenConditionContent OpenConditionContentType { get; set; }
  ...
  public Japan.WeekDay OpenDayOfWeek { get; set; }
  public long OpenHour { get; set; }
  public Japan.WeekDay CloseDayOfWeek { get; set; }
  ...
  public OpenConditionExcelT() {
    this.OpenConditionContentType = Japan.OpenConditionContent.Shop;
    this.LockUI = null;
    ...
    this.OpenDayOfWeek = Japan.WeekDay.Sunday;
    this.OpenHour = 0;
    this.CloseDayOfWeek = Japan.WeekDay.Sunday;
    this.CloseHour = 0;
    this.OpenedCafeId = 0;
...
static public class OpenConditionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyField(tablePos, 4 /*OpenConditionContentType*/, 4 /*Japan.OpenConditionContent*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 24 /*MultipleConditionCheckType*/, 4 /*Japan.MultipleConditionCheckType*/, 4, false)
      && verifier.VerifyField(tablePos, 26 /*OpenDayOfWeek*/, 4 /*Japan.WeekDay*/, 4, false)
      && verifier.VerifyField(tablePos, 28 /*OpenHour*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 30 /*CloseDayOfWeek*/, 4 /*Japan.WeekDay*/, 4, false)
