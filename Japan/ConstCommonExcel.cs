...
public struct ConstCommonExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.ConstCommonExcel> EndConstCommonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ConstCommonExcel>(o);
  }
  ...
  public static Offset<Japan.ConstCommonExcel> Pack(FlatBufferBuilder builder, ConstCommonExcelT _o) {
    if (_o == null) return default(Offset<Japan.ConstCommonExcel>);
		byte[] key = TableEncryptionService.CreateKey("ConstCommon");
