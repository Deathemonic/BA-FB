...
public struct HpBarAbbreviationExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.HpBarAbbreviationExcel> CreateHpBarAbbreviationExcel(FlatBufferBuilder builder,
      int MonsterLv = 0,
      int StandardHpBar = 0,
      int RaidBossHpBar = 0) {
  ...
  public static Offset<Japan.HpBarAbbreviationExcel> EndHpBarAbbreviationExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.HpBarAbbreviationExcel>(o);
  }
  ...
  public static Offset<Japan.HpBarAbbreviationExcel> Pack(FlatBufferBuilder builder, HpBarAbbreviationExcelT _o) {
    if (_o == null) return default(Offset<Japan.HpBarAbbreviationExcel>);
		byte[] key = TableEncryptionService.CreateKey("HpBarAbbreviation");
