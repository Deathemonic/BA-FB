...
public struct MultiFloorRaidSeasonManageExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.MultiFloorRaidSeasonManageExcel> CreateMultiFloorRaidSeasonManageExcel(FlatBufferBuilder builder,
      long SeasonId = 0,
  ...
  public static Offset<Japan.MultiFloorRaidSeasonManageExcel> EndMultiFloorRaidSeasonManageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.MultiFloorRaidSeasonManageExcel>(o);
  }
  ...
  public static Offset<Japan.MultiFloorRaidSeasonManageExcel> Pack(FlatBufferBuilder builder, MultiFloorRaidSeasonManageExcelT _o) {
    if (_o == null) return default(Offset<Japan.MultiFloorRaidSeasonManageExcel>);
		byte[] key = TableEncryptionService.CreateKey("MultiFloorRaidSeasonManage");
