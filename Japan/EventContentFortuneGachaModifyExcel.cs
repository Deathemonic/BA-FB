...
public struct EventContentFortuneGachaModifyExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.EventContentFortuneGachaModifyExcel> CreateEventContentFortuneGachaModifyExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.EventContentFortuneGachaModifyExcel> EndEventContentFortuneGachaModifyExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.EventContentFortuneGachaModifyExcel>(o);
  }
  ...
  public static Offset<Japan.EventContentFortuneGachaModifyExcel> Pack(FlatBufferBuilder builder, EventContentFortuneGachaModifyExcelT _o) {
    if (_o == null) return default(Offset<Japan.EventContentFortuneGachaModifyExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentFortuneGachaModify");
