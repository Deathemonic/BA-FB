...
public struct MiniGameAudioAnimatorExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.MiniGameAudioAnimatorExcel> CreateMiniGameAudioAnimatorExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.MiniGameAudioAnimatorExcel> EndMiniGameAudioAnimatorExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.MiniGameAudioAnimatorExcel>(o);
  }
  ...
  public static Offset<Japan.MiniGameAudioAnimatorExcel> Pack(FlatBufferBuilder builder, MiniGameAudioAnimatorExcelT _o) {
    if (_o == null) return default(Offset<Japan.MiniGameAudioAnimatorExcel>);
		byte[] key = TableEncryptionService.CreateKey("MiniGameAudioAnimator");
