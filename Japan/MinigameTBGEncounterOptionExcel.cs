...
public struct MinigameTBGEncounterOptionExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.MinigameTBGEncounterOptionExcel> CreateMinigameTBGEncounterOptionExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.MinigameTBGEncounterOptionExcel> EndMinigameTBGEncounterOptionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.MinigameTBGEncounterOptionExcel>(o);
  }
  ...
  public static Offset<Japan.MinigameTBGEncounterOptionExcel> Pack(FlatBufferBuilder builder, MinigameTBGEncounterOptionExcelT _o) {
    if (_o == null) return default(Offset<Japan.MinigameTBGEncounterOptionExcel>);
		byte[] key = TableEncryptionService.CreateKey("MinigameTBGEncounterOption");
