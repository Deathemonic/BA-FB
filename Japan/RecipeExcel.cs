...
public struct RecipeExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.RecipeExcel> CreateRecipeExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Japan.RecipeExcel> EndRecipeExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.RecipeExcel>(o);
  }
  ...
  public void UnPackTo(RecipeExcelT _o) {
    ...
    _o.RecipeSelectionGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.RecipeSelectionGroupId, key) : this.RecipeSelectionGroupId;
  ...
  public static Offset<Japan.RecipeExcel> Pack(FlatBufferBuilder builder, RecipeExcelT _o) {
    if (_o == null) return default(Offset<Japan.RecipeExcel>);
		byte[] key = TableEncryptionService.CreateKey("Recipe");
		...
		var _RecipeSelectionGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.RecipeSelectionGroupId, key) : _o.RecipeSelectionGroupId;
