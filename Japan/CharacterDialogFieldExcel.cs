...
public struct CharacterDialogFieldExcel : IFlatbufferObject
{
  ...
  public Japan.FieldDialogType DialogType { get { int o = __p.__offset(10); return o != 0 ? (Japan.FieldDialogType)__p.bb.GetInt(o + __p.bb_pos) : Japan.FieldDialogType.None; } }
  ...
  public static Offset<Japan.CharacterDialogFieldExcel> CreateCharacterDialogFieldExcel(FlatBufferBuilder builder,
      long GroupId = 0,
      int Phase = 0,
      int TargetIndex = 0,
      Japan.FieldDialogType DialogType = Japan.FieldDialogType.None,
      long Duration = 0,
  ...
  public static void AddDialogType(FlatBufferBuilder builder, Japan.FieldDialogType dialogType) { builder.AddInt(3, (int)dialogType, 0); }
  ...
  public static Offset<Japan.CharacterDialogFieldExcel> EndCharacterDialogFieldExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.CharacterDialogFieldExcel>(o);
  }
  ...
  public static Offset<Japan.CharacterDialogFieldExcel> Pack(FlatBufferBuilder builder, CharacterDialogFieldExcelT _o) {
    if (_o == null) return default(Offset<Japan.CharacterDialogFieldExcel>);
		byte[] key = TableEncryptionService.CreateKey("CharacterDialogField");
...
public class CharacterDialogFieldExcelT
{
  ...
  public Japan.FieldDialogType DialogType { get; set; }
  ...
  public CharacterDialogFieldExcelT() {
    ...
    this.Phase = 0;
    this.TargetIndex = 0;
    this.DialogType = Japan.FieldDialogType.None;
    this.Duration = 0;
...
static public class CharacterDialogFieldExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*DialogType*/, 4 /*Japan.FieldDialogType*/, 4, false)
