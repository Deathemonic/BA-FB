...
public struct CharacterDialogFieldExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(CharacterDialogFieldExcelT _o) {
    ...
    _o.DialogType = TableEncryptionService.UseEncryption ? (Japan.FieldDialogType)TableEncryptionService.Convert((int)this.DialogType, key) : this.DialogType;
  ...
  public static Offset<Japan.CharacterDialogFieldExcel> Pack(FlatBufferBuilder builder, CharacterDialogFieldExcelT _o) {
    if (_o == null) return default(Offset<Japan.CharacterDialogFieldExcel>);
		...
		var _DialogType = TableEncryptionService.UseEncryption ? (Japan.FieldDialogType)TableEncryptionService.Convert((int)_o.DialogType, key) : _o.DialogType;
