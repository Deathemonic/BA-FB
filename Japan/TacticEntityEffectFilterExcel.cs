...
public struct TacticEntityEffectFilterExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.TacticEntityEffectFilterExcel> CreateTacticEntityEffectFilterExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.TacticEntityEffectFilterExcel> EndTacticEntityEffectFilterExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.TacticEntityEffectFilterExcel>(o);
  }
  ...
  public static Offset<Japan.TacticEntityEffectFilterExcel> Pack(FlatBufferBuilder builder, TacticEntityEffectFilterExcelT _o) {
    if (_o == null) return default(Offset<Japan.TacticEntityEffectFilterExcel>);
		byte[] key = TableEncryptionService.CreateKey("TacticEntityEffectFilter");
