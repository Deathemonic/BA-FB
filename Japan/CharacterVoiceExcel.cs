...
public struct CharacterVoiceExcel : IFlatbufferObject
{
  ...
  public Japan.CVCollectionType CVCollectionType { get { int o = __p.__offset(18); return o != 0 ? (Japan.CVCollectionType)__p.bb.GetInt(o + __p.bb_pos) : Japan.CVCollectionType.CVNormal; } }
  ...
  public Japan.Nation Nation(int j) { int o = __p.__offset(24); return o != 0 ? (Japan.Nation)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.Nation)0; }
  public int NationLength { get { int o = __p.__offset(24); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.Nation> GetNationBytes() { return __p.__vector_as_span<Japan.Nation>(24, 4); }
#else
  public ArraySegment<byte>? GetNationBytes() { return __p.__vector_as_arraysegment(24); }
#endif
  public Japan.Nation[] GetNationArray() { int o = __p.__offset(24); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.Nation[] a = new Japan.Nation[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.Nation)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Japan.CharacterVoiceExcel> CreateCharacterVoiceExcel(FlatBufferBuilder builder,
  ...
  public static void AddCVCollectionType(FlatBufferBuilder builder, Japan.CVCollectionType cVCollectionType) { builder.AddInt(7, (int)cVCollectionType, 0); }
  ...
  public static Offset<Japan.CharacterVoiceExcel> EndCharacterVoiceExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.CharacterVoiceExcel>(o);
  }
  ...
  public void UnPackTo(CharacterVoiceExcelT _o) {
    ...
    _o.CharacterVoiceUniqueId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CharacterVoiceUniqueId, key) : this.CharacterVoiceUniqueId;
    ...
    _o.VoiceHash = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.VoiceHash, key) : this.VoiceHash;
    _o.OnlyOne = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.OnlyOne, key) : this.OnlyOne;
    ...
    for (var _j = 0; _j < this.DelayLength; ++_j) {_o.Delay.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Delay(_j), key) : this.Delay(_j));}
  ...
  public static Offset<Japan.CharacterVoiceExcel> Pack(FlatBufferBuilder builder, CharacterVoiceExcelT _o) {
    if (_o == null) return default(Offset<Japan.CharacterVoiceExcel>);
		byte[] key = TableEncryptionService.CreateKey("CharacterVoice");
		var _CharacterVoiceUniqueId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CharacterVoiceUniqueId, key) : _o.CharacterVoiceUniqueId;
		...
		var _VoiceHash = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.VoiceHash, key) : _o.VoiceHash;
		var _OnlyOne = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.OnlyOne, key) : _o.OnlyOne;
		var _Priority = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Priority, key) : _o.Priority;
    ...
    if (_o.Volume != null) {
      var __Volume = _o.Volume.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
      _Volume = CreateVolumeVector(builder, __Volume);
    }
    var _Delay = default(VectorOffset);
    if (_o.Delay != null) {
      var __Delay = _o.Delay.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
      _Delay = CreateDelayVector(builder, __Delay);
    }
    var _Path = default(VectorOffset);
    if (_o.Path != null) {
      var __Path = new StringOffset[_o.Path.Count];
      for (var _j = 0; _j < __Path.Length; ++_j) { __Path[_j] = builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.Path[_j], key) : _o.Path[_j])); }
...
static public class CharacterVoiceExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 18 /*CVCollectionType*/, 4 /*Japan.CVCollectionType*/, 4, false)
      && verifier.VerifyField(tablePos, 20 /*UnlockFavorRank*/, 8 /*long*/, 8, false)
      && verifier.VerifyString(tablePos, 22 /*LocalizeCVGroup*/, false)
      && verifier.VerifyVectorOfData(tablePos, 24 /*Nation*/, 4 /*Japan.Nation*/, false)
