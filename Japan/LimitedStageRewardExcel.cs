...
public struct LimitedStageRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.LimitedStageRewardExcel> CreateLimitedStageRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static Offset<Japan.LimitedStageRewardExcel> EndLimitedStageRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.LimitedStageRewardExcel>(o);
  }
  ...
  public static Offset<Japan.LimitedStageRewardExcel> Pack(FlatBufferBuilder builder, LimitedStageRewardExcelT _o) {
    if (_o == null) return default(Offset<Japan.LimitedStageRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("LimitedStageReward");
