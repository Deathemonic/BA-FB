...
public struct ConquestProgressResourceExcel : IFlatbufferObject
{
  ...
  public Japan.ConquestProgressType Group { get { int o = __p.__offset(8); return o != 0 ? (Japan.ConquestProgressType)__p.bb.GetInt(o + __p.bb_pos) : Japan.ConquestProgressType.None; } }
  ...
  public static Offset<Japan.ConquestProgressResourceExcel> CreateConquestProgressResourceExcel(FlatBufferBuilder builder,
      long Id = 0,
      long EventContentId = 0,
      Japan.ConquestProgressType Group = Japan.ConquestProgressType.None,
  ...
  public static void AddGroup(FlatBufferBuilder builder, Japan.ConquestProgressType group) { builder.AddInt(2, (int)group, 0); }
  ...
  public static Offset<Japan.ConquestProgressResourceExcel> EndConquestProgressResourceExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ConquestProgressResourceExcel>(o);
  }
  ...
  public void UnPackTo(ConquestProgressResourceExcelT _o) {
    ...
    _o.Group = TableEncryptionService.UseEncryption ? (Japan.ConquestProgressType)TableEncryptionService.Convert((int)this.Group, key) : this.Group;
    _o.ProgressResource = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ProgressResource, key) : this.ProgressResource;
    ...
    _o.ProgressLocalizeCode = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ProgressLocalizeCode, key) : this.ProgressLocalizeCode;
  }
  public static Offset<Japan.ConquestProgressResourceExcel> Pack(FlatBufferBuilder builder, ConquestProgressResourceExcelT _o) {
    if (_o == null) return default(Offset<Japan.ConquestProgressResourceExcel>);
		byte[] key = TableEncryptionService.CreateKey("ConquestProgressResource");
		...
		var _Group = TableEncryptionService.UseEncryption ? (Japan.ConquestProgressType)TableEncryptionService.Convert((int)_o.Group, key) : _o.Group;
    var _ProgressResource = _o.ProgressResource == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.ProgressResource, key) : _o.ProgressResource));
    ...
    var _ProgressLocalizeCode = _o.ProgressLocalizeCode == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.ProgressLocalizeCode, key) : _o.ProgressLocalizeCode));
...
public class ConquestProgressResourceExcelT
{
  ...
  public Japan.ConquestProgressType Group { get; set; }
  ...
  public ConquestProgressResourceExcelT() {
    ...
    this.Group = Japan.ConquestProgressType.None;
...
static public class ConquestProgressResourceExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*Group*/, 4 /*Japan.ConquestProgressType*/, 4, false)
