...
public struct ConstAudioExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.ConstAudioExcel> CreateConstAudioExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.ConstAudioExcel> EndConstAudioExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ConstAudioExcel>(o);
  }
  ...
  public static Offset<Japan.ConstAudioExcel> Pack(FlatBufferBuilder builder, ConstAudioExcelT _o) {
    if (_o == null) return default(Offset<Japan.ConstAudioExcel>);
		byte[] key = TableEncryptionService.CreateKey("ConstAudio");
