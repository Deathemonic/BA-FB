...
public struct GachaGroupExcel : IFlatbufferObject
{
  ...
  public Japan.GachaGroupType GroupType { get { int o = __p.__offset(10); return o != 0 ? (Japan.GachaGroupType)__p.bb.GetInt(o + __p.bb_pos) : Japan.GachaGroupType.None; } }

  public static Offset<Japan.GachaGroupExcel> CreateGachaGroupExcel(FlatBufferBuilder builder,
      long ID = 0,
      StringOffset NameKrOffset = default(StringOffset),
      bool IsRecursive = false,
      Japan.GachaGroupType GroupType = Japan.GachaGroupType.None) {
  ...
  public static void AddGroupType(FlatBufferBuilder builder, Japan.GachaGroupType groupType) { builder.AddInt(3, (int)groupType, 0); }
  public static Offset<Japan.GachaGroupExcel> EndGachaGroupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.GachaGroupExcel>(o);
  }
  ...
  public static Offset<Japan.GachaGroupExcel> Pack(FlatBufferBuilder builder, GachaGroupExcelT _o) {
    if (_o == null) return default(Offset<Japan.GachaGroupExcel>);
		byte[] key = TableEncryptionService.CreateKey("GachaGroup");
...
public class GachaGroupExcelT
{
  ...
  public Japan.GachaGroupType GroupType { get; set; }

  public GachaGroupExcelT() {
    this.ID = 0;
    this.NameKr = null;
    this.IsRecursive = false;
    this.GroupType = Japan.GachaGroupType.None;
  }
}
...
static public class GachaGroupExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*GroupType*/, 4 /*Japan.GachaGroupType*/, 4, false)
