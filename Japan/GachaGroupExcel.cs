...
public struct GachaGroupExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(GachaGroupExcelT _o) {
    ...
    _o.GroupType = TableEncryptionService.UseEncryption ? (Japan.GachaGroupType)TableEncryptionService.Convert((int)this.GroupType, key) : this.GroupType;
  }
  public static Offset<Japan.GachaGroupExcel> Pack(FlatBufferBuilder builder, GachaGroupExcelT _o) {
    ...
    var _NameKr = _o.NameKr == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.NameKr, key) : _o.NameKr));
		...
		var _GroupType = TableEncryptionService.UseEncryption ? (Japan.GachaGroupType)TableEncryptionService.Convert((int)_o.GroupType, key) : _o.GroupType;
