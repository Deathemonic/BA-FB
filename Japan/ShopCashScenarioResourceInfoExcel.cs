...
public struct ShopCashScenarioResourceInfoExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.ShopCashScenarioResourceInfoExcel> CreateShopCashScenarioResourceInfoExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.ShopCashScenarioResourceInfoExcel> EndShopCashScenarioResourceInfoExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ShopCashScenarioResourceInfoExcel>(o);
  }
  ...
  public static Offset<Japan.ShopCashScenarioResourceInfoExcel> Pack(FlatBufferBuilder builder, ShopCashScenarioResourceInfoExcelT _o) {
    if (_o == null) return default(Offset<Japan.ShopCashScenarioResourceInfoExcel>);
		byte[] key = TableEncryptionService.CreateKey("ShopCashScenarioResourceInfo");
