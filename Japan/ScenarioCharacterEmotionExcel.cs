...
public struct ScenarioCharacterEmotionExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.ScenarioCharacterEmotionExcel> CreateScenarioCharacterEmotionExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.ScenarioCharacterEmotionExcel> EndScenarioCharacterEmotionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ScenarioCharacterEmotionExcel>(o);
  }
  ...
  public static Offset<Japan.ScenarioCharacterEmotionExcel> Pack(FlatBufferBuilder builder, ScenarioCharacterEmotionExcelT _o) {
    if (_o == null) return default(Offset<Japan.ScenarioCharacterEmotionExcel>);
		byte[] key = TableEncryptionService.CreateKey("ScenarioCharacterEmotion");
