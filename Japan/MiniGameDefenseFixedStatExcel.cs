...
public struct MiniGameDefenseFixedStatExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.MiniGameDefenseFixedStatExcel> CreateMiniGameDefenseFixedStatExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.MiniGameDefenseFixedStatExcel> EndMiniGameDefenseFixedStatExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.MiniGameDefenseFixedStatExcel>(o);
  }
  ...
  public static Offset<Japan.MiniGameDefenseFixedStatExcel> Pack(FlatBufferBuilder builder, MiniGameDefenseFixedStatExcelT _o) {
    if (_o == null) return default(Offset<Japan.MiniGameDefenseFixedStatExcel>);
		byte[] key = TableEncryptionService.CreateKey("MiniGameDefenseFixedStat");
