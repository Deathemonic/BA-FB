...
public struct FieldWorldMapZoneExcel : IFlatbufferObject
{
  ...
  public Japan.FieldConditionType OpenConditionType { get { int o = __p.__offset(10); return o != 0 ? (Japan.FieldConditionType)__p.bb.GetInt(o + __p.bb_pos) : Japan.FieldConditionType.Invalid; } }
  public long OpenConditionId { get { int o = __p.__offset(12); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public Japan.FieldConditionType CloseConditionType { get { int o = __p.__offset(14); return o != 0 ? (Japan.FieldConditionType)__p.bb.GetInt(o + __p.bb_pos) : Japan.FieldConditionType.Invalid; } }
  ...
  public Japan.FieldWorldMapButtonType WorldMapButtonType { get { int o = __p.__offset(22); return o != 0 ? (Japan.FieldWorldMapButtonType)__p.bb.GetInt(o + __p.bb_pos) : Japan.FieldWorldMapButtonType.DefaultMode; } }
  ...
  public static Offset<Japan.FieldWorldMapZoneExcel> CreateFieldWorldMapZoneExcel(FlatBufferBuilder builder,
      long Id = 0,
      int GroupId = 0,
      int Date = 0,
      Japan.FieldConditionType OpenConditionType = Japan.FieldConditionType.Invalid,
      long OpenConditionId = 0,
      Japan.FieldConditionType CloseConditionType = Japan.FieldConditionType.Invalid,
      long CloseConditionId = 0,
      long ResultFieldScene = 0,
      long FieldStageInteractionId = 0,
      Japan.FieldWorldMapButtonType WorldMapButtonType = Japan.FieldWorldMapButtonType.DefaultMode,
      uint LocalizeCode = 0,
  ...
  public static void AddOpenConditionType(FlatBufferBuilder builder, Japan.FieldConditionType openConditionType) { builder.AddInt(3, (int)openConditionType, 0); }
  public static void AddOpenConditionId(FlatBufferBuilder builder, long openConditionId) { builder.AddLong(4, openConditionId, 0); }
  public static void AddCloseConditionType(FlatBufferBuilder builder, Japan.FieldConditionType closeConditionType) { builder.AddInt(5, (int)closeConditionType, 0); }
  ...
  public static void AddWorldMapButtonType(FlatBufferBuilder builder, Japan.FieldWorldMapButtonType worldMapButtonType) { builder.AddInt(9, (int)worldMapButtonType, 0); }
  ...
  public static Offset<Japan.FieldWorldMapZoneExcel> EndFieldWorldMapZoneExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.FieldWorldMapZoneExcel>(o);
  }
  ...
  public void UnPackTo(FieldWorldMapZoneExcelT _o) {
    ...
    _o.Date = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Date, key) : this.Date;
    _o.OpenConditionType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.OpenConditionType, key) : this.OpenConditionType;
    _o.OpenConditionId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.OpenConditionId, key) : this.OpenConditionId;
    _o.CloseConditionType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CloseConditionType, key) : this.CloseConditionType;
    _o.CloseConditionId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CloseConditionId, key) : this.CloseConditionId;
    _o.ResultFieldScene = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ResultFieldScene, key) : this.ResultFieldScene;
    _o.FieldStageInteractionId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.FieldStageInteractionId, key) : this.FieldStageInteractionId;
    _o.WorldMapButtonType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.WorldMapButtonType, key) : this.WorldMapButtonType;
    ...
    _o.NewTagDisplay = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.NewTagDisplay, key) : this.NewTagDisplay;
  }
  public static Offset<Japan.FieldWorldMapZoneExcel> Pack(FlatBufferBuilder builder, FieldWorldMapZoneExcelT _o) {
    if (_o == null) return default(Offset<Japan.FieldWorldMapZoneExcel>);
		byte[] key = TableEncryptionService.CreateKey("FieldWorldMapZone");
		...
		var _Date = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Date, key) : _o.Date;
		var _OpenConditionType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.OpenConditionType, key) : _o.OpenConditionType;
		var _OpenConditionId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.OpenConditionId, key) : _o.OpenConditionId;
		var _CloseConditionType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CloseConditionType, key) : _o.CloseConditionType;
		var _CloseConditionId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CloseConditionId, key) : _o.CloseConditionId;
		var _ResultFieldScene = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ResultFieldScene, key) : _o.ResultFieldScene;
		var _FieldStageInteractionId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.FieldStageInteractionId, key) : _o.FieldStageInteractionId;
		var _WorldMapButtonType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.WorldMapButtonType, key) : _o.WorldMapButtonType;
		...
		var _NewTagDisplay = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.NewTagDisplay, key) : _o.NewTagDisplay;
...
public class FieldWorldMapZoneExcelT
{
  ...
  public Japan.FieldConditionType OpenConditionType { get; set; }
  public long OpenConditionId { get; set; }
  public Japan.FieldConditionType CloseConditionType { get; set; }
  public long CloseConditionId { get; set; }
  public long ResultFieldScene { get; set; }
  public long FieldStageInteractionId { get; set; }
  public Japan.FieldWorldMapButtonType WorldMapButtonType { get; set; }
  ...
  public FieldWorldMapZoneExcelT() {
    ...
    this.GroupId = 0;
    this.Date = 0;
    this.OpenConditionType = Japan.FieldConditionType.Invalid;
    this.OpenConditionId = 0;
    this.CloseConditionType = Japan.FieldConditionType.Invalid;
    this.CloseConditionId = 0;
    this.ResultFieldScene = 0;
    this.FieldStageInteractionId = 0;
    this.WorldMapButtonType = Japan.FieldWorldMapButtonType.DefaultMode;
    this.LocalizeCode = 0;
...
static public class FieldWorldMapZoneExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*OpenConditionType*/, 4 /*Japan.FieldConditionType*/, 4, false)
      && verifier.VerifyField(tablePos, 12 /*OpenConditionId*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 14 /*CloseConditionType*/, 4 /*Japan.FieldConditionType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 22 /*WorldMapButtonType*/, 4 /*Japan.FieldWorldMapButtonType*/, 4, false)
