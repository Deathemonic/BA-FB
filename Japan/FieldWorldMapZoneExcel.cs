...
public struct FieldWorldMapZoneExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(FieldWorldMapZoneExcelT _o) {
    ...
    _o.OpenConditionType = TableEncryptionService.UseEncryption ? (Japan.FieldConditionType)TableEncryptionService.Convert((int)this.OpenConditionType, key) : this.OpenConditionType;
    ...
    _o.CloseConditionType = TableEncryptionService.UseEncryption ? (Japan.FieldConditionType)TableEncryptionService.Convert((int)this.CloseConditionType, key) : this.CloseConditionType;
    ...
    _o.WorldMapButtonType = TableEncryptionService.UseEncryption ? (Japan.FieldWorldMapButtonType)TableEncryptionService.Convert((int)this.WorldMapButtonType, key) : this.WorldMapButtonType;
  ...
  public static Offset<Japan.FieldWorldMapZoneExcel> Pack(FlatBufferBuilder builder, FieldWorldMapZoneExcelT _o) {
    if (_o == null) return default(Offset<Japan.FieldWorldMapZoneExcel>);
		...
		var _OpenConditionType = TableEncryptionService.UseEncryption ? (Japan.FieldConditionType)TableEncryptionService.Convert((int)_o.OpenConditionType, key) : _o.OpenConditionType;
		...
		var _CloseConditionType = TableEncryptionService.UseEncryption ? (Japan.FieldConditionType)TableEncryptionService.Convert((int)_o.CloseConditionType, key) : _o.CloseConditionType;
		...
		var _WorldMapButtonType = TableEncryptionService.UseEncryption ? (Japan.FieldWorldMapButtonType)TableEncryptionService.Convert((int)_o.WorldMapButtonType, key) : _o.WorldMapButtonType;
