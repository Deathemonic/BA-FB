...
public struct ContentEnterCostReduceExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ContentEnterCostReduceExcelT _o) {
    ...
    _o.ReduceEnterCostType = TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)this.ReduceEnterCostType, key) : this.ReduceEnterCostType;
  ...
  public static Offset<Japan.ContentEnterCostReduceExcel> Pack(FlatBufferBuilder builder, ContentEnterCostReduceExcelT _o) {
    if (_o == null) return default(Offset<Japan.ContentEnterCostReduceExcel>);
		...
		var _ReduceEnterCostType = TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)_o.ReduceEnterCostType, key) : _o.ReduceEnterCostType;
