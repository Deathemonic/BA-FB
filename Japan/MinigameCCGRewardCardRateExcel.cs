...
public struct MinigameCCGRewardCardRateExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.MinigameCCGRewardCardRateExcel> CreateMinigameCCGRewardCardRateExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.MinigameCCGRewardCardRateExcel> EndMinigameCCGRewardCardRateExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.MinigameCCGRewardCardRateExcel>(o);
  }
  ...
  public static Offset<Japan.MinigameCCGRewardCardRateExcel> Pack(FlatBufferBuilder builder, MinigameCCGRewardCardRateExcelT _o) {
    if (_o == null) return default(Offset<Japan.MinigameCCGRewardCardRateExcel>);
		byte[] key = TableEncryptionService.CreateKey("MinigameCCGRewardCardRate");
		var _RarityGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RarityGroupId, key) : _o.RarityGroupId;
