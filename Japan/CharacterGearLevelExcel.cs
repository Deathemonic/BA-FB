...
public struct CharacterGearLevelExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.CharacterGearLevelExcel> CreateCharacterGearLevelExcel(FlatBufferBuilder builder,
      int Level = 0,
  ...
  public static Offset<Japan.CharacterGearLevelExcel> EndCharacterGearLevelExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.CharacterGearLevelExcel>(o);
  }
  ...
  public static Offset<Japan.CharacterGearLevelExcel> Pack(FlatBufferBuilder builder, CharacterGearLevelExcelT _o) {
    if (_o == null) return default(Offset<Japan.CharacterGearLevelExcel>);
		byte[] key = TableEncryptionService.CreateKey("CharacterGearLevel");
