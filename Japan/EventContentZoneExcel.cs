...
public struct EventContentZoneExcel : IFlatbufferObject
{
  ...
  public Japan.Tag Tags(int j) { int o = __p.__offset(20); return o != 0 ? (Japan.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.Tag)0; }
  public int TagsLength { get { int o = __p.__offset(20); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.Tag> GetTagsBytes() { return __p.__vector_as_span<Japan.Tag>(20, 4); }
#else
  public ArraySegment<byte>? GetTagsBytes() { return __p.__vector_as_arraysegment(20); }
#endif
  public Japan.Tag[] GetTagsArray() { int o = __p.__offset(20); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.Tag[] a = new Japan.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.Tag)__p.bb.GetInt(p + i * 4); } return a; }
  public Japan.Tag WhiteListTags(int j) { int o = __p.__offset(22); return o != 0 ? (Japan.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.Tag)0; }
  public int WhiteListTagsLength { get { int o = __p.__offset(22); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.Tag> GetWhiteListTagsBytes() { return __p.__vector_as_span<Japan.Tag>(22, 4); }
#else
  public ArraySegment<byte>? GetWhiteListTagsBytes() { return __p.__vector_as_arraysegment(22); }
#endif
  public Japan.Tag[] GetWhiteListTagsArray() { int o = __p.__offset(22); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.Tag[] a = new Japan.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.Tag)__p.bb.GetInt(p + i * 4); } return a; }

  public static Offset<Japan.EventContentZoneExcel> CreateEventContentZoneExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static VectorOffset CreateWhiteListTagsVector(FlatBufferBuilder builder, Japan.Tag[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateWhiteListTagsVectorBlock(FlatBufferBuilder builder, Japan.Tag[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateWhiteListTagsVectorBlock(FlatBufferBuilder builder, ArraySegment<Japan.Tag> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateWhiteListTagsVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Japan.Tag>(dataPtr, sizeInBytes); return builder.EndVector(); }
  public static void StartWhiteListTagsVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static Offset<Japan.EventContentZoneExcel> EndEventContentZoneExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.EventContentZoneExcel>(o);
  }
  ...
  public void UnPackTo(EventContentZoneExcelT _o) {
    ...
    _o.WhiteListTags = new List<Japan.Tag>();
    for (var _j = 0; _j < this.WhiteListTagsLength; ++_j) {_o.WhiteListTags.Add(TableEncryptionService.UseEncryption ? (Japan.Tag)TableEncryptionService.Convert((int)this.WhiteListTags(_j), key) : this.WhiteListTags(_j));}
  }
  public static Offset<Japan.EventContentZoneExcel> Pack(FlatBufferBuilder builder, EventContentZoneExcelT _o) {
    if (_o == null) return default(Offset<Japan.EventContentZoneExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentZone");
    ...
    if (_o.WhiteListTags != null) {
      var __WhiteListTags = _o.WhiteListTags.Select(x => TableEncryptionService.UseEncryption ? (Japan.Tag)TableEncryptionService.Convert((int)x, key) : x).ToArray();
...
public class EventContentZoneExcelT
{
  ...
  public List<Japan.Tag> WhiteListTags { get; set; }
...
static public class EventContentZoneExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 20 /*Tags*/, 4 /*Japan.Tag*/, false)
      && verifier.VerifyVectorOfData(tablePos, 22 /*WhiteListTags*/, 4 /*Japan.Tag*/, false)
