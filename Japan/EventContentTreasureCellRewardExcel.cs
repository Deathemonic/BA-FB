...
public struct EventContentTreasureCellRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.EventContentTreasureCellRewardExcel> CreateEventContentTreasureCellRewardExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Japan.EventContentTreasureCellRewardExcel> EndEventContentTreasureCellRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.EventContentTreasureCellRewardExcel>(o);
  }
  ...
  public static Offset<Japan.EventContentTreasureCellRewardExcel> Pack(FlatBufferBuilder builder, EventContentTreasureCellRewardExcelT _o) {
    if (_o == null) return default(Offset<Japan.EventContentTreasureCellRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentTreasureCellReward");
