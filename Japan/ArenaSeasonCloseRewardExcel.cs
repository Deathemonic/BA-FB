...
public struct ArenaSeasonCloseRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.ArenaSeasonCloseRewardExcel> CreateArenaSeasonCloseRewardExcel(FlatBufferBuilder builder,
      long SeasonId = 0,
      long RankStart = 0,
      long RankEnd = 0,
  ...
  public static Offset<Japan.ArenaSeasonCloseRewardExcel> EndArenaSeasonCloseRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ArenaSeasonCloseRewardExcel>(o);
  }
  ...
  public static Offset<Japan.ArenaSeasonCloseRewardExcel> Pack(FlatBufferBuilder builder, ArenaSeasonCloseRewardExcelT _o) {
    if (_o == null) return default(Offset<Japan.ArenaSeasonCloseRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("ArenaSeasonCloseReward");
