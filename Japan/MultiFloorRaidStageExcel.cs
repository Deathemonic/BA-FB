...
public struct MultiFloorRaidStageExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.MultiFloorRaidStageExcel> CreateMultiFloorRaidStageExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Japan.MultiFloorRaidStageExcel> EndMultiFloorRaidStageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.MultiFloorRaidStageExcel>(o);
  }
  ...
  public void UnPackTo(MultiFloorRaidStageExcelT _o) {
    ...
    _o.AssistSlot = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.AssistSlot, key) : this.AssistSlot;
    _o.StageOpenCondition = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StageOpenCondition, key) : this.StageOpenCondition;
    _o.FloorListSection = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.FloorListSection, key) : this.FloorListSection;
    _o.FloorListSectionOpenCondition = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.FloorListSectionOpenCondition, key) : this.FloorListSectionOpenCondition;
    _o.FloorListSectionLabel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.FloorListSectionLabel, key) : this.FloorListSectionLabel;
    ...
    for (var _j = 0; _j < this.StatChangeIdLength; ++_j) {_o.StatChangeId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StatChangeId(_j), key) : this.StatChangeId(_j));}
  ...
  public static Offset<Japan.MultiFloorRaidStageExcel> Pack(FlatBufferBuilder builder, MultiFloorRaidStageExcelT _o) {
    if (_o == null) return default(Offset<Japan.MultiFloorRaidStageExcel>);
		byte[] key = TableEncryptionService.CreateKey("MultiFloorRaidStage");
    ...
    var _BossGroupId = _o.BossGroupId == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.BossGroupId, key) : _o.BossGroupId));
		var _AssistSlot = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.AssistSlot, key) : _o.AssistSlot;
		var _StageOpenCondition = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StageOpenCondition, key) : _o.StageOpenCondition;
		var _FloorListSection = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.FloorListSection, key) : _o.FloorListSection;
		var _FloorListSectionOpenCondition = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.FloorListSectionOpenCondition, key) : _o.FloorListSectionOpenCondition;
		var _FloorListSectionLabel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.FloorListSectionLabel, key) : _o.FloorListSectionLabel;
    ...
    var _FloorListImgPath = _o.FloorListImgPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.FloorListImgPath, key) : _o.FloorListImgPath));
    var _FloorImgPath = _o.FloorImgPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.FloorImgPath, key) : _o.FloorImgPath));
    ...
    if (_o.StatChangeId != null) {
      var __StatChangeId = _o.StatChangeId.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
