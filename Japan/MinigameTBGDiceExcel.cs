...
public struct MinigameTBGDiceExcel : IFlatbufferObject
{
  ...
  public Japan.TBGProbModifyCondition ProbModifyCondition(int j) { int o = __p.__offset(14); return o != 0 ? (Japan.TBGProbModifyCondition)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.TBGProbModifyCondition)0; }
  public int ProbModifyConditionLength { get { int o = __p.__offset(14); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.TBGProbModifyCondition> GetProbModifyConditionBytes() { return __p.__vector_as_span<Japan.TBGProbModifyCondition>(14, 4); }
#else
  public ArraySegment<byte>? GetProbModifyConditionBytes() { return __p.__vector_as_arraysegment(14); }
#endif
  public Japan.TBGProbModifyCondition[] GetProbModifyConditionArray() { int o = __p.__offset(14); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.TBGProbModifyCondition[] a = new Japan.TBGProbModifyCondition[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.TBGProbModifyCondition)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Japan.MinigameTBGDiceExcel> CreateMinigameTBGDiceExcel(FlatBufferBuilder builder,
  ...
  public static VectorOffset CreateProbModifyConditionVector(FlatBufferBuilder builder, Japan.TBGProbModifyCondition[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateProbModifyConditionVectorBlock(FlatBufferBuilder builder, Japan.TBGProbModifyCondition[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateProbModifyConditionVectorBlock(FlatBufferBuilder builder, ArraySegment<Japan.TBGProbModifyCondition> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateProbModifyConditionVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Japan.TBGProbModifyCondition>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Japan.MinigameTBGDiceExcel> EndMinigameTBGDiceExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.MinigameTBGDiceExcel>(o);
  }
  ...
  public void UnPackTo(MinigameTBGDiceExcelT _o) {
    ...
    _o.ProbModifyCondition = new List<Japan.TBGProbModifyCondition>();
    for (var _j = 0; _j < this.ProbModifyConditionLength; ++_j) {_o.ProbModifyCondition.Add(TableEncryptionService.UseEncryption ? (Japan.TBGProbModifyCondition)TableEncryptionService.Convert((int)this.ProbModifyCondition(_j), key) : this.ProbModifyCondition(_j));}
  ...
  public static Offset<Japan.MinigameTBGDiceExcel> Pack(FlatBufferBuilder builder, MinigameTBGDiceExcelT _o) {
    if (_o == null) return default(Offset<Japan.MinigameTBGDiceExcel>);
		byte[] key = TableEncryptionService.CreateKey("MinigameTBGDice");
    ...
    if (_o.ProbModifyCondition != null) {
      var __ProbModifyCondition = _o.ProbModifyCondition.Select(x => TableEncryptionService.UseEncryption ? (Japan.TBGProbModifyCondition)TableEncryptionService.Convert((int)x, key) : x).ToArray();
...
public class MinigameTBGDiceExcelT
{
  ...
  public List<Japan.TBGProbModifyCondition> ProbModifyCondition { get; set; }
...
static public class MinigameTBGDiceExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 14 /*ProbModifyCondition*/, 4 /*Japan.TBGProbModifyCondition*/, false)
