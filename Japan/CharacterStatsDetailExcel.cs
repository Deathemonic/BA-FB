...
public struct CharacterStatsDetailExcel : IFlatbufferObject
{
  ...
  public Japan.StatType DetailShowStats(int j) { int o = __p.__offset(6); return o != 0 ? (Japan.StatType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.StatType)0; }
  public int DetailShowStatsLength { get { int o = __p.__offset(6); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.StatType> GetDetailShowStatsBytes() { return __p.__vector_as_span<Japan.StatType>(6, 4); }
#else
  public ArraySegment<byte>? GetDetailShowStatsBytes() { return __p.__vector_as_arraysegment(6); }
#endif
  public Japan.StatType[] GetDetailShowStatsArray() { int o = __p.__offset(6); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.StatType[] a = new Japan.StatType[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.StatType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Japan.CharacterStatsDetailExcel> CreateCharacterStatsDetailExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static VectorOffset CreateDetailShowStatsVector(FlatBufferBuilder builder, Japan.StatType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateDetailShowStatsVectorBlock(FlatBufferBuilder builder, Japan.StatType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateDetailShowStatsVectorBlock(FlatBufferBuilder builder, ArraySegment<Japan.StatType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateDetailShowStatsVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Japan.StatType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Japan.CharacterStatsDetailExcel> EndCharacterStatsDetailExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.CharacterStatsDetailExcel>(o);
  }
  ...
  public void UnPackTo(CharacterStatsDetailExcelT _o) {
    ...
    _o.DetailShowStats = new List<Japan.StatType>();
    for (var _j = 0; _j < this.DetailShowStatsLength; ++_j) {_o.DetailShowStats.Add(TableEncryptionService.UseEncryption ? (Japan.StatType)TableEncryptionService.Convert((int)this.DetailShowStats(_j), key) : this.DetailShowStats(_j));}
    _o.IsStatsPercent = new List<bool>();
    for (var _j = 0; _j < this.IsStatsPercentLength; ++_j) {_o.IsStatsPercent.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.IsStatsPercent(_j), key) : this.IsStatsPercent(_j));}
  }
  public static Offset<Japan.CharacterStatsDetailExcel> Pack(FlatBufferBuilder builder, CharacterStatsDetailExcelT _o) {
    if (_o == null) return default(Offset<Japan.CharacterStatsDetailExcel>);
		byte[] key = TableEncryptionService.CreateKey("CharacterStatsDetail");
		var _Id = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.Id, key) : _o.Id;
    var _DetailShowStats = default(VectorOffset);
    if (_o.DetailShowStats != null) {
      var __DetailShowStats = _o.DetailShowStats.Select(x => TableEncryptionService.UseEncryption ? (Japan.StatType)TableEncryptionService.Convert((int)x, key) : x).ToArray();
    ...
    if (_o.IsStatsPercent != null) {
      var __IsStatsPercent = _o.IsStatsPercent.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)x, key) : x).ToArray();
...
public class CharacterStatsDetailExcelT
{
  ...
  public List<Japan.StatType> DetailShowStats { get; set; }
...
static public class CharacterStatsDetailExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 6 /*DetailShowStats*/, 4 /*Japan.StatType*/, false)
