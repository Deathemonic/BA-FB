...
public struct CharacterStatsDetailExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(CharacterStatsDetailExcelT _o) {
    ...
    for (var _j = 0; _j < this.DetailShowStatsLength; ++_j) {_o.DetailShowStats.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.DetailShowStats(_j), key) : this.DetailShowStats(_j));}
    _o.IsStatsPercent = new List<bool>();
    for (var _j = 0; _j < this.IsStatsPercentLength; ++_j) {_o.IsStatsPercent.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.IsStatsPercent(_j), key) : this.IsStatsPercent(_j));}
  }
