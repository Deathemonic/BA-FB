...
public struct RecipeIngredientExcel : IFlatbufferObject
{
  ...
  public Japan.RecipeType RecipeType { get { int o = __p.__offset(6); return o != 0 ? (Japan.RecipeType)__p.bb.GetInt(o + __p.bb_pos) : Japan.RecipeType.None; } }
  public Japan.ParcelType CostParcelType(int j) { int o = __p.__offset(8); return o != 0 ? (Japan.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.ParcelType)0; }
  public int CostParcelTypeLength { get { int o = __p.__offset(8); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.ParcelType> GetCostParcelTypeBytes() { return __p.__vector_as_span<Japan.ParcelType>(8, 4); }
#else
  public ArraySegment<byte>? GetCostParcelTypeBytes() { return __p.__vector_as_arraysegment(8); }
#endif
  public Japan.ParcelType[] GetCostParcelTypeArray() { int o = __p.__offset(8); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.ParcelType[] a = new Japan.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Japan.ParcelType IngredientParcelType(int j) { int o = __p.__offset(14); return o != 0 ? (Japan.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.ParcelType)0; }
  public int IngredientParcelTypeLength { get { int o = __p.__offset(14); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.ParcelType> GetIngredientParcelTypeBytes() { return __p.__vector_as_span<Japan.ParcelType>(14, 4); }
#else
  public ArraySegment<byte>? GetIngredientParcelTypeBytes() { return __p.__vector_as_arraysegment(14); }
#endif
  public Japan.ParcelType[] GetIngredientParcelTypeArray() { int o = __p.__offset(14); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.ParcelType[] a = new Japan.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Japan.RecipeIngredientExcel> CreateRecipeIngredientExcel(FlatBufferBuilder builder,
      long Id = 0,
      Japan.RecipeType RecipeType = Japan.RecipeType.None,
  ...
  public static void AddRecipeType(FlatBufferBuilder builder, Japan.RecipeType recipeType) { builder.AddInt(1, (int)recipeType, 0); }
  ...
  public static VectorOffset CreateIngredientParcelTypeVector(FlatBufferBuilder builder, Japan.ParcelType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateIngredientParcelTypeVectorBlock(FlatBufferBuilder builder, Japan.ParcelType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateIngredientParcelTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Japan.ParcelType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateIngredientParcelTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Japan.ParcelType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Japan.RecipeIngredientExcel> EndRecipeIngredientExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.RecipeIngredientExcel>(o);
  }
  ...
  public void UnPackTo(RecipeIngredientExcelT _o) {
    ...
    _o.RecipeType = TableEncryptionService.UseEncryption ? (Japan.RecipeType)TableEncryptionService.Convert((int)this.RecipeType, key) : this.RecipeType;
    ...
    for (var _j = 0; _j < this.CostIdLength; ++_j) {_o.CostId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.CostId(_j), key) : this.CostId(_j));}
    _o.CostAmount = new List<long>();
    for (var _j = 0; _j < this.CostAmountLength; ++_j) {_o.CostAmount.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.CostAmount(_j), key) : this.CostAmount(_j));}
    _o.IngredientParcelType = new List<Japan.ParcelType>();
    for (var _j = 0; _j < this.IngredientParcelTypeLength; ++_j) {_o.IngredientParcelType.Add(TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)this.IngredientParcelType(_j), key) : this.IngredientParcelType(_j));}
    _o.IngredientId = new List<long>();
    for (var _j = 0; _j < this.IngredientIdLength; ++_j) {_o.IngredientId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.IngredientId(_j), key) : this.IngredientId(_j));}
    _o.IngredientAmount = new List<long>();
    for (var _j = 0; _j < this.IngredientAmountLength; ++_j) {_o.IngredientAmount.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.IngredientAmount(_j), key) : this.IngredientAmount(_j));}
    _o.CostTimeInSecond = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.CostTimeInSecond, key) : this.CostTimeInSecond;
  }
  public static Offset<Japan.RecipeIngredientExcel> Pack(FlatBufferBuilder builder, RecipeIngredientExcelT _o) {
    if (_o == null) return default(Offset<Japan.RecipeIngredientExcel>);
		byte[] key = TableEncryptionService.CreateKey("RecipeIngredient");
		var _Id = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.Id, key) : _o.Id;
		var _RecipeType = TableEncryptionService.UseEncryption ? (Japan.RecipeType)TableEncryptionService.Convert((int)_o.RecipeType, key) : _o.RecipeType;
    ...
    if (_o.CostId != null) {
      var __CostId = _o.CostId.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
      _CostId = CreateCostIdVector(builder, __CostId);
    }
    var _CostAmount = default(VectorOffset);
    if (_o.CostAmount != null) {
      var __CostAmount = _o.CostAmount.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
    ...
    if (_o.IngredientParcelType != null) {
      var __IngredientParcelType = _o.IngredientParcelType.Select(x => TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)x, key) : x).ToArray();
    ...
    if (_o.IngredientId != null) {
      var __IngredientId = _o.IngredientId.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
    ...
    if (_o.IngredientAmount != null) {
      var __IngredientAmount = _o.IngredientAmount.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
      _IngredientAmount = CreateIngredientAmountVector(builder, __IngredientAmount);
    }
		var _CostTimeInSecond = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.CostTimeInSecond, key) : _o.CostTimeInSecond;
...
public class RecipeIngredientExcelT
{
  ...
  public RecipeIngredientExcelT() {
    this.Id = 0;
    this.RecipeType = Japan.RecipeType.None;
...
static public class RecipeIngredientExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*RecipeType*/, 4 /*Japan.RecipeType*/, 4, false)
      && verifier.VerifyVectorOfData(tablePos, 8 /*CostParcelType*/, 4 /*Japan.ParcelType*/, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 14 /*IngredientParcelType*/, 4 /*Japan.ParcelType*/, false)
