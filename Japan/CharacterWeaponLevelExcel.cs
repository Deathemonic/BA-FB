...
public struct CharacterWeaponLevelExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.CharacterWeaponLevelExcel> CreateCharacterWeaponLevelExcel(FlatBufferBuilder builder,
      int Level = 0,
      long Exp = 0,
      long TotalExp = 0) {
  ...
  public static Offset<Japan.CharacterWeaponLevelExcel> EndCharacterWeaponLevelExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.CharacterWeaponLevelExcel>(o);
  }
  ...
  public static Offset<Japan.CharacterWeaponLevelExcel> Pack(FlatBufferBuilder builder, CharacterWeaponLevelExcelT _o) {
    if (_o == null) return default(Offset<Japan.CharacterWeaponLevelExcel>);
		byte[] key = TableEncryptionService.CreateKey("CharacterWeaponLevel");
