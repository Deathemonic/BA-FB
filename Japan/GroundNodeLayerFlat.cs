...
public struct GroundNodeLayerFlat : IFlatbufferObject
{
  ...
  public static Offset<Japan.GroundNodeLayerFlat> CreateGroundNodeLayerFlat(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.GroundNodeLayerFlat> EndGroundNodeLayerFlat(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.GroundNodeLayerFlat>(o);
  }
  ...
  public void UnPackTo(GroundNodeLayerFlatT _o) {
    ...
    for (var _j = 0; _j < this.LayersLength; ++_j) {_o.Layers.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Layers(_j), key) : this.Layers(_j));}
  }
  public static Offset<Japan.GroundNodeLayerFlat> Pack(FlatBufferBuilder builder, GroundNodeLayerFlatT _o) {
    if (_o == null) return default(Offset<Japan.GroundNodeLayerFlat>);
		byte[] key = TableEncryptionService.CreateKey("GroundNodeLaye");
    var _Layers = default(VectorOffset);
    if (_o.Layers != null) {
      var __Layers = _o.Layers.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
