...
public struct WorldRaidSeasonManageExcel : IFlatbufferObject
{
  ...
  public Japan.CurrencyTypes EnterTicket { get { int o = __p.__offset(8); return o != 0 ? (Japan.CurrencyTypes)__p.bb.GetInt(o + __p.bb_pos) : Japan.CurrencyTypes.Invalid; } }
  ...
  public static Offset<Japan.WorldRaidSeasonManageExcel> CreateWorldRaidSeasonManageExcel(FlatBufferBuilder builder,
      long SeasonId = 0,
      long EventContentId = 0,
      Japan.CurrencyTypes EnterTicket = Japan.CurrencyTypes.Invalid,
  ...
  public static void AddEnterTicket(FlatBufferBuilder builder, Japan.CurrencyTypes enterTicket) { builder.AddInt(2, (int)enterTicket, 0); }
  ...
  public static Offset<Japan.WorldRaidSeasonManageExcel> EndWorldRaidSeasonManageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.WorldRaidSeasonManageExcel>(o);
  }
  ...
  public void UnPackTo(WorldRaidSeasonManageExcelT _o) {
    ...
    _o.EnterTicket = TableEncryptionService.UseEncryption ? (Japan.CurrencyTypes)TableEncryptionService.Convert((int)this.EnterTicket, key) : this.EnterTicket;
  ...
  public static Offset<Japan.WorldRaidSeasonManageExcel> Pack(FlatBufferBuilder builder, WorldRaidSeasonManageExcelT _o) {
    if (_o == null) return default(Offset<Japan.WorldRaidSeasonManageExcel>);
		byte[] key = TableEncryptionService.CreateKey("WorldRaidSeasonManage");
		...
		var _EnterTicket = TableEncryptionService.UseEncryption ? (Japan.CurrencyTypes)TableEncryptionService.Convert((int)_o.EnterTicket, key) : _o.EnterTicket;
...
public class WorldRaidSeasonManageExcelT
{
  ...
  public Japan.CurrencyTypes EnterTicket { get; set; }
  ...
  public WorldRaidSeasonManageExcelT() {
    ...
    this.EnterTicket = Japan.CurrencyTypes.Invalid;
...
static public class WorldRaidSeasonManageExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*EnterTicket*/, 4 /*Japan.CurrencyTypes*/, 4, false)
