...
public struct ArenaRewardExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ArenaRewardExcelT _o) {
    ...
    _o.ArenaRewardType = TableEncryptionService.UseEncryption ? (Japan.ArenaRewardType)TableEncryptionService.Convert((int)this.ArenaRewardType, key) : this.ArenaRewardType;
  ...
  public static Offset<Japan.ArenaRewardExcel> Pack(FlatBufferBuilder builder, ArenaRewardExcelT _o) {
    if (_o == null) return default(Offset<Japan.ArenaRewardExcel>);
		...
		var _ArenaRewardType = TableEncryptionService.UseEncryption ? (Japan.ArenaRewardType)TableEncryptionService.Convert((int)_o.ArenaRewardType, key) : _o.ArenaRewardType;
