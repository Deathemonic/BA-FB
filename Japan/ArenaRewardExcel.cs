...
public struct ArenaRewardExcel : IFlatbufferObject
{
  ...
  public Japan.ArenaRewardType ArenaRewardType { get { int o = __p.__offset(6); return o != 0 ? (Japan.ArenaRewardType)__p.bb.GetInt(o + __p.bb_pos) : Japan.ArenaRewardType.None; } }
  ...
  public static Offset<Japan.ArenaRewardExcel> CreateArenaRewardExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      Japan.ArenaRewardType ArenaRewardType = Japan.ArenaRewardType.None,
      long RankStart = 0,
      long RankEnd = 0,
  ...
  public static void StartArenaRewardExcel(FlatBufferBuilder builder) { builder.StartTable(8); }
  public static void AddUniqueId(FlatBufferBuilder builder, long uniqueId) { builder.AddLong(0, uniqueId, 0); }
  public static void AddArenaRewardType(FlatBufferBuilder builder, Japan.ArenaRewardType arenaRewardType) { builder.AddInt(1, (int)arenaRewardType, 0); }
  ...
  public static Offset<Japan.ArenaRewardExcel> EndArenaRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ArenaRewardExcel>(o);
  }
  ...
  public void UnPackTo(ArenaRewardExcelT _o) {
    ...
    _o.ArenaRewardType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ArenaRewardType, key) : this.ArenaRewardType;
  ...
  public static Offset<Japan.ArenaRewardExcel> Pack(FlatBufferBuilder builder, ArenaRewardExcelT _o) {
    if (_o == null) return default(Offset<Japan.ArenaRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("ArenaReward");
		var _UniqueId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.UniqueId, key) : _o.UniqueId;
		var _ArenaRewardType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ArenaRewardType, key) : _o.ArenaRewardType;
...
public class ArenaRewardExcelT
{
  ...
  public Japan.ArenaRewardType ArenaRewardType { get; set; }
  ...
  public ArenaRewardExcelT() {
    this.UniqueId = 0;
    this.ArenaRewardType = Japan.ArenaRewardType.None;
    this.RankStart = 0;
    this.RankEnd = 0;
...
static public class ArenaRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*ArenaRewardType*/, 4 /*Japan.ArenaRewardType*/, 4, false)
