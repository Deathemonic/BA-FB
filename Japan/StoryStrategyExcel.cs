...
public struct StoryStrategyExcel : IFlatbufferObject
{
  ...
  public Japan.StageTopography StageTopography { get { int o = __p.__offset(22); return o != 0 ? (Japan.StageTopography)__p.bb.GetInt(o + __p.bb_pos) : Japan.StageTopography.Street; } }
  public Japan.StrategyEnvironment StrategyEnvironment { get { int o = __p.__offset(24); return o != 0 ? (Japan.StrategyEnvironment)__p.bb.GetInt(o + __p.bb_pos) : Japan.StrategyEnvironment.None; } }
  public Japan.ContentType ContentType { get { int o = __p.__offset(26); return o != 0 ? (Japan.ContentType)__p.bb.GetInt(o + __p.bb_pos) : Japan.ContentType.None; } }
  ...
  public static Offset<Japan.StoryStrategyExcel> CreateStoryStrategyExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddStageTopography(FlatBufferBuilder builder, Japan.StageTopography stageTopography) { builder.AddInt(9, (int)stageTopography, 0); }
  public static void AddStrategyEnvironment(FlatBufferBuilder builder, Japan.StrategyEnvironment strategyEnvironment) { builder.AddInt(10, (int)strategyEnvironment, 0); }
  public static void AddContentType(FlatBufferBuilder builder, Japan.ContentType contentType) { builder.AddInt(11, (int)contentType, 0); }
  ...
  public static Offset<Japan.StoryStrategyExcel> EndStoryStrategyExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.StoryStrategyExcel>(o);
  }
  ...
  public static Offset<Japan.StoryStrategyExcel> Pack(FlatBufferBuilder builder, StoryStrategyExcelT _o) {
    if (_o == null) return default(Offset<Japan.StoryStrategyExcel>);
		byte[] key = TableEncryptionService.CreateKey("StoryStrategy");
...
static public class StoryStrategyExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 22 /*StageTopography*/, 4 /*Japan.StageTopography*/, 4, false)
      && verifier.VerifyField(tablePos, 24 /*StrategyEnvironment*/, 4 /*Japan.StrategyEnvironment*/, 4, false)
      && verifier.VerifyField(tablePos, 26 /*ContentType*/, 4 /*Japan.ContentType*/, 4, false)
