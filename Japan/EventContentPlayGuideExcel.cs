...
public struct EventContentPlayGuideExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.EventContentPlayGuideExcel> CreateEventContentPlayGuideExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Japan.EventContentPlayGuideExcel> EndEventContentPlayGuideExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.EventContentPlayGuideExcel>(o);
  }
  ...
  public static Offset<Japan.EventContentPlayGuideExcel> Pack(FlatBufferBuilder builder, EventContentPlayGuideExcelT _o) {
    if (_o == null) return default(Offset<Japan.EventContentPlayGuideExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentPlayGuide");
