...
public struct MinigameCCGEnemyExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(MinigameCCGEnemyExcelT _o) {
    ...
    _o.CharacterType = TableEncryptionService.UseEncryption ? (Japan.CCGCharacterType)TableEncryptionService.Convert((int)this.CharacterType, key) : this.CharacterType;
  ...
  public static Offset<Japan.MinigameCCGEnemyExcel> Pack(FlatBufferBuilder builder, MinigameCCGEnemyExcelT _o) {
    if (_o == null) return default(Offset<Japan.MinigameCCGEnemyExcel>);
		...
		var _CharacterType = TableEncryptionService.UseEncryption ? (Japan.CCGCharacterType)TableEncryptionService.Convert((int)_o.CharacterType, key) : _o.CharacterType;
