...
public struct GachaCraftNodeExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.GachaCraftNodeExcel> CreateGachaCraftNodeExcel(FlatBufferBuilder builder,
      long ID = 0,
      long Tier = 0,
  ...
  public static Offset<Japan.GachaCraftNodeExcel> EndGachaCraftNodeExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.GachaCraftNodeExcel>(o);
  }
  ...
  public static Offset<Japan.GachaCraftNodeExcel> Pack(FlatBufferBuilder builder, GachaCraftNodeExcelT _o) {
    if (_o == null) return default(Offset<Japan.GachaCraftNodeExcel>);
		byte[] key = TableEncryptionService.CreateKey("GachaCraftNode");
