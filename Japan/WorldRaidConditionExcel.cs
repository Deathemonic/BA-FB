...
public struct WorldRaidConditionExcel : IFlatbufferObject
{
  ...
  public Japan.MultipleConditionCheckType MultipleConditionCheckType { get { int o = __p.__offset(16); return o != 0 ? (Japan.MultipleConditionCheckType)__p.bb.GetInt(o + __p.bb_pos) : Japan.MultipleConditionCheckType.And; } }
  ...
  public static Offset<Japan.WorldRaidConditionExcel> CreateWorldRaidConditionExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddMultipleConditionCheckType(FlatBufferBuilder builder, Japan.MultipleConditionCheckType multipleConditionCheckType) { builder.AddInt(6, (int)multipleConditionCheckType, 0); }
  ...
  public static Offset<Japan.WorldRaidConditionExcel> EndWorldRaidConditionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.WorldRaidConditionExcel>(o);
  }
  ...
  public static Offset<Japan.WorldRaidConditionExcel> Pack(FlatBufferBuilder builder, WorldRaidConditionExcelT _o) {
    if (_o == null) return default(Offset<Japan.WorldRaidConditionExcel>);
		byte[] key = TableEncryptionService.CreateKey("WorldRaidCondition");
...
static public class WorldRaidConditionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 16 /*MultipleConditionCheckType*/, 4 /*Japan.MultipleConditionCheckType*/, 4, false)
