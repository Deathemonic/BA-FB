...
public struct EventContentShopExcel : IFlatbufferObject
{
  ...
  public Japan.ShopCategoryType CategoryType { get { int o = __p.__offset(10); return o != 0 ? (Japan.ShopCategoryType)__p.bb.GetInt(o + __p.bb_pos) : Japan.ShopCategoryType.General; } }
  ...
  public static Offset<Japan.EventContentShopExcel> CreateEventContentShopExcel(FlatBufferBuilder builder,
  ...
  public static void AddCategoryType(FlatBufferBuilder builder, Japan.ShopCategoryType categoryType) { builder.AddInt(3, (int)categoryType, 0); }
  ...
  public static Offset<Japan.EventContentShopExcel> EndEventContentShopExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.EventContentShopExcel>(o);
  }
  ...
  public static Offset<Japan.EventContentShopExcel> Pack(FlatBufferBuilder builder, EventContentShopExcelT _o) {
    if (_o == null) return default(Offset<Japan.EventContentShopExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentShop");
...
static public class EventContentShopExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*CategoryType*/, 4 /*Japan.ShopCategoryType*/, 4, false)
