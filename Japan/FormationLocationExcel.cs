...
public struct FormationLocationExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.FormationLocationExcel> CreateFormationLocationExcel(FlatBufferBuilder builder,
      long Id = 0,
      long GroupID = 0,
  ...
  public static Offset<Japan.FormationLocationExcel> EndFormationLocationExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.FormationLocationExcel>(o);
  }
  ...
  public static Offset<Japan.FormationLocationExcel> Pack(FlatBufferBuilder builder, FormationLocationExcelT _o) {
    if (_o == null) return default(Offset<Japan.FormationLocationExcel>);
		byte[] key = TableEncryptionService.CreateKey("FormationLocation");
