...
public struct VoiceSpineExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(VoiceSpineExcelT _o) {
    ...
    _o.Id = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)this.Id, key) : this.Id;
  ...
  public static Offset<Japan.VoiceSpineExcel> Pack(FlatBufferBuilder builder, VoiceSpineExcelT _o) {
    if (_o == null) return default(Offset<Japan.VoiceSpineExcel>);
		...
		var _Id = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)_o.Id, key) : _o.Id;
