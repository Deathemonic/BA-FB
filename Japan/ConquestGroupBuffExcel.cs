...
public struct ConquestGroupBuffExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.ConquestGroupBuffExcel> CreateConquestGroupBuffExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.ConquestGroupBuffExcel> EndConquestGroupBuffExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ConquestGroupBuffExcel>(o);
  }
  ...
  public void UnPackTo(ConquestGroupBuffExcelT _o) {
    ...
    _o.ConquestBuffId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ConquestBuffId, key) : this.ConquestBuffId;
  ...
  public static Offset<Japan.ConquestGroupBuffExcel> Pack(FlatBufferBuilder builder, ConquestGroupBuffExcelT _o) {
    if (_o == null) return default(Offset<Japan.ConquestGroupBuffExcel>);
		byte[] key = TableEncryptionService.CreateKey("ConquestGroupBuff");
