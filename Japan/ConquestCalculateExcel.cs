...
public struct ConquestCalculateExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ConquestCalculateExcelT _o) {
    ...
    _o.CalculateConditionParcelType = TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)this.CalculateConditionParcelType, key) : this.CalculateConditionParcelType;
  ...
  public static Offset<Japan.ConquestCalculateExcel> Pack(FlatBufferBuilder builder, ConquestCalculateExcelT _o) {
    if (_o == null) return default(Offset<Japan.ConquestCalculateExcel>);
		...
		var _CalculateConditionParcelType = TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)_o.CalculateConditionParcelType, key) : _o.CalculateConditionParcelType;
