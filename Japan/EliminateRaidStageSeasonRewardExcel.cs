...
public struct EliminateRaidStageSeasonRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.EliminateRaidStageSeasonRewardExcel> CreateEliminateRaidStageSeasonRewardExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.EliminateRaidStageSeasonRewardExcel> EndEliminateRaidStageSeasonRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.EliminateRaidStageSeasonRewardExcel>(o);
  }
  ...
  public static Offset<Japan.EliminateRaidStageSeasonRewardExcel> Pack(FlatBufferBuilder builder, EliminateRaidStageSeasonRewardExcelT _o) {
    if (_o == null) return default(Offset<Japan.EliminateRaidStageSeasonRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("EliminateRaidStageSeasonReward");
