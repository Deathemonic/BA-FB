...
public struct AniEventData : IFlatbufferObject
{
  ...
  public static Offset<Japan.AniEventData> CreateAniEventData(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.AniEventData> EndAniEventData(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.AniEventData>(o);
  }
  ...
  public static Offset<Japan.AniEventData> Pack(FlatBufferBuilder builder, AniEventDataT _o) {
    if (_o == null) return default(Offset<Japan.AniEventData>);
		byte[] key = TableEncryptionService.CreateKey("AniEven");
