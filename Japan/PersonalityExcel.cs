...
public struct PersonalityExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.PersonalityExcel> CreatePersonalityExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Japan.PersonalityExcel> EndPersonalityExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.PersonalityExcel>(o);
  }
  ...
  public static Offset<Japan.PersonalityExcel> Pack(FlatBufferBuilder builder, PersonalityExcelT _o) {
    if (_o == null) return default(Offset<Japan.PersonalityExcel>);
		byte[] key = TableEncryptionService.CreateKey("Personality");
