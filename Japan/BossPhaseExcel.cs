...
public struct BossPhaseExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.BossPhaseExcel> CreateBossPhaseExcel(FlatBufferBuilder builder,
      long Id = 0,
      long AIPhase = 0,
  ...
  public static Offset<Japan.BossPhaseExcel> EndBossPhaseExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.BossPhaseExcel>(o);
  }
  ...
  public void UnPackTo(BossPhaseExcelT _o) {
    ...
    for (var _j = 0; _j < this.UseExSkillLength; ++_j) {_o.UseExSkill.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.UseExSkill(_j), key) : this.UseExSkill(_j));}
  }
  public static Offset<Japan.BossPhaseExcel> Pack(FlatBufferBuilder builder, BossPhaseExcelT _o) {
    if (_o == null) return default(Offset<Japan.BossPhaseExcel>);
		byte[] key = TableEncryptionService.CreateKey("BossPhase");
