...
public struct ScenarioScriptField1Excel : IFlatbufferObject
{
  ...
  public static Offset<Japan.ScenarioScriptField1Excel> Pack(FlatBufferBuilder builder, ScenarioScriptField1ExcelT _o) {
    ...
    var _VoiceJp = _o.VoiceJp == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.VoiceJp, key) : _o.VoiceJp));
