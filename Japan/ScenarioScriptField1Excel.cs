...
public struct ScenarioScriptField1Excel : IFlatbufferObject
{
  ...
  public static Offset<Japan.ScenarioScriptField1Excel> CreateScenarioScriptField1Excel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static Offset<Japan.ScenarioScriptField1Excel> EndScenarioScriptField1Excel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ScenarioScriptField1Excel>(o);
  }
  ...
  public void UnPackTo(ScenarioScriptField1ExcelT _o) {
    ...
    _o.VoiceJp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.VoiceJp, key) : this.VoiceJp;
  }
  public static Offset<Japan.ScenarioScriptField1Excel> Pack(FlatBufferBuilder builder, ScenarioScriptField1ExcelT _o) {
    if (_o == null) return default(Offset<Japan.ScenarioScriptField1Excel>);
		byte[] key = TableEncryptionService.CreateKey("ScenarioScriptField1");
    ...
    var _VoiceJp = _o.VoiceJp == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.VoiceJp, key) : _o.VoiceJp));
