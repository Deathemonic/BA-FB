...
public struct ConquestMapExcel : IFlatbufferObject
{
  ...
  public Japan.StageDifficulty MapDifficulty { get { int o = __p.__offset(8); return o != 0 ? (Japan.StageDifficulty)__p.bb.GetInt(o + __p.bb_pos) : Japan.StageDifficulty.None; } }
  ...
  public Japan.ConquestConditionType StepOpenConditionType(int j) { int o = __p.__offset(16); return o != 0 ? (Japan.ConquestConditionType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.ConquestConditionType)0; }
  public int StepOpenConditionTypeLength { get { int o = __p.__offset(16); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.ConquestConditionType> GetStepOpenConditionTypeBytes() { return __p.__vector_as_span<Japan.ConquestConditionType>(16, 4); }
#else
  public ArraySegment<byte>? GetStepOpenConditionTypeBytes() { return __p.__vector_as_arraysegment(16); }
#endif
  public Japan.ConquestConditionType[] GetStepOpenConditionTypeArray() { int o = __p.__offset(16); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.ConquestConditionType[] a = new Japan.ConquestConditionType[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.ConquestConditionType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Japan.ConquestMapExcel> CreateConquestMapExcel(FlatBufferBuilder builder,
  ...
  public static void AddMapDifficulty(FlatBufferBuilder builder, Japan.StageDifficulty mapDifficulty) { builder.AddInt(2, (int)mapDifficulty, 0); }
  ...
  public static VectorOffset CreateStepOpenConditionTypeVector(FlatBufferBuilder builder, Japan.ConquestConditionType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateStepOpenConditionTypeVectorBlock(FlatBufferBuilder builder, Japan.ConquestConditionType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateStepOpenConditionTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Japan.ConquestConditionType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateStepOpenConditionTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Japan.ConquestConditionType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Japan.ConquestMapExcel> EndConquestMapExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ConquestMapExcel>(o);
  }
  ...
  public void UnPackTo(ConquestMapExcelT _o) {
    ...
    _o.StepOpenConditionType = new List<Japan.ConquestConditionType>();
    for (var _j = 0; _j < this.StepOpenConditionTypeLength; ++_j) {_o.StepOpenConditionType.Add(TableEncryptionService.UseEncryption ? (Japan.ConquestConditionType)TableEncryptionService.Convert((int)this.StepOpenConditionType(_j), key) : this.StepOpenConditionType(_j));}
  ...
  public static Offset<Japan.ConquestMapExcel> Pack(FlatBufferBuilder builder, ConquestMapExcelT _o) {
    if (_o == null) return default(Offset<Japan.ConquestMapExcel>);
		byte[] key = TableEncryptionService.CreateKey("ConquestMap");
    ...
    if (_o.StepOpenConditionType != null) {
      var __StepOpenConditionType = _o.StepOpenConditionType.Select(x => TableEncryptionService.UseEncryption ? (Japan.ConquestConditionType)TableEncryptionService.Convert((int)x, key) : x).ToArray();
...
public class ConquestMapExcelT
{
  ...
  public List<Japan.ConquestConditionType> StepOpenConditionType { get; set; }
...
static public class ConquestMapExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*MapDifficulty*/, 4 /*Japan.StageDifficulty*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 16 /*StepOpenConditionType*/, 4 /*Japan.ConquestConditionType*/, false)
