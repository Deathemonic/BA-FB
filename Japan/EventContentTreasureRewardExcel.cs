...
public struct EventContentTreasureRewardExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(EventContentTreasureRewardExcelT _o) {
    ...
    _o.CellUnderImageWidth = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.CellUnderImageWidth, key) : this.CellUnderImageWidth;
    _o.CellUnderImageHeight = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.CellUnderImageHeight, key) : this.CellUnderImageHeight;
    _o.HiddenImage = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.HiddenImage, key) : this.HiddenImage;
  ...
  public static Offset<Japan.EventContentTreasureRewardExcel> Pack(FlatBufferBuilder builder, EventContentTreasureRewardExcelT _o) {
    ...
    var _LocalizeCodeID = _o.LocalizeCodeID == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.LocalizeCodeID, key) : _o.LocalizeCodeID));
		var _CellUnderImageWidth = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.CellUnderImageWidth, key) : _o.CellUnderImageWidth;
		var _CellUnderImageHeight = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)_o.CellUnderImageHeight, key) : _o.CellUnderImageHeight;
		var _HiddenImage = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.HiddenImage, key) : _o.HiddenImage;
    ...
    var _CellUnderImagePath = _o.CellUnderImagePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.CellUnderImagePath, key) : _o.CellUnderImagePath));
    var _TreasureSmallImagePath = _o.TreasureSmallImagePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.TreasureSmallImagePath, key) : _o.TreasureSmallImagePath));
    var _TreasureSizeIconPath = _o.TreasureSizeIconPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.TreasureSizeIconPath, key) : _o.TreasureSizeIconPath));
