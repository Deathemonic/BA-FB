...
public struct EventContentTreasureRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.EventContentTreasureRewardExcel> CreateEventContentTreasureRewardExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Japan.EventContentTreasureRewardExcel> EndEventContentTreasureRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.EventContentTreasureRewardExcel>(o);
  }
  ...
  public void UnPackTo(EventContentTreasureRewardExcelT _o) {
    ...
    _o.CellUnderImageWidth = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CellUnderImageWidth, key) : this.CellUnderImageWidth;
    _o.CellUnderImageHeight = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CellUnderImageHeight, key) : this.CellUnderImageHeight;
    _o.HiddenImage = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.HiddenImage, key) : this.HiddenImage;
    ...
    _o.CellUnderImagePath = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CellUnderImagePath, key) : this.CellUnderImagePath;
    _o.TreasureSmallImagePath = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.TreasureSmallImagePath, key) : this.TreasureSmallImagePath;
    _o.TreasureSizeIconPath = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.TreasureSizeIconPath, key) : this.TreasureSizeIconPath;
  }
  public static Offset<Japan.EventContentTreasureRewardExcel> Pack(FlatBufferBuilder builder, EventContentTreasureRewardExcelT _o) {
    if (_o == null) return default(Offset<Japan.EventContentTreasureRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentTreasureReward");
		var _Id = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Id, key) : _o.Id;
    var _LocalizeCodeID = _o.LocalizeCodeID == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.LocalizeCodeID, key) : _o.LocalizeCodeID));
		var _CellUnderImageWidth = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CellUnderImageWidth, key) : _o.CellUnderImageWidth;
		var _CellUnderImageHeight = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CellUnderImageHeight, key) : _o.CellUnderImageHeight;
		var _HiddenImage = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.HiddenImage, key) : _o.HiddenImage;
    ...
    var _CellUnderImagePath = _o.CellUnderImagePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.CellUnderImagePath, key) : _o.CellUnderImagePath));
    var _TreasureSmallImagePath = _o.TreasureSmallImagePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.TreasureSmallImagePath, key) : _o.TreasureSmallImagePath));
    var _TreasureSizeIconPath = _o.TreasureSizeIconPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.TreasureSizeIconPath, key) : _o.TreasureSizeIconPath));
    return CreateEventContentTreasureRewardExcel(
      builder,
      TableEncryptionService.UseEncryption ? _Id : _o.Id,
      _LocalizeCodeID,
      TableEncryptionService.UseEncryption ? _CellUnderImageWidth : _o.CellUnderImageWidth,
      TableEncryptionService.UseEncryption ? _CellUnderImageHeight : _o.CellUnderImageHeight,
      TableEncryptionService.UseEncryption ? _HiddenImage : _o.HiddenImage,
      _RewardParcelType,
      _RewardParcelId,
      _RewardParcelAmount,
      _CellUnderImagePath,
