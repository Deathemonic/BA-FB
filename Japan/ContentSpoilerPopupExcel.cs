...
public struct ContentSpoilerPopupExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.ContentSpoilerPopupExcel> CreateContentSpoilerPopupExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.ContentSpoilerPopupExcel> EndContentSpoilerPopupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ContentSpoilerPopupExcel>(o);
  }
  ...
  public void UnPackTo(ContentSpoilerPopupExcelT _o) {
    ...
    _o.IsWarningPopUp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.IsWarningPopUp, key) : this.IsWarningPopUp;
    _o.ConditionScenarioModeId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ConditionScenarioModeId, key) : this.ConditionScenarioModeId;
  }
  public static Offset<Japan.ContentSpoilerPopupExcel> Pack(FlatBufferBuilder builder, ContentSpoilerPopupExcelT _o) {
    if (_o == null) return default(Offset<Japan.ContentSpoilerPopupExcel>);
		byte[] key = TableEncryptionService.CreateKey("ContentSpoilerPopup");
    ...
    var _SpoilerPopupTitle = _o.SpoilerPopupTitle == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.SpoilerPopupTitle, key) : _o.SpoilerPopupTitle));
    var _SpoilerPopupDescription = _o.SpoilerPopupDescription == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.SpoilerPopupDescription, key) : _o.SpoilerPopupDescription));
		var _IsWarningPopUp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.IsWarningPopUp, key) : _o.IsWarningPopUp;
		var _ConditionScenarioModeId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ConditionScenarioModeId, key) : _o.ConditionScenarioModeId;
    return CreateContentSpoilerPopupExcel(
      ...
      TableEncryptionService.UseEncryption ? _IsWarningPopUp : _o.IsWarningPopUp,
      TableEncryptionService.UseEncryption ? _ConditionScenarioModeId : _o.ConditionScenarioModeId);
  }
}
