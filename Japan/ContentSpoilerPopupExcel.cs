...
public struct ContentSpoilerPopupExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.ContentSpoilerPopupExcel> Pack(FlatBufferBuilder builder, ContentSpoilerPopupExcelT _o) {
    ...
    var _SpoilerPopupTitle = _o.SpoilerPopupTitle == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.SpoilerPopupTitle, key) : _o.SpoilerPopupTitle));
    var _SpoilerPopupDescription = _o.SpoilerPopupDescription == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.SpoilerPopupDescription, key) : _o.SpoilerPopupDescription));
		var _IsWarningPopUp = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IsWarningPopUp, key) : _o.IsWarningPopUp;
		var _ConditionScenarioModeId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ConditionScenarioModeId, key) : _o.ConditionScenarioModeId;
