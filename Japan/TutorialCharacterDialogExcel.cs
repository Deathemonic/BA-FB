...
public struct TutorialCharacterDialogExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.TutorialCharacterDialogExcel> CreateTutorialCharacterDialogExcel(FlatBufferBuilder builder,
      long TalkId = 0,
  ...
  public static Offset<Japan.TutorialCharacterDialogExcel> EndTutorialCharacterDialogExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.TutorialCharacterDialogExcel>(o);
  }
  ...
  public static Offset<Japan.TutorialCharacterDialogExcel> Pack(FlatBufferBuilder builder, TutorialCharacterDialogExcelT _o) {
    if (_o == null) return default(Offset<Japan.TutorialCharacterDialogExcel>);
		byte[] key = TableEncryptionService.CreateKey("TutorialCharacterDialog");
