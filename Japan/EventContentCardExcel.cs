...
public struct EventContentCardExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.EventContentCardExcel> Pack(FlatBufferBuilder builder, EventContentCardExcelT _o) {
    ...
    var _BackIconPath = _o.BackIconPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.BackIconPath, key) : _o.BackIconPath));
