...
public struct EventContentCardExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.EventContentCardExcel> CreateEventContentCardExcel(FlatBufferBuilder builder,
      int CardGroupId = 0,
  ...
  public static Offset<Japan.EventContentCardExcel> EndEventContentCardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.EventContentCardExcel>(o);
  }
  ...
  public void UnPackTo(EventContentCardExcelT _o) {
    ...
    _o.BackIconPath = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BackIconPath, key) : this.BackIconPath;
  ...
  public static Offset<Japan.EventContentCardExcel> Pack(FlatBufferBuilder builder, EventContentCardExcelT _o) {
    if (_o == null) return default(Offset<Japan.EventContentCardExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentCard");
