...
public struct ConstNewbieContentExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.ConstNewbieContentExcel> CreateConstNewbieContentExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.ConstNewbieContentExcel> EndConstNewbieContentExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ConstNewbieContentExcel>(o);
  }
  ...
  public static Offset<Japan.ConstNewbieContentExcel> Pack(FlatBufferBuilder builder, ConstNewbieContentExcelT _o) {
    if (_o == null) return default(Offset<Japan.ConstNewbieContentExcel>);
		byte[] key = TableEncryptionService.CreateKey("ConstNewbieContent");
