...
public struct CafeInteractionExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(CafeInteractionExcelT _o) {
    ...
    _o.IgnoreIfUnobtained = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.IgnoreIfUnobtained, key) : this.IgnoreIfUnobtained;
    ...
    for (var _j = 0; _j < this.BubbleTypeLength; ++_j) {_o.BubbleType.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BubbleType(_j), key) : this.BubbleType(_j));}
    _o.BubbleDuration = new List<long>();
    for (var _j = 0; _j < this.BubbleDurationLength; ++_j) {_o.BubbleDuration.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BubbleDuration(_j), key) : this.BubbleDuration(_j));}
    _o.FavorEmoticonRewardParcelType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.FavorEmoticonRewardParcelType, key) : this.FavorEmoticonRewardParcelType;
    _o.FavorEmoticonRewardId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.FavorEmoticonRewardId, key) : this.FavorEmoticonRewardId;
    _o.FavorEmoticonRewardAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.FavorEmoticonRewardAmount, key) : this.FavorEmoticonRewardAmount;
  ...
  public static Offset<Japan.CafeInteractionExcel> Pack(FlatBufferBuilder builder, CafeInteractionExcelT _o) {
    ...
    if (_o.BubbleDuration != null) {
      var __BubbleDuration = _o.BubbleDuration.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
      _BubbleDuration = CreateBubbleDurationVector(builder, __BubbleDuration);
    }
		var _FavorEmoticonRewardParcelType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.FavorEmoticonRewardParcelType, key) : _o.FavorEmoticonRewardParcelType;
		var _FavorEmoticonRewardId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.FavorEmoticonRewardId, key) : _o.FavorEmoticonRewardId;
		var _FavorEmoticonRewardAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.FavorEmoticonRewardAmount, key) : _o.FavorEmoticonRewardAmount;
    ...
    if (_o.CafeCharacterState != null) {
      ...
      for (var _j = 0; _j < __CafeCharacterState.Length; ++_j) { __CafeCharacterState[_j] = builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.CafeCharacterState[_j], key) : _o.CafeCharacterState[_j])); }
