...
public struct CafeInteractionExcel : IFlatbufferObject
{
  ...
  public Japan.BubbleType BubbleType(int j) { int o = __p.__offset(12); return o != 0 ? (Japan.BubbleType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.BubbleType)0; }
  public int BubbleTypeLength { get { int o = __p.__offset(12); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.BubbleType> GetBubbleTypeBytes() { return __p.__vector_as_span<Japan.BubbleType>(12, 4); }
#else
  public ArraySegment<byte>? GetBubbleTypeBytes() { return __p.__vector_as_arraysegment(12); }
#endif
  public Japan.BubbleType[] GetBubbleTypeArray() { int o = __p.__offset(12); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.BubbleType[] a = new Japan.BubbleType[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.BubbleType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Japan.ParcelType FavorEmoticonRewardParcelType { get { int o = __p.__offset(16); return o != 0 ? (Japan.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Japan.ParcelType.None; } }
  ...
  public static Offset<Japan.CafeInteractionExcel> CreateCafeInteractionExcel(FlatBufferBuilder builder,
      long CharacterId = 0,
      ...
      Japan.ParcelType FavorEmoticonRewardParcelType = Japan.ParcelType.None,
  ...
  public static VectorOffset CreateBubbleTypeVector(FlatBufferBuilder builder, Japan.BubbleType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateBubbleTypeVectorBlock(FlatBufferBuilder builder, Japan.BubbleType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateBubbleTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Japan.BubbleType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateBubbleTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Japan.BubbleType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static void AddFavorEmoticonRewardParcelType(FlatBufferBuilder builder, Japan.ParcelType favorEmoticonRewardParcelType) { builder.AddInt(6, (int)favorEmoticonRewardParcelType, 0); }
  ...
  public static Offset<Japan.CafeInteractionExcel> EndCafeInteractionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.CafeInteractionExcel>(o);
  }
  ...
  public void UnPackTo(CafeInteractionExcelT _o) {
    ...
    _o.IgnoreIfUnobtained = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.IgnoreIfUnobtained, key) : this.IgnoreIfUnobtained;
    _o.IgnoreIfUnobtainedStartDate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.IgnoreIfUnobtainedStartDate, key) : this.IgnoreIfUnobtainedStartDate;
    _o.IgnoreIfUnobtainedEndDate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.IgnoreIfUnobtainedEndDate, key) : this.IgnoreIfUnobtainedEndDate;
    _o.BubbleType = new List<Japan.BubbleType>();
    for (var _j = 0; _j < this.BubbleTypeLength; ++_j) {_o.BubbleType.Add(TableEncryptionService.UseEncryption ? (Japan.BubbleType)TableEncryptionService.Convert((int)this.BubbleType(_j), key) : this.BubbleType(_j));}
    _o.BubbleDuration = new List<long>();
    for (var _j = 0; _j < this.BubbleDurationLength; ++_j) {_o.BubbleDuration.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.BubbleDuration(_j), key) : this.BubbleDuration(_j));}
    _o.FavorEmoticonRewardParcelType = TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)this.FavorEmoticonRewardParcelType, key) : this.FavorEmoticonRewardParcelType;
    _o.FavorEmoticonRewardId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.FavorEmoticonRewardId, key) : this.FavorEmoticonRewardId;
    _o.FavorEmoticonRewardAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.FavorEmoticonRewardAmount, key) : this.FavorEmoticonRewardAmount;
    _o.CafeCharacterState = new List<string>();
    for (var _j = 0; _j < this.CafeCharacterStateLength; ++_j) {_o.CafeCharacterState.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CafeCharacterState(_j), key) : this.CafeCharacterState(_j));}
  }
  public static Offset<Japan.CafeInteractionExcel> Pack(FlatBufferBuilder builder, CafeInteractionExcelT _o) {
    if (_o == null) return default(Offset<Japan.CafeInteractionExcel>);
		byte[] key = TableEncryptionService.CreateKey("CafeInteraction");
		...
		var _IgnoreIfUnobtained = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.IgnoreIfUnobtained, key) : _o.IgnoreIfUnobtained;
    var _IgnoreIfUnobtainedStartDate = _o.IgnoreIfUnobtainedStartDate == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.IgnoreIfUnobtainedStartDate, key) : _o.IgnoreIfUnobtainedStartDate));
    var _IgnoreIfUnobtainedEndDate = _o.IgnoreIfUnobtainedEndDate == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.IgnoreIfUnobtainedEndDate, key) : _o.IgnoreIfUnobtainedEndDate));
    var _BubbleType = default(VectorOffset);
    if (_o.BubbleType != null) {
      var __BubbleType = _o.BubbleType.Select(x => TableEncryptionService.UseEncryption ? (Japan.BubbleType)TableEncryptionService.Convert((int)x, key) : x).ToArray();
      _BubbleType = CreateBubbleTypeVector(builder, __BubbleType);
    }
    var _BubbleDuration = default(VectorOffset);
    if (_o.BubbleDuration != null) {
      var __BubbleDuration = _o.BubbleDuration.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
      _BubbleDuration = CreateBubbleDurationVector(builder, __BubbleDuration);
    }
		var _FavorEmoticonRewardParcelType = TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)_o.FavorEmoticonRewardParcelType, key) : _o.FavorEmoticonRewardParcelType;
		var _FavorEmoticonRewardId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.FavorEmoticonRewardId, key) : _o.FavorEmoticonRewardId;
		var _FavorEmoticonRewardAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.FavorEmoticonRewardAmount, key) : _o.FavorEmoticonRewardAmount;
    ...
    if (_o.CafeCharacterState != null) {
      ...
      for (var _j = 0; _j < __CafeCharacterState.Length; ++_j) { __CafeCharacterState[_j] = builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.CafeCharacterState[_j], key) : _o.CafeCharacterState[_j])); }
    ...
    return CreateCafeInteractionExcel(
      ...
      TableEncryptionService.UseEncryption ? _FavorEmoticonRewardAmount : _o.FavorEmoticonRewardAmount,
      _CafeCharacterState);
  }
}
...
public class CafeInteractionExcelT
{
  ...
  public List<Japan.BubbleType> BubbleType { get; set; }
  public List<long> BubbleDuration { get; set; }
  public Japan.ParcelType FavorEmoticonRewardParcelType { get; set; }
  ...
  public CafeInteractionExcelT() {
    ...
    this.FavorEmoticonRewardParcelType = Japan.ParcelType.None;
...
static public class CafeInteractionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 12 /*BubbleType*/, 4 /*Japan.BubbleType*/, false)
      && verifier.VerifyVectorOfData(tablePos, 14 /*BubbleDuration*/, 8 /*long*/, false)
      && verifier.VerifyField(tablePos, 16 /*FavorEmoticonRewardParcelType*/, 4 /*Japan.ParcelType*/, 4, false)
