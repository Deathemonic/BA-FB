...
public struct AcademyLocationRankExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.AcademyLocationRankExcel> CreateAcademyLocationRankExcel(FlatBufferBuilder builder,
      long Rank = 0,
      long RankExp = 0,
      long TotalExp = 0) {
  ...
  public static Offset<Japan.AcademyLocationRankExcel> EndAcademyLocationRankExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.AcademyLocationRankExcel>(o);
  }
  ...
  public static Offset<Japan.AcademyLocationRankExcel> Pack(FlatBufferBuilder builder, AcademyLocationRankExcelT _o) {
    if (_o == null) return default(Offset<Japan.AcademyLocationRankExcel>);
		byte[] key = TableEncryptionService.CreateKey("AcademyLocationRank");
