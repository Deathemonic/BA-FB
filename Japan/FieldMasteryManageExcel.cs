...
public struct FieldMasteryManageExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.FieldMasteryManageExcel> CreateFieldMasteryManageExcel(FlatBufferBuilder builder,
      long FieldSeason = 0,
      uint LocalizeEtc = 0,
  ...
  public static Offset<Japan.FieldMasteryManageExcel> EndFieldMasteryManageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.FieldMasteryManageExcel>(o);
  }
  ...
  public static Offset<Japan.FieldMasteryManageExcel> Pack(FlatBufferBuilder builder, FieldMasteryManageExcelT _o) {
    if (_o == null) return default(Offset<Japan.FieldMasteryManageExcel>);
		byte[] key = TableEncryptionService.CreateKey("FieldMasteryManage");
