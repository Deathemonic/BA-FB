...
public struct MinigameTBGThemaExcel : IFlatbufferObject
{
  ...
  public Japan.TBGThemaType ThemaType { get { int o = __p.__offset(10); return o != 0 ? (Japan.TBGThemaType)__p.bb.GetInt(o + __p.bb_pos) : Japan.TBGThemaType.None; } }
  ...
  public Japan.TBGPortalCondition PortalCondition(int j) { int o = __p.__offset(16); return o != 0 ? (Japan.TBGPortalCondition)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.TBGPortalCondition)0; }
  public int PortalConditionLength { get { int o = __p.__offset(16); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.TBGPortalCondition> GetPortalConditionBytes() { return __p.__vector_as_span<Japan.TBGPortalCondition>(16, 4); }
#else
  public ArraySegment<byte>? GetPortalConditionBytes() { return __p.__vector_as_arraysegment(16); }
#endif
  public Japan.TBGPortalCondition[] GetPortalConditionArray() { int o = __p.__offset(16); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.TBGPortalCondition[] a = new Japan.TBGPortalCondition[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.TBGPortalCondition)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Japan.MinigameTBGThemaExcel> CreateMinigameTBGThemaExcel(FlatBufferBuilder builder,
  ...
  public static void AddThemaType(FlatBufferBuilder builder, Japan.TBGThemaType themaType) { builder.AddInt(3, (int)themaType, 0); }
  ...
  public static VectorOffset CreatePortalConditionVector(FlatBufferBuilder builder, Japan.TBGPortalCondition[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreatePortalConditionVectorBlock(FlatBufferBuilder builder, Japan.TBGPortalCondition[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreatePortalConditionVectorBlock(FlatBufferBuilder builder, ArraySegment<Japan.TBGPortalCondition> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreatePortalConditionVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Japan.TBGPortalCondition>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Japan.MinigameTBGThemaExcel> EndMinigameTBGThemaExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.MinigameTBGThemaExcel>(o);
  }
  ...
  public void UnPackTo(MinigameTBGThemaExcelT _o) {
    ...
    _o.PortalCondition = new List<Japan.TBGPortalCondition>();
    for (var _j = 0; _j < this.PortalConditionLength; ++_j) {_o.PortalCondition.Add(TableEncryptionService.UseEncryption ? (Japan.TBGPortalCondition)TableEncryptionService.Convert((int)this.PortalCondition(_j), key) : this.PortalCondition(_j));}
  ...
  public static Offset<Japan.MinigameTBGThemaExcel> Pack(FlatBufferBuilder builder, MinigameTBGThemaExcelT _o) {
    if (_o == null) return default(Offset<Japan.MinigameTBGThemaExcel>);
		byte[] key = TableEncryptionService.CreateKey("MinigameTBGThema");
    ...
    if (_o.PortalCondition != null) {
      var __PortalCondition = _o.PortalCondition.Select(x => TableEncryptionService.UseEncryption ? (Japan.TBGPortalCondition)TableEncryptionService.Convert((int)x, key) : x).ToArray();
...
public class MinigameTBGThemaExcelT
{
  ...
  public List<Japan.TBGPortalCondition> PortalCondition { get; set; }
...
static public class MinigameTBGThemaExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*ThemaType*/, 4 /*Japan.TBGThemaType*/, 4, false)
      && verifier.VerifyString(tablePos, 12 /*ThemaMap*/, false)
      && verifier.VerifyString(tablePos, 14 /*ThemaMapBG*/, false)
      && verifier.VerifyVectorOfData(tablePos, 16 /*PortalCondition*/, 4 /*Japan.TBGPortalCondition*/, false)
