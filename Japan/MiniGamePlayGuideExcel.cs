...
public struct MiniGamePlayGuideExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.MiniGamePlayGuideExcel> CreateMiniGamePlayGuideExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Japan.MiniGamePlayGuideExcel> EndMiniGamePlayGuideExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.MiniGamePlayGuideExcel>(o);
  }
  ...
  public static Offset<Japan.MiniGamePlayGuideExcel> Pack(FlatBufferBuilder builder, MiniGamePlayGuideExcelT _o) {
    if (_o == null) return default(Offset<Japan.MiniGamePlayGuideExcel>);
		byte[] key = TableEncryptionService.CreateKey("MiniGamePlayGuide");
