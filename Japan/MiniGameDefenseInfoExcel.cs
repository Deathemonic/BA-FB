...
public struct MiniGameDefenseInfoExcel : IFlatbufferObject
{
  ...
  public Japan.ParcelType DefenseBattleParcelType { get { int o = __p.__offset(6); return o != 0 ? (Japan.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Japan.ParcelType.None; } }
  ...
  public static Offset<Japan.MiniGameDefenseInfoExcel> CreateMiniGameDefenseInfoExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      Japan.ParcelType DefenseBattleParcelType = Japan.ParcelType.None,
  ...
  public static void AddDefenseBattleParcelType(FlatBufferBuilder builder, Japan.ParcelType defenseBattleParcelType) { builder.AddInt(1, (int)defenseBattleParcelType, 0); }
  ...
  public static Offset<Japan.MiniGameDefenseInfoExcel> EndMiniGameDefenseInfoExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.MiniGameDefenseInfoExcel>(o);
  }
  ...
  public void UnPackTo(MiniGameDefenseInfoExcelT _o) {
    ...
    _o.DefenseBattleParcelType = TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)this.DefenseBattleParcelType, key) : this.DefenseBattleParcelType;
  ...
  public static Offset<Japan.MiniGameDefenseInfoExcel> Pack(FlatBufferBuilder builder, MiniGameDefenseInfoExcelT _o) {
    if (_o == null) return default(Offset<Japan.MiniGameDefenseInfoExcel>);
		byte[] key = TableEncryptionService.CreateKey("MiniGameDefenseInfo");
		...
		var _DefenseBattleParcelType = TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)_o.DefenseBattleParcelType, key) : _o.DefenseBattleParcelType;
...
public class MiniGameDefenseInfoExcelT
{
  ...
  public Japan.ParcelType DefenseBattleParcelType { get; set; }
  ...
  public MiniGameDefenseInfoExcelT() {
    ...
    this.DefenseBattleParcelType = Japan.ParcelType.None;
...
static public class MiniGameDefenseInfoExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*DefenseBattleParcelType*/, 4 /*Japan.ParcelType*/, 4, false)
