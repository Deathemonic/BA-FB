...
public struct ConquestGroupBonusExcel : IFlatbufferObject
{
  ...
  public Japan.School School(int j) { int o = __p.__offset(6); return o != 0 ? (Japan.School)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.School)0; }
  public int SchoolLength { get { int o = __p.__offset(6); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.School> GetSchoolBytes() { return __p.__vector_as_span<Japan.School>(6, 4); }
#else
  public ArraySegment<byte>? GetSchoolBytes() { return __p.__vector_as_arraysegment(6); }
#endif
  public Japan.School[] GetSchoolArray() { int o = __p.__offset(6); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.School[] a = new Japan.School[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.School)__p.bb.GetInt(p + i * 4); } return a; }
  public uint RecommandLocalizeEtcId { get { int o = __p.__offset(8); return o != 0 ? __p.bb.GetUint(o + __p.bb_pos) : (uint)0; } }
  public Japan.ParcelType BonusParcelType(int j) { int o = __p.__offset(10); return o != 0 ? (Japan.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.ParcelType)0; }
  public int BonusParcelTypeLength { get { int o = __p.__offset(10); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.ParcelType> GetBonusParcelTypeBytes() { return __p.__vector_as_span<Japan.ParcelType>(10, 4); }
#else
  public ArraySegment<byte>? GetBonusParcelTypeBytes() { return __p.__vector_as_arraysegment(10); }
#endif
  public Japan.ParcelType[] GetBonusParcelTypeArray() { int o = __p.__offset(10); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.ParcelType[] a = new Japan.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Japan.ConquestGroupBonusExcel> CreateConquestGroupBonusExcel(FlatBufferBuilder builder,
  ...
  public static VectorOffset CreateSchoolVector(FlatBufferBuilder builder, Japan.School[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateSchoolVectorBlock(FlatBufferBuilder builder, Japan.School[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateSchoolVectorBlock(FlatBufferBuilder builder, ArraySegment<Japan.School> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateSchoolVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Japan.School>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static VectorOffset CreateBonusParcelTypeVector(FlatBufferBuilder builder, Japan.ParcelType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateBonusParcelTypeVectorBlock(FlatBufferBuilder builder, Japan.ParcelType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateBonusParcelTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Japan.ParcelType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateBonusParcelTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Japan.ParcelType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Japan.ConquestGroupBonusExcel> EndConquestGroupBonusExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ConquestGroupBonusExcel>(o);
  }
  ...
  public void UnPackTo(ConquestGroupBonusExcelT _o) {
    ...
    _o.ConquestBonusId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.ConquestBonusId, key) : this.ConquestBonusId;
    _o.School = new List<Japan.School>();
    for (var _j = 0; _j < this.SchoolLength; ++_j) {_o.School.Add(TableEncryptionService.UseEncryption ? (Japan.School)TableEncryptionService.Convert((int)this.School(_j), key) : this.School(_j));}
    ...
    _o.BonusParcelType = new List<Japan.ParcelType>();
    for (var _j = 0; _j < this.BonusParcelTypeLength; ++_j) {_o.BonusParcelType.Add(TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)this.BonusParcelType(_j), key) : this.BonusParcelType(_j));}
    _o.BonusId = new List<long>();
    for (var _j = 0; _j < this.BonusIdLength; ++_j) {_o.BonusId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.BonusId(_j), key) : this.BonusId(_j));}
    _o.BonusCharacterCount1 = new List<int>();
    for (var _j = 0; _j < this.BonusCharacterCount1Length; ++_j) {_o.BonusCharacterCount1.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.BonusCharacterCount1(_j), key) : this.BonusCharacterCount1(_j));}
    _o.BonusPercentage1 = new List<long>();
    for (var _j = 0; _j < this.BonusPercentage1Length; ++_j) {_o.BonusPercentage1.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.BonusPercentage1(_j), key) : this.BonusPercentage1(_j));}
    _o.BonusCharacterCount2 = new List<int>();
    for (var _j = 0; _j < this.BonusCharacterCount2Length; ++_j) {_o.BonusCharacterCount2.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.BonusCharacterCount2(_j), key) : this.BonusCharacterCount2(_j));}
    _o.BonusPercentage2 = new List<long>();
    for (var _j = 0; _j < this.BonusPercentage2Length; ++_j) {_o.BonusPercentage2.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.BonusPercentage2(_j), key) : this.BonusPercentage2(_j));}
    _o.BonusCharacterCount3 = new List<int>();
    for (var _j = 0; _j < this.BonusCharacterCount3Length; ++_j) {_o.BonusCharacterCount3.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)this.BonusCharacterCount3(_j), key) : this.BonusCharacterCount3(_j));}
    _o.BonusPercentage3 = new List<long>();
    for (var _j = 0; _j < this.BonusPercentage3Length; ++_j) {_o.BonusPercentage3.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.BonusPercentage3(_j), key) : this.BonusPercentage3(_j));}
  }
  public static Offset<Japan.ConquestGroupBonusExcel> Pack(FlatBufferBuilder builder, ConquestGroupBonusExcelT _o) {
    if (_o == null) return default(Offset<Japan.ConquestGroupBonusExcel>);
		byte[] key = TableEncryptionService.CreateKey("ConquestGroupBonus");
		var _ConquestBonusId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.ConquestBonusId, key) : _o.ConquestBonusId;
    var _School = default(VectorOffset);
    if (_o.School != null) {
      var __School = _o.School.Select(x => TableEncryptionService.UseEncryption ? (Japan.School)TableEncryptionService.Convert((int)x, key) : x).ToArray();
    ...
    if (_o.BonusParcelType != null) {
      var __BonusParcelType = _o.BonusParcelType.Select(x => TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)x, key) : x).ToArray();
      _BonusParcelType = CreateBonusParcelTypeVector(builder, __BonusParcelType);
    }
    var _BonusId = default(VectorOffset);
    if (_o.BonusId != null) {
      var __BonusId = _o.BonusId.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
    ...
    if (_o.BonusCharacterCount1 != null) {
      var __BonusCharacterCount1 = _o.BonusCharacterCount1.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)x, key) : x).ToArray();
    ...
    if (_o.BonusPercentage1 != null) {
      var __BonusPercentage1 = _o.BonusPercentage1.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
    ...
    if (_o.BonusCharacterCount2 != null) {
      var __BonusCharacterCount2 = _o.BonusCharacterCount2.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)x, key) : x).ToArray();
    ...
    if (_o.BonusPercentage2 != null) {
      var __BonusPercentage2 = _o.BonusPercentage2.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
    ...
    if (_o.BonusCharacterCount3 != null) {
      var __BonusCharacterCount3 = _o.BonusCharacterCount3.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((int)x, key) : x).ToArray();
    ...
    if (_o.BonusPercentage3 != null) {
      var __BonusPercentage3 = _o.BonusPercentage3.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
...
public class ConquestGroupBonusExcelT
{
  ...
  public List<Japan.School> School { get; set; }
  public uint RecommandLocalizeEtcId { get; set; }
  public List<Japan.ParcelType> BonusParcelType { get; set; }
...
static public class ConquestGroupBonusExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 6 /*School*/, 4 /*Japan.School*/, false)
      && verifier.VerifyField(tablePos, 8 /*RecommandLocalizeEtcId*/, 4 /*uint*/, 4, false)
      && verifier.VerifyVectorOfData(tablePos, 10 /*BonusParcelType*/, 4 /*Japan.ParcelType*/, false)
