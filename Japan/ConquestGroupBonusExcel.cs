...
public struct ConquestGroupBonusExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ConquestGroupBonusExcelT _o) {
    ...
    _o.ConquestBonusId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ConquestBonusId, key) : this.ConquestBonusId;
    _o.School = new List<Japan.School>();
    for (var _j = 0; _j < this.SchoolLength; ++_j) {_o.School.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.School(_j), key) : this.School(_j));}
    _o.RecommandLocalizeEtcId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.RecommandLocalizeEtcId, key) : this.RecommandLocalizeEtcId;
    _o.BonusParcelType = new List<Japan.ParcelType>();
    for (var _j = 0; _j < this.BonusParcelTypeLength; ++_j) {_o.BonusParcelType.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BonusParcelType(_j), key) : this.BonusParcelType(_j));}
    _o.BonusId = new List<long>();
    for (var _j = 0; _j < this.BonusIdLength; ++_j) {_o.BonusId.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BonusId(_j), key) : this.BonusId(_j));}
    _o.BonusCharacterCount1 = new List<int>();
    for (var _j = 0; _j < this.BonusCharacterCount1Length; ++_j) {_o.BonusCharacterCount1.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BonusCharacterCount1(_j), key) : this.BonusCharacterCount1(_j));}
    _o.BonusPercentage1 = new List<long>();
    for (var _j = 0; _j < this.BonusPercentage1Length; ++_j) {_o.BonusPercentage1.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BonusPercentage1(_j), key) : this.BonusPercentage1(_j));}
    _o.BonusCharacterCount2 = new List<int>();
    for (var _j = 0; _j < this.BonusCharacterCount2Length; ++_j) {_o.BonusCharacterCount2.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BonusCharacterCount2(_j), key) : this.BonusCharacterCount2(_j));}
    _o.BonusPercentage2 = new List<long>();
    for (var _j = 0; _j < this.BonusPercentage2Length; ++_j) {_o.BonusPercentage2.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BonusPercentage2(_j), key) : this.BonusPercentage2(_j));}
    _o.BonusCharacterCount3 = new List<int>();
    for (var _j = 0; _j < this.BonusCharacterCount3Length; ++_j) {_o.BonusCharacterCount3.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BonusCharacterCount3(_j), key) : this.BonusCharacterCount3(_j));}
    _o.BonusPercentage3 = new List<long>();
    for (var _j = 0; _j < this.BonusPercentage3Length; ++_j) {_o.BonusPercentage3.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.BonusPercentage3(_j), key) : this.BonusPercentage3(_j));}
  }
  public static Offset<Japan.ConquestGroupBonusExcel> Pack(FlatBufferBuilder builder, ConquestGroupBonusExcelT _o) {
    ...
    if (_o.BonusCharacterCount1 != null) {
      var __BonusCharacterCount1 = _o.BonusCharacterCount1.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
