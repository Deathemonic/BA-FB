...
public struct FixedEchelonSettingExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.FixedEchelonSettingExcel> CreateFixedEchelonSettingExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.FixedEchelonSettingExcel> EndFixedEchelonSettingExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.FixedEchelonSettingExcel>(o);
  }
  ...
  public static Offset<Japan.FixedEchelonSettingExcel> Pack(FlatBufferBuilder builder, FixedEchelonSettingExcelT _o) {
    if (_o == null) return default(Offset<Japan.FixedEchelonSettingExcel>);
		byte[] key = TableEncryptionService.CreateKey("FixedEchelonSetting");
