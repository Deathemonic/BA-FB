...
public struct MiniGameDreamReplayScenarioExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.MiniGameDreamReplayScenarioExcel> CreateMiniGameDreamReplayScenarioExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.MiniGameDreamReplayScenarioExcel> EndMiniGameDreamReplayScenarioExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.MiniGameDreamReplayScenarioExcel>(o);
  }
  ...
  public static Offset<Japan.MiniGameDreamReplayScenarioExcel> Pack(FlatBufferBuilder builder, MiniGameDreamReplayScenarioExcelT _o) {
    if (_o == null) return default(Offset<Japan.MiniGameDreamReplayScenarioExcel>);
		byte[] key = TableEncryptionService.CreateKey("MiniGameDreamReplayScenario");
