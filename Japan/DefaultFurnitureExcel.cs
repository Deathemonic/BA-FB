...
public struct DefaultFurnitureExcel : IFlatbufferObject
{
  ...
  public Japan.FurnitureLocation Location { get { int o = __p.__offset(6); return o != 0 ? (Japan.FurnitureLocation)__p.bb.GetInt(o + __p.bb_pos) : Japan.FurnitureLocation.None; } }
  ...
  public static Offset<Japan.DefaultFurnitureExcel> CreateDefaultFurnitureExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddLocation(FlatBufferBuilder builder, Japan.FurnitureLocation location) { builder.AddInt(1, (int)location, 0); }
  ...
  public static Offset<Japan.DefaultFurnitureExcel> EndDefaultFurnitureExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.DefaultFurnitureExcel>(o);
  }
  ...
  public static Offset<Japan.DefaultFurnitureExcel> Pack(FlatBufferBuilder builder, DefaultFurnitureExcelT _o) {
    if (_o == null) return default(Offset<Japan.DefaultFurnitureExcel>);
		byte[] key = TableEncryptionService.CreateKey("DefaultFurniture");
...
static public class DefaultFurnitureExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*Location*/, 4 /*Japan.FurnitureLocation*/, 4, false)
