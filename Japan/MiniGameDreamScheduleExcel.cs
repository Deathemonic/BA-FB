...
public struct MiniGameDreamScheduleExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.MiniGameDreamScheduleExcel> CreateMiniGameDreamScheduleExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.MiniGameDreamScheduleExcel> EndMiniGameDreamScheduleExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.MiniGameDreamScheduleExcel>(o);
  }
  ...
  public static Offset<Japan.MiniGameDreamScheduleExcel> Pack(FlatBufferBuilder builder, MiniGameDreamScheduleExcelT _o) {
    if (_o == null) return default(Offset<Japan.MiniGameDreamScheduleExcel>);
		byte[] key = TableEncryptionService.CreateKey("MiniGameDreamSchedule");
