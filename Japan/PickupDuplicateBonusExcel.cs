...
public struct PickupDuplicateBonusExcel : IFlatbufferObject
{
  ...
  public Japan.ShopCategoryType ShopCategoryType { get { int o = __p.__offset(6); return o != 0 ? (Japan.ShopCategoryType)__p.bb.GetInt(o + __p.bb_pos) : Japan.ShopCategoryType.General; } }
  ...
  public static Offset<Japan.PickupDuplicateBonusExcel> CreatePickupDuplicateBonusExcel(FlatBufferBuilder builder,
      long Id = 0,
      Japan.ShopCategoryType ShopCategoryType = Japan.ShopCategoryType.General,
      long ShopId = 0,
  ...
  public static void AddShopCategoryType(FlatBufferBuilder builder, Japan.ShopCategoryType shopCategoryType) { builder.AddInt(1, (int)shopCategoryType, 0); }
  ...
  public static Offset<Japan.PickupDuplicateBonusExcel> EndPickupDuplicateBonusExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.PickupDuplicateBonusExcel>(o);
  }
  ...
  public static Offset<Japan.PickupDuplicateBonusExcel> Pack(FlatBufferBuilder builder, PickupDuplicateBonusExcelT _o) {
    if (_o == null) return default(Offset<Japan.PickupDuplicateBonusExcel>);
		byte[] key = TableEncryptionService.CreateKey("PickupDuplicateBonus");
...
public class PickupDuplicateBonusExcelT
{
  ...
  public Japan.ShopCategoryType ShopCategoryType { get; set; }
  ...
  public PickupDuplicateBonusExcelT() {
    this.Id = 0;
    this.ShopCategoryType = Japan.ShopCategoryType.General;
    this.ShopId = 0;
...
static public class PickupDuplicateBonusExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*ShopCategoryType*/, 4 /*Japan.ShopCategoryType*/, 4, false)
