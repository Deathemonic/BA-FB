...
public struct PickupDuplicateBonusExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(PickupDuplicateBonusExcelT _o) {
    ...
    _o.ShopCategoryType = TableEncryptionService.UseEncryption ? (Japan.ShopCategoryType)TableEncryptionService.Convert((int)this.ShopCategoryType, key) : this.ShopCategoryType;
  ...
  public static Offset<Japan.PickupDuplicateBonusExcel> Pack(FlatBufferBuilder builder, PickupDuplicateBonusExcelT _o) {
    if (_o == null) return default(Offset<Japan.PickupDuplicateBonusExcel>);
		...
		var _ShopCategoryType = TableEncryptionService.UseEncryption ? (Japan.ShopCategoryType)TableEncryptionService.Convert((int)_o.ShopCategoryType, key) : _o.ShopCategoryType;
