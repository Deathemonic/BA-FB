...
public struct ConstMinigameTBGExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.ConstMinigameTBGExcel> CreateConstMinigameTBGExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.ConstMinigameTBGExcel> EndConstMinigameTBGExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ConstMinigameTBGExcel>(o);
  }
  ...
  public void UnPackTo(ConstMinigameTBGExcelT _o) {
    ...
    _o.EncounterAllyRotation = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EncounterAllyRotation, key) : this.EncounterAllyRotation;
    _o.EncounterEnemyRotation = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EncounterEnemyRotation, key) : this.EncounterEnemyRotation;
    _o.EncounterRewardReceiveIndex = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EncounterRewardReceiveIndex, key) : this.EncounterRewardReceiveIndex;
  }
  public static Offset<Japan.ConstMinigameTBGExcel> Pack(FlatBufferBuilder builder, ConstMinigameTBGExcelT _o) {
    if (_o == null) return default(Offset<Japan.ConstMinigameTBGExcel>);
		byte[] key = TableEncryptionService.CreateKey("ConstMinigameTBG");
		var _ConquestMapBoundaryOffsetLeft = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ConquestMapBoundaryOffsetLeft, key) : _o.ConquestMapBoundaryOffsetLeft;
		var _ConquestMapBoundaryOffsetRight = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ConquestMapBoundaryOffsetRight, key) : _o.ConquestMapBoundaryOffsetRight;
		var _ConquestMapBoundaryOffsetTop = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ConquestMapBoundaryOffsetTop, key) : _o.ConquestMapBoundaryOffsetTop;
		var _ConquestMapBoundaryOffsetBottom = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ConquestMapBoundaryOffsetBottom, key) : _o.ConquestMapBoundaryOffsetBottom;
		var _ConquestMapCenterOffsetX = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ConquestMapCenterOffsetX, key) : _o.ConquestMapCenterOffsetX;
		var _ConquestMapCenterOffsetY = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ConquestMapCenterOffsetY, key) : _o.ConquestMapCenterOffsetY;
		var _CameraAngle = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CameraAngle, key) : _o.CameraAngle;
		var _CameraZoomMax = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CameraZoomMax, key) : _o.CameraZoomMax;
		...
		var _ThemaLoadingProgressTime = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ThemaLoadingProgressTime, key) : _o.ThemaLoadingProgressTime;
		var _MapAllyRotation = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MapAllyRotation, key) : _o.MapAllyRotation;
    var _AniAllyBattleAttack = _o.AniAllyBattleAttack == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.AniAllyBattleAttack, key) : _o.AniAllyBattleAttack));
    var _EffectAllyBattleAttack = _o.EffectAllyBattleAttack == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.EffectAllyBattleAttack, key) : _o.EffectAllyBattleAttack));
    var _EffectAllyBattleDamage = _o.EffectAllyBattleDamage == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.EffectAllyBattleDamage, key) : _o.EffectAllyBattleDamage));
    var _AniEnemyBattleAttack = _o.AniEnemyBattleAttack == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.AniEnemyBattleAttack, key) : _o.AniEnemyBattleAttack));
    var _EffectEnemyBattleAttack = _o.EffectEnemyBattleAttack == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.EffectEnemyBattleAttack, key) : _o.EffectEnemyBattleAttack));
    var _EffectEnemyBattleDamage = _o.EffectEnemyBattleDamage == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.EffectEnemyBattleDamage, key) : _o.EffectEnemyBattleDamage));
		var _EncounterAllyRotation = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EncounterAllyRotation, key) : _o.EncounterAllyRotation;
		var _EncounterEnemyRotation = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EncounterEnemyRotation, key) : _o.EncounterEnemyRotation;
		var _EncounterRewardReceiveIndex = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EncounterRewardReceiveIndex, key) : _o.EncounterRewardReceiveIndex;
