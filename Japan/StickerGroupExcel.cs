...
public struct StickerGroupExcel : IFlatbufferObject
{
  ...
  public Japan.ParcelType PageCompleteRewardParcelType { get { int o = __p.__offset(14); return o != 0 ? (Japan.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Japan.ParcelType.None; } }
  ...
  public static Offset<Japan.StickerGroupExcel> CreateStickerGroupExcel(FlatBufferBuilder builder,
      long Id = 0,
      ...
      Japan.ParcelType PageCompleteRewardParcelType = Japan.ParcelType.None,
  ...
  public static void AddPageCompleteRewardParcelType(FlatBufferBuilder builder, Japan.ParcelType pageCompleteRewardParcelType) { builder.AddInt(5, (int)pageCompleteRewardParcelType, 0); }
  ...
  public static Offset<Japan.StickerGroupExcel> EndStickerGroupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.StickerGroupExcel>(o);
  }
  ...
  public void UnPackTo(StickerGroupExcelT _o) {
    ...
    _o.PageCompleteRewardParcelType = TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)this.PageCompleteRewardParcelType, key) : this.PageCompleteRewardParcelType;
  ...
  public static Offset<Japan.StickerGroupExcel> Pack(FlatBufferBuilder builder, StickerGroupExcelT _o) {
    if (_o == null) return default(Offset<Japan.StickerGroupExcel>);
		byte[] key = TableEncryptionService.CreateKey("StickerGroup");
    ...
    var _StickerGroupIconpath = _o.StickerGroupIconpath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.StickerGroupIconpath, key) : _o.StickerGroupIconpath));
		...
		var _PageCompleteRewardParcelType = TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)_o.PageCompleteRewardParcelType, key) : _o.PageCompleteRewardParcelType;
...
public class StickerGroupExcelT
{
  ...
  public Japan.ParcelType PageCompleteRewardParcelType { get; set; }
  ...
  public StickerGroupExcelT() {
    ...
    this.PageCompleteRewardParcelType = Japan.ParcelType.None;
...
static public class StickerGroupExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 14 /*PageCompleteRewardParcelType*/, 4 /*Japan.ParcelType*/, 4, false)
