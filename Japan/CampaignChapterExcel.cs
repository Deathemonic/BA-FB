...
public struct CampaignChapterExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.CampaignChapterExcel> CreateCampaignChapterExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Japan.CampaignChapterExcel> EndCampaignChapterExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.CampaignChapterExcel>(o);
  }
  ...
  public static Offset<Japan.CampaignChapterExcel> Pack(FlatBufferBuilder builder, CampaignChapterExcelT _o) {
    if (_o == null) return default(Offset<Japan.CampaignChapterExcel>);
		byte[] key = TableEncryptionService.CreateKey("CampaignChapter");
