...
public struct GachaElementExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.GachaElementExcel> CreateGachaElementExcel(FlatBufferBuilder builder,
      long ID = 0,
      long GachaGroupID = 0,
  ...
  public static Offset<Japan.GachaElementExcel> EndGachaElementExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.GachaElementExcel>(o);
  }
  ...
  public static Offset<Japan.GachaElementExcel> Pack(FlatBufferBuilder builder, GachaElementExcelT _o) {
    if (_o == null) return default(Offset<Japan.GachaElementExcel>);
		byte[] key = TableEncryptionService.CreateKey("GachaElement");
