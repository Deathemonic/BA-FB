...
public struct MiniGameRhythmBgmExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.MiniGameRhythmBgmExcel> CreateMiniGameRhythmBgmExcel(FlatBufferBuilder builder,
      long RhythmBgmId = 0,
  ...
  public static Offset<Japan.MiniGameRhythmBgmExcel> EndMiniGameRhythmBgmExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.MiniGameRhythmBgmExcel>(o);
  }
  ...
  public static Offset<Japan.MiniGameRhythmBgmExcel> Pack(FlatBufferBuilder builder, MiniGameRhythmBgmExcelT _o) {
    if (_o == null) return default(Offset<Japan.MiniGameRhythmBgmExcel>);
		byte[] key = TableEncryptionService.CreateKey("MiniGameRhythmBgm");
