...
public struct EventContentBuffExcel : IFlatbufferObject
{
  ...
  public Japan.Tag CharacterTag { get { int o = __p.__offset(8); return o != 0 ? (Japan.Tag)__p.bb.GetInt(o + __p.bb_pos) : Japan.Tag.A; } }
  public Japan.EventContentBuffFindRule EnumType { get { int o = __p.__offset(10); return o != 0 ? (Japan.EventContentBuffFindRule)__p.bb.GetInt(o + __p.bb_pos) : Japan.EventContentBuffFindRule.None; } }
  ...
  public static Offset<Japan.EventContentBuffExcel> CreateEventContentBuffExcel(FlatBufferBuilder builder,
      long EventContentBuffId = 0,
      bool IsBuff = false,
      Japan.Tag CharacterTag = Japan.Tag.A,
      Japan.EventContentBuffFindRule EnumType = Japan.EventContentBuffFindRule.None,
  ...
  public static void AddCharacterTag(FlatBufferBuilder builder, Japan.Tag characterTag) { builder.AddInt(2, (int)characterTag, 0); }
  public static void AddEnumType(FlatBufferBuilder builder, Japan.EventContentBuffFindRule enumType) { builder.AddInt(3, (int)enumType, 0); }
  ...
  public static Offset<Japan.EventContentBuffExcel> EndEventContentBuffExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.EventContentBuffExcel>(o);
  }
  ...
  public void UnPackTo(EventContentBuffExcelT _o) {
    ...
    _o.EventContentBuffId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EventContentBuffId, key) : this.EventContentBuffId;
    _o.IsBuff = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.IsBuff, key) : this.IsBuff;
    _o.CharacterTag = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CharacterTag, key) : this.CharacterTag;
    _o.EnumType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EnumType, key) : this.EnumType;
  ...
  public static Offset<Japan.EventContentBuffExcel> Pack(FlatBufferBuilder builder, EventContentBuffExcelT _o) {
    if (_o == null) return default(Offset<Japan.EventContentBuffExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentBuff");
		var _EventContentBuffId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EventContentBuffId, key) : _o.EventContentBuffId;
    ...
    var _BuffDescriptionLocalizeCodeId = _o.BuffDescriptionLocalizeCodeId == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.BuffDescriptionLocalizeCodeId, key) : _o.BuffDescriptionLocalizeCodeId));
...
public class EventContentBuffExcelT
{
  ...
  public Japan.Tag CharacterTag { get; set; }
  public Japan.EventContentBuffFindRule EnumType { get; set; }
  ...
  public EventContentBuffExcelT() {
    ...
    this.IsBuff = false;
    this.CharacterTag = Japan.Tag.A;
    this.EnumType = Japan.EventContentBuffFindRule.None;
...
static public class EventContentBuffExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*CharacterTag*/, 4 /*Japan.Tag*/, 4, false)
      && verifier.VerifyField(tablePos, 10 /*EnumType*/, 4 /*Japan.EventContentBuffFindRule*/, 4, false)
