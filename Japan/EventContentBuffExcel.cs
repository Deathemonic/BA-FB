...
public struct EventContentBuffExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(EventContentBuffExcelT _o) {
    ...
    _o.CharacterTag = TableEncryptionService.UseEncryption ? (Japan.Tag)TableEncryptionService.Convert((int)this.CharacterTag, key) : this.CharacterTag;
    _o.EnumType = TableEncryptionService.UseEncryption ? (Japan.EventContentBuffFindRule)TableEncryptionService.Convert((int)this.EnumType, key) : this.EnumType;
  ...
  public static Offset<Japan.EventContentBuffExcel> Pack(FlatBufferBuilder builder, EventContentBuffExcelT _o) {
    if (_o == null) return default(Offset<Japan.EventContentBuffExcel>);
		...
		var _CharacterTag = TableEncryptionService.UseEncryption ? (Japan.Tag)TableEncryptionService.Convert((int)_o.CharacterTag, key) : _o.CharacterTag;
		var _EnumType = TableEncryptionService.UseEncryption ? (Japan.EventContentBuffFindRule)TableEncryptionService.Convert((int)_o.EnumType, key) : _o.EnumType;
