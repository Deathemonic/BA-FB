...
public struct BGMExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.BGMExcel> CreateBGMExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Japan.BGMExcel> EndBGMExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.BGMExcel>(o);
  }
  ...
  public static Offset<Japan.BGMExcel> Pack(FlatBufferBuilder builder, BGMExcelT _o) {
    if (_o == null) return default(Offset<Japan.BGMExcel>);
		byte[] key = TableEncryptionService.CreateKey("BGM");
    ...
    if (_o.LoopStartTime != null) {
      var __LoopStartTime = _o.LoopStartTime.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.LoopEndTime != null) {
      var __LoopEndTime = _o.LoopEndTime.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.LoopTranstionTime != null) {
      var __LoopTranstionTime = _o.LoopTranstionTime.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
    ...
    if (_o.LoopOffsetTime != null) {
      var __LoopOffsetTime = _o.LoopOffsetTime.Select(x => (TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(x, key) : x)).ToArray();
