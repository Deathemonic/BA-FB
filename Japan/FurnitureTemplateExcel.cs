...
public struct FurnitureTemplateExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.FurnitureTemplateExcel> CreateFurnitureTemplateExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.FurnitureTemplateExcel> EndFurnitureTemplateExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.FurnitureTemplateExcel>(o);
  }
  ...
  public static Offset<Japan.FurnitureTemplateExcel> Pack(FlatBufferBuilder builder, FurnitureTemplateExcelT _o) {
    if (_o == null) return default(Offset<Japan.FurnitureTemplateExcel>);
		byte[] key = TableEncryptionService.CreateKey("FurnitureTemplate");
