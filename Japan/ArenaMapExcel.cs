...
public struct ArenaMapExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.ArenaMapExcel> CreateArenaMapExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      long TerrainType = 0,
  ...
  public static Offset<Japan.ArenaMapExcel> EndArenaMapExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ArenaMapExcel>(o);
  }
  ...
  public void UnPackTo(ArenaMapExcelT _o) {
    ...
    _o.GroundGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.GroundGroupId, key) : this.GroundGroupId;
    ...
    _o.StartRank = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.StartRank, key) : this.StartRank;
    _o.EndRank = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EndRank, key) : this.EndRank;
    _o.GroundId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.GroundId, key) : this.GroundId;
  }
  public static Offset<Japan.ArenaMapExcel> Pack(FlatBufferBuilder builder, ArenaMapExcelT _o) {
    if (_o == null) return default(Offset<Japan.ArenaMapExcel>);
		byte[] key = TableEncryptionService.CreateKey("ArenaMap");
		var _UniqueId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.UniqueId, key) : _o.UniqueId;
		var _TerrainType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.TerrainType, key) : _o.TerrainType;
    var _TerrainTypeLocalizeKey = _o.TerrainTypeLocalizeKey == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.TerrainTypeLocalizeKey, key) : _o.TerrainTypeLocalizeKey));
    var _ImagePath = _o.ImagePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.ImagePath, key) : _o.ImagePath));
		var _GroundGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.GroundGroupId, key) : _o.GroundGroupId;
    var _GroundGroupNameLocalizeKey = _o.GroundGroupNameLocalizeKey == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.GroundGroupNameLocalizeKey, key) : _o.GroundGroupNameLocalizeKey));
		var _StartRank = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StartRank, key) : _o.StartRank;
		var _EndRank = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EndRank, key) : _o.EndRank;
