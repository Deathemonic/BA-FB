...
public struct EmoticonSpecialExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.EmoticonSpecialExcel> CreateEmoticonSpecialExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
  ...
  public static Offset<Japan.EmoticonSpecialExcel> EndEmoticonSpecialExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.EmoticonSpecialExcel>(o);
  }
  ...
  public void UnPackTo(EmoticonSpecialExcelT _o) {
    ...
    _o.CharacterUniqueId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CharacterUniqueId, key) : this.CharacterUniqueId;
    _o.Random = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Random, key) : this.Random;
  }
  public static Offset<Japan.EmoticonSpecialExcel> Pack(FlatBufferBuilder builder, EmoticonSpecialExcelT _o) {
    if (_o == null) return default(Offset<Japan.EmoticonSpecialExcel>);
		byte[] key = TableEncryptionService.CreateKey("EmoticonSpecial");
		var _UniqueId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.UniqueId, key) : _o.UniqueId;
		var _CharacterUniqueId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CharacterUniqueId, key) : _o.CharacterUniqueId;
    var _Random = _o.Random == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.Random, key) : _o.Random));
