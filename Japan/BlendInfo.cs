...
public struct BlendInfo : IFlatbufferObject
{
  ...
  public static Offset<Japan.BlendInfo> CreateBlendInfo(FlatBufferBuilder builder,
      int From = 0,
      int To = 0,
      float blend = 0.0f) {
  ...
  public static Offset<Japan.BlendInfo> EndBlendInfo(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.BlendInfo>(o);
  }
  ...
  public static Offset<Japan.BlendInfo> Pack(FlatBufferBuilder builder, BlendInfoT _o) {
    if (_o == null) return default(Offset<Japan.BlendInfo>);
		byte[] key = TableEncryptionService.CreateKey("Blen");
