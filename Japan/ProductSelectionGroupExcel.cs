...
public struct ProductSelectionGroupExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ProductSelectionGroupExcelT _o) {
    ...
    _o.ConditionParcelType = TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)this.ConditionParcelType, key) : this.ConditionParcelType;
  ...
  public static Offset<Japan.ProductSelectionGroupExcel> Pack(FlatBufferBuilder builder, ProductSelectionGroupExcelT _o) {
    if (_o == null) return default(Offset<Japan.ProductSelectionGroupExcel>);
		...
		var _ConditionParcelType = TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)_o.ConditionParcelType, key) : _o.ConditionParcelType;
