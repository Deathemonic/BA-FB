...
public struct EventContentMeetupInfoExcel : IFlatbufferObject
{
  ...
  public Japan.ParcelType CostParcelType { get { int o = __p.__offset(6); return o != 0 ? (Japan.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Japan.ParcelType.None; } }
  ...
  public static Offset<Japan.EventContentMeetupInfoExcel> CreateEventContentMeetupInfoExcel(FlatBufferBuilder builder,
  ...
  public static void AddCostParcelType(FlatBufferBuilder builder, Japan.ParcelType costParcelType) { builder.AddInt(1, (int)costParcelType, 0); }
  ...
  public static Offset<Japan.EventContentMeetupInfoExcel> EndEventContentMeetupInfoExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.EventContentMeetupInfoExcel>(o);
  }
  ...
  public static Offset<Japan.EventContentMeetupInfoExcel> Pack(FlatBufferBuilder builder, EventContentMeetupInfoExcelT _o) {
    if (_o == null) return default(Offset<Japan.EventContentMeetupInfoExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentMeetupInfo");
...
static public class EventContentMeetupInfoExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*CostParcelType*/, 4 /*Japan.ParcelType*/, 4, false)
