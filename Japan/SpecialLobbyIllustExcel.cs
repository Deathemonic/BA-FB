...
public struct SpecialLobbyIllustExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.SpecialLobbyIllustExcel> CreateSpecialLobbyIllustExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
  ...
  public static Offset<Japan.SpecialLobbyIllustExcel> EndSpecialLobbyIllustExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.SpecialLobbyIllustExcel>(o);
  }
  ...
  public static Offset<Japan.SpecialLobbyIllustExcel> Pack(FlatBufferBuilder builder, SpecialLobbyIllustExcelT _o) {
    if (_o == null) return default(Offset<Japan.SpecialLobbyIllustExcel>);
		byte[] key = TableEncryptionService.CreateKey("SpecialLobbyIllust");
