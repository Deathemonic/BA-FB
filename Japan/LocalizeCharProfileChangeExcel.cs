...
public struct LocalizeCharProfileChangeExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.LocalizeCharProfileChangeExcel> CreateLocalizeCharProfileChangeExcel(FlatBufferBuilder builder,
      long CharacterId = 0,
  ...
  public static Offset<Japan.LocalizeCharProfileChangeExcel> EndLocalizeCharProfileChangeExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.LocalizeCharProfileChangeExcel>(o);
  }
  ...
  public static Offset<Japan.LocalizeCharProfileChangeExcel> Pack(FlatBufferBuilder builder, LocalizeCharProfileChangeExcelT _o) {
    if (_o == null) return default(Offset<Japan.LocalizeCharProfileChangeExcel>);
		byte[] key = TableEncryptionService.CreateKey("LocalizeCharProfileChange");
