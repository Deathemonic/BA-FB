...
public struct ScenarioScriptExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.ScenarioScriptExcel> CreateScenarioScriptExcel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static Offset<Japan.ScenarioScriptExcel> EndScenarioScriptExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ScenarioScriptExcel>(o);
  }
  ...
  public static Offset<Japan.ScenarioScriptExcel> Pack(FlatBufferBuilder builder, ScenarioScriptExcelT _o) {
    if (_o == null) return default(Offset<Japan.ScenarioScriptExcel>);
		byte[] key = TableEncryptionService.CreateKey("ScenarioScript");
