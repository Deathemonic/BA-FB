...
public struct CharacterPotentialStatExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.CharacterPotentialStatExcel> CreateCharacterPotentialStatExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.CharacterPotentialStatExcel> EndCharacterPotentialStatExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.CharacterPotentialStatExcel>(o);
  }
  ...
  public static Offset<Japan.CharacterPotentialStatExcel> Pack(FlatBufferBuilder builder, CharacterPotentialStatExcelT _o) {
    if (_o == null) return default(Offset<Japan.CharacterPotentialStatExcel>);
		byte[] key = TableEncryptionService.CreateKey("CharacterPotentialStat");
