...
public struct EventContentStageRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.EventContentStageRewardExcel> CreateEventContentStageRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static Offset<Japan.EventContentStageRewardExcel> EndEventContentStageRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.EventContentStageRewardExcel>(o);
  }
  ...
  public static Offset<Japan.EventContentStageRewardExcel> Pack(FlatBufferBuilder builder, EventContentStageRewardExcelT _o) {
    if (_o == null) return default(Offset<Japan.EventContentStageRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentStageReward");
