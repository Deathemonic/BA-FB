...
public struct CharacterCalculationLimitExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(CharacterCalculationLimitExcelT _o) {
    ...
    _o.CalculationValue = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CalculationValue, key) : this.CalculationValue;
    _o.MinValue = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MinValue, key) : this.MinValue;
    _o.MaxValue = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MaxValue, key) : this.MaxValue;
    _o.LimitStartValue = new List<long>();
    for (var _j = 0; _j < this.LimitStartValueLength; ++_j) {_o.LimitStartValue.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.LimitStartValue(_j), key) : this.LimitStartValue(_j));}
    _o.DecreaseRate = new List<long>();
    for (var _j = 0; _j < this.DecreaseRateLength; ++_j) {_o.DecreaseRate.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.DecreaseRate(_j), key) : this.DecreaseRate(_j));}
  }
