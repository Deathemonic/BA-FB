...
public struct CharacterCalculationLimitExcel : IFlatbufferObject
{
  ...
  public Japan.TacticEntityType TacticEntityType { get { int o = __p.__offset(6); return o != 0 ? (Japan.TacticEntityType)__p.bb.GetInt(o + __p.bb_pos) : Japan.TacticEntityType.None; } }
  public Japan.BattleCalculationStat CalculationValue { get { int o = __p.__offset(8); return o != 0 ? (Japan.BattleCalculationStat)__p.bb.GetInt(o + __p.bb_pos) : Japan.BattleCalculationStat.FinalDamage; } }
  ...
  public static Offset<Japan.CharacterCalculationLimitExcel> CreateCharacterCalculationLimitExcel(FlatBufferBuilder builder,
      long Id = 0,
      Japan.TacticEntityType TacticEntityType = Japan.TacticEntityType.None,
      Japan.BattleCalculationStat CalculationValue = Japan.BattleCalculationStat.FinalDamage,
      long MinValue = 0,
      long MaxValue = 0,
  ...
  public static void AddTacticEntityType(FlatBufferBuilder builder, Japan.TacticEntityType tacticEntityType) { builder.AddInt(1, (int)tacticEntityType, 0); }
  public static void AddCalculationValue(FlatBufferBuilder builder, Japan.BattleCalculationStat calculationValue) { builder.AddInt(2, (int)calculationValue, 0); }
  ...
  public static Offset<Japan.CharacterCalculationLimitExcel> EndCharacterCalculationLimitExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.CharacterCalculationLimitExcel>(o);
  }
  ...
  public void UnPackTo(CharacterCalculationLimitExcelT _o) {
    ...
    _o.CalculationValue = TableEncryptionService.UseEncryption ? (Japan.BattleCalculationStat)TableEncryptionService.Convert((int)this.CalculationValue, key) : this.CalculationValue;
    _o.MinValue = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.MinValue, key) : this.MinValue;
    _o.MaxValue = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.MaxValue, key) : this.MaxValue;
    _o.LimitStartValue = new List<long>();
    for (var _j = 0; _j < this.LimitStartValueLength; ++_j) {_o.LimitStartValue.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.LimitStartValue(_j), key) : this.LimitStartValue(_j));}
    _o.DecreaseRate = new List<long>();
    for (var _j = 0; _j < this.DecreaseRateLength; ++_j) {_o.DecreaseRate.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.DecreaseRate(_j), key) : this.DecreaseRate(_j));}
  }
  public static Offset<Japan.CharacterCalculationLimitExcel> Pack(FlatBufferBuilder builder, CharacterCalculationLimitExcelT _o) {
    if (_o == null) return default(Offset<Japan.CharacterCalculationLimitExcel>);
		byte[] key = TableEncryptionService.CreateKey("CharacterCalculationLimit");
		...
		var _CalculationValue = TableEncryptionService.UseEncryption ? (Japan.BattleCalculationStat)TableEncryptionService.Convert((int)_o.CalculationValue, key) : _o.CalculationValue;
		var _MinValue = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.MinValue, key) : _o.MinValue;
		var _MaxValue = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.MaxValue, key) : _o.MaxValue;
    var _LimitStartValue = default(VectorOffset);
    if (_o.LimitStartValue != null) {
      var __LimitStartValue = _o.LimitStartValue.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
    ...
    if (_o.DecreaseRate != null) {
      var __DecreaseRate = _o.DecreaseRate.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
...
public class CharacterCalculationLimitExcelT
{
  ...
  public Japan.BattleCalculationStat CalculationValue { get; set; }
  ...
  public CharacterCalculationLimitExcelT() {
    ...
    this.CalculationValue = Japan.BattleCalculationStat.FinalDamage;
    this.MinValue = 0;
    this.MaxValue = 0;
...
static public class CharacterCalculationLimitExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*TacticEntityType*/, 4 /*Japan.TacticEntityType*/, 4, false)
      && verifier.VerifyField(tablePos, 8 /*CalculationValue*/, 4 /*Japan.BattleCalculationStat*/, 4, false)
