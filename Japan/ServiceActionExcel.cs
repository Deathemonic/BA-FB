...
public struct ServiceActionExcel : IFlatbufferObject
{
  ...
  public Japan.ServiceActionType ServiceActionType { get { int o = __p.__offset(4); return o != 0 ? (Japan.ServiceActionType)__p.bb.GetInt(o + __p.bb_pos) : Japan.ServiceActionType.ClanCreate; } }
  ...
  public static Offset<Japan.ServiceActionExcel> CreateServiceActionExcel(FlatBufferBuilder builder,
      Japan.ServiceActionType ServiceActionType = Japan.ServiceActionType.ClanCreate,
      bool IsLegacy = false,
      long GoodsId = 0) {
  ...
  public static void AddServiceActionType(FlatBufferBuilder builder, Japan.ServiceActionType serviceActionType) { builder.AddInt(0, (int)serviceActionType, 0); }
  ...
  public static Offset<Japan.ServiceActionExcel> EndServiceActionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ServiceActionExcel>(o);
  }
  ...
  public void UnPackTo(ServiceActionExcelT _o) {
    ...
    _o.ServiceActionType = TableEncryptionService.UseEncryption ? (Japan.ServiceActionType)TableEncryptionService.Convert((int)this.ServiceActionType, key) : this.ServiceActionType;
  ...
  public static Offset<Japan.ServiceActionExcel> Pack(FlatBufferBuilder builder, ServiceActionExcelT _o) {
    if (_o == null) return default(Offset<Japan.ServiceActionExcel>);
		byte[] key = TableEncryptionService.CreateKey("ServiceAction");
		var _ServiceActionType = TableEncryptionService.UseEncryption ? (Japan.ServiceActionType)TableEncryptionService.Convert((int)_o.ServiceActionType, key) : _o.ServiceActionType;
...
{
  public Japan.ServiceActionType ServiceActionType { get; set; }
  public bool IsLegacy { get; set; }
  public long GoodsId { get; set; }

  public ServiceActionExcelT() {
    this.ServiceActionType = Japan.ServiceActionType.ClanCreate;
    this.IsLegacy = false;
    this.GoodsId = 0;
  }
}
...
static public class ServiceActionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyField(tablePos, 4 /*ServiceActionType*/, 4 /*Japan.ServiceActionType*/, 4, false)
