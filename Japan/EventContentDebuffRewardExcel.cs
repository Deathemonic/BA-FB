...
public struct EventContentDebuffRewardExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(EventContentDebuffRewardExcelT _o) {
    ...
    _o.EventStageId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EventStageId, key) : this.EventStageId;
    ...
    _o.RewardPercentage = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.RewardPercentage, key) : this.RewardPercentage;
  }
  public static Offset<Japan.EventContentDebuffRewardExcel> Pack(FlatBufferBuilder builder, EventContentDebuffRewardExcelT _o) {
    if (_o == null) return default(Offset<Japan.EventContentDebuffRewardExcel>);
		...
		var _EventStageId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EventStageId, key) : _o.EventStageId;
		...
		var _RewardPercentage = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RewardPercentage, key) : _o.RewardPercentage;
