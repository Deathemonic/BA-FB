...
public struct ConquestPlayGuideExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.ConquestPlayGuideExcel> CreateConquestPlayGuideExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Japan.ConquestPlayGuideExcel> EndConquestPlayGuideExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ConquestPlayGuideExcel>(o);
  }
  ...
  public static Offset<Japan.ConquestPlayGuideExcel> Pack(FlatBufferBuilder builder, ConquestPlayGuideExcelT _o) {
    if (_o == null) return default(Offset<Japan.ConquestPlayGuideExcel>);
		byte[] key = TableEncryptionService.CreateKey("ConquestPlayGuide");
