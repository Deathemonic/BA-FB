...
public struct MessagePopupExcel : IFlatbufferObject
{
  ...
  public Japan.MessagePopupLayout MessagePopupLayout { get { int o = __p.__offset(6); return o != 0 ? (Japan.MessagePopupLayout)__p.bb.GetInt(o + __p.bb_pos) : Japan.MessagePopupLayout.TextOnly; } }
  public Japan.MessagePopupImagePositionType OrderType { get { int o = __p.__offset(8); return o != 0 ? (Japan.MessagePopupImagePositionType)__p.bb.GetInt(o + __p.bb_pos) : Japan.MessagePopupImagePositionType.ImageFirst; } }
  ...
  public Japan.MessagePopupButtonType Button(int j) { int o = __p.__offset(22); return o != 0 ? (Japan.MessagePopupButtonType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.MessagePopupButtonType)0; }
  public int ButtonLength { get { int o = __p.__offset(22); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.MessagePopupButtonType> GetButtonBytes() { return __p.__vector_as_span<Japan.MessagePopupButtonType>(22, 4); }
#else
  public ArraySegment<byte>? GetButtonBytes() { return __p.__vector_as_arraysegment(22); }
#endif
  public Japan.MessagePopupButtonType[] GetButtonArray() { int o = __p.__offset(22); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.MessagePopupButtonType[] a = new Japan.MessagePopupButtonType[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.MessagePopupButtonType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Japan.MessagePopupExcel> CreateMessagePopupExcel(FlatBufferBuilder builder,
      uint StringId = 0,
      Japan.MessagePopupLayout MessagePopupLayout = Japan.MessagePopupLayout.TextOnly,
      Japan.MessagePopupImagePositionType OrderType = Japan.MessagePopupImagePositionType.ImageFirst,
  ...
  public static void AddMessagePopupLayout(FlatBufferBuilder builder, Japan.MessagePopupLayout messagePopupLayout) { builder.AddInt(1, (int)messagePopupLayout, 0); }
  public static void AddOrderType(FlatBufferBuilder builder, Japan.MessagePopupImagePositionType orderType) { builder.AddInt(2, (int)orderType, 0); }
  ...
  public static VectorOffset CreateButtonVector(FlatBufferBuilder builder, Japan.MessagePopupButtonType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateButtonVectorBlock(FlatBufferBuilder builder, Japan.MessagePopupButtonType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateButtonVectorBlock(FlatBufferBuilder builder, ArraySegment<Japan.MessagePopupButtonType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateButtonVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Japan.MessagePopupButtonType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Japan.MessagePopupExcel> EndMessagePopupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.MessagePopupExcel>(o);
  }
  ...
  public void UnPackTo(MessagePopupExcelT _o) {
    ...
    _o.MessagePopupLayout = TableEncryptionService.UseEncryption ? (Japan.MessagePopupLayout)TableEncryptionService.Convert((int)this.MessagePopupLayout, key) : this.MessagePopupLayout;
    _o.OrderType = TableEncryptionService.UseEncryption ? (Japan.MessagePopupImagePositionType)TableEncryptionService.Convert((int)this.OrderType, key) : this.OrderType;
    ...
    _o.Button = new List<Japan.MessagePopupButtonType>();
    for (var _j = 0; _j < this.ButtonLength; ++_j) {_o.Button.Add(TableEncryptionService.UseEncryption ? (Japan.MessagePopupButtonType)TableEncryptionService.Convert((int)this.Button(_j), key) : this.Button(_j));}
  ...
  public static Offset<Japan.MessagePopupExcel> Pack(FlatBufferBuilder builder, MessagePopupExcelT _o) {
    if (_o == null) return default(Offset<Japan.MessagePopupExcel>);
		byte[] key = TableEncryptionService.CreateKey("MessagePopup");
		var _StringId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)_o.StringId, key) : _o.StringId;
		var _MessagePopupLayout = TableEncryptionService.UseEncryption ? (Japan.MessagePopupLayout)TableEncryptionService.Convert((int)_o.MessagePopupLayout, key) : _o.MessagePopupLayout;
		var _OrderType = TableEncryptionService.UseEncryption ? (Japan.MessagePopupImagePositionType)TableEncryptionService.Convert((int)_o.OrderType, key) : _o.OrderType;
    ...
    if (_o.Button != null) {
      var __Button = _o.Button.Select(x => TableEncryptionService.UseEncryption ? (Japan.MessagePopupButtonType)TableEncryptionService.Convert((int)x, key) : x).ToArray();
...
public class MessagePopupExcelT
{
  ...
  public Japan.MessagePopupLayout MessagePopupLayout { get; set; }
  public Japan.MessagePopupImagePositionType OrderType { get; set; }
  ...
  public List<Japan.MessagePopupButtonType> Button { get; set; }
  ...
  public MessagePopupExcelT() {
    this.StringId = 0;
    this.MessagePopupLayout = Japan.MessagePopupLayout.TextOnly;
    this.OrderType = Japan.MessagePopupImagePositionType.ImageFirst;
    this.Image = null;
    this.TitleText = 0;
    this.SubTitleText = 0;
    this.MessageText = 0;
...
static public class MessagePopupExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*MessagePopupLayout*/, 4 /*Japan.MessagePopupLayout*/, 4, false)
      && verifier.VerifyField(tablePos, 8 /*OrderType*/, 4 /*Japan.MessagePopupImagePositionType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 22 /*Button*/, 4 /*Japan.MessagePopupButtonType*/, false)
