...
public struct RaidStageExcel : IFlatbufferObject
{
  ...
  public Japan.Difficulty Difficulty { get { int o = __p.__offset(20); return o != 0 ? (Japan.Difficulty)__p.bb.GetInt(o + __p.bb_pos) : Japan.Difficulty.Normal; } }
  ...
  public Japan.TacticEnvironment TacticEnvironment { get { int o = __p.__offset(36); return o != 0 ? (Japan.TacticEnvironment)__p.bb.GetInt(o + __p.bb_pos) : Japan.TacticEnvironment.None; } }
  ...
  public Japan.EchelonExtensionType EchelonExtensionType { get { int o = __p.__offset(72); return o != 0 ? (Japan.EchelonExtensionType)__p.bb.GetInt(o + __p.bb_pos) : Japan.EchelonExtensionType.Base; } }

  public static Offset<Japan.RaidStageExcel> CreateRaidStageExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddDifficulty(FlatBufferBuilder builder, Japan.Difficulty difficulty) { builder.AddInt(8, (int)difficulty, 0); }
  ...
  public static void AddTacticEnvironment(FlatBufferBuilder builder, Japan.TacticEnvironment tacticEnvironment) { builder.AddInt(16, (int)tacticEnvironment, 0); }
  ...
  public static void AddEchelonExtensionType(FlatBufferBuilder builder, Japan.EchelonExtensionType echelonExtensionType) { builder.AddInt(34, (int)echelonExtensionType, 0); }
  public static Offset<Japan.RaidStageExcel> EndRaidStageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.RaidStageExcel>(o);
  }
  ...
  public static Offset<Japan.RaidStageExcel> Pack(FlatBufferBuilder builder, RaidStageExcelT _o) {
    if (_o == null) return default(Offset<Japan.RaidStageExcel>);
		byte[] key = TableEncryptionService.CreateKey("RaidStage");
...
static public class RaidStageExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 20 /*Difficulty*/, 4 /*Japan.Difficulty*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 36 /*TacticEnvironment*/, 4 /*Japan.TacticEnvironment*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 72 /*EchelonExtensionType*/, 4 /*Japan.EchelonExtensionType*/, 4, false)
