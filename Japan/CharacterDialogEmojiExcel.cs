...
public struct CharacterDialogEmojiExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.CharacterDialogEmojiExcel> CreateCharacterDialogEmojiExcel(FlatBufferBuilder builder,
      long GroupId = 0,
      int TargetIndex = 0,
  ...
  public static Offset<Japan.CharacterDialogEmojiExcel> EndCharacterDialogEmojiExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.CharacterDialogEmojiExcel>(o);
  }
  ...
  public static Offset<Japan.CharacterDialogEmojiExcel> Pack(FlatBufferBuilder builder, CharacterDialogEmojiExcelT _o) {
    if (_o == null) return default(Offset<Japan.CharacterDialogEmojiExcel>);
		byte[] key = TableEncryptionService.CreateKey("CharacterDialogEmoji");
