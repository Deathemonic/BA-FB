...
public struct RecipeSelectionGroupExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.RecipeSelectionGroupExcel> CreateRecipeSelectionGroupExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.RecipeSelectionGroupExcel> EndRecipeSelectionGroupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.RecipeSelectionGroupExcel>(o);
  }
  ...
  public static Offset<Japan.RecipeSelectionGroupExcel> Pack(FlatBufferBuilder builder, RecipeSelectionGroupExcelT _o) {
    if (_o == null) return default(Offset<Japan.RecipeSelectionGroupExcel>);
		byte[] key = TableEncryptionService.CreateKey("RecipeSelectionGroup");
