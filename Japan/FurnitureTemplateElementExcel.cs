...
public struct FurnitureTemplateElementExcel : IFlatbufferObject
{
  ...
  public Japan.FurnitureLocation Location { get { int o = __p.__offset(8); return o != 0 ? (Japan.FurnitureLocation)__p.bb.GetInt(o + __p.bb_pos) : Japan.FurnitureLocation.None; } }
  ...
  public static Offset<Japan.FurnitureTemplateElementExcel> CreateFurnitureTemplateElementExcel(FlatBufferBuilder builder,
      long FurnitureTemplateId = 0,
      long FurnitureId = 0,
      Japan.FurnitureLocation Location = Japan.FurnitureLocation.None,
  ...
  public static void AddLocation(FlatBufferBuilder builder, Japan.FurnitureLocation location) { builder.AddInt(2, (int)location, 0); }
  ...
  public static Offset<Japan.FurnitureTemplateElementExcel> EndFurnitureTemplateElementExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.FurnitureTemplateElementExcel>(o);
  }
  ...
  public void UnPackTo(FurnitureTemplateElementExcelT _o) {
    ...
    _o.Location = TableEncryptionService.UseEncryption ? (Japan.FurnitureLocation)TableEncryptionService.Convert((int)this.Location, key) : this.Location;
  ...
  public static Offset<Japan.FurnitureTemplateElementExcel> Pack(FlatBufferBuilder builder, FurnitureTemplateElementExcelT _o) {
    if (_o == null) return default(Offset<Japan.FurnitureTemplateElementExcel>);
		byte[] key = TableEncryptionService.CreateKey("FurnitureTemplateElement");
		...
		var _Location = TableEncryptionService.UseEncryption ? (Japan.FurnitureLocation)TableEncryptionService.Convert((int)_o.Location, key) : _o.Location;
...
public class FurnitureTemplateElementExcelT
{
  ...
  public Japan.FurnitureLocation Location { get; set; }
  ...
  public FurnitureTemplateElementExcelT() {
    ...
    this.FurnitureId = 0;
    this.Location = Japan.FurnitureLocation.None;
    this.PositionX = 0.0f;
    this.PositionY = 0.0f;
    this.Rotation = 0.0f;
    this.Order = 0;
...
static public class FurnitureTemplateElementExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*Location*/, 4 /*Japan.FurnitureLocation*/, 4, false)
