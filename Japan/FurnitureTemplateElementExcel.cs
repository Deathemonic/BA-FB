...
public struct FurnitureTemplateElementExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(FurnitureTemplateElementExcelT _o) {
    ...
    _o.FurnitureTemplateId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.FurnitureTemplateId, key) : this.FurnitureTemplateId;
    _o.FurnitureId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.FurnitureId, key) : this.FurnitureId;
  ...
  public static Offset<Japan.FurnitureTemplateElementExcel> Pack(FlatBufferBuilder builder, FurnitureTemplateElementExcelT _o) {
    if (_o == null) return default(Offset<Japan.FurnitureTemplateElementExcel>);
		byte[] key = TableEncryptionService.CreateKey("FurnitureTemplateElement");
		var _FurnitureTemplateId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.FurnitureTemplateId, key) : _o.FurnitureTemplateId;
		var _FurnitureId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.FurnitureId, key) : _o.FurnitureId;
		var _Location = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Location, key) : _o.Location;
		var _PositionX = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PositionX, key) : _o.PositionX;
		var _PositionY = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PositionY, key) : _o.PositionY;
		var _Rotation = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Rotation, key) : _o.Rotation;
