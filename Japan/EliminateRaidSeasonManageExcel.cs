...
public struct EliminateRaidSeasonManageExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.EliminateRaidSeasonManageExcel> CreateEliminateRaidSeasonManageExcel(FlatBufferBuilder builder,
      long SeasonId = 0,
  ...
  public static Offset<Japan.EliminateRaidSeasonManageExcel> EndEliminateRaidSeasonManageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.EliminateRaidSeasonManageExcel>(o);
  }
  ...
  public static Offset<Japan.EliminateRaidSeasonManageExcel> Pack(FlatBufferBuilder builder, EliminateRaidSeasonManageExcelT _o) {
    if (_o == null) return default(Offset<Japan.EliminateRaidSeasonManageExcel>);
		byte[] key = TableEncryptionService.CreateKey("EliminateRaidSeasonManage");
		var _SeasonId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.SeasonId, key) : _o.SeasonId;
		var _SeasonDisplay = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.SeasonDisplay, key) : _o.SeasonDisplay;
    var _SeasonStartData = _o.SeasonStartData == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.SeasonStartData, key) : _o.SeasonStartData));
    var _EndNoteLabelStartDate = _o.EndNoteLabelStartDate == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.EndNoteLabelStartDate, key) : _o.EndNoteLabelStartDate));
    var _SeasonEndData = _o.SeasonEndData == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.SeasonEndData, key) : _o.SeasonEndData));
    var _SettlementEndDate = _o.SettlementEndDate == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.SettlementEndDate, key) : _o.SettlementEndDate));
    var _LobbyTableBGPath = _o.LobbyTableBGPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.LobbyTableBGPath, key) : _o.LobbyTableBGPath));
    var _LobbyScreenBGPath = _o.LobbyScreenBGPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.LobbyScreenBGPath, key) : _o.LobbyScreenBGPath));
    var _OpenRaidBossGroup01 = _o.OpenRaidBossGroup01 == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.OpenRaidBossGroup01, key) : _o.OpenRaidBossGroup01));
    var _OpenRaidBossGroup02 = _o.OpenRaidBossGroup02 == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.OpenRaidBossGroup02, key) : _o.OpenRaidBossGroup02));
    var _OpenRaidBossGroup03 = _o.OpenRaidBossGroup03 == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.OpenRaidBossGroup03, key) : _o.OpenRaidBossGroup03));
		...
		var _MaxSeasonRewardGauage = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MaxSeasonRewardGauage, key) : _o.MaxSeasonRewardGauage;
    ...
    if (_o.SeasonRewardId != null) {
      ...
      _SeasonRewardId = CreateSeasonRewardIdVector(builder, __SeasonRewardId);
		...
		var _LimitedRewardIdNormal = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.LimitedRewardIdNormal, key) : _o.LimitedRewardIdNormal;
		var _LimitedRewardIdHard = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.LimitedRewardIdHard, key) : _o.LimitedRewardIdHard;
		var _LimitedRewardIdVeryhard = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.LimitedRewardIdVeryhard, key) : _o.LimitedRewardIdVeryhard;
		var _LimitedRewardIdHardcore = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.LimitedRewardIdHardcore, key) : _o.LimitedRewardIdHardcore;
		var _LimitedRewardIdExtreme = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.LimitedRewardIdExtreme, key) : _o.LimitedRewardIdExtreme;
		var _LimitedRewardIdInsane = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.LimitedRewardIdInsane, key) : _o.LimitedRewardIdInsane;
		var _LimitedRewardIdTorment = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.LimitedRewardIdTorment, key) : _o.LimitedRewardIdTorment;
