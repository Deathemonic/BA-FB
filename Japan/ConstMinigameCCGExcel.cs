...
public struct ConstMinigameCCGExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.ConstMinigameCCGExcel> CreateConstMinigameCCGExcel(FlatBufferBuilder builder,
      int TurnDrawCount = 0,
  ...
  public static Offset<Japan.ConstMinigameCCGExcel> EndConstMinigameCCGExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ConstMinigameCCGExcel>(o);
  }
  ...
  public static Offset<Japan.ConstMinigameCCGExcel> Pack(FlatBufferBuilder builder, ConstMinigameCCGExcelT _o) {
    if (_o == null) return default(Offset<Japan.ConstMinigameCCGExcel>);
		byte[] key = TableEncryptionService.CreateKey("ConstMinigameCCG");
		var _TurnDrawCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.TurnDrawCount, key) : _o.TurnDrawCount;
    ...
    var _AniAllyBattleAttack = _o.AniAllyBattleAttack == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.AniAllyBattleAttack, key) : _o.AniAllyBattleAttack));
		var _MaxHandCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MaxHandCount, key) : _o.MaxHandCount;
		var _MaxCost = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MaxCost, key) : _o.MaxCost;
		var _StartCost = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StartCost, key) : _o.StartCost;
		var _TurnCost = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.TurnCost, key) : _o.TurnCost;
		var _StrikerSwapFrontCost = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StrikerSwapFrontCost, key) : _o.StrikerSwapFrontCost;
		var _StrikerMaxEquipCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StrikerMaxEquipCount, key) : _o.StrikerMaxEquipCount;
		var _StartDrawCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.StartDrawCount, key) : _o.StartDrawCount;
		var _CampReviveHealthRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CampReviveHealthRate, key) : _o.CampReviveHealthRate;
		var _BaseRewardRerollPoint = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.BaseRewardRerollPoint, key) : _o.BaseRewardRerollPoint;
		var _SelectRewardOptionCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.SelectRewardOptionCount, key) : _o.SelectRewardOptionCount;
    var _AlternativeCardImagePath = _o.AlternativeCardImagePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.AlternativeCardImagePath, key) : _o.AlternativeCardImagePath));
