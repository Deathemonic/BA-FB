...
public struct GuideMissionOpenStageConditionExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.GuideMissionOpenStageConditionExcel> CreateGuideMissionOpenStageConditionExcel(FlatBufferBuilder builder,
      long SeasonId = 0,
      long OrderNumber = 0,
  ...
  public static Offset<Japan.GuideMissionOpenStageConditionExcel> EndGuideMissionOpenStageConditionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.GuideMissionOpenStageConditionExcel>(o);
  }
  ...
  public static Offset<Japan.GuideMissionOpenStageConditionExcel> Pack(FlatBufferBuilder builder, GuideMissionOpenStageConditionExcelT _o) {
    if (_o == null) return default(Offset<Japan.GuideMissionOpenStageConditionExcel>);
		byte[] key = TableEncryptionService.CreateKey("GuideMissionOpenStageCondition");
