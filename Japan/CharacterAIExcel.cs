...
public struct CharacterAIExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(CharacterAIExcelT _o) {
    ...
    _o.EngageType = TableEncryptionService.UseEncryption ? (Japan.EngageType)TableEncryptionService.Convert((int)this.EngageType, key) : this.EngageType;
    _o.Positioning = TableEncryptionService.UseEncryption ? (Japan.PositioningType)TableEncryptionService.Convert((int)this.Positioning, key) : this.Positioning;
  ...
  public static Offset<Japan.CharacterAIExcel> Pack(FlatBufferBuilder builder, CharacterAIExcelT _o) {
    if (_o == null) return default(Offset<Japan.CharacterAIExcel>);
		...
		var _EngageType = TableEncryptionService.UseEncryption ? (Japan.EngageType)TableEncryptionService.Convert((int)_o.EngageType, key) : _o.EngageType;
		var _Positioning = TableEncryptionService.UseEncryption ? (Japan.PositioningType)TableEncryptionService.Convert((int)_o.Positioning, key) : _o.Positioning;
