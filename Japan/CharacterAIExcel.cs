...
public struct CharacterAIExcel : IFlatbufferObject
{
  ...
  public Japan.EngageType EngageType { get { int o = __p.__offset(6); return o != 0 ? (Japan.EngageType)__p.bb.GetInt(o + __p.bb_pos) : Japan.EngageType.SearchAndMove; } }
  public Japan.PositioningType Positioning { get { int o = __p.__offset(8); return o != 0 ? (Japan.PositioningType)__p.bb.GetInt(o + __p.bb_pos) : Japan.PositioningType.CloseToObstacle; } }
  ...
  public static Offset<Japan.CharacterAIExcel> CreateCharacterAIExcel(FlatBufferBuilder builder,
      long Id = 0,
      Japan.EngageType EngageType = Japan.EngageType.SearchAndMove,
      Japan.PositioningType Positioning = Japan.PositioningType.CloseToObstacle,
  ...
  public static void AddEngageType(FlatBufferBuilder builder, Japan.EngageType engageType) { builder.AddInt(1, (int)engageType, 0); }
  public static void AddPositioning(FlatBufferBuilder builder, Japan.PositioningType positioning) { builder.AddInt(2, (int)positioning, 0); }
  ...
  public static Offset<Japan.CharacterAIExcel> EndCharacterAIExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.CharacterAIExcel>(o);
  }
  ...
  public void UnPackTo(CharacterAIExcelT _o) {
    ...
    _o.EngageType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EngageType, key) : this.EngageType;
    _o.Positioning = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.Positioning, key) : this.Positioning;
    _o.CheckCanUseAutoSkill = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CheckCanUseAutoSkill, key) : this.CheckCanUseAutoSkill;
    _o.DistanceReduceRatioObstaclePath = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.DistanceReduceRatioObstaclePath, key) : this.DistanceReduceRatioObstaclePath;
    _o.DistanceReduceObstaclePath = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.DistanceReduceObstaclePath, key) : this.DistanceReduceObstaclePath;
    _o.DistanceReduceRatioFormationPath = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.DistanceReduceRatioFormationPath, key) : this.DistanceReduceRatioFormationPath;
    _o.DistanceReduceFormationPath = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.DistanceReduceFormationPath, key) : this.DistanceReduceFormationPath;
    _o.MinimumPositionGap = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MinimumPositionGap, key) : this.MinimumPositionGap;
    _o.CanUseObstacleOfKneelMotion = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CanUseObstacleOfKneelMotion, key) : this.CanUseObstacleOfKneelMotion;
    _o.CanUseObstacleOfStandMotion = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CanUseObstacleOfStandMotion, key) : this.CanUseObstacleOfStandMotion;
    _o.HasTargetSwitchingMotion = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.HasTargetSwitchingMotion, key) : this.HasTargetSwitchingMotion;
  }
  public static Offset<Japan.CharacterAIExcel> Pack(FlatBufferBuilder builder, CharacterAIExcelT _o) {
    if (_o == null) return default(Offset<Japan.CharacterAIExcel>);
		byte[] key = TableEncryptionService.CreateKey("CharacterAI");
		var _Id = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Id, key) : _o.Id;
		var _EngageType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EngageType, key) : _o.EngageType;
		var _Positioning = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.Positioning, key) : _o.Positioning;
		var _CheckCanUseAutoSkill = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CheckCanUseAutoSkill, key) : _o.CheckCanUseAutoSkill;
		var _DistanceReduceRatioObstaclePath = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DistanceReduceRatioObstaclePath, key) : _o.DistanceReduceRatioObstaclePath;
		var _DistanceReduceObstaclePath = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DistanceReduceObstaclePath, key) : _o.DistanceReduceObstaclePath;
		var _DistanceReduceRatioFormationPath = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DistanceReduceRatioFormationPath, key) : _o.DistanceReduceRatioFormationPath;
		var _DistanceReduceFormationPath = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.DistanceReduceFormationPath, key) : _o.DistanceReduceFormationPath;
		var _MinimumPositionGap = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.MinimumPositionGap, key) : _o.MinimumPositionGap;
		var _CanUseObstacleOfKneelMotion = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CanUseObstacleOfKneelMotion, key) : _o.CanUseObstacleOfKneelMotion;
		var _CanUseObstacleOfStandMotion = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CanUseObstacleOfStandMotion, key) : _o.CanUseObstacleOfStandMotion;
		var _HasTargetSwitchingMotion = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.HasTargetSwitchingMotion, key) : _o.HasTargetSwitchingMotion;
...
public class CharacterAIExcelT
{
  ...
  public Japan.EngageType EngageType { get; set; }
  public Japan.PositioningType Positioning { get; set; }
  ...
  public CharacterAIExcelT() {
    this.Id = 0;
    this.EngageType = Japan.EngageType.SearchAndMove;
    this.Positioning = Japan.PositioningType.CloseToObstacle;
...
static public class CharacterAIExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*EngageType*/, 4 /*Japan.EngageType*/, 4, false)
      && verifier.VerifyField(tablePos, 8 /*Positioning*/, 4 /*Japan.PositioningType*/, 4, false)
