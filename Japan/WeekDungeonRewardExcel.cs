...
public struct WeekDungeonRewardExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(WeekDungeonRewardExcelT _o) {
    ...
    _o.DungeonType = TableEncryptionService.UseEncryption ? (Japan.WeekDungeonType)TableEncryptionService.Convert((int)this.DungeonType, key) : this.DungeonType;
  ...
  public static Offset<Japan.WeekDungeonRewardExcel> Pack(FlatBufferBuilder builder, WeekDungeonRewardExcelT _o) {
    if (_o == null) return default(Offset<Japan.WeekDungeonRewardExcel>);
		...
		var _DungeonType = TableEncryptionService.UseEncryption ? (Japan.WeekDungeonType)TableEncryptionService.Convert((int)_o.DungeonType, key) : _o.DungeonType;
