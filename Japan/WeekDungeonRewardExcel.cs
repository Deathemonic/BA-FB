...
public struct WeekDungeonRewardExcel : IFlatbufferObject
{
  ...
  public Japan.WeekDungeonType DungeonType { get { int o = __p.__offset(6); return o != 0 ? (Japan.WeekDungeonType)__p.bb.GetInt(o + __p.bb_pos) : Japan.WeekDungeonType.None; } }
  ...
  public static Offset<Japan.WeekDungeonRewardExcel> CreateWeekDungeonRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
      Japan.WeekDungeonType DungeonType = Japan.WeekDungeonType.None,
  ...
  public static void AddDungeonType(FlatBufferBuilder builder, Japan.WeekDungeonType dungeonType) { builder.AddInt(1, (int)dungeonType, 0); }
  ...
  public static Offset<Japan.WeekDungeonRewardExcel> EndWeekDungeonRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.WeekDungeonRewardExcel>(o);
  }
  ...
  public static Offset<Japan.WeekDungeonRewardExcel> Pack(FlatBufferBuilder builder, WeekDungeonRewardExcelT _o) {
    if (_o == null) return default(Offset<Japan.WeekDungeonRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("WeekDungeonReward");
...
public class WeekDungeonRewardExcelT
{
  ...
  public Japan.WeekDungeonType DungeonType { get; set; }
  ...
  public WeekDungeonRewardExcelT() {
    this.GroupId = 0;
    this.DungeonType = Japan.WeekDungeonType.None;
...
static public class WeekDungeonRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*DungeonType*/, 4 /*Japan.WeekDungeonType*/, 4, false)
