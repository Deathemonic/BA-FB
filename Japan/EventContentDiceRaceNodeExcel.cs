...
public struct EventContentDiceRaceNodeExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(EventContentDiceRaceNodeExcelT _o) {
    ...
    _o.EventContentDiceRaceNodeType = TableEncryptionService.UseEncryption ? (Japan.EventContentDiceRaceNodeType)TableEncryptionService.Convert((int)this.EventContentDiceRaceNodeType, key) : this.EventContentDiceRaceNodeType;
  ...
  public static Offset<Japan.EventContentDiceRaceNodeExcel> Pack(FlatBufferBuilder builder, EventContentDiceRaceNodeExcelT _o) {
    if (_o == null) return default(Offset<Japan.EventContentDiceRaceNodeExcel>);
		...
		var _EventContentDiceRaceNodeType = TableEncryptionService.UseEncryption ? (Japan.EventContentDiceRaceNodeType)TableEncryptionService.Convert((int)_o.EventContentDiceRaceNodeType, key) : _o.EventContentDiceRaceNodeType;
