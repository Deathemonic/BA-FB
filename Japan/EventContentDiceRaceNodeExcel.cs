...
public struct EventContentDiceRaceNodeExcel : IFlatbufferObject
{
  ...
  public Japan.EventContentDiceRaceNodeType EventContentDiceRaceNodeType { get { int o = __p.__offset(8); return o != 0 ? (Japan.EventContentDiceRaceNodeType)__p.bb.GetInt(o + __p.bb_pos) : Japan.EventContentDiceRaceNodeType.StartNode; } }
  ...
  public static Offset<Japan.EventContentDiceRaceNodeExcel> CreateEventContentDiceRaceNodeExcel(FlatBufferBuilder builder,
  ...
  public static void AddEventContentDiceRaceNodeType(FlatBufferBuilder builder, Japan.EventContentDiceRaceNodeType eventContentDiceRaceNodeType) { builder.AddInt(2, (int)eventContentDiceRaceNodeType, 0); }
  ...
  public static Offset<Japan.EventContentDiceRaceNodeExcel> EndEventContentDiceRaceNodeExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.EventContentDiceRaceNodeExcel>(o);
  }
  ...
  public void UnPackTo(EventContentDiceRaceNodeExcelT _o) {
    ...
    _o.EventContentDiceRaceNodeType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EventContentDiceRaceNodeType, key) : this.EventContentDiceRaceNodeType;
    _o.MoveForwardTypeArg = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.MoveForwardTypeArg, key) : this.MoveForwardTypeArg;
  ...
  public static Offset<Japan.EventContentDiceRaceNodeExcel> Pack(FlatBufferBuilder builder, EventContentDiceRaceNodeExcelT _o) {
    if (_o == null) return default(Offset<Japan.EventContentDiceRaceNodeExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentDiceRaceNode");
...
public class EventContentDiceRaceNodeExcelT
{
  ...
  public Japan.EventContentDiceRaceNodeType EventContentDiceRaceNodeType { get; set; }
  ...
  public EventContentDiceRaceNodeExcelT() {
    ...
    this.NodeId = 0;
    this.EventContentDiceRaceNodeType = Japan.EventContentDiceRaceNodeType.StartNode;
...
static public class EventContentDiceRaceNodeExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*EventContentDiceRaceNodeType*/, 4 /*Japan.EventContentDiceRaceNodeType*/, 4, false)
