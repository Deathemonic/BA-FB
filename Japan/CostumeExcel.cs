...
public struct CostumeExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(CostumeExcelT _o) {
    ...
    _o.EntityMaterialType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.EntityMaterialType, key) : this.EntityMaterialType;
    ...
    _o.UseObjectHPBAR = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.UseObjectHPBAR, key) : this.UseObjectHPBAR;
    ...
    _o.AnimationValidator = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.AnimationValidator, key) : this.AnimationValidator;
    _o.CharacterVoiceGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CharacterVoiceGroupId, key) : this.CharacterVoiceGroupId;
    _o.ShowObjectHpStatus = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.ShowObjectHpStatus, key) : this.ShowObjectHpStatus;
  }
  public static Offset<Japan.CostumeExcel> Pack(FlatBufferBuilder builder, CostumeExcelT _o) {
    ...
    var _AnimatorName = _o.AnimatorName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.AnimatorName, key) : _o.AnimatorName));
    var _CafeModelPrefabName = _o.CafeModelPrefabName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.CafeModelPrefabName, key) : _o.CafeModelPrefabName));
    var _EchelonModelPrefabName = _o.EchelonModelPrefabName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.EchelonModelPrefabName, key) : _o.EchelonModelPrefabName));
    var _StrategyModelPrefabName = _o.StrategyModelPrefabName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.StrategyModelPrefabName, key) : _o.StrategyModelPrefabName));
    var _TextureDir = _o.TextureDir == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.TextureDir, key) : _o.TextureDir));
    var _CollectionTexturePath = _o.CollectionTexturePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.CollectionTexturePath, key) : _o.CollectionTexturePath));
    var _CollectionBGTexturePath = _o.CollectionBGTexturePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.CollectionBGTexturePath, key) : _o.CollectionBGTexturePath));
    ...
    var _EnterStrategyAnimationName = _o.EnterStrategyAnimationName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.EnterStrategyAnimationName, key) : _o.EnterStrategyAnimationName));
		var _AnimationValidator = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.AnimationValidator, key) : _o.AnimationValidator;
		var _CharacterVoiceGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CharacterVoiceGroupId, key) : _o.CharacterVoiceGroupId;
		var _ShowObjectHpStatus = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ShowObjectHpStatus, key) : _o.ShowObjectHpStatus;
