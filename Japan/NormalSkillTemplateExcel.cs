...
public struct NormalSkillTemplateExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.NormalSkillTemplateExcel> CreateNormalSkillTemplateExcel(FlatBufferBuilder builder,
      long Index = 0,
  ...
  public static Offset<Japan.NormalSkillTemplateExcel> EndNormalSkillTemplateExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.NormalSkillTemplateExcel>(o);
  }
  ...
  public static Offset<Japan.NormalSkillTemplateExcel> Pack(FlatBufferBuilder builder, NormalSkillTemplateExcelT _o) {
    if (_o == null) return default(Offset<Japan.NormalSkillTemplateExcel>);
		byte[] key = TableEncryptionService.CreateKey("NormalSkillTemplate");
