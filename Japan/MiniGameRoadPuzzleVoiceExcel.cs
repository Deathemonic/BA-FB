...
public struct MiniGameRoadPuzzleVoiceExcel : IFlatbufferObject
{
  ...
  public Japan.RoadPuzzleVoiceCondition VoiceCondition { get { int o = __p.__offset(8); return o != 0 ? (Japan.RoadPuzzleVoiceCondition)__p.bb.GetInt(o + __p.bb_pos) : Japan.RoadPuzzleVoiceCondition.None; } }
  public uint VoiceClip { get { int o = __p.__offset(10); return o != 0 ? __p.bb.GetUint(o + __p.bb_pos) : (uint)0; } }

  public static Offset<Japan.MiniGameRoadPuzzleVoiceExcel> CreateMiniGameRoadPuzzleVoiceExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      long UniqueId = 0,
      Japan.RoadPuzzleVoiceCondition VoiceCondition = Japan.RoadPuzzleVoiceCondition.None,
      uint VoiceClip = 0) {
  ...
  public static void AddVoiceCondition(FlatBufferBuilder builder, Japan.RoadPuzzleVoiceCondition voiceCondition) { builder.AddInt(2, (int)voiceCondition, 0); }
  public static void AddVoiceClip(FlatBufferBuilder builder, uint voiceClip) { builder.AddUint(3, voiceClip, 0); }
  public static Offset<Japan.MiniGameRoadPuzzleVoiceExcel> EndMiniGameRoadPuzzleVoiceExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.MiniGameRoadPuzzleVoiceExcel>(o);
  }
  ...
  public void UnPackTo(MiniGameRoadPuzzleVoiceExcelT _o) {
    ...
    _o.VoiceCondition = TableEncryptionService.UseEncryption ? (Japan.RoadPuzzleVoiceCondition)TableEncryptionService.Convert((int)this.VoiceCondition, key) : this.VoiceCondition;
    _o.VoiceClip = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((uint)this.VoiceClip, key) : this.VoiceClip;
  }
  public static Offset<Japan.MiniGameRoadPuzzleVoiceExcel> Pack(FlatBufferBuilder builder, MiniGameRoadPuzzleVoiceExcelT _o) {
    if (_o == null) return default(Offset<Japan.MiniGameRoadPuzzleVoiceExcel>);
		byte[] key = TableEncryptionService.CreateKey("MiniGameRoadPuzzleVoice");
		...
		var _VoiceCondition = TableEncryptionService.UseEncryption ? (Japan.RoadPuzzleVoiceCondition)TableEncryptionService.Convert((int)_o.VoiceCondition, key) : _o.VoiceCondition;
...
public class MiniGameRoadPuzzleVoiceExcelT
{
  ...
  public Japan.RoadPuzzleVoiceCondition VoiceCondition { get; set; }
  public uint VoiceClip { get; set; }

  public MiniGameRoadPuzzleVoiceExcelT() {
    this.EventContentId = 0;
    this.UniqueId = 0;
    this.VoiceCondition = Japan.RoadPuzzleVoiceCondition.None;
    this.VoiceClip = 0;
  }
}
...
static public class MiniGameRoadPuzzleVoiceExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*VoiceCondition*/, 4 /*Japan.RoadPuzzleVoiceCondition*/, 4, false)
