...
public struct EliminateRaidRankingRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.EliminateRaidRankingRewardExcel> CreateEliminateRaidRankingRewardExcel(FlatBufferBuilder builder,
  ...
  public static void StartEliminateRaidRankingRewardExcel(FlatBufferBuilder builder) { builder.StartTable(10); }
  ...
  public static Offset<Japan.EliminateRaidRankingRewardExcel> EndEliminateRaidRankingRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.EliminateRaidRankingRewardExcel>(o);
  }
  ...
  public static Offset<Japan.EliminateRaidRankingRewardExcel> Pack(FlatBufferBuilder builder, EliminateRaidRankingRewardExcelT _o) {
    if (_o == null) return default(Offset<Japan.EliminateRaidRankingRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("EliminateRaidRankingReward");
