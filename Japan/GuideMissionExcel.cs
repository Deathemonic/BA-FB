...
public struct GuideMissionExcel : IFlatbufferObject
{
  ...
  public Japan.MissionCompleteConditionType CompleteConditionType { get { int o = __p.__offset(24); return o != 0 ? (Japan.MissionCompleteConditionType)__p.bb.GetInt(o + __p.bb_pos) : Japan.MissionCompleteConditionType.None; } }
  ...
  public Japan.Tag CompleteConditionParameterTag(int j) { int o = __p.__offset(30); return o != 0 ? (Japan.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.Tag)0; }
  public int CompleteConditionParameterTagLength { get { int o = __p.__offset(30); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.Tag> GetCompleteConditionParameterTagBytes() { return __p.__vector_as_span<Japan.Tag>(30, 4); }
#else
  public ArraySegment<byte>? GetCompleteConditionParameterTagBytes() { return __p.__vector_as_arraysegment(30); }
#endif
  public Japan.Tag[] GetCompleteConditionParameterTagArray() { int o = __p.__offset(30); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.Tag[] a = new Japan.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.Tag)__p.bb.GetInt(p + i * 4); } return a; }
  public bool IsAutoClearForScenario { get { int o = __p.__offset(32); return o != 0 ? 0!=__p.bb.Get(o + __p.bb_pos) : (bool)false; } }
  public Japan.ParcelType MissionRewardParcelType(int j) { int o = __p.__offset(34); return o != 0 ? (Japan.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.ParcelType)0; }
  public int MissionRewardParcelTypeLength { get { int o = __p.__offset(34); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.ParcelType> GetMissionRewardParcelTypeBytes() { return __p.__vector_as_span<Japan.ParcelType>(34, 4); }
#else
  public ArraySegment<byte>? GetMissionRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(34); }
#endif
  public Japan.ParcelType[] GetMissionRewardParcelTypeArray() { int o = __p.__offset(34); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.ParcelType[] a = new Japan.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Japan.GuideMissionExcel> CreateGuideMissionExcel(FlatBufferBuilder builder,
      long SeasonId = 0,
      long Id = 0,
  ...
  public static void AddCompleteConditionType(FlatBufferBuilder builder, Japan.MissionCompleteConditionType completeConditionType) { builder.AddInt(10, (int)completeConditionType, 0); }
  ...
  public static Offset<Japan.GuideMissionExcel> EndGuideMissionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.GuideMissionExcel>(o);
  }
  ...
  public void UnPackTo(GuideMissionExcelT _o) {
    ...
    _o.TabNumber = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.TabNumber, key) : this.TabNumber;
    ...
    _o.IsAutoClearForScenario = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)this.IsAutoClearForScenario, key) : this.IsAutoClearForScenario;
  ...
  public static Offset<Japan.GuideMissionExcel> Pack(FlatBufferBuilder builder, GuideMissionExcelT _o) {
    if (_o == null) return default(Offset<Japan.GuideMissionExcel>);
		byte[] key = TableEncryptionService.CreateKey("GuideMission");
		...
		var _TabNumber = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.TabNumber, key) : _o.TabNumber;
    ...
    if (_o.CompleteConditionParameterTag != null) {
      ...
      _CompleteConditionParameterTag = CreateCompleteConditionParameterTagVector(builder, __CompleteConditionParameterTag);
		...
		var _IsAutoClearForScenario = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((bool)_o.IsAutoClearForScenario, key) : _o.IsAutoClearForScenario;
...
static public class GuideMissionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 24 /*CompleteConditionType*/, 4 /*Japan.MissionCompleteConditionType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 30 /*CompleteConditionParameterTag*/, 4 /*Japan.Tag*/, false)
      && verifier.VerifyField(tablePos, 32 /*IsAutoClearForScenario*/, 1 /*bool*/, 1, false)
      && verifier.VerifyVectorOfData(tablePos, 34 /*MissionRewardParcelType*/, 4 /*Japan.ParcelType*/, false)
