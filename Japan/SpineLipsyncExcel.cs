...
public struct SpineLipsyncExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.SpineLipsyncExcel> CreateSpineLipsyncExcel(FlatBufferBuilder builder,
      uint VoiceId = 0,
  ...
  public static Offset<Japan.SpineLipsyncExcel> EndSpineLipsyncExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.SpineLipsyncExcel>(o);
  }
  ...
  public static Offset<Japan.SpineLipsyncExcel> Pack(FlatBufferBuilder builder, SpineLipsyncExcelT _o) {
    if (_o == null) return default(Offset<Japan.SpineLipsyncExcel>);
		byte[] key = TableEncryptionService.CreateKey("SpineLipsync");
