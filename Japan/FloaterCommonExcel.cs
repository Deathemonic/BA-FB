...
public struct FloaterCommonExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.FloaterCommonExcel> CreateFloaterCommonExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Japan.FloaterCommonExcel> EndFloaterCommonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.FloaterCommonExcel>(o);
  }
  ...
  public static Offset<Japan.FloaterCommonExcel> Pack(FlatBufferBuilder builder, FloaterCommonExcelT _o) {
    if (_o == null) return default(Offset<Japan.FloaterCommonExcel>);
		byte[] key = TableEncryptionService.CreateKey("FloaterCommon");
		...
		var _FloaterOffsetPosX = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.FloaterOffsetPosX, key) : _o.FloaterOffsetPosX;
		var _FloaterOffsetPosY = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.FloaterOffsetPosY, key) : _o.FloaterOffsetPosY;
		var _FloaterRandomPosRangeX = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.FloaterRandomPosRangeX, key) : _o.FloaterRandomPosRangeX;
		var _FloaterRandomPosRangeY = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.FloaterRandomPosRangeY, key) : _o.FloaterRandomPosRangeY;
