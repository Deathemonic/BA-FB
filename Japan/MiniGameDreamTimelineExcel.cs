...
public struct MiniGameDreamTimelineExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.MiniGameDreamTimelineExcel> CreateMiniGameDreamTimelineExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Japan.MiniGameDreamTimelineExcel> EndMiniGameDreamTimelineExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.MiniGameDreamTimelineExcel>(o);
  }
  ...
  public static Offset<Japan.MiniGameDreamTimelineExcel> Pack(FlatBufferBuilder builder, MiniGameDreamTimelineExcelT _o) {
    if (_o == null) return default(Offset<Japan.MiniGameDreamTimelineExcel>);
		byte[] key = TableEncryptionService.CreateKey("MiniGameDreamTimeline");
