...
public struct ShopRefreshExcel : IFlatbufferObject
{
  ...
  public Japan.ProductDisplayTag DisplayTag { get { int o = __p.__offset(26); return o != 0 ? (Japan.ProductDisplayTag)__p.bb.GetInt(o + __p.bb_pos) : Japan.ProductDisplayTag.None; } }
  ...
  public static void AddDisplayTag(FlatBufferBuilder builder, Japan.ProductDisplayTag displayTag) { builder.AddInt(11, (int)displayTag, 0); }
...
static public class ShopRefreshExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 26 /*DisplayTag*/, 4 /*Japan.ProductDisplayTag*/, 4, false)
