...
public struct EventContentCharacterBonusExcel : IFlatbufferObject
{
  ...
  public Japan.EventContentItemType EventContentItemType(int j) { int o = __p.__offset(8); return o != 0 ? (Japan.EventContentItemType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.EventContentItemType)0; }
  public int EventContentItemTypeLength { get { int o = __p.__offset(8); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.EventContentItemType> GetEventContentItemTypeBytes() { return __p.__vector_as_span<Japan.EventContentItemType>(8, 4); }
#else
  public ArraySegment<byte>? GetEventContentItemTypeBytes() { return __p.__vector_as_arraysegment(8); }
#endif
  public Japan.EventContentItemType[] GetEventContentItemTypeArray() { int o = __p.__offset(8); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.EventContentItemType[] a = new Japan.EventContentItemType[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.EventContentItemType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static VectorOffset CreateEventContentItemTypeVector(FlatBufferBuilder builder, Japan.EventContentItemType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateEventContentItemTypeVectorBlock(FlatBufferBuilder builder, Japan.EventContentItemType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateEventContentItemTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Japan.EventContentItemType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateEventContentItemTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Japan.EventContentItemType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Japan.EventContentCharacterBonusExcel> EndEventContentCharacterBonusExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.EventContentCharacterBonusExcel>(o);
  }
  ...
  public void UnPackTo(EventContentCharacterBonusExcelT _o) {
    ...
    _o.EventContentItemType = new List<Japan.EventContentItemType>();
    for (var _j = 0; _j < this.EventContentItemTypeLength; ++_j) {_o.EventContentItemType.Add(TableEncryptionService.UseEncryption ? (Japan.EventContentItemType)TableEncryptionService.Convert((int)this.EventContentItemType(_j), key) : this.EventContentItemType(_j));}
  ...
  public static Offset<Japan.EventContentCharacterBonusExcel> Pack(FlatBufferBuilder builder, EventContentCharacterBonusExcelT _o) {
    if (_o == null) return default(Offset<Japan.EventContentCharacterBonusExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentCharacterBonus");
    ...
    if (_o.EventContentItemType != null) {
      var __EventContentItemType = _o.EventContentItemType.Select(x => TableEncryptionService.UseEncryption ? (Japan.EventContentItemType)TableEncryptionService.Convert((int)x, key) : x).ToArray();
...
public class EventContentCharacterBonusExcelT
{
  ...
  public List<Japan.EventContentItemType> EventContentItemType { get; set; }
...
static public class EventContentCharacterBonusExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 8 /*EventContentItemType*/, 4 /*Japan.EventContentItemType*/, false)
