...
public struct FieldInteractionExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.FieldInteractionExcel> Pack(FlatBufferBuilder builder, FieldInteractionExcelT _o) {
    if (_o == null) return default(Offset<Japan.FieldInteractionExcel>);
		byte[] key = TableEncryptionService.CreateKey("FieldInteraction");
		var _FieldSeasonId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.FieldSeasonId, key) : _o.FieldSeasonId;
		var _UniqueId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.UniqueId, key) : _o.UniqueId;
		var _FieldDateId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.FieldDateId, key) : _o.FieldDateId;
		var _ShowEmoji = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ShowEmoji, key) : _o.ShowEmoji;
    var _KeywordLocalize = _o.KeywordLocalize == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.KeywordLocalize, key) : _o.KeywordLocalize));
