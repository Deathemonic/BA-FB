...
public struct FieldInteractionExcel : IFlatbufferObject
{
  ...
  public Japan.FieldInteractionType InteractionType(int j) { int o = __p.__offset(14); return o != 0 ? (Japan.FieldInteractionType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.FieldInteractionType)0; }
  public int InteractionTypeLength { get { int o = __p.__offset(14); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.FieldInteractionType> GetInteractionTypeBytes() { return __p.__vector_as_span<Japan.FieldInteractionType>(14, 4); }
#else
  public ArraySegment<byte>? GetInteractionTypeBytes() { return __p.__vector_as_arraysegment(14); }
#endif
  public Japan.FieldInteractionType[] GetInteractionTypeArray() { int o = __p.__offset(14); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.FieldInteractionType[] a = new Japan.FieldInteractionType[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.FieldInteractionType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Japan.FieldConditionClass ConditionClass { get { int o = __p.__offset(18); return o != 0 ? (Japan.FieldConditionClass)__p.bb.GetInt(o + __p.bb_pos) : Japan.FieldConditionClass.AndOr; } }
  ...
  public Japan.FieldConditionType ConditionType(int j) { int o = __p.__offset(26); return o != 0 ? (Japan.FieldConditionType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.FieldConditionType)0; }
  public int ConditionTypeLength { get { int o = __p.__offset(26); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.FieldConditionType> GetConditionTypeBytes() { return __p.__vector_as_span<Japan.FieldConditionType>(26, 4); }
#else
  public ArraySegment<byte>? GetConditionTypeBytes() { return __p.__vector_as_arraysegment(26); }
#endif
  public Japan.FieldConditionType[] GetConditionTypeArray() { int o = __p.__offset(26); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.FieldConditionType[] a = new Japan.FieldConditionType[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.FieldConditionType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Japan.FieldInteractionExcel> CreateFieldInteractionExcel(FlatBufferBuilder builder,
      ...
      Japan.FieldConditionClass ConditionClass = Japan.FieldConditionClass.AndOr,
  ...
  public static VectorOffset CreateInteractionTypeVector(FlatBufferBuilder builder, Japan.FieldInteractionType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateInteractionTypeVectorBlock(FlatBufferBuilder builder, Japan.FieldInteractionType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateInteractionTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Japan.FieldInteractionType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateInteractionTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Japan.FieldInteractionType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static void AddConditionClass(FlatBufferBuilder builder, Japan.FieldConditionClass conditionClass) { builder.AddInt(7, (int)conditionClass, 0); }
  ...
  public static VectorOffset CreateConditionTypeVector(FlatBufferBuilder builder, Japan.FieldConditionType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateConditionTypeVectorBlock(FlatBufferBuilder builder, Japan.FieldConditionType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateConditionTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Japan.FieldConditionType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateConditionTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Japan.FieldConditionType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Japan.FieldInteractionExcel> EndFieldInteractionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.FieldInteractionExcel>(o);
  }
  ...
  public void UnPackTo(FieldInteractionExcelT _o) {
    ...
    _o.InteractionType = new List<Japan.FieldInteractionType>();
    for (var _j = 0; _j < this.InteractionTypeLength; ++_j) {_o.InteractionType.Add(TableEncryptionService.UseEncryption ? (Japan.FieldInteractionType)TableEncryptionService.Convert((int)this.InteractionType(_j), key) : this.InteractionType(_j));}
    ...
    _o.ConditionClass = TableEncryptionService.UseEncryption ? (Japan.FieldConditionClass)TableEncryptionService.Convert((int)this.ConditionClass, key) : this.ConditionClass;
    ...
    _o.ConditionType = new List<Japan.FieldConditionType>();
    for (var _j = 0; _j < this.ConditionTypeLength; ++_j) {_o.ConditionType.Add(TableEncryptionService.UseEncryption ? (Japan.FieldConditionType)TableEncryptionService.Convert((int)this.ConditionType(_j), key) : this.ConditionType(_j));}
  ...
  public static Offset<Japan.FieldInteractionExcel> Pack(FlatBufferBuilder builder, FieldInteractionExcelT _o) {
    if (_o == null) return default(Offset<Japan.FieldInteractionExcel>);
		byte[] key = TableEncryptionService.CreateKey("FieldInteraction");
    ...
    if (_o.InteractionType != null) {
      var __interactionType = _o.InteractionType.Select(x => TableEncryptionService.UseEncryption ? (Japan.FieldInteractionType)TableEncryptionService.Convert((int)x, key) : x).ToArray();
    ...
    if (_o.InteractionId != null) {
      ...
      _interactionId = CreateInteractionIdVector(builder, __interactionId);
		...
		var _ConditionClass = TableEncryptionService.UseEncryption ? (Japan.FieldConditionClass)TableEncryptionService.Convert((int)_o.ConditionClass, key) : _o.ConditionClass;
    ...
    if (_o.ConditionType != null) {
      var __conditionType = _o.ConditionType.Select(x => TableEncryptionService.UseEncryption ? (Japan.FieldConditionType)TableEncryptionService.Convert((int)x, key) : x).ToArray();
...
public class FieldInteractionExcelT
{
  ...
  public List<Japan.FieldInteractionType> InteractionType { get; set; }
  public List<long> InteractionId { get; set; }
  public Japan.FieldConditionClass ConditionClass { get; set; }
  public List<long> ConditionClassParameters { get; set; }
  public bool OnceOnly { get; set; }
  public List<long> ConditionIndex { get; set; }
  public List<Japan.FieldConditionType> ConditionType { get; set; }
  ...
  public FieldInteractionExcelT() {
    ...
    this.ConditionClass = Japan.FieldConditionClass.AndOr;
...
static public class FieldInteractionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 14 /*InteractionType*/, 4 /*Japan.FieldInteractionType*/, false)
      && verifier.VerifyVectorOfData(tablePos, 16 /*InteractionId*/, 8 /*long*/, false)
      && verifier.VerifyField(tablePos, 18 /*ConditionClass*/, 4 /*Japan.FieldConditionClass*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 26 /*ConditionType*/, 4 /*Japan.FieldConditionType*/, false)
