...
public struct CafeProductionExcel : IFlatbufferObject
{
  ...
  public Japan.ParcelType CafeProductionParcelType { get { int o = __p.__offset(8); return o != 0 ? (Japan.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Japan.ParcelType.None; } }
  ...
  public static Offset<Japan.CafeProductionExcel> CreateCafeProductionExcel(FlatBufferBuilder builder,
      long CafeId = 0,
      long Rank = 0,
      Japan.ParcelType CafeProductionParcelType = Japan.ParcelType.None,
  ...
  public static void AddCafeProductionParcelType(FlatBufferBuilder builder, Japan.ParcelType cafeProductionParcelType) { builder.AddInt(2, (int)cafeProductionParcelType, 0); }
  ...
  public static Offset<Japan.CafeProductionExcel> EndCafeProductionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.CafeProductionExcel>(o);
  }
  ...
  public static Offset<Japan.CafeProductionExcel> Pack(FlatBufferBuilder builder, CafeProductionExcelT _o) {
    if (_o == null) return default(Offset<Japan.CafeProductionExcel>);
		byte[] key = TableEncryptionService.CreateKey("CafeProduction");
...
public class CafeProductionExcelT
{
  ...
  public Japan.ParcelType CafeProductionParcelType { get; set; }
  ...
  public CafeProductionExcelT() {
    this.CafeId = 0;
    this.Rank = 0;
    this.CafeProductionParcelType = Japan.ParcelType.None;
...
static public class CafeProductionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*CafeProductionParcelType*/, 4 /*Japan.ParcelType*/, 4, false)
