...
public struct CafeProductionExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(CafeProductionExcelT _o) {
    ...
    _o.CafeProductionParcelType = TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)this.CafeProductionParcelType, key) : this.CafeProductionParcelType;
  ...
  public static Offset<Japan.CafeProductionExcel> Pack(FlatBufferBuilder builder, CafeProductionExcelT _o) {
    if (_o == null) return default(Offset<Japan.CafeProductionExcel>);
		...
		var _CafeProductionParcelType = TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)_o.CafeProductionParcelType, key) : _o.CafeProductionParcelType;
