...
public struct TimeAttackDungeonRewardExcel : IFlatbufferObject
{
  ...
  public Japan.TimeAttackDungeonRewardType RewardType(int j) { int o = __p.__offset(8); return o != 0 ? (Japan.TimeAttackDungeonRewardType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.TimeAttackDungeonRewardType)0; }
  public int RewardTypeLength { get { int o = __p.__offset(8); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.TimeAttackDungeonRewardType> GetRewardTypeBytes() { return __p.__vector_as_span<Japan.TimeAttackDungeonRewardType>(8, 4); }
#else
  public ArraySegment<byte>? GetRewardTypeBytes() { return __p.__vector_as_arraysegment(8); }
#endif
  public Japan.TimeAttackDungeonRewardType[] GetRewardTypeArray() { int o = __p.__offset(8); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.TimeAttackDungeonRewardType[] a = new Japan.TimeAttackDungeonRewardType[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.TimeAttackDungeonRewardType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Japan.ParcelType RewardParcelType(int j) { int o = __p.__offset(12); return o != 0 ? (Japan.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.ParcelType)0; }
  public int RewardParcelTypeLength { get { int o = __p.__offset(12); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.ParcelType> GetRewardParcelTypeBytes() { return __p.__vector_as_span<Japan.ParcelType>(12, 4); }
#else
  public ArraySegment<byte>? GetRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(12); }
#endif
  public Japan.ParcelType[] GetRewardParcelTypeArray() { int o = __p.__offset(12); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.ParcelType[] a = new Japan.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Japan.TimeAttackDungeonRewardExcel> CreateTimeAttackDungeonRewardExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static VectorOffset CreateRewardTypeVector(FlatBufferBuilder builder, Japan.TimeAttackDungeonRewardType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateRewardTypeVectorBlock(FlatBufferBuilder builder, Japan.TimeAttackDungeonRewardType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateRewardTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Japan.TimeAttackDungeonRewardType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateRewardTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Japan.TimeAttackDungeonRewardType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Japan.TimeAttackDungeonRewardExcel> EndTimeAttackDungeonRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.TimeAttackDungeonRewardExcel>(o);
  }
  ...
  public void UnPackTo(TimeAttackDungeonRewardExcelT _o) {
    ...
    _o.RewardMaxPoint = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.RewardMaxPoint, key) : this.RewardMaxPoint;
    _o.RewardType = new List<Japan.TimeAttackDungeonRewardType>();
    for (var _j = 0; _j < this.RewardTypeLength; ++_j) {_o.RewardType.Add(TableEncryptionService.UseEncryption ? (Japan.TimeAttackDungeonRewardType)TableEncryptionService.Convert((int)this.RewardType(_j), key) : this.RewardType(_j));}
    _o.RewardMinPoint = new List<long>();
    for (var _j = 0; _j < this.RewardMinPointLength; ++_j) {_o.RewardMinPoint.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.RewardMinPoint(_j), key) : this.RewardMinPoint(_j));}
    ...
    for (var _j = 0; _j < this.RewardParcelDefaultAmountLength; ++_j) {_o.RewardParcelDefaultAmount.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.RewardParcelDefaultAmount(_j), key) : this.RewardParcelDefaultAmount(_j));}
    _o.RewardParcelMaxAmount = new List<long>();
    for (var _j = 0; _j < this.RewardParcelMaxAmountLength; ++_j) {_o.RewardParcelMaxAmount.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)this.RewardParcelMaxAmount(_j), key) : this.RewardParcelMaxAmount(_j));}
  }
  public static Offset<Japan.TimeAttackDungeonRewardExcel> Pack(FlatBufferBuilder builder, TimeAttackDungeonRewardExcelT _o) {
    if (_o == null) return default(Offset<Japan.TimeAttackDungeonRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("TimeAttackDungeonReward");
		var _Id = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.Id, key) : _o.Id;
		var _RewardMaxPoint = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.RewardMaxPoint, key) : _o.RewardMaxPoint;
    var _RewardType = default(VectorOffset);
    if (_o.RewardType != null) {
      var __RewardType = _o.RewardType.Select(x => TableEncryptionService.UseEncryption ? (Japan.TimeAttackDungeonRewardType)TableEncryptionService.Convert((int)x, key) : x).ToArray();
      _RewardType = CreateRewardTypeVector(builder, __RewardType);
    }
    var _RewardMinPoint = default(VectorOffset);
    if (_o.RewardMinPoint != null) {
      var __RewardMinPoint = _o.RewardMinPoint.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
    ...
    if (_o.RewardParcelDefaultAmount != null) {
      var __RewardParcelDefaultAmount = _o.RewardParcelDefaultAmount.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
    ...
    if (_o.RewardParcelMaxAmount != null) {
      var __RewardParcelMaxAmount = _o.RewardParcelMaxAmount.Select(x => TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)x, key) : x).ToArray();
...
public class TimeAttackDungeonRewardExcelT
{
  ...
  public List<Japan.TimeAttackDungeonRewardType> RewardType { get; set; }
...
static public class TimeAttackDungeonRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 8 /*RewardType*/, 4 /*Japan.TimeAttackDungeonRewardType*/, false)
      && verifier.VerifyVectorOfData(tablePos, 10 /*RewardMinPoint*/, 8 /*long*/, false)
      && verifier.VerifyVectorOfData(tablePos, 12 /*RewardParcelType*/, 4 /*Japan.ParcelType*/, false)
