...
public struct TimeAttackDungeonRewardExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(TimeAttackDungeonRewardExcelT _o) {
    ...
    _o.RewardMaxPoint = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.RewardMaxPoint, key) : this.RewardMaxPoint;
    _o.RewardType = new List<Japan.TimeAttackDungeonRewardType>();
    for (var _j = 0; _j < this.RewardTypeLength; ++_j) {_o.RewardType.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.RewardType(_j), key) : this.RewardType(_j));}
    _o.RewardMinPoint = new List<long>();
    for (var _j = 0; _j < this.RewardMinPointLength; ++_j) {_o.RewardMinPoint.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.RewardMinPoint(_j), key) : this.RewardMinPoint(_j));}
    ...
    for (var _j = 0; _j < this.RewardParcelDefaultAmountLength; ++_j) {_o.RewardParcelDefaultAmount.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.RewardParcelDefaultAmount(_j), key) : this.RewardParcelDefaultAmount(_j));}
    _o.RewardParcelMaxAmount = new List<long>();
    for (var _j = 0; _j < this.RewardParcelMaxAmountLength; ++_j) {_o.RewardParcelMaxAmount.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.RewardParcelMaxAmount(_j), key) : this.RewardParcelMaxAmount(_j));}
  }
  public static Offset<Japan.TimeAttackDungeonRewardExcel> Pack(FlatBufferBuilder builder, TimeAttackDungeonRewardExcelT _o) {
    if (_o == null) return default(Offset<Japan.TimeAttackDungeonRewardExcel>);
		...
		var _RewardMaxPoint = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.RewardMaxPoint, key) : _o.RewardMaxPoint;
