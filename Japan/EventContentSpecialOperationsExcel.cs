...
public struct EventContentSpecialOperationsExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.EventContentSpecialOperationsExcel> CreateEventContentSpecialOperationsExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.EventContentSpecialOperationsExcel> EndEventContentSpecialOperationsExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.EventContentSpecialOperationsExcel>(o);
  }
  ...
  public void UnPackTo(EventContentSpecialOperationsExcelT _o) {
    ...
    _o.PointItemId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.PointItemId, key) : this.PointItemId;
  }
  public static Offset<Japan.EventContentSpecialOperationsExcel> Pack(FlatBufferBuilder builder, EventContentSpecialOperationsExcelT _o) {
    if (_o == null) return default(Offset<Japan.EventContentSpecialOperationsExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentSpecialOperations");
		...
		var _PointItemId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PointItemId, key) : _o.PointItemId;
