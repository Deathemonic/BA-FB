...
public struct EventContentTreasureExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.EventContentTreasureExcel> CreateEventContentTreasureExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.EventContentTreasureExcel> EndEventContentTreasureExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.EventContentTreasureExcel>(o);
  }
  ...
  public static Offset<Japan.EventContentTreasureExcel> Pack(FlatBufferBuilder builder, EventContentTreasureExcelT _o) {
    if (_o == null) return default(Offset<Japan.EventContentTreasureExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentTreasure");
