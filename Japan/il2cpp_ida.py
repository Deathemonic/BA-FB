...
# Target Unity version: 2022.3.33 - 2023.1.99
...
class IDADisassemblerInterface(BaseDisassemblerInterface):
	...
	def on_start(self):
		...
		if IDACLANG_AVAILABLE:
			header_path = os.path.join(self.get_script_directory(), "cpp/appdata/il2cpp-types.h")
			...
			ida_typeinf.idc_parse_types(os.path.join(self.get_script_directory(), "cpp/appdata/il2cpp-types.h"), ida_typeinf.PT_FILE)
