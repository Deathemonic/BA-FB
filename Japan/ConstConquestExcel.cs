...
public struct ConstConquestExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.ConstConquestExcel> CreateConstConquestExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.ConstConquestExcel> EndConstConquestExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ConstConquestExcel>(o);
  }
  ...
  public static Offset<Japan.ConstConquestExcel> Pack(FlatBufferBuilder builder, ConstConquestExcelT _o) {
    if (_o == null) return default(Offset<Japan.ConstConquestExcel>);
		byte[] key = TableEncryptionService.CreateKey("ConstConquest");
