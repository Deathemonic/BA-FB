...
public struct FavorLevelExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.FavorLevelExcel> CreateFavorLevelExcel(FlatBufferBuilder builder,
      long Level = 0,
  ...
  public static Offset<Japan.FavorLevelExcel> EndFavorLevelExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.FavorLevelExcel>(o);
  }
  ...
  public static Offset<Japan.FavorLevelExcel> Pack(FlatBufferBuilder builder, FavorLevelExcelT _o) {
    if (_o == null) return default(Offset<Japan.FavorLevelExcel>);
		byte[] key = TableEncryptionService.CreateKey("FavorLevel");
