...
public struct ShopRecruitExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ShopRecruitExcelT _o) {
    ...
    _o.DisplayTag = TableEncryptionService.UseEncryption ? (Japan.GachaDisplayTag)TableEncryptionService.Convert((int)this.DisplayTag, key) : this.DisplayTag;
  ...
  public static Offset<Japan.ShopRecruitExcel> Pack(FlatBufferBuilder builder, ShopRecruitExcelT _o) {
    ...
    var _GoodsDevName = _o.GoodsDevName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.GoodsDevName, key) : _o.GoodsDevName));
		var _DisplayTag = TableEncryptionService.UseEncryption ? (Japan.GachaDisplayTag)TableEncryptionService.Convert((int)_o.DisplayTag, key) : _o.DisplayTag;
