...
public struct TutorialFailureImageExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(TutorialFailureImageExcelT _o) {
    ...
    _o.Contents = TableEncryptionService.UseEncryption ? (Japan.TutorialFailureContentType)TableEncryptionService.Convert((int)this.Contents, key) : this.Contents;
  ...
  public static Offset<Japan.TutorialFailureImageExcel> Pack(FlatBufferBuilder builder, TutorialFailureImageExcelT _o) {
    if (_o == null) return default(Offset<Japan.TutorialFailureImageExcel>);
		...
		var _Contents = TableEncryptionService.UseEncryption ? (Japan.TutorialFailureContentType)TableEncryptionService.Convert((int)_o.Contents, key) : _o.Contents;
