...
public struct FieldContentStageRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.FieldContentStageRewardExcel> CreateFieldContentStageRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static Offset<Japan.FieldContentStageRewardExcel> EndFieldContentStageRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.FieldContentStageRewardExcel>(o);
  }
  ...
  public static Offset<Japan.FieldContentStageRewardExcel> Pack(FlatBufferBuilder builder, FieldContentStageRewardExcelT _o) {
    if (_o == null) return default(Offset<Japan.FieldContentStageRewardExcel>);
		byte[] key = TableEncryptionService.CreateKey("FieldContentStageReward");
