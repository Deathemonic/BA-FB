...
public struct GroundExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(GroundExcelT _o) {
    ...
    _o.EnemyBulletType = TableEncryptionService.UseEncryption ? (Japan.BulletType)TableEncryptionService.Convert((int)this.EnemyBulletType, key) : this.EnemyBulletType;
    _o.EnemyArmorType = TableEncryptionService.UseEncryption ? (Japan.ArmorType)TableEncryptionService.Convert((int)this.EnemyArmorType, key) : this.EnemyArmorType;
    ...
    _o.ForcedTacticSpeed = TableEncryptionService.UseEncryption ? (Japan.TacticSpeed)TableEncryptionService.Convert((int)this.ForcedTacticSpeed, key) : this.ForcedTacticSpeed;
    _o.ForcedSkillUse = TableEncryptionService.UseEncryption ? (Japan.TacticSkillUse)TableEncryptionService.Convert((int)this.ForcedSkillUse, key) : this.ForcedSkillUse;
    _o.ShowNPCSkillCutIn = TableEncryptionService.UseEncryption ? (Japan.ShowSkillCutIn)TableEncryptionService.Convert((int)this.ShowNPCSkillCutIn, key) : this.ShowNPCSkillCutIn;
    ...
    _o.UIEnemyCount = TableEncryptionService.UseEncryption ? (Japan.UIEnemyCountType)TableEncryptionService.Convert((int)this.UIEnemyCount, key) : this.UIEnemyCount;
  ...
  public static Offset<Japan.GroundExcel> Pack(FlatBufferBuilder builder, GroundExcelT _o) {
    ...
    var _GroundSceneName = _o.GroundSceneName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.GroundSceneName, key) : _o.GroundSceneName));
		...
		var _EnemyBulletType = TableEncryptionService.UseEncryption ? (Japan.BulletType)TableEncryptionService.Convert((int)_o.EnemyBulletType, key) : _o.EnemyBulletType;
		var _EnemyArmorType = TableEncryptionService.UseEncryption ? (Japan.ArmorType)TableEncryptionService.Convert((int)_o.EnemyArmorType, key) : _o.EnemyArmorType;
		...
		var _ForcedTacticSpeed = TableEncryptionService.UseEncryption ? (Japan.TacticSpeed)TableEncryptionService.Convert((int)_o.ForcedTacticSpeed, key) : _o.ForcedTacticSpeed;
		var _ForcedSkillUse = TableEncryptionService.UseEncryption ? (Japan.TacticSkillUse)TableEncryptionService.Convert((int)_o.ForcedSkillUse, key) : _o.ForcedSkillUse;
		var _ShowNPCSkillCutIn = TableEncryptionService.UseEncryption ? (Japan.ShowSkillCutIn)TableEncryptionService.Convert((int)_o.ShowNPCSkillCutIn, key) : _o.ShowNPCSkillCutIn;
		...
		var _UIEnemyCount = TableEncryptionService.UseEncryption ? (Japan.UIEnemyCountType)TableEncryptionService.Convert((int)_o.UIEnemyCount, key) : _o.UIEnemyCount;
