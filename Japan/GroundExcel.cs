...
public struct GroundExcel : IFlatbufferObject
{
  ...
  public Japan.StageTopography StageTopography { get { int o = __p.__offset(12); return o != 0 ? (Japan.StageTopography)__p.bb.GetInt(o + __p.bb_pos) : Japan.StageTopography.Street; } }
  public Japan.BulletType EnemyBulletType { get { int o = __p.__offset(14); return o != 0 ? (Japan.BulletType)__p.bb.GetInt(o + __p.bb_pos) : Japan.BulletType.Normal; } }
  public Japan.ArmorType EnemyArmorType { get { int o = __p.__offset(16); return o != 0 ? (Japan.ArmorType)__p.bb.GetInt(o + __p.bb_pos) : Japan.ArmorType.LightArmor; } }
  ...
  public Japan.TacticSpeed ForcedTacticSpeed { get { int o = __p.__offset(82); return o != 0 ? (Japan.TacticSpeed)__p.bb.GetInt(o + __p.bb_pos) : Japan.TacticSpeed.None; } }
  public Japan.TacticSkillUse ForcedSkillUse { get { int o = __p.__offset(84); return o != 0 ? (Japan.TacticSkillUse)__p.bb.GetInt(o + __p.bb_pos) : Japan.TacticSkillUse.None; } }
  public Japan.ShowSkillCutIn ShowNPCSkillCutIn { get { int o = __p.__offset(86); return o != 0 ? (Japan.ShowSkillCutIn)__p.bb.GetInt(o + __p.bb_pos) : Japan.ShowSkillCutIn.None; } }
  ...
  public Japan.UIEnemyCountType UIEnemyCount { get { int o = __p.__offset(92); return o != 0 ? (Japan.UIEnemyCountType)__p.bb.GetInt(o + __p.bb_pos) : Japan.UIEnemyCountType.Normal; } }
  ...
  public static Offset<Japan.GroundExcel> CreateGroundExcel(FlatBufferBuilder builder,
      long Id = 0,
      ...
      Japan.BulletType EnemyBulletType = Japan.BulletType.Normal,
      Japan.ArmorType EnemyArmorType = Japan.ArmorType.LightArmor,
      long LevelNPC = 0,
      long LevelMinion = 0,
      long LevelElite = 0,
      ...
      Japan.TacticSpeed ForcedTacticSpeed = Japan.TacticSpeed.None,
      Japan.TacticSkillUse ForcedSkillUse = Japan.TacticSkillUse.None,
      Japan.ShowSkillCutIn ShowNPCSkillCutIn = Japan.ShowSkillCutIn.None,
      bool ImmuneHitBeforeTimeOutEnd = false,
      bool UIBattleHideFromScratch = false,
      Japan.UIEnemyCountType UIEnemyCount = Japan.UIEnemyCountType.Normal,
  ...
  public static void AddStageTopography(FlatBufferBuilder builder, Japan.StageTopography stageTopography) { builder.AddInt(4, (int)stageTopography, 0); }
  public static void AddEnemyBulletType(FlatBufferBuilder builder, Japan.BulletType enemyBulletType) { builder.AddInt(5, (int)enemyBulletType, 0); }
  public static void AddEnemyArmorType(FlatBufferBuilder builder, Japan.ArmorType enemyArmorType) { builder.AddInt(6, (int)enemyArmorType, 0); }
  ...
  public static void AddForcedTacticSpeed(FlatBufferBuilder builder, Japan.TacticSpeed forcedTacticSpeed) { builder.AddInt(39, (int)forcedTacticSpeed, 0); }
  public static void AddForcedSkillUse(FlatBufferBuilder builder, Japan.TacticSkillUse forcedSkillUse) { builder.AddInt(40, (int)forcedSkillUse, 0); }
  public static void AddShowNPCSkillCutIn(FlatBufferBuilder builder, Japan.ShowSkillCutIn showNPCSkillCutIn) { builder.AddInt(41, (int)showNPCSkillCutIn, 0); }
  ...
  public static void AddUIEnemyCount(FlatBufferBuilder builder, Japan.UIEnemyCountType uIEnemyCount) { builder.AddInt(44, (int)uIEnemyCount, 0); }
  ...
  public static Offset<Japan.GroundExcel> EndGroundExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.GroundExcel>(o);
  }
  ...
  public static Offset<Japan.GroundExcel> Pack(FlatBufferBuilder builder, GroundExcelT _o) {
    if (_o == null) return default(Offset<Japan.GroundExcel>);
		byte[] key = TableEncryptionService.CreateKey("Ground");
    ...
    if (_o.StageFileName != null) {
      ...
      for (var _j = 0; _j < __StageFileName.Length; ++_j) { __StageFileName[_j] = builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.StageFileName[_j], key) : _o.StageFileName[_j])); }
      _StageFileName = CreateStageFileNameVector(builder, __StageFileName);
    }
    var _GroundSceneName = _o.GroundSceneName == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.GroundSceneName, key) : _o.GroundSceneName));
		var _FormationGroupId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.FormationGroupId, key) : _o.FormationGroupId;
		...
		var _EnemyBulletType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EnemyBulletType, key) : _o.EnemyBulletType;
		var _EnemyArmorType = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EnemyArmorType, key) : _o.EnemyArmorType;
		var _LevelNPC = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.LevelNPC, key) : _o.LevelNPC;
		var _LevelMinion = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.LevelMinion, key) : _o.LevelMinion;
		var _LevelElite = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.LevelElite, key) : _o.LevelElite;
		var _LevelChampion = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.LevelChampion, key) : _o.LevelChampion;
		var _LevelBoss = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.LevelBoss, key) : _o.LevelBoss;
		var _ObstacleLevel = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ObstacleLevel, key) : _o.ObstacleLevel;
		var _GradeNPC = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.GradeNPC, key) : _o.GradeNPC;
		var _GradeMinion = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.GradeMinion, key) : _o.GradeMinion;
		var _GradeElite = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.GradeElite, key) : _o.GradeElite;
		var _GradeChampion = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.GradeChampion, key) : _o.GradeChampion;
		var _GradeBoss = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.GradeBoss, key) : _o.GradeBoss;
		var _PlayerSightPointAdd = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PlayerSightPointAdd, key) : _o.PlayerSightPointAdd;
		var _PlayerSightPointRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PlayerSightPointRate, key) : _o.PlayerSightPointRate;
		var _PlayerAttackRangeAdd = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PlayerAttackRangeAdd, key) : _o.PlayerAttackRangeAdd;
		var _PlayerAttackRangeRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PlayerAttackRangeRate, key) : _o.PlayerAttackRangeRate;
		var _EnemySightPointAdd = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EnemySightPointAdd, key) : _o.EnemySightPointAdd;
		var _EnemySightPointRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EnemySightPointRate, key) : _o.EnemySightPointRate;
		var _EnemyAttackRangeAdd = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EnemyAttackRangeAdd, key) : _o.EnemyAttackRangeAdd;
		var _EnemyAttackRangeRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EnemyAttackRangeRate, key) : _o.EnemyAttackRangeRate;
		var _PlayerSkillRangeAdd = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PlayerSkillRangeAdd, key) : _o.PlayerSkillRangeAdd;
		var _PlayerSkillRangeRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PlayerSkillRangeRate, key) : _o.PlayerSkillRangeRate;
		var _EnemySkillRangeAdd = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EnemySkillRangeAdd, key) : _o.EnemySkillRangeAdd;
		var _EnemySkillRangeRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EnemySkillRangeRate, key) : _o.EnemySkillRangeRate;
		var _PlayerMinimumPositionGapRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PlayerMinimumPositionGapRate, key) : _o.PlayerMinimumPositionGapRate;
		var _EnemyMinimumPositionGapRate = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EnemyMinimumPositionGapRate, key) : _o.EnemyMinimumPositionGapRate;
		var _PlayerSightRangeMax = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.PlayerSightRangeMax, key) : _o.PlayerSightRangeMax;
		var _EnemySightRangeMax = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EnemySightRangeMax, key) : _o.EnemySightRangeMax;
		var _TSSAirUnitHeight = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.TSSAirUnitHeight, key) : _o.TSSAirUnitHeight;
		var _IsPhaseBGM = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.IsPhaseBGM, key) : _o.IsPhaseBGM;
		var _BGMId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.BGMId, key) : _o.BGMId;
		var _WarningUI = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.WarningUI, key) : _o.WarningUI;
		var _TSSHatchOpen = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.TSSHatchOpen, key) : _o.TSSHatchOpen;
		var _ForcedTacticSpeed = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ForcedTacticSpeed, key) : _o.ForcedTacticSpeed;
		var _ForcedSkillUse = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ForcedSkillUse, key) : _o.ForcedSkillUse;
		var _ShowNPCSkillCutIn = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ShowNPCSkillCutIn, key) : _o.ShowNPCSkillCutIn;
		var _ImmuneHitBeforeTimeOutEnd = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.ImmuneHitBeforeTimeOutEnd, key) : _o.ImmuneHitBeforeTimeOutEnd;
		var _UIBattleHideFromScratch = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.UIBattleHideFromScratch, key) : _o.UIBattleHideFromScratch;
		var _UIEnemyCount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.UIEnemyCount, key) : _o.UIEnemyCount;
    var _BattleReadyTimelinePath = _o.BattleReadyTimelinePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.BattleReadyTimelinePath, key) : _o.BattleReadyTimelinePath));
    var _BeforeVictoryTimelinePath = _o.BeforeVictoryTimelinePath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.BeforeVictoryTimelinePath, key) : _o.BeforeVictoryTimelinePath));
		var _SkipBattleEnd = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.SkipBattleEnd, key) : _o.SkipBattleEnd;
		var _HideNPCWhenBattleEnd = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.HideNPCWhenBattleEnd, key) : _o.HideNPCWhenBattleEnd;
		var _CoverPointOff = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CoverPointOff, key) : _o.CoverPointOff;
		var _UIHpScale = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.UIHpScale, key) : _o.UIHpScale;
		var _UIEmojiScale = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.UIEmojiScale, key) : _o.UIEmojiScale;
		var _UISkillMainLogScale = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.UISkillMainLogScale, key) : _o.UISkillMainLogScale;
		var _EffectCountLimit = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.EffectCountLimit, key) : _o.EffectCountLimit;
    ...
    if (_o.AllyPassiveSkillId != null) {
      ...
      for (var _j = 0; _j < __AllyPassiveSkillId.Length; ++_j) { __AllyPassiveSkillId[_j] = builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack(_o.AllyPassiveSkillId[_j], key) : _o.AllyPassiveSkillId[_j])); }
...
public class GroundExcelT
{
  ...
  public Japan.BulletType EnemyBulletType { get; set; }
  public Japan.ArmorType EnemyArmorType { get; set; }
  ...
  public Japan.TacticSpeed ForcedTacticSpeed { get; set; }
  public Japan.TacticSkillUse ForcedSkillUse { get; set; }
  public Japan.ShowSkillCutIn ShowNPCSkillCutIn { get; set; }
  public bool ImmuneHitBeforeTimeOutEnd { get; set; }
  public bool UIBattleHideFromScratch { get; set; }
  public Japan.UIEnemyCountType UIEnemyCount { get; set; }
  ...
  public GroundExcelT() {
    ...
    this.EnemyBulletType = Japan.BulletType.Normal;
    this.EnemyArmorType = Japan.ArmorType.LightArmor;
    this.LevelNPC = 0;
    this.LevelMinion = 0;
    this.LevelElite = 0;
    ...
    this.ForcedTacticSpeed = Japan.TacticSpeed.None;
    this.ForcedSkillUse = Japan.TacticSkillUse.None;
    this.ShowNPCSkillCutIn = Japan.ShowSkillCutIn.None;
    this.ImmuneHitBeforeTimeOutEnd = false;
    this.UIBattleHideFromScratch = false;
    this.UIEnemyCount = Japan.UIEnemyCountType.Normal;
...
static public class GroundExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*StageTopography*/, 4 /*Japan.StageTopography*/, 4, false)
      && verifier.VerifyField(tablePos, 14 /*EnemyBulletType*/, 4 /*Japan.BulletType*/, 4, false)
      && verifier.VerifyField(tablePos, 16 /*EnemyArmorType*/, 4 /*Japan.ArmorType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 82 /*ForcedTacticSpeed*/, 4 /*Japan.TacticSpeed*/, 4, false)
      && verifier.VerifyField(tablePos, 84 /*ForcedSkillUse*/, 4 /*Japan.TacticSkillUse*/, 4, false)
      && verifier.VerifyField(tablePos, 86 /*ShowNPCSkillCutIn*/, 4 /*Japan.ShowSkillCutIn*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 92 /*UIEnemyCount*/, 4 /*Japan.UIEnemyCountType*/, 4, false)
