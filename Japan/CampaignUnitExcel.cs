...
public struct CampaignUnitExcel : IFlatbufferObject
{
  ...
  public Japan.StrategyAIType AIMoveType { get { int o = __p.__offset(22); return o != 0 ? (Japan.StrategyAIType)__p.bb.GetInt(o + __p.bb_pos) : Japan.StrategyAIType.None; } }
  public Japan.HexaUnitGrade Grade { get { int o = __p.__offset(24); return o != 0 ? (Japan.HexaUnitGrade)__p.bb.GetInt(o + __p.bb_pos) : Japan.HexaUnitGrade.Grade1; } }
  public Japan.TacticEnvironment EnvironmentType { get { int o = __p.__offset(26); return o != 0 ? (Japan.TacticEnvironment)__p.bb.GetInt(o + __p.bb_pos) : Japan.TacticEnvironment.None; } }
  ...
  public static Offset<Japan.CampaignUnitExcel> CreateCampaignUnitExcel(FlatBufferBuilder builder,
      long Id = 0,
      uint Key = 0,
      ...
      long GroundId = 0,
      int MoveRange = 0,
      Japan.StrategyAIType AIMoveType = Japan.StrategyAIType.None,
      Japan.HexaUnitGrade Grade = Japan.HexaUnitGrade.Grade1,
      Japan.TacticEnvironment EnvironmentType = Japan.TacticEnvironment.None,
      float Scale = 0.0f,
  ...
  public static void AddAIMoveType(FlatBufferBuilder builder, Japan.StrategyAIType aIMoveType) { builder.AddInt(9, (int)aIMoveType, 0); }
  public static void AddGrade(FlatBufferBuilder builder, Japan.HexaUnitGrade grade) { builder.AddInt(10, (int)grade, 0); }
  public static void AddEnvironmentType(FlatBufferBuilder builder, Japan.TacticEnvironment environmentType) { builder.AddInt(11, (int)environmentType, 0); }
  ...
  public static Offset<Japan.CampaignUnitExcel> EndCampaignUnitExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.CampaignUnitExcel>(o);
  }
  ...
  public static Offset<Japan.CampaignUnitExcel> Pack(FlatBufferBuilder builder, CampaignUnitExcelT _o) {
    if (_o == null) return default(Offset<Japan.CampaignUnitExcel>);
		byte[] key = TableEncryptionService.CreateKey("CampaignUnit");
...
public class CampaignUnitExcelT
{
  ...
  public Japan.StrategyAIType AIMoveType { get; set; }
  public Japan.HexaUnitGrade Grade { get; set; }
  public Japan.TacticEnvironment EnvironmentType { get; set; }
  ...
  public CampaignUnitExcelT() {
    ...
    this.GroundId = 0;
    this.MoveRange = 0;
    this.AIMoveType = Japan.StrategyAIType.None;
    this.Grade = Japan.HexaUnitGrade.Grade1;
    this.EnvironmentType = Japan.TacticEnvironment.None;
    this.Scale = 0.0f;
...
static public class CampaignUnitExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 22 /*AIMoveType*/, 4 /*Japan.StrategyAIType*/, 4, false)
      && verifier.VerifyField(tablePos, 24 /*Grade*/, 4 /*Japan.HexaUnitGrade*/, 4, false)
      && verifier.VerifyField(tablePos, 26 /*EnvironmentType*/, 4 /*Japan.TacticEnvironment*/, 4, false)
