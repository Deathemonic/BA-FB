...
public struct CampaignUnitExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(CampaignUnitExcelT _o) {
    ...
    _o.AIMoveType = TableEncryptionService.UseEncryption ? (Japan.StrategyAIType)TableEncryptionService.Convert((int)this.AIMoveType, key) : this.AIMoveType;
    _o.Grade = TableEncryptionService.UseEncryption ? (Japan.HexaUnitGrade)TableEncryptionService.Convert((int)this.Grade, key) : this.Grade;
    _o.EnvironmentType = TableEncryptionService.UseEncryption ? (Japan.TacticEnvironment)TableEncryptionService.Convert((int)this.EnvironmentType, key) : this.EnvironmentType;
  ...
  public static Offset<Japan.CampaignUnitExcel> Pack(FlatBufferBuilder builder, CampaignUnitExcelT _o) {
    ...
    if (_o.ClearScenarioGroupId != null) {
      ...
      _ClearScenarioGroupId = CreateClearScenarioGroupIdVector(builder, __ClearScenarioGroupId);
		...
		var _AIMoveType = TableEncryptionService.UseEncryption ? (Japan.StrategyAIType)TableEncryptionService.Convert((int)_o.AIMoveType, key) : _o.AIMoveType;
		var _Grade = TableEncryptionService.UseEncryption ? (Japan.HexaUnitGrade)TableEncryptionService.Convert((int)_o.Grade, key) : _o.Grade;
		var _EnvironmentType = TableEncryptionService.UseEncryption ? (Japan.TacticEnvironment)TableEncryptionService.Convert((int)_o.EnvironmentType, key) : _o.EnvironmentType;
