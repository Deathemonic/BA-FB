...
public struct EventContentDiceRaceProbExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.EventContentDiceRaceProbExcel> CreateEventContentDiceRaceProbExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.EventContentDiceRaceProbExcel> EndEventContentDiceRaceProbExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.EventContentDiceRaceProbExcel>(o);
  }
  ...
  public void UnPackTo(EventContentDiceRaceProbExcelT _o) {
    ...
    _o.CostItemId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CostItemId, key) : this.CostItemId;
    _o.CostItemAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.CostItemAmount, key) : this.CostItemAmount;
  ...
  public static Offset<Japan.EventContentDiceRaceProbExcel> Pack(FlatBufferBuilder builder, EventContentDiceRaceProbExcelT _o) {
    if (_o == null) return default(Offset<Japan.EventContentDiceRaceProbExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentDiceRaceProb");
		...
		var _CostItemId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CostItemId, key) : _o.CostItemId;
		var _CostItemAmount = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(_o.CostItemAmount, key) : _o.CostItemAmount;
