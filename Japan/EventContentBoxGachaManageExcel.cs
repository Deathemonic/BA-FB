...
public struct EventContentBoxGachaManageExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.EventContentBoxGachaManageExcel> CreateEventContentBoxGachaManageExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.EventContentBoxGachaManageExcel> EndEventContentBoxGachaManageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.EventContentBoxGachaManageExcel>(o);
  }
  ...
  public static Offset<Japan.EventContentBoxGachaManageExcel> Pack(FlatBufferBuilder builder, EventContentBoxGachaManageExcelT _o) {
    if (_o == null) return default(Offset<Japan.EventContentBoxGachaManageExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentBoxGachaManage");
