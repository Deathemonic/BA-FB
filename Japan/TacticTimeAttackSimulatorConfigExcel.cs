...
public struct TacticTimeAttackSimulatorConfigExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.TacticTimeAttackSimulatorConfigExcel> CreateTacticTimeAttackSimulatorConfigExcel(FlatBufferBuilder builder,
      long Order = 0,
      long Repeat = 0,
  ...
  public static Offset<Japan.TacticTimeAttackSimulatorConfigExcel> EndTacticTimeAttackSimulatorConfigExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.TacticTimeAttackSimulatorConfigExcel>(o);
  }
  ...
  public static Offset<Japan.TacticTimeAttackSimulatorConfigExcel> Pack(FlatBufferBuilder builder, TacticTimeAttackSimulatorConfigExcelT _o) {
    if (_o == null) return default(Offset<Japan.TacticTimeAttackSimulatorConfigExcel>);
		byte[] key = TableEncryptionService.CreateKey("TacticTimeAttackSimulatorConfig");
