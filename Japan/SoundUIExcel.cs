...
public struct SoundUIExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.SoundUIExcel> CreateSoundUIExcel(FlatBufferBuilder builder,
      long ID = 0,
  ...
  public static Offset<Japan.SoundUIExcel> EndSoundUIExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.SoundUIExcel>(o);
  }
  ...
  public static Offset<Japan.SoundUIExcel> Pack(FlatBufferBuilder builder, SoundUIExcelT _o) {
    if (_o == null) return default(Offset<Japan.SoundUIExcel>);
		byte[] key = TableEncryptionService.CreateKey("SoundUI");
