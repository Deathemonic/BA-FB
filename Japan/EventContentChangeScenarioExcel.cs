...
public struct EventContentChangeScenarioExcel : IFlatbufferObject
{
  ...
  public Japan.EventChangeType ChangeType { get { int o = __p.__offset(6); return o != 0 ? (Japan.EventChangeType)__p.bb.GetInt(o + __p.bb_pos) : Japan.EventChangeType.MainSub; } }
  ...
  public static Offset<Japan.EventContentChangeScenarioExcel> CreateEventContentChangeScenarioExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      Japan.EventChangeType ChangeType = Japan.EventChangeType.MainSub,
      long ChangeCount = 0,
  ...
  public static void AddChangeType(FlatBufferBuilder builder, Japan.EventChangeType changeType) { builder.AddInt(1, (int)changeType, 0); }
  ...
  public static Offset<Japan.EventContentChangeScenarioExcel> EndEventContentChangeScenarioExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.EventContentChangeScenarioExcel>(o);
  }
  ...
  public static Offset<Japan.EventContentChangeScenarioExcel> Pack(FlatBufferBuilder builder, EventContentChangeScenarioExcelT _o) {
    if (_o == null) return default(Offset<Japan.EventContentChangeScenarioExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentChangeScenario");
...
static public class EventContentChangeScenarioExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*ChangeType*/, 4 /*Japan.EventChangeType*/, 4, false)
