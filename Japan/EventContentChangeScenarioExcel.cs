...
public struct EventContentChangeScenarioExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(EventContentChangeScenarioExcelT _o) {
    ...
    _o.ChangeType = TableEncryptionService.UseEncryption ? (Japan.EventChangeType)TableEncryptionService.Convert((int)this.ChangeType, key) : this.ChangeType;
  ...
  public static Offset<Japan.EventContentChangeScenarioExcel> Pack(FlatBufferBuilder builder, EventContentChangeScenarioExcelT _o) {
    if (_o == null) return default(Offset<Japan.EventContentChangeScenarioExcel>);
		...
		var _ChangeType = TableEncryptionService.UseEncryption ? (Japan.EventChangeType)TableEncryptionService.Convert((int)_o.ChangeType, key) : _o.ChangeType;
