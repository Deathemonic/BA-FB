...
public struct DefaultParcelExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.DefaultParcelExcel> CreateDefaultParcelExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.DefaultParcelExcel> EndDefaultParcelExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.DefaultParcelExcel>(o);
  }
  ...
  public static Offset<Japan.DefaultParcelExcel> Pack(FlatBufferBuilder builder, DefaultParcelExcelT _o) {
    if (_o == null) return default(Offset<Japan.DefaultParcelExcel>);
		byte[] key = TableEncryptionService.CreateKey("DefaultParcel");
