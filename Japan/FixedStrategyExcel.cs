...
public struct FixedStrategyExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.FixedStrategyExcel> CreateFixedStrategyExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Japan.FixedStrategyExcel> EndFixedStrategyExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.FixedStrategyExcel>(o);
  }
  ...
  public static Offset<Japan.FixedStrategyExcel> Pack(FlatBufferBuilder builder, FixedStrategyExcelT _o) {
    if (_o == null) return default(Offset<Japan.FixedStrategyExcel>);
		byte[] key = TableEncryptionService.CreateKey("FixedStrategy");
