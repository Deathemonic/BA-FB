...
public struct TacticSkipExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.TacticSkipExcel> CreateTacticSkipExcel(FlatBufferBuilder builder,
      int LevelDiff = 0,
      long HPResult = 0) {
  ...
  public static Offset<Japan.TacticSkipExcel> EndTacticSkipExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.TacticSkipExcel>(o);
  }
  ...
  public static Offset<Japan.TacticSkipExcel> Pack(FlatBufferBuilder builder, TacticSkipExcelT _o) {
    if (_o == null) return default(Offset<Japan.TacticSkipExcel>);
		byte[] key = TableEncryptionService.CreateKey("TacticSkip");
