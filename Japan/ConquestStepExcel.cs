...
public struct ConquestStepExcel : IFlatbufferObject
{
  ...
  public Japan.StageDifficulty MapDifficulty { get { int o = __p.__offset(6); return o != 0 ? (Japan.StageDifficulty)__p.bb.GetInt(o + __p.bb_pos) : Japan.StageDifficulty.None; } }
  ...
  public Japan.ParcelType StepEnterItemType { get { int o = __p.__offset(14); return o != 0 ? (Japan.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Japan.ParcelType.None; } }
  ...
  public static Offset<Japan.ConquestStepExcel> CreateConquestStepExcel(FlatBufferBuilder builder,
      ...
      Japan.ParcelType StepEnterItemType = Japan.ParcelType.None,
  ...
  public static void AddMapDifficulty(FlatBufferBuilder builder, Japan.StageDifficulty mapDifficulty) { builder.AddInt(1, (int)mapDifficulty, 0); }
  ...
  public static void AddStepEnterItemType(FlatBufferBuilder builder, Japan.ParcelType stepEnterItemType) { builder.AddInt(5, (int)stepEnterItemType, 0); }
  ...
  public static Offset<Japan.ConquestStepExcel> EndConquestStepExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.ConquestStepExcel>(o);
  }
  ...
  public void UnPackTo(ConquestStepExcelT _o) {
    ...
    _o.StepEnterItemType = TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)this.StepEnterItemType, key) : this.StepEnterItemType;
  ...
  public static Offset<Japan.ConquestStepExcel> Pack(FlatBufferBuilder builder, ConquestStepExcelT _o) {
    if (_o == null) return default(Offset<Japan.ConquestStepExcel>);
		byte[] key = TableEncryptionService.CreateKey("ConquestStep");
    ...
    var _StepGoalLocalize = _o.StepGoalLocalize == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.StepGoalLocalize, key) : _o.StepGoalLocalize));
		...
		var _StepEnterItemType = TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)_o.StepEnterItemType, key) : _o.StepEnterItemType;
...
public class ConquestStepExcelT
{
  ...
  public Japan.ParcelType StepEnterItemType { get; set; }
  ...
  public ConquestStepExcelT() {
    ...
    this.StepEnterItemType = Japan.ParcelType.None;
...
static public class ConquestStepExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*MapDifficulty*/, 4 /*Japan.StageDifficulty*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 14 /*StepEnterItemType*/, 4 /*Japan.ParcelType*/, 4, false)
