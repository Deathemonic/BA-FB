...
public struct RaidSeasonManageExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.RaidSeasonManageExcel> CreateRaidSeasonManageExcel(FlatBufferBuilder builder,
      long SeasonId = 0,
  ...
  public static Offset<Japan.RaidSeasonManageExcel> EndRaidSeasonManageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.RaidSeasonManageExcel>(o);
  }
  ...
  public static Offset<Japan.RaidSeasonManageExcel> Pack(FlatBufferBuilder builder, RaidSeasonManageExcelT _o) {
    if (_o == null) return default(Offset<Japan.RaidSeasonManageExcel>);
		byte[] key = TableEncryptionService.CreateKey("RaidSeasonManage");
