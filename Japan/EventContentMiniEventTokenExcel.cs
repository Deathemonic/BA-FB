...
public struct EventContentMiniEventTokenExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.EventContentMiniEventTokenExcel> CreateEventContentMiniEventTokenExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.EventContentMiniEventTokenExcel> EndEventContentMiniEventTokenExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.EventContentMiniEventTokenExcel>(o);
  }
  ...
  public static Offset<Japan.EventContentMiniEventTokenExcel> Pack(FlatBufferBuilder builder, EventContentMiniEventTokenExcelT _o) {
    if (_o == null) return default(Offset<Japan.EventContentMiniEventTokenExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentMiniEventToken");
