...
public struct StickerPageContentExcel : IFlatbufferObject
{
  ...
  public Japan.StickerGetConditionType StickerGetConditionType { get { int o = __p.__offset(12); return o != 0 ? (Japan.StickerGetConditionType)__p.bb.GetInt(o + __p.bb_pos) : Japan.StickerGetConditionType.None; } }
  public Japan.StickerCheckPassType StickerCheckPassType { get { int o = __p.__offset(14); return o != 0 ? (Japan.StickerCheckPassType)__p.bb.GetInt(o + __p.bb_pos) : Japan.StickerCheckPassType.None; } }
  public Japan.GetStickerConditionType GetStickerConditionType { get { int o = __p.__offset(16); return o != 0 ? (Japan.GetStickerConditionType)__p.bb.GetInt(o + __p.bb_pos) : Japan.GetStickerConditionType.None; } }
  ...
  public Japan.Tag StickerGetConditionParameterTag(int j) { int o = __p.__offset(22); return o != 0 ? (Japan.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.Tag)0; }
  public int StickerGetConditionParameterTagLength { get { int o = __p.__offset(22); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.Tag> GetStickerGetConditionParameterTagBytes() { return __p.__vector_as_span<Japan.Tag>(22, 4); }
#else
  public ArraySegment<byte>? GetStickerGetConditionParameterTagBytes() { return __p.__vector_as_arraysegment(22); }
#endif
  public Japan.Tag[] GetStickerGetConditionParameterTagArray() { int o = __p.__offset(22); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.Tag[] a = new Japan.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.Tag)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Japan.StickerPageContentExcel> CreateStickerPageContentExcel(FlatBufferBuilder builder,
      long Id = 0,
      long StickerGroupId = 0,
      long StickerPageId = 0,
      long StickerSlot = 0,
      Japan.StickerGetConditionType StickerGetConditionType = Japan.StickerGetConditionType.None,
      Japan.StickerCheckPassType StickerCheckPassType = Japan.StickerCheckPassType.None,
      Japan.GetStickerConditionType GetStickerConditionType = Japan.GetStickerConditionType.None,
  ...
  public static void AddStickerGetConditionType(FlatBufferBuilder builder, Japan.StickerGetConditionType stickerGetConditionType) { builder.AddInt(4, (int)stickerGetConditionType, 0); }
  public static void AddStickerCheckPassType(FlatBufferBuilder builder, Japan.StickerCheckPassType stickerCheckPassType) { builder.AddInt(5, (int)stickerCheckPassType, 0); }
  public static void AddGetStickerConditionType(FlatBufferBuilder builder, Japan.GetStickerConditionType getStickerConditionType) { builder.AddInt(6, (int)getStickerConditionType, 0); }
  ...
  public static VectorOffset CreateStickerGetConditionParameterTagVector(FlatBufferBuilder builder, Japan.Tag[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateStickerGetConditionParameterTagVectorBlock(FlatBufferBuilder builder, Japan.Tag[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateStickerGetConditionParameterTagVectorBlock(FlatBufferBuilder builder, ArraySegment<Japan.Tag> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateStickerGetConditionParameterTagVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Japan.Tag>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Japan.StickerPageContentExcel> EndStickerPageContentExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.StickerPageContentExcel>(o);
  }
  ...
  public void UnPackTo(StickerPageContentExcelT _o) {
    ...
    _o.StickerGetConditionType = TableEncryptionService.UseEncryption ? (Japan.StickerGetConditionType)TableEncryptionService.Convert((int)this.StickerGetConditionType, key) : this.StickerGetConditionType;
    _o.StickerCheckPassType = TableEncryptionService.UseEncryption ? (Japan.StickerCheckPassType)TableEncryptionService.Convert((int)this.StickerCheckPassType, key) : this.StickerCheckPassType;
    _o.GetStickerConditionType = TableEncryptionService.UseEncryption ? (Japan.GetStickerConditionType)TableEncryptionService.Convert((int)this.GetStickerConditionType, key) : this.GetStickerConditionType;
    ...
    _o.StickerGetConditionParameterTag = new List<Japan.Tag>();
    for (var _j = 0; _j < this.StickerGetConditionParameterTagLength; ++_j) {_o.StickerGetConditionParameterTag.Add(TableEncryptionService.UseEncryption ? (Japan.Tag)TableEncryptionService.Convert((int)this.StickerGetConditionParameterTag(_j), key) : this.StickerGetConditionParameterTag(_j));}
  ...
  public static Offset<Japan.StickerPageContentExcel> Pack(FlatBufferBuilder builder, StickerPageContentExcelT _o) {
    if (_o == null) return default(Offset<Japan.StickerPageContentExcel>);
		byte[] key = TableEncryptionService.CreateKey("StickerPageContent");
		...
		var _StickerGetConditionType = TableEncryptionService.UseEncryption ? (Japan.StickerGetConditionType)TableEncryptionService.Convert((int)_o.StickerGetConditionType, key) : _o.StickerGetConditionType;
		var _StickerCheckPassType = TableEncryptionService.UseEncryption ? (Japan.StickerCheckPassType)TableEncryptionService.Convert((int)_o.StickerCheckPassType, key) : _o.StickerCheckPassType;
		var _GetStickerConditionType = TableEncryptionService.UseEncryption ? (Japan.GetStickerConditionType)TableEncryptionService.Convert((int)_o.GetStickerConditionType, key) : _o.GetStickerConditionType;
    ...
    if (_o.StickerGetConditionParameterTag != null) {
      var __StickerGetConditionParameterTag = _o.StickerGetConditionParameterTag.Select(x => TableEncryptionService.UseEncryption ? (Japan.Tag)TableEncryptionService.Convert((int)x, key) : x).ToArray();
...
public class StickerPageContentExcelT
{
  ...
  public Japan.StickerGetConditionType StickerGetConditionType { get; set; }
  public Japan.StickerCheckPassType StickerCheckPassType { get; set; }
  public Japan.GetStickerConditionType GetStickerConditionType { get; set; }
  public long StickerGetConditionCount { get; set; }
  public List<long> StickerGetConditionParameter { get; set; }
  public List<Japan.Tag> StickerGetConditionParameterTag { get; set; }
  ...
  public StickerPageContentExcelT() {
    ...
    this.StickerSlot = 0;
    this.StickerGetConditionType = Japan.StickerGetConditionType.None;
    this.StickerCheckPassType = Japan.StickerCheckPassType.None;
    this.GetStickerConditionType = Japan.GetStickerConditionType.None;
...
static public class StickerPageContentExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*StickerGetConditionType*/, 4 /*Japan.StickerGetConditionType*/, 4, false)
      && verifier.VerifyField(tablePos, 14 /*StickerCheckPassType*/, 4 /*Japan.StickerCheckPassType*/, 4, false)
      && verifier.VerifyField(tablePos, 16 /*GetStickerConditionType*/, 4 /*Japan.GetStickerConditionType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 22 /*StickerGetConditionParameterTag*/, 4 /*Japan.Tag*/, false)
