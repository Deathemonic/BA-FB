...
public struct AniStateData : IFlatbufferObject
{
  ...
  public Japan.AniEventData? Events(int j) { int o = __p.__offset(26); return o != 0 ? (Japan.AniEventData?)(new Japan.AniEventData()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  public int EventsLength { get { int o = __p.__offset(26); return o != 0 ? __p.__vector_len(o) : 0; } }

  public static Offset<Japan.AniStateData> CreateAniStateData(FlatBufferBuilder builder,
  ...
  public static VectorOffset CreateEventsVector(FlatBufferBuilder builder, Offset<Japan.AniEventData>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateEventsVectorBlock(FlatBufferBuilder builder, Offset<Japan.AniEventData>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateEventsVectorBlock(FlatBufferBuilder builder, ArraySegment<Offset<Japan.AniEventData>> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateEventsVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Offset<Japan.AniEventData>>(dataPtr, sizeInBytes); return builder.EndVector(); }
  public static void StartEventsVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static Offset<Japan.AniStateData> EndAniStateData(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.AniStateData>(o);
  }
  ...
  public void UnPackTo(AniStateDataT _o) {
    ...
    _o.Events = new List<Japan.AniEventDataT>();
    for (var _j = 0; _j < this.EventsLength; ++_j) {_o.Events.Add(this.Events(_j).HasValue ? this.Events(_j).Value.UnPack() : null);}
  }
  public static Offset<Japan.AniStateData> Pack(FlatBufferBuilder builder, AniStateDataT _o) {
    if (_o == null) return default(Offset<Japan.AniStateData>);
		byte[] key = TableEncryptionService.CreateKey("AniStat");
    ...
    if (_o.Events != null) {
      var __Events = new Offset<Japan.AniEventData>[_o.Events.Count];
      for (var _j = 0; _j < __Events.Length; ++_j) { __Events[_j] = Japan.AniEventData.Pack(builder, _o.Events[_j]); }
...
public class AniStateDataT
{
  ...
  public List<Japan.AniEventDataT> Events { get; set; }
...
static public class AniStateDataVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfTables(tablePos, 26 /*Events*/, Japan.AniEventDataVerify.Verify, false)
