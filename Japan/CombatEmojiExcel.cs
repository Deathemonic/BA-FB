...
public struct CombatEmojiExcel : IFlatbufferObject
{
  ...
  public Japan.EmojiEvent EmojiEvent { get { int o = __p.__offset(6); return o != 0 ? (Japan.EmojiEvent)__p.bb.GetInt(o + __p.bb_pos) : Japan.EmojiEvent.EnterConver; } }
  ...
  public static Offset<Japan.CombatEmojiExcel> CreateCombatEmojiExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      Japan.EmojiEvent EmojiEvent = Japan.EmojiEvent.EnterConver,
  ...
  public static void AddEmojiEvent(FlatBufferBuilder builder, Japan.EmojiEvent emojiEvent) { builder.AddInt(1, (int)emojiEvent, 0); }
  ...
  public static Offset<Japan.CombatEmojiExcel> EndCombatEmojiExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.CombatEmojiExcel>(o);
  }
  ...
  public void UnPackTo(CombatEmojiExcelT _o) {
    ...
    _o.EmojiEvent = TableEncryptionService.UseEncryption ? (Japan.EmojiEvent)TableEncryptionService.Convert((int)this.EmojiEvent, key) : this.EmojiEvent;
  ...
  public static Offset<Japan.CombatEmojiExcel> Pack(FlatBufferBuilder builder, CombatEmojiExcelT _o) {
    if (_o == null) return default(Offset<Japan.CombatEmojiExcel>);
		byte[] key = TableEncryptionService.CreateKey("CombatEmoji");
		var _UniqueId = TableEncryptionService.UseEncryption ? TableEncryptionService.Convert((long)_o.UniqueId, key) : _o.UniqueId;
		var _EmojiEvent = TableEncryptionService.UseEncryption ? (Japan.EmojiEvent)TableEncryptionService.Convert((int)_o.EmojiEvent, key) : _o.EmojiEvent;
...
public class CombatEmojiExcelT
{
  ...
  public Japan.EmojiEvent EmojiEvent { get; set; }
  ...
  public CombatEmojiExcelT() {
    this.UniqueId = 0;
    this.EmojiEvent = Japan.EmojiEvent.EnterConver;
...
static public class CombatEmojiExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*EmojiEvent*/, 4 /*Japan.EmojiEvent*/, 4, false)
