...
public struct InformationExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.InformationExcel> CreateInformationExcel(FlatBufferBuilder builder,
      long GroupID = 0,
  ...
  public static Offset<Japan.InformationExcel> EndInformationExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.InformationExcel>(o);
  }
  ...
  public static Offset<Japan.InformationExcel> Pack(FlatBufferBuilder builder, InformationExcelT _o) {
    if (_o == null) return default(Offset<Japan.InformationExcel>);
		byte[] key = TableEncryptionService.CreateKey("Information");
