...
public struct FieldTutorialExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(FieldTutorialExcelT _o) {
    ...
    for (var _j = 0; _j < this.TutorialTypeLength; ++_j) {_o.TutorialType.Add(TableEncryptionService.UseEncryption ? TableEncryptionService.Convert(this.TutorialType(_j), key) : this.TutorialType(_j));}
