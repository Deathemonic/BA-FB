...
public struct FieldTutorialExcel : IFlatbufferObject
{
  ...
  public Japan.FieldTutorialType TutorialType(int j) { int o = __p.__offset(6); return o != 0 ? (Japan.FieldTutorialType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.FieldTutorialType)0; }
  public int TutorialTypeLength { get { int o = __p.__offset(6); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.FieldTutorialType> GetTutorialTypeBytes() { return __p.__vector_as_span<Japan.FieldTutorialType>(6, 4); }
#else
  public ArraySegment<byte>? GetTutorialTypeBytes() { return __p.__vector_as_arraysegment(6); }
#endif
  public Japan.FieldTutorialType[] GetTutorialTypeArray() { int o = __p.__offset(6); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.FieldTutorialType[] a = new Japan.FieldTutorialType[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.FieldTutorialType)__p.bb.GetInt(p + i * 4); } return a; }
  public Japan.FieldConditionType ConditionType(int j) { int o = __p.__offset(8); return o != 0 ? (Japan.FieldConditionType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Japan.FieldConditionType)0; }
  public int ConditionTypeLength { get { int o = __p.__offset(8); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Japan.FieldConditionType> GetConditionTypeBytes() { return __p.__vector_as_span<Japan.FieldConditionType>(8, 4); }
#else
  public ArraySegment<byte>? GetConditionTypeBytes() { return __p.__vector_as_arraysegment(8); }
#endif
  public Japan.FieldConditionType[] GetConditionTypeArray() { int o = __p.__offset(8); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Japan.FieldConditionType[] a = new Japan.FieldConditionType[l]; for (int i = 0; i < l; i++) { a[i] = (Japan.FieldConditionType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Japan.FieldTutorialExcel> CreateFieldTutorialExcel(FlatBufferBuilder builder,
      long SeasonId = 0,
  ...
  public static VectorOffset CreateTutorialTypeVector(FlatBufferBuilder builder, Japan.FieldTutorialType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateTutorialTypeVectorBlock(FlatBufferBuilder builder, Japan.FieldTutorialType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateTutorialTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Japan.FieldTutorialType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateTutorialTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Japan.FieldTutorialType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Japan.FieldTutorialExcel> EndFieldTutorialExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.FieldTutorialExcel>(o);
  }
  ...
  public void UnPackTo(FieldTutorialExcelT _o) {
    ...
    _o.TutorialType = new List<Japan.FieldTutorialType>();
    for (var _j = 0; _j < this.TutorialTypeLength; ++_j) {_o.TutorialType.Add(TableEncryptionService.UseEncryption ? (Japan.FieldTutorialType)TableEncryptionService.Convert((int)this.TutorialType(_j), key) : this.TutorialType(_j));}
  ...
  public static Offset<Japan.FieldTutorialExcel> Pack(FlatBufferBuilder builder, FieldTutorialExcelT _o) {
    if (_o == null) return default(Offset<Japan.FieldTutorialExcel>);
		byte[] key = TableEncryptionService.CreateKey("FieldTutorial");
    ...
    if (_o.TutorialType != null) {
      var __tutorialType = _o.TutorialType.Select(x => TableEncryptionService.UseEncryption ? (Japan.FieldTutorialType)TableEncryptionService.Convert((int)x, key) : x).ToArray();
...
public class FieldTutorialExcelT
{
  ...
  public List<Japan.FieldTutorialType> TutorialType { get; set; }
...
static public class FieldTutorialExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 6 /*TutorialType*/, 4 /*Japan.FieldTutorialType*/, false)
      && verifier.VerifyVectorOfData(tablePos, 8 /*ConditionType*/, 4 /*Japan.FieldConditionType*/, false)
