...
public struct VoiceLogicEffectExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.VoiceLogicEffectExcel> CreateVoiceLogicEffectExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Japan.VoiceLogicEffectExcel> EndVoiceLogicEffectExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.VoiceLogicEffectExcel>(o);
  }
  ...
  public static Offset<Japan.VoiceLogicEffectExcel> Pack(FlatBufferBuilder builder, VoiceLogicEffectExcelT _o) {
    if (_o == null) return default(Offset<Japan.VoiceLogicEffectExcel>);
		byte[] key = TableEncryptionService.CreateKey("VoiceLogicEffect");
