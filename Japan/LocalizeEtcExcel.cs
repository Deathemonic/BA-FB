...
public struct LocalizeEtcExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.LocalizeEtcExcel> CreateLocalizeEtcExcel(FlatBufferBuilder builder,
      uint Key = 0,
  ...
  public static Offset<Japan.LocalizeEtcExcel> EndLocalizeEtcExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.LocalizeEtcExcel>(o);
  }
  ...
  public static Offset<Japan.LocalizeEtcExcel> Pack(FlatBufferBuilder builder, LocalizeEtcExcelT _o) {
    if (_o == null) return default(Offset<Japan.LocalizeEtcExcel>);
		byte[] key = TableEncryptionService.CreateKey("LocalizeEtc");
