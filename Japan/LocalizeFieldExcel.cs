...
public struct LocalizeFieldExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.LocalizeFieldExcel> CreateLocalizeFieldExcel(FlatBufferBuilder builder,
      uint Key = 0,
  ...
  public static Offset<Japan.LocalizeFieldExcel> EndLocalizeFieldExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.LocalizeFieldExcel>(o);
  }
  ...
  public static Offset<Japan.LocalizeFieldExcel> Pack(FlatBufferBuilder builder, LocalizeFieldExcelT _o) {
    if (_o == null) return default(Offset<Japan.LocalizeFieldExcel>);
		byte[] key = TableEncryptionService.CreateKey("LocalizeField");
