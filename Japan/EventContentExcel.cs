...
public struct EventContentExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.EventContentExcel> CreateEventContentExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Japan.EventContentExcel> EndEventContentExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.EventContentExcel>(o);
  }
  ...
  public static Offset<Japan.EventContentExcel> Pack(FlatBufferBuilder builder, EventContentExcelT _o) {
    if (_o == null) return default(Offset<Japan.EventContentExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContent");
