...
public struct MissionEmergencyCompleteExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.MissionEmergencyCompleteExcel> CreateMissionEmergencyCompleteExcel(FlatBufferBuilder builder,
      long MissionId = 0,
  ...
  public static Offset<Japan.MissionEmergencyCompleteExcel> EndMissionEmergencyCompleteExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.MissionEmergencyCompleteExcel>(o);
  }
  ...
  public static Offset<Japan.MissionEmergencyCompleteExcel> Pack(FlatBufferBuilder builder, MissionEmergencyCompleteExcelT _o) {
    if (_o == null) return default(Offset<Japan.MissionEmergencyCompleteExcel>);
		byte[] key = TableEncryptionService.CreateKey("MissionEmergencyComplete");
