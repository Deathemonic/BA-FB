...
public struct LimitedStageSeasonExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.LimitedStageSeasonExcel> CreateLimitedStageSeasonExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Japan.LimitedStageSeasonExcel> EndLimitedStageSeasonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.LimitedStageSeasonExcel>(o);
  }
  ...
  public static Offset<Japan.LimitedStageSeasonExcel> Pack(FlatBufferBuilder builder, LimitedStageSeasonExcelT _o) {
    if (_o == null) return default(Offset<Japan.LimitedStageSeasonExcel>);
		byte[] key = TableEncryptionService.CreateKey("LimitedStageSeason");
