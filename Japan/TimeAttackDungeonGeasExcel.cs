...
public struct TimeAttackDungeonGeasExcel : IFlatbufferObject
{
  ...
  public static Offset<Japan.TimeAttackDungeonGeasExcel> CreateTimeAttackDungeonGeasExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Japan.TimeAttackDungeonGeasExcel> EndTimeAttackDungeonGeasExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.TimeAttackDungeonGeasExcel>(o);
  }
  ...
  public static Offset<Japan.TimeAttackDungeonGeasExcel> Pack(FlatBufferBuilder builder, TimeAttackDungeonGeasExcelT _o) {
    if (_o == null) return default(Offset<Japan.TimeAttackDungeonGeasExcel>);
		byte[] key = TableEncryptionService.CreateKey("TimeAttackDungeonGeas");
