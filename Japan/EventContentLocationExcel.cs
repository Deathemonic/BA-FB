...
public struct EventContentLocationExcel : IFlatbufferObject
{
  ...
  public Japan.ParcelType ScheduleEventPointCostParcelType { get { int o = __p.__offset(14); return o != 0 ? (Japan.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Japan.ParcelType.None; } }
  ...
  public static Offset<Japan.EventContentLocationExcel> CreateEventContentLocationExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      long Id = 0,
      uint LocalizeEtcId = 0,
      StringOffset PrefabPathOffset = default(StringOffset),
      int LocationResetScheduleCount = 0,
      Japan.ParcelType ScheduleEventPointCostParcelType = Japan.ParcelType.None,
  ...
  public static void AddScheduleEventPointCostParcelType(FlatBufferBuilder builder, Japan.ParcelType scheduleEventPointCostParcelType) { builder.AddInt(5, (int)scheduleEventPointCostParcelType, 0); }
  ...
  public static Offset<Japan.EventContentLocationExcel> EndEventContentLocationExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Japan.EventContentLocationExcel>(o);
  }
  ...
  public void UnPackTo(EventContentLocationExcelT _o) {
    ...
    _o.ScheduleEventPointCostParcelType = TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)this.ScheduleEventPointCostParcelType, key) : this.ScheduleEventPointCostParcelType;
  ...
  public static Offset<Japan.EventContentLocationExcel> Pack(FlatBufferBuilder builder, EventContentLocationExcelT _o) {
    if (_o == null) return default(Offset<Japan.EventContentLocationExcel>);
		byte[] key = TableEncryptionService.CreateKey("EventContentLocation");
    ...
    var _PrefabPath = _o.PrefabPath == null ? default(StringOffset) : builder.CreateString((TableEncryptionService.UseEncryption ? TableEncryptionService.ConvertPack((string)_o.PrefabPath, key) : _o.PrefabPath));
		...
		var _ScheduleEventPointCostParcelType = TableEncryptionService.UseEncryption ? (Japan.ParcelType)TableEncryptionService.Convert((int)_o.ScheduleEventPointCostParcelType, key) : _o.ScheduleEventPointCostParcelType;
...
public class EventContentLocationExcelT
{
  ...
  public Japan.ParcelType ScheduleEventPointCostParcelType { get; set; }
  ...
  public EventContentLocationExcelT() {
    ...
    this.ScheduleEventPointCostParcelType = Japan.ParcelType.None;
...
static public class EventContentLocationExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 14 /*ScheduleEventPointCostParcelType*/, 4 /*Japan.ParcelType*/, 4, false)
